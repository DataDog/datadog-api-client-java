...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    try {
      PermissionsResponse result = apiInstance.addPermissionToRole(
        roleId,
        body
      );
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    try {
      UsersResponse result = apiInstance.listRoleUsers(
        roleId,
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    RelationshipToPermission body = new RelationshipToPermission(); // RelationshipToPermission |
    try {
      PermissionsResponse result = apiInstance.removePermissionFromRole(
        roleId,
        body
      );
      System.out.println(result);
      ...
      System.err.println(
        "Exception when calling RolesApi#removePermissionFromRole"
      );
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
