...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    try {
      ApplicationKeyResponse result = apiInstance.createServiceAccountApplicationKey(
        serviceAccountId,
        body
      );
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    String appKeyId = "appKeyId_example"; // String | The ID of the application key.
    try {
      PartialApplicationKeyResponse result = apiInstance.getServiceAccountApplicationKey(
        serviceAccountId,
        appKeyId
      );
      System.out.println(result);
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    try {
      ListApplicationKeysResponse result = apiInstance.listServiceAccountApplicationKeys(
        serviceAccountId,
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    try {
      PartialApplicationKeyResponse result = apiInstance.updateServiceAccountApplicationKey(
        serviceAccountId,
        appKeyId,
        body
      );
