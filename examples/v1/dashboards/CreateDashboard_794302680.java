...
.name("query1")
.query("avg:aws.stream.globalaccelerator.processed_bytes_in{*} by {aws_account,acceleratoripaddress}")), new FormulaAndFunctionQueryDefinition(
new FormulaAndFunctionMetricQueryDefinition()
.aggregator(FormulaAndFunctionMetricAggregation.AVG)
.dataSource(FormulaAndFunctionMetricDataSource.METRICS)
.name("query2")
...
.textFormats(Arrays.asList(Arrays.asList(new TableWidgetTextFormatRule()
...
.replace(new TableWidgetTextFormatReplace(
new TableWidgetTextFormatReplaceAll()
.type(TableWidgetTextFormatReplaceAllType.ALL)
.with("vegetable"))), new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.IS)
.value("animal"))
.palette(TableWidgetTextFormatPalette.CUSTOM_BG)
.customBgColor("#632ca6"), new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.IS)
.value("robot"))
.palette(TableWidgetTextFormatPalette.RED_ON_WHITE), new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.IS)
.value("ai"))
.palette(TableWidgetTextFormatPalette.YELLOW_ON_WHITE)), Collections.singletonList(new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.IS_NOT)
.value("xyz"))
.palette(TableWidgetTextFormatPalette.WHITE_ON_YELLOW)), Collections.singletonList(new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
...
new TableWidgetTextFormatReplaceAll()
.type(TableWidgetTextFormatReplaceAllType.ALL)
.with("vegetable")))), Collections.singletonList(new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.DOES_NOT_CONTAIN)
.value("blah"))
.palette(TableWidgetTextFormatPalette.BLACK_ON_LIGHT_RED)), Collections.singletonList(new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.STARTS_WITH)
.value("abc"))
.palette(TableWidgetTextFormatPalette.BLACK_ON_LIGHT_YELLOW)), Arrays.asList(new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.ENDS_WITH)
.value("xyz"))
.palette(TableWidgetTextFormatPalette.BLACK_ON_LIGHT_GREEN), new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.ENDS_WITH)
.value("zzz"))
.palette(TableWidgetTextFormatPalette.GREEN_ON_WHITE), new TableWidgetTextFormatRule()
.match(new TableWidgetTextFormatMatch()
.type(TableWidgetTextFormatMatchType.IS)
.value("animal"))
