...
import com.datadog.api.client.v1.model.SankeyNetworkDataSource;
import com.datadog.api.client.v1.model.SankeyNetworkQuery;
import com.datadog.api.client.v1.model.SankeyNetworkRequest;
import com.datadog.api.client.v1.model.SankeyNetworkRequestType;
...
.requests(Collections.singletonList(new SankeyWidgetRequest(
new SankeyNetworkRequest()
.query(new SankeyNetworkQuery()
.dataSource(SankeyNetworkDataSource.NETWORK)
.queryString("*")
.groupBy(Arrays.asList("source", "destination"))
.limit(100L))
.requestType(SankeyNetworkRequestType.NETFLOW_SANKEY))))))))
