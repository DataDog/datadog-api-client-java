...
.max("auto")
.includeZero(true))
.markers(Arrays.asList(new WidgetMarker()
.displayType("percentile")
.value("50"), new WidgetMarker()
.displayType("percentile")
.value("99")))
.requests(Collections.singletonList(new HeatMapWidgetRequest()
.requestType(WidgetHistogramRequestType.HISTOGRAM)
.query(new FormulaAndFunctionMetricQueryDefinition()
