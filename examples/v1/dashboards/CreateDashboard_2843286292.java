...
.dataSource(ListStreamSource.LOGS_TRANSACTION_STREAM)
.queryString("")
.groupBy(Collections.singletonList(new ListStreamGroupByItems()
.facet("service")))
.compute(Collections.singletonList(new ListStreamComputeItems()
.facet("service")
