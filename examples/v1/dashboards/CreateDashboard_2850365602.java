...
.templateVariablePresets(Collections.singletonList(new DashboardTemplateVariablePreset()
.name("my saved view")
.templateVariables(Collections.singletonList(new DashboardTemplateVariablePresetValue()
.name("datacenter")
.values(Arrays.asList("*", "my-host"))))))
.templateVariables(Collections.singletonList(new DashboardTemplateVariable()
