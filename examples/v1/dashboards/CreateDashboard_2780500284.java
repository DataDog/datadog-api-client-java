...
import com.datadog.api.client.v1.model.DatasetListQuery;
import com.datadog.api.client.v1.model.DatasetListQueryDataSourceType;
...
import com.datadog.api.client.v1.model.HostMapWidgetProjection;
import com.datadog.api.client.v1.model.HostMapWidgetProjectionDimensionMapping;
import com.datadog.api.client.v1.model.HostMapWidgetProjectionType;
import com.datadog.api.client.v1.model.PublishedDatasetProvider;
                                ...
                                new HostMapWidgetDefinition()
                                    ...
                                    .requests(
                                        new HostMapWidgetDefinitionRequests()
                                            .requestType(
                                                HostMapWidgetDefinitionRequestType.DATA_PROJECTION)
                                            .limit(1000L)
                                            .query(
                                                new DatasetListQuery()
                                                    .dataSource(
                                            ...
                                            .projection(
                                                new HostMapWidgetProjection()
                                                    .type(HostMapWidgetProjectionType.HOSTMAP)
                                                    .dimensions(
                                                        Arrays.asList(
                                                            new HostMapWidgetProjectionDimensionMapping()
                                                                .column("entity_id")
                                                                .dimension(
