...
public class Example {
  public static void main(String[] args) {
    ...
    List<ServiceCheck> body = Collections.singletonList(new ServiceCheck()
.check("app.ok")
.hostName("host")
.status(ServiceCheckStatus.OK)
.tags(Collections.singletonList("test:ExampleSubmitaServiceCheckreturnsPayloadacceptedresponse")));
