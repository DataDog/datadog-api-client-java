...
.assertions(new ArrayList<SyntheticsAssertion>() {{;}})
...
.allowInsecure(true)
.deviceIds(new ArrayList<SyntheticsDeviceID>() {{add(SyntheticsDeviceID.TABLET);}})
.disableCors(true)
...
.interval(10.0))
.tickEvery(300L))
.tags(new ArrayList<String>() {{add("testing:browser");}})
