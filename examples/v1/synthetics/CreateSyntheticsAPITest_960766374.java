...
.updatedAt("2020-10-16T09:23:24.857Z")))
.headers(Map.ofEntries(Map.entry("unique", "examplecreateanapihttpwithoauthroptestreturnsokreturnsthecreatedtestdetailsresponse")))
.method("GET")
.timeout(10.0)
...
.resource("resource")
.scope("yoyo")
.tokenApiAuthentication(SyntheticsBasicAuthOauthTokenApiAuthentication.BODY)
...
.monitorName("Example-Create_an_API_HTTP_with_oauth_rop_test_returns_OK_Returns_the_created_test_details_response")
.monitorPriority(5)
