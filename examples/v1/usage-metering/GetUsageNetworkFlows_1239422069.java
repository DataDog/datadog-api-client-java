...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageNetworkFlowsResponse result = apiInstance.getUsageNetworkFlows(OffsetDateTime.now().plusDays(-5),new GetUsageNetworkFlowsOptionalParameters().endHr(OffsetDateTime.now().plusDays(-3)));
