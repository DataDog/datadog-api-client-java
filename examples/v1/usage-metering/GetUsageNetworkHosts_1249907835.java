...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageNetworkHostsResponse result = apiInstance.getUsageNetworkHosts(OffsetDateTime.now().plusDays(-5),new GetUsageNetworkHostsOptionalParameters().endHr(OffsetDateTime.now().plusDays(-3)));
