...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageProfilingResponse result = apiInstance.getUsageProfiling(OffsetDateTime.now().plusDays(-5),new GetUsageProfilingOptionalParameters().endHr(OffsetDateTime.now().plusDays(-3)));
