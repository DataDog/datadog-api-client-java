...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageAnalyzedLogsResponse result = apiInstance.getUsageAnalyzedLogs(OffsetDateTime.now().plusDays(-5),new GetUsageAnalyzedLogsOptionalParameters().endHr(OffsetDateTime.now().plusDays(-3)));
