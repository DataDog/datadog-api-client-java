                                ...
                                Arrays.asList(
                                    new LogsSchemaMapper(
                                        new LogsSchemaCategoryMapper()
                                            ...
                                            .categories(
                                                Arrays.asList(
                                                    new LogsSchemaCategoryMapperCategory()
                                                        .filter(
                                                            new LogsFilter()
                                                    ...
                                                    new LogsSchemaCategoryMapperCategory()
                                                        .filter(
                                                            new LogsFilter().query("@eventName:*"))
                                                        .name("Other")
                                                        .id(99L)))
                                            .targets(
                                                new LogsSchemaCategoryMapperTargets()
                                                    .name("ocsf.activity_name")
                                                    .id("ocsf.activity_id"))
                                            .fallback(
                                                new LogsSchemaCategoryMapperFallback()
                                                    .values(
                                                        Map.ofEntries(
                                                            Map.entry("ocsf.activity_id", "99"),
                                                            Map.entry(
                                        ...
                                        new LogsSchemaCategoryMapper()
                                            ...
                                            .categories(
                                                Arrays.asList(
                                                    new LogsSchemaCategoryMapperCategory()
                                                        .filter(
                                                            new LogsFilter().query("-@errorCode:*"))
                                                        .id(1L)
                                                        .name("Success"),
                                                    new LogsSchemaCategoryMapperCategory()
                                                        .filter(
