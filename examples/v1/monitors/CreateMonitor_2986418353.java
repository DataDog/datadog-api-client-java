...
import com.datadog.api.client.v1.model.MonitorFormulaAndFunctionDataQualityDiffType;
import com.datadog.api.client.v1.model.MonitorFormulaAndFunctionDataQualityEntityMetricConfig;
import com.datadog.api.client.v1.model.MonitorFormulaAndFunctionDataQualityMonitorOptions;
import com.datadog.api.client.v1.model.MonitorFormulaAndFunctionDataQualityQueryDefinition;
import com.datadog.api.client.v1.model.MonitorFormulaAndFunctionDataQualitySourceToTargetConfig;
                        ...
                        Collections.singletonList(
                            new MonitorFormulaAndFunctionQueryDefinition(
                                new MonitorFormulaAndFunctionDataQualityQueryDefinition()
                                    ...
                                    .monitorOptions(
                                        new MonitorFormulaAndFunctionDataQualityMonitorOptions()
                                            .sourceToTargetConfig(
                                                new MonitorFormulaAndFunctionDataQualitySourceToTargetConfig()
                                                    .source(
                                                        new MonitorFormulaAndFunctionDataQualityEntityMetricConfig()
