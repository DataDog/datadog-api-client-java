...
.dataSource(MonitorFormulaAndFunctionAggregateFilteredDataSource.AGGREGATE_FILTERED_QUERY)
.name("query1")
...
.filterQuery(new MonitorFormulaAndFunctionAggregateFilterQuery(
...
.name("cluster_name")))))
.filters(Collections.singletonList(new MonitorFormulaAndFunctionAggregateQueryFilter()
