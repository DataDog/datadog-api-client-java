...
.cells(Arrays.asList(new NotebookCellCreateRequest()
...
.type(NotebookCellResourceType.NOTEBOOK_CELLS), new NotebookCellCreateRequest()
.attributes(new NotebookCellCreateRequestAttributes(
...
.q("avg:system.load.1{*}")
.style(new TimeseriesRequestStyle()
