...
public class Example {
  public static void main(String[] args) {
    ...
    UsageAttributionSort sortName =
        UsageAttributionSort.fromValue(
            "api_percentage"); // UsageAttributionSort | The field to sort by.
    Boolean includeDescendants =
        false; // Boolean | Include child org usage in the response. Defaults to false.
