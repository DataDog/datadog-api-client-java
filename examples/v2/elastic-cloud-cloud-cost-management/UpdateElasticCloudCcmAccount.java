...
import com.datadog.api.client.v2.model.ElasticCloudCcmAccountUpdateAttributes;
import com.datadog.api.client.v2.model.ElasticCloudCcmAccountUpdateData;
...
import com.datadog.api.client.v2.model.ElasticCloudCcmSettingsUpdate;
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.updateElasticCloudCcmAccount", true);
    ElasticCloudCloudCostManagementApi apiInstance =
        new ElasticCloudCloudCostManagementApi(defaultClient);

    ElasticCloudCcmAccountUpdateRequest body =
        new ElasticCloudCcmAccountUpdateRequest()
            .data(
                new ElasticCloudCcmAccountUpdateData()
                    .attributes(
                        new ElasticCloudCcmAccountUpdateAttributes()
                            .authentication(
                            ...
                            .settings(
                                new ElasticCloudCcmSettingsUpdate().elasticOrgId("2079364244")))
                    .type(IntegrationAccountType.INTEGRATION_ACCOUNT));

    try {
      ElasticCloudCcmAccountResponse result =
          apiInstance.updateElasticCloudCcmAccount("account_id", body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling ElasticCloudCloudCostManagementApi#updateElasticCloudCcmAccount");
