...
public class Example {
  public static void main(String[] args) {
    ...
    QueryAccountRequest body = new QueryAccountRequest()
.data(new QueryAccountRequestData()
.attributes(new QueryAccountRequestDataAttributes()
.limit(20L)
.query("plan_type:enterprise AND user_count:>100 AND subscription_status:active")
.selectColumns(Arrays.asList("account_id", "account_name", "user_count", "plan_type", "subscription_status", "created_at", "mrr", "industry"))
.sort(new QueryAccountRequestDataAttributesSort()
.field("user_count")
.order("DESC"))
