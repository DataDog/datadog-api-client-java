...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateConnectionRequest body = new UpdateConnectionRequest()
.data(new UpdateConnectionRequestData()
.attributes(new UpdateConnectionRequestDataAttributes()
.fieldsToAdd(Collections.singletonList(new CreateConnectionRequestDataAttributesFieldsItems()
...
.fieldsToUpdate(Collections.singletonList(new UpdateConnectionRequestDataAttributesFieldsToUpdateItems()
