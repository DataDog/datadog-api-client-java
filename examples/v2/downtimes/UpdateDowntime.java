...
import com.datadog.api.client.v2.model.DowntimeAttributeEditRequest;
import com.datadog.api.client.v2.model.DowntimeEditData;
...
public class Example {
  public static void main(String[] args) {
    ...
    DowntimeEditRequest body =
        new DowntimeEditRequest()
            .data(
                new DowntimeEditData()
                    .attributes(new DowntimeAttributeEditRequest().message("light speed"))
