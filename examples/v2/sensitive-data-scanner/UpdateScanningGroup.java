...
public class Example {
  public static void main(String[] args) {
    ...
    SensitiveDataScannerGroupUpdateRequest body = new SensitiveDataScannerGroupUpdateRequest()
.meta(new SensitiveDataScannerMetaVersionOnly())
.data(new SensitiveDataScannerGroupUpdate()
.id(GROUP_DATA_ID)
...
.rules(new SensitiveDataScannerRuleData())));
    ...
    try {
      SensitiveDataScannerGroupUpdateResponse result = apiInstance.updateScanningGroup(GROUP_DATA_ID, body);
