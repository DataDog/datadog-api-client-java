...
public class Example {
  public static void main(String[] args) {
    ...
    RumMetricCreateRequest body = new RumMetricCreateRequest()
.data(new RumMetricCreateData()
.attributes(new RumMetricCreateAttributes()
.compute(new RumMetricCompute()
...
.uniqueness(new RumMetricUniqueness()
