...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      OrgAuthorizedClientsResponse result = apiInstance.listOrgAuthorizedClients();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrgAuthorizedClientsApi#listOrgAuthorizedClients");
