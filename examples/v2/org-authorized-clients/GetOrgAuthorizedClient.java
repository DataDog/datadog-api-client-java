  ...
  public static void main(String[] args) {
    ...
    try {
      OrgAuthorizedClientResponse result =
          apiInstance.getOrgAuthorizedClient("00000000-0000-0000-0000-000000000001");
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OrgAuthorizedClientsApi#getOrgAuthorizedClient");
