...
import com.datadog.api.client.v2.model.ProductAnalyticsFormulaJourneyQuery;
import com.datadog.api.client.v2.model.ProductAnalyticsFormulaJourneyRequest;
import com.datadog.api.client.v2.model.ProductAnalyticsFormulaJourneyRequestAttributes;
import com.datadog.api.client.v2.model.ProductAnalyticsFormulaJourneyRequestData;
import com.datadog.api.client.v2.model.ProductAnalyticsFormulaJourneyRequestType;
import com.datadog.api.client.v2.model.ProductAnalyticsGraphQueryCompute;
...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.queryProductAnalyticsJourneyTimeseries", true);
    ProductAnalyticsApi apiInstance = new ProductAnalyticsApi(defaultClient);

    ProductAnalyticsFormulaJourneyRequest body =
        new ProductAnalyticsFormulaJourneyRequest()
            .data(
                new ProductAnalyticsFormulaJourneyRequestData()
                    .attributes(
                        new ProductAnalyticsFormulaJourneyRequestAttributes()
                            .from(1756425600000L)
                            .query(
                                new ProductAnalyticsFormulaJourneyQuery()
                                    .compute(
                                        new ProductAnalyticsGraphQueryCompute()
                                            .aggregation("count")
                                            .target(
    ...
    try {
      ProductAnalyticsJourneyTimeseriesResponse result =
          apiInstance.queryProductAnalyticsJourneyTimeseries(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling ProductAnalyticsApi#queryProductAnalyticsJourneyTimeseries");
