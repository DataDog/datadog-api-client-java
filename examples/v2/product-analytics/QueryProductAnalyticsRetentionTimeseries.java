...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ProductAnalyticsTimeseriesResponse result =
          apiInstance.queryProductAnalyticsRetentionTimeseries(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling ProductAnalyticsApi#queryProductAnalyticsRetentionTimeseries");
