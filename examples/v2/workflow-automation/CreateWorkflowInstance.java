...
public class Example {
  public static void main(String[] args) {
    ...
    WorkflowInstanceCreateRequest body = new WorkflowInstanceCreateRequest()
.meta(new WorkflowInstanceCreateMeta()
.payload(Map.ofEntries(Map.entry("input", "value"))));

    try {
      WorkflowInstanceCreateResponse result = apiInstance.createWorkflowInstance("ccf73164-1998-4785-a7a3-8d06c7e5f558", body);
