...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FleetDeploymentsV2Response result = apiInstance.listFleetDeploymentsV2();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FleetAutomationApi#listFleetDeploymentsV2");
