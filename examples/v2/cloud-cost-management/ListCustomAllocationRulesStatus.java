...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.listCustomAllocationRulesStatus", true);
    CloudCostManagementApi apiInstance = new CloudCostManagementApi(defaultClient);

    try {
      CustomAllocationRuleStatusResponse result = apiInstance.listCustomAllocationRulesStatus();
