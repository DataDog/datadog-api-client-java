...
public class Example {
  public static void main(String[] args) {
    ...
    BudgetValidationRequest body = new BudgetValidationRequest()
.data(new BudgetValidationRequestData()
.attributes(new BudgetWithEntriesDataAttributes()
.createdAt(1738258683590L)
.createdBy("00000000-0a0a-0a0a-aaa0-00000000000a")
.endMonth(202502L)
.entries(Arrays.asList(new BudgetWithEntriesDataAttributesEntriesItems()
.amount(500.0)
.month(202501L)
.tagFilters(Collections.singletonList(new BudgetWithEntriesDataAttributesEntriesItemsTagFiltersItems()
.tagKey("service")
.tagValue("ec2"))), new BudgetWithEntriesDataAttributesEntriesItems()
.amount(500.0)
.month(202502L)
.tagFilters(Collections.singletonList(new BudgetWithEntriesDataAttributesEntriesItemsTagFiltersItems()
.tagKey("service")
