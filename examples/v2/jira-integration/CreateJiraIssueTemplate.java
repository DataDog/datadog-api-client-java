...
public class Example {
  public static void main(String[] args) {
    ...
    JiraIssueTemplateCreateRequest body = new JiraIssueTemplateCreateRequest()
.data(new JiraIssueTemplateCreateRequestData()
.attributes(new JiraIssueTemplateCreateRequestAttributes()
.fields(Map.ofEntries(Map.entry("description", "{'payload': 'Test', 'type': 'json'}")))
.issueTypeId("12730")
.jiraAccount(new JiraIssueTemplateCreateRequestAttributesJiraAccount()
