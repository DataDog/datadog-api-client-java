...
public class Example {
  public static void main(String[] args) {
    ...
    JiraIssueTemplateUpdateRequest body = new JiraIssueTemplateUpdateRequest()
.data(new JiraIssueTemplateUpdateRequestData()
.attributes(new JiraIssueTemplateUpdateRequestAttributes()
.fields(Map.ofEntries(Map.entry("description", "{'payload': 'Updated Description', 'type': 'json'}")))
.name("test_template_updated"))
.type(JiraIssueTemplateType.JIRA_ISSUE_TEMPLATE));

    try {
      JiraIssueTemplateResponse result = apiInstance.updateJiraIssueTemplate(UUID.fromString("65b3341b-0680-47f9-a6d4-134db45c603e"), body);
