...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.submitStixThreatIntel", true);
    ...
    try {
      STIXIngestResponse result = apiInstance.submitStixThreatIntel("Acme-Inc", body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ThreatIntelligenceApi#submitStixThreatIntel");
