...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.getAWSMetricNameFilterPreview", true);
    AwsIntegrationApi apiInstance = new AwsIntegrationApi(defaultClient);

    try {
      AWSMetricNameFilterPreviewResponse result =
          apiInstance.getAWSMetricNameFilterPreview("aws_account_config_id");
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AwsIntegrationApi#getAWSMetricNameFilterPreview");
