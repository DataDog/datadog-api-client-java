...
public class Example {
  public static void main(String[] args) {
    ...
    CreateMaintenanceRequest body = new CreateMaintenanceRequest()
.data(new CreateMaintenanceRequestData()
.attributes(new CreateMaintenanceRequestDataAttributes()
...
.type(PatchMaintenanceRequestDataType.MAINTENANCES));
    ...
    try {
      Maintenance result = apiInstance.createMaintenance(UUID.fromString("9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d"), body);
