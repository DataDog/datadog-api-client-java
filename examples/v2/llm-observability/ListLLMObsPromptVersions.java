  ...
  public static void main(String[] args) {
    ...
    try {
      LLMObsPromptVersionsResponse result =
          apiInstance.listLLMObsPromptVersions(PROMPT_DATA_ATTRIBUTES_PROMPT_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling LlmObservabilityApi#listLLMObsPromptVersions");
