...
public class Example {
  public static void main(String[] args) {
    ...
    LLMObsExperimentUpdateRequest body = new LLMObsExperimentUpdateRequest()
.data(new LLMObsExperimentUpdateDataRequest()
.attributes(new LLMObsExperimentUpdateDataAttributesRequest())
.type(LLMObsExperimentType.EXPERIMENTS));

    try {
      LLMObsExperimentResponse result = apiInstance.updateLLMObsExperiment("3fd6b5e0-8910-4b1c-a7d0-5b84de329012", body);
