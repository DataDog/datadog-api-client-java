...
public class Example {
  public static void main(String[] args) {
    ...
    LLMObsDatasetRecordsRequest body = new LLMObsDatasetRecordsRequest()
.data(new LLMObsDatasetRecordsDataRequest()
.attributes(new LLMObsDatasetRecordsDataAttributesRequest()
.records(Collections.singletonList(new LLMObsDatasetRecordItem()
.expectedOutput(null)
.input(null))))
.type(LLMObsRecordType.RECORDS));

    try {
      LLMObsDatasetRecordsMutationResponse result = apiInstance.createLLMObsDatasetRecords("a33671aa-24fd-4dcd-9b33-a8ec7dde7751", "9f64e5c7-dc5a-45c8-a17c-1b85f0bec97d", body);
