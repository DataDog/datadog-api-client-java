...
public class Example {
  public static void main(String[] args) {
    ...
    LLMObsExperimentEventsRequest body = new LLMObsExperimentEventsRequest()
.data(new LLMObsExperimentEventsDataRequest()
.attributes(new LLMObsExperimentEventsDataAttributesRequest()
.metrics(Collections.singletonList(new LLMObsExperimentMetric()
...
.meta(new LLMObsExperimentSpanMeta()
