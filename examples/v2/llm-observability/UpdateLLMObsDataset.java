...
public class Example {
  public static void main(String[] args) {
    ...
    LLMObsDatasetUpdateRequest body = new LLMObsDatasetUpdateRequest()
.data(new LLMObsDatasetUpdateDataRequest()
.attributes(new LLMObsDatasetUpdateDataAttributesRequest())
.type(LLMObsDatasetType.DATASETS));

    try {
      LLMObsDatasetResponse result = apiInstance.updateLLMObsDataset("a33671aa-24fd-4dcd-9b33-a8ec7dde7751", "9f64e5c7-dc5a-45c8-a17c-1b85f0bec97d", body);
