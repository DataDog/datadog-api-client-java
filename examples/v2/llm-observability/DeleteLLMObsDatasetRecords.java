...
public class Example {
  public static void main(String[] args) {
    ...
    LLMObsDeleteDatasetRecordsRequest body = new LLMObsDeleteDatasetRecordsRequest()
.data(new LLMObsDeleteDatasetRecordsDataRequest()
.attributes(new LLMObsDeleteDatasetRecordsDataAttributesRequest()
.recordIds(Collections.singletonList("rec-7c3f5a1b-9e2d-4f8a-b1c6-3d7e9f0a2b4c")))
.type(LLMObsRecordType.RECORDS));

    try {
      apiInstance.deleteLLMObsDatasetRecords("a33671aa-24fd-4dcd-9b33-a8ec7dde7751", "9f64e5c7-dc5a-45c8-a17c-1b85f0bec97d", body);
