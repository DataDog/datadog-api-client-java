...
public class Example {
  public static void main(String[] args) {
    ...
    CaseNotificationRuleUpdateRequest body = new CaseNotificationRuleUpdateRequest()
.data(new CaseNotificationRuleUpdate()
.attributes(new CaseNotificationRuleAttributes()
...
.type(CaseNotificationRuleResourceType.NOTIFICATION_RULE));
    ...
    try {
      apiInstance.updateProjectNotificationRule("e555e290-ed65-49bd-ae18-8acbfcf18db7", "e555e290-ed65-49bd-ae18-8acbfcf18db7", body);
