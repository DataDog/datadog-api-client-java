...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.listModelLabProjectFacetValues", true);
    ModelLabApiApi apiInstance = new ModelLabApiApi(defaultClient);

    try {
      ModelLabFacetValuesResponse result =
          apiInstance.listModelLabProjectFacetValues(ModelLabProjectFacetType.TAG, "model");
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ModelLabApiApi#listModelLabProjectFacetValues");
