...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.deleteTwilioAccount", true);
    TwilioIntegrationAccountsApi apiInstance = new TwilioIntegrationAccountsApi(defaultClient);

    try {
      apiInstance.deleteTwilioAccount("account_id");
    } catch (ApiException e) {
      System.err.println("Exception when calling TwilioIntegrationAccountsApi#deleteTwilioAccount");
