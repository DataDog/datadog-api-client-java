...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.getTwilioIntegrationAccount", true);
    ...
    try {
      TwilioIntegrationAccountResponse result =
          apiInstance.getTwilioIntegrationAccount(TwilioInterfaceType.TWILIO, "account_id");
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling TwilioIntegrationAccountsApi#getTwilioIntegrationAccount");
