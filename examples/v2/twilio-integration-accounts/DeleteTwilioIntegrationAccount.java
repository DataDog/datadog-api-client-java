...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteTwilioIntegrationAccount(TwilioInterfaceType.TWILIO, "account_id");
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling TwilioIntegrationAccountsApi#deleteTwilioIntegrationAccount");
