...
public class Example {
  public static void main(String[] args) {
    ...
    String OPSGENIE_SERVICE_DATA_ATTRIBUTES_NAME = System.getenv("OPSGENIE_SERVICE_DATA_ATTRIBUTES_NAME");
    String OPSGENIE_SERVICE_DATA_ID = System.getenv("OPSGENIE_SERVICE_DATA_ID");

    OpsgenieServiceUpdateRequest body = new OpsgenieServiceUpdateRequest()
.data(new OpsgenieServiceUpdateData()
.attributes(new OpsgenieServiceUpdateAttributes()
...
.type(OpsgenieServiceType.OPSGENIE_SERVICE));
    ...
    try {
      OpsgenieServiceResponse result = apiInstance.updateOpsgenieService(OPSGENIE_SERVICE_DATA_ID, body);
