...
public class Example {
  public static void main(String[] args) {
    ...
    DeletedTestsRequestDeleteRequest body = new DeletedTestsRequestDeleteRequest()
.data(new DeletedTestsRequestDelete()
.attributes(new DeletedTestsRequestDeleteAttributes()
