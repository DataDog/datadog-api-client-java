...
public class Example {
  public static void main(String[] args) {
    ...
    FastlyAccountCreateRequest body = new FastlyAccountCreateRequest()
.data(new FastlyAccountCreateRequestData()
.attributes(new FastlyAccountCreateRequestAttributes()
