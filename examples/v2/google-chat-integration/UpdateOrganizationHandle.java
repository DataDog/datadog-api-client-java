...
public class Example {
  public static void main(String[] args) {
    ...
    String ORGANIZATION_HANDLE_DATA_ATTRIBUTES_NAME = System.getenv("ORGANIZATION_HANDLE_DATA_ATTRIBUTES_NAME");
    String ORGANIZATION_HANDLE_DATA_ID = System.getenv("ORGANIZATION_HANDLE_DATA_ID");

    GoogleChatUpdateOrganizationHandleRequest body = new GoogleChatUpdateOrganizationHandleRequest()
.data(new GoogleChatUpdateOrganizationHandleRequestData()
.attributes(new GoogleChatUpdateOrganizationHandleRequestAttributes()
.name("fake-handle-name--updated")))
.type(GoogleChatOrganizationHandleType.GOOGLE_CHAT_ORGANIZATION_HANDLE_TYPE);

    try {
      GoogleChatOrganizationHandleResponse result = apiInstance.updateOrganizationHandle("e54cb570-c674-529c-769d-84b312288ed7", ORGANIZATION_HANDLE_DATA_ID, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling GoogleChatIntegrationApi#updateOrganizationHandle");
