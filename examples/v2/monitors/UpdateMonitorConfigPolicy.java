...
public class Example {
  public static void main(String[] args) {
    ...
    MonitorConfigPolicyEditRequest body = new MonitorConfigPolicyEditRequest()
.data(new MonitorConfigPolicyEditData()
.attributes(new MonitorConfigPolicyAttributeEditRequest()
.policy(new MonitorConfigPolicyPolicy(
...
.type(MonitorConfigPolicyResourceType.MONITOR_CONFIG_POLICY));
    ...
    try {
      MonitorConfigPolicyResponse result = apiInstance.updateMonitorConfigPolicy(MONITOR_CONFIGURATION_POLICY_DATA_ID, body);
