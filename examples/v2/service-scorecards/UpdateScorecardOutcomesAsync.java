...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateOutcomesAsyncRequest body = new UpdateOutcomesAsyncRequest()
.data(new UpdateOutcomesAsyncRequestData()
.attributes(new UpdateOutcomesAsyncAttributes()
.results(Collections.singletonList(new UpdateOutcomesAsyncRequestItem()
...
.type(UpdateOutcomesAsyncType.BATCHED_OUTCOME));
    ...
    try {
      ...
      System.err.println("Exception when calling ServiceScorecardsApi#updateScorecardOutcomesAsync");
