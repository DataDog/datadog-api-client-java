...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CostByOrgResponse result = apiInstance.getEstimatedCostByOrg("sub-org",new GetEstimatedCostByOrgOptionalParameters().startMonth(OffsetDateTime.now().plusDays(-5)));
