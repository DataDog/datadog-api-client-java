...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MonthlyCostAttributionResponse result = apiInstance.getMonthlyCostAttribution(OffsetDateTime.now().plusDays(-5), OffsetDateTime.now().plusDays(-3), "infra_host_total_cost");
