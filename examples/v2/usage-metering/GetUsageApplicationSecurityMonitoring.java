...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      UsageApplicationSecurityMonitoringResponse result = apiInstance.getUsageApplicationSecurityMonitoring(OffsetDateTime.parse("2021-11-11T11:11:11.111+00:00"));
