...
public class Example {
  public static void main(String[] args) {
    ...
    UpdateCustomFrameworkRequest body = new UpdateCustomFrameworkRequest()
...
.rulesId(Collections.singletonList("def-000-be9"))))))));
    ...
    try {
      UpdateCustomFrameworkResponse result = apiInstance.updateCustomFramework("create-framework-new", "10", body);
