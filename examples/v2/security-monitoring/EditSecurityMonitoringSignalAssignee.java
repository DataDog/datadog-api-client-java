...
public class Example {
  public static void main(String[] args) {
    ...
    SecurityMonitoringSignalAssigneeUpdateRequest body = new SecurityMonitoringSignalAssigneeUpdateRequest()
...
.uuid(""))));
    ...
    try {
      SecurityMonitoringSignalTriageUpdateResponse result = apiInstance.editSecurityMonitoringSignalAssignee("AQAAAYG1bl5K4HuUewAAAABBWUcxYmw1S0FBQmt2RmhRN0V4ZUVnQUE", body);
