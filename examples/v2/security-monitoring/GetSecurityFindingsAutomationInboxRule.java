...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.getSecurityFindingsAutomationInboxRule", true);
    ...
    try {
      InboxRuleResponse result =
          apiInstance.getSecurityFindingsAutomationInboxRule(VALID_INBOX_RULE_DATA_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling SecurityMonitoringApi#getSecurityFindingsAutomationInboxRule");
