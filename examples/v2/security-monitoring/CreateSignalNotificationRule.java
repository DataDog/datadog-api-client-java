...
public class Example {
  public static void main(String[] args) {
    ...
    CreateNotificationRuleParameters body = new CreateNotificationRuleParameters()
.data(new CreateNotificationRuleParametersData()
.attributes(new CreateNotificationRuleParametersDataAttributes()
.enabled(true)
.name("Rule 1")
