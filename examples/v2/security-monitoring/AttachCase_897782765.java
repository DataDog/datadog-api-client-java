...
public class Example {
  public static void main(String[] args) {
    ...
    AttachCaseRequest body = new AttachCaseRequest()
.data(new AttachCaseRequestData()
.id("7d16945b-baf8-411e-ab2a-20fe43af1ea3")
.relationships(new AttachCaseRequestDataRelationships()
...
.type(CaseDataType.CASES));
    ...
    try {
      FindingCaseResponse result = apiInstance.attachCase("7d16945b-baf8-411e-ab2a-20fe43af1ea3", body);
