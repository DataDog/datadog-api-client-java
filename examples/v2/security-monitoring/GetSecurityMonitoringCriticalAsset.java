...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SecurityMonitoringCriticalAssetResponse result = apiInstance.getSecurityMonitoringCriticalAsset(CRITICAL_ASSET_DATA_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SecurityMonitoringApi#getSecurityMonitoringCriticalAsset");
