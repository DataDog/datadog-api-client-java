...
import com.datadog.api.v2.client.model.SecurityMonitoringRuleThirdPartyOptions;
import java.time.*;
import java.util.*;
  ...
  public static void main(String[] args) {
    ...
    SecurityMonitoringRuleCreatePayload body =
        new SecurityMonitoringRuleCreatePayload()
            .name(
                "Example-Create_a_detection_rule_with_detection_method_third_party_returns_OK_response")
            .queries(
                ...
                new SecurityMonitoringRuleOptions()
                    ...
                    .thirdPartyRuleOptions(
                        new SecurityMonitoringRuleThirdPartyOptions()
                            .rootQuery("@pop")
                            .defaultStatus(SecurityMonitoringRuleSeverity.LOW)))
            .message(
                "Example-Create_a_detection_rule_with_detection_method_third_party_returns_OK_response"
                    + " message")
            .tags(
