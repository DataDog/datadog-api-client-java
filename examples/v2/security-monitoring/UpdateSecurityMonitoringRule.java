...
import com.datadog.api.client.v2.model.SecurityMonitoringRuleImpossibleTravelOptionsBaselineUserLocations;
...
.filters(Collections.singletonList(new SecurityMonitoringFilter()
...
.impossibleTravelOptions(new SecurityMonitoringRuleImpossibleTravelOptions()
...
.learningDuration(SecurityMonitoringRuleNewValueOptionsLearningDuration.ZERO_DAYS)
...
.version(1);
    ...
    try {
      SecurityMonitoringRuleResponse result = apiInstance.updateSecurityMonitoringRule("rule_id", body);
