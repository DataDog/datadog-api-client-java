...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SecurityMonitoringPaginatedSuppressionsResponse result = apiInstance.listSecurityMonitoringSuppressions(new ListSecurityMonitoringSuppressionsOptionalParameters().sort(SecurityMonitoringSuppressionSort.NAME).query("id:3dd-0uc-h1s OR id:886e6c3e-e543-049c-ee1b-56a1110295c0"));
