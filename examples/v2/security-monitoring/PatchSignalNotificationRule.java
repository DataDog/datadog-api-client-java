...
import com.datadog.api.client.v2.model.Enabled;
...
import com.datadog.api.client.v2.model.TimeAggregation;
import com.datadog.api.client.v2.model.TriggerSource;
import com.datadog.api.client.v2.model.Version;
import java.io.File;
...
public class Example {
  public static void main(String[] args) {
    ...
    String VALID_SIGNAL_NOTIFICATION_RULE_DATA_ID = System.getenv("VALID_SIGNAL_NOTIFICATION_RULE_DATA_ID");

    PatchNotificationRuleParameters body = new PatchNotificationRuleParameters()
.data(new PatchNotificationRuleParametersData()
.attributes(new PatchNotificationRuleParametersDataAttributes()
.enabled(true)
.name("Rule 1")
.selectors(new Selectors()
.query("(source:production_service OR env:prod)")
.ruleTypes(Arrays.asList(RuleTypesItems.MISCONFIGURATION, RuleTypesItems.ATTACK_PATH))
...
.type(NotificationRulesType.NOTIFICATION_RULES));
    ...
    try {
      NotificationRuleResponse result = apiInstance.patchSignalNotificationRule(VALID_SIGNAL_NOTIFICATION_RULE_DATA_ID, body);
