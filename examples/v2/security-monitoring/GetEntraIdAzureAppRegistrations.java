...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      SecurityMonitoringEntraIdAzureAppRegistrationsResponse result =
          apiInstance.getEntraIdAzureAppRegistrations();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling SecurityMonitoringApi#getEntraIdAzureAppRegistrations");
