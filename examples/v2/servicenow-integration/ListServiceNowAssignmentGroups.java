...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ServiceNowAssignmentGroupsResponse result = apiInstance.listServiceNowAssignmentGroups(UUID.fromString("65b3341b-0680-47f9-a6d4-134db45c603e"));
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ServiceNowIntegrationApi#listServiceNowAssignmentGroups");
