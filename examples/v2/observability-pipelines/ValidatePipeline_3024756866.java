...
.mapping(Arrays.asList(new ObservabilityPipelineOcsfMappingCustomFieldMapping()
._default("")
.dest("time")
.source("timestamp"), new ObservabilityPipelineOcsfMappingCustomFieldMapping()
._default("")
.dest("severity")
.source("level"), new ObservabilityPipelineOcsfMappingCustomFieldMapping()
._default("")
.dest("device.type")
.lookup(new ObservabilityPipelineOcsfMappingCustomLookup()
.table(Collections.singletonList(new ObservabilityPipelineOcsfMappingCustomLookupTableEntry()
.contains("Desktop")
.value("desktop"))))
.source("host.type")))
.metadata(new ObservabilityPipelineOcsfMappingCustomMetadata()
._class("Device Inventory Info")
.profiles(Collections.singletonList("container"))
.version("1.3.0"))
.version(1L)))))
