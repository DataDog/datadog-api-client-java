// Validate an observability pipeline with Splunk TCP source max_connection_duration_secs returns
// "OK" response
...
import com.datadog.api.client.v2.model.ObservabilityPipelineSplunkTcpSource;
import com.datadog.api.client.v2.model.ObservabilityPipelineSplunkTcpSourceType;
                                    ...
                                    .processorGroups(
                                        Collections.singletonList(
                                            new ObservabilityPipelineConfigProcessorGroup()
                                                ...
                                                .inputs(
                                                    Collections.singletonList("splunk-tcp-source"))
                                                .processors(
                                                    Collections.singletonList(
                                    ...
                                    .sources(
                                        Collections.singletonList(
                                            new ObservabilityPipelineConfigSourceItem(
                                                new ObservabilityPipelineSplunkTcpSource()
                                                    .id("splunk-tcp-source")
                                                    .type(
                                                        ObservabilityPipelineSplunkTcpSourceType
                                                            .SPLUNK_TCP)
                                                    .maxConnectionDurationSecs(3600L)))))
