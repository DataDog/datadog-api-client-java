...
.accessDetails(new CreateTableRequestDataAttributesFileMetadataOneOfAccessDetails()
...
.azureDetail(new CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail()
...
.gcpDetail(new CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail()
...
.fields(Collections.singletonList(new CreateTableRequestDataAttributesSchemaFieldsItems()
.name("field_1")
