...
public class Example {
  public static void main(String[] args) {
    ...
    ApplicationSecurityWafExclusionFilterUpdateRequest body = new ApplicationSecurityWafExclusionFilterUpdateRequest()
.data(new ApplicationSecurityWafExclusionFilterUpdateData()
.attributes(new ApplicationSecurityWafExclusionFilterUpdateAttributes()
...
.type(ApplicationSecurityWafExclusionFilterType.EXCLUSION_FILTER));
    ...
    try {
      ApplicationSecurityWafExclusionFilterResponse result = apiInstance.updateApplicationSecurityWafExclusionFilter(EXCLUSION_FILTER_DATA_ID, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ApplicationSecurityApi#updateApplicationSecurityWafExclusionFilter");
