  ...
  public static void main(String[] args) {
    ...
    try {
      ApplicationSecurityExclusionFilterResponse result =
          apiInstance.getApplicationSecurityExclusionFilter("exclusion_filter_id");
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling ApplicationSecurityApi#getApplicationSecurityExclusionFilter");
