...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      apiInstance.deleteApplicationSecurityExclusionFilter("exclusion_filter_id");
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling ApplicationSecurityApi#deleteApplicationSecurityExclusionFilter");
