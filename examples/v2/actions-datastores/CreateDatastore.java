...
public class Example {
  public static void main(String[] args) {
    ...
    CreateAppsDatastoreRequest body = new CreateAppsDatastoreRequest()
.data(new CreateAppsDatastoreRequestData()
.attributes(new CreateAppsDatastoreRequestDataAttributes()
.name("datastore-name")
