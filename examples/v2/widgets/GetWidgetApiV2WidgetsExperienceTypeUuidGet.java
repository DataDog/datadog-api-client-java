...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      WidgetSchemaJSONAPIDocument result = apiInstance.getWidgetApiV2WidgetsExperienceTypeUuidGet(UUID.fromString("9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d"), WidgetExperienceType.CCM_REPORTS);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WidgetsApi#getWidgetApiV2WidgetsExperienceTypeUuidGet");
