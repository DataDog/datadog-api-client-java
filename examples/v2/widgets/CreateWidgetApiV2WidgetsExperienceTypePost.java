...
.meta(null);
    ...
    try {
      WidgetSchemaJSONAPIDocument result = apiInstance.createWidgetApiV2WidgetsExperienceTypePost(WidgetExperienceType.CCM_REPORTS, body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WidgetsApi#createWidgetApiV2WidgetsExperienceTypePost");
