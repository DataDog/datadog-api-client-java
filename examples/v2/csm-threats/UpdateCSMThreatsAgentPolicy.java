...
.data(new CloudWorkloadSecurityAgentPolicyUpdateData()
.attributes(new CloudWorkloadSecurityAgentPolicyUpdateAttributes()
...
.type(CloudWorkloadSecurityAgentPolicyType.POLICY));
    ...
    try {
      CloudWorkloadSecurityAgentPolicyResponse result = apiInstance.updateCSMThreatsAgentPolicy(POLICY_DATA_ID, body);
