...
import com.datadog.api.client.v2.model.CustomDestinationWithId;
...
public class Example {
  public static void main(String[] args) {
    ...
    CustomDestinationUpdatePayload body =
        new CustomDestinationUpdatePayload()
            .data(
                new CustomDestinationWithId()
