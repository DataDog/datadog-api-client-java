...
public class Example {
  public static void main(String[] args) {
    ...
    ChangeRequestUpdateRequest body = new ChangeRequestUpdateRequest()
.data(new ChangeRequestUpdateData()
.attributes(new ChangeRequestUpdateAttributes()
...
.relationships(new ChangeRequestUpdateRelationships()
