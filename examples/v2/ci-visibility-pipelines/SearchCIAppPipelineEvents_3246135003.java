...
public class Example {
  public static void main(String[] args) {
    ...
    CIAppPipelineEventsRequest body = new CIAppPipelineEventsRequest()
...
.sort(CIAppSort.TIMESTAMP_ASCENDING);
    ...
    try {
      PaginationIterable<CIAppPipelineEvent> iterable = apiInstance.searchCIAppPipelineEventsWithPagination(new SearchCIAppPipelineEventsOptionalParameters().body(body));

      for (CIAppPipelineEvent item : iterable) {
       System.out.println(item);
      }
    } catch (RuntimeException e) {
      System.err.println("Exception when calling CiVisibilityPipelinesApi#searchCIAppPipelineEventsWithPagination");
