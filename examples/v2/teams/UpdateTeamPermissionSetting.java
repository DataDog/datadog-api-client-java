...
public class Example {
  public static void main(String[] args) {
    ...
    TeamPermissionSettingUpdateRequest body = new TeamPermissionSettingUpdateRequest()
.data(new TeamPermissionSettingUpdate()
...
.type(TeamPermissionSettingType.TEAM_PERMISSION_SETTINGS));
    ...
    try {
      TeamPermissionSettingResponse result = apiInstance.updateTeamPermissionSetting(DD_TEAM_DATA_ID, "manage_membership", body);
