...
public class Example {
  public static void main(String[] args) {
    ...
    String WORKFLOWS_WEBHOOK_HANDLE_DATA_ATTRIBUTES_NAME = System.getenv("WORKFLOWS_WEBHOOK_HANDLE_DATA_ATTRIBUTES_NAME");
...
.type(MicrosoftTeamsWorkflowsWebhookHandleType.WORKFLOWS_WEBHOOK_HANDLE));
    ...
    try {
      MicrosoftTeamsWorkflowsWebhookHandleResponse result = apiInstance.updateWorkflowsWebhookHandle(WORKFLOWS_WEBHOOK_HANDLE_DATA_ID, body);
