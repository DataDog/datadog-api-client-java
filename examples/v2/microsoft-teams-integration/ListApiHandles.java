...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MicrosoftTeamsApiHandlesResponse result = apiInstance.listApiHandles();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling MicrosoftTeamsIntegrationApi#listApiHandles");
