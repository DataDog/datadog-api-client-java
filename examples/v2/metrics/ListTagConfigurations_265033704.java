...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      MetricsAndMetricTagConfigurationsResponse result = apiInstance.listTagConfigurations(new ListTagConfigurationsOptionalParameters().filterTags("ExampleGetalistofmetricswithatagfilterreturnsSuccessresponse"));
