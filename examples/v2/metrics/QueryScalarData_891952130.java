...
import com.datadog.api.client.v2.model.ContainerDataSource;
import com.datadog.api.client.v2.model.ContainerScalarQuery;
                    ...
                    .attributes(
                        new ScalarFormulaRequestAttributes()
                            ...
                            .queries(
                                Collections.singletonList(
                                    new ScalarQuery(
                                        new ContainerScalarQuery()
                                            .dataSource(ContainerDataSource.CONTAINER)
                                            .name("a")
