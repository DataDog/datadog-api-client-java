...
public class Example {
  public static void main(String[] args) {
    ...
    SnapshotUpdateRequest body = new SnapshotUpdateRequest()
.data(new SnapshotUpdateRequestData()
.attributes(new SnapshotUpdateRequestDataAttributes()
...
.type(SnapshotUpdateRequestDataType.SNAPSHOTS));
    ...
    try {
      Snapshot result = apiInstance.updateReplayHeatmapSnapshot("00000000-0000-0000-0000-000000000001", body);
