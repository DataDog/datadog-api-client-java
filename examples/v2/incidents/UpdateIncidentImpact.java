...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.updateIncidentImpact", true);
    ...
    try {
      IncidentImpactResponse result =
          apiInstance.updateIncidentImpact("incident_id", "impact_id", body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IncidentsApi#updateIncidentImpact");
