  ...
  public static void main(String[] args) {
                        ...
                        .attributes(
                            new IncidentAttachmentUpdateAttributes(
                                new IncidentAttachmentPostmortemAttributes()
                                    .attachment(
                                        new IncidentAttachmentsPostmortemAttributesAttachmentObject()
                                ...
                                new IncidentAttachmentLinkAttributes()
                                    .attachment(
                                        new IncidentAttachmentLinkAttributesAttachmentObject()
                                            .documentUrl(
                                                "https://www.example.com/webstore-failure-runbook")
    ...
    try {
      IncidentAttachmentUpdateResponse result =
          apiInstance.updateIncidentAttachments("incident_id", body);
