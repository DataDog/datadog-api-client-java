...
public class Example {
  public static void main(String[] args) {
    ...
    PostmortemAttachmentRequest body = new PostmortemAttachmentRequest()
.data(new PostmortemAttachmentRequestData()
.attributes(new PostmortemAttachmentRequestAttributes()
.cells(Collections.singletonList(new PostmortemCell()
.attributes(new PostmortemCellAttributes()
.definition(new PostmortemCellDefinition()
.content("""
## Incident Summary
...
.type(IncidentAttachmentType.INCIDENT_ATTACHMENTS));
    ...
    try {
      Attachment result = apiInstance.createIncidentPostmortemAttachment("00000000-0000-0000-0000-000000000000", body);
