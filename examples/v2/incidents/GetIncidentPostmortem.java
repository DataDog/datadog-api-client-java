...
public class Example {
  public static void main(String[] args) {
    ...
    defaultClient.setUnstableOperationEnabled("v2.getIncidentPostmortem", true);
    ...
    try {
      IncidentPostmortemResponse result =
          apiInstance.getIncidentPostmortem(POSTMORTEM_DATA_RELATIONSHIPS_INCIDENT_DATA_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling IncidentsApi#getIncidentPostmortem");
