...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ScheduleOnCallResponders result = apiInstance.getScheduleOnCallResponders(SCHEDULE_DATA_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling OnCallApi#getScheduleOnCallResponders");
