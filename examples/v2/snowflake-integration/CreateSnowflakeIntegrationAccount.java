...
import com.datadog.api.client.v2.model.SnowflakeIntegrationAccountCreateAttributes;
import com.datadog.api.client.v2.model.SnowflakeIntegrationAccountCreateData;
import com.datadog.api.client.v2.model.SnowflakeIntegrationAccountCreateRequest;
import com.datadog.api.client.v2.model.SnowflakeIntegrationAccountPrivateKeyAuthRequest;
...
import com.datadog.api.client.v2.model.SnowflakeIntegrationAccountSettingsRequest;
...
public class Example {
  public static void main(String[] args) {
    ...
    SnowflakeIntegrationAccountCreateRequest body =
        new SnowflakeIntegrationAccountCreateRequest()
            .data(
                new SnowflakeIntegrationAccountCreateData()
                    .attributes(
                        new SnowflakeIntegrationAccountCreateAttributes()
                            .authentication(
                                new SnowflakeIntegrationAccountAuthenticationRequest(
                                    new SnowflakeIntegrationAccountPrivateKeyAuthRequest()
                                        .authType(
...
""")
                            ...
                            .name("prod-snowflake")
                            .settings(
                                new SnowflakeIntegrationAccountSettingsRequest()
    ...
    try {
      SnowflakeIntegrationAccountResponse result =
          apiInstance.createSnowflakeIntegrationAccount(body);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println(
          "Exception when calling SnowflakeIntegrationApi#createSnowflakeIntegrationAccount");
