...
import com.datadog.api.client.v2.model.IDPConfigValueItem;
import java.io.File;
...
public class Example {
  public static void main(String[] args) {
    ...
    IDPConfigRequest body = new IDPConfigRequest()
.data(new IDPConfigRequestData()
.attributes(new IDPConfigRequestAttributes()
.value(Collections.singletonList(Map.ofEntries(Map.entry("displayName", "My Dashboard"),Map.entry("id", "dashboard-1")))))
