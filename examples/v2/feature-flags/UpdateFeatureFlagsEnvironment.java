  ...
  public static void main(String[] args) {
    ...
    UpdateEnvironmentRequest body =
        new UpdateEnvironmentRequest()
            .data(
                new UpdateEnvironmentData()
                    .type(UpdateEnvironmentDataType.ENVIRONMENTS)
                    .attributes(
                        new UpdateEnvironmentAttributes()
                            .name("Updated Test Environment Example-Feature-Flag")
                            .queries(
                                Arrays.asList(
                                    "updated-Example-Feature-Flag", "live-Example-Feature-Flag"))));

    try {
      EnvironmentResponse result =
          apiInstance.updateFeatureFlagsEnvironment(ENVIRONMENT_DATA_ID, body);
