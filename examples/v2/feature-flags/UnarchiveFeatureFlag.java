...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FeatureFlagResponse result = apiInstance.unarchiveFeatureFlag(FEATURE_FLAG_DATA_ID);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling FeatureFlagsApi#unarchiveFeatureFlag");
