...
public class WebhooksIntegrationCustomVariableUpdateRequest {
  ...
  **/
  ...
  @ApiModelProperty(value = "Make custom variable is secret or not. If the custom variable is secret, the value is not returned in the response payload.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "CUSTOM_VARIABLE_NAME", value = "The name of the variable. It corresponds with `<CUSTOM_VARIABLE_NAME>`. It must only contains upper-case characters, integers or underscores.")
