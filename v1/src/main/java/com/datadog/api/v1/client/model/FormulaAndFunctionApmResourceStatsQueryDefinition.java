...
public class FormulaAndFunctionApmResourceStatsQueryDefinition {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "datacenter", value = "Name of the second primary tag used within APM. Required when `primary_tag_value` is specified. See https://docs.datadoghq.com/tracing/guide/setting_primary_tags_to_scope/#add-a-second-primary-tag-in-datadog")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "us-east-az", value = "Value of the second primary tag by which to filter APM data. `primary_tag_name` must also be specified.")
