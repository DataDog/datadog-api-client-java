 ...
 */
@ApiModel(description = "Response containing the audit logs usage for each hour for a given organization.")
@JsonPropertyOrder({
...
public class UsageAuditLogsResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "Get hourly usage for audit logs.")
