...
public class SyntheticsGlobalVariableValue {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "example-value", value = "Value of the global variable. When reading a global variable, the value will not be present if the variable is hidden with the `secure` property.")
