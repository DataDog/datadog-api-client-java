...
> ApiKeyResponse editAPIKey(key, apiKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApiKey apiKey = new ApiKey(); // ApiKey | 
        try {
            ApiKeyResponse result = apiInstance.editAPIKey(key, apiKey);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApplicationKeyResponse editApplicationKey(key, applicationKey)
...
public class Example {
    public static void main(String[] args) {
        ...
        ApplicationKey applicationKey = new ApplicationKey(); // ApplicationKey | 
        try {
            ApplicationKeyResponse result = apiInstance.editApplicationKey(key, applicationKey);
            System.out.println(result);
        } catch (ApiException e) {
