...
private ApiResponse<SecurityMonitoringSignalsListResponse> listSecurityMonitoringSignalsWithHttpInfo(String filterQuery, OffsetDateTime filterFrom, OffsetDateTime filterTo, SecurityMonitoringSignalsSort sort, String pageCursor, Integer pageLimit) throws ApiException {
  ...
  public class APIlistSecurityMonitoringSignalsRequest {
    ...
    /**
     * Set filterQuery
     * @param filterQuery Search query for security signals. (optional)
    ...
    /**
     * Set filterFrom
     * @param filterFrom Minimum timestamp for requested security signals. (optional)
     * @return APIlistSecurityMonitoringSignalsRequest
     */
    ...
    /**
     * Set filterTo
     * @param filterTo Maximum timestamp for requested security signals. (optional)
     * @return APIlistSecurityMonitoringSignalsRequest
     */
    ...
    /**
     * Set sort
     * @param sort Order of security signals in results. (optional)
     * @return APIlistSecurityMonitoringSignalsRequest
     */
    ...
    /**
     * Set pageLimit
     * @param pageLimit Maximum number of security signals in the response. (optional, default to 10)
     * @return APIlistSecurityMonitoringSignalsRequest
     */
