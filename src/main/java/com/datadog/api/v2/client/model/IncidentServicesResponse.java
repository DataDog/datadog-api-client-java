...
public class IncidentServicesResponse {
    ...
    @JsonCreator
    public IncidentServicesResponse(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<IncidentServiceResponseData> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.data, incidentServicesResponse.data) &&
