...
@JsonPropertyOrder({ DashboardListItems.JSON_PROPERTY_DASHBOARDS, DashboardListItems.JSON_PROPERTY_TOTAL })
...
public class DashboardListItems {
    ...
    @JsonCreator
    public DashboardListItems(@JsonProperty(required = true, value = JSON_PROPERTY_DASHBOARDS) List<DashboardListItem> dashboards) {
