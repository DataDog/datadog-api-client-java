...
public class SecurityMonitoringRuleQueryCreate {
    ...
    @JsonCreator
    public SecurityMonitoringRuleQueryCreate(@JsonProperty(required = true, value = JSON_PROPERTY_QUERY) String query) {
        this.query = query;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.agentRule, securityMonitoringRuleQueryCreate.agentRule) &&
