...
public class LogsArchiveOrderAttributes {
    ...
    @JsonCreator
    public LogsArchiveOrderAttributes(@JsonProperty(required = true, value = JSON_PROPERTY_ARCHIVE_IDS) List<String> archiveIds) {
     ...
     **/
    @ApiModelProperty(
        example = "[\"a2zcMylnM4OCHpYusxIi1g\",\"a2zcMylnM4OCHpYusxIi2g\",\"a2zcMylnM4OCHpYusxIi3g\"]",
        required = true,
        value = "An ordered array of `<ARCHIVE_ID>` strings, the order of archive IDs in the array define the overall archives order for Datadog."
    )
