...
@JsonPropertyOrder({ APIKeyUpdateData.JSON_PROPERTY_ATTRIBUTES, APIKeyUpdateData.JSON_PROPERTY_ID, APIKeyUpdateData.JSON_PROPERTY_TYPE })
...
public class APIKeyUpdateData {
     ...
     * @return id
     **/
    @ApiModelProperty(example = "00112233-4455-6677-8899-aabbccddeeff", required = true, value = "ID of the API key.")
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, apIKeyUpdateData.attributes) &&
