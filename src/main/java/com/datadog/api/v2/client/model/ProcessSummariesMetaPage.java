...
public class ProcessSummariesMetaPage {
  ...
  **/
  ...
  @ApiModelProperty(example = "911abf1204838d9cdfcb9a96d0b6a1bd03e1b514074f1ce1737c4cbd", value = "The cursor used to get the next results, if any. To make the next request, use the same parameters with the addition of the `page[cursor]`.")
