 ...
 */
@ApiModel(description = "Update request for an incident.")
...
public class IncidentUpdateRequest {
    ...
    @JsonCreator
    public IncidentUpdateRequest(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) IncidentUpdateData data) {
        this.data = data;
