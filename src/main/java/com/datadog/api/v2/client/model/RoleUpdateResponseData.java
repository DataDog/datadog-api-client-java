...
public class RoleUpdateResponseData {
    ...
    @JsonCreator
    public RoleUpdateResponseData(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) RolesType type) {
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, roleUpdateResponseData.attributes) &&
