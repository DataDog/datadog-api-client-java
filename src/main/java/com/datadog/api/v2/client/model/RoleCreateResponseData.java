...
public class RoleCreateResponseData {
    ...
    @JsonCreator
    public RoleCreateResponseData(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) RolesType type) {
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, roleCreateResponseData.attributes) &&
