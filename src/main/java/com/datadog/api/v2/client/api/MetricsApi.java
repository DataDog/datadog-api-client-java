...
private ApiResponse<MetricTagConfigurationResponse> createTagConfigurationWithHttpInfo(String metricName, MetricTagConfigurationCreateRequest body) throws ApiException {
    ...
    return apiClient.invokeAPI("MetricsApi.createTagConfiguration", localVarPath, "POST", localVarQueryParams, localVarPostBody,
   ...
   */
  public APIcreateTagConfigurationRequest createTagConfiguration(String metricName) throws ApiException {
...
private ApiResponse<Void> deleteTagConfigurationWithHttpInfo(String metricName) throws ApiException {
    ...
    return apiClient.invokeAPI("MetricsApi.deleteTagConfiguration", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
   ...
   */
  public APIdeleteTagConfigurationRequest deleteTagConfiguration(String metricName) throws ApiException {
...
private ApiResponse<MetricTagConfigurationResponse> listTagConfigurationByNameWithHttpInfo(String metricName) throws ApiException {
    Object localVarPostBody = null;
    ...
    return apiClient.invokeAPI("MetricsApi.listTagConfigurationByName", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
   ...
   */
  public APIlistTagConfigurationByNameRequest listTagConfigurationByName(String metricName) throws ApiException {
...
private ApiResponse<MetricsAndMetricTagConfigurationsResponse> listTagConfigurationsWithHttpInfo(Boolean filterConfigured, String filterTagsConfigured, MetricTagConfigurationMetricTypes filterMetricType, Boolean filterIncludePercentiles) throws ApiException {
    ...
    return apiClient.invokeAPI("MetricsApi.listTagConfigurations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  ...
  public class APIlistTagConfigurationsRequest {
     ...
     * @return APIlistTagConfigurationsRequest
     */
    public APIlistTagConfigurationsRequest filterMetricType(MetricTagConfigurationMetricTypes filterMetricType) {
     ...
     * @return APIlistTagConfigurationsRequest
     */
    public APIlistTagConfigurationsRequest filterIncludePercentiles(Boolean filterIncludePercentiles) {
...
private ApiResponse<MetricTagConfigurationResponse> updateTagConfigurationWithHttpInfo(String metricName, MetricTagConfigurationUpdateRequest body) throws ApiException {
    ...
    return apiClient.invokeAPI("MetricsApi.updateTagConfiguration", localVarPath, "PATCH", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
   ...
   */
  public APIupdateTagConfigurationRequest updateTagConfiguration(String metricName) throws ApiException {
