 ...
 */
@ApiModel(description = "Create request with a service payload.")
@JsonPropertyOrder({
...
public class ServiceCreateRequest {
  ...
  private ServiceCreateData data;


  public ServiceCreateRequest data(ServiceCreateData data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public ServiceCreateData getData() {
    return data;
  }


  public void setData(ServiceCreateData data) {
    this.data = data;
  }
