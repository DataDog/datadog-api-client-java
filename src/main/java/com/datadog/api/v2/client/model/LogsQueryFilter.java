...
public class LogsQueryFilter {
  ...
  **/
  ...
  @ApiModelProperty(example = "now-15m", value = "The minimum time for the requested logs, supports date math and regular timestamps (milliseconds).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "now", value = "The maximum time for the requested logs, supports date math and regular timestamps (milliseconds).")
