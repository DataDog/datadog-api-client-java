...
@ApiModel(
    description =
        "Global query options that are used during the query. Note: Specify either timezone or"
            + " time offset, not both. Otherwise, the query fails.")
@JsonPropertyOrder({
...
public class AuditLogsQueryOptions {
  ...
  @ApiModelProperty(value = "Time offset (in seconds) to apply to the query.")
  ...
  @ApiModelProperty(
      example = "GMT",
      value = "Timezone code. Can be specified as an offset, for example: \"UTC+03:00\".")
