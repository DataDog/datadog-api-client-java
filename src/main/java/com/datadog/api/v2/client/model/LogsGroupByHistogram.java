...
@JsonPropertyOrder(
    { LogsGroupByHistogram.JSON_PROPERTY_INTERVAL, LogsGroupByHistogram.JSON_PROPERTY_MAX, LogsGroupByHistogram.JSON_PROPERTY_MIN }
)
...
public class LogsGroupByHistogram {
    ...
    @ApiModelProperty(
        example = "100",
        required = true,
        value = "The maximum value for the measure used in the histogram (values greater than this one are filtered out)"
    )
    ...
    @ApiModelProperty(
        example = "50",
        required = true,
        value = "The minimum value for the measure used in the histogram (values smaller than this one are filtered out)"
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.interval, logsGroupByHistogram.interval) &&
