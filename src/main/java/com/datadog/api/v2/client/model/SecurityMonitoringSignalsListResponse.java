 ...
 */
@ApiModel(description = "Response object with all security signals matching the request and pagination information.")
@JsonPropertyOrder({
...
public class SecurityMonitoringSignalsListResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "Array of security signals matching the request.")
  ...
  **/
  ...
  public SecurityMonitoringSignalsListResponse meta(LogsListResponseMeta meta) {
    this.meta = meta;
    return this;
  }
