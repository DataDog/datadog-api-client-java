...
public class IncidentResponseAttributes {
    ...
    @JsonCreator
    public IncidentResponseAttributes(@JsonProperty(required = true, value = JSON_PROPERTY_TITLE) String title) {
        this.title = title;
    }
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Length of the incident's customer impact in seconds. Equals the difference between `customer_impact_start` and `customer_impact_end`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The amount of time in seconds to detect the incident. Equals the difference between `customer_impact_start` and `detected`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The amount of time in seconds to call incident after detection. Equals the difference of `detected` and `created`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The amount of time in seconds to resolve customer impact after detecting the issue. Equals the difference between `customer_impact_end` and `detected`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The amount of time in seconds to resolve the incident after it was created. Equals the difference between `created` and `resolved`."
    )
