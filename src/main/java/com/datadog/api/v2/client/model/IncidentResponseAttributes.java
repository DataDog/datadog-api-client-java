...
public class IncidentResponseAttributes {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Length of the incident's customer impact in seconds. Equals the difference between `customer_impact_start` and `customer_impact_end`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "An example customer impact scope", value = "A summary of the impact customers experienced during the incident.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"severity\":{\"type\":\"dropdown\",\"value\":\"SEV-5\"}}", value = "A condensed view of the user-defined fields attached to incidents.")
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NOTIFICATION_HANDLES)
  public void setNotificationHandles_JsonNullable(JsonNullable<List<IncidentNotificationHandle>> notificationHandles) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "00000000-0000-0000-0000-000000000000", value = "The UUID of the postmortem object attached to the incident.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "1", value = "The monotonically increasing integer ID for the incident.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of time in seconds to detect the incident. Equals the difference between `customer_impact_start` and `detected`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of time in seconds to call incident after detection. Equals the difference of `detected` and `created`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of time in seconds to resolve customer impact after detecting the issue. Equals the difference between `customer_impact_end` and `detected`.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The amount of time in seconds to resolve the incident after it was created. Equals the difference between `created` and `resolved`.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, incidentResponseAttributes.created) &&
        Objects.equals(this.customerImpactDuration, incidentResponseAttributes.customerImpactDuration) &&
        ...
        Objects.equals(this.timeToInternalResponse, incidentResponseAttributes.timeToInternalResponse) &&
