...
public class LogsMetricCreateAttributes {
    ...
    @JsonCreator
    public LogsMetricCreateAttributes(@JsonProperty(required = true, value = JSON_PROPERTY_COMPUTE) LogsMetricCompute compute) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.compute, logsMetricCreateAttributes.compute) &&
