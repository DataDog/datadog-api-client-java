...
public class MetricTagConfigurationAttributes {
    ...
    @ApiModelProperty(
        example = "true",
        value = "Toggle to turn on/off percentile aggregations for distribution metrics. Only present when the `metric_type` is `distribution`."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aggregations, metricTagConfigurationAttributes.aggregations) &&
