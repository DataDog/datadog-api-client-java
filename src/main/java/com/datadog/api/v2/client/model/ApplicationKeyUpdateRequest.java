 ...
 */
@ApiModel(description = "Request used to update an application key.")
...
public class ApplicationKeyUpdateRequest {
    ...
    @JsonCreator
    public ApplicationKeyUpdateRequest(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) ApplicationKeyUpdateData data) {
        this.data = data;
