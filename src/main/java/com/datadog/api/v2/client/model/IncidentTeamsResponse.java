...
@JsonPropertyOrder(
    { IncidentTeamsResponse.JSON_PROPERTY_DATA, IncidentTeamsResponse.JSON_PROPERTY_INCLUDED, IncidentTeamsResponse.JSON_PROPERTY_META }
)
...
public class IncidentTeamsResponse {
    ...
    @JsonCreator
    public IncidentTeamsResponse(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<IncidentTeamResponseData> data) {
        this.data = data;
    }
     ...
     **/
    @ApiModelProperty(
        example = "[{\"attributes\":{\"name\":\"team name\"},\"id\":\"00000000-0000-0000-0000-000000000000\",\"type\":\"teams\"}]",
        required = true,
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.data, incidentTeamsResponse.data) &&
