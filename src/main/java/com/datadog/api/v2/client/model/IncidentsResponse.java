...
@JsonPropertyOrder({ IncidentsResponse.JSON_PROPERTY_DATA, IncidentsResponse.JSON_PROPERTY_INCLUDED, IncidentsResponse.JSON_PROPERTY_META })
...
public class IncidentsResponse {
    ...
    @JsonCreator
    public IncidentsResponse(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<IncidentResponseData> data) {
        this.data = data;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.data, incidentsResponse.data) &&
