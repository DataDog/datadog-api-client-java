...
public class SecurityMonitoringRuleCreatePayload {
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "true", value = "Whether the notifications include the triggering group-by values in their title.")
     ...
     * @return name
     **/
    @ApiModelProperty(example = "My security monitoring rule.", required = true, value = "The name of the rule.")
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.cases, securityMonitoringRuleCreatePayload.cases) &&
            Objects.equals(this.filters, securityMonitoringRuleCreatePayload.filters) &&
            Objects.equals(this.hasExtendedTitle, securityMonitoringRuleCreatePayload.hasExtendedTitle) &&
