...
public class LogAttributes {
    ...
    @ApiModelProperty(
        example = "agent",
        value = "The name of the application or service generating the log events. It is used to switch from Logs to APM, so make sure you define the same value when you use both products."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, logAttributes.attributes) &&
