 ...
 */
@ApiModel(description = "The team's attributes for an update request.")
@JsonPropertyOrder({
...
public class TeamUpdateAttributes {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "team name", required = true, value = "Name of the team.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, teamUpdateAttributes.name);
  }
