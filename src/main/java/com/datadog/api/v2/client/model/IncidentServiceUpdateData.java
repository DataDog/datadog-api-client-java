...
public class IncidentServiceUpdateData {
    ...
    @JsonCreator
    public IncidentServiceUpdateData(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) IncidentServiceType type) {
        this.type = type;
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "00000000-0000-0000-0000-000000000000", value = "The incident service's ID.")
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, incidentServiceUpdateData.attributes) &&
