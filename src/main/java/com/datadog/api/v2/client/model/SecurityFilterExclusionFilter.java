...
@JsonPropertyOrder({ SecurityFilterExclusionFilter.JSON_PROPERTY_NAME, SecurityFilterExclusionFilter.JSON_PROPERTY_QUERY })
...
public class SecurityFilterExclusionFilter {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Exclusion filter query. Logs that match this query are excluded from the security filter."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.name, securityFilterExclusionFilter.name) && Objects.equals(this.query, securityFilterExclusionFilter.query)
        );
    }
