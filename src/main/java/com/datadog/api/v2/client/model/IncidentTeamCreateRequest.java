 ...
 */
@ApiModel(description = "Create request with an incident team payload.")
...
public class IncidentTeamCreateRequest {
    ...
    @JsonCreator
    public IncidentTeamCreateRequest(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) IncidentTeamCreateData data) {
        this.data = data;
