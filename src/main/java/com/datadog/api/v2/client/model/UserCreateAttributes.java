...
@JsonPropertyOrder(
    { UserCreateAttributes.JSON_PROPERTY_EMAIL, UserCreateAttributes.JSON_PROPERTY_NAME, UserCreateAttributes.JSON_PROPERTY_TITLE }
)
...
public class UserCreateAttributes {
    ...
    @JsonCreator
    public UserCreateAttributes(@JsonProperty(required = true, value = JSON_PROPERTY_EMAIL) String email) {
        this.email = email;
    }
