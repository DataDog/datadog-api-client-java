...
@JsonPropertyOrder({ LogsMetricResponseGroupBy.JSON_PROPERTY_PATH, LogsMetricResponseGroupBy.JSON_PROPERTY_TAG_NAME })
...
public class LogsMetricResponseGroupBy {
    ...
    @ApiModelProperty(
        example = "status_code",
        value = "Eventual name of the tag that gets created. By default, the path attribute is used as the tag name."
    )
