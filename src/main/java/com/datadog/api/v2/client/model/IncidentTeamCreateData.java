...
public class IncidentTeamCreateData {
    ...
    @JsonCreator
    public IncidentTeamCreateData(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) IncidentTeamType type) {
        this.type = type;
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.attributes, incidentTeamCreateData.attributes) &&
