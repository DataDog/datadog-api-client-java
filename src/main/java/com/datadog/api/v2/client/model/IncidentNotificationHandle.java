...
@JsonPropertyOrder({ IncidentNotificationHandle.JSON_PROPERTY_DISPLAY_NAME, IncidentNotificationHandle.JSON_PROPERTY_HANDLE })
...
public class IncidentNotificationHandle {
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "@test.user@test.com", value = "The email address used for the notification.")
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.displayName, incidentNotificationHandle.displayName) &&
