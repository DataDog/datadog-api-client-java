 ...
 */
@ApiModel(description = "JSON object containing all signal attributes and their associated values.")
@JsonPropertyOrder({
...
public class SecurityMonitoringSignalAttributes {
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"workflow\":{\"first_seen\":\"2020-06-23T14:46:01.000Z\",\"last_seen\":\"2020-06-23T14:46:49.000Z\",\"rule\":{\"id\":\"0f5-e0c-805\",\"name\":\"Brute Force Attack Grouped By User \",\"version\":12}}}", value = "JSON object of attributes in the security signal.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "Detect Account Take Over (ATO) through brute force attempts", value = "The message the security signal, defined by the rule which which generated the signal.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"security:attack\",\"technique:T1110-brute-force\"]", value = "Array of tags associated with the security signal.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2019-01-02T09:42:36.320Z", value = "Timestamp of the security signal.")
