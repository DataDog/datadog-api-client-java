...
@JsonPropertyOrder({ IncidentServiceResponse.JSON_PROPERTY_DATA, IncidentServiceResponse.JSON_PROPERTY_INCLUDED })
...
public class IncidentServiceResponse {
    ...
    @JsonCreator
    public IncidentServiceResponse(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) IncidentServiceResponseData data) {
        this.data = data;
