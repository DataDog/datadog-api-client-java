...
/**
   * <p>The monitor summary widget displays a summary view of all your Datadog monitors, or a subset based on a query.</p>
 */
@JsonPropertyOrder({
...
public class MonitorSummaryWidgetDefinition {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(colorPreference,count,description,displayFormat,hideZeroCounts,query,showLastTriggered,showPriority,sort,start,summaryType,title,titleAlign,titleSize,type, additionalProperties);
  }
