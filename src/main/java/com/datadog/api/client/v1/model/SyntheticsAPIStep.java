...
public class SyntheticsAPIStep extends AbstractOpenApiSchema {
    ...
    public static class SyntheticsAPIStepSerializer extends StdSerializer<SyntheticsAPIStep> {
        ...
        @Override
        public void serialize(SyntheticsAPIStep value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class SyntheticsAPIStepDeserializer extends StdDeserializer<SyntheticsAPIStep> {
        ...
        @Override
        public SyntheticsAPIStep deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (SyntheticsAPITestStep.class.equals(Integer.class) || SyntheticsAPITestStep.class.equals(Long.class) || SyntheticsAPITestStep.class.equals(Float.class) || SyntheticsAPITestStep.class.equals(Double.class) || SyntheticsAPITestStep.class.equals(Boolean.class) || SyntheticsAPITestStep.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyntheticsAPITestStep.class.equals(Integer.class) || SyntheticsAPITestStep.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyntheticsAPITestStep.class.equals(Float.class) || SyntheticsAPITestStep.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SyntheticsAPITestStep.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyntheticsAPITestStep.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SyntheticsAPIWaitStep.class.equals(Integer.class) || SyntheticsAPIWaitStep.class.equals(Long.class) || SyntheticsAPIWaitStep.class.equals(Float.class) || SyntheticsAPIWaitStep.class.equals(Double.class) || SyntheticsAPIWaitStep.class.equals(Boolean.class) || SyntheticsAPIWaitStep.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyntheticsAPIWaitStep.class.equals(Integer.class) || SyntheticsAPIWaitStep.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyntheticsAPIWaitStep.class.equals(Float.class) || SyntheticsAPIWaitStep.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SyntheticsAPIWaitStep.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyntheticsAPIWaitStep.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SyntheticsAPISubtestStep.class.equals(Integer.class) || SyntheticsAPISubtestStep.class.equals(Long.class) || SyntheticsAPISubtestStep.class.equals(Float.class) || SyntheticsAPISubtestStep.class.equals(Double.class) || SyntheticsAPISubtestStep.class.equals(Boolean.class) || SyntheticsAPISubtestStep.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyntheticsAPISubtestStep.class.equals(Integer.class) || SyntheticsAPISubtestStep.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyntheticsAPISubtestStep.class.equals(Float.class) || SyntheticsAPISubtestStep.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SyntheticsAPISubtestStep.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyntheticsAPISubtestStep.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * SyntheticsAPITestStep, SyntheticsAPIWaitStep, SyntheticsAPISubtestStep
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SyntheticsAPITestStep, SyntheticsAPIWaitStep, SyntheticsAPISubtestStep");
    }
     ...
     * SyntheticsAPITestStep, SyntheticsAPIWaitStep, SyntheticsAPISubtestStep
     *
     * @return The actual instance (SyntheticsAPITestStep, SyntheticsAPIWaitStep, SyntheticsAPISubtestStep)
     */
    @Override
    ...
    /**
     * Get the actual instance of `SyntheticsAPITestStep`. If the actual instance is not `SyntheticsAPITestStep`,
    ...
    /**
     * Get the actual instance of `SyntheticsAPIWaitStep`. If the actual instance is not `SyntheticsAPIWaitStep`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `SyntheticsAPISubtestStep`. If the actual instance is not `SyntheticsAPISubtestStep`,
     * the ClassCastException will be thrown.
     *
