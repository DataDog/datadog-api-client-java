...
public class DistributionWidgetRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apmQuery,apmStatsQuery,eventQuery,logQuery,networkQuery,processQuery,profileMetricsQuery,q,query,requestType,rumQuery,securityQuery,style);
  }
