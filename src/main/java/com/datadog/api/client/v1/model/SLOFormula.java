 ...
 */
@JsonPropertyOrder({
  SLOFormula.JSON_PROPERTY_FORMULA
})
...
public class SLOFormula {
  ...
  /**
   * <p>The formula string, which is an expression involving named queries.</p>
   * @return formula
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.formula, sloFormula.formula) && Objects.equals(this.additionalProperties, sloFormula.additionalProperties);
  }
