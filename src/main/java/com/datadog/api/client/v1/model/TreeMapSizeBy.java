...
public class TreeMapSizeBy extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("pct_cpu", "pct_mem"));
  ...
  public static class TreeMapSizeBySerializer extends StdSerializer<TreeMapSizeBy> {
      ...
      @Override
      public void serialize(TreeMapSizeBy value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
