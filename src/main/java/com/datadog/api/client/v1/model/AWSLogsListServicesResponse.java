...
/**
   * <p>The list of current AWS services for which Datadog offers automatic log collection.</p>
 */
@JsonPropertyOrder({
...
public class AWSLogsListServicesResponse {
  ...
  /**
   * <p>Key value in returned object.</p>
   * @return id
  **/
  ...
  /**
   * <p>Name of service available for configuration with Datadog logs.</p>
   * @return label
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, awsLogsListServicesResponse.id) && Objects.equals(this.label, awsLogsListServicesResponse.label) && Objects.equals(this.additionalProperties, awsLogsListServicesResponse.additionalProperties);
  }
