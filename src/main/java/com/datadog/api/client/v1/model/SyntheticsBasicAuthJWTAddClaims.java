...
public class SyntheticsBasicAuthJWTAddClaims {
  ...
  /**
   * <p>Whether to inject the <code>exp</code> (expiration) claim.</p>
   * @return exp
  **/
  ...
  /**
   * <p>Whether to inject the <code>iat</code> (issued at) claim.</p>
   * @return iat
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsBasicAuthJWTAddClaims syntheticsBasicAuthJwtAddClaims = (SyntheticsBasicAuthJWTAddClaims) o;
    return Objects.equals(this.exp, syntheticsBasicAuthJwtAddClaims.exp) && Objects.equals(this.iat, syntheticsBasicAuthJwtAddClaims.iat) && Objects.equals(this.additionalProperties, syntheticsBasicAuthJwtAddClaims.additionalProperties);
  }
