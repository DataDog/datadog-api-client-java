...
/**
 * Represents key links tied to a monitor to help users take action on alerts. This feature is in
 * Preview and only available to users with the feature enabled.
 */
@JsonPropertyOrder({
...
public class MonitorAsset {
  ...
  /**
   * Represents the identifier of the internal Datadog resource that this asset represents. IDs in
   * this field should be passed in as strings.
   *
   * @return resourceKey
   */
  ...
  /**
   * URL link for the asset. For links with an internal resource type set, this should be the
   * relative path to where the Datadog domain is appended internally. For external links, this
   * should be the full URL path.
   *
   * @return url
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, monitorAsset.category)
        && Objects.equals(this.name, monitorAsset.name)
        && Objects.equals(this.resourceKey, monitorAsset.resourceKey)
        && Objects.equals(this.resourceType, monitorAsset.resourceType)
        && Objects.equals(this.url, monitorAsset.url)
        && Objects.equals(this.additionalProperties, monitorAsset.additionalProperties);
  }
