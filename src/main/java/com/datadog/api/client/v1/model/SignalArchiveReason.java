...
public class SignalArchiveReason extends ModelEnum<String> {
  ...
  public static final SignalArchiveReason INVESTIGATED_CASE_OPENED = new SignalArchiveReason("investigated_case_opened");
  public static final SignalArchiveReason TRUE_POSITIVE_BENIGN = new SignalArchiveReason("true_positive_benign");
  public static final SignalArchiveReason TRUE_POSITIVE_MALICIOUS = new SignalArchiveReason("true_positive_malicious");
