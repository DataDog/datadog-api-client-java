 ...
 */
@JsonPropertyOrder({
  IPPrefixesOrchestrator.JSON_PROPERTY_PREFIXES_IPV4,
  IPPrefixesOrchestrator.JSON_PROPERTY_PREFIXES_IPV6
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class IPPrefixesOrchestrator {
  @JsonIgnore
  ...
  public IPPrefixesOrchestrator prefixesIpv4(List<String> prefixesIpv4) {
    this.prefixesIpv4 = prefixesIpv4;
    return this;
  }
  public IPPrefixesOrchestrator addPrefixesIpv4Item(String prefixesIpv4Item) {
  ...
  **/
  ...
  public IPPrefixesOrchestrator prefixesIpv6(List<String> prefixesIpv6) {
    this.prefixesIpv6 = prefixesIpv6;
    return this;
  }
  public IPPrefixesOrchestrator addPrefixesIpv6Item(String prefixesIpv6Item) {
  ...
  **/
   ...
   * @return IPPrefixesOrchestrator
   */
  @JsonAnySetter
  public IPPrefixesOrchestrator putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IPPrefixesOrchestrator ipPrefixesOrchestrator = (IPPrefixesOrchestrator) o;
    return Objects.equals(this.prefixesIpv4, ipPrefixesOrchestrator.prefixesIpv4) && Objects.equals(this.prefixesIpv6, ipPrefixesOrchestrator.prefixesIpv6) && Objects.equals(this.additionalProperties, ipPrefixesOrchestrator.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPPrefixesOrchestrator {\n");
