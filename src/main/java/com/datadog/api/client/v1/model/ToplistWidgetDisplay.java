...
public class ToplistWidgetDisplay extends AbstractOpenApiSchema {
    ...
    public static class ToplistWidgetDisplaySerializer extends StdSerializer<ToplistWidgetDisplay> {
        ...
        @Override
        public void serialize(ToplistWidgetDisplay value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ToplistWidgetDisplayDeserializer extends StdDeserializer<ToplistWidgetDisplay> {
        ...
        @Override
        public ToplistWidgetDisplay deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (ToplistWidgetStacked.class.equals(Integer.class) || ToplistWidgetStacked.class.equals(Long.class) || ToplistWidgetStacked.class.equals(Float.class) || ToplistWidgetStacked.class.equals(Double.class) || ToplistWidgetStacked.class.equals(Boolean.class) || ToplistWidgetStacked.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ToplistWidgetStacked.class.equals(Integer.class) || ToplistWidgetStacked.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ToplistWidgetStacked.class.equals(Float.class) || ToplistWidgetStacked.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ToplistWidgetStacked.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ToplistWidgetStacked.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ToplistWidgetFlat.class.equals(Integer.class) || ToplistWidgetFlat.class.equals(Long.class) || ToplistWidgetFlat.class.equals(Float.class) || ToplistWidgetFlat.class.equals(Double.class) || ToplistWidgetFlat.class.equals(Boolean.class) || ToplistWidgetFlat.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ToplistWidgetFlat.class.equals(Integer.class) || ToplistWidgetFlat.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ToplistWidgetFlat.class.equals(Float.class) || ToplistWidgetFlat.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ToplistWidgetFlat.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ToplistWidgetFlat.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public ToplistWidgetDisplay getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * ToplistWidgetStacked, ToplistWidgetFlat
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ToplistWidgetStacked, ToplistWidgetFlat");
    }
    ...
    /**
     * Get the actual instance of `ToplistWidgetStacked`. If the actual instance is not `ToplistWidgetStacked`,
    ...
    /**
     * Get the actual instance of `ToplistWidgetFlat`. If the actual instance is not `ToplistWidgetFlat`,
     * the ClassCastException will be thrown.
     *
