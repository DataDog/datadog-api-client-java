...
public class WidgetTime extends AbstractOpenApiSchema {
    ...
    public static class WidgetTimeSerializer extends StdSerializer<WidgetTime> {
        ...
        @Override
        public void serialize(WidgetTime value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class WidgetTimeDeserializer extends StdDeserializer<WidgetTime> {
        ...
        @Override
        public WidgetTime deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (WidgetLegacyLiveSpan.class.equals(Integer.class) || WidgetLegacyLiveSpan.class.equals(Long.class) || WidgetLegacyLiveSpan.class.equals(Float.class) || WidgetLegacyLiveSpan.class.equals(Double.class) || WidgetLegacyLiveSpan.class.equals(Boolean.class) || WidgetLegacyLiveSpan.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        attemptParsing |= ((WidgetLegacyLiveSpan.class.equals(Integer.class) || WidgetLegacyLiveSpan.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WidgetLegacyLiveSpan.class.equals(Float.class) || WidgetLegacyLiveSpan.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WidgetLegacyLiveSpan.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WidgetLegacyLiveSpan.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                ...
                if (WidgetNewLiveSpan.class.equals(Integer.class) || WidgetNewLiveSpan.class.equals(Long.class) || WidgetNewLiveSpan.class.equals(Float.class) || WidgetNewLiveSpan.class.equals(Double.class) || WidgetNewLiveSpan.class.equals(Boolean.class) || WidgetNewLiveSpan.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((WidgetNewLiveSpan.class.equals(Integer.class) || WidgetNewLiveSpan.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WidgetNewLiveSpan.class.equals(Float.class) || WidgetNewLiveSpan.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WidgetNewLiveSpan.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WidgetNewLiveSpan.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                ...
                if (WidgetNewFixedSpan.class.equals(Integer.class) || WidgetNewFixedSpan.class.equals(Long.class) || WidgetNewFixedSpan.class.equals(Float.class) || WidgetNewFixedSpan.class.equals(Double.class) || WidgetNewFixedSpan.class.equals(Boolean.class) || WidgetNewFixedSpan.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((WidgetNewFixedSpan.class.equals(Integer.class) || WidgetNewFixedSpan.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WidgetNewFixedSpan.class.equals(Float.class) || WidgetNewFixedSpan.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WidgetNewFixedSpan.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WidgetNewFixedSpan.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * WidgetLegacyLiveSpan, WidgetNewLiveSpan, WidgetNewFixedSpan
     *
    ...
    /**
     * Get the actual instance of `WidgetLegacyLiveSpan`. If the actual instance is not `WidgetLegacyLiveSpan`,
    ...
    /**
     * Get the actual instance of `WidgetNewLiveSpan`. If the actual instance is not `WidgetNewLiveSpan`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `WidgetNewFixedSpan`. If the actual instance is not `WidgetNewFixedSpan`,
     * the ClassCastException will be thrown.
     *
