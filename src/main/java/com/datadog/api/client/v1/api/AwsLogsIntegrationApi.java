...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated.</strong> Test if permissions are present to add a log-forwarding triggers for the given services and AWS account. The input
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated.</strong> Test if permissions are present to add log-forwarding triggers for the
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated.</strong> Attach the Lambda ARN of the Lambda created for the Datadog-AWS log collection to your AWS account ID to enable log collection.</p>
   *
   * @param body AWS Log Lambda Async request body. (required)
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated.</strong> Delete a Datadog-AWS logs configuration by removing the specific Lambda ARN associated with a given AWS account.</p>
   *
   * @param body Delete AWS Lambda ARN request body. (required)
   * @return ApiResponse&lt;Object&gt;
   * @throws ApiException if fails to make API call
