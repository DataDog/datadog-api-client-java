...
/**
   * <p>Response containing the Database Monitoring usage for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
  UsageDBMResponse.JSON_PROPERTY_USAGE
})
...
public class UsageDBMResponse {
  ...
  /**
   * <p>Get hourly usage for Database Monitoring</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageDBMResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageDbmResponse.usage) && Objects.equals(this.additionalProperties, usageDbmResponse.additionalProperties);
  }
