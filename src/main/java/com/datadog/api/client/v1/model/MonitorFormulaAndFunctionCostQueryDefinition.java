...
public class MonitorFormulaAndFunctionCostQueryDefinition {
  ...
  public MonitorFormulaAndFunctionCostQueryDefinition aggregator(
      MonitorFormulaAndFunctionCostAggregator aggregator) {
   ...
   */
  @JsonAnySetter
  public MonitorFormulaAndFunctionCostQueryDefinition putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    MonitorFormulaAndFunctionCostQueryDefinition monitorFormulaAndFunctionCostQueryDefinition =
        (MonitorFormulaAndFunctionCostQueryDefinition) o;
    return Objects.equals(this.aggregator, monitorFormulaAndFunctionCostQueryDefinition.aggregator)
        && Objects.equals(this.dataSource, monitorFormulaAndFunctionCostQueryDefinition.dataSource)
        && Objects.equals(this.name, monitorFormulaAndFunctionCostQueryDefinition.name)
        && Objects.equals(this.query, monitorFormulaAndFunctionCostQueryDefinition.query)
        && Objects.equals(
            this.additionalProperties,
            monitorFormulaAndFunctionCostQueryDefinition.additionalProperties);
  }
