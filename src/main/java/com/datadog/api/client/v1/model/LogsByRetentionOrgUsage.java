...
/**
   * <p>Indexed logs usage by retention for a single organization.</p>
 */
@JsonPropertyOrder({
  LogsByRetentionOrgUsage.JSON_PROPERTY_USAGE
})
...
public class LogsByRetentionOrgUsage {
  ...
  /**
   * <p>Indexed logs usage for each active retention for the organization.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public LogsByRetentionOrgUsage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, logsByRetentionOrgUsage.usage) && Objects.equals(this.additionalProperties, logsByRetentionOrgUsage.additionalProperties);
  }
