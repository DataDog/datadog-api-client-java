...
public class ImageWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static class ImageWidgetDefinitionTypeSerializer extends StdSerializer<ImageWidgetDefinitionType> {
      ...
      @Override
      public void serialize(ImageWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
