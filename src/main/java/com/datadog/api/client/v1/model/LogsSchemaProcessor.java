...
/**
 * A processor that has additional validations and checks for a given schema. Currently supported
 * schema types include OCSF.
 */
@JsonPropertyOrder({
...
public class LogsSchemaProcessor {
  ...
  /**
   * The <code>LogsSchemaProcessor</code> <code>mappers</code>.
   *
   * @return mappers
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isEnabled, logsSchemaProcessor.isEnabled)
        && Objects.equals(this.mappers, logsSchemaProcessor.mappers)
        && Objects.equals(this.name, logsSchemaProcessor.name)
        && Objects.equals(this.schema, logsSchemaProcessor.schema)
        && Objects.equals(this.type, logsSchemaProcessor.type)
        && Objects.equals(this.additionalProperties, logsSchemaProcessor.additionalProperties);
  }
