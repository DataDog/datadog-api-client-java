...
public class DistributionWidgetXAxis {
  ...
  **/
  ...
  /**
   * <p>Specifies maximum value to show on the x-axis. It takes a number, percentile (p90 === 90th percentile), or auto for default behavior.</p>
   * @return max
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Specifies minimum value to show on the x-axis. It takes a number, percentile (p90 === 90th percentile), or auto for default behavior.</p>
   * @return min
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of value buckets to target, also known as the resolution of the value bins.</p>
   * minimum: 1
   * @return numBuckets
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Specifies the scale type. Possible values are <code>linear</code>.</p>
   * @return scale
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeZero, distributionWidgetXAxis.includeZero) && Objects.equals(this.max, distributionWidgetXAxis.max) && Objects.equals(this.min, distributionWidgetXAxis.min) && Objects.equals(this.numBuckets, distributionWidgetXAxis.numBuckets) && Objects.equals(this.scale, distributionWidgetXAxis.scale) && Objects.equals(this.additionalProperties, distributionWidgetXAxis.additionalProperties);
  }
