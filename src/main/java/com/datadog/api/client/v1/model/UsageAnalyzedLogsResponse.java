...
/**
   * <p>A response containing the number of analyzed logs for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class UsageAnalyzedLogsResponse {
  ...
  /**
   * <p>Get hourly usage for analyzed logs.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageAnalyzedLogsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageAnalyzedLogsResponse.usage) && Objects.equals(this.additionalProperties, usageAnalyzedLogsResponse.additionalProperties);
  }
