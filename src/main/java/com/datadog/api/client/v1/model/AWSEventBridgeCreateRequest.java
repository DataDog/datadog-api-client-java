...
public class AWSEventBridgeCreateRequest {
  ...
  /**
   * True if Datadog should create the event bus in addition to the event source. Requires the
   * <code>events:CreateEventBus</code> permission.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accountId, awsEventBridgeCreateRequest.accountId)
        && Objects.equals(this.createEventBus, awsEventBridgeCreateRequest.createEventBus)
        && Objects.equals(this.eventGeneratorName, awsEventBridgeCreateRequest.eventGeneratorName)
        && Objects.equals(this.region, awsEventBridgeCreateRequest.region)
        && Objects.equals(
            this.additionalProperties, awsEventBridgeCreateRequest.additionalProperties);
  }
