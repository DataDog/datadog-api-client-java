...
public class HostMapWidgetDefinitionRequests {
  ...
  /**
   * <p>Infrastructure-backed request for the host map widget. Supports entity-based
   * visualization with metric query enrichments, tag-based filtering, flexible grouping,
   * and hierarchical views.</p>
   * @return child
  **/
  ...
  /**
   * <p>List of conditional formatting rules applied to fill values.</p>
  ...
  **/
  ...
  /**
   * <p>Metric or event queries joined to the entity set. Each formula specifies a visual dimension. Only used by the infrastructure-backed format.</p>
   * @return enrichments
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Deprecated - Legacy metric-based host map request. Use the infrastructure-backed (<code>request_type: infrastructure_hostmap</code>) or DDSQL (<code>request_type: data_projection</code>) format instead.</p>
   * @return fill
   * @deprecated
  **/
      @Deprecated
  ...
  /**
   * <p>Filter string for the entity set in tag format (for example, <code>env:prod</code>). Only used by the infrastructure-backed format.</p>
   * @return filter
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Defines how entities are grouped into tiles. The ordering of entries implies
   * the grouping hierarchy. Only used by the infrastructure-backed format.</p>
   * @return groupBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Maximum number of rows to return from the dataset query. Only used by the DDSQL format.</p>
   * @return limit
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to hide entities that have no group assignment.</p>
   * @return noGroupHosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to hide entities that have no enrichment data.</p>
  ...
  **/
  ...
  /**
   * <p>Which type of infrastructure entity to visualize in the host map.</p>
   * @return nodeType
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Query that lists the rows of a published dataset (a DDSQL query) without aggregation.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  public HostMapWidgetDefinitionRequests requestType(HostMapWidgetDefinitionRequestType requestType) {
  ...
  /**
   * <p>Identifies which host map request format the sibling fields on <code>HostMapWidgetDefinitionRequests</code> describe: an infrastructure-backed request or a DDSQL published-dataset request.</p>
   * @return requestType
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Style configuration for the infrastructure host map.</p>
   * @return style
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.child, hostMapWidgetDefinitionRequests.child) && Objects.equals(this.conditionalFormats, hostMapWidgetDefinitionRequests.conditionalFormats) && Objects.equals(this.enrichments, hostMapWidgetDefinitionRequests.enrichments) && Objects.equals(this.fill, hostMapWidgetDefinitionRequests.fill) && Objects.equals(this.filter, hostMapWidgetDefinitionRequests.filter) && Objects.equals(this.groupBy, hostMapWidgetDefinitionRequests.groupBy) && Objects.equals(this.limit, hostMapWidgetDefinitionRequests.limit) && Objects.equals(this.noGroupHosts, hostMapWidgetDefinitionRequests.noGroupHosts) && Objects.equals(this.noMetricHosts, hostMapWidgetDefinitionRequests.noMetricHosts) && Objects.equals(this.nodeType, hostMapWidgetDefinitionRequests.nodeType) && Objects.equals(this.projection, hostMapWidgetDefinitionRequests.projection) && Objects.equals(this.query, hostMapWidgetDefinitionRequests.query) && Objects.equals(this.requestType, hostMapWidgetDefinitionRequests.requestType) && Objects.equals(this.size, hostMapWidgetDefinitionRequests.size) && Objects.equals(this.style, hostMapWidgetDefinitionRequests.style) && Objects.equals(this.additionalProperties, hostMapWidgetDefinitionRequests.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(child,conditionalFormats,enrichments,fill,filter,groupBy,limit,noGroupHosts,noMetricHosts,nodeType,projection,query,requestType,size,style, additionalProperties);
  }
