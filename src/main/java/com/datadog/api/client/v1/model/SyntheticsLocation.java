...
/**
   * <p>Synthetic location that can be used when creating or editing a
   * test.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsLocation {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SyntheticsLocation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, syntheticsLocation.id) && Objects.equals(this.name, syntheticsLocation.name) && Objects.equals(this.additionalProperties, syntheticsLocation.additionalProperties);
  }
