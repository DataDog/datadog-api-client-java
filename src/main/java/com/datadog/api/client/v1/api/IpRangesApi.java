 ...
 */
  ...
  public CompletableFuture<ApiResponse<IPRanges>> getIPRangesWithHttpInfoAsync() {
    ...
    try {
      builder = apiClient.createBuilder("IpRangesApi.getIPRanges", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] {  });
