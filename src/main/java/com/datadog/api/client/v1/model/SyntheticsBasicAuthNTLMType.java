...
public class SyntheticsBasicAuthNTLMType extends ModelEnum<String> {
  ...
  public static class SyntheticsBasicAuthNTLMTypeSerializer extends StdSerializer<SyntheticsBasicAuthNTLMType> {
      ...
      @Override
      public void serialize(SyntheticsBasicAuthNTLMType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
