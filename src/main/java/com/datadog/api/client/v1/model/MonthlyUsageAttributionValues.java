...
public class MonthlyUsageAttributionValues {
  ...
  **/
  ...
  /**
   * <p>The percentage of estimated live ingested logs usage by tag(s). This field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The estimated live ingested logs usage by tag(s). This field is in private beta.</p>
