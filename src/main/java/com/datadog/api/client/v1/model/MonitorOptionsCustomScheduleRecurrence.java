...
/**
   * <p>Configuration for a recurrence set on the monitor options for custom schedule.</p>
 */
@JsonPropertyOrder({
...
public class MonitorOptionsCustomScheduleRecurrence {
  ...
  /**
   * <p>Defines the recurrence rule (RRULE) for a given schedule.</p>
   * @return rrule
  **/
  ...
  /**
   * <p>Defines the start date and time of the recurring schedule.</p>
   * @return start
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Defines the timezone the schedule runs on.</p>
   * @return timezone
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    MonitorOptionsCustomScheduleRecurrence monitorOptionsCustomScheduleRecurrence = (MonitorOptionsCustomScheduleRecurrence) o;
    return Objects.equals(this.rrule, monitorOptionsCustomScheduleRecurrence.rrule) && Objects.equals(this.start, monitorOptionsCustomScheduleRecurrence.start) && Objects.equals(this.timezone, monitorOptionsCustomScheduleRecurrence.timezone) && Objects.equals(this.additionalProperties, monitorOptionsCustomScheduleRecurrence.additionalProperties);
  }
