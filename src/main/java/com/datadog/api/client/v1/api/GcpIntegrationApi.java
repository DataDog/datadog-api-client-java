 ...
 */
  ...
  /**
   * <p>Create a Datadog-GCP integration.</p>
   *
   * @param body Create a Datadog-GCP integration. (required)
  ...
  public CompletableFuture<ApiResponse<Object>> createGCPIntegrationWithHttpInfoAsync(GCPAccount body) {
    ...
    try {
      builder = apiClient.createBuilder("GcpIntegrationApi.createGCPIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  /**
   * <p>Delete a given Datadog-GCP integration.</p>
   *
   * @param body Delete a given Datadog-GCP integration. (required)
   * @return ApiResponse&lt;Object&gt;
   * @throws ApiException if fails to make API call
  ...
  public CompletableFuture<ApiResponse<Object>> deleteGCPIntegrationWithHttpInfoAsync(GCPAccount body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("GcpIntegrationApi.deleteGCPIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  /**
   * <p>List all Datadog-GCP integrations configured in your Datadog account.</p>
   *
  ...
  public CompletableFuture<ApiResponse<List<GCPAccount>>> listGCPIntegrationWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("GcpIntegrationApi.listGCPIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  /**
   * <p>Update a Datadog-GCP integrations host_filters and/or auto-mute.
  ...
  public CompletableFuture<ApiResponse<Object>> updateGCPIntegrationWithHttpInfoAsync(GCPAccount body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("GcpIntegrationApi.updateGCPIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
