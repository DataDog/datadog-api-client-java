 ...
 */
@JsonSerialize(using = DistributionPointsContentEncoding.DistributionPointsContentEncodingSerializer.class)
public class DistributionPointsContentEncoding extends ModelEnum<String> {
  ...
  public static final DistributionPointsContentEncoding DEFLATE = new DistributionPointsContentEncoding("deflate");
  ...
  public static class DistributionPointsContentEncodingSerializer extends StdSerializer<DistributionPointsContentEncoding> {
      ...
      @Override
      public void serialize(DistributionPointsContentEncoding value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
