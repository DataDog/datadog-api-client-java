...
/**
   * <p>Use the Category Processor to add a new attribute (without spaces or special characters in the new attribute name)
   * to a log matching a provided search query. Use categories to create groups for an analytical view.
   * For example, URL groups, machine groups, environments, and response time buckets.</p>
   ...
   * <li>Once the log has matched one of the Processor queries, it stops.
   *   Make sure they are properly ordered in case a log could match several queries.</li>
   * <li>The names of the categories must be unique.</li>
   * <li>Once defined in the Category Processor, you can map categories to log status using the Log Status Remapper.</li>
   * </ul>
 */
@JsonPropertyOrder({
...
public class LogsCategoryProcessor {
  ...
  **/
  ...
  /**
   * <p>Name of the target attribute which value is defined by the matching category.</p>
   * @return target
  **/
