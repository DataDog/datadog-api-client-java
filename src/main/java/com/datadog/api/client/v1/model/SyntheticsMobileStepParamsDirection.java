 ...
 */
@JsonSerialize(using = SyntheticsMobileStepParamsDirection.SyntheticsMobileStepParamsDirectionSerializer.class)
public class SyntheticsMobileStepParamsDirection extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("up", "down", "left", "right"));

  public static final SyntheticsMobileStepParamsDirection UP = new SyntheticsMobileStepParamsDirection("up");
  public static final SyntheticsMobileStepParamsDirection DOWN = new SyntheticsMobileStepParamsDirection("down");
  ...
  public static class SyntheticsMobileStepParamsDirectionSerializer extends StdSerializer<SyntheticsMobileStepParamsDirection> {
      public SyntheticsMobileStepParamsDirectionSerializer(Class<SyntheticsMobileStepParamsDirection> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(SyntheticsMobileStepParamsDirection value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
