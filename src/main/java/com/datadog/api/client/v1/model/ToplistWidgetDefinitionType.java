...
public class ToplistWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final ToplistWidgetDefinitionType TOPLIST = new ToplistWidgetDefinitionType("toplist");
  ...
  public static class ToplistWidgetDefinitionTypeSerializer extends StdSerializer<ToplistWidgetDefinitionType> {
      ...
      @Override
      public void serialize(ToplistWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
