...
public class LogsGeoIPParser {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isEnabled, logsGeoIpParser.isEnabled)
        ...
        && Objects.equals(this.additionalProperties, logsGeoIpParser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isEnabled, name, sources, target, type, additionalProperties);
  }
