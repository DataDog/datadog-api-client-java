...
public class GeomapWidgetDefinition {
  ...
  **/
  ...
  /**
   * <p>Array of one request object to display in the widget. The request must contain a <code>group-by</code> tag whose value is a country ISO code.</p>
   * <p>See the <a href="https://docs.datadoghq.com/dashboards/graphing_json/request_json">Request JSON schema documentation</a>
