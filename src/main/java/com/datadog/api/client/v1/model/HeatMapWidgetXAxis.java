...
public class HeatMapWidgetXAxis {
  ...
  public HeatMapWidgetXAxis numBuckets(Long numBuckets) {
    this.numBuckets = numBuckets;
    return this;
  }

  /**
   * Number of time buckets to target, aka the resolution of the time bins. This is only applicable
   * for distribution of points (group distributions use the roll-up modifier).
   *
   * @return numBuckets
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(numBuckets, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HeatMapWidgetXAxis {\n");
