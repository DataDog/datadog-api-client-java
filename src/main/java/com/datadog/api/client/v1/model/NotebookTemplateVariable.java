...
public class NotebookTemplateVariable {
   ...
   * @return NotebookTemplateVariable
   */
  @JsonAnySetter
  public NotebookTemplateVariable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableValues, notebookTemplateVariable.availableValues)
        ...
        && Objects.equals(this.additionalProperties, notebookTemplateVariable.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(availableValues, _default, name, prefix, additionalProperties);
  }
