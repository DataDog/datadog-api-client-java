...
/**
   * <p>Free text is a widget that allows you to add headings to your dashboard. Commonly used to state the overall purpose of the dashboard.</p>
 */
@JsonPropertyOrder({
...
public class FreeTextWidgetDefinition {
  ...
  /**
   * <p>Background color of the widget. Supported values are <code>white</code>, <code>blue</code>, <code>purple</code>, <code>pink</code>, <code>orange</code>, <code>yellow</code>, <code>green</code>, <code>gray</code>, <code>vivid_blue</code>, <code>vivid_purple</code>, <code>vivid_pink</code>, <code>vivid_orange</code>, <code>vivid_yellow</code>, <code>vivid_green</code>, and <code>transparent</code>.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.backgroundColor, freeTextWidgetDefinition.backgroundColor) && Objects.equals(this.color, freeTextWidgetDefinition.color) && Objects.equals(this.fontSize, freeTextWidgetDefinition.fontSize) && Objects.equals(this.text, freeTextWidgetDefinition.text) && Objects.equals(this.textAlign, freeTextWidgetDefinition.textAlign) && Objects.equals(this.type, freeTextWidgetDefinition.type) && Objects.equals(this.additionalProperties, freeTextWidgetDefinition.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(backgroundColor,color,fontSize,text,textAlign,type, additionalProperties);
  }
