...
public class SyntheticsSSLCertificate {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cipher,exponent,extKeyUsage,fingerprint,fingerprint256,issuer,modulus,protocol,serialNumber,subject,validFrom,validTo, additionalProperties);
  }
