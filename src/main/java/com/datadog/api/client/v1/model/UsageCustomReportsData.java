...
/**
   * <p>The response containing the date and type for custom reports.</p>
 */
@JsonPropertyOrder({
...
public class UsageCustomReportsData {
  ...
  /**
   * <p>The response containing attributes for custom reports.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The date for specified custom reports.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
   ...
   */
  @JsonAnySetter
  public UsageCustomReportsData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, usageCustomReportsData.attributes) && Objects.equals(this.id, usageCustomReportsData.id) && Objects.equals(this.type, usageCustomReportsData.type) && Objects.equals(this.additionalProperties, usageCustomReportsData.additionalProperties);
  }
