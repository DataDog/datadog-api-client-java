...
public class WidgetAxis {
  ...
  **/
  ...
  /**
   * <p>Specifies the scale type. Possible values are <code>linear</code>, <code>log</code>, <code>sqrt</code>, <code>pow##</code> (for example <code>pow2</code>, <code>pow0.5</code> etc.).</p>
   * @return scale
  **/
      @jakarta.annotation.Nullable
