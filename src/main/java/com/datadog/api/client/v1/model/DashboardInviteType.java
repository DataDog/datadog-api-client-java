...
public class DashboardInviteType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("public_dashboard_invitation"));

  public static final DashboardInviteType PUBLIC_DASHBOARD_INVITATION = new DashboardInviteType("public_dashboard_invitation");
  ...
  public static class DashboardInviteTypeSerializer extends StdSerializer<DashboardInviteType> {
      ...
      @Override
      public void serialize(DashboardInviteType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
