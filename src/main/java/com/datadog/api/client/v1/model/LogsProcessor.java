...
public class LogsProcessor extends AbstractOpenApiSchema {
    ...
    public static class LogsProcessorDeserializer extends StdDeserializer<LogsProcessor> {
        ...
        public LogsProcessor deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            // deserialize LogsExcludeAttributeProcessor
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (LogsExcludeAttributeProcessor.class.equals(Integer.class) || LogsExcludeAttributeProcessor.class.equals(Long.class) || LogsExcludeAttributeProcessor.class.equals(Float.class) || LogsExcludeAttributeProcessor.class.equals(Double.class) || LogsExcludeAttributeProcessor.class.equals(Boolean.class) || LogsExcludeAttributeProcessor.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((LogsExcludeAttributeProcessor.class.equals(Integer.class) || LogsExcludeAttributeProcessor.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((LogsExcludeAttributeProcessor.class.equals(Float.class) || LogsExcludeAttributeProcessor.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (LogsExcludeAttributeProcessor.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (LogsExcludeAttributeProcessor.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(LogsExcludeAttributeProcessor.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    if (!((LogsExcludeAttributeProcessor) tmp).unparsed) {
                        deserialized = tmp;
                        match++;
                    }
                    log.log(Level.FINER, "Input data matches schema 'LogsExcludeAttributeProcessor'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (LogsArrayMapProcessor.class.equals(Integer.class) || LogsArrayMapProcessor.class.equals(Long.class) || LogsArrayMapProcessor.class.equals(Float.class) || LogsArrayMapProcessor.class.equals(Double.class) || LogsArrayMapProcessor.class.equals(Boolean.class) || LogsArrayMapProcessor.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((LogsArrayMapProcessor.class.equals(Integer.class) || LogsArrayMapProcessor.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((LogsArrayMapProcessor.class.equals(Float.class) || LogsArrayMapProcessor.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (LogsArrayMapProcessor.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (LogsArrayMapProcessor.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
    ...
    public LogsProcessor(LogsExcludeAttributeProcessor o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("LogsExcludeAttributeProcessor", new GenericType<LogsExcludeAttributeProcessor>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(LogsExcludeAttributeProcessor.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `LogsExcludeAttributeProcessor`. If the actual instance is not `LogsExcludeAttributeProcessor`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `LogsExcludeAttributeProcessor`
     * @throws ClassCastException if the instance is not `LogsExcludeAttributeProcessor`
     */
    public LogsExcludeAttributeProcessor getLogsExcludeAttributeProcessor() throws ClassCastException {
        return (LogsExcludeAttributeProcessor)super.getActualInstance();
    }

    /**
     * Get the actual instance of `LogsArrayMapProcessor`. If the actual instance is not `LogsArrayMapProcessor`,
     * the ClassCastException will be thrown.
     *
