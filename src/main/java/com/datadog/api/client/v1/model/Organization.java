...
public class Organization {
  ...
  **/
  ...
  /**
   * <p>Date of the organization creation.</p>
   * @return created
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The name of the child organization, limited to 32 characters.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The <code>public_id</code> of the organization you are operating within.</p>
   * @return publicId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Only available for MSP customers. Allows child organizations to be created on a trial plan.</p>
   * @return trial
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billing, organization.billing) && Objects.equals(this.created, organization.created) && Objects.equals(this.description, organization.description) && Objects.equals(this.name, organization.name) && Objects.equals(this.publicId, organization.publicId) && Objects.equals(this.settings, organization.settings) && Objects.equals(this.subscription, organization.subscription) && Objects.equals(this.trial, organization.trial) && Objects.equals(this.additionalProperties, organization.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(billing,created,description,name,publicId,settings,subscription,trial, additionalProperties);
  }
