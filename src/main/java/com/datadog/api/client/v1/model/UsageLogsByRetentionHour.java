...
public class UsageLogsByRetentionHour {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LIVE_INDEXED_EVENTS_COUNT)public void setLiveIndexedEventsCount_JsonNullable(JsonNullable<Long> liveIndexedEventsCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REHYDRATED_INDEXED_EVENTS_COUNT)public void setRehydratedIndexedEventsCount_JsonNullable(JsonNullable<Long> rehydratedIndexedEventsCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RETENTION)public void setRetention_JsonNullable(JsonNullable<String> retention) {
