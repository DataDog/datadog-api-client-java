...
/**
   * <p>Cloud Security Management Pro usage for a given organization for a given hour.</p>
 */
@JsonPropertyOrder({
...
public class UsageCloudSecurityPostureManagementHour {
  ...
  /**
   * <p>The number of Cloud Security Management Pro Azure app services hosts during a given hour.</p>
   * @return aasHostCount
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AAS_HOST_COUNT)public void setAasHostCount_JsonNullable(JsonNullable<Double> aasHostCount) {
  ...
  /**
   * <p>The number of Cloud Security Management Pro AWS hosts during a given hour.</p>
   * @return awsHostCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_AWS_HOST_COUNT)public void setAwsHostCount_JsonNullable(JsonNullable<Double> awsHostCount) {
  ...
  /**
   * <p>The number of Cloud Security Management Pro Azure hosts during a given hour.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AZURE_HOST_COUNT)public void setAzureHostCount_JsonNullable(JsonNullable<Double> azureHostCount) {
  ...
  /**
   * <p>The number of Cloud Security Management Pro hosts during a given hour.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_COMPLIANCE_HOST_COUNT)public void setComplianceHostCount_JsonNullable(JsonNullable<Double> complianceHostCount) {
  ...
  /**
   * <p>The total number of Cloud Security Management Pro containers during a given hour.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CONTAINER_COUNT)public void setContainerCount_JsonNullable(JsonNullable<Double> containerCount) {
  ...
  /**
   * <p>The number of Cloud Security Management Pro GCP hosts during a given hour.</p>
   * @return gcpHostCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_GCP_HOST_COUNT)public void setGcpHostCount_JsonNullable(JsonNullable<Double> gcpHostCount) {
  ...
  /**
   * <p>The total number of Cloud Security Management Pro hosts during a given hour.</p>
   * @return hostCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_HOST_COUNT)public void setHostCount_JsonNullable(JsonNullable<Double> hostCount) {
