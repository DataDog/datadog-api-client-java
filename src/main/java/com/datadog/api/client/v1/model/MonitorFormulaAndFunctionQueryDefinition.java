...
public class MonitorFormulaAndFunctionQueryDefinition extends AbstractOpenApiSchema {
    ...
    public static class MonitorFormulaAndFunctionQueryDefinitionDeserializer extends StdDeserializer<MonitorFormulaAndFunctionQueryDefinition> {
        ...
        public MonitorFormulaAndFunctionQueryDefinition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Long.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Double.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Boolean.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (MonitorFormulaAndFunctionDataJobsQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(MonitorFormulaAndFunctionDataJobsQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'MonitorFormulaAndFunctionDataJobsQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'MonitorFormulaAndFunctionDataJobsQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Long.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Double.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Boolean.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Long.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Double.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Boolean.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Integer.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Float.class) || MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'MonitorFormulaAndFunctionAggregateFilteredQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'MonitorFormulaAndFunctionAggregateFilteredQueryDefinition'", e);
            }
    ...
    public MonitorFormulaAndFunctionQueryDefinition(MonitorFormulaAndFunctionDataJobsQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public MonitorFormulaAndFunctionQueryDefinition(MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public MonitorFormulaAndFunctionQueryDefinition(MonitorFormulaAndFunctionAggregateFilteredQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("MonitorFormulaAndFunctionDataJobsQueryDefinition", new GenericType<MonitorFormulaAndFunctionDataJobsQueryDefinition>() {
        });
        schemas.put("MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition", new GenericType<MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition>() {
        });
        schemas.put("MonitorFormulaAndFunctionAggregateFilteredQueryDefinition", new GenericType<MonitorFormulaAndFunctionAggregateFilteredQueryDefinition>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(MonitorFormulaAndFunctionDataJobsQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(MonitorFormulaAndFunctionAggregateFilteredQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * MonitorFormulaAndFunctionEventQueryDefinition, MonitorFormulaAndFunctionCostQueryDefinition, MonitorFormulaAndFunctionDataQualityQueryDefinition, MonitorFormulaAndFunctionDataJobsQueryDefinition, MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition, MonitorFormulaAndFunctionAggregateFilteredQueryDefinition
     *
     * @return The actual instance (MonitorFormulaAndFunctionEventQueryDefinition, MonitorFormulaAndFunctionCostQueryDefinition, MonitorFormulaAndFunctionDataQualityQueryDefinition, MonitorFormulaAndFunctionDataJobsQueryDefinition, MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition, MonitorFormulaAndFunctionAggregateFilteredQueryDefinition)
     */
    @Override
    ...
    /**
     * Get the actual instance of `MonitorFormulaAndFunctionDataJobsQueryDefinition`. If the actual instance is not `MonitorFormulaAndFunctionDataJobsQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MonitorFormulaAndFunctionDataJobsQueryDefinition`
     * @throws ClassCastException if the instance is not `MonitorFormulaAndFunctionDataJobsQueryDefinition`
     */
    public MonitorFormulaAndFunctionDataJobsQueryDefinition getMonitorFormulaAndFunctionDataJobsQueryDefinition() throws ClassCastException {
        return (MonitorFormulaAndFunctionDataJobsQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition`. If the actual instance is not `MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition`
     * @throws ClassCastException if the instance is not `MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition`
     */
    public MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition getMonitorFormulaAndFunctionAggregateAugmentedQueryDefinition() throws ClassCastException {
        return (MonitorFormulaAndFunctionAggregateAugmentedQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `MonitorFormulaAndFunctionAggregateFilteredQueryDefinition`. If the actual instance is not `MonitorFormulaAndFunctionAggregateFilteredQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public MonitorFormulaAndFunctionAggregateFilteredQueryDefinition getMonitorFormulaAndFunctionAggregateFilteredQueryDefinition() throws ClassCastException {
