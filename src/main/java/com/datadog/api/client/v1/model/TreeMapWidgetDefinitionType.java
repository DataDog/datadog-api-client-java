...
public class TreeMapWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final TreeMapWidgetDefinitionType TREEMAP = new TreeMapWidgetDefinitionType("treemap");
  ...
  public static class TreeMapWidgetDefinitionTypeSerializer extends StdSerializer<TreeMapWidgetDefinitionType> {
      ...
      @Override
      public void serialize(TreeMapWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
