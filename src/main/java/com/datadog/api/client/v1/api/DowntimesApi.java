 ...
 */
  ...
  public CompletableFuture<ApiResponse<Void>> cancelDowntimeWithHttpInfoAsync(Long downtimeId) {
    ...
    try {
      builder = apiClient.createBuilder("DowntimesApi.cancelDowntime", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<CanceledDowntimesIds>> cancelDowntimesByScopeWithHttpInfoAsync(CancelDowntimesByScopeRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.cancelDowntimesByScope", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CanceledDowntimesIds>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Downtime>> createDowntimeWithHttpInfoAsync(Downtime body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.createDowntime", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Downtime>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Downtime>> getDowntimeWithHttpInfoAsync(Long downtimeId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.getDowntime", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Downtime>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<List<Downtime>>> listDowntimesWithHttpInfoAsync(ListDowntimesOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.listDowntimes", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  public CompletableFuture<ApiResponse<List<Downtime>>> listMonitorDowntimesWithHttpInfoAsync(Long monitorId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.listMonitorDowntimes", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<List<Downtime>>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Downtime>> updateDowntimeWithHttpInfoAsync(Long downtimeId, Downtime body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DowntimesApi.updateDowntime", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Downtime>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
