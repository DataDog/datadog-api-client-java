 ...
 */
@JsonPropertyOrder({
  SyntheticsTestCiOptions.JSON_PROPERTY_EXECUTION_RULE
})
...
public class SyntheticsTestCiOptions {
  ...
  @JsonCreator
  public SyntheticsTestCiOptions(
            @JsonProperty(required=true, value=JSON_PROPERTY_EXECUTION_RULE)SyntheticsTestExecutionRule executionRule) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.executionRule, syntheticsTestCiOptions.executionRule) && Objects.equals(this.additionalProperties, syntheticsTestCiOptions.additionalProperties);
  }
