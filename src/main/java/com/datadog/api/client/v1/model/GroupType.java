 ...
 */
@JsonSerialize(using = GroupType.GroupTypeSerializer.class)
public class GroupType extends ModelEnum<String> {
  ...
  public static class GroupTypeSerializer extends StdSerializer<GroupType> {
      public GroupTypeSerializer(Class<GroupType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(GroupType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
