...
/**
   * <p>Response from the delete dashboard call.</p>
 */
@JsonPropertyOrder({
  DashboardDeleteResponse.JSON_PROPERTY_DELETED_DASHBOARD_ID
})
...
public class DashboardDeleteResponse {
  ...
  /**
   * <p>ID of the deleted dashboard.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public DashboardDeleteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deletedDashboardId, dashboardDeleteResponse.deletedDashboardId) && Objects.equals(this.additionalProperties, dashboardDeleteResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(deletedDashboardId, additionalProperties);
  }
