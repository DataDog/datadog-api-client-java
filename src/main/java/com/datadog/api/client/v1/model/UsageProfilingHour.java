...
public class UsageProfilingHour {
  ...
  /**
   * <p>Contains the total number of profiled Azure app services reporting during a given hour.</p>
   * @return aasCount
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AAS_COUNT)public void setAasCount_JsonNullable(JsonNullable<Long> aasCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AVG_CONTAINER_AGENT_COUNT)public void setAvgContainerAgentCount_JsonNullable(JsonNullable<Long> avgContainerAgentCount) {
