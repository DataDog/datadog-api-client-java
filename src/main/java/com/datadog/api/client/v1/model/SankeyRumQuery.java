...
/**
   * <p>Query configuration for Product Analytics or RUM Sankey widget.</p>
 */
@JsonPropertyOrder({
...
public class SankeyRumQuery {
  ...
  **/
  ...
  /**
   * <p>Product Analytics or RUM data source type.</p>
   * @return dataSource
  **/
  ...
  **/
  ...
  /**
   * <p>Sankey mode for Product Analytics or RUM queries.</p>
   * @return mode
  **/
