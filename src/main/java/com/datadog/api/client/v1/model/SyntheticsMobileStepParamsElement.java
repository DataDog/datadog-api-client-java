...
/** The definition of <code>SyntheticsMobileStepParamsElement</code> object. */
@JsonPropertyOrder({
...
public class SyntheticsMobileStepParamsElement {
  ...
  /**
   * The <code>element</code> <code>context</code>.
   *
   * @return context
   */
  ...
  public SyntheticsMobileStepParamsElement contextType(
      SyntheticsMobileStepParamsElementContextType contextType) {
  ...
  /**
   * The definition of <code>SyntheticsMobileStepParamsElementContextType</code> object.
   *
   * @return contextType
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>element</code> <code>elementDescription</code>.
   *
  ...
  /**
   * The <code>element</code> <code>multiLocator</code>.
   *
   * @return multiLocator
   */
  @jakarta.annotation.Nullable
  ...
  public SyntheticsMobileStepParamsElement relativePosition(
  ...
  /**
   * The definition of <code>SyntheticsMobileStepParamsElementRelativePosition</code> object.
   *
  ...
  /**
   * The <code>element</code> <code>textContent</code>.
   *
   * @return textContent
   */
  @jakarta.annotation.Nullable
  ...
  public SyntheticsMobileStepParamsElement userLocator(
      SyntheticsMobileStepParamsElementUserLocator userLocator) {
  ...
  /**
   * The <code>element</code> <code>viewName</code>.
   *
   * @return viewName
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsMobileStepParamsElement syntheticsMobileStepParamsElement =
        (SyntheticsMobileStepParamsElement) o;
    return Objects.equals(this.context, syntheticsMobileStepParamsElement.context)
        && Objects.equals(this.contextType, syntheticsMobileStepParamsElement.contextType)
        && Objects.equals(
            this.elementDescription, syntheticsMobileStepParamsElement.elementDescription)
        && Objects.equals(this.multiLocator, syntheticsMobileStepParamsElement.multiLocator)
        && Objects.equals(this.relativePosition, syntheticsMobileStepParamsElement.relativePosition)
        && Objects.equals(this.textContent, syntheticsMobileStepParamsElement.textContent)
        && Objects.equals(this.userLocator, syntheticsMobileStepParamsElement.userLocator)
        && Objects.equals(this.viewName, syntheticsMobileStepParamsElement.viewName)
        && Objects.equals(
            this.additionalProperties, syntheticsMobileStepParamsElement.additionalProperties);
  }
