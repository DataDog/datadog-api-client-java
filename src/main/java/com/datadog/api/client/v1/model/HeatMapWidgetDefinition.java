...
public class HeatMapWidgetDefinition {
  ...
  private HeatMapWidgetYAxis yaxis;
  ...
  public HeatMapWidgetDefinition yaxis(HeatMapWidgetYAxis yaxis) {
    this.yaxis = yaxis;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public HeatMapWidgetYAxis getYaxis() {
    return yaxis;
  }

  public void setYaxis(HeatMapWidgetYAxis yaxis) {
    this.yaxis = yaxis;
  }
