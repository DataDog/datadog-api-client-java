...
public class SyntheticsMobileTestType extends ModelEnum<String> {
  ...
  public static class SyntheticsMobileTestTypeSerializer extends StdSerializer<SyntheticsMobileTestType> {
      ...
      @Override
      public void serialize(SyntheticsMobileTestType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
