...
/**
   * <p>Response containing the number of RUM Units for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class UsageRumUnitsResponse {
  ...
  /**
   * <p>Get hourly usage for RUM Units.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageRumUnitsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageRumUnitsResponse.usage) && Objects.equals(this.additionalProperties, usageRumUnitsResponse.additionalProperties);
  }
