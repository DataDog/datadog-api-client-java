...
public class NumberFormatUnitScaleType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("canonical_unit"));
  ...
  public static class NumberFormatUnitScaleTypeSerializer extends StdSerializer<NumberFormatUnitScaleType> {
      ...
      @Override
      public void serialize(NumberFormatUnitScaleType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
