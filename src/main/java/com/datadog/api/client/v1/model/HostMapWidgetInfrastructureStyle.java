...
public class HostMapWidgetInfrastructureStyle {
  ...
  /**
   * <p>Maximum value for the fill color scale. Omit to use automatic scaling.</p>
   * @return fillMax
  **/
  ...
  /**
   * <p>Minimum value for the fill color scale. Omit to use automatic scaling.</p>
   * @return fillMin
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Color palette name or alias.</p>
   * @return palette
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to invert the color palette.</p>
   * @return paletteFlip
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    HostMapWidgetInfrastructureStyle hostMapWidgetInfrastructureStyle = (HostMapWidgetInfrastructureStyle) o;
    return Objects.equals(this.fillMax, hostMapWidgetInfrastructureStyle.fillMax) && Objects.equals(this.fillMin, hostMapWidgetInfrastructureStyle.fillMin) && Objects.equals(this.palette, hostMapWidgetInfrastructureStyle.palette) && Objects.equals(this.paletteFlip, hostMapWidgetInfrastructureStyle.paletteFlip) && Objects.equals(this.additionalProperties, hostMapWidgetInfrastructureStyle.additionalProperties);
  }
