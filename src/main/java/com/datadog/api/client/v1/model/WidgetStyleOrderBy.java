...
public class WidgetStyleOrderBy extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("tags", "values"));
  ...
  public static class WidgetStyleOrderBySerializer extends StdSerializer<WidgetStyleOrderBy> {
      ...
      @Override
      public void serialize(WidgetStyleOrderBy value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
