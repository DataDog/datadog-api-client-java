...
public class QueryValueWidgetDefinition {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoscale,customLinks,customUnit,description,precision,requests,textAlign,time,timeseriesBackground,title,titleAlign,titleSize,type, additionalProperties);
  }
