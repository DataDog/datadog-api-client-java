...
public class DistributionPointsType extends ModelEnum<String> {
  ...
  public static final DistributionPointsType DISTRIBUTION = new DistributionPointsType("distribution");
  ...
  public static class DistributionPointsTypeSerializer extends StdSerializer<DistributionPointsType> {
      ...
      @Override
      public void serialize(DistributionPointsType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
