...
/**
   * <p>Supported metrics for monthly usage attribution requests. Usage types are in the format <code>&lt;usage_type&gt;_usage</code>.
...
public class MonthlyUsageAttributionSupportedMetrics extends ModelEnum<String> {
  ...
  public static final MonthlyUsageAttributionSupportedMetrics INFRA_HOST_BASIC_USAGE = new MonthlyUsageAttributionSupportedMetrics("infra_host_basic_usage");
  public static final MonthlyUsageAttributionSupportedMetrics INFRA_HOST_BASIC_PERCENTAGE = new MonthlyUsageAttributionSupportedMetrics("infra_host_basic_percentage");
  ...
  public static final MonthlyUsageAttributionSupportedMetrics SERVERLESS_APPS_APM_USAGE = new MonthlyUsageAttributionSupportedMetrics("serverless_apps_apm_usage");
  public static final MonthlyUsageAttributionSupportedMetrics SERVERLESS_APPS_APM_PERCENTAGE = new MonthlyUsageAttributionSupportedMetrics("serverless_apps_apm_percentage");
  ...
  public static final MonthlyUsageAttributionSupportedMetrics SIEM_12MO_RETENTION_USAGE = new MonthlyUsageAttributionSupportedMetrics("siem_12mo_retention_usage");
  public static final MonthlyUsageAttributionSupportedMetrics SIEM_12MO_RETENTION_PERCENTAGE = new MonthlyUsageAttributionSupportedMetrics("siem_12mo_retention_percentage");
  public static final MonthlyUsageAttributionSupportedMetrics SIEM_6MO_RETENTION_USAGE = new MonthlyUsageAttributionSupportedMetrics("siem_6mo_retention_usage");
  public static final MonthlyUsageAttributionSupportedMetrics SIEM_6MO_RETENTION_PERCENTAGE = new MonthlyUsageAttributionSupportedMetrics("siem_6mo_retention_percentage");
