...
/**
   * <p>Response containing the audit logs usage for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
  UsageAuditLogsResponse.JSON_PROPERTY_USAGE
})
...
public class UsageAuditLogsResponse {
  ...
  /**
   * <p>Get hourly usage for audit logs.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageAuditLogsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageAuditLogsResponse.usage) && Objects.equals(this.additionalProperties, usageAuditLogsResponse.additionalProperties);
  }
