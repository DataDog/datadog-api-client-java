...
/**
   * <p>Configuration settings applied to resources from the specified Azure resource provider.</p>
 */
@JsonPropertyOrder({
...
public class ResourceProviderConfig {
  ...
  /**
   * <p>Collect metrics for resources from this provider.</p>
  ...
  **/
  ...
  /**
   * <p>The provider namespace to apply this configuration to.</p>
   * @return namespace
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metricsEnabled, resourceProviderConfig.metricsEnabled) && Objects.equals(this.namespace, resourceProviderConfig.namespace) && Objects.equals(this.additionalProperties, resourceProviderConfig.additionalProperties);
  }
