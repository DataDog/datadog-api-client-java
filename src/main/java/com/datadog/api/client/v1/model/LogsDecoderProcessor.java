...
/**
   * <p>The decoder processor decodes any source attribute containing a
   * base64/base16-encoded UTF-8/ASCII string back to its original value, storing the
   * result in a target attribute.</p>
 */
@JsonPropertyOrder({
...
public class LogsDecoderProcessor {
  ...
  @JsonCreator
  public LogsDecoderProcessor(
            @JsonProperty(required=true, value=JSON_PROPERTY_BINARY_TO_TEXT_ENCODING)LogsDecoderProcessorBinaryToTextEncoding binaryToTextEncoding,
            @JsonProperty(required=true, value=JSON_PROPERTY_INPUT_REPRESENTATION)LogsDecoderProcessorInputRepresentation inputRepresentation,
  ...
  **/
  ...
  /**
   * <p>Whether the processor is enabled.</p>
   * @return isEnabled
  **/
  ...
  **/
  ...
  /**
   * <p>Name of the log attribute with the encoded data.</p>
   * @return source
  **/
  ...
  /**
   * <p>Name of the log attribute that contains the decoded data.</p>
   * @return target
  **/
  ...
  /**
   * <p>Type of logs decoder processor.</p>
   * @return type
  **/
