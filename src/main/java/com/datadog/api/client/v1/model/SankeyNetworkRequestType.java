...
public class SankeyNetworkRequestType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("netflow_sankey"));

  public static final SankeyNetworkRequestType NETFLOW_SANKEY = new SankeyNetworkRequestType("netflow_sankey");
  ...
  public static class SankeyNetworkRequestTypeSerializer extends StdSerializer<SankeyNetworkRequestType> {
      ...
      @Override
      public void serialize(SankeyNetworkRequestType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
