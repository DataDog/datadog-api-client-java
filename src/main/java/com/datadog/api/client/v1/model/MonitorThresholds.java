...
public class MonitorThresholds {
  ...
  **/
  ...
  /**
   * <p>Query evaluated as a dynamic <code>CRITICAL</code> threshold. Only supported on metric monitors with a formula query and options['variables']. Cannot be combined with static thresholds. This field is in preview.</p>
  ...
  **/
  ...
  /**
   * <p>Query evaluated as a dynamic <code>CRITICAL</code> recovery threshold. Only supported on metric monitors with a formula query and options['variables']. Cannot be combined with static thresholds. This field is in preview.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.critical, monitorThresholds.critical) && Objects.equals(this.criticalQuery, monitorThresholds.criticalQuery) && Objects.equals(this.criticalRecovery, monitorThresholds.criticalRecovery) && Objects.equals(this.criticalRecoveryQuery, monitorThresholds.criticalRecoveryQuery) && Objects.equals(this.ok, monitorThresholds.ok) && Objects.equals(this.unknown, monitorThresholds.unknown) && Objects.equals(this.warning, monitorThresholds.warning) && Objects.equals(this.warningRecovery, monitorThresholds.warningRecovery) && Objects.equals(this.additionalProperties, monitorThresholds.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(critical,criticalQuery,criticalRecovery,criticalRecoveryQuery,ok,unknown,warning,warningRecovery, additionalProperties);
  }
