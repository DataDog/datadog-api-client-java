...
public class PointPlotWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final PointPlotWidgetDefinitionType POINT_PLOT = new PointPlotWidgetDefinitionType("point_plot");
  ...
  public static class PointPlotWidgetDefinitionTypeSerializer extends StdSerializer<PointPlotWidgetDefinitionType> {
      ...
      @Override
      public void serialize(PointPlotWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
