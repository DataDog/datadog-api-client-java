...
public class ListStreamResponseFormat {
  ...
  public static class ListStreamResponseFormatSerializer extends StdSerializer<ListStreamResponseFormat> {
      ...
      @Override
      public void serialize(ListStreamResponseFormat value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
  ...
  /**
   * Return true if this ListStreamResponseFormat object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((ListStreamResponseFormat) o).value);
  }
