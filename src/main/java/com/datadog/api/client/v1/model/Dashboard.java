...
public class Dashboard {
  ...
  **/
  ...
  /**
   * <p>The default timeframe applied when opening the dashboard. Set to <code>null</code> to clear the dashboard's default timeframe.</p>
  ...
  **/
  ...
  /**
   * <p>Whether this dashboard is read-only. If True, only the author and admins can make changes to it.</p>
   * <p>This property is deprecated; please use the <a href="https://docs.datadoghq.com/api/latest/restriction-policies/">Restriction Policies API</a> instead to manage write authorization for individual dashboards.</p>
   * @return isReadOnly
   * @deprecated
  **/
      @Deprecated
  ...
  **/
  ...
  /**
   * <p>List of tabs for organizing dashboard widgets into groups.</p>
   * @return tabs
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_TABS)public void setTabs_JsonNullable(JsonNullable<List<DashboardTab>> tabs) {
    this.tabs = tabs;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorHandle, dashboard.authorHandle) && Objects.equals(this.authorName, dashboard.authorName) && Objects.equals(this.createdAt, dashboard.createdAt) && Objects.equals(this.defaultTimeframe, dashboard.defaultTimeframe) && Objects.equals(this.description, dashboard.description) && Objects.equals(this.id, dashboard.id) && Objects.equals(this.isReadOnly, dashboard.isReadOnly) && Objects.equals(this.layoutType, dashboard.layoutType) && Objects.equals(this.modifiedAt, dashboard.modifiedAt) && Objects.equals(this.notifyList, dashboard.notifyList) && Objects.equals(this.reflowType, dashboard.reflowType) && Objects.equals(this.restrictedRoles, dashboard.restrictedRoles) && Objects.equals(this.tabs, dashboard.tabs) && Objects.equals(this.tags, dashboard.tags) && Objects.equals(this.templateVariablePresets, dashboard.templateVariablePresets) && Objects.equals(this.templateVariables, dashboard.templateVariables) && Objects.equals(this.title, dashboard.title) && Objects.equals(this.url, dashboard.url) && Objects.equals(this.widgets, dashboard.widgets) && Objects.equals(this.additionalProperties, dashboard.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(authorHandle,authorName,createdAt,defaultTimeframe,description,id,isReadOnly,layoutType,modifiedAt,notifyList,reflowType,restrictedRoles,tabs,tags,templateVariablePresets,templateVariables,title,url,widgets, additionalProperties);
  }
