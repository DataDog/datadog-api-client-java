...
public class Dashboard {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authorHandle,authorName,createdAt,description,id,isReadOnly,layoutType,modifiedAt,notifyList,reflowType,restrictedRoles,tabs,tags,templateVariablePresets,templateVariables,title,url,widgets, additionalProperties);
  }
