...
public class MonitorFormulaAndFunctionDataQualityModelConfiguration {
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration autoResolveDays(
      Integer autoResolveDays) {
    this.autoResolveDays = autoResolveDays;
    return this;
  }

  /**
   * Number of days after which an open alert is automatically resolved. When unset, alerts stay
   * open until the measure returns within bounds. minimum: 1 maximum: 365
   *
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration enableFlatlineDetection(
      Boolean enableFlatlineDetection) {
    this.enableFlatlineDetection = enableFlatlineDetection;
    return this;
  }

  /**
   * Whether to alert when the measure stops changing entirely. Defaults to <code>true</code>.
   *
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration function(
      MonitorFormulaAndFunctionDataQualityDiffFunction function) {
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration minLowerBoundSize(
  ...
  /**
   * Minimum distance between the predicted value and the lower bound. Widening the lower bound to
   * at least this size suppresses alerts on small downward deviations. When unset, no minimum is
   * enforced.
   *
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration minUpperBoundSize(
  ...
  /**
   * Minimum distance between the predicted value and the upper bound. Widening the upper bound to
   * at least this size suppresses alerts on small upward deviations. When unset, no minimum is
   * enforced.
   *
  ...
  public MonitorFormulaAndFunctionDataQualityModelConfiguration modelBoundsOverride(
      MonitorFormulaAndFunctionDataQualityModelBoundsOverride modelBoundsOverride) {
  ...
  public void setModelBoundsOverride(
      MonitorFormulaAndFunctionDataQualityModelBoundsOverride modelBoundsOverride) {
   ...
   */
  @JsonAnySetter
  public MonitorFormulaAndFunctionDataQualityModelConfiguration putAdditionalProperty(
  ...
  /**
   * Return true if this MonitorFormulaAndFunctionDataQualityModelConfiguration object is equal to
   * o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MonitorFormulaAndFunctionDataQualityModelConfiguration
        monitorFormulaAndFunctionDataQualityModelConfiguration =
            (MonitorFormulaAndFunctionDataQualityModelConfiguration) o;
    return Objects.equals(
            this.autoResolveDays,
            monitorFormulaAndFunctionDataQualityModelConfiguration.autoResolveDays)
        && Objects.equals(
            this.enableFlatlineDetection,
            monitorFormulaAndFunctionDataQualityModelConfiguration.enableFlatlineDetection)
        && Objects.equals(
            this.function, monitorFormulaAndFunctionDataQualityModelConfiguration.function)
        && Objects.equals(
            this.minLowerBoundSize,
            monitorFormulaAndFunctionDataQualityModelConfiguration.minLowerBoundSize)
        && Objects.equals(
            this.minUpperBoundSize,
            monitorFormulaAndFunctionDataQualityModelConfiguration.minUpperBoundSize)
        && Objects.equals(
            this.modelBoundsOverride,
            monitorFormulaAndFunctionDataQualityModelConfiguration.modelBoundsOverride)
        && Objects.equals(
            this.additionalProperties,
            monitorFormulaAndFunctionDataQualityModelConfiguration.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    enableFlatlineDetection: ")
        .append(toIndentedString(enableFlatlineDetection))
        .append("\n");
    ...
    sb.append("    modelBoundsOverride: ")
        .append(toIndentedString(modelBoundsOverride))
        .append("\n");
