...
public class UsageLogsHour {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BILLABLE_INGESTED_BYTES)public void setBillableIngestedBytes_JsonNullable(JsonNullable<Long> billableIngestedBytes) {
  ...
  **/
  ...
  /**
   * <p>Contains the number of logs forwarded bytes (data available as of April 1st 2023)</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOGS_FORWARDING_EVENTS_BYTES)public void setLogsForwardingEventsBytes_JsonNullable(JsonNullable<Long> logsForwardingEventsBytes) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOGS_LIVE_INDEXED_COUNT)public void setLogsLiveIndexedCount_JsonNullable(JsonNullable<Long> logsLiveIndexedCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOGS_LIVE_INGESTED_BYTES)public void setLogsLiveIngestedBytes_JsonNullable(JsonNullable<Long> logsLiveIngestedBytes) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOGS_REHYDRATED_INDEXED_COUNT)public void setLogsRehydratedIndexedCount_JsonNullable(JsonNullable<Long> logsRehydratedIndexedCount) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOGS_REHYDRATED_INGESTED_BYTES)public void setLogsRehydratedIngestedBytes_JsonNullable(JsonNullable<Long> logsRehydratedIngestedBytes) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    logsForwardingEventsBytes: ").append(toIndentedString(logsForwardingEventsBytes)).append("\n");
