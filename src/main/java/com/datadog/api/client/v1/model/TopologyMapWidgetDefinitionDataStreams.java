...
/**
   * <p>Topology map widget backed by the data streams data source.</p>
 */
@JsonPropertyOrder({
...
public class TopologyMapWidgetDefinitionDataStreams {
  ...
  @JsonCreator
  public TopologyMapWidgetDefinitionDataStreams(
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUESTS)List<TopologyRequestDataStreams> requests,
  ...
  public TopologyMapWidgetDefinitionDataStreams addCustomLinksItem(WidgetCustomLink customLinksItem) {
  ...
  **/
  ...
  public TopologyMapWidgetDefinitionDataStreams requests(List<TopologyRequestDataStreams> requests) {
    this.requests = requests;
    for (TopologyRequestDataStreams item : requests) {
      this.unparsed |= item.unparsed;
    }
  ...
  public TopologyMapWidgetDefinitionDataStreams addRequestsItem(TopologyRequestDataStreams requestsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TopologyMapWidgetDefinitionDataStreams topologyMapWidgetDefinitionDataStreams = (TopologyMapWidgetDefinitionDataStreams) o;
    return Objects.equals(this.customLinks, topologyMapWidgetDefinitionDataStreams.customLinks) && Objects.equals(this.description, topologyMapWidgetDefinitionDataStreams.description) && Objects.equals(this.requests, topologyMapWidgetDefinitionDataStreams.requests) && Objects.equals(this.time, topologyMapWidgetDefinitionDataStreams.time) && Objects.equals(this.title, topologyMapWidgetDefinitionDataStreams.title) && Objects.equals(this.titleAlign, topologyMapWidgetDefinitionDataStreams.titleAlign) && Objects.equals(this.titleSize, topologyMapWidgetDefinitionDataStreams.titleSize) && Objects.equals(this.type, topologyMapWidgetDefinitionDataStreams.type);
  }


  @Override
  public int hashCode() {
    return Objects.hash(customLinks,description,requests,time,title,titleAlign,titleSize,type);
  }
