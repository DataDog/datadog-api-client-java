...
public class SLOCorrectionResponseAttributes {
  ...
  **/
  ...
  /**
   * <p>ID of the single SLO that this correction applies to.</p>
   * @return sloId
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_SLO_ID)public void setSloId_JsonNullable(JsonNullable<String> sloId) {
    this.sloId = sloId;
  }
  ...
  /**
   * <p>Query that matches the SLOs this correction applies to.</p>
   * @return sloQuery
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_SLO_QUERY)public void setSloQuery_JsonNullable(JsonNullable<String> sloQuery) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category,createdAt,creator,description,duration,end,modifiedAt,modifier,rrule,sloId,sloQuery,start,timezone, additionalProperties);
  }
