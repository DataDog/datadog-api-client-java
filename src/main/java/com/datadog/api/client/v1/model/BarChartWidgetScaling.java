...
public class BarChartWidgetScaling extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("absolute", "relative"));
  ...
  public static class BarChartWidgetScalingSerializer extends StdSerializer<BarChartWidgetScaling> {
      ...
      @Override
      public void serialize(BarChartWidgetScaling value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
