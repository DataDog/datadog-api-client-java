...
/**
   * <p>Response containing the number of profiled hosts for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
  UsageProfilingResponse.JSON_PROPERTY_USAGE
})
...
public class UsageProfilingResponse {
  ...
  /**
   * <p>Get hourly usage for profiled hosts.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageProfilingResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageProfilingResponse.usage) && Objects.equals(this.additionalProperties, usageProfilingResponse.additionalProperties);
  }
