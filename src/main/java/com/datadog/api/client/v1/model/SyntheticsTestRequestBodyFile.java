...
/**
   * <p>Object describing a file to be used as part of the request in the test.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsTestRequestBodyFile {
  ...
  **/
  ...
  /**
   * <p>Encoding of the file content. The only supported value is <code>base64</code>, indicating the <code>content</code> field contains base64-encoded data.</p>
   * @return encoding
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bucketKey, syntheticsTestRequestBodyFile.bucketKey) && Objects.equals(this.content, syntheticsTestRequestBodyFile.content) && Objects.equals(this.encoding, syntheticsTestRequestBodyFile.encoding) && Objects.equals(this.name, syntheticsTestRequestBodyFile.name) && Objects.equals(this.originalFileName, syntheticsTestRequestBodyFile.originalFileName) && Objects.equals(this.size, syntheticsTestRequestBodyFile.size) && Objects.equals(this.type, syntheticsTestRequestBodyFile.type) && Objects.equals(this.additionalProperties, syntheticsTestRequestBodyFile.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(bucketKey,content,encoding,name,originalFileName,size,type, additionalProperties);
  }
