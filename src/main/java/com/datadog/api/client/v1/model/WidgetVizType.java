...
public class WidgetVizType {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("timeseries", "toplist"));
  ...
  public static class WidgetVizTypeSerializer extends StdSerializer<WidgetVizType> {
      ...
      @Override
      public void serialize(WidgetVizType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
  ...
  /**
   * Return true if this WidgetVizType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((WidgetVizType) o).value);
  }
