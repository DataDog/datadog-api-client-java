...
public class UsageAttributionSort {
  ...
  public static final UsageAttributionSort APM_FARGATE_USAGE = new UsageAttributionSort("apm_fargate_usage");
  public static final UsageAttributionSort APM_FARGATE_PERCENTAGE = new UsageAttributionSort("apm_fargate_percentage");
  public static final UsageAttributionSort APPSEC_FARGATE_USAGE = new UsageAttributionSort("appsec_fargate_usage");
  public static final UsageAttributionSort APPSEC_FARGATE_PERCENTAGE = new UsageAttributionSort("appsec_fargate_percentage");
  public static final UsageAttributionSort ESTIMATED_RUM_USAGE_ATTRIBUTION_USAGE = new UsageAttributionSort("estimated_rum_usage_attribution_usage");
  public static final UsageAttributionSort ESTIMATED_RUM_USAGE_ATTRIBUTION_PERCENTAGE = new UsageAttributionSort("estimated_rum_usage_attribution_percentage");
