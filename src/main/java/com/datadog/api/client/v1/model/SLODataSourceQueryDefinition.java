...
@JsonDeserialize(using = SLODataSourceQueryDefinition.SLODataSourceQueryDefinitionDeserializer.class)
@JsonSerialize(using = SLODataSourceQueryDefinition.SLODataSourceQueryDefinitionSerializer.class)
public class SLODataSourceQueryDefinition extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SLODataSourceQueryDefinition.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SLODataSourceQueryDefinitionSerializer extends StdSerializer<SLODataSourceQueryDefinition> {
        public SLODataSourceQueryDefinitionSerializer(Class<SLODataSourceQueryDefinition> t) {
            super(t);
        }

        public SLODataSourceQueryDefinitionSerializer() {
            this(null);
        }

        @Override
        public void serialize(SLODataSourceQueryDefinition value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SLODataSourceQueryDefinitionDeserializer extends StdDeserializer<SLODataSourceQueryDefinition> {
        public SLODataSourceQueryDefinitionDeserializer() {
            this(SLODataSourceQueryDefinition.class);
        }

        public SLODataSourceQueryDefinitionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SLODataSourceQueryDefinition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            SLODataSourceQueryDefinition ret = new SLODataSourceQueryDefinition();
            if (match == 1) {
         ...
         */
        @Override
        public SLODataSourceQueryDefinition getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SLODataSourceQueryDefinition cannot be null");
        }
    }
    ...
    public SLODataSourceQueryDefinition() {
        super("oneOf", Boolean.FALSE);
    }
    public SLODataSourceQueryDefinition(FormulaAndFunctionMetricQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SLODataSourceQueryDefinition.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return SLODataSourceQueryDefinition.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be FormulaAndFunctionMetricQueryDefinition");
    }
