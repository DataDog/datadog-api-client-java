...
public class LogsArithmeticProcessor {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.expression, logsArithmeticProcessor.expression)
        ...
        && Objects.equals(this.additionalProperties, logsArithmeticProcessor.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        expression, isEnabled, isReplaceMissing, name, target, type, additionalProperties);
  }
