...
public class FormulaAndFunctionSLOQueryDefinition {
  ...
  @JsonCreator
  public FormulaAndFunctionSLOQueryDefinition(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)FormulaAndFunctionSLODataSource dataSource,
            @JsonProperty(required=true, value=JSON_PROPERTY_MEASURE)FormulaAndFunctionSLOMeasure measure,
  ...
  public FormulaAndFunctionSLOQueryDefinition additionalQueryFilters(String additionalQueryFilters) {
  ...
  **/
  ...
  public FormulaAndFunctionSLOQueryDefinition dataSource(FormulaAndFunctionSLODataSource dataSource) {
    this.dataSource = dataSource;
    this.unparsed |= !dataSource.isValid();
    return this;
  }
  ...
  /**
   * <p>Data source for SLO measures queries.</p>
   * @return dataSource
  **/
  ...
  /**
   * <p>Group mode to query measures.</p>
   * @return groupMode
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>ID of an SLO to query measures.</p>
   * @return sloId
  **/
  ...
  public FormulaAndFunctionSLOQueryDefinition sloQueryType(FormulaAndFunctionSLOQueryType sloQueryType) {
