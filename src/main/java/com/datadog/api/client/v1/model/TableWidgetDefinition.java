...
/**
   * <p>The table visualization is available on dashboards. It displays columns of metrics grouped by tag key.</p>
 */
@JsonPropertyOrder({
...
public class TableWidgetDefinition {
  ...
  **/
  ...
  /**
   * <p>Controls the display of the search bar.</p>
   * @return hasSearchBar
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customLinks, tableWidgetDefinition.customLinks) && Objects.equals(this.description, tableWidgetDefinition.description) && Objects.equals(this.hasSearchBar, tableWidgetDefinition.hasSearchBar) && Objects.equals(this.requests, tableWidgetDefinition.requests) && Objects.equals(this.time, tableWidgetDefinition.time) && Objects.equals(this.title, tableWidgetDefinition.title) && Objects.equals(this.titleAlign, tableWidgetDefinition.titleAlign) && Objects.equals(this.titleSize, tableWidgetDefinition.titleSize) && Objects.equals(this.type, tableWidgetDefinition.type) && Objects.equals(this.additionalProperties, tableWidgetDefinition.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(customLinks,description,hasSearchBar,requests,time,title,titleAlign,titleSize,type, additionalProperties);
  }
