...
/**
   ...
   * See the <a href="https://docs.datadoghq.com/synthetics/browser_tests/actions/?tab=testanelementontheactivepage#variables">Recording Steps documentation</a>.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsBrowserVariable {
  ...
  **/
  ...
  /**
   * <p>Determines whether or not the browser test variable is obfuscated. Can only be used with browser variables of type <code>text</code>.</p>
   * @return secure
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.example, syntheticsBrowserVariable.example) && Objects.equals(this.id, syntheticsBrowserVariable.id) && Objects.equals(this.name, syntheticsBrowserVariable.name) && Objects.equals(this.pattern, syntheticsBrowserVariable.pattern) && Objects.equals(this.secure, syntheticsBrowserVariable.secure) && Objects.equals(this.type, syntheticsBrowserVariable.type) && Objects.equals(this.additionalProperties, syntheticsBrowserVariable.additionalProperties);
  }
