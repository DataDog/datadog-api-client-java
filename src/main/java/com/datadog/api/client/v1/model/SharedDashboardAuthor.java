...
public class SharedDashboardAuthor {
  ...
  /**
   * <p>Identifier of the user who shared the dashboard.</p>
   * @return handle
  **/
  ...
  /**
   * <p>Name of the user who shared the dashboard.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_NAME)private void setName_JsonNullable(JsonNullable<String> name) {
    this.name = name;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.handle, sharedDashboardAuthor.handle) && Objects.equals(this.name, sharedDashboardAuthor.name) && Objects.equals(this.additionalProperties, sharedDashboardAuthor.additionalProperties);
  }
