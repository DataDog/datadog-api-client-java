 ...
 */
@JsonPropertyOrder({
  LogsByRetentionOrgs.JSON_PROPERTY_USAGE
})
...
public class LogsByRetentionOrgs {
  ...
  /**
   * <p>Indexed logs usage summary for each organization.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public LogsByRetentionOrgs putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, logsByRetentionOrgs.usage) && Objects.equals(this.additionalProperties, logsByRetentionOrgs.additionalProperties);
  }
