...
public class DistributionPointItem extends AbstractOpenApiSchema {
    ...
    public static class DistributionPointItemSerializer extends StdSerializer<DistributionPointItem> {
        ...
        @Override
        public void serialize(DistributionPointItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DistributionPointItemDeserializer extends StdDeserializer<DistributionPointItem> {
        ...
        @Override
        public DistributionPointItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public DistributionPointItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
