...
public class GCPAccount {
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog performs configuration checks across your Google Cloud environment by continuously scanning every resource.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authProviderX509CertUrl,authUri,automute,clientEmail,clientId,clientX509CertUrl,errors,hostFilters,isCspmEnabled,privateKey,privateKeyId,projectId,tokenUri,type);
  }
