...
public class GCPAccount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authProviderX509CertUrl,authUri,automute,clientEmail,clientId,clientX509CertUrl,cloudRunRevisionFilters,errors,hostFilters,isCspmEnabled,isResourceChangeCollectionEnabled,isSecurityCommandCenterEnabled,monitoredResourceConfigs,privateKey,privateKeyId,projectId,resourceCollectionEnabled,tokenUri,type, additionalProperties);
  }
