...
/**
   * <p>An arithmetic sub-processor for use inside an array-map processor.
   * Unlike the top-level arithmetic processor, <code>is_enabled</code> is not supported.</p>
 */
@JsonPropertyOrder({
...
public class LogsArrayMapArithmeticSubProcessor {
  ...
  /**
   * <p>Arithmetic operation to perform.</p>
   * @return expression
  **/
  ...
  /**
   * <p>Replace missing attribute values with 0.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogsArrayMapArithmeticSubProcessor logsArrayMapArithmeticSubProcessor = (LogsArrayMapArithmeticSubProcessor) o;
    return Objects.equals(this.expression, logsArrayMapArithmeticSubProcessor.expression) && Objects.equals(this.isReplaceMissing, logsArrayMapArithmeticSubProcessor.isReplaceMissing) && Objects.equals(this.name, logsArrayMapArithmeticSubProcessor.name) && Objects.equals(this.target, logsArrayMapArithmeticSubProcessor.target) && Objects.equals(this.type, logsArrayMapArithmeticSubProcessor.type) && Objects.equals(this.additionalProperties, logsArrayMapArithmeticSubProcessor.additionalProperties);
  }
