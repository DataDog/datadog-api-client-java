...
public class ListStreamIssuePersona extends ModelEnum<String> {
  ...
  public static class ListStreamIssuePersonaSerializer extends StdSerializer<ListStreamIssuePersona> {
      ...
      @Override
      public void serialize(ListStreamIssuePersona value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
