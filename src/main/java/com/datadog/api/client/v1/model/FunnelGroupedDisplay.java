...
public class FunnelGroupedDisplay extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("stacked", "side_by_side"));
  ...
  public static class FunnelGroupedDisplaySerializer extends StdSerializer<FunnelGroupedDisplay> {
      ...
      @Override
      public void serialize(FunnelGroupedDisplay value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
