...
public class FormulaAndFunctionEventQueryDefinition {
  ...
  **/
  ...
  public FormulaAndFunctionEventQueryDefinition groupBy(FormulaAndFunctionEventQueryGroupByConfig groupBy) {
  ...
  /**
   * <p>Group by configuration for a formula and functions events query. Accepts either a list of facet objects or a flat object that specifies a list of facet fields.</p>
   * @return groupBy
  **/
      @jakarta.annotation.Nullable
