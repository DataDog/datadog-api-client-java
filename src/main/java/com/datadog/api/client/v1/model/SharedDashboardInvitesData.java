...
public class SharedDashboardInvitesData extends AbstractOpenApiSchema {
  ...
  public static class SharedDashboardInvitesDataSerializer
      extends StdSerializer<SharedDashboardInvitesData> {
    ...
    public void serialize(
        SharedDashboardInvitesData value, JsonGenerator jgen, SerializerProvider provider)
        throws IOException, JsonProcessingException {
      jgen.writeObject(value.getActualInstance());
    }
  }

  public static class SharedDashboardInvitesDataDeserializer
      extends StdDeserializer<SharedDashboardInvitesData> {
    ...
    @Override
    public SharedDashboardInvitesData deserialize(JsonParser jp, DeserializationContext ctxt)
        throws IOException, JsonProcessingException {
      ...
      try {
        ...
        if (SharedDashboardInvitesDataObject.class.equals(Integer.class)
            || SharedDashboardInvitesDataObject.class.equals(Long.class)
            || SharedDashboardInvitesDataObject.class.equals(Float.class)
            || SharedDashboardInvitesDataObject.class.equals(Double.class)
            || SharedDashboardInvitesDataObject.class.equals(Boolean.class)
            || SharedDashboardInvitesDataObject.class.equals(String.class)) {
          attemptParsing = typeCoercion;
          if (!attemptParsing) {
            attemptParsing |=
                ((SharedDashboardInvitesDataObject.class.equals(Integer.class)
                        || SharedDashboardInvitesDataObject.class.equals(Long.class))
    ...
    @Override
    public SharedDashboardInvitesData getNullValue(DeserializationContext ctxt)
  ...
  static {
    schemas.put(
        "SharedDashboardInvitesDataObject", new GenericType<SharedDashboardInvitesDataObject>() {});
    schemas.put(
        "List<SharedDashboardInvitesDataObject>",
        new GenericType<List<SharedDashboardInvitesDataObject>>() {});
    JSON.registerDescendants(
        SharedDashboardInvitesData.class, Collections.unmodifiableMap(schemas));
  }
   ...
   * against the oneOf child schemas: SharedDashboardInvitesDataObject,
   * List&lt;SharedDashboardInvitesDataObject&gt;
   *
  ...
  public void setActualInstance(Object instance) {
    if (JSON.isInstanceOf(
        SharedDashboardInvitesDataObject.class, instance, new HashSet<Class<?>>())) {
    ...
    throw new RuntimeException(
        "Invalid instance type. Must be SharedDashboardInvitesDataObject,"
            + " List<SharedDashboardInvitesDataObject>");
  }
   ...
   * List&lt;SharedDashboardInvitesDataObject&gt;
   *
   * @return The actual instance (SharedDashboardInvitesDataObject,
   *     List&lt;SharedDashboardInvitesDataObject&gt;)
   */
  @Override
  ...
  /**
   * Get the actual instance of `SharedDashboardInvitesDataObject`. If the actual instance is not
   * `SharedDashboardInvitesDataObject`, the ClassCastException will be thrown.
   *
   ...
   */
  public SharedDashboardInvitesDataObject getSharedDashboardInvitesDataObject()
      throws ClassCastException {
    return (SharedDashboardInvitesDataObject) super.getActualInstance();
  }

  /**
   * Get the actual instance of `List&lt;SharedDashboardInvitesDataObject&gt;`. If the actual
   * instance is not `List&lt;SharedDashboardInvitesDataObject&gt;`, the ClassCastException will be
   * thrown.
   *
