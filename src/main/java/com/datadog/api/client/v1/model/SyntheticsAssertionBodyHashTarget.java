...
/**
   * <p>An assertion which targets body hash.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsAssertionBodyHashTarget {
  ...
  @JsonCreator
  public SyntheticsAssertionBodyHashTarget(
            @JsonProperty(required=true, value=JSON_PROPERTY_OPERATOR)SyntheticsAssertionBodyHashOperator operator,
            @JsonProperty(required=true, value=JSON_PROPERTY_TARGET)SyntheticsAssertionTargetValue target,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SyntheticsAssertionBodyHashType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsAssertionBodyHashTarget syntheticsAssertionBodyHashTarget = (SyntheticsAssertionBodyHashTarget) o;
    return Objects.equals(this.operator, syntheticsAssertionBodyHashTarget.operator) && Objects.equals(this.target, syntheticsAssertionBodyHashTarget.target) && Objects.equals(this.type, syntheticsAssertionBodyHashTarget.type) && Objects.equals(this.additionalProperties, syntheticsAssertionBodyHashTarget.additionalProperties);
  }
