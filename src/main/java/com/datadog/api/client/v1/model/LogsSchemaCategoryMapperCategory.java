...
public class LogsSchemaCategoryMapperCategory {
  ...
  public boolean equals(Object o) {
    ...
    LogsSchemaCategoryMapperCategory logsSchemaCategoryMapperCategory =
        (LogsSchemaCategoryMapperCategory) o;
    return Objects.equals(this.filter, logsSchemaCategoryMapperCategory.filter)
        && Objects.equals(this.id, logsSchemaCategoryMapperCategory.id)
        && Objects.equals(this.name, logsSchemaCategoryMapperCategory.name)
        && Objects.equals(
            this.additionalProperties, logsSchemaCategoryMapperCategory.additionalProperties);
  }
