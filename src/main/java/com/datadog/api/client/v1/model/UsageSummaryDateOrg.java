...
public class UsageSummaryDateOrg {
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all audit logs lines indexed over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser lite sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser replay sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser RUM units over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management Azure app services hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management AWS hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management Azure hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Cloud Security Posture Management containers over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the high-water mark of Cloud Security Posture Management containers over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all log events indexed over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile lite sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions on Android over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions on iOS over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions on React Native over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM units over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Network flows indexed over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all distinct Networks hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all profiled hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile sessions and all browser lite and legacy sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser RUM Lite Sessions over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser and mobile RUM units over all hours in the current date for the given org.</p>
   * @return rumUnitsSum
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentHostTop99p,apmAzureAppServiceHostTop99p,apmHostTop99p,auditLogsLinesIndexedSum,avgProfiledFargateTasks,awsHostTop99p,awsLambdaFuncCount,awsLambdaInvocationsSum,azureAppServiceTop99p,billableIngestedBytesSum,browserRumLiteSessionCountSum,browserRumReplaySessionCountSum,browserRumUnitsSum,ciPipelineIndexedSpansSum,ciTestIndexedSpansSum,ciVisibilityPipelineCommittersHwm,ciVisibilityTestCommittersHwm,containerAvg,containerHwm,cspmAasHostTop99p,cspmAwsHostTop99p,cspmAzureHostTop99p,cspmContainerAvg,cspmContainerHwm,cspmHostTop99p,customTsAvg,cwsContainerCountAvg,cwsHostTop99p,dbmHostTop99pSum,dbmQueriesAvgSum,fargateTasksCountAvg,fargateTasksCountHwm,gcpHostTop99p,herokuHostTop99p,id,incidentManagementMonthlyActiveUsersHwm,indexedEventsCountSum,infraHostTop99p,ingestedEventsBytesSum,iotDeviceAggSum,iotDeviceTop99pSum,mobileRumLiteSessionCountSum,mobileRumSessionCountAndroidSum,mobileRumSessionCountIosSum,mobileRumSessionCountReactnativeSum,mobileRumSessionCountSum,mobileRumUnitsSum,name,netflowIndexedEventsCountSum,npmHostTop99p,observabilityPipelinesBytesProcessedSum,onlineArchiveEventsCountSum,opentelemetryHostTop99p,profilingHostTop99p,publicId,region,rumBrowserAndMobileSessionCount,rumSessionCountSum,rumTotalSessionCountSum,rumUnitsSum,sdsLogsScannedBytesSum,sdsTotalScannedBytesSum,syntheticsBrowserCheckCallsCountSum,syntheticsCheckCallsCountSum,traceSearchIndexedEventsCountSum,twolIngestedEventsBytesSum,vsphereHostTop99p);
  }
