...
public class UsageSummaryDateOrg {
  ...
  **/
  ...
  /**
   * <p>Shows the average of all APM ECS Fargate tasks over all hours in the current months for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all Application Security Monitoring ECS Fargate tasks over all hours in the current months for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Host count average of Cloud Cost Management for the given date and given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management GCP hosts over all hours in the current date for the given org.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions on Flutter over all hours in the current date for the given org.</p>
