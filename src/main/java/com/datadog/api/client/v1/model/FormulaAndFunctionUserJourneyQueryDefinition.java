...
@JsonPropertyOrder({
  ...
  FormulaAndFunctionUserJourneyQueryDefinition.JSON_PROPERTY_DATA_SOURCE,
  FormulaAndFunctionUserJourneyQueryDefinition.JSON_PROPERTY_GROUP_BY,
...
public class FormulaAndFunctionUserJourneyQueryDefinition {
  ...
  private List<UserJourneyFormulaGroupBy> groupBy = null;
  ...
  public String toString() {
    ...
    sb.append("class FormulaAndFunctionUserJourneyQueryDefinition {\n");
