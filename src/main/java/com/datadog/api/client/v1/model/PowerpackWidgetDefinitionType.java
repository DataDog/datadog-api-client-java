...
public class PowerpackWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final PowerpackWidgetDefinitionType POWERPACK = new PowerpackWidgetDefinitionType("powerpack");
  ...
  public static class PowerpackWidgetDefinitionTypeSerializer extends StdSerializer<PowerpackWidgetDefinitionType> {
      ...
      @Override
      public void serialize(PowerpackWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
