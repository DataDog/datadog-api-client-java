...
public class NotebookUpdateCell extends AbstractOpenApiSchema {
    ...
    public static class NotebookUpdateCellSerializer extends StdSerializer<NotebookUpdateCell> {
        ...
        @Override
        public void serialize(NotebookUpdateCell value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class NotebookUpdateCellDeserializer extends StdDeserializer<NotebookUpdateCell> {
        ...
        @Override
        public NotebookUpdateCell deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (NotebookCellCreateRequest.class.equals(Integer.class) || NotebookCellCreateRequest.class.equals(Long.class) || NotebookCellCreateRequest.class.equals(Float.class) || NotebookCellCreateRequest.class.equals(Double.class) || NotebookCellCreateRequest.class.equals(Boolean.class) || NotebookCellCreateRequest.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((NotebookCellCreateRequest.class.equals(Integer.class) || NotebookCellCreateRequest.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((NotebookCellCreateRequest.class.equals(Float.class) || NotebookCellCreateRequest.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (NotebookCellCreateRequest.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (NotebookCellCreateRequest.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (NotebookCellUpdateRequest.class.equals(Integer.class) || NotebookCellUpdateRequest.class.equals(Long.class) || NotebookCellUpdateRequest.class.equals(Float.class) || NotebookCellUpdateRequest.class.equals(Double.class) || NotebookCellUpdateRequest.class.equals(Boolean.class) || NotebookCellUpdateRequest.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((NotebookCellUpdateRequest.class.equals(Integer.class) || NotebookCellUpdateRequest.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((NotebookCellUpdateRequest.class.equals(Float.class) || NotebookCellUpdateRequest.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (NotebookCellUpdateRequest.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (NotebookCellUpdateRequest.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public NotebookUpdateCell getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * NotebookCellCreateRequest, NotebookCellUpdateRequest
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be NotebookCellCreateRequest, NotebookCellUpdateRequest");
    }
    ...
    /**
     * Get the actual instance of `NotebookCellCreateRequest`. If the actual instance is not `NotebookCellCreateRequest`,
    ...
    /**
     * Get the actual instance of `NotebookCellUpdateRequest`. If the actual instance is not `NotebookCellUpdateRequest`,
     * the ClassCastException will be thrown.
     *
