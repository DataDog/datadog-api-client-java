...
public class ScatterplotTableRequestType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("table", "data_projection"));
  ...
  public static class ScatterplotTableRequestTypeSerializer
      extends StdSerializer<ScatterplotTableRequestType> {
    public ScatterplotTableRequestTypeSerializer(Class<ScatterplotTableRequestType> t) {
      super(t);
    }
