...
/**
   * <p>Response containing the number of Fargate tasks run and hourly usage.</p>
 */
@JsonPropertyOrder({
...
public class UsageFargateResponse {
  ...
  /**
   * <p>Array with the number of hourly Fargate tasks recorded for a given organization.</p>
   * @return usage
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageFargateResponse.usage) && Objects.equals(this.additionalProperties, usageFargateResponse.additionalProperties);
  }
