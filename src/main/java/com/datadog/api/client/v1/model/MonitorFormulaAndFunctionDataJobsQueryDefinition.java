...
/**
   * <p>A formula and functions data jobs query.</p>
 */
@JsonPropertyOrder({
...
public class MonitorFormulaAndFunctionDataJobsQueryDefinition {
  ...
  /**
   * <p>The type of job being monitored. Valid values include:
   * <code>databricks.job</code>, <code>spark.application</code>, <code>airflow.dag</code>,
   * <code>dbt.job</code>, <code>dbt.model</code>, <code>dbt.test</code>, <code>glue.job</code>.
   * Custom job types are supported with the <code>custom.ol.</code> prefix.</p>
   * @return jobType
  **/
  ...
  /**
   * <p>Filter expression used to select the jobs to monitor.</p>
   * @return jobsQuery
  **/
  ...
  /**
   * <p>Name of the query for use in formulas. Must be <code>run_query</code>.</p>
   * @return name
  **/
  ...
  /**
   * <p>Query dialect for data jobs queries. Currently only <code>metric</code> is supported.</p>
   * @return queryDialect
  **/
   ...
   */
  @JsonAnySetter
  public MonitorFormulaAndFunctionDataJobsQueryDefinition putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorFormulaAndFunctionDataJobsQueryDefinition monitorFormulaAndFunctionDataJobsQueryDefinition = (MonitorFormulaAndFunctionDataJobsQueryDefinition) o;
    return Objects.equals(this.jobType, monitorFormulaAndFunctionDataJobsQueryDefinition.jobType) && Objects.equals(this.jobsQuery, monitorFormulaAndFunctionDataJobsQueryDefinition.jobsQuery) && Objects.equals(this.name, monitorFormulaAndFunctionDataJobsQueryDefinition.name) && Objects.equals(this.queryDialect, monitorFormulaAndFunctionDataJobsQueryDefinition.queryDialect) && Objects.equals(this.additionalProperties, monitorFormulaAndFunctionDataJobsQueryDefinition.additionalProperties);
  }
