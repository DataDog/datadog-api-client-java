...
/**
   * <p>The cohort widget visualizes user retention over time.</p>
 */
@JsonPropertyOrder({
...
public class CohortWidgetDefinition {
  ...
  @JsonCreator
  public CohortWidgetDefinition(
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUESTS)List<RetentionGridRequest> requests,
  ...
  **/
  ...
  /**
   * <p>List of Cohort widget requests.</p>
   * @return requests
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, cohortWidgetDefinition.description) && Objects.equals(this.requests, cohortWidgetDefinition.requests) && Objects.equals(this.time, cohortWidgetDefinition.time) && Objects.equals(this.title, cohortWidgetDefinition.title) && Objects.equals(this.titleAlign, cohortWidgetDefinition.titleAlign) && Objects.equals(this.titleSize, cohortWidgetDefinition.titleSize) && Objects.equals(this.type, cohortWidgetDefinition.type);
  }
