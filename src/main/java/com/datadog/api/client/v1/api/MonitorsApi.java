 ...
 */
   ...
   * </ul>
   * <p>To use a dynamic threshold on a metric monitor with a formula query, replace <code>#</code> with the <code>threshold</code> keyword
   * (for example, <code>... &gt; threshold</code>) and provide the threshold as a query via <code>critical_query</code> on <code>options.thresholds</code>.
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listMonitors", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, false, false, limit, args, 0);
 ...
 */
   ...
   * <p><strong>Note</strong>: Log monitors require an unscoped App Key and <code>logs_read_data</code> permission.</p>
   *
   * @param monitorId The ID of the monitor (required)
   * @param body Monitor request object (required)
