...
public class ServiceLevelObjectiveRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description,groups,monitorIds,name,query,sliSpecification,tags,targetThreshold,thresholds,timeframe,type,warningThreshold, additionalProperties);
  }
