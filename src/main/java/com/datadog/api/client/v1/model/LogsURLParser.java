...
public class LogsURLParser {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isEnabled, logsUrlParser.isEnabled)
        ...
        && Objects.equals(this.additionalProperties, logsUrlParser.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        isEnabled, name, normalizeEndingSlashes, sources, target, type, additionalProperties);
  }
