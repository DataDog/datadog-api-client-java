...
public class FormulaAndFunctionEventsDataSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs", "spans", "network", "rum", "security_signals", "profiles", "audit", "events", "ci_tests", "ci_pipelines", "incident_analytics", "product_analytics", "on_call_events", "errors", "llm_observability"));
  ...
  public static final FormulaAndFunctionEventsDataSource ERRORS = new FormulaAndFunctionEventsDataSource("errors");
  public static final FormulaAndFunctionEventsDataSource LLM_OBSERVABILITY = new FormulaAndFunctionEventsDataSource("llm_observability");
