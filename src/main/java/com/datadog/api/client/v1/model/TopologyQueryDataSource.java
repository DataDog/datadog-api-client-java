...
public class TopologyQueryDataSource {
  ...
  public static class TopologyQueryDataSourceSerializer extends StdSerializer<TopologyQueryDataSource> {
  ...
  /**
   * Return true if this TopologyQueryDataSource object is equal to o.
   */
  @Override
