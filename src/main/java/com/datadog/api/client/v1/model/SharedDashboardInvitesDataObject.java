...
/**
   * <p>Object containing the information for an invitation to a shared dashboard.</p>
 */
@JsonPropertyOrder({
...
public class SharedDashboardInvitesDataObject {
  ...
  @JsonCreator
  public SharedDashboardInvitesDataObject(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SharedDashboardInvitesDataObjectAttributes attributes,
  ...
  public SharedDashboardInvitesDataObject attributes(SharedDashboardInvitesDataObjectAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Type for shared dashboard invitation request body.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    SharedDashboardInvitesDataObject sharedDashboardInvitesDataObject = (SharedDashboardInvitesDataObject) o;
    return Objects.equals(this.attributes, sharedDashboardInvitesDataObject.attributes) && Objects.equals(this.type, sharedDashboardInvitesDataObject.type) && Objects.equals(this.additionalProperties, sharedDashboardInvitesDataObject.additionalProperties);
  }
