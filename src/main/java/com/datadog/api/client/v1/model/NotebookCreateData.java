...
/**
   * <p>The data for a notebook create request.</p>
 */
@JsonPropertyOrder({
...
public class NotebookCreateData {
  ...
  @JsonCreator
  public NotebookCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)NotebookCreateDataAttributes attributes,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, notebookCreateData.attributes) && Objects.equals(this.type, notebookCreateData.type) && Objects.equals(this.additionalProperties, notebookCreateData.additionalProperties);
  }
