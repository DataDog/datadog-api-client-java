 ...
 */
  ...
  public ApiResponse<HostTotals> getHostTotalsWithHttpInfo(GetHostTotalsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.getHostTotals", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<HostTotals>> getHostTotalsWithHttpInfoAsync(GetHostTotalsOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v1.HostsApi.getHostTotals", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
 ...
 */
   ...
   * Retention is 7 days.
   * Results are paginated with a max of 1000 results at a time.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<HostListResponse> listHostsWithHttpInfo(ListHostsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.listHosts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<HostListResponse>> listHostsWithHttpInfoAsync(ListHostsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.HostsApi.listHosts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
