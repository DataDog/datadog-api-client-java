 ...
 *
 * See {@link #getHostTotalsWithHttpInfo}.
 *
 * @return HostTotals
 ...
 * Get the total number of active hosts.
 *
 * See {@link #getHostTotalsWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;HostTotals&gt;
 */
  public CompletableFuture<HostTotals>getHostTotalsAsync() {
    return getHostTotalsWithHttpInfoAsync(new GetHostTotalsOptionalParameters()).thenApply(response -> {
 ...
 */
  public CompletableFuture<HostTotals>getHostTotalsAsync(GetHostTotalsOptionalParameters parameters) {
    return getHostTotalsWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
   ...
   * Active means the host has reported in the past hour, and up means it has reported in the past two hours.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<HostTotals> getHostTotalsWithHttpInfo(GetHostTotalsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.getHostTotals", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTotals>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostTotals>> getHostTotalsWithHttpInfoAsync(GetHostTotalsOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v1.HostsApi.getHostTotals", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostTotals>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTotals>() {});
  }
  ...
  public static class ListHostsOptionalParameters {
    ...
    /**
     * Set sortDir.
     * @param sortDir Direction of sort. Options include <code>asc</code> and <code>desc</code>. (optional)
     * @return ListHostsOptionalParameters
     */
    ...
    /**
     * Set start.
     * @param start Specify the starting point for the host search results. For example, if you set <code>count</code> to 100 and the first 100 results have already been returned, you can set <code>start</code> to <code>101</code> to get the next 100 results. (optional)
     * @return ListHostsOptionalParameters
     */
 ...
 *
 * See {@link #listHostsWithHttpInfo}.
 *
 ...
 * Get all hosts for your organization.
 *
 * See {@link #listHostsWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;HostListResponse&gt;
 */
  public CompletableFuture<HostListResponse>listHostsAsync() {
    return listHostsWithHttpInfoAsync(new ListHostsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<HostListResponse>listHostsAsync(ListHostsOptionalParameters parameters) {
    return listHostsWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>This endpoint allows searching for hosts by name, alias, or tag.
   ...
   * <strong>Note</strong>: To enrich the data returned by this endpoint with security scans, see the new <a href="https://docs.datadoghq.com/api/latest/security-monitoring/#list-scanned-assets-metadata">api/v2/security/scanned-assets-metadata</a> endpoint.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<HostListResponse> listHostsWithHttpInfo(ListHostsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.listHosts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostListResponse>> listHostsWithHttpInfoAsync(ListHostsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.HostsApi.listHosts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostListResponse>() {});
  }

  /**
 * Mute a host.
 *
 * See {@link #muteHostWithHttpInfo}.
 *
 ...
 * Mute a host.
 *
 * See {@link #muteHostWithHttpInfoAsync}.
 *
 * @param hostName Name of the host to mute. (required)
 * @param body Mute a host request body. (required)
 ...
 */
  public CompletableFuture<HostMuteResponse>muteHostAsync(String hostName, HostMuteSettings body) {
    return muteHostWithHttpInfoAsync(hostName, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Mute a host. <strong>Note:</strong> This creates a <a href="https://docs.datadoghq.com/api/latest/downtimes/#schedule-a-downtime">Downtime V2</a> for the host.</p>
   *
   * @param hostName Name of the host to mute. (required)
   * @param body Mute a host request body. (required)
  ...
  public ApiResponse<HostMuteResponse> muteHostWithHttpInfo(String hostName, HostMuteSettings body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.muteHost", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostMuteResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostMuteResponse>> muteHostWithHttpInfoAsync(String hostName, HostMuteSettings body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.HostsApi.muteHost", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostMuteResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostMuteResponse>() {});
  }

  /**
 * Unmute a host.
 *
 * See {@link #unmuteHostWithHttpInfo}.
 *
 ...
 * Unmute a host.
 *
 * See {@link #unmuteHostWithHttpInfoAsync}.
 *
 * @param hostName Name of the host to unmute. (required)
 * @return CompletableFuture&lt;HostMuteResponse&gt;
 */
  public CompletableFuture<HostMuteResponse>unmuteHostAsync(String hostName) {
    return unmuteHostWithHttpInfoAsync(hostName).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Unmutes a host. This endpoint takes no JSON arguments.</p>
   *
   * @param hostName Name of the host to unmute. (required)
   * @return ApiResponse&lt;HostMuteResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<HostMuteResponse> unmuteHostWithHttpInfo(String hostName) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.HostsApi.unmuteHost", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostMuteResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostMuteResponse>> unmuteHostWithHttpInfoAsync(String hostName) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.HostsApi.unmuteHost", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostMuteResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostMuteResponse>() {});
  }
}