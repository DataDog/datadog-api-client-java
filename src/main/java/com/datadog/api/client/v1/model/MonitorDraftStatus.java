...
public class MonitorDraftStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("draft", "published"));
  ...
  public static class MonitorDraftStatusSerializer extends StdSerializer<MonitorDraftStatus> {
      ...
      @Override
      public void serialize(MonitorDraftStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
