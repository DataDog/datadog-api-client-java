...
public class NotebookCellResourceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("notebook_cells"));

  public static final NotebookCellResourceType NOTEBOOK_CELLS = new NotebookCellResourceType("notebook_cells");
  ...
  public static class NotebookCellResourceTypeSerializer extends StdSerializer<NotebookCellResourceType> {
      ...
      @Override
      public void serialize(NotebookCellResourceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
