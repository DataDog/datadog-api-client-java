...
/**
   * <p>Operation that extracts key-value pairs from a <code>source</code> array and stores the result in the <code>target</code> attribute.</p>
 */
@JsonPropertyOrder({
...
public class LogsArrayProcessorOperationExtractKeyValue {
  ...
  public LogsArrayProcessorOperationExtractKeyValue(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)LogsArrayProcessorOperationExtractKeyValueType type,
  ...
  /**
   * <p>Key of the attribute in each array element that holds the name to use for the extracted attribute.</p>
   * @return keyToExtract
  **/
  ...
  /**
   * <p>Whether to override the target element if it's already set.</p>
  ...
  **/
  ...
  /**
   * <p>Attribute path of the array to extract key-value pairs from.</p>
   * @return source
  **/
  ...
  /**
   * <p>Attribute that receives the extracted key-value pairs. If not specified, the extracted attributes are added at the root level of the log.</p>
   * @return target
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Key of the attribute in each array element that holds the value to use for the extracted attribute.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LogsArrayProcessorOperationExtractKeyValue logsArrayProcessorOperationExtractKeyValue = (LogsArrayProcessorOperationExtractKeyValue) o;
    return Objects.equals(this.keyToExtract, logsArrayProcessorOperationExtractKeyValue.keyToExtract) && Objects.equals(this.overrideOnConflict, logsArrayProcessorOperationExtractKeyValue.overrideOnConflict) && Objects.equals(this.source, logsArrayProcessorOperationExtractKeyValue.source) && Objects.equals(this.target, logsArrayProcessorOperationExtractKeyValue.target) && Objects.equals(this.type, logsArrayProcessorOperationExtractKeyValue.type) && Objects.equals(this.valueToExtract, logsArrayProcessorOperationExtractKeyValue.valueToExtract) && Objects.equals(this.additionalProperties, logsArrayProcessorOperationExtractKeyValue.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(keyToExtract,overrideOnConflict,source,target,type,valueToExtract, additionalProperties);
  }
