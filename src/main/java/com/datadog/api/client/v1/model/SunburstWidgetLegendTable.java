...
/**
   * <p>Configuration of table-based legend.</p>
 */
@JsonPropertyOrder({
  SunburstWidgetLegendTable.JSON_PROPERTY_TYPE
})
...
public class SunburstWidgetLegendTable {
  ...
  @JsonCreator
  public SunburstWidgetLegendTable(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SunburstWidgetLegendTableType type) {
        this.type = type;
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SunburstWidgetLegendTable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, sunburstWidgetLegendTable.type) && Objects.equals(this.additionalProperties, sunburstWidgetLegendTable.additionalProperties);
  }
