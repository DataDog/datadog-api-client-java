...
public class LogsByRetentionMonthlyUsage {
  ...
  **/
  ...
  /**
   * <p>Indexed logs usage for each active retention for the month.</p>
   * @return usage
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public LogsByRetentionMonthlyUsage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, logsByRetentionMonthlyUsage.date) && Objects.equals(this.usage, logsByRetentionMonthlyUsage.usage) && Objects.equals(this.additionalProperties, logsByRetentionMonthlyUsage.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(date,usage, additionalProperties);
  }
