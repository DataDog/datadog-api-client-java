...
@JsonDeserialize(using = SplitGraphSourceWidgetDefinition.SplitGraphSourceWidgetDefinitionDeserializer.class)
@JsonSerialize(using = SplitGraphSourceWidgetDefinition.SplitGraphSourceWidgetDefinitionSerializer.class)
public class SplitGraphSourceWidgetDefinition extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SplitGraphSourceWidgetDefinition.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SplitGraphSourceWidgetDefinitionSerializer extends StdSerializer<SplitGraphSourceWidgetDefinition> {
        ...
        @Override
        public void serialize(SplitGraphSourceWidgetDefinition value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SplitGraphSourceWidgetDefinitionDeserializer extends StdDeserializer<SplitGraphSourceWidgetDefinition> {
        ...
        @Override
        public SplitGraphSourceWidgetDefinition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public SplitGraphSourceWidgetDefinition getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SplitGraphSourceWidgetDefinition cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(SplitGraphSourceWidgetDefinition.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * BarChartWidgetDefinition, ChangeWidgetDefinition, GeomapWidgetDefinition, QueryValueWidgetDefinition, ScatterPlotWidgetDefinition, SunburstWidgetDefinition, TableWidgetDefinition, TimeseriesWidgetDefinition, ToplistWidgetDefinition, TreeMapWidgetDefinition
     *
     ...
     * BarChartWidgetDefinition, ChangeWidgetDefinition, GeomapWidgetDefinition, QueryValueWidgetDefinition, ScatterPlotWidgetDefinition, SunburstWidgetDefinition, TableWidgetDefinition, TimeseriesWidgetDefinition, ToplistWidgetDefinition, TreeMapWidgetDefinition
     *
     * @return The actual instance (BarChartWidgetDefinition, ChangeWidgetDefinition, GeomapWidgetDefinition, QueryValueWidgetDefinition, ScatterPlotWidgetDefinition, SunburstWidgetDefinition, TableWidgetDefinition, TimeseriesWidgetDefinition, ToplistWidgetDefinition, TreeMapWidgetDefinition)
     */
    @Override
