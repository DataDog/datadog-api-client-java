...
@JsonDeserialize(using = SyntheticsTestRequestDNSServerPort.SyntheticsTestRequestDNSServerPortDeserializer.class)
@JsonSerialize(using = SyntheticsTestRequestDNSServerPort.SyntheticsTestRequestDNSServerPortSerializer.class)
public class SyntheticsTestRequestDNSServerPort extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyntheticsTestRequestDNSServerPort.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SyntheticsTestRequestDNSServerPortSerializer extends StdSerializer<SyntheticsTestRequestDNSServerPort> {
        public SyntheticsTestRequestDNSServerPortSerializer(Class<SyntheticsTestRequestDNSServerPort> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(SyntheticsTestRequestDNSServerPort value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SyntheticsTestRequestDNSServerPortDeserializer extends StdDeserializer<SyntheticsTestRequestDNSServerPort> {
        ...
        @Override
        public SyntheticsTestRequestDNSServerPort deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public SyntheticsTestRequestDNSServerPort getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SyntheticsTestRequestDNSServerPort cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(SyntheticsTestRequestDNSServerPort.class, Collections.unmodifiableMap(schemas));
    }
