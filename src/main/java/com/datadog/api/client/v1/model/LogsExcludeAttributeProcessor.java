...
/**
   * <p>Use this processor to remove an attribute from a log during processing.
   * The processor strips the specified attribute from the log event, which is useful
   * when the attribute contains sensitive data or is no longer needed downstream.</p>
 */
@JsonPropertyOrder({
...
public class LogsExcludeAttributeProcessor {
  ...
  private LogsExcludeAttributeProcessorType type = LogsExcludeAttributeProcessorType.EXCLUDE_ATTRIBUTE;

  public LogsExcludeAttributeProcessor() {}

  @JsonCreator
  public LogsExcludeAttributeProcessor(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTE_TO_EXCLUDE)String attributeToExclude,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)LogsExcludeAttributeProcessorType type) {
  ...
  /**
   * <p>Name of the log attribute to remove from the log event.</p>
  ...
  **/
  ...
  /**
   * <p>Type of logs exclude attribute processor.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributeToExclude, logsExcludeAttributeProcessor.attributeToExclude) && Objects.equals(this.isEnabled, logsExcludeAttributeProcessor.isEnabled) && Objects.equals(this.name, logsExcludeAttributeProcessor.name) && Objects.equals(this.type, logsExcludeAttributeProcessor.type) && Objects.equals(this.additionalProperties, logsExcludeAttributeProcessor.additionalProperties);
  }
