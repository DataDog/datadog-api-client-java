...
public class SLOCountSpec {
  ...
  private SLOCountCondition count;

  public SLOCountSpec() {}

  @JsonCreator
  public SLOCountSpec(
      @JsonProperty(required = true, value = JSON_PROPERTY_COUNT) SLOCountCondition count) {
    this.count = count;
    this.unparsed |= count.unparsed;
  }

  public SLOCountSpec count(SLOCountCondition count) {
    this.count = count;
    this.unparsed |= count.unparsed;
    return this;
  }
  ...
  public SLOCountCondition getCount() {
    return count;
  }

  public void setCount(SLOCountCondition count) {
    this.count = count;
  }
