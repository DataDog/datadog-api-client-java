...
public class SLOCountSpec {
  ...
  /**
   * <p>A count-based (metric) SLI specification, composed of three parts: the good events formula,
   * the bad or total events formula, and the underlying queries.
   * Exactly one of <code>total_events_formula</code> or <code>bad_events_formula</code> must be provided.</p>
   * @return count
  **/
