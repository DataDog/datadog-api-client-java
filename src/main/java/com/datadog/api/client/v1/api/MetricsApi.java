 ...
 * Get metric metadata.
 *
 * See {@link #getMetricMetadataWithHttpInfo}.
 *
 ...
 */
  ...
  /**
   * <p>Get metadata about a specific metric.</p>
   *
   * @param metricName Name of the metric for which to get metadata. (required)
  ...
  public ApiResponse<MetricMetadata> getMetricMetadataWithHttpInfo(String metricName) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.getMetricMetadata", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricMetadata>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MetricMetadata>> getMetricMetadataWithHttpInfoAsync(String metricName) {
    ...
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.getMetricMetadata", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MetricMetadata>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricMetadata>() {});
  }
 ...
 *
 * See {@link #listActiveMetricsWithHttpInfo}.
 *
 ...
 * Get active metrics list.
 *
 * See {@link #listActiveMetricsWithHttpInfoAsync}.
 *
 * @param from Seconds since the Unix epoch. (required)
 ...
 */
  public CompletableFuture<MetricsListResponse>listActiveMetricsAsync(Long from) {
    return listActiveMetricsWithHttpInfoAsync(from, new ListActiveMetricsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<MetricsListResponse>listActiveMetricsAsync( Long from, ListActiveMetricsOptionalParameters parameters) {
    return listActiveMetricsWithHttpInfoAsync(from, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get the list of actively reporting metrics from a given time until now.</p>
   *
   * @param from Seconds since the Unix epoch. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<MetricsListResponse> listActiveMetricsWithHttpInfo(Long from, ListActiveMetricsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.listActiveMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricsListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MetricsListResponse>> listActiveMetricsWithHttpInfoAsync(Long from, ListActiveMetricsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.listActiveMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MetricsListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricsListResponse>() {});
  }

  /**
 * Search metrics.
 *
 * See {@link #listMetricsWithHttpInfo}.
 *
 * @param q Query string to search metrics upon. Can optionally be prefixed with <code>metrics:</code>. (required)
 ...
 * Search metrics.
 *
 * See {@link #listMetricsWithHttpInfoAsync}.
 *
 * @param q Query string to search metrics upon. Can optionally be prefixed with <code>metrics:</code>. (required)
...
@Deprecated
  public CompletableFuture<MetricSearchResponse>listMetricsAsync(String q) {
    return listMetricsWithHttpInfoAsync(q).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p><strong>Note</strong>: This endpoint is deprecated. Use <code>/api/v2/metrics</code> instead.</p>
   * <p>Search for metrics from the last 24 hours in Datadog.</p>
   *
   * @param q Query string to search metrics upon. Can optionally be prefixed with <code>metrics:</code>. (required)
  ...
  public ApiResponse<MetricSearchResponse> listMetricsWithHttpInfo(String q) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.listMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricSearchResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MetricSearchResponse>> listMetricsWithHttpInfoAsync(String q) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.listMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MetricSearchResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricSearchResponse>() {});
  }

  /**
 * Query timeseries points.
 *
 * See {@link #queryMetricsWithHttpInfo}.
 *
 ...
 * Query timeseries points.
 *
 * See {@link #queryMetricsWithHttpInfoAsync}.
 *
 * @param from Start of the queried time period, seconds since the Unix epoch. (required)
 * @param to End of the queried time period, seconds since the Unix epoch. (required)
 * @param query Query string. (required)
 ...
 */
  public CompletableFuture<MetricsQueryResponse>queryMetricsAsync(Long from, Long to, String query) {
    return queryMetricsWithHttpInfoAsync(from, to, query).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Query timeseries points. Datadog recommends using the v2
   * <code>/api/v2/query/timeseries</code> endpoint over this endpoint for
   * querying timeseries data.</p>
   *
   * @param from Start of the queried time period, seconds since the Unix epoch. (required)
   * @param to End of the queried time period, seconds since the Unix epoch. (required)
   * @param query Query string. (required)
  ...
  public ApiResponse<MetricsQueryResponse> queryMetricsWithHttpInfo(Long from, Long to, String query) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.queryMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricsQueryResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MetricsQueryResponse>> queryMetricsWithHttpInfoAsync(Long from, Long to, String query) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.queryMetrics", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MetricsQueryResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricsQueryResponse>() {});
  }
 ...
 *
 * See {@link #submitDistributionPointsWithHttpInfo}.
 *
 * @param body  (required)
 ...
 */
  public IntakePayloadAccepted submitDistributionPoints (DistributionPointsPayload body) throws ApiException {
    return submitDistributionPointsWithHttpInfo( body, new SubmitDistributionPointsOptionalParameters()).getData();
  }

  /**
 * Submit distribution points.
 *
 * See {@link #submitDistributionPointsWithHttpInfoAsync}.
 *
 * @param body  (required)
 ...
 */
  public CompletableFuture<IntakePayloadAccepted>submitDistributionPointsAsync(DistributionPointsPayload body) {
    return submitDistributionPointsWithHttpInfoAsync(body, new SubmitDistributionPointsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<IntakePayloadAccepted>submitDistributionPointsAsync( DistributionPointsPayload body, SubmitDistributionPointsOptionalParameters parameters) {
    return submitDistributionPointsWithHttpInfoAsync(body, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>The distribution points end-point allows you to post distribution data that can be graphed on Datadog’s dashboards.</p>
   *
   * @param body  (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<IntakePayloadAccepted> submitDistributionPointsWithHttpInfo(DistributionPointsPayload body, SubmitDistributionPointsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.submitDistributionPoints", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"text/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IntakePayloadAccepted>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IntakePayloadAccepted>> submitDistributionPointsWithHttpInfoAsync(DistributionPointsPayload body, SubmitDistributionPointsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.submitDistributionPoints", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IntakePayloadAccepted>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"text/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IntakePayloadAccepted>() {});
  }
 ...
 */
   ...
   * The maximum payload size is 3.2 megabytes (3200000 bytes). Compressed payloads must have a decompressed size of less than 62 megabytes (62914560 bytes).</p>
   ...
   * <li>40 bytes for the metric names</li>
   * <li>50 bytes for the timeseries</li>
   * <li>The full payload is approximately 100 bytes. However, with the DogStatsD API,
   * compression is applied, which reduces the payload size.</li>
   * </ul>
   *
   * @param body  (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<IntakePayloadAccepted> submitMetricsWithHttpInfo(MetricsPayload body, SubmitMetricsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.submitMetrics", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"text/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IntakePayloadAccepted>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IntakePayloadAccepted>> submitMetricsWithHttpInfoAsync(MetricsPayload body, SubmitMetricsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.submitMetrics", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IntakePayloadAccepted>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #updateMetricMetadataWithHttpInfo}.
 *
 ...
 * Edit metric metadata.
 *
 * See {@link #updateMetricMetadataWithHttpInfoAsync}.
 *
 * @param metricName Name of the metric for which to edit metadata. (required)
 * @param body New metadata. (required)
 * @return CompletableFuture&lt;MetricMetadata&gt;
 */
  public CompletableFuture<MetricMetadata>updateMetricMetadataAsync(String metricName, MetricMetadata body) {
    return updateMetricMetadataWithHttpInfoAsync(metricName, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Edit metadata of a specific metric. Find out more about <a href="https://docs.datadoghq.com/developers/metrics">supported types</a>.</p>
   *
   * @param metricName Name of the metric for which to edit metadata. (required)
   * @param body New metadata. (required)
   * @return ApiResponse&lt;MetricMetadata&gt;
  ...
  public ApiResponse<MetricMetadata> updateMetricMetadataWithHttpInfo(String metricName, MetricMetadata body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.MetricsApi.updateMetricMetadata", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricMetadata>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MetricMetadata>> updateMetricMetadataWithHttpInfoAsync(String metricName, MetricMetadata body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.MetricsApi.updateMetricMetadata", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MetricMetadata>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MetricMetadata>() {});
  }
}