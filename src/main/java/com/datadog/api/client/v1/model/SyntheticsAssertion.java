...
public class SyntheticsAssertion extends AbstractOpenApiSchema {
    ...
    public static class SyntheticsAssertionDeserializer extends StdDeserializer<SyntheticsAssertion> {
        ...
        public SyntheticsAssertion deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Integer.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Long.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Float.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Double.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Boolean.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Integer.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Float.class) || SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyntheticsAssertionMCPServerCapabilitiesTarget.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(SyntheticsAssertionMCPServerCapabilitiesTarget.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'SyntheticsAssertionMCPServerCapabilitiesTarget'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'SyntheticsAssertionMCPServerCapabilitiesTarget'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SyntheticsAssertionMCPRespectsSpecification.class.equals(Integer.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Long.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Float.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Double.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Boolean.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SyntheticsAssertionMCPRespectsSpecification.class.equals(Integer.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SyntheticsAssertionMCPRespectsSpecification.class.equals(Float.class) || SyntheticsAssertionMCPRespectsSpecification.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SyntheticsAssertionMCPRespectsSpecification.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SyntheticsAssertionMCPRespectsSpecification.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(SyntheticsAssertionMCPRespectsSpecification.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'SyntheticsAssertionMCPRespectsSpecification'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'SyntheticsAssertionMCPRespectsSpecification'", e);
            }
    ...
    static {
        ...
        schemas.put("SyntheticsAssertionMCPServerCapabilitiesTarget", new GenericType<SyntheticsAssertionMCPServerCapabilitiesTarget>() {
        });
        schemas.put("SyntheticsAssertionMCPRespectsSpecification", new GenericType<SyntheticsAssertionMCPRespectsSpecification>() {
        });
     ...
     * SyntheticsAssertionTarget, SyntheticsAssertionBodyHashTarget, SyntheticsAssertionJSONPathTarget, SyntheticsAssertionJSONSchemaTarget, SyntheticsAssertionXPathTarget, SyntheticsAssertionJavascript, SyntheticsAssertionMCPServerCapabilitiesTarget, SyntheticsAssertionMCPRespectsSpecification
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(SyntheticsAssertionMCPServerCapabilitiesTarget.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(SyntheticsAssertionMCPRespectsSpecification.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `SyntheticsAssertionMCPServerCapabilitiesTarget`. If the actual instance is not `SyntheticsAssertionMCPServerCapabilitiesTarget`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `SyntheticsAssertionMCPServerCapabilitiesTarget`
     * @throws ClassCastException if the instance is not `SyntheticsAssertionMCPServerCapabilitiesTarget`
     */
    public SyntheticsAssertionMCPServerCapabilitiesTarget getSyntheticsAssertionMCPServerCapabilitiesTarget() throws ClassCastException {
        return (SyntheticsAssertionMCPServerCapabilitiesTarget)super.getActualInstance();
    }

    /**
     * Get the actual instance of `SyntheticsAssertionMCPRespectsSpecification`. If the actual instance is not `SyntheticsAssertionMCPRespectsSpecification`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public SyntheticsAssertionMCPRespectsSpecification getSyntheticsAssertionMCPRespectsSpecification() throws ClassCastException {
