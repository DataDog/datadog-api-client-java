...
public class LogsLookupProcessor {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultLookup, logsLookupProcessor.defaultLookup)
        ...
        && Objects.equals(this.additionalProperties, logsLookupProcessor.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        defaultLookup, isEnabled, lookupTable, name, source, target, type, additionalProperties);
  }
