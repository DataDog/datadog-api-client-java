...
public class FormulaAndFunctionApmResourceStatName extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("errors", "error_rate", "hits", "latency_avg", "latency_distribution", "latency_max", "latency_p50", "latency_p75", "latency_p90", "latency_p95", "latency_p99"));
  ...
  public static final FormulaAndFunctionApmResourceStatName LATENCY_DISTRIBUTION = new FormulaAndFunctionApmResourceStatName("latency_distribution");
