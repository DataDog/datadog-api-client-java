...
/**
   * <p>Filter applied to occurrence counts when building a Product Analytics audience.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsAudienceOccurrenceFilter {
  ...
  /**
   * <p>The comparison operator used for the occurrence filter (for example: <code>gt</code>, <code>lt</code>, <code>eq</code>).</p>
   * @return operator
  **/
  ...
  /**
   * <p>The threshold value to compare occurrence counts against.</p>
   * @return value
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsAudienceOccurrenceFilter productAnalyticsAudienceOccurrenceFilter = (ProductAnalyticsAudienceOccurrenceFilter) o;
    return Objects.equals(this.operator, productAnalyticsAudienceOccurrenceFilter.operator) && Objects.equals(this.value, productAnalyticsAudienceOccurrenceFilter.value) && Objects.equals(this.additionalProperties, productAnalyticsAudienceOccurrenceFilter.additionalProperties);
  }
