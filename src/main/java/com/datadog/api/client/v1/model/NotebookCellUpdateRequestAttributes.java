...
@JsonDeserialize(using = NotebookCellUpdateRequestAttributes.NotebookCellUpdateRequestAttributesDeserializer.class)
@JsonSerialize(using = NotebookCellUpdateRequestAttributes.NotebookCellUpdateRequestAttributesSerializer.class)
public class NotebookCellUpdateRequestAttributes extends AbstractOpenApiSchema {
    ...
    public static class NotebookCellUpdateRequestAttributesSerializer extends StdSerializer<NotebookCellUpdateRequestAttributes> {
        public NotebookCellUpdateRequestAttributesSerializer(Class<NotebookCellUpdateRequestAttributes> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(NotebookCellUpdateRequestAttributes value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class NotebookCellUpdateRequestAttributesDeserializer extends StdDeserializer<NotebookCellUpdateRequestAttributes> {
        ...
        @Override
        public NotebookCellUpdateRequestAttributes deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public NotebookCellUpdateRequestAttributes getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "NotebookCellUpdateRequestAttributes cannot be null");
        }
    }
