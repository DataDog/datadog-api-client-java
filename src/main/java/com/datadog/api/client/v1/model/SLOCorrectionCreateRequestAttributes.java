...
/**
   ...
   * <p>Exactly one of <code>slo_id</code> or <code>slo_query</code> must be provided.</p>
 */
@JsonPropertyOrder({
...
public class SLOCorrectionCreateRequestAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category,description,duration,end,rrule,sloId,sloQuery,start,timezone, additionalProperties);
  }
