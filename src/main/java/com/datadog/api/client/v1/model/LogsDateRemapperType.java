...
public class LogsDateRemapperType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("date-remapper"));

  public static final LogsDateRemapperType DATE_REMAPPER = new LogsDateRemapperType("date-remapper");
  ...
  public static class LogsDateRemapperTypeSerializer extends StdSerializer<LogsDateRemapperType> {
      ...
      @Override
      public void serialize(LogsDateRemapperType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
