 ...
 *
 * See {@link #submitServiceCheckWithHttpInfo}.
 *
 ...
 * Submit a Service Check.
 *
 * See {@link #submitServiceCheckWithHttpInfoAsync}.
 *
 * @param body Service Check request body. (required)
 ...
 */
  public CompletableFuture<IntakePayloadAccepted>submitServiceCheckAsync(List<ServiceCheck> body) {
    return submitServiceCheckWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Submit a list of Service Checks.</p>
   * <p><strong>Notes</strong>:
   * - A valid API key is required.
   * - Service checks can be submitted up to 10 minutes in the past.</p>
   *
   * @param body Service Check request body. (required)
  ...
  public ApiResponse<IntakePayloadAccepted> submitServiceCheckWithHttpInfo(List<ServiceCheck> body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.ServiceChecksApi.submitServiceCheck", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<IntakePayloadAccepted>> submitServiceCheckWithHttpInfoAsync(List<ServiceCheck> body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.ServiceChecksApi.submitServiceCheck", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
