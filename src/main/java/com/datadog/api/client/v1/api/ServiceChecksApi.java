 ...
 */
  ...
  public CompletableFuture<ApiResponse<IntakePayloadAccepted>> submitServiceCheckWithHttpInfoAsync(List<ServiceCheck> body) {
    ...
    try {
      builder = apiClient.createBuilder("ServiceChecksApi.submitServiceCheck", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"text/json", "application/json" }, new String[] { "apiKeyAuth" });
