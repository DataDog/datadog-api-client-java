...
/**
   * <p>The Log Stream displays a log flow matching the defined query.</p>
 */
@JsonPropertyOrder({
...
public class LogStreamWidgetDefinition {
  ...
  @JsonCreator
  public LogStreamWidgetDefinition(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)LogStreamWidgetDefinitionType type) {
        this.type = type;
  ...
  /**
   * <p>Which columns to display on the widget.</p>
   * @return columns
  **/
  ...
  **/
  ...
  /**
   * <p>An array of index names to query in the stream. Use [] to query all indexes at once.</p>
   * @return indexes
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Amount of log lines to display</p>
  ...
  **/
  ...
  /**
   * <p>Query to filter the log stream with.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to show the date column or not</p>
  ...
  **/
  ...
  /**
   * <p>Whether to show the message column or not</p>
  ...
  **/
  ...
  /**
   * <p>Type of the log stream widget.</p>
   * @return type
  **/
