...
public class LogStreamWidgetDefinition {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(columns,indexes,logset,messageDisplay,query,showDateColumn,showMessageColumn,sort,time,title,titleAlign,titleSize,type, additionalProperties);
  }
