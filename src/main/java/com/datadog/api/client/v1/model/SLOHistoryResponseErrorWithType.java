...
/**
   * <p>An object describing the error with error type and error message.</p>
 */
@JsonPropertyOrder({
...
public class SLOHistoryResponseErrorWithType {
  ...
  /**
   * <p>A message with more details about the error.</p>
   * @return errorMessage
  **/
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SLOHistoryResponseErrorWithType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorMessage, sloHistoryResponseErrorWithType.errorMessage) && Objects.equals(this.errorType, sloHistoryResponseErrorWithType.errorType) && Objects.equals(this.additionalProperties, sloHistoryResponseErrorWithType.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(errorMessage,errorType, additionalProperties);
  }
