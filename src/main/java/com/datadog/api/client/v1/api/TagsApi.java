...
public class TagsApi {
  ...
  public static class CreateHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source Source to add tags. <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. Use "user" source for custom-defined tags. If no source is specified, defaults to "user". (optional)
 ...
 */
  public CompletableFuture<HostTags>createHostTagsAsync(String hostName, HostTags body) {
    return createHostTagsWithHttpInfoAsync(hostName, body, new CreateHostTagsOptionalParameters()).thenApply(response -> {
 ...
 */
  public CompletableFuture<HostTags>createHostTagsAsync( String hostName,  HostTags body, CreateHostTagsOptionalParameters parameters) {
    return createHostTagsWithHttpInfoAsync(hostName, body, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>This endpoint allows you to add new tags to a host,
   * optionally specifying what source these tags come from. If tags already exist, appends new tags to the tag list. If no source is specified, defaults to "user".</p>
   *
   * @param hostName Specified host name to add new tags (required)
   * @param body Update host tags request body. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<HostTags> createHostTagsWithHttpInfo(String hostName, HostTags body, CreateHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.createHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostTags>> createHostTagsWithHttpInfoAsync(String hostName, HostTags body, CreateHostTagsOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v1.TagsApi.createHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostTags>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
  ...
  public static class DeleteHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source Source of the tags to be deleted. <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. Use "user" source for custom-defined tags. (optional)
 ...
 */
  public CompletableFuture<Void>deleteHostTagsAsync(String hostName) {
    return deleteHostTagsWithHttpInfoAsync(hostName, new DeleteHostTagsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<Void>deleteHostTagsAsync( String hostName, DeleteHostTagsOptionalParameters parameters) {
    return deleteHostTagsWithHttpInfoAsync(hostName, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>This endpoint allows you to remove all tags
   * for a single host. If no source is specified, only deletes from the source "User".</p>
   *
   * @param hostName Specified host name to delete tags (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<Void> deleteHostTagsWithHttpInfo(String hostName, DeleteHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.deleteHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteHostTagsWithHttpInfoAsync(String hostName, DeleteHostTagsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.TagsApi.deleteHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
  ...
  public static class GetHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source Source to filter. <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. Use "user" source for custom-defined tags. (optional)
 ...
 */
  public CompletableFuture<HostTags>getHostTagsAsync(String hostName) {
    return getHostTagsWithHttpInfoAsync(hostName, new GetHostTagsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<HostTags>getHostTagsAsync( String hostName, GetHostTagsOptionalParameters parameters) {
    return getHostTagsWithHttpInfoAsync(hostName, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Return the list of tags that apply to a given host.</p>
   *
   * @param hostName Name of the host to retrieve tags for (required)
   * @param parameters Optional parameters for the request.
   * @return ApiResponse&lt;HostTags&gt;
  ...
  public ApiResponse<HostTags> getHostTagsWithHttpInfo(String hostName, GetHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.getHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostTags>> getHostTagsWithHttpInfoAsync(String hostName, GetHostTagsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.TagsApi.getHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostTags>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
 ...
 */
  public CompletableFuture<TagToHosts>listHostTagsAsync() {
    return listHostTagsWithHttpInfoAsync(new ListHostTagsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<TagToHosts>listHostTagsAsync(ListHostTagsOptionalParameters parameters) {
    return listHostTagsWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns a mapping of tags to hosts. For each tag, the response returns a list of host names that contain this tag. There is a restriction of 10k total host names from the org that can be attached to tags and returned.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<TagToHosts> listHostTagsWithHttpInfo(ListHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.listHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<TagToHosts>() {});
  }
  ...
  public CompletableFuture<ApiResponse<TagToHosts>> listHostTagsWithHttpInfoAsync(ListHostTagsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.TagsApi.listHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<TagToHosts>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<TagToHosts>() {});
  }
  ...
  public static class UpdateHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source Source to update tags. <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. Use "user" source for custom-defined tags. If no source specified, defaults to "user". (optional)
 ...
 */
  public CompletableFuture<HostTags>updateHostTagsAsync(String hostName, HostTags body) {
    return updateHostTagsWithHttpInfoAsync(hostName, body, new UpdateHostTagsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<HostTags>updateHostTagsAsync( String hostName,  HostTags body, UpdateHostTagsOptionalParameters parameters) {
    return updateHostTagsWithHttpInfoAsync(hostName, body, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>This endpoint allows you to update/replace all tags in
   * an integration source with those supplied in the request.</p>
   *
   * @param hostName Specified host name to change tags (required)
   * @param body Add tags to host (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<HostTags> updateHostTagsWithHttpInfo(String hostName, HostTags body, UpdateHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.updateHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
  ...
  public CompletableFuture<ApiResponse<HostTags>> updateHostTagsWithHttpInfoAsync(String hostName, HostTags body, UpdateHostTagsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.TagsApi.updateHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<HostTags>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<HostTags>() {});
  }
}