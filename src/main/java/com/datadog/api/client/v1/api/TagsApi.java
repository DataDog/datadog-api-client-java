...
public class TagsApi {
  ...
  public static class CreateHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source The source of the tags. <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. (optional)
 ...
 */
   ...
   * optionally specifying where these tags come from.</p>
   *
   * @param hostName This endpoint allows you to add new tags to a host, optionally specifying where the tags came from. (required)
   * @param body Update host tags request body. (required)
   * @param parameters Optional parameters for the request.
  ...
  public static class DeleteHostTagsOptionalParameters {
    ...
    /**
     * Set source.
     * @param source The source of the tags (for example chef, puppet). <a href="https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value">Complete list of source attribute values</a>. (optional)
 ...
 */
  ...
  /**
   * <p>This endpoint allows you to remove all user-assigned tags
   * for a single host.</p>
   *
   * @param hostName This endpoint allows you to remove all user-assigned tags for a single host. (required)
   * @param parameters Optional parameters for the request.
 ...
 */
  ...
  /**
   * <p>Return a mapping of tags to hosts for your whole infrastructure.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<TagToHosts> listHostTagsWithHttpInfo(ListHostTagsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.TagsApi.listHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<TagToHosts>> listHostTagsWithHttpInfoAsync(ListHostTagsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.TagsApi.listHostTags", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
