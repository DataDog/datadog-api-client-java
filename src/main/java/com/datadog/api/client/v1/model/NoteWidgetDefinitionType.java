...
public class NoteWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static class NoteWidgetDefinitionTypeSerializer extends StdSerializer<NoteWidgetDefinitionType> {
      ...
      @Override
      public void serialize(NoteWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
