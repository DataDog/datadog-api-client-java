...
/**
   * <p>Issue state filter for the <code>issue_stream</code> data source.</p>
 */
...
public class ListStreamIssueState extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("OPEN", "IGNORED", "ACKNOWLEDGED", "RESOLVED"));
  ...
  public static class ListStreamIssueStateSerializer extends StdSerializer<ListStreamIssueState> {
      ...
      @Override
      public void serialize(ListStreamIssueState value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
