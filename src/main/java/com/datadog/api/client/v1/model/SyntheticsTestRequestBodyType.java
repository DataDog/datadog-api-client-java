...
public class SyntheticsTestRequestBodyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("text/plain", "application/json", "text/xml", "text/html", "application/x-www-form-urlencoded", "graphql", "application/octet-stream", "multipart/form-data"));
  ...
  public static final SyntheticsTestRequestBodyType APPLICATION_OCTET_STREAM = new SyntheticsTestRequestBodyType("application/octet-stream");
  public static final SyntheticsTestRequestBodyType MULTIPART_FORM_DATA = new SyntheticsTestRequestBodyType("multipart/form-data");
  ...
  public static class SyntheticsTestRequestBodyTypeSerializer extends StdSerializer<SyntheticsTestRequestBodyType> {
      ...
      @Override
      public void serialize(SyntheticsTestRequestBodyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
