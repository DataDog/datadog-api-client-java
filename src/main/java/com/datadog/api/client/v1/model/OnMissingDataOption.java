 ...
 * conditions. For monitor using any query type other than Count, for example Gauge or Rate, the
 * monitor shows the last known status. This option is only available for APM Trace Analytics, Audit
