...
public class DatasetListQuery {
  ...
  @JsonCreator
  public DatasetListQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)DatasetListQueryDataSourceType dataSource,
            @JsonProperty(required=true, value=JSON_PROPERTY_DATASET_ID)String datasetId,
            @JsonProperty(required=true, value=JSON_PROPERTY_DATASET_PROVIDER)PublishedDatasetProvider datasetProvider) {
  ...
  /**
   * <p>Identifies this as a published-dataset list query.</p>
   * @return dataSource
  **/
  ...
  /**
   * <p>ID of the published dataset to query.</p>
   * @return datasetId
  **/
  ...
  /**
   * <p>Product page that published the dataset queried by a <code>DatasetListQuery</code>. <code>ddsql_query</code> is the only provider currently supported for host map widgets.</p>
  ...
  **/
  ...
  /**
   * <p>Filter applied to the dataset's rows, using events-style search syntax.</p>
   * @return filter
  **/
  ...
  /**
   * <p>Maximum number of rows to return from the dataset query.</p>
   * @return limit
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Sort configuration for a <code>DatasetListQuery</code>.</p>
   * @return sort
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSource, datasetListQuery.dataSource) && Objects.equals(this.datasetId, datasetListQuery.datasetId) && Objects.equals(this.datasetProvider, datasetListQuery.datasetProvider) && Objects.equals(this.filter, datasetListQuery.filter) && Objects.equals(this.limit, datasetListQuery.limit) && Objects.equals(this.sort, datasetListQuery.sort) && Objects.equals(this.additionalProperties, datasetListQuery.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(dataSource,datasetId,datasetProvider,filter,limit,sort, additionalProperties);
  }
