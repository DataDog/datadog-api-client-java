...
/**
   * <p>The User-Agent parser takes a User-Agent attribute and extracts the OS, browser, device, and other user data.
   * It recognizes major bots like the Google Bot, Yahoo Slurp, and Bing.</p>
 */
@JsonPropertyOrder({
...
public class LogsUserAgentParser {
  ...
  **/
  ...
  /**
   * <p>Define if the source attribute is URL encoded or not.</p>
   * @return isEncoded
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Type of logs User-Agent parser.</p>
   * @return type
  **/
