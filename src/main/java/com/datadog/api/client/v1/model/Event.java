...
public class Event {
  ...
  **/
   ...
   * Limited to events up to 18 hours in the past and two hours in the future.</p>
   * @return dateHappened
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alertType,dateHappened,deviceName,host,id,idStr,payload,priority,sourceTypeName,tags,text,title,url, additionalProperties);
  }
