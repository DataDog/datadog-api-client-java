...
/**
   * <p>A description of a single position for a <code>flick</code> step type.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsMobileStepParamsPositionsItems {
  ...
  /**
   * <p>The <code>x</code> position for the flick.</p>
   * @return x
  **/
  ...
  /**
   * <p>The <code>y</code> position for the flick.</p>
   * @return y
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsMobileStepParamsPositionsItems syntheticsMobileStepParamsPositionsItems = (SyntheticsMobileStepParamsPositionsItems) o;
    return Objects.equals(this.x, syntheticsMobileStepParamsPositionsItems.x) && Objects.equals(this.y, syntheticsMobileStepParamsPositionsItems.y) && Objects.equals(this.additionalProperties, syntheticsMobileStepParamsPositionsItems.additionalProperties);
  }
