...
public class LogsDailyLimitReset {
  ...
  /**
   * <p>String in <code>HH:00</code> format representing the time of day the daily limit should be reset. The hours must be between 00 and 23 (inclusive).</p>
   * @return resetTime
  **/
  ...
  /**
   * <p>String in <code>(-|+)HH:00</code> format representing the UTC offset to apply to the given reset time. The hours must be between -12 and +14 (inclusive).</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resetTime, logsDailyLimitReset.resetTime) && Objects.equals(this.resetUtcOffset, logsDailyLimitReset.resetUtcOffset) && Objects.equals(this.additionalProperties, logsDailyLimitReset.additionalProperties);
  }
