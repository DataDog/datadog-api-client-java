...
public class HostMapWidgetNodeType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("host", "container", "pod", "cluster"));
  ...
  public static class HostMapWidgetNodeTypeSerializer extends StdSerializer<HostMapWidgetNodeType> {
      ...
      @Override
      public void serialize(HostMapWidgetNodeType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
