...
public class SplitGraphVizSize extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("xs", "sm", "md", "lg"));
  ...
  public static class SplitGraphVizSizeSerializer extends StdSerializer<SplitGraphVizSize> {
      ...
      @Override
      public void serialize(SplitGraphVizSize value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
