...
@JsonPropertyOrder({WidgetSortBy.JSON_PROPERTY_COUNT, WidgetSortBy.JSON_PROPERTY_ORDER_BY})
...
public class WidgetSortBy {
  ...
  /**
   * The number of items to limit the widget to. minimum: 0
   *
   * @return count
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, widgetSortBy.count)
        && Objects.equals(this.orderBy, widgetSortBy.orderBy)
        && Objects.equals(this.additionalProperties, widgetSortBy.additionalProperties);
  }
