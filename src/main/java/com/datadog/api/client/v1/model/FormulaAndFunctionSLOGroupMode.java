 ...
 */
@JsonSerialize(using = FormulaAndFunctionSLOGroupMode.FormulaAndFunctionSLOGroupModeSerializer.class)
public class FormulaAndFunctionSLOGroupMode extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("overall", "components"));

  public static final FormulaAndFunctionSLOGroupMode OVERALL = new FormulaAndFunctionSLOGroupMode("overall");
  public static final FormulaAndFunctionSLOGroupMode COMPONENTS = new FormulaAndFunctionSLOGroupMode("components");
  ...
  public static class FormulaAndFunctionSLOGroupModeSerializer extends StdSerializer<FormulaAndFunctionSLOGroupMode> {
      ...
      @Override
      public void serialize(FormulaAndFunctionSLOGroupMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
