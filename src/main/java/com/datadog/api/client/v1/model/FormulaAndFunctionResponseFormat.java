...
public class FormulaAndFunctionResponseFormat extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("timeseries", "scalar", "event_list"));
  ...
  public static final FormulaAndFunctionResponseFormat EVENT_LIST = new FormulaAndFunctionResponseFormat("event_list");
