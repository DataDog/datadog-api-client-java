 ...
 */
  ...
  public CompletableFuture<ApiResponse<EventCreateResponse>> createEventWithHttpInfoAsync(EventCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("EventsApi.createEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<EventResponse>> getEventWithHttpInfoAsync(Long eventId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("EventsApi.getEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
