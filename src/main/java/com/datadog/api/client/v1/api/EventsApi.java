 ...
 */
  public CompletableFuture<EventCreateResponse>createEventAsync(EventCreateRequest body) {
    return createEventWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>This endpoint allows you to post events to the stream.
   * Tag them, set priority and event aggregate them with other events.</p>
   *
   * @param body Event request object (required)
  ...
  public ApiResponse<EventCreateResponse> createEventWithHttpInfo(EventCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.EventsApi.createEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventCreateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<EventCreateResponse>> createEventWithHttpInfoAsync(EventCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.EventsApi.createEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventCreateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventCreateResponse>() {});
  }
 ...
 */
  ...
  /**
   * <p>This endpoint allows you to query for event details.</p>
   * <p><strong>Note</strong>: If the event you’re querying contains markdown formatting of any kind,
   * you may see characters such as <code>%</code>,<code>\</code>,<code>n</code> in your output.</p>
   *
   * @param eventId The ID of the event. (required)
  ...
  public ApiResponse<EventResponse> getEventWithHttpInfo(Long eventId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.EventsApi.getEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<EventResponse>> getEventWithHttpInfoAsync(Long eventId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.EventsApi.getEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventResponse>() {});
  }
  ...
  public static class ListEventsOptionalParameters {
    ...
    /**
     * Set priority.
     * @param priority Priority of your events, either <code>low</code> or <code>normal</code>. (optional)
    ...
    /**
     * Set tags.
     * @param tags A comma separated list indicating what tags, if any, should be used to filter the list of events. (optional)
     * @return ListEventsOptionalParameters
     */
    ...
    /**
     * Set unaggregated.
     * @param unaggregated Set unaggregated to <code>true</code> to return all events within the specified [<code>start</code>,<code>end</code>] timeframe. Otherwise if an event is aggregated to a parent event with a timestamp outside of the timeframe, it won't be available in the output. Aggregated events with <code>is_aggregate=true</code> in the response will still be returned unless exclude_aggregate is set to <code>true.</code> (optional)
     * @return ListEventsOptionalParameters
     */
     ...
     * @param excludeAggregate Set <code>exclude_aggregate</code> to <code>true</code> to only return unaggregated events where <code>is_aggregate=false</code> in the response. If the <code>exclude_aggregate</code> parameter is set to <code>true</code>, then the unaggregated parameter is ignored and will be <code>true</code> by default. (optional)
     * @return ListEventsOptionalParameters
     */
    ...
    /**
     * Set page.
     * @param page By default 1000 results are returned per request. Set page to the number of the page to return with <code>0</code> being the first page. The page parameter can only be used when either unaggregated or exclude_aggregate is set to <code>true.</code> (optional)
     * @return ListEventsOptionalParameters
     */
 ...
 */
  public CompletableFuture<EventListResponse>listEventsAsync(Long start, Long end) {
    return listEventsWithHttpInfoAsync(start, end, new ListEventsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<EventListResponse>listEventsAsync( Long start,  Long end, ListEventsOptionalParameters parameters) {
    return listEventsWithHttpInfoAsync(start, end, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>The event stream can be queried and filtered by time, priority, sources and tags.</p>
   * <p><strong>Notes</strong>:
   * - If the event you’re querying contains markdown formatting of any kind,
   * you may see characters such as <code>%</code>,<code>\</code>,<code>n</code> in your output.</p>
   * <ul>
   * <li>This endpoint returns a maximum of <code>1000</code> most recent results. To return additional results,
   * identify the last timestamp of the last result and set that as the <code>end</code> query time to
   * paginate the results. You can also use the page parameter to specify which set of <code>1000</code> results to return.</li>
   * </ul>
   *
   * @param start POSIX timestamp. (required)
   * @param end POSIX timestamp. (required)
  ...
  public ApiResponse<EventListResponse> listEventsWithHttpInfo(Long start, Long end, ListEventsOptionalParameters parameters) throws ApiException {
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "exclude_aggregate", excludeAggregate));
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page", page));

    Invocation.Builder builder = apiClient.createBuilder("v1.EventsApi.listEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<EventListResponse>> listEventsWithHttpInfoAsync(Long start, Long end, ListEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.EventsApi.listEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventListResponse>() {});
  }
}