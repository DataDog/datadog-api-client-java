...
public class SyntheticsBasicAuthWebType extends ModelEnum<String> {
  ...
  public static class SyntheticsBasicAuthWebTypeSerializer extends StdSerializer<SyntheticsBasicAuthWebType> {
      ...
      @Override
      public void serialize(SyntheticsBasicAuthWebType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
