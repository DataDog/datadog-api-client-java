...
/**
   * <p>The description of a notebook cell update request.</p>
 */
@JsonPropertyOrder({
...
public class NotebookCellUpdateRequest {
  ...
  /**
   * <p>The attributes of a notebook cell in update cell request. Valid cell types are <code>markdown</code>, <code>timeseries</code>, <code>toplist</code>, <code>heatmap</code>, <code>distribution</code>,
  ...
  **/
   ...
   */
  @JsonAnySetter
  public NotebookCellUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, notebookCellUpdateRequest.attributes) && Objects.equals(this.id, notebookCellUpdateRequest.id) && Objects.equals(this.type, notebookCellUpdateRequest.type) && Objects.equals(this.additionalProperties, notebookCellUpdateRequest.additionalProperties);
  }
