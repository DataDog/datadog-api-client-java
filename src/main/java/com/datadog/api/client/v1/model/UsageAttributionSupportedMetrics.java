...
/**
   * <p>Supported fields for usage attribution requests (valid requests contain one or more metrics, or <code>*</code> for all).</p>
 */
@JsonSerialize(using = UsageAttributionSupportedMetrics.UsageAttributionSupportedMetricsSerializer.class)
public class UsageAttributionSupportedMetrics {
  ...
  public static final UsageAttributionSupportedMetrics LAMBDA_FUNCTIONS_USAGE = new UsageAttributionSupportedMetrics("lambda_functions_usage");
  public static final UsageAttributionSupportedMetrics LAMBDA_FUNCTIONS_PERCENTAGE = new UsageAttributionSupportedMetrics("lambda_functions_percentage");
  public static final UsageAttributionSupportedMetrics LAMBDA_INVOCATIONS_USAGE = new UsageAttributionSupportedMetrics("lambda_invocations_usage");
  public static final UsageAttributionSupportedMetrics LAMBDA_INVOCATIONS_PERCENTAGE = new UsageAttributionSupportedMetrics("lambda_invocations_percentage");
  public static final UsageAttributionSupportedMetrics FARGATE_USAGE = new UsageAttributionSupportedMetrics("fargate_usage");
  public static final UsageAttributionSupportedMetrics FARGATE_PERCENTAGE = new UsageAttributionSupportedMetrics("fargate_percentage");
  public static final UsageAttributionSupportedMetrics PROFILED_HOST_USAGE = new UsageAttributionSupportedMetrics("profiled_host_usage");
  public static final UsageAttributionSupportedMetrics PROFILED_HOST_PERCENTAGE = new UsageAttributionSupportedMetrics("profiled_host_percentage");
  ...
  public static final UsageAttributionSupportedMetrics DBM_HOSTS_USAGE = new UsageAttributionSupportedMetrics("dbm_hosts_usage");
  public static final UsageAttributionSupportedMetrics DBM_HOSTS_PERCENTAGE = new UsageAttributionSupportedMetrics("dbm_hosts_percentage");
  public static final UsageAttributionSupportedMetrics DBM_QUERIES_USAGE = new UsageAttributionSupportedMetrics("dbm_queries_usage");
  public static final UsageAttributionSupportedMetrics DBM_QUERIES_PERCENTAGE = new UsageAttributionSupportedMetrics("dbm_queries_percentage");
  ...
  public static final UsageAttributionSupportedMetrics ESTIMATED_INGESTED_LOGS_USAGE = new UsageAttributionSupportedMetrics("estimated_ingested_logs_usage");
  public static final UsageAttributionSupportedMetrics ESTIMATED_INGESTED_LOGS_PERCENTAGE = new UsageAttributionSupportedMetrics("estimated_ingested_logs_percentage");
  ...
  public static final UsageAttributionSupportedMetrics APM_FARGATE_USAGE = new UsageAttributionSupportedMetrics("apm_fargate_usage");
  public static final UsageAttributionSupportedMetrics APM_FARGATE_PERCENTAGE = new UsageAttributionSupportedMetrics("apm_fargate_percentage");
  public static final UsageAttributionSupportedMetrics APPSEC_FARGATE_USAGE = new UsageAttributionSupportedMetrics("appsec_fargate_usage");
  public static final UsageAttributionSupportedMetrics APPSEC_FARGATE_PERCENTAGE = new UsageAttributionSupportedMetrics("appsec_fargate_percentage");
  public static final UsageAttributionSupportedMetrics ESTIMATED_RUM_USAGE_ATTRIBUTION_USAGE = new UsageAttributionSupportedMetrics("estimated_rum_usage_attribution_usage");
  public static final UsageAttributionSupportedMetrics ESTIMATED_RUM_USAGE_ATTRIBUTION_PERCENTAGE = new UsageAttributionSupportedMetrics("estimated_rum_usage_attribution_percentage");
  public static final UsageAttributionSupportedMetrics ALL = new UsageAttributionSupportedMetrics("*");

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("custom_timeseries_usage", "container_usage", "snmp_percentage", "apm_host_usage", "browser_usage", "npm_host_percentage", "infra_host_usage", "custom_timeseries_percentage", "container_percentage", "api_usage", "apm_host_percentage", "infra_host_percentage", "snmp_usage", "browser_percentage", "api_percentage", "npm_host_usage", "lambda_functions_usage", "lambda_functions_percentage", "lambda_invocations_usage", "lambda_invocations_percentage", "fargate_usage", "fargate_percentage", "profiled_host_usage", "profiled_host_percentage", "profiled_container_usage", "profiled_container_percentage", "dbm_hosts_usage", "dbm_hosts_percentage", "dbm_queries_usage", "dbm_queries_percentage", "estimated_indexed_logs_usage", "estimated_indexed_logs_percentage", "estimated_ingested_logs_usage", "estimated_ingested_logs_percentage", "appsec_usage", "appsec_percentage", "estimated_indexed_spans_usage", "estimated_indexed_spans_percentage", "estimated_ingested_spans_usage", "estimated_ingested_spans_percentage", "apm_fargate_usage", "apm_fargate_percentage", "appsec_fargate_usage", "appsec_fargate_percentage", "estimated_rum_usage_attribution_usage", "estimated_rum_usage_attribution_percentage", "*"));
  ...
  public static class UsageAttributionSupportedMetricsSerializer extends StdSerializer<UsageAttributionSupportedMetrics> {
      ...
      @Override
      public void serialize(UsageAttributionSupportedMetrics value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
