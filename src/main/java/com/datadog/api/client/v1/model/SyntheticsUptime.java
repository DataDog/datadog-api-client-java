...
public class SyntheticsUptime {
  ...
  private JsonNullable<List<SLOHistoryResponseErrorWithType>> errors =
      JsonNullable.<List<SLOHistoryResponseErrorWithType>>undefined();
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  public void setErrors_JsonNullable(JsonNullable<List<SLOHistoryResponseErrorWithType>> errors) {
    this.errors = errors;
  }
   ...
   * the second element is the state (integer). For the state, an integer value of <code>0</code>
   * indicates uptime, <code>1</code> indicates downtime, and <code>2</code> indicates no data.
   *
   * @return history
   */
  @jakarta.annotation.Nullable
