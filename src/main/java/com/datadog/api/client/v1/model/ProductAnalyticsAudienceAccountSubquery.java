...
/**
   * <p>Product Analytics audience account subquery.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsAudienceAccountSubquery {
  ...
  /**
   * <p>The name of the account subquery.</p>
   * @return name
  **/
  ...
  /**
   * <p>The query string for the account subquery.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsAudienceAccountSubquery productAnalyticsAudienceAccountSubquery = (ProductAnalyticsAudienceAccountSubquery) o;
    return Objects.equals(this.name, productAnalyticsAudienceAccountSubquery.name) && Objects.equals(this.query, productAnalyticsAudienceAccountSubquery.query) && Objects.equals(this.additionalProperties, productAnalyticsAudienceAccountSubquery.additionalProperties);
  }
