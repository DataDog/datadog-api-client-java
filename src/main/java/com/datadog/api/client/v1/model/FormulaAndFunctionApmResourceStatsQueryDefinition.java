...
/**
   * <p>APM resource stats query using formulas and functions. Deprecated - Use <code>apm_metrics</code> query type instead.</p>
 * @deprecated
 */
@Deprecated
@JsonPropertyOrder({
...
public class FormulaAndFunctionApmResourceStatsQueryDefinition {
  ...
  @JsonCreator
  public FormulaAndFunctionApmResourceStatsQueryDefinition(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)FormulaAndFunctionApmResourceStatsDataSource dataSource,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STAT)FormulaAndFunctionApmResourceStatName stat) {
  ...
  public FormulaAndFunctionApmResourceStatsQueryDefinition crossOrgUuids(List<String> crossOrgUuids) {
    this.crossOrgUuids = crossOrgUuids;
    return this;
  }
  public FormulaAndFunctionApmResourceStatsQueryDefinition addCrossOrgUuidsItem(String crossOrgUuidsItem) {
  ...
  **/
  ...
  public FormulaAndFunctionApmResourceStatsQueryDefinition dataSource(FormulaAndFunctionApmResourceStatsDataSource dataSource) {
    this.dataSource = dataSource;
    this.unparsed |= !dataSource.isValid();
    return this;
  }
  ...
  /**
   * <p>Data source for APM resource stats queries.</p>
   * @return dataSource
  **/
  ...
  **/
  ...
  /**
   * <p>Array of fields to group results by.</p>
   * @return groupBy
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Name of the second primary tag used within APM. Required when <code>primary_tag_value</code> is specified. See https://docs.datadoghq.com/tracing/guide/setting_primary_tags_to_scope/#add-a-second-primary-tag-in-datadog</p>
  ...
  **/
  ...
  /**
   * <p>Value of the second primary tag by which to filter APM data. <code>primary_tag_name</code> must also be specified.</p>
  ...
  **/
  ...
  public FormulaAndFunctionApmResourceStatsQueryDefinition stat(FormulaAndFunctionApmResourceStatName stat) {
    this.stat = stat;
    this.unparsed |= !stat.isValid();
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public FormulaAndFunctionApmResourceStatsQueryDefinition putAdditionalProperty(String key, Object value) {
