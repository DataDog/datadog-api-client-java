...
public class ListStreamSource {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs_stream", "audit_stream", "ci_pipeline_stream", "rum_issue_stream", "apm_issue_stream", "logs_pattern_stream", "logs_transaction_stream", "event_stream"));
