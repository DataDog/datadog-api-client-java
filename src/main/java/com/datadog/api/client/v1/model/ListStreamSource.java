...
public class ListStreamSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs_stream", "audit_stream", "ci_pipeline_stream", "ci_test_stream", "rum_issue_stream", "apm_issue_stream", "trace_stream", "logs_issue_stream", "logs_pattern_stream", "logs_transaction_stream", "event_stream", "rum_stream", "llm_observability_stream", "issue_stream", "security_runtime_stream", "security_signals_stream", "incidents_stream"));
  ...
  public static final ListStreamSource SECURITY_RUNTIME_STREAM = new ListStreamSource("security_runtime_stream");
  public static final ListStreamSource SECURITY_SIGNALS_STREAM = new ListStreamSource("security_signals_stream");
