...
/**
   * <p>Infrastructure-backed host map child request (leaf node, no further nesting supported).</p>
 */
@JsonPropertyOrder({
...
public class HostMapWidgetInfrastructureRequestLeaf {
  ...
  @JsonCreator
  public HostMapWidgetInfrastructureRequestLeaf(
            @JsonProperty(required=true, value=JSON_PROPERTY_ENRICHMENTS)List<HostMapWidgetScalarRequest> enrichments,
            @JsonProperty(required=true, value=JSON_PROPERTY_NODE_TYPE)HostMapWidgetNodeType nodeType,
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUEST_TYPE)HostMapWidgetInfrastructureRequestRequestType requestType) {
  ...
  public HostMapWidgetInfrastructureRequestLeaf conditionalFormats(List<WidgetConditionalFormat> conditionalFormats) {
  ...
  public HostMapWidgetInfrastructureRequestLeaf addConditionalFormatsItem(WidgetConditionalFormat conditionalFormatsItem) {
  ...
  **/
  ...
  public HostMapWidgetInfrastructureRequestLeaf enrichments(List<HostMapWidgetScalarRequest> enrichments) {
    this.enrichments = enrichments;
    for (HostMapWidgetScalarRequest item : enrichments) {
      this.unparsed |= item.unparsed;
    }
  ...
  public HostMapWidgetInfrastructureRequestLeaf addEnrichmentsItem(HostMapWidgetScalarRequest enrichmentsItem) {
  ...
  /**
   * <p>Metric or event queries joined to the entity set. Each formula specifies a visual dimension.</p>
   * @return enrichments
  **/
  ...
  /**
   * <p>Filter string for the entity set in tag format (for example, <code>env:prod</code>).</p>
   * @return filter
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public HostMapWidgetInfrastructureRequestLeaf requestType(HostMapWidgetInfrastructureRequestRequestType requestType) {
    this.requestType = requestType;
    this.unparsed |= !requestType.isValid();
    return this;
  }
  ...
  /**
   * <p>Identifies this as an infrastructure-backed host map request.</p>
   * @return requestType
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HostMapWidgetInfrastructureRequestLeaf hostMapWidgetInfrastructureRequestLeaf = (HostMapWidgetInfrastructureRequestLeaf) o;
    return Objects.equals(this.conditionalFormats, hostMapWidgetInfrastructureRequestLeaf.conditionalFormats) && Objects.equals(this.enrichments, hostMapWidgetInfrastructureRequestLeaf.enrichments) && Objects.equals(this.filter, hostMapWidgetInfrastructureRequestLeaf.filter) && Objects.equals(this.groupBy, hostMapWidgetInfrastructureRequestLeaf.groupBy) && Objects.equals(this.noGroupHosts, hostMapWidgetInfrastructureRequestLeaf.noGroupHosts) && Objects.equals(this.noMetricHosts, hostMapWidgetInfrastructureRequestLeaf.noMetricHosts) && Objects.equals(this.nodeType, hostMapWidgetInfrastructureRequestLeaf.nodeType) && Objects.equals(this.requestType, hostMapWidgetInfrastructureRequestLeaf.requestType) && Objects.equals(this.style, hostMapWidgetInfrastructureRequestLeaf.style) && Objects.equals(this.additionalProperties, hostMapWidgetInfrastructureRequestLeaf.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(conditionalFormats,enrichments,filter,groupBy,noGroupHosts,noMetricHosts,nodeType,requestType,style, additionalProperties);
  }
