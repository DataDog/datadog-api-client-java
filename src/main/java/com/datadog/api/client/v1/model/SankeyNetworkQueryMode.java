...
public class SankeyNetworkQueryMode extends ModelEnum<String> {
  ...
  public static class SankeyNetworkQueryModeSerializer extends StdSerializer<SankeyNetworkQueryMode> {
      ...
      @Override
      public void serialize(SankeyNetworkQueryMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
