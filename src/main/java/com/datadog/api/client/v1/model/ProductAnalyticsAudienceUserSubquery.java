...
/**
   * <p>Product Analytics audience user subquery.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsAudienceUserSubquery {
  ...
  /**
   * <p>The name of the user subquery.</p>
   * @return name
  **/
  ...
  /**
   * <p>The query string for the user subquery.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsAudienceUserSubquery productAnalyticsAudienceUserSubquery = (ProductAnalyticsAudienceUserSubquery) o;
    return Objects.equals(this.name, productAnalyticsAudienceUserSubquery.name) && Objects.equals(this.query, productAnalyticsAudienceUserSubquery.query) && Objects.equals(this.additionalProperties, productAnalyticsAudienceUserSubquery.additionalProperties);
  }
