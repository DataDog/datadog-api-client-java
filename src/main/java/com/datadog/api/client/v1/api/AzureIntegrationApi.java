 ...
 */
  ...
  public CompletableFuture<ApiResponse<Object>> createAzureIntegrationWithHttpInfoAsync(AzureAccount body) {
    ...
    try {
      builder = apiClient.createBuilder("AzureIntegrationApi.createAzureIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Object>> deleteAzureIntegrationWithHttpInfoAsync(AzureAccount body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("AzureIntegrationApi.deleteAzureIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<List<AzureAccount>>> listAzureIntegrationWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("AzureIntegrationApi.listAzureIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Object>> updateAzureHostFiltersWithHttpInfoAsync(AzureAccount body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("AzureIntegrationApi.updateAzureHostFilters", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Object>> updateAzureIntegrationWithHttpInfoAsync(AzureAccount body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("AzureIntegrationApi.updateAzureIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
