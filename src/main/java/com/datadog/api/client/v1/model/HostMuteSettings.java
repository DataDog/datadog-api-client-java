...
/**
   * <p>Combination of settings to mute a host.</p>
 */
@JsonPropertyOrder({
...
public class HostMuteSettings {
  ...
  /**
   * <p>POSIX timestamp in seconds when the host is unmuted. If omitted, the host remains muted until explicitly unmuted.</p>
   * @return end
  **/
  ...
  /**
   * <p>Message to associate with the muting of this host.</p>
   * @return message
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>If true and the host is already muted, replaces existing host mute settings.</p>
   * @return override
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, hostMuteSettings.end) && Objects.equals(this.message, hostMuteSettings.message) && Objects.equals(this.override, hostMuteSettings.override) && Objects.equals(this.additionalProperties, hostMuteSettings.additionalProperties);
  }
