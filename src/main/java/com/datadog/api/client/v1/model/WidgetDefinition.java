...
public class WidgetDefinition extends AbstractOpenApiSchema {
    ...
    public static class WidgetDefinitionDeserializer extends StdDeserializer<WidgetDefinition> {
        ...
        public WidgetDefinition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (CohortWidgetDefinition.class.equals(Integer.class) || CohortWidgetDefinition.class.equals(Long.class) || CohortWidgetDefinition.class.equals(Float.class) || CohortWidgetDefinition.class.equals(Double.class) || CohortWidgetDefinition.class.equals(Boolean.class) || CohortWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((CohortWidgetDefinition.class.equals(Integer.class) || CohortWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((CohortWidgetDefinition.class.equals(Float.class) || CohortWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (CohortWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (CohortWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ProductAnalyticsFunnelWidgetDefinition.class.equals(Integer.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Long.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Float.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Double.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Boolean.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ProductAnalyticsFunnelWidgetDefinition.class.equals(Integer.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ProductAnalyticsFunnelWidgetDefinition.class.equals(Float.class) || ProductAnalyticsFunnelWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ProductAnalyticsFunnelWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ProductAnalyticsFunnelWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(ProductAnalyticsFunnelWidgetDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'ProductAnalyticsFunnelWidgetDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'ProductAnalyticsFunnelWidgetDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (PointPlotWidgetDefinition.class.equals(Integer.class) || PointPlotWidgetDefinition.class.equals(Long.class) || PointPlotWidgetDefinition.class.equals(Float.class) || PointPlotWidgetDefinition.class.equals(Double.class) || PointPlotWidgetDefinition.class.equals(Boolean.class) || PointPlotWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((PointPlotWidgetDefinition.class.equals(Integer.class) || PointPlotWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((PointPlotWidgetDefinition.class.equals(Float.class) || PointPlotWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (PointPlotWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (PointPlotWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (RetentionCurveWidgetDefinition.class.equals(Integer.class) || RetentionCurveWidgetDefinition.class.equals(Long.class) || RetentionCurveWidgetDefinition.class.equals(Float.class) || RetentionCurveWidgetDefinition.class.equals(Double.class) || RetentionCurveWidgetDefinition.class.equals(Boolean.class) || RetentionCurveWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((RetentionCurveWidgetDefinition.class.equals(Integer.class) || RetentionCurveWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((RetentionCurveWidgetDefinition.class.equals(Float.class) || RetentionCurveWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (RetentionCurveWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (RetentionCurveWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'RetentionCurveWidgetDefinition'", e);
            }
            ...
            // deserialize SankeyWidgetDefinition
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (SankeyWidgetDefinition.class.equals(Integer.class) || SankeyWidgetDefinition.class.equals(Long.class) || SankeyWidgetDefinition.class.equals(Float.class) || SankeyWidgetDefinition.class.equals(Double.class) || SankeyWidgetDefinition.class.equals(Boolean.class) || SankeyWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SankeyWidgetDefinition.class.equals(Integer.class) || SankeyWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SankeyWidgetDefinition.class.equals(Float.class) || SankeyWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SankeyWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SankeyWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(SankeyWidgetDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    if (!((SankeyWidgetDefinition) tmp).unparsed) {
                        deserialized = tmp;
                        match++;
                    }
                    log.log(Level.FINER, "Input data matches schema 'SankeyWidgetDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'SankeyWidgetDefinition'", e);
            }
            ...
            try {
                ...
                if (attemptParsing) {
                    ...
                    if (!((TopologyMapWidgetDefinition) tmp).unparsed
                            && !(((TopologyMapWidgetDefinition) tmp).getActualInstance() instanceof UnparsedObject)) {
                        deserialized = tmp;
                        match++;
                    }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (WildcardWidgetDefinition.class.equals(Integer.class) || WildcardWidgetDefinition.class.equals(Long.class) || WildcardWidgetDefinition.class.equals(Float.class) || WildcardWidgetDefinition.class.equals(Double.class) || WildcardWidgetDefinition.class.equals(Boolean.class) || WildcardWidgetDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((WildcardWidgetDefinition.class.equals(Integer.class) || WildcardWidgetDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WildcardWidgetDefinition.class.equals(Float.class) || WildcardWidgetDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WildcardWidgetDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WildcardWidgetDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
    ...
    public WidgetDefinition(SankeyWidgetDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("ProductAnalyticsFunnelWidgetDefinition", new GenericType<ProductAnalyticsFunnelWidgetDefinition>() {
        });
        ...
        schemas.put("RetentionCurveWidgetDefinition", new GenericType<RetentionCurveWidgetDefinition>() {
        });
        ...
        schemas.put("SankeyWidgetDefinition", new GenericType<SankeyWidgetDefinition>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(ProductAnalyticsFunnelWidgetDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (JSON.isInstanceOf(RetentionCurveWidgetDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (JSON.isInstanceOf(SankeyWidgetDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `CohortWidgetDefinition`. If the actual instance is not `CohortWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `ProductAnalyticsFunnelWidgetDefinition`. If the actual instance is not `ProductAnalyticsFunnelWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public ProductAnalyticsFunnelWidgetDefinition getProductAnalyticsFunnelWidgetDefinition() throws ClassCastException {
    ...
    /**
     * Get the actual instance of `PointPlotWidgetDefinition`. If the actual instance is not `PointPlotWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `RetentionCurveWidgetDefinition`. If the actual instance is not `RetentionCurveWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public RetentionCurveWidgetDefinition getRetentionCurveWidgetDefinition() throws ClassCastException {
    ...
    /**
     * Get the actual instance of `SankeyWidgetDefinition`. If the actual instance is not `SankeyWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `SankeyWidgetDefinition`
     * @throws ClassCastException if the instance is not `SankeyWidgetDefinition`
     */
    public SankeyWidgetDefinition getSankeyWidgetDefinition() throws ClassCastException {
        return (SankeyWidgetDefinition)super.getActualInstance();
    }
    ...
    /**
     * Get the actual instance of `WildcardWidgetDefinition`. If the actual instance is not `WildcardWidgetDefinition`,
     * the ClassCastException will be thrown.
     *
