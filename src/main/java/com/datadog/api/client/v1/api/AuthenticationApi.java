 ...
 */
  ...
  public CompletableFuture<ApiResponse<AuthenticationValidationResponse>> validateWithHttpInfoAsync() {
    ...
    try {
      builder = apiClient.createBuilder("AuthenticationApi.validate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth" });
