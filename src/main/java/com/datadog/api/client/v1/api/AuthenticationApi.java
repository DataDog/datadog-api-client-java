 ...
 */
  ...
  public ApiResponse<AuthenticationValidationResponse> validateWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AuthenticationApi.validate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AuthenticationValidationResponse>> validateWithHttpInfoAsync() {
    ...
    try {
      builder = apiClient.createBuilder("v1.AuthenticationApi.validate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth" });
