...
public class SyntheticsBasicAuthOauthClient {
  ...
  public SyntheticsBasicAuthOauthClient(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SyntheticsBasicAuthOauthClientType type) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessTokenUrl,audience,clientId,clientSecret,resource,scope,tokenApiAuthentication,type, additionalProperties);
  }
