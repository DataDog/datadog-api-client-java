...
/**
   * <p>There are two ways to define correlation between application spans and logs:</p>
   * <ol>
   * <li>
   * <p>Follow the documentation on <a href="https://docs.datadoghq.com/tracing/connect_logs_and_traces">how to inject a span ID in the application logs</a>.
   *   Log integrations automatically handle all remaining setup steps by default.</p>
   * </li>
   * <li>
   * <p>Use the span remapper processor to define a log attribute as its associated span ID.</p>
   * </li>
   * </ol>
 */
@JsonPropertyOrder({
...
public class LogsSpanRemapper {
  ...
  **/
  ...
  /**
   * <p>Type of logs span remapper.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isEnabled, logsSpanRemapper.isEnabled) && Objects.equals(this.name, logsSpanRemapper.name) && Objects.equals(this.sources, logsSpanRemapper.sources) && Objects.equals(this.type, logsSpanRemapper.type) && Objects.equals(this.additionalProperties, logsSpanRemapper.additionalProperties);
  }
