...
public class PointPlotProjectionType extends ModelEnum<String> {
  ...
  public static final PointPlotProjectionType POINT_PLOT = new PointPlotProjectionType("point_plot");
  ...
  public static class PointPlotProjectionTypeSerializer extends StdSerializer<PointPlotProjectionType> {
      ...
      @Override
      public void serialize(PointPlotProjectionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
