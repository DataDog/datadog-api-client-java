...
/**
   * <p>Number of hosts/containers recorded for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class UsageHostHour {
  ...
  /**
   * <p>Contains the total number of infrastructure hosts reporting
   * during a given hour that were running the Datadog Agent.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_HOST_COUNT)public void setAgentHostCount_JsonNullable(JsonNullable<Long> agentHostCount) {
  ...
  /**
   * <p>Contains the total number of hosts that reported through Alibaba integration
   * (and were NOT running the Datadog Agent).</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALIBABA_HOST_COUNT)public void setAlibabaHostCount_JsonNullable(JsonNullable<Long> alibabaHostCount) {
  ...
  /**
   * <p>Contains the total number of Azure App Services hosts using APM.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_APM_AZURE_APP_SERVICE_HOST_COUNT)public void setApmAzureAppServiceHostCount_JsonNullable(JsonNullable<Long> apmAzureAppServiceHostCount) {
  ...
  /**
   * <p>Shows the total number of hosts using APM during the hour,
   * these are counted as billable (except during trial periods).</p>
   * @return apmHostCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_APM_HOST_COUNT)public void setApmHostCount_JsonNullable(JsonNullable<Long> apmHostCount) {
  ...
  /**
   * <p>Contains the total number of hosts that reported through the AWS integration
   * (and were NOT running the Datadog Agent).</p>
   * @return awsHostCount
  **/
      @jakarta.annotation.Nullable
  ...
  @JsonProperty(JSON_PROPERTY_AWS_HOST_COUNT)public void setAwsHostCount_JsonNullable(JsonNullable<Long> awsHostCount) {
  ...
  /**
   * <p>Contains the total number of hosts that reported through Azure integration
   * (and were NOT running the Datadog Agent).</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AZURE_HOST_COUNT)public void setAzureHostCount_JsonNullable(JsonNullable<Long> azureHostCount) {
  ...
  /**
   * <p>Shows the total number of containers reported by the Docker integration during the hour.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CONTAINER_COUNT)public void setContainerCount_JsonNullable(JsonNullable<Long> containerCount) {
  ...
  /**
   * <p>Contains the total number of hosts that reported through the Google Cloud integration
   * (and were NOT running the Datadog Agent).</p>
   * @return gcpHostCount
  **/
      @jakarta.annotation.Nullable
  ...
  @JsonProperty(JSON_PROPERTY_GCP_HOST_COUNT)public void setGcpHostCount_JsonNullable(JsonNullable<Long> gcpHostCount) {
  ...
  /**
   * <p>Contains the total number of Heroku dynos reported by the Datadog Agent.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_HEROKU_HOST_COUNT)public void setHerokuHostCount_JsonNullable(JsonNullable<Long> herokuHostCount) {
  ...
  /**
   * <p>Contains the total number of billable infrastructure hosts reporting during a given hour.
   * This is the sum of <code>agent_host_count</code>, <code>aws_host_count</code>, and <code>gcp_host_count</code>.</p>
   * @return hostCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_HOUR)public void setHour_JsonNullable(JsonNullable<OffsetDateTime> hour) {
    this.hour = hour;
  }
  ...
  /**
   * <p>Contains the total number of hosts that reported through the Azure App Services integration
   * (and were NOT running the Datadog Agent).</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INFRA_AZURE_APP_SERVICE)public void setInfraAzureAppService_JsonNullable(JsonNullable<Long> infraAzureAppService) {
  ...
  /**
   * <p>Contains the total number of hosts using APM reported by Datadog exporter for the OpenTelemetry Collector.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_OPENTELEMETRY_APM_HOST_COUNT)public void setOpentelemetryApmHostCount_JsonNullable(JsonNullable<Long> opentelemetryApmHostCount) {
  ...
  /**
   * <p>Contains the total number of hosts reported by Datadog exporter for the OpenTelemetry Collector.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_OPENTELEMETRY_HOST_COUNT)public void setOpentelemetryHostCount_JsonNullable(JsonNullable<Long> opentelemetryHostCount) {
  ...
  **/
  ...
  /**
   * <p>Contains the total number of hosts that reported through vSphere integration
   * (and were NOT running the Datadog Agent).</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_VSPHERE_HOST_COUNT)public void setVsphereHostCount_JsonNullable(JsonNullable<Long> vsphereHostCount) {
