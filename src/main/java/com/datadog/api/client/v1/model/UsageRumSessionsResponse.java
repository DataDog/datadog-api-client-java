...
/**
   * <p>Response containing the number of RUM sessions for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
  UsageRumSessionsResponse.JSON_PROPERTY_USAGE
})
...
public class UsageRumSessionsResponse {
  ...
  /**
   * <p>Get hourly usage for RUM sessions.</p>
   * @return usage
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageRumSessionsResponse.usage) && Objects.equals(this.additionalProperties, usageRumSessionsResponse.additionalProperties);
  }
