...
public class HeatMapWidgetRequest {
  ...
  public HeatMapWidgetRequest query(DistributionWidgetHistogramRequestQuery query) {
    this.query = query;
  ...
  public HeatMapWidgetRequest requestType(DistributionWidgetHistogramRequestType requestType) {
