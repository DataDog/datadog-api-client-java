...
public class SyntheticsMCPProtocolVersion extends ModelEnum<String> {
  ...
  public static final SyntheticsMCPProtocolVersion VERSION_2025_06_18 = new SyntheticsMCPProtocolVersion("2025-06-18");
  ...
  public static class SyntheticsMCPProtocolVersionSerializer extends StdSerializer<SyntheticsMCPProtocolVersion> {
      ...
      @Override
      public void serialize(SyntheticsMCPProtocolVersion value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
