...
@JsonSerialize(
    using =
        ScatterplotDataProjectionProjectionType.ScatterplotDataProjectionProjectionTypeSerializer
            .class)
public class ScatterplotDataProjectionProjectionType extends ModelEnum<String> {
  ...
  public static class ScatterplotDataProjectionProjectionTypeSerializer
      extends StdSerializer<ScatterplotDataProjectionProjectionType> {
    public ScatterplotDataProjectionProjectionTypeSerializer(
        Class<ScatterplotDataProjectionProjectionType> t) {
      super(t);
    }
