...
public class WidgetCompareTo extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("hour_before", "day_before", "week_before", "month_before"));
  ...
  public static class WidgetCompareToSerializer extends StdSerializer<WidgetCompareTo> {
      ...
      @Override
      public void serialize(WidgetCompareTo value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
