...
public class SyntheticsTestRequest {
  ...
  public SyntheticsTestRequest bodyType(String bodyType) {
    this.bodyType = bodyType;
    return this;
  }

  /**
   * Request body type. Supported values are <code>text/plain</code>, <code>application/json</code>,
   * <code>text/xml</code>, <code>text/html</code>, <code>application/x-www-form-urlencoded</code>,
   * <code>GraphQL</code>, or <code>None</code>.
   *
   * @return bodyType
   */
  @jakarta.annotation.Nullable
