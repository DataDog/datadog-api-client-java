...
public class SyntheticsTestRequest {
  ...
  **/
  ...
  /**
   * <p>The MCP protocol version used by the step. See https://modelcontextprotocol.io/specification.</p>
  ...
  **/
  ...
  /**
   * <p>Arguments to pass to the MCP tool. Free-form object whose shape depends on the tool. Used when <code>callType</code> is <code>tool_call</code>.</p>
   * @return toolArgs
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name of the MCP tool to call. Required when <code>callType</code> is <code>tool_call</code>.</p>
   * @return toolName
  **/
      @jakarta.annotation.Nullable
