...
public class SyntheticsTestRequest {
  ...
  **/
  ...
  /**
   * <p>gRPC service on which you want to perform the healthcheck.</p>
   * @return service
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowInsecure,basicAuth,body,certificate,dnsServer,dnsServerPort,followRedirects,headers,host,message,metadata,method,noSavingResponseBody,numberOfPackets,port,proxy,query,servername,service,shouldTrackHops,timeout,url);
  }
