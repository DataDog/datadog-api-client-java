...
/**
   * <p>Query to the data streams topology data source.</p>
 */
@JsonPropertyOrder({
...
public class TopologyQueryDataStreams {
  ...
  @JsonCreator
  public TopologyQueryDataStreams(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)TopologyQueryDataStreamsDataSource dataSource,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSource, topologyQueryDataStreams.dataSource) && Objects.equals(this.filters, topologyQueryDataStreams.filters) && Objects.equals(this.queryString, topologyQueryDataStreams.queryString) && Objects.equals(this.service, topologyQueryDataStreams.service);
  }
