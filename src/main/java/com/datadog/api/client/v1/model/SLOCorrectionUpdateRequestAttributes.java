...
public class SLOCorrectionUpdateRequestAttributes {
  ...
  **/
  ...
  /**
   * <p>Query that matches the SLOs this correction applies to.
   * The query uses the <a href="https://docs.datadoghq.com/events/explorer/searching/">Events search syntax</a>
   * and can filter SLOs by SLO tags.</p>
   * @return sloQuery
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, sloCorrectionUpdateRequestAttributes.category) && Objects.equals(this.description, sloCorrectionUpdateRequestAttributes.description) && Objects.equals(this.duration, sloCorrectionUpdateRequestAttributes.duration) && Objects.equals(this.end, sloCorrectionUpdateRequestAttributes.end) && Objects.equals(this.rrule, sloCorrectionUpdateRequestAttributes.rrule) && Objects.equals(this.sloQuery, sloCorrectionUpdateRequestAttributes.sloQuery) && Objects.equals(this.start, sloCorrectionUpdateRequestAttributes.start) && Objects.equals(this.timezone, sloCorrectionUpdateRequestAttributes.timezone) && Objects.equals(this.additionalProperties, sloCorrectionUpdateRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(category,description,duration,end,rrule,sloQuery,start,timezone, additionalProperties);
  }
