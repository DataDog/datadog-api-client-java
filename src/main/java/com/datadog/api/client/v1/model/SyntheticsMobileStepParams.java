...
@JsonPropertyOrder({
  ...
  SyntheticsMobileStepParams.JSON_PROPERTY_POSITION,
...
public class SyntheticsMobileStepParams {
  ...
  private SyntheticsMobileStepParamsCheck check;
  ...
  private SyntheticsMobileStepParamsPosition position;
  ...
  public SyntheticsMobileStepParams check(SyntheticsMobileStepParamsCheck check) {
    this.check = check;
  ...
  public SyntheticsMobileStepParamsCheck getCheck() {
    return check;
  }

  public void setCheck(SyntheticsMobileStepParamsCheck check) {
    this.check = check;
  }
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>delay</code>. minimum: 0 maximum: 5000
   *
   * @return delay
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The definition of <code>SyntheticsMobileStepParamsDirection</code> object.
   *
   * @return direction
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>enable</code>.
   *
   * @return enable
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>maxScrolls</code>.
   *
   * @return maxScrolls
   */
  @jakarta.annotation.Nullable
  ...
  public SyntheticsMobileStepParams position(SyntheticsMobileStepParamsPosition position) {
    this.position = position;
    this.unparsed |= position.unparsed;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SyntheticsMobileStepParamsPosition getPosition() {
    return position;
  }

  public void setPosition(SyntheticsMobileStepParamsPosition position) {
    this.position = position;
  }
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>subtestPublicId</code>.
   *
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>value</code>.
   *
   * @return value
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>withEnter</code>.
   *
   * @return withEnter
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>x</code>.
   *
   * @return x
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>SyntheticsMobileStepParams</code> <code>y</code>.
   *
   * @return y
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.check, syntheticsMobileStepParams.check)
        ...
        && Objects.equals(this.position, syntheticsMobileStepParams.position)
