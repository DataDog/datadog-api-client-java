...
public class SyntheticsMobileStepParams {
  ...
  /**
   * Number of milliseconds to wait between inputs in a TYPE_TEXT step type. minimum: 0 maximum:
   * 5000
   *
   * @return delay
   */
  ...
  /**
   * Boolean to signal if <code>Enter</code> should be pressed at the end of the TYPE_TEXT step
   * type.
   *
   * @return withEnter
   */
  ...
  /**
   * Amount to scroll by on the <code>x</code> axis for a SCROLL step type.
   *
   * @return x
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * Amount to scroll by on the <code>y</code> axis for a SCROLL step type.
   *
   * @return y
   */
  @jakarta.annotation.Nullable
