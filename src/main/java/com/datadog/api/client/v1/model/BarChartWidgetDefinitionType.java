...
public class BarChartWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final BarChartWidgetDefinitionType BAR_CHART = new BarChartWidgetDefinitionType("bar_chart");
  ...
  public static class BarChartWidgetDefinitionTypeSerializer extends StdSerializer<BarChartWidgetDefinitionType> {
      ...
      @Override
      public void serialize(BarChartWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
