...
public class UsageTopAvgMetricsMetadata {
  ...
  /**
   * <p>The day value from the user request that contains the returned usage data. (If day was used the request)</p>
   * @return day
  **/
  ...
  /**
   * <p>The month value from the user request that contains the returned usage data. (If month was used the request)</p>
   * @return month
  **/
      @jakarta.annotation.Nullable
  ...
  **/
   ...
   */
  @JsonAnySetter
  public UsageTopAvgMetricsMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.day, usageTopAvgMetricsMetadata.day) && Objects.equals(this.month, usageTopAvgMetricsMetadata.month) && Objects.equals(this.pagination, usageTopAvgMetricsMetadata.pagination) && Objects.equals(this.additionalProperties, usageTopAvgMetricsMetadata.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(day,month,pagination, additionalProperties);
  }
