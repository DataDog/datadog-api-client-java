...
public class MonitorFormulaAndFunctionDataQualityQueryDefinition {
  ...
  public MonitorFormulaAndFunctionDataQualityQueryDefinition(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA_SOURCE)
          MonitorFormulaAndFunctionDataQualityDataSource dataSource,
  ...
  public MonitorFormulaAndFunctionDataQualityQueryDefinition dataSource(
      MonitorFormulaAndFunctionDataQualityDataSource dataSource) {
    this.dataSource = dataSource;
    this.unparsed |= !dataSource.isValid();
    return this;
  ...
  /**
   * The data quality measure to query. Common values include: <code>bytes</code>, <code>cardinality
   * </code>, <code>custom</code>, <code>freshness</code>, <code>max</code>, <code>mean</code>,
   * <code>min</code>, <code>nullness</code>, <code>percent_negative</code>, <code>percent_zero
   * </code>, <code>row_count</code>, <code>stddev</code>, <code>sum</code>, <code>uniqueness</code>
   * . Additional values may be supported.
   *
   * @return measure
   */
  ...
  public MonitorFormulaAndFunctionDataQualityQueryDefinition monitorOptions(
      MonitorFormulaAndFunctionDataQualityMonitorOptions monitorOptions) {
  ...
  /**
   * Optional scoping expression to further filter metrics. Uses metrics filter syntax. This is
   * useful when an entity has been configured to emit metrics with additional tags.
   *
   * @return scope
   */
  @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public MonitorFormulaAndFunctionDataQualityQueryDefinition putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    MonitorFormulaAndFunctionDataQualityQueryDefinition
        monitorFormulaAndFunctionDataQualityQueryDefinition =
            (MonitorFormulaAndFunctionDataQualityQueryDefinition) o;
    return Objects.equals(
            this.dataSource, monitorFormulaAndFunctionDataQualityQueryDefinition.dataSource)
        && Objects.equals(this.filter, monitorFormulaAndFunctionDataQualityQueryDefinition.filter)
        && Objects.equals(this.groupBy, monitorFormulaAndFunctionDataQualityQueryDefinition.groupBy)
        && Objects.equals(this.measure, monitorFormulaAndFunctionDataQualityQueryDefinition.measure)
        && Objects.equals(
            this.monitorOptions, monitorFormulaAndFunctionDataQualityQueryDefinition.monitorOptions)
        && Objects.equals(this.name, monitorFormulaAndFunctionDataQualityQueryDefinition.name)
        && Objects.equals(
            this.schemaVersion, monitorFormulaAndFunctionDataQualityQueryDefinition.schemaVersion)
        && Objects.equals(this.scope, monitorFormulaAndFunctionDataQualityQueryDefinition.scope)
        && Objects.equals(
            this.additionalProperties,
            monitorFormulaAndFunctionDataQualityQueryDefinition.additionalProperties);
  }
