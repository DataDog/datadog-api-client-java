...
public class NumberFormatUnit extends AbstractOpenApiSchema {
    ...
    public static class NumberFormatUnitSerializer extends StdSerializer<NumberFormatUnit> {
        ...
        @Override
        public void serialize(NumberFormatUnit value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class NumberFormatUnitDeserializer extends StdDeserializer<NumberFormatUnit> {
        ...
        @Override
        public NumberFormatUnit deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (NumberFormatUnitCanonical.class.equals(Integer.class) || NumberFormatUnitCanonical.class.equals(Long.class) || NumberFormatUnitCanonical.class.equals(Float.class) || NumberFormatUnitCanonical.class.equals(Double.class) || NumberFormatUnitCanonical.class.equals(Boolean.class) || NumberFormatUnitCanonical.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((NumberFormatUnitCanonical.class.equals(Integer.class) || NumberFormatUnitCanonical.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((NumberFormatUnitCanonical.class.equals(Float.class) || NumberFormatUnitCanonical.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (NumberFormatUnitCanonical.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (NumberFormatUnitCanonical.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (NumberFormatUnitCustom.class.equals(Integer.class) || NumberFormatUnitCustom.class.equals(Long.class) || NumberFormatUnitCustom.class.equals(Float.class) || NumberFormatUnitCustom.class.equals(Double.class) || NumberFormatUnitCustom.class.equals(Boolean.class) || NumberFormatUnitCustom.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((NumberFormatUnitCustom.class.equals(Integer.class) || NumberFormatUnitCustom.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((NumberFormatUnitCustom.class.equals(Float.class) || NumberFormatUnitCustom.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (NumberFormatUnitCustom.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (NumberFormatUnitCustom.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * NumberFormatUnitCanonical, NumberFormatUnitCustom
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be NumberFormatUnitCanonical, NumberFormatUnitCustom");
    }
    ...
    /**
     * Get the actual instance of `NumberFormatUnitCanonical`. If the actual instance is not `NumberFormatUnitCanonical`,
    ...
    /**
     * Get the actual instance of `NumberFormatUnitCustom`. If the actual instance is not `NumberFormatUnitCustom`,
     * the ClassCastException will be thrown.
     *
