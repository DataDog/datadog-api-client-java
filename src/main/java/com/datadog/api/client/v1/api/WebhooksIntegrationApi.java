 ...
 *
 * See {@link #createWebhooksIntegrationWithHttpInfo}.
 *
 ...
 * Create a webhooks integration.
 *
 * See {@link #createWebhooksIntegrationWithHttpInfoAsync}.
 *
 * @param body Create a webhooks integration request body. (required)
 ...
 */
  public CompletableFuture<WebhooksIntegration>createWebhooksIntegrationAsync(WebhooksIntegration body) {
    return createWebhooksIntegrationWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Creates an endpoint with the name <code>&lt;WEBHOOK_NAME&gt;</code>.</p>
   *
   * @param body Create a webhooks integration request body. (required)
  ...
  public ApiResponse<WebhooksIntegration> createWebhooksIntegrationWithHttpInfo(WebhooksIntegration body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.createWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegration>> createWebhooksIntegrationWithHttpInfoAsync(WebhooksIntegration body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.createWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegration>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }

  /**
 * Create a custom variable.
 *
 * See {@link #createWebhooksIntegrationCustomVariableWithHttpInfo}.
 *
 ...
 * Create a custom variable.
 *
 * See {@link #createWebhooksIntegrationCustomVariableWithHttpInfoAsync}.
 *
 * @param body Define a custom variable request body. (required)
 ...
 */
  public CompletableFuture<WebhooksIntegrationCustomVariableResponse>createWebhooksIntegrationCustomVariableAsync(WebhooksIntegrationCustomVariable body) {
    return createWebhooksIntegrationCustomVariableWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates an endpoint with the name <code>&lt;CUSTOM_VARIABLE_NAME&gt;</code>.</p>
   *
   * @param body Define a custom variable request body. (required)
  ...
  public ApiResponse<WebhooksIntegrationCustomVariableResponse> createWebhooksIntegrationCustomVariableWithHttpInfo(WebhooksIntegrationCustomVariable body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.createWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> createWebhooksIntegrationCustomVariableWithHttpInfoAsync(WebhooksIntegrationCustomVariable body) {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
        CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> result = new CompletableFuture<>();
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.createWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }

  /**
 * Delete a webhook.
 *
 * See {@link #deleteWebhooksIntegrationWithHttpInfo}.
 *
 ...
 * Delete a webhook.
 *
 * See {@link #deleteWebhooksIntegrationWithHttpInfoAsync}.
 *
 * @param webhookName The name of the webhook. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteWebhooksIntegrationAsync(String webhookName) {
    return deleteWebhooksIntegrationWithHttpInfoAsync(webhookName).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes the endpoint with the name <code>&lt;WEBHOOK NAME&gt;</code>. This action cannot be undone.</p>
   *
   * @param webhookName The name of the webhook. (required)
  ...
  public ApiResponse<Void> deleteWebhooksIntegrationWithHttpInfo(String webhookName) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v1/integration/webhooks/configuration/webhooks/{webhook_name}"
      .replaceAll("\\{" + "webhook_name" + "\\}", apiClient.escapeString(webhookName.toString()));

    
    Map<String, String> localVarHeaderParams = new HashMap<String, String>();


    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.deleteWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteWebhooksIntegrationWithHttpInfoAsync(String webhookName) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.deleteWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #deleteWebhooksIntegrationCustomVariableWithHttpInfo}.
 *
 ...
 * Delete a custom variable.
 *
 * See {@link #deleteWebhooksIntegrationCustomVariableWithHttpInfoAsync}.
 *
 * @param customVariableName The name of the custom variable. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteWebhooksIntegrationCustomVariableAsync(String customVariableName) {
    return deleteWebhooksIntegrationCustomVariableWithHttpInfoAsync(customVariableName).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes the endpoint with the name <code>&lt;CUSTOM_VARIABLE_NAME&gt;</code>.</p>
   *
   * @param customVariableName The name of the custom variable. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteWebhooksIntegrationCustomVariableWithHttpInfo(String customVariableName) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v1/integration/webhooks/configuration/custom-variables/{custom_variable_name}"
      .replaceAll("\\{" + "custom_variable_name" + "\\}", apiClient.escapeString(customVariableName.toString()));

    
    Map<String, String> localVarHeaderParams = new HashMap<String, String>();


    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.deleteWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteWebhooksIntegrationCustomVariableWithHttpInfoAsync(String customVariableName) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.deleteWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #getWebhooksIntegrationWithHttpInfo}.
 *
 * @param webhookName The name of the webhook. (required)
 * @return WebhooksIntegration
 * @throws ApiException if fails to make API call
 ...
 * Get a webhook integration.
 *
 * See {@link #getWebhooksIntegrationWithHttpInfoAsync}.
 *
 * @param webhookName The name of the webhook. (required)
 * @return CompletableFuture&lt;WebhooksIntegration&gt;
 */
  public CompletableFuture<WebhooksIntegration>getWebhooksIntegrationAsync(String webhookName) {
    return getWebhooksIntegrationWithHttpInfoAsync(webhookName).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Gets the content of the webhook with the name <code>&lt;WEBHOOK_NAME&gt;</code>.</p>
   *
   * @param webhookName The name of the webhook. (required)
   * @return ApiResponse&lt;WebhooksIntegration&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<WebhooksIntegration> getWebhooksIntegrationWithHttpInfo(String webhookName) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.getWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegration>> getWebhooksIntegrationWithHttpInfoAsync(String webhookName) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.getWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegration>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }

  /**
 * Get a custom variable.
 *
 * See {@link #getWebhooksIntegrationCustomVariableWithHttpInfo}.
 *
 * @param customVariableName The name of the custom variable. (required)
 * @return WebhooksIntegrationCustomVariableResponse
 * @throws ApiException if fails to make API call
 ...
 * Get a custom variable.
 *
 * See {@link #getWebhooksIntegrationCustomVariableWithHttpInfoAsync}.
 *
 * @param customVariableName The name of the custom variable. (required)
 * @return CompletableFuture&lt;WebhooksIntegrationCustomVariableResponse&gt;
 */
  public CompletableFuture<WebhooksIntegrationCustomVariableResponse>getWebhooksIntegrationCustomVariableAsync(String customVariableName) {
    return getWebhooksIntegrationCustomVariableWithHttpInfoAsync(customVariableName).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Shows the content of the custom variable with the name <code>&lt;CUSTOM_VARIABLE_NAME&gt;</code>.</p>
   * <p>If the custom variable is secret, the value does not return in the
   * response payload.</p>
   *
   * @param customVariableName The name of the custom variable. (required)
   * @return ApiResponse&lt;WebhooksIntegrationCustomVariableResponse&gt;
  ...
  public ApiResponse<WebhooksIntegrationCustomVariableResponse> getWebhooksIntegrationCustomVariableWithHttpInfo(String customVariableName) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.getWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> getWebhooksIntegrationCustomVariableWithHttpInfoAsync(String customVariableName) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.getWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }

  /**
 * Update a webhook.
 *
 * See {@link #updateWebhooksIntegrationWithHttpInfo}.
 *
 * @param webhookName The name of the webhook. (required)
 ...
 * Update a webhook.
 *
 * See {@link #updateWebhooksIntegrationWithHttpInfoAsync}.
 *
 * @param webhookName The name of the webhook. (required)
 * @param body Update an existing Datadog-Webhooks integration. (required)
 * @return CompletableFuture&lt;WebhooksIntegration&gt;
 */
  public CompletableFuture<WebhooksIntegration>updateWebhooksIntegrationAsync(String webhookName, WebhooksIntegrationUpdateRequest body) {
    return updateWebhooksIntegrationWithHttpInfoAsync(webhookName, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the endpoint with the name <code>&lt;WEBHOOK_NAME&gt;</code>.</p>
   *
   * @param webhookName The name of the webhook. (required)
   * @param body Update an existing Datadog-Webhooks integration. (required)
   * @return ApiResponse&lt;WebhooksIntegration&gt;
  ...
  public ApiResponse<WebhooksIntegration> updateWebhooksIntegrationWithHttpInfo(String webhookName, WebhooksIntegrationUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.updateWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegration>> updateWebhooksIntegrationWithHttpInfoAsync(String webhookName, WebhooksIntegrationUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.updateWebhooksIntegration", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegration>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegration>() {});
  }

  /**
 * Update a custom variable.
 *
 * See {@link #updateWebhooksIntegrationCustomVariableWithHttpInfo}.
 *
 * @param customVariableName The name of the custom variable. (required)
 ...
 * Update a custom variable.
 *
 * See {@link #updateWebhooksIntegrationCustomVariableWithHttpInfoAsync}.
 *
 * @param customVariableName The name of the custom variable. (required)
 * @param body Update an existing custom variable request body. (required)
 * @return CompletableFuture&lt;WebhooksIntegrationCustomVariableResponse&gt;
 */
  public CompletableFuture<WebhooksIntegrationCustomVariableResponse>updateWebhooksIntegrationCustomVariableAsync(String customVariableName, WebhooksIntegrationCustomVariableUpdateRequest body) {
    return updateWebhooksIntegrationCustomVariableWithHttpInfoAsync(customVariableName, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the endpoint with the name <code>&lt;CUSTOM_VARIABLE_NAME&gt;</code>.</p>
   *
   * @param customVariableName The name of the custom variable. (required)
   * @param body Update an existing custom variable request body. (required)
   * @return ApiResponse&lt;WebhooksIntegrationCustomVariableResponse&gt;
  ...
  public ApiResponse<WebhooksIntegrationCustomVariableResponse> updateWebhooksIntegrationCustomVariableWithHttpInfo(String customVariableName, WebhooksIntegrationCustomVariableUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.updateWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> updateWebhooksIntegrationCustomVariableWithHttpInfoAsync(String customVariableName, WebhooksIntegrationCustomVariableUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.WebhooksIntegrationApi.updateWebhooksIntegrationCustomVariable", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<WebhooksIntegrationCustomVariableResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<WebhooksIntegrationCustomVariableResponse>() {});
  }
}