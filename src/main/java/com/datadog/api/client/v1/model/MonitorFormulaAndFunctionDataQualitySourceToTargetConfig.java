...
public class MonitorFormulaAndFunctionDataQualitySourceToTargetConfig {
  ...
  @JsonCreator
  public MonitorFormulaAndFunctionDataQualitySourceToTargetConfig(
      @JsonProperty(required = true, value = JSON_PROPERTY_DIFF_TYPE)
          MonitorFormulaAndFunctionDataQualityDiffType diffType,
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_SOURCE)
          MonitorFormulaAndFunctionDataQualityEntityMetricConfig source,
      @JsonProperty(required = true, value = JSON_PROPERTY_TARGET)
          MonitorFormulaAndFunctionDataQualityEntityMetricConfig target) {
  ...
  public MonitorFormulaAndFunctionDataQualitySourceToTargetConfig diffType(
      MonitorFormulaAndFunctionDataQualityDiffType diffType) {
    this.diffType = diffType;
    this.unparsed |= !diffType.isValid();
    return this;
  ...
  public MonitorFormulaAndFunctionDataQualitySourceToTargetConfig source(
      MonitorFormulaAndFunctionDataQualityEntityMetricConfig source) {
    this.source = source;
    this.unparsed |= source.unparsed;
    return this;
  ...
  public MonitorFormulaAndFunctionDataQualitySourceToTargetConfig target(
      MonitorFormulaAndFunctionDataQualityEntityMetricConfig target) {
    this.target = target;
    this.unparsed |= target.unparsed;
    return this;
   ...
   */
  @JsonAnySetter
  public MonitorFormulaAndFunctionDataQualitySourceToTargetConfig putAdditionalProperty(
  ...
  /**
   * Return true if this MonitorFormulaAndFunctionDataQualitySourceToTargetConfig object is equal to
   * o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    MonitorFormulaAndFunctionDataQualitySourceToTargetConfig
        monitorFormulaAndFunctionDataQualitySourceToTargetConfig =
            (MonitorFormulaAndFunctionDataQualitySourceToTargetConfig) o;
    return Objects.equals(
            this.diffType, monitorFormulaAndFunctionDataQualitySourceToTargetConfig.diffType)
        && Objects.equals(
            this.entityType, monitorFormulaAndFunctionDataQualitySourceToTargetConfig.entityType)
        && Objects.equals(
            this.source, monitorFormulaAndFunctionDataQualitySourceToTargetConfig.source)
        && Objects.equals(
            this.target, monitorFormulaAndFunctionDataQualitySourceToTargetConfig.target)
        && Objects.equals(
            this.additionalProperties,
            monitorFormulaAndFunctionDataQualitySourceToTargetConfig.additionalProperties);
  }
