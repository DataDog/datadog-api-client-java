...
public class DashboardTemplateVariable {
  ...
  **/
  ...
  /**
   * <p>(deprecated) The default value for the template variable on dashboard load. Cannot be used in conjunction with <code>defaults</code>.</p>
   * @return _default
   * @deprecated
  **/
      @Deprecated
  ...
  /**
   * <p>One or many default values for template variables on load. If more than one default is specified, they will be unioned together with <code>OR</code>. Cannot be used in conjunction with <code>default</code>.</p>
   * @return defaults
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableValues, dashboardTemplateVariable.availableValues) && Objects.equals(this._default, dashboardTemplateVariable._default) && Objects.equals(this.defaults, dashboardTemplateVariable.defaults) && Objects.equals(this.name, dashboardTemplateVariable.name) && Objects.equals(this.prefix, dashboardTemplateVariable.prefix) && Objects.equals(this.type, dashboardTemplateVariable.type) && Objects.equals(this.additionalProperties, dashboardTemplateVariable.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(availableValues,_default,defaults,name,prefix,type, additionalProperties);
  }
