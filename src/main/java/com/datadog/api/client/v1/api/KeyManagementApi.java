 ...
 */
  ...
  /**
   * <p>Create an application key with a given name.</p>
   *
   * @param body  (required)
 ...
 */
  ...
  /**
   * <p>Delete a given application key.</p>
   *
   * @param key The specific APP key you are working with. (required)
   * @return ApiResponse&lt;ApplicationKeyResponse&gt;
   * @throws ApiException if fails to make API call
 ...
 */
  ...
  /**
   * <p>Get a given application key.</p>
   *
   * @param key The specific APP key you are working with. (required)
   * @return ApiResponse&lt;ApplicationKeyResponse&gt;
   * @throws ApiException if fails to make API call
 ...
 */
  ...
  /**
   * <p>Get all application keys available for your Datadog account.</p>
   *
 ...
 */
  ...
  /**
   * <p>Edit an application key name.</p>
   *
   * @param key The specific APP key you are working with. (required)
   * @param body  (required)
   * @return ApiResponse&lt;ApplicationKeyResponse&gt;
