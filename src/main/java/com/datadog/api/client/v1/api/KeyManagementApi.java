 ...
 */
  ...
  /**
   * <p>Creates an API key with a given name.</p>
   * <p><strong>Note</strong>: This endpoint is disabled for the Government sites (US1-FED and US2-FED). Use the <a href="https://docs.datadoghq.com/api/latest/key-management/">V2 Key Management</a> endpoints instead.</p>
   *
   * @param body  (required)
  ...
  public ApiResponse<ApiKeyResponse> createAPIKeyWithHttpInfo(ApiKey body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.createAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<ApiKeyResponse>> createAPIKeyWithHttpInfoAsync(ApiKey body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.createAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 *
 * See {@link #createApplicationKeyWithHttpInfo}.
 *
 * @param body  (required)
 ...
 * Create an application key.
 *
 * See {@link #createApplicationKeyWithHttpInfoAsync}.
 *
 * @param body  (required)
 ...
 */
  public CompletableFuture<ApplicationKeyResponse>createApplicationKeyAsync(ApplicationKey body) {
    return createApplicationKeyWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
   ...
   * This endpoint is disabled for organizations in <a href="https://docs.datadoghq.com/account_management/api-app-keys/#one-time-read-mode">One-Time Read mode</a>.</p>
   * <p><strong>Note</strong>: This endpoint is disabled for the Government sites (US1-FED and US2-FED). Use the <a href="https://docs.datadoghq.com/api/latest/key-management/">V2 Key Management</a> endpoints instead.</p>
   *
   * @param body  (required)
  ...
  public ApiResponse<ApplicationKeyResponse> createApplicationKeyWithHttpInfo(ApplicationKey body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.createApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<ApplicationKeyResponse>> createApplicationKeyWithHttpInfoAsync(ApplicationKey body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.createApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApplicationKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<ApiKeyResponse>deleteAPIKeyAsync(String key) {
    return deleteAPIKeyWithHttpInfoAsync(key).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApiKeyResponse> deleteAPIKeyWithHttpInfo(String key) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.deleteAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApiKeyResponse>> deleteAPIKeyWithHttpInfoAsync(String key) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.deleteAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApiKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyResponse>() {});
  }
 ...
 */
  public CompletableFuture<ApplicationKeyResponse>deleteApplicationKeyAsync(String key) {
    return deleteApplicationKeyWithHttpInfoAsync(key).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApplicationKeyResponse> deleteApplicationKeyWithHttpInfo(String key) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.deleteApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApplicationKeyResponse>> deleteApplicationKeyWithHttpInfoAsync(String key) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.deleteApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApplicationKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyResponse>() {});
  }
 ...
 */
  public CompletableFuture<ApiKeyResponse>getAPIKeyAsync(String key) {
    return getAPIKeyWithHttpInfoAsync(key).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApiKeyResponse> getAPIKeyWithHttpInfo(String key) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.getAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<ApiKeyResponse>> getAPIKeyWithHttpInfoAsync(String key) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.getAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApiKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<ApplicationKeyResponse>getApplicationKeyAsync(String key) {
    return getApplicationKeyWithHttpInfoAsync(key).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApplicationKeyResponse> getApplicationKeyWithHttpInfo(String key) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.getApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<ApplicationKeyResponse>> getApplicationKeyWithHttpInfoAsync(String key) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.getApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApplicationKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<ApiKeyListResponse>listAPIKeysAsync() {
    return listAPIKeysWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get all API keys available for your account.</p>
   * <p><strong>Note</strong>: This endpoint is disabled for the Government sites (US1-FED and US2-FED). Use the <a href="https://docs.datadoghq.com/api/latest/key-management/">V2 Key Management</a> endpoints instead.</p>
   *
  ...
  public ApiResponse<ApiKeyListResponse> listAPIKeysWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.listAPIKeys", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApiKeyListResponse>> listAPIKeysWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.listAPIKeys", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApiKeyListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyListResponse>() {});
  }
 ...
 */
  public CompletableFuture<ApplicationKeyListResponse>listApplicationKeysAsync() {
    return listApplicationKeysWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApplicationKeyListResponse> listApplicationKeysWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.listApplicationKeys", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApplicationKeyListResponse>> listApplicationKeysWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.listApplicationKeys", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApplicationKeyListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyListResponse>() {});
  }
 ...
 */
  public CompletableFuture<ApiKeyResponse>updateAPIKeyAsync(String key, ApiKey body) {
    return updateAPIKeyWithHttpInfoAsync(key, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApiKeyResponse> updateAPIKeyWithHttpInfo(String key, ApiKey body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.updateAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApiKeyResponse>> updateAPIKeyWithHttpInfoAsync(String key, ApiKey body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.updateAPIKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApiKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApiKeyResponse>() {});
  }
 ...
 */
  public CompletableFuture<ApplicationKeyResponse>updateApplicationKeyAsync(String key, ApplicationKey body) {
    return updateApplicationKeyWithHttpInfoAsync(key, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ApplicationKeyResponse> updateApplicationKeyWithHttpInfo(String key, ApplicationKey body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.KeyManagementApi.updateApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ApplicationKeyResponse>> updateApplicationKeyWithHttpInfoAsync(String key, ApplicationKey body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.KeyManagementApi.updateApplicationKey", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ApplicationKeyResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ApplicationKeyResponse>() {});
  }
}