...
public class FormulaAndFunctionQueryDefinition extends AbstractOpenApiSchema {
    ...
    public static class FormulaAndFunctionQueryDefinitionDeserializer extends StdDeserializer<FormulaAndFunctionQueryDefinition> {
        ...
        public FormulaAndFunctionQueryDefinition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (FormulaAndFunctionProcessQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(Long.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(Float.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(Double.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        ...
                        attemptParsing |= ((FormulaAndFunctionProcessQueryDefinition.class.equals(Float.class) || FormulaAndFunctionProcessQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                ...
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionProcessQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Long.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Float.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Double.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Float.class) || FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionApmDependencyStatsQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionApmDependencyStatsQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionApmDependencyStatsQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionApmDependencyStatsQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Long.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Float.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Double.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Float.class) || FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionApmMetricsQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionApmMetricsQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionApmMetricsQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionApmMetricsQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionApmMetricsQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionSLOQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Long.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Float.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Double.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionSLOQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionSLOQueryDefinition.class.equals(Float.class) || FormulaAndFunctionSLOQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionSLOQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionSLOQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionSLOQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionSLOQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionCloudCostQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Long.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Float.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Double.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionCloudCostQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionCloudCostQueryDefinition.class.equals(Float.class) || FormulaAndFunctionCloudCostQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionCloudCostQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionCloudCostQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionCloudCostQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionCloudCostQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionCloudCostQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Long.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Float.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Double.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Float.class) || FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionProductAnalyticsExtendedQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionProductAnalyticsExtendedQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Long.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Float.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Double.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Float.class) || FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionUserJourneyQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionUserJourneyQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionUserJourneyQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionUserJourneyQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionUserJourneyQueryDefinition'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (FormulaAndFunctionRetentionQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Long.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Float.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Double.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Boolean.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FormulaAndFunctionRetentionQueryDefinition.class.equals(Integer.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FormulaAndFunctionRetentionQueryDefinition.class.equals(Float.class) || FormulaAndFunctionRetentionQueryDefinition.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FormulaAndFunctionRetentionQueryDefinition.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FormulaAndFunctionRetentionQueryDefinition.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(FormulaAndFunctionRetentionQueryDefinition.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'FormulaAndFunctionRetentionQueryDefinition'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'FormulaAndFunctionRetentionQueryDefinition'", e);
            }
    ...
    public FormulaAndFunctionQueryDefinition(FormulaAndFunctionApmMetricsQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public FormulaAndFunctionQueryDefinition(FormulaAndFunctionProductAnalyticsExtendedQueryDefinition o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        schemas.put("FormulaAndFunctionApmDependencyStatsQueryDefinition", new GenericType<FormulaAndFunctionApmDependencyStatsQueryDefinition>() {
        });
        ...
        schemas.put("FormulaAndFunctionApmMetricsQueryDefinition", new GenericType<FormulaAndFunctionApmMetricsQueryDefinition>() {
        });
        schemas.put("FormulaAndFunctionSLOQueryDefinition", new GenericType<FormulaAndFunctionSLOQueryDefinition>() {
        });
        schemas.put("FormulaAndFunctionCloudCostQueryDefinition", new GenericType<FormulaAndFunctionCloudCostQueryDefinition>() {
        });
        schemas.put("FormulaAndFunctionProductAnalyticsExtendedQueryDefinition", new GenericType<FormulaAndFunctionProductAnalyticsExtendedQueryDefinition>() {
        });
        schemas.put("FormulaAndFunctionUserJourneyQueryDefinition", new GenericType<FormulaAndFunctionUserJourneyQueryDefinition>() {
        });
        schemas.put("FormulaAndFunctionRetentionQueryDefinition", new GenericType<FormulaAndFunctionRetentionQueryDefinition>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(FormulaAndFunctionApmDependencyStatsQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (JSON.isInstanceOf(FormulaAndFunctionApmMetricsQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(FormulaAndFunctionSLOQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(FormulaAndFunctionCloudCostQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(FormulaAndFunctionProductAnalyticsExtendedQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(FormulaAndFunctionUserJourneyQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(FormulaAndFunctionRetentionQueryDefinition.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
    ...
    /**
     * Get the actual instance of `FormulaAndFunctionProcessQueryDefinition`. If the actual instance is not `FormulaAndFunctionProcessQueryDefinition`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `FormulaAndFunctionApmDependencyStatsQueryDefinition`. If the actual instance is not `FormulaAndFunctionApmDependencyStatsQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormulaAndFunctionApmDependencyStatsQueryDefinition`
     * @throws ClassCastException if the instance is not `FormulaAndFunctionApmDependencyStatsQueryDefinition`
     */
    public FormulaAndFunctionApmDependencyStatsQueryDefinition getFormulaAndFunctionApmDependencyStatsQueryDefinition() throws ClassCastException {
    ...
    /**
     * Get the actual instance of `FormulaAndFunctionApmMetricsQueryDefinition`. If the actual instance is not `FormulaAndFunctionApmMetricsQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public FormulaAndFunctionApmMetricsQueryDefinition getFormulaAndFunctionApmMetricsQueryDefinition() throws ClassCastException {
        return (FormulaAndFunctionApmMetricsQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormulaAndFunctionSLOQueryDefinition`. If the actual instance is not `FormulaAndFunctionSLOQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public FormulaAndFunctionSLOQueryDefinition getFormulaAndFunctionSLOQueryDefinition() throws ClassCastException {
        return (FormulaAndFunctionSLOQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormulaAndFunctionCloudCostQueryDefinition`. If the actual instance is not `FormulaAndFunctionCloudCostQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public FormulaAndFunctionCloudCostQueryDefinition getFormulaAndFunctionCloudCostQueryDefinition() throws ClassCastException {
        return (FormulaAndFunctionCloudCostQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormulaAndFunctionProductAnalyticsExtendedQueryDefinition`. If the actual instance is not `FormulaAndFunctionProductAnalyticsExtendedQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormulaAndFunctionProductAnalyticsExtendedQueryDefinition`
     * @throws ClassCastException if the instance is not `FormulaAndFunctionProductAnalyticsExtendedQueryDefinition`
     */
    public FormulaAndFunctionProductAnalyticsExtendedQueryDefinition getFormulaAndFunctionProductAnalyticsExtendedQueryDefinition() throws ClassCastException {
        return (FormulaAndFunctionProductAnalyticsExtendedQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormulaAndFunctionUserJourneyQueryDefinition`. If the actual instance is not `FormulaAndFunctionUserJourneyQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     * @return The actual instance of `FormulaAndFunctionUserJourneyQueryDefinition`
     * @throws ClassCastException if the instance is not `FormulaAndFunctionUserJourneyQueryDefinition`
     */
    public FormulaAndFunctionUserJourneyQueryDefinition getFormulaAndFunctionUserJourneyQueryDefinition() throws ClassCastException {
        return (FormulaAndFunctionUserJourneyQueryDefinition)super.getActualInstance();
    }

    /**
     * Get the actual instance of `FormulaAndFunctionRetentionQueryDefinition`. If the actual instance is not `FormulaAndFunctionRetentionQueryDefinition`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public FormulaAndFunctionRetentionQueryDefinition getFormulaAndFunctionRetentionQueryDefinition() throws ClassCastException {
