...
/**
   * <p>Response containing the number of Synthetics API tests run for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class UsageSyntheticsResponse {
  ...
  /**
   * <p>Array with the number of hourly Synthetics test run for a given organization.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageSyntheticsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageSyntheticsResponse.usage) && Objects.equals(this.additionalProperties, usageSyntheticsResponse.additionalProperties);
  }
