...
public class ViewingPreferencesTheme extends ModelEnum<String> {
  ...
  public static class ViewingPreferencesThemeSerializer extends StdSerializer<ViewingPreferencesTheme> {
      ...
      @Override
      public void serialize(ViewingPreferencesTheme value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
