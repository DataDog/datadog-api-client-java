...
/**
   * <p>Response containing the number of Synthetics Browser tests run for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class UsageSyntheticsBrowserResponse {
  ...
  /**
   * <p>Get hourly usage for Synthetics Browser tests.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageSyntheticsBrowserResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageSyntheticsBrowserResponse.usage) && Objects.equals(this.additionalProperties, usageSyntheticsBrowserResponse.additionalProperties);
  }
