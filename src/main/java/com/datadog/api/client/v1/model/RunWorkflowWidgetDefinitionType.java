...
public class RunWorkflowWidgetDefinitionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("run_workflow"));

  public static final RunWorkflowWidgetDefinitionType RUN_WORKFLOW = new RunWorkflowWidgetDefinitionType("run_workflow");
  ...
  public static class RunWorkflowWidgetDefinitionTypeSerializer extends StdSerializer<RunWorkflowWidgetDefinitionType> {
      ...
      @Override
      public void serialize(RunWorkflowWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
