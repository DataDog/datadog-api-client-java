 ...
 */
  ...
  /**
   * <p>Take graph snapshots.
   * <strong>Note</strong>: When a snapshot is created, there is some delay before it is available.</p>
   *
   * @param start The POSIX timestamp of the start of the query. (required)
   * @param end The POSIX timestamp of the end of the query. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<GraphSnapshot> getGraphSnapshotWithHttpInfo(Long start, Long end, GetGraphSnapshotOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.SnapshotsApi.getGraphSnapshot", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<GraphSnapshot>> getGraphSnapshotWithHttpInfoAsync(Long start, Long end, GetGraphSnapshotOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v1.SnapshotsApi.getGraphSnapshot", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
