...
public class SankeyRumQueryMode extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("source", "target"));
  ...
  public static class SankeyRumQueryModeSerializer extends StdSerializer<SankeyRumQueryMode> {
      ...
      @Override
      public void serialize(SankeyRumQueryMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
