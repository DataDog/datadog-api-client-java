...
public class NotifyEndState extends ModelEnum<String> {
  ...
  public static class NotifyEndStateSerializer extends StdSerializer<NotifyEndState> {
      ...
      @Override
      public void serialize(NotifyEndState value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
