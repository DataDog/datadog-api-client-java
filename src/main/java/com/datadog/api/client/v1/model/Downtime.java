...
/**
   * <p>Downtiming gives you greater control over monitor notifications by
   * allowing you to globally exclude scopes from alerting.
   * Downtime settings, which can be scheduled with start and end times,
   * prevent all alerting related to specified Datadog tags.</p>
 */
@JsonPropertyOrder({
...
public class Downtime {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ACTIVE_CHILD)private void setActiveChild_JsonNullable(JsonNullable<DowntimeChild> activeChild) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(active,activeChild,canceled,creatorId,disabled,downtimeType,end,id,message,monitorId,monitorTags,muteFirstRecoveryNotification,notifyEndStates,notifyEndTypes,parentId,recurrence,scope,start,timezone,updaterId, additionalProperties);
  }
