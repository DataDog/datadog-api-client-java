...
/**
   * <p>Response containing the indexed logs usage broken down by retention period for an organization during a given hour.</p>
 */
@JsonPropertyOrder({
...
public class UsageLogsByRetentionResponse {
  ...
  /**
   * <p>Get hourly usage for indexed logs by retention period.</p>
   * @return usage
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageLogsByRetentionResponse.usage) && Objects.equals(this.additionalProperties, usageLogsByRetentionResponse.additionalProperties);
  }
