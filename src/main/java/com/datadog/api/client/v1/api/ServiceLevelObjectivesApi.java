 ...
 */
  ...
  public static class ListSLOsOptionalParameters {
    ...
    /**
     * Set isDeleted.
     * @param isDeleted Whether to return only deleted service level objective objects. (optional, default to false)
     * @return ListSLOsOptionalParameters
     */
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listSLOs", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, false, limit, args, 0);
