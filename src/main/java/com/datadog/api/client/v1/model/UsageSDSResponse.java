...
/**
   * <p>Response containing the Sensitive Data Scanner usage for each hour for a given organization.</p>
 */
@JsonPropertyOrder({
  UsageSDSResponse.JSON_PROPERTY_USAGE
})
...
public class UsageSDSResponse {
  ...
  /**
   * <p>Get hourly usage for Sensitive Data Scanner.</p>
   * @return usage
  **/
   ...
   */
  @JsonAnySetter
  public UsageSDSResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.usage, usageSdsResponse.usage) && Objects.equals(this.additionalProperties, usageSdsResponse.additionalProperties);
  }
