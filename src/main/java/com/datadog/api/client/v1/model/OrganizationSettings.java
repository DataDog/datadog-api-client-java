...
public class OrganizationSettings {
  ...
  /**
   * <p>Whether or not the organization users can share widgets outside of Datadog.</p>
  ...
  **/
  ...
  /**
   * <p>Set the boolean property enabled to enable or disable single sign on with SAML.
   * See the SAML documentation for more information about all SAML settings.</p>
   * @return saml
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SAML_AUTOCREATE_ACCESS_ROLE)public void setSamlAutocreateAccessRole_JsonNullable(JsonNullable<AccessRole> samlAutocreateAccessRole) {
  ...
  **/
  ...
  /**
   * <p>Whether or not SAML can be enabled for this organization.</p>
  ...
  **/
  ...
  /**
   * <p>Identity provider endpoint for SAML authentication.</p>
  ...
  **/
  ...
  /**
   * <p>Whether or not a SAML identity provider metadata file was provided to the Datadog organization.</p>
