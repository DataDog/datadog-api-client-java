...
/**
   * <p>Monitor state for a single group.</p>
 */
@JsonPropertyOrder({
...
public class MonitorStateGroup {
  ...
  /**
   * <p>Latest timestamp the monitor was in NO_DATA state.</p>
   * @return lastNodataTs
  **/
  ...
  /**
   * <p>Latest timestamp of the notification sent for this monitor group.</p>
  ...
  **/
  ...
  /**
   * <p>Latest timestamp the monitor group was resolved.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(lastNodataTs,lastNotifiedTs,lastResolvedTs,lastTriggeredTs,name,status, additionalProperties);
  }
