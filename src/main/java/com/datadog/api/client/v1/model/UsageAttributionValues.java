...
public class UsageAttributionValues {
  ...
  **/
  ...
  public UsageAttributionValues estimatedIngestedLogsPercentage(Double estimatedIngestedLogsPercentage) {
    this.estimatedIngestedLogsPercentage = estimatedIngestedLogsPercentage;
    return this;
  }

  /**
   * <p>The percentage of estimated live ingested logs usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The estimated live ingested logs usage by tag(s). Note this field is in private beta.</p>
