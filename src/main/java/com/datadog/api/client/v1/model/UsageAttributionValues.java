...
public class UsageAttributionValues {
  ...
  **/
  ...
  /**
   * <p>The percentage of Cloud Security Posture Management container usage by tag(s)</p>
  ...
  **/
  ...
  /**
   * <p>The Cloud Security Posture Management container usage by tag(s)</p>
  ...
  **/
  ...
  /**
   * <p>The percentage of Cloud Security Posture Management host usage by tag(s)</p>
  ...
  **/
  ...
  /**
   * <p>The Cloud Security Posture Management host usage by tag(s)</p>
  ...
  **/
  ...
  /**
   * <p>The percentage of Database Monitoring normalized queries usage by tag(s).</p>
  ...
  **/
  ...
  /**
   * <p>The Database Monitoring normalized queries usage by tag(s).</p>
  ...
  **/
  ...
  public UsageAttributionValues estimatedIndexedLogsPercentage(Double estimatedIndexedLogsPercentage) {
    this.estimatedIndexedLogsPercentage = estimatedIndexedLogsPercentage;
    return this;
  }

  /**
   * <p>The percentage of estimated live indexed logs usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The estimated live indexed logs usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  public UsageAttributionValues estimatedIndexedSpansPercentage(Double estimatedIndexedSpansPercentage) {
    this.estimatedIndexedSpansPercentage = estimatedIndexedSpansPercentage;
    return this;
  }

  /**
   * <p>The percentage of estimated indexed spans usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The estimated indexed spans usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  public UsageAttributionValues estimatedIngestedSpansPercentage(Double estimatedIngestedSpansPercentage) {
    this.estimatedIngestedSpansPercentage = estimatedIngestedSpansPercentage;
    return this;
  }

  /**
   * <p>The percentage of estimated ingested spans usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The estimated ingested spans usage by tag(s). Note this field is in private beta.</p>
  ...
  **/
  ...
  /**
   * <p>The percentage of profiled containers usage by tag(s).</p>
  ...
  **/
  ...
  /**
   * <p>The profiled host usage by tag(s).</p>
