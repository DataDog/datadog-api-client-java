...
/**
   * <p>The steps used in a Synthetic browser test.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsStep {
  ...
  **/
  ...
  /**
   * <p>A boolean set to exit the test if the step succeeds.</p>
  ...
  **/
  ...
  /**
   * <p>A boolean set to skip taking a screenshot for the step.</p>
   * @return noScreenshot
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowFailure,alwaysExecute,exitIfSucceed,isCritical,name,noScreenshot,params,publicId,timeout,type, additionalProperties);
  }
