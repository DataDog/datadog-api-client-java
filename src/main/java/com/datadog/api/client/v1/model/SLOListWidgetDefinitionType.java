...
public class SLOListWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static final SLOListWidgetDefinitionType SLO_LIST = new SLOListWidgetDefinitionType("slo_list");
  ...
  public static class SLOListWidgetDefinitionTypeSerializer extends StdSerializer<SLOListWidgetDefinitionType> {
      ...
      @Override
      public void serialize(SLOListWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
