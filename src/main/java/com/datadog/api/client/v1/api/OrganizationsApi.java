 ...
 */
  ...
  public CompletableFuture<ApiResponse<OrganizationCreateResponse>> createChildOrgWithHttpInfoAsync(OrganizationCreateBody body) {
    ...
    try {
      builder = apiClient.createBuilder("OrganizationsApi.createChildOrg", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<OrgDowngradedResponse>> downgradeOrgWithHttpInfoAsync(String publicId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("OrganizationsApi.downgradeOrg", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OrgDowngradedResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<OrganizationResponse>> getOrgWithHttpInfoAsync(String publicId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("OrganizationsApi.getOrg", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OrganizationResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<OrganizationListResponse>> listOrgsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("OrganizationsApi.listOrgs", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  public CompletableFuture<ApiResponse<OrganizationResponse>> updateOrgWithHttpInfoAsync(String publicId, Organization body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("OrganizationsApi.updateOrg", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OrganizationResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<IdpResponse>> uploadIdPForOrgWithHttpInfoAsync(String publicId, File idpFile) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("OrganizationsApi.uploadIdPForOrg", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IdpResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
