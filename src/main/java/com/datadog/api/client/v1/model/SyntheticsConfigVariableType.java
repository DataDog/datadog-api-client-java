...
public class SyntheticsConfigVariableType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("global", "text", "email"));
  ...
  public static final SyntheticsConfigVariableType EMAIL = new SyntheticsConfigVariableType("email");
