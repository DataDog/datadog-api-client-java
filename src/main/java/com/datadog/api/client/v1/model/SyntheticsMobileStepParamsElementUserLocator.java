...
public class SyntheticsMobileStepParamsElementUserLocator {
  ...
  /**
   * <p>Whether if the test should fail if the element cannot be found.</p>
  ...
  **/
  ...
  /**
   * <p>Values of the user locator.</p>
   * @return values
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsMobileStepParamsElementUserLocator syntheticsMobileStepParamsElementUserLocator = (SyntheticsMobileStepParamsElementUserLocator) o;
    return Objects.equals(this.failTestOnCannotLocate, syntheticsMobileStepParamsElementUserLocator.failTestOnCannotLocate) && Objects.equals(this.values, syntheticsMobileStepParamsElementUserLocator.values) && Objects.equals(this.additionalProperties, syntheticsMobileStepParamsElementUserLocator.additionalProperties);
  }
