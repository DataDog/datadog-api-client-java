...
public class UsageSummaryDate {
  ...
  /**
   * Host count average of Cloud Cost Management for all cloud providers for the given date for all
   * organizations.
   *
  ...
  /**
   * Shows the average of the number of Serverless Apps for Azure for the given date for all
   * organizations.
   *
  ...
  /**
   * Shows the average of the number of Serverless Apps for Google Cloud for the given date for all
   * organizations.
   *
