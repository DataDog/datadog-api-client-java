...
public class UsageSummaryDate {
  ...
  **/
  ...
  /**
   * <p>Host count average of Cloud Cost Management for the given date and given organization.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Posture Management GCP hosts over all hours in the current date for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM Sessions on Flutter over all hours in the current date for all organizations.</p>
