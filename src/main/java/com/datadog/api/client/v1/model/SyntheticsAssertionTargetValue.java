...
@JsonDeserialize(using = SyntheticsAssertionTargetValue.SyntheticsAssertionTargetValueDeserializer.class)
@JsonSerialize(using = SyntheticsAssertionTargetValue.SyntheticsAssertionTargetValueSerializer.class)
public class SyntheticsAssertionTargetValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SyntheticsAssertionTargetValue.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SyntheticsAssertionTargetValueSerializer extends StdSerializer<SyntheticsAssertionTargetValue> {
        public SyntheticsAssertionTargetValueSerializer(Class<SyntheticsAssertionTargetValue> t) {
            super(t);
        }

        public SyntheticsAssertionTargetValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(SyntheticsAssertionTargetValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SyntheticsAssertionTargetValueDeserializer extends StdDeserializer<SyntheticsAssertionTargetValue> {
        public SyntheticsAssertionTargetValueDeserializer() {
            this(SyntheticsAssertionTargetValue.class);
        }

        public SyntheticsAssertionTargetValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SyntheticsAssertionTargetValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            SyntheticsAssertionTargetValue ret = new SyntheticsAssertionTargetValue();
            if (match == 1) {
         ...
         */
        @Override
        public SyntheticsAssertionTargetValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SyntheticsAssertionTargetValue cannot be null");
        }
    }
    ...
    public SyntheticsAssertionTargetValue(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public SyntheticsAssertionTargetValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SyntheticsAssertionTargetValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return SyntheticsAssertionTargetValue.schemas;
    }
