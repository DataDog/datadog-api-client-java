 ...
 */
  ...
  public CompletableFuture<ApiResponse<SLOCorrectionResponse>> createSLOCorrectionWithHttpInfoAsync(SLOCorrectionCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.ServiceLevelObjectiveCorrectionsApi.createSLOCorrection", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public static class ListSLOCorrectionOptionalParameters {
    ...
    /**
     * Set limit.
     * @param limit The number of SLO corrections to return in the response. Default is 25. (optional)
     * @return ListSLOCorrectionOptionalParameters
     */
 ...
 */
  ...
  public ApiResponse<SLOCorrectionListResponse> listSLOCorrectionWithHttpInfo(ListSLOCorrectionOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.ServiceLevelObjectiveCorrectionsApi.listSLOCorrection", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<SLOCorrectionListResponse>> listSLOCorrectionWithHttpInfoAsync(ListSLOCorrectionOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.ServiceLevelObjectiveCorrectionsApi.listSLOCorrection", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
