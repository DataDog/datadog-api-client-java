 ...
 */
  ...
  /**
   * <p>Create an SLO correction. Use <code>slo_id</code> to apply the correction to a single SLO, or <code>slo_query</code> to apply the
   * correction to SLOs that match a query. Exactly one of <code>slo_id</code> or <code>slo_query</code> is required.</p>
   *
   * @param body Create an SLO Correction (required)
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listSLOCorrection", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, false, limit, args, 0);
