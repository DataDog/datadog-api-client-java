...
public class UsageTopAvgMetricsPagination {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TOTAL_NUMBER_OF_RECORDS)public void setTotalNumberOfRecords_JsonNullable(JsonNullable<Long> totalNumberOfRecords) {
