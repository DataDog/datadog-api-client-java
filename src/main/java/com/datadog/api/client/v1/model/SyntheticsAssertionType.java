...
public class SyntheticsAssertionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("body", "header", "statusCode", "certificate", "responseTime", "property", "recordEvery", "recordSome", "tlsVersion", "minTlsVersion", "latency", "packetLossPercentage", "packetsReceived", "networkHop", "receivedMessage", "grpcHealthcheckStatus", "grpcMetadata", "grpcProto", "connection", "multiNetworkHop", "jitter", "mcpToolNameLength", "mcpToolCount"));
  ...
  public static final SyntheticsAssertionType GRPC_METADATA = new SyntheticsAssertionType("grpcMetadata");
  ...
  public static final SyntheticsAssertionType MULTI_NETWORK_HOP = new SyntheticsAssertionType("multiNetworkHop");
  public static final SyntheticsAssertionType JITTER = new SyntheticsAssertionType("jitter");
  public static final SyntheticsAssertionType MCP_TOOL_NAME_LENGTH = new SyntheticsAssertionType("mcpToolNameLength");
  public static final SyntheticsAssertionType MCP_TOOL_COUNT = new SyntheticsAssertionType("mcpToolCount");
