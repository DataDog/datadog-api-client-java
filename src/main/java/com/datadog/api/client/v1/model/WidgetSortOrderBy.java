...
public class WidgetSortOrderBy extends AbstractOpenApiSchema {
    ...
    public static class WidgetSortOrderBySerializer extends StdSerializer<WidgetSortOrderBy> {
        ...
        @Override
        public void serialize(WidgetSortOrderBy value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class WidgetSortOrderByDeserializer extends StdDeserializer<WidgetSortOrderBy> {
        ...
        @Override
        public WidgetSortOrderBy deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (WidgetFormulaSort.class.equals(Integer.class) || WidgetFormulaSort.class.equals(Long.class) || WidgetFormulaSort.class.equals(Float.class) || WidgetFormulaSort.class.equals(Double.class) || WidgetFormulaSort.class.equals(Boolean.class) || WidgetFormulaSort.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((WidgetFormulaSort.class.equals(Integer.class) || WidgetFormulaSort.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WidgetFormulaSort.class.equals(Float.class) || WidgetFormulaSort.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WidgetFormulaSort.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WidgetFormulaSort.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (WidgetGroupSort.class.equals(Integer.class) || WidgetGroupSort.class.equals(Long.class) || WidgetGroupSort.class.equals(Float.class) || WidgetGroupSort.class.equals(Double.class) || WidgetGroupSort.class.equals(Boolean.class) || WidgetGroupSort.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((WidgetGroupSort.class.equals(Integer.class) || WidgetGroupSort.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((WidgetGroupSort.class.equals(Float.class) || WidgetGroupSort.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (WidgetGroupSort.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (WidgetGroupSort.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * WidgetFormulaSort, WidgetGroupSort
     *
    ...
    /**
     * Get the actual instance of `WidgetFormulaSort`. If the actual instance is not `WidgetFormulaSort`,
