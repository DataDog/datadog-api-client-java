...
public class ListStreamColumnWidth extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("auto", "compact", "full"));
  ...
  public static class ListStreamColumnWidthSerializer extends StdSerializer<ListStreamColumnWidth> {
      ...
      @Override
      public void serialize(ListStreamColumnWidth value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
