...
@Deprecated
  ...
  public ApiResponse<AWSAccountCreateResponse> createAWSAccountWithHttpInfo(AWSAccount body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountCreateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AWSAccountCreateResponse>> createAWSAccountWithHttpInfoAsync(AWSAccount body) {
    ...
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSAccountCreateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountCreateResponse>() {});
  }
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated - use the V2 endpoints instead.</strong> Create an Amazon EventBridge source.</p>
   *
   * @param body Create an Amazon EventBridge source for an AWS account with a given name and region. (required)
  ...
  public ApiResponse<AWSEventBridgeCreateResponse> createAWSEventBridgeSourceWithHttpInfo(AWSEventBridgeCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSEventBridgeSource", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AWSEventBridgeCreateResponse>> createAWSEventBridgeSourceWithHttpInfoAsync(AWSEventBridgeCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSEventBridgeSource", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSEventBridgeCreateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #createAWSTagFilterWithHttpInfo}.
 *
 * @param body Set an AWS tag filter using an <code>aws_account_identifier</code>, <code>namespace</code>, and filtering string. Namespace options are <code>application_elb</code>, <code>elb</code>, <code>lambda</code>, <code>network_elb</code>, <code>rds</code>, <code>sqs</code>, and <code>custom</code>. (required)
 * @return Object
 * @throws ApiException if fails to make API call
 * @deprecated
 */
 ...
 * Set an AWS tag filter.
 *
 * See {@link #createAWSTagFilterWithHttpInfoAsync}.
 *
 * @param body Set an AWS tag filter using an <code>aws_account_identifier</code>, <code>namespace</code>, and filtering string. Namespace options are <code>application_elb</code>, <code>elb</code>, <code>lambda</code>, <code>network_elb</code>, <code>rds</code>, <code>sqs</code>, and <code>custom</code>. (required)
...
@Deprecated
  public CompletableFuture<Object>createAWSTagFilterAsync(AWSTagFilterCreateRequest body) {
    return createAWSTagFilterWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Object> createAWSTagFilterWithHttpInfo(AWSTagFilterCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSTagFilter", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Object>> createAWSTagFilterWithHttpInfoAsync(AWSTagFilterCreateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createAWSTagFilter"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v1/integration/aws/filtering";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.createAWSTagFilter", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * @param body Your Datadog role delegation name. For more information about your AWS account Role name, see the <a href="https://docs.datadoghq.com/integrations/amazon_web_services/#setup">Datadog AWS integration configuration info</a>. (required)
 * @return AWSAccountCreateResponse
 * @throws ApiException if fails to make API call
 * @deprecated
 */
...
@Deprecated
  public CompletableFuture<AWSAccountCreateResponse>createNewAWSExternalIDAsync(AWSAccount body) {
    return createNewAWSExternalIDWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AWSAccountCreateResponse> createNewAWSExternalIDWithHttpInfo(AWSAccount body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.createNewAWSExternalID", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountCreateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AWSAccountCreateResponse>> createNewAWSExternalIDWithHttpInfoAsync(AWSAccount body) {
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<AWSAccountCreateResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createNewAWSExternalID"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v1/integration/aws/generate_new_external_id";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.createNewAWSExternalID", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSAccountCreateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountCreateResponse>() {});
  }
...
@Deprecated
  public CompletableFuture<Object>deleteAWSAccountAsync(AWSAccountDeleteRequest body) {
    return deleteAWSAccountWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Object> deleteAWSAccountWithHttpInfo(AWSAccountDeleteRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Object>> deleteAWSAccountWithHttpInfoAsync(AWSAccountDeleteRequest body) {
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling deleteAWSAccount"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v1/integration/aws";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated - use the V2 endpoints instead.</strong> Delete an Amazon EventBridge source.</p>
   *
   * @param body Delete the Amazon EventBridge source with the given name, region, and associated AWS account. (required)
  ...
  public ApiResponse<AWSEventBridgeDeleteResponse> deleteAWSEventBridgeSourceWithHttpInfo(AWSEventBridgeDeleteRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSEventBridgeSource", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AWSEventBridgeDeleteResponse>> deleteAWSEventBridgeSourceWithHttpInfoAsync(AWSEventBridgeDeleteRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSEventBridgeSource", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSEventBridgeDeleteResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #deleteAWSTagFilterWithHttpInfo}.
 *
 * @param body Delete a tag filtering entry for a given AWS account and <code>dd-aws</code> namespace. (required)
 * @return Object
 * @throws ApiException if fails to make API call
 * @deprecated
 */
 ...
 * Delete a tag filtering entry.
 *
 * See {@link #deleteAWSTagFilterWithHttpInfoAsync}.
 *
 * @param body Delete a tag filtering entry for a given AWS account and <code>dd-aws</code> namespace. (required)
 * @return CompletableFuture&lt;Object&gt;
 * @deprecated
...
@Deprecated
  public CompletableFuture<Object>deleteAWSTagFilterAsync(AWSTagFilterDeleteRequest body) {
    return deleteAWSTagFilterWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete a tag filtering entry.</p>
   *
   * @param body Delete a tag filtering entry for a given AWS account and <code>dd-aws</code> namespace. (required)
   * @return ApiResponse&lt;Object&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Object> deleteAWSTagFilterWithHttpInfo(AWSTagFilterDeleteRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSTagFilter", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<Object>() {});
  }
  ...
  public CompletableFuture<ApiResponse<Object>> deleteAWSTagFilterWithHttpInfoAsync(AWSTagFilterDeleteRequest body) {
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling deleteAWSTagFilter"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v1/integration/aws/filtering";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.deleteAWSTagFilter", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #listAvailableAWSNamespacesWithHttpInfo}.
 *
 * @return List&lt;String&gt;
 * @throws ApiException if fails to make API call
 * @deprecated
 ...
 * List namespace rules.
 *
 * See {@link #listAvailableAWSNamespacesWithHttpInfoAsync}.
 *
...
@Deprecated
  public CompletableFuture<List<String>>listAvailableAWSNamespacesAsync() {
    return listAvailableAWSNamespacesWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<List<String>> listAvailableAWSNamespacesWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAvailableAWSNamespaces", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<List<String>>> listAvailableAWSNamespacesWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAvailableAWSNamespaces", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
  ...
  public static class ListAWSAccountsOptionalParameters {
    ...
    /**
     * Set accountId.
     * @param accountId Only return AWS accounts that matches this <code>account_id</code>. (optional)
    ...
    /**
     * Set accessKeyId.
     * @param accessKeyId Only return AWS accounts that matches this <code>access_key_id</code>. (optional)
     * @return ListAWSAccountsOptionalParameters
     */
 ...
 */
@Deprecated
  public CompletableFuture<AWSAccountListResponse>listAWSAccountsAsync(ListAWSAccountsOptionalParameters parameters) {
  ...
  public ApiResponse<AWSAccountListResponse> listAWSAccountsWithHttpInfo(ListAWSAccountsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSAccounts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountListResponse>() {});
  }
   ...
   */
  @Deprecated
  public CompletableFuture<ApiResponse<AWSAccountListResponse>> listAWSAccountsWithHttpInfoAsync(ListAWSAccountsOptionalParameters parameters) {
    Object localVarPostBody = null;
    String accountId = parameters.accountId;
    String roleName = parameters.roleName;
    String accessKeyId = parameters.accessKeyId;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSAccounts", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSAccountListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSAccountListResponse>() {});
  }
...
@Deprecated
  ...
  /**
   * <p><strong>This endpoint is deprecated - use the V2 endpoints instead.</strong> Get all Amazon EventBridge sources.</p>
   *
  ...
  public ApiResponse<AWSEventBridgeListResponse> listAWSEventBridgeSourcesWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSEventBridgeSources", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AWSEventBridgeListResponse>> listAWSEventBridgeSourcesWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSEventBridgeSources", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 *
 * See {@link #listAWSTagFiltersWithHttpInfo}.
 *
 ...
 * Get all AWS tag filters.
 *
 * See {@link #listAWSTagFiltersWithHttpInfoAsync}.
 *
 * @param accountId Only return AWS filters that matches this <code>account_id</code>. (required)
...
@Deprecated
  public CompletableFuture<AWSTagFilterListResponse>listAWSTagFiltersAsync(String accountId) {
    return listAWSTagFiltersWithHttpInfoAsync(accountId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AWSTagFilterListResponse> listAWSTagFiltersWithHttpInfo(String accountId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSTagFilters", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSTagFilterListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AWSTagFilterListResponse>> listAWSTagFiltersWithHttpInfoAsync(String accountId) {
    ...
    if (accountId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'accountId' when calling listAWSTagFilters"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v1/integration/aws/filtering";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.listAWSTagFilters", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AWSTagFilterListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AWSTagFilterListResponse>() {});
  }
  ...
  public static class UpdateAWSAccountOptionalParameters {
    ...
    /**
     * Set roleName.
     * @param roleName Only return AWS accounts that match this <code>role_name</code>. Required if <code>account_id</code> is specified. (optional)
     * @return UpdateAWSAccountOptionalParameters
     */
    ...
    /**
     * Set accessKeyId.
     * @param accessKeyId Only return AWS accounts that matches this <code>access_key_id</code>. Required if none of the other two options are specified. (optional)
     * @return UpdateAWSAccountOptionalParameters
     */
...
@Deprecated
  public CompletableFuture<Object>updateAWSAccountAsync(AWSAccount body) {
    return updateAWSAccountWithHttpInfoAsync(body, new UpdateAWSAccountOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
@Deprecated
  public CompletableFuture<Object>updateAWSAccountAsync( AWSAccount body, UpdateAWSAccountOptionalParameters parameters) {
    return updateAWSAccountWithHttpInfoAsync(body, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Object> updateAWSAccountWithHttpInfo(AWSAccount body, UpdateAWSAccountOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v1.AwsIntegrationApi.updateAWSAccount", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
   ...
   */
  @Deprecated
  public CompletableFuture<ApiResponse<Object>> updateAWSAccountWithHttpInfoAsync(AWSAccount body, UpdateAWSAccountOptionalParameters parameters) {
    Object localVarPostBody = body;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v1.AwsIntegrationApi.updateAWSAccount", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Object>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
