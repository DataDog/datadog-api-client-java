...
public class AzureAccount {
  ...
  /**
   * <p>Limit the Azure app service plans that are pulled into Datadog using tags.
   * Only app service plans that match one of the defined tags are imported into Datadog.</p>
  ...
  **/
  ...
  /**
   * <p>Limit the Azure container apps that are pulled into Datadog using tags.
   * Only container apps that match one of the defined tags are imported into Datadog.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog’s Cloud Security Management product scans resource configurations monitored by this app registration.
   * Note: This requires resource_collection_enabled to be set to true.</p>
   * @return cspmEnabled
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Enable custom metrics for your organization.</p>
  ...
  **/
  ...
  /**
   * <p>Enable Azure metrics for your organization.</p>
  ...
  **/
  ...
  /**
   * <p>Enable Azure metrics for your organization for resource providers where no resource provider config is specified.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog collects metadata and configuration info from cloud resources (compute instances, databases, load balancers, etc.) monitored by this app registration.</p>
  ...
  **/
  ...
  public AzureAccount resourceProviderConfigs(List<ResourceProviderConfig> resourceProviderConfigs) {
  ...
  public AzureAccount addResourceProviderConfigsItem(ResourceProviderConfig resourceProviderConfigsItem) {
  ...
  /**
   * <p>Configuration settings applied to resources from the specified Azure resource providers.</p>
  ...
  **/
  ...
  /**
   * <p>(Preview) When enabled, Datadog authenticates with this app registration using federated workload identity credentials instead of a client secret.</p>
  ...
  **/
  ...
  /**
   * <p>Enable azure.usage metrics for your organization.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appServicePlanFilters, azureAccount.appServicePlanFilters) && Objects.equals(this.automute, azureAccount.automute) && Objects.equals(this.clientId, azureAccount.clientId) && Objects.equals(this.clientSecret, azureAccount.clientSecret) && Objects.equals(this.containerAppFilters, azureAccount.containerAppFilters) && Objects.equals(this.cspmEnabled, azureAccount.cspmEnabled) && Objects.equals(this.customMetricsEnabled, azureAccount.customMetricsEnabled) && Objects.equals(this.errors, azureAccount.errors) && Objects.equals(this.hostFilters, azureAccount.hostFilters) && Objects.equals(this.metricsEnabled, azureAccount.metricsEnabled) && Objects.equals(this.metricsEnabledDefault, azureAccount.metricsEnabledDefault) && Objects.equals(this.newClientId, azureAccount.newClientId) && Objects.equals(this.newTenantName, azureAccount.newTenantName) && Objects.equals(this.resourceCollectionEnabled, azureAccount.resourceCollectionEnabled) && Objects.equals(this.resourceProviderConfigs, azureAccount.resourceProviderConfigs) && Objects.equals(this.secretlessAuthEnabled, azureAccount.secretlessAuthEnabled) && Objects.equals(this.tenantName, azureAccount.tenantName) && Objects.equals(this.usageMetricsEnabled, azureAccount.usageMetricsEnabled) && Objects.equals(this.additionalProperties, azureAccount.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(appServicePlanFilters,automute,clientId,clientSecret,containerAppFilters,cspmEnabled,customMetricsEnabled,errors,hostFilters,metricsEnabled,metricsEnabledDefault,newClientId,newTenantName,resourceCollectionEnabled,resourceProviderConfigs,secretlessAuthEnabled,tenantName,usageMetricsEnabled, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    appServicePlanFilters: ").append(toIndentedString(appServicePlanFilters)).append("\n");
    sb.append("    automute: ").append(toIndentedString(automute)).append("\n");
    sb.append("    clientId: ").append(toIndentedString(clientId)).append("\n");
    sb.append("    clientSecret: ").append(toIndentedString(clientSecret)).append("\n");
    sb.append("    containerAppFilters: ").append(toIndentedString(containerAppFilters)).append("\n");
    sb.append("    cspmEnabled: ").append(toIndentedString(cspmEnabled)).append("\n");
    sb.append("    customMetricsEnabled: ").append(toIndentedString(customMetricsEnabled)).append("\n");
