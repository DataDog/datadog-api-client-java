...
public class AzureAccount {
  ...
  /**
   * Limit the App Service Plans, Web Apps, Function Apps, and other resources under the Azure App
   * Services (Microsoft.Web) resource provider. Filtering an App Service Plan applies to all Apps
   * running on that plan.
   *
