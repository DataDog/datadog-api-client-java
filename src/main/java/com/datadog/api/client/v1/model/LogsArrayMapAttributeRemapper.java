...
/**
   * <p>An attribute remapper sub-processor for use inside an array-map processor.
   * Unlike the top-level attribute remapper, <code>is_enabled</code>, <code>source_type</code>, and
   * <code>target_type</code> are not supported.</p>
 */
@JsonPropertyOrder({
...
public class LogsArrayMapAttributeRemapper {
  ...
  **/
  ...
  /**
   * <p>Override the target element if already set.</p>
  ...
  **/
  ...
  /**
   * <p>Array of source attribute paths.</p>
   * @return sources
  **/
