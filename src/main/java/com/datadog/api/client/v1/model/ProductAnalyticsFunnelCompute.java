...
public class ProductAnalyticsFunnelCompute {
  ...
  @JsonCreator
  public ProductAnalyticsFunnelCompute(
            @JsonProperty(required=true, value=JSON_PROPERTY_AGGREGATION)ProductAnalyticsFunnelComputeAggregation aggregation,
            @JsonProperty(required=true, value=JSON_PROPERTY_METRIC)ProductAnalyticsFunnelComputeMetric metric) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregation, productAnalyticsFunnelCompute.aggregation) && Objects.equals(this.metric, productAnalyticsFunnelCompute.metric);
  }
