...
public class BarChartWidgetStackedType extends ModelEnum<String> {
  ...
  public static class BarChartWidgetStackedTypeSerializer extends StdSerializer<BarChartWidgetStackedType> {
      ...
      @Override
      public void serialize(BarChartWidgetStackedType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
