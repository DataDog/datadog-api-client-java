...
public class GeomapWidgetDefinitionType extends ModelEnum<String> {
  ...
  public static class GeomapWidgetDefinitionTypeSerializer extends StdSerializer<GeomapWidgetDefinitionType> {
      ...
      @Override
      public void serialize(GeomapWidgetDefinitionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
