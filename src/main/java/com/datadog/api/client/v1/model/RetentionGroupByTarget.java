...
public class RetentionGroupByTarget extends ModelEnum<String> {
  ...
  public static final RetentionGroupByTarget RETURN_PERIOD = new RetentionGroupByTarget("return_period");
  ...
  public static class RetentionGroupByTargetSerializer extends StdSerializer<RetentionGroupByTarget> {
      ...
      @Override
      public void serialize(RetentionGroupByTarget value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
