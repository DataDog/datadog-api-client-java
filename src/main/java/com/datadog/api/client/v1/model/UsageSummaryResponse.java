...
/**
   * <p>Response summarizing all usage aggregated across the months in the request for all organizations, and broken down by month and by organization.</p>
 */
@JsonPropertyOrder({
  ...
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_APPSERVICE_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_AZUREFUNCTION_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_CONTAINERAPP_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_GCP_CLOUDFUNCTION_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_GCP_CLOUDRUN_INSTANCES_AVG_SUM,
  ...
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_CONTAINER_APP_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_FUNCTION_APP_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_WEB_APP_INSTANCES_AVG_SUM,
  UsageSummaryResponse.JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_GOOGLE_CLOUD_FUNCTIONS_INSTANCES_AVG_SUM,
...
public class UsageSummaryResponse {
  ...
  public static final String JSON_PROPERTY_APM_DEVSECOPS_HOST_TOP99P_SUM = "apm_devsecops_host_top99p_sum";
  private Long apmDevsecopsHostTop99pSum;

  public static final String JSON_PROPERTY_APM_ENTERPRISE_STANDALONE_HOSTS_TOP99P_SUM = "apm_enterprise_standalone_hosts_top99p_sum";
  ...
  public static final String JSON_PROPERTY_APM_PRO_STANDALONE_HOSTS_TOP99P_SUM = "apm_pro_standalone_hosts_top99p_sum";
  ...
  public static final String JSON_PROPERTY_BITS_AI_INVESTIGATIONS_AGG_SUM = "bits_ai_investigations_agg_sum";
  ...
  public static final String JSON_PROPERTY_CCM_SPEND_MONITORED_ENT_LAST_SUM = "ccm_spend_monitored_ent_last_sum";
  private Long ccmSpendMonitoredEntLastSum;

  public static final String JSON_PROPERTY_CCM_SPEND_MONITORED_PRO_LAST_SUM = "ccm_spend_monitored_pro_last_sum";
  ...
  public static final String JSON_PROPERTY_CLOUD_COST_MANAGEMENT_GCP_HOST_COUNT_AVG_SUM = "cloud_cost_management_gcp_host_count_avg_sum";
  ...
  public static final String JSON_PROPERTY_CLOUD_COST_MANAGEMENT_OCI_HOST_COUNT_AVG_SUM = "cloud_cost_management_oci_host_count_avg_sum";
  ...
  public static final String JSON_PROPERTY_CODE_ANALYSIS_SA_COMMITTERS_HWM_SUM = "code_analysis_sa_committers_hwm_sum";
  private Long codeAnalysisSaCommittersHwmSum;

  public static final String JSON_PROPERTY_CODE_ANALYSIS_SCA_COMMITTERS_HWM_SUM = "code_analysis_sca_committers_hwm_sum";
  private Long codeAnalysisScaCommittersHwmSum;

  public static final String JSON_PROPERTY_CODE_SECURITY_HOST_TOP99P_SUM = "code_security_host_top99p_sum";
  ...
  public static final String JSON_PROPERTY_CSM_CONTAINER_ENTERPRISE_COMPLIANCE_COUNT_AGG_SUM = "csm_container_enterprise_compliance_count_agg_sum";
  private Long csmContainerEnterpriseComplianceCountAggSum;

  public static final String JSON_PROPERTY_CSM_CONTAINER_ENTERPRISE_CWS_COUNT_AGG_SUM = "csm_container_enterprise_cws_count_agg_sum";
  private Long csmContainerEnterpriseCwsCountAggSum;

  public static final String JSON_PROPERTY_CSM_CONTAINER_ENTERPRISE_TOTAL_COUNT_AGG_SUM = "csm_container_enterprise_total_count_agg_sum";
  private Long csmContainerEnterpriseTotalCountAggSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_AAS_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_aas_host_count_top99p_sum";
  private Long csmHostEnterpriseAasHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_AWS_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_aws_host_count_top99p_sum";
  private Long csmHostEnterpriseAwsHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_AZURE_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_azure_host_count_top99p_sum";
  private Long csmHostEnterpriseAzureHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_COMPLIANCE_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_compliance_host_count_top99p_sum";
  private Long csmHostEnterpriseComplianceHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_CWS_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_cws_host_count_top99p_sum";
  private Long csmHostEnterpriseCwsHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_GCP_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_gcp_host_count_top99p_sum";
  private Long csmHostEnterpriseGcpHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_OCI_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_oci_host_count_top99p_sum";
  private Long csmHostEnterpriseOciHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_ENTERPRISE_TOTAL_HOST_COUNT_TOP99P_SUM = "csm_host_enterprise_total_host_count_top99p_sum";
  private Long csmHostEnterpriseTotalHostCountTop99pSum;

  public static final String JSON_PROPERTY_CSM_HOST_PRO_OCI_HOST_COUNT_TOP99P_SUM = "csm_host_pro_oci_host_count_top99p_sum";
  ...
  public static final String JSON_PROPERTY_DATA_JOBS_MONITORING_HOST_HR_AGG_SUM = "data_jobs_monitoring_host_hr_agg_sum";
  ...
  public static final String JSON_PROPERTY_EPH_INFRA_HOST_AGENT_AGG_SUM = "eph_infra_host_agent_agg_sum";
  private Long ephInfraHostAgentAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_ALIBABA_AGG_SUM = "eph_infra_host_alibaba_agg_sum";
  private Long ephInfraHostAlibabaAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_AWS_AGG_SUM = "eph_infra_host_aws_agg_sum";
  private Long ephInfraHostAwsAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_AZURE_AGG_SUM = "eph_infra_host_azure_agg_sum";
  private Long ephInfraHostAzureAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_ENT_AGG_SUM = "eph_infra_host_ent_agg_sum";
  private Long ephInfraHostEntAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_GCP_AGG_SUM = "eph_infra_host_gcp_agg_sum";
  private Long ephInfraHostGcpAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_HEROKU_AGG_SUM = "eph_infra_host_heroku_agg_sum";
  private Long ephInfraHostHerokuAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_ONLY_AAS_AGG_SUM = "eph_infra_host_only_aas_agg_sum";
  private Long ephInfraHostOnlyAasAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_ONLY_VSPHERE_AGG_SUM = "eph_infra_host_only_vsphere_agg_sum";
  private Long ephInfraHostOnlyVsphereAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_OPENTELEMETRY_AGG_SUM = "eph_infra_host_opentelemetry_agg_sum";
  private Long ephInfraHostOpentelemetryAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_OPENTELEMETRY_APM_AGG_SUM = "eph_infra_host_opentelemetry_apm_agg_sum";
  private Long ephInfraHostOpentelemetryApmAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_PRO_AGG_SUM = "eph_infra_host_pro_agg_sum";
  private Long ephInfraHostProAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_PROPLUS_AGG_SUM = "eph_infra_host_proplus_agg_sum";
  private Long ephInfraHostProplusAggSum;

  public static final String JSON_PROPERTY_EPH_INFRA_HOST_PROXMOX_AGG_SUM = "eph_infra_host_proxmox_agg_sum";
  private Long ephInfraHostProxmoxAggSum;

  public static final String JSON_PROPERTY_ERROR_TRACKING_APM_ERROR_EVENTS_AGG_SUM = "error_tracking_apm_error_events_agg_sum";
  private Long errorTrackingApmErrorEventsAggSum;

  public static final String JSON_PROPERTY_ERROR_TRACKING_ERROR_EVENTS_AGG_SUM = "error_tracking_error_events_agg_sum";
  private Long errorTrackingErrorEventsAggSum;

  public static final String JSON_PROPERTY_ERROR_TRACKING_EVENTS_AGG_SUM = "error_tracking_events_agg_sum";
  private Long errorTrackingEventsAggSum;

  public static final String JSON_PROPERTY_ERROR_TRACKING_RUM_ERROR_EVENTS_AGG_SUM = "error_tracking_rum_error_events_agg_sum";
  private Long errorTrackingRumErrorEventsAggSum;

  public static final String JSON_PROPERTY_EVENT_MANAGEMENT_CORRELATION_AGG_SUM = "event_management_correlation_agg_sum";
  private Long eventManagementCorrelationAggSum;

  public static final String JSON_PROPERTY_EVENT_MANAGEMENT_CORRELATION_CORRELATED_EVENTS_AGG_SUM = "event_management_correlation_correlated_events_agg_sum";
  private Long eventManagementCorrelationCorrelatedEventsAggSum;

  public static final String JSON_PROPERTY_EVENT_MANAGEMENT_CORRELATION_CORRELATED_RELATED_EVENTS_AGG_SUM = "event_management_correlation_correlated_related_events_agg_sum";
  private Long eventManagementCorrelationCorrelatedRelatedEventsAggSum;

  public static final String JSON_PROPERTY_FARGATE_CONTAINER_PROFILER_PROFILING_FARGATE_AVG_SUM = "fargate_container_profiler_profiling_fargate_avg_sum";
  private Long fargateContainerProfilerProfilingFargateAvgSum;

  public static final String JSON_PROPERTY_FARGATE_CONTAINER_PROFILER_PROFILING_FARGATE_EKS_AVG_SUM = "fargate_container_profiler_profiling_fargate_eks_avg_sum";
  ...
  public static final String JSON_PROPERTY_FLEX_LOGS_COMPUTE_LARGE_AVG_SUM = "flex_logs_compute_large_avg_sum";
  private Long flexLogsComputeLargeAvgSum;

  public static final String JSON_PROPERTY_FLEX_LOGS_COMPUTE_MEDIUM_AVG_SUM = "flex_logs_compute_medium_avg_sum";
  private Long flexLogsComputeMediumAvgSum;

  public static final String JSON_PROPERTY_FLEX_LOGS_COMPUTE_SMALL_AVG_SUM = "flex_logs_compute_small_avg_sum";
  private Long flexLogsComputeSmallAvgSum;

  public static final String JSON_PROPERTY_FLEX_LOGS_COMPUTE_XLARGE_AVG_SUM = "flex_logs_compute_xlarge_avg_sum";
  private Long flexLogsComputeXlargeAvgSum;

  public static final String JSON_PROPERTY_FLEX_LOGS_COMPUTE_XSMALL_AVG_SUM = "flex_logs_compute_xsmall_avg_sum";
  ...
  public static final String JSON_PROPERTY_FLEX_LOGS_STARTER_STORAGE_INDEX_AVG_SUM = "flex_logs_starter_storage_index_avg_sum";
  private Long flexLogsStarterStorageIndexAvgSum;

  public static final String JSON_PROPERTY_FLEX_LOGS_STARTER_STORAGE_RETENTION_ADJUSTMENT_AVG_SUM = "flex_logs_starter_storage_retention_adjustment_avg_sum";
  ...
  public static final String JSON_PROPERTY_INCIDENT_MANAGEMENT_SEATS_HWM_SUM = "incident_management_seats_hwm_sum";
  ...
  public static final String JSON_PROPERTY_INFRA_EDGE_MONITORING_DEVICES_TOP99P_SUM = "infra_edge_monitoring_devices_top99p_sum";
  ...
  public static final String JSON_PROPERTY_LLM_OBSERVABILITY_MIN_SPEND_AGG_SUM = "llm_observability_min_spend_agg_sum";
  ...
  public static final String JSON_PROPERTY_NDM_NETFLOW_EVENTS_AGG_SUM = "ndm_netflow_events_agg_sum";
  ...
  public static final String JSON_PROPERTY_NETWORK_DEVICE_WIRELESS_TOP99P_SUM = "network_device_wireless_top99p_sum";
  ...
  public static final String JSON_PROPERTY_PROFILING_AAS_COUNT_TOP99P_SUM = "profiling_aas_count_top99p_sum";
  ...
  public static final String JSON_PROPERTY_RUM_BROWSER_LEGACY_SESSION_COUNT_AGG_SUM = "rum_browser_legacy_session_count_agg_sum";
  private Long rumBrowserLegacySessionCountAggSum;

  public static final String JSON_PROPERTY_RUM_BROWSER_LITE_SESSION_COUNT_AGG_SUM = "rum_browser_lite_session_count_agg_sum";
  private Long rumBrowserLiteSessionCountAggSum;

  public static final String JSON_PROPERTY_RUM_BROWSER_REPLAY_SESSION_COUNT_AGG_SUM = "rum_browser_replay_session_count_agg_sum";
  private Long rumBrowserReplaySessionCountAggSum;

  public static final String JSON_PROPERTY_RUM_INDEXED_SESSIONS_AGG_SUM = "rum_indexed_sessions_agg_sum";
  private Long rumIndexedSessionsAggSum;

  public static final String JSON_PROPERTY_RUM_INGESTED_SESSIONS_AGG_SUM = "rum_ingested_sessions_agg_sum";
  private Long rumIngestedSessionsAggSum;

  public static final String JSON_PROPERTY_RUM_LITE_SESSION_COUNT_AGG_SUM = "rum_lite_session_count_agg_sum";
  private Long rumLiteSessionCountAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LEGACY_SESSION_COUNT_ANDROID_AGG_SUM = "rum_mobile_legacy_session_count_android_agg_sum";
  private Long rumMobileLegacySessionCountAndroidAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LEGACY_SESSION_COUNT_FLUTTER_AGG_SUM = "rum_mobile_legacy_session_count_flutter_agg_sum";
  private Long rumMobileLegacySessionCountFlutterAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LEGACY_SESSION_COUNT_IOS_AGG_SUM = "rum_mobile_legacy_session_count_ios_agg_sum";
  private Long rumMobileLegacySessionCountIosAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LEGACY_SESSION_COUNT_REACTNATIVE_AGG_SUM = "rum_mobile_legacy_session_count_reactnative_agg_sum";
  private Long rumMobileLegacySessionCountReactnativeAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LEGACY_SESSION_COUNT_ROKU_AGG_SUM = "rum_mobile_legacy_session_count_roku_agg_sum";
  private Long rumMobileLegacySessionCountRokuAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_ANDROID_AGG_SUM = "rum_mobile_lite_session_count_android_agg_sum";
  private Long rumMobileLiteSessionCountAndroidAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_FLUTTER_AGG_SUM = "rum_mobile_lite_session_count_flutter_agg_sum";
  private Long rumMobileLiteSessionCountFlutterAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_IOS_AGG_SUM = "rum_mobile_lite_session_count_ios_agg_sum";
  private Long rumMobileLiteSessionCountIosAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_KOTLINMULTIPLATFORM_AGG_SUM = "rum_mobile_lite_session_count_kotlinmultiplatform_agg_sum";
  private Long rumMobileLiteSessionCountKotlinmultiplatformAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_REACTNATIVE_AGG_SUM = "rum_mobile_lite_session_count_reactnative_agg_sum";
  private Long rumMobileLiteSessionCountReactnativeAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_ROKU_AGG_SUM = "rum_mobile_lite_session_count_roku_agg_sum";
  private Long rumMobileLiteSessionCountRokuAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_LITE_SESSION_COUNT_UNITY_AGG_SUM = "rum_mobile_lite_session_count_unity_agg_sum";
  private Long rumMobileLiteSessionCountUnityAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_REPLAY_SESSION_COUNT_ANDROID_AGG_SUM = "rum_mobile_replay_session_count_android_agg_sum";
  private Long rumMobileReplaySessionCountAndroidAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_REPLAY_SESSION_COUNT_IOS_AGG_SUM = "rum_mobile_replay_session_count_ios_agg_sum";
  private Long rumMobileReplaySessionCountIosAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_REPLAY_SESSION_COUNT_KOTLINMULTIPLATFORM_AGG_SUM = "rum_mobile_replay_session_count_kotlinmultiplatform_agg_sum";
  private Long rumMobileReplaySessionCountKotlinmultiplatformAggSum;

  public static final String JSON_PROPERTY_RUM_MOBILE_REPLAY_SESSION_COUNT_REACTNATIVE_AGG_SUM = "rum_mobile_replay_session_count_reactnative_agg_sum";
  private Long rumMobileReplaySessionCountReactnativeAggSum;

  public static final String JSON_PROPERTY_RUM_REPLAY_SESSION_COUNT_AGG_SUM = "rum_replay_session_count_agg_sum";
  ...
  public static final String JSON_PROPERTY_RUM_SESSION_REPLAY_ADD_ON_AGG_SUM = "rum_session_replay_add_on_agg_sum";
  ...
  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_AZURE_APPSERVICE_INSTANCES_AVG_SUM = "serverless_apps_apm_apm_azure_appservice_instances_avg_sum";
  private Long serverlessAppsApmApmAzureAppserviceInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_AZURE_AZUREFUNCTION_INSTANCES_AVG_SUM = "serverless_apps_apm_apm_azure_azurefunction_instances_avg_sum";
  private Long serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_AZURE_CONTAINERAPP_INSTANCES_AVG_SUM = "serverless_apps_apm_apm_azure_containerapp_instances_avg_sum";
  private Long serverlessAppsApmApmAzureContainerappInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_FARGATE_ECS_TASKS_AVG_SUM = "serverless_apps_apm_apm_fargate_ecs_tasks_avg_sum";
  private Long serverlessAppsApmApmFargateEcsTasksAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_GCP_CLOUDFUNCTION_INSTANCES_AVG_SUM = "serverless_apps_apm_apm_gcp_cloudfunction_instances_avg_sum";
  private Long serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_APM_GCP_CLOUDRUN_INSTANCES_AVG_SUM = "serverless_apps_apm_apm_gcp_cloudrun_instances_avg_sum";
  private Long serverlessAppsApmApmGcpCloudrunInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_AVG_SUM = "serverless_apps_apm_avg_sum";
  private Long serverlessAppsApmAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_APPSERVICE_INSTANCES_AVG_SUM = "serverless_apps_apm_excl_fargate_apm_azure_appservice_instances_avg_sum";
  private Long serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_AZUREFUNCTION_INSTANCES_AVG_SUM = "serverless_apps_apm_excl_fargate_apm_azure_azurefunction_instances_avg_sum";
  private Long serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_CONTAINERAPP_INSTANCES_AVG_SUM = "serverless_apps_apm_excl_fargate_apm_azure_containerapp_instances_avg_sum";
  private Long serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_GCP_CLOUDFUNCTION_INSTANCES_AVG_SUM = "serverless_apps_apm_excl_fargate_apm_gcp_cloudfunction_instances_avg_sum";
  private Long serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_GCP_CLOUDRUN_INSTANCES_AVG_SUM = "serverless_apps_apm_excl_fargate_apm_gcp_cloudrun_instances_avg_sum";
  private Long serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_AVG_SUM = "serverless_apps_apm_excl_fargate_avg_sum";
  private Long serverlessAppsApmExclFargateAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_AZURE_CONTAINER_APP_INSTANCES_AVG_SUM = "serverless_apps_azure_container_app_instances_avg_sum";
  private Long serverlessAppsAzureContainerAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_AZURE_COUNT_AVG_SUM = "serverless_apps_azure_count_avg_sum";
  private Long serverlessAppsAzureCountAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_AZURE_FUNCTION_APP_INSTANCES_AVG_SUM = "serverless_apps_azure_function_app_instances_avg_sum";
  private Long serverlessAppsAzureFunctionAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_AZURE_WEB_APP_INSTANCES_AVG_SUM = "serverless_apps_azure_web_app_instances_avg_sum";
  private Long serverlessAppsAzureWebAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_ECS_AVG_SUM = "serverless_apps_ecs_avg_sum";
  private Long serverlessAppsEcsAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EKS_AVG_SUM = "serverless_apps_eks_avg_sum";
  private Long serverlessAppsEksAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AVG_SUM = "serverless_apps_excl_fargate_avg_sum";
  private Long serverlessAppsExclFargateAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_CONTAINER_APP_INSTANCES_AVG_SUM = "serverless_apps_excl_fargate_azure_container_app_instances_avg_sum";
  private Long serverlessAppsExclFargateAzureContainerAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_FUNCTION_APP_INSTANCES_AVG_SUM = "serverless_apps_excl_fargate_azure_function_app_instances_avg_sum";
  private Long serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_AZURE_WEB_APP_INSTANCES_AVG_SUM = "serverless_apps_excl_fargate_azure_web_app_instances_avg_sum";
  private Long serverlessAppsExclFargateAzureWebAppInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_GOOGLE_CLOUD_FUNCTIONS_INSTANCES_AVG_SUM = "serverless_apps_excl_fargate_google_cloud_functions_instances_avg_sum";
  private Long serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_EXCL_FARGATE_GOOGLE_CLOUD_RUN_INSTANCES_AVG_SUM = "serverless_apps_excl_fargate_google_cloud_run_instances_avg_sum";
  private Long serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_GOOGLE_CLOUD_FUNCTIONS_INSTANCES_AVG_SUM = "serverless_apps_google_cloud_functions_instances_avg_sum";
  private Long serverlessAppsGoogleCloudFunctionsInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_GOOGLE_CLOUD_RUN_INSTANCES_AVG_SUM = "serverless_apps_google_cloud_run_instances_avg_sum";
  private Long serverlessAppsGoogleCloudRunInstancesAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_GOOGLE_COUNT_AVG_SUM = "serverless_apps_google_count_avg_sum";
  private Long serverlessAppsGoogleCountAvgSum;

  public static final String JSON_PROPERTY_SERVERLESS_APPS_TOTAL_COUNT_AVG_SUM = "serverless_apps_total_count_avg_sum";
  private Long serverlessAppsTotalCountAvgSum;

  public static final String JSON_PROPERTY_SIEM_ANALYZED_LOGS_ADD_ON_COUNT_AGG_SUM = "siem_analyzed_logs_add_on_count_agg_sum";
  ...
  public static final String JSON_PROPERTY_SYNTHETICS_MOBILE_TEST_RUNS_AGG_SUM = "synthetics_mobile_test_runs_agg_sum";
  ...
  /**
   * <p>Shows the 99th percentile of all agent hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Azure app services using APM over all hours in the current month all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all APM DevSecOps hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the 99th percentile of all distinct standalone Enterprise hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all APM ECS Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all distinct APM hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the 99th percentile of all distinct standalone Pro hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all Application Security Monitoring ECS Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Application Security Monitoring Serverless invocations over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all audit logs lines indexed over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the total number of organizations that had Audit Trail enabled over a specific number of months.</p>
  ...
  **/
  ...
  /**
   * <p>The average total count for Fargate Container Profiler over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all AWS hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of the number of functions that executed 1 or more times each hour in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all AWS Lambda invocations over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Azure app services over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Azure hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all log bytes ingested over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Bits AI Investigations over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse browserRumLiteSessionCountAggSum(Long browserRumLiteSessionCountAggSum) {
    this.browserRumLiteSessionCountAggSum = browserRumLiteSessionCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all browser lite sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse browserRumReplaySessionCountAggSum(Long browserRumReplaySessionCountAggSum) {
    this.browserRumReplaySessionCountAggSum = browserRumReplaySessionCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all browser replay sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser RUM units over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the last value of the amount of cloud spend monitored for Enterprise in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the last value of the amount of cloud spend monitored for Pro in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all CI pipeline indexed spans over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all CI test indexed spans over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse ciVisibilityItrCommittersHwmSum(Long ciVisibilityItrCommittersHwmSum) {
    this.ciVisibilityItrCommittersHwmSum = ciVisibilityItrCommittersHwmSum;
    return this;
  }

  /**
   * <p>Shows the high-water mark of all CI visibility intelligent test runner committers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse ciVisibilityPipelineCommittersHwmSum(Long ciVisibilityPipelineCommittersHwmSum) {
    this.ciVisibilityPipelineCommittersHwmSum = ciVisibilityPipelineCommittersHwmSum;
    return this;
  }

  /**
   * <p>Shows the high-water mark of all CI visibility pipeline committers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse ciVisibilityTestCommittersHwmSum(Long ciVisibilityTestCommittersHwmSum) {
    this.ciVisibilityTestCommittersHwmSum = ciVisibilityTestCommittersHwmSum;
    return this;
  }

  /**
   * <p>Shows the high-water mark of all CI visibility test committers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse cloudCostManagementAwsHostCountAvgSum(Long cloudCostManagementAwsHostCountAvgSum) {
    this.cloudCostManagementAwsHostCountAvgSum = cloudCostManagementAwsHostCountAvgSum;
    return this;
  }

  /**
   * <p>Sum of the host count average for Cloud Cost Management for AWS.</p>
  ...
  **/
  ...
  public UsageSummaryResponse cloudCostManagementAzureHostCountAvgSum(Long cloudCostManagementAzureHostCountAvgSum) {
    this.cloudCostManagementAzureHostCountAvgSum = cloudCostManagementAzureHostCountAvgSum;
    return this;
  }

  /**
   * <p>Sum of the host count average for Cloud Cost Management for Azure.</p>
  ...
  **/
  ...
  public void setCloudCostManagementAzureHostCountAvgSum(Long cloudCostManagementAzureHostCountAvgSum) {
    this.cloudCostManagementAzureHostCountAvgSum = cloudCostManagementAzureHostCountAvgSum;
  }
  public UsageSummaryResponse cloudCostManagementGcpHostCountAvgSum(Long cloudCostManagementGcpHostCountAvgSum) {
    this.cloudCostManagementGcpHostCountAvgSum = cloudCostManagementGcpHostCountAvgSum;
    return this;
  }

  /**
   * <p>Sum of the host count average for Cloud Cost Management for GCP.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of the host count average for Cloud Cost Management for all cloud providers.</p>
  ...
  **/
  ...
  public UsageSummaryResponse cloudCostManagementOciHostCountAvgSum(Long cloudCostManagementOciHostCountAvgSum) {
    this.cloudCostManagementOciHostCountAvgSum = cloudCostManagementOciHostCountAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average host counts for Cloud Cost Management on OCI.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Cloud Security Information and Event Management events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the high-water mark of all Static Analysis committers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse codeAnalysisScaCommittersHwmSum(Long codeAnalysisScaCommittersHwmSum) {
    this.codeAnalysisScaCommittersHwmSum = codeAnalysisScaCommittersHwmSum;
    return this;
  }

  /**
   * <p>Shows the high-water mark of all static Software Composition Analysis committers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Code Security hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all distinct containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of the containers without the Datadog Agent over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of all distinct containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse csmContainerEnterpriseComplianceCountAggSum(Long csmContainerEnterpriseComplianceCountAggSum) {
    this.csmContainerEnterpriseComplianceCountAggSum = csmContainerEnterpriseComplianceCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Cloud Security Management Enterprise compliance containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmContainerEnterpriseComplianceCountAggSum(Long csmContainerEnterpriseComplianceCountAggSum) {
    this.csmContainerEnterpriseComplianceCountAggSum = csmContainerEnterpriseComplianceCountAggSum;
  }
  public UsageSummaryResponse csmContainerEnterpriseCwsCountAggSum(Long csmContainerEnterpriseCwsCountAggSum) {
    this.csmContainerEnterpriseCwsCountAggSum = csmContainerEnterpriseCwsCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Cloud Security Management Enterprise Cloud Workload Security containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse csmContainerEnterpriseTotalCountAggSum(Long csmContainerEnterpriseTotalCountAggSum) {
    this.csmContainerEnterpriseTotalCountAggSum = csmContainerEnterpriseTotalCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Cloud Security Management Enterprise containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmContainerEnterpriseTotalCountAggSum(Long csmContainerEnterpriseTotalCountAggSum) {
    this.csmContainerEnterpriseTotalCountAggSum = csmContainerEnterpriseTotalCountAggSum;
  }
  public UsageSummaryResponse csmHostEnterpriseAasHostCountTop99pSum(Long csmHostEnterpriseAasHostCountTop99pSum) {
    this.csmHostEnterpriseAasHostCountTop99pSum = csmHostEnterpriseAasHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise Azure app services hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseAasHostCountTop99pSum(Long csmHostEnterpriseAasHostCountTop99pSum) {
    this.csmHostEnterpriseAasHostCountTop99pSum = csmHostEnterpriseAasHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseAwsHostCountTop99pSum(Long csmHostEnterpriseAwsHostCountTop99pSum) {
    this.csmHostEnterpriseAwsHostCountTop99pSum = csmHostEnterpriseAwsHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise AWS hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseAwsHostCountTop99pSum(Long csmHostEnterpriseAwsHostCountTop99pSum) {
    this.csmHostEnterpriseAwsHostCountTop99pSum = csmHostEnterpriseAwsHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseAzureHostCountTop99pSum(Long csmHostEnterpriseAzureHostCountTop99pSum) {
    this.csmHostEnterpriseAzureHostCountTop99pSum = csmHostEnterpriseAzureHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise Azure hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse csmHostEnterpriseComplianceHostCountTop99pSum(Long csmHostEnterpriseComplianceHostCountTop99pSum) {
    this.csmHostEnterpriseComplianceHostCountTop99pSum = csmHostEnterpriseComplianceHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise compliance hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseComplianceHostCountTop99pSum(Long csmHostEnterpriseComplianceHostCountTop99pSum) {
    this.csmHostEnterpriseComplianceHostCountTop99pSum = csmHostEnterpriseComplianceHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseCwsHostCountTop99pSum(Long csmHostEnterpriseCwsHostCountTop99pSum) {
    this.csmHostEnterpriseCwsHostCountTop99pSum = csmHostEnterpriseCwsHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise Cloud Workload Security hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseCwsHostCountTop99pSum(Long csmHostEnterpriseCwsHostCountTop99pSum) {
    this.csmHostEnterpriseCwsHostCountTop99pSum = csmHostEnterpriseCwsHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseGcpHostCountTop99pSum(Long csmHostEnterpriseGcpHostCountTop99pSum) {
    this.csmHostEnterpriseGcpHostCountTop99pSum = csmHostEnterpriseGcpHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise GCP hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseGcpHostCountTop99pSum(Long csmHostEnterpriseGcpHostCountTop99pSum) {
    this.csmHostEnterpriseGcpHostCountTop99pSum = csmHostEnterpriseGcpHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseOciHostCountTop99pSum(Long csmHostEnterpriseOciHostCountTop99pSum) {
    this.csmHostEnterpriseOciHostCountTop99pSum = csmHostEnterpriseOciHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise OCI hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseOciHostCountTop99pSum(Long csmHostEnterpriseOciHostCountTop99pSum) {
    this.csmHostEnterpriseOciHostCountTop99pSum = csmHostEnterpriseOciHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostEnterpriseTotalHostCountTop99pSum(Long csmHostEnterpriseTotalHostCountTop99pSum) {
    this.csmHostEnterpriseTotalHostCountTop99pSum = csmHostEnterpriseTotalHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Enterprise hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setCsmHostEnterpriseTotalHostCountTop99pSum(Long csmHostEnterpriseTotalHostCountTop99pSum) {
    this.csmHostEnterpriseTotalHostCountTop99pSum = csmHostEnterpriseTotalHostCountTop99pSum;
  }
  public UsageSummaryResponse csmHostProOciHostCountTop99pSum(Long csmHostProOciHostCountTop99pSum) {
    this.csmHostProOciHostCountTop99pSum = csmHostProOciHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro OCI hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro Azure app services hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro AWS hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro Azure hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Cloud Security Management Pro containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of Cloud Security Management Pro containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro GCP hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Security Management Pro hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of distinct historical custom metrics over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of distinct live custom metrics over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of distinct custom metrics over all hours in the current month for all organizations.</p>
   * @return customTsSum
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Shows the average of all distinct Cloud Workload Security containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all distinct Cloud Workload Security Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Cloud Workload Security hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of Data Jobs Monitoring hosts over all hours in the current months for all organizations</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Database Monitoring hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all distinct Database Monitoring Normalized Queries over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the last date of usage in the current month for all organizations.</p>
   * @return endDate
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts with the Datadog Agent over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts on Alibaba over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts on AWS over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts on Azure over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts for Enterprise over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts on GCP over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts on Heroku over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts with only Azure App Services over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts with only vSphere over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse ephInfraHostOpentelemetryAggSum(Long ephInfraHostOpentelemetryAggSum) {
    this.ephInfraHostOpentelemetryAggSum = ephInfraHostOpentelemetryAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all ephemeral hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse ephInfraHostOpentelemetryApmAggSum(Long ephInfraHostOpentelemetryApmAggSum) {
    this.ephInfraHostOpentelemetryApmAggSum = ephInfraHostOpentelemetryApmAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all ephemeral APM hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts for Pro over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ephemeral infrastructure hosts for Pro Plus over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all ephemeral infrastructure hosts for Proxmox over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Error Tracking APM error events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Error Tracking error events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Error Tracking events over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse errorTrackingRumErrorEventsAggSum(Long errorTrackingRumErrorEventsAggSum) {
    this.errorTrackingRumErrorEventsAggSum = errorTrackingRumErrorEventsAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Error Tracking RUM error events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse eventManagementCorrelationAggSum(Long eventManagementCorrelationAggSum) {
    this.eventManagementCorrelationAggSum = eventManagementCorrelationAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Event Management correlations over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse eventManagementCorrelationCorrelatedEventsAggSum(Long eventManagementCorrelationCorrelatedEventsAggSum) {
    this.eventManagementCorrelationCorrelatedEventsAggSum = eventManagementCorrelationCorrelatedEventsAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Event Management correlated events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setEventManagementCorrelationCorrelatedEventsAggSum(Long eventManagementCorrelationCorrelatedEventsAggSum) {
    this.eventManagementCorrelationCorrelatedEventsAggSum = eventManagementCorrelationCorrelatedEventsAggSum;
  }
  public UsageSummaryResponse eventManagementCorrelationCorrelatedRelatedEventsAggSum(Long eventManagementCorrelationCorrelatedRelatedEventsAggSum) {
    this.eventManagementCorrelationCorrelatedRelatedEventsAggSum = eventManagementCorrelationCorrelatedRelatedEventsAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all Event Management correlated related events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setEventManagementCorrelationCorrelatedRelatedEventsAggSum(Long eventManagementCorrelationCorrelatedRelatedEventsAggSum) {
    this.eventManagementCorrelationCorrelatedRelatedEventsAggSum = eventManagementCorrelationCorrelatedRelatedEventsAggSum;
  }
  public UsageSummaryResponse fargateContainerProfilerProfilingFargateAvgSum(Long fargateContainerProfilerProfilingFargateAvgSum) {
    this.fargateContainerProfilerProfilingFargateAvgSum = fargateContainerProfilerProfilingFargateAvgSum;
    return this;
  }

  /**
   * <p>The average number of Profiling Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setFargateContainerProfilerProfilingFargateAvgSum(Long fargateContainerProfilerProfilingFargateAvgSum) {
    this.fargateContainerProfilerProfilingFargateAvgSum = fargateContainerProfilerProfilingFargateAvgSum;
  }
  public UsageSummaryResponse fargateContainerProfilerProfilingFargateEksAvgSum(Long fargateContainerProfilerProfilingFargateEksAvgSum) {
    this.fargateContainerProfilerProfilingFargateEksAvgSum = fargateContainerProfilerProfilingFargateEksAvgSum;
    return this;
  }

  /**
   * <p>The average number of Profiling Fargate Elastic Kubernetes Service tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setFargateContainerProfilerProfilingFargateEksAvgSum(Long fargateContainerProfilerProfilingFargateEksAvgSum) {
    this.fargateContainerProfilerProfilingFargateEksAvgSum = fargateContainerProfilerProfilingFargateEksAvgSum;
  }
  ...
  /**
   * <p>Shows the average of all Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of all Fargate tasks over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Compute Large Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Compute Medium Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Compute Small Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Compute Extra Large Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Compute Extra Small Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of Flex Logs Starter Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse flexLogsStarterStorageIndexAvgSum(Long flexLogsStarterStorageIndexAvgSum) {
    this.flexLogsStarterStorageIndexAvgSum = flexLogsStarterStorageIndexAvgSum;
    return this;
  }

  /**
   * <p>Shows the average number of Flex Logs Starter Storage Index Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse flexLogsStarterStorageRetentionAdjustmentAvgSum(Long flexLogsStarterStorageRetentionAdjustmentAvgSum) {
    this.flexLogsStarterStorageRetentionAdjustmentAvgSum = flexLogsStarterStorageRetentionAdjustmentAvgSum;
    return this;
  }

  /**
   * <p>Shows the average number of Flex Logs Starter Storage Retention Adjustment Instances over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  public void setFlexLogsStarterStorageRetentionAdjustmentAvgSum(Long flexLogsStarterStorageRetentionAdjustmentAvgSum) {
    this.flexLogsStarterStorageRetentionAdjustmentAvgSum = flexLogsStarterStorageRetentionAdjustmentAvgSum;
  }
  ...
  /**
   * <p>Shows the average of all Flex Stored Logs over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all logs forwarding bytes over all hours in the current month for all organizations (data available as of April 1, 2023)</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all GCP hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Heroku dynos over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows sum of the high-water marks of incident management monthly active users in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of Incident Management seats over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all log events indexed over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse infraEdgeMonitoringDevicesTop99pSum(Long infraEdgeMonitoringDevicesTop99pSum) {
    this.infraEdgeMonitoringDevicesTop99pSum = infraEdgeMonitoringDevicesTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Edge Devices Monitoring devices over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all distinct infrastructure hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all IoT devices over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all IoT devices over all hours in the current month of all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the most recent hour in the current month for all organizations for which all usages were calculated.</p>
   * @return lastUpdated
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Shows the sum of all live logs indexed over all hours in the current month for all organization (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all live logs bytes ingested over all hours in the current month for all organizations (data available as of December 1, 2020).</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all LLM observability sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Minimum spend for LLM observability sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile lite sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM sessions on Android over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM sessions on Flutter over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM sessions on iOS over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse mobileRumSessionCountReactnativeAggSum(Long mobileRumSessionCountReactnativeAggSum) {
    this.mobileRumSessionCountReactnativeAggSum = mobileRumSessionCountReactnativeAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM sessions on React Native over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  @Deprecated
  public void setMobileRumSessionCountReactnativeAggSum(Long mobileRumSessionCountReactnativeAggSum) {
    this.mobileRumSessionCountReactnativeAggSum = mobileRumSessionCountReactnativeAggSum;
  }
  public UsageSummaryResponse mobileRumSessionCountRokuAggSum(Long mobileRumSessionCountRokuAggSum) {
    this.mobileRumSessionCountRokuAggSum = mobileRumSessionCountRokuAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM sessions on Roku over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all mobile RUM units over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Network Device Monitoring NetFlow events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Network flows indexed over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all Network Device Monitoring wireless devices over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Network Path scheduled tests over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all distinct Cloud Network Monitoring hosts (formerly known as Network hosts) over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse observabilityPipelinesBytesProcessedAggSum(Long observabilityPipelinesBytesProcessedAggSum) {
    this.observabilityPipelinesBytesProcessedAggSum = observabilityPipelinesBytesProcessedAggSum;
    return this;
  }

  /**
   * <p>Sum of all observability pipelines bytes processed over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setObservabilityPipelinesBytesProcessedAggSum(Long observabilityPipelinesBytesProcessedAggSum) {
    this.observabilityPipelinesBytesProcessedAggSum = observabilityPipelinesBytesProcessedAggSum;
  }
  ...
  /**
   * <p>Shows the sum of Oracle Cloud Infrastructure hosts over all hours in the current months for all organizations</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of Oracle Cloud Infrastructure hosts over all hours in the current months for all organizations</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of On-Call seats over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all online archived events over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of APM hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all product analytics sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all profiled Azure app services over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average number of profiled containers over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the 99th percentile of all profiled hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all Proxmox hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of the 99th percentile of all Proxmox hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the high-water mark of all published applications over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all rehydrated logs indexed over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all rehydrated logs bytes ingested over all hours in the current month for all organizations (data available as of December 1, 2020).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumBrowserAndMobileSessionCount(Long rumBrowserAndMobileSessionCount) {
    this.rumBrowserAndMobileSessionCount = rumBrowserAndMobileSessionCount;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile sessions and all browser lite and legacy sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumBrowserLegacySessionCountAggSum(Long rumBrowserLegacySessionCountAggSum) {
    this.rumBrowserLegacySessionCountAggSum = rumBrowserLegacySessionCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all browser RUM legacy sessions over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumBrowserLiteSessionCountAggSum(Long rumBrowserLiteSessionCountAggSum) {
    this.rumBrowserLiteSessionCountAggSum = rumBrowserLiteSessionCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all browser RUM lite sessions over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumBrowserReplaySessionCountAggSum(Long rumBrowserReplaySessionCountAggSum) {
    this.rumBrowserReplaySessionCountAggSum = rumBrowserReplaySessionCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all browser RUM Session Replay counts over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all RUM indexed sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all RUM ingested sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all RUM lite sessions (browser and mobile) over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLegacySessionCountAndroidAggSum(Long rumMobileLegacySessionCountAndroidAggSum) {
    this.rumMobileLegacySessionCountAndroidAggSum = rumMobileLegacySessionCountAndroidAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM legacy sessions on Android over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public void setRumMobileLegacySessionCountAndroidAggSum(Long rumMobileLegacySessionCountAndroidAggSum) {
    this.rumMobileLegacySessionCountAndroidAggSum = rumMobileLegacySessionCountAndroidAggSum;
  }
  public UsageSummaryResponse rumMobileLegacySessionCountFlutterAggSum(Long rumMobileLegacySessionCountFlutterAggSum) {
    this.rumMobileLegacySessionCountFlutterAggSum = rumMobileLegacySessionCountFlutterAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM legacy sessions on Flutter over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLegacySessionCountIosAggSum(Long rumMobileLegacySessionCountIosAggSum) {
    this.rumMobileLegacySessionCountIosAggSum = rumMobileLegacySessionCountIosAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM legacy sessions on iOS over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLegacySessionCountReactnativeAggSum(Long rumMobileLegacySessionCountReactnativeAggSum) {
    this.rumMobileLegacySessionCountReactnativeAggSum = rumMobileLegacySessionCountReactnativeAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM legacy sessions on React Native over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public void setRumMobileLegacySessionCountReactnativeAggSum(Long rumMobileLegacySessionCountReactnativeAggSum) {
    this.rumMobileLegacySessionCountReactnativeAggSum = rumMobileLegacySessionCountReactnativeAggSum;
  }
  public UsageSummaryResponse rumMobileLegacySessionCountRokuAggSum(Long rumMobileLegacySessionCountRokuAggSum) {
    this.rumMobileLegacySessionCountRokuAggSum = rumMobileLegacySessionCountRokuAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM legacy sessions on Roku over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLiteSessionCountAndroidAggSum(Long rumMobileLiteSessionCountAndroidAggSum) {
    this.rumMobileLiteSessionCountAndroidAggSum = rumMobileLiteSessionCountAndroidAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on Android over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLiteSessionCountFlutterAggSum(Long rumMobileLiteSessionCountFlutterAggSum) {
    this.rumMobileLiteSessionCountFlutterAggSum = rumMobileLiteSessionCountFlutterAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on Flutter over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public void setRumMobileLiteSessionCountFlutterAggSum(Long rumMobileLiteSessionCountFlutterAggSum) {
    this.rumMobileLiteSessionCountFlutterAggSum = rumMobileLiteSessionCountFlutterAggSum;
  }
  public UsageSummaryResponse rumMobileLiteSessionCountIosAggSum(Long rumMobileLiteSessionCountIosAggSum) {
    this.rumMobileLiteSessionCountIosAggSum = rumMobileLiteSessionCountIosAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on iOS over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLiteSessionCountKotlinmultiplatformAggSum(Long rumMobileLiteSessionCountKotlinmultiplatformAggSum) {
    this.rumMobileLiteSessionCountKotlinmultiplatformAggSum = rumMobileLiteSessionCountKotlinmultiplatformAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on Kotlin Multiplatform over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public void setRumMobileLiteSessionCountKotlinmultiplatformAggSum(Long rumMobileLiteSessionCountKotlinmultiplatformAggSum) {
    this.rumMobileLiteSessionCountKotlinmultiplatformAggSum = rumMobileLiteSessionCountKotlinmultiplatformAggSum;
  }
  ...
  /**
   * <p>Shows the sum of all mobile RUM lite sessions on React Native over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public void setRumMobileLiteSessionCountReactnativeAggSum(Long rumMobileLiteSessionCountReactnativeAggSum) {
    this.rumMobileLiteSessionCountReactnativeAggSum = rumMobileLiteSessionCountReactnativeAggSum;
  }
  public UsageSummaryResponse rumMobileLiteSessionCountRokuAggSum(Long rumMobileLiteSessionCountRokuAggSum) {
    this.rumMobileLiteSessionCountRokuAggSum = rumMobileLiteSessionCountRokuAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on Roku over all hours within the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileLiteSessionCountUnityAggSum(Long rumMobileLiteSessionCountUnityAggSum) {
    this.rumMobileLiteSessionCountUnityAggSum = rumMobileLiteSessionCountUnityAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM lite sessions on Unity over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileReplaySessionCountAndroidAggSum(Long rumMobileReplaySessionCountAndroidAggSum) {
    this.rumMobileReplaySessionCountAndroidAggSum = rumMobileReplaySessionCountAndroidAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM replay sessions on Android over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public void setRumMobileReplaySessionCountAndroidAggSum(Long rumMobileReplaySessionCountAndroidAggSum) {
    this.rumMobileReplaySessionCountAndroidAggSum = rumMobileReplaySessionCountAndroidAggSum;
  }
  public UsageSummaryResponse rumMobileReplaySessionCountIosAggSum(Long rumMobileReplaySessionCountIosAggSum) {
    this.rumMobileReplaySessionCountIosAggSum = rumMobileReplaySessionCountIosAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM replay sessions on iOS over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse rumMobileReplaySessionCountKotlinmultiplatformAggSum(Long rumMobileReplaySessionCountKotlinmultiplatformAggSum) {
    this.rumMobileReplaySessionCountKotlinmultiplatformAggSum = rumMobileReplaySessionCountKotlinmultiplatformAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM replay sessions on Kotlin Multiplatform over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public void setRumMobileReplaySessionCountKotlinmultiplatformAggSum(Long rumMobileReplaySessionCountKotlinmultiplatformAggSum) {
    this.rumMobileReplaySessionCountKotlinmultiplatformAggSum = rumMobileReplaySessionCountKotlinmultiplatformAggSum;
  }
  public UsageSummaryResponse rumMobileReplaySessionCountReactnativeAggSum(Long rumMobileReplaySessionCountReactnativeAggSum) {
    this.rumMobileReplaySessionCountReactnativeAggSum = rumMobileReplaySessionCountReactnativeAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all mobile RUM replay sessions on React Native over all hours within the current month for all organizations.</p>
  ...
  **/
  ...
  public void setRumMobileReplaySessionCountReactnativeAggSum(Long rumMobileReplaySessionCountReactnativeAggSum) {
    this.rumMobileReplaySessionCountReactnativeAggSum = rumMobileReplaySessionCountReactnativeAggSum;
  }
  ...
  /**
   * <p>Shows the sum of all RUM Session Replay counts over all hours in the current month for all organizations (To be introduced on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser RUM lite sessions over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all RUM session replay add-on sessions for all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of RUM sessions (browser and mobile) over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all browser and mobile RUM units over all hours in the current month for all organizations (To be deprecated on October 1st, 2024).</p>
  ...
  **/
  ...
  /**
   * <p>Shows the average of all Software Composition Analysis Fargate tasks over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of the high-water marks of all Software Composition Analysis Fargate tasks over all hours in the current months for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all APM bytes scanned with sensitive data scanner in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all event stream events bytes scanned with sensitive data scanner in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all RUM bytes scanned with sensitive data scanner in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsApmApmAzureAppserviceInstancesAvgSum(Long serverlessAppsApmApmAzureAppserviceInstancesAvgSum) {
    this.serverlessAppsApmApmAzureAppserviceInstancesAvgSum = serverlessAppsApmApmAzureAppserviceInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Azure App Service instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmAzureAppserviceInstancesAvgSum(Long serverlessAppsApmApmAzureAppserviceInstancesAvgSum) {
    this.serverlessAppsApmApmAzureAppserviceInstancesAvgSum = serverlessAppsApmApmAzureAppserviceInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum(Long serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum) {
    this.serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum = serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Azure Function instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmAzureAzurefunctionInstancesAvgSum(Long serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum) {
    this.serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum = serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmApmAzureContainerappInstancesAvgSum(Long serverlessAppsApmApmAzureContainerappInstancesAvgSum) {
    this.serverlessAppsApmApmAzureContainerappInstancesAvgSum = serverlessAppsApmApmAzureContainerappInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Azure Container App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmAzureContainerappInstancesAvgSum(Long serverlessAppsApmApmAzureContainerappInstancesAvgSum) {
    this.serverlessAppsApmApmAzureContainerappInstancesAvgSum = serverlessAppsApmApmAzureContainerappInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmApmFargateEcsTasksAvgSum(Long serverlessAppsApmApmFargateEcsTasksAvgSum) {
    this.serverlessAppsApmApmFargateEcsTasksAvgSum = serverlessAppsApmApmFargateEcsTasksAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Fargate Elastic Container Service tasks in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmFargateEcsTasksAvgSum(Long serverlessAppsApmApmFargateEcsTasksAvgSum) {
    this.serverlessAppsApmApmFargateEcsTasksAvgSum = serverlessAppsApmApmFargateEcsTasksAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum(Long serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum) {
    this.serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum = serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Google Cloud Platform Cloud Function instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmGcpCloudfunctionInstancesAvgSum(Long serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum) {
    this.serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum = serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmApmGcpCloudrunInstancesAvgSum(Long serverlessAppsApmApmGcpCloudrunInstancesAvgSum) {
    this.serverlessAppsApmApmGcpCloudrunInstancesAvgSum = serverlessAppsApmApmGcpCloudrunInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring for Google Cloud Platform Cloud Run instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmApmGcpCloudrunInstancesAvgSum(Long serverlessAppsApmApmGcpCloudrunInstancesAvgSum) {
    this.serverlessAppsApmApmGcpCloudrunInstancesAvgSum = serverlessAppsApmApmGcpCloudrunInstancesAvgSum;
  }
  ...
  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum = serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate for Azure App Service instances in the current month for all organizations.</p>
   * @return serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_APPSERVICE_INSTANCES_AVG_SUM)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public Long getServerlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum() {
        return serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum;
      }
  public void setServerlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum = serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum = serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate for Azure Function instances in the current month for all organizations.</p>
   * @return serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_AZUREFUNCTION_INSTANCES_AVG_SUM)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public Long getServerlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum() {
        return serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum;
      }
  public void setServerlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum = serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum = serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate for Azure Container App instances in the current month for all organizations.</p>
   * @return serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_AZURE_CONTAINERAPP_INSTANCES_AVG_SUM)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public Long getServerlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum() {
        return serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum;
      }
  public void setServerlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum(Long serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum = serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum(Long serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum = serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate for Google Cloud Platform Cloud Function instances in the current month for all organizations.</p>
   * @return serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_SERVERLESS_APPS_APM_EXCL_FARGATE_APM_GCP_CLOUDFUNCTION_INSTANCES_AVG_SUM)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public Long getServerlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum() {
        return serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum;
      }
  public void setServerlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum(Long serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum = serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum(Long serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum = serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate for Google Cloud Platform Cloud Run instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum(Long serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum) {
    this.serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum = serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsApmExclFargateAvgSum(Long serverlessAppsApmExclFargateAvgSum) {
    this.serverlessAppsApmExclFargateAvgSum = serverlessAppsApmExclFargateAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps with Application Performance Monitoring excluding Fargate in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsAzureContainerAppInstancesAvgSum(Long serverlessAppsAzureContainerAppInstancesAvgSum) {
    this.serverlessAppsAzureContainerAppInstancesAvgSum = serverlessAppsAzureContainerAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Azure Container App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsAzureContainerAppInstancesAvgSum(Long serverlessAppsAzureContainerAppInstancesAvgSum) {
    this.serverlessAppsAzureContainerAppInstancesAvgSum = serverlessAppsAzureContainerAppInstancesAvgSum;
  }
  ...
  /**
   * <p>Sum of the average number of Serverless Apps for Azure in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsAzureFunctionAppInstancesAvgSum(Long serverlessAppsAzureFunctionAppInstancesAvgSum) {
    this.serverlessAppsAzureFunctionAppInstancesAvgSum = serverlessAppsAzureFunctionAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Azure Function App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsAzureFunctionAppInstancesAvgSum(Long serverlessAppsAzureFunctionAppInstancesAvgSum) {
    this.serverlessAppsAzureFunctionAppInstancesAvgSum = serverlessAppsAzureFunctionAppInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsAzureWebAppInstancesAvgSum(Long serverlessAppsAzureWebAppInstancesAvgSum) {
    this.serverlessAppsAzureWebAppInstancesAvgSum = serverlessAppsAzureWebAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Azure Web App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsAzureWebAppInstancesAvgSum(Long serverlessAppsAzureWebAppInstancesAvgSum) {
    this.serverlessAppsAzureWebAppInstancesAvgSum = serverlessAppsAzureWebAppInstancesAvgSum;
  }
  ...
  /**
   * <p>Sum of the average number of Serverless Apps for Elastic Container Service in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of the average number of Serverless Apps for Elastic Kubernetes Service in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsExclFargateAvgSum(Long serverlessAppsExclFargateAvgSum) {
    this.serverlessAppsExclFargateAvgSum = serverlessAppsExclFargateAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse serverlessAppsExclFargateAzureContainerAppInstancesAvgSum(Long serverlessAppsExclFargateAzureContainerAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureContainerAppInstancesAvgSum = serverlessAppsExclFargateAzureContainerAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate for Azure Container App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsExclFargateAzureContainerAppInstancesAvgSum(Long serverlessAppsExclFargateAzureContainerAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureContainerAppInstancesAvgSum = serverlessAppsExclFargateAzureContainerAppInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum(Long serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum = serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate for Azure Function App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsExclFargateAzureFunctionAppInstancesAvgSum(Long serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum = serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsExclFargateAzureWebAppInstancesAvgSum(Long serverlessAppsExclFargateAzureWebAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureWebAppInstancesAvgSum = serverlessAppsExclFargateAzureWebAppInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate for Azure Web App instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsExclFargateAzureWebAppInstancesAvgSum(Long serverlessAppsExclFargateAzureWebAppInstancesAvgSum) {
    this.serverlessAppsExclFargateAzureWebAppInstancesAvgSum = serverlessAppsExclFargateAzureWebAppInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum(Long serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum) {
    this.serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum = serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate for Google Cloud Platform Cloud Functions instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum(Long serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum) {
    this.serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum = serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum(Long serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum) {
    this.serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum = serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps excluding Fargate for Google Cloud Platform Cloud Run instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsExclFargateGoogleCloudRunInstancesAvgSum(Long serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum) {
    this.serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum = serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsGoogleCloudFunctionsInstancesAvgSum(Long serverlessAppsGoogleCloudFunctionsInstancesAvgSum) {
    this.serverlessAppsGoogleCloudFunctionsInstancesAvgSum = serverlessAppsGoogleCloudFunctionsInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Google Cloud Platform Cloud Functions instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsGoogleCloudFunctionsInstancesAvgSum(Long serverlessAppsGoogleCloudFunctionsInstancesAvgSum) {
    this.serverlessAppsGoogleCloudFunctionsInstancesAvgSum = serverlessAppsGoogleCloudFunctionsInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsGoogleCloudRunInstancesAvgSum(Long serverlessAppsGoogleCloudRunInstancesAvgSum) {
    this.serverlessAppsGoogleCloudRunInstancesAvgSum = serverlessAppsGoogleCloudRunInstancesAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Google Cloud Platform Cloud Run instances in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setServerlessAppsGoogleCloudRunInstancesAvgSum(Long serverlessAppsGoogleCloudRunInstancesAvgSum) {
    this.serverlessAppsGoogleCloudRunInstancesAvgSum = serverlessAppsGoogleCloudRunInstancesAvgSum;
  }
  public UsageSummaryResponse serverlessAppsGoogleCountAvgSum(Long serverlessAppsGoogleCountAvgSum) {
    this.serverlessAppsGoogleCountAvgSum = serverlessAppsGoogleCountAvgSum;
    return this;
  }

  /**
   * <p>Sum of the average number of Serverless Apps for Google Cloud in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of the average number of Serverless Apps for Azure and Google Cloud in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse siemAnalyzedLogsAddOnCountAggSum(Long siemAnalyzedLogsAddOnCountAggSum) {
    this.siemAnalyzedLogsAddOnCountAggSum = siemAnalyzedLogsAddOnCountAggSum;
    return this;
  }

  /**
   * <p>Shows the sum of all log events analyzed by Cloud SIEM over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the first date of usage in the current month for all organizations.</p>
   * @return startDate
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Shows the sum of all Synthetic browser tests over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all Synthetic API tests over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of Synthetic mobile application tests over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse syntheticsParallelTestingMaxSlotsHwmSum(Long syntheticsParallelTestingMaxSlotsHwmSum) {
    this.syntheticsParallelTestingMaxSlotsHwmSum = syntheticsParallelTestingMaxSlotsHwmSum;
    return this;
  }

  /**
   * <p>Shows the sum of the high-water marks of used synthetics parallel testing slots over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setSyntheticsParallelTestingMaxSlotsHwmSum(Long syntheticsParallelTestingMaxSlotsHwmSum) {
    this.syntheticsParallelTestingMaxSlotsHwmSum = syntheticsParallelTestingMaxSlotsHwmSum;
  }
  ...
  /**
   * <p>Shows the sum of all Indexed Spans indexed over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Shows the sum of all ingested APM span bytes over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse universalServiceMonitoringHostTop99pSum(Long universalServiceMonitoringHostTop99pSum) {
    this.universalServiceMonitoringHostTop99pSum = universalServiceMonitoringHostTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Universal Service Monitoring hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public void setUniversalServiceMonitoringHostTop99pSum(Long universalServiceMonitoringHostTop99pSum) {
    this.universalServiceMonitoringHostTop99pSum = universalServiceMonitoringHostTop99pSum;
  }
  ...
  /**
   * <p>An array of objects regarding hourly usage.</p>
   * @return usage
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Shows the 99th percentile of all vSphere hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public UsageSummaryResponse vulnManagementHostCountTop99pSum(Long vulnManagementHostCountTop99pSum) {
    this.vulnManagementHostCountTop99pSum = vulnManagementHostCountTop99pSum;
    return this;
  }

  /**
   * <p>Shows the 99th percentile of all Application Vulnerability Management hosts over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  /**
   * <p>Sum of all workflows executed over all hours in the current month for all organizations.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentHostTop99pSum, usageSummaryResponse.agentHostTop99pSum) && Objects.equals(this.apmAzureAppServiceHostTop99pSum, usageSummaryResponse.apmAzureAppServiceHostTop99pSum) && Objects.equals(this.apmDevsecopsHostTop99pSum, usageSummaryResponse.apmDevsecopsHostTop99pSum) && Objects.equals(this.apmEnterpriseStandaloneHostsTop99pSum, usageSummaryResponse.apmEnterpriseStandaloneHostsTop99pSum) && Objects.equals(this.apmFargateCountAvgSum, usageSummaryResponse.apmFargateCountAvgSum) && Objects.equals(this.apmHostTop99pSum, usageSummaryResponse.apmHostTop99pSum) && Objects.equals(this.apmProStandaloneHostsTop99pSum, usageSummaryResponse.apmProStandaloneHostsTop99pSum) && Objects.equals(this.appsecFargateCountAvgSum, usageSummaryResponse.appsecFargateCountAvgSum) && Objects.equals(this.asmServerlessAggSum, usageSummaryResponse.asmServerlessAggSum) && Objects.equals(this.auditLogsLinesIndexedAggSum, usageSummaryResponse.auditLogsLinesIndexedAggSum) && Objects.equals(this.auditTrailEnabledHwmSum, usageSummaryResponse.auditTrailEnabledHwmSum) && Objects.equals(this.avgProfiledFargateTasksSum, usageSummaryResponse.avgProfiledFargateTasksSum) && Objects.equals(this.awsHostTop99pSum, usageSummaryResponse.awsHostTop99pSum) && Objects.equals(this.awsLambdaFuncCount, usageSummaryResponse.awsLambdaFuncCount) && Objects.equals(this.awsLambdaInvocationsSum, usageSummaryResponse.awsLambdaInvocationsSum) && Objects.equals(this.azureAppServiceTop99pSum, usageSummaryResponse.azureAppServiceTop99pSum) && Objects.equals(this.azureHostTop99pSum, usageSummaryResponse.azureHostTop99pSum) && Objects.equals(this.billableIngestedBytesAggSum, usageSummaryResponse.billableIngestedBytesAggSum) && Objects.equals(this.bitsAiInvestigationsAggSum, usageSummaryResponse.bitsAiInvestigationsAggSum) && Objects.equals(this.browserRumLiteSessionCountAggSum, usageSummaryResponse.browserRumLiteSessionCountAggSum) && Objects.equals(this.browserRumReplaySessionCountAggSum, usageSummaryResponse.browserRumReplaySessionCountAggSum) && Objects.equals(this.browserRumUnitsAggSum, usageSummaryResponse.browserRumUnitsAggSum) && Objects.equals(this.ccmSpendMonitoredEntLastSum, usageSummaryResponse.ccmSpendMonitoredEntLastSum) && Objects.equals(this.ccmSpendMonitoredProLastSum, usageSummaryResponse.ccmSpendMonitoredProLastSum) && Objects.equals(this.ciPipelineIndexedSpansAggSum, usageSummaryResponse.ciPipelineIndexedSpansAggSum) && Objects.equals(this.ciTestIndexedSpansAggSum, usageSummaryResponse.ciTestIndexedSpansAggSum) && Objects.equals(this.ciVisibilityItrCommittersHwmSum, usageSummaryResponse.ciVisibilityItrCommittersHwmSum) && Objects.equals(this.ciVisibilityPipelineCommittersHwmSum, usageSummaryResponse.ciVisibilityPipelineCommittersHwmSum) && Objects.equals(this.ciVisibilityTestCommittersHwmSum, usageSummaryResponse.ciVisibilityTestCommittersHwmSum) && Objects.equals(this.cloudCostManagementAwsHostCountAvgSum, usageSummaryResponse.cloudCostManagementAwsHostCountAvgSum) && Objects.equals(this.cloudCostManagementAzureHostCountAvgSum, usageSummaryResponse.cloudCostManagementAzureHostCountAvgSum) && Objects.equals(this.cloudCostManagementGcpHostCountAvgSum, usageSummaryResponse.cloudCostManagementGcpHostCountAvgSum) && Objects.equals(this.cloudCostManagementHostCountAvgSum, usageSummaryResponse.cloudCostManagementHostCountAvgSum) && Objects.equals(this.cloudCostManagementOciHostCountAvgSum, usageSummaryResponse.cloudCostManagementOciHostCountAvgSum) && Objects.equals(this.cloudSiemEventsAggSum, usageSummaryResponse.cloudSiemEventsAggSum) && Objects.equals(this.codeAnalysisSaCommittersHwmSum, usageSummaryResponse.codeAnalysisSaCommittersHwmSum) && Objects.equals(this.codeAnalysisScaCommittersHwmSum, usageSummaryResponse.codeAnalysisScaCommittersHwmSum) && Objects.equals(this.codeSecurityHostTop99pSum, usageSummaryResponse.codeSecurityHostTop99pSum) && Objects.equals(this.containerAvgSum, usageSummaryResponse.containerAvgSum) && Objects.equals(this.containerExclAgentAvgSum, usageSummaryResponse.containerExclAgentAvgSum) && Objects.equals(this.containerHwmSum, usageSummaryResponse.containerHwmSum) && Objects.equals(this.csmContainerEnterpriseComplianceCountAggSum, usageSummaryResponse.csmContainerEnterpriseComplianceCountAggSum) && Objects.equals(this.csmContainerEnterpriseCwsCountAggSum, usageSummaryResponse.csmContainerEnterpriseCwsCountAggSum) && Objects.equals(this.csmContainerEnterpriseTotalCountAggSum, usageSummaryResponse.csmContainerEnterpriseTotalCountAggSum) && Objects.equals(this.csmHostEnterpriseAasHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseAasHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseAwsHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseAwsHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseAzureHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseAzureHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseComplianceHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseComplianceHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseCwsHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseCwsHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseGcpHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseGcpHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseOciHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseOciHostCountTop99pSum) && Objects.equals(this.csmHostEnterpriseTotalHostCountTop99pSum, usageSummaryResponse.csmHostEnterpriseTotalHostCountTop99pSum) && Objects.equals(this.csmHostProOciHostCountTop99pSum, usageSummaryResponse.csmHostProOciHostCountTop99pSum) && Objects.equals(this.cspmAasHostTop99pSum, usageSummaryResponse.cspmAasHostTop99pSum) && Objects.equals(this.cspmAwsHostTop99pSum, usageSummaryResponse.cspmAwsHostTop99pSum) && Objects.equals(this.cspmAzureHostTop99pSum, usageSummaryResponse.cspmAzureHostTop99pSum) && Objects.equals(this.cspmContainerAvgSum, usageSummaryResponse.cspmContainerAvgSum) && Objects.equals(this.cspmContainerHwmSum, usageSummaryResponse.cspmContainerHwmSum) && Objects.equals(this.cspmGcpHostTop99pSum, usageSummaryResponse.cspmGcpHostTop99pSum) && Objects.equals(this.cspmHostTop99pSum, usageSummaryResponse.cspmHostTop99pSum) && Objects.equals(this.customHistoricalTsSum, usageSummaryResponse.customHistoricalTsSum) && Objects.equals(this.customLiveTsSum, usageSummaryResponse.customLiveTsSum) && Objects.equals(this.customTsSum, usageSummaryResponse.customTsSum) && Objects.equals(this.cwsContainerAvgSum, usageSummaryResponse.cwsContainerAvgSum) && Objects.equals(this.cwsFargateTaskAvgSum, usageSummaryResponse.cwsFargateTaskAvgSum) && Objects.equals(this.cwsHostTop99pSum, usageSummaryResponse.cwsHostTop99pSum) && Objects.equals(this.dataJobsMonitoringHostHrAggSum, usageSummaryResponse.dataJobsMonitoringHostHrAggSum) && Objects.equals(this.dbmHostTop99pSum, usageSummaryResponse.dbmHostTop99pSum) && Objects.equals(this.dbmQueriesAvgSum, usageSummaryResponse.dbmQueriesAvgSum) && Objects.equals(this.endDate, usageSummaryResponse.endDate) && Objects.equals(this.ephInfraHostAgentAggSum, usageSummaryResponse.ephInfraHostAgentAggSum) && Objects.equals(this.ephInfraHostAlibabaAggSum, usageSummaryResponse.ephInfraHostAlibabaAggSum) && Objects.equals(this.ephInfraHostAwsAggSum, usageSummaryResponse.ephInfraHostAwsAggSum) && Objects.equals(this.ephInfraHostAzureAggSum, usageSummaryResponse.ephInfraHostAzureAggSum) && Objects.equals(this.ephInfraHostEntAggSum, usageSummaryResponse.ephInfraHostEntAggSum) && Objects.equals(this.ephInfraHostGcpAggSum, usageSummaryResponse.ephInfraHostGcpAggSum) && Objects.equals(this.ephInfraHostHerokuAggSum, usageSummaryResponse.ephInfraHostHerokuAggSum) && Objects.equals(this.ephInfraHostOnlyAasAggSum, usageSummaryResponse.ephInfraHostOnlyAasAggSum) && Objects.equals(this.ephInfraHostOnlyVsphereAggSum, usageSummaryResponse.ephInfraHostOnlyVsphereAggSum) && Objects.equals(this.ephInfraHostOpentelemetryAggSum, usageSummaryResponse.ephInfraHostOpentelemetryAggSum) && Objects.equals(this.ephInfraHostOpentelemetryApmAggSum, usageSummaryResponse.ephInfraHostOpentelemetryApmAggSum) && Objects.equals(this.ephInfraHostProAggSum, usageSummaryResponse.ephInfraHostProAggSum) && Objects.equals(this.ephInfraHostProplusAggSum, usageSummaryResponse.ephInfraHostProplusAggSum) && Objects.equals(this.ephInfraHostProxmoxAggSum, usageSummaryResponse.ephInfraHostProxmoxAggSum) && Objects.equals(this.errorTrackingApmErrorEventsAggSum, usageSummaryResponse.errorTrackingApmErrorEventsAggSum) && Objects.equals(this.errorTrackingErrorEventsAggSum, usageSummaryResponse.errorTrackingErrorEventsAggSum) && Objects.equals(this.errorTrackingEventsAggSum, usageSummaryResponse.errorTrackingEventsAggSum) && Objects.equals(this.errorTrackingRumErrorEventsAggSum, usageSummaryResponse.errorTrackingRumErrorEventsAggSum) && Objects.equals(this.eventManagementCorrelationAggSum, usageSummaryResponse.eventManagementCorrelationAggSum) && Objects.equals(this.eventManagementCorrelationCorrelatedEventsAggSum, usageSummaryResponse.eventManagementCorrelationCorrelatedEventsAggSum) && Objects.equals(this.eventManagementCorrelationCorrelatedRelatedEventsAggSum, usageSummaryResponse.eventManagementCorrelationCorrelatedRelatedEventsAggSum) && Objects.equals(this.fargateContainerProfilerProfilingFargateAvgSum, usageSummaryResponse.fargateContainerProfilerProfilingFargateAvgSum) && Objects.equals(this.fargateContainerProfilerProfilingFargateEksAvgSum, usageSummaryResponse.fargateContainerProfilerProfilingFargateEksAvgSum) && Objects.equals(this.fargateTasksCountAvgSum, usageSummaryResponse.fargateTasksCountAvgSum) && Objects.equals(this.fargateTasksCountHwmSum, usageSummaryResponse.fargateTasksCountHwmSum) && Objects.equals(this.flexLogsComputeLargeAvgSum, usageSummaryResponse.flexLogsComputeLargeAvgSum) && Objects.equals(this.flexLogsComputeMediumAvgSum, usageSummaryResponse.flexLogsComputeMediumAvgSum) && Objects.equals(this.flexLogsComputeSmallAvgSum, usageSummaryResponse.flexLogsComputeSmallAvgSum) && Objects.equals(this.flexLogsComputeXlargeAvgSum, usageSummaryResponse.flexLogsComputeXlargeAvgSum) && Objects.equals(this.flexLogsComputeXsmallAvgSum, usageSummaryResponse.flexLogsComputeXsmallAvgSum) && Objects.equals(this.flexLogsStarterAvgSum, usageSummaryResponse.flexLogsStarterAvgSum) && Objects.equals(this.flexLogsStarterStorageIndexAvgSum, usageSummaryResponse.flexLogsStarterStorageIndexAvgSum) && Objects.equals(this.flexLogsStarterStorageRetentionAdjustmentAvgSum, usageSummaryResponse.flexLogsStarterStorageRetentionAdjustmentAvgSum) && Objects.equals(this.flexStoredLogsAvgSum, usageSummaryResponse.flexStoredLogsAvgSum) && Objects.equals(this.forwardingEventsBytesAggSum, usageSummaryResponse.forwardingEventsBytesAggSum) && Objects.equals(this.gcpHostTop99pSum, usageSummaryResponse.gcpHostTop99pSum) && Objects.equals(this.herokuHostTop99pSum, usageSummaryResponse.herokuHostTop99pSum) && Objects.equals(this.incidentManagementMonthlyActiveUsersHwmSum, usageSummaryResponse.incidentManagementMonthlyActiveUsersHwmSum) && Objects.equals(this.incidentManagementSeatsHwmSum, usageSummaryResponse.incidentManagementSeatsHwmSum) && Objects.equals(this.indexedEventsCountAggSum, usageSummaryResponse.indexedEventsCountAggSum) && Objects.equals(this.infraEdgeMonitoringDevicesTop99pSum, usageSummaryResponse.infraEdgeMonitoringDevicesTop99pSum) && Objects.equals(this.infraHostTop99pSum, usageSummaryResponse.infraHostTop99pSum) && Objects.equals(this.ingestedEventsBytesAggSum, usageSummaryResponse.ingestedEventsBytesAggSum) && Objects.equals(this.iotDeviceAggSum, usageSummaryResponse.iotDeviceAggSum) && Objects.equals(this.iotDeviceTop99pSum, usageSummaryResponse.iotDeviceTop99pSum) && Objects.equals(this.lastUpdated, usageSummaryResponse.lastUpdated) && Objects.equals(this.liveIndexedEventsAggSum, usageSummaryResponse.liveIndexedEventsAggSum) && Objects.equals(this.liveIngestedBytesAggSum, usageSummaryResponse.liveIngestedBytesAggSum) && Objects.equals(this.llmObservabilityAggSum, usageSummaryResponse.llmObservabilityAggSum) && Objects.equals(this.llmObservabilityMinSpendAggSum, usageSummaryResponse.llmObservabilityMinSpendAggSum) && Objects.equals(this.logsByRetention, usageSummaryResponse.logsByRetention) && Objects.equals(this.mobileRumLiteSessionCountAggSum, usageSummaryResponse.mobileRumLiteSessionCountAggSum) && Objects.equals(this.mobileRumSessionCountAggSum, usageSummaryResponse.mobileRumSessionCountAggSum) && Objects.equals(this.mobileRumSessionCountAndroidAggSum, usageSummaryResponse.mobileRumSessionCountAndroidAggSum) && Objects.equals(this.mobileRumSessionCountFlutterAggSum, usageSummaryResponse.mobileRumSessionCountFlutterAggSum) && Objects.equals(this.mobileRumSessionCountIosAggSum, usageSummaryResponse.mobileRumSessionCountIosAggSum) && Objects.equals(this.mobileRumSessionCountReactnativeAggSum, usageSummaryResponse.mobileRumSessionCountReactnativeAggSum) && Objects.equals(this.mobileRumSessionCountRokuAggSum, usageSummaryResponse.mobileRumSessionCountRokuAggSum) && Objects.equals(this.mobileRumUnitsAggSum, usageSummaryResponse.mobileRumUnitsAggSum) && Objects.equals(this.ndmNetflowEventsAggSum, usageSummaryResponse.ndmNetflowEventsAggSum) && Objects.equals(this.netflowIndexedEventsCountAggSum, usageSummaryResponse.netflowIndexedEventsCountAggSum) && Objects.equals(this.networkDeviceWirelessTop99pSum, usageSummaryResponse.networkDeviceWirelessTop99pSum) && Objects.equals(this.networkPathAggSum, usageSummaryResponse.networkPathAggSum) && Objects.equals(this.npmHostTop99pSum, usageSummaryResponse.npmHostTop99pSum) && Objects.equals(this.observabilityPipelinesBytesProcessedAggSum, usageSummaryResponse.observabilityPipelinesBytesProcessedAggSum) && Objects.equals(this.ociHostAggSum, usageSummaryResponse.ociHostAggSum) && Objects.equals(this.ociHostTop99pSum, usageSummaryResponse.ociHostTop99pSum) && Objects.equals(this.onCallSeatHwmSum, usageSummaryResponse.onCallSeatHwmSum) && Objects.equals(this.onlineArchiveEventsCountAggSum, usageSummaryResponse.onlineArchiveEventsCountAggSum) && Objects.equals(this.opentelemetryApmHostTop99pSum, usageSummaryResponse.opentelemetryApmHostTop99pSum) && Objects.equals(this.opentelemetryHostTop99pSum, usageSummaryResponse.opentelemetryHostTop99pSum) && Objects.equals(this.productAnalyticsAggSum, usageSummaryResponse.productAnalyticsAggSum) && Objects.equals(this.profilingAasCountTop99pSum, usageSummaryResponse.profilingAasCountTop99pSum) && Objects.equals(this.profilingContainerAgentCountAvg, usageSummaryResponse.profilingContainerAgentCountAvg) && Objects.equals(this.profilingHostCountTop99pSum, usageSummaryResponse.profilingHostCountTop99pSum) && Objects.equals(this.proxmoxHostAggSum, usageSummaryResponse.proxmoxHostAggSum) && Objects.equals(this.proxmoxHostTop99pSum, usageSummaryResponse.proxmoxHostTop99pSum) && Objects.equals(this.publishedAppHwmSum, usageSummaryResponse.publishedAppHwmSum) && Objects.equals(this.rehydratedIndexedEventsAggSum, usageSummaryResponse.rehydratedIndexedEventsAggSum) && Objects.equals(this.rehydratedIngestedBytesAggSum, usageSummaryResponse.rehydratedIngestedBytesAggSum) && Objects.equals(this.rumBrowserAndMobileSessionCount, usageSummaryResponse.rumBrowserAndMobileSessionCount) && Objects.equals(this.rumBrowserLegacySessionCountAggSum, usageSummaryResponse.rumBrowserLegacySessionCountAggSum) && Objects.equals(this.rumBrowserLiteSessionCountAggSum, usageSummaryResponse.rumBrowserLiteSessionCountAggSum) && Objects.equals(this.rumBrowserReplaySessionCountAggSum, usageSummaryResponse.rumBrowserReplaySessionCountAggSum) && Objects.equals(this.rumIndexedSessionsAggSum, usageSummaryResponse.rumIndexedSessionsAggSum) && Objects.equals(this.rumIngestedSessionsAggSum, usageSummaryResponse.rumIngestedSessionsAggSum) && Objects.equals(this.rumLiteSessionCountAggSum, usageSummaryResponse.rumLiteSessionCountAggSum) && Objects.equals(this.rumMobileLegacySessionCountAndroidAggSum, usageSummaryResponse.rumMobileLegacySessionCountAndroidAggSum) && Objects.equals(this.rumMobileLegacySessionCountFlutterAggSum, usageSummaryResponse.rumMobileLegacySessionCountFlutterAggSum) && Objects.equals(this.rumMobileLegacySessionCountIosAggSum, usageSummaryResponse.rumMobileLegacySessionCountIosAggSum) && Objects.equals(this.rumMobileLegacySessionCountReactnativeAggSum, usageSummaryResponse.rumMobileLegacySessionCountReactnativeAggSum) && Objects.equals(this.rumMobileLegacySessionCountRokuAggSum, usageSummaryResponse.rumMobileLegacySessionCountRokuAggSum) && Objects.equals(this.rumMobileLiteSessionCountAndroidAggSum, usageSummaryResponse.rumMobileLiteSessionCountAndroidAggSum) && Objects.equals(this.rumMobileLiteSessionCountFlutterAggSum, usageSummaryResponse.rumMobileLiteSessionCountFlutterAggSum) && Objects.equals(this.rumMobileLiteSessionCountIosAggSum, usageSummaryResponse.rumMobileLiteSessionCountIosAggSum) && Objects.equals(this.rumMobileLiteSessionCountKotlinmultiplatformAggSum, usageSummaryResponse.rumMobileLiteSessionCountKotlinmultiplatformAggSum) && Objects.equals(this.rumMobileLiteSessionCountReactnativeAggSum, usageSummaryResponse.rumMobileLiteSessionCountReactnativeAggSum) && Objects.equals(this.rumMobileLiteSessionCountRokuAggSum, usageSummaryResponse.rumMobileLiteSessionCountRokuAggSum) && Objects.equals(this.rumMobileLiteSessionCountUnityAggSum, usageSummaryResponse.rumMobileLiteSessionCountUnityAggSum) && Objects.equals(this.rumMobileReplaySessionCountAndroidAggSum, usageSummaryResponse.rumMobileReplaySessionCountAndroidAggSum) && Objects.equals(this.rumMobileReplaySessionCountIosAggSum, usageSummaryResponse.rumMobileReplaySessionCountIosAggSum) && Objects.equals(this.rumMobileReplaySessionCountKotlinmultiplatformAggSum, usageSummaryResponse.rumMobileReplaySessionCountKotlinmultiplatformAggSum) && Objects.equals(this.rumMobileReplaySessionCountReactnativeAggSum, usageSummaryResponse.rumMobileReplaySessionCountReactnativeAggSum) && Objects.equals(this.rumReplaySessionCountAggSum, usageSummaryResponse.rumReplaySessionCountAggSum) && Objects.equals(this.rumSessionCountAggSum, usageSummaryResponse.rumSessionCountAggSum) && Objects.equals(this.rumSessionReplayAddOnAggSum, usageSummaryResponse.rumSessionReplayAddOnAggSum) && Objects.equals(this.rumTotalSessionCountAggSum, usageSummaryResponse.rumTotalSessionCountAggSum) && Objects.equals(this.rumUnitsAggSum, usageSummaryResponse.rumUnitsAggSum) && Objects.equals(this.scaFargateCountAvgSum, usageSummaryResponse.scaFargateCountAvgSum) && Objects.equals(this.scaFargateCountHwmSum, usageSummaryResponse.scaFargateCountHwmSum) && Objects.equals(this.sdsApmScannedBytesSum, usageSummaryResponse.sdsApmScannedBytesSum) && Objects.equals(this.sdsEventsScannedBytesSum, usageSummaryResponse.sdsEventsScannedBytesSum) && Objects.equals(this.sdsLogsScannedBytesSum, usageSummaryResponse.sdsLogsScannedBytesSum) && Objects.equals(this.sdsRumScannedBytesSum, usageSummaryResponse.sdsRumScannedBytesSum) && Objects.equals(this.sdsTotalScannedBytesSum, usageSummaryResponse.sdsTotalScannedBytesSum) && Objects.equals(this.serverlessAppsApmApmAzureAppserviceInstancesAvgSum, usageSummaryResponse.serverlessAppsApmApmAzureAppserviceInstancesAvgSum) && Objects.equals(this.serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum, usageSummaryResponse.serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum) && Objects.equals(this.serverlessAppsApmApmAzureContainerappInstancesAvgSum, usageSummaryResponse.serverlessAppsApmApmAzureContainerappInstancesAvgSum) && Objects.equals(this.serverlessAppsApmApmFargateEcsTasksAvgSum, usageSummaryResponse.serverlessAppsApmApmFargateEcsTasksAvgSum) && Objects.equals(this.serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum, usageSummaryResponse.serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum) && Objects.equals(this.serverlessAppsApmApmGcpCloudrunInstancesAvgSum, usageSummaryResponse.serverlessAppsApmApmGcpCloudrunInstancesAvgSum) && Objects.equals(this.serverlessAppsApmAvgSum, usageSummaryResponse.serverlessAppsApmAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum) && Objects.equals(this.serverlessAppsApmExclFargateAvgSum, usageSummaryResponse.serverlessAppsApmExclFargateAvgSum) && Objects.equals(this.serverlessAppsAzureContainerAppInstancesAvgSum, usageSummaryResponse.serverlessAppsAzureContainerAppInstancesAvgSum) && Objects.equals(this.serverlessAppsAzureCountAvgSum, usageSummaryResponse.serverlessAppsAzureCountAvgSum) && Objects.equals(this.serverlessAppsAzureFunctionAppInstancesAvgSum, usageSummaryResponse.serverlessAppsAzureFunctionAppInstancesAvgSum) && Objects.equals(this.serverlessAppsAzureWebAppInstancesAvgSum, usageSummaryResponse.serverlessAppsAzureWebAppInstancesAvgSum) && Objects.equals(this.serverlessAppsEcsAvgSum, usageSummaryResponse.serverlessAppsEcsAvgSum) && Objects.equals(this.serverlessAppsEksAvgSum, usageSummaryResponse.serverlessAppsEksAvgSum) && Objects.equals(this.serverlessAppsExclFargateAvgSum, usageSummaryResponse.serverlessAppsExclFargateAvgSum) && Objects.equals(this.serverlessAppsExclFargateAzureContainerAppInstancesAvgSum, usageSummaryResponse.serverlessAppsExclFargateAzureContainerAppInstancesAvgSum) && Objects.equals(this.serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum, usageSummaryResponse.serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum) && Objects.equals(this.serverlessAppsExclFargateAzureWebAppInstancesAvgSum, usageSummaryResponse.serverlessAppsExclFargateAzureWebAppInstancesAvgSum) && Objects.equals(this.serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum, usageSummaryResponse.serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum) && Objects.equals(this.serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum, usageSummaryResponse.serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum) && Objects.equals(this.serverlessAppsGoogleCloudFunctionsInstancesAvgSum, usageSummaryResponse.serverlessAppsGoogleCloudFunctionsInstancesAvgSum) && Objects.equals(this.serverlessAppsGoogleCloudRunInstancesAvgSum, usageSummaryResponse.serverlessAppsGoogleCloudRunInstancesAvgSum) && Objects.equals(this.serverlessAppsGoogleCountAvgSum, usageSummaryResponse.serverlessAppsGoogleCountAvgSum) && Objects.equals(this.serverlessAppsTotalCountAvgSum, usageSummaryResponse.serverlessAppsTotalCountAvgSum) && Objects.equals(this.siemAnalyzedLogsAddOnCountAggSum, usageSummaryResponse.siemAnalyzedLogsAddOnCountAggSum) && Objects.equals(this.startDate, usageSummaryResponse.startDate) && Objects.equals(this.syntheticsBrowserCheckCallsCountAggSum, usageSummaryResponse.syntheticsBrowserCheckCallsCountAggSum) && Objects.equals(this.syntheticsCheckCallsCountAggSum, usageSummaryResponse.syntheticsCheckCallsCountAggSum) && Objects.equals(this.syntheticsMobileTestRunsAggSum, usageSummaryResponse.syntheticsMobileTestRunsAggSum) && Objects.equals(this.syntheticsParallelTestingMaxSlotsHwmSum, usageSummaryResponse.syntheticsParallelTestingMaxSlotsHwmSum) && Objects.equals(this.traceSearchIndexedEventsCountAggSum, usageSummaryResponse.traceSearchIndexedEventsCountAggSum) && Objects.equals(this.twolIngestedEventsBytesAggSum, usageSummaryResponse.twolIngestedEventsBytesAggSum) && Objects.equals(this.universalServiceMonitoringHostTop99pSum, usageSummaryResponse.universalServiceMonitoringHostTop99pSum) && Objects.equals(this.usage, usageSummaryResponse.usage) && Objects.equals(this.vsphereHostTop99pSum, usageSummaryResponse.vsphereHostTop99pSum) && Objects.equals(this.vulnManagementHostCountTop99pSum, usageSummaryResponse.vulnManagementHostCountTop99pSum) && Objects.equals(this.workflowExecutionsUsageAggSum, usageSummaryResponse.workflowExecutionsUsageAggSum) && Objects.equals(this.additionalProperties, usageSummaryResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(agentHostTop99pSum,apmAzureAppServiceHostTop99pSum,apmDevsecopsHostTop99pSum,apmEnterpriseStandaloneHostsTop99pSum,apmFargateCountAvgSum,apmHostTop99pSum,apmProStandaloneHostsTop99pSum,appsecFargateCountAvgSum,asmServerlessAggSum,auditLogsLinesIndexedAggSum,auditTrailEnabledHwmSum,avgProfiledFargateTasksSum,awsHostTop99pSum,awsLambdaFuncCount,awsLambdaInvocationsSum,azureAppServiceTop99pSum,azureHostTop99pSum,billableIngestedBytesAggSum,bitsAiInvestigationsAggSum,browserRumLiteSessionCountAggSum,browserRumReplaySessionCountAggSum,browserRumUnitsAggSum,ccmSpendMonitoredEntLastSum,ccmSpendMonitoredProLastSum,ciPipelineIndexedSpansAggSum,ciTestIndexedSpansAggSum,ciVisibilityItrCommittersHwmSum,ciVisibilityPipelineCommittersHwmSum,ciVisibilityTestCommittersHwmSum,cloudCostManagementAwsHostCountAvgSum,cloudCostManagementAzureHostCountAvgSum,cloudCostManagementGcpHostCountAvgSum,cloudCostManagementHostCountAvgSum,cloudCostManagementOciHostCountAvgSum,cloudSiemEventsAggSum,codeAnalysisSaCommittersHwmSum,codeAnalysisScaCommittersHwmSum,codeSecurityHostTop99pSum,containerAvgSum,containerExclAgentAvgSum,containerHwmSum,csmContainerEnterpriseComplianceCountAggSum,csmContainerEnterpriseCwsCountAggSum,csmContainerEnterpriseTotalCountAggSum,csmHostEnterpriseAasHostCountTop99pSum,csmHostEnterpriseAwsHostCountTop99pSum,csmHostEnterpriseAzureHostCountTop99pSum,csmHostEnterpriseComplianceHostCountTop99pSum,csmHostEnterpriseCwsHostCountTop99pSum,csmHostEnterpriseGcpHostCountTop99pSum,csmHostEnterpriseOciHostCountTop99pSum,csmHostEnterpriseTotalHostCountTop99pSum,csmHostProOciHostCountTop99pSum,cspmAasHostTop99pSum,cspmAwsHostTop99pSum,cspmAzureHostTop99pSum,cspmContainerAvgSum,cspmContainerHwmSum,cspmGcpHostTop99pSum,cspmHostTop99pSum,customHistoricalTsSum,customLiveTsSum,customTsSum,cwsContainerAvgSum,cwsFargateTaskAvgSum,cwsHostTop99pSum,dataJobsMonitoringHostHrAggSum,dbmHostTop99pSum,dbmQueriesAvgSum,endDate,ephInfraHostAgentAggSum,ephInfraHostAlibabaAggSum,ephInfraHostAwsAggSum,ephInfraHostAzureAggSum,ephInfraHostEntAggSum,ephInfraHostGcpAggSum,ephInfraHostHerokuAggSum,ephInfraHostOnlyAasAggSum,ephInfraHostOnlyVsphereAggSum,ephInfraHostOpentelemetryAggSum,ephInfraHostOpentelemetryApmAggSum,ephInfraHostProAggSum,ephInfraHostProplusAggSum,ephInfraHostProxmoxAggSum,errorTrackingApmErrorEventsAggSum,errorTrackingErrorEventsAggSum,errorTrackingEventsAggSum,errorTrackingRumErrorEventsAggSum,eventManagementCorrelationAggSum,eventManagementCorrelationCorrelatedEventsAggSum,eventManagementCorrelationCorrelatedRelatedEventsAggSum,fargateContainerProfilerProfilingFargateAvgSum,fargateContainerProfilerProfilingFargateEksAvgSum,fargateTasksCountAvgSum,fargateTasksCountHwmSum,flexLogsComputeLargeAvgSum,flexLogsComputeMediumAvgSum,flexLogsComputeSmallAvgSum,flexLogsComputeXlargeAvgSum,flexLogsComputeXsmallAvgSum,flexLogsStarterAvgSum,flexLogsStarterStorageIndexAvgSum,flexLogsStarterStorageRetentionAdjustmentAvgSum,flexStoredLogsAvgSum,forwardingEventsBytesAggSum,gcpHostTop99pSum,herokuHostTop99pSum,incidentManagementMonthlyActiveUsersHwmSum,incidentManagementSeatsHwmSum,indexedEventsCountAggSum,infraEdgeMonitoringDevicesTop99pSum,infraHostTop99pSum,ingestedEventsBytesAggSum,iotDeviceAggSum,iotDeviceTop99pSum,lastUpdated,liveIndexedEventsAggSum,liveIngestedBytesAggSum,llmObservabilityAggSum,llmObservabilityMinSpendAggSum,logsByRetention,mobileRumLiteSessionCountAggSum,mobileRumSessionCountAggSum,mobileRumSessionCountAndroidAggSum,mobileRumSessionCountFlutterAggSum,mobileRumSessionCountIosAggSum,mobileRumSessionCountReactnativeAggSum,mobileRumSessionCountRokuAggSum,mobileRumUnitsAggSum,ndmNetflowEventsAggSum,netflowIndexedEventsCountAggSum,networkDeviceWirelessTop99pSum,networkPathAggSum,npmHostTop99pSum,observabilityPipelinesBytesProcessedAggSum,ociHostAggSum,ociHostTop99pSum,onCallSeatHwmSum,onlineArchiveEventsCountAggSum,opentelemetryApmHostTop99pSum,opentelemetryHostTop99pSum,productAnalyticsAggSum,profilingAasCountTop99pSum,profilingContainerAgentCountAvg,profilingHostCountTop99pSum,proxmoxHostAggSum,proxmoxHostTop99pSum,publishedAppHwmSum,rehydratedIndexedEventsAggSum,rehydratedIngestedBytesAggSum,rumBrowserAndMobileSessionCount,rumBrowserLegacySessionCountAggSum,rumBrowserLiteSessionCountAggSum,rumBrowserReplaySessionCountAggSum,rumIndexedSessionsAggSum,rumIngestedSessionsAggSum,rumLiteSessionCountAggSum,rumMobileLegacySessionCountAndroidAggSum,rumMobileLegacySessionCountFlutterAggSum,rumMobileLegacySessionCountIosAggSum,rumMobileLegacySessionCountReactnativeAggSum,rumMobileLegacySessionCountRokuAggSum,rumMobileLiteSessionCountAndroidAggSum,rumMobileLiteSessionCountFlutterAggSum,rumMobileLiteSessionCountIosAggSum,rumMobileLiteSessionCountKotlinmultiplatformAggSum,rumMobileLiteSessionCountReactnativeAggSum,rumMobileLiteSessionCountRokuAggSum,rumMobileLiteSessionCountUnityAggSum,rumMobileReplaySessionCountAndroidAggSum,rumMobileReplaySessionCountIosAggSum,rumMobileReplaySessionCountKotlinmultiplatformAggSum,rumMobileReplaySessionCountReactnativeAggSum,rumReplaySessionCountAggSum,rumSessionCountAggSum,rumSessionReplayAddOnAggSum,rumTotalSessionCountAggSum,rumUnitsAggSum,scaFargateCountAvgSum,scaFargateCountHwmSum,sdsApmScannedBytesSum,sdsEventsScannedBytesSum,sdsLogsScannedBytesSum,sdsRumScannedBytesSum,sdsTotalScannedBytesSum,serverlessAppsApmApmAzureAppserviceInstancesAvgSum,serverlessAppsApmApmAzureAzurefunctionInstancesAvgSum,serverlessAppsApmApmAzureContainerappInstancesAvgSum,serverlessAppsApmApmFargateEcsTasksAvgSum,serverlessAppsApmApmGcpCloudfunctionInstancesAvgSum,serverlessAppsApmApmGcpCloudrunInstancesAvgSum,serverlessAppsApmAvgSum,serverlessAppsApmExclFargateApmAzureAppserviceInstancesAvgSum,serverlessAppsApmExclFargateApmAzureAzurefunctionInstancesAvgSum,serverlessAppsApmExclFargateApmAzureContainerappInstancesAvgSum,serverlessAppsApmExclFargateApmGcpCloudfunctionInstancesAvgSum,serverlessAppsApmExclFargateApmGcpCloudrunInstancesAvgSum,serverlessAppsApmExclFargateAvgSum,serverlessAppsAzureContainerAppInstancesAvgSum,serverlessAppsAzureCountAvgSum,serverlessAppsAzureFunctionAppInstancesAvgSum,serverlessAppsAzureWebAppInstancesAvgSum,serverlessAppsEcsAvgSum,serverlessAppsEksAvgSum,serverlessAppsExclFargateAvgSum,serverlessAppsExclFargateAzureContainerAppInstancesAvgSum,serverlessAppsExclFargateAzureFunctionAppInstancesAvgSum,serverlessAppsExclFargateAzureWebAppInstancesAvgSum,serverlessAppsExclFargateGoogleCloudFunctionsInstancesAvgSum,serverlessAppsExclFargateGoogleCloudRunInstancesAvgSum,serverlessAppsGoogleCloudFunctionsInstancesAvgSum,serverlessAppsGoogleCloudRunInstancesAvgSum,serverlessAppsGoogleCountAvgSum,serverlessAppsTotalCountAvgSum,siemAnalyzedLogsAddOnCountAggSum,startDate,syntheticsBrowserCheckCallsCountAggSum,syntheticsCheckCallsCountAggSum,syntheticsMobileTestRunsAggSum,syntheticsParallelTestingMaxSlotsHwmSum,traceSearchIndexedEventsCountAggSum,twolIngestedEventsBytesAggSum,universalServiceMonitoringHostTop99pSum,usage,vsphereHostTop99pSum,vulnManagementHostCountTop99pSum,workflowExecutionsUsageAggSum, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    apmDevsecopsHostTop99pSum: ").append(toIndentedString(apmDevsecopsHostTop99pSum)).append("\n");
    ...
    sb.append("    asmServerlessAggSum: ").append(toIndentedString(asmServerlessAggSum)).append("\n");
    sb.append("    auditLogsLinesIndexedAggSum: ").append(toIndentedString(auditLogsLinesIndexedAggSum)).append("\n");
    sb.append("    auditTrailEnabledHwmSum: ").append(toIndentedString(auditTrailEnabledHwmSum)).append("\n");
    ...
    sb.append("    bitsAiInvestigationsAggSum: ").append(toIndentedString(bitsAiInvestigationsAggSum)).append("\n");
    ...
    sb.append("    cloudCostManagementAwsHostCountAvgSum: ").append(toIndentedString(cloudCostManagementAwsHostCountAvgSum)).append("\n");
    sb.append("    cloudCostManagementAzureHostCountAvgSum: ").append(toIndentedString(cloudCostManagementAzureHostCountAvgSum)).append("\n");
    sb.append("    cloudCostManagementGcpHostCountAvgSum: ").append(toIndentedString(cloudCostManagementGcpHostCountAvgSum)).append("\n");
    ...
    sb.append("    codeAnalysisSaCommittersHwmSum: ").append(toIndentedString(codeAnalysisSaCommittersHwmSum)).append("\n");
    sb.append("    codeAnalysisScaCommittersHwmSum: ").append(toIndentedString(codeAnalysisScaCommittersHwmSum)).append("\n");
    sb.append("    codeSecurityHostTop99pSum: ").append(toIndentedString(codeSecurityHostTop99pSum)).append("\n");
    ...
    sb.append("    csmContainerEnterpriseComplianceCountAggSum: ").append(toIndentedString(csmContainerEnterpriseComplianceCountAggSum)).append("\n");
    sb.append("    csmContainerEnterpriseCwsCountAggSum: ").append(toIndentedString(csmContainerEnterpriseCwsCountAggSum)).append("\n");
    sb.append("    csmContainerEnterpriseTotalCountAggSum: ").append(toIndentedString(csmContainerEnterpriseTotalCountAggSum)).append("\n");
    sb.append("    csmHostEnterpriseAasHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseAasHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseAwsHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseAwsHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseAzureHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseAzureHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseComplianceHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseComplianceHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseCwsHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseCwsHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseGcpHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseGcpHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseOciHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseOciHostCountTop99pSum)).append("\n");
    sb.append("    csmHostEnterpriseTotalHostCountTop99pSum: ").append(toIndentedString(csmHostEnterpriseTotalHostCountTop99pSum)).append("\n");
    ...
    sb.append("    cwsFargateTaskAvgSum: ").append(toIndentedString(cwsFargateTaskAvgSum)).append("\n");
    sb.append("    cwsHostTop99pSum: ").append(toIndentedString(cwsHostTop99pSum)).append("\n");
    sb.append("    dataJobsMonitoringHostHrAggSum: ").append(toIndentedString(dataJobsMonitoringHostHrAggSum)).append("\n");
    ...
    sb.append("    flexLogsComputeLargeAvgSum: ").append(toIndentedString(flexLogsComputeLargeAvgSum)).append("\n");
    sb.append("    flexLogsComputeMediumAvgSum: ").append(toIndentedString(flexLogsComputeMediumAvgSum)).append("\n");
    sb.append("    flexLogsComputeSmallAvgSum: ").append(toIndentedString(flexLogsComputeSmallAvgSum)).append("\n");
    ...
    sb.append("    flexLogsStarterAvgSum: ").append(toIndentedString(flexLogsStarterAvgSum)).append("\n");
    sb.append("    flexLogsStarterStorageIndexAvgSum: ").append(toIndentedString(flexLogsStarterStorageIndexAvgSum)).append("\n");
    sb.append("    flexLogsStarterStorageRetentionAdjustmentAvgSum: ").append(toIndentedString(flexLogsStarterStorageRetentionAdjustmentAvgSum)).append("\n");
    sb.append("    flexStoredLogsAvgSum: ").append(toIndentedString(flexStoredLogsAvgSum)).append("\n");
    sb.append("    forwardingEventsBytesAggSum: ").append(toIndentedString(forwardingEventsBytesAggSum)).append("\n");
    ...
    sb.append("    incidentManagementSeatsHwmSum: ").append(toIndentedString(incidentManagementSeatsHwmSum)).append("\n");
    ...
    sb.append("    ndmNetflowEventsAggSum: ").append(toIndentedString(ndmNetflowEventsAggSum)).append("\n");
    ...
    sb.append("    rumBrowserLegacySessionCountAggSum: ").append(toIndentedString(rumBrowserLegacySessionCountAggSum)).append("\n");
    sb.append("    rumBrowserLiteSessionCountAggSum: ").append(toIndentedString(rumBrowserLiteSessionCountAggSum)).append("\n");
    sb.append("    rumBrowserReplaySessionCountAggSum: ").append(toIndentedString(rumBrowserReplaySessionCountAggSum)).append("\n");
    ...
    sb.append("    rumMobileLegacySessionCountAndroidAggSum: ").append(toIndentedString(rumMobileLegacySessionCountAndroidAggSum)).append("\n");
    sb.append("    rumMobileLegacySessionCountFlutterAggSum: ").append(toIndentedString(rumMobileLegacySessionCountFlutterAggSum)).append("\n");
    sb.append("    rumMobileLegacySessionCountIosAggSum: ").append(toIndentedString(rumMobileLegacySessionCountIosAggSum)).append("\n");
    sb.append("    rumMobileLegacySessionCountReactnativeAggSum: ").append(toIndentedString(rumMobileLegacySessionCountReactnativeAggSum)).append("\n");
    sb.append("    rumMobileLegacySessionCountRokuAggSum: ").append(toIndentedString(rumMobileLegacySessionCountRokuAggSum)).append("\n");
    sb.append("    rumMobileLiteSessionCountAndroidAggSum: ").append(toIndentedString(rumMobileLiteSessionCountAndroidAggSum)).append("\n");
    sb.append("    rumMobileLiteSessionCountFlutterAggSum: ").append(toIndentedString(rumMobileLiteSessionCountFlutterAggSum)).append("\n");
    sb.append("    rumMobileLiteSessionCountIosAggSum: ").append(toIndentedString(rumMobileLiteSessionCountIosAggSum)).append("\n");
    ...
    sb.append("    siemAnalyzedLogsAddOnCountAggSum: ").append(toIndentedString(siemAnalyzedLogsAddOnCountAggSum)).append("\n");
    ...
    sb.append("    vulnManagementHostCountTop99pSum: ").append(toIndentedString(vulnManagementHostCountTop99pSum)).append("\n");
