      ...
      new HashMap<String, Boolean>() {
        {
          ...
          put("v2.createElasticCloudCcmAccount", false);
          put("v2.deleteElasticCloudCcmAccount", false);
          put("v2.getElasticCloudCcmAccount", false);
          put("v2.listElasticCloudCcmAccounts", false);
          put("v2.updateElasticCloudCcmAccount", false);
          put("v2.createElasticCloudMonitoringAccount", false);
          put("v2.deleteElasticCloudMonitoringAccount", false);
          put("v2.getElasticCloudMonitoringAccount", false);
          put("v2.listElasticCloudMonitoringAccounts", false);
          put("v2.updateElasticCloudMonitoringAccount", false);
          put("v2.createTwilioAccount", false);
          put("v2.deleteTwilioAccount", false);
          put("v2.getTwilioAccount", false);
          put("v2.listTwilioAccounts", false);
          put("v2.updateTwilioAccount", false);
