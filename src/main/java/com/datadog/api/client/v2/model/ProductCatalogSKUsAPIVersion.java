...
/**
   * <p>The version of the product catalog contract to return.</p>
 */
...
public class ProductCatalogSKUsAPIVersion extends ModelEnum<String> {
  ...
  public static class ProductCatalogSKUsAPIVersionSerializer extends StdSerializer<ProductCatalogSKUsAPIVersion> {
      ...
      @Override
      public void serialize(ProductCatalogSKUsAPIVersion value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
