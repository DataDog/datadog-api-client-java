...
/**
   * <p>The <code>websocket</code> source ingests logs from a WebSocket server using the <code>ws://</code> or <code>wss://</code> protocol.</p>
...
public class ObservabilityPipelineWebsocketSource {
  ...
  private ObservabilityPipelineWebsocketSourceType type = ObservabilityPipelineWebsocketSourceType.WEBSOCKET;
  ...
  @JsonCreator
  public ObservabilityPipelineWebsocketSource(
            @JsonProperty(required=true, value=JSON_PROPERTY_AUTH_STRATEGY)ObservabilityPipelineWebsocketSourceAuthStrategy authStrategy,
            @JsonProperty(required=true, value=JSON_PROPERTY_DECODING)ObservabilityPipelineDecoding decoding,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineWebsocketSourceType type) {
  ...
  public ObservabilityPipelineWebsocketSource authStrategy(ObservabilityPipelineWebsocketSourceAuthStrategy authStrategy) {
    this.authStrategy = authStrategy;
    this.unparsed |= !authStrategy.isValid();
    return this;
  }
  ...
  /**
   * <p>Authentication strategy for the WebSocket source connection.</p>
   * @return authStrategy
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the custom authorization header value. Used when <code>auth_strategy</code> is <code>custom</code>.</p>
   * @return customKey
  **/
  ...
  **/
  ...
  /**
   * <p>TLS configuration for the WebSocket source. Use <code>enabled</code> for standard <code>wss://</code> connections, or <code>with_client_cert</code> to present a client certificate for mutual TLS.</p>
   * @return tls
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The source type. The value should always be <code>websocket</code>.</p>
   * @return type
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the WebSocket server URI (<code>ws://</code> or <code>wss://</code>).</p>
   * @return uriKey
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineWebsocketSource observabilityPipelineWebsocketSource = (ObservabilityPipelineWebsocketSource) o;
    return Objects.equals(this.authStrategy, observabilityPipelineWebsocketSource.authStrategy) && Objects.equals(this.customKey, observabilityPipelineWebsocketSource.customKey) && Objects.equals(this.decoding, observabilityPipelineWebsocketSource.decoding) && Objects.equals(this.id, observabilityPipelineWebsocketSource.id) && Objects.equals(this.passwordKey, observabilityPipelineWebsocketSource.passwordKey) && Objects.equals(this.tls, observabilityPipelineWebsocketSource.tls) && Objects.equals(this.tokenKey, observabilityPipelineWebsocketSource.tokenKey) && Objects.equals(this.type, observabilityPipelineWebsocketSource.type) && Objects.equals(this.uriKey, observabilityPipelineWebsocketSource.uriKey) && Objects.equals(this.usernameKey, observabilityPipelineWebsocketSource.usernameKey) && Objects.equals(this.additionalProperties, observabilityPipelineWebsocketSource.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(authStrategy,customKey,decoding,id,passwordKey,tls,tokenKey,type,uriKey,usernameKey, additionalProperties);
  }
