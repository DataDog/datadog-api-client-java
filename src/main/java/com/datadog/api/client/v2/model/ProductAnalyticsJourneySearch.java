...
public class ProductAnalyticsJourneySearch {
  ...
  /**
   * <p>Expression combining the node aliases in order, for example <code>A -&gt; B -&gt; C</code>.</p>
   * @return expression
  **/
  ...
  **/
  ...
  /**
   * <p>Identity join keys used to stitch events belonging to the same user or session.</p>
   * @return joinKeys
  **/
      @jakarta.annotation.Nullable
  ...
  public ProductAnalyticsJourneySearch nodeObjects(Map<String, ProductAnalyticsBaseQuery> nodeObjects) {
    this.nodeObjects = nodeObjects;
    return this;
  }
  public ProductAnalyticsJourneySearch putNodeObjectsItem(String key, ProductAnalyticsBaseQuery nodeObjectsItem) {
    this.nodeObjects.put(key, nodeObjectsItem);
    return this;
  }

  /**
   * <p>Map of node alias to the query matching that step of the journey.
   * Every alias used in <code>expression</code> must have an entry here.</p>
   * @return nodeObjects
  **/
