...
/**
   * <p>A filter applied to a step, or a range of steps, of the journey graph.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsJourneySearchGraphFilter {
  ...
  @JsonCreator
  public ProductAnalyticsJourneySearchGraphFilter(
            @JsonProperty(required=true, value=JSON_PROPERTY_NAME)ProductAnalyticsJourneySearchGraphFilterName name,
            @JsonProperty(required=true, value=JSON_PROPERTY_OPERATOR)ProductAnalyticsJourneySearchGraphFilterOperator operator,
  ...
  public ProductAnalyticsJourneySearchGraphFilter name(ProductAnalyticsJourneySearchGraphFilterName name) {
    this.name = name;
    this.unparsed |= !name.isValid();
    return this;
  }
  ...
  **/
  ...
  public ProductAnalyticsJourneySearchGraphFilter operator(ProductAnalyticsJourneySearchGraphFilterOperator operator) {
    this.operator = operator;
    this.unparsed |= !operator.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Value compared against the metric. Durations are expressed in milliseconds.</p>
   * @return value
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsJourneySearchGraphFilter productAnalyticsJourneySearchGraphFilter = (ProductAnalyticsJourneySearchGraphFilter) o;
    return Objects.equals(this.name, productAnalyticsJourneySearchGraphFilter.name) && Objects.equals(this.operator, productAnalyticsJourneySearchGraphFilter.operator) && Objects.equals(this.target, productAnalyticsJourneySearchGraphFilter.target) && Objects.equals(this.value, productAnalyticsJourneySearchGraphFilter.value) && Objects.equals(this.additionalProperties, productAnalyticsJourneySearchGraphFilter.additionalProperties);
  }
