...
/**
   * <p>The <code>add_env_vars</code> processor adds environment variable values to log events.</p>
...
public class ObservabilityPipelineAddEnvVarsProcessor {
  ...
  private ObservabilityPipelineAddEnvVarsProcessorType type = ObservabilityPipelineAddEnvVarsProcessorType.ADD_ENV_VARS;
  ...
  public ObservabilityPipelineAddEnvVarsProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineAddEnvVarsProcessorType type,
            @JsonProperty(required=true, value=JSON_PROPERTY_VARIABLES)List<ObservabilityPipelineAddEnvVarsProcessorVariable> variables) {
  ...
  **/
  ...
  /**
   * <p>The unique identifier for this component. Used to reference this processor in the pipeline.</p>
   * @return id
  **/
  ...
  **/
  ...
  public ObservabilityPipelineAddEnvVarsProcessor type(ObservabilityPipelineAddEnvVarsProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>add_env_vars</code>.</p>
   * @return type
  **/
  ...
  public ObservabilityPipelineAddEnvVarsProcessor variables(List<ObservabilityPipelineAddEnvVarsProcessorVariable> variables) {
    this.variables = variables;
  ...
  public ObservabilityPipelineAddEnvVarsProcessor addVariablesItem(ObservabilityPipelineAddEnvVarsProcessorVariable variablesItem) {
  ...
  /**
   * <p>A list of environment variable mappings to apply to log fields.</p>
   * @return variables
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineAddEnvVarsProcessor observabilityPipelineAddEnvVarsProcessor = (ObservabilityPipelineAddEnvVarsProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineAddEnvVarsProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineAddEnvVarsProcessor.enabled) && Objects.equals(this.id, observabilityPipelineAddEnvVarsProcessor.id) && Objects.equals(this.include, observabilityPipelineAddEnvVarsProcessor.include) && Objects.equals(this.type, observabilityPipelineAddEnvVarsProcessor.type) && Objects.equals(this.variables, observabilityPipelineAddEnvVarsProcessor.variables) && Objects.equals(this.additionalProperties, observabilityPipelineAddEnvVarsProcessor.additionalProperties);
  }
