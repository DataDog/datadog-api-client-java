...
/**
   * <p>Data object representing an incident handle in a create or update request.</p>
 */
@JsonPropertyOrder({
...
public class IncidentHandleDataRequest {
  ...
  private JsonNullable<IncidentHandleRelationshipsRequest> relationships = JsonNullable.<IncidentHandleRelationshipsRequest>undefined();
  ...
  @JsonCreator
  public IncidentHandleDataRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)IncidentHandleAttributesRequest attributes,
  ...
  /**
   * <p>Incident handle attributes for requests</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The ID of the incident handle (required for PUT requests)</p>
   * @return id
  **/
  ...
  public IncidentHandleDataRequest relationships(IncidentHandleRelationshipsRequest relationships) {
    this.relationships = JsonNullable.<IncidentHandleRelationshipsRequest>of(relationships);
    return this;
  }

  /**
   * <p>Relationships to associate with an incident handle in a create or update request.</p>
  ...
  **/
  ...
  @JsonInclude(
    value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<IncidentHandleRelationshipsRequest> getRelationships_JsonNullable() {
    return relationships;
  }
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)public void setRelationships_JsonNullable(JsonNullable<IncidentHandleRelationshipsRequest> relationships) {
  ...
  /**
   * <p>Incident handle resource type</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, incidentHandleDataRequest.attributes) && Objects.equals(this.id, incidentHandleDataRequest.id) && Objects.equals(this.relationships, incidentHandleDataRequest.relationships) && Objects.equals(this.type, incidentHandleDataRequest.type) && Objects.equals(this.additionalProperties, incidentHandleDataRequest.additionalProperties);
  }
