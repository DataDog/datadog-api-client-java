...
public class RawErrorBudgetRemaining {
  ...
  /**
   * The unit of the error budget (for example, <code>seconds</code>, <code>requests</code>).
   *
   * @return unit
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.unit, rawErrorBudgetRemaining.unit)
        && Objects.equals(this.value, rawErrorBudgetRemaining.value)
        && Objects.equals(this.additionalProperties, rawErrorBudgetRemaining.additionalProperties);
  }
