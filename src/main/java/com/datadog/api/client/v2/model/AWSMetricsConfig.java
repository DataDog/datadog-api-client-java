...
public class AWSMetricsConfig {
  ...
  **/
  ...
  /**
   * <p>AWS CloudWatch metric name filters. Each filter applies to a single namespace.
   * Exactly one of <code>include_only</code> or <code>exclude_only</code> must be set on each filter.</p>
