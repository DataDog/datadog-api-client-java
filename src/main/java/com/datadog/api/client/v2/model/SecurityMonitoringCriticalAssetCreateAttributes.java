...
public class SecurityMonitoringCriticalAssetCreateAttributes {
  ...
  public SecurityMonitoringCriticalAssetCreateAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SEVERITY)SecurityMonitoringCriticalAssetSeverity severity) {
        this.query = query;
  ...
  /**
   * <p>A description of the critical asset.</p>
   * @return description
  **/
  ...
  /**
   * <p>Whether the critical asset is enabled. Defaults to <code>true</code> if not specified.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public SecurityMonitoringCriticalAssetCreateAttributes severity(SecurityMonitoringCriticalAssetSeverity severity) {
    this.severity = severity;
    this.unparsed |= !severity.isValid();
    return this;
  }
  ...
  /**
   * <p>Severity associated with this critical asset. Either an explicit severity can be set, or the severity can be increased or decreased, or the severity can be left unchanged (no-op).</p>
   * @return severity
  **/
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringCriticalAssetCreateAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringCriticalAssetCreateAttributes securityMonitoringCriticalAssetCreateAttributes = (SecurityMonitoringCriticalAssetCreateAttributes) o;
    return Objects.equals(this.description, securityMonitoringCriticalAssetCreateAttributes.description) && Objects.equals(this.enabled, securityMonitoringCriticalAssetCreateAttributes.enabled) && Objects.equals(this.query, securityMonitoringCriticalAssetCreateAttributes.query) && Objects.equals(this.ruleQuery, securityMonitoringCriticalAssetCreateAttributes.ruleQuery) && Objects.equals(this.severity, securityMonitoringCriticalAssetCreateAttributes.severity) && Objects.equals(this.tags, securityMonitoringCriticalAssetCreateAttributes.tags) && Objects.equals(this.additionalProperties, securityMonitoringCriticalAssetCreateAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(description,enabled,query,ruleQuery,severity,tags, additionalProperties);
  }
