...
@JsonPropertyOrder({
  ...
  SecurityMonitoringIntegrationConfigAttributes.JSON_PROPERTY_ENABLED,
  SecurityMonitoringIntegrationConfigAttributes.JSON_PROPERTY_INTEGRATION_TYPE,
  SecurityMonitoringIntegrationConfigAttributes.JSON_PROPERTY_MODIFIED_AT,
  SecurityMonitoringIntegrationConfigAttributes.JSON_PROPERTY_NAME,
...
public class SecurityMonitoringIntegrationConfigAttributes {
  ...
  private SecurityMonitoringIntegrationConfigState state;
  ...
  public String toString() {
    ...
    sb.append("class SecurityMonitoringIntegrationConfigAttributes {\n");
