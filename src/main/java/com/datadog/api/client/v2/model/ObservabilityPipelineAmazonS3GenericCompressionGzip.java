...
public class ObservabilityPipelineAmazonS3GenericCompressionGzip {
  ...
  private ObservabilityPipelineAmazonS3GenericCompressionGzipType algorithm =
  ...
  public ObservabilityPipelineAmazonS3GenericCompressionGzip(
      @JsonProperty(required = true, value = JSON_PROPERTY_ALGORITHM)
          ObservabilityPipelineAmazonS3GenericCompressionGzipType algorithm,
  ...
  public ObservabilityPipelineAmazonS3GenericCompressionGzip algorithm(
      ObservabilityPipelineAmazonS3GenericCompressionGzipType algorithm) {
    this.algorithm = algorithm;
    this.unparsed |= !algorithm.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.algorithm, observabilityPipelineAmazonS3GenericCompressionGzip.algorithm)
        && Objects.equals(this.level, observabilityPipelineAmazonS3GenericCompressionGzip.level)
        && Objects.equals(
