...
/**
   * <p>Details of a running pipeline.</p>
 */
@JsonPropertyOrder({
...
public class CIAppPipelineEventInProgressPipeline {
  ...
  public CIAppPipelineEventInProgressPipeline(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)CIAppPipelineEventPipelineInProgressStatus status,
  ...
  **/
  ...
  public CIAppPipelineEventInProgressPipeline parentPipeline(CIAppPipelineEventParentPipeline parentPipeline) {
  ...
  **/
  ...
  public CIAppPipelineEventInProgressPipeline previousAttempt(CIAppPipelineEventPreviousPipeline previousAttempt) {
  ...
  **/
  ...
  public CIAppPipelineEventInProgressPipeline status(CIAppPipelineEventPipelineInProgressStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  /**
   * <p>The in progress status of the pipeline.</p>
   * @return status
  **/
  ...
  **/
  ...
  /**
   * <p>UUID of the pipeline run. The ID has to be the same as the finished pipeline.</p>
   * @return uniqueId
  **/
