...
public class FlagSuggestionDataType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("flag-suggestions"));
  ...
  public static class FlagSuggestionDataTypeSerializer
      extends StdSerializer<FlagSuggestionDataType> {
    public FlagSuggestionDataTypeSerializer(Class<FlagSuggestionDataType> t) {
      super(t);
    }
