...
public class SnowflakeIntegrationDataflowsRequest {
   ...
   * data transferred out of Snowflake. Reading that schema requires the ORGADMIN role; without it
   * this dataflow collects no data.
   *
  ...
  /**
   * Execution logs for your scheduled Snowflake tasks, covering start time, end time, status, and
   * any error message.
   *
