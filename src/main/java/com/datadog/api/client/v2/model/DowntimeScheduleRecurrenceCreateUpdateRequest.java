...
public class DowntimeScheduleRecurrenceCreateUpdateRequest {
  ...
  /**
   * <p>The length of the downtime. Must begin with an integer and end with one of 'm', 'h', d', or 'w'.</p>
   * @return duration
  **/
  ...
  /**
   * <p>The <code>RRULE</code> standard for defining recurring events.
  ...
  **/
  ...
  /**
   * <p>ISO-8601 Datetime to start the downtime. Must not include a UTC offset. If not provided, the
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_START)public void setStart_JsonNullable(JsonNullable<String> start) {
    this.start = start;
  }
  ...
  public boolean equals(Object o) {
    ...
    DowntimeScheduleRecurrenceCreateUpdateRequest downtimeScheduleRecurrenceCreateUpdateRequest = (DowntimeScheduleRecurrenceCreateUpdateRequest) o;
    return Objects.equals(this.duration, downtimeScheduleRecurrenceCreateUpdateRequest.duration) && Objects.equals(this.rrule, downtimeScheduleRecurrenceCreateUpdateRequest.rrule) && Objects.equals(this.start, downtimeScheduleRecurrenceCreateUpdateRequest.start) && Objects.equals(this.additionalProperties, downtimeScheduleRecurrenceCreateUpdateRequest.additionalProperties);
  }
