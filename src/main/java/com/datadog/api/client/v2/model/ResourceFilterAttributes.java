...
public class ResourceFilterAttributes {
  ...
  private Map<String, Map<String, List<String>>> cloudProvider = new HashMap<String, Map<String, List<String>>>();
  ...
  @JsonCreator
  public ResourceFilterAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_CLOUD_PROVIDER)Map<String, Map<String, List<String>>> cloudProvider) {
  ...
  /**
   * <p>A map of cloud provider names (e.g., "aws", "gcp", "azure") to a map of account/resource IDs and their associated tag filters.</p>
  ...
  **/
  ...
  /**
   * <p>The UUID of the resource filter.</p>
   * @return uuid
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cloudProvider, resourceFilterAttributes.cloudProvider) && Objects.equals(this.uuid, resourceFilterAttributes.uuid) && Objects.equals(this.additionalProperties, resourceFilterAttributes.additionalProperties);
  }
