...
@JsonDeserialize(using = ActionQueryMockedOutputsEnabled.ActionQueryMockedOutputsEnabledDeserializer.class)
@JsonSerialize(using = ActionQueryMockedOutputsEnabled.ActionQueryMockedOutputsEnabledSerializer.class)
public class ActionQueryMockedOutputsEnabled extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryMockedOutputsEnabled.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryMockedOutputsEnabledSerializer extends StdSerializer<ActionQueryMockedOutputsEnabled> {
        public ActionQueryMockedOutputsEnabledSerializer(Class<ActionQueryMockedOutputsEnabled> t) {
            super(t);
        }

        public ActionQueryMockedOutputsEnabledSerializer() {
            this(null);
        }

        @Override
        public void serialize(ActionQueryMockedOutputsEnabled value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryMockedOutputsEnabledDeserializer extends StdDeserializer<ActionQueryMockedOutputsEnabled> {
        public ActionQueryMockedOutputsEnabledDeserializer() {
            this(ActionQueryMockedOutputsEnabled.class);
        }

        public ActionQueryMockedOutputsEnabledDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ActionQueryMockedOutputsEnabled deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ActionQueryMockedOutputsEnabled ret = new ActionQueryMockedOutputsEnabled();
            if (match == 1) {
         ...
         */
        @Override
        public ActionQueryMockedOutputsEnabled getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryMockedOutputsEnabled cannot be null");
        }
    }
    ...
    public ActionQueryMockedOutputsEnabled() {
        super("oneOf", Boolean.FALSE);
    }
    public ActionQueryMockedOutputsEnabled(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ActionQueryMockedOutputsEnabled(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryMockedOutputsEnabled.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ActionQueryMockedOutputsEnabled.schemas;
    }
