...
/**
   * <p>The mapping created by an <code>add</code> operation.</p>
 */
@JsonPropertyOrder({
...
public class TeamsOwnershipMappingBatchResultData {
  ...
  private TeamsOwnershipMappingBatchResultDataAttributes attributes;
  ...
  @JsonCreator
  public TeamsOwnershipMappingBatchResultData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TeamsOwnershipMappingBatchResultDataAttributes attributes,
  ...
  **/
  ...
  public void setAttributes(TeamsOwnershipMappingBatchResultDataAttributes attributes) {
    this.attributes = attributes;
    if (attributes != null) {
      this.unparsed |= attributes.unparsed;
    }
  ...
  /**
   * <p>The unique identifier of the teams ownership mapping.</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of the resource. The value should always be teams_ownership_mappings.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingBatchResultData teamsOwnershipMappingBatchResultData = (TeamsOwnershipMappingBatchResultData) o;
    return Objects.equals(this.attributes, teamsOwnershipMappingBatchResultData.attributes) && Objects.equals(this.id, teamsOwnershipMappingBatchResultData.id) && Objects.equals(this.type, teamsOwnershipMappingBatchResultData.type) && Objects.equals(this.additionalProperties, teamsOwnershipMappingBatchResultData.additionalProperties);
  }
