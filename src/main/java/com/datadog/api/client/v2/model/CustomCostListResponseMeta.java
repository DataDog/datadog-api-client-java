...
public class CustomCostListResponseMeta {
  ...
  /**
   * <p>Number of Custom Costs files per status.</p>
  ...
  **/
  ...
  /**
   * <p>List of available providers.</p>
   * @return providers
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of Custom Costs files returned by the List Custom Costs endpoint</p>
  ...
  **/
  ...
  public CustomCostListResponseMeta version(String version) {
  ...
  **/
   ...
   * @return CustomCostListResponseMeta
   */
  @JsonAnySetter
  public CustomCostListResponseMeta putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this CustomCostListResponseMeta object is equal to o.
   */
  @Override
