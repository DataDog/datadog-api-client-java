...
/**
   * <p>Attributes for creating or updating a Synthetics downtime.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsDowntimeDataAttributesRequest {
  ...
  public SyntheticsDowntimeDataAttributesRequest(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TIME_SLOTS)List<SyntheticsDowntimeTimeSlotRequest> timeSlots) {
  ...
  /**
   * <p>An optional description of the downtime.</p>
   * @return description
  **/
  ...
  **/
  ...
  /**
   * <p>List of time slots for a Synthetics downtime create or update request.</p>
   * @return timeSlots
  **/
