...
public class AzureScanOptionsDataType extends ModelEnum<String> {
  ...
  public static final AzureScanOptionsDataType AZURE_SCAN_OPTIONS =
      new AzureScanOptionsDataType("azure_scan_options");

  AzureScanOptionsDataType(String value) {
    super(value, allowedValues);
  }

  public static class AzureScanOptionsDataTypeSerializer
      extends StdSerializer<AzureScanOptionsDataType> {
    ...
    public void serialize(
        AzureScanOptionsDataType value, JsonGenerator jgen, SerializerProvider provider)
