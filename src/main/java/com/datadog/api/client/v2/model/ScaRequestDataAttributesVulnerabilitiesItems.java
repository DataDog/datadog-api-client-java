...
/** The definition of <code>ScaRequestDataAttributesVulnerabilitiesItems</code> object. */
@JsonPropertyOrder({
...
public class ScaRequestDataAttributesVulnerabilitiesItems {
  ...
  /**
   * The <code>items</code> <code>affects</code>.
   *
   * @return affects
   */
  ...
  /**
   * The <code>items</code> <code>bom_ref</code>.
   *
   * @return bomRef
   */
  @jakarta.annotation.Nullable
