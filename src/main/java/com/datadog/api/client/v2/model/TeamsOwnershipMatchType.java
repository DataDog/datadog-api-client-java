...
public class TeamsOwnershipMatchType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("exact", "prefix"));
  ...
  public static class TeamsOwnershipMatchTypeSerializer extends StdSerializer<TeamsOwnershipMatchType> {
      public TeamsOwnershipMatchTypeSerializer(Class<TeamsOwnershipMatchType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(TeamsOwnershipMatchType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
