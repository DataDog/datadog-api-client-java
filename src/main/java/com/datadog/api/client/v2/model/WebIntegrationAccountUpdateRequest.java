...
/**
   * <p>Payload schema when updating a web integration account.</p>
 */
@JsonPropertyOrder({
  WebIntegrationAccountUpdateRequest.JSON_PROPERTY_DATA
})
...
public class WebIntegrationAccountUpdateRequest {
  ...
  @JsonCreator
  public WebIntegrationAccountUpdateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)WebIntegrationAccountUpdateRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebIntegrationAccountUpdateRequest webIntegrationAccountUpdateRequest = (WebIntegrationAccountUpdateRequest) o;
    return Objects.equals(this.data, webIntegrationAccountUpdateRequest.data) && Objects.equals(this.additionalProperties, webIntegrationAccountUpdateRequest.additionalProperties);
  }
