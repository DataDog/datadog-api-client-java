...
/**
   * <p>The <code>rename_metric_tags</code> processor changes the keys of tags on metrics.</p>
...
public class ObservabilityPipelineRenameMetricTagsProcessor {
  ...
  private ObservabilityPipelineRenameMetricTagsProcessorType type = ObservabilityPipelineRenameMetricTagsProcessorType.RENAME_METRIC_TAGS;
  ...
  public ObservabilityPipelineRenameMetricTagsProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TAGS)List<ObservabilityPipelineRenameMetricTagsProcessorTag> tags,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineRenameMetricTagsProcessorType type) {
  ...
  **/
  ...
  public ObservabilityPipelineRenameMetricTagsProcessor tags(List<ObservabilityPipelineRenameMetricTagsProcessorTag> tags) {
    this.tags = tags;
    for (ObservabilityPipelineRenameMetricTagsProcessorTag item : tags) {
      this.unparsed |= item.unparsed;
    }
  ...
  public ObservabilityPipelineRenameMetricTagsProcessor addTagsItem(ObservabilityPipelineRenameMetricTagsProcessorTag tagsItem) {
  ...
  /**
   * <p>A list of rename rules specifying which tag keys to rename on each metric.</p>
   * @return tags
  **/
  ...
  public ObservabilityPipelineRenameMetricTagsProcessor type(ObservabilityPipelineRenameMetricTagsProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value must be <code>rename_metric_tags</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineRenameMetricTagsProcessor putAdditionalProperty(String key, Object value) {
