...
public class AwsCurConfigResponseDataAttributes {
  ...
  public AwsCurConfigResponseDataAttributes accountFilters(
      AwsCurConfigResponseDataAttributesAccountFilters accountFilters) {
  ...
  /**
   * The <code>attributes</code> <code>bucket_region</code>.
   *
   * @return bucketRegion
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>report_name</code>.
   *
   * @return reportName
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>report_prefix</code>.
   *
   * @return reportPrefix
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    AwsCurConfigResponseDataAttributes awsCurConfigResponseDataAttributes =
        (AwsCurConfigResponseDataAttributes) o;
    return Objects.equals(this.accountFilters, awsCurConfigResponseDataAttributes.accountFilters)
        && Objects.equals(this.accountId, awsCurConfigResponseDataAttributes.accountId)
        && Objects.equals(this.bucketName, awsCurConfigResponseDataAttributes.bucketName)
        && Objects.equals(this.bucketRegion, awsCurConfigResponseDataAttributes.bucketRegion)
        && Objects.equals(this.createdAt, awsCurConfigResponseDataAttributes.createdAt)
        && Objects.equals(this.errorMessages, awsCurConfigResponseDataAttributes.errorMessages)
        && Objects.equals(this.months, awsCurConfigResponseDataAttributes.months)
        && Objects.equals(this.reportName, awsCurConfigResponseDataAttributes.reportName)
        && Objects.equals(this.reportPrefix, awsCurConfigResponseDataAttributes.reportPrefix)
        && Objects.equals(this.status, awsCurConfigResponseDataAttributes.status)
        && Objects.equals(this.statusUpdatedAt, awsCurConfigResponseDataAttributes.statusUpdatedAt)
        && Objects.equals(this.updatedAt, awsCurConfigResponseDataAttributes.updatedAt)
        && Objects.equals(
            this.additionalProperties, awsCurConfigResponseDataAttributes.additionalProperties);
  }
