...
/**
   * <p>Amazon EventBridge list response data.</p>
 */
@JsonPropertyOrder({
...
public class AWSEventBridgeListResponseData {
  ...
  @JsonCreator
  public AWSEventBridgeListResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AWSEventBridgeListResponseAttributes attributes,
  ...
  public AWSEventBridgeListResponseData attributes(AWSEventBridgeListResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSEventBridgeListResponseData awsEventBridgeListResponseData = (AWSEventBridgeListResponseData) o;
    return Objects.equals(this.attributes, awsEventBridgeListResponseData.attributes) && Objects.equals(this.id, awsEventBridgeListResponseData.id) && Objects.equals(this.type, awsEventBridgeListResponseData.type) && Objects.equals(this.additionalProperties, awsEventBridgeListResponseData.additionalProperties);
  }
