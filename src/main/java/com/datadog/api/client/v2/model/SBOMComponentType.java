...
public class SBOMComponentType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("application", "container", "data", "device", "device-driver", "file", "firmware", "framework", "library", "machine-learning-model", "operating-system", "platform"));
  ...
  public static class SBOMComponentTypeSerializer extends StdSerializer<SBOMComponentType> {
      ...
      @Override
      public void serialize(SBOMComponentType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
