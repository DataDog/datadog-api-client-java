...
@JsonPropertyOrder({
  ...
  UpdateTenancyConfigDataAttributesLogsConfig.JSON_PROPERTY_ENABLED_SERVICES
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class UpdateTenancyConfigDataAttributesLogsConfig {
  @JsonIgnore
  ...
  /**
   * <p>List of compartment tag filters to scope log collection to specific compartments.</p>
  ...
  **/
   ...
   * @return UpdateTenancyConfigDataAttributesLogsConfig
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    UpdateTenancyConfigDataAttributesLogsConfig updateTenancyConfigDataAttributesLogsConfig = (UpdateTenancyConfigDataAttributesLogsConfig) o;
    return Objects.equals(this.compartmentTagFilters, updateTenancyConfigDataAttributesLogsConfig.compartmentTagFilters) && Objects.equals(this.enabled, updateTenancyConfigDataAttributesLogsConfig.enabled) && Objects.equals(this.enabledServices, updateTenancyConfigDataAttributesLogsConfig.enabledServices) && Objects.equals(this.additionalProperties, updateTenancyConfigDataAttributesLogsConfig.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateTenancyConfigDataAttributesLogsConfig {\n");
