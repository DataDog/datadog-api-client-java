...
/**
   * <p>The notification settings for a single event type on a control.</p>
 */
@JsonPropertyOrder({
...
public class ControlNotificationEventSetting {
  ...
  public ControlNotificationEventSetting(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TARGETS)List<ControlNotificationTarget> targets) {
  ...
  /**
   * <p>Whether notifications are enabled for this event type.</p>
   * @return enabled
  **/
  ...
  /**
   * <p>The event type the notification settings apply to, such as <code>new_detection</code>.</p>
   * @return eventType
  **/
  ...
  /**
   * <p>The destinations that receive notifications for an event type.</p>
   * @return targets
  **/
  ...
  public boolean equals(Object o) {
    ...
    ControlNotificationEventSetting controlNotificationEventSetting = (ControlNotificationEventSetting) o;
    return Objects.equals(this.enabled, controlNotificationEventSetting.enabled) && Objects.equals(this.eventType, controlNotificationEventSetting.eventType) && Objects.equals(this.targets, controlNotificationEventSetting.targets) && Objects.equals(this.additionalProperties, controlNotificationEventSetting.additionalProperties);
  }
