...
public class CaseNotificationRuleCreateAttributes {
  ...
  @JsonCreator
  public CaseNotificationRuleCreateAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_RECIPIENTS)List<CaseNotificationRuleRecipient> recipients,
            @JsonProperty(required=true, value=JSON_PROPERTY_TRIGGERS)List<CaseNotificationRuleTrigger> triggers) {
  ...
  **/
  ...
  /**
   * <p>Query to filter cases for this notification rule</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of notification recipients</p>
   * @return recipients
  **/
  ...
  /**
   * <p>List of triggers for this notification rule</p>
   * @return triggers
  **/
  ...
  public boolean equals(Object o) {
    ...
    CaseNotificationRuleCreateAttributes caseNotificationRuleCreateAttributes = (CaseNotificationRuleCreateAttributes) o;
