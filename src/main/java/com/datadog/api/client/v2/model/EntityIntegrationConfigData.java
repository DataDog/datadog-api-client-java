...
/**
   * <p>JSON:API resource object for an entity integration configuration.</p>
 */
@JsonPropertyOrder({
...
public class EntityIntegrationConfigData {
  ...
  @JsonCreator
  public EntityIntegrationConfigData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)EntityIntegrationConfigAttributes attributes,
  ...
  /**
   * <p>The organization ID, integration identifier, and integration-specific configuration payload for an entity integration configuration.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Unique identifier of the entity integration configuration.</p>
   * @return id
  **/
  ...
  /**
   * <p>JSON:API resource type for an entity integration configuration. Always <code>entity_integration_configs</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, entityIntegrationConfigData.attributes) && Objects.equals(this.id, entityIntegrationConfigData.id) && Objects.equals(this.type, entityIntegrationConfigData.type) && Objects.equals(this.additionalProperties, entityIntegrationConfigData.additionalProperties);
  }
