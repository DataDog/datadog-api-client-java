...
/**
   * <p>Response payload containing global incident settings.</p>
 */
@JsonPropertyOrder({
  GlobalIncidentSettingsResponse.JSON_PROPERTY_DATA
})
...
public class GlobalIncidentSettingsResponse {
  ...
  @JsonCreator
  public GlobalIncidentSettingsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)GlobalIncidentSettingsDataResponse data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GlobalIncidentSettingsResponse globalIncidentSettingsResponse = (GlobalIncidentSettingsResponse) o;
    return Objects.equals(this.data, globalIncidentSettingsResponse.data) && Objects.equals(this.additionalProperties, globalIncidentSettingsResponse.additionalProperties);
  }
