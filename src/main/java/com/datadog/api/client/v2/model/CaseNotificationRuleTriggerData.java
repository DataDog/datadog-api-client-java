...
public class CaseNotificationRuleTriggerData {
  ...
  /**
   * <p>Change type (added, removed, changed)</p>
   * @return changeType
  **/
  ...
  /**
   * <p>Field name for attribute value changed trigger</p>
   * @return field
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Status ID to transition from</p>
   * @return fromStatus
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Status name to transition from</p>
  ...
  **/
  ...
  /**
   * <p>Status ID to transition to</p>
   * @return toStatus
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Status name to transition to</p>
   * @return toStatusName
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    CaseNotificationRuleTriggerData caseNotificationRuleTriggerData = (CaseNotificationRuleTriggerData) o;
    return Objects.equals(this.changeType, caseNotificationRuleTriggerData.changeType) && Objects.equals(this.field, caseNotificationRuleTriggerData.field) && Objects.equals(this.fromStatus, caseNotificationRuleTriggerData.fromStatus) && Objects.equals(this.fromStatusName, caseNotificationRuleTriggerData.fromStatusName) && Objects.equals(this.toStatus, caseNotificationRuleTriggerData.toStatus) && Objects.equals(this.toStatusName, caseNotificationRuleTriggerData.toStatusName) && Objects.equals(this.additionalProperties, caseNotificationRuleTriggerData.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(changeType,field,fromStatus,fromStatusName,toStatus,toStatusName, additionalProperties);
  }
