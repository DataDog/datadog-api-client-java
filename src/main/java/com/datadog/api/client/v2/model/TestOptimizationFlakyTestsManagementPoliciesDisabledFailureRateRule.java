...
public class TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule {
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule branches(List<String> branches) {
    this.branches = branches;
    return this;
  }
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule addBranchesItem(String branchesItem) {
  ...
  /**
   * <p>List of branches to which this rule applies.</p>
   * @return branches
  **/
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

  /**
   * <p>Whether this failure rate rule is enabled.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Minimum number of runs required before the rule is evaluated. Must be greater than or equal to 0.</p>
   * @return minRuns
  **/
      @jakarta.annotation.Nullable
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule status(TestOptimizationFlakyTestsManagementPoliciesDisabledStatus status) {
    this.status = status;
  ...
  /**
   * <p>Test status that the disable policy applies to.
   * Must be either <code>active</code> or <code>quarantined</code>.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule threshold(Double threshold) {
    this.threshold = threshold;
    return this;
  }

  /**
   * <p>Failure rate threshold (0.0–1.0) above which the rule triggers.</p>
   * @return threshold
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule object is equal to o.
   */
  @Override
