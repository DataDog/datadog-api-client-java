...
public class LLMObsLabelSchemaType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("score", "categorical", "boolean", "text"));
  ...
  public static class LLMObsLabelSchemaTypeSerializer extends StdSerializer<LLMObsLabelSchemaType> {
      ...
      @Override
      public void serialize(LLMObsLabelSchemaType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
