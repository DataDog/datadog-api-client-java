...
public class SecurityMonitoringContentPackStateAttributes {
  ...
  @JsonCreator
  public SecurityMonitoringContentPackStateAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_DETAILS)SecurityMonitoringContentPackStateDetails details,
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)SecurityMonitoringContentPackStatus status) {
        this.details = details;
        this.unparsed |= details.unparsed;
        this.status = status;
        this.unparsed |= !status.isValid();
  }
  public SecurityMonitoringContentPackStateAttributes details(SecurityMonitoringContentPackStateDetails details) {
    this.details = details;
    this.unparsed |= details.unparsed;
    return this;
  }
  ...
  /**
   * <p>Type-specific details for a content pack state. The set of fields present depends
   * on the content pack's <code>type</code>. When Cloud SIEM is inactive for the requesting organization, <code>onboarding</code> is returned instead of the content pack's usual type, such as <code>logs</code> or <code>vulnerability</code>.`</p>
   * @return details
  **/
  ...
  public SecurityMonitoringContentPackStateAttributes status(SecurityMonitoringContentPackStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.details, securityMonitoringContentPackStateAttributes.details) && Objects.equals(this.status, securityMonitoringContentPackStateAttributes.status) && Objects.equals(this.additionalProperties, securityMonitoringContentPackStateAttributes.additionalProperties);
  }
