...
public class OrgConnectionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("org_connection"));
  ...
  public static class OrgConnectionTypeSerializer extends StdSerializer<OrgConnectionType> {
      ...
      @Override
      public void serialize(OrgConnectionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
