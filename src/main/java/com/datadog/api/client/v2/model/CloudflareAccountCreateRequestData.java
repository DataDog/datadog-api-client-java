...
/**
   * <p>Data object for creating a Cloudflare account.</p>
 */
@JsonPropertyOrder({
...
public class CloudflareAccountCreateRequestData {
  ...
  @JsonCreator
  public CloudflareAccountCreateRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CloudflareAccountCreateRequestAttributes attributes,
  ...
  public CloudflareAccountCreateRequestData attributes(CloudflareAccountCreateRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The JSON:API type for this API. Should always be <code>cloudflare-accounts</code>.</p>
   * @return type
  **/
   ...
   * @return CloudflareAccountCreateRequestData
   */
  @JsonAnySetter
  public CloudflareAccountCreateRequestData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CloudflareAccountCreateRequestData cloudflareAccountCreateRequestData = (CloudflareAccountCreateRequestData) o;
    return Objects.equals(this.attributes, cloudflareAccountCreateRequestData.attributes) && Objects.equals(this.type, cloudflareAccountCreateRequestData.type) && Objects.equals(this.additionalProperties, cloudflareAccountCreateRequestData.additionalProperties);
  }
