...
/**
   * <p>Provides basic user information for an escalation policy, including a name and email address.</p>
 */
@JsonPropertyOrder({
...
public class EscalationPolicyUserAttributes {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EscalationPolicyUserAttributes escalationPolicyUserAttributes = (EscalationPolicyUserAttributes) o;
    return Objects.equals(this.email, escalationPolicyUserAttributes.email) && Objects.equals(this.name, escalationPolicyUserAttributes.name) && Objects.equals(this.status, escalationPolicyUserAttributes.status) && Objects.equals(this.additionalProperties, escalationPolicyUserAttributes.additionalProperties);
  }
