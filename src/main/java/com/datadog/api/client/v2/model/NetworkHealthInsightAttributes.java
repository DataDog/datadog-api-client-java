...
/**
   * <p>Detailed attributes of a network health insight.</p>
 */
@JsonPropertyOrder({
...
public class NetworkHealthInsightAttributes {
  ...
  public static final String JSON_PROPERTY_CERTIFICATE_LIFETIME_PERCENT = "certificate_lifetime_percent";
  ...
  /**
   * <p>AWS account identifier where the certificate is located. Only set for <code>tls-cert</code> insights.</p>
   * @return accountId
  **/
  ...
  /**
   * <p>ARN or identifier of the certificate. Only set for <code>tls-cert</code> insights.</p>
  ...
  **/
  ...
  public NetworkHealthInsightAttributes certificateLifetimePercent(Double certificateLifetimePercent) {
    this.certificateLifetimePercent = certificateLifetimePercent;
    return this;
  }

  /**
   * <p>Percentage of the certificate's validity period that has elapsed, ranging from 0 to 100.
   * Only set for <code>tls-cert</code> insights.</p>
  ...
  **/
  ...
  /**
   * <p>AWS region where the client is located. Only set for <code>tls-cert</code> insights.</p>
   * @return clientRegion
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the service making the request (DNS query or TLS-secured connection).
   * Set to <code>N/A</code> when the client service cannot be determined.</p>
  ...
  **/
  ...
  /**
   * <p>Number of days remaining until the certificate expires. Negative values indicate the
   * certificate has already expired. Only set for <code>tls-cert</code> insights.</p>
  ...
  **/
  ...
  /**
   * <p>Domain name that was being resolved when the DNS failure occurred. Only set for <code>dns</code> insights.</p>
   * @return dnsQuery
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>DNS server that received the failing query. Only set for <code>dns</code> insights.</p>
   * @return dnsServer
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Domain name covered by the certificate. Only set for <code>tls-cert</code> insights.</p>
   * @return domainName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Count of failed events observed during the query window. Only set for <code>dns</code>, <code>tcp</code>,
   * and <code>security-group</code> insights.</p>
   * minimum: 0
  ...
  **/
  ...
  /**
   * <p>Percentage of requests that failed during the query window, ranging from 0 to 100.
   * Only set for <code>dns</code>, <code>tcp</code>, and <code>security-group</code> insights.</p>
   * minimum: 0
   * maximum: 100
   * @return failureRate
  **/
  ...
  /**
   * <p>Specific failure type within the insight category. For DNS insights: <code>timeout</code>, <code>nxdomain</code>,
   * <code>servfail</code>, or <code>general_failure</code>. For TLS certificate insights: <code>expired</code> or <code>expiring_soon</code>.
   * For security group insights: <code>denied</code>.</p>
   * @return failureType
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>ARN of the load balancer using the certificate. Only set for <code>tls-cert</code> insights.</p>
  ...
  **/
  ...
  /**
   * <p>AWS region where the server or load balancer is located. Only set for <code>tls-cert</code> insights.</p>
   * @return serverRegion
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the target service the client was trying to reach.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of requests observed during the query window. Provides context for
   * <code>failure_magnitude</code> and <code>failure_rate</code>. Only set for <code>dns</code>, <code>tcp</code>, and <code>security-group</code> insights.</p>
   * minimum: 0
  ...
  **/
  ...
  public NetworkHealthInsightAttributes trafficVolume(NetworkHealthInsightTrafficVolume trafficVolume) {
  ...
  /**
   * <p>Network traffic volume metrics between the client and server services during the query window.</p>
