...
public class ApmMetricsQuery {
  ...
  public ApmMetricsQuery spanKind(String spanKind) {
    this.spanKind = spanKind;
    return this;
  }

  /**
   * Describes the relationship between the span, its parents, and its children in a trace. Known
   * values include consumer, server, client, producer, internal.
   *
   * @return spanKind
   */
  @jakarta.annotation.Nullable
