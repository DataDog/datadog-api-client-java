...
public class DashboardUsageAttributes {
  ...
  private JsonNullable<Map<String, Long>> totalViewsByType = JsonNullable.<Map<String, Long>>undefined();
  ...
  private JsonNullable<Map<String, Long>> widgetCountByType = JsonNullable.<Map<String, Long>>undefined();
  ...
  /**
   * <p>A user referenced from a dashboard usage record (author or viewer).</p>
   * @return author
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AUTHOR)public void setAuthor_JsonNullable(JsonNullable<DashboardUsageUser> author) {
    this.author = author;
  }
  ...
  /**
   * <p>When the dashboard was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The dashboard quality score, or <code>null</code> when no score is available.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DASHBOARD_QUALITY_SCORE)public void setDashboardQualityScore_JsonNullable(JsonNullable<Double> dashboardQualityScore) {
  ...
  /**
   * <p>When the dashboard was most recently edited.</p>
   * @return editedAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_EDITED_AT)public void setEditedAt_JsonNullable(JsonNullable<OffsetDateTime> editedAt) {
  ...
  /**
   * <p>The Datadog organization that owns the dashboard.</p>
   * @return orgId
  **/
  ...
  /**
   * <p>Teams the dashboard is tagged with.</p>
   * @return teams
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_TEAMS)public void setTeams_JsonNullable(JsonNullable<List<String>> teams) {
    this.teams = teams;
  }
  ...
  **/
  ...
  /**
   * <p>Total view count for the dashboard. Counts only views captured by Real User Monitoring (RUM); <code>0</code> in orgs without RUM.</p>
   * @return totalViews
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>View counts keyed by view type (<code>in_app</code>, <code>embed</code>, <code>public</code>, <code>shared</code>, <code>api</code>, <code>unknown</code>). Counts only views captured by Real User Monitoring (RUM); empty in orgs without RUM.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_TOTAL_VIEWS_BY_TYPE)public void setTotalViewsByType_JsonNullable(JsonNullable<Map<String, Long>> totalViewsByType) {
  ...
  /**
   * <p>When the dashboard was most recently viewed. Populated only when Real User Monitoring (RUM) is active for the org; <code>null</code> in orgs without RUM.</p>
   * @return viewedAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_VIEWED_AT)public void setViewedAt_JsonNullable(JsonNullable<OffsetDateTime> viewedAt) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_VIEWER)public void setViewer_JsonNullable(JsonNullable<DashboardUsageUser> viewer) {
    this.viewer = viewer;
  }
  ...
  /**
   * <p>The total number of widgets on the dashboard.</p>
   * @return widgetCount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_WIDGET_COUNT)public void setWidgetCount_JsonNullable(JsonNullable<Long> widgetCount) {
  ...
  /**
   * <p>Widget counts keyed by widget type. The map includes group widgets and widgets without requests.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_WIDGET_COUNT_BY_TYPE)public void setWidgetCountByType_JsonNullable(JsonNullable<Map<String, Long>> widgetCountByType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.author, dashboardUsageAttributes.author) && Objects.equals(this.createdAt, dashboardUsageAttributes.createdAt) && Objects.equals(this.dashboardQualityScore, dashboardUsageAttributes.dashboardQualityScore) && Objects.equals(this.editedAt, dashboardUsageAttributes.editedAt) && Objects.equals(this.orgId, dashboardUsageAttributes.orgId) && Objects.equals(this.teams, dashboardUsageAttributes.teams) && Objects.equals(this.title, dashboardUsageAttributes.title) && Objects.equals(this.totalViews, dashboardUsageAttributes.totalViews) && Objects.equals(this.totalViewsByType, dashboardUsageAttributes.totalViewsByType) && Objects.equals(this.viewedAt, dashboardUsageAttributes.viewedAt) && Objects.equals(this.viewer, dashboardUsageAttributes.viewer) && Objects.equals(this.widgetCount, dashboardUsageAttributes.widgetCount) && Objects.equals(this.widgetCountByType, dashboardUsageAttributes.widgetCountByType) && Objects.equals(this.additionalProperties, dashboardUsageAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(author,createdAt,dashboardQualityScore,editedAt,orgId,teams,title,totalViews,totalViewsByType,viewedAt,viewer,widgetCount,widgetCountByType, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    dashboardQualityScore: ").append(toIndentedString(dashboardQualityScore)).append("\n");
