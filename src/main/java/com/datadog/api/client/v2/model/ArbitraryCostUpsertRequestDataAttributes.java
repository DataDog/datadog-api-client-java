...
/** The definition of <code>ArbitraryCostUpsertRequestDataAttributes</code> object. */
@JsonPropertyOrder({
...
public class ArbitraryCostUpsertRequestDataAttributes {
  ...
  private List<ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems> costsToAllocate =
      new ArrayList<>();
  ...
  public ArbitraryCostUpsertRequestDataAttributes costsToAllocate(
      List<ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems> costsToAllocate) {
    this.costsToAllocate = costsToAllocate;
  ...
  public ArbitraryCostUpsertRequestDataAttributes addCostsToAllocateItem(
      ArbitraryCostUpsertRequestDataAttributesCostsToAllocateItems costsToAllocateItem) {
  ...
  public ArbitraryCostUpsertRequestDataAttributes strategy(
      ArbitraryCostUpsertRequestDataAttributesStrategy strategy) {
    this.strategy = strategy;
    this.unparsed |= strategy.unparsed;
    return this;
  ...
  public boolean equals(Object o) {
    ...
    ArbitraryCostUpsertRequestDataAttributes arbitraryCostUpsertRequestDataAttributes =
        (ArbitraryCostUpsertRequestDataAttributes) o;
    return Objects.equals(
            this.costsToAllocate, arbitraryCostUpsertRequestDataAttributes.costsToAllocate)
        && Objects.equals(this.enabled, arbitraryCostUpsertRequestDataAttributes.enabled)
        && Objects.equals(this.orderId, arbitraryCostUpsertRequestDataAttributes.orderId)
        && Objects.equals(this.provider, arbitraryCostUpsertRequestDataAttributes.provider)
        && Objects.equals(this.rejected, arbitraryCostUpsertRequestDataAttributes.rejected)
        && Objects.equals(this.ruleName, arbitraryCostUpsertRequestDataAttributes.ruleName)
        && Objects.equals(this.strategy, arbitraryCostUpsertRequestDataAttributes.strategy)
        && Objects.equals(this.type, arbitraryCostUpsertRequestDataAttributes.type)
        && Objects.equals(
            this.additionalProperties,
            arbitraryCostUpsertRequestDataAttributes.additionalProperties);
  }
