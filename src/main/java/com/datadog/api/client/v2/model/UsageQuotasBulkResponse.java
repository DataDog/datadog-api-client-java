...
/**
 * Response containing the result of a bulk usage quota create-or-update request. Returned with a
 * <code>200</code> status regardless of whether individual items succeeded or failed; check each
 * item's <code>error</code> attribute to determine its outcome.
 */
@JsonPropertyOrder({UsageQuotasBulkResponse.JSON_PROPERTY_DATA})
...
public class UsageQuotasBulkResponse {
  ...
  public UsageQuotasBulkResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          List<UsageQuotaBulkResultData> data) {
    this.data = data;
  ...
  /**
   * The results of writing each usage quota in a bulk create-or-update request, in the same order
   * as the request.
   *
   * @return data
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, usageQuotasBulkResponse.data)
        && Objects.equals(this.additionalProperties, usageQuotasBulkResponse.additionalProperties);
  }
