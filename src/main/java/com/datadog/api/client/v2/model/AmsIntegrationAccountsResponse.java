...
public class AmsIntegrationAccountsResponse {
  ...
  private List<AmsIntegrationAccountResponseData> data = null;

  public static final String JSON_PROPERTY_INTEGRATION_NAME = "integration_name";
  private String integrationName;

  public AmsIntegrationAccountsResponse data(List<AmsIntegrationAccountResponseData> data) {
    this.data = data;
  ...
  public List<AmsIntegrationAccountResponseData> getData() {
    return data;
  }

  public void setData(List<AmsIntegrationAccountResponseData> data) {
    this.data = data;
  }
