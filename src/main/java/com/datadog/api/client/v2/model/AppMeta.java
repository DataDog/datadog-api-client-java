...
public class AppMeta {
  ...
  /**
   * <p>Timestamp of when the app was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Timestamp of when the app was deleted.</p>
   * @return deletedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The Datadog organization ID that owns the app.</p>
   * @return orgId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp of when the app was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the app was updated since it was last published. Published apps are pinned to a specific version and do not automatically update when the app is updated.</p>
  ...
  **/
  ...
  /**
   * <p>The ID of the user who created the app.</p>
   * @return userId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name (or email address) of the user who created the app.</p>
   * @return userName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The UUID of the user who created the app.</p>
   * @return userUuid
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The version number of the app. This starts at 1 and increments with each update.</p>
   * @return version
  **/
      @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt,deletedAt,orgId,updatedAt,updatedSinceDeployment,userId,userName,userUuid,version, additionalProperties);
  }
