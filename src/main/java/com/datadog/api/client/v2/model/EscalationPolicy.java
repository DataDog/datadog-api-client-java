...
/**
   * <p>Represents a complete escalation policy response, including policy data and optionally included related resources.</p>
 */
@JsonPropertyOrder({
  EscalationPolicy.JSON_PROPERTY_DATA,
  EscalationPolicy.JSON_PROPERTY_INCLUDED
})
...
public class EscalationPolicy {
  ...
  **/
  ...
  /**
   * <p>Provides any included related resources, such as steps or targets, returned with the policy.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, escalationPolicy.data) && Objects.equals(this.included, escalationPolicy.included) && Objects.equals(this.additionalProperties, escalationPolicy.additionalProperties);
  }
