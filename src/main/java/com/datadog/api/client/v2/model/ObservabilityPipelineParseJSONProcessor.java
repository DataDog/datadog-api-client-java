...
/**
   * <p>The <code>parse_json</code> processor extracts JSON from a specified field and flattens it into the event. This is useful when logs contain embedded JSON as a string.</p>
...
public class ObservabilityPipelineParseJSONProcessor {
  ...
  private ObservabilityPipelineParseJSONProcessorType type = ObservabilityPipelineParseJSONProcessorType.PARSE_JSON;
  ...
  public ObservabilityPipelineParseJSONProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineParseJSONProcessorType type) {
  ...
  **/
  ...
  /**
   * <p>The name of the log field that contains a JSON string.</p>
   * @return field
  **/
  ...
  **/
  ...
  public ObservabilityPipelineParseJSONProcessor type(ObservabilityPipelineParseJSONProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>parse_json</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineParseJSONProcessor observabilityPipelineParseJsonProcessor = (ObservabilityPipelineParseJSONProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineParseJsonProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineParseJsonProcessor.enabled) && Objects.equals(this.field, observabilityPipelineParseJsonProcessor.field) && Objects.equals(this.id, observabilityPipelineParseJsonProcessor.id) && Objects.equals(this.include, observabilityPipelineParseJsonProcessor.include) && Objects.equals(this.type, observabilityPipelineParseJsonProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineParseJsonProcessor.additionalProperties);
  }
