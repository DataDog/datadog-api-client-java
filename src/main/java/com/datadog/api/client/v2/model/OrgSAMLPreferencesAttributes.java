...
public class OrgSAMLPreferencesAttributes {
  ...
  @JsonCreator
  public OrgSAMLPreferencesAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_DEFAULT_ROLE_UUIDS)List<UUID> defaultRoleUuids,
  ...
  /**
   * <p>The UUID of the default role assigned to just-in-time provisioned users.
   * Exactly one role UUID must be provided.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultRoleUuids, orgSamlPreferencesAttributes.defaultRoleUuids) && Objects.equals(this.jitDomains, orgSamlPreferencesAttributes.jitDomains) && Objects.equals(this.additionalProperties, orgSamlPreferencesAttributes.additionalProperties);
  }
