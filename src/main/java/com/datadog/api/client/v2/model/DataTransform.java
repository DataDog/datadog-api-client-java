...
/**
   * <p>A data transformer, which is custom JavaScript code that executes and transforms data when its inputs change.</p>
 */
@JsonPropertyOrder({
...
public class DataTransform {
  ...
  public DataTransform(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_PROPERTIES)DataTransformProperties properties,
  ...
  /**
   * <p>The ID of the data transformer.</p>
   * @return id
  **/
  ...
  /**
   * <p>A unique identifier for this data transformer. This name is also used to access the transformer's result throughout the app.</p>
   * @return name
  **/
