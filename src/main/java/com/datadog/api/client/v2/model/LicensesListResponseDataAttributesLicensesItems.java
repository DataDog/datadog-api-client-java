...
/**
   * <p>An SPDX license entry returned by the licenses list endpoint.</p>
 */
@JsonPropertyOrder({
...
public class LicensesListResponseDataAttributesLicensesItems {
  ...
  /**
   * <p>The human-readable name of the license.</p>
   * @return displayName
  **/
  ...
  /**
   * <p>The SPDX identifier of the license.</p>
   * @return identifier
  **/
  ...
  /**
   * <p>The short name of the license, typically matching the SPDX identifier.</p>
   * @return shortName
  **/
  ...
  public boolean equals(Object o) {
    ...
    LicensesListResponseDataAttributesLicensesItems licensesListResponseDataAttributesLicensesItems = (LicensesListResponseDataAttributesLicensesItems) o;
