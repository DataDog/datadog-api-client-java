...
public class ContainerGroupType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("container_group"));

  public static final ContainerGroupType CONTAINER_GROUP = new ContainerGroupType("container_group");
  ...
  public static class ContainerGroupTypeSerializer extends StdSerializer<ContainerGroupType> {
      ...
      @Override
      public void serialize(ContainerGroupType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
