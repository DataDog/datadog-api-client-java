...
public class ApplicationSecurityWafCustomRuleMetadata {
  ...
  /**
   * <p>The date and time the WAF custom rule was created.</p>
   * @return addedAt
  **/
  ...
  /**
   * <p>The handle of the user who created the WAF custom rule.</p>
   * @return addedBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name of the user who created the WAF custom rule.</p>
   * @return addedByName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The date and time the WAF custom rule was last updated.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The handle of the user who last updated the WAF custom rule.</p>
   * @return modifiedBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name of the user who last updated the WAF custom rule.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleMetadata applicationSecurityWafCustomRuleMetadata = (ApplicationSecurityWafCustomRuleMetadata) o;
