...
public class OrgGroupPolicyConfigAttributes {
  ...
  @JsonCreator
  public OrgGroupPolicyConfigAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ALLOWED_VALUES)List<String> allowedValues,
  ...
  /**
   * <p>The allowed values for this config.</p>
  ...
  **/
  ...
  /**
   * <p>The default value for this config.</p>
   * @return defaultValue
  **/
  ...
  /**
   * <p>The description of the policy config.</p>
   * @return description
  **/
  ...
  /**
   * <p>The name of the policy config.</p>
   * @return name
  **/
  ...
  /**
   * <p>The type of the value for this config.</p>
   * @return valueType
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrgGroupPolicyConfigAttributes orgGroupPolicyConfigAttributes = (OrgGroupPolicyConfigAttributes) o;
    return Objects.equals(this.allowedValues, orgGroupPolicyConfigAttributes.allowedValues) && Objects.equals(this.defaultValue, orgGroupPolicyConfigAttributes.defaultValue) && Objects.equals(this.description, orgGroupPolicyConfigAttributes.description) && Objects.equals(this.name, orgGroupPolicyConfigAttributes.name) && Objects.equals(this.valueType, orgGroupPolicyConfigAttributes.valueType) && Objects.equals(this.additionalProperties, orgGroupPolicyConfigAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(allowedValues,defaultValue,description,name,valueType, additionalProperties);
  }
