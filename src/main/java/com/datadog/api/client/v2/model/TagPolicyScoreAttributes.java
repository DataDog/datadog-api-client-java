...
/**
   * <p>Attributes of a tag policy compliance score.</p>
 */
@JsonPropertyOrder({
...
public class TagPolicyScoreAttributes {
  ...
  /**
   * <p>The compliance score for the policy over the requested time window, as a percentage
   * between 0 and 100. <code>null</code> indicates that no relevant telemetry was found.</p>
   * @return score
  **/
  ...
  /**
   * <p>End of the time window the score was computed over, as a Unix timestamp in milliseconds.</p>
   * @return tsEnd
  **/
  ...
  /**
   * <p>Start of the time window the score was computed over, as a Unix timestamp in milliseconds.</p>
   * @return tsStart
  **/
  ...
  /**
   * <p>The version of the tag policy that the score was computed against.</p>
   * @return version
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.score, tagPolicyScoreAttributes.score) && Objects.equals(this.tsEnd, tagPolicyScoreAttributes.tsEnd) && Objects.equals(this.tsStart, tagPolicyScoreAttributes.tsStart) && Objects.equals(this.version, tagPolicyScoreAttributes.version) && Objects.equals(this.additionalProperties, tagPolicyScoreAttributes.additionalProperties);
  }
