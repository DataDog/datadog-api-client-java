...
public class ScannedAssetMetadataLastSuccess {
  ...
  /**
   * <p>The environment of the last success scan of the asset.</p>
   * @return env
  **/
  ...
  /**
   * <p>The list of origins of the last success scan of the asset.</p>
   * @return origin
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The timestamp of the last success scan of the asset.</p>
   * @return timestamp
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScannedAssetMetadataLastSuccess scannedAssetMetadataLastSuccess = (ScannedAssetMetadataLastSuccess) o;
    return Objects.equals(this.env, scannedAssetMetadataLastSuccess.env) && Objects.equals(this.origin, scannedAssetMetadataLastSuccess.origin) && Objects.equals(this.timestamp, scannedAssetMetadataLastSuccess.timestamp) && Objects.equals(this.additionalProperties, scannedAssetMetadataLastSuccess.additionalProperties);
  }
