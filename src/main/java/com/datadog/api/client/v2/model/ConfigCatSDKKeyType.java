...
public class ConfigCatSDKKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("ConfigCatSDKKey"));

  public static final ConfigCatSDKKeyType CONFIGCATSDKKEY =
      new ConfigCatSDKKeyType("ConfigCatSDKKey");
  ...
  public static class ConfigCatSDKKeyTypeSerializer extends StdSerializer<ConfigCatSDKKeyType> {
    ...
    public void serialize(
        ConfigCatSDKKeyType value, JsonGenerator jgen, SerializerProvider provider)
