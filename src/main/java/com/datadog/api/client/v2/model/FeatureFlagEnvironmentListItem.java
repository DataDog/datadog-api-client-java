...
/**
   * <p>Environment-specific settings for a feature flag in list responses.</p>
 */
@JsonPropertyOrder({
...
public class FeatureFlagEnvironmentListItem {
  ...
  **/
  ...
  public FeatureFlagEnvironmentListItem requireFeatureFlagApproval(Boolean requireFeatureFlagApproval) {
