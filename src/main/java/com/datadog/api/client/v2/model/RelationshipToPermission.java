...
public class RelationshipToPermission {
  ...
  public RelationshipToPermission() {}

  @JsonCreator
  public RelationshipToPermission(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          RelationshipToPermissionData data) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, relationshipToPermission.data)
        && Objects.equals(this.additionalProperties, relationshipToPermission.additionalProperties);
  }
