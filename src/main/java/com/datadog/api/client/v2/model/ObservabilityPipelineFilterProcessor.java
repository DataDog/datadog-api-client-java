...
/**
   * <p>The <code>filter</code> processor allows conditional processing of logs/metrics based on a Datadog search query. Logs/metrics that match the <code>include</code> query are passed through; others are discarded.</p>
...
public class ObservabilityPipelineFilterProcessor {
  ...
  private ObservabilityPipelineFilterProcessorType type = ObservabilityPipelineFilterProcessorType.FILTER;
  ...
  public ObservabilityPipelineFilterProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineFilterProcessorType type) {
  ...
  **/
  ...
  public ObservabilityPipelineFilterProcessor include(String include) {
    this.include = include;
    return this;
  }

  /**
   * <p>A Datadog search query used to determine which logs/metrics should pass through the filter. Logs/metrics that match this query continue to downstream components; others are dropped.</p>
   * @return include
  **/
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public ObservabilityPipelineFilterProcessorType getType() {
        return type;
      }
  public void setType(ObservabilityPipelineFilterProcessorType type) {
    if (!type.isValid()) {
        this.unparsed = true;
    }
    this.type = type;
   ...
   * @return ObservabilityPipelineFilterProcessor
   */
  @JsonAnySetter
  public ObservabilityPipelineFilterProcessor putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ObservabilityPipelineFilterProcessor object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineFilterProcessor observabilityPipelineFilterProcessor = (ObservabilityPipelineFilterProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineFilterProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineFilterProcessor.enabled) && Objects.equals(this.id, observabilityPipelineFilterProcessor.id) && Objects.equals(this.include, observabilityPipelineFilterProcessor.include) && Objects.equals(this.type, observabilityPipelineFilterProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineFilterProcessor.additionalProperties);
  }
