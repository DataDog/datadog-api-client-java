...
@JsonPropertyOrder({
  DashboardReportCreateAttributes.JSON_PROPERTY_DESCRIPTION,
  DashboardReportCreateAttributes.JSON_PROPERTY_DESTINATIONS,
  DashboardReportCreateAttributes.JSON_PROPERTY_SCHEDULE,
  DashboardReportCreateAttributes.JSON_PROPERTY_TEMPLATE_VARIABLES,
  DashboardReportCreateAttributes.JSON_PROPERTY_TIMEFRAME,
  DashboardReportCreateAttributes.JSON_PROPERTY_TITLE
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class DashboardReportCreateAttributes {
  ...
  public DashboardReportCreateAttributes description(String description) {
  ...
  public DashboardReportCreateAttributes destinations(DashboardReportDestination destinations) {
    this.destinations = destinations;
    this.unparsed |= destinations.unparsed;
    return this;
  }
  ...
  public DashboardReportCreateAttributes schedule(DashboardReportSchedule schedule) {
    this.schedule = schedule;
    this.unparsed |= schedule.unparsed;
    return this;
  }
  ...
  public DashboardReportCreateAttributes templateVariables(Map<String, String> templateVariables) {
    this.templateVariables = templateVariables;
    return this;
  }

  public DashboardReportCreateAttributes putTemplateVariablesItem(
  ...
  public DashboardReportCreateAttributes timeframe(DashboardReportTimeframe timeframe) {
    this.timeframe = timeframe;
    this.unparsed |= !timeframe.isValid();
    return this;
  }
  ...
  public DashboardReportCreateAttributes title(String title) {
    this.title = title;
    return this;
  }
  ...
  /** Return true if this DashboardReportCreateAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    DashboardReportCreateAttributes dashboardReportCreateAttributes =
        (DashboardReportCreateAttributes) o;
    return Objects.equals(this.description, dashboardReportCreateAttributes.description)
        && Objects.equals(this.destinations, dashboardReportCreateAttributes.destinations)
        && Objects.equals(this.schedule, dashboardReportCreateAttributes.schedule)
        && Objects.equals(this.templateVariables, dashboardReportCreateAttributes.templateVariables)
        && Objects.equals(this.timeframe, dashboardReportCreateAttributes.timeframe)
        && Objects.equals(this.title, dashboardReportCreateAttributes.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class DashboardReportCreateAttributes {\n");
