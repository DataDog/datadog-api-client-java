...
public class InterfaceAttributesStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("up", "down", "warning", "off"));
  ...
  public static class InterfaceAttributesStatusSerializer extends StdSerializer<InterfaceAttributesStatus> {
      ...
      @Override
      public void serialize(InterfaceAttributesStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
