...
public class CsmAgentlessHostType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("agentless_host"));

  public static final CsmAgentlessHostType AGENTLESS_HOST = new CsmAgentlessHostType("agentless_host");
  ...
  public static class CsmAgentlessHostTypeSerializer extends StdSerializer<CsmAgentlessHostType> {
      ...
      @Override
      public void serialize(CsmAgentlessHostType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
