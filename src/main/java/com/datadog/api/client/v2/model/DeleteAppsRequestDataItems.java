...
/** The definition of <code>DeleteAppsRequestDataItems</code> object. */
@JsonPropertyOrder({
...
public class DeleteAppsRequestDataItems {
  ...
  private DeleteAppsRequestDataItemsType type = DeleteAppsRequestDataItemsType.APPDEFINITIONS;
  ...
  public DeleteAppsRequestDataItems(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          DeleteAppsRequestDataItemsType type) {
    this.id = id;
    this.type = type;
    this.unparsed |= !type.isValid();
  }

  public DeleteAppsRequestDataItems id(String id) {
    this.id = id;
    return this;
  }
  ...
  public DeleteAppsRequestDataItems type(DeleteAppsRequestDataItemsType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public DeleteAppsRequestDataItemsType getType() {
    return type;
  }

  public void setType(DeleteAppsRequestDataItemsType type) {
    if (!type.isValid()) {
      this.unparsed = true;
    }
    this.type = type;
