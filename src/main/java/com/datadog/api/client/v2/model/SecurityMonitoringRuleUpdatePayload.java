...
public class SecurityMonitoringRuleUpdatePayload {
  ...
  public SecurityMonitoringRuleUpdatePayload calculatedFields(List<CalculatedField> calculatedFields) {
  ...
  public SecurityMonitoringRuleUpdatePayload addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  **/
  ...
  /**
   * <p>Custom/Overridden name (used in case of Default rule update).</p>
   * @return customName
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public SecurityMonitoringRuleUpdatePayload referenceTables(List<SecurityMonitoringReferenceTable> referenceTables) {
  ...
  public SecurityMonitoringRuleUpdatePayload addReferenceTablesItem(SecurityMonitoringReferenceTable referenceTablesItem) {
  ...
  **/
  ...
  public SecurityMonitoringRuleUpdatePayload schedulingOptions(SecurityMonitoringSchedulingOptions schedulingOptions) {
  ...
  **/
  ...
  public SecurityMonitoringRuleUpdatePayload thirdPartyCases(List<SecurityMonitoringThirdPartyRuleCase> thirdPartyCases) {
  ...
  public SecurityMonitoringRuleUpdatePayload addThirdPartyCasesItem(SecurityMonitoringThirdPartyRuleCase thirdPartyCasesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.calculatedFields, securityMonitoringRuleUpdatePayload.calculatedFields) && Objects.equals(this.cases, securityMonitoringRuleUpdatePayload.cases) && Objects.equals(this.complianceSignalOptions, securityMonitoringRuleUpdatePayload.complianceSignalOptions) && Objects.equals(this.customMessage, securityMonitoringRuleUpdatePayload.customMessage) && Objects.equals(this.customName, securityMonitoringRuleUpdatePayload.customName) && Objects.equals(this.filters, securityMonitoringRuleUpdatePayload.filters) && Objects.equals(this.groupSignalsBy, securityMonitoringRuleUpdatePayload.groupSignalsBy) && Objects.equals(this.hasExtendedTitle, securityMonitoringRuleUpdatePayload.hasExtendedTitle) && Objects.equals(this.isEnabled, securityMonitoringRuleUpdatePayload.isEnabled) && Objects.equals(this.message, securityMonitoringRuleUpdatePayload.message) && Objects.equals(this.name, securityMonitoringRuleUpdatePayload.name) && Objects.equals(this.options, securityMonitoringRuleUpdatePayload.options) && Objects.equals(this.queries, securityMonitoringRuleUpdatePayload.queries) && Objects.equals(this.referenceTables, securityMonitoringRuleUpdatePayload.referenceTables) && Objects.equals(this.schedulingOptions, securityMonitoringRuleUpdatePayload.schedulingOptions) && Objects.equals(this.tags, securityMonitoringRuleUpdatePayload.tags) && Objects.equals(this.thirdPartyCases, securityMonitoringRuleUpdatePayload.thirdPartyCases) && Objects.equals(this.version, securityMonitoringRuleUpdatePayload.version) && Objects.equals(this.additionalProperties, securityMonitoringRuleUpdatePayload.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(calculatedFields,cases,complianceSignalOptions,customMessage,customName,filters,groupSignalsBy,hasExtendedTitle,isEnabled,message,name,options,queries,referenceTables,schedulingOptions,tags,thirdPartyCases,version, additionalProperties);
  }
