...
/**
   * <p>The <code>amazon_s3_generic</code> destination sends your logs to an Amazon S3 bucket.</p>
...
public class ObservabilityPipelineAmazonS3GenericDestination {
  ...
  private ObservabilityPipelineAmazonS3GenericDestinationType type = ObservabilityPipelineAmazonS3GenericDestinationType.GENERIC_ARCHIVES_S3;
  ...
  public ObservabilityPipelineAmazonS3GenericDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_COMPRESSION)ObservabilityPipelineAmazonS3GenericCompression compression,
            @JsonProperty(required=true, value=JSON_PROPERTY_ENCODING)ObservabilityPipelineAmazonS3GenericEncoding encoding,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineAmazonS3GenericDestinationType type) {
        this.bucket = bucket;
  ...
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination batchSettings(ObservabilityPipelineAmazonS3GenericBatchSettings batchSettings) {
  ...
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
  ...
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination compression(ObservabilityPipelineAmazonS3GenericCompression compression) {
    this.compression = compression;
    this.unparsed |= compression.unparsed;
    return this;
  }
  ...
  /**
   * <p>Compression algorithm applied to encoded logs.</p>
   * @return compression
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination encoding(ObservabilityPipelineAmazonS3GenericEncoding encoding) {
    this.encoding = encoding;
    this.unparsed |= encoding.unparsed;
    return this;
  }
  ...
  /**
   * <p>Encoding format for the destination.</p>
   * @return encoding
  **/
  ...
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination serverSideEncryption(ObservabilityPipelineAmazonS3DestinationServerSideEncryption serverSideEncryption) {
  ...
  **/
  ...
  public void setServerSideEncryption(ObservabilityPipelineAmazonS3DestinationServerSideEncryption serverSideEncryption) {
  ...
  /**
   * <p>The AWS KMS key ID used for SSE-KMS encryption.
   * Only applies when <code>server_side_encryption</code> is set to <code>aws:kms</code>.</p>
   * @return ssekmsKeyId
  **/
      @jakarta.annotation.Nullable
  ...
  public ObservabilityPipelineAmazonS3GenericDestination storageClass(ObservabilityPipelineAmazonS3DestinationStorageClass storageClass) {
    this.storageClass = storageClass;
    this.unparsed |= !storageClass.isValid();
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineAmazonS3GenericDestination type(ObservabilityPipelineAmazonS3GenericDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. Always <code>amazon_s3_generic</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineAmazonS3GenericDestination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineAmazonS3GenericDestination observabilityPipelineAmazonS3GenericDestination = (ObservabilityPipelineAmazonS3GenericDestination) o;
    return Objects.equals(this.auth, observabilityPipelineAmazonS3GenericDestination.auth) && Objects.equals(this.batchSettings, observabilityPipelineAmazonS3GenericDestination.batchSettings) && Objects.equals(this.bucket, observabilityPipelineAmazonS3GenericDestination.bucket) && Objects.equals(this.buffer, observabilityPipelineAmazonS3GenericDestination.buffer) && Objects.equals(this.compression, observabilityPipelineAmazonS3GenericDestination.compression) && Objects.equals(this.encoding, observabilityPipelineAmazonS3GenericDestination.encoding) && Objects.equals(this.id, observabilityPipelineAmazonS3GenericDestination.id) && Objects.equals(this.inputs, observabilityPipelineAmazonS3GenericDestination.inputs) && Objects.equals(this.keyPrefix, observabilityPipelineAmazonS3GenericDestination.keyPrefix) && Objects.equals(this.region, observabilityPipelineAmazonS3GenericDestination.region) && Objects.equals(this.serverSideEncryption, observabilityPipelineAmazonS3GenericDestination.serverSideEncryption) && Objects.equals(this.ssekmsKeyId, observabilityPipelineAmazonS3GenericDestination.ssekmsKeyId) && Objects.equals(this.storageClass, observabilityPipelineAmazonS3GenericDestination.storageClass) && Objects.equals(this.type, observabilityPipelineAmazonS3GenericDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineAmazonS3GenericDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(auth,batchSettings,bucket,buffer,compression,encoding,id,inputs,keyPrefix,region,serverSideEncryption,ssekmsKeyId,storageClass,type, additionalProperties);
  }
