...
public class SyntheticsTestResultVariable {
  ...
  /**
   * <p>Error encountered when evaluating the variable.</p>
   * @return err
  **/
  ...
  /**
   * <p>Human-readable error message for variable evaluation.</p>
   * @return errorMessage
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Example value for the variable.</p>
   * @return example
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Pattern used to extract the variable.</p>
   * @return pattern
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the variable holds a secure value.</p>
   * @return secure
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Evaluated value of the variable.</p>
   * @return val
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.err, syntheticsTestResultVariable.err) && Objects.equals(this.errorMessage, syntheticsTestResultVariable.errorMessage) && Objects.equals(this.example, syntheticsTestResultVariable.example) && Objects.equals(this.id, syntheticsTestResultVariable.id) && Objects.equals(this.name, syntheticsTestResultVariable.name) && Objects.equals(this.pattern, syntheticsTestResultVariable.pattern) && Objects.equals(this.secure, syntheticsTestResultVariable.secure) && Objects.equals(this.type, syntheticsTestResultVariable.type) && Objects.equals(this.val, syntheticsTestResultVariable.val) && Objects.equals(this.value, syntheticsTestResultVariable.value) && Objects.equals(this.additionalProperties, syntheticsTestResultVariable.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(err,errorMessage,example,id,name,pattern,secure,type,val,value, additionalProperties);
  }
