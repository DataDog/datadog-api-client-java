...
/**
 * Attributes of a personal access token including the secret key value. This is only returned when
...
@JsonPropertyOrder({
  ...
  FullPersonalAccessTokenAttributes.JSON_PROPERTY_MODIFIED_AT,
...
public class FullPersonalAccessTokenAttributes {
  ...
  public FullPersonalAccessTokenAttributes() {}
  ...
  public FullPersonalAccessTokenAttributes expiresAt(OffsetDateTime expiresAt) {
    this.expiresAt = expiresAt;
    return this;
  }
  ...
  /**
   * The secret token value. This is only returned when creating a new personal access token and
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, fullPersonalAccessTokenAttributes.createdAt)
        ...
        && Objects.equals(this.modifiedAt, fullPersonalAccessTokenAttributes.modifiedAt)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, expiresAt, key, modifiedAt, name, scopes, additionalProperties);
  }
