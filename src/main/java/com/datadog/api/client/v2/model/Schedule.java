...
/**
   * <p>Top-level container for a schedule object, including both the <code>data</code> payload and any related <code>included</code> resources (such as teams, layers, or members).</p>
 */
@JsonPropertyOrder({
  Schedule.JSON_PROPERTY_DATA,
  Schedule.JSON_PROPERTY_INCLUDED
})
...
public class Schedule {
  ...
  **/
  ...
  /**
   * <p>Any additional resources related to this schedule, such as teams and layers.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, schedule.data) && Objects.equals(this.included, schedule.included) && Objects.equals(this.additionalProperties, schedule.additionalProperties);
  }
