...
/**
   * <p>A template variable that viewers can modify on the shared dashboard.</p>
 */
@JsonPropertyOrder({
...
public class SharedDashboardSelectableTemplateVariable {
  ...
  /**
   * <p>Whether viewers can see all tag values for the template variable and specify any value.</p>
  ...
  **/
  ...
  /**
   * <p>Default selected values for the variable.</p>
  ...
  **/
  ...
  /**
   * <p>Tag prefix for the variable.</p>
   * @return prefix
  **/
  ...
  /**
   * <p>Type of the template variable.</p>
   * @return type
  **/
  ...
  /**
   * <p>Restricts which tag values are visible to the viewer.</p>
   * @return visibleTags
  **/
  ...
  public boolean equals(Object o) {
    ...
    SharedDashboardSelectableTemplateVariable sharedDashboardSelectableTemplateVariable = (SharedDashboardSelectableTemplateVariable) o;
    return Objects.equals(this.allowAnyValue, sharedDashboardSelectableTemplateVariable.allowAnyValue) && Objects.equals(this.defaultValues, sharedDashboardSelectableTemplateVariable.defaultValues) && Objects.equals(this.name, sharedDashboardSelectableTemplateVariable.name) && Objects.equals(this.prefix, sharedDashboardSelectableTemplateVariable.prefix) && Objects.equals(this.type, sharedDashboardSelectableTemplateVariable.type) && Objects.equals(this.visibleTags, sharedDashboardSelectableTemplateVariable.visibleTags) && Objects.equals(this.additionalProperties, sharedDashboardSelectableTemplateVariable.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(allowAnyValue,defaultValues,name,prefix,type,visibleTags, additionalProperties);
  }
