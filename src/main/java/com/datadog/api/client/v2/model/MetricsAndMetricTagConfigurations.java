...
@JsonDeserialize(using = MetricsAndMetricTagConfigurations.MetricsAndMetricTagConfigurationsDeserializer.class)
@JsonSerialize(using = MetricsAndMetricTagConfigurations.MetricsAndMetricTagConfigurationsSerializer.class)
public class MetricsAndMetricTagConfigurations extends AbstractOpenApiSchema {
    ...
    public static class MetricsAndMetricTagConfigurationsSerializer extends StdSerializer<MetricsAndMetricTagConfigurations> {
    ...
    public static class MetricsAndMetricTagConfigurationsDeserializer extends StdDeserializer<MetricsAndMetricTagConfigurations> {
        ...
        public MetricsAndMetricTagConfigurations deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (MetricTagConfiguration.class.equals(Integer.class) || MetricTagConfiguration.class.equals(Long.class) || MetricTagConfiguration.class.equals(Float.class) || MetricTagConfiguration.class.equals(Double.class) || MetricTagConfiguration.class.equals(Boolean.class) || MetricTagConfiguration.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
        ...
        public MetricsAndMetricTagConfigurations getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "MetricsAndMetricTagConfigurations cannot be null");
        }
    }
    ...
    /**
     * Get the actual instance of `MetricTagConfiguration`. If the actual instance is not `MetricTagConfiguration`,
     * the ClassCastException will be thrown.
     *
