...
/**
   * <p>Response schema when interacting with a list of Confluent resources.</p>
 */
@JsonPropertyOrder({
  ConfluentResourcesResponse.JSON_PROPERTY_DATA
})
...
public class ConfluentResourcesResponse {
  ...
  /**
   * <p>The JSON:API data attribute.</p>
   * @return data
  **/
   ...
   */
  @JsonAnySetter
  public ConfluentResourcesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, confluentResourcesResponse.data) && Objects.equals(this.additionalProperties, confluentResourcesResponse.additionalProperties);
  }
