...
public class SecurityMonitoringStandardRuleResponse {
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse calculatedFields(List<CalculatedField> calculatedFields) {
  ...
  public SecurityMonitoringStandardRuleResponse addCalculatedFieldsItem(CalculatedField calculatedFieldsItem) {
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse complianceSignalOptions(CloudConfigurationRuleComplianceSignalOptions complianceSignalOptions) {
  ...
  **/
  ...
  /**
   * <p>IDs of rules that this rule depends on.</p>
   * @return dependencies
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse addFiltersItem(SecurityMonitoringFilter filtersItem) {
  ...
  **/
  ...
  /**
   * <p>The type of findings generated by the rule.</p>
   * @return findingType
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse queries(List<SecurityMonitoringStandardRuleQuery> queries) {
  ...
  public SecurityMonitoringStandardRuleResponse addQueriesItem(SecurityMonitoringStandardRuleQuery queriesItem) {
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse referenceTables(List<SecurityMonitoringReferenceTable> referenceTables) {
  ...
  public SecurityMonitoringStandardRuleResponse addReferenceTablesItem(SecurityMonitoringReferenceTable referenceTablesItem) {
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse schedulingOptions(SecurityMonitoringSchedulingOptions schedulingOptions) {
  ...
  **/
  ...
  public SecurityMonitoringStandardRuleResponse thirdPartyCases(List<SecurityMonitoringThirdPartyRuleCase> thirdPartyCases) {
  ...
  public SecurityMonitoringStandardRuleResponse addThirdPartyCasesItem(SecurityMonitoringThirdPartyRuleCase thirdPartyCasesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringStandardRuleResponse securityMonitoringStandardRuleResponse = (SecurityMonitoringStandardRuleResponse) o;
    return Objects.equals(this.blocking, securityMonitoringStandardRuleResponse.blocking) && Objects.equals(this.calculatedFields, securityMonitoringStandardRuleResponse.calculatedFields) && Objects.equals(this.cases, securityMonitoringStandardRuleResponse.cases) && Objects.equals(this.complianceSignalOptions, securityMonitoringStandardRuleResponse.complianceSignalOptions) && Objects.equals(this.createdAt, securityMonitoringStandardRuleResponse.createdAt) && Objects.equals(this.creationAuthorId, securityMonitoringStandardRuleResponse.creationAuthorId) && Objects.equals(this.creator, securityMonitoringStandardRuleResponse.creator) && Objects.equals(this.customMessage, securityMonitoringStandardRuleResponse.customMessage) && Objects.equals(this.customName, securityMonitoringStandardRuleResponse.customName) && Objects.equals(this.defaultRuleId, securityMonitoringStandardRuleResponse.defaultRuleId) && Objects.equals(this.defaultTags, securityMonitoringStandardRuleResponse.defaultTags) && Objects.equals(this.dependencies, securityMonitoringStandardRuleResponse.dependencies) && Objects.equals(this.deprecationDate, securityMonitoringStandardRuleResponse.deprecationDate) && Objects.equals(this.filters, securityMonitoringStandardRuleResponse.filters) && Objects.equals(this.findingType, securityMonitoringStandardRuleResponse.findingType) && Objects.equals(this.groupSignalsBy, securityMonitoringStandardRuleResponse.groupSignalsBy) && Objects.equals(this.hasExtendedTitle, securityMonitoringStandardRuleResponse.hasExtendedTitle) && Objects.equals(this.id, securityMonitoringStandardRuleResponse.id) && Objects.equals(this.isBeta, securityMonitoringStandardRuleResponse.isBeta) && Objects.equals(this.isDefault, securityMonitoringStandardRuleResponse.isDefault) && Objects.equals(this.isDeleted, securityMonitoringStandardRuleResponse.isDeleted) && Objects.equals(this.isDeprecated, securityMonitoringStandardRuleResponse.isDeprecated) && Objects.equals(this.isEnabled, securityMonitoringStandardRuleResponse.isEnabled) && Objects.equals(this.isPartner, securityMonitoringStandardRuleResponse.isPartner) && Objects.equals(this.message, securityMonitoringStandardRuleResponse.message) && Objects.equals(this.metadata, securityMonitoringStandardRuleResponse.metadata) && Objects.equals(this.name, securityMonitoringStandardRuleResponse.name) && Objects.equals(this.options, securityMonitoringStandardRuleResponse.options) && Objects.equals(this.queries, securityMonitoringStandardRuleResponse.queries) && Objects.equals(this.referenceTables, securityMonitoringStandardRuleResponse.referenceTables) && Objects.equals(this.schedulingOptions, securityMonitoringStandardRuleResponse.schedulingOptions) && Objects.equals(this.tags, securityMonitoringStandardRuleResponse.tags) && Objects.equals(this.thirdPartyCases, securityMonitoringStandardRuleResponse.thirdPartyCases) && Objects.equals(this.type, securityMonitoringStandardRuleResponse.type) && Objects.equals(this.updateAuthorId, securityMonitoringStandardRuleResponse.updateAuthorId) && Objects.equals(this.updatedAt, securityMonitoringStandardRuleResponse.updatedAt) && Objects.equals(this.updater, securityMonitoringStandardRuleResponse.updater) && Objects.equals(this.version, securityMonitoringStandardRuleResponse.version) && Objects.equals(this.additionalProperties, securityMonitoringStandardRuleResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(blocking,calculatedFields,cases,complianceSignalOptions,createdAt,creationAuthorId,creator,customMessage,customName,defaultRuleId,defaultTags,dependencies,deprecationDate,filters,findingType,groupSignalsBy,hasExtendedTitle,id,isBeta,isDefault,isDeleted,isDeprecated,isEnabled,isPartner,message,metadata,name,options,queries,referenceTables,schedulingOptions,tags,thirdPartyCases,type,updateAuthorId,updatedAt,updater,version, additionalProperties);
  }
