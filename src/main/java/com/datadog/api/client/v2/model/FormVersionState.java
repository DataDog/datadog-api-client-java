...
public class FormVersionState extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("draft", "frozen"));
  ...
  public static class FormVersionStateSerializer extends StdSerializer<FormVersionState> {
      ...
      @Override
      public void serialize(FormVersionState value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
