...
public class CustomDestinationResponseForwardDestinationHttp {
  ...
  private CustomDestinationResponseForwardDestinationHttpType type =
  ...
  public CustomDestinationResponseForwardDestinationHttp(
      @JsonProperty(required = true, value = JSON_PROPERTY_AUTH)
          CustomDestinationResponseHttpDestinationAuth auth,
  ...
  public CustomDestinationResponseForwardDestinationHttp auth(
      CustomDestinationResponseHttpDestinationAuth auth) {
    this.auth = auth;
    this.unparsed |= auth.unparsed;
    return this;
  ...
  public CustomDestinationResponseForwardDestinationHttp type(
      CustomDestinationResponseForwardDestinationHttpType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
   ...
   */
  @JsonAnySetter
  public CustomDestinationResponseForwardDestinationHttp putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auth, customDestinationResponseForwardDestinationHttp.auth)
        && Objects.equals(this.endpoint, customDestinationResponseForwardDestinationHttp.endpoint)
        && Objects.equals(this.type, customDestinationResponseForwardDestinationHttp.type)
        && Objects.equals(
            this.additionalProperties,
            customDestinationResponseForwardDestinationHttp.additionalProperties);
  }
