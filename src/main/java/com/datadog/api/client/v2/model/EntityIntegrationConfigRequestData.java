...
public class EntityIntegrationConfigRequestData {
  ...
  private EntityIntegrationConfigRequestType type = EntityIntegrationConfigRequestType.ENTITY_INTEGRATION_CONFIG_REQUESTS;

  public EntityIntegrationConfigRequestData() {}

  @JsonCreator
  public EntityIntegrationConfigRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)EntityIntegrationConfigRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)EntityIntegrationConfigRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public EntityIntegrationConfigRequestData attributes(EntityIntegrationConfigRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>JSON:API resource type for the entity integration configuration create or update request. Always <code>entity_integration_config_requests</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    EntityIntegrationConfigRequestData entityIntegrationConfigRequestData = (EntityIntegrationConfigRequestData) o;
    return Objects.equals(this.attributes, entityIntegrationConfigRequestData.attributes) && Objects.equals(this.type, entityIntegrationConfigRequestData.type) && Objects.equals(this.additionalProperties, entityIntegrationConfigRequestData.additionalProperties);
  }
