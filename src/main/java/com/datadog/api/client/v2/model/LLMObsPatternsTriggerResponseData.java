...
public class LLMObsPatternsTriggerResponseData {
  ...
  @JsonCreator
  public LLMObsPatternsTriggerResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)LLMObsPatternsTriggerResponseAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)LLMObsPatternsTriggerResponseType type) {
  ...
  public LLMObsPatternsTriggerResponseData attributes(LLMObsPatternsTriggerResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes of an Agent Observability patterns trigger response.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The ID of the patterns configuration that was run.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsPatternsTriggerResponseData llmObsPatternsTriggerResponseData = (LLMObsPatternsTriggerResponseData) o;
    return Objects.equals(this.attributes, llmObsPatternsTriggerResponseData.attributes) && Objects.equals(this.id, llmObsPatternsTriggerResponseData.id) && Objects.equals(this.type, llmObsPatternsTriggerResponseData.type) && Objects.equals(this.additionalProperties, llmObsPatternsTriggerResponseData.additionalProperties);
  }
