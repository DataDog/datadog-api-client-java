...
/**
   * <p>Response containing a list of identity providers for an organization.</p>
 */
@JsonPropertyOrder({
  IdentityProvidersResponse.JSON_PROPERTY_DATA
})
...
public class IdentityProvidersResponse {
  ...
  /**
   * <p>List of organization identity provider data objects.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, identityProvidersResponse.data) && Objects.equals(this.additionalProperties, identityProvidersResponse.additionalProperties);
  }
