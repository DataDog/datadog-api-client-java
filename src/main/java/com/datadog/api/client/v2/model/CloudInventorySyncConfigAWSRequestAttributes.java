...
public class CloudInventorySyncConfigAWSRequestAttributes {
  ...
  public CloudInventorySyncConfigAWSRequestAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_DESTINATION_BUCKET_REGION)String destinationBucketRegion) {
  ...
  /**
   * <p>AWS account ID that owns the inventory bucket.</p>
   * @return awsAccountId
  **/
  ...
  /**
   * <p>Name of the S3 bucket containing inventory files.</p>
  ...
  **/
  ...
  /**
   * <p>AWS Region of the inventory bucket.</p>
  ...
  **/
  ...
  /**
   * <p>Object key prefix where inventory reports are written. Omit or set to <code>/</code> when reports are written at the bucket root.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloudInventorySyncConfigAWSRequestAttributes cloudInventorySyncConfigAwsRequestAttributes = (CloudInventorySyncConfigAWSRequestAttributes) o;
    return Objects.equals(this.awsAccountId, cloudInventorySyncConfigAwsRequestAttributes.awsAccountId) && Objects.equals(this.destinationBucketName, cloudInventorySyncConfigAwsRequestAttributes.destinationBucketName) && Objects.equals(this.destinationBucketRegion, cloudInventorySyncConfigAwsRequestAttributes.destinationBucketRegion) && Objects.equals(this.destinationPrefix, cloudInventorySyncConfigAwsRequestAttributes.destinationPrefix) && Objects.equals(this.additionalProperties, cloudInventorySyncConfigAwsRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(awsAccountId,destinationBucketName,destinationBucketRegion,destinationPrefix, additionalProperties);
  }
