...
/**
   * <p>An update made to a maintenance.</p>
 */
@JsonPropertyOrder({
...
public class MaintenanceDataAttributesUpdatesItems {
  ...
  private List<MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems> componentsAffected = null;
  ...
  public MaintenanceDataAttributesUpdatesItems componentsAffected(List<MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems> componentsAffected) {
  ...
  public MaintenanceDataAttributesUpdatesItems addComponentsAffectedItem(MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems componentsAffectedItem) {
  ...
  **/
      ...
      public List<MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems> getComponentsAffected() {
        return componentsAffected;
      }
  public void setComponentsAffected(List<MaintenanceDataAttributesUpdatesItemsComponentsAffectedItems> componentsAffected) {
    this.componentsAffected = componentsAffected;
  }
