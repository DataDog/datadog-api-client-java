...
/**
   * <p>A list of input parameters for the workflow. Input parameters are available under the <code>Trigger</code> object and can be referenced in workflow steps using <code>{{ Trigger.&lt;parameter_name&gt; }}</code>.</p>
 */
@JsonPropertyOrder({
  InputSchema.JSON_PROPERTY_PARAMETERS
})
...
public class InputSchema {
  ...
  /**
   * <p>The <code>InputSchema</code> <code>parameters</code>.</p>
   * @return parameters
  **/
   ...
   */
  @JsonAnySetter
  public InputSchema putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.parameters, inputSchema.parameters) && Objects.equals(this.additionalProperties, inputSchema.additionalProperties);
  }
