...
/** The definition of <code>ScaRequestDataAttributes</code> object. */
@JsonPropertyOrder({
...
public class ScaRequestDataAttributes {
  ...
  /**
   * The definition of <code>ScaRequestDataAttributesCommit</code> object.
   *
   * @return commit
   */
  ...
  /**
   * The <code>attributes</code> <code>dependencies</code>.
   *
   * @return dependencies
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>env</code>.
   *
   * @return env
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>files</code>.
   *
   * @return files
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>relations</code>.
   *
   * @return relations
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The definition of <code>ScaRequestDataAttributesRepository</code> object.
   *
   * @return repository
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>service</code>.
   *
   * @return service
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>vulnerabilities</code>.
   *
