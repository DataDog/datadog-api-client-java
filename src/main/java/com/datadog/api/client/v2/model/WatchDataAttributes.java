...
public class WatchDataAttributes {
  ...
  /**
   * <p>Unique identifier of the RUM application containing the session.</p>
  ...
  **/
  ...
  /**
   * <p>Data source type indicating the origin of the session data (e.g., rum or product_analytics).</p>
   * @return dataSource
  **/
  ...
  /**
   * <p>Unique identifier of the RUM event that was watched.</p>
   * @return eventId
  **/
  ...
  /**
   * <p>Timestamp when the session was watched.</p>
   * @return timestamp
  **/
