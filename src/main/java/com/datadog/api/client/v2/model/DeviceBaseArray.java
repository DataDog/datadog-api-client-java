...
public class DeviceBaseArray {
  ...
  private List<DeviceBaseData> data = new ArrayList<>();

  public DeviceBaseArray() {}

  @JsonCreator
  public DeviceBaseArray(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<DeviceBaseData> data) {
    this.data = data;
  }

  public DeviceBaseArray data(List<DeviceBaseData> data) {
    this.data = data;
  ...
  public List<DeviceBaseData> getData() {
    return data;
  }

  public void setData(List<DeviceBaseData> data) {
    this.data = data;
  }
