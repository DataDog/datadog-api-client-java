...
public class CloudflareAccountResponseData {
  ...
  @JsonCreator
  public CloudflareAccountResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CloudflareAccountResponseAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The ID of the Cloudflare account, a hash of the account name.</p>
   * @return id
  **/
  ...
  **/
   ...
   * @return CloudflareAccountResponseData
   */
  @JsonAnySetter
  public CloudflareAccountResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, cloudflareAccountResponseData.attributes) && Objects.equals(this.id, cloudflareAccountResponseData.id) && Objects.equals(this.type, cloudflareAccountResponseData.type) && Objects.equals(this.additionalProperties, cloudflareAccountResponseData.additionalProperties);
  }
