...
public class DegradationDataRelationships {
  ...
  private DegradationDataRelationshipsLastModifiedByUser lastModifiedByUser;
   ...
   * @return DegradationDataRelationships
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class DegradationDataRelationships {\n");
