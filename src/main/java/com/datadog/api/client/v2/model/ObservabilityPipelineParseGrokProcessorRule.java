...
/**
 * A grok parsing rule used in the <code>parse_grok</code> processor. Each rule defines how to
 * extract structured fields from a specific log field using grok patterns.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineParseGrokProcessorRule {
  ...
  public ObservabilityPipelineParseGrokProcessorRule addMatchRulesItem(
  ...
  /**
   * A list of grok matching rules that define how to extract fields from the source field. Each
   * rule must contain a name and a valid grok pattern.
   *
   * @return matchRules
   */
  ...
  /**
   * A list of auxiliary Grok patterns that can be referenced by the matching rules. These are
   * reusable named patterns that simplify complex matching.
   *
   * @return supportRules
   */
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineParseGrokProcessorRule putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.matchRules, observabilityPipelineParseGrokProcessorRule.matchRules)
        && Objects.equals(this.source, observabilityPipelineParseGrokProcessorRule.source)
        && Objects.equals(
            this.supportRules, observabilityPipelineParseGrokProcessorRule.supportRules)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineParseGrokProcessorRule.additionalProperties);
  }
