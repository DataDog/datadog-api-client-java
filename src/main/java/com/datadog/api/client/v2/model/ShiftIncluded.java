...
public class ShiftIncluded extends AbstractOpenApiSchema {
    ...
    public static class ShiftIncludedSerializer extends StdSerializer<ShiftIncluded> {
        ...
        @Override
        public void serialize(ShiftIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ShiftIncludedDeserializer extends StdDeserializer<ShiftIncluded> {
        ...
        @Override
        public ShiftIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
