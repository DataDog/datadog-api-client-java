...
/**
   * <p>The definition of the <code>DatadogIntegration</code> object.</p>
 */
@JsonPropertyOrder({
...
public class DatadogIntegration {
  ...
  @JsonCreator
  public DatadogIntegration(
            @JsonProperty(required=true, value=JSON_PROPERTY_CREDENTIALS)DatadogCredentials credentials,
  ...
  /**
   * <p>The definition of the <code>DatadogCredentials</code> object.</p>
   * @return credentials
  **/
  ...
  /**
   * <p>The definition of the <code>DatadogIntegrationType</code> object.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentials, datadogIntegration.credentials) && Objects.equals(this.type, datadogIntegration.type) && Objects.equals(this.additionalProperties, datadogIntegration.additionalProperties);
  }
