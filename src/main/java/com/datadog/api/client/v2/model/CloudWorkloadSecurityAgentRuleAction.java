...
/**
   * <p>The action the rule can perform if triggered</p>
 */
@JsonPropertyOrder({
...
public class CloudWorkloadSecurityAgentRuleAction {
  ...
  /**
   * <p>Whether the action is disabled</p>
   * @return disabled
  **/
  ...
  /**
   * <p>SECL expression used to target the container to apply the action on</p>
   * @return filter
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Kill system call applied on the container matching the rule</p>
   * @return kill
  **/
      @jakarta.annotation.Nullable
  ...
  public CloudWorkloadSecurityAgentRuleAction metadata(CloudWorkloadSecurityAgentRuleActionMetadata metadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloudWorkloadSecurityAgentRuleAction cloudWorkloadSecurityAgentRuleAction = (CloudWorkloadSecurityAgentRuleAction) o;
    return Objects.equals(this.disabled, cloudWorkloadSecurityAgentRuleAction.disabled) && Objects.equals(this.filter, cloudWorkloadSecurityAgentRuleAction.filter) && Objects.equals(this.hash, cloudWorkloadSecurityAgentRuleAction.hash) && Objects.equals(this.kill, cloudWorkloadSecurityAgentRuleAction.kill) && Objects.equals(this.metadata, cloudWorkloadSecurityAgentRuleAction.metadata) && Objects.equals(this.set, cloudWorkloadSecurityAgentRuleAction.set) && Objects.equals(this.additionalProperties, cloudWorkloadSecurityAgentRuleAction.additionalProperties);
  }
