...
/**
   * <p>Configuration for a URL that should have distributed tracing enabled.</p>
 */
@JsonPropertyOrder({
...
public class RumSdkConfigTracingUrlConfig {
  ...
  public RumSdkConfigTracingUrlConfig(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_PROPAGATOR_TYPES)List<RumSdkConfigTracingUrlPropagatorType> propagatorTypes) {
        this.match = match;
  ...
  **/
  ...
  public RumSdkConfigTracingUrlConfig propagatorTypes(List<RumSdkConfigTracingUrlPropagatorType> propagatorTypes) {
    this.propagatorTypes = propagatorTypes;
    return this;
  }
  public RumSdkConfigTracingUrlConfig addPropagatorTypesItem(RumSdkConfigTracingUrlPropagatorType propagatorTypesItem) {
  ...
  /**
   * <p>The list of trace propagator types to use for this URL.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.match, rumSdkConfigTracingUrlConfig.match) && Objects.equals(this.propagatorTypes, rumSdkConfigTracingUrlConfig.propagatorTypes) && Objects.equals(this.additionalProperties, rumSdkConfigTracingUrlConfig.additionalProperties);
  }
