...
/**
   * <p>Object describing a single change within a version.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsTestVersionChangeMetadataItem {
  ...
  /**
   * <p>The action that was performed (for example, <code>updated</code> or <code>created</code>).</p>
   * @return action
  **/
  ...
  public SyntheticsTestVersionChangeMetadataItem actionMetadata(SyntheticsTestVersionActionMetadata actionMetadata) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestVersionChangeMetadataItem syntheticsTestVersionChangeMetadataItem = (SyntheticsTestVersionChangeMetadataItem) o;
    return Objects.equals(this.action, syntheticsTestVersionChangeMetadataItem.action) && Objects.equals(this.actionMetadata, syntheticsTestVersionChangeMetadataItem.actionMetadata) && Objects.equals(this.additionalProperties, syntheticsTestVersionChangeMetadataItem.additionalProperties);
  }
