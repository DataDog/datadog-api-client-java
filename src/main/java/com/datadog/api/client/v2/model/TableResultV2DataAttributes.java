...
public class TableResultV2DataAttributes {
  ...
  /**
   * <p>UUID of the user who created the reference table.</p>
   * @return createdBy
  **/
  ...
  **/
  ...
  /**
   * <p>UUID of the user who last updated the reference table.</p>
  ...
  **/
  ...
  /**
   * <p>The number of successfully processed rows in the reference table.</p>
   * @return rowCount
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The processing status of the table.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique name to identify this reference table. Used in enrichment processors and API calls.</p>
   * @return tableName
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>When the reference table was last updated, in ISO 8601 format.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdBy,description,fileMetadata,lastUpdatedBy,rowCount,schema,source,status,tableName,tags,updatedAt, additionalProperties);
  }
