 ...
 */
@JsonPropertyOrder({
  ProductAnalyticsScalarColumnMeta.JSON_PROPERTY_UNIT
})
...
public class ProductAnalyticsScalarColumnMeta {
  ...
  private JsonNullable<List<ProductAnalyticsUnit>> unit = JsonNullable.<List<ProductAnalyticsUnit>>undefined();
  ...
  /**
   * <p>Unit definitions for the column values, if applicable.</p>
   * @return unit
  **/
  ...
  @JsonProperty(JSON_PROPERTY_UNIT)public void setUnit_JsonNullable(JsonNullable<List<ProductAnalyticsUnit>> unit) {
    this.unit = unit;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsScalarColumnMeta productAnalyticsScalarColumnMeta = (ProductAnalyticsScalarColumnMeta) o;
    return Objects.equals(this.unit, productAnalyticsScalarColumnMeta.unit) && Objects.equals(this.additionalProperties, productAnalyticsScalarColumnMeta.additionalProperties);
  }
