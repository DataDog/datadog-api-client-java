...
public class RelationType extends ModelEnum<String> {
  ...
  public static final RelationType RELATIONTYPEDEPENDSON =
      new RelationType("RelationTypeDependsOn");
  public static final RelationType RELATIONTYPEDEPENDENCYOF =
      new RelationType("RelationTypeDependencyOf");
  ...
  public static final RelationType RELATIONTYPEOTHEROWNS =
      new RelationType("RelationTypeOtherOwns");
  public static final RelationType RELATIONTYPEOTHEROWNEDBY =
      new RelationType("RelationTypeOtherOwnedBy");
  public static final RelationType RELATIONTYPEIMPLEMENTEDBY =
      new RelationType("RelationTypeImplementedBy");
  public static final RelationType RELATIONTYPEIMPLEMENTS =
      new RelationType("RelationTypeImplements");
  ...
  public static class RelationTypeSerializer extends StdSerializer<RelationType> {
    ...
    @Override
    public void serialize(RelationType value, JsonGenerator jgen, SerializerProvider provider)
