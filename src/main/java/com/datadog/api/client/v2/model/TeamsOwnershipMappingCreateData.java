...
/**
   * <p>The JSON:API data envelope for a teams ownership mapping create request.</p>
 */
@JsonPropertyOrder({
...
public class TeamsOwnershipMappingCreateData {
  ...
  @JsonCreator
  public TeamsOwnershipMappingCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TeamsOwnershipMappingCreateDataAttributes attributes,
  ...
  public TeamsOwnershipMappingCreateData attributes(TeamsOwnershipMappingCreateDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>The attributes of the teams ownership mapping to create.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingCreateData teamsOwnershipMappingCreateData = (TeamsOwnershipMappingCreateData) o;
    return Objects.equals(this.attributes, teamsOwnershipMappingCreateData.attributes) && Objects.equals(this.type, teamsOwnershipMappingCreateData.type) && Objects.equals(this.additionalProperties, teamsOwnershipMappingCreateData.additionalProperties);
  }
