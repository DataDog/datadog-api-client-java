...
public class CreateFeatureFlagAttributes {
   ...
   * <code>rule_targets</code>. Uses Datadog log search syntax (<code>AND</code>, <code>OR</code>,
   * <code>NOT</code>, parentheses) to match against the <code>notification_type</code> facet.
   *
