...
/** The definition of <code>ResponseSchema</code> object. */
@JsonPropertyOrder({
...
public class ListPipelinesResponse {
  ...
  /**
   * The <code>schema</code> <code>data</code>.
   *
   * @return data
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listPipelinesResponse.data)
        && Objects.equals(this.meta, listPipelinesResponse.meta)
        && Objects.equals(this.additionalProperties, listPipelinesResponse.additionalProperties);
  }
