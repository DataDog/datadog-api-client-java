...
@JsonPropertyOrder({
  DowntimeAttributeScheduleRecurrenceCreateEditRequest.JSON_PROPERTY_DURATION,
  DowntimeAttributeScheduleRecurrenceCreateEditRequest.JSON_PROPERTY_RRULE,
  DowntimeAttributeScheduleRecurrenceCreateEditRequest.JSON_PROPERTY_START
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class DowntimeAttributeScheduleRecurrenceCreateEditRequest {
  ...
  public DowntimeAttributeScheduleRecurrenceCreateEditRequest() {}
  ...
  public DowntimeAttributeScheduleRecurrenceCreateEditRequest duration(String duration) {
    this.duration = duration;
    return this;
  }
  ...
  public DowntimeAttributeScheduleRecurrenceCreateEditRequest rrule(String rrule) {
    this.rrule = rrule;
    return this;
  }
  ...
  public DowntimeAttributeScheduleRecurrenceCreateEditRequest start(String start) {
  ...
  /**
   * Return true if this DowntimeAttributeScheduleRecurrenceCreateEditRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DowntimeAttributeScheduleRecurrenceCreateEditRequest
        downtimeAttributeScheduleRecurrenceCreateEditRequest =
            (DowntimeAttributeScheduleRecurrenceCreateEditRequest) o;
    return Objects.equals(
            this.duration, downtimeAttributeScheduleRecurrenceCreateEditRequest.duration)
        && Objects.equals(this.rrule, downtimeAttributeScheduleRecurrenceCreateEditRequest.rrule)
        && Objects.equals(this.start, downtimeAttributeScheduleRecurrenceCreateEditRequest.start);
  }
  ...
  public String toString() {
    ...
    sb.append("class DowntimeAttributeScheduleRecurrenceCreateEditRequest {\n");
