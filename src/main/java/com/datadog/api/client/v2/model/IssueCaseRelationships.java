...
@JsonPropertyOrder({
  IssueCaseRelationships.JSON_PROPERTY_ASSIGNEE,
  IssueCaseRelationships.JSON_PROPERTY_CREATED_BY,
  IssueCaseRelationships.JSON_PROPERTY_MODIFIED_BY,
  IssueCaseRelationships.JSON_PROPERTY_PROJECT
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class IssueCaseRelationships {
  ...
  public IssueCaseRelationships assignee(NullableUserRelationship assignee) {
  ...
  public IssueCaseRelationships createdBy(NullableUserRelationship createdBy) {
  ...
  public IssueCaseRelationships modifiedBy(NullableUserRelationship modifiedBy) {
  ...
  public IssueCaseRelationships project(ProjectRelationship project) {
   ...
   * @return IssueCaseRelationships
   */
  @JsonAnySetter
  public IssueCaseRelationships putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this IssueCaseRelationships object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    IssueCaseRelationships issueCaseRelationships = (IssueCaseRelationships) o;
    return Objects.equals(this.assignee, issueCaseRelationships.assignee)
        && Objects.equals(this.createdBy, issueCaseRelationships.createdBy)
        && Objects.equals(this.modifiedBy, issueCaseRelationships.modifiedBy)
        && Objects.equals(this.project, issueCaseRelationships.project)
        && Objects.equals(this.additionalProperties, issueCaseRelationships.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCaseRelationships {\n");
