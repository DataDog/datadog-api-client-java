...
/**
   * <p>The RUM retention quota configuration to create or update.</p>
 */
@JsonPropertyOrder({
...
public class RumRetentionQuotaConfigUpdateData {
  ...
  @JsonCreator
  public RumRetentionQuotaConfigUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RumRetentionQuotaConfigUpdateAttributes attributes,
  ...
  public RumRetentionQuotaConfigUpdateData attributes(RumRetentionQuotaConfigUpdateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The identifier of the scope the retention quota configuration applies to.
   * Must match <code>scope_id</code> in the path.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RumRetentionQuotaConfigUpdateData rumRetentionQuotaConfigUpdateData = (RumRetentionQuotaConfigUpdateData) o;
    return Objects.equals(this.attributes, rumRetentionQuotaConfigUpdateData.attributes) && Objects.equals(this.id, rumRetentionQuotaConfigUpdateData.id) && Objects.equals(this.type, rumRetentionQuotaConfigUpdateData.type) && Objects.equals(this.additionalProperties, rumRetentionQuotaConfigUpdateData.additionalProperties);
  }
