...
@JsonPropertyOrder({
  ...
  StatusPageAsIncludedAttributes.JSON_PROPERTY_SLACK_APP_ICON,
  StatusPageAsIncludedAttributes.JSON_PROPERTY_SLACK_SUBSCRIPTIONS_ENABLED,
...
public class StatusPageAsIncludedAttributes {
  ...
  **/
  ...
  public StatusPageAsIncludedAttributes slackAppIcon(String slackAppIcon) {
  ...
  **/
  ...
  public StatusPageAsIncludedAttributes slackSubscriptionsEnabled(Boolean slackSubscriptionsEnabled) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyLogo,components,createdAt,customDomain,customDomainEnabled,domainPrefix,emailHeaderImage,enabled,favicon,modifiedAt,name,pageUrl,slackAppIcon,slackSubscriptionsEnabled,subscriptionsEnabled,type,visualizationType, additionalProperties);
  }
