...
/**
   * <p>The <code>http_client</code> source scrapes logs from HTTP endpoints at regular intervals.</p>
...
public class ObservabilityPipelineHttpClientSource {
  ...
  private ObservabilityPipelineHttpClientSourceType type = ObservabilityPipelineHttpClientSourceType.HTTP_CLIENT;
  ...
  public ObservabilityPipelineHttpClientSource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineHttpClientSourceType type) {
  ...
  public ObservabilityPipelineHttpClientSource authStrategy(ObservabilityPipelineHttpClientSourceAuthStrategy authStrategy) {
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the HTTP endpoint URL to scrape.</p>
  ...
  **/
  ...
  /**
   * <p>The interval (in seconds) between HTTP scrape requests.</p>
  ...
  **/
  ...
  /**
   * <p>The timeout (in seconds) for each scrape request.</p>
  ...
  **/
  ...
  public ObservabilityPipelineHttpClientSource type(ObservabilityPipelineHttpClientSourceType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The source type. The value should always be <code>http_client</code>.</p>
   * @return type
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineHttpClientSource observabilityPipelineHttpClientSource = (ObservabilityPipelineHttpClientSource) o;
    return Objects.equals(this.authStrategy, observabilityPipelineHttpClientSource.authStrategy) && Objects.equals(this.customKey, observabilityPipelineHttpClientSource.customKey) && Objects.equals(this.decoding, observabilityPipelineHttpClientSource.decoding) && Objects.equals(this.endpointUrlKey, observabilityPipelineHttpClientSource.endpointUrlKey) && Objects.equals(this.id, observabilityPipelineHttpClientSource.id) && Objects.equals(this.passwordKey, observabilityPipelineHttpClientSource.passwordKey) && Objects.equals(this.scrapeIntervalSecs, observabilityPipelineHttpClientSource.scrapeIntervalSecs) && Objects.equals(this.scrapeTimeoutSecs, observabilityPipelineHttpClientSource.scrapeTimeoutSecs) && Objects.equals(this.tls, observabilityPipelineHttpClientSource.tls) && Objects.equals(this.tokenKey, observabilityPipelineHttpClientSource.tokenKey) && Objects.equals(this.type, observabilityPipelineHttpClientSource.type) && Objects.equals(this.usernameKey, observabilityPipelineHttpClientSource.usernameKey) && Objects.equals(this.additionalProperties, observabilityPipelineHttpClientSource.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(authStrategy,customKey,decoding,endpointUrlKey,id,passwordKey,scrapeIntervalSecs,scrapeTimeoutSecs,tls,tokenKey,type,usernameKey, additionalProperties);
  }
