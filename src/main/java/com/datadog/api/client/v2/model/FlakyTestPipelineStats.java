...
public class FlakyTestPipelineStats {
  ...
  /**
   * The number of pipelines that failed due to this test for the past 7 days. This is computed as
   * the sum of failed CI pipeline events associated with test runs where the flaky test failed.
   *
  ...
  @JsonProperty(JSON_PROPERTY_FAILED_PIPELINES)
  public void setFailedPipelines_JsonNullable(JsonNullable<Long> failedPipelines) {
  ...
  /**
   * The total time lost by CI pipelines due to this flaky test in milliseconds. This is computed as
   * the sum of the duration of failed CI pipeline events associated with test runs where the flaky
   * test failed.
   *
  ...
  @JsonProperty(JSON_PROPERTY_TOTAL_LOST_TIME_MS)
  public void setTotalLostTimeMs_JsonNullable(JsonNullable<Long> totalLostTimeMs) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.failedPipelines, flakyTestPipelineStats.failedPipelines)
        && Objects.equals(this.totalLostTimeMs, flakyTestPipelineStats.totalLostTimeMs)
        && Objects.equals(this.additionalProperties, flakyTestPipelineStats.additionalProperties);
  }
