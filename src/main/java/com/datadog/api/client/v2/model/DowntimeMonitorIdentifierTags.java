...
/**
   * <p>Object of the monitor tags.</p>
 */
@JsonPropertyOrder({
  DowntimeMonitorIdentifierTags.JSON_PROPERTY_MONITOR_TAGS
})
...
public class DowntimeMonitorIdentifierTags {
  ...
  /**
   * <p>A list of monitor tags. For example, tags that are applied directly to monitors,
   * not tags that are used in monitor queries (which are filtered by the scope parameter), to which the downtime applies.
   * The resulting downtime applies to monitors that match <strong>all</strong> provided monitor tags. Setting <code>monitor_tags</code>
   * to <code>[*]</code> configures the downtime to mute all monitors for the given scope.</p>
   * @return monitorTags
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.monitorTags, downtimeMonitorIdentifierTags.monitorTags) && Objects.equals(this.additionalProperties, downtimeMonitorIdentifierTags.additionalProperties);
  }
