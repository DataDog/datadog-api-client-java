...
@JsonDeserialize(using = SpansGroupByMissing.SpansGroupByMissingDeserializer.class)
@JsonSerialize(using = SpansGroupByMissing.SpansGroupByMissingSerializer.class)
public class SpansGroupByMissing extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SpansGroupByMissing.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SpansGroupByMissingSerializer extends StdSerializer<SpansGroupByMissing> {
        public SpansGroupByMissingSerializer(Class<SpansGroupByMissing> t) {
            super(t);
        }

        public SpansGroupByMissingSerializer() {
            this(null);
        }

        @Override
        public void serialize(SpansGroupByMissing value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SpansGroupByMissingDeserializer extends StdDeserializer<SpansGroupByMissing> {
        public SpansGroupByMissingDeserializer() {
            this(SpansGroupByMissing.class);
        }

        public SpansGroupByMissingDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public SpansGroupByMissing deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            SpansGroupByMissing ret = new SpansGroupByMissing();
            if (match == 1) {
         ...
         */
        @Override
        public SpansGroupByMissing getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SpansGroupByMissing cannot be null");
        }
    }
    ...
    public SpansGroupByMissing() {
        super("oneOf", Boolean.FALSE);
    }
    public SpansGroupByMissing(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public SpansGroupByMissing(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(SpansGroupByMissing.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return SpansGroupByMissing.schemas;
    }
