...
public class TriggerType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("monitor_alert_trigger"));
  ...
  public static class TriggerTypeSerializer extends StdSerializer<TriggerType> {
      ...
      @Override
      public void serialize(TriggerType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
