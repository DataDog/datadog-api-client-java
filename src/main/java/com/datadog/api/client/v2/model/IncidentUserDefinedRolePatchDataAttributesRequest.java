...
public class IncidentUserDefinedRolePatchDataAttributesRequest {
  ...
  public IncidentUserDefinedRolePatchDataAttributesRequest description(String description) {
  ...
  public String toString() {
    ...
    sb.append("class IncidentUserDefinedRolePatchDataAttributesRequest {\n");
