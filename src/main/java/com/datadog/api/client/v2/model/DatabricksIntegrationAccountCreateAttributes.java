...
public class DatabricksIntegrationAccountCreateAttributes {
   ...
   * </code> dataflow unable to collect data. <code>bearer_token</code> is not available on
   * creation: Databricks accepts it only on accounts that already use it, so it can only appear on
   * read and update.
   *
