...
public class LLMObsSpanSearchOptions {
  ...
  /**
   * <p>Whether to include attachment data in the response. Defaults to <code>true</code>.</p>
  ...
  **/
  ...
  /**
   * <p>Offset in seconds applied to both <code>from</code> and <code>to</code> timestamps.</p>
   * @return timeOffset
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeAttachments, llmObsSpanSearchOptions.includeAttachments) && Objects.equals(this.timeOffset, llmObsSpanSearchOptions.timeOffset) && Objects.equals(this.additionalProperties, llmObsSpanSearchOptions.additionalProperties);
  }
