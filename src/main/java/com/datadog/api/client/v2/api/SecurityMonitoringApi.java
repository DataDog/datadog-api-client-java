 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listFindings", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, limit, args, 0);
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listSecurityFindings", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, limit, args, 0);
 ...
 */
  public CompletableFuture<SecurityMonitoringCriticalAssetsResponse>listSecurityMonitoringCriticalAssetsAsync() {
    return listSecurityMonitoringCriticalAssetsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<SecurityMonitoringCriticalAssetsResponse> listSecurityMonitoringCriticalAssetsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.SecurityMonitoringApi.listSecurityMonitoringCriticalAssets", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<SecurityMonitoringCriticalAssetsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<SecurityMonitoringCriticalAssetsResponse>> listSecurityMonitoringCriticalAssetsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.SecurityMonitoringApi.listSecurityMonitoringCriticalAssets", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<SecurityMonitoringCriticalAssetsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listSecurityMonitoringSignals", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, limit, args, 0);
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchSecurityFindings", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, limit, args, 0);
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchSecurityMonitoringSignals", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, limit, args, 0);
