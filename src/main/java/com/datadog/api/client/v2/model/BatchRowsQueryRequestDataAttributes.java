...
/**
   * <p>Attributes for a batch rows query request.</p>
 */
@JsonPropertyOrder({
...
public class BatchRowsQueryRequestDataAttributes {
  ...
  /**
   * <p>List of row identifiers to query from the reference table.</p>
   * @return rowIds
  **/
  ...
  /**
   * <p>Unique identifier of the reference table to query.</p>
   * @return tableId
  **/
  ...
  public boolean equals(Object o) {
    ...
    BatchRowsQueryRequestDataAttributes batchRowsQueryRequestDataAttributes = (BatchRowsQueryRequestDataAttributes) o;
    return Objects.equals(this.rowIds, batchRowsQueryRequestDataAttributes.rowIds) && Objects.equals(this.tableId, batchRowsQueryRequestDataAttributes.tableId) && Objects.equals(this.additionalProperties, batchRowsQueryRequestDataAttributes.additionalProperties);
  }
