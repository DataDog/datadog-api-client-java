...
public class WebIntegrationAccountType extends ModelEnum<String> {
  ...
  public static class WebIntegrationAccountTypeSerializer extends StdSerializer<WebIntegrationAccountType> {
      public WebIntegrationAccountTypeSerializer(Class<WebIntegrationAccountType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(WebIntegrationAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
