...
public class SeverityModifierRuleShiftAction {
  ...
  @JsonCreator
  public SeverityModifierRuleShiftAction(
      @JsonProperty(required = true, value = JSON_PROPERTY_SEVERITY_DELTA)
          SeverityModifierSeverityDelta severityDelta,
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          SeverityModifierRuleShiftActionType type) {
  ...
  public SeverityModifierRuleShiftAction severityDelta(
      SeverityModifierSeverityDelta severityDelta) {
    this.severityDelta = severityDelta;
    this.unparsed |= !severityDelta.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    SeverityModifierRuleShiftAction severityModifierRuleShiftAction =
        (SeverityModifierRuleShiftAction) o;
    return Objects.equals(this.description, severityModifierRuleShiftAction.description)
        && Objects.equals(this.severityDelta, severityModifierRuleShiftAction.severityDelta)
        && Objects.equals(this.type, severityModifierRuleShiftAction.type)
        && Objects.equals(
            this.additionalProperties, severityModifierRuleShiftAction.additionalProperties);
  }
