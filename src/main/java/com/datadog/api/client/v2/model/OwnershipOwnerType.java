...
public class OwnershipOwnerType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("user", "team", "service", "unknown"));
  ...
  public static class OwnershipOwnerTypeSerializer extends StdSerializer<OwnershipOwnerType> {
      ...
      @Override
      public void serialize(OwnershipOwnerType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
