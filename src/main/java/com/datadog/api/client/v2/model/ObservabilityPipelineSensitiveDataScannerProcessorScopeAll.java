...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorScopeAll</code> object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorScopeAll {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorScopeAllTarget</code>
   * object.
   *
   * @return target
   */
