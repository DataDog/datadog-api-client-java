...
/**
   * <p>Response containing a list of Agent Observability projects.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsProjectsResponse {
  ...
  @JsonCreator
  public LLMObsProjectsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<LLMObsProjectDataResponse> data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, llmObsProjectsResponse.data) && Objects.equals(this.meta, llmObsProjectsResponse.meta) && Objects.equals(this.additionalProperties, llmObsProjectsResponse.additionalProperties);
  }
