 ...
 */
@JsonPropertyOrder({
  IncidentUserDefinedRolePolicy.JSON_PROPERTY_IS_SINGLE
})
...
public class IncidentUserDefinedRolePolicy {
  ...
  /**
   * <p>Whether this role can only be assigned to one responder at a time.</p>
   * @return isSingle
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isSingle, incidentUserDefinedRolePolicy.isSingle) && Objects.equals(this.additionalProperties, incidentUserDefinedRolePolicy.additionalProperties);
  }
