 ...
 */
@JsonSerialize(using = TeamRoutingRulesRequestDataType.TeamRoutingRulesRequestDataTypeSerializer.class)
public class TeamRoutingRulesRequestDataType extends ModelEnum<String> {
  ...
  public static final TeamRoutingRulesRequestDataType TEAM_ROUTING_RULES = new TeamRoutingRulesRequestDataType("team_routing_rules");
  ...
  public static class TeamRoutingRulesRequestDataTypeSerializer extends StdSerializer<TeamRoutingRulesRequestDataType> {
      ...
      @Override
      public void serialize(TeamRoutingRulesRequestDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
