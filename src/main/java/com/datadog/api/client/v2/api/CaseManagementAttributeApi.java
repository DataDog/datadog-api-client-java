 ...
 *
 * See {@link #updateCustomAttributeConfigWithHttpInfo}.
 *
 * @param caseTypeId The UUID of the case type. (required)
 * @param customAttributeId Case Custom attribute's UUID (required)
 * @param body Custom attribute config payload. (required)
 ...
 * Update custom attribute config.
 *
 * See {@link #updateCustomAttributeConfigWithHttpInfoAsync}.
 *
 * @param caseTypeId The UUID of the case type. (required)
 * @param customAttributeId Case Custom attribute's UUID (required)
 * @param body Custom attribute config payload. (required)
 * @return CompletableFuture&lt;CustomAttributeConfigResponse&gt;
 */
  public CompletableFuture<CustomAttributeConfigResponse>updateCustomAttributeConfigAsync(String caseTypeId, String customAttributeId, CustomAttributeConfigUpdateRequest body) {
    return updateCustomAttributeConfigWithHttpInfoAsync(caseTypeId, customAttributeId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the display name, description, type, or options of an existing custom attribute configuration for a case type.</p>
   *
   * @param caseTypeId The UUID of the case type. (required)
   * @param customAttributeId Case Custom attribute's UUID (required)
   * @param body Custom attribute config payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<CustomAttributeConfigResponse> updateCustomAttributeConfigWithHttpInfo(String caseTypeId, String customAttributeId, CustomAttributeConfigUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseTypeId' is set
    if (caseTypeId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseTypeId' when calling updateCustomAttributeConfig");
    }

    // verify the required parameter 'customAttributeId' is set
    if (customAttributeId == null) {
      throw new ApiException(400, "Missing the required parameter 'customAttributeId' when calling updateCustomAttributeConfig");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCustomAttributeConfig");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/types/{case_type_id}/custom_attributes/{custom_attribute_id}"
      .replaceAll("\\{" + "case_type_id" + "\\}", apiClient.escapeString(caseTypeId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementAttributeApi.updateCustomAttributeConfig", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CustomAttributeConfigResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CustomAttributeConfigResponse>> updateCustomAttributeConfigWithHttpInfoAsync(String caseTypeId, String customAttributeId, CustomAttributeConfigUpdateRequest body) {
    ...
    if (caseTypeId == null) {
        CompletableFuture<ApiResponse<CustomAttributeConfigResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseTypeId' when calling updateCustomAttributeConfig"));
        return result;
    }
    ...
    if (customAttributeId == null) {
        CompletableFuture<ApiResponse<CustomAttributeConfigResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'customAttributeId' when calling updateCustomAttributeConfig"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CustomAttributeConfigResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCustomAttributeConfig"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/types/{case_type_id}/custom_attributes/{custom_attribute_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementAttributeApi.updateCustomAttributeConfig", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CustomAttributeConfigResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CustomAttributeConfigResponse>() {});
  }
}