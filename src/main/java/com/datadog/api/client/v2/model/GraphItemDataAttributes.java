...
public class GraphItemDataAttributes {
  ...
  private List<GraphItemDataAttributesCountsItems> counts = null;

  public static final String JSON_PROPERTY_TYPE = "type";
  private String type;

  public GraphItemDataAttributes counts(List<GraphItemDataAttributesCountsItems> counts) {
    this.counts = counts;
  ...
  public List<GraphItemDataAttributesCountsItems> getCounts() {
    return counts;
  }

  public void setCounts(List<GraphItemDataAttributesCountsItems> counts) {
    this.counts = counts;
  }
  ...
  /**
   * Identifier of the grouping column (for example, <code>os</code> or <code>type</code>).
   *
   * @return type
   */
  @jakarta.annotation.Nullable
