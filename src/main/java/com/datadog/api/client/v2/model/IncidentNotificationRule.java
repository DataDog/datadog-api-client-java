...
public class IncidentNotificationRule {
  ...
  public IncidentNotificationRule(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          IncidentNotificationRuleResponseData data) {
    this.data = data;
  ...
  public IncidentNotificationRule addIncludedItem(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, incidentNotificationRule.data)
        && Objects.equals(this.included, incidentNotificationRule.included)
        && Objects.equals(this.additionalProperties, incidentNotificationRule.additionalProperties);
  }
