...
public class AzureTenantType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("AzureTenant"));
  ...
  public static class AzureTenantTypeSerializer extends StdSerializer<AzureTenantType> {
      ...
      @Override
      public void serialize(AzureTenantType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
