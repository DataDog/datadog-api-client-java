...
public class AnyValue extends AbstractOpenApiSchema {
    ...
    public static class AnyValueSerializer extends StdSerializer<AnyValue> {
        ...
        @Override
        public void serialize(AnyValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AnyValueDeserializer extends StdDeserializer<AnyValue> {
        ...
        @Override
        public AnyValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(new TypeReference<List<AnyValueItem>>() {});
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    // keep the matched list, but propagate 'unparsed' from any invalid item
                    boolean itemsUnparsed = false;
                    for (AnyValueItem item : (List<AnyValueItem>) tmp) {
     ...
     * String, Double, Map&lt;String, Object&gt;, List&lt;AnyValueItem&gt;, Boolean
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be String, Double, Map<String, Object>, List<AnyValueItem>, Boolean");
    }
     ...
     * String, Double, Map&lt;String, Object&gt;, List&lt;AnyValueItem&gt;, Boolean
     *
     * @return The actual instance (String, Double, Map&lt;String, Object&gt;, List&lt;AnyValueItem&gt;, Boolean)
     */
    @Override
    ...
    /**
     * Get the actual instance of `List&lt;AnyValueItem&gt;`. If the actual instance is not `List&lt;AnyValueItem&gt;`,
     * the ClassCastException will be thrown.
     *
