...
/**
   * <p>Response containing a list of custom Agent Observability evaluator configurations.</p>
 */
@JsonPropertyOrder({
  LLMObsCustomEvalConfigListResponse.JSON_PROPERTY_DATA
})
...
public class LLMObsCustomEvalConfigListResponse {
  ...
  @JsonCreator
  public LLMObsCustomEvalConfigListResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<LLMObsCustomEvalConfigData> data) {
        this.data = data;
  ...
  /**
   * <p>List of custom evaluator configuration data objects.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsCustomEvalConfigListResponse llmObsCustomEvalConfigListResponse = (LLMObsCustomEvalConfigListResponse) o;
    return Objects.equals(this.data, llmObsCustomEvalConfigListResponse.data) && Objects.equals(this.additionalProperties, llmObsCustomEvalConfigListResponse.additionalProperties);
  }
