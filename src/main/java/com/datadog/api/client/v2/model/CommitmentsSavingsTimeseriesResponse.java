...
/**
   * <p>Response containing timeseries savings metrics for cloud commitment programs.</p>
 */
@JsonPropertyOrder({
...
public class CommitmentsSavingsTimeseriesResponse {
  ...
  @JsonCreator
  public CommitmentsSavingsTimeseriesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ACTUAL_COST)CommitmentsTimeseriesMetric actualCost,
            @JsonProperty(required=true, value=JSON_PROPERTY_EFFECTIVE_SAVINGS_RATE)CommitmentsTimeseriesMetric effectiveSavingsRate,
            @JsonProperty(required=true, value=JSON_PROPERTY_ON_DEMAND_EQUIVALENT_COST)CommitmentsTimeseriesMetric onDemandEquivalentCost,
            @JsonProperty(required=true, value=JSON_PROPERTY_REALIZED_SAVINGS)CommitmentsTimeseriesMetric realizedSavings) {
  ...
  /**
   * <p>A timeseries metric containing timestamps, series values, and optional unit metadata.</p>
   * @return actualCost
  **/
  ...
  public CommitmentsSavingsTimeseriesResponse effectiveSavingsRate(CommitmentsTimeseriesMetric effectiveSavingsRate) {
    this.effectiveSavingsRate = effectiveSavingsRate;
    this.unparsed |= effectiveSavingsRate.unparsed;
    return this;
  }
  ...
  **/
  ...
  public CommitmentsSavingsTimeseriesResponse onDemandEquivalentCost(CommitmentsTimeseriesMetric onDemandEquivalentCost) {
    this.onDemandEquivalentCost = onDemandEquivalentCost;
    this.unparsed |= onDemandEquivalentCost.unparsed;
    return this;
  }
  ...
  **/
  ...
  public CommitmentsSavingsTimeseriesResponse realizedSavings(CommitmentsTimeseriesMetric realizedSavings) {
    this.realizedSavings = realizedSavings;
    this.unparsed |= realizedSavings.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CommitmentsSavingsTimeseriesResponse commitmentsSavingsTimeseriesResponse = (CommitmentsSavingsTimeseriesResponse) o;
    return Objects.equals(this.actualCost, commitmentsSavingsTimeseriesResponse.actualCost) && Objects.equals(this.effectiveSavingsRate, commitmentsSavingsTimeseriesResponse.effectiveSavingsRate) && Objects.equals(this.onDemandEquivalentCost, commitmentsSavingsTimeseriesResponse.onDemandEquivalentCost) && Objects.equals(this.realizedSavings, commitmentsSavingsTimeseriesResponse.realizedSavings) && Objects.equals(this.additionalProperties, commitmentsSavingsTimeseriesResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(actualCost,effectiveSavingsRate,onDemandEquivalentCost,realizedSavings, additionalProperties);
  }
