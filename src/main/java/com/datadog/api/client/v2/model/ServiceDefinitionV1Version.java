...
public class ServiceDefinitionV1Version extends ModelEnum<String> {
  ...
  public static class ServiceDefinitionV1VersionSerializer extends StdSerializer<ServiceDefinitionV1Version> {
      ...
      @Override
      public void serialize(ServiceDefinitionV1Version value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
