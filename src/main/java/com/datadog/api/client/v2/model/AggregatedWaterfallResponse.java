...
/**
   * <p>Response body for the aggregated waterfall endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedWaterfallResponse.JSON_PROPERTY_DATA
})
...
public class AggregatedWaterfallResponse {
  ...
  @JsonCreator
  public AggregatedWaterfallResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedWaterfallResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, aggregatedWaterfallResponse.data) && Objects.equals(this.additionalProperties, aggregatedWaterfallResponse.additionalProperties);
  }
