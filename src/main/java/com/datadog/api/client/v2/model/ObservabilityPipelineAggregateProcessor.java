...
/**
   * <p>The <code>aggregate</code> processor combines metrics that share the same name and tags into a single metric over a configurable interval.</p>
...
public class ObservabilityPipelineAggregateProcessor {
  ...
  private ObservabilityPipelineAggregateProcessorType type = ObservabilityPipelineAggregateProcessorType.AGGREGATE;
  ...
  public ObservabilityPipelineAggregateProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_MODE)ObservabilityPipelineAggregateProcessorMode mode,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineAggregateProcessorType type) {
  ...
  **/
  ...
  /**
   * <p>The interval, in seconds, over which metrics are aggregated.</p>
   * minimum: 1
   * maximum: 60
   * @return intervalSecs
  **/
  ...
  public ObservabilityPipelineAggregateProcessor mode(ObservabilityPipelineAggregateProcessorMode mode) {
    this.mode = mode;
    this.unparsed |= !mode.isValid();
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineAggregateProcessor type(ObservabilityPipelineAggregateProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value must be <code>aggregate</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineAggregateProcessor observabilityPipelineAggregateProcessor = (ObservabilityPipelineAggregateProcessor) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName,enabled,id,include,intervalSecs,mode,type, additionalProperties);
  }
