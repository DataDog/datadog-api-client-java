...
public class AIGuardMessageContent extends AbstractOpenApiSchema {
  ...
  public static class AIGuardMessageContentSerializer extends StdSerializer<AIGuardMessageContent> {
    public AIGuardMessageContentSerializer(Class<AIGuardMessageContent> t) {
      super(t);
    }
  ...
  public static class AIGuardMessageContentDeserializer
      extends StdDeserializer<AIGuardMessageContent> {
    ...
    public AIGuardMessageContent deserialize(JsonParser jp, DeserializationContext ctxt)
      ...
      // deserialize List<AIGuardContentPart>
      try {
        boolean attemptParsing = true;
        // ensure that we respect type coercion as set on the client ObjectMapper
        ...
        if (attemptParsing) {
          tmp =
              tree.traverse(jp.getCodec())
                  .readValueAs(new TypeReference<List<AIGuardContentPart>>() {});
          // TODO: there is no validation against JSON schema constraints
          // (min, max, enum, pattern...), this does not perform a strict JSON
          // validation, which means the 'match' count may be higher than it should be.
          deserialized = tmp;
          ...
          log.log(Level.FINER, "Input data matches schema 'List<AIGuardContentPart>'");
        }
      } catch (Exception e) {
        // deserialization failed, continue
        log.log(Level.FINER, "Input data does not match schema 'List<AIGuardContentPart>'", e);
      }
    ...
    @Override
    public AIGuardMessageContent getNullValue(DeserializationContext ctxt)
        throws JsonMappingException {
      throw new JsonMappingException(ctxt.getParser(), "AIGuardMessageContent cannot be null");
    }
  }
  ...
  public AIGuardMessageContent() {
    super("oneOf", Boolean.FALSE);
  }

  public AIGuardMessageContent(String o) {
    super("oneOf", Boolean.FALSE);
    setActualInstance(o);
  }

  public AIGuardMessageContent(List<AIGuardContentPart> o) {
    super("oneOf", Boolean.FALSE);
    setActualInstance(o);
  }
  ...
  static {
    ...
    schemas.put("List<AIGuardContentPart>", new GenericType<List<AIGuardContentPart>>() {});
    JSON.registerDescendants(AIGuardMessageContent.class, Collections.unmodifiableMap(schemas));
  }

  @Override
  public Map<String, GenericType> getSchemas() {
    return AIGuardMessageContent.schemas;
  }

  /**
   * Set the instance that matches the oneOf child schema, check the instance parameter is valid
   * against the oneOf child schemas: String, List&lt;AIGuardContentPart&gt;
   *
  ...
  public void setActualInstance(Object instance) {
    ...
    throw new RuntimeException("Invalid instance type. Must be String, List<AIGuardContentPart>");
  }

  /**
   * Get the actual instance, which can be the following: String, List&lt;AIGuardContentPart&gt;
   *
   * @return The actual instance (String, List&lt;AIGuardContentPart&gt;)
   */
  @Override
  ...
  /**
   * Get the actual instance of `List&lt;AIGuardContentPart&gt;`. If the actual instance is not
   * `List&lt;AIGuardContentPart&gt;`, the ClassCastException will be thrown.
   *
   * @return The actual instance of `List&lt;AIGuardContentPart&gt;`
   * @throws ClassCastException if the instance is not `List&lt;AIGuardContentPart&gt;`
   */
  public List<AIGuardContentPart> getList() throws ClassCastException {
    return (List<AIGuardContentPart>) super.getActualInstance();
  }
}
