...
/**
   * <p>Schema for a Case-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class CaseTriggerWrapper {
  ...
  /**
   * <p>Trigger a workflow from a Case. For automatic triggering a handle must be configured and the workflow must be published.</p>
   * @return caseTrigger
  **/
  ...
  **/
   ...
   * @return CaseTriggerWrapper
   */
  @JsonAnySetter
  public CaseTriggerWrapper putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.caseTrigger, caseTriggerWrapper.caseTrigger) && Objects.equals(this.startStepNames, caseTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, caseTriggerWrapper.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(caseTrigger,startStepNames, additionalProperties);
  }
