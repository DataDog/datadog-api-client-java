 ...
 */
@JsonPropertyOrder({
  BulkDeleteAppsDatastoreItemsRequestDataAttributes.JSON_PROPERTY_ITEM_KEYS
})
...
public class BulkDeleteAppsDatastoreItemsRequestDataAttributes {
  ...
  public BulkDeleteAppsDatastoreItemsRequestDataAttributes itemKeys(List<String> itemKeys) {
  ...
  /**
   * <p>List of primary keys identifying items to delete from datastore. Up to 100 items can be deleted in a single request.</p>
   * @return itemKeys
  **/
   ...
   */
  @JsonAnySetter
  public BulkDeleteAppsDatastoreItemsRequestDataAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BulkDeleteAppsDatastoreItemsRequestDataAttributes bulkDeleteAppsDatastoreItemsRequestDataAttributes = (BulkDeleteAppsDatastoreItemsRequestDataAttributes) o;
    return Objects.equals(this.itemKeys, bulkDeleteAppsDatastoreItemsRequestDataAttributes.itemKeys) && Objects.equals(this.additionalProperties, bulkDeleteAppsDatastoreItemsRequestDataAttributes.additionalProperties);
  }
