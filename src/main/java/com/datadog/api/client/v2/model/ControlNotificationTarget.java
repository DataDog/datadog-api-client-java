...
/**
   * <p>A destination that receives notifications for an event type.</p>
 */
@JsonPropertyOrder({
...
public class ControlNotificationTarget {
  ...
  public ControlNotificationTarget(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ControlNotificationTargetType type) {
        this.handle = handle;
        this.type = type;
  ...
  /**
   * <p>The destination handle, such as an email address, Slack channel, or user handle.</p>
   * @return handle
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.handle, controlNotificationTarget.handle) && Objects.equals(this.type, controlNotificationTarget.type) && Objects.equals(this.additionalProperties, controlNotificationTarget.additionalProperties);
  }
