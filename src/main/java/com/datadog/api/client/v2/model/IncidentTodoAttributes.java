...
public class IncidentTodoAttributes {
  ...
  @JsonCreator
  public IncidentTodoAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ASSIGNEES)List<IncidentTodoAssignee> assignees,
  ...
  **/
  ...
  /**
   * <p>Timestamp when the todo was completed.</p>
   * @return completed
  **/
  ...
  @JsonProperty(JSON_PROPERTY_COMPLETED)public void setCompleted_JsonNullable(JsonNullable<String> completed) {
  ...
  /**
   * <p>The follow-up task's content.</p>
   * @return content
  **/
  ...
  **/
  ...
  /**
   * <p>Timestamp when the todo should be completed by.</p>
   * @return dueDate
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_DUE_DATE)public void setDueDate_JsonNullable(JsonNullable<String> dueDate) {
  ...
  /**
   * <p>UUID of the incident this todo is connected to.</p>
   * @return incidentId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignees,completed,content,created,dueDate,incidentId,modified, additionalProperties);
  }
