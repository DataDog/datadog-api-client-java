 ...
 */
@JsonSerialize(using = ServiceDefinitionV2Dot2Version.ServiceDefinitionV2Dot2VersionSerializer.class)
public class ServiceDefinitionV2Dot2Version extends ModelEnum<String> {
  ...
  public static final ServiceDefinitionV2Dot2Version V2_2 = new ServiceDefinitionV2Dot2Version("v2.2");
  ...
  public static class ServiceDefinitionV2Dot2VersionSerializer extends StdSerializer<ServiceDefinitionV2Dot2Version> {
      ...
      @Override
      public void serialize(ServiceDefinitionV2Dot2Version value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
