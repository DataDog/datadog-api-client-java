...
/**
   * <p>Fields to update on a Google Workspace entity context sync configuration.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes {
  ...
  **/
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes enabled(Boolean enabled) {
  ...
  **/
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes integrationType(SecurityMonitoringIntegrationTypeGoogleWorkspace integrationType) {
    this.integrationType = integrationType;
    this.unparsed |= !integrationType.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes secrets(SecurityMonitoringIntegrationConfigGoogleWorkspaceSecrets secrets) {
  ...
  **/
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes settings(Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes putSettingsItem(String key, Object settingsItem) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecurityMonitoringGoogleWorkspaceIntegrationConfigUpdateAttributes object is equal to o.
   */
  @Override
