...
public class ReactNativeSourcemapAttributes {
  ...
  **/
  ...
  /**
   * <p>The debug identifier (UUID format).</p>
   * @return debugId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The platform the source map was built for (e.g., <code>ios</code>, <code>android</code>).</p>
   * @return platform
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReactNativeSourcemapAttributes reactNativeSourcemapAttributes = (ReactNativeSourcemapAttributes) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildNumber,bundleName,bundleVersion,createdAt,debugId,mapkind,platform,service,size,version, additionalProperties);
  }
