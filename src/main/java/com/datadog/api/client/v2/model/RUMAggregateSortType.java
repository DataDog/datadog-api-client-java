...
public class RUMAggregateSortType {
  ...
  public static class RUMAggregateSortTypeSerializer extends StdSerializer<RUMAggregateSortType> {
      ...
      @Override
      public void serialize(RUMAggregateSortType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
  ...
  /**
   * Return true if this RUMAggregateSortType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((RUMAggregateSortType) o).value);
  }
