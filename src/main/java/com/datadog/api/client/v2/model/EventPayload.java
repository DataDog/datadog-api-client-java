...
public class EventPayload {
  ...
  /**
   * Integration IDs sourced from integration manifests. Only <code>custom-events</code> is
   * supported.
   *
  ...
  /**
   * A list of tags to apply to the event. Maximum of 100 tags allowed. Refer to <a
