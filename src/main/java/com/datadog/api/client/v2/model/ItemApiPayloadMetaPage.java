...
/** The definition of <code>ItemApiPayloadMetaPage</code> object. */
@JsonPropertyOrder({
...
public class ItemApiPayloadMetaPage {
  ...
  /**
   * The <code>ItemApiPayloadMeta</code> <code>hasMore</code>.
   *
   * @return hasMore
   */
  ...
  /**
   * The <code>ItemApiPayloadMeta</code> <code>totalCount</code>.
   *
   * @return totalCount
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>ItemApiPayloadMeta</code> <code>totalFilteredCount</code>.
   *
