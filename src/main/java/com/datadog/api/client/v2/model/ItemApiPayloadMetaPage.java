...
/**
   * <p>Pagination information for a collection of datastore items.</p>
 */
@JsonPropertyOrder({
...
public class ItemApiPayloadMetaPage {
  ...
  /**
   * <p>Whether there are additional pages of items beyond the current page.</p>
   * @return hasMore
  **/
  ...
  /**
   * <p>The total number of items in the datastore, ignoring any filters.</p>
   * @return totalCount
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The total number of items that match the current filter criteria.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, itemApiPayloadMetaPage.hasMore) && Objects.equals(this.totalCount, itemApiPayloadMetaPage.totalCount) && Objects.equals(this.totalFilteredCount, itemApiPayloadMetaPage.totalFilteredCount) && Objects.equals(this.additionalProperties, itemApiPayloadMetaPage.additionalProperties);
  }
