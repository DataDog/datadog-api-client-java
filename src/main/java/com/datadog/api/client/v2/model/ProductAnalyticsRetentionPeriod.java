...
public class ProductAnalyticsRetentionPeriod {
  ...
  /**
   * Time unit of the period, such as <code>day</code>, <code>week</code>, <code>month</code>, or
   * <code>year</code>.
   *
   * @return unit
   */
  ...
  /**
   * Length of the period, expressed in <code>unit</code>.
   *
   * @return value
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsRetentionPeriod productAnalyticsRetentionPeriod =
        (ProductAnalyticsRetentionPeriod) o;
    return Objects.equals(this.unit, productAnalyticsRetentionPeriod.unit)
        && Objects.equals(this.value, productAnalyticsRetentionPeriod.value)
        && Objects.equals(
            this.additionalProperties, productAnalyticsRetentionPeriod.additionalProperties);
  }
