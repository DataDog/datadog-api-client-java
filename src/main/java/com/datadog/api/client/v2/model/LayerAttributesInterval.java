...
public class LayerAttributesInterval {
  ...
  /**
   * The number of days in each rotation cycle. maximum: 400
   *
   * @return days
   */
  ...
  /**
   * Any additional seconds for the rotation cycle (up to 30 days). maximum: 2592000
   *
   * @return seconds
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.days, layerAttributesInterval.days)
        && Objects.equals(this.seconds, layerAttributesInterval.seconds)
        && Objects.equals(this.additionalProperties, layerAttributesInterval.additionalProperties);
  }
