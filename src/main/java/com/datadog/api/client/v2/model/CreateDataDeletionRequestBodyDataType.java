 ...
 */
@JsonSerialize(using = CreateDataDeletionRequestBodyDataType.CreateDataDeletionRequestBodyDataTypeSerializer.class)
public class CreateDataDeletionRequestBodyDataType extends ModelEnum<String> {
  ...
  public static class CreateDataDeletionRequestBodyDataTypeSerializer extends StdSerializer<CreateDataDeletionRequestBodyDataType> {
      public CreateDataDeletionRequestBodyDataTypeSerializer(Class<CreateDataDeletionRequestBodyDataType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(CreateDataDeletionRequestBodyDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
