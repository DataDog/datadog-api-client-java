...
/**
   * <p>Request payload for updating global incident settings.</p>
 */
@JsonPropertyOrder({
  GlobalIncidentSettingsRequest.JSON_PROPERTY_DATA
})
...
public class GlobalIncidentSettingsRequest {
  ...
  @JsonCreator
  public GlobalIncidentSettingsRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)GlobalIncidentSettingsDataRequest data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, globalIncidentSettingsRequest.data) && Objects.equals(this.additionalProperties, globalIncidentSettingsRequest.additionalProperties);
  }
