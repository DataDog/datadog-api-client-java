...
/**
   * <p>Data envelope for the rule-based view response.</p>
 */
@JsonPropertyOrder({
...
public class RuleBasedViewData {
  ...
  @JsonCreator
  public RuleBasedViewData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RuleBasedViewAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>Unique identifier of the rule-based view document.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, ruleBasedViewData.attributes) && Objects.equals(this.id, ruleBasedViewData.id) && Objects.equals(this.type, ruleBasedViewData.type) && Objects.equals(this.additionalProperties, ruleBasedViewData.additionalProperties);
  }
