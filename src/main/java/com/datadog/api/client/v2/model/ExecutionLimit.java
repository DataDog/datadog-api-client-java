 ...
 */
@JsonPropertyOrder({
  ExecutionLimit.JSON_PROPERTY_COUNT
})
...
public class ExecutionLimit {
  ...
  @JsonCreator
  public ExecutionLimit(
            @JsonProperty(required=true, value=JSON_PROPERTY_COUNT)Integer count) {
        this.count = count;
  }
  ...
  /**
   * <p>The maximum number of workflow executions.</p>
   * minimum: 1
   * maximum: 9999
   * @return count
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, executionLimit.count) && Objects.equals(this.additionalProperties, executionLimit.additionalProperties);
  }
