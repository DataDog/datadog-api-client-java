 ...
 */
  public CompletableFuture<PowerpackResponse>createPowerpackAsync(Powerpack body) {
    return createPowerpackWithHttpInfoAsync(body).thenApply(response -> {
  ...
  public ApiResponse<PowerpackResponse> createPowerpackWithHttpInfo(Powerpack body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.PowerpackApi.createPowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PowerpackResponse>> createPowerpackWithHttpInfoAsync(Powerpack body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.PowerpackApi.createPowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PowerpackResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>deletePowerpackAsync(String powerpackId) {
    return deletePowerpackWithHttpInfoAsync(powerpackId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Void> deletePowerpackWithHttpInfo(String powerpackId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/powerpacks/{powerpack_id}"
      .replaceAll("\\{" + "powerpack_id" + "\\}", apiClient.escapeString(powerpackId.toString()));

    
    Map<String, String> localVarHeaderParams = new HashMap<String, String>();


    Invocation.Builder builder = apiClient.createBuilder("v2.PowerpackApi.deletePowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deletePowerpackWithHttpInfoAsync(String powerpackId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.PowerpackApi.deletePowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<PowerpackResponse>getPowerpackAsync(String powerpackId) {
    return getPowerpackWithHttpInfoAsync(powerpackId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<PowerpackResponse> getPowerpackWithHttpInfo(String powerpackId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.PowerpackApi.getPowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PowerpackResponse>> getPowerpackWithHttpInfoAsync(String powerpackId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.PowerpackApi.getPowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PowerpackResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
 ...
 */
  public CompletableFuture<ListPowerpacksResponse>listPowerpacksAsync() {
    return listPowerpacksWithHttpInfoAsync(new ListPowerpacksOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<ListPowerpacksResponse>listPowerpacksAsync(ListPowerpacksOptionalParameters parameters) {
    return listPowerpacksWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listPowerpacks", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, false, limit, args, 0);
  ...
  /**
   * <p>Get a list of all powerpacks.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<ListPowerpacksResponse> listPowerpacksWithHttpInfo(ListPowerpacksOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.PowerpackApi.listPowerpacks", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListPowerpacksResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ListPowerpacksResponse>> listPowerpacksWithHttpInfoAsync(ListPowerpacksOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.PowerpackApi.listPowerpacks", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ListPowerpacksResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListPowerpacksResponse>() {});
  }
 ...
 */
  public CompletableFuture<PowerpackResponse>updatePowerpackAsync(String powerpackId, Powerpack body) {
    return updatePowerpackWithHttpInfoAsync(powerpackId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<PowerpackResponse> updatePowerpackWithHttpInfo(String powerpackId, Powerpack body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.PowerpackApi.updatePowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PowerpackResponse>> updatePowerpackWithHttpInfoAsync(String powerpackId, Powerpack body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.PowerpackApi.updatePowerpack", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PowerpackResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PowerpackResponse>() {});
  }
}