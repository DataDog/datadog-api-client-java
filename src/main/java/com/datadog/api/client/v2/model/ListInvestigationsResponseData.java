...
/**
   * <p>Data for an investigation list item.</p>
 */
@JsonPropertyOrder({
...
public class ListInvestigationsResponseData {
  ...
  @JsonCreator
  public ListInvestigationsResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ListInvestigationsResponseDataAttributes attributes,
  ...
  public ListInvestigationsResponseData attributes(ListInvestigationsResponseDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListInvestigationsResponseData listInvestigationsResponseData = (ListInvestigationsResponseData) o;
    return Objects.equals(this.attributes, listInvestigationsResponseData.attributes) && Objects.equals(this.id, listInvestigationsResponseData.id) && Objects.equals(this.type, listInvestigationsResponseData.type) && Objects.equals(this.additionalProperties, listInvestigationsResponseData.additionalProperties);
  }
