...
public class IoCScoreEffect extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("RAISE_SCORE", "LOWER_SCORE", "NO_EFFECT"));
  ...
  public static class IoCScoreEffectSerializer extends StdSerializer<IoCScoreEffect> {
      ...
      @Override
      public void serialize(IoCScoreEffect value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
