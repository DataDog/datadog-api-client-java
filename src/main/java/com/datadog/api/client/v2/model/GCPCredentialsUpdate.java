...
public class GCPCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class GCPCredentialsUpdateSerializer extends StdSerializer<GCPCredentialsUpdate> {
        ...
        @Override
        public void serialize(GCPCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GCPCredentialsUpdateDeserializer extends StdDeserializer<GCPCredentialsUpdate> {
        ...
        @Override
        public GCPCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (GCPServiceAccountUpdate.class.equals(Integer.class) || GCPServiceAccountUpdate.class.equals(Long.class) || GCPServiceAccountUpdate.class.equals(Float.class) || GCPServiceAccountUpdate.class.equals(Double.class) || GCPServiceAccountUpdate.class.equals(Boolean.class) || GCPServiceAccountUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((GCPServiceAccountUpdate.class.equals(Integer.class) || GCPServiceAccountUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((GCPServiceAccountUpdate.class.equals(Float.class) || GCPServiceAccountUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (GCPServiceAccountUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (GCPServiceAccountUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public GCPCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `GCPServiceAccountUpdate`. If the actual instance is not `GCPServiceAccountUpdate`,
