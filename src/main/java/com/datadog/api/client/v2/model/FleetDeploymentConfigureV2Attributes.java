...
public class FleetDeploymentConfigureV2Attributes {
  ...
  @JsonCreator
  public FleetDeploymentConfigureV2Attributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_CONFIG_OPERATIONS)List<FleetDeploymentOperation> configOperations,
  ...
  /**
   * <p>Ordered list of configuration file operations to perform on the target hosts.</p>
  ...
  **/
  ...
  /**
   * <p>Set to <code>true</code> to validate the configuration and resolve target hosts and packages
   * without deploying anything. Returns a 200 with the validation result instead of
   * creating and starting a real deployment.</p>
   * @return dryRun
  **/
  ...
  **/
  ...
  /**
   * <p>List of packages and their target versions to additionally deploy alongside
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FleetDeploymentConfigureV2Attributes fleetDeploymentConfigureV2Attributes = (FleetDeploymentConfigureV2Attributes) o;
    return Objects.equals(this.configOperations, fleetDeploymentConfigureV2Attributes.configOperations) && Objects.equals(this.dryRun, fleetDeploymentConfigureV2Attributes.dryRun) && Objects.equals(this.filterQuery, fleetDeploymentConfigureV2Attributes.filterQuery) && Objects.equals(this.targetPackages, fleetDeploymentConfigureV2Attributes.targetPackages) && Objects.equals(this.additionalProperties, fleetDeploymentConfigureV2Attributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(configOperations,dryRun,filterQuery,targetPackages, additionalProperties);
  }
