...
/**
   * <p>The incident impact's resource relationships.</p>
 */
@JsonPropertyOrder({
  IncidentImpactRelationships.JSON_PROPERTY_CREATED_BY_USER,
  IncidentImpactRelationships.JSON_PROPERTY_INCIDENT,
  IncidentImpactRelationships.JSON_PROPERTY_LAST_MODIFIED_BY_USER
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class IncidentImpactRelationships {
  @JsonIgnore
  ...
  public IncidentImpactRelationships createdByUser(RelationshipToUser createdByUser) {
  ...
  **/
   ...
   * @return IncidentImpactRelationships
   */
  @JsonAnySetter
  public IncidentImpactRelationships putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this IncidentImpactRelationships object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    IncidentImpactRelationships incidentImpactRelationships = (IncidentImpactRelationships) o;
    return Objects.equals(this.createdByUser, incidentImpactRelationships.createdByUser) && Objects.equals(this.incident, incidentImpactRelationships.incident) && Objects.equals(this.lastModifiedByUser, incidentImpactRelationships.lastModifiedByUser) && Objects.equals(this.additionalProperties, incidentImpactRelationships.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdByUser,incident,lastModifiedByUser, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IncidentImpactRelationships {\n");
