...
public class StateVariable {
  ...
  /**
   * A unique identifier for this state variable. This name is also used to access the variable's
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, stateVariable.id)
        && Objects.equals(this.name, stateVariable.name)
        && Objects.equals(this.properties, stateVariable.properties)
        && Objects.equals(this.type, stateVariable.type)
        && Objects.equals(this.additionalProperties, stateVariable.additionalProperties);
  }
