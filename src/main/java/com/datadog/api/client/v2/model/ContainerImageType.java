...
public class ContainerImageType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("container_image"));

  public static final ContainerImageType CONTAINER_IMAGE = new ContainerImageType("container_image");
  ...
  public static class ContainerImageTypeSerializer extends StdSerializer<ContainerImageType> {
      ...
      @Override
      public void serialize(ContainerImageType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
