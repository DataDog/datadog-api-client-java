...
/**
   * <p>A single ownership inference history entry.</p>
 */
@JsonPropertyOrder({
...
public class OwnershipHistoryItem {
  ...
  /**
   * <p>A checksum identifying the state of the inference at this point in time.</p>
   * @return checksum
  **/
  ...
  **/
  ...
  /**
   * <p>The time this history entry was created.</p>
   * @return createdAt
  **/
  ...
  **/
  ...
  /**
   * <p>The time when this inference failed, if applicable.</p>
   * @return failedAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_FAILED_AT)public void setFailedAt_JsonNullable(JsonNullable<OffsetDateTime> failedAt) {
  ...
  /**
   * <p>The reason why this inference failed, if applicable.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_FAILURE_REASON)public void setFailureReason_JsonNullable(JsonNullable<String> failureReason) {
  ...
  /**
   * <p>The unique identifier of the history entry.</p>
   * @return id
  **/
  ...
  **/
  ...
  /**
   * <p>The identifier of the resource that the inference applies to.</p>
   * @return resourceId
  **/
  ...
  /**
   * <p>The scheduled retry time for a failed inference, if applicable.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RETRY_SCHEDULE)public void setRetrySchedule_JsonNullable(JsonNullable<OffsetDateTime> retrySchedule) {
