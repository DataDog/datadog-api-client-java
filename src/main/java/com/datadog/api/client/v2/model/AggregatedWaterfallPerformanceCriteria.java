...
public class AggregatedWaterfallPerformanceCriteria {
  ...
  @JsonCreator
  public AggregatedWaterfallPerformanceCriteria(
            @JsonProperty(required=true, value=JSON_PROPERTY_METRIC)AggregatedWaterfallPerformanceCriteriaMetric metric) {
        this.metric = metric;
  ...
  /**
   * <p>Maximum threshold in seconds (inclusive).</p>
   * @return max
  **/
  ...
  **/
  ...
  /**
   * <p>Minimum threshold in seconds (inclusive).</p>
   * @return min
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    AggregatedWaterfallPerformanceCriteria aggregatedWaterfallPerformanceCriteria = (AggregatedWaterfallPerformanceCriteria) o;
    return Objects.equals(this.max, aggregatedWaterfallPerformanceCriteria.max) && Objects.equals(this.metric, aggregatedWaterfallPerformanceCriteria.metric) && Objects.equals(this.min, aggregatedWaterfallPerformanceCriteria.min) && Objects.equals(this.additionalProperties, aggregatedWaterfallPerformanceCriteria.additionalProperties);
  }
