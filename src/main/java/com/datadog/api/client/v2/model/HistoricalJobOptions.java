 ...
 */
@JsonPropertyOrder({
  HistoricalJobOptions.JSON_PROPERTY_ANOMALY_DETECTION_OPTIONS,
...
public class HistoricalJobOptions {
  ...
  public HistoricalJobOptions anomalyDetectionOptions(SecurityMonitoringRuleAnomalyDetectionOptions anomalyDetectionOptions) {
