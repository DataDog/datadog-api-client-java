...
public class SlosMeasure extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("good_events", "bad_events", "slo_status", "error_budget_remaining", "error_budget_remaining_history", "error_budget_burndown", "burn_rate", "slo_status_history", "good_minutes", "bad_minutes"));
  ...
  public static final SlosMeasure ERROR_BUDGET_REMAINING = new SlosMeasure("error_budget_remaining");
  public static final SlosMeasure ERROR_BUDGET_REMAINING_HISTORY = new SlosMeasure("error_budget_remaining_history");
  ...
  public static class SlosMeasureSerializer extends StdSerializer<SlosMeasure> {
      ...
      @Override
      public void serialize(SlosMeasure value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
