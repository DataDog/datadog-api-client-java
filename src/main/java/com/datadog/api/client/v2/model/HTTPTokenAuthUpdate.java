...
/**
   * <p>The definition of <code>HTTPTokenAuthUpdate</code> object.</p>
 */
@JsonPropertyOrder({
...
public class HTTPTokenAuthUpdate {
  ...
  **/
  ...
  /**
   * <p>The <code>HTTPTokenAuthUpdate</code> <code>headers</code>.</p>
   * @return headers
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The <code>HTTPTokenAuthUpdate</code> <code>tokens</code>.</p>
   * @return tokens
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The <code>HTTPTokenAuthUpdate</code> <code>url_parameters</code>.</p>
