...
public class CloudflareCredentials extends AbstractOpenApiSchema {
    ...
    public static class CloudflareCredentialsDeserializer extends StdDeserializer<CloudflareCredentials> {
        ...
        public CloudflareCredentials deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (CloudflareAPIToken.class.equals(Integer.class) || CloudflareAPIToken.class.equals(Long.class) || CloudflareAPIToken.class.equals(Float.class) || CloudflareAPIToken.class.equals(Double.class) || CloudflareAPIToken.class.equals(Boolean.class) || CloudflareAPIToken.class.equals(String.class)) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (CloudflareGlobalAPIToken.class.equals(Integer.class) || CloudflareGlobalAPIToken.class.equals(Long.class) || CloudflareGlobalAPIToken.class.equals(Float.class) || CloudflareGlobalAPIToken.class.equals(Double.class) || CloudflareGlobalAPIToken.class.equals(Boolean.class) || CloudflareGlobalAPIToken.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
     ...
     * CloudflareAPIToken, CloudflareGlobalAPIToken
     *
    ...
    /**
     * Get the actual instance of `CloudflareAPIToken`. If the actual instance is not `CloudflareAPIToken`,
    ...
    /**
     * Get the actual instance of `CloudflareGlobalAPIToken`. If the actual instance is not `CloudflareGlobalAPIToken`,
     * the ClassCastException will be thrown.
     *
