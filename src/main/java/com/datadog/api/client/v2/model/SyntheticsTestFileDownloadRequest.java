...
/**
   * <p>Request body for getting a presigned download URL for a test file.</p>
 */
@JsonPropertyOrder({
  SyntheticsTestFileDownloadRequest.JSON_PROPERTY_BUCKET_KEY
})
...
public class SyntheticsTestFileDownloadRequest {
  ...
  /**
   * <p>The bucket key referencing the file to download.</p>
   * @return bucketKey
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestFileDownloadRequest syntheticsTestFileDownloadRequest = (SyntheticsTestFileDownloadRequest) o;
    return Objects.equals(this.bucketKey, syntheticsTestFileDownloadRequest.bucketKey) && Objects.equals(this.additionalProperties, syntheticsTestFileDownloadRequest.additionalProperties);
  }
