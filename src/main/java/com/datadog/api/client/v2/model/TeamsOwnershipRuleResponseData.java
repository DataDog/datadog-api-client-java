...
/**
   * <p>The JSON:API data envelope for a teams ownership rule.</p>
 */
@JsonPropertyOrder({
...
public class TeamsOwnershipRuleResponseData {
  ...
  @JsonCreator
  public TeamsOwnershipRuleResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TeamsOwnershipRuleResponseAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>A deterministic identifier derived from the rule's grouping key.
   * This ID cannot be used to delete the rule directly; delete individual mappings
   * using the <code>mapping_id</code> under <code>teams</code> instead.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipRuleResponseData teamsOwnershipRuleResponseData = (TeamsOwnershipRuleResponseData) o;
    return Objects.equals(this.attributes, teamsOwnershipRuleResponseData.attributes) && Objects.equals(this.id, teamsOwnershipRuleResponseData.id) && Objects.equals(this.type, teamsOwnershipRuleResponseData.type) && Objects.equals(this.additionalProperties, teamsOwnershipRuleResponseData.additionalProperties);
  }
