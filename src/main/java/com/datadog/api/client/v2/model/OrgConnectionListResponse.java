...
/**
   * <p>Response containing a list of org connections.</p>
 */
@JsonPropertyOrder({
...
public class OrgConnectionListResponse {
  ...
  private List<OrgConnection> data = new ArrayList<>();
  ...
  /**
   * <p>List of org connections.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<OrgConnection> getData() {
        return data;
      }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, orgConnectionListResponse.data) && Objects.equals(this.meta, orgConnectionListResponse.meta) && Objects.equals(this.additionalProperties, orgConnectionListResponse.additionalProperties);
  }
