...
public class SBOMAttributes {
  ...
  /**
   * Specifies the format of the BOM. This helps to identify the file as CycloneDX since BOM do not
   * have a filename convention nor does JSON schema support namespaces. This value MUST be <code>
   * CycloneDX</code>.
   *
   * @return bomFormat
   */
   ...
   * changed overt time. The serial number follows <a
   * href="https://datatracker.ietf.org/doc/html/rfc4122">RFC-4122</a>
   *
   * @return serialNumber
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bomFormat, sbomAttributes.bomFormat)
        ...
        && Objects.equals(this.version, sbomAttributes.version)
        && Objects.equals(this.additionalProperties, sbomAttributes.additionalProperties);
  }
