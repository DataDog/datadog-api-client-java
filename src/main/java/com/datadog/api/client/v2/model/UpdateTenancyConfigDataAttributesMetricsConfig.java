...
/**
 * Metrics collection configuration for updating an OCI tenancy, controlling which compartments and
...
public class UpdateTenancyConfigDataAttributesMetricsConfig {
  ...
  public UpdateTenancyConfigDataAttributesMetricsConfig compartmentTagFilters(
      List<String> compartmentTagFilters) {
    this.compartmentTagFilters = compartmentTagFilters;
    return this;
  }

  public UpdateTenancyConfigDataAttributesMetricsConfig addCompartmentTagFiltersItem(
  ...
  public UpdateTenancyConfigDataAttributesMetricsConfig excludedServices(
      List<String> excludedServices) {
    this.excludedServices = excludedServices;
    return this;
  }

  public UpdateTenancyConfigDataAttributesMetricsConfig addExcludedServicesItem(
   ...
   */
  @JsonAnySetter
  public UpdateTenancyConfigDataAttributesMetricsConfig putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    UpdateTenancyConfigDataAttributesMetricsConfig updateTenancyConfigDataAttributesMetricsConfig =
        (UpdateTenancyConfigDataAttributesMetricsConfig) o;
    return Objects.equals(
            this.compartmentTagFilters,
            updateTenancyConfigDataAttributesMetricsConfig.compartmentTagFilters)
        && Objects.equals(this.enabled, updateTenancyConfigDataAttributesMetricsConfig.enabled)
        && Objects.equals(
            this.excludedServices, updateTenancyConfigDataAttributesMetricsConfig.excludedServices)
        && Objects.equals(
            this.additionalProperties,
            updateTenancyConfigDataAttributesMetricsConfig.additionalProperties);
  }
