...
public class GuardrailTriggerAction extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("PAUSE", "ABORT"));
  ...
  public static class GuardrailTriggerActionSerializer extends StdSerializer<GuardrailTriggerAction> {
      ...
      @Override
      public void serialize(GuardrailTriggerAction value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
