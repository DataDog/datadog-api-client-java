...
/** The <code>throttle</code> processor limits the rate of events using a time-based window. */
@JsonPropertyOrder({
...
public class ObservabilityPipelineThrottleProcessor {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, observabilityPipelineThrottleProcessor.id)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, include, inputs, threshold, type, window, additionalProperties);
  }
