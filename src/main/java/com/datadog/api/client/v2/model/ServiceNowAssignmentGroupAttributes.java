...
public class ServiceNowAssignmentGroupAttributes {
  ...
  @JsonCreator
  public ServiceNowAssignmentGroupAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ASSIGNMENT_GROUP_NAME)String assignmentGroupName,
            @JsonProperty(required=true, value=JSON_PROPERTY_ASSIGNMENT_GROUP_SYS_ID)String assignmentGroupSysId,
  ...
  /**
   * <p>The name of the assignment group</p>
  ...
  **/
  ...
  /**
   * <p>The system ID of the assignment group in ServiceNow</p>
