...
public class CIAppPipelineEventStageLevel extends ModelEnum<String> {
  ...
  public static final CIAppPipelineEventStageLevel STAGE = new CIAppPipelineEventStageLevel("stage");
  ...
  public static class CIAppPipelineEventStageLevelSerializer extends StdSerializer<CIAppPipelineEventStageLevel> {
      ...
      @Override
      public void serialize(CIAppPipelineEventStageLevel value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
