...
public class ChangeRequestChangeType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("NORMAL", "STANDARD", "EMERGENCY"));
  ...
  public static class ChangeRequestChangeTypeSerializer extends StdSerializer<ChangeRequestChangeType> {
      ...
      @Override
      public void serialize(ChangeRequestChangeType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
