 ...
 */
@JsonPropertyOrder({
  DORAFailureRequestData.JSON_PROPERTY_ATTRIBUTES
})
...
public class DORAFailureRequestData {
  ...
  @JsonCreator
  public DORAFailureRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)DORAFailureRequestAttributes attributes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, doraFailureRequestData.attributes) && Objects.equals(this.additionalProperties, doraFailureRequestData.additionalProperties);
  }
