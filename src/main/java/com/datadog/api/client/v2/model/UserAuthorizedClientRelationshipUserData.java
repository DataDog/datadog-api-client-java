...
public class UserAuthorizedClientRelationshipUserData {
  ...
  public UserAuthorizedClientRelationshipUserData(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)UserAuthorizedClientRelationshipUserDataType type) {
        this.id = id;
        this.type = type;
  ...
  **/
  ...
  public UserAuthorizedClientRelationshipUserData type(UserAuthorizedClientRelationshipUserDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserAuthorizedClientRelationshipUserData userAuthorizedClientRelationshipUserData = (UserAuthorizedClientRelationshipUserData) o;
    return Objects.equals(this.id, userAuthorizedClientRelationshipUserData.id) && Objects.equals(this.type, userAuthorizedClientRelationshipUserData.type) && Objects.equals(this.additionalProperties, userAuthorizedClientRelationshipUserData.additionalProperties);
  }
