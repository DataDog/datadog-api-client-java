...
public class IssuesSearchResultAttributes {
  ...
  /**
   * <p>Count of sessions impacted by the issue over the queried time window.</p>
  ...
  **/
  ...
  /**
   * <p>Count of users impacted by the issue over the queried time window.</p>
  ...
  **/
  ...
  /**
   * <p>Total count of errors that match the issue over the queried time window.</p>
   * @return totalCount
  **/
      @jakarta.annotation.Nullable
