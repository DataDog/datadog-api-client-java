...
/**
   * <p>JSON:API document containing a single Recommendation resource. Returned by SPA when the Spark Gateway requests recommendations.</p>
 */
@JsonPropertyOrder({
  RecommendationDocument.JSON_PROPERTY_DATA
})
...
public class RecommendationDocument {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, recommendationDocument.data) && Objects.equals(this.additionalProperties, recommendationDocument.additionalProperties);
  }
