...
/**
   * <p>A budget and all its entries.</p>
 */
@JsonPropertyOrder({
  BudgetWithEntriesData.JSON_PROPERTY_ATTRIBUTES,
  BudgetWithEntriesData.JSON_PROPERTY_ID,
  BudgetWithEntriesData.JSON_PROPERTY_TYPE
})
...
public class BudgetWithEntriesData {
  ...
  **/
  ...
  /**
   * <p>The <code>BudgetWithEntriesData</code> <code>id</code>.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  public BudgetWithEntriesData type(String type) {
    this.type = type;
    return this;
  }

  /**
   * <p>The type of the object, must be <code>budget</code>.</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, budgetWithEntriesData.attributes) && Objects.equals(this.id, budgetWithEntriesData.id) && Objects.equals(this.type, budgetWithEntriesData.type) && Objects.equals(this.additionalProperties, budgetWithEntriesData.additionalProperties);
  }
