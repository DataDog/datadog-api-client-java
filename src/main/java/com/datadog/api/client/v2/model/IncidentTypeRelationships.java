...
public class IncidentTypeRelationships {
  ...
  private JsonNullable<GoogleMeetConfigurationReference> googleMeetConfiguration =
      JsonNullable.<GoogleMeetConfigurationReference>undefined();
  ...
  private JsonNullable<MicrosoftTeamsConfigurationReference> microsoftTeamsConfiguration =
      JsonNullable.<MicrosoftTeamsConfigurationReference>undefined();

  public static final String JSON_PROPERTY_ZOOM_CONFIGURATION = "zoom_configuration";
  private JsonNullable<ZoomConfigurationReference> zoomConfiguration =
      JsonNullable.<ZoomConfigurationReference>undefined();
  ...
  public IncidentTypeRelationships googleMeetConfiguration(
      GoogleMeetConfigurationReference googleMeetConfiguration) {
    this.googleMeetConfiguration =
        JsonNullable.<GoogleMeetConfigurationReference>of(googleMeetConfiguration);
    return this;
  }
  ...
  public void setGoogleMeetConfiguration_JsonNullable(
      JsonNullable<GoogleMeetConfigurationReference> googleMeetConfiguration) {
  ...
  public IncidentTypeRelationships microsoftTeamsConfiguration(
    ...
    this.microsoftTeamsConfiguration =
        JsonNullable.<MicrosoftTeamsConfigurationReference>of(microsoftTeamsConfiguration);
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<MicrosoftTeamsConfigurationReference>
  ...
  public void setMicrosoftTeamsConfiguration_JsonNullable(
      JsonNullable<MicrosoftTeamsConfigurationReference> microsoftTeamsConfiguration) {
  ...
  public void setZoomConfiguration_JsonNullable(
      JsonNullable<ZoomConfigurationReference> zoomConfiguration) {
