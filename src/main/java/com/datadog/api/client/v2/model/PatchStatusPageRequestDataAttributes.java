...
public class PatchStatusPageRequestDataAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyLogo,domainPrefix,emailHeaderImage,enabled,favicon,name,slackAppIcon,slackSubscriptionsEnabled,subscriptionsEnabled,type,visualizationType, additionalProperties);
  }
