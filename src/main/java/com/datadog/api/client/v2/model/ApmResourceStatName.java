...
public class ApmResourceStatName extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("error_rate", "errors", "hits", "latency_avg", "latency_max", "latency_p50", "latency_p75", "latency_p90", "latency_p95", "latency_p99", "latency_distribution", "total_time"));
  ...
  public static final ApmResourceStatName LATENCY_DISTRIBUTION = new ApmResourceStatName("latency_distribution");
  ...
  public static class ApmResourceStatNameSerializer extends StdSerializer<ApmResourceStatName> {
      ...
      @Override
      public void serialize(ApmResourceStatName value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
