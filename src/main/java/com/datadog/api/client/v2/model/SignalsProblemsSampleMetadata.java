...
public class SignalsProblemsSampleMetadata {
  ...
  /**
   * <p>Number of view instances that failed to process.</p>
   * maximum: 2147483647
   * @return failed
  **/
  ...
  /**
   * <p>Number of view instances requested for sampling.</p>
   * maximum: 2147483647
   * @return requested
  **/
  ...
  /**
   * <p>List of RUM view IDs that were sampled.</p>
  ...
  **/
  ...
  /**
   * <p>Number of view instances successfully processed.</p>
   * maximum: 2147483647
   * @return succeeded
  **/
  ...
  /**
   * <p>Ratio of successfully processed views to requested views.</p>
   * @return successRate
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.failed, signalsProblemsSampleMetadata.failed) && Objects.equals(this.requested, signalsProblemsSampleMetadata.requested) && Objects.equals(this.sampledViewIds, signalsProblemsSampleMetadata.sampledViewIds) && Objects.equals(this.succeeded, signalsProblemsSampleMetadata.succeeded) && Objects.equals(this.successRate, signalsProblemsSampleMetadata.successRate) && Objects.equals(this.additionalProperties, signalsProblemsSampleMetadata.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(failed,requested,sampledViewIds,succeeded,successRate, additionalProperties);
  }
