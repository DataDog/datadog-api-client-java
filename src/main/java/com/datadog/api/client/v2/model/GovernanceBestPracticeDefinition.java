...
/**
   * <p>The best practice associated with an insight. Populated with the first active best practice
   * matched to the insight; <code>null</code> when no best practice is attached.</p>
 */
@JsonPropertyOrder({
...
public class GovernanceBestPracticeDefinition {
  ...
  public GovernanceBestPracticeDefinition(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TRIGGER_CONDITION)String triggerCondition,
  ...
  /**
   * <p>The value driver the best practice is grouped under, such as <code>access_governance</code>,
   * <code>security</code>, <code>compliance</code>, or <code>operational_hygiene</code>.</p>
   * @return category
  **/
  ...
  /**
   * <p>A relative link to the configuration page where the best practice can be acted upon.</p>
   * @return deepLink
  **/
  ...
  /**
   * <p>The full rationale and guidance for the best practice.</p>
   * @return description
  **/
  ...
  /**
   * <p>An optional association to a control's detection type. <code>null</code> when not associated with a control.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DETECTION_TYPE)public void setDetectionType_JsonNullable(JsonNullable<String> detectionType) {
  ...
  /**
   * <p>The unique identifier of the best practice.</p>
   * @return id
  **/
  ...
  /**
   * <p>The expected impact of following the best practice.</p>
   * @return impact
  **/
  ...
  /**
   * <p>A priority hint for ordering best practices by expected impact. Lower values indicate
   * higher priority.</p>
   * @return impactHint
  **/
  ...
  /**
   * <p>The permissions required for the user to act on the best practice.</p>
   * @return permissions
  **/
  ...
  /**
   * <p>Whether the best practice is currently <code>active</code> or <code>deprecated</code>.</p>
   * @return status
  **/
  ...
  /**
   * <p>A one-line explanation of why this best practice matters.</p>
   * @return summary
  **/
  ...
  /**
   * <p>A short, human-readable name for the best practice.</p>
   * @return title
  **/
  ...
  /**
   * <p>The condition that surfaces the best practice. For an <code>insight</code> trigger, the insight
   * slug; for a <code>static</code> trigger, a descriptive condition key.</p>
  ...
  **/
  ...
  /**
   * <p>How the best practice is surfaced. <code>insight</code> ties it to an insight; <code>static</code> surfaces it
   * unless its condition is met.</p>
   * @return triggerType
  **/
