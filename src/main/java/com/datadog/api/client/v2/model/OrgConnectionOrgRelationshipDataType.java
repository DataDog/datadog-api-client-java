...
/** The definition of <code>OrgConnectionOrgRelationshipDataType</code> object. */
@JsonSerialize(
    using =
...
public class OrgConnectionOrgRelationshipDataType extends ModelEnum<String> {
  ...
  public static class OrgConnectionOrgRelationshipDataTypeSerializer
      extends StdSerializer<OrgConnectionOrgRelationshipDataType> {
    public OrgConnectionOrgRelationshipDataTypeSerializer(
        Class<OrgConnectionOrgRelationshipDataType> t) {
      super(t);
    }
