...
public class CIAppAggregateSortType extends ModelEnum<String> {
  ...
  public static final CIAppAggregateSortType ALPHABETICAL = new CIAppAggregateSortType("alphabetical");
  ...
  public static class CIAppAggregateSortTypeSerializer extends StdSerializer<CIAppAggregateSortType> {
      ...
      @Override
      public void serialize(CIAppAggregateSortType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
