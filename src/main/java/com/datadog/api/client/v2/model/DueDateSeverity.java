...
public class DueDateSeverity extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("critical", "high", "medium", "low", "info", "none", "unknown"));
  ...
  public static class DueDateSeveritySerializer extends StdSerializer<DueDateSeverity> {
      ...
      @Override
      public void serialize(DueDateSeverity value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
