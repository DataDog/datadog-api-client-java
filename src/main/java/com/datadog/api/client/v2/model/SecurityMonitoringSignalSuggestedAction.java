...
/**
   * <p>A suggested action for a security signal.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringSignalSuggestedAction {
  ...
  @JsonCreator
  public SecurityMonitoringSignalSuggestedAction(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SecurityMonitoringSignalSuggestedActionAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SecurityMonitoringSignalSuggestedActionType type) {
  ...
  public SecurityMonitoringSignalSuggestedAction attributes(SecurityMonitoringSignalSuggestedActionAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The unique ID of the suggested action.</p>
   * @return id
  **/
  ...
  public SecurityMonitoringSignalSuggestedAction type(SecurityMonitoringSignalSuggestedActionType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringSignalSuggestedAction securityMonitoringSignalSuggestedAction = (SecurityMonitoringSignalSuggestedAction) o;
    return Objects.equals(this.attributes, securityMonitoringSignalSuggestedAction.attributes) && Objects.equals(this.id, securityMonitoringSignalSuggestedAction.id) && Objects.equals(this.type, securityMonitoringSignalSuggestedAction.type) && Objects.equals(this.additionalProperties, securityMonitoringSignalSuggestedAction.additionalProperties);
  }
