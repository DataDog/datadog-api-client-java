...
/**
   * <p>Widget experience types that differentiate between the products using the specific widget.</p>
 */
...
public class WidgetExperienceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ccm_reports", "logs_reports", "csv_reports", "product_analytics"));
  ...
  public static final WidgetExperienceType PRODUCT_ANALYTICS = new WidgetExperienceType("product_analytics");
  ...
  public static class WidgetExperienceTypeSerializer extends StdSerializer<WidgetExperienceType> {
      ...
      @Override
      public void serialize(WidgetExperienceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
