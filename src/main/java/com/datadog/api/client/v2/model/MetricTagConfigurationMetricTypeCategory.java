...
/**
   * <p>The metric's type category.</p>
 */
@JsonSerialize(using = MetricTagConfigurationMetricTypeCategory.MetricTagConfigurationMetricTypeCategorySerializer.class)
public class MetricTagConfigurationMetricTypeCategory extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("non_distribution", "distribution"));
  ...
  public static class MetricTagConfigurationMetricTypeCategorySerializer extends StdSerializer<MetricTagConfigurationMetricTypeCategory> {
      public MetricTagConfigurationMetricTypeCategorySerializer(Class<MetricTagConfigurationMetricTypeCategory> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(MetricTagConfigurationMetricTypeCategory value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
