...
public class FunnelSuggestionRequestDataType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("funnel_suggestion_request"));
  ...
  public static class FunnelSuggestionRequestDataTypeSerializer
      extends StdSerializer<FunnelSuggestionRequestDataType> {
    public FunnelSuggestionRequestDataTypeSerializer(Class<FunnelSuggestionRequestDataType> t) {
      super(t);
    }
