...
public class SecurityMonitoringRuleImpossibleTravelOptions {
  ...
  public static final String JSON_PROPERTY_BASELINE_USER_LOCATIONS_DURATION = "baselineUserLocationsDuration";
  ...
  /**
   * <p>If true, signals are suppressed for the first 24 hours. In that time, Datadog learns the user's regular
   * access locations. This can be helpful to reduce noise and infer VPN usage or credentialed API access.</p>
  ...
  **/
  ...
  public SecurityMonitoringRuleImpossibleTravelOptions baselineUserLocationsDuration(Integer baselineUserLocationsDuration) {
    this.baselineUserLocationsDuration = JsonNullable.<Integer>of(baselineUserLocationsDuration);
    return this;
  }

  /**
   * <p>The duration in days during which Datadog learns the user's regular access locations. After this period, signals are generated for accesses from unknown locations.</p>
   * minimum: 1
   * maximum: 30
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_BASELINE_USER_LOCATIONS_DURATION)public void setBaselineUserLocationsDuration_JsonNullable(JsonNullable<Integer> baselineUserLocationsDuration) {
  ...
  public SecurityMonitoringRuleImpossibleTravelOptions detectIpTransition(Boolean detectIpTransition) {
    this.detectIpTransition = detectIpTransition;
    return this;
  }

  /**
   * <p>Whether to detect transitions between IP addresses.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringRuleImpossibleTravelOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringRuleImpossibleTravelOptions securityMonitoringRuleImpossibleTravelOptions = (SecurityMonitoringRuleImpossibleTravelOptions) o;
    return Objects.equals(this.baselineUserLocations, securityMonitoringRuleImpossibleTravelOptions.baselineUserLocations) && Objects.equals(this.baselineUserLocationsDuration, securityMonitoringRuleImpossibleTravelOptions.baselineUserLocationsDuration) && Objects.equals(this.detectIpTransition, securityMonitoringRuleImpossibleTravelOptions.detectIpTransition) && Objects.equals(this.additionalProperties, securityMonitoringRuleImpossibleTravelOptions.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(baselineUserLocations,baselineUserLocationsDuration,detectIpTransition, additionalProperties);
  }
