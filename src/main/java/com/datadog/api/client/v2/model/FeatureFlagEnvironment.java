...
/**
   * <p>Environment-specific settings for a feature flag.</p>
 */
@JsonPropertyOrder({
...
public class FeatureFlagEnvironment {
  ...
  private JsonNullable<Map<String, Object>> allocations = JsonNullable.<Map<String, Object>>undefined();
  ...
  /**
   * <p>Allocation metadata for this environment.</p>
   * @return allocations
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALLOCATIONS)public void setAllocations_JsonNullable(JsonNullable<Map<String, Object>> allocations) {
  ...
  /**
   * <p>The allocation key used for the default variant.</p>
  ...
  **/
  ...
  /**
   * <p>The ID of the default variant for this environment.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_VARIANT_ID)public void setDefaultVariantId_JsonNullable(JsonNullable<String> defaultVariantId) {
  ...
  **/
  ...
  /**
   * <p>Indicates whether the environment is production.</p>
   * @return isProduction
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The allocation key used for the override variant.</p>
  ...
  **/
  ...
  /**
   * <p>The ID of the override variant for this environment.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_OVERRIDE_VARIANT_ID)public void setOverrideVariantId_JsonNullable(JsonNullable<String> overrideVariantId) {
  ...
  /**
   * <p>Pending suggestion identifier, if approval is required.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PENDING_SUGGESTION_ID)public void setPendingSuggestionId_JsonNullable(JsonNullable<String> pendingSuggestionId) {
  ...
  **/
  ...
  /**
   * <p>Rollout percentage for this environment.</p>
   * minimum: 0
   * maximum: 100
  ...
  **/
  ...
  /**
   * <p>Environment targeting rules for this feature flag.</p>
   * @return rules
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allocations, featureFlagEnvironment.allocations) && Objects.equals(this.defaultAllocationKey, featureFlagEnvironment.defaultAllocationKey) && Objects.equals(this.defaultVariantId, featureFlagEnvironment.defaultVariantId) && Objects.equals(this.environmentId, featureFlagEnvironment.environmentId) && Objects.equals(this.environmentName, featureFlagEnvironment.environmentName) && Objects.equals(this.isProduction, featureFlagEnvironment.isProduction) && Objects.equals(this.overrideAllocationKey, featureFlagEnvironment.overrideAllocationKey) && Objects.equals(this.overrideVariantId, featureFlagEnvironment.overrideVariantId) && Objects.equals(this.pendingSuggestionId, featureFlagEnvironment.pendingSuggestionId) && Objects.equals(this.requireFeatureFlagApproval, featureFlagEnvironment.requireFeatureFlagApproval) && Objects.equals(this.rolloutPercentage, featureFlagEnvironment.rolloutPercentage) && Objects.equals(this.rules, featureFlagEnvironment.rules) && Objects.equals(this.status, featureFlagEnvironment.status) && Objects.equals(this.additionalProperties, featureFlagEnvironment.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(allocations,defaultAllocationKey,defaultVariantId,environmentId,environmentName,isProduction,overrideAllocationKey,overrideVariantId,pendingSuggestionId,requireFeatureFlagApproval,rolloutPercentage,rules,status, additionalProperties);
  }
