 ...
 */
@JsonPropertyOrder({
  EventsRequestPage.JSON_PROPERTY_CURSOR,
  EventsRequestPage.JSON_PROPERTY_LIMIT
})
...
public class EventsRequestPage {
  ...
  /**
   * <p>The returned paging point to use to get the next results.</p>
   * @return cursor
  **/
  ...
  /**
   * <p>The maximum number of events in the response.</p>
   * maximum: 1000
   * @return limit
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cursor, eventsRequestPage.cursor) && Objects.equals(this.limit, eventsRequestPage.limit) && Objects.equals(this.additionalProperties, eventsRequestPage.additionalProperties);
  }
