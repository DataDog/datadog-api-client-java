...
public class GetAstRequestDataAttributes {
  ...
  /**
   * <p>The base64-encoded source code to parse into an abstract syntax tree.</p>
   * @return code
  **/
  ...
  /**
   * <p>The encoding of the source code file (must be utf-8).</p>
   * @return fileEncoding
  **/
  ...
  /**
   * <p>The programming language of the source code to parse.</p>
   * @return language
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, getAstRequestDataAttributes.code) && Objects.equals(this.fileEncoding, getAstRequestDataAttributes.fileEncoding) && Objects.equals(this.language, getAstRequestDataAttributes.language) && Objects.equals(this.additionalProperties, getAstRequestDataAttributes.additionalProperties);
  }
