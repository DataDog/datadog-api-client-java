...
public class ServiceDefinitionMeta {
  ...
  **/
  ...
  /**
   * <p>User defined origin of the service definition.</p>
   * @return origin
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>User defined origin's detail of the service definition.</p>
   * @return originDetail
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A list of schema validation warnings.</p>
   * @return warnings
  **/
      @jakarta.annotation.Nullable
