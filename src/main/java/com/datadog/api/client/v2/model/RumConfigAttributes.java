...
/**
   * <p>Attributes of the RUM configuration.</p>
 */
@JsonPropertyOrder({
...
public class RumConfigAttributes {
  ...
  public static final String JSON_PROPERTY_ENFORCED_APPLICATION_TAGS_UPDATED_AT = "enforced_application_tags_updated_at";
  private OffsetDateTime enforcedApplicationTagsUpdatedAt;

  public static final String JSON_PROPERTY_ENFORCED_APPLICATION_TAGS_UPDATED_BY = "enforced_application_tags_updated_by";
  ...
  public static final String JSON_PROPERTY_OOTB_METRICS_VERSION_INSTALLED_AT = "ootb_metrics_version_installed_at";
  ...
  public static final String JSON_PROPERTY_RETENTION_FILTERS_ENABLED_UPDATED_AT = "retention_filters_enabled_updated_at";
  private OffsetDateTime retentionFiltersEnabledUpdatedAt;

  public static final String JSON_PROPERTY_RETENTION_FILTERS_ENABLED_UPDATED_BY = "retention_filters_enabled_updated_by";
  ...
  @JsonCreator
  public RumConfigAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ENFORCED_APPLICATION_TAGS)Boolean enforcedApplicationTags,
            @JsonProperty(required=true, value=JSON_PROPERTY_RETENTION_FILTERS_ENABLED)Boolean retentionFiltersEnabled) {
  ...
  /**
   * <p>Whether the RUM configuration is disabled for the organization.</p>
   * @return disabled
  **/
  ...
  /**
   * <p>Whether application tags are enforced for the RUM applications in the organization.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp of when the enforced application tags setting was last updated.</p>
  ...
  **/
  ...
  /**
   * <p>Handle of the user who last updated the enforced application tags setting.</p>
  ...
  **/
  ...
  /**
   * <p>Version of the out-of-the-box metrics installed for the organization.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp of when the out-of-the-box metrics version was installed.</p>
  ...
  **/
  ...
  /**
   * <p>Whether retention filters are enabled for the organization.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp of when the retention filters setting was last updated.</p>
  ...
  **/
  ...
  /**
   * <p>Handle of the user or job who last updated the retention filters setting.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disabled, rumConfigAttributes.disabled) && Objects.equals(this.enforcedApplicationTags, rumConfigAttributes.enforcedApplicationTags) && Objects.equals(this.enforcedApplicationTagsUpdatedAt, rumConfigAttributes.enforcedApplicationTagsUpdatedAt) && Objects.equals(this.enforcedApplicationTagsUpdatedBy, rumConfigAttributes.enforcedApplicationTagsUpdatedBy) && Objects.equals(this.ootbMetricsVersion, rumConfigAttributes.ootbMetricsVersion) && Objects.equals(this.ootbMetricsVersionInstalledAt, rumConfigAttributes.ootbMetricsVersionInstalledAt) && Objects.equals(this.retentionFiltersEnabled, rumConfigAttributes.retentionFiltersEnabled) && Objects.equals(this.retentionFiltersEnabledUpdatedAt, rumConfigAttributes.retentionFiltersEnabledUpdatedAt) && Objects.equals(this.retentionFiltersEnabledUpdatedBy, rumConfigAttributes.retentionFiltersEnabledUpdatedBy) && Objects.equals(this.additionalProperties, rumConfigAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(disabled,enforcedApplicationTags,enforcedApplicationTagsUpdatedAt,enforcedApplicationTagsUpdatedBy,ootbMetricsVersion,ootbMetricsVersionInstalledAt,retentionFiltersEnabled,retentionFiltersEnabledUpdatedAt,retentionFiltersEnabledUpdatedBy, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    enforcedApplicationTags: ").append(toIndentedString(enforcedApplicationTags)).append("\n");
    sb.append("    enforcedApplicationTagsUpdatedAt: ").append(toIndentedString(enforcedApplicationTagsUpdatedAt)).append("\n");
    sb.append("    enforcedApplicationTagsUpdatedBy: ").append(toIndentedString(enforcedApplicationTagsUpdatedBy)).append("\n");
    sb.append("    ootbMetricsVersion: ").append(toIndentedString(ootbMetricsVersion)).append("\n");
    sb.append("    ootbMetricsVersionInstalledAt: ").append(toIndentedString(ootbMetricsVersionInstalledAt)).append("\n");
    sb.append("    retentionFiltersEnabled: ").append(toIndentedString(retentionFiltersEnabled)).append("\n");
    sb.append("    retentionFiltersEnabledUpdatedAt: ").append(toIndentedString(retentionFiltersEnabledUpdatedAt)).append("\n");
    sb.append("    retentionFiltersEnabledUpdatedBy: ").append(toIndentedString(retentionFiltersEnabledUpdatedBy)).append("\n");
