...
/**
   * <p>The RUM retention quota configuration object.</p>
 */
@JsonPropertyOrder({
...
public class RumRetentionQuotaConfigData {
  ...
  @JsonCreator
  public RumRetentionQuotaConfigData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RumRetentionQuotaConfigAttributes attributes,
  ...
  /**
   * <p>The RUM retention quota configuration properties.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The identifier of the scope the retention quota configuration applies to.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, rumRetentionQuotaConfigData.attributes) && Objects.equals(this.id, rumRetentionQuotaConfigData.id) && Objects.equals(this.type, rumRetentionQuotaConfigData.type) && Objects.equals(this.additionalProperties, rumRetentionQuotaConfigData.additionalProperties);
  }
