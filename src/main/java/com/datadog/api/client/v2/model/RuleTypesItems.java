...
public class RuleTypesItems extends ModelEnum<String> {
  ...
  public static final RuleTypesItems SECRET_VULNERABILITY = new RuleTypesItems("secret_vulnerability");
  ...
  public static final RuleTypesItems SERVERLESS_FUNCTION_CODE_VULNERABILITY = new RuleTypesItems("serverless_function_code_vulnerability");
