...
public class SyntheticsTestResultBucketKeys {
  ...
  /**
   * <p>Key for the screenshot captured after the step (goal-based tests).</p>
  ...
  **/
  ...
  /**
   * <p>Key for the screenshot captured after the turn (goal-based tests).</p>
  ...
  **/
  ...
  /**
   * <p>Key for miscellaneous artifacts.</p>
   * @return artifacts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Key for the screenshot captured before the step (goal-based tests).</p>
  ...
  **/
  ...
  /**
   * <p>Key for the screenshot captured before the turn (goal-based tests).</p>
  ...
  **/
  ...
  /**
   * <p>Key for a captured crash report.</p>
   * @return crashReport
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Key for captured device logs.</p>
   * @return deviceLogs
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Keys for email message payloads captured by the step.</p>
  ...
  **/
  ...
  /**
   * <p>Key for the captured screenshot.</p>
   * @return screenshot
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Key for the captured DOM snapshot.</p>
   * @return snapshot
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Key for the page source or element source.</p>
   * @return source
  **/
      @jakarta.annotation.Nullable
