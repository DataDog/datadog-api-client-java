 ...
 * Update a case type.
 *
 * See {@link #updateCaseTypeWithHttpInfo}.
 *
 * @param caseTypeId The UUID of the case type. (required)
 * @param body Case type payload. (required)
 * @return CaseTypeResponse
 ...
 * Update a case type.
 *
 * See {@link #updateCaseTypeWithHttpInfoAsync}.
 *
 * @param caseTypeId The UUID of the case type. (required)
 * @param body Case type payload. (required)
 * @return CompletableFuture&lt;CaseTypeResponse&gt;
 */
  public CompletableFuture<CaseTypeResponse>updateCaseTypeAsync(String caseTypeId, CaseTypeUpdateRequest body) {
    return updateCaseTypeWithHttpInfoAsync(caseTypeId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the name, emoji, or description of an existing case type.</p>
   *
   * @param caseTypeId The UUID of the case type. (required)
   * @param body Case type payload. (required)
   * @return ApiResponse&lt;CaseTypeResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<CaseTypeResponse> updateCaseTypeWithHttpInfo(String caseTypeId, CaseTypeUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseTypeId' is set
    if (caseTypeId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseTypeId' when calling updateCaseType");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseType");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/types/{case_type_id}"
      .replaceAll("\\{" + "case_type_id" + "\\}", apiClient.escapeString(caseTypeId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementTypeApi.updateCaseType", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseTypeResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseTypeResponse>> updateCaseTypeWithHttpInfoAsync(String caseTypeId, CaseTypeUpdateRequest body) {
    ...
    if (caseTypeId == null) {
        CompletableFuture<ApiResponse<CaseTypeResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseTypeId' when calling updateCaseType"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseTypeResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseType"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/types/{case_type_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementTypeApi.updateCaseType", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseTypeResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseTypeResponse>() {});
  }
}