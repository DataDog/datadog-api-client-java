...
public class SeatsApi {
   ...
   *
   * <p>See {@link #assignSeatsUserWithHttpInfo}.
   *
   * @param body (required)
   ...
   * Assign seats to users.
   *
   * <p>See {@link #assignSeatsUserWithHttpInfoAsync}.
   *
   * @param body (required)
   * @return CompletableFuture&lt;AssignSeatsUserResponse&gt;
   */
  public CompletableFuture<AssignSeatsUserResponse> assignSeatsUserAsync(
      AssignSeatsUserRequest body) {
    return assignSeatsUserWithHttpInfoAsync(body)
        .thenApply(
            response -> {
   ...
   *     </table>
   */
  public ApiResponse<AssignSeatsUserResponse> assignSeatsUserWithHttpInfo(
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling assignSeatsUser");
    }
   ...
   */
  public CompletableFuture<ApiResponse<AssignSeatsUserResponse>> assignSeatsUserWithHttpInfoAsync(
      AssignSeatsUserRequest body) {
    Object localVarPostBody = body;
   ...
   *
   * <p>See {@link #getSeatsUsersWithHttpInfo}.
   *
   ...
   * Get users with seats.
   *
   * <p>See {@link #getSeatsUsersWithHttpInfoAsync}.
   *
   * @param productCode The product code for which to retrieve seat users. (required)
  ...
  public CompletableFuture<SeatUserDataArray> getSeatsUsersAsync(String productCode) {
    return getSeatsUsersWithHttpInfoAsync(productCode, new GetSeatsUsersOptionalParameters())
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   * @throws ApiException if fails to make API call
   */
  public SeatUserDataArray getSeatsUsers(
      String productCode, GetSeatsUsersOptionalParameters parameters) throws ApiException {
   ...
   * @return CompletableFuture&lt;SeatUserDataArray&gt;
   */
  public CompletableFuture<SeatUserDataArray> getSeatsUsersAsync(
      String productCode, GetSeatsUsersOptionalParameters parameters) {
    return getSeatsUsersWithHttpInfoAsync(productCode, parameters)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<SeatUserDataArray> getSeatsUsersWithHttpInfo(
      String productCode, GetSeatsUsersOptionalParameters parameters) throws ApiException {
   ...
   */
  public CompletableFuture<ApiResponse<SeatUserDataArray>> getSeatsUsersWithHttpInfoAsync(
      String productCode, GetSeatsUsersOptionalParameters parameters) {
    Object localVarPostBody = null;
   ...
   *
   * <p>See {@link #unassignSeatsUserWithHttpInfo}.
   *
   * @param body (required)
   * @throws ApiException if fails to make API call
   */
   ...
   * Unassign seats from users.
   *
   * <p>See {@link #unassignSeatsUserWithHttpInfoAsync}.
   *
   * @param body (required)
   * @return CompletableFuture
   */
  public CompletableFuture<Void> unassignSeatsUserAsync(UnassignSeatsUserRequest body) {
    return unassignSeatsUserWithHttpInfoAsync(body)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<Void> unassignSeatsUserWithHttpInfo(UnassignSeatsUserRequest body)
      throws ApiException {
    Object localVarPostBody = body;
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling unassignSeatsUser");
    }
    // create path and map variables
    String localVarPath = "/api/v2/seats/users";
   ...
   */
  public CompletableFuture<ApiResponse<Void>> unassignSeatsUserWithHttpInfoAsync(
