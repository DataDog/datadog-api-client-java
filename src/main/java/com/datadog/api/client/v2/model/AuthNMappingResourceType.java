...
public class AuthNMappingResourceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("role", "team"));
  ...
  public static class AuthNMappingResourceTypeSerializer extends StdSerializer<AuthNMappingResourceType> {
      ...
      @Override
      public void serialize(AuthNMappingResourceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
