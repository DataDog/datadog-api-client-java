...
/**
   * <p>Represents the data for updating an existing escalation policy, including its ID, attributes, relationships, and resource type.</p>
 */
@JsonPropertyOrder({
...
public class EscalationPolicyUpdateRequestData {
  ...
  private EscalationPolicyUpdateRequestDataType type = EscalationPolicyUpdateRequestDataType.POLICIES;

  public EscalationPolicyUpdateRequestData() {}

  @JsonCreator
  public EscalationPolicyUpdateRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)EscalationPolicyUpdateRequestDataAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)EscalationPolicyUpdateRequestDataType type) {
  ...
  public EscalationPolicyUpdateRequestData attributes(EscalationPolicyUpdateRequestDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Specifies the unique identifier of the escalation policy being updated.</p>
   * @return id
  **/
  ...
  public EscalationPolicyUpdateRequestData relationships(EscalationPolicyUpdateRequestDataRelationships relationships) {
  ...
  /**
   * <p>Represents relationships in an escalation policy update request, including references to teams.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EscalationPolicyUpdateRequestData escalationPolicyUpdateRequestData = (EscalationPolicyUpdateRequestData) o;
    return Objects.equals(this.attributes, escalationPolicyUpdateRequestData.attributes) && Objects.equals(this.id, escalationPolicyUpdateRequestData.id) && Objects.equals(this.relationships, escalationPolicyUpdateRequestData.relationships) && Objects.equals(this.type, escalationPolicyUpdateRequestData.type) && Objects.equals(this.additionalProperties, escalationPolicyUpdateRequestData.additionalProperties);
  }
