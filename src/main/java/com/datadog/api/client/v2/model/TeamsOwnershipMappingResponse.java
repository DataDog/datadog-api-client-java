...
/**
   * <p>The response body for a single teams ownership mapping.</p>
 */
@JsonPropertyOrder({
  TeamsOwnershipMappingResponse.JSON_PROPERTY_DATA
})
...
public class TeamsOwnershipMappingResponse {
  ...
  @JsonCreator
  public TeamsOwnershipMappingResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)TeamsOwnershipMappingResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, teamsOwnershipMappingResponse.data) && Objects.equals(this.additionalProperties, teamsOwnershipMappingResponse.additionalProperties);
  }
