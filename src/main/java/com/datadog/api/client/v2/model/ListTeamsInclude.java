...
/**
   * <p>Included related resources optionally requested.</p>
 */
...
public class ListTeamsInclude extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_links", "user_team_permissions"));

  public static final ListTeamsInclude TEAM_LINKS = new ListTeamsInclude("team_links");
  public static final ListTeamsInclude USER_TEAM_PERMISSIONS = new ListTeamsInclude("user_team_permissions");
  ...
  public static class ListTeamsIncludeSerializer extends StdSerializer<ListTeamsInclude> {
      ...
      @Override
      public void serialize(ListTeamsInclude value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
