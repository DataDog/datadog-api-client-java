...
/**
   * <p>The definition of the <code>SplitIntegration</code> object.</p>
 */
@JsonPropertyOrder({
...
public class SplitIntegration {
  ...
  @JsonCreator
  public SplitIntegration(
            @JsonProperty(required=true, value=JSON_PROPERTY_CREDENTIALS)SplitCredentials credentials,
  ...
  /**
   * <p>The definition of the <code>SplitCredentials</code> object.</p>
   * @return credentials
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentials, splitIntegration.credentials) && Objects.equals(this.type, splitIntegration.type) && Objects.equals(this.additionalProperties, splitIntegration.additionalProperties);
  }
