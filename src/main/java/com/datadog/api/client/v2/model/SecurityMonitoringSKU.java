...
public class SecurityMonitoringSKU extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("per_gb_analyzed", "per_event_in_siem_index_2023", "add_on_2024", "standalone_indexed", "unknown"));
  ...
  public static final SecurityMonitoringSKU STANDALONE_INDEXED = new SecurityMonitoringSKU("standalone_indexed");
