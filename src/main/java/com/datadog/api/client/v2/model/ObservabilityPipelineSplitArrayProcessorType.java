...
public class ObservabilityPipelineSplitArrayProcessorType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("split_array"));
  ...
  public static class ObservabilityPipelineSplitArrayProcessorTypeSerializer
      extends StdSerializer<ObservabilityPipelineSplitArrayProcessorType> {
    public ObservabilityPipelineSplitArrayProcessorTypeSerializer(
        Class<ObservabilityPipelineSplitArrayProcessorType> t) {
      super(t);
    }
