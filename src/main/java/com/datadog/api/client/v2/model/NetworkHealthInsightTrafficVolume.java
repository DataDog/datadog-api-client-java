...
public class NetworkHealthInsightTrafficVolume {
  ...
  /**
   * <p>Total bytes read from the server to the client during the query window.</p>
   * @return bytesRead
  **/
  ...
  /**
   * <p>Total bytes written from the client to the server during the query window.</p>
   * @return bytesWritten
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Sum of bytes written and bytes read across the query window.</p>
   * @return totalTraffic
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    NetworkHealthInsightTrafficVolume networkHealthInsightTrafficVolume = (NetworkHealthInsightTrafficVolume) o;
    return Objects.equals(this.bytesRead, networkHealthInsightTrafficVolume.bytesRead) && Objects.equals(this.bytesWritten, networkHealthInsightTrafficVolume.bytesWritten) && Objects.equals(this.totalTraffic, networkHealthInsightTrafficVolume.totalTraffic) && Objects.equals(this.additionalProperties, networkHealthInsightTrafficVolume.additionalProperties);
  }
