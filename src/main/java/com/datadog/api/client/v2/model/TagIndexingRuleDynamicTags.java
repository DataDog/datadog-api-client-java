...
/**
   * <p>Options for dynamic tag indexing applied per metric, such as tags filtered by query usage.</p>
   * <p>Before a tag key is dropped by this rule, two grace period conditions must be met:</p>
   * <ol>
   * <li>The metric must be submitted for at least as long as the selected window.</li>
   * <li>A tag key must have been submitted for at least 15 days.</li>
   * </ol>
   * <p>Any metric or tag key that does not meet these conditions are excluded from this
   * indexing rule. The <code>exclude_not_*</code> fields require <code>exclude_tags_mode</code> to be set to <code>true</code>.</p>
 */
@JsonPropertyOrder({
...
public class TagIndexingRuleDynamicTags {
  ...
  public static final String JSON_PROPERTY_EXCLUDE_NOT_QUERIED_WINDOW_SECONDS = "exclude_not_queried_window_seconds";
  private Long excludeNotQueriedWindowSeconds;

  public static final String JSON_PROPERTY_EXCLUDE_NOT_USED_IN_ASSETS = "exclude_not_used_in_assets";
  private Boolean excludeNotUsedInAssets;

  public static final String JSON_PROPERTY_QUERIED_TAGS_WINDOW_SECONDS = "queried_tags_window_seconds";
  ...
  public TagIndexingRuleDynamicTags excludeNotQueriedWindowSeconds(Long excludeNotQueriedWindowSeconds) {
    this.excludeNotQueriedWindowSeconds = excludeNotQueriedWindowSeconds;
    return this;
  }

  /**
   * <p>Tags that have not been queried within this window are excluded from indexing. Maximum of <code>7776000</code> (90 days).</p>
   * maximum: 7776000
  ...
  **/
  ...
  /**
   * <p>Tags not used in any dashboards,  monitors, notebooks, or SLOs are excluded from indexing.</p>
  ...
  **/
  ...
  /**
   * <p>Window in seconds for evaluating queried tags.</p>
  ...
  **/
  ...
  /**
   * <p>When true, tags from related assets are included.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.excludeNotQueriedWindowSeconds, tagIndexingRuleDynamicTags.excludeNotQueriedWindowSeconds) && Objects.equals(this.excludeNotUsedInAssets, tagIndexingRuleDynamicTags.excludeNotUsedInAssets) && Objects.equals(this.queriedTagsWindowSeconds, tagIndexingRuleDynamicTags.queriedTagsWindowSeconds) && Objects.equals(this.relatedAssetTags, tagIndexingRuleDynamicTags.relatedAssetTags) && Objects.equals(this.additionalProperties, tagIndexingRuleDynamicTags.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(excludeNotQueriedWindowSeconds,excludeNotUsedInAssets,queriedTagsWindowSeconds,relatedAssetTags, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    excludeNotQueriedWindowSeconds: ").append(toIndentedString(excludeNotQueriedWindowSeconds)).append("\n");
    sb.append("    excludeNotUsedInAssets: ").append(toIndentedString(excludeNotUsedInAssets)).append("\n");
