...
public class CreatePageRequestDataAttributes {
  ...
  public CreatePageRequestDataAttributes(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_URGENCY) String urgency) {
    this.target = target;
  ...
  public CreatePageRequestDataAttributes urgency(String urgency) {
    this.urgency = urgency;
    return this;
  }

  /**
   * The level of urgency for the alert. Possible value <code>low</code> or <code>high</code>.
   *
   * @return urgency
   */
