...
/**
   * <p>A quantity of one SKU that is included with, and consumed before, the billable usage of
   * another SKU.</p>
 */
@JsonPropertyOrder({
...
public class ProductCatalogSKUAllotment {
  ...
  /**
   * <p>The code of the SKU that receives the allotment.</p>
   * @return childSkuCode
  **/
  ...
  /**
   * <p>The quantity allotted per hour. Fractional for some allotments, and equal to
   * <code>monthly_quantity</code> for others, depending on how the child SKU meters usage.</p>
  ...
  **/
  ...
  /**
   * <p>The quantity allotted per month.</p>
  ...
  **/
  ...
  /**
   * <p>The code of the SKU that provides the allotment. Always the code of the SKU the
   * allotment is returned under.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.childSkuCode, productCatalogSkuAllotment.childSkuCode) && Objects.equals(this.hourlyQuantity, productCatalogSkuAllotment.hourlyQuantity) && Objects.equals(this.monthlyQuantity, productCatalogSkuAllotment.monthlyQuantity) && Objects.equals(this.parentSkuCode, productCatalogSkuAllotment.parentSkuCode) && Objects.equals(this.additionalProperties, productCatalogSkuAllotment.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(childSkuCode,hourlyQuantity,monthlyQuantity,parentSkuCode, additionalProperties);
  }
