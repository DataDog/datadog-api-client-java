...
public class FleetAgentInfoDetails {
  ...
  **/
  ...
  public FleetAgentInfoDetails isSingleStepInstrumentationEnabled(Boolean isSingleStepInstrumentationEnabled) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentVersion,apiKeyName,apiKeyUuid,cloudProvider,clusterName,datadogAgentKey,enabledProducts,env,firstSeenAt,hostname,hostnameAliases,installMethodInstallerVersion,installMethodTool,ipAddresses,isSingleStepInstrumentationEnabled,lastRestartAt,os,osVersion,otelCollectorVersion,otelCollectorVersions,otelCollectors,podName,pythonVersion,region,remoteAgentManagement,remoteConfigStatus,services,tags,team, additionalProperties);
  }
