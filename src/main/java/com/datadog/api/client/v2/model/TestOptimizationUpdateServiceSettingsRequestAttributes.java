...
/**
   ...
   * Setting a field to <code>null</code> is a no-op. To reset a setting to inherit from the repository level, use the corresponding <code>&lt;setting&gt;_inherit</code> field.</p>
 */
@JsonPropertyOrder({
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_AUTO_TEST_RETRIES_ENABLED,
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_AUTO_TEST_RETRIES_ENABLED_INHERIT,
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_CODE_COVERAGE_ENABLED,
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_CODE_COVERAGE_ENABLED_INHERIT,
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_EARLY_FLAKE_DETECTION_ENABLED,
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_EARLY_FLAKE_DETECTION_ENABLED_INHERIT,
  ...
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_FAILED_TEST_REPLAY_ENABLED_INHERIT,
  ...
  TestOptimizationUpdateServiceSettingsRequestAttributes.JSON_PROPERTY_TEST_IMPACT_ANALYSIS_ENABLED_INHERIT
})
...
public class TestOptimizationUpdateServiceSettingsRequestAttributes {
  ...
  public static final String JSON_PROPERTY_AUTO_TEST_RETRIES_ENABLED_INHERIT = "auto_test_retries_enabled_inherit";
  ...
  public static final String JSON_PROPERTY_CODE_COVERAGE_ENABLED_INHERIT = "code_coverage_enabled_inherit";
  ...
  public static final String JSON_PROPERTY_EARLY_FLAKE_DETECTION_ENABLED_INHERIT = "early_flake_detection_enabled_inherit";
  ...
  public static final String JSON_PROPERTY_FAILED_TEST_REPLAY_ENABLED_INHERIT = "failed_test_replay_enabled_inherit";
  ...
  public static final String JSON_PROPERTY_TEST_IMPACT_ANALYSIS_ENABLED_INHERIT = "test_impact_analysis_enabled_inherit";
  ...
  /**
   * <p>Whether Auto Test Retries are enabled for this service. Setting to <code>null</code> is a no-op; use <code>auto_test_retries_enabled_inherit</code> to reset to repository-level inheritance.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, resets the Auto Test Retries setting to inherit from the repository level.</p>
  ...
  **/
  ...
  /**
   * <p>Whether Code Coverage is enabled for this service. Setting to <code>null</code> is a no-op; use <code>code_coverage_enabled_inherit</code> to reset to repository-level inheritance.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, resets the Code Coverage setting to inherit from the repository level.</p>
  ...
  **/
  ...
  /**
   * <p>Whether Early Flake Detection is enabled for this service. Setting to <code>null</code> is a no-op; use <code>early_flake_detection_enabled_inherit</code> to reset to repository-level inheritance.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, resets the Early Flake Detection setting to inherit from the repository level.</p>
  ...
  **/
  ...
  /**
   * <p>Whether Failed Test Replay is enabled for this service. Setting to <code>null</code> is a no-op; use <code>failed_test_replay_enabled_inherit</code> to reset to repository-level inheritance.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, resets the Failed Test Replay setting to inherit from the repository level.</p>
  ...
  **/
  ...
  /**
   * <p>This field is ignored. PR Comments cannot be overridden at the service level.</p>
  ...
  **/
  ...
  /**
   * <p>Whether Test Impact Analysis is enabled for this service. Setting to <code>null</code> is a no-op; use <code>test_impact_analysis_enabled_inherit</code> to reset to repository-level inheritance.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, resets the Test Impact Analysis setting to inherit from the repository level.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoTestRetriesEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.autoTestRetriesEnabled) && Objects.equals(this.autoTestRetriesEnabledInherit, testOptimizationUpdateServiceSettingsRequestAttributes.autoTestRetriesEnabledInherit) && Objects.equals(this.codeCoverageEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.codeCoverageEnabled) && Objects.equals(this.codeCoverageEnabledInherit, testOptimizationUpdateServiceSettingsRequestAttributes.codeCoverageEnabledInherit) && Objects.equals(this.earlyFlakeDetectionEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.earlyFlakeDetectionEnabled) && Objects.equals(this.earlyFlakeDetectionEnabledInherit, testOptimizationUpdateServiceSettingsRequestAttributes.earlyFlakeDetectionEnabledInherit) && Objects.equals(this.env, testOptimizationUpdateServiceSettingsRequestAttributes.env) && Objects.equals(this.failedTestReplayEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.failedTestReplayEnabled) && Objects.equals(this.failedTestReplayEnabledInherit, testOptimizationUpdateServiceSettingsRequestAttributes.failedTestReplayEnabledInherit) && Objects.equals(this.prCommentsEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.prCommentsEnabled) && Objects.equals(this.repositoryId, testOptimizationUpdateServiceSettingsRequestAttributes.repositoryId) && Objects.equals(this.serviceName, testOptimizationUpdateServiceSettingsRequestAttributes.serviceName) && Objects.equals(this.testImpactAnalysisEnabled, testOptimizationUpdateServiceSettingsRequestAttributes.testImpactAnalysisEnabled) && Objects.equals(this.testImpactAnalysisEnabledInherit, testOptimizationUpdateServiceSettingsRequestAttributes.testImpactAnalysisEnabledInherit) && Objects.equals(this.additionalProperties, testOptimizationUpdateServiceSettingsRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(autoTestRetriesEnabled,autoTestRetriesEnabledInherit,codeCoverageEnabled,codeCoverageEnabledInherit,earlyFlakeDetectionEnabled,earlyFlakeDetectionEnabledInherit,env,failedTestReplayEnabled,failedTestReplayEnabledInherit,prCommentsEnabled,repositoryId,serviceName,testImpactAnalysisEnabled,testImpactAnalysisEnabledInherit, additionalProperties);
  }
