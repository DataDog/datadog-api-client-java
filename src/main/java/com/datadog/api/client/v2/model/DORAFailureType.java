...
public class DORAFailureType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("dora_failure"));
  ...
  public static class DORAFailureTypeSerializer extends StdSerializer<DORAFailureType> {
      ...
      @Override
      public void serialize(DORAFailureType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
