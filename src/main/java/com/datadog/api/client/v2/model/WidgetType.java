...
/**
   * <p>Widget types that are allowed to be stored as individual records.
   * This is not a complete list of dashboard and notebook widget types.</p>
 */
@JsonSerialize(using = WidgetType.WidgetTypeSerializer.class)
public class WidgetType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("bar_chart", "change", "cloud_cost_summary", "cohort", "funnel", "geomap", "list_stream", "query_table", "query_value", "retention_curve", "sankey", "sunburst", "timeseries", "toplist", "treemap"));
  ...
  public static class WidgetTypeSerializer extends StdSerializer<WidgetType> {
      ...
      @Override
      public void serialize(WidgetType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
