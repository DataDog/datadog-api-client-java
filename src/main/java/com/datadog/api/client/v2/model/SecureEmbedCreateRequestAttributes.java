...
public class SecureEmbedCreateRequestAttributes {
  ...
  @JsonCreator
  public SecureEmbedCreateRequestAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_GLOBAL_TIME)SecureEmbedGlobalTime globalTime,
            @JsonProperty(required=true, value=JSON_PROPERTY_GLOBAL_TIME_SELECTABLE)Boolean globalTimeSelectable,
            @JsonProperty(required=true, value=JSON_PROPERTY_SELECTABLE_TEMPLATE_VARS)List<SecureEmbedSelectableTemplateVariable> selectableTemplateVars,
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)SecureEmbedStatus status,
            @JsonProperty(required=true, value=JSON_PROPERTY_TITLE)String title,
            @JsonProperty(required=true, value=JSON_PROPERTY_VIEWING_PREFERENCES)SecureEmbedViewingPreferences viewingPreferences) {
  ...
  **/
  ...
  /**
   * <p>Whether viewers can change the time range.</p>
  ...
  **/
  ...
  /**
   * <p>Template variables viewers can modify.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecureEmbedCreateRequestAttributes secureEmbedCreateRequestAttributes = (SecureEmbedCreateRequestAttributes) o;
    return Objects.equals(this.globalTime, secureEmbedCreateRequestAttributes.globalTime) && Objects.equals(this.globalTimeSelectable, secureEmbedCreateRequestAttributes.globalTimeSelectable) && Objects.equals(this.selectableTemplateVars, secureEmbedCreateRequestAttributes.selectableTemplateVars) && Objects.equals(this.status, secureEmbedCreateRequestAttributes.status) && Objects.equals(this.title, secureEmbedCreateRequestAttributes.title) && Objects.equals(this.viewingPreferences, secureEmbedCreateRequestAttributes.viewingPreferences) && Objects.equals(this.additionalProperties, secureEmbedCreateRequestAttributes.additionalProperties);
  }
