...
/**
   * <p>Compliance framework mapping for a rule.</p>
 */
@JsonPropertyOrder({
...
public class RuleBasedViewComplianceFramework {
  ...
  /**
   * <p>Identifier of the control inside the requirement.</p>
   * @return control
  **/
  ...
  /**
   * <p>Handle of the compliance framework.</p>
   * @return framework
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the framework is a Datadog default framework. <code>true</code> indicates a Datadog framework and <code>false</code> indicates a custom framework.</p>
   * @return isDefault
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Optional message describing the framework mapping for the rule.</p>
   * @return message
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the requirement that contains the control.</p>
   * @return requirement
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Version of the compliance framework.</p>
   * @return version
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    RuleBasedViewComplianceFramework ruleBasedViewComplianceFramework = (RuleBasedViewComplianceFramework) o;
    return Objects.equals(this.control, ruleBasedViewComplianceFramework.control) && Objects.equals(this.framework, ruleBasedViewComplianceFramework.framework) && Objects.equals(this.isDefault, ruleBasedViewComplianceFramework.isDefault) && Objects.equals(this.message, ruleBasedViewComplianceFramework.message) && Objects.equals(this.requirement, ruleBasedViewComplianceFramework.requirement) && Objects.equals(this.version, ruleBasedViewComplianceFramework.version) && Objects.equals(this.additionalProperties, ruleBasedViewComplianceFramework.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(control,framework,isDefault,message,requirement,version, additionalProperties);
  }
