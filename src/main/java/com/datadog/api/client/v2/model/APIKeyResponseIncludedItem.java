...
public class APIKeyResponseIncludedItem extends AbstractOpenApiSchema {
    ...
    public static class APIKeyResponseIncludedItemSerializer extends StdSerializer<APIKeyResponseIncludedItem> {
        ...
        @Override
        public void serialize(APIKeyResponseIncludedItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class APIKeyResponseIncludedItemDeserializer extends StdDeserializer<APIKeyResponseIncludedItem> {
        ...
        @Override
        public APIKeyResponseIncludedItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public APIKeyResponseIncludedItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
