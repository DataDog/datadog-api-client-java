...
@JsonPropertyOrder({
  ...
  RoutingRuleEscalationPolicyAction.JSON_PROPERTY_SUPPORT_HOURS,
...
public class RoutingRuleEscalationPolicyAction {
  ...
  public RoutingRuleEscalationPolicyAction supportHours(TimeRestrictions supportHours) {
   ...
   * @return RoutingRuleEscalationPolicyAction
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class RoutingRuleEscalationPolicyAction {\n");
