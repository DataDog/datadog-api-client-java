...
/**
   * <p>A single detected Cloud Cost Management anomaly.</p>
 */
@JsonPropertyOrder({
...
public class CostAnomaly {
  ...
  public CostAnomaly(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_ANOMALOUS_COST_CHANGE)Double anomalousCostChange,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_CORRELATED_TAGS)Map<String, List<String>> correlatedTags,
            @JsonProperty(required=true, value=JSON_PROPERTY_DIMENSIONS)Map<String, String> dimensions,
  ...
  /**
   * <p>Actual cost incurred during the anomaly window.</p>
   * @return actualCost
  **/
  ...
  /**
   * <p>Anomalous cost change relative to the expected baseline.</p>
  ...
  **/
  ...
  /**
   * <p>Anomaly end timestamp in Unix milliseconds.</p>
   * @return anomalyEnd
  **/
  ...
  /**
   * <p>Anomaly start timestamp in Unix milliseconds.</p>
   * @return anomalyStart
  **/
  ...
  /**
   * <p>Map of correlated tag keys to the list of correlated tag values.</p>
  ...
  **/
  ...
  /**
   * <p>Map of cost dimension keys to their values for the anomaly grouping.</p>
   * @return dimensions
  **/
  ...
  **/
  ...
  /**
   * <p>Maximum cost observed during the anomaly window.</p>
   * @return maxCost
  **/
  ...
  /**
   * <p>Cloud or SaaS provider associated with the anomaly (for example <code>aws</code>, <code>gcp</code>, <code>azure</code>).</p>
   * @return provider
  **/
  ...
  /**
   * <p>The metrics query that detected the anomaly.</p>
   * @return query
  **/
  ...
  /**
   * <p>The unique identifier of the anomaly.</p>
   * @return uuid
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actualCost, costAnomaly.actualCost) && Objects.equals(this.anomalousCostChange, costAnomaly.anomalousCostChange) && Objects.equals(this.anomalyEnd, costAnomaly.anomalyEnd) && Objects.equals(this.anomalyStart, costAnomaly.anomalyStart) && Objects.equals(this.correlatedTags, costAnomaly.correlatedTags) && Objects.equals(this.dimensions, costAnomaly.dimensions) && Objects.equals(this.dismissal, costAnomaly.dismissal) && Objects.equals(this.maxCost, costAnomaly.maxCost) && Objects.equals(this.provider, costAnomaly.provider) && Objects.equals(this.query, costAnomaly.query) && Objects.equals(this.uuid, costAnomaly.uuid) && Objects.equals(this.additionalProperties, costAnomaly.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(actualCost,anomalousCostChange,anomalyEnd,anomalyStart,correlatedTags,dimensions,dismissal,maxCost,provider,query,uuid, additionalProperties);
  }
