...
/**
   * <p>A relationship to the compliance score resource for this policy.</p>
 */
@JsonPropertyOrder({
  TagPolicyScoreRelationship.JSON_PROPERTY_DATA
})
...
public class TagPolicyScoreRelationship {
  ...
  @JsonCreator
  public TagPolicyScoreRelationship(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)TagPolicyScoreRelationshipData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, tagPolicyScoreRelationship.data) && Objects.equals(this.additionalProperties, tagPolicyScoreRelationship.additionalProperties);
  }
