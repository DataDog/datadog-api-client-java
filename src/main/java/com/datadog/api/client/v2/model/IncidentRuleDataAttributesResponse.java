...
public class IncidentRuleDataAttributesResponse {
  ...
  public IncidentRuleDataAttributesResponse conditionTableType(Integer conditionTableType) {
  ...
  public IncidentRuleDataAttributesResponse executionType(Integer executionType) {
