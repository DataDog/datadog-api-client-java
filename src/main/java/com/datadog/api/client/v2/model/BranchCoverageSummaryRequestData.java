...
/**
   * <p>Data object for branch summary request.</p>
 */
@JsonPropertyOrder({
...
public class BranchCoverageSummaryRequestData {
  ...
  @JsonCreator
  public BranchCoverageSummaryRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)BranchCoverageSummaryRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)BranchCoverageSummaryRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public BranchCoverageSummaryRequestData attributes(BranchCoverageSummaryRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for requesting code coverage summary for a branch.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    BranchCoverageSummaryRequestData branchCoverageSummaryRequestData = (BranchCoverageSummaryRequestData) o;
    return Objects.equals(this.attributes, branchCoverageSummaryRequestData.attributes) && Objects.equals(this.type, branchCoverageSummaryRequestData.type) && Objects.equals(this.additionalProperties, branchCoverageSummaryRequestData.additionalProperties);
  }
