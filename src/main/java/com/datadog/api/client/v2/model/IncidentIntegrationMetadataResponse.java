...
/**
   * <p>Response with an incident integration metadata.</p>
 */
@JsonPropertyOrder({
...
public class IncidentIntegrationMetadataResponse {
  ...
  @JsonCreator
  public IncidentIntegrationMetadataResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)IncidentIntegrationMetadataResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentIntegrationMetadataResponse incidentIntegrationMetadataResponse = (IncidentIntegrationMetadataResponse) o;
    return Objects.equals(this.data, incidentIntegrationMetadataResponse.data) && Objects.equals(this.included, incidentIntegrationMetadataResponse.included) && Objects.equals(this.additionalProperties, incidentIntegrationMetadataResponse.additionalProperties);
  }
