...
/**
   * <p>The name of a supported LLM provider integration.</p>
 */
...
public class LLMObsIntegrationName extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("openai", "amazon_bedrock", "anthropic", "azure_openai", "vertex_ai", "llmproxy"));

  public static final LLMObsIntegrationName OPENAI = new LLMObsIntegrationName("openai");
  public static final LLMObsIntegrationName AMAZON_BEDROCK = new LLMObsIntegrationName("amazon_bedrock");
  public static final LLMObsIntegrationName ANTHROPIC = new LLMObsIntegrationName("anthropic");
  public static final LLMObsIntegrationName AZURE_OPENAI = new LLMObsIntegrationName("azure_openai");
  ...
  public static class LLMObsIntegrationNameSerializer extends StdSerializer<LLMObsIntegrationName> {
      ...
      @Override
      public void serialize(LLMObsIntegrationName value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
