...
@JsonPropertyOrder({
  ...
  IncidentImpactFieldDataAttributesResponse.JSON_PROPERTY_FIELD_TYPE,
...
public class IncidentImpactFieldDataAttributesResponse {
   ...
   * @return IncidentImpactFieldDataAttributesResponse
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class IncidentImpactFieldDataAttributesResponse {\n");
