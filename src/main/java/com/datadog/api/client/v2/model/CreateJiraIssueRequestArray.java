...
/**
   * <p>List of requests to create Jira issues for security findings.</p>
 */
@JsonPropertyOrder({
...
public class CreateJiraIssueRequestArray {
  ...
  @JsonCreator
  public CreateJiraIssueRequestArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<CreateJiraIssueRequestData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>Array of Jira issue creation request data objects.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<CreateJiraIssueRequestData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createJiraIssueRequestArray.data) && Objects.equals(this.additionalProperties, createJiraIssueRequestArray.additionalProperties);
  }
