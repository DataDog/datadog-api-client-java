...
/**
   * <p>Object containing all your STS enabled accounts.</p>
 */
@JsonPropertyOrder({
  GCPSTSServiceAccountsResponse.JSON_PROPERTY_DATA
})
...
public class GCPSTSServiceAccountsResponse {
  ...
  private List<GCPSTSServiceAccount> data = null;
  ...
  /**
   * <p>Array of GCP STS enabled service accounts.</p>
   * @return data
  **/
      ...
      public List<GCPSTSServiceAccount> getData() {
        return data;
      }
   ...
   */
  @JsonAnySetter
  public GCPSTSServiceAccountsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, gcpstsServiceAccountsResponse.data) && Objects.equals(this.additionalProperties, gcpstsServiceAccountsResponse.additionalProperties);
  }
