...
/**
   * <p>Attributes of the rule-based view.</p>
 */
@JsonPropertyOrder({
...
public class RuleBasedViewAttributes {
  ...
  private List<RuleBasedViewRule> rules = new ArrayList<>();
  ...
  /**
   * <p>Total number of rules in the view.</p>
   * @return count
  **/
  ...
  public RuleBasedViewAttributes rules(List<RuleBasedViewRule> rules) {
    this.rules = rules;
    for (RuleBasedViewRule item : rules) {
      this.unparsed |= item.unparsed;
    }
  ...
  /**
   * <p>List of rules in the rule-based view.</p>
   * @return rules
  **/
      @JsonProperty(JSON_PROPERTY_RULES)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<RuleBasedViewRule> getRules() {
        return rules;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, ruleBasedViewAttributes.count) && Objects.equals(this.rules, ruleBasedViewAttributes.rules) && Objects.equals(this.additionalProperties, ruleBasedViewAttributes.additionalProperties);
  }
