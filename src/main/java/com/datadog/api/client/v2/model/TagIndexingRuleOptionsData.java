...
public class TagIndexingRuleOptionsData {
  ...
  public static final String JSON_PROPERTY_MANAGE_PREEXISTING_METRICS = "manage_preexisting_metrics";
  ...
  **/
  ...
  /**
   * <p>When true, the rule applies to metrics that were ingested before the rule was created.</p>
  ...
  **/
  ...
  /**
   * <p>Criteria for matching metrics based on query state.</p>
   * @return metricMatch
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>When true, this rule's tag list overrides tags configured by earlier rules for the same metric. When false (default), tags from all matching rules are combined.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dynamicTags, tagIndexingRuleOptionsData.dynamicTags) && Objects.equals(this.managePreexistingMetrics, tagIndexingRuleOptionsData.managePreexistingMetrics) && Objects.equals(this.metricMatch, tagIndexingRuleOptionsData.metricMatch) && Objects.equals(this.overridePreviousRules, tagIndexingRuleOptionsData.overridePreviousRules) && Objects.equals(this.additionalProperties, tagIndexingRuleOptionsData.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(dynamicTags,managePreexistingMetrics,metricMatch,overridePreviousRules, additionalProperties);
  }
