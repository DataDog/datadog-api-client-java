...
public class LLMObsSearchSpansRequestAttributes {
  ...
  private LLMObsSpanSearchOptions options;

  public static final String JSON_PROPERTY_PAGE = "page";
  private LLMObsSpanPageQuery page;
  ...
  **/
   ...
   * @return LLMObsSearchSpansRequestAttributes
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class LLMObsSearchSpansRequestAttributes {\n");
