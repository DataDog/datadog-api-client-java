...
/**
   * <p>Schema for a Workflow-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class WorkflowTriggerWrapper {
  ...
  @JsonCreator
  public WorkflowTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_WORKFLOW_TRIGGER)Object workflowTrigger) {
  ...
  **/
  ...
  /**
   * <p>Trigger a workflow from the Datadog UI. When present, this must be the workflow's only trigger.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startStepNames, workflowTriggerWrapper.startStepNames) && Objects.equals(this.workflowTrigger, workflowTriggerWrapper.workflowTrigger) && Objects.equals(this.additionalProperties, workflowTriggerWrapper.additionalProperties);
  }
