...
/**
   * <p>The data object for a budget validation request, containing the resource type, ID, and budget attributes to validate.</p>
 */
@JsonPropertyOrder({
...
public class BudgetValidationRequestData {
  ...
  /**
   * <p>The attributes of a budget including all its monthly entries.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The unique identifier of the budget to validate.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, budgetValidationRequestData.attributes) && Objects.equals(this.id, budgetValidationRequestData.id) && Objects.equals(this.type, budgetValidationRequestData.type) && Objects.equals(this.additionalProperties, budgetValidationRequestData.additionalProperties);
  }
