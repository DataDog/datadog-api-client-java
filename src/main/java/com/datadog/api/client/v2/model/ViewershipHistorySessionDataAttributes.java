...
public class ViewershipHistorySessionDataAttributes {
  ...
  @JsonCreator
  public ViewershipHistorySessionDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_LAST_WATCHED_AT)OffsetDateTime lastWatchedAt) {
  ...
  /**
   * <p>Unique identifier of the RUM event associated with the watched session.</p>
   * @return eventId
  **/
  ...
  /**
   * <p>Timestamp when the session was last watched by the user.</p>
  ...
  **/
  ...
  public ViewershipHistorySessionDataAttributes putSessionEventItem(String key, Object sessionEventItem) {
  ...
  /**
   * <p>Raw event data associated with the replay session.</p>
   * @return sessionEvent
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Replay track identifier indicating which recording track the session belongs to.</p>
   * @return track
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ViewershipHistorySessionDataAttributes viewershipHistorySessionDataAttributes = (ViewershipHistorySessionDataAttributes) o;
    return Objects.equals(this.eventId, viewershipHistorySessionDataAttributes.eventId) && Objects.equals(this.lastWatchedAt, viewershipHistorySessionDataAttributes.lastWatchedAt) && Objects.equals(this.sessionEvent, viewershipHistorySessionDataAttributes.sessionEvent) && Objects.equals(this.track, viewershipHistorySessionDataAttributes.track) && Objects.equals(this.additionalProperties, viewershipHistorySessionDataAttributes.additionalProperties);
  }
