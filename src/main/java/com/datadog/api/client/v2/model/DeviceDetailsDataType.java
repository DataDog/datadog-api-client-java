...
public class DeviceDetailsDataType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("devices"));
  ...
  public static class DeviceDetailsDataTypeSerializer extends StdSerializer<DeviceDetailsDataType> {
    public DeviceDetailsDataTypeSerializer(Class<DeviceDetailsDataType> t) {
      super(t);
    }
