...
/**
   * <p>Service definition v2.1 for providing service metadata and integrations.</p>
 */
@JsonPropertyOrder({
...
public class ServiceDefinitionV2Dot1 {
  ...
  public ServiceDefinitionV2Dot1(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SCHEMA_VERSION)ServiceDefinitionV2Dot1Version schemaVersion) {
