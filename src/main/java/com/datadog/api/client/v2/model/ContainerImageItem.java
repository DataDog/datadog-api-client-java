...
public class ContainerImageItem extends AbstractOpenApiSchema {
    ...
    public static class ContainerImageItemSerializer extends StdSerializer<ContainerImageItem> {
        ...
        @Override
        public void serialize(ContainerImageItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ContainerImageItemDeserializer extends StdDeserializer<ContainerImageItem> {
        ...
        @Override
        public ContainerImageItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (ContainerImage.class.equals(Integer.class) || ContainerImage.class.equals(Long.class) || ContainerImage.class.equals(Float.class) || ContainerImage.class.equals(Double.class) || ContainerImage.class.equals(Boolean.class) || ContainerImage.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ContainerImage.class.equals(Integer.class) || ContainerImage.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ContainerImage.class.equals(Float.class) || ContainerImage.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ContainerImage.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ContainerImage.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ContainerImageGroup.class.equals(Integer.class) || ContainerImageGroup.class.equals(Long.class) || ContainerImageGroup.class.equals(Float.class) || ContainerImageGroup.class.equals(Double.class) || ContainerImageGroup.class.equals(Boolean.class) || ContainerImageGroup.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ContainerImageGroup.class.equals(Integer.class) || ContainerImageGroup.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ContainerImageGroup.class.equals(Float.class) || ContainerImageGroup.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ContainerImageGroup.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ContainerImageGroup.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public ContainerImageItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * ContainerImage, ContainerImageGroup
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ContainerImage, ContainerImageGroup");
    }
    ...
    /**
     * Get the actual instance of `ContainerImageGroup`. If the actual instance is not `ContainerImageGroup`,
     * the ClassCastException will be thrown.
     *
