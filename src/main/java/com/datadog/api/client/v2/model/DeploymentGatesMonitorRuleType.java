 ...
 */
@JsonSerialize(using = DeploymentGatesMonitorRuleType.DeploymentGatesMonitorRuleTypeSerializer.class)
public class DeploymentGatesMonitorRuleType extends ModelEnum<String> {
  ...
  public static final DeploymentGatesMonitorRuleType MONITOR = new DeploymentGatesMonitorRuleType("monitor");
  ...
  public static class DeploymentGatesMonitorRuleTypeSerializer extends StdSerializer<DeploymentGatesMonitorRuleType> {
      ...
      @Override
      public void serialize(DeploymentGatesMonitorRuleType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
