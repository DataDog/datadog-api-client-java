...
/**
   * <p>An HTTP status code range that indicates an invalid (unsuccessful) secret match during validation.</p>
 */
@JsonPropertyOrder({
...
public class SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems secretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems = (SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems) o;
    return Objects.equals(this.end, secretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems.end) && Objects.equals(this.start, secretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems.start) && Objects.equals(this.additionalProperties, secretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems.additionalProperties);
  }
