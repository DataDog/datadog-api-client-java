...
public class FunnelRequestDataAttributesSearch {
  ...
  private List<FunnelRequestDataAttributesSearchStepsItems> steps = null;
  ...
  public FunnelRequestDataAttributesSearch steps(
      List<FunnelRequestDataAttributesSearchStepsItems> steps) {
    this.steps = steps;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public List<FunnelRequestDataAttributesSearchStepsItems> getSteps() {
    return steps;
  }

  public void setSteps(List<FunnelRequestDataAttributesSearchStepsItems> steps) {
    this.steps = steps;
  }
