...
@JsonDeserialize(using = ComponentGridPropertiesIsVisible.ComponentGridPropertiesIsVisibleDeserializer.class)
@JsonSerialize(using = ComponentGridPropertiesIsVisible.ComponentGridPropertiesIsVisibleSerializer.class)
public class ComponentGridPropertiesIsVisible extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ComponentGridPropertiesIsVisible.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ComponentGridPropertiesIsVisibleSerializer extends StdSerializer<ComponentGridPropertiesIsVisible> {
        public ComponentGridPropertiesIsVisibleSerializer(Class<ComponentGridPropertiesIsVisible> t) {
            super(t);
        }

        public ComponentGridPropertiesIsVisibleSerializer() {
            this(null);
        }

        @Override
        public void serialize(ComponentGridPropertiesIsVisible value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ComponentGridPropertiesIsVisibleDeserializer extends StdDeserializer<ComponentGridPropertiesIsVisible> {
        public ComponentGridPropertiesIsVisibleDeserializer() {
            this(ComponentGridPropertiesIsVisible.class);
        }

        public ComponentGridPropertiesIsVisibleDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ComponentGridPropertiesIsVisible deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ComponentGridPropertiesIsVisible ret = new ComponentGridPropertiesIsVisible();
            if (match == 1) {
         ...
         */
        @Override
        public ComponentGridPropertiesIsVisible getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ComponentGridPropertiesIsVisible cannot be null");
        }
    }
    ...
    public ComponentGridPropertiesIsVisible() {
        super("oneOf", Boolean.FALSE);
    }
    public ComponentGridPropertiesIsVisible(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ComponentGridPropertiesIsVisible(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ComponentGridPropertiesIsVisible.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ComponentGridPropertiesIsVisible.schemas;
    }
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be String, Boolean");
    }
     ...
     * String, Boolean
     *
     * @return The actual instance (String, Boolean)
     */
    @Override
