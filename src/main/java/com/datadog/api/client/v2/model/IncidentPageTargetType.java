...
public class IncidentPageTargetType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_handle", "team_uuid", "user_uuid"));

  public static final IncidentPageTargetType TEAM_HANDLE = new IncidentPageTargetType("team_handle");
  ...
  public static class IncidentPageTargetTypeSerializer extends StdSerializer<IncidentPageTargetType> {
      ...
      @Override
      public void serialize(IncidentPageTargetType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
