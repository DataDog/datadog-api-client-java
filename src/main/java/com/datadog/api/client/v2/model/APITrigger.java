...
/**
   * <p>Trigger a workflow from an API request. The workflow must be published.</p>
 */
@JsonPropertyOrder({
  APITrigger.JSON_PROPERTY_RATE_LIMIT
})
...
public class APITrigger {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public APITrigger putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this APITrigger object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    APITrigger apiTrigger = (APITrigger) o;
    return Objects.equals(this.rateLimit, apiTrigger.rateLimit) && Objects.equals(this.additionalProperties, apiTrigger.additionalProperties);
  }
