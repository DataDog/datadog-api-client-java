...
@JsonDeserialize(using = ElasticCloudIntegrationAccountAuthenticationRequest.ElasticCloudIntegrationAccountAuthenticationRequestDeserializer.class)
@JsonSerialize(using = ElasticCloudIntegrationAccountAuthenticationRequest.ElasticCloudIntegrationAccountAuthenticationRequestSerializer.class)
public class ElasticCloudIntegrationAccountAuthenticationRequest extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ElasticCloudIntegrationAccountAuthenticationRequest.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ElasticCloudIntegrationAccountAuthenticationRequestSerializer extends StdSerializer<ElasticCloudIntegrationAccountAuthenticationRequest> {
        public ElasticCloudIntegrationAccountAuthenticationRequestSerializer(Class<ElasticCloudIntegrationAccountAuthenticationRequest> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(ElasticCloudIntegrationAccountAuthenticationRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ElasticCloudIntegrationAccountAuthenticationRequestDeserializer extends StdDeserializer<ElasticCloudIntegrationAccountAuthenticationRequest> {
        ...
        @Override
        public ElasticCloudIntegrationAccountAuthenticationRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ElasticCloudIntegrationAccountAuthenticationRequest ret = new ElasticCloudIntegrationAccountAuthenticationRequest();
            if (match == 1) {
         ...
         */
        @Override
        public ElasticCloudIntegrationAccountAuthenticationRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ElasticCloudIntegrationAccountAuthenticationRequest cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(ElasticCloudIntegrationAccountAuthenticationRequest.class, Collections.unmodifiableMap(schemas));
    }
