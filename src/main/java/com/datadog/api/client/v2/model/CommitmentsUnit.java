...
public class CommitmentsUnit {
  ...
  /**
   * <p>The unit family (for example, percentage or money).</p>
   * @return family
  **/
  ...
  **/
  ...
  /**
   * <p>The unit name (for example, percent or dollar).</p>
   * @return name
  **/
  ...
  **/
  ...
  /**
   * <p>The scale factor for the unit.</p>
   * @return scaleFactor
  **/
  ...
  /**
   * <p>The abbreviated unit name (for example, % or $).</p>
   * @return shortName
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.family, commitmentsUnit.family) && Objects.equals(this.id, commitmentsUnit.id) && Objects.equals(this.name, commitmentsUnit.name) && Objects.equals(this.plural, commitmentsUnit.plural) && Objects.equals(this.scaleFactor, commitmentsUnit.scaleFactor) && Objects.equals(this.shortName, commitmentsUnit.shortName) && Objects.equals(this.additionalProperties, commitmentsUnit.additionalProperties);
  }
