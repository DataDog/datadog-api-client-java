...
public class TagPolicyData {
  ...
  @JsonCreator
  public TagPolicyData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TagPolicyAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the tag policy.</p>
   * @return id
  **/
  ...
  /**
   * <p>Related resources for a tag policy. Only present when the corresponding <code>include</code> query parameter is supplied.</p>
  ...
  **/
  ...
  /**
   * <p>JSON:API resource type for a tag policy.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, tagPolicyData.attributes) && Objects.equals(this.id, tagPolicyData.id) && Objects.equals(this.relationships, tagPolicyData.relationships) && Objects.equals(this.type, tagPolicyData.type) && Objects.equals(this.additionalProperties, tagPolicyData.additionalProperties);
  }
