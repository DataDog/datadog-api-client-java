...
public class TestOptimizationFlakyTestsManagementPoliciesDisabled {
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabled autoDisableRule(TestOptimizationFlakyTestsManagementPoliciesAutoDisableRule autoDisableRule) {
  ...
  /**
   * <p>Automatic disable triggering rule based on a time window and test status.</p>
  ...
  **/
  ...
  public void setAutoDisableRule(TestOptimizationFlakyTestsManagementPoliciesAutoDisableRule autoDisableRule) {
    this.autoDisableRule = autoDisableRule;
    if (autoDisableRule != null) {
      this.unparsed |= autoDisableRule.unparsed;
    }
  }
  public TestOptimizationFlakyTestsManagementPoliciesDisabled branchRule(TestOptimizationFlakyTestsManagementPoliciesBranchRule branchRule) {
  ...
  **/
  ...
  /**
   * <p>Whether the disabled policy is enabled.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
  ...
  public TestOptimizationFlakyTestsManagementPoliciesDisabled failureRateRule(TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule failureRateRule) {
  ...
  /**
   * <p>Failure-rate-based rule for the disabled policy.</p>
  ...
  **/
  ...
  public void setFailureRateRule(TestOptimizationFlakyTestsManagementPoliciesDisabledFailureRateRule failureRateRule) {
    this.failureRateRule = failureRateRule;
   ...
   */
  @JsonAnySetter
  public TestOptimizationFlakyTestsManagementPoliciesDisabled putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TestOptimizationFlakyTestsManagementPoliciesDisabled testOptimizationFlakyTestsManagementPoliciesDisabled = (TestOptimizationFlakyTestsManagementPoliciesDisabled) o;
    return Objects.equals(this.autoDisableRule, testOptimizationFlakyTestsManagementPoliciesDisabled.autoDisableRule) && Objects.equals(this.branchRule, testOptimizationFlakyTestsManagementPoliciesDisabled.branchRule) && Objects.equals(this.enabled, testOptimizationFlakyTestsManagementPoliciesDisabled.enabled) && Objects.equals(this.failureRateRule, testOptimizationFlakyTestsManagementPoliciesDisabled.failureRateRule) && Objects.equals(this.additionalProperties, testOptimizationFlakyTestsManagementPoliciesDisabled.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(autoDisableRule,branchRule,enabled,failureRateRule, additionalProperties);
  }
