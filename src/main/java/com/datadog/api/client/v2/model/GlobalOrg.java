...
/**
   * <p>Organization information for a global organization association.</p>
 */
@JsonPropertyOrder({
...
public class GlobalOrg {
  ...
  **/
  ...
  /**
   * <p>The public identifier of the organization.</p>
   * @return publicId
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PUBLIC_ID)public void setPublicId_JsonNullable(JsonNullable<String> publicId) {
  ...
  /**
   * <p>The subdomain used to access the organization, if configured.</p>
   * @return subdomain
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_SUBDOMAIN)public void setSubdomain_JsonNullable(JsonNullable<String> subdomain) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, globalOrg.name) && Objects.equals(this.publicId, globalOrg.publicId) && Objects.equals(this.subdomain, globalOrg.subdomain) && Objects.equals(this.uuid, globalOrg.uuid) && Objects.equals(this.additionalProperties, globalOrg.additionalProperties);
  }
