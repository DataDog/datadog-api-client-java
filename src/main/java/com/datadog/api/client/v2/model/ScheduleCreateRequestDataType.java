...
public class ScheduleCreateRequestDataType extends ModelEnum<String> {
  ...
  public static final ScheduleCreateRequestDataType SCHEDULES = new ScheduleCreateRequestDataType("schedules");
  ...
  public static class ScheduleCreateRequestDataTypeSerializer extends StdSerializer<ScheduleCreateRequestDataType> {
      ...
      @Override
      public void serialize(ScheduleCreateRequestDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
