...
/**
   * <p>Response containing a single annotated interaction and its related events.</p>
 */
@JsonPropertyOrder({
  LLMObsAnnotatedInteractionResponse.JSON_PROPERTY_DATA
})
...
public class LLMObsAnnotatedInteractionResponse {
  ...
  @JsonCreator
  public LLMObsAnnotatedInteractionResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)LLMObsAnnotatedInteractionDataResponse data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsAnnotatedInteractionResponse llmObsAnnotatedInteractionResponse = (LLMObsAnnotatedInteractionResponse) o;
    return Objects.equals(this.data, llmObsAnnotatedInteractionResponse.data) && Objects.equals(this.additionalProperties, llmObsAnnotatedInteractionResponse.additionalProperties);
  }
