...
/**
   * <p>Attributes of an existing secure embed shared dashboard.</p>
 */
@JsonPropertyOrder({
...
public class SecureEmbedGetResponseAttributes {
  ...
  **/
  ...
  /**
   * <p>Last 4 characters of the credential. Defaults to <code>0000</code> if unavailable.</p>
  ...
  **/
  ...
  /**
   * <p>Whether time range is viewer-selectable.</p>
  ...
  **/
  ...
  public SecureEmbedGetResponseAttributes selectableTemplateVars(List<SecureEmbedSelectableTemplateVariable> selectableTemplateVars) {
  ...
  public SecureEmbedGetResponseAttributes addSelectableTemplateVarsItem(SecureEmbedSelectableTemplateVariable selectableTemplateVarsItem) {
  ...
  /**
   * <p>Template variables with their configuration.</p>
  ...
  **/
  ...
  /**
   * <p>The type of share. Always <code>secure_embed</code>.</p>
   * @return shareType
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>CDN URL for the shared dashboard.</p>
   * @return url
  **/
      @jakarta.annotation.Nullable
  ...
  public SecureEmbedGetResponseAttributes viewingPreferences(SecureEmbedViewingPreferences viewingPreferences) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecureEmbedGetResponseAttributes secureEmbedGetResponseAttributes = (SecureEmbedGetResponseAttributes) o;
    return Objects.equals(this.createdAt, secureEmbedGetResponseAttributes.createdAt) && Objects.equals(this.credentialSuffix, secureEmbedGetResponseAttributes.credentialSuffix) && Objects.equals(this.dashboardId, secureEmbedGetResponseAttributes.dashboardId) && Objects.equals(this.globalTime, secureEmbedGetResponseAttributes.globalTime) && Objects.equals(this.globalTimeSelectable, secureEmbedGetResponseAttributes.globalTimeSelectable) && Objects.equals(this.id, secureEmbedGetResponseAttributes.id) && Objects.equals(this.selectableTemplateVars, secureEmbedGetResponseAttributes.selectableTemplateVars) && Objects.equals(this.shareType, secureEmbedGetResponseAttributes.shareType) && Objects.equals(this.status, secureEmbedGetResponseAttributes.status) && Objects.equals(this.title, secureEmbedGetResponseAttributes.title) && Objects.equals(this.token, secureEmbedGetResponseAttributes.token) && Objects.equals(this.url, secureEmbedGetResponseAttributes.url) && Objects.equals(this.viewingPreferences, secureEmbedGetResponseAttributes.viewingPreferences) && Objects.equals(this.additionalProperties, secureEmbedGetResponseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdAt,credentialSuffix,dashboardId,globalTime,globalTimeSelectable,id,selectableTemplateVars,shareType,status,title,token,url,viewingPreferences, additionalProperties);
  }
