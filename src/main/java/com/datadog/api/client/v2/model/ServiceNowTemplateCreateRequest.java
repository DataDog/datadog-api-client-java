...
/**
   * <p>Request to create a ServiceNow template</p>
 */
@JsonPropertyOrder({
...
public class ServiceNowTemplateCreateRequest {
  ...
  @JsonCreator
  public ServiceNowTemplateCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ServiceNowTemplateCreateRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ServiceNowTemplateCreateRequest serviceNowTemplateCreateRequest = (ServiceNowTemplateCreateRequest) o;
    return Objects.equals(this.data, serviceNowTemplateCreateRequest.data) && Objects.equals(this.additionalProperties, serviceNowTemplateCreateRequest.additionalProperties);
  }
