...
public class LLMObsInferenceContentValue {
  ...
  private LLMObsInferenceToolCall toolCall;

  public static final String JSON_PROPERTY_TOOL_CALL_RESULT = "tool_call_result";
  private LLMObsInferenceToolResult toolCallResult;
   ...
   * @return LLMObsInferenceContentValue
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class LLMObsInferenceContentValue {\n");
