...
@JsonPropertyOrder({
  ProductAnalyticsJourneyFunnelStepGroup.JSON_PROPERTY_CONVERSION_COUNT,
  ProductAnalyticsJourneyFunnelStepGroup.JSON_PROPERTY_ELAPSED_TIME_TO_NEXT_STEP,
  ProductAnalyticsJourneyFunnelStepGroup.JSON_PROPERTY_GROUP_TAGS,
  ProductAnalyticsJourneyFunnelStepGroup.JSON_PROPERTY_VALUE
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ProductAnalyticsJourneyFunnelStepGroup {
  @JsonIgnore public boolean unparsed = false;
  public static final String JSON_PROPERTY_CONVERSION_COUNT = "conversion_count";
  ...
  @JsonCreator
  public ProductAnalyticsJourneyFunnelStepGroup(
      @JsonProperty(required = true, value = JSON_PROPERTY_CONVERSION_COUNT) Long conversionCount,
      @JsonProperty(required = true, value = JSON_PROPERTY_ELAPSED_TIME_TO_NEXT_STEP)
   ...
   */
  @JsonProperty(JSON_PROPERTY_CONVERSION_COUNT)
  ...
  public ProductAnalyticsJourneyFunnelStepGroup elapsedTimeToNextStep(
      ProductAnalyticsElapsedTime elapsedTimeToNextStep) {
    this.elapsedTimeToNextStep = elapsedTimeToNextStep;
    this.unparsed |= elapsedTimeToNextStep.unparsed;
    return this;
   ...
   * @return ProductAnalyticsJourneyFunnelStepGroup
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsJourneyFunnelStepGroup productAnalyticsJourneyFunnelStepGroup =
        (ProductAnalyticsJourneyFunnelStepGroup) o;
    return Objects.equals(
            this.conversionCount, productAnalyticsJourneyFunnelStepGroup.conversionCount)
        && Objects.equals(
            this.elapsedTimeToNextStep,
            productAnalyticsJourneyFunnelStepGroup.elapsedTimeToNextStep)
        && Objects.equals(this.groupTags, productAnalyticsJourneyFunnelStepGroup.groupTags)
        && Objects.equals(this.value, productAnalyticsJourneyFunnelStepGroup.value)
        && Objects.equals(
            this.additionalProperties, productAnalyticsJourneyFunnelStepGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        conversionCount, elapsedTimeToNextStep, groupTags, value, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductAnalyticsJourneyFunnelStepGroup {\n");
