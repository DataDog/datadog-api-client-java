...
public class XRayServicesList extends AbstractOpenApiSchema {
    ...
    public static class XRayServicesListSerializer extends StdSerializer<XRayServicesList> {
        ...
        @Override
        public void serialize(XRayServicesList value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class XRayServicesListDeserializer extends StdDeserializer<XRayServicesList> {
        ...
        @Override
        public XRayServicesList deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (XRayServicesIncludeAll.class.equals(Integer.class) || XRayServicesIncludeAll.class.equals(Long.class) || XRayServicesIncludeAll.class.equals(Float.class) || XRayServicesIncludeAll.class.equals(Double.class) || XRayServicesIncludeAll.class.equals(Boolean.class) || XRayServicesIncludeAll.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((XRayServicesIncludeAll.class.equals(Integer.class) || XRayServicesIncludeAll.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((XRayServicesIncludeAll.class.equals(Float.class) || XRayServicesIncludeAll.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (XRayServicesIncludeAll.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (XRayServicesIncludeAll.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (XRayServicesIncludeOnly.class.equals(Integer.class) || XRayServicesIncludeOnly.class.equals(Long.class) || XRayServicesIncludeOnly.class.equals(Float.class) || XRayServicesIncludeOnly.class.equals(Double.class) || XRayServicesIncludeOnly.class.equals(Boolean.class) || XRayServicesIncludeOnly.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((XRayServicesIncludeOnly.class.equals(Integer.class) || XRayServicesIncludeOnly.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((XRayServicesIncludeOnly.class.equals(Float.class) || XRayServicesIncludeOnly.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (XRayServicesIncludeOnly.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (XRayServicesIncludeOnly.class.equals(String.class) && token == JsonToken.VALUE_STRING);
     ...
     * XRayServicesIncludeAll, XRayServicesIncludeOnly
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be XRayServicesIncludeAll, XRayServicesIncludeOnly");
    }
    ...
    /**
     * Get the actual instance of `XRayServicesIncludeAll`. If the actual instance is not `XRayServicesIncludeAll`,
    ...
    /**
     * Get the actual instance of `XRayServicesIncludeOnly`. If the actual instance is not `XRayServicesIncludeOnly`,
     * the ClassCastException will be thrown.
     *
