...
/**
   * <p>Schema for a GitHub webhook-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class GithubWebhookTriggerWrapper {
  ...
  @JsonCreator
  public GithubWebhookTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_GITHUB_WEBHOOK_TRIGGER)GithubWebhookTrigger githubWebhookTrigger) {
        this.githubWebhookTrigger = githubWebhookTrigger;
        this.unparsed |= githubWebhookTrigger.unparsed;
  }
  public GithubWebhookTriggerWrapper githubWebhookTrigger(GithubWebhookTrigger githubWebhookTrigger) {
    this.githubWebhookTrigger = githubWebhookTrigger;
    this.unparsed |= githubWebhookTrigger.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.githubWebhookTrigger, githubWebhookTriggerWrapper.githubWebhookTrigger) && Objects.equals(this.startStepNames, githubWebhookTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, githubWebhookTriggerWrapper.additionalProperties);
  }
