...
public class AuthNMappingIncluded extends AbstractOpenApiSchema {
    ...
    public static class AuthNMappingIncludedSerializer extends StdSerializer<AuthNMappingIncluded> {
        ...
        @Override
        public void serialize(AuthNMappingIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AuthNMappingIncludedDeserializer extends StdDeserializer<AuthNMappingIncluded> {
        ...
        @Override
        public AuthNMappingIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (SAMLAssertionAttribute.class.equals(Integer.class) || SAMLAssertionAttribute.class.equals(Long.class) || SAMLAssertionAttribute.class.equals(Float.class) || SAMLAssertionAttribute.class.equals(Double.class) || SAMLAssertionAttribute.class.equals(Boolean.class) || SAMLAssertionAttribute.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SAMLAssertionAttribute.class.equals(Integer.class) || SAMLAssertionAttribute.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SAMLAssertionAttribute.class.equals(Float.class) || SAMLAssertionAttribute.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SAMLAssertionAttribute.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SAMLAssertionAttribute.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AuthNMappingTeam.class.equals(Integer.class) || AuthNMappingTeam.class.equals(Long.class) || AuthNMappingTeam.class.equals(Float.class) || AuthNMappingTeam.class.equals(Double.class) || AuthNMappingTeam.class.equals(Boolean.class) || AuthNMappingTeam.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AuthNMappingTeam.class.equals(Integer.class) || AuthNMappingTeam.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AuthNMappingTeam.class.equals(Float.class) || AuthNMappingTeam.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AuthNMappingTeam.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AuthNMappingTeam.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public AuthNMappingIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * SAMLAssertionAttribute, Role, AuthNMappingTeam
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SAMLAssertionAttribute, Role, AuthNMappingTeam");
    }
    ...
    /**
     * Get the actual instance of `SAMLAssertionAttribute`. If the actual instance is not `SAMLAssertionAttribute`,
    ...
    /**
     * Get the actual instance of `AuthNMappingTeam`. If the actual instance is not `AuthNMappingTeam`,
     * the ClassCastException will be thrown.
     *
