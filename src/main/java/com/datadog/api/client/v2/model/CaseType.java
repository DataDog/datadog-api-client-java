...
public class CaseType extends ModelEnum<String> {
  ...
  public static class CaseTypeSerializer extends StdSerializer<CaseType> {
      public CaseTypeSerializer(Class<CaseType> t) {
          super(t);
      }

      public CaseTypeSerializer() {
          this(null);
      }

      @Override
      public void serialize(CaseType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
