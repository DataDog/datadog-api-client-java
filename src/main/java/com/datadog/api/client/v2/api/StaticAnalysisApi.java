...
public class StaticAnalysisApi {
   ...
   * Show Custom Rule.
   *
   * <p>See {@link #showCustomRuleWithHttpInfo}.
   *
   * @param rulesetName The ruleset name (required)
   * @param ruleName The rule name (required)
   * @return CustomRuleResponse
   ...
   * Show Custom Rule.
   *
   * <p>See {@link #showCustomRuleWithHttpInfoAsync}.
   *
   * @param rulesetName The ruleset name (required)
   * @param ruleName The rule name (required)
   * @return CompletableFuture&lt;CustomRuleResponse&gt;
   */
  public CompletableFuture<CustomRuleResponse> showCustomRuleAsync(
      String rulesetName, String ruleName) {
   ...
   *     </table>
   */
  public ApiResponse<CustomRuleResponse> showCustomRuleWithHttpInfo(
   ...
   * @return CompletableFuture&lt;ApiResponse&lt;CustomRuleResponse&gt;&gt;
   */
  public CompletableFuture<ApiResponse<CustomRuleResponse>> showCustomRuleWithHttpInfoAsync(
      String rulesetName, String ruleName) {
    // Check if unstable operation is enabled
    String operationId = "showCustomRule";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
   ...
   *
   * <p>See {@link #showCustomRuleRevisionWithHttpInfo}.
   *
   * @param rulesetName The ruleset name (required)
   * @param ruleName The rule name (required)
   ...
   * Show Custom Rule Revision.
   *
   * <p>See {@link #showCustomRuleRevisionWithHttpInfoAsync}.
   *
   * @param rulesetName The ruleset name (required)
   * @param ruleName The rule name (required)
   * @param id The revision ID (required)
   ...
   */
  public CompletableFuture<CustomRuleRevisionResponse> showCustomRuleRevisionAsync(
   ...
   *     </table>
   */
  public ApiResponse<CustomRuleRevisionResponse> showCustomRuleRevisionWithHttpInfo(
      String rulesetName, String ruleName, String id) throws ApiException {
    // Check if unstable operation is enabled
   ...
   * Show Custom Ruleset.
   *
   * <p>See {@link #showCustomRulesetWithHttpInfo}.
   *
   * @param rulesetName The ruleset name (required)
   ...
   * Show Custom Ruleset.
   *
   * <p>See {@link #showCustomRulesetWithHttpInfoAsync}.
   *
   * @param rulesetName The ruleset name (required)
   * @return CompletableFuture&lt;CustomRulesetResponse&gt;
   */
  public CompletableFuture<CustomRulesetResponse> showCustomRulesetAsync(String rulesetName) {
   ...
   *     </table>
   */
  public ApiResponse<CustomRulesetResponse> showCustomRulesetWithHttpInfo(String rulesetName)
      throws ApiException {
    // Check if unstable operation is enabled
   ...
   */
  public CompletableFuture<ApiResponse<CustomRulesetResponse>> showCustomRulesetWithHttpInfoAsync(
      String rulesetName) {
    // Check if unstable operation is enabled
    String operationId = "showCustomRuleset";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void updateCustomRuleset(String rulesetName, CustomRulesetRequest body)
      throws ApiException {
    updateCustomRulesetWithHttpInfo(rulesetName, body);
  }
   ...
   * @return CompletableFuture
   */
  public CompletableFuture<Void> updateCustomRulesetAsync(
   ...
   *     </table>
   */
  public ApiResponse<Void> updateCustomRulesetWithHttpInfo(
   ...
   * @return CompletableFuture&lt;ApiResponse&lt;Void&gt;&gt;
   */
  public CompletableFuture<ApiResponse<Void>> updateCustomRulesetWithHttpInfoAsync(
      String rulesetName, CustomRulesetRequest body) {
    // Check if unstable operation is enabled
    String operationId = "updateCustomRuleset";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
