 ...
 *
 * See {@link #createAwsOnDemandTaskWithHttpInfo}.
 *
 ...
 * Create AWS on demand task.
 *
 * See {@link #createAwsOnDemandTaskWithHttpInfoAsync}.
 *
 * @param body The definition of the on demand task. (required)
 ...
 */
  public CompletableFuture<AwsOnDemandResponse>createAwsOnDemandTaskAsync(AwsOnDemandCreateRequest body) {
    return createAwsOnDemandTaskWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Trigger the scan of an AWS resource with a high priority. Agentless scanning must be activated for the AWS account containing the resource to scan.</p>
   *
   * @param body The definition of the on demand task. (required)
  ...
  public ApiResponse<AwsOnDemandResponse> createAwsOnDemandTaskWithHttpInfo(AwsOnDemandCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAwsOnDemandTask", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsOnDemandResponse>> createAwsOnDemandTaskWithHttpInfoAsync(AwsOnDemandCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAwsOnDemandTask", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsOnDemandResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandResponse>() {});
  }
 ...
 */
  public CompletableFuture<AwsScanOptionsResponse>createAwsScanOptionsAsync(AwsScanOptionsCreateRequest body) {
    return createAwsScanOptionsWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AwsScanOptionsResponse> createAwsScanOptionsWithHttpInfo(AwsScanOptionsCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsScanOptionsResponse>> createAwsScanOptionsWithHttpInfoAsync(AwsScanOptionsCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsScanOptionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsResponse>() {});
  }

  /**
 * Create Azure scan options.
 *
 * See {@link #createAzureScanOptionsWithHttpInfo}.
 *
 * @param body  (required)
 ...
 * Create Azure scan options.
 *
 * See {@link #createAzureScanOptionsWithHttpInfoAsync}.
 *
 * @param body  (required)
 ...
 */
  public CompletableFuture<AzureScanOptions>createAzureScanOptionsAsync(AzureScanOptions body) {
    return createAzureScanOptionsWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Activate Agentless scan options for an Azure subscription.</p>
   *
   * @param body  (required)
  ...
  public ApiResponse<AzureScanOptions> createAzureScanOptionsWithHttpInfo(AzureScanOptions body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AzureScanOptions>> createAzureScanOptionsWithHttpInfoAsync(AzureScanOptions body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.createAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AzureScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }

  /**
 * Create GCP scan options.
 *
 * See {@link #createGcpScanOptionsWithHttpInfo}.
 *
 * @param body The definition of the new scan options. (required)
 ...
 * Create GCP scan options.
 *
 * See {@link #createGcpScanOptionsWithHttpInfoAsync}.
 *
 * @param body The definition of the new scan options. (required)
 ...
 */
  public CompletableFuture<GcpScanOptions>createGcpScanOptionsAsync(GcpScanOptions body) {
    return createGcpScanOptionsWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Activate Agentless scan options for a GCP project.</p>
   *
   * @param body The definition of the new scan options. (required)
  ...
  public ApiResponse<GcpScanOptions> createGcpScanOptionsWithHttpInfo(GcpScanOptions body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.createGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GcpScanOptions>> createGcpScanOptionsWithHttpInfoAsync(GcpScanOptions body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.createGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GcpScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteAwsScanOptionsAsync(String accountId) {
    return deleteAwsScanOptionsWithHttpInfoAsync(accountId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Void> deleteAwsScanOptionsWithHttpInfo(String accountId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/agentless_scanning/accounts/aws/{account_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteAwsScanOptionsWithHttpInfoAsync(String accountId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #deleteAzureScanOptionsWithHttpInfo}.
 *
 ...
 * Delete Azure scan options.
 *
 * See {@link #deleteAzureScanOptionsWithHttpInfoAsync}.
 *
 * @param subscriptionId The Azure subscription ID. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteAzureScanOptionsAsync(String subscriptionId) {
    return deleteAzureScanOptionsWithHttpInfoAsync(subscriptionId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete Agentless scan options for an Azure subscription.</p>
   *
   * @param subscriptionId The Azure subscription ID. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteAzureScanOptionsWithHttpInfo(String subscriptionId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/agentless_scanning/accounts/azure/{subscription_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteAzureScanOptionsWithHttpInfoAsync(String subscriptionId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #deleteGcpScanOptionsWithHttpInfo}.
 *
 ...
 * Delete GCP scan options.
 *
 * See {@link #deleteGcpScanOptionsWithHttpInfoAsync}.
 *
 * @param projectId The GCP project ID. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteGcpScanOptionsAsync(String projectId) {
    return deleteGcpScanOptionsWithHttpInfoAsync(projectId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete Agentless scan options for a GCP project.</p>
   *
   * @param projectId The GCP project ID. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteGcpScanOptionsWithHttpInfo(String projectId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/agentless_scanning/accounts/gcp/{project_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteGcpScanOptionsWithHttpInfoAsync(String projectId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.deleteGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #getAwsOnDemandTaskWithHttpInfo}.
 *
 ...
 * Get AWS on demand task.
 *
 * See {@link #getAwsOnDemandTaskWithHttpInfoAsync}.
 *
 * @param taskId The UUID of the task. (required)
 * @return CompletableFuture&lt;AwsOnDemandResponse&gt;
 */
  public CompletableFuture<AwsOnDemandResponse>getAwsOnDemandTaskAsync(String taskId) {
    return getAwsOnDemandTaskWithHttpInfoAsync(taskId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AwsOnDemandResponse> getAwsOnDemandTaskWithHttpInfo(String taskId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/agentless_scanning/ondemand/aws/{task_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAwsOnDemandTask", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsOnDemandResponse>> getAwsOnDemandTaskWithHttpInfoAsync(String taskId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAwsOnDemandTask", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsOnDemandResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandResponse>() {});
  }

  /**
 * Get AWS scan options.
 *
 * See {@link #getAwsScanOptionsWithHttpInfo}.
 *
 * @param accountId The ID of an AWS account. (required)
 * @return AwsScanOptionsResponse
 * @throws ApiException if fails to make API call
 ...
 * Get AWS scan options.
 *
 * See {@link #getAwsScanOptionsWithHttpInfoAsync}.
 *
 * @param accountId The ID of an AWS account. (required)
 * @return CompletableFuture&lt;AwsScanOptionsResponse&gt;
 */
  public CompletableFuture<AwsScanOptionsResponse>getAwsScanOptionsAsync(String accountId) {
    return getAwsScanOptionsWithHttpInfoAsync(accountId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Fetches the Agentless scan options for an activated account.</p>
   *
   * @param accountId The ID of an AWS account. (required)
   * @return ApiResponse&lt;AwsScanOptionsResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<AwsScanOptionsResponse> getAwsScanOptionsWithHttpInfo(String accountId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsScanOptionsResponse>> getAwsScanOptionsWithHttpInfoAsync(String accountId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsScanOptionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsResponse>() {});
  }

  /**
 * Get Azure scan options.
 *
 * See {@link #getAzureScanOptionsWithHttpInfo}.
 *
 * @param subscriptionId The Azure subscription ID. (required)
 * @return AzureScanOptions
 * @throws ApiException if fails to make API call
 ...
 * Get Azure scan options.
 *
 * See {@link #getAzureScanOptionsWithHttpInfoAsync}.
 *
 * @param subscriptionId The Azure subscription ID. (required)
 * @return CompletableFuture&lt;AzureScanOptions&gt;
 */
  public CompletableFuture<AzureScanOptions>getAzureScanOptionsAsync(String subscriptionId) {
    return getAzureScanOptionsWithHttpInfoAsync(subscriptionId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Fetches the Agentless scan options for an activated subscription.</p>
   *
   * @param subscriptionId The Azure subscription ID. (required)
   * @return ApiResponse&lt;AzureScanOptions&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<AzureScanOptions> getAzureScanOptionsWithHttpInfo(String subscriptionId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AzureScanOptions>> getAzureScanOptionsWithHttpInfoAsync(String subscriptionId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.getAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AzureScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }

  /**
 * Get GCP scan options.
 *
 * See {@link #getGcpScanOptionsWithHttpInfo}.
 *
 * @param projectId The GCP project ID. (required)
 * @return GcpScanOptions
 * @throws ApiException if fails to make API call
 ...
 * Get GCP scan options.
 *
 * See {@link #getGcpScanOptionsWithHttpInfoAsync}.
 *
 * @param projectId The GCP project ID. (required)
 * @return CompletableFuture&lt;GcpScanOptions&gt;
 */
  public CompletableFuture<GcpScanOptions>getGcpScanOptionsAsync(String projectId) {
    return getGcpScanOptionsWithHttpInfoAsync(projectId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Fetches the Agentless scan options for an activated GCP project.</p>
   *
   * @param projectId The GCP project ID. (required)
   * @return ApiResponse&lt;GcpScanOptions&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<GcpScanOptions> getGcpScanOptionsWithHttpInfo(String projectId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.getGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GcpScanOptions>> getGcpScanOptionsWithHttpInfoAsync(String projectId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.getGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GcpScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
 ...
 */
  public CompletableFuture<AwsOnDemandListResponse>listAwsOnDemandTasksAsync() {
    return listAwsOnDemandTasksWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AwsOnDemandListResponse> listAwsOnDemandTasksWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAwsOnDemandTasks", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsOnDemandListResponse>> listAwsOnDemandTasksWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAwsOnDemandTasks", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsOnDemandListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsOnDemandListResponse>() {});
  }
 ...
 */
  public CompletableFuture<AwsScanOptionsListResponse>listAwsScanOptionsAsync() {
    return listAwsScanOptionsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<AwsScanOptionsListResponse> listAwsScanOptionsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsListResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AwsScanOptionsListResponse>> listAwsScanOptionsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AwsScanOptionsListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AwsScanOptionsListResponse>() {});
  }

  /**
 * List Azure scan options.
 *
 * See {@link #listAzureScanOptionsWithHttpInfo}.
 *
 ...
 */
  ...
  /**
   * <p>Fetches the scan options configured for Azure accounts.</p>
   *
  ...
  public ApiResponse<AzureScanOptionsArray> listAzureScanOptionsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptionsArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AzureScanOptionsArray>> listAzureScanOptionsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.listAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AzureScanOptionsArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptionsArray>() {});
  }

  /**
 * List GCP scan options.
 *
 * See {@link #listGcpScanOptionsWithHttpInfo}.
 *
 ...
 */
  ...
  /**
   * <p>Fetches the scan options configured for all GCP projects.</p>
   *
  ...
  public ApiResponse<GcpScanOptionsArray> listGcpScanOptionsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.listGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptionsArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GcpScanOptionsArray>> listGcpScanOptionsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.listGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GcpScanOptionsArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptionsArray>() {});
  }
 ...
 */
  public CompletableFuture<Void>updateAwsScanOptionsAsync(String accountId, AwsScanOptionsUpdateRequest body) {
    return updateAwsScanOptionsWithHttpInfoAsync(accountId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Void> updateAwsScanOptionsWithHttpInfo(String accountId, AwsScanOptionsUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> updateAwsScanOptionsWithHttpInfoAsync(String accountId, AwsScanOptionsUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateAwsScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #updateAzureScanOptionsWithHttpInfo}.
 *
 * @param subscriptionId The Azure subscription ID. (required)
 * @param body  (required)
 * @return AzureScanOptions
 ...
 * Update Azure scan options.
 *
 * See {@link #updateAzureScanOptionsWithHttpInfoAsync}.
 *
 * @param subscriptionId The Azure subscription ID. (required)
 * @param body  (required)
 * @return CompletableFuture&lt;AzureScanOptions&gt;
 */
  public CompletableFuture<AzureScanOptions>updateAzureScanOptionsAsync(String subscriptionId, AzureScanOptionsInputUpdate body) {
    return updateAzureScanOptionsWithHttpInfoAsync(subscriptionId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update the Agentless scan options for an activated subscription.</p>
   *
   * @param subscriptionId The Azure subscription ID. (required)
   * @param body  (required)
   * @return ApiResponse&lt;AzureScanOptions&gt;
  ...
  public ApiResponse<AzureScanOptions> updateAzureScanOptionsWithHttpInfo(String subscriptionId, AzureScanOptionsInputUpdate body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AzureScanOptions>> updateAzureScanOptionsWithHttpInfoAsync(String subscriptionId, AzureScanOptionsInputUpdate body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateAzureScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AzureScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AzureScanOptions>() {});
  }

  /**
 * Update GCP scan options.
 *
 * See {@link #updateGcpScanOptionsWithHttpInfo}.
 *
 * @param projectId The GCP project ID. (required)
 * @param body New definition of the scan options. (required)
 * @return GcpScanOptions
 ...
 * Update GCP scan options.
 *
 * See {@link #updateGcpScanOptionsWithHttpInfoAsync}.
 *
 * @param projectId The GCP project ID. (required)
 * @param body New definition of the scan options. (required)
 * @return CompletableFuture&lt;GcpScanOptions&gt;
 */
  public CompletableFuture<GcpScanOptions>updateGcpScanOptionsAsync(String projectId, GcpScanOptionsInputUpdate body) {
    return updateGcpScanOptionsWithHttpInfoAsync(projectId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update the Agentless scan options for an activated GCP project.</p>
   *
   * @param projectId The GCP project ID. (required)
   * @param body New definition of the scan options. (required)
   * @return ApiResponse&lt;GcpScanOptions&gt;
  ...
  public ApiResponse<GcpScanOptions> updateGcpScanOptionsWithHttpInfo(String projectId, GcpScanOptionsInputUpdate body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GcpScanOptions>> updateGcpScanOptionsWithHttpInfoAsync(String projectId, GcpScanOptionsInputUpdate body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AgentlessScanningApi.updateGcpScanOptions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GcpScanOptions>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GcpScanOptions>() {});
  }
}