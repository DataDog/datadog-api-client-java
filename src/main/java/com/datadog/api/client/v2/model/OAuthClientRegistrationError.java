...
/**
   * <p>Error payload returned by OAuth2 dynamic client registration as defined by RFC 7591.</p>
 */
@JsonPropertyOrder({
...
public class OAuthClientRegistrationError {
  ...
  public OAuthClientRegistrationError(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_ERROR_DESCRIPTION)String errorDescription) {
        this.error = error;
  ...
  /**
   * <p>Single ASCII error code per RFC 7591, such as <code>invalid_request</code> or <code>invalid_client_metadata</code>.</p>
   * @return error
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, oAuthClientRegistrationError.error) && Objects.equals(this.errorDescription, oAuthClientRegistrationError.errorDescription) && Objects.equals(this.additionalProperties, oAuthClientRegistrationError.additionalProperties);
  }
