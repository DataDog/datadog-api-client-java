...
/**
   * <p>A single label value entry in an annotation.
   * The <code>value</code> type must match the label schema type:
   * - <code>score</code>: a number within the schema <code>min</code>/<code>max</code> range (integer if <code>is_integer</code> is <code>true</code>).
   * - <code>categorical</code>: a string that is one of the schema <code>values</code>.
   * - <code>boolean</code>: <code>true</code> or <code>false</code>.
   * - <code>text</code>: any non-empty string.</p>
 */
@JsonPropertyOrder({
