...
/** The definition of <code>OrgConnectionUserRelationshipDataType</code> object. */
@JsonSerialize(
    using =
...
public class OrgConnectionUserRelationshipDataType extends ModelEnum<String> {
  ...
  public static class OrgConnectionUserRelationshipDataTypeSerializer
      extends StdSerializer<OrgConnectionUserRelationshipDataType> {
    public OrgConnectionUserRelationshipDataTypeSerializer(
        Class<OrgConnectionUserRelationshipDataType> t) {
      super(t);
    }
