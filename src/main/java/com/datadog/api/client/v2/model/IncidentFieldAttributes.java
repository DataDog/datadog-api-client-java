...
public class IncidentFieldAttributes extends AbstractOpenApiSchema {
    ...
    public static class IncidentFieldAttributesSerializer extends StdSerializer<IncidentFieldAttributes> {
        ...
        @Override
        public void serialize(IncidentFieldAttributes value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class IncidentFieldAttributesDeserializer extends StdDeserializer<IncidentFieldAttributes> {
        ...
        @Override
        public IncidentFieldAttributes deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (IncidentFieldAttributesSingleValue.class.equals(Integer.class) || IncidentFieldAttributesSingleValue.class.equals(Long.class) || IncidentFieldAttributesSingleValue.class.equals(Float.class) || IncidentFieldAttributesSingleValue.class.equals(Double.class) || IncidentFieldAttributesSingleValue.class.equals(Boolean.class) || IncidentFieldAttributesSingleValue.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentFieldAttributesSingleValue.class.equals(Integer.class) || IncidentFieldAttributesSingleValue.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentFieldAttributesSingleValue.class.equals(Float.class) || IncidentFieldAttributesSingleValue.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentFieldAttributesSingleValue.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentFieldAttributesSingleValue.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                log.log(Level.FINER, "Input data does not match schema 'IncidentFieldAttributesSingleValue'", e);
            }
            ...
            try {
                ...
                if (IncidentFieldAttributesMultipleValue.class.equals(Integer.class) || IncidentFieldAttributesMultipleValue.class.equals(Long.class) || IncidentFieldAttributesMultipleValue.class.equals(Float.class) || IncidentFieldAttributesMultipleValue.class.equals(Double.class) || IncidentFieldAttributesMultipleValue.class.equals(Boolean.class) || IncidentFieldAttributesMultipleValue.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentFieldAttributesMultipleValue.class.equals(Integer.class) || IncidentFieldAttributesMultipleValue.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentFieldAttributesMultipleValue.class.equals(Float.class) || IncidentFieldAttributesMultipleValue.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentFieldAttributesMultipleValue.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentFieldAttributesMultipleValue.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(IncidentFieldAttributesMultipleValue.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentFieldAttributesMultipleValue'", e);
            }
         ...
         */
        @Override
        public IncidentFieldAttributes getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        schemas.put("IncidentFieldAttributesSingleValue", new GenericType<IncidentFieldAttributesSingleValue>() {
        });
        schemas.put("IncidentFieldAttributesMultipleValue", new GenericType<IncidentFieldAttributesMultipleValue>() {
        });
     ...
     * IncidentFieldAttributesSingleValue, IncidentFieldAttributesMultipleValue
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(IncidentFieldAttributesSingleValue.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(IncidentFieldAttributesMultipleValue.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be IncidentFieldAttributesSingleValue, IncidentFieldAttributesMultipleValue");
    }
     ...
     * IncidentFieldAttributesSingleValue, IncidentFieldAttributesMultipleValue
     *
     * @return The actual instance (IncidentFieldAttributesSingleValue, IncidentFieldAttributesMultipleValue)
     */
    @Override
    ...
    /**
     * Get the actual instance of `IncidentFieldAttributesSingleValue`. If the actual instance is not `IncidentFieldAttributesSingleValue`,
    ...
    /**
     * Get the actual instance of `IncidentFieldAttributesMultipleValue`. If the actual instance is not `IncidentFieldAttributesMultipleValue`,
     * the ClassCastException will be thrown.
     *
