...
public class GetMultipleRulesetsRequestDataAttributes {
  ...
  /**
   * <p>When true, rules that are available in testing mode are included in the response.</p>
  ...
  **/
  ...
  /**
   * <p>When true, test cases associated with each rule are included in the response.</p>
   * @return includeTests
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The list of ruleset names to retrieve.</p>
   * @return rulesets
  **/
      @jakarta.annotation.Nullable
