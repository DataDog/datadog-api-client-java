...
/** The definition of the <code>FastlyIntegrationUpdate</code> object. */
@JsonPropertyOrder({
...
public class FastlyIntegrationUpdate {
  ...
  /**
   * The definition of the <code>FastlyCredentialsUpdate</code> object.
   *
   * @return credentials
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentials, fastlyIntegrationUpdate.credentials)
        && Objects.equals(this.type, fastlyIntegrationUpdate.type)
        && Objects.equals(this.additionalProperties, fastlyIntegrationUpdate.additionalProperties);
  }
