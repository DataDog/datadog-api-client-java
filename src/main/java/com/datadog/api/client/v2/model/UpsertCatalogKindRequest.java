...
public class UpsertCatalogKindRequest extends AbstractOpenApiSchema {
    ...
    public static class UpsertCatalogKindRequestSerializer extends StdSerializer<UpsertCatalogKindRequest> {
        ...
        @Override
        public void serialize(UpsertCatalogKindRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UpsertCatalogKindRequestDeserializer extends StdDeserializer<UpsertCatalogKindRequest> {
        ...
        @Override
        public UpsertCatalogKindRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (KindObj.class.equals(Integer.class) || KindObj.class.equals(Long.class) || KindObj.class.equals(Float.class) || KindObj.class.equals(Double.class) || KindObj.class.equals(Boolean.class) || KindObj.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((KindObj.class.equals(Integer.class) || KindObj.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((KindObj.class.equals(Float.class) || KindObj.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (KindObj.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (KindObj.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public UpsertCatalogKindRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `KindObj`. If the actual instance is not `KindObj`,
