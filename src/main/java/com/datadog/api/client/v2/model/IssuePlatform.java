...
public class IssuePlatform extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ANDROID", "BACKEND", "BROWSER", "FLUTTER", "IOS", "REACT_NATIVE", "ROKU", "UNKNOWN"));
  ...
  public static class IssuePlatformSerializer extends StdSerializer<IssuePlatform> {
      ...
      @Override
      public void serialize(IssuePlatform value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
