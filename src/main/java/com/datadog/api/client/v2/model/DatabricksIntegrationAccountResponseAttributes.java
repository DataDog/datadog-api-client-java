...
public class DatabricksIntegrationAccountResponseAttributes {
  ...
  /**
   * Authentication configured on the Databricks integration account. A <code>bearer_token</code>
   * method indicates an account still on token authentication, which Databricks accepts only on
   * accounts that already use it.
   *
