...
/**
 * The <code>remap_vrl</code> processor transforms events using Vector Remap Language (VRL) scripts
...
public class ObservabilityPipelineRemapVrlProcessor {
  ...
  /**
   * Array of VRL remap configurations. Each remap defines a transformation rule with its own filter
   * and VRL script.
   *
   * @return remaps
   */
