...
public class SecurityMonitoringDatasetType extends ModelEnum<String> {
  ...
  public static final SecurityMonitoringDatasetType DATASET = new SecurityMonitoringDatasetType("dataset");
  ...
  public static class SecurityMonitoringDatasetTypeSerializer extends StdSerializer<SecurityMonitoringDatasetType> {
      ...
      @Override
      public void serialize(SecurityMonitoringDatasetType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
