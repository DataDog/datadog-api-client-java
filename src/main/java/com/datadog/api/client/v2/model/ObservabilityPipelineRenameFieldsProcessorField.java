...
/**
   * <p>Defines how to rename a field in log events.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineRenameFieldsProcessorField {
  ...
  /**
   * <p>The field name to assign the renamed value to.</p>
   * @return destination
  **/
  ...
  /**
   * <p>Indicates whether the original field, that is received from the source, should be kept (<code>true</code>) or removed (<code>false</code>) after renaming.</p>
  ...
  **/
  ...
  /**
   * <p>The original field name in the log event that should be renamed.</p>
   * @return source
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineRenameFieldsProcessorField observabilityPipelineRenameFieldsProcessorField = (ObservabilityPipelineRenameFieldsProcessorField) o;
