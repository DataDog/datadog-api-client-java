...
/**
   * <p>Facet data for the incident property fields.</p>
 */
@JsonPropertyOrder({
...
public class IncidentSearchResponsePropertyFieldFacetData {
  ...
  @JsonCreator
  public IncidentSearchResponsePropertyFieldFacetData(
            @JsonProperty(required=true, value=JSON_PROPERTY_FACETS)List<IncidentSearchResponseFieldFacetData> facets,
            @JsonProperty(required=true, value=JSON_PROPERTY_NAME)String name) {
        this.facets = facets;
        this.name = name;
  }
  public IncidentSearchResponsePropertyFieldFacetData aggregates(IncidentSearchResponseNumericFacetDataAggregates aggregates) {
  ...
  **/
  ...
  public IncidentSearchResponsePropertyFieldFacetData facets(List<IncidentSearchResponseFieldFacetData> facets) {
    this.facets = facets;
  ...
  public IncidentSearchResponsePropertyFieldFacetData addFacetsItem(IncidentSearchResponseFieldFacetData facetsItem) {
  ...
  /**
   * <p>Facet data for the property field of an incident.</p>
   * @return facets
  **/
  ...
  /**
   * <p>Name of the incident property field.</p>
   * @return name
  **/
   ...
   */
  @JsonAnySetter
  public IncidentSearchResponsePropertyFieldFacetData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentSearchResponsePropertyFieldFacetData incidentSearchResponsePropertyFieldFacetData = (IncidentSearchResponsePropertyFieldFacetData) o;
    return Objects.equals(this.aggregates, incidentSearchResponsePropertyFieldFacetData.aggregates) && Objects.equals(this.facets, incidentSearchResponsePropertyFieldFacetData.facets) && Objects.equals(this.name, incidentSearchResponsePropertyFieldFacetData.name) && Objects.equals(this.additionalProperties, incidentSearchResponsePropertyFieldFacetData.additionalProperties);
  }
