...
/**
   * <p>A single entry in the version history of a dataset.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringDatasetVersionEntry {
  ...
  @JsonCreator
  public SecurityMonitoringDatasetVersionEntry(
            @JsonProperty(required=true, value=JSON_PROPERTY_CHANGES)List<SecurityMonitoringDatasetVersionFieldChange> changes,
            @JsonProperty(required=true, value=JSON_PROPERTY_DATASET)SecurityMonitoringDatasetAttributesResponse dataset) {
  ...
  public SecurityMonitoringDatasetVersionEntry changes(List<SecurityMonitoringDatasetVersionFieldChange> changes) {
    this.changes = changes;
    for (SecurityMonitoringDatasetVersionFieldChange item : changes) {
      this.unparsed |= item.unparsed;
    }
  ...
  public SecurityMonitoringDatasetVersionEntry addChangesItem(SecurityMonitoringDatasetVersionFieldChange changesItem) {
  ...
  /**
   * <p>The list of field changes between this version of the dataset and the previous one.</p>
   * @return changes
  **/
  ...
  public SecurityMonitoringDatasetVersionEntry dataset(SecurityMonitoringDatasetAttributesResponse dataset) {
    this.dataset = dataset;
    this.unparsed |= dataset.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringDatasetVersionEntry securityMonitoringDatasetVersionEntry = (SecurityMonitoringDatasetVersionEntry) o;
    return Objects.equals(this.changes, securityMonitoringDatasetVersionEntry.changes) && Objects.equals(this.dataset, securityMonitoringDatasetVersionEntry.dataset) && Objects.equals(this.additionalProperties, securityMonitoringDatasetVersionEntry.additionalProperties);
  }
