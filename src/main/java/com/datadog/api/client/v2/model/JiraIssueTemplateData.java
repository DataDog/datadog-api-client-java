...
public class JiraIssueTemplateData {
  ...
  @JsonCreator
  public JiraIssueTemplateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)JiraIssueTemplateDataAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>Unique identifier for the Jira issue template</p>
   * @return id
  **/
