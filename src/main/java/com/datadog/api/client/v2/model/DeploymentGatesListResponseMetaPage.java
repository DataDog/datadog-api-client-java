...
public class DeploymentGatesListResponseMetaPage {
  ...
  /**
   * The number of results per page. minimum: 1 maximum: 1000
   *
   * @return size
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    DeploymentGatesListResponseMetaPage deploymentGatesListResponseMetaPage =
        (DeploymentGatesListResponseMetaPage) o;
    return Objects.equals(this.cursor, deploymentGatesListResponseMetaPage.cursor)
        && Objects.equals(this.nextCursor, deploymentGatesListResponseMetaPage.nextCursor)
        && Objects.equals(this.size, deploymentGatesListResponseMetaPage.size)
        && Objects.equals(
            this.additionalProperties, deploymentGatesListResponseMetaPage.additionalProperties);
  }
