...
/**
   * <p>Recurrence settings returned in a Synthetics downtime time slot response.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsDowntimeTimeSlotRecurrenceResponse {
  ...
  @JsonCreator
  public SyntheticsDowntimeTimeSlotRecurrenceResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_FREQUENCY)SyntheticsDowntimeFrequency frequency,
            @JsonProperty(required=true, value=JSON_PROPERTY_INTERVAL)Long interval,
            @JsonProperty(required=true, value=JSON_PROPERTY_WEEKDAYS)List<SyntheticsDowntimeWeekday> weekdays) {
  ...
  **/
  ...
  /**
   * <p>The interval between recurrences, relative to the frequency.</p>
   * @return interval
  **/
  ...
  **/
  ...
  /**
   * <p>Positions of the weekdays within a month for a monthly Synthetics downtime recurrence. Used in combination with <code>weekdays</code> to schedule occurrences such as "the first Monday of the month".</p>
  ...
  **/
  ...
  /**
   * <p>Days of the week for a Synthetics downtime recurrence schedule.</p>
   * @return weekdays
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsDowntimeTimeSlotRecurrenceResponse syntheticsDowntimeTimeSlotRecurrenceResponse = (SyntheticsDowntimeTimeSlotRecurrenceResponse) o;
    return Objects.equals(this.frequency, syntheticsDowntimeTimeSlotRecurrenceResponse.frequency) && Objects.equals(this.interval, syntheticsDowntimeTimeSlotRecurrenceResponse.interval) && Objects.equals(this.until, syntheticsDowntimeTimeSlotRecurrenceResponse.until) && Objects.equals(this.weekdayPositions, syntheticsDowntimeTimeSlotRecurrenceResponse.weekdayPositions) && Objects.equals(this.weekdays, syntheticsDowntimeTimeSlotRecurrenceResponse.weekdays) && Objects.equals(this.additionalProperties, syntheticsDowntimeTimeSlotRecurrenceResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(frequency,interval,until,weekdayPositions,weekdays, additionalProperties);
  }
