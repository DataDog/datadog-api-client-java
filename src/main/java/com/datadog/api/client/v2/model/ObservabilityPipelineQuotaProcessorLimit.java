...
public class ObservabilityPipelineQuotaProcessorLimit {
  ...
  public ObservabilityPipelineQuotaProcessorLimit(
      @JsonProperty(required = true, value = JSON_PROPERTY_ENFORCE)
          ObservabilityPipelineQuotaProcessorLimitEnforceType enforce,
  ...
  public ObservabilityPipelineQuotaProcessorLimit enforce(
      ObservabilityPipelineQuotaProcessorLimitEnforceType enforce) {
    this.enforce = enforce;
    this.unparsed |= !enforce.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineQuotaProcessorLimit observabilityPipelineQuotaProcessorLimit =
        (ObservabilityPipelineQuotaProcessorLimit) o;
    return Objects.equals(this.enforce, observabilityPipelineQuotaProcessorLimit.enforce)
        && Objects.equals(this.limit, observabilityPipelineQuotaProcessorLimit.limit)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineQuotaProcessorLimit.additionalProperties);
  }
