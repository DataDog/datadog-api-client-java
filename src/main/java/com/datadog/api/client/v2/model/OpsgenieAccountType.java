...
public class OpsgenieAccountType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("opsgenie-account"));

  public static final OpsgenieAccountType OPSGENIE_ACCOUNT = new OpsgenieAccountType("opsgenie-account");
  ...
  public static class OpsgenieAccountTypeSerializer extends StdSerializer<OpsgenieAccountType> {
      ...
      @Override
      public void serialize(OpsgenieAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
