...
/**
   * <p>An included change request decision for a create or update operation.</p>
 */
@JsonPropertyOrder({
...
public class ChangeRequestDecisionCreateItem {
  ...
  public ChangeRequestDecisionCreateItem(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ChangeRequestDecisionResourceType type) {
        this.id = id;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public ChangeRequestDecisionCreateItem attributes(ChangeRequestDecisionCreateAttributes attributes) {
  ...
  /**
   * <p>Attributes for creating a change request decision.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public ChangeRequestDecisionCreateItem relationships(ChangeRequestDecisionCreateRelationships relationships) {
  ...
  /**
   * <p>Relationships for creating a change request decision.</p>
  ...
  **/
  ...
  /**
   * <p>Change request decision resource type.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChangeRequestDecisionCreateItem changeRequestDecisionCreateItem = (ChangeRequestDecisionCreateItem) o;
    return Objects.equals(this.attributes, changeRequestDecisionCreateItem.attributes) && Objects.equals(this.id, changeRequestDecisionCreateItem.id) && Objects.equals(this.relationships, changeRequestDecisionCreateItem.relationships) && Objects.equals(this.type, changeRequestDecisionCreateItem.type) && Objects.equals(this.additionalProperties, changeRequestDecisionCreateItem.additionalProperties);
  }
