...
public class SloStatusDataAttributes {
  ...
  @JsonCreator
  public SloStatusDataAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_ERROR_BUDGET_REMAINING)
          Double errorBudgetRemaining,
      @JsonProperty(required = true, value = JSON_PROPERTY_RAW_ERROR_BUDGET_REMAINING)
  ...
  public SloStatusDataAttributes rawErrorBudgetRemaining(
      RawErrorBudgetRemaining rawErrorBudgetRemaining) {
    this.rawErrorBudgetRemaining = rawErrorBudgetRemaining;
    this.unparsed |= rawErrorBudgetRemaining.unparsed;
    return this;
  ...
  /**
   * The current state of the SLO (for example, <code>breached</code>, <code>warning</code>, <code>
   * ok</code>).
   *
   * @return state
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.errorBudgetRemaining, sloStatusDataAttributes.errorBudgetRemaining)
        && Objects.equals(
            this.rawErrorBudgetRemaining, sloStatusDataAttributes.rawErrorBudgetRemaining)
        && Objects.equals(this.sli, sloStatusDataAttributes.sli)
        && Objects.equals(this.spanPrecision, sloStatusDataAttributes.spanPrecision)
        && Objects.equals(this.state, sloStatusDataAttributes.state)
        && Objects.equals(this.additionalProperties, sloStatusDataAttributes.additionalProperties);
  }
