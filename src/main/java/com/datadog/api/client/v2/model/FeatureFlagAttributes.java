...
/**
   * <p>Attributes of a feature flag.</p>
 */
@JsonPropertyOrder({
...
public class FeatureFlagAttributes {
  ...
  /**
   * <p>The timestamp when the feature flag was archived.</p>
   * @return archivedAt
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ARCHIVED_AT)public void setArchivedAt_JsonNullable(JsonNullable<OffsetDateTime> archivedAt) {
  ...
  /**
   * <p>The timestamp when the feature flag was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The ID of the user who created the feature flag.</p>
   * @return createdBy
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Distribution channel for the feature flag.</p>
  ...
  **/
  ...
  /**
   * <p>Environment-specific settings for the feature flag.</p>
  ...
  **/
  ...
  /**
   * <p>The ID of the user who last updated the feature flag.</p>
  ...
  **/
  ...
  /**
   * <p>Indicates whether this feature flag requires approval for changes.</p>
  ...
  **/
  ...
  /**
   * <p>The timestamp when the feature flag was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archivedAt, featureFlagAttributes.archivedAt) && Objects.equals(this.createdAt, featureFlagAttributes.createdAt) && Objects.equals(this.createdBy, featureFlagAttributes.createdBy) && Objects.equals(this.description, featureFlagAttributes.description) && Objects.equals(this.distributionChannel, featureFlagAttributes.distributionChannel) && Objects.equals(this.featureFlagEnvironments, featureFlagAttributes.featureFlagEnvironments) && Objects.equals(this.jsonSchema, featureFlagAttributes.jsonSchema) && Objects.equals(this.key, featureFlagAttributes.key) && Objects.equals(this.lastUpdatedBy, featureFlagAttributes.lastUpdatedBy) && Objects.equals(this.name, featureFlagAttributes.name) && Objects.equals(this.requireApproval, featureFlagAttributes.requireApproval) && Objects.equals(this.updatedAt, featureFlagAttributes.updatedAt) && Objects.equals(this.valueType, featureFlagAttributes.valueType) && Objects.equals(this.variants, featureFlagAttributes.variants) && Objects.equals(this.additionalProperties, featureFlagAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(archivedAt,createdAt,createdBy,description,distributionChannel,featureFlagEnvironments,jsonSchema,key,lastUpdatedBy,name,requireApproval,updatedAt,valueType,variants, additionalProperties);
  }
