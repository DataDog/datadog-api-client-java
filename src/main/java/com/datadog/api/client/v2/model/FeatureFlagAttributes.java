...
public class FeatureFlagAttributes {
  ...
  **/
  ...
  /**
   * <p>Indicates the whether a feature flag is stale or not.</p>
  ...
  **/
  ...
  /**
   * <p>Tags associated with the feature flag.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(archivedAt,createdAt,createdBy,description,distributionChannel,featureFlagEnvironments,jsonSchema,key,lastUpdatedBy,name,requireApproval,stalenessStatus,tags,updatedAt,valueType,variants, additionalProperties);
  }
