...
public class CustomFrameworkRequirement {
  ...
  @JsonCreator
  public CustomFrameworkRequirement(
            @JsonProperty(required=true, value=JSON_PROPERTY_CONTROLS)List<CustomFrameworkControl> controls,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.controls, customFrameworkRequirement.controls) && Objects.equals(this.name, customFrameworkRequirement.name) && Objects.equals(this.additionalProperties, customFrameworkRequirement.additionalProperties);
  }
