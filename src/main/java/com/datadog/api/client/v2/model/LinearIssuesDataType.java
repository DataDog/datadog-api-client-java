...
public class LinearIssuesDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("linear_issues"));

  public static final LinearIssuesDataType LINEAR_ISSUES =
      new LinearIssuesDataType("linear_issues");
  ...
  public static class LinearIssuesDataTypeSerializer extends StdSerializer<LinearIssuesDataType> {
    ...
    public void serialize(
        LinearIssuesDataType value, JsonGenerator jgen, SerializerProvider provider)
