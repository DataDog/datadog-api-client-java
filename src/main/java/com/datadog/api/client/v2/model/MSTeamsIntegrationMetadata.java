...
/**
   * <p>Incident integration metadata for the Microsoft Teams integration.</p>
 */
@JsonPropertyOrder({
  MSTeamsIntegrationMetadata.JSON_PROPERTY_TEAMS
})
...
public class MSTeamsIntegrationMetadata {
  ...
  @JsonCreator
  public MSTeamsIntegrationMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_TEAMS)List<MSTeamsIntegrationMetadataTeamsItem> teams) {
        this.teams = teams;
  }
  ...
  /**
   * <p>Array of Microsoft Teams in this integration metadata.</p>
   * @return teams
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.teams, msTeamsIntegrationMetadata.teams) && Objects.equals(this.additionalProperties, msTeamsIntegrationMetadata.additionalProperties);
  }
