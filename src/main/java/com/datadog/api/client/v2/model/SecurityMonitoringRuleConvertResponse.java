...
public class SecurityMonitoringRuleConvertResponse {
  ...
  **/
  ...
  /**
   * <p>Terraform string as a result of converting the rule from JSON.</p>
   * @return terraformContent
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_TERRAFORM_CONTENT)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public String getTerraformContent() {
        return terraformContent;
      }
  public void setTerraformContent(String terraformContent) {
    this.terraformContent = terraformContent;
  }
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringRuleConvertResponse putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecurityMonitoringRuleConvertResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SecurityMonitoringRuleConvertResponse securityMonitoringRuleConvertResponse = (SecurityMonitoringRuleConvertResponse) o;
    return Objects.equals(this.ruleId, securityMonitoringRuleConvertResponse.ruleId) && Objects.equals(this.terraformContent, securityMonitoringRuleConvertResponse.terraformContent) && Objects.equals(this.additionalProperties, securityMonitoringRuleConvertResponse.additionalProperties);
  }
