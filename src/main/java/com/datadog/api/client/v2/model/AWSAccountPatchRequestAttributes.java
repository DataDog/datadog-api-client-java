...
@JsonPropertyOrder({
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_ACCOUNT_TAGS,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_AUTH_CONFIG,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_AWS_ACCOUNT_ID,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_AWS_PARTITION,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_AWS_REGIONS,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_LOGS_CONFIG,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_METRICS_CONFIG,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_RESOURCES_CONFIG,
  AWSAccountPatchRequestAttributes.JSON_PROPERTY_TRACES_CONFIG
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class AWSAccountPatchRequestAttributes {
  ...
  public AWSAccountPatchRequestAttributes() {}
  ...
  public AWSAccountPatchRequestAttributes accountTags(List<String> accountTags) {
    this.accountTags = JsonNullable.<List<String>>of(accountTags);
    return this;
  }

  public AWSAccountPatchRequestAttributes addAccountTagsItem(String accountTagsItem) {
  ...
  public AWSAccountPatchRequestAttributes authConfig(AWSAuthConfig authConfig) {
  ...
  public AWSAccountPatchRequestAttributes awsAccountId(String awsAccountId) {
    this.awsAccountId = awsAccountId;
    return this;
  }
  ...
  public AWSAccountPatchRequestAttributes awsPartition(AWSAccountPartition awsPartition) {
  ...
  public AWSAccountPatchRequestAttributes awsRegions(AWSRegions awsRegions) {
  ...
  public AWSAccountPatchRequestAttributes logsConfig(AWSLogsConfig logsConfig) {
  ...
  public AWSAccountPatchRequestAttributes metricsConfig(AWSMetricsConfig metricsConfig) {
  ...
  public AWSAccountPatchRequestAttributes resourcesConfig(AWSResourcesConfig resourcesConfig) {
  ...
  public AWSAccountPatchRequestAttributes tracesConfig(AWSTracesConfig tracesConfig) {
   ...
   * @return AWSAccountPatchRequestAttributes
   */
  @JsonAnySetter
  public AWSAccountPatchRequestAttributes putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this AWSAccountPatchRequestAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    AWSAccountPatchRequestAttributes awsAccountPatchRequestAttributes =
        (AWSAccountPatchRequestAttributes) o;
    return Objects.equals(this.accountTags, awsAccountPatchRequestAttributes.accountTags)
        && Objects.equals(this.authConfig, awsAccountPatchRequestAttributes.authConfig)
        && Objects.equals(this.awsAccountId, awsAccountPatchRequestAttributes.awsAccountId)
        && Objects.equals(this.awsPartition, awsAccountPatchRequestAttributes.awsPartition)
        && Objects.equals(this.awsRegions, awsAccountPatchRequestAttributes.awsRegions)
        && Objects.equals(this.logsConfig, awsAccountPatchRequestAttributes.logsConfig)
        && Objects.equals(this.metricsConfig, awsAccountPatchRequestAttributes.metricsConfig)
        && Objects.equals(this.resourcesConfig, awsAccountPatchRequestAttributes.resourcesConfig)
        && Objects.equals(this.tracesConfig, awsAccountPatchRequestAttributes.tracesConfig)
        && Objects.equals(
            this.additionalProperties, awsAccountPatchRequestAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AWSAccountPatchRequestAttributes {\n");
