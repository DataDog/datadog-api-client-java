...
public class SyntheticsTestResultResponseInfo {
  ...
  **/
  ...
  /**
   * <p>Compressed representation of the response body.</p>
  ...
  **/
  ...
  /**
   * <p>Hashes computed over the response body.</p>
   * @return bodyHashes
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Size of the response body in bytes.</p>
   * @return bodySize
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Cache-related response headers.</p>
   * @return cacheHeaders
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>WebSocket close frame information for WebSocket test responses.</p>
   * @return close
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Compressed representation of the response message.</p>
  ...
  **/
  ...
  /**
   * <p>Health check information returned from a gRPC health check call.</p>
   * @return healthcheck
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>HTTP version of the response.</p>
   * @return httpVersion
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the response body was truncated.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the response message was truncated.</p>
  ...
  **/
  ...
  /**
   * <p>Message received in the response (for WebSocket/TCP/UDP tests).</p>
   * @return message
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Additional metadata returned with the response.</p>
   * @return metadata
  **/
      @jakarta.annotation.Nullable
  ...
  public SyntheticsTestResultResponseInfo addRecordsItem(SyntheticsTestResultDnsRecord recordsItem) {
  ...
  /**
   * <p>DNS records returned in the response (DNS tests only).</p>
   * @return records
  **/
      @jakarta.annotation.Nullable
  ...
  public SyntheticsTestResultResponseInfo addRedirectsItem(SyntheticsTestResultRedirect redirectsItem) {
  ...
  /**
   * <p>Redirect hops encountered while performing the request.</p>
   * @return redirects
  **/
      @jakarta.annotation.Nullable
