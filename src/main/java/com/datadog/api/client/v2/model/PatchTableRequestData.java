...
@JsonPropertyOrder({
  ...
  PatchTableRequestData.JSON_PROPERTY_ID,
...
public class PatchTableRequestData {
  ...
  public PatchTableRequestData id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return PatchTableRequestData
   */
  @JsonAnySetter
  public PatchTableRequestData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, patchTableRequestData.attributes)
        && Objects.equals(this.id, patchTableRequestData.id)
        && Objects.equals(this.type, patchTableRequestData.type)
        && Objects.equals(this.additionalProperties, patchTableRequestData.additionalProperties);
  }
