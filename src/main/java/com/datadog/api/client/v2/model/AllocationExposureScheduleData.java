...
public class AllocationExposureScheduleData {
  ...
  @JsonCreator
  public AllocationExposureScheduleData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AllocationExposureSchedule attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)UUID id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AllocationExposureScheduleDataType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AllocationExposureScheduleData allocationExposureScheduleData = (AllocationExposureScheduleData) o;
    return Objects.equals(this.attributes, allocationExposureScheduleData.attributes) && Objects.equals(this.id, allocationExposureScheduleData.id) && Objects.equals(this.type, allocationExposureScheduleData.type) && Objects.equals(this.additionalProperties, allocationExposureScheduleData.additionalProperties);
  }
