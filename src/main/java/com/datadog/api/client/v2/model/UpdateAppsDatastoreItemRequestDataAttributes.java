...
public class UpdateAppsDatastoreItemRequestDataAttributes {
  ...
  @JsonCreator
  public UpdateAppsDatastoreItemRequestDataAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_ITEM_CHANGES)
          UpdateAppsDatastoreItemRequestDataAttributesItemChanges itemChanges,
  ...
  public UpdateAppsDatastoreItemRequestDataAttributes itemChanges(
      UpdateAppsDatastoreItemRequestDataAttributesItemChanges itemChanges) {
    this.itemChanges = itemChanges;
    this.unparsed |= itemChanges.unparsed;
    return this;
   ...
   */
  @JsonAnySetter
  public UpdateAppsDatastoreItemRequestDataAttributes putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    UpdateAppsDatastoreItemRequestDataAttributes updateAppsDatastoreItemRequestDataAttributes =
        (UpdateAppsDatastoreItemRequestDataAttributes) o;
    return Objects.equals(
            this.itemChanges, updateAppsDatastoreItemRequestDataAttributes.itemChanges)
        && Objects.equals(this.itemKey, updateAppsDatastoreItemRequestDataAttributes.itemKey)
        && Objects.equals(
            this.additionalProperties,
            updateAppsDatastoreItemRequestDataAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(itemChanges, itemKey, additionalProperties);
  }
