...
@JsonPropertyOrder({MetaInfo.JSON_PROPERTY_ACCESSIBLE_PROJECTS})
...
public class MetaInfo {
  ...
  public MetaInfo accessibleProjects(List<String> accessibleProjects) {
    this.accessibleProjects = accessibleProjects;
    return this;
  }

  public MetaInfo addAccessibleProjectsItem(String accessibleProjectsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessibleProjects, metaInfo.accessibleProjects);
  }
