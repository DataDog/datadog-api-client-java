...
public class LLMObsDatasetBatchUpdateInsertRecord {
  ...
  /**
   * Optional user-provided identifier for the record. If omitted, the server generates an
   * identifier.
   *
   * @return id
   */
  ...
  public LLMObsDatasetBatchUpdateInsertRecord tagOperations(
  ...
  public boolean equals(Object o) {
    ...
    LLMObsDatasetBatchUpdateInsertRecord llmObsDatasetBatchUpdateInsertRecord =
        (LLMObsDatasetBatchUpdateInsertRecord) o;
    return Objects.equals(this.expectedOutput, llmObsDatasetBatchUpdateInsertRecord.expectedOutput)
        && Objects.equals(this.id, llmObsDatasetBatchUpdateInsertRecord.id)
        && Objects.equals(this.input, llmObsDatasetBatchUpdateInsertRecord.input)
        && Objects.equals(this.metadata, llmObsDatasetBatchUpdateInsertRecord.metadata)
        && Objects.equals(this.tagOperations, llmObsDatasetBatchUpdateInsertRecord.tagOperations)
        && Objects.equals(this.tags, llmObsDatasetBatchUpdateInsertRecord.tags)
        && Objects.equals(
            this.additionalProperties, llmObsDatasetBatchUpdateInsertRecord.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        expectedOutput, id, input, metadata, tagOperations, tags, additionalProperties);
  }
