...
/**
   * <p>The <code>opensearch</code> destination writes logs to an OpenSearch cluster.</p>
...
public class ObservabilityPipelineOpenSearchDestination {
  ...
  private ObservabilityPipelineOpenSearchDestinationType type = ObservabilityPipelineOpenSearchDestinationType.OPENSEARCH;
  ...
  public ObservabilityPipelineOpenSearchDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineOpenSearchDestinationType type) {
        this.id = id;
        this.inputs = inputs;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public ObservabilityPipelineOpenSearchDestination auth(ObservabilityPipelineElasticsearchDestinationAuth auth) {
    this.auth = auth;
  ...
  **/
  ...
  public ObservabilityPipelineOpenSearchDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
  ...
  **/
  ...
  public ObservabilityPipelineOpenSearchDestination dataStream(ObservabilityPipelineOpenSearchDestinationDataStream dataStream) {
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the OpenSearch endpoint URL.</p>
  ...
  **/
  ...
  public ObservabilityPipelineOpenSearchDestination type(ObservabilityPipelineOpenSearchDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. The value should always be <code>opensearch</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineOpenSearchDestination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineOpenSearchDestination observabilityPipelineOpenSearchDestination = (ObservabilityPipelineOpenSearchDestination) o;
    return Objects.equals(this.auth, observabilityPipelineOpenSearchDestination.auth) && Objects.equals(this.buffer, observabilityPipelineOpenSearchDestination.buffer) && Objects.equals(this.bulkIndex, observabilityPipelineOpenSearchDestination.bulkIndex) && Objects.equals(this.dataStream, observabilityPipelineOpenSearchDestination.dataStream) && Objects.equals(this.endpointUrlKey, observabilityPipelineOpenSearchDestination.endpointUrlKey) && Objects.equals(this.id, observabilityPipelineOpenSearchDestination.id) && Objects.equals(this.inputs, observabilityPipelineOpenSearchDestination.inputs) && Objects.equals(this.type, observabilityPipelineOpenSearchDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineOpenSearchDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(auth,buffer,bulkIndex,dataStream,endpointUrlKey,id,inputs,type, additionalProperties);
  }
