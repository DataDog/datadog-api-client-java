...
/**
   * <p>Details of a single entity attribute including its mapping configuration and metadata.</p>
 */
@JsonPropertyOrder({
...
public class GetMappingResponseDataAttributesAttributesItems {
  ...
  /**
   * <p>The attribute identifier as used in the entity data model.</p>
   * @return attribute
  **/
  ...
  /**
   * <p>Human-readable explanation of what the attribute represents.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The human-readable label for the attribute shown in the UI.</p>
   * @return displayName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of group labels used to categorize the attribute.</p>
   * @return groups
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether this attribute is a custom user-defined attribute rather than a built-in one.</p>
   * @return isCustom
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The data type of the attribute (for example, string or number).</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
