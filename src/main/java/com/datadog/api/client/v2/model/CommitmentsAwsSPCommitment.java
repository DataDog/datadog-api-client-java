...
/**
   * <p>AWS Savings Plan commitment details.</p>
 */
@JsonPropertyOrder({
...
public class CommitmentsAwsSPCommitment {
  ...
  public CommitmentsAwsSPCommitment(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SAVINGS_PLAN_TYPE)String savingsPlanType) {
  ...
  **/
  ...
  /**
   * <p>The payment option for the Savings Plan.</p>
