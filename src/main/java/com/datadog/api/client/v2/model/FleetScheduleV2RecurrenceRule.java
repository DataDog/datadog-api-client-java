...
public class FleetScheduleV2RecurrenceRule {
  ...
  /**
   * Days of the week when the schedule triggers. Valid values are "Mon", "Tue", "Wed", "Thu",
   * "Fri", "Sat", "Sun".
   *
   * @return daysOfWeek
   */
  ...
  /**
   * Interval between schedule runs in weeks. 1 means the schedule runs every week on the specified
   * days. Higher values repeat every N weeks.
   *
   * @return interval
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.daysOfWeek, fleetScheduleV2RecurrenceRule.daysOfWeek)
        && Objects.equals(this.interval, fleetScheduleV2RecurrenceRule.interval)
        && Objects.equals(
            this.maintenanceWindowDuration, fleetScheduleV2RecurrenceRule.maintenanceWindowDuration)
        && Objects.equals(
            this.startMaintenanceWindow, fleetScheduleV2RecurrenceRule.startMaintenanceWindow)
        && Objects.equals(this.timezone, fleetScheduleV2RecurrenceRule.timezone)
        && Objects.equals(
            this.additionalProperties, fleetScheduleV2RecurrenceRule.additionalProperties);
  }
