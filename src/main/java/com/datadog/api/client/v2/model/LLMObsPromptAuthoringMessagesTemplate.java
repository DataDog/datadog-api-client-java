...
public class LLMObsPromptAuthoringMessagesTemplate {
  ...
  private List<LLMObsPromptAuthoringItem> messages = new ArrayList<>();
  ...
  public LLMObsPromptAuthoringMessagesTemplate(
      @JsonProperty(required = true, value = JSON_PROPERTY_MESSAGES)
          List<LLMObsPromptAuthoringItem> messages) {
  ...
  public LLMObsPromptAuthoringMessagesTemplate messages(List<LLMObsPromptAuthoringItem> messages) {
    this.messages = messages;
    for (LLMObsPromptAuthoringItem item : messages) {
      this.unparsed |= item.unparsed;
    }
  ...
  public List<LLMObsPromptAuthoringItem> getMessages() {
    return messages;
  }

  public void setMessages(List<LLMObsPromptAuthoringItem> messages) {
    this.messages = messages;
    if (messages != null) {
      for (LLMObsPromptAuthoringItem item : messages) {
        this.unparsed |= item.unparsed;
