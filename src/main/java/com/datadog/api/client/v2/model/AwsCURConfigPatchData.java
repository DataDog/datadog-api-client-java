...
public class AwsCURConfigPatchData {
  ...
  private AwsCURConfigPatchRequestType type = AwsCURConfigPatchRequestType.AWS_CUR_CONFIG_PATCH_REQUEST;

  public AwsCURConfigPatchData() {}

  @JsonCreator
  public AwsCURConfigPatchData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AwsCURConfigPatchRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AwsCURConfigPatchRequestType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, awsCurConfigPatchData.attributes) && Objects.equals(this.type, awsCurConfigPatchData.type) && Objects.equals(this.additionalProperties, awsCurConfigPatchData.additionalProperties);
  }
