...
/** Type discriminator for a <code>frontend</code> display block. */
@JsonSerialize(
    using = LLMObsFrontendContentBlockType.LLMObsFrontendContentBlockTypeSerializer.class)
public class LLMObsFrontendContentBlockType extends ModelEnum<String> {
  ...
  public static class LLMObsFrontendContentBlockTypeSerializer
      extends StdSerializer<LLMObsFrontendContentBlockType> {
    public LLMObsFrontendContentBlockTypeSerializer(Class<LLMObsFrontendContentBlockType> t) {
      super(t);
    }
