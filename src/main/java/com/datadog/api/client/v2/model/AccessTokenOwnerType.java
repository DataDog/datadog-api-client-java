...
public class AccessTokenOwnerType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("users", "service_account"));

  public static final AccessTokenOwnerType USERS = new AccessTokenOwnerType("users");
  public static final AccessTokenOwnerType SERVICE_ACCOUNT = new AccessTokenOwnerType("service_account");
  ...
  public static class AccessTokenOwnerTypeSerializer extends StdSerializer<AccessTokenOwnerType> {
      ...
      @Override
      public void serialize(AccessTokenOwnerType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
