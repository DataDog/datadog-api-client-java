...
/**
   * <p>Attributes of a unified host, combining data from agent and agentless sources.</p>
 */
@JsonPropertyOrder({
...
public class CsmUnifiedHostAttributes {
  ...
  public static final String JSON_PROPERTY_AGENT_CSM_VM_CONTAINERS_ENABLED = "agent_csm_vm_containers_enabled";
  private JsonNullable<Boolean> agentCsmVmContainersEnabled = JsonNullable.<Boolean>undefined();

  public static final String JSON_PROPERTY_AGENT_CSM_VM_HOSTS_ENABLED = "agent_csm_vm_hosts_enabled";
  ...
  public static final String JSON_PROPERTY_AGENTLESS_POSTURE_MANAGEMENT = "agentless_posture_management";
  private JsonNullable<Boolean> agentlessPostureManagement = JsonNullable.<Boolean>undefined();

  public static final String JSON_PROPERTY_AGENTLESS_VULNERABILITY_SCANNING = "agentless_vulnerability_scanning";
  ...
  /**
   * <p>The ID of the cloud account that the host belongs to. Present only when the host was discovered through agentless scanning.</p>
   * @return accountId
  **/
  ...
  /**
   * <p>Whether CSM Vulnerabilities is enabled for containers through the Datadog Agent. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_CSM_VM_CONTAINERS_ENABLED)public void setAgentCsmVmContainersEnabled_JsonNullable(JsonNullable<Boolean> agentCsmVmContainersEnabled) {
  ...
  /**
   * <p>Whether CSM Vulnerabilities is enabled for hosts through the Datadog Agent. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_CSM_VM_HOSTS_ENABLED)public void setAgentCsmVmHostsEnabled_JsonNullable(JsonNullable<Boolean> agentCsmVmHostsEnabled) {
  ...
  /**
   * <p>Whether CSM Threats is enabled for this host through the Datadog Agent. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_CWS_ENABLED)public void setAgentCwsEnabled_JsonNullable(JsonNullable<Boolean> agentCwsEnabled) {
  ...
  /**
   * <p>Whether CSM Misconfigurations is enabled for this host through the Datadog Agent. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_POSTURE_MANAGEMENT)public void setAgentPostureManagement_JsonNullable(JsonNullable<Boolean> agentPostureManagement) {
  ...
  /**
   * <p>The version of the Datadog Agent running on this host.</p>
   * @return agentVersion
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_AGENT_VERSION)public void setAgentVersion_JsonNullable(JsonNullable<String> agentVersion) {
  ...
  /**
   * <p>Whether CSM Misconfigurations is enabled for this host via agentless scanning. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENTLESS_POSTURE_MANAGEMENT)public void setAgentlessPostureManagement_JsonNullable(JsonNullable<Boolean> agentlessPostureManagement) {
  ...
  /**
   * <p>Whether CSM Vulnerabilities is enabled for this host via agentless scanning. <code>true</code> if enabled; <code>false</code> if disabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AGENTLESS_VULNERABILITY_SCANNING)public void setAgentlessVulnerabilityScanning_JsonNullable(JsonNullable<Boolean> agentlessVulnerabilityScanning) {
  ...
  /**
   * <p>The cloud provider of a host resource.</p>
  ...
  **/
  ...
  /**
   * <p>The name of the Kubernetes cluster the host belongs to, if applicable.</p>
   * @return clusterName
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_CLUSTER_NAME)public void setClusterName_JsonNullable(JsonNullable<String> clusterName) {
  ...
  /**
   * <p>The Datadog Agent key associated with this host. Present only for agent-sourced hosts.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATADOG_AGENT_KEY)public void setDatadogAgentKey_JsonNullable(JsonNullable<String> datadogAgentKey) {
  ...
  /**
   * <p>The list of environment tags associated with this host.</p>
   * @return env
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_ENV)public void setEnv_JsonNullable(JsonNullable<List<String>> env) {
    this.env = env;
  }
  ...
  /**
   * <p>The internal Datadog host identifier. Present only for agent-sourced hosts.</p>
   * @return hostId
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_HOST_ID)public void setHostId_JsonNullable(JsonNullable<Long> hostId) {
    this.hostId = hostId;
  }
  ...
  /**
   * <p>The tool used to install the Datadog Agent on this host.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INSTALL_METHOD_TOOL)public void setInstallMethodTool_JsonNullable(JsonNullable<String> installMethodTool) {
  ...
  /**
   * <p>The operating system of the host. Present only for agent-sourced hosts.</p>
   * @return os
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_OS)public void setOs_JsonNullable(JsonNullable<String> os) {
    this.os = os;
  }
  ...
  **/
  ...
  /**
   * <p>The source of a unified host entry, indicating whether it was discovered via agent, agentless scanning, or both.</p>
   * @return source
  **/
