...
/** Pagination links. */
@JsonPropertyOrder({
  ContainersResponseLinks.JSON_PROPERTY_FIRST,
  ContainersResponseLinks.JSON_PROPERTY_LAST,
  ContainersResponseLinks.JSON_PROPERTY_NEXT,
  ContainersResponseLinks.JSON_PROPERTY_PREV,
  ContainersResponseLinks.JSON_PROPERTY_SELF
})
...
public class ContainersResponseLinks {
  ...
  public ContainersResponseLinks first(String first) {
    this.first = first;
    return this;
  }
  ...
  public ContainersResponseLinks last(String last) {
  ...
  public ContainersResponseLinks next(String next) {
  ...
  public ContainersResponseLinks prev(String prev) {
  ...
  public ContainersResponseLinks self(String self) {
    this.self = self;
    return this;
  }
   ...
   * @return ContainersResponseLinks
   */
  @JsonAnySetter
  public ContainersResponseLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ContainersResponseLinks containersResponseLinks = (ContainersResponseLinks) o;
    return Objects.equals(this.first, containersResponseLinks.first)
        && Objects.equals(this.last, containersResponseLinks.last)
        && Objects.equals(this.next, containersResponseLinks.next)
        && Objects.equals(this.prev, containersResponseLinks.prev)
        && Objects.equals(this.self, containersResponseLinks.self)
