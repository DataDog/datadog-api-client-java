...
public class ObservabilityPipelineEnrichmentTableReferenceTable {
  ...
  /**
   * <p>Name of the environment variable or secret that holds the Datadog application key used to access the reference table.</p>
   * @return appKeyKey
  **/
  ...
  /**
   * <p>List of column names to include from the reference table. If not provided, all columns are included.</p>
   * @return columns
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Path to the field in the log event to match against the reference table.</p>
   * @return keyField
  **/
  ...
  /**
   * <p>The unique identifier of the reference table.</p>
   * @return tableId
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineEnrichmentTableReferenceTable observabilityPipelineEnrichmentTableReferenceTable = (ObservabilityPipelineEnrichmentTableReferenceTable) o;
    return Objects.equals(this.appKeyKey, observabilityPipelineEnrichmentTableReferenceTable.appKeyKey) && Objects.equals(this.columns, observabilityPipelineEnrichmentTableReferenceTable.columns) && Objects.equals(this.keyField, observabilityPipelineEnrichmentTableReferenceTable.keyField) && Objects.equals(this.tableId, observabilityPipelineEnrichmentTableReferenceTable.tableId) && Objects.equals(this.additionalProperties, observabilityPipelineEnrichmentTableReferenceTable.additionalProperties);
  }
