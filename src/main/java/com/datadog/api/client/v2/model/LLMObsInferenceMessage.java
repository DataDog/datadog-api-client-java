...
/**
   * <p>A single message in an LLM inference conversation.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsInferenceMessage {
  ...
  /**
   * <p>Plain text content of the message.</p>
   * @return content
  **/
  ...
  /**
   * <p>List of structured content blocks in a message.</p>
   * @return contents
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>List of tool calls in a message.</p>
   * @return toolCalls
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of tool results in a message.</p>
   * @return toolResults
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, llmObsInferenceMessage.content) && Objects.equals(this.contents, llmObsInferenceMessage.contents) && Objects.equals(this.id, llmObsInferenceMessage.id) && Objects.equals(this.role, llmObsInferenceMessage.role) && Objects.equals(this.toolCalls, llmObsInferenceMessage.toolCalls) && Objects.equals(this.toolResults, llmObsInferenceMessage.toolResults) && Objects.equals(this.additionalProperties, llmObsInferenceMessage.additionalProperties);
  }
