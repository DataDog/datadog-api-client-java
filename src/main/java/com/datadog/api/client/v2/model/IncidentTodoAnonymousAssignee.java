...
public class IncidentTodoAnonymousAssignee {
  ...
  public IncidentTodoAnonymousAssignee(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SOURCE)IncidentTodoAnonymousAssigneeSource source) {
        this.icon = icon;
        this.id = id;
        this.name = name;
        this.source = source;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.icon, incidentTodoAnonymousAssignee.icon) && Objects.equals(this.id, incidentTodoAnonymousAssignee.id) && Objects.equals(this.name, incidentTodoAnonymousAssignee.name) && Objects.equals(this.source, incidentTodoAnonymousAssignee.source) && Objects.equals(this.additionalProperties, incidentTodoAnonymousAssignee.additionalProperties);
  }
