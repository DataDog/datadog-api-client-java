...
public class Metadata {
  ...
  /**
   * <p>Number of entities included in the response.</p>
   * @return count
  **/
  ...
  /**
   * <p>The token that identifies the request.</p>
   * @return token
  **/
  ...
  /**
   * <p>Total number of entities across all pages.</p>
   * @return total
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, metadata.count) && Objects.equals(this.token, metadata.token) && Objects.equals(this.total, metadata.total) && Objects.equals(this.additionalProperties, metadata.additionalProperties);
  }
