...
public class ObservabilityPipelineMtlsServerTls {
  ...
  /**
   * <p>Path to the Certificate Authority (CA) file used to validate connecting clients' TLS certificates.</p>
   * @return caFile
  **/
  ...
  /**
   * <p>Path to the TLS server certificate file used to used to identify the pipeline component to connecting clients.</p>
   * @return crtFile
  **/
  ...
  /**
   * <p>Path to the private key file associated with the TLS server certificate.</p>
   * @return keyFile
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, requires client connections to present a valid certificate, enabling mutual TLS authentication.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineMtlsServerTls observabilityPipelineMtlsServerTls = (ObservabilityPipelineMtlsServerTls) o;
    return Objects.equals(this.caFile, observabilityPipelineMtlsServerTls.caFile) && Objects.equals(this.crtFile, observabilityPipelineMtlsServerTls.crtFile) && Objects.equals(this.keyFile, observabilityPipelineMtlsServerTls.keyFile) && Objects.equals(this.keyPassKey, observabilityPipelineMtlsServerTls.keyPassKey) && Objects.equals(this.verifyCertificate, observabilityPipelineMtlsServerTls.verifyCertificate) && Objects.equals(this.additionalProperties, observabilityPipelineMtlsServerTls.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(caFile,crtFile,keyFile,keyPassKey,verifyCertificate, additionalProperties);
  }
