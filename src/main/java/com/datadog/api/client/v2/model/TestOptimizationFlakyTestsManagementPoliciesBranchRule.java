...
public class TestOptimizationFlakyTestsManagementPoliciesBranchRule {
  ...
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule addBranchesItem(String branchesItem) {
  ...
  /**
   * <p>List of branches to which the policy applies.</p>
   * @return branches
  **/
  ...
  /**
   * <p>Whether this branch rule is enabled.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
  ...
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule excludedBranches(List<String> excludedBranches) {
    this.excludedBranches = excludedBranches;
    return this;
  }
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule addExcludedBranchesItem(String excludedBranchesItem) {
  ...
  /**
   * <p>List of branches excluded from the policy.</p>
  ...
  **/
  ...
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule excludedTestServices(List<String> excludedTestServices) {
    this.excludedTestServices = excludedTestServices;
    return this;
  }
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule addExcludedTestServicesItem(String excludedTestServicesItem) {
  ...
  /**
   * <p>List of test services excluded from the policy.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public TestOptimizationFlakyTestsManagementPoliciesBranchRule putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this TestOptimizationFlakyTestsManagementPoliciesBranchRule object is equal to o.
   */
  @Override
