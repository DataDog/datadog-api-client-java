...
/**
   * <p>Google Chat space data from a response.</p>
 */
@JsonPropertyOrder({
...
public class GoogleChatAppNamedSpaceResponseData {
  ...
  private GoogleChatAppNamedSpaceType type = GoogleChatAppNamedSpaceType.GOOGLE_CHAT_APP_NAMED_SPACE_TYPE;

  public GoogleChatAppNamedSpaceResponseData attributes(GoogleChatAppNamedSpaceResponseAttributes attributes) {
  ...
  **/
  ...
  /**
   * <p>The ID of the Google Chat space.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Google Chat space resource type.</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    GoogleChatAppNamedSpaceResponseData googleChatAppNamedSpaceResponseData = (GoogleChatAppNamedSpaceResponseData) o;
    return Objects.equals(this.attributes, googleChatAppNamedSpaceResponseData.attributes) && Objects.equals(this.id, googleChatAppNamedSpaceResponseData.id) && Objects.equals(this.type, googleChatAppNamedSpaceResponseData.type) && Objects.equals(this.additionalProperties, googleChatAppNamedSpaceResponseData.additionalProperties);
  }
