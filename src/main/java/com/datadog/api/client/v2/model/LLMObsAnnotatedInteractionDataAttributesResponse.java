...
/**
   * <p>Attributes containing an annotated interaction and its related events.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsAnnotatedInteractionDataAttributesResponse {
  ...
  @JsonCreator
  public LLMObsAnnotatedInteractionDataAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ANNOTATED_INTERACTION)LLMObsAnnotatedInteractionItem annotatedInteraction,
            @JsonProperty(required=true, value=JSON_PROPERTY_EVENTS)List<LLMObsAnnotatedInteractionEvent> events,
            @JsonProperty(required=true, value=JSON_PROPERTY_INTERACTION_TYPE)LLMObsAnyInteractionType interactionType) {
  ...
  public LLMObsAnnotatedInteractionDataAttributesResponse annotatedInteraction(LLMObsAnnotatedInteractionItem annotatedInteraction) {
    this.annotatedInteraction = annotatedInteraction;
    this.unparsed |= annotatedInteraction.unparsed;
    return this;
  }
  ...
  /**
   * <p>An interaction with its associated annotations.</p>
  ...
  **/
  ...
  public LLMObsAnnotatedInteractionDataAttributesResponse events(List<LLMObsAnnotatedInteractionEvent> events) {
    this.events = events;
    for (LLMObsAnnotatedInteractionEvent item : events) {
      this.unparsed |= item.unparsed;
    }
  ...
  public LLMObsAnnotatedInteractionDataAttributesResponse addEventsItem(LLMObsAnnotatedInteractionEvent eventsItem) {
  ...
  /**
   * <p>Page of events associated with the annotated interaction.</p>
   * @return events
  **/
  ...
  public LLMObsAnnotatedInteractionDataAttributesResponse interactionType(LLMObsAnyInteractionType interactionType) {
    this.interactionType = interactionType;
    this.unparsed |= !interactionType.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Cursor to retrieve the next page of events. Absent when there are no more events.</p>
   * @return nextCursor
  **/
   ...
   */
  @JsonAnySetter
  public LLMObsAnnotatedInteractionDataAttributesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LLMObsAnnotatedInteractionDataAttributesResponse llmObsAnnotatedInteractionDataAttributesResponse = (LLMObsAnnotatedInteractionDataAttributesResponse) o;
    return Objects.equals(this.annotatedInteraction, llmObsAnnotatedInteractionDataAttributesResponse.annotatedInteraction) && Objects.equals(this.events, llmObsAnnotatedInteractionDataAttributesResponse.events) && Objects.equals(this.interactionType, llmObsAnnotatedInteractionDataAttributesResponse.interactionType) && Objects.equals(this.nextCursor, llmObsAnnotatedInteractionDataAttributesResponse.nextCursor) && Objects.equals(this.additionalProperties, llmObsAnnotatedInteractionDataAttributesResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(annotatedInteraction,events,interactionType,nextCursor, additionalProperties);
  }
