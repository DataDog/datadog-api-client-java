...
public class SourcemapFileDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("sourcemap_files"));

  public static final SourcemapFileDataType SOURCEMAP_FILES =
      new SourcemapFileDataType("sourcemap_files");
  ...
  public static class SourcemapFileDataTypeSerializer extends StdSerializer<SourcemapFileDataType> {
    ...
    public void serialize(
        SourcemapFileDataType value, JsonGenerator jgen, SerializerProvider provider)
