...
@JsonPropertyOrder({UCConfigPairDataAttributes.JSON_PROPERTY_CONFIGS})
...
public class UCConfigPairDataAttributes {
  ...
  public UCConfigPairDataAttributes addConfigsItem(
      UCConfigPairDataAttributesConfigsItems configsItem) {
  ...
  /**
   * The <code>attributes</code> <code>configs</code>.
   *
   * @return configs
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configs, ucConfigPairDataAttributes.configs)
        && Objects.equals(
            this.additionalProperties, ucConfigPairDataAttributes.additionalProperties);
  }
