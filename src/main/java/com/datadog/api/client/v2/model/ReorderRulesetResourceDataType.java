 ...
 */
@JsonSerialize(using = ReorderRulesetResourceDataType.ReorderRulesetResourceDataTypeSerializer.class)
public class ReorderRulesetResourceDataType extends ModelEnum<String> {
  ...
  public static final ReorderRulesetResourceDataType RULESET = new ReorderRulesetResourceDataType("ruleset");
  ...
  public static class ReorderRulesetResourceDataTypeSerializer extends StdSerializer<ReorderRulesetResourceDataType> {
      ...
      @Override
      public void serialize(ReorderRulesetResourceDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
