...
/**
   * <p>The new security filter properties.</p>
 */
@JsonPropertyOrder({
...
public class SecurityFilterUpdateData {
  ...
  @JsonCreator
  public SecurityFilterUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SecurityFilterUpdateAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The type of the resource. The value should always be <code>security_filters</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public SecurityFilterUpdateData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, securityFilterUpdateData.attributes) && Objects.equals(this.type, securityFilterUpdateData.type) && Objects.equals(this.additionalProperties, securityFilterUpdateData.additionalProperties);
  }
