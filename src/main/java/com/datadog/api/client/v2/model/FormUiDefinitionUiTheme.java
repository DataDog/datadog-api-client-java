...
public class FormUiDefinitionUiTheme {
  ...
  public FormUiDefinitionUiTheme primaryColor(FormUiDefinitionUiThemePrimaryColor primaryColor) {
    this.primaryColor = primaryColor;
    this.unparsed |= !primaryColor.isValid();
    return this;
  }
   ...
   * @return FormUiDefinitionUiTheme
   */
  @JsonAnySetter
  ...
  @Override
  public int hashCode() {
    return Objects.hash(primaryColor, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FormUiDefinitionUiTheme {\n");
