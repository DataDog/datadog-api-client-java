...
public class FleetDeploymentHostsPage {
  ...
  /**
   * <p>Current page index (zero-based).</p>
   * @return currentPage
  **/
  ...
  /**
   * <p>Number of hosts returned per page.</p>
   * @return pageSize
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Total number of hosts in this deployment.</p>
   * @return totalHosts
  **/
      @jakarta.annotation.Nullable
