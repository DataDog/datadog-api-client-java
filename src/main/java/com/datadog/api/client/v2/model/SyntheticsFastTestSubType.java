...
public class SyntheticsFastTestSubType extends ModelEnum<String> {
  ...
  public static final SyntheticsFastTestSubType WEBSOCKET =
      new SyntheticsFastTestSubType("websocket");

  SyntheticsFastTestSubType(String value) {
    super(value, allowedValues);
  }

  public static class SyntheticsFastTestSubTypeSerializer
      extends StdSerializer<SyntheticsFastTestSubType> {
    ...
    public void serialize(
        SyntheticsFastTestSubType value, JsonGenerator jgen, SerializerProvider provider)
