...
public class PatchComponentRequestDataAttributes {
  ...
  /**
   * The position of the component. If the component belongs to a group, the position is relative to
  ...
  public boolean equals(Object o) {
    ...
    PatchComponentRequestDataAttributes patchComponentRequestDataAttributes =
        (PatchComponentRequestDataAttributes) o;
    return Objects.equals(this.name, patchComponentRequestDataAttributes.name)
        && Objects.equals(this.position, patchComponentRequestDataAttributes.position)
        && Objects.equals(
            this.additionalProperties, patchComponentRequestDataAttributes.additionalProperties);
  }
