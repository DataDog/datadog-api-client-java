...
@JsonDeserialize(using = SecurityMonitoringRuleConvertPayload.SecurityMonitoringRuleConvertPayloadDeserializer.class)
@JsonSerialize(using = SecurityMonitoringRuleConvertPayload.SecurityMonitoringRuleConvertPayloadSerializer.class)
public class SecurityMonitoringRuleConvertPayload extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SecurityMonitoringRuleConvertPayload.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class SecurityMonitoringRuleConvertPayloadSerializer extends StdSerializer<SecurityMonitoringRuleConvertPayload> {
        public SecurityMonitoringRuleConvertPayloadSerializer(Class<SecurityMonitoringRuleConvertPayload> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(SecurityMonitoringRuleConvertPayload value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class SecurityMonitoringRuleConvertPayloadDeserializer extends StdDeserializer<SecurityMonitoringRuleConvertPayload> {
        ...
        @Override
        public SecurityMonitoringRuleConvertPayload deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public SecurityMonitoringRuleConvertPayload getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SecurityMonitoringRuleConvertPayload cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(SecurityMonitoringRuleConvertPayload.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * SecurityMonitoringStandardRulePayload, SecurityMonitoringSignalRulePayload
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be SecurityMonitoringStandardRulePayload, SecurityMonitoringSignalRulePayload");
    }
     ...
     * SecurityMonitoringStandardRulePayload, SecurityMonitoringSignalRulePayload
     *
     * @return The actual instance (SecurityMonitoringStandardRulePayload, SecurityMonitoringSignalRulePayload)
     */
    @Override
