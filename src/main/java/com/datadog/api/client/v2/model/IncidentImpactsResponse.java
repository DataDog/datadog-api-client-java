...
public class IncidentImpactsResponse {
  ...
  public IncidentImpactsResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          List<IncidentImpactResponseData> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, incidentImpactsResponse.data)
        && Objects.equals(this.included, incidentImpactsResponse.included)
        && Objects.equals(this.additionalProperties, incidentImpactsResponse.additionalProperties);
  }
