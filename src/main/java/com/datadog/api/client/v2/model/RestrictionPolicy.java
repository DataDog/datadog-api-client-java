...
public class RestrictionPolicy {
  ...
  @JsonCreator
  public RestrictionPolicy(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RestrictionPolicyAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The identifier, always equivalent to the value specified in the <code>resource_id</code> path parameter.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, restrictionPolicy.attributes) && Objects.equals(this.id, restrictionPolicy.id) && Objects.equals(this.type, restrictionPolicy.type) && Objects.equals(this.additionalProperties, restrictionPolicy.additionalProperties);
  }
