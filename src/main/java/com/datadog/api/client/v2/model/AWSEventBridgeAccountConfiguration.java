...
/**
   * <p>The EventBridge configuration for one AWS account.</p>
 */
@JsonPropertyOrder({
...
public class AWSEventBridgeAccountConfiguration {
  ...
  public static final String JSON_PROPERTY_EVENT_HUBS = "event_hubs";
  ...
  **/
  ...
  /**
   * <p>Array of AWS event sources associated with this account.</p>
   * @return eventHubs
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Array of tags (in the form <code>key:value</code>) which are added to all hosts
   * and metrics reporting through the main AWS integration.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
