...
public class ProductAnalyticsJourneyFunnelStep {
  ...
  public ProductAnalyticsJourneyFunnelStep(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_GROUPS)
  ...
  public ProductAnalyticsJourneyFunnelStep elapsedTimeToNextStep(
      ProductAnalyticsElapsedTime elapsedTimeToNextStep) {
    this.elapsedTimeToNextStep = elapsedTimeToNextStep;
    this.unparsed |= elapsedTimeToNextStep.unparsed;
    return this;
  ...
  public ProductAnalyticsJourneyFunnelStep groups(
      List<ProductAnalyticsJourneyFunnelStepGroup> groups) {
    this.groups = groups;
    for (ProductAnalyticsJourneyFunnelStepGroup item : groups) {
      this.unparsed |= item.unparsed;
  ...
  public ProductAnalyticsJourneyFunnelStep addGroupsItem(
      ProductAnalyticsJourneyFunnelStepGroup groupsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsJourneyFunnelStep productAnalyticsJourneyFunnelStep =
        (ProductAnalyticsJourneyFunnelStep) o;
    return Objects.equals(
            this.elapsedTimeToNextStep, productAnalyticsJourneyFunnelStep.elapsedTimeToNextStep)
        && Objects.equals(this.groups, productAnalyticsJourneyFunnelStep.groups)
        && Objects.equals(this.label, productAnalyticsJourneyFunnelStep.label)
        && Objects.equals(this.unit, productAnalyticsJourneyFunnelStep.unit)
        && Objects.equals(this.value, productAnalyticsJourneyFunnelStep.value)
        && Objects.equals(
            this.additionalProperties, productAnalyticsJourneyFunnelStep.additionalProperties);
  }
