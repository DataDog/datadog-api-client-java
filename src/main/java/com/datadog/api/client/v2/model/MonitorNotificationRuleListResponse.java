...
/**
   * <p>Response for retrieving all monitor notification rules.</p>
 */
@JsonPropertyOrder({
...
public class MonitorNotificationRuleListResponse {
  ...
  /**
   * <p>A list of monitor notification rules.</p>
   * @return data
  **/
  ...
  public MonitorNotificationRuleListResponse included(List<MonitorNotificationRuleResponseIncludedItem> included) {
  ...
  public MonitorNotificationRuleListResponse addIncludedItem(MonitorNotificationRuleResponseIncludedItem includedItem) {
  ...
  /**
   * <p>Array of objects related to the monitor notification rules.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    MonitorNotificationRuleListResponse monitorNotificationRuleListResponse = (MonitorNotificationRuleListResponse) o;
    return Objects.equals(this.data, monitorNotificationRuleListResponse.data) && Objects.equals(this.included, monitorNotificationRuleListResponse.included) && Objects.equals(this.additionalProperties, monitorNotificationRuleListResponse.additionalProperties);
  }
