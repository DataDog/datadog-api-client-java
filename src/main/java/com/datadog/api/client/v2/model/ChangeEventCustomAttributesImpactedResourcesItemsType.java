 ...
 */
@JsonSerialize(using = ChangeEventCustomAttributesImpactedResourcesItemsType.ChangeEventCustomAttributesImpactedResourcesItemsTypeSerializer.class)
public class ChangeEventCustomAttributesImpactedResourcesItemsType extends ModelEnum<String> {
  ...
  public static class ChangeEventCustomAttributesImpactedResourcesItemsTypeSerializer extends StdSerializer<ChangeEventCustomAttributesImpactedResourcesItemsType> {
      public ChangeEventCustomAttributesImpactedResourcesItemsTypeSerializer(Class<ChangeEventCustomAttributesImpactedResourcesItemsType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(ChangeEventCustomAttributesImpactedResourcesItemsType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
