...
public class OutputSchemaParametersType extends ModelEnum<String> {
  ...
  public static final OutputSchemaParametersType BOOLEAN =
      new OutputSchemaParametersType("BOOLEAN");
  public static final OutputSchemaParametersType OBJECT = new OutputSchemaParametersType("OBJECT");
  public static final OutputSchemaParametersType ARRAY_STRING =
      new OutputSchemaParametersType("ARRAY_STRING");
  public static final OutputSchemaParametersType ARRAY_NUMBER =
      new OutputSchemaParametersType("ARRAY_NUMBER");
  public static final OutputSchemaParametersType ARRAY_BOOLEAN =
      new OutputSchemaParametersType("ARRAY_BOOLEAN");
  public static final OutputSchemaParametersType ARRAY_OBJECT =
      new OutputSchemaParametersType("ARRAY_OBJECT");

  OutputSchemaParametersType(String value) {
    super(value, allowedValues);
  }

  public static class OutputSchemaParametersTypeSerializer
      extends StdSerializer<OutputSchemaParametersType> {
    ...
    public void serialize(
        OutputSchemaParametersType value, JsonGenerator jgen, SerializerProvider provider)
