...
public class EscalationPolicyCreateRequestData {
  ...
  private EscalationPolicyCreateRequestDataType type =
  ...
  public EscalationPolicyCreateRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          EscalationPolicyCreateRequestDataAttributes attributes,
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          EscalationPolicyCreateRequestDataType type) {
  ...
  public EscalationPolicyCreateRequestData attributes(
      EscalationPolicyCreateRequestDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  ...
  public EscalationPolicyCreateRequestData relationships(
      EscalationPolicyCreateRequestDataRelationships relationships) {
  ...
  /**
   * Represents relationships in an escalation policy creation request, including references to
   * teams.
   *
  ...
  public boolean equals(Object o) {
    ...
    EscalationPolicyCreateRequestData escalationPolicyCreateRequestData =
        (EscalationPolicyCreateRequestData) o;
    return Objects.equals(this.attributes, escalationPolicyCreateRequestData.attributes)
        && Objects.equals(this.relationships, escalationPolicyCreateRequestData.relationships)
        && Objects.equals(this.type, escalationPolicyCreateRequestData.type)
        && Objects.equals(
            this.additionalProperties, escalationPolicyCreateRequestData.additionalProperties);
  }
