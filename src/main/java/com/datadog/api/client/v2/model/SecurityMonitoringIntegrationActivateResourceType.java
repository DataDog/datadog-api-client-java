...
public class SecurityMonitoringIntegrationActivateResourceType extends ModelEnum<String> {
  ...
  @JsonCreator
  public static SecurityMonitoringIntegrationActivateResourceType fromValue(String value) {
    return new SecurityMonitoringIntegrationActivateResourceType(value);
  }
}
