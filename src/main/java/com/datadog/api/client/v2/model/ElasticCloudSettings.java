...
@JsonPropertyOrder({
  ElasticCloudSettings.JSON_PROPERTY_CAT_ALLOCATION_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_DETAILED_INDEX_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_INDEX_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_PENDING_TASK_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_PSHARD_GRACEFUL_TO_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_PSHARD_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_SLM_STATS_ENABLED,
  ElasticCloudSettings.JSON_PROPERTY_TAGS,
  ElasticCloudSettings.JSON_PROPERTY_URL
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ElasticCloudSettings {
  ...
  public ElasticCloudSettings catAllocationStatsEnabled(Boolean catAllocationStatsEnabled) {
  ...
  public ElasticCloudSettings detailedIndexStatsEnabled(Boolean detailedIndexStatsEnabled) {
  ...
  public ElasticCloudSettings indexStatsEnabled(Boolean indexStatsEnabled) {
  ...
  public ElasticCloudSettings pendingTaskStatsEnabled(Boolean pendingTaskStatsEnabled) {
  ...
  public ElasticCloudSettings pshardGracefulToEnabled(Boolean pshardGracefulToEnabled) {
  ...
  public ElasticCloudSettings pshardStatsEnabled(Boolean pshardStatsEnabled) {
  ...
  public ElasticCloudSettings slmStatsEnabled(Boolean slmStatsEnabled) {
  ...
  public ElasticCloudSettings tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public ElasticCloudSettings addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public ElasticCloudSettings url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return ElasticCloudSettings
   */
  @JsonAnySetter
  public ElasticCloudSettings putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this ElasticCloudSettings object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ElasticCloudSettings elasticCloudSettings = (ElasticCloudSettings) o;
    return Objects.equals(
            this.catAllocationStatsEnabled, elasticCloudSettings.catAllocationStatsEnabled)
        && Objects.equals(
            this.detailedIndexStatsEnabled, elasticCloudSettings.detailedIndexStatsEnabled)
        && Objects.equals(this.indexStatsEnabled, elasticCloudSettings.indexStatsEnabled)
        && Objects.equals(
            this.pendingTaskStatsEnabled, elasticCloudSettings.pendingTaskStatsEnabled)
        && Objects.equals(
            this.pshardGracefulToEnabled, elasticCloudSettings.pshardGracefulToEnabled)
        && Objects.equals(this.pshardStatsEnabled, elasticCloudSettings.pshardStatsEnabled)
        && Objects.equals(this.slmStatsEnabled, elasticCloudSettings.slmStatsEnabled)
        && Objects.equals(this.tags, elasticCloudSettings.tags)
        && Objects.equals(this.url, elasticCloudSettings.url)
        && Objects.equals(this.additionalProperties, elasticCloudSettings.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ElasticCloudSettings {\n");
