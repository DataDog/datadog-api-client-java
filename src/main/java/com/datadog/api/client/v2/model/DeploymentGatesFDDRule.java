...
/**
   * <p>A faulty deployment detection rule to evaluate as part of a deployment gate evaluation.</p>
 */
@JsonPropertyOrder({
...
public class DeploymentGatesFDDRule {
  ...
  /**
   * <p>Rule-level dry run. When enabled, the rule is evaluated normally but it always returns <code>pass</code>. The real result is visible in the Datadog UI.</p>
   * @return dryRun
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dryRun, deploymentGatesFddRule.dryRun) && Objects.equals(this.name, deploymentGatesFddRule.name) && Objects.equals(this.options, deploymentGatesFddRule.options) && Objects.equals(this.type, deploymentGatesFddRule.type) && Objects.equals(this.additionalProperties, deploymentGatesFddRule.additionalProperties);
  }
