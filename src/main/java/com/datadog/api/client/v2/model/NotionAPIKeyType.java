...
public class NotionAPIKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("NotionAPIKey"));
  ...
  public static class NotionAPIKeyTypeSerializer extends StdSerializer<NotionAPIKeyType> {
      ...
      @Override
      public void serialize(NotionAPIKeyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
