...
/**
   * <p>Response containing a single AWS cloud authentication persona mapping</p>
 */
@JsonPropertyOrder({
  AWSCloudAuthPersonaMappingResponse.JSON_PROPERTY_DATA
})
...
public class AWSCloudAuthPersonaMappingResponse {
  ...
  @JsonCreator
  public AWSCloudAuthPersonaMappingResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AWSCloudAuthPersonaMappingDataResponse data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSCloudAuthPersonaMappingResponse awsCloudAuthPersonaMappingResponse = (AWSCloudAuthPersonaMappingResponse) o;
    return Objects.equals(this.data, awsCloudAuthPersonaMappingResponse.data) && Objects.equals(this.additionalProperties, awsCloudAuthPersonaMappingResponse.additionalProperties);
  }
