...
/**
   * <p>Attributes for updating a SAML configuration.</p>
 */
@JsonPropertyOrder({
...
public class SAMLConfigurationUpdateAttributes {
  ...
  **/
   ...
   * (just-in-time provisioning). A default role is required to enable just-in-time provisioning.</p>
   * @return jitDomains
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SAMLConfigurationUpdateAttributes samlConfigurationUpdateAttributes = (SAMLConfigurationUpdateAttributes) o;
    return Objects.equals(this.idpInitiated, samlConfigurationUpdateAttributes.idpInitiated) && Objects.equals(this.jitDomains, samlConfigurationUpdateAttributes.jitDomains) && Objects.equals(this.additionalProperties, samlConfigurationUpdateAttributes.additionalProperties);
  }
