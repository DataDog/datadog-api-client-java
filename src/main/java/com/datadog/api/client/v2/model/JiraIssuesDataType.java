...
public class JiraIssuesDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("jira_issues"));
  ...
  public static class JiraIssuesDataTypeSerializer extends StdSerializer<JiraIssuesDataType> {
      ...
      @Override
      public void serialize(JiraIssuesDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
