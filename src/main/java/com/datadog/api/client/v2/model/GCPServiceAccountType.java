...
public class GCPServiceAccountType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("gcp_service_account"));

  public static final GCPServiceAccountType GCP_SERVICE_ACCOUNT = new GCPServiceAccountType("gcp_service_account");
  ...
  public static class GCPServiceAccountTypeSerializer extends StdSerializer<GCPServiceAccountType> {
      public GCPServiceAccountTypeSerializer(Class<GCPServiceAccountType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(GCPServiceAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
