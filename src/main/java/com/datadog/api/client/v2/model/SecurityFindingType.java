...
public class SecurityFindingType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("vulnerability", "configuration_finding"));

  public static final SecurityFindingType VULNERABILITY = new SecurityFindingType("vulnerability");
  public static final SecurityFindingType CONFIGURATION_FINDING =
      new SecurityFindingType("configuration_finding");
