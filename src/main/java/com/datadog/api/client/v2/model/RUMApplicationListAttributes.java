...
public class RUMApplicationListAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(applicationId,createdAt,createdByHandle,hash,isActive,name,orgId,productScales,type,updatedAt,updatedByHandle, additionalProperties);
  }
