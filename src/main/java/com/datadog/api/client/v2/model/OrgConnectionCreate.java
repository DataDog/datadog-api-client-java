...
/**
   * <p>Org connection creation data.</p>
 */
@JsonPropertyOrder({
...
public class OrgConnectionCreate {
  ...
  @JsonCreator
  public OrgConnectionCreate(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)OrgConnectionCreateAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)OrgConnectionCreateRelationships relationships,
  ...
  **/
  ...
  /**
   * <p>Relationships for org connection creation.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, orgConnectionCreate.attributes) && Objects.equals(this.relationships, orgConnectionCreate.relationships) && Objects.equals(this.type, orgConnectionCreate.type) && Objects.equals(this.additionalProperties, orgConnectionCreate.additionalProperties);
  }
