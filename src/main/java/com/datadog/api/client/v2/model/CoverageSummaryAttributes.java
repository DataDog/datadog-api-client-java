...
public class CoverageSummaryAttributes {
  ...
  private JsonNullable<Map<String, CoverageSummaryCodeownerStats>> codeowners =
      JsonNullable.<Map<String, CoverageSummaryCodeownerStats>>undefined();
  ...
  private JsonNullable<Map<String, CoverageSummaryServiceStats>> services =
      JsonNullable.<Map<String, CoverageSummaryServiceStats>>undefined();
  ...
  public CoverageSummaryAttributes codeowners(
      Map<String, CoverageSummaryCodeownerStats> codeowners) {
    this.codeowners = JsonNullable.<Map<String, CoverageSummaryCodeownerStats>>of(codeowners);
    return this;
  }

  public CoverageSummaryAttributes putCodeownersItem(
      String key, CoverageSummaryCodeownerStats codeownersItem) {
    if (this.codeowners == null || !this.codeowners.isPresent()) {
      this.codeowners =
          JsonNullable.<Map<String, CoverageSummaryCodeownerStats>>of(new HashMap<>());
    }
    try {
  ...
  @JsonProperty(JSON_PROPERTY_CODEOWNERS)
  public void setCodeowners_JsonNullable(
      JsonNullable<Map<String, CoverageSummaryCodeownerStats>> codeowners) {
  ...
  @JsonProperty(JSON_PROPERTY_PATCH_COVERAGE)
  public void setPatchCoverage_JsonNullable(JsonNullable<Double> patchCoverage) {
  ...
  public CoverageSummaryAttributes putServicesItem(
      String key, CoverageSummaryServiceStats servicesItem) {
  ...
  @JsonProperty(JSON_PROPERTY_SERVICES)
  public void setServices_JsonNullable(
      JsonNullable<Map<String, CoverageSummaryServiceStats>> services) {
  ...
  @JsonProperty(JSON_PROPERTY_TOTAL_COVERAGE)
  public void setTotalCoverage_JsonNullable(JsonNullable<Double> totalCoverage) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.codeowners, coverageSummaryAttributes.codeowners)
        && Objects.equals(this.evaluatedFlagsCount, coverageSummaryAttributes.evaluatedFlagsCount)
        && Objects.equals(
            this.evaluatedReportsCount, coverageSummaryAttributes.evaluatedReportsCount)
        && Objects.equals(this.patchCoverage, coverageSummaryAttributes.patchCoverage)
        && Objects.equals(this.services, coverageSummaryAttributes.services)
        && Objects.equals(this.totalCoverage, coverageSummaryAttributes.totalCoverage)
        && Objects.equals(
            this.additionalProperties, coverageSummaryAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    evaluatedFlagsCount: ")
        .append(toIndentedString(evaluatedFlagsCount))
        .append("\n");
    sb.append("    evaluatedReportsCount: ")
        .append(toIndentedString(evaluatedReportsCount))
        .append("\n");
