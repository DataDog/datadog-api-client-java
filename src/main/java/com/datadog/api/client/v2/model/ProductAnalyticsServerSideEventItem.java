...
public class ProductAnalyticsServerSideEventItem {
  ...
  private ProductAnalyticsAccount account;

  public static final String JSON_PROPERTY_APPLICATION = "application";
  private ProductAnalyticsApplication application;

  public static final String JSON_PROPERTY_EVENT = "event";
  private ProductAnalyticsEvent event;

  public static final String JSON_PROPERTY_SESSION = "session";
  private ProductAnalyticsSession session;

  public static final String JSON_PROPERTY_TYPE = "type";
  private ProductAnalyticsEventType type;

  public static final String JSON_PROPERTY_USR = "usr";
  private ProductAnalyticsUser usr;
  ...
  public ProductAnalyticsServerSideEventItem(
      @JsonProperty(required = true, value = JSON_PROPERTY_APPLICATION)
          ProductAnalyticsApplication application,
      @JsonProperty(required = true, value = JSON_PROPERTY_EVENT) ProductAnalyticsEvent event,
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE) ProductAnalyticsEventType type) {
  ...
  public ProductAnalyticsServerSideEventItem account(ProductAnalyticsAccount account) {
  ...
  public ProductAnalyticsAccount getAccount() {
    return account;
  }

  public void setAccount(ProductAnalyticsAccount account) {
    this.account = account;
  }

  public ProductAnalyticsServerSideEventItem application(ProductAnalyticsApplication application) {
    this.application = application;
    this.unparsed |= application.unparsed;
    return this;
  }
  ...
  public ProductAnalyticsApplication getApplication() {
    return application;
  }

  public void setApplication(ProductAnalyticsApplication application) {
    this.application = application;
  }

  public ProductAnalyticsServerSideEventItem event(ProductAnalyticsEvent event) {
    this.event = event;
    this.unparsed |= event.unparsed;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public ProductAnalyticsEvent getEvent() {
    return event;
  }

  public void setEvent(ProductAnalyticsEvent event) {
    this.event = event;
  }

  public ProductAnalyticsServerSideEventItem session(ProductAnalyticsSession session) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ProductAnalyticsSession getSession() {
    return session;
  }

  public void setSession(ProductAnalyticsSession session) {
    this.session = session;
  }

  public ProductAnalyticsServerSideEventItem type(ProductAnalyticsEventType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public ProductAnalyticsEventType getType() {
    return type;
  }

  public void setType(ProductAnalyticsEventType type) {
    if (!type.isValid()) {
      this.unparsed = true;
    }
    this.type = type;
  ...
  public ProductAnalyticsServerSideEventItem usr(ProductAnalyticsUser usr) {
    this.usr = usr;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public ProductAnalyticsUser getUsr() {
    return usr;
  }

  public void setUsr(ProductAnalyticsUser usr) {
    this.usr = usr;
  }
