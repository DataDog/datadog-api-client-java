...
public class EventCreateRequestType extends ModelEnum<String> {
  ...
  public static class EventCreateRequestTypeSerializer extends StdSerializer<EventCreateRequestType> {
      public EventCreateRequestTypeSerializer(Class<EventCreateRequestType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(EventCreateRequestType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
