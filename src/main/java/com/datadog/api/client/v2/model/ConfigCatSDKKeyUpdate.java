...
public class ConfigCatSDKKeyUpdate {
  ...
  /**
   * The <code>ConfigCatSDKKeyUpdate</code> <code>api_password</code>.
   *
   * @return apiPassword
   */
  ...
  /**
   * The <code>ConfigCatSDKKeyUpdate</code> <code>api_username</code>.
   *
   * @return apiUsername
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>ConfigCatSDKKeyUpdate</code> <code>sdk_key</code>.
   *
   * @return sdkKey
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiPassword, configCatSdkKeyUpdate.apiPassword)
        && Objects.equals(this.apiUsername, configCatSdkKeyUpdate.apiUsername)
        && Objects.equals(this.sdkKey, configCatSdkKeyUpdate.sdkKey)
        && Objects.equals(this.type, configCatSdkKeyUpdate.type)
        && Objects.equals(this.additionalProperties, configCatSdkKeyUpdate.additionalProperties);
  }
