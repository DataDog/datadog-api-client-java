...
/**
   * <p>The RUM rate limit configuration object.</p>
 */
@JsonPropertyOrder({
...
public class RumRateLimitConfigData {
  ...
  @JsonCreator
  public RumRateLimitConfigData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RumRateLimitConfigAttributes attributes,
  ...
  /**
   * <p>The RUM rate limit configuration properties.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The identifier of the scope the rate limit configuration applies to.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, rumRateLimitConfigData.attributes) && Objects.equals(this.id, rumRateLimitConfigData.id) && Objects.equals(this.type, rumRateLimitConfigData.type) && Objects.equals(this.additionalProperties, rumRateLimitConfigData.additionalProperties);
  }
