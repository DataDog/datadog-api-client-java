...
/**
   * <p>Attributes of an Agent Observability prompt registry entry.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsPromptDataAttributes {
  ...
  public LLMObsPromptDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SOURCE)LLMObsPromptResponseSource source) {
  ...
  /**
   * <p>UUID of the user who authored the prompt.</p>
   * @return author
  **/
  ...
  /**
   * <p>Timestamp when the prompt was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Source that created the prompt, such as <code>ui-registry</code>, <code>sdk-registry</code>, or <code>sdk-instrumentation</code>.</p>
   * @return createdFrom
  **/
  ...
  /**
   * <p>Datasets observed in runs associated with this prompt.</p>
   * @return datasets
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Source prompt from which this prompt was extracted, when applicable.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the prompt is a registry entry (as opposed to a code-discovered prompt).</p>
   * @return inRegistry
  **/
  ...
  /**
   * <p>Timestamp of the most recent observed run of this prompt.</p>
   * @return lastSeenAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp when the most recent version of the prompt was created.</p>
  ...
  **/
  ...
  /**
   * <p>ML applications observed running this prompt.</p>
   * @return mlApps
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of versions of the prompt.</p>
   * @return numVersions
  **/
  ...
  **/
  ...
  /**
   * <p>Whether the prompt was created from the registry or discovered from observed LLM calls.</p>
   * @return source
  **/
  ...
  /**
   * <p>Tags observed on runs of this prompt.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.author, llmObsPromptDataAttributes.author) && Objects.equals(this.createdAt, llmObsPromptDataAttributes.createdAt) && Objects.equals(this.createdFrom, llmObsPromptDataAttributes.createdFrom) && Objects.equals(this.datasets, llmObsPromptDataAttributes.datasets) && Objects.equals(this.description, llmObsPromptDataAttributes.description) && Objects.equals(this.extractedFrom, llmObsPromptDataAttributes.extractedFrom) && Objects.equals(this.inRegistry, llmObsPromptDataAttributes.inRegistry) && Objects.equals(this.lastSeenAt, llmObsPromptDataAttributes.lastSeenAt) && Objects.equals(this.lastVersionCreatedAt, llmObsPromptDataAttributes.lastVersionCreatedAt) && Objects.equals(this.mlApp, llmObsPromptDataAttributes.mlApp) && Objects.equals(this.mlApps, llmObsPromptDataAttributes.mlApps) && Objects.equals(this.numVersions, llmObsPromptDataAttributes.numVersions) && Objects.equals(this.promptId, llmObsPromptDataAttributes.promptId) && Objects.equals(this.source, llmObsPromptDataAttributes.source) && Objects.equals(this.tags, llmObsPromptDataAttributes.tags) && Objects.equals(this.title, llmObsPromptDataAttributes.title) && Objects.equals(this.additionalProperties, llmObsPromptDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(author,createdAt,createdFrom,datasets,description,extractedFrom,inRegistry,lastSeenAt,lastVersionCreatedAt,mlApp,mlApps,numVersions,promptId,source,tags,title, additionalProperties);
  }
