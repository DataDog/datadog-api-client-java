...
/** The definition of <code>GetMultipleRulesetsResponseDataAttributesRulesetsItems</code> object. */
@JsonPropertyOrder({
...
public class GetMultipleRulesetsResponseDataAttributesRulesetsItems {
  ...
  /**
   * The definition of <code>GetMultipleRulesetsResponseDataAttributesRulesetsItemsData</code>
   * object.
   *
   * @return data
   */
  ...
  /**
   * The <code>items</code> <code>rules</code>.
   *
   * @return rules
   */
  @jakarta.annotation.Nullable
