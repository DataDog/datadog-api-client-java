...
public class PatchDegradationUpdateRequestData {
  ...
  private PatchDegradationUpdateRequestDataType type = PatchDegradationUpdateRequestDataType.DEGRADATION_UPDATES;

  public PatchDegradationUpdateRequestData() {}

  @JsonCreator
  public PatchDegradationUpdateRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)PatchDegradationUpdateRequestDataType type) {
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public PatchDegradationUpdateRequestData attributes(PatchDegradationUpdateRequestDataAttributes attributes) {
  ...
  **/
  ...
  /**
   * <p>The ID of the degradation update to edit.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PatchDegradationUpdateRequestData patchDegradationUpdateRequestData = (PatchDegradationUpdateRequestData) o;
    return Objects.equals(this.attributes, patchDegradationUpdateRequestData.attributes) && Objects.equals(this.id, patchDegradationUpdateRequestData.id) && Objects.equals(this.type, patchDegradationUpdateRequestData.type) && Objects.equals(this.additionalProperties, patchDegradationUpdateRequestData.additionalProperties);
  }
