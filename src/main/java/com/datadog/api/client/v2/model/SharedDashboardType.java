...
public class SharedDashboardType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("shared_dashboard"));

  public static final SharedDashboardType SHARED_DASHBOARD = new SharedDashboardType("shared_dashboard");
  ...
  public static class SharedDashboardTypeSerializer extends StdSerializer<SharedDashboardType> {
      ...
      @Override
      public void serialize(SharedDashboardType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
