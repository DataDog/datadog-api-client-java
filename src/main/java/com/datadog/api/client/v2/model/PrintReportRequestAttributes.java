...
public class PrintReportRequestAttributes {
  ...
  /**
   * <p>The start of an absolute time range, as a Unix timestamp in milliseconds.
   * Required when <code>timeframe</code> is omitted.</p>
   * @return fromTs
  **/
  ...
  /**
   * <p>The identifier of the dashboard or integration dashboard to render.</p>
   * @return resourceId
  **/
  ...
  **/
  ...
  /**
   * <p>A relative time window (for example <code>1w</code> or <code>calendar_month</code>). Mutually
   * exclusive with <code>from_ts</code> and <code>to_ts</code>.</p>
   * @return timeframe
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The IANA time zone identifier used to evaluate the time window.</p>
   * @return timezone
  **/
  ...
  /**
   * <p>The end of an absolute time range, as a Unix timestamp in milliseconds.
   * Required when <code>timeframe</code> is omitted.</p>
   * @return toTs
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fromTs, printReportRequestAttributes.fromTs) && Objects.equals(this.resourceId, printReportRequestAttributes.resourceId) && Objects.equals(this.resourceType, printReportRequestAttributes.resourceType) && Objects.equals(this.templateVariables, printReportRequestAttributes.templateVariables) && Objects.equals(this.timeframe, printReportRequestAttributes.timeframe) && Objects.equals(this.timezone, printReportRequestAttributes.timezone) && Objects.equals(this.toTs, printReportRequestAttributes.toTs) && Objects.equals(this.additionalProperties, printReportRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(fromTs,resourceId,resourceType,templateVariables,timeframe,timezone,toTs, additionalProperties);
  }
