 ...
 */
@JsonPropertyOrder({
  AccountFiltersPatchRequestAttributes.JSON_PROPERTY_ACCOUNT_FILTERS
})
...
public class AccountFiltersPatchRequestAttributes {
  ...
  @JsonCreator
  public AccountFiltersPatchRequestAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ACCOUNT_FILTERS)AccountFilteringConfig accountFilters) {
        this.accountFilters = accountFilters;
        this.unparsed |= accountFilters.unparsed;
  }
  public AccountFiltersPatchRequestAttributes accountFilters(AccountFilteringConfig accountFilters) {
    this.accountFilters = accountFilters;
    this.unparsed |= accountFilters.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AccountFiltersPatchRequestAttributes accountFiltersPatchRequestAttributes = (AccountFiltersPatchRequestAttributes) o;
    return Objects.equals(this.accountFilters, accountFiltersPatchRequestAttributes.accountFilters) && Objects.equals(this.additionalProperties, accountFiltersPatchRequestAttributes.additionalProperties);
  }
