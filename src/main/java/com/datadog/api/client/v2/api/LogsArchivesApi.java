 ...
 *
 * See {@link #addReadRoleToArchiveWithHttpInfo}.
 *
 ...
 * Grant role to an archive.
 *
 * See {@link #addReadRoleToArchiveWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @param body  (required)
 ...
 */
  public CompletableFuture<Void>addReadRoleToArchiveAsync(String archiveId, RelationshipToRole body) {
    return addReadRoleToArchiveWithHttpInfoAsync(archiveId, body).thenApply(response -> {
  ...
  /**
   * <p>Adds a read role to an archive. (<a href="https://docs.datadoghq.com/api/v2/roles/">Roles API</a>)</p>
   *
   * @param archiveId The ID of the archive. (required)
   * @param body  (required)
  ...
  public ApiResponse<Void> addReadRoleToArchiveWithHttpInfo(String archiveId, RelationshipToRole body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.addReadRoleToArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> addReadRoleToArchiveWithHttpInfoAsync(String archiveId, RelationshipToRole body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.addReadRoleToArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 * Create an archive.
 *
 * See {@link #createLogsArchiveWithHttpInfo}.
 *
 ...
 * Create an archive.
 *
 * See {@link #createLogsArchiveWithHttpInfoAsync}.
 *
 * @param body The definition of the new archive. (required)
 ...
 */
  public CompletableFuture<LogsArchive>createLogsArchiveAsync(LogsArchiveCreateRequest body) {
    return createLogsArchiveWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Create an archive in your organization.</p>
   *
   * @param body The definition of the new archive. (required)
  ...
  public ApiResponse<LogsArchive> createLogsArchiveWithHttpInfo(LogsArchiveCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.createLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchive>> createLogsArchiveWithHttpInfoAsync(LogsArchiveCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.createLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchive>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }

  /**
 * Delete an archive.
 *
 * See {@link #deleteLogsArchiveWithHttpInfo}.
 *
 * @param archiveId The ID of the archive. (required)
 * @throws ApiException if fails to make API call
 */
 ...
 * Delete an archive.
 *
 * See {@link #deleteLogsArchiveWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteLogsArchiveAsync(String archiveId) {
    return deleteLogsArchiveWithHttpInfoAsync(archiveId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete a given archive from your organization.</p>
   *
   * @param archiveId The ID of the archive. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteLogsArchiveWithHttpInfo(String archiveId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.deleteLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteLogsArchiveWithHttpInfoAsync(String archiveId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.deleteLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Get an archive.
 *
 * See {@link #getLogsArchiveWithHttpInfo}.
 *
 * @param archiveId The ID of the archive. (required)
 * @return LogsArchive
 * @throws ApiException if fails to make API call
 ...
 * Get an archive.
 *
 * See {@link #getLogsArchiveWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @return CompletableFuture&lt;LogsArchive&gt;
 */
  public CompletableFuture<LogsArchive>getLogsArchiveAsync(String archiveId) {
    return getLogsArchiveWithHttpInfoAsync(archiveId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get a specific archive from your organization.</p>
   *
   * @param archiveId The ID of the archive. (required)
   * @return ApiResponse&lt;LogsArchive&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<LogsArchive> getLogsArchiveWithHttpInfo(String archiveId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.getLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchive>> getLogsArchiveWithHttpInfoAsync(String archiveId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.getLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchive>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }

  /**
 * Get archive order.
 *
 * See {@link #getLogsArchiveOrderWithHttpInfo}.
 *
 ...
 * Get archive order.
 *
 * See {@link #getLogsArchiveOrderWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;LogsArchiveOrder&gt;
 */
  public CompletableFuture<LogsArchiveOrder>getLogsArchiveOrderAsync() {
    return getLogsArchiveOrderWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get the current order of your archives.
   * This endpoint takes no JSON arguments.</p>
   *
  ...
  public ApiResponse<LogsArchiveOrder> getLogsArchiveOrderWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.getLogsArchiveOrder", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchiveOrder>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchiveOrder>> getLogsArchiveOrderWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.getLogsArchiveOrder", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchiveOrder>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchiveOrder>() {});
  }

  /**
 * List read roles for an archive.
 *
 * See {@link #listArchiveReadRolesWithHttpInfo}.
 *
 * @param archiveId The ID of the archive. (required)
 ...
 * List read roles for an archive.
 *
 * See {@link #listArchiveReadRolesWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @return CompletableFuture&lt;RolesResponse&gt;
 */
  public CompletableFuture<RolesResponse>listArchiveReadRolesAsync(String archiveId) {
    return listArchiveReadRolesWithHttpInfoAsync(archiveId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns all read roles a given archive is restricted to.</p>
   *
   * @param archiveId The ID of the archive. (required)
  ...
  public ApiResponse<RolesResponse> listArchiveReadRolesWithHttpInfo(String archiveId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.listArchiveReadRoles", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<RolesResponse>> listArchiveReadRolesWithHttpInfoAsync(String archiveId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.listArchiveReadRoles", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RolesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Get all archives.
 *
 * See {@link #listLogsArchivesWithHttpInfo}.
 *
 * @return LogsArchives
 * @throws ApiException if fails to make API call
 */
 ...
 * Get all archives.
 *
 * See {@link #listLogsArchivesWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;LogsArchives&gt;
 */
  public CompletableFuture<LogsArchives>listLogsArchivesAsync() {
    return listLogsArchivesWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get the list of configured logs archives with their definitions.</p>
   *
  ...
  public ApiResponse<LogsArchives> listLogsArchivesWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.listLogsArchives", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchives>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchives>> listLogsArchivesWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.listLogsArchives", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchives>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchives>() {});
  }

  /**
 * Revoke role from an archive.
 *
 * See {@link #removeRoleFromArchiveWithHttpInfo}.
 *
 * @param archiveId The ID of the archive. (required)
 * @param body  (required)
 * @throws ApiException if fails to make API call
 ...
 * Revoke role from an archive.
 *
 * See {@link #removeRoleFromArchiveWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @param body  (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>removeRoleFromArchiveAsync(String archiveId, RelationshipToRole body) {
    return removeRoleFromArchiveWithHttpInfoAsync(archiveId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes a role from an archive. (<a href="https://docs.datadoghq.com/api/v2/roles/">Roles API</a>)</p>
   *
   * @param archiveId The ID of the archive. (required)
   * @param body  (required)
   * @return ApiResponse&lt;Void&gt;
  ...
  public ApiResponse<Void> removeRoleFromArchiveWithHttpInfo(String archiveId, RelationshipToRole body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.removeRoleFromArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> removeRoleFromArchiveWithHttpInfoAsync(String archiveId, RelationshipToRole body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.removeRoleFromArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Update an archive.
 *
 * See {@link #updateLogsArchiveWithHttpInfo}.
 *
 * @param archiveId The ID of the archive. (required)
 ...
 * Update an archive.
 *
 * See {@link #updateLogsArchiveWithHttpInfoAsync}.
 *
 * @param archiveId The ID of the archive. (required)
 * @param body New definition of the archive. (required)
 * @return CompletableFuture&lt;LogsArchive&gt;
 */
  public CompletableFuture<LogsArchive>updateLogsArchiveAsync(String archiveId, LogsArchiveCreateRequest body) {
    return updateLogsArchiveWithHttpInfoAsync(archiveId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update a given archive configuration.</p>
   * <p><strong>Note</strong>: Using this method updates your archive configuration by <strong>replacing</strong>
  ...
  public ApiResponse<LogsArchive> updateLogsArchiveWithHttpInfo(String archiveId, LogsArchiveCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.updateLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchive>> updateLogsArchiveWithHttpInfoAsync(String archiveId, LogsArchiveCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.updateLogsArchive", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchive>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchive>() {});
  }

  /**
 * Update archive order.
 *
 * See {@link #updateLogsArchiveOrderWithHttpInfo}.
 *
 ...
 * Update archive order.
 *
 * See {@link #updateLogsArchiveOrderWithHttpInfoAsync}.
 *
 * @param body An object containing the new ordered list of archive IDs. (required)
 * @return CompletableFuture&lt;LogsArchiveOrder&gt;
 */
  public CompletableFuture<LogsArchiveOrder>updateLogsArchiveOrderAsync(LogsArchiveOrder body) {
    return updateLogsArchiveOrderWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update the order of your archives. Since logs are processed sequentially, reordering an archive may change
   * the structure and content of the data processed by other archives.</p>
   * <p><strong>Note</strong>: Using the <code>PUT</code> method updates your archive's order by replacing the current order
   * with the new one.</p>
   *
   * @param body An object containing the new ordered list of archive IDs. (required)
   * @return ApiResponse&lt;LogsArchiveOrder&gt;
  ...
  public ApiResponse<LogsArchiveOrder> updateLogsArchiveOrderWithHttpInfo(LogsArchiveOrder body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.LogsArchivesApi.updateLogsArchiveOrder", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchiveOrder>() {});
  }
  ...
  public CompletableFuture<ApiResponse<LogsArchiveOrder>> updateLogsArchiveOrderWithHttpInfoAsync(LogsArchiveOrder body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.LogsArchivesApi.updateLogsArchiveOrder", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<LogsArchiveOrder>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<LogsArchiveOrder>() {});
  }
}