...
/**
   * <p>Packet loss percentage assertion for a Network Path test.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsNetworkAssertionPacketLossPercentage {
  ...
  private SyntheticsNetworkAssertionPacketLossPercentageType type = SyntheticsNetworkAssertionPacketLossPercentageType.PACKET_LOSS_PERCENTAGE;
  ...
  public SyntheticsNetworkAssertionPacketLossPercentage(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SyntheticsNetworkAssertionPacketLossPercentageType type) {
  ...
  **/
  ...
  /**
   * <p>Target value as a percentage (0 to 1).</p>
   * minimum: 0
   * maximum: 1
   * @return target
  **/
  ...
  /**
   * <p>Type of the packet loss percentage assertion.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsNetworkAssertionPacketLossPercentage syntheticsNetworkAssertionPacketLossPercentage = (SyntheticsNetworkAssertionPacketLossPercentage) o;
