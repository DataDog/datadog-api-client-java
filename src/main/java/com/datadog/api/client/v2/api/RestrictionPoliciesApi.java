...
public class RestrictionPoliciesApi {
   ...
   *     dashboard</code>, <code>canvas</code>, <code>integration-service</code>, <code>
   *     integration-webhook</code>, <code>notebook</code>, <code>powerpack</code>, <code>
   *     reference-table</code>, <code>security-rule</code>, <code>slo</code>, <code>
   *     synthetics-global-variable</code>, <code>synthetics-test</code>, <code>
   *     synthetics-private-location</code>, <code>monitor</code>, <code>workflow</code>, <code>
   *     app-builder-app</code>, <code>connection</code>, <code>connection-group</code>, <code>
   *     rum-application</code>, <code>cross-org-connection</code>, <code>spreadsheet</code>, <code>
   *     on-call-schedule</code>, <code>on-call-escalation-policy</code>, <code>
   *     on-call-team-routing-rules</code>, <code>logs-pipeline</code>, <code>
   *     case-management-project</code>, <code>monitor-notification-rule</code>, <code>status-page
   *     </code>, <code>feature-flag</code>, <code>network-path-config</code>. (required)
   ...
   * dashboard</code> - Dashboard Canvases: <code>canvas</code> - Integration Services: <code>
   * integration-service</code> - Integration Webhooks: <code>integration-webhook</code> -
   * Notebooks: <code>notebook</code> - Powerpacks: <code>powerpack</code> - Reference Tables:
   * <code>reference-table</code> - Security Rules: <code>security-rule</code> - Service Level
   * Objectives: <code>slo</code> - Synthetic Global Variables: <code>synthetics-global-variable
   * </code> - Synthetic Tests: <code>synthetics-test</code> - Synthetic Private Locations: <code>
   * synthetics-private-location</code> - Monitors: <code>monitor</code> - Workflows: <code>workflow
   * </code> - App Builder Apps: <code>app-builder-app</code> - Connections: <code>connection</code>
   * - Connection Groups: <code>connection-group</code> - RUM Applications: <code>rum-application
   * </code> - Cross Org Connections: <code>cross-org-connection</code> - Spreadsheets: <code>
   * spreadsheet</code> - On-Call Schedules: <code>on-call-schedule</code> - On-Call Escalation
   * Policies: <code>on-call-escalation-policy</code> - On-Call Team Routing Rules: <code>
   * on-call-team-routing-rules</code> - Logs Pipelines: <code>logs-pipeline</code> - Case
   * Management Projects: <code>case-management-project</code> - Monitor Notification Rules: <code>
   * monitor-notification-rule</code> - Status Pages: <code>status-page</code> - Feature Flags:
   * <code>feature-flag</code> - Network Path Configs: <code>network-path-config</code>
   *
   * <h3>Supported relations for resources</h3>
   *
   * <p>Resource Type | Supported Relations ----------------------------|--------------------------
   * Dashboards | <code>viewer</code>, <code>editor</code> Dashboard Canvases | <code>viewer</code>,
   * <code>editor</code> Integration Services | <code>viewer</code>, <code>editor</code> Integration
   * Webhooks | <code>viewer</code>, <code>editor</code> Notebooks | <code>viewer</code>, <code>
   ...
   * Cross Org Connections | <code>viewer</code>, <code>editor</code> Spreadsheets | <code>viewer
   * </code>, <code>editor</code> On-Call Schedules | <code>viewer</code>, <code>overrider</code>,
   * <code>editor</code> On-Call Escalation Policies | <code>viewer</code>, <code>editor</code>
   * On-Call Team Routing Rules | <code>viewer</code>, <code>editor</code> Logs Pipelines | <code>
   * viewer</code>, <code>processors_editor</code>, <code>editor</code> Case Management Projects |
   * <code>viewer</code>, <code>contributor</code>, <code>manager</code> Monitor Notification Rules
   * | <code>viewer</code>, <code>editor</code> Status Pages | <code>viewer</code>, <code>responder
   * </code>, <code>manager</code> Feature Flags | <code>viewer</code>, <code>contributor</code>,
   * <code>editor</code> Network Path Configs | <code>viewer</code>, <code>editor</code>
   *
   * @param resourceId Identifier, formatted as <code>type:id</code>. Supported types: <code>
   *     dashboard</code>, <code>canvas</code>, <code>integration-service</code>, <code>
   *     integration-webhook</code>, <code>notebook</code>, <code>powerpack</code>, <code>
