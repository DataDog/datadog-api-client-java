...
public class RestrictionPoliciesApi {
   ...
   * dashboard</code> - Integration Services: <code>integration-service</code> - Integration
   ...
   * Network Path Configs: <code>network-path-config</code>
   *
   ...
   * Feature Flags | <code>viewer</code>, <code>contributor</code>, <code>editor</code> Network Path
   * Configs | <code>viewer</code>, <code>editor</code>
   *
   * @param resourceId Identifier, formatted as <code>type:id</code>. Supported types: <code>
   *     dashboard</code>, <code>integration-service</code>, <code>integration-webhook</code>,
   *     <code>notebook</code>, <code>powerpack</code>, <code>reference-table</code>, <code>
