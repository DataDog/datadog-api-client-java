 ...
 */
   ...
   * - Case Management Projects: <code>case-management-project</code>
   * - Monitor Notification Rules: <code>monitor-notification-rule</code>
   * - Status Pages: <code>status-page</code>
   * - Feature Flags: <code>feature-flag</code>
   * - Network Path Configs: <code>network-path-config</code></p>
   ...
   * Case Management Projects    | <code>viewer</code>, <code>contributor</code>, <code>manager</code>
   * Monitor Notification Rules  | <code>viewer</code>, <code>editor</code>
   * Status Pages                | <code>viewer</code>, <code>responder</code>, <code>manager</code>
   * Feature Flags               | <code>viewer</code>, <code>contributor</code>, <code>editor</code>
   * Network Path Configs        | <code>viewer</code>, <code>editor</code></p>
   *
   * @param resourceId Identifier, formatted as <code>type:id</code>. Supported types: <code>dashboard</code>, <code>integration-service</code>, <code>integration-webhook</code>, <code>notebook</code>, <code>powerpack</code>, <code>reference-table</code>, <code>security-rule</code>, <code>slo</code>, <code>synthetics-global-variable</code>, <code>synthetics-test</code>, <code>synthetics-private-location</code>, <code>monitor</code>, <code>workflow</code>, <code>app-builder-app</code>, <code>connection</code>, <code>connection-group</code>, <code>rum-application</code>, <code>cross-org-connection</code>, <code>spreadsheet</code>, <code>on-call-schedule</code>, <code>on-call-escalation-policy</code>, <code>on-call-team-routing-rules</code>, <code>logs-pipeline</code>, <code>case-management-project</code>, <code>monitor-notification-rule</code>, <code>status-page</code>, <code>feature-flag</code>, <code>network-path-config</code>. (required)
   * @param body Restriction policy payload (required)
   * @param parameters Optional parameters for the request.
