...
/**
   * <p>The sort direction for results.</p>
 */
...
public class OrderDirection extends ModelEnum<String> {
  ...
  public static class OrderDirectionSerializer extends StdSerializer<OrderDirection> {
      ...
      @Override
      public void serialize(OrderDirection value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
