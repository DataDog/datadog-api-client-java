...
/**
   * <p>Response with a list of Opsgenie services.</p>
 */
@JsonPropertyOrder({
  OpsgenieServicesResponse.JSON_PROPERTY_DATA
})
...
public class OpsgenieServicesResponse {
  ...
  @JsonCreator
  public OpsgenieServicesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<OpsgenieServiceResponseData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>An array of Opsgenie services.</p>
   * @return data
  **/
   ...
   */
  @JsonAnySetter
  public OpsgenieServicesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, opsgenieServicesResponse.data) && Objects.equals(this.additionalProperties, opsgenieServicesResponse.additionalProperties);
  }
