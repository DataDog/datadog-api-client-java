...
/**
   * <p>Scorecard outcome for a single entity and rule.</p>
 */
@JsonPropertyOrder({
...
public class UpdateOutcomesAsyncRequestItem {
  ...
  /**
   * <p>The unique reference for an IDP entity.</p>
  ...
  **/
  ...
  /**
   * <p>Any remarks regarding the scorecard rule's evaluation. Supports HTML hyperlinks.</p>
   * @return remarks
  **/
  ...
  **/
  ...
  /**
   * <p>The state of the rule evaluation.</p>
   * @return state
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateOutcomesAsyncRequestItem updateOutcomesAsyncRequestItem = (UpdateOutcomesAsyncRequestItem) o;
    return Objects.equals(this.entityReference, updateOutcomesAsyncRequestItem.entityReference) && Objects.equals(this.remarks, updateOutcomesAsyncRequestItem.remarks) && Objects.equals(this.ruleId, updateOutcomesAsyncRequestItem.ruleId) && Objects.equals(this.state, updateOutcomesAsyncRequestItem.state) && Objects.equals(this.additionalProperties, updateOutcomesAsyncRequestItem.additionalProperties);
  }
