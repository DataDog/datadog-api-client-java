...
/**
   * <p>A dashboard template variable applied when rendering the report.</p>
 */
@JsonPropertyOrder({
...
public class ReportScheduleTemplateVariable {
  ...
  **/
  ...
  /**
   * <p>The selected values for the template variable.</p>
   * @return values
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleTemplateVariable reportScheduleTemplateVariable = (ReportScheduleTemplateVariable) o;
    return Objects.equals(this.name, reportScheduleTemplateVariable.name) && Objects.equals(this.values, reportScheduleTemplateVariable.values) && Objects.equals(this.additionalProperties, reportScheduleTemplateVariable.additionalProperties);
  }
