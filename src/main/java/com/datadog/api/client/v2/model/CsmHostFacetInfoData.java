...
/**
   * <p>The data wrapper for a facet info response.</p>
 */
@JsonPropertyOrder({
...
public class CsmHostFacetInfoData {
  ...
  @JsonCreator
  public CsmHostFacetInfoData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CsmHostFacetInfoAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The identifier of the facet.</p>
   * @return id
  **/
  ...
  /**
   * <p>Metadata for the facet info response.</p>
   * @return meta
  **/
  ...
  /**
   * <p>The JSON:API type for facet info resources. The value should always be <code>facet_info</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, csmHostFacetInfoData.attributes) && Objects.equals(this.id, csmHostFacetInfoData.id) && Objects.equals(this.meta, csmHostFacetInfoData.meta) && Objects.equals(this.type, csmHostFacetInfoData.type) && Objects.equals(this.additionalProperties, csmHostFacetInfoData.additionalProperties);
  }
