...
/**
   * <p>Aggregated high frozen frame rate detection at view level.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedHighFrozenFrameRate {
  ...
  @JsonCreator
  public AggregatedHighFrozenFrameRate(
            @JsonProperty(required=true, value=JSON_PROPERTY_AVG_FROZEN_FRAME_RATE)Double avgFrozenFrameRate,
            @JsonProperty(required=true, value=JSON_PROPERTY_AVG_SEGMENT_DURATION)Long avgSegmentDuration,
            @JsonProperty(required=true, value=JSON_PROPERTY_AVG_TOTAL_FROZEN_DURATION)Long avgTotalFrozenDuration,
  ...
  /**
   * <p>Average frozen frame rate as a fraction of total frames.</p>
  ...
  **/
  ...
  /**
   * <p>Average segment duration in nanoseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Average total frozen duration in nanoseconds.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avgFrozenFrameRate, aggregatedHighFrozenFrameRate.avgFrozenFrameRate) && Objects.equals(this.avgSegmentDuration, aggregatedHighFrozenFrameRate.avgSegmentDuration) && Objects.equals(this.avgTotalFrozenDuration, aggregatedHighFrozenFrameRate.avgTotalFrozenDuration) && Objects.equals(this.fingerprint, aggregatedHighFrozenFrameRate.fingerprint) && Objects.equals(this.impactScore, aggregatedHighFrozenFrameRate.impactScore) && Objects.equals(this.viewOccurrences, aggregatedHighFrozenFrameRate.viewOccurrences) && Objects.equals(this.additionalProperties, aggregatedHighFrozenFrameRate.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(avgFrozenFrameRate,avgSegmentDuration,avgTotalFrozenDuration,fingerprint,impactScore,viewOccurrences, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    avgTotalFrozenDuration: ").append(toIndentedString(avgTotalFrozenDuration)).append("\n");
