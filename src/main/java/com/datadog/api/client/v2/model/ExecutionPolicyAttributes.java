...
public class ExecutionPolicyAttributes {
  ...
  public ExecutionPolicyAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TARGETS)List<ExecutionPolicyTarget> targets,
  ...
  **/
  ...
  /**
   * <p>The date and time the execution policy was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The ID of the user who created the execution policy.</p>
   * @return createdBy
  **/
  ...
  **/
  ...
  /**
   * <p>The date and time the execution policy was last updated.</p>
   * @return updatedAt
  **/
  ...
  /**
   * <p>The ID of the user who last updated the execution policy.</p>
   * @return updatedBy
  **/
  ...
  /**
   * <p>The version of the execution policy. Incremented on every update.</p>
   * maximum: 2147483647
   * @return version
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionPattern, executionPolicyAttributes.actionPattern) && Objects.equals(this.createdAt, executionPolicyAttributes.createdAt) && Objects.equals(this.createdBy, executionPolicyAttributes.createdBy) && Objects.equals(this.effect, executionPolicyAttributes.effect) && Objects.equals(this.name, executionPolicyAttributes.name) && Objects.equals(this.scope, executionPolicyAttributes.scope) && Objects.equals(this.targets, executionPolicyAttributes.targets) && Objects.equals(this.updatedAt, executionPolicyAttributes.updatedAt) && Objects.equals(this.updatedBy, executionPolicyAttributes.updatedBy) && Objects.equals(this.version, executionPolicyAttributes.version) && Objects.equals(this.additionalProperties, executionPolicyAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(actionPattern,createdAt,createdBy,effect,name,scope,targets,updatedAt,updatedBy,version, additionalProperties);
  }
