...
public class CaseAttributes {
  ...
  private JsonNullable<ServiceNowTicket> serviceNowTicket = JsonNullable.<ServiceNowTicket>undefined();
  ...
  **/
  ...
  /**
   * <p>Key-value pairs of case attributes. Each key maps to an array of string values, used for flexible metadata such as labels or tags.</p>
   * @return attributes
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public CaseAttributes putCustomAttributesItem(String key, CustomAttributeValue customAttributesItem) {
  ...
  **/
  ...
  /**
   * <p>Jira issue attached to case</p>
   * @return jiraIssue
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_JIRA_ISSUE)private void setJiraIssue_JsonNullable(JsonNullable<JiraIssue> jiraIssue) {
  ...
  **/
  ...
  /**
   * <p>ServiceNow ticket attached to case</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SERVICE_NOW_TICKET)private void setServiceNowTicket_JsonNullable(JsonNullable<ServiceNowTicket> serviceNowTicket) {
  ...
  **/
  ...
  /**
   * <p>Status of the case. Must be one of the existing statuses for the case's type.</p>
   * @return statusName
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.archivedAt, caseAttributes.archivedAt) && Objects.equals(this.attributes, caseAttributes.attributes) && Objects.equals(this.closedAt, caseAttributes.closedAt) && Objects.equals(this.createdAt, caseAttributes.createdAt) && Objects.equals(this.customAttributes, caseAttributes.customAttributes) && Objects.equals(this.description, caseAttributes.description) && Objects.equals(this.jiraIssue, caseAttributes.jiraIssue) && Objects.equals(this.key, caseAttributes.key) && Objects.equals(this.modifiedAt, caseAttributes.modifiedAt) && Objects.equals(this.priority, caseAttributes.priority) && Objects.equals(this.serviceNowTicket, caseAttributes.serviceNowTicket) && Objects.equals(this.status, caseAttributes.status) && Objects.equals(this.statusGroup, caseAttributes.statusGroup) && Objects.equals(this.statusName, caseAttributes.statusName) && Objects.equals(this.title, caseAttributes.title) && Objects.equals(this.type, caseAttributes.type) && Objects.equals(this.typeId, caseAttributes.typeId) && Objects.equals(this.additionalProperties, caseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(archivedAt,attributes,closedAt,createdAt,customAttributes,description,jiraIssue,key,modifiedAt,priority,serviceNowTicket,status,statusGroup,statusName,title,type,typeId, additionalProperties);
  }
