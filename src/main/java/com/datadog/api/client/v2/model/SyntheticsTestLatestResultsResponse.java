...
/**
   * <p>Response object for a Synthetic test's latest result summaries.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsTestLatestResultsResponse {
  ...
  /**
   * <p>Array of Synthetic test result summaries.</p>
   * @return data
  **/
  ...
  public SyntheticsTestLatestResultsResponse included(List<SyntheticsTestResultIncludedItem> included) {
  ...
  public SyntheticsTestLatestResultsResponse addIncludedItem(SyntheticsTestResultIncludedItem includedItem) {
  ...
  /**
   * <p>Array of included related resources, such as the test definition.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestLatestResultsResponse syntheticsTestLatestResultsResponse = (SyntheticsTestLatestResultsResponse) o;
    return Objects.equals(this.data, syntheticsTestLatestResultsResponse.data) && Objects.equals(this.included, syntheticsTestLatestResultsResponse.included) && Objects.equals(this.additionalProperties, syntheticsTestLatestResultsResponse.additionalProperties);
  }
