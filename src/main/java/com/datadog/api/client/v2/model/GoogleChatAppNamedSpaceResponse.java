...
/**
   * <p>Response with Google Chat space information.</p>
 */
@JsonPropertyOrder({
  GoogleChatAppNamedSpaceResponse.JSON_PROPERTY_DATA
})
...
public class GoogleChatAppNamedSpaceResponse {
  ...
  @JsonCreator
  public GoogleChatAppNamedSpaceResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)GoogleChatAppNamedSpaceResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GoogleChatAppNamedSpaceResponse googleChatAppNamedSpaceResponse = (GoogleChatAppNamedSpaceResponse) o;
    return Objects.equals(this.data, googleChatAppNamedSpaceResponse.data) && Objects.equals(this.additionalProperties, googleChatAppNamedSpaceResponse.additionalProperties);
  }
