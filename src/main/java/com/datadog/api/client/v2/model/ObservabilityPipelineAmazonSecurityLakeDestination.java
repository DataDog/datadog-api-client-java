...
/**
   * <p>The <code>amazon_security_lake</code> destination sends your logs to Amazon Security Lake.</p>
...
public class ObservabilityPipelineAmazonSecurityLakeDestination {
  ...
  private ObservabilityPipelineAmazonSecurityLakeDestinationType type = ObservabilityPipelineAmazonSecurityLakeDestinationType.AMAZON_SECURITY_LAKE;
  ...
  public ObservabilityPipelineAmazonSecurityLakeDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_CUSTOM_SOURCE_NAME)String customSourceName,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_INPUTS)List<String> inputs,
            @JsonProperty(required=true, value=JSON_PROPERTY_REGION)String region,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineAmazonSecurityLakeDestinationType type) {
        this.bucket = bucket;
  ...
  public ObservabilityPipelineAmazonSecurityLakeDestination auth(ObservabilityPipelineAwsAuth auth) {
    this.auth = auth;
  ...
  **/
  ...
  /**
   * <p>Name of the Amazon S3 bucket in Security Lake (3-63 characters).</p>
   * @return bucket
  **/
  ...
  public ObservabilityPipelineAmazonSecurityLakeDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
  ...
  **/
  ...
  public ObservabilityPipelineAmazonSecurityLakeDestination customSourceName(String customSourceName) {
    this.customSourceName = customSourceName;
    return this;
  }

  /**
   * <p>Custom source name for the logs in Security Lake.</p>
  ...
  **/
  ...
  public ObservabilityPipelineAmazonSecurityLakeDestination type(ObservabilityPipelineAmazonSecurityLakeDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. Always <code>amazon_security_lake</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineAmazonSecurityLakeDestination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineAmazonSecurityLakeDestination observabilityPipelineAmazonSecurityLakeDestination = (ObservabilityPipelineAmazonSecurityLakeDestination) o;
    return Objects.equals(this.auth, observabilityPipelineAmazonSecurityLakeDestination.auth) && Objects.equals(this.bucket, observabilityPipelineAmazonSecurityLakeDestination.bucket) && Objects.equals(this.buffer, observabilityPipelineAmazonSecurityLakeDestination.buffer) && Objects.equals(this.customSourceName, observabilityPipelineAmazonSecurityLakeDestination.customSourceName) && Objects.equals(this.id, observabilityPipelineAmazonSecurityLakeDestination.id) && Objects.equals(this.inputs, observabilityPipelineAmazonSecurityLakeDestination.inputs) && Objects.equals(this.region, observabilityPipelineAmazonSecurityLakeDestination.region) && Objects.equals(this.tls, observabilityPipelineAmazonSecurityLakeDestination.tls) && Objects.equals(this.type, observabilityPipelineAmazonSecurityLakeDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineAmazonSecurityLakeDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(auth,bucket,buffer,customSourceName,id,inputs,region,tls,type, additionalProperties);
  }
