...
public class FormVersionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("form_versions"));
  ...
  public static class FormVersionTypeSerializer extends StdSerializer<FormVersionType> {
      ...
      @Override
      public void serialize(FormVersionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
