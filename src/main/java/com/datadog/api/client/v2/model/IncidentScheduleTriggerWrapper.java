...
/**
   * <p>Schema for an incident schedule trigger.</p>
 */
@JsonPropertyOrder({
...
public class IncidentScheduleTriggerWrapper {
  ...
  @JsonCreator
  public IncidentScheduleTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_INCIDENT_SCHEDULE_TRIGGER)IncidentScheduleTrigger incidentScheduleTrigger) {
        this.incidentScheduleTrigger = incidentScheduleTrigger;
        this.unparsed |= incidentScheduleTrigger.unparsed;
  }
  public IncidentScheduleTriggerWrapper incidentScheduleTrigger(IncidentScheduleTrigger incidentScheduleTrigger) {
    this.incidentScheduleTrigger = incidentScheduleTrigger;
    this.unparsed |= incidentScheduleTrigger.unparsed;
    return this;
  }
  ...
  /**
   * <p>Trigger a workflow on a schedule for an incident.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentScheduleTriggerWrapper incidentScheduleTriggerWrapper = (IncidentScheduleTriggerWrapper) o;
    return Objects.equals(this.incidentScheduleTrigger, incidentScheduleTriggerWrapper.incidentScheduleTrigger) && Objects.equals(this.startStepNames, incidentScheduleTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, incidentScheduleTriggerWrapper.additionalProperties);
  }
