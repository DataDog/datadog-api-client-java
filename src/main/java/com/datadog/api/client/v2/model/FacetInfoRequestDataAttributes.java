...
/**
   * <p>Attributes for the facet info request, specifying which facet to query and optional filters to apply.</p>
 */
@JsonPropertyOrder({
...
public class FacetInfoRequestDataAttributes {
  ...
  /**
   * <p>The identifier of the facet attribute to retrieve value information for.</p>
   * @return facetId
  **/
  ...
  /**
   * <p>Maximum number of facet values to return in the response.</p>
   * @return limit
  **/
  ...
  /**
   * <p>Query-based search configuration for filtering the audience context when retrieving facet values.</p>
   * @return search
  **/
  ...
  public FacetInfoRequestDataAttributes termSearch(FacetInfoRequestDataAttributesTermSearch termSearch) {
  ...
  /**
   * <p>Term-level search configuration for filtering facet values by an exact or partial term match.</p>
   * @return termSearch
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    FacetInfoRequestDataAttributes facetInfoRequestDataAttributes = (FacetInfoRequestDataAttributes) o;
    return Objects.equals(this.facetId, facetInfoRequestDataAttributes.facetId) && Objects.equals(this.limit, facetInfoRequestDataAttributes.limit) && Objects.equals(this.search, facetInfoRequestDataAttributes.search) && Objects.equals(this.termSearch, facetInfoRequestDataAttributes.termSearch) && Objects.equals(this.additionalProperties, facetInfoRequestDataAttributes.additionalProperties);
  }
