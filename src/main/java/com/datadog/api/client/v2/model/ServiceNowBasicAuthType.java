...
public class ServiceNowBasicAuthType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ServiceNowBasicAuth"));

  public static final ServiceNowBasicAuthType SERVICENOWBASICAUTH = new ServiceNowBasicAuthType("ServiceNowBasicAuth");
  ...
  public static class ServiceNowBasicAuthTypeSerializer extends StdSerializer<ServiceNowBasicAuthType> {
      ...
      @Override
      public void serialize(ServiceNowBasicAuthType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
