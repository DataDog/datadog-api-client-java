...
/**
   * <p>Response containing a list of scorecards.</p>
 */
@JsonPropertyOrder({
  ListScorecardsResponse.JSON_PROPERTY_DATA
})
...
public class ListScorecardsResponse {
  ...
  @JsonCreator
  public ListScorecardsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<ScorecardListResponseData> data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listScorecardsResponse.data) && Objects.equals(this.additionalProperties, listScorecardsResponse.additionalProperties);
  }
