...
/**
   * <p>Data object to create a change request branch.</p>
 */
@JsonPropertyOrder({
...
public class ChangeRequestBranchCreateData {
  ...
  @JsonCreator
  public ChangeRequestBranchCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ChangeRequestBranchCreateAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ChangeRequestBranchResourceType type) {
  ...
  /**
   * <p>Attributes for creating a change request branch.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, changeRequestBranchCreateData.attributes) && Objects.equals(this.type, changeRequestBranchCreateData.type) && Objects.equals(this.additionalProperties, changeRequestBranchCreateData.additionalProperties);
  }
