...
/**
   * <p>Attributes of a deployment in the v2 API response.</p>
 */
@JsonPropertyOrder({
...
public class FleetDeploymentV2Attributes {
  ...
  **/
  ...
  /**
   * <p>Time the deployment finished as a Unix timestamp. Zero if not yet finished.</p>
   * @return finishedAt
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Time the deployment started as a Unix timestamp. Zero if not yet started.</p>
   * @return startedAt
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Package versions targeted by this deployment.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.author, fleetDeploymentV2Attributes.author) && Objects.equals(this.configOperations, fleetDeploymentV2Attributes.configOperations) && Objects.equals(this.durationSeconds, fleetDeploymentV2Attributes.durationSeconds) && Objects.equals(this.errorSummary, fleetDeploymentV2Attributes.errorSummary) && Objects.equals(this.estimatedFinishedAt, fleetDeploymentV2Attributes.estimatedFinishedAt) && Objects.equals(this.finishedAt, fleetDeploymentV2Attributes.finishedAt) && Objects.equals(this.isScheduled, fleetDeploymentV2Attributes.isScheduled) && Objects.equals(this.query, fleetDeploymentV2Attributes.query) && Objects.equals(this.scheduleId, fleetDeploymentV2Attributes.scheduleId) && Objects.equals(this.startedAt, fleetDeploymentV2Attributes.startedAt) && Objects.equals(this.status, fleetDeploymentV2Attributes.status) && Objects.equals(this.targetVersions, fleetDeploymentV2Attributes.targetVersions) && Objects.equals(this.totalHosts, fleetDeploymentV2Attributes.totalHosts) && Objects.equals(this.updateType, fleetDeploymentV2Attributes.updateType) && Objects.equals(this.additionalProperties, fleetDeploymentV2Attributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(author,configOperations,durationSeconds,errorSummary,estimatedFinishedAt,finishedAt,isScheduled,query,scheduleId,startedAt,status,targetVersions,totalHosts,updateType, additionalProperties);
  }
