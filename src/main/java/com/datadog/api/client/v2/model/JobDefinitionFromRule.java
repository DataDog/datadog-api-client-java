...
public class JobDefinitionFromRule {
  ...
  /**
   * <p>Zero-based index of the rule case to use as the job's signal condition. When omitted, all cases are evaluated. Up to 10 cases are supported, so valid values are 0 to 9.</p>
   * minimum: 0
   * maximum: 9
   * @return caseIndex
  **/
  ...
  **/
  ...
  /**
   * <p>ID of the detection rule used to create the job.</p>
   * @return id
  **/
  ...
  **/
  ...
  /**
   * <p>Notifications sent when the job is completed.</p>
