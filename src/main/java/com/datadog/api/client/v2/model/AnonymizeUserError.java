...
/**
   * <p>Error encountered when anonymizing a specific user.</p>
 */
@JsonPropertyOrder({
...
public class AnonymizeUserError {
  ...
  /**
   * <p>Error message describing why anonymization failed.</p>
   * @return error
  **/
  ...
  /**
   * <p>UUID of the user that failed to be anonymized.</p>
   * @return userId
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, anonymizeUserError.error) && Objects.equals(this.userId, anonymizeUserError.userId) && Objects.equals(this.additionalProperties, anonymizeUserError.additionalProperties);
  }
