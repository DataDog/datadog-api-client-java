...
public class DdsqlTabularQueryResponseData {
  ...
  @JsonCreator
  public DdsqlTabularQueryResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)DdsqlTabularQueryResponseAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)DdsqlTabularQueryResponseType type) {
  ...
  **/
  ...
  /**
   * <p>Stable identifier for the query response resource.</p>
   * @return id
  **/
  ...
  /**
   * <p>JSON:API resource type for a DDSQL tabular query response.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, ddsqlTabularQueryResponseData.attributes) && Objects.equals(this.id, ddsqlTabularQueryResponseData.id) && Objects.equals(this.type, ddsqlTabularQueryResponseData.type) && Objects.equals(this.additionalProperties, ddsqlTabularQueryResponseData.additionalProperties);
  }
