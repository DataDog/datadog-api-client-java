...
public class GlobalOrgAttributes {
  ...
  **/
  ...
  /**
   * <p>The login URL used to switch into the organization, if available.</p>
   * @return redirectUrl
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REDIRECT_URL)public void setRedirectUrl_JsonNullable(JsonNullable<String> redirectUrl) {
  ...
  /**
   * <p>The source region of the organization.</p>
   * @return sourceRegion
  **/
  ...
  /**
   * <p>User information for a global organization association.</p>
   * @return user
  **/
