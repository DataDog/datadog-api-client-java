...
public class IssuesSearchRequestDataAttributes {
  ...
  /**
   * <p>Filter issues by assignee IDs. Multiple values are combined with OR logic.</p>
   * @return assigneeIds
  **/
  ...
  **/
  ...
  public IssuesSearchRequestDataAttributes orderBy(IssuesSearchRequestDataAttributesOrderBy orderBy) {
  ...
  **/
  ...
  public IssuesSearchRequestDataAttributes persona(IssuesSearchRequestDataAttributesPersona persona) {
  ...
  **/
  ...
  /**
   * <p>Search query following the event search syntax.</p>
   * @return query
  **/
  ...
  /**
   * <p>Filter issues by state. Multiple values are combined with OR logic.</p>
   * @return states
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Filter issues by team IDs. Multiple values are combined with OR logic.</p>
   * @return teamIds
  **/
      @jakarta.annotation.Nullable
