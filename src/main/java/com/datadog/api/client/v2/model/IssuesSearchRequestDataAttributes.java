...
@JsonPropertyOrder({
  ...
  IssuesSearchRequestDataAttributes.JSON_PROPERTY_INDEXES,
...
public class IssuesSearchRequestDataAttributes {
  ...
  public IssuesSearchRequestDataAttributes indexes(List<String> indexes) {
    this.indexes = indexes;
    return this;
  }

  public IssuesSearchRequestDataAttributes addIndexesItem(String indexesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, issuesSearchRequestDataAttributes.from)
        && Objects.equals(this.indexes, issuesSearchRequestDataAttributes.indexes)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(from, indexes, persona, query, to, track, additionalProperties);
  }
