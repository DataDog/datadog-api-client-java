...
public class RUMOperationStrongLinkResponseAttributes {
  ...
  public RUMOperationStrongLinkResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)RUMOperationStrongLinkStatus status) {
  ...
  /**
   * <p>The timestamp when the strong link was created.</p>
   * @return createdAt
  **/
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the linked feature.</p>
   * @return featureId
  **/
  ...
  /**
   * <p>The unique identifier of the linked RUM operation.</p>
   * @return operationId
  **/
  ...
  **/
  ...
  /**
   * <p>The timestamp when the strong link was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
