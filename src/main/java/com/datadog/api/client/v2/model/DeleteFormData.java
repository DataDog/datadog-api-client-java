...
/**
   * <p>The data returned when a form is deleted.</p>
 */
@JsonPropertyOrder({
  DeleteFormData.JSON_PROPERTY_ID,
  DeleteFormData.JSON_PROPERTY_TYPE
})
...
public class DeleteFormData {
  ...
  /**
   * <p>The ID of the deleted form.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, deleteFormData.id) && Objects.equals(this.type, deleteFormData.type) && Objects.equals(this.additionalProperties, deleteFormData.additionalProperties);
  }
