...
public class SecurityMonitoringContentPackThreatIntelDetails {
  ...
  public SecurityMonitoringContentPackThreatIntelDetails(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          SecurityMonitoringContentPackThreatIntelDetailsType type) {
  ...
  public SecurityMonitoringContentPackThreatIntelDetails cpActivation(
      SecurityMonitoringContentPackActivation cpActivation) {
    this.cpActivation = cpActivation;
    this.unparsed |= !cpActivation.isValid();
    return this;
  ...
  public SecurityMonitoringContentPackThreatIntelDetails dataLastSeen(
      SecurityMonitoringContentPackTimestampBucket dataLastSeen) {
    this.dataLastSeen = dataLastSeen;
    this.unparsed |= !dataLastSeen.isValid();
    return this;
  ...
  public SecurityMonitoringContentPackThreatIntelDetails integrationInstalledStatus(
      SecurityMonitoringContentPackIntegrationStatus integrationInstalledStatus) {
    this.integrationInstalledStatus = integrationInstalledStatus;
    this.unparsed |= !integrationInstalledStatus.isValid();
    return this;
  ...
  public SecurityMonitoringContentPackThreatIntelDetails type(
      SecurityMonitoringContentPackThreatIntelDetailsType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringContentPackThreatIntelDetails putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.cpActivation, securityMonitoringContentPackThreatIntelDetails.cpActivation)
        && Objects.equals(
            this.dataLastSeen, securityMonitoringContentPackThreatIntelDetails.dataLastSeen)
        && Objects.equals(
            this.integrationInstalledStatus,
            securityMonitoringContentPackThreatIntelDetails.integrationInstalledStatus)
        && Objects.equals(this.type, securityMonitoringContentPackThreatIntelDetails.type)
        && Objects.equals(
            this.additionalProperties,
            securityMonitoringContentPackThreatIntelDetails.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        cpActivation, dataLastSeen, integrationInstalledStatus, type, additionalProperties);
  }
