...
/**
   * <p>A condition that must be met to trigger the notification rule.</p>
 */
@JsonPropertyOrder({
...
public class IncidentNotificationRuleConditionsItems {
  ...
  /**
   * <p>The incident field to evaluate</p>
   * @return field
  **/
  ...
  /**
   * <p>The value(s) to compare against. Multiple values are <code>ORed</code> together.</p>
   * @return values
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentNotificationRuleConditionsItems incidentNotificationRuleConditionsItems = (IncidentNotificationRuleConditionsItems) o;
    return Objects.equals(this.field, incidentNotificationRuleConditionsItems.field) && Objects.equals(this.values, incidentNotificationRuleConditionsItems.values) && Objects.equals(this.additionalProperties, incidentNotificationRuleConditionsItems.additionalProperties);
  }
