...
public class AWSAccountCreateRequest {
  ...
  private AWSAccountCreate data;

  public AWSAccountCreateRequest() {}

  @JsonCreator
  public AWSAccountCreateRequest(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) AWSAccountCreate data) {
    this.data = data;
    this.unparsed |= data.unparsed;
  }

  public AWSAccountCreateRequest data(AWSAccountCreate data) {
    this.data = data;
    this.unparsed |= data.unparsed;
    return this;
  }
  ...
  public AWSAccountCreate getData() {
    return data;
  }

  public void setData(AWSAccountCreate data) {
    this.data = data;
  }
