...
/**
   * <p>Relationships of a Jira issue template</p>
 */
@JsonPropertyOrder({
  JiraIssueTemplateDataRelationships.JSON_PROPERTY_JIRA_ACCOUNT
})
...
public class JiraIssueTemplateDataRelationships {
  ...
  @JsonCreator
  public JiraIssueTemplateDataRelationships(
            @JsonProperty(required=true, value=JSON_PROPERTY_JIRA_ACCOUNT)JiraAccountRelationship jiraAccount) {
  ...
  /**
   * <p>Relationship to a Jira account</p>
   * @return jiraAccount
  **/
  ...
  public boolean equals(Object o) {
    ...
    JiraIssueTemplateDataRelationships jiraIssueTemplateDataRelationships = (JiraIssueTemplateDataRelationships) o;
    return Objects.equals(this.jiraAccount, jiraIssueTemplateDataRelationships.jiraAccount) && Objects.equals(this.additionalProperties, jiraIssueTemplateDataRelationships.additionalProperties);
  }
