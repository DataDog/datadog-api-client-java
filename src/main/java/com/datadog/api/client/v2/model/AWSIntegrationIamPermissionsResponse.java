...
/**
   * <p>AWS Integration IAM Permissions response body.</p>
 */
@JsonPropertyOrder({
  AWSIntegrationIamPermissionsResponse.JSON_PROPERTY_DATA
})
...
public class AWSIntegrationIamPermissionsResponse {
  ...
  @JsonCreator
  public AWSIntegrationIamPermissionsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AWSIntegrationIamPermissionsResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSIntegrationIamPermissionsResponse awsIntegrationIamPermissionsResponse = (AWSIntegrationIamPermissionsResponse) o;
    return Objects.equals(this.data, awsIntegrationIamPermissionsResponse.data) && Objects.equals(this.additionalProperties, awsIntegrationIamPermissionsResponse.additionalProperties);
  }
