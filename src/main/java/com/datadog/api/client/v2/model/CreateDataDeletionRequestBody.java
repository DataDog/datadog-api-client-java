...
/**
   * <p>Object needed to create a data deletion request.</p>
 */
@JsonPropertyOrder({
  CreateDataDeletionRequestBody.JSON_PROPERTY_DATA
})
...
public class CreateDataDeletionRequestBody {
  ...
  @JsonCreator
  public CreateDataDeletionRequestBody(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)CreateDataDeletionRequestBodyData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createDataDeletionRequestBody.data) && Objects.equals(this.additionalProperties, createDataDeletionRequestBody.additionalProperties);
  }
