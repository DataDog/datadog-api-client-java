...
/**
   * <p>A Product Analytics occurrence-filtered query.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsOccurrenceQuery {
  ...
  @JsonCreator
  public ProductAnalyticsOccurrenceQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)ProductAnalyticsOccurrenceQueryDataSource dataSource,
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH)ProductAnalyticsOccurrenceSearch search) {
        this.dataSource = dataSource;
        this.unparsed |= !dataSource.isValid();
        this.search = search;
        this.unparsed |= search.unparsed;
  }
  public ProductAnalyticsOccurrenceQuery dataSource(ProductAnalyticsOccurrenceQueryDataSource dataSource) {
    this.dataSource = dataSource;
    this.unparsed |= !dataSource.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsOccurrenceQuery productAnalyticsOccurrenceQuery = (ProductAnalyticsOccurrenceQuery) o;
    return Objects.equals(this.dataSource, productAnalyticsOccurrenceQuery.dataSource) && Objects.equals(this.search, productAnalyticsOccurrenceQuery.search) && Objects.equals(this.additionalProperties, productAnalyticsOccurrenceQuery.additionalProperties);
  }
