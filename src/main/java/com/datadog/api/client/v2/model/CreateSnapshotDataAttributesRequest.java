...
public class CreateSnapshotDataAttributesRequest {
  ...
  public CreateSnapshotDataAttributesRequest(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_WIDGET_DEFINITION)Map<String, Object> widgetDefinition) {
        this.end = end;
        this.start = start;
  ...
  /**
   * <p>Additional configuration options for snapshot creation.</p>
  ...
  **/
  ...
  /**
   * <p>End of the time window for the snapshot, in milliseconds since Unix epoch.</p>
   * @return end
  **/
  ...
  /**
   * <p>The height of the rendered snapshot in pixels.</p>
   * @return height
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the snapshot requires authentication to view. Authenticated snapshots are scoped to the creating organization.</p>
  ...
  **/
  ...
  /**
   * <p>Start of the time window for the snapshot, in milliseconds since Unix epoch.</p>
   * @return start
  **/
  ...
  **/
  ...
  /**
   * <p>The widget definition to render as a snapshot. Must include a valid <code>type</code> field and non-empty <code>requests</code> array.</p>
  ...
  **/
  ...
  /**
   * <p>The width of the rendered snapshot in pixels.</p>
   * @return width
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    CreateSnapshotDataAttributesRequest createSnapshotDataAttributesRequest = (CreateSnapshotDataAttributesRequest) o;
    return Objects.equals(this.additionalConfig, createSnapshotDataAttributesRequest.additionalConfig) && Objects.equals(this.end, createSnapshotDataAttributesRequest.end) && Objects.equals(this.height, createSnapshotDataAttributesRequest.height) && Objects.equals(this.isAuthenticated, createSnapshotDataAttributesRequest.isAuthenticated) && Objects.equals(this.start, createSnapshotDataAttributesRequest.start) && Objects.equals(this.ttl, createSnapshotDataAttributesRequest.ttl) && Objects.equals(this.widgetDefinition, createSnapshotDataAttributesRequest.widgetDefinition) && Objects.equals(this.width, createSnapshotDataAttributesRequest.width) && Objects.equals(this.additionalProperties, createSnapshotDataAttributesRequest.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(additionalConfig,end,height,isAuthenticated,start,ttl,widgetDefinition,width, additionalProperties);
  }
