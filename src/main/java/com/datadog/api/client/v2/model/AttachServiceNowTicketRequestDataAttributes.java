...
public class AttachServiceNowTicketRequestDataAttributes {
  ...
  @JsonCreator
  public AttachServiceNowTicketRequestDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_SERVICENOW_TICKET_URL)String servicenowTicketUrl) {
        this.servicenowTicketUrl = servicenowTicketUrl;
  }
  public AttachServiceNowTicketRequestDataAttributes servicenowTicketUrl(String servicenowTicketUrl) {
    this.servicenowTicketUrl = servicenowTicketUrl;
    return this;
  }

  /**
   * <p>URL of the ServiceNow incident to attach security findings to. Must be a service-now.com URL pointing to an incident record.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public AttachServiceNowTicketRequestDataAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AttachServiceNowTicketRequestDataAttributes attachServiceNowTicketRequestDataAttributes = (AttachServiceNowTicketRequestDataAttributes) o;
    return Objects.equals(this.servicenowTicketUrl, attachServiceNowTicketRequestDataAttributes.servicenowTicketUrl) && Objects.equals(this.additionalProperties, attachServiceNowTicketRequestDataAttributes.additionalProperties);
  }
