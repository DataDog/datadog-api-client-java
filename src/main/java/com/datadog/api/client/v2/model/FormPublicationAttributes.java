...
public class FormPublicationAttributes {
  ...
  /**
   * <p>The time at which the publication was created.</p>
   * @return createdAt
  **/
  ...
  **/
  ...
  /**
   * <p>The version number that was published.</p>
   * @return formVersion
  **/
  ...
  **/
  ...
  /**
   * <p>The time at which the publication was last modified.</p>
   * @return modifiedAt
  **/
  ...
  /**
   * <p>The ID of the organization that owns this publication.</p>
   * @return orgId
  **/
  ...
  /**
   * <p>The sequential publication number for this form.</p>
   * @return publishSeq
  **/
  ...
  /**
   * <p>The ID of the user who created this publication.</p>
   * @return userId
  **/
  ...
  /**
   * <p>The UUID of the user who created this publication.</p>
   * @return userUuid
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt,formId,formVersion,id,modifiedAt,orgId,publishSeq,userId,userUuid, additionalProperties);
  }
