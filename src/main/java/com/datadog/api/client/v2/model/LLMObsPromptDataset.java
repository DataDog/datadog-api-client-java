...
/**
   * <p>A dataset observed in runs associated with a prompt or prompt version.</p>
 */
@JsonPropertyOrder({
  LLMObsPromptDataset.JSON_PROPERTY_ID,
  LLMObsPromptDataset.JSON_PROPERTY_NAME
})
...
public class LLMObsPromptDataset {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, llmObsPromptDataset.id) && Objects.equals(this.name, llmObsPromptDataset.name) && Objects.equals(this.additionalProperties, llmObsPromptDataset.additionalProperties);
  }
