 ...
 */
@JsonPropertyOrder({
  ApplicationSecurityServicesMetadata.JSON_PROPERTY_NUM_SERVICES_WITH_APPSEC
})
...
public class ApplicationSecurityServicesMetadata {
  ...
  @JsonCreator
  public ApplicationSecurityServicesMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_NUM_SERVICES_WITH_APPSEC)Long numServicesWithAppsec) {
  ...
  /**
   * <p>The number of services with Application Security Management (Threats) enabled.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityServicesMetadata applicationSecurityServicesMetadata = (ApplicationSecurityServicesMetadata) o;
    return Objects.equals(this.numServicesWithAppsec, applicationSecurityServicesMetadata.numServicesWithAppsec) && Objects.equals(this.additionalProperties, applicationSecurityServicesMetadata.additionalProperties);
  }
