...
/**
   * <p>A single monthly budget entry defining the allocated amount and optional tag filters for a specific month.</p>
 */
@JsonPropertyOrder({
...
public class BudgetWithEntriesDataAttributesEntriesItems {
  ...
  **/
  ...
  public BudgetWithEntriesDataAttributesEntriesItems costs(BudgetWithEntriesDataAttributesEntriesItemsCosts costs) {
    this.costs = costs;
  ...
  **/
  ...
  /**
   * <p>The month this budget entry applies to, in YYYYMM format.</p>
   * @return month
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The list of tag filters that scope this budget entry to specific resources.</p>
   * @return tagFilters
  **/
      @jakarta.annotation.Nullable
