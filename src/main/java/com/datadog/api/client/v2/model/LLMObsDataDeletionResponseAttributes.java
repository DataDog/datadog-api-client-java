...
public class LLMObsDataDeletionResponseAttributes {
  ...
  /**
   * <p>Timestamp when the deletion request was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>UUID of the user who created the deletion request.</p>
   * @return createdBy
  **/
  ...
  /**
   * <p>Start of the deletion time range in milliseconds since Unix epoch.</p>
   * @return fromTime
  **/
  ...
  /**
   * <p>ID of the organization that submitted the deletion request.</p>
   * @return orgId
  **/
  ...
  /**
   * <p>Product name for the deletion request.</p>
   * @return product
  **/
  ...
  /**
   * <p>The query string used to select data for deletion.</p>
   * @return query
  **/
  ...
  /**
   * <p>End of the deletion time range in milliseconds since Unix epoch.</p>
   * @return toTime
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsDataDeletionResponseAttributes llmObsDataDeletionResponseAttributes = (LLMObsDataDeletionResponseAttributes) o;
    return Objects.equals(this.createdAt, llmObsDataDeletionResponseAttributes.createdAt) && Objects.equals(this.createdBy, llmObsDataDeletionResponseAttributes.createdBy) && Objects.equals(this.fromTime, llmObsDataDeletionResponseAttributes.fromTime) && Objects.equals(this.orgId, llmObsDataDeletionResponseAttributes.orgId) && Objects.equals(this.product, llmObsDataDeletionResponseAttributes.product) && Objects.equals(this.query, llmObsDataDeletionResponseAttributes.query) && Objects.equals(this.toTime, llmObsDataDeletionResponseAttributes.toTime) && Objects.equals(this.additionalProperties, llmObsDataDeletionResponseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdAt,createdBy,fromTime,orgId,product,query,toTime, additionalProperties);
  }
