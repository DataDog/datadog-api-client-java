...
public class IncidentRuleQueryCondition {
  ...
  /**
   * <p>The normalized query string.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NORMALIZED_QUERY)public void setNormalizedQuery_JsonNullable(JsonNullable<String> normalizedQuery) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RAW_QUERY)public void setRawQuery_JsonNullable(JsonNullable<String> rawQuery) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.normalizedQuery, incidentRuleQueryCondition.normalizedQuery) && Objects.equals(this.rawQuery, incidentRuleQueryCondition.rawQuery) && Objects.equals(this.additionalProperties, incidentRuleQueryCondition.additionalProperties);
  }
