...
public class PlaylistDataAttributesCreatedBy {
  ...
  public boolean equals(Object o) {
    ...
    PlaylistDataAttributesCreatedBy playlistDataAttributesCreatedBy =
        (PlaylistDataAttributesCreatedBy) o;
    return Objects.equals(this.handle, playlistDataAttributesCreatedBy.handle)
        && Objects.equals(this.icon, playlistDataAttributesCreatedBy.icon)
        && Objects.equals(this.id, playlistDataAttributesCreatedBy.id)
        && Objects.equals(this.name, playlistDataAttributesCreatedBy.name)
        && Objects.equals(this.uuid, playlistDataAttributesCreatedBy.uuid)
        && Objects.equals(
            this.additionalProperties, playlistDataAttributesCreatedBy.additionalProperties);
  }
