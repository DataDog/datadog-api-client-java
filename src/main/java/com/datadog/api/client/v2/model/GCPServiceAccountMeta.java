 ...
 */
@JsonPropertyOrder({
  GCPServiceAccountMeta.JSON_PROPERTY_ACCESSIBLE_PROJECTS
})
...
public class GCPServiceAccountMeta {
  ...
  /**
   * <p>The current list of projects accessible from your service account.</p>
  ...
  **/
   ...
   * @return GCPServiceAccountMeta
   */
  @JsonAnySetter
  public GCPServiceAccountMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessibleProjects, gcpServiceAccountMeta.accessibleProjects) && Objects.equals(this.additionalProperties, gcpServiceAccountMeta.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(accessibleProjects, additionalProperties);
  }
