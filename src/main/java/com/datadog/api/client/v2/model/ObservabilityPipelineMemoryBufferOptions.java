...
/**
   * <p>Options for configuring a memory buffer by byte size.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineMemoryBufferOptions {
  ...
  /**
   * <p>Maximum size of the memory buffer.</p>
   * @return maxSize
  **/
  ...
  public ObservabilityPipelineMemoryBufferOptions type(ObservabilityPipelineBufferOptionsMemoryType type) {
    this.type = type;
  ...
  **/
  ...
  public ObservabilityPipelineMemoryBufferOptions whenFull(ObservabilityPipelineBufferOptionsWhenFull whenFull) {
