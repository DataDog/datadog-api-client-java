...
public class FleetDeploymentConfigureV2Package {
   ...
   * @return FleetDeploymentConfigureV2Package
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class FleetDeploymentConfigureV2Package {\n");
    sb.append("    apmInstrumentation: ").append(toIndentedString(apmInstrumentation)).append("\n");
