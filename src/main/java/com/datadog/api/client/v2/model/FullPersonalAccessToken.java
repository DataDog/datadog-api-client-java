...
/**
 * Personal access token object with the secret key value. This is only returned when creating a new
 * token.
 */
@JsonPropertyOrder({
...
public class FullPersonalAccessToken {
  ...
  public FullPersonalAccessToken() {}

  @JsonCreator
  public FullPersonalAccessToken(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          FullPersonalAccessTokenAttributes attributes,
  ...
  /**
   * Attributes of a personal access token including the secret key value. This is only returned
  ...
  public FullPersonalAccessToken id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public FullPersonalAccessToken type(PersonalAccessTokenType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
