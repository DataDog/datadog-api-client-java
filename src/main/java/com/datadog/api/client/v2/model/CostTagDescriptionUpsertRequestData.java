...
public class CostTagDescriptionUpsertRequestData {
  ...
  @JsonCreator
  public CostTagDescriptionUpsertRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CostTagDescriptionUpsertRequestDataAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>Identifier of the tag key the description applies to. Matches the <code>tag_key</code> path parameter.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CostTagDescriptionUpsertRequestData costTagDescriptionUpsertRequestData = (CostTagDescriptionUpsertRequestData) o;
    return Objects.equals(this.attributes, costTagDescriptionUpsertRequestData.attributes) && Objects.equals(this.id, costTagDescriptionUpsertRequestData.id) && Objects.equals(this.type, costTagDescriptionUpsertRequestData.type) && Objects.equals(this.additionalProperties, costTagDescriptionUpsertRequestData.additionalProperties);
  }
