...
/**
   * <p>Details for a logs-based content pack.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringContentPackLogsDetails {
  ...
  public SecurityMonitoringContentPackLogsDetails(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_FILTERS_CONFIGURED)Boolean filtersConfigured,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SIEM_INDEX_INCORRECT)Boolean siemIndexIncorrect,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SecurityFilterFilteredDataType type) {
  ...
  public SecurityMonitoringContentPackLogsDetails cpActivation(SecurityMonitoringContentPackActivation cpActivation) {
    this.cpActivation = cpActivation;
    this.unparsed |= !cpActivation.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringContentPackLogsDetails dataLastSeen(SecurityMonitoringContentPackTimestampBucket dataLastSeen) {
    this.dataLastSeen = dataLastSeen;
    this.unparsed |= !dataLastSeen.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Whether filters (Security Filters or Index Query depending on the pricing model) are
   * present and correctly configured to route logs into Cloud SIEM.</p>
  ...
  **/
  ...
  public SecurityMonitoringContentPackLogsDetails integrationInstalledStatus(SecurityMonitoringContentPackIntegrationStatus integrationInstalledStatus) {
    this.integrationInstalledStatus = integrationInstalledStatus;
    this.unparsed |= !integrationInstalledStatus.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringContentPackLogsDetails logsSeenFromAnyIndex(Boolean logsSeenFromAnyIndex) {
    this.logsSeenFromAnyIndex = logsSeenFromAnyIndex;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringContentPackLogsDetails securityMonitoringContentPackLogsDetails = (SecurityMonitoringContentPackLogsDetails) o;
    return Objects.equals(this.cpActivation, securityMonitoringContentPackLogsDetails.cpActivation) && Objects.equals(this.dataLastSeen, securityMonitoringContentPackLogsDetails.dataLastSeen) && Objects.equals(this.filtersConfigured, securityMonitoringContentPackLogsDetails.filtersConfigured) && Objects.equals(this.integrationInstalledStatus, securityMonitoringContentPackLogsDetails.integrationInstalledStatus) && Objects.equals(this.logsSeenFromAnyIndex, securityMonitoringContentPackLogsDetails.logsSeenFromAnyIndex) && Objects.equals(this.siemIndexIncorrect, securityMonitoringContentPackLogsDetails.siemIndexIncorrect) && Objects.equals(this.type, securityMonitoringContentPackLogsDetails.type) && Objects.equals(this.additionalProperties, securityMonitoringContentPackLogsDetails.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(cpActivation,dataLastSeen,filtersConfigured,integrationInstalledStatus,logsSeenFromAnyIndex,siemIndexIncorrect,type, additionalProperties);
  }
