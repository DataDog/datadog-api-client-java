...
public class CloudWorkloadSecurityAgentRuleUpdateData {
  ...
  @JsonCreator
  public CloudWorkloadSecurityAgentRuleUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CloudWorkloadSecurityAgentRuleUpdateAttributes attributes,
  ...
  public CloudWorkloadSecurityAgentRuleUpdateData attributes(CloudWorkloadSecurityAgentRuleUpdateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public CloudWorkloadSecurityAgentRuleUpdateData id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The type of the resource, must always be <code>agent_rule</code></p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public CloudWorkloadSecurityAgentRuleUpdateData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CloudWorkloadSecurityAgentRuleUpdateData cloudWorkloadSecurityAgentRuleUpdateData = (CloudWorkloadSecurityAgentRuleUpdateData) o;
    return Objects.equals(this.attributes, cloudWorkloadSecurityAgentRuleUpdateData.attributes) && Objects.equals(this.id, cloudWorkloadSecurityAgentRuleUpdateData.id) && Objects.equals(this.type, cloudWorkloadSecurityAgentRuleUpdateData.type) && Objects.equals(this.additionalProperties, cloudWorkloadSecurityAgentRuleUpdateData.additionalProperties);
  }
