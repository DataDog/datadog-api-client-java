...
public class CIAppGitHubAccountUpdateRequestData {
  ...
  public CIAppGitHubAccountUpdateRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          CIAppGitHubAccountUpdateRequestAttributes attributes,
  ...
  public CIAppGitHubAccountUpdateRequestData attributes(
      CIAppGitHubAccountUpdateRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
   ...
   * enabled</code> or <code>repository.enabled</code> must be provided. Account-level and
   * repository-level opt-in changes are independent and may both be supplied in the same request.
   *
   * @return attributes
   */
  ...
  public boolean equals(Object o) {
    ...
    CIAppGitHubAccountUpdateRequestData ciAppGitHubAccountUpdateRequestData =
        (CIAppGitHubAccountUpdateRequestData) o;
    return Objects.equals(this.attributes, ciAppGitHubAccountUpdateRequestData.attributes)
        && Objects.equals(this.type, ciAppGitHubAccountUpdateRequestData.type)
        && Objects.equals(
            this.additionalProperties, ciAppGitHubAccountUpdateRequestData.additionalProperties);
  }
