...
public class IncidentResponderDataAttributesResponse {
  ...
  /**
   * <p>Timestamp when the responder was created.</p>
   * @return created
  **/
  ...
  /**
   * <p>The external ID of the responder.</p>
   * @return externalId
  **/
  ...
  @JsonProperty(JSON_PROPERTY_EXTERNAL_ID)public void setExternalId_JsonNullable(JsonNullable<String> externalId) {
  ...
  /**
   * <p>The external source of the responder.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_EXTERNAL_SOURCE)public void setExternalSource_JsonNullable(JsonNullable<String> externalSource) {
  ...
  /**
   * <p>Whether this responder counts toward billing.</p>
   * @return isBillable
  **/
  ...
  /**
   * <p>Timestamp when the responder was last active.</p>
   * @return lastActive
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_LAST_ACTIVE)public void setLastActive_JsonNullable(JsonNullable<OffsetDateTime> lastActive) {
  ...
  /**
   * <p>Additional metadata for the responder.</p>
   * @return meta
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_META)public void setMeta_JsonNullable(JsonNullable<Map<String, Object>> meta) {
    this.meta = meta;
  }
  ...
  /**
   * <p>Timestamp when the responder was last modified.</p>
   * @return modified
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentResponderDataAttributesResponse incidentResponderDataAttributesResponse = (IncidentResponderDataAttributesResponse) o;
    return Objects.equals(this.created, incidentResponderDataAttributesResponse.created) && Objects.equals(this.externalId, incidentResponderDataAttributesResponse.externalId) && Objects.equals(this.externalSource, incidentResponderDataAttributesResponse.externalSource) && Objects.equals(this.isBillable, incidentResponderDataAttributesResponse.isBillable) && Objects.equals(this.lastActive, incidentResponderDataAttributesResponse.lastActive) && Objects.equals(this.meta, incidentResponderDataAttributesResponse.meta) && Objects.equals(this.modified, incidentResponderDataAttributesResponse.modified) && Objects.equals(this.additionalProperties, incidentResponderDataAttributesResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(created,externalId,externalSource,isBillable,lastActive,meta,modified, additionalProperties);
  }
