...
public class PrintReportResponseAttributes {
  ...
  /**
   * <p>The URL from which the rendered PDF report can be downloaded.</p>
   * @return downloadUrl
  **/
  ...
  /**
   * <p>The start of the rendered time range, as a Unix timestamp in milliseconds.</p>
   * @return fromTs
  **/
  ...
  /**
   * <p>The identifier of the dashboard or integration dashboard.</p>
   * @return resourceId
  **/
  ...
  **/
  ...
  /**
   * <p>The relative time window used, if one was specified in the request.</p>
   * @return timeframe
  **/
  ...
  /**
   * <p>The IANA time zone identifier used when rendering the report.</p>
   * @return timezone
  **/
  ...
  /**
   * <p>The end of the rendered time range, as a Unix timestamp in milliseconds.</p>
   * @return toTs
  **/
