...
public class EventPriority extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("normal", "low", "1", "2", "3", "4", "5"));
  ...
  public static class EventPrioritySerializer extends StdSerializer<EventPriority> {
      ...
      @Override
      public void serialize(EventPriority value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
