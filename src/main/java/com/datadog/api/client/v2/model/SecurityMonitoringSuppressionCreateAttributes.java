...
public class SecurityMonitoringSuppressionCreateAttributes {
  ...
  **/
  ...
  /**
   * <p>The suppression query of the suppression rule. If a signal matches this query, it is suppressed and is not triggered. It uses the same syntax as the queries to search signals in the Signals Explorer.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringSuppressionCreateAttributes securityMonitoringSuppressionCreateAttributes = (SecurityMonitoringSuppressionCreateAttributes) o;
    return Objects.equals(this.dataExclusionQuery, securityMonitoringSuppressionCreateAttributes.dataExclusionQuery) && Objects.equals(this.description, securityMonitoringSuppressionCreateAttributes.description) && Objects.equals(this.enabled, securityMonitoringSuppressionCreateAttributes.enabled) && Objects.equals(this.expirationDate, securityMonitoringSuppressionCreateAttributes.expirationDate) && Objects.equals(this.name, securityMonitoringSuppressionCreateAttributes.name) && Objects.equals(this.ruleQuery, securityMonitoringSuppressionCreateAttributes.ruleQuery) && Objects.equals(this.startDate, securityMonitoringSuppressionCreateAttributes.startDate) && Objects.equals(this.suppressionQuery, securityMonitoringSuppressionCreateAttributes.suppressionQuery) && Objects.equals(this.tags, securityMonitoringSuppressionCreateAttributes.tags) && Objects.equals(this.additionalProperties, securityMonitoringSuppressionCreateAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(dataExclusionQuery,description,enabled,expirationDate,name,ruleQuery,startDate,suppressionQuery,tags, additionalProperties);
  }
