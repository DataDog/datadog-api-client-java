...
public class FlakyTestRunMetadata {
  ...
  @JsonProperty(JSON_PROPERTY_ERROR_STACK)
  public void setErrorStack_JsonNullable(JsonNullable<String> errorStack) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE_END)
  public void setSourceEnd_JsonNullable(JsonNullable<Long> sourceEnd) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE_FILE)
  public void setSourceFile_JsonNullable(JsonNullable<String> sourceFile) {
  ...
  @JsonProperty(JSON_PROPERTY_SOURCE_START)
  public void setSourceStart_JsonNullable(JsonNullable<Long> sourceStart) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.durationMs, flakyTestRunMetadata.durationMs)
        && Objects.equals(this.errorMessage, flakyTestRunMetadata.errorMessage)
        && Objects.equals(this.errorStack, flakyTestRunMetadata.errorStack)
        && Objects.equals(this.sourceEnd, flakyTestRunMetadata.sourceEnd)
        && Objects.equals(this.sourceFile, flakyTestRunMetadata.sourceFile)
        && Objects.equals(this.sourceStart, flakyTestRunMetadata.sourceStart)
        && Objects.equals(this.additionalProperties, flakyTestRunMetadata.additionalProperties);
  }
