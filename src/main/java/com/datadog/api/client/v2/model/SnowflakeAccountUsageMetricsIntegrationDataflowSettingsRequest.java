...
public class SnowflakeAccountUsageMetricsIntegrationDataflowSettingsRequest {
  ...
  /**
   * The period each metric aggregates over. Set to <code>true</code> to aggregate the past 24 hours
   * on a rolling basis, or <code>false</code> to aggregate the current day so far. Defaults to
   * <code>false</code>.
   *
