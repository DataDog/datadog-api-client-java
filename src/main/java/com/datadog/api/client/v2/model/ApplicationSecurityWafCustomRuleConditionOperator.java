...
/**
   * <p>Operator to use for the WAF Condition.</p>
 */
@JsonSerialize(using = ApplicationSecurityWafCustomRuleConditionOperator.ApplicationSecurityWafCustomRuleConditionOperatorSerializer.class)
public class ApplicationSecurityWafCustomRuleConditionOperator extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("match_regex", "!match_regex", "phrase_match", "!phrase_match", "is_xss", "is_sqli", "exact_match", "!exact_match", "ip_match", "!ip_match", "capture_data", "exists", "!exists", "equals", "!equals"));
  ...
  public static final ApplicationSecurityWafCustomRuleConditionOperator EXISTS = new ApplicationSecurityWafCustomRuleConditionOperator("exists");
  public static final ApplicationSecurityWafCustomRuleConditionOperator NOT_EXISTS = new ApplicationSecurityWafCustomRuleConditionOperator("!exists");
  public static final ApplicationSecurityWafCustomRuleConditionOperator EQUALS = new ApplicationSecurityWafCustomRuleConditionOperator("equals");
  public static final ApplicationSecurityWafCustomRuleConditionOperator NOT_EQUALS = new ApplicationSecurityWafCustomRuleConditionOperator("!equals");
  ...
  public static class ApplicationSecurityWafCustomRuleConditionOperatorSerializer extends StdSerializer<ApplicationSecurityWafCustomRuleConditionOperator> {
      public ApplicationSecurityWafCustomRuleConditionOperatorSerializer(Class<ApplicationSecurityWafCustomRuleConditionOperator> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(ApplicationSecurityWafCustomRuleConditionOperator value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
