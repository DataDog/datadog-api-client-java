...
public class CycloneDXMetadata {
  ...
  private CycloneDXAssetComponent component;

  public static final String JSON_PROPERTY_TOOLS = "tools";
  private CycloneDXTools tools;
  ...
  public CycloneDXMetadata(
      @JsonProperty(required = true, value = JSON_PROPERTY_COMPONENT)
          CycloneDXAssetComponent component,
      @JsonProperty(required = true, value = JSON_PROPERTY_TOOLS) CycloneDXTools tools) {
  ...
  public CycloneDXMetadata component(CycloneDXAssetComponent component) {
    this.component = component;
    this.unparsed |= component.unparsed;
    return this;
  }
  ...
  public CycloneDXAssetComponent getComponent() {
    return component;
  }

  public void setComponent(CycloneDXAssetComponent component) {
    this.component = component;
  }

  public CycloneDXMetadata tools(CycloneDXTools tools) {
    this.tools = tools;
    this.unparsed |= tools.unparsed;
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public CycloneDXTools getTools() {
    return tools;
  }

  public void setTools(CycloneDXTools tools) {
    this.tools = tools;
  }
