...
/**
   * <p>A cardinality override for a specific tag key within a per-metric limit.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit {
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit overrideType(ObservabilityPipelineTagCardinalityLimitProcessorOverrideType overrideType) {
    this.overrideType = overrideType;
    this.unparsed |= !overrideType.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The tag key this override applies to.</p>
   * @return tagKey
  **/
  ...
  /**
   * <p>The maximum number of distinct values allowed for this tag. Required when <code>override_type</code> is <code>limit_override</code>. Must be omitted when <code>override_type</code> is <code>excluded</code>.</p>
   * minimum: 0
   * maximum: 1000000
   * @return valueLimit
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit object is equal to o.
   */
  @Override
