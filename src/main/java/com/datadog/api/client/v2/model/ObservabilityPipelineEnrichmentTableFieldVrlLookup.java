...
/**
   * <p>Evaluates a VRL expression to produce the lookup key.</p>
 */
@JsonPropertyOrder({
  ObservabilityPipelineEnrichmentTableFieldVrlLookup.JSON_PROPERTY_VRL
})
...
public class ObservabilityPipelineEnrichmentTableFieldVrlLookup {
  ...
  /**
   * <p>A VRL expression that returns the value to use as the lookup key.</p>
   * @return vrl
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineEnrichmentTableFieldVrlLookup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineEnrichmentTableFieldVrlLookup observabilityPipelineEnrichmentTableFieldVrlLookup = (ObservabilityPipelineEnrichmentTableFieldVrlLookup) o;
    return Objects.equals(this.vrl, observabilityPipelineEnrichmentTableFieldVrlLookup.vrl) && Objects.equals(this.additionalProperties, observabilityPipelineEnrichmentTableFieldVrlLookup.additionalProperties);
  }
