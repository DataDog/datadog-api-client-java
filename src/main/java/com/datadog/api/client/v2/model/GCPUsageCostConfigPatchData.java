...
/**
   * <p>Google Cloud Usage Cost config patch data.</p>
 */
@JsonPropertyOrder({
...
public class GCPUsageCostConfigPatchData {
  ...
  private GCPUsageCostConfigPatchRequestType type = GCPUsageCostConfigPatchRequestType.GCP_USAGE_COST_CONFIG_PATCH_REQUEST;

  public GCPUsageCostConfigPatchData() {}

  @JsonCreator
  public GCPUsageCostConfigPatchData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)GCPUsageCostConfigPatchRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)GCPUsageCostConfigPatchRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public GCPUsageCostConfigPatchData attributes(GCPUsageCostConfigPatchRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for Google Cloud Usage Cost config patch request.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Type of Google Cloud Usage Cost config patch request.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, gcpUsageCostConfigPatchData.attributes) && Objects.equals(this.type, gcpUsageCostConfigPatchData.type) && Objects.equals(this.additionalProperties, gcpUsageCostConfigPatchData.additionalProperties);
  }
