 ...
 */
  ...
  public ApiResponse<RUMAnalyticsAggregateResponse> aggregateRUMEventsWithHttpInfo(RUMAggregateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumApi.aggregateRUMEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<RUMAnalyticsAggregateResponse>> aggregateRUMEventsWithHttpInfoAsync(RUMAggregateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("RumApi.aggregateRUMEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<RUMApplicationResponse>> createRUMApplicationWithHttpInfoAsync(RUMApplicationCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.createRUMApplication", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RUMApplicationResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<Void>> deleteRUMApplicationWithHttpInfoAsync(String id) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.deleteRUMApplication", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<RUMApplicationResponse>> getRUMApplicationWithHttpInfoAsync(String id) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.getRUMApplication", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RUMApplicationResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<RUMApplicationsResponse>> getRUMApplicationsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.getRUMApplications", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listRUMEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  public ApiResponse<RUMEventsResponse> listRUMEventsWithHttpInfo(ListRUMEventsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumApi.listRUMEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<RUMEventsResponse>> listRUMEventsWithHttpInfoAsync(ListRUMEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.listRUMEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchRUMEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  public ApiResponse<RUMEventsResponse> searchRUMEventsWithHttpInfo(RUMSearchEventsRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumApi.searchRUMEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<RUMEventsResponse>> searchRUMEventsWithHttpInfoAsync(RUMSearchEventsRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.searchRUMEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RUMEventsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<RUMApplicationResponse>> updateRUMApplicationWithHttpInfoAsync(String id, RUMApplicationUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("RumApi.updateRUMApplication", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RUMApplicationResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
