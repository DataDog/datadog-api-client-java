...
public class TeamHierarchyLinkType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_hierarchy_links"));

  public static final TeamHierarchyLinkType TEAM_HIERARCHY_LINKS = new TeamHierarchyLinkType("team_hierarchy_links");
  ...
  public static class TeamHierarchyLinkTypeSerializer extends StdSerializer<TeamHierarchyLinkType> {
      ...
      @Override
      public void serialize(TeamHierarchyLinkType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
