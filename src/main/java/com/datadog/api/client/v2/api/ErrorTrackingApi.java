 ...
 */
  public CompletableFuture<Void>deleteIssueAssigneeAsync(String issueId) {
    return deleteIssueAssigneeWithHttpInfoAsync(issueId).thenApply(response -> {
  ...
  /**
   * <p>Remove the assignee of an issue by <code>issue_id</code>.</p>
   *
   * @param issueId The identifier of the issue. (required)
  ...
  public ApiResponse<Void> deleteIssueAssigneeWithHttpInfo(String issueId) throws ApiException {
    ...
    String localVarPath = "/api/v2/error-tracking/issues/{issue_id}/assignee"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ErrorTrackingApi.deleteIssueAssignee", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteIssueAssigneeWithHttpInfoAsync(String issueId) {
    ...
    try {
      builder = apiClient.createBuilder("v2.ErrorTrackingApi.deleteIssueAssignee", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public static class GetIssueOptionalParameters {
    ...
    /**
     * Set include.
     * @param include Comma-separated list of relationship objects that should be included in the response. Possible values are <code>assignee</code>, <code>case</code>, and <code>team_owners</code>. (optional)
 ...
 * Get the details of an error tracking issue.
 *
 * See {@link #getIssueWithHttpInfoAsync}.
 *
 * @param issueId The identifier of the issue. (required)
 * @return CompletableFuture&lt;IssueResponse&gt;
 */
  public CompletableFuture<IssueResponse>getIssueAsync(String issueId) {
    return getIssueWithHttpInfoAsync(issueId, new GetIssueOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<IssueResponse>getIssueAsync( String issueId, GetIssueOptionalParameters parameters) {
    return getIssueWithHttpInfoAsync(issueId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Retrieve the full details for a specific error tracking issue, including attributes and relationships.</p>
   *
   * @param issueId The identifier of the issue. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<IssueResponse> getIssueWithHttpInfo(String issueId, GetIssueOptionalParameters parameters) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/error-tracking/issues/{issue_id}"
      .replaceAll("\\{" + "issue_id" + "\\}", apiClient.escapeString(issueId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ErrorTrackingApi.getIssue", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssueResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IssueResponse>> getIssueWithHttpInfoAsync(String issueId, GetIssueOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ErrorTrackingApi.getIssue", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IssueResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssueResponse>() {});
  }
  ...
  public static class SearchIssuesOptionalParameters {
    ...
    /**
     * Set include.
     * @param include Comma-separated list of relationship objects that should be included in the response. Possible values are <code>issue</code>, <code>issue.assignee</code>, <code>issue.case</code>, and <code>issue.team_owners</code>. (optional)
 ...
 *
 * See {@link #searchIssuesWithHttpInfo}.
 *
 ...
 * Search error tracking issues.
 *
 * See {@link #searchIssuesWithHttpInfoAsync}.
 *
 * @param body Search issues request payload. (required)
 ...
 */
  public CompletableFuture<IssuesSearchResponse>searchIssuesAsync(IssuesSearchRequest body) {
    return searchIssuesWithHttpInfoAsync(body, new SearchIssuesOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<IssuesSearchResponse>searchIssuesAsync( IssuesSearchRequest body, SearchIssuesOptionalParameters parameters) {
    return searchIssuesWithHttpInfoAsync(body, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Search issues endpoint allows you to programmatically search for issues within your organization. This endpoint returns a list of issues that match a given search query, following the event search syntax. The search results are limited to a maximum of 100 issues per request.</p>
   *
   * @param body Search issues request payload. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<IssuesSearchResponse> searchIssuesWithHttpInfo(IssuesSearchRequest body, SearchIssuesOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ErrorTrackingApi.searchIssues", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssuesSearchResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IssuesSearchResponse>> searchIssuesWithHttpInfoAsync(IssuesSearchRequest body, SearchIssuesOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ErrorTrackingApi.searchIssues", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IssuesSearchResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssuesSearchResponse>() {});
  }

  /**
 * Update the assignee of an issue.
 *
 * See {@link #updateIssueAssigneeWithHttpInfo}.
 *
 * @param issueId The identifier of the issue. (required)
 ...
 * Update the assignee of an issue.
 *
 * See {@link #updateIssueAssigneeWithHttpInfoAsync}.
 *
 * @param issueId The identifier of the issue. (required)
 * @param body Update issue assignee request payload. (required)
 * @return CompletableFuture&lt;IssueResponse&gt;
 */
  public CompletableFuture<IssueResponse>updateIssueAssigneeAsync(String issueId, IssueUpdateAssigneeRequest body) {
    return updateIssueAssigneeWithHttpInfoAsync(issueId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update the assignee of an issue by <code>issue_id</code>.</p>
   *
   * @param issueId The identifier of the issue. (required)
   * @param body Update issue assignee request payload. (required)
   * @return ApiResponse&lt;IssueResponse&gt;
  ...
  public ApiResponse<IssueResponse> updateIssueAssigneeWithHttpInfo(String issueId, IssueUpdateAssigneeRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ErrorTrackingApi.updateIssueAssignee", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssueResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IssueResponse>> updateIssueAssigneeWithHttpInfoAsync(String issueId, IssueUpdateAssigneeRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ErrorTrackingApi.updateIssueAssignee", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IssueResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssueResponse>() {});
  }

  /**
 * Update the state of an issue.
 *
 * See {@link #updateIssueStateWithHttpInfo}.
 *
 * @param issueId The identifier of the issue. (required)
 ...
 * Update the state of an issue.
 *
 * See {@link #updateIssueStateWithHttpInfoAsync}.
 *
 * @param issueId The identifier of the issue. (required)
 * @param body Update issue state request payload. (required)
 * @return CompletableFuture&lt;IssueResponse&gt;
 */
  public CompletableFuture<IssueResponse>updateIssueStateAsync(String issueId, IssueUpdateStateRequest body) {
    return updateIssueStateWithHttpInfoAsync(issueId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update the state of an issue by <code>issue_id</code>. Use this endpoint to move an issue between states such as <code>OPEN</code>, <code>RESOLVED</code>, or <code>IGNORED</code>.</p>
   *
   * @param issueId The identifier of the issue. (required)
   * @param body Update issue state request payload. (required)
   * @return ApiResponse&lt;IssueResponse&gt;
  ...
  public ApiResponse<IssueResponse> updateIssueStateWithHttpInfo(String issueId, IssueUpdateStateRequest body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/error-tracking/issues/{issue_id}/state"
      .replaceAll("\\{" + "issue_id" + "\\}", apiClient.escapeString(issueId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ErrorTrackingApi.updateIssueState", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IssueResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IssueResponse>> updateIssueStateWithHttpInfoAsync(String issueId, IssueUpdateStateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ErrorTrackingApi.updateIssueState", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IssueResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
