...
public class SecurityMonitoringRuleCaseCreate {
  ...
  public SecurityMonitoringRuleCaseCreate addActionsItem(SecurityMonitoringRuleCaseAction actionsItem) {
  ...
  /**
   * <p>Action to perform for each rule case.</p>
   * @return actions
  **/
  ...
  /**
   * <p>A case contains logical operations (<code>&gt;</code>,<code>&gt;=</code>, <code>&amp;&amp;</code>, <code>||</code>) to determine if a signal should be generated
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, securityMonitoringRuleCaseCreate.actions) && Objects.equals(this.condition, securityMonitoringRuleCaseCreate.condition) && Objects.equals(this.name, securityMonitoringRuleCaseCreate.name) && Objects.equals(this.notifications, securityMonitoringRuleCaseCreate.notifications) && Objects.equals(this.status, securityMonitoringRuleCaseCreate.status) && Objects.equals(this.additionalProperties, securityMonitoringRuleCaseCreate.additionalProperties);
  }
