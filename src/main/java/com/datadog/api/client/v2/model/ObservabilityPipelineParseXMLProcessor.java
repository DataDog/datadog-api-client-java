...
/**
   * <p>The <code>parse_xml</code> processor parses XML from a specified field and extracts it into the event.</p>
...
public class ObservabilityPipelineParseXMLProcessor {
  ...
  private ObservabilityPipelineParseXMLProcessorType type = ObservabilityPipelineParseXMLProcessorType.PARSE_XML;
  ...
  public ObservabilityPipelineParseXMLProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineParseXMLProcessorType type) {
  ...
  /**
   * <p>Whether to always use a text key for element content.</p>
  ...
  **/
  ...
  /**
   * <p>The prefix to use for XML attributes in the parsed output.</p>
   * @return attrPrefix
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The name of the log field that contains an XML string.</p>
   * @return field
  **/
  ...
  **/
  ...
  /**
   * <p>Whether to include XML attributes in the parsed output.</p>
   * @return includeAttr
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to parse boolean values from strings.</p>
   * @return parseBool
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to parse null values.</p>
   * @return parseNull
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether to parse numeric values from strings.</p>
   * @return parseNumber
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The key name to use for text content within XML elements. Must be at least 1 character if specified.</p>
   * @return textKey
  **/
      @jakarta.annotation.Nullable
  ...
  public ObservabilityPipelineParseXMLProcessor type(ObservabilityPipelineParseXMLProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
