...
/**
   * <p>The action query spec object.</p>
 */
@JsonPropertyOrder({
...
public class ActionQuerySpecObject {
  ...
  **/
  ...
  /**
   * <p>The ID of the custom connection to use for this action query.</p>
   * @return connectionId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The fully qualified name of the action type.</p>
   * @return fqn
  **/
  ...
  /**
   * <p>The inputs to the action query. These are the values that are passed to the action when it is triggered.</p>
   * @return inputs
  **/
      @jakarta.annotation.Nullable
