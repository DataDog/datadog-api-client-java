...
public class AssetAttributes {
  ...
  **/
  ...
  /**
   * <p>List of environments where the asset is deployed.</p>
   * @return environments
  **/
  ...
  **/
  ...
  /**
   * <p>List of teams that own the asset.</p>
   * @return teams
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(arch,environments,name,operatingSystem,risks,teams,type,version, additionalProperties);
  }
