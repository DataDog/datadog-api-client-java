...
/**
   * <p>Response body for the aggregated long tasks endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedLongTasksResponse.JSON_PROPERTY_DATA
})
...
public class AggregatedLongTasksResponse {
  ...
  @JsonCreator
  public AggregatedLongTasksResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedLongTasksResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, aggregatedLongTasksResponse.data) && Objects.equals(this.additionalProperties, aggregatedLongTasksResponse.additionalProperties);
  }
