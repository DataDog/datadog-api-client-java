...
/**
   * <p>A single field change between two versions of a dataset.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringDatasetVersionFieldChange {
  ...
  /**
   * <p>The current value of the field, serialized as a JSON value.</p>
   * @return current
  **/
  ...
  /**
   * <p>The name of the field that changed.</p>
   * @return field
  **/
  ...
  /**
   * <p>The previous value of the field, serialized as a JSON value.</p>
   * @return previous
  **/
