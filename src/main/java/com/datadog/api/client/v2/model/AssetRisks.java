...
public class AssetRisks {
  ...
  /**
   * <p>Whether the asset has access to sensitive data or not.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the asset has privileged access or not.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the asset is in production or not.</p>
   * @return inProduction
  **/
  ...
  /**
   * <p>Whether the asset is publicly accessible or not.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the asset is under attack or not.</p>
   * @return underAttack
  **/
      @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hasAccessToSensitiveData,hasPrivilegedAccess,inProduction,isPubliclyAccessible,underAttack, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    hasAccessToSensitiveData: ").append(toIndentedString(hasAccessToSensitiveData)).append("\n");
    sb.append("    hasPrivilegedAccess: ").append(toIndentedString(hasPrivilegedAccess)).append("\n");
