...
public class CreateUploadRequestDataAttributes {
  ...
  /**
   * <p>The CSV file headers that define the schema fields, provided in the same order as the columns in the uploaded file. Maximum of 200 columns.</p>
   * @return headers
  **/
  ...
  /**
   * <p>Number of parts to split the file into for multipart upload.</p>
   * maximum: 20
   * @return partCount
  **/
  ...
  /**
   * <p>The size of each part in the upload in bytes. All parts except the last one must be at least 5,000,000 bytes.</p>
   * @return partSize
  **/
  ...
  /**
   * <p>Name of the table to associate with this upload.</p>
   * @return tableName
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateUploadRequestDataAttributes createUploadRequestDataAttributes = (CreateUploadRequestDataAttributes) o;
    return Objects.equals(this.headers, createUploadRequestDataAttributes.headers) && Objects.equals(this.partCount, createUploadRequestDataAttributes.partCount) && Objects.equals(this.partSize, createUploadRequestDataAttributes.partSize) && Objects.equals(this.tableName, createUploadRequestDataAttributes.tableName) && Objects.equals(this.additionalProperties, createUploadRequestDataAttributes.additionalProperties);
  }
