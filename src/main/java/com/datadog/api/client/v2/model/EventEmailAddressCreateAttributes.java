...
@JsonPropertyOrder({
  EventEmailAddressCreateAttributes.JSON_PROPERTY_ALERT_TYPE,
  EventEmailAddressCreateAttributes.JSON_PROPERTY_DESCRIPTION,
  EventEmailAddressCreateAttributes.JSON_PROPERTY_FORMAT,
  EventEmailAddressCreateAttributes.JSON_PROPERTY_NOTIFY_HANDLES,
  EventEmailAddressCreateAttributes.JSON_PROPERTY_TAGS
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class EventEmailAddressCreateAttributes {
  ...
  public EventEmailAddressCreateAttributes alertType(EventEmailAddressAlertType alertType) {
  ...
  public EventEmailAddressCreateAttributes description(String description) {
  ...
  public EventEmailAddressCreateAttributes format(EventEmailAddressFormat format) {
    this.format = format;
    this.unparsed |= !format.isValid();
    return this;
  }
  ...
  public EventEmailAddressCreateAttributes notifyHandles(List<String> notifyHandles) {
    this.notifyHandles = notifyHandles;
    return this;
  }

  public EventEmailAddressCreateAttributes addNotifyHandlesItem(String notifyHandlesItem) {
  ...
  public EventEmailAddressCreateAttributes tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public EventEmailAddressCreateAttributes addTagsItem(String tagsItem) {
    if (this.tags == null) {
   ...
   * @return EventEmailAddressCreateAttributes
   */
  @JsonAnySetter
  public EventEmailAddressCreateAttributes putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this EventEmailAddressCreateAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    EventEmailAddressCreateAttributes eventEmailAddressCreateAttributes =
        (EventEmailAddressCreateAttributes) o;
    return Objects.equals(this.alertType, eventEmailAddressCreateAttributes.alertType)
        && Objects.equals(this.description, eventEmailAddressCreateAttributes.description)
        && Objects.equals(this.format, eventEmailAddressCreateAttributes.format)
        && Objects.equals(this.notifyHandles, eventEmailAddressCreateAttributes.notifyHandles)
        && Objects.equals(this.tags, eventEmailAddressCreateAttributes.tags)
        && Objects.equals(
            this.additionalProperties, eventEmailAddressCreateAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventEmailAddressCreateAttributes {\n");
