...
public class BudgetWithEntriesDataType extends ModelEnum<String> {
  ...
  public static class BudgetWithEntriesDataTypeSerializer extends StdSerializer<BudgetWithEntriesDataType> {
      ...
      @Override
      public void serialize(BudgetWithEntriesDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
