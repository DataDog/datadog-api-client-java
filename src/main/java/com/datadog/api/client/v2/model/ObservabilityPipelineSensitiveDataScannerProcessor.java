...
/**
   * <p>The <code>sensitive_data_scanner</code> processor detects and optionally redacts sensitive data in log events.</p>
...
public class ObservabilityPipelineSensitiveDataScannerProcessor {
  ...
  private ObservabilityPipelineSensitiveDataScannerProcessorType type = ObservabilityPipelineSensitiveDataScannerProcessorType.SENSITIVE_DATA_SCANNER;
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RULES)List<ObservabilityPipelineSensitiveDataScannerProcessorRule> rules,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineSensitiveDataScannerProcessorType type) {
  ...
  **/
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessor rules(List<ObservabilityPipelineSensitiveDataScannerProcessorRule> rules) {
    this.rules = rules;
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessor addRulesItem(ObservabilityPipelineSensitiveDataScannerProcessorRule rulesItem) {
  ...
  /**
   * <p>A list of rules for identifying and acting on sensitive data patterns.</p>
   * @return rules
  **/
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessor type(ObservabilityPipelineSensitiveDataScannerProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>sensitive_data_scanner</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSensitiveDataScannerProcessor putAdditionalProperty(String key, Object value) {
