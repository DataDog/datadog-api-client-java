...
public class ArbitraryRuleResponseDataAttributes {
  ...
  private List<ArbitraryRuleResponseDataAttributesCostsToAllocateItems> costsToAllocate = new ArrayList<>();
  ...
  @JsonCreator
  public ArbitraryRuleResponseDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_COSTS_TO_ALLOCATE)List<ArbitraryRuleResponseDataAttributesCostsToAllocateItems> costsToAllocate,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STRATEGY)ArbitraryRuleResponseDataAttributesStrategy strategy,
  ...
  **/
  ...
  public void setCostsToAllocate(List<ArbitraryRuleResponseDataAttributesCostsToAllocateItems> costsToAllocate) {
    this.costsToAllocate = costsToAllocate;
  }
  ...
  /**
   * <p>The <code>attributes</code> <code>created</code>.</p>
   * @return created
  **/
  ...
  **/
  ...
  /**
   * <p>The <code>attributes</code> <code>updated</code>.</p>
   * @return updated
  **/
