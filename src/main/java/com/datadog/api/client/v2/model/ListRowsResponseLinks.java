...
/**
   * <p>Pagination links for the list rows response.</p>
 */
@JsonPropertyOrder({
...
public class ListRowsResponseLinks {
  ...
  **/
  ...
  /**
   * <p>Link to the next page of results. Only present when more rows are available.</p>
   * @return next
  **/
  ...
  /**
   * <p>Link to the current page of results.</p>
   * @return self
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.first, listRowsResponseLinks.first) && Objects.equals(this.next, listRowsResponseLinks.next) && Objects.equals(this.self, listRowsResponseLinks.self) && Objects.equals(this.additionalProperties, listRowsResponseLinks.additionalProperties);
  }
