...
public class CostByOrgType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("cost_by_org"));
  ...
  public static class CostByOrgTypeSerializer extends StdSerializer<CostByOrgType> {
      ...
      @Override
      public void serialize(CostByOrgType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
