...
public class UpsertCatalogEntityRequest extends AbstractOpenApiSchema {
    ...
    public static class UpsertCatalogEntityRequestSerializer extends StdSerializer<UpsertCatalogEntityRequest> {
        ...
        @Override
        public void serialize(UpsertCatalogEntityRequest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class UpsertCatalogEntityRequestDeserializer extends StdDeserializer<UpsertCatalogEntityRequest> {
        ...
        @Override
        public UpsertCatalogEntityRequest deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (EntityV3.class.equals(Integer.class) || EntityV3.class.equals(Long.class) || EntityV3.class.equals(Float.class) || EntityV3.class.equals(Double.class) || EntityV3.class.equals(Boolean.class) || EntityV3.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityV3.class.equals(Integer.class) || EntityV3.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityV3.class.equals(Float.class) || EntityV3.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityV3.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityV3.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    ...
                    if (!((EntityV3)tmp).unparsed
                        && !(((EntityV3)tmp).getActualInstance()
         ...
         */
        @Override
        public UpsertCatalogEntityRequest getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        ...
        JSON.registerDescendants(UpsertCatalogEntityRequest.class, Collections.unmodifiableMap(schemas));
    }
    ...
    /**
     * Get the actual instance of `EntityV3`. If the actual instance is not `EntityV3`,
