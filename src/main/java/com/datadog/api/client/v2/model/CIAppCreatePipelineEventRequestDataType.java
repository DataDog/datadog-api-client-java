...
@JsonSerialize(
    using =
        CIAppCreatePipelineEventRequestDataType.CIAppCreatePipelineEventRequestDataTypeSerializer
            .class)
public class CIAppCreatePipelineEventRequestDataType {
  ...
  /** Return true if this CIAppCreatePipelineEventRequestDataType object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((CIAppCreatePipelineEventRequestDataType) o).value);
  }
