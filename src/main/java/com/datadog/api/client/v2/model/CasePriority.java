...
public class CasePriority extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("NOT_DEFINED", "P1", "P2", "P3", "P4", "P5"));
  ...
  public static class CasePrioritySerializer extends StdSerializer<CasePriority> {
      ...
      @Override
      public void serialize(CasePriority value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
