...
public class UpdateFlakyTestsResponseAttributes {
  ...
  /**
   * <code>True</code> if any errors occurred during the update operations. <code>False</code> if
   * all tests succeeded to be updated.
   *
   * @return hasErrors
   */
  ...
  public UpdateFlakyTestsResponseAttributes addResultsItem(
      UpdateFlakyTestsResponseResult resultsItem) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFlakyTestsResponseAttributes updateFlakyTestsResponseAttributes =
        (UpdateFlakyTestsResponseAttributes) o;
    return Objects.equals(this.hasErrors, updateFlakyTestsResponseAttributes.hasErrors)
        && Objects.equals(this.results, updateFlakyTestsResponseAttributes.results)
        && Objects.equals(
            this.additionalProperties, updateFlakyTestsResponseAttributes.additionalProperties);
  }
