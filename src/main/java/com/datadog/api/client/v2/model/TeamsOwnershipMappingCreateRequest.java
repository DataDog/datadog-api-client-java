...
/**
   * <p>The request body for creating a teams ownership mapping.</p>
 */
@JsonPropertyOrder({
  TeamsOwnershipMappingCreateRequest.JSON_PROPERTY_DATA
})
...
public class TeamsOwnershipMappingCreateRequest {
  ...
  @JsonCreator
  public TeamsOwnershipMappingCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)TeamsOwnershipMappingCreateData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingCreateRequest teamsOwnershipMappingCreateRequest = (TeamsOwnershipMappingCreateRequest) o;
    return Objects.equals(this.data, teamsOwnershipMappingCreateRequest.data) && Objects.equals(this.additionalProperties, teamsOwnershipMappingCreateRequest.additionalProperties);
  }
