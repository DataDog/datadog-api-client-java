...
/**
   * <p>Attributes for creating a tag indexing rule.</p>
 */
@JsonPropertyOrder({
...
public class TagIndexingRuleCreateAttributes {
  ...
  @JsonCreator
  public TagIndexingRuleCreateAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_METRIC_NAME_MATCHES)List<String> metricNameMatches,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TagIndexingRuleCreateAttributes tagIndexingRuleCreateAttributes = (TagIndexingRuleCreateAttributes) o;
    return Objects.equals(this.excludeTagsMode, tagIndexingRuleCreateAttributes.excludeTagsMode) && Objects.equals(this.ignoredMetricNameMatches, tagIndexingRuleCreateAttributes.ignoredMetricNameMatches) && Objects.equals(this.metricNameMatches, tagIndexingRuleCreateAttributes.metricNameMatches) && Objects.equals(this.name, tagIndexingRuleCreateAttributes.name) && Objects.equals(this.options, tagIndexingRuleCreateAttributes.options) && Objects.equals(this.tags, tagIndexingRuleCreateAttributes.tags) && Objects.equals(this.additionalProperties, tagIndexingRuleCreateAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(excludeTagsMode,ignoredMetricNameMatches,metricNameMatches,name,options,tags, additionalProperties);
  }
