...
public class LLMObsExperimentationFilter {
  ...
  /**
   * <p>When <code>true</code>, include soft-deleted entities alongside active ones.</p>
  ...
  **/
  ...
  /**
   * <p>When <code>true</code>, return only soft-deleted entities.</p>
   * @return isDeleted
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Entity types to search. Valid values are <code>projects</code>, <code>datasets</code>, <code>dataset_records</code>, <code>experiments</code>, and <code>experiment_runs</code>.</p>
   * @return scope
  **/
  ...
  /**
   * <p>Filter dataset records by a specific dataset version.</p>
   * @return version
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_VERSION)public void setVersion_JsonNullable(JsonNullable<Long> version) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeDeleted, llmObsExperimentationFilter.includeDeleted) && Objects.equals(this.isDeleted, llmObsExperimentationFilter.isDeleted) && Objects.equals(this.query, llmObsExperimentationFilter.query) && Objects.equals(this.scope, llmObsExperimentationFilter.scope) && Objects.equals(this.version, llmObsExperimentationFilter.version) && Objects.equals(this.additionalProperties, llmObsExperimentationFilter.additionalProperties);
  }
