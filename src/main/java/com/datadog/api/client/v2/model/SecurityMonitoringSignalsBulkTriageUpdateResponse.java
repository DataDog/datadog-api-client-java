...
/**
   * <p>Response for a bulk triage update of security signals.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringSignalsBulkTriageUpdateResponse {
  ...
  @JsonCreator
  public SecurityMonitoringSignalsBulkTriageUpdateResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_RESULT)SecurityMonitoringSignalsBulkTriageUpdateResult result,
  ...
  public SecurityMonitoringSignalsBulkTriageUpdateResponse result(SecurityMonitoringSignalsBulkTriageUpdateResult result) {
    this.result = result;
    this.unparsed |= result.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The status of the bulk operation.</p>
   * @return status
  **/
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringSignalsBulkTriageUpdateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringSignalsBulkTriageUpdateResponse securityMonitoringSignalsBulkTriageUpdateResponse = (SecurityMonitoringSignalsBulkTriageUpdateResponse) o;
    return Objects.equals(this.result, securityMonitoringSignalsBulkTriageUpdateResponse.result) && Objects.equals(this.status, securityMonitoringSignalsBulkTriageUpdateResponse.status) && Objects.equals(this.type, securityMonitoringSignalsBulkTriageUpdateResponse.type) && Objects.equals(this.additionalProperties, securityMonitoringSignalsBulkTriageUpdateResponse.additionalProperties);
  }
