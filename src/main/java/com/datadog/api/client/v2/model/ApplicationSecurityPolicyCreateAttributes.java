...
@JsonPropertyOrder({
  ...
  ApplicationSecurityPolicyCreateAttributes.JSON_PROPERTY_RULESETS,
...
public class ApplicationSecurityPolicyCreateAttributes {
  ...
  /**
   * <p>When creating a new policy, clone the policy indicated by this identifier.</p>
   * @return basedOn
  **/
  ...
  **/
  ...
  public ApplicationSecurityPolicyCreateAttributes protectionPresets(List<String> protectionPresets) {
    this.protectionPresets = protectionPresets;
    return this;
  }
  public ApplicationSecurityPolicyCreateAttributes addProtectionPresetsItem(String protectionPresetsItem) {
  ...
  **/
  ...
  public ApplicationSecurityPolicyCreateAttributes rules(List<ApplicationSecurityPolicyRuleOverride> rules) {
    this.rules = rules;
    if (rules != null) {
  ...
  public ApplicationSecurityPolicyCreateAttributes addRulesItem(ApplicationSecurityPolicyRuleOverride rulesItem) {
    if (this.rules == null) {
  ...
  **/
  ...
  public ApplicationSecurityPolicyCreateAttributes rulesets(List<ApplicationSecurityPolicyRulesetOverride> rulesets) {
  ...
  public ApplicationSecurityPolicyCreateAttributes addRulesetsItem(ApplicationSecurityPolicyRulesetOverride rulesetsItem) {
  ...
  **/
  ...
  public ApplicationSecurityPolicyCreateAttributes scope(List<ApplicationSecurityPolicyScope> scope) {
    this.scope = scope;
    if (scope != null) {
  ...
  public ApplicationSecurityPolicyCreateAttributes addScopeItem(ApplicationSecurityPolicyScope scopeItem) {
    if (this.scope == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityPolicyCreateAttributes applicationSecurityPolicyCreateAttributes = (ApplicationSecurityPolicyCreateAttributes) o;
    return Objects.equals(this.basedOn, applicationSecurityPolicyCreateAttributes.basedOn) && Objects.equals(this.description, applicationSecurityPolicyCreateAttributes.description) && Objects.equals(this.isDefault, applicationSecurityPolicyCreateAttributes.isDefault) && Objects.equals(this.name, applicationSecurityPolicyCreateAttributes.name) && Objects.equals(this.protectionPresets, applicationSecurityPolicyCreateAttributes.protectionPresets) && Objects.equals(this.rules, applicationSecurityPolicyCreateAttributes.rules) && Objects.equals(this.rulesets, applicationSecurityPolicyCreateAttributes.rulesets) && Objects.equals(this.scope, applicationSecurityPolicyCreateAttributes.scope) && Objects.equals(this.version, applicationSecurityPolicyCreateAttributes.version) && Objects.equals(this.additionalProperties, applicationSecurityPolicyCreateAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(basedOn,description,isDefault,name,protectionPresets,rules,rulesets,scope,version, additionalProperties);
  }
