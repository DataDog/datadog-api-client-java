...
public class FleetScheduleV2Attributes {
  ...
  /**
   * RFC3339 timestamp of the next scheduled maintenance window start time. Absent when the next run
  ...
  public FleetScheduleV2Attributes notificationRule(
      FleetScheduleV2NotificationRule notificationRule) {
   ...
   *
   * <p>Included when available. If the notification rule cannot be retrieved, this field is omitted
   * and the schedule is still returned. If the notification rule is retrieved but its handles
   * cannot be resolved, it is still included with an empty <code>handles</code> array.
   *
   ...
   * major versions. minimum: 0 maximum: 2
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, fleetScheduleV2Attributes.createdAt)
        && Objects.equals(this.createdBy, fleetScheduleV2Attributes.createdBy)
        && Objects.equals(this.isDefault, fleetScheduleV2Attributes.isDefault)
        && Objects.equals(this.name, fleetScheduleV2Attributes.name)
        && Objects.equals(this.nextRun, fleetScheduleV2Attributes.nextRun)
        && Objects.equals(this.notificationRule, fleetScheduleV2Attributes.notificationRule)
        && Objects.equals(this.query, fleetScheduleV2Attributes.query)
        && Objects.equals(this.rule, fleetScheduleV2Attributes.rule)
        && Objects.equals(this.status, fleetScheduleV2Attributes.status)
        && Objects.equals(this.updatedAt, fleetScheduleV2Attributes.updatedAt)
        && Objects.equals(this.updatedBy, fleetScheduleV2Attributes.updatedBy)
        && Objects.equals(this.versionToLatest, fleetScheduleV2Attributes.versionToLatest)
        && Objects.equals(
            this.additionalProperties, fleetScheduleV2Attributes.additionalProperties);
  }
