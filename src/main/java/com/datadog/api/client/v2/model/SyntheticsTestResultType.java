...
public class SyntheticsTestResultType extends ModelEnum<String> {
  ...
  public static class SyntheticsTestResultTypeSerializer extends StdSerializer<SyntheticsTestResultType> {
      ...
      @Override
      public void serialize(SyntheticsTestResultType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
