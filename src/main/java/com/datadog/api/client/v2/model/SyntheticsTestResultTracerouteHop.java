...
public class SyntheticsTestResultTracerouteHop {
  ...
  **/
  ...
  /**
   * <p>Size of each probe packet in bytes.</p>
   * @return packetSize
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Resolved IP address for the target.</p>
   * @return resolvedIp
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of intermediate routers for the traceroute.</p>
   * @return routers
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestResultTracerouteHop syntheticsTestResultTracerouteHop = (SyntheticsTestResultTracerouteHop) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(host,latency,packetLossPercentage,packetSize,packetsReceived,packetsSent,resolvedIp,routers, additionalProperties);
  }
