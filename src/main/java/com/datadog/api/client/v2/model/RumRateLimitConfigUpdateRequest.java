...
/**
   * <p>The body of a request to create or update a RUM rate limit configuration.</p>
 */
@JsonPropertyOrder({
  RumRateLimitConfigUpdateRequest.JSON_PROPERTY_DATA
})
...
public class RumRateLimitConfigUpdateRequest {
  ...
  @JsonCreator
  public RumRateLimitConfigUpdateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)RumRateLimitConfigUpdateData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RumRateLimitConfigUpdateRequest rumRateLimitConfigUpdateRequest = (RumRateLimitConfigUpdateRequest) o;
    return Objects.equals(this.data, rumRateLimitConfigUpdateRequest.data) && Objects.equals(this.additionalProperties, rumRateLimitConfigUpdateRequest.additionalProperties);
  }
