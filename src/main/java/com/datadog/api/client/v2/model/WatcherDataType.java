...
public class WatcherDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("rum_replay_watcher"));

  public static final WatcherDataType RUM_REPLAY_WATCHER = new WatcherDataType("rum_replay_watcher");
  ...
  public static class WatcherDataTypeSerializer extends StdSerializer<WatcherDataType> {
      ...
      @Override
      public void serialize(WatcherDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
