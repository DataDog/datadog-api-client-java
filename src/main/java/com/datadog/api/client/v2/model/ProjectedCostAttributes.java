...
public class ProjectedCostAttributes {
  ...
  **/
  ...
  /**
   * <p>The total projected cost of products for the month.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accountName,accountPublicId,charges,date,orgName,projectedTotalCost,publicId,region, additionalProperties);
  }
