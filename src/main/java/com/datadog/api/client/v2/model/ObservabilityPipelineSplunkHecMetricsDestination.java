...
/**
   * <p>The <code>splunk_hec_metrics</code> destination forwards metrics to Splunk using the HTTP Event Collector (HEC).</p>
...
public class ObservabilityPipelineSplunkHecMetricsDestination {
  ...
  private ObservabilityPipelineSplunkHecMetricsDestinationCompression compression = ObservabilityPipelineSplunkHecMetricsDestinationCompression.NONE;
  ...
  private ObservabilityPipelineSplunkHecMetricsDestinationType type = ObservabilityPipelineSplunkHecMetricsDestinationType.SPLUNK_HEC_METRICS;
  ...
  public ObservabilityPipelineSplunkHecMetricsDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineSplunkHecMetricsDestinationType type) {
        this.id = id;
        this.inputs = inputs;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public ObservabilityPipelineSplunkHecMetricsDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
  ...
  **/
  ...
  public ObservabilityPipelineSplunkHecMetricsDestination compression(ObservabilityPipelineSplunkHecMetricsDestinationCompression compression) {
  ...
  /**
   * <p>Compression algorithm applied when sending metrics to Splunk HEC.</p>
   * @return compression
  **/
      @jakarta.annotation.Nullable
  ...
  public void setCompression(ObservabilityPipelineSplunkHecMetricsDestinationCompression compression) {
    if (!compression.isValid()) {
        this.unparsed = true;
    }
    this.compression = compression;
  }
  public ObservabilityPipelineSplunkHecMetricsDestination defaultNamespace(String defaultNamespace) {
    this.defaultNamespace = defaultNamespace;
    return this;
  }

  /**
   * <p>Optional default namespace for metrics sent to Splunk HEC.</p>
  ...
  **/
  ...
  /**
   * <p>Optional name of the Splunk index where metrics are written.</p>
   * @return index
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The Splunk source field value for metric events.</p>
   * @return source
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The Splunk sourcetype to assign to metric events.</p>
   * @return sourcetype
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public ObservabilityPipelineSplunkHecMetricsDestination type(ObservabilityPipelineSplunkHecMetricsDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. Always <code>splunk_hec_metrics</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSplunkHecMetricsDestination putAdditionalProperty(String key, Object value) {
