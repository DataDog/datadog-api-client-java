...
/**
   * <p>The <code>datadog_tags</code> processor includes or excludes specific Datadog tags in your logs.</p>
...
public class ObservabilityPipelineDatadogTagsProcessor {
  ...
  private ObservabilityPipelineDatadogTagsProcessorType type = ObservabilityPipelineDatadogTagsProcessorType.DATADOG_TAGS;

  public ObservabilityPipelineDatadogTagsProcessor() {}

  @JsonCreator
  public ObservabilityPipelineDatadogTagsProcessor(
            @JsonProperty(required=true, value=JSON_PROPERTY_ACTION)ObservabilityPipelineDatadogTagsProcessorAction action,
            @JsonProperty(required=true, value=JSON_PROPERTY_ENABLED)Boolean enabled,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_INCLUDE)String include,
            @JsonProperty(required=true, value=JSON_PROPERTY_KEYS)List<String> keys,
            @JsonProperty(required=true, value=JSON_PROPERTY_MODE)ObservabilityPipelineDatadogTagsProcessorMode mode,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineDatadogTagsProcessorType type) {
        this.action = action;
  ...
  public ObservabilityPipelineDatadogTagsProcessor action(ObservabilityPipelineDatadogTagsProcessorAction action) {
    this.action = action;
    this.unparsed |= !action.isValid();
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineDatadogTagsProcessor mode(ObservabilityPipelineDatadogTagsProcessorMode mode) {
    this.mode = mode;
    this.unparsed |= !mode.isValid();
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineDatadogTagsProcessor type(ObservabilityPipelineDatadogTagsProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>datadog_tags</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineDatadogTagsProcessor observabilityPipelineDatadogTagsProcessor = (ObservabilityPipelineDatadogTagsProcessor) o;
    return Objects.equals(this.action, observabilityPipelineDatadogTagsProcessor.action) && Objects.equals(this.displayName, observabilityPipelineDatadogTagsProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineDatadogTagsProcessor.enabled) && Objects.equals(this.id, observabilityPipelineDatadogTagsProcessor.id) && Objects.equals(this.include, observabilityPipelineDatadogTagsProcessor.include) && Objects.equals(this.keys, observabilityPipelineDatadogTagsProcessor.keys) && Objects.equals(this.mode, observabilityPipelineDatadogTagsProcessor.mode) && Objects.equals(this.type, observabilityPipelineDatadogTagsProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineDatadogTagsProcessor.additionalProperties);
  }
