 ...
 */
  public CompletableFuture<CaseResponse>addCaseInsightsAsync(String caseId, CaseInsightsRequest body) {
    return addCaseInsightsWithHttpInfoAsync(caseId, body).thenApply(response -> {
  ...
  /**
   * <p>Adds one or more insights to a case. Insights are references to related Datadog resources (such as monitors, security signals, incidents, or error tracking issues) that provide investigative context. Up to 100 insights can be added per request. Each insight requires a type (see <code>CaseInsightType</code> for allowed values), a ref (URL path to the resource), and a resource_id.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param body Case insights request. (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseResponse> addCaseInsightsWithHttpInfo(String caseId, CaseInsightsRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling addCaseInsights");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling addCaseInsights");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/insights"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.addCaseInsights", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseResponse>> addCaseInsightsWithHttpInfoAsync(String caseId, CaseInsightsRequest body) {
    ...
    if (caseId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling addCaseInsights"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling addCaseInsights"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/insights"
    ...
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.addCaseInsights", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
 ...
 */
  public CompletableFuture<CaseAggregateResponse>aggregateCasesAsync(CaseAggregateRequest body) {
    return aggregateCasesWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Performs an aggregation query over cases, grouping results by specified fields and returning counts per group along with a total. Useful for dashboards and analytics.</p>
   *
   * @param body Case aggregate request payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseAggregateResponse> aggregateCasesWithHttpInfo(CaseAggregateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling aggregateCases");
    }
    // create path and map variables
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.aggregateCases", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseAggregateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseAggregateResponse>> aggregateCasesWithHttpInfoAsync(CaseAggregateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling aggregateCases"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/aggregate";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.aggregateCases", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseAggregateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseAggregateResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>bulkUpdateCasesAsync(CaseBulkUpdateRequest body) {
    return bulkUpdateCasesWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Applies a single action (such as changing priority, status, assignment, or archiving) to multiple cases at once. The list of case IDs and the action type with its payload are specified in the request body.</p>
   *
   * @param body Case bulk update request payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<Void> bulkUpdateCasesWithHttpInfo(CaseBulkUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling bulkUpdateCases");
    }
    // create path and map variables
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.bulkUpdateCases", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> bulkUpdateCasesWithHttpInfoAsync(CaseBulkUpdateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling bulkUpdateCases"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/bulk";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.bulkUpdateCases", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<CaseCountResponse>countCasesAsync() {
    return countCasesWithHttpInfoAsync(new CountCasesOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 * @return CompletableFuture&lt;CaseCountResponse&gt;
 */
  public CompletableFuture<CaseCountResponse>countCasesAsync(CountCasesOptionalParameters parameters) {
    return countCasesWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns case counts, optionally grouped by one or more fields (for example, status, priority). Supports a query filter to narrow the scope.</p>
   *
   * @param parameters Optional parameters for the request.
   ...
   *     </table>
   */
  public ApiResponse<CaseCountResponse> countCasesWithHttpInfo(CountCasesOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.countCases", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseCountResponse>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<CaseCountResponse>> countCasesWithHttpInfoAsync(CountCasesOptionalParameters parameters) {
    Object localVarPostBody = null;
    String queryFilter = parameters.queryFilter;
    String groupBys = parameters.groupBys;
    Long limit = parameters.limit;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.countCases", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseCountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseCountResponse>() {});
  }
 ...
 * @throws ApiException if fails to make API call
 */
  public AutomationRuleResponse  createCaseAutomationRule(String projectId, AutomationRuleCreateRequest body) throws ApiException {
 ...
 */
  public CompletableFuture<AutomationRuleResponse>createCaseAutomationRuleAsync(String projectId, AutomationRuleCreateRequest body) {
    return createCaseAutomationRuleWithHttpInfoAsync(projectId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates an automation rule for a project. The rule defines a trigger event (for example, case created, status transitioned) and an action to execute.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param body Automation rule payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<AutomationRuleResponse> createCaseAutomationRuleWithHttpInfo(String projectId, AutomationRuleCreateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling createCaseAutomationRule");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRuleResponse>> createCaseAutomationRuleWithHttpInfoAsync(String projectId, AutomationRuleCreateRequest body) {
    ...
    if (projectId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling createCaseAutomationRule"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
 ...
 * Create a case link.
 *
 * See {@link #createCaseLinkWithHttpInfo}.
 *
 ...
 * Create a case link.
 *
 * See {@link #createCaseLinkWithHttpInfoAsync}.
 *
 * @param body Case link create request. (required)
 ...
 */
  public CompletableFuture<CaseLinkResponse>createCaseLinkAsync(CaseLinkCreateRequest body) {
    return createCaseLinkWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates a directional link between two cases (for example, case A blocks case B). The parent and child cases and their relationship type must be specified.</p>
   *
   * @param body Case link create request. (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseLinkResponse> createCaseLinkWithHttpInfo(CaseLinkCreateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createCaseLink");
    }
    // create path and map variables
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseLink", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseLinkResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseLinkResponse>> createCaseLinkWithHttpInfoAsync(CaseLinkCreateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createCaseLink"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/link";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseLink", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseLinkResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseLinkResponse>() {});
  }
 ...
 * Create a case view.
 *
 * See {@link #createCaseViewWithHttpInfo}.
 *
 ...
 * Create a case view.
 *
 * See {@link #createCaseViewWithHttpInfoAsync}.
 *
 * @param body Case view payload. (required)
 ...
 */
  public CompletableFuture<CaseViewResponse>createCaseViewAsync(CaseViewCreateRequest body) {
    return createCaseViewWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates a new saved case view with a name, filter query, and associated project. Optionally, a notification rule can be linked to the view.</p>
   *
   * @param body Case view payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseViewResponse> createCaseViewWithHttpInfo(CaseViewCreateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createCaseView");
    }
    // create path and map variables
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseViewResponse>> createCaseViewWithHttpInfoAsync(CaseViewCreateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createCaseView"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.createCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }

  /**
 * Create a maintenance window.
 *
 * See {@link #createMaintenanceWindowWithHttpInfo}.
 *
 * @param body Maintenance window payload. (required)
 * @return MaintenanceWindowResponse
 * @throws ApiException if fails to make API call
 */
  public MaintenanceWindowResponse  createMaintenanceWindow(MaintenanceWindowCreateRequest body) throws ApiException {
 ...
 * Create a maintenance window.
 *
 * See {@link #createMaintenanceWindowWithHttpInfoAsync}.
 *
 * @param body Maintenance window payload. (required)
 * @return CompletableFuture&lt;MaintenanceWindowResponse&gt;
 */
  public CompletableFuture<MaintenanceWindowResponse>createMaintenanceWindowAsync(MaintenanceWindowCreateRequest body) {
    return createMaintenanceWindowWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates a maintenance window for event management cases with a name, case filter query, and time range (start and end).</p>
   *
   * @param body Maintenance window payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<MaintenanceWindowResponse> createMaintenanceWindowWithHttpInfo(MaintenanceWindowCreateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createMaintenanceWindow");
    }
    // create path and map variables
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.createMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MaintenanceWindowResponse>> createMaintenanceWindowWithHttpInfoAsync(MaintenanceWindowCreateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createMaintenanceWindow"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/maintenance_windows";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.createMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MaintenanceWindowResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowResponse>() {});
  }
 ...
 *
 * See {@link #deleteCaseAutomationRuleWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 ...
 * Delete an automation rule.
 *
 * See {@link #deleteCaseAutomationRuleWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteCaseAutomationRuleAsync(String projectId, String ruleId) {
    return deleteCaseAutomationRuleWithHttpInfoAsync(projectId, ruleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Permanently deletes an automation rule from a project.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param ruleId The UUID of the automation rule. (required)
   * @return ApiResponse&lt;Void&gt;
   ...
   *     </table>
   */
  public ApiResponse<Void> deleteCaseAutomationRuleWithHttpInfo(String projectId, String ruleId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling deleteCaseAutomationRule");
    }

    // verify the required parameter 'ruleId' is set
    if (ruleId == null) {
      throw new ApiException(400, "Missing the required parameter 'ruleId' when calling deleteCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteCaseAutomationRuleWithHttpInfoAsync(String projectId, String ruleId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling deleteCaseAutomationRule"));
        return result;
    }
    ...
    if (ruleId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'ruleId' when calling deleteCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Delete a case link.
 *
 * See {@link #deleteCaseLinkWithHttpInfo}.
 *
 ...
 * Delete a case link.
 *
 * See {@link #deleteCaseLinkWithHttpInfoAsync}.
 *
 * @param linkId The UUID of the case link. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteCaseLinkAsync(String linkId) {
    return deleteCaseLinkWithHttpInfoAsync(linkId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes an existing link between cases by link ID.</p>
   *
   * @param linkId The UUID of the case link. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteCaseLinkWithHttpInfo(String linkId) throws ApiException {
    ...
    if (linkId == null) {
      throw new ApiException(400, "Missing the required parameter 'linkId' when calling deleteCaseLink");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/link/{link_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseLink", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteCaseLinkWithHttpInfoAsync(String linkId) {
    ...
    if (linkId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'linkId' when calling deleteCaseLink"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/link/{link_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseLink", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Delete a case view.
 *
 * See {@link #deleteCaseViewWithHttpInfo}.
 *
 ...
 * Delete a case view.
 *
 * See {@link #deleteCaseViewWithHttpInfoAsync}.
 *
 * @param viewId The UUID of the case view. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteCaseViewAsync(String viewId) {
    return deleteCaseViewWithHttpInfoAsync(viewId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Permanently deletes a saved case view.</p>
   *
   * @param viewId The UUID of the case view. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteCaseViewWithHttpInfo(String viewId) throws ApiException {
    ...
    if (viewId == null) {
      throw new ApiException(400, "Missing the required parameter 'viewId' when calling deleteCaseView");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteCaseViewWithHttpInfoAsync(String viewId) {
    ...
    if (viewId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'viewId' when calling deleteCaseView"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.deleteCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #deleteMaintenanceWindowWithHttpInfo}.
 *
 ...
 * Delete a maintenance window.
 *
 * See {@link #deleteMaintenanceWindowWithHttpInfoAsync}.
 *
 * @param maintenanceWindowId The UUID of the maintenance window. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteMaintenanceWindowAsync(String maintenanceWindowId) {
    return deleteMaintenanceWindowWithHttpInfoAsync(maintenanceWindowId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Permanently deletes a maintenance window.</p>
   *
   * @param maintenanceWindowId The UUID of the maintenance window. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
   ...
   *     </table>
   */
  public ApiResponse<Void> deleteMaintenanceWindowWithHttpInfo(String maintenanceWindowId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'maintenanceWindowId' is set
    if (maintenanceWindowId == null) {
      throw new ApiException(400, "Missing the required parameter 'maintenanceWindowId' when calling deleteMaintenanceWindow");
    }
    // create path and map variables
    String localVarPath = "/api/v2/maintenance_windows/{maintenance_window_id}"
      .replaceAll("\\{" + "maintenance_window_id" + "\\}", apiClient.escapeString(maintenanceWindowId.toString()));

    
    Map<String, String> localVarHeaderParams = new HashMap<String, String>();


    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.deleteMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> deleteMaintenanceWindowWithHttpInfoAsync(String maintenanceWindowId) {
    ...
    if (maintenanceWindowId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'maintenanceWindowId' when calling deleteMaintenanceWindow"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/maintenance_windows/{maintenance_window_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.deleteMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #disableCaseAutomationRuleWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return AutomationRuleResponse
 * @throws ApiException if fails to make API call
 */
  public AutomationRuleResponse  disableCaseAutomationRule(String projectId, String ruleId) throws ApiException {
 ...
 * Disable an automation rule.
 *
 * See {@link #disableCaseAutomationRuleWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return CompletableFuture&lt;AutomationRuleResponse&gt;
 */
  public CompletableFuture<AutomationRuleResponse>disableCaseAutomationRuleAsync(String projectId, String ruleId) {
    return disableCaseAutomationRuleWithHttpInfoAsync(projectId, ruleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Disables an automation rule so it no longer triggers on case events. The rule configuration is preserved.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param ruleId The UUID of the automation rule. (required)
   * @return ApiResponse&lt;AutomationRuleResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<AutomationRuleResponse> disableCaseAutomationRuleWithHttpInfo(String projectId, String ruleId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling disableCaseAutomationRule");
    }

    // verify the required parameter 'ruleId' is set
    if (ruleId == null) {
      throw new ApiException(400, "Missing the required parameter 'ruleId' when calling disableCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}/disable"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
      .replaceAll("\\{" + "rule_id" + "\\}", apiClient.escapeString(ruleId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.disableCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRuleResponse>> disableCaseAutomationRuleWithHttpInfoAsync(String projectId, String ruleId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling disableCaseAutomationRule"));
        return result;
    }
    ...
    if (ruleId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'ruleId' when calling disableCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}/disable"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.disableCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }

  /**
 * Enable an automation rule.
 *
 * See {@link #enableCaseAutomationRuleWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return AutomationRuleResponse
 * @throws ApiException if fails to make API call
 */
  public AutomationRuleResponse  enableCaseAutomationRule(String projectId, String ruleId) throws ApiException {
 ...
 * Enable an automation rule.
 *
 * See {@link #enableCaseAutomationRuleWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return CompletableFuture&lt;AutomationRuleResponse&gt;
 */
  public CompletableFuture<AutomationRuleResponse>enableCaseAutomationRuleAsync(String projectId, String ruleId) {
    return enableCaseAutomationRuleWithHttpInfoAsync(projectId, ruleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Enables a previously disabled automation rule so it triggers on matching case events.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param ruleId The UUID of the automation rule. (required)
   * @return ApiResponse&lt;AutomationRuleResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<AutomationRuleResponse> enableCaseAutomationRuleWithHttpInfo(String projectId, String ruleId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling enableCaseAutomationRule");
    }

    // verify the required parameter 'ruleId' is set
    if (ruleId == null) {
      throw new ApiException(400, "Missing the required parameter 'ruleId' when calling enableCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}/enable"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
      .replaceAll("\\{" + "rule_id" + "\\}", apiClient.escapeString(ruleId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.enableCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRuleResponse>> enableCaseAutomationRuleWithHttpInfoAsync(String projectId, String ruleId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling enableCaseAutomationRule"));
        return result;
    }
    ...
    if (ruleId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'ruleId' when calling enableCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}/enable"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.enableCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Favorite a project.
 *
 * See {@link #favoriteCaseProjectWithHttpInfo}.
 *
 * @param projectId Project UUID. (required)
 * @throws ApiException if fails to make API call
 */
 ...
 * Favorite a project.
 *
 * See {@link #favoriteCaseProjectWithHttpInfoAsync}.
 *
 * @param projectId Project UUID. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>favoriteCaseProjectAsync(String projectId) {
    return favoriteCaseProjectWithHttpInfoAsync(projectId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Marks a case project as a favorite for the current authenticated user.</p>
   *
   * @param projectId Project UUID. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> favoriteCaseProjectWithHttpInfo(String projectId) throws ApiException {
    ...
    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling favoriteCaseProject");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/favorites"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.favoriteCaseProject", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> favoriteCaseProjectWithHttpInfoAsync(String projectId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling favoriteCaseProject"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/favorites"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.favoriteCaseProject", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #getCaseAutomationRuleWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return AutomationRuleResponse
 * @throws ApiException if fails to make API call
 */
  public AutomationRuleResponse  getCaseAutomationRule(String projectId, String ruleId) throws ApiException {
 ...
 * Get an automation rule.
 *
 * See {@link #getCaseAutomationRuleWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @return CompletableFuture&lt;AutomationRuleResponse&gt;
 */
  public CompletableFuture<AutomationRuleResponse>getCaseAutomationRuleAsync(String projectId, String ruleId) {
    return getCaseAutomationRuleWithHttpInfoAsync(projectId, ruleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns a single automation rule identified by its UUID, including its trigger, action, and current state (enabled/disabled).</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param ruleId The UUID of the automation rule. (required)
   * @return ApiResponse&lt;AutomationRuleResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<AutomationRuleResponse> getCaseAutomationRuleWithHttpInfo(String projectId, String ruleId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling getCaseAutomationRule");
    }

    // verify the required parameter 'ruleId' is set
    if (ruleId == null) {
      throw new ApiException(400, "Missing the required parameter 'ruleId' when calling getCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.getCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRuleResponse>> getCaseAutomationRuleWithHttpInfoAsync(String projectId, String ruleId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling getCaseAutomationRule"));
        return result;
    }
    ...
    if (ruleId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'ruleId' when calling getCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.getCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }

  /**
 * Get a case view.
 *
 * See {@link #getCaseViewWithHttpInfo}.
 *
 * @param viewId The UUID of the case view. (required)
 * @return CaseViewResponse
 * @throws ApiException if fails to make API call
 ...
 * Get a case view.
 *
 * See {@link #getCaseViewWithHttpInfoAsync}.
 *
 * @param viewId The UUID of the case view. (required)
 * @return CompletableFuture&lt;CaseViewResponse&gt;
 */
  public CompletableFuture<CaseViewResponse>getCaseViewAsync(String viewId) {
    return getCaseViewWithHttpInfoAsync(viewId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns a single saved case view identified by its UUID, including its query, associated project, and timestamps.</p>
   *
   * @param viewId The UUID of the case view. (required)
   * @return ApiResponse&lt;CaseViewResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<CaseViewResponse> getCaseViewWithHttpInfo(String viewId) throws ApiException {
    ...
    // verify the required parameter 'viewId' is set
    if (viewId == null) {
      throw new ApiException(400, "Missing the required parameter 'viewId' when calling getCaseView");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
      .replaceAll("\\{" + "view_id" + "\\}", apiClient.escapeString(viewId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.getCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseViewResponse>> getCaseViewWithHttpInfoAsync(String viewId) {
    ...
    if (viewId == null) {
        CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'viewId' when calling getCaseView"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.getCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }
 ...
 *
 * See {@link #listCaseAutomationRulesWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 ...
 * List automation rules.
 *
 * See {@link #listCaseAutomationRulesWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 ...
 */
  public CompletableFuture<AutomationRulesResponse>listCaseAutomationRulesAsync(String projectId) {
    return listCaseAutomationRulesWithHttpInfoAsync(projectId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns all automation rules configured for a project. Automation rules allow automatic actions to be triggered by case events like creation, status transitions, or attribute changes.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   ...
   *     </table>
   */
  public ApiResponse<AutomationRulesResponse> listCaseAutomationRulesWithHttpInfo(String projectId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling listCaseAutomationRules");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseAutomationRules", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRulesResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRulesResponse>> listCaseAutomationRulesWithHttpInfoAsync(String projectId) {
    ...
    if (projectId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling listCaseAutomationRules"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseAutomationRules", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRulesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRulesResponse>() {});
  }
  ...
  public static class ListCaseLinksOptionalParameters {
    ...
    /**
     * Set relationship.
     * @param relationship Optional filter to only return links of a specific relationship type (for example, <code>BLOCKS</code> or <code>CAUSES</code>). (optional)
 ...
 * List case links.
 *
 * See {@link #listCaseLinksWithHttpInfo}.
 *
 * @param entityType The entity type to look up links for. Use <code>CASE</code> to find links for a specific case. (required)
 ...
 */
  public CaseLinksResponse listCaseLinks (String entityType, String entityId) throws ApiException {
    return listCaseLinksWithHttpInfo( entityType,  entityId, new ListCaseLinksOptionalParameters()).getData();
  }

  /**
 * List case links.
 *
 * See {@link #listCaseLinksWithHttpInfoAsync}.
 *
 * @param entityType The entity type to look up links for. Use <code>CASE</code> to find links for a specific case. (required)
 * @param entityId The UUID of the entity to look up links for. (required)
 * @return CompletableFuture&lt;CaseLinksResponse&gt;
 */
  public CompletableFuture<CaseLinksResponse>listCaseLinksAsync(String entityType, String entityId) {
    return listCaseLinksWithHttpInfoAsync(entityType, entityId, new ListCaseLinksOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 * @throws ApiException if fails to make API call
 */
  public CaseLinksResponse listCaseLinks(String entityType, String entityId, ListCaseLinksOptionalParameters parameters) throws ApiException {
 ...
 * @return CompletableFuture&lt;CaseLinksResponse&gt;
 */
  public CompletableFuture<CaseLinksResponse>listCaseLinksAsync( String entityType,  String entityId, ListCaseLinksOptionalParameters parameters) {
    return listCaseLinksWithHttpInfoAsync(entityType, entityId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns all links associated with a case. Links define relationships (for example, BLOCKS) between cases. Requires entity_type and entity_id query parameters.</p>
   *
   * @param entityType The entity type to look up links for. Use <code>CASE</code> to find links for a specific case. (required)
   * @param entityId The UUID of the entity to look up links for. (required)
   * @param parameters Optional parameters for the request.
   ...
   *     </table>
   */
  public ApiResponse<CaseLinksResponse> listCaseLinksWithHttpInfo(String entityType, String entityId, ListCaseLinksOptionalParameters parameters) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'entityType' is set
    if (entityType == null) {
      throw new ApiException(400, "Missing the required parameter 'entityType' when calling listCaseLinks");
    }

    // verify the required parameter 'entityId' is set
    if (entityId == null) {
      throw new ApiException(400, "Missing the required parameter 'entityId' when calling listCaseLinks");
    }
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseLinks", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseLinksResponse>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<CaseLinksResponse>> listCaseLinksWithHttpInfoAsync(String entityType, String entityId, ListCaseLinksOptionalParameters parameters) {
    Object localVarPostBody = null;

    // verify the required parameter 'entityType' is set
    if (entityType == null) {
        CompletableFuture<ApiResponse<CaseLinksResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'entityType' when calling listCaseLinks"));
        return result;
    }
    ...
    if (entityId == null) {
        CompletableFuture<ApiResponse<CaseLinksResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'entityId' when calling listCaseLinks"));
        return result;
    }
    String relationship = parameters.relationship;
    // create path and map variables
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseLinks", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseLinksResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseLinksResponse>() {});
  }
  ...
  public static class ListCaseTimelineOptionalParameters {
    ...
    /**
     * Set sortAscending.
     * @param sortAscending If <code>true</code>, returns timeline cells in chronological order (oldest first). Defaults to <code>false</code> (newest first). (optional, default to false)
     * @return ListCaseTimelineOptionalParameters
     */
 ...
 * Get case timeline.
 *
 * See {@link #listCaseTimelineWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 * @return TimelineResponse
 * @throws ApiException if fails to make API call
 ...
 * Get case timeline.
 *
 * See {@link #listCaseTimelineWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @return CompletableFuture&lt;TimelineResponse&gt;
 */
  public CompletableFuture<TimelineResponse>listCaseTimelineAsync(String caseId) {
    return listCaseTimelineWithHttpInfoAsync(caseId, new ListCaseTimelineOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 * @throws ApiException if fails to make API call
 */
  public TimelineResponse listCaseTimeline(String caseId, ListCaseTimelineOptionalParameters parameters) throws ApiException {
 ...
 * @return CompletableFuture&lt;TimelineResponse&gt;
 */
  public CompletableFuture<TimelineResponse>listCaseTimelineAsync( String caseId, ListCaseTimelineOptionalParameters parameters) {
    return listCaseTimelineWithHttpInfoAsync(caseId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns the timeline of events for a case, including comments, status changes, and other activity. Supports pagination and sort order.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param parameters Optional parameters for the request.
   * @return ApiResponse&lt;TimelineResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<TimelineResponse> listCaseTimelineWithHttpInfo(String caseId, ListCaseTimelineOptionalParameters parameters) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling listCaseTimeline");
    }
    Long pageSize = parameters.pageSize;
    Long pageNumber = parameters.pageNumber;
    Boolean sortAscending = parameters.sortAscending;
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/timelines"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseTimeline", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<TimelineResponse>() {});
  }
   ...
   * @return CompletableFuture&lt;ApiResponse&lt;TimelineResponse&gt;&gt;
   */
  public CompletableFuture<ApiResponse<TimelineResponse>> listCaseTimelineWithHttpInfoAsync(String caseId, ListCaseTimelineOptionalParameters parameters) {
    Object localVarPostBody = null;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
        CompletableFuture<ApiResponse<TimelineResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling listCaseTimeline"));
        return result;
    }
    Long pageSize = parameters.pageSize;
    Long pageNumber = parameters.pageNumber;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseTimeline", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<TimelineResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<TimelineResponse>() {});
  }

  /**
 * List case views.
 *
 * See {@link #listCaseViewsWithHttpInfo}.
 *
 ...
 */
  ...
  /**
   * <p>Returns all saved case views for a given project. Views are saved search queries that allow quick access to filtered lists of cases.</p>
   *
   * @param projectId Filter views by project identifier. (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseViewsResponse> listCaseViewsWithHttpInfo(String projectId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling listCaseViews");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views";
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseViews", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseViewsResponse>> listCaseViewsWithHttpInfoAsync(String projectId) {
    ...
    if (projectId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling listCaseViews"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseViews", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseViewsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewsResponse>() {});
  }

  /**
 * List case watchers.
 *
 * See {@link #listCaseWatchersWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 ...
 * List case watchers.
 *
 * See {@link #listCaseWatchersWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 ...
 */
  public CompletableFuture<CaseWatchersResponse>listCaseWatchersAsync(String caseId) {
    return listCaseWatchersWithHttpInfoAsync(caseId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns the list of users who are watching a case. Watchers receive notifications about updates to the case.</p>
   *
   * @param caseId Case's UUID or key (required)
   ...
   *     </table>
   */
  public ApiResponse<CaseWatchersResponse> listCaseWatchersWithHttpInfo(String caseId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling listCaseWatchers");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseWatchers", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseWatchersResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseWatchersResponse>> listCaseWatchersWithHttpInfoAsync(String caseId) {
    ...
    if (caseId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling listCaseWatchers"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listCaseWatchers", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseWatchersResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseWatchersResponse>() {});
  }

  /**
 * List maintenance windows.
 *
 * See {@link #listMaintenanceWindowsWithHttpInfo}.
 *
 ...
 * List maintenance windows.
 *
 * See {@link #listMaintenanceWindowsWithHttpInfoAsync}.
 *
 ...
 */
  public CompletableFuture<MaintenanceWindowsResponse>listMaintenanceWindowsAsync() {
    return listMaintenanceWindowsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns all configured maintenance windows for event management cases. Maintenance windows define time periods during which case notifications and automation rules are suppressed for cases matching a given query.</p>
   *
  ...
  public ApiResponse<MaintenanceWindowsResponse> listMaintenanceWindowsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listMaintenanceWindows", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MaintenanceWindowsResponse>> listMaintenanceWindowsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listMaintenanceWindows", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MaintenanceWindowsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowsResponse>() {});
  }

  /**
 * List project favorites.
 *
 * See {@link #listUserCaseProjectFavoritesWithHttpInfo}.
 *
 ...
 * List project favorites.
 *
 * See {@link #listUserCaseProjectFavoritesWithHttpInfoAsync}.
 *
 ...
 */
  public CompletableFuture<ProjectFavoritesResponse>listUserCaseProjectFavoritesAsync() {
    return listUserCaseProjectFavoritesWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns the list of case projects that the current authenticated user has marked as favorites.</p>
   *
  ...
  public ApiResponse<ProjectFavoritesResponse> listUserCaseProjectFavoritesWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.listUserCaseProjectFavorites", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ProjectFavoritesResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ProjectFavoritesResponse>> listUserCaseProjectFavoritesWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.listUserCaseProjectFavorites", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ProjectFavoritesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ProjectFavoritesResponse>() {});
  }
 ...
 *
 * See {@link #removeCaseInsightsWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 * @param body Case insights request. (required)
 * @return CaseResponse
 * @throws ApiException if fails to make API call
 */
  public CaseResponse  removeCaseInsights(String caseId, CaseInsightsRequest body) throws ApiException {
 ...
 * Remove insights from a case.
 *
 * See {@link #removeCaseInsightsWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param body Case insights request. (required)
 * @return CompletableFuture&lt;CaseResponse&gt;
 */
  public CompletableFuture<CaseResponse>removeCaseInsightsAsync(String caseId, CaseInsightsRequest body) {
    return removeCaseInsightsWithHttpInfoAsync(caseId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes one or more previously added insights from a case by specifying their type and resource identifier in the request body.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param body Case insights request. (required)
   * @return ApiResponse&lt;CaseResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<CaseResponse> removeCaseInsightsWithHttpInfo(String caseId, CaseInsightsRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling removeCaseInsights");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling removeCaseInsights");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/insights"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.removeCaseInsights", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseResponse>> removeCaseInsightsWithHttpInfoAsync(String caseId, CaseInsightsRequest body) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling removeCaseInsights"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling removeCaseInsights"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/insights"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.removeCaseInsights", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchCases", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, false, false, limit, args, 1);
 ...
 *
 * See {@link #unfavoriteCaseProjectWithHttpInfo}.
 *
 * @param projectId Project UUID. (required)
 * @throws ApiException if fails to make API call
 */
 ...
 * Unfavorite a project.
 *
 * See {@link #unfavoriteCaseProjectWithHttpInfoAsync}.
 *
 * @param projectId Project UUID. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>unfavoriteCaseProjectAsync(String projectId) {
    return unfavoriteCaseProjectWithHttpInfoAsync(projectId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes a case project from the current user's favorites list.</p>
   *
   * @param projectId Project UUID. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> unfavoriteCaseProjectWithHttpInfo(String projectId) throws ApiException {
    ...
    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling unfavoriteCaseProject");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/favorites"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.unfavoriteCaseProject", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> unfavoriteCaseProjectWithHttpInfoAsync(String projectId) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling unfavoriteCaseProject"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/favorites"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.unfavoriteCaseProject", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Unwatch a case.
 *
 * See {@link #unwatchCaseWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 ...
 * Unwatch a case.
 *
 * See {@link #unwatchCaseWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param userUuid The UUID of the user to add or remove as a watcher. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>unwatchCaseAsync(String caseId, String userUuid) {
    return unwatchCaseWithHttpInfoAsync(caseId, userUuid).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes a user from the watchers list of a case. The user no longer receives notifications about updates to the case.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param userUuid The UUID of the user to add or remove as a watcher. (required)
   * @return ApiResponse&lt;Void&gt;
   ...
   *     </table>
   */
  public ApiResponse<Void> unwatchCaseWithHttpInfo(String caseId, String userUuid) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling unwatchCase");
    }

    // verify the required parameter 'userUuid' is set
    if (userUuid == null) {
      throw new ApiException(400, "Missing the required parameter 'userUuid' when calling unwatchCase");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers/{user_uuid}"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.unwatchCase", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> unwatchCaseWithHttpInfoAsync(String caseId, String userUuid) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling unwatchCase"));
        return result;
    }
    ...
    if (userUuid == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'userUuid' when calling unwatchCase"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers/{user_uuid}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.unwatchCase", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #updateCaseAutomationRuleWithHttpInfo}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @param body Automation rule payload. (required)
 ...
 * @throws ApiException if fails to make API call
 */
  public AutomationRuleResponse  updateCaseAutomationRule(String projectId, String ruleId, AutomationRuleUpdateRequest body) throws ApiException {
 ...
 * Update an automation rule.
 *
 * See {@link #updateCaseAutomationRuleWithHttpInfoAsync}.
 *
 * @param projectId The UUID of the project that owns the automation rules. (required)
 * @param ruleId The UUID of the automation rule. (required)
 * @param body Automation rule payload. (required)
 * @return CompletableFuture&lt;AutomationRuleResponse&gt;
 */
  public CompletableFuture<AutomationRuleResponse>updateCaseAutomationRuleAsync(String projectId, String ruleId, AutomationRuleUpdateRequest body) {
    return updateCaseAutomationRuleWithHttpInfoAsync(projectId, ruleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the trigger, action, name, or state of an existing automation rule.</p>
   *
   * @param projectId The UUID of the project that owns the automation rules. (required)
   * @param ruleId The UUID of the automation rule. (required)
   * @param body Automation rule payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<AutomationRuleResponse> updateCaseAutomationRuleWithHttpInfo(String projectId, String ruleId, AutomationRuleUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'projectId' is set
    if (projectId == null) {
      throw new ApiException(400, "Missing the required parameter 'projectId' when calling updateCaseAutomationRule");
    }

    // verify the required parameter 'ruleId' is set
    if (ruleId == null) {
      throw new ApiException(400, "Missing the required parameter 'ruleId' when calling updateCaseAutomationRule");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseAutomationRule");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
      .replaceAll("\\{" + "project_id" + "\\}", apiClient.escapeString(projectId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<AutomationRuleResponse>> updateCaseAutomationRuleWithHttpInfoAsync(String projectId, String ruleId, AutomationRuleUpdateRequest body) {
    ...
    if (projectId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'projectId' when calling updateCaseAutomationRule"));
        return result;
    }
    ...
    if (ruleId == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'ruleId' when calling updateCaseAutomationRule"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseAutomationRule"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/projects/{project_id}/rules/{rule_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseAutomationRule", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AutomationRuleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<AutomationRuleResponse>() {});
  }

  /**
 * Update case comment.
 *
 * See {@link #updateCaseCommentWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 * @param cellId The UUID of the timeline cell (comment) to update. (required)
 ...
 * @throws ApiException if fails to make API call
 */
  public  void  updateCaseComment(String caseId, String cellId, CaseUpdateCommentRequest body) throws ApiException {
 ...
 * Update case comment.
 *
 * See {@link #updateCaseCommentWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param cellId The UUID of the timeline cell (comment) to update. (required)
 * @param body Case update comment payload. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>updateCaseCommentAsync(String caseId, String cellId, CaseUpdateCommentRequest body) {
    return updateCaseCommentWithHttpInfoAsync(caseId, cellId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the text content of an existing comment on a case timeline. The comment is identified by its cell ID.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param cellId The UUID of the timeline cell (comment) to update. (required)
   * @param body Case update comment payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<Void> updateCaseCommentWithHttpInfo(String caseId, String cellId, CaseUpdateCommentRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseComment");
    }

    // verify the required parameter 'cellId' is set
    if (cellId == null) {
      throw new ApiException(400, "Missing the required parameter 'cellId' when calling updateCaseComment");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseComment");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/comment/{cell_id}"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseComment", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> updateCaseCommentWithHttpInfoAsync(String caseId, String cellId, CaseUpdateCommentRequest body) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseComment"));
        return result;
    }
    ...
    if (cellId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'cellId' when calling updateCaseComment"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseComment"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/comment/{cell_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseComment", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #updateCaseDueDateWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 ...
 * @throws ApiException if fails to make API call
 */
  public CaseResponse  updateCaseDueDate(String caseId, CaseUpdateDueDateRequest body) throws ApiException {
 ...
 * Update case due date.
 *
 * See {@link #updateCaseDueDateWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param body Case due date update payload. (required)
 * @return CompletableFuture&lt;CaseResponse&gt;
 */
  public CompletableFuture<CaseResponse>updateCaseDueDateAsync(String caseId, CaseUpdateDueDateRequest body) {
    return updateCaseDueDateWithHttpInfoAsync(caseId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Sets or updates the due date for a case. The due date is a calendar date (without a time component) indicating when the case should be resolved.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param body Case due date update payload. (required)
   * @return ApiResponse&lt;CaseResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<CaseResponse> updateCaseDueDateWithHttpInfo(String caseId, CaseUpdateDueDateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseDueDate");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseDueDate");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/due_date"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseDueDate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseResponse>> updateCaseDueDateWithHttpInfoAsync(String caseId, CaseUpdateDueDateRequest body) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseDueDate"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseDueDate"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/due_date"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseDueDate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #updateCaseResolvedReasonWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 ...
 * @throws ApiException if fails to make API call
 */
  public CaseResponse  updateCaseResolvedReason(String caseId, CaseUpdateResolvedReasonRequest body) throws ApiException {
 ...
 * Update case resolved reason.
 *
 * See {@link #updateCaseResolvedReasonWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param body Case resolved reason update payload. (required)
 * @return CompletableFuture&lt;CaseResponse&gt;
 */
  public CompletableFuture<CaseResponse>updateCaseResolvedReasonAsync(String caseId, CaseUpdateResolvedReasonRequest body) {
    return updateCaseResolvedReasonWithHttpInfoAsync(caseId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Sets the resolved reason for a security case (for example, FALSE_POSITIVE, TRUE_POSITIVE). Applicable to security-type cases.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param body Case resolved reason update payload. (required)
   * @return ApiResponse&lt;CaseResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<CaseResponse> updateCaseResolvedReasonWithHttpInfo(String caseId, CaseUpdateResolvedReasonRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'caseId' is set
    if (caseId == null) {
      throw new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseResolvedReason");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseResolvedReason");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/resolved_reason"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseResolvedReason", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseResponse>> updateCaseResolvedReasonWithHttpInfoAsync(String caseId, CaseUpdateResolvedReasonRequest body) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling updateCaseResolvedReason"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseResolvedReason"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/resolved_reason"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseResolvedReason", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Update a case view.
 *
 * See {@link #updateCaseViewWithHttpInfo}.
 *
 * @param viewId The UUID of the case view. (required)
 * @param body Case view payload. (required)
 * @return CaseViewResponse
 * @throws ApiException if fails to make API call
 */
  public CaseViewResponse  updateCaseView(String viewId, CaseViewUpdateRequest body) throws ApiException {
 ...
 * Update a case view.
 *
 * See {@link #updateCaseViewWithHttpInfoAsync}.
 *
 * @param viewId The UUID of the case view. (required)
 * @param body Case view payload. (required)
 * @return CompletableFuture&lt;CaseViewResponse&gt;
 */
  public CompletableFuture<CaseViewResponse>updateCaseViewAsync(String viewId, CaseViewUpdateRequest body) {
    return updateCaseViewWithHttpInfoAsync(viewId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the name, query, or notification rule of an existing case view.</p>
   *
   * @param viewId The UUID of the case view. (required)
   * @param body Case view payload. (required)
   * @return ApiResponse&lt;CaseViewResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<CaseViewResponse> updateCaseViewWithHttpInfo(String viewId, CaseViewUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'viewId' is set
    if (viewId == null) {
      throw new ApiException(400, "Missing the required parameter 'viewId' when calling updateCaseView");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateCaseView");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
      .replaceAll("\\{" + "view_id" + "\\}", apiClient.escapeString(viewId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CaseViewResponse>> updateCaseViewWithHttpInfoAsync(String viewId, CaseViewUpdateRequest body) {
    ...
    if (viewId == null) {
        CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'viewId' when calling updateCaseView"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateCaseView"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/views/{view_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateCaseView", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CaseViewResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CaseViewResponse>() {});
  }

  /**
 * Update a maintenance window.
 *
 * See {@link #updateMaintenanceWindowWithHttpInfo}.
 *
 * @param maintenanceWindowId The UUID of the maintenance window. (required)
 * @param body Maintenance window payload. (required)
 * @return MaintenanceWindowResponse
 * @throws ApiException if fails to make API call
 */
  public MaintenanceWindowResponse  updateMaintenanceWindow(String maintenanceWindowId, MaintenanceWindowUpdateRequest body) throws ApiException {
 ...
 * Update a maintenance window.
 *
 * See {@link #updateMaintenanceWindowWithHttpInfoAsync}.
 *
 * @param maintenanceWindowId The UUID of the maintenance window. (required)
 * @param body Maintenance window payload. (required)
 * @return CompletableFuture&lt;MaintenanceWindowResponse&gt;
 */
  public CompletableFuture<MaintenanceWindowResponse>updateMaintenanceWindowAsync(String maintenanceWindowId, MaintenanceWindowUpdateRequest body) {
    return updateMaintenanceWindowWithHttpInfoAsync(maintenanceWindowId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates the name, query, start time, or end time of an existing maintenance window.</p>
   *
   * @param maintenanceWindowId The UUID of the maintenance window. (required)
   * @param body Maintenance window payload. (required)
   * @return ApiResponse&lt;MaintenanceWindowResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<MaintenanceWindowResponse> updateMaintenanceWindowWithHttpInfo(String maintenanceWindowId, MaintenanceWindowUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'maintenanceWindowId' is set
    if (maintenanceWindowId == null) {
      throw new ApiException(400, "Missing the required parameter 'maintenanceWindowId' when calling updateMaintenanceWindow");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateMaintenanceWindow");
    }
    // create path and map variables
    String localVarPath = "/api/v2/maintenance_windows/{maintenance_window_id}"
      .replaceAll("\\{" + "maintenance_window_id" + "\\}", apiClient.escapeString(maintenanceWindowId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.updateMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<MaintenanceWindowResponse>> updateMaintenanceWindowWithHttpInfoAsync(String maintenanceWindowId, MaintenanceWindowUpdateRequest body) {
    ...
    if (maintenanceWindowId == null) {
        CompletableFuture<ApiResponse<MaintenanceWindowResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'maintenanceWindowId' when calling updateMaintenanceWindow"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<MaintenanceWindowResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateMaintenanceWindow"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/maintenance_windows/{maintenance_window_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.updateMaintenanceWindow", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<MaintenanceWindowResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<MaintenanceWindowResponse>() {});
  }
 ...
 * Watch a case.
 *
 * See {@link #watchCaseWithHttpInfo}.
 *
 * @param caseId Case's UUID or key (required)
 * @param userUuid The UUID of the user to add or remove as a watcher. (required)
 * @throws ApiException if fails to make API call
 ...
 * Watch a case.
 *
 * See {@link #watchCaseWithHttpInfoAsync}.
 *
 * @param caseId Case's UUID or key (required)
 * @param userUuid The UUID of the user to add or remove as a watcher. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>watchCaseAsync(String caseId, String userUuid) {
    return watchCaseWithHttpInfoAsync(caseId, userUuid).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Adds a user (identified by their UUID) as a watcher of a case. The user receives notifications about subsequent updates to the case.</p>
   *
   * @param caseId Case's UUID or key (required)
   * @param userUuid The UUID of the user to add or remove as a watcher. (required)
   * @return ApiResponse&lt;Void&gt;
   ...
   *     </table>
   */
  public ApiResponse<Void> watchCaseWithHttpInfo(String caseId, String userUuid) throws ApiException {
    Object localVarPostBody = null;
    ...
    // verify the required parameter 'userUuid' is set
    if (userUuid == null) {
      throw new ApiException(400, "Missing the required parameter 'userUuid' when calling watchCase");
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers/{user_uuid}"
      .replaceAll("\\{" + "case_id" + "\\}", apiClient.escapeString(caseId.toString()))
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CaseManagementApi.watchCase", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
  ...
  public CompletableFuture<ApiResponse<Void>> watchCaseWithHttpInfoAsync(String caseId, String userUuid) {
    ...
    if (caseId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'caseId' when calling watchCase"));
        return result;
    }
    ...
    if (userUuid == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'userUuid' when calling watchCase"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/cases/{case_id}/watchers/{user_uuid}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CaseManagementApi.watchCase", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
