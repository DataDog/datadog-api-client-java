...
/**
   * <p>The response data containing status and agents array.</p>
 */
@JsonPropertyOrder({
...
public class FleetAgentsResponseData {
  ...
  @JsonCreator
  public FleetAgentsResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)FleetAgentsResponseDataAttributes attributes,
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, fleetAgentsResponseData.attributes) && Objects.equals(this.id, fleetAgentsResponseData.id) && Objects.equals(this.type, fleetAgentsResponseData.type) && Objects.equals(this.additionalProperties, fleetAgentsResponseData.additionalProperties);
  }
