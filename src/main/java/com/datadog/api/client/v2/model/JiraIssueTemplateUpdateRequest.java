...
/**
   * <p>Request to update a Jira issue template</p>
 */
@JsonPropertyOrder({
  JiraIssueTemplateUpdateRequest.JSON_PROPERTY_DATA
})
...
public class JiraIssueTemplateUpdateRequest {
  ...
  @JsonCreator
  public JiraIssueTemplateUpdateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)JiraIssueTemplateUpdateRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JiraIssueTemplateUpdateRequest jiraIssueTemplateUpdateRequest = (JiraIssueTemplateUpdateRequest) o;
    return Objects.equals(this.data, jiraIssueTemplateUpdateRequest.data) && Objects.equals(this.additionalProperties, jiraIssueTemplateUpdateRequest.additionalProperties);
  }
