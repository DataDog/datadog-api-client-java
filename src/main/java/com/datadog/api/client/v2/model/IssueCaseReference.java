...
@JsonPropertyOrder({IssueCaseReference.JSON_PROPERTY_ID, IssueCaseReference.JSON_PROPERTY_TYPE})
...
public class IssueCaseReference {
  ...
  public IssueCaseReference type(CaseResourceType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, issueCaseReference.id)
        && Objects.equals(this.type, issueCaseReference.type)
        && Objects.equals(this.additionalProperties, issueCaseReference.additionalProperties);
  }
