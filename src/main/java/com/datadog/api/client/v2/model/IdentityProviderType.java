...
public class IdentityProviderType extends ModelEnum<String> {
  ...
  public static final IdentityProviderType IDENTITY_PROVIDERS = new IdentityProviderType("identity_providers");
  ...
  public static class IdentityProviderTypeSerializer extends StdSerializer<IdentityProviderType> {
      ...
      @Override
      public void serialize(IdentityProviderType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
