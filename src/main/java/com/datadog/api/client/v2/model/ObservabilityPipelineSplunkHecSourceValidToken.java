...
/**
   * <p>An accepted HEC token used to authenticate incoming Splunk HEC requests.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSplunkHecSourceValidToken {
  ...
  **/
  ...
  public ObservabilityPipelineSplunkHecSourceValidToken fieldToAdd(ObservabilityPipelineSourceValidTokenFieldToAdd fieldToAdd) {
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the expected HEC token value.</p>
   * @return tokenKey
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSplunkHecSourceValidToken putAdditionalProperty(String key, Object value) {
