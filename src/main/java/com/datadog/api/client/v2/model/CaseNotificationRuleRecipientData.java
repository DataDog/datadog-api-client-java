...
public class CaseNotificationRuleRecipientData {
  ...
  public boolean equals(Object o) {
    ...
    CaseNotificationRuleRecipientData caseNotificationRuleRecipientData =
        (CaseNotificationRuleRecipientData) o;
    return Objects.equals(this.channel, caseNotificationRuleRecipientData.channel)
        && Objects.equals(this.channelId, caseNotificationRuleRecipientData.channelId)
        && Objects.equals(this.channelName, caseNotificationRuleRecipientData.channelName)
        && Objects.equals(this.connectorName, caseNotificationRuleRecipientData.connectorName)
        && Objects.equals(this.email, caseNotificationRuleRecipientData.email)
        && Objects.equals(this.name, caseNotificationRuleRecipientData.name)
        && Objects.equals(this.serviceName, caseNotificationRuleRecipientData.serviceName)
        && Objects.equals(this.teamId, caseNotificationRuleRecipientData.teamId)
        && Objects.equals(this.teamName, caseNotificationRuleRecipientData.teamName)
        && Objects.equals(this.tenantId, caseNotificationRuleRecipientData.tenantId)
        && Objects.equals(this.tenantName, caseNotificationRuleRecipientData.tenantName)
        && Objects.equals(this.workspace, caseNotificationRuleRecipientData.workspace)
        && Objects.equals(this.workspaceId, caseNotificationRuleRecipientData.workspaceId)
        && Objects.equals(
            this.additionalProperties, caseNotificationRuleRecipientData.additionalProperties);
  }
