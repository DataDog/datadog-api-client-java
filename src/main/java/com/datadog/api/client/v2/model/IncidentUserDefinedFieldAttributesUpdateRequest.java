...
/**
   * <p>Attributes for updating an incident user-defined field. All fields are optional.</p>
 */
@JsonPropertyOrder({
...
public class IncidentUserDefinedFieldAttributesUpdateRequest {
  ...
  private JsonNullable<List<IncidentUserDefinedFieldValidValue>> validValues = JsonNullable.<List<IncidentUserDefinedFieldValidValue>>undefined();

  public IncidentUserDefinedFieldAttributesUpdateRequest category(IncidentUserDefinedFieldCategory category) {
  ...
  **/
  ...
  public IncidentUserDefinedFieldAttributesUpdateRequest collected(IncidentUserDefinedFieldCollected collected) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REQUIRED)public void setRequired_JsonNullable(JsonNullable<Boolean> required) {
    this.required = required;
  }
  public void setRequired(Boolean required) {
    this.required = JsonNullable.<Boolean>of(required);
  }
  public IncidentUserDefinedFieldAttributesUpdateRequest validValues(List<IncidentUserDefinedFieldValidValue> validValues) {
    this.validValues = JsonNullable.<List<IncidentUserDefinedFieldValidValue>>of(validValues);
    return this;
  }
  public IncidentUserDefinedFieldAttributesUpdateRequest addValidValuesItem(IncidentUserDefinedFieldValidValue validValuesItem) {
    if (this.validValues == null || !this.validValues.isPresent()) {
      this.validValues = JsonNullable.<List<IncidentUserDefinedFieldValidValue>>of(new ArrayList<>());
    }
    try {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_VALID_VALUES)public void setValidValues_JsonNullable(JsonNullable<List<IncidentUserDefinedFieldValidValue>> validValues) {
   ...
   */
  @JsonAnySetter
  public IncidentUserDefinedFieldAttributesUpdateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentUserDefinedFieldAttributesUpdateRequest incidentUserDefinedFieldAttributesUpdateRequest = (IncidentUserDefinedFieldAttributesUpdateRequest) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category,collected,defaultValue,displayName,ordinal,required,validValues, additionalProperties);
  }
