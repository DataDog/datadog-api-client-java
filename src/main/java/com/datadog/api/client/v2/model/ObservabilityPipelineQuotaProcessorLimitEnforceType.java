 ...
 */
@JsonSerialize(using = ObservabilityPipelineQuotaProcessorLimitEnforceType.ObservabilityPipelineQuotaProcessorLimitEnforceTypeSerializer.class)
public class ObservabilityPipelineQuotaProcessorLimitEnforceType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("bytes", "events"));
  ...
  public static class ObservabilityPipelineQuotaProcessorLimitEnforceTypeSerializer extends StdSerializer<ObservabilityPipelineQuotaProcessorLimitEnforceType> {
      public ObservabilityPipelineQuotaProcessorLimitEnforceTypeSerializer(Class<ObservabilityPipelineQuotaProcessorLimitEnforceType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(ObservabilityPipelineQuotaProcessorLimitEnforceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
