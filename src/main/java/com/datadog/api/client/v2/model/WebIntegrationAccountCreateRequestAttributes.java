...
/**
   * <p>Attributes object for creating a web integration account.</p>
 */
@JsonPropertyOrder({
...
public class WebIntegrationAccountCreateRequestAttributes {
  ...
  /**
   * <p>A human-readable name for the account. Must be unique among accounts of the same integration.</p>
   * @return name
  **/
  ...
  public WebIntegrationAccountCreateRequestAttributes putSecretsItem(String key, Object secretsItem) {
    this.secrets.put(key, secretsItem);
    return this;
  }

  /**
   * <p>Integration-specific secrets. The shape of this object varies by integration. Secrets
   * are write-only and never returned by the API.</p>
   * @return secrets
  **/
  ...
  public WebIntegrationAccountCreateRequestAttributes putSettingsItem(String key, Object settingsItem) {
    this.settings.put(key, settingsItem);
    return this;
  }

  /**
   * <p>Integration-specific settings. The shape of this object varies by integration.</p>
   * @return settings
  **/
   ...
   */
  @JsonAnySetter
  public WebIntegrationAccountCreateRequestAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    WebIntegrationAccountCreateRequestAttributes webIntegrationAccountCreateRequestAttributes = (WebIntegrationAccountCreateRequestAttributes) o;
    return Objects.equals(this.name, webIntegrationAccountCreateRequestAttributes.name) && Objects.equals(this.secrets, webIntegrationAccountCreateRequestAttributes.secrets) && Objects.equals(this.settings, webIntegrationAccountCreateRequestAttributes.settings) && Objects.equals(this.additionalProperties, webIntegrationAccountCreateRequestAttributes.additionalProperties);
  }
