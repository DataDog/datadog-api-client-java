...
/**
   * <p>Object for a single security filter.</p>
 */
@JsonPropertyOrder({
...
public class SecurityFilterCreateData {
  ...
  @JsonCreator
  public SecurityFilterCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SecurityFilterCreateAttributes attributes,
  ...
  /**
   * <p>Object containing the attributes of the security filter to be created.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, securityFilterCreateData.attributes) && Objects.equals(this.type, securityFilterCreateData.type) && Objects.equals(this.additionalProperties, securityFilterCreateData.additionalProperties);
  }
