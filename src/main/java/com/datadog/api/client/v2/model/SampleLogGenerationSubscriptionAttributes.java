...
public class SampleLogGenerationSubscriptionAttributes {
  ...
  public SampleLogGenerationSubscriptionAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)SampleLogGenerationSubscriptionStatus status) {
  ...
  /**
   * <p>The identifier of the Cloud SIEM content pack the subscription targets.</p>
  ...
  **/
  ...
  /**
   * <p>The time at which the subscription was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The time at which the subscription expires and stops generating logs.</p>
   * @return expiresAt
  **/
  ...
  /**
   * <p>Whether the subscription is currently active and generating logs.</p>
   * @return isActive
  **/
  ...
  public SampleLogGenerationSubscriptionAttributes status(SampleLogGenerationSubscriptionStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SampleLogGenerationSubscriptionAttributes sampleLogGenerationSubscriptionAttributes = (SampleLogGenerationSubscriptionAttributes) o;
    return Objects.equals(this.contentPackId, sampleLogGenerationSubscriptionAttributes.contentPackId) && Objects.equals(this.createdAt, sampleLogGenerationSubscriptionAttributes.createdAt) && Objects.equals(this.expiresAt, sampleLogGenerationSubscriptionAttributes.expiresAt) && Objects.equals(this.isActive, sampleLogGenerationSubscriptionAttributes.isActive) && Objects.equals(this.status, sampleLogGenerationSubscriptionAttributes.status) && Objects.equals(this.additionalProperties, sampleLogGenerationSubscriptionAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(contentPackId,createdAt,expiresAt,isActive,status, additionalProperties);
  }
