...
/**
   * <p>Information about the Private Action Runner used by the custom connection, if the custom connection is associated with a Private Action Runner.</p>
 */
@JsonPropertyOrder({
...
public class CustomConnectionAttributesOnPremRunner {
  ...
  /**
   * <p>The Private Action Runner ID.</p>
   * @return id
  **/
  ...
  /**
   * <p>The URL of the Private Action Runner.</p>
   * @return url
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    CustomConnectionAttributesOnPremRunner customConnectionAttributesOnPremRunner = (CustomConnectionAttributesOnPremRunner) o;
    return Objects.equals(this.id, customConnectionAttributesOnPremRunner.id) && Objects.equals(this.url, customConnectionAttributesOnPremRunner.url) && Objects.equals(this.additionalProperties, customConnectionAttributesOnPremRunner.additionalProperties);
  }
