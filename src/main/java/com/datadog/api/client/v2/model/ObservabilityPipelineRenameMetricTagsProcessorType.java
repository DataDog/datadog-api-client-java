...
public class ObservabilityPipelineRenameMetricTagsProcessorType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("rename_metric_tags"));
  ...
  public static class ObservabilityPipelineRenameMetricTagsProcessorTypeSerializer
      extends StdSerializer<ObservabilityPipelineRenameMetricTagsProcessorType> {
    public ObservabilityPipelineRenameMetricTagsProcessorTypeSerializer(
        Class<ObservabilityPipelineRenameMetricTagsProcessorType> t) {
      super(t);
    }
