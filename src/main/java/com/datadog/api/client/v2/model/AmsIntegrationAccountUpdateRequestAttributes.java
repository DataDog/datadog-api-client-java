...
public class AmsIntegrationAccountUpdateRequestAttributes {
  ...
  public AmsIntegrationAccountUpdateRequestAttributes secrets(Map<String, Object> secrets) {
  ...
  public AmsIntegrationAccountUpdateRequestAttributes settings(Map<String, Object> settings) {
