...
/**
   * <p>Request body for creating or updating a widget.</p>
 */
@JsonPropertyOrder({
  CreateOrUpdateWidgetRequest.JSON_PROPERTY_DATA
})
...
public class CreateOrUpdateWidgetRequest {
  ...
  @JsonCreator
  public CreateOrUpdateWidgetRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)CreateOrUpdateWidgetRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createOrUpdateWidgetRequest.data) && Objects.equals(this.additionalProperties, createOrUpdateWidgetRequest.additionalProperties);
  }
