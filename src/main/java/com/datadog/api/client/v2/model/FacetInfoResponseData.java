...
/**
   * <p>The data object containing the resource type and attributes for the facet info response.</p>
 */
@JsonPropertyOrder({
...
public class FacetInfoResponseData {
  ...
  /**
   * <p>Attributes of the facet info response, containing the facet result data.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Unique identifier for the facet info response resource.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Users facet info resource type.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, facetInfoResponseData.attributes) && Objects.equals(this.id, facetInfoResponseData.id) && Objects.equals(this.type, facetInfoResponseData.type) && Objects.equals(this.additionalProperties, facetInfoResponseData.additionalProperties);
  }
