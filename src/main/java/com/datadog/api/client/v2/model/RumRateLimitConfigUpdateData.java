...
/**
   * <p>The RUM rate limit configuration to create or update.</p>
 */
@JsonPropertyOrder({
...
public class RumRateLimitConfigUpdateData {
  ...
  @JsonCreator
  public RumRateLimitConfigUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RumRateLimitConfigUpdateAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The identifier of the scope the rate limit configuration applies to.
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, rumRateLimitConfigUpdateData.attributes) && Objects.equals(this.id, rumRateLimitConfigUpdateData.id) && Objects.equals(this.type, rumRateLimitConfigUpdateData.type) && Objects.equals(this.additionalProperties, rumRateLimitConfigUpdateData.additionalProperties);
  }
