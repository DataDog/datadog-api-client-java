...
public class SecurityMonitoringContentPackStateMeta {
  ...
  public SecurityMonitoringContentPackStateMeta cloudSiemIndexIncorrect(Boolean cloudSiemIndexIncorrect) {
    this.cloudSiemIndexIncorrect = cloudSiemIndexIncorrect;
    return this;
  }

  /**
   * <p>Whether the Cloud SIEM index configuration is incorrect for the organization.</p>
  ...
  **/
  ...
  /**
   * <p>The number of months that standard logs are retained for organizations on the standalone_indexed` pricing model. This field is omitted for other pricing models.</p>
   * maximum: 60
  ...
  **/
  ...
  /**
   * <p>The Cloud SIEM pricing model (SKU) for the organization.</p>
   * @return sku
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringContentPackStateMeta securityMonitoringContentPackStateMeta = (SecurityMonitoringContentPackStateMeta) o;
    return Objects.equals(this.cloudSiemIndexIncorrect, securityMonitoringContentPackStateMeta.cloudSiemIndexIncorrect) && Objects.equals(this.retentionMonths, securityMonitoringContentPackStateMeta.retentionMonths) && Objects.equals(this.sku, securityMonitoringContentPackStateMeta.sku) && Objects.equals(this.additionalProperties, securityMonitoringContentPackStateMeta.additionalProperties);
  }
