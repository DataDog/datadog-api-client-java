...
public class ProductAnalyticsJoinKeys {
  ...
  /**
   * <p>Primary identity join key. Defaults to <code>@session.id</code>.</p>
   * @return primary
  **/
  ...
  /**
   * <p>Additional identity join keys.</p>
   * @return secondary
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.primary, productAnalyticsJoinKeys.primary) && Objects.equals(this.secondary, productAnalyticsJoinKeys.secondary) && Objects.equals(this.additionalProperties, productAnalyticsJoinKeys.additionalProperties);
  }
