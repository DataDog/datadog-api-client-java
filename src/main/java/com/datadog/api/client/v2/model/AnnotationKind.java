...
public class AnnotationKind extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("pointInTime", "timeRegion"));
  ...
  public static class AnnotationKindSerializer extends StdSerializer<AnnotationKind> {
      ...
      @Override
      public void serialize(AnnotationKind value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
