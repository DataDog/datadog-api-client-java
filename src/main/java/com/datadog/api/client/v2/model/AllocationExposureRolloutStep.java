...
/**
   * <p>Exposure progression step details.</p>
 */
@JsonPropertyOrder({
...
public class AllocationExposureRolloutStep {
  ...
  public AllocationExposureRolloutStep(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_GROUPED_STEP_INDEX)Long groupedStepIndex,
  ...
  /**
   * <p>The progressive rollout ID this step belongs to.</p>
  ...
  **/
  ...
  /**
   * <p>The timestamp when the progression step was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The exposure ratio for this step.</p>
   * minimum: 0
   * maximum: 1
  ...
  **/
  ...
  /**
   * <p>Logical index grouping related steps.</p>
   * minimum: 0
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the progression step.</p>
   * @return id
  **/
  ...
  /**
   * <p>Step duration in milliseconds.</p>
   * @return intervalMs
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INTERVAL_MS)public void setIntervalMs_JsonNullable(JsonNullable<Long> intervalMs) {
  ...
  /**
   * <p>Whether this step represents a pause record.</p>
  ...
  **/
  ...
  /**
   * <p>Sort order for the progression step.</p>
  ...
  **/
  ...
  /**
   * <p>The timestamp when the progression step was last updated.</p>
   * @return updatedAt
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allocationExposureScheduleId,createdAt,exposureRatio,groupedStepIndex,id,intervalMs,isPauseRecord,orderPosition,updatedAt, additionalProperties);
  }
