...
public class IntegrationServiceNow {
  ...
  **/
  ...
  /**
   * <p>Whether ServiceNow integration is enabled.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
