...
/**
   * <p>Response containing a single report schedule.</p>
 */
@JsonPropertyOrder({
  ReportScheduleResponse.JSON_PROPERTY_DATA,
...
public class ReportScheduleResponse {
  ...
  private ReportScheduleResponseData data;
  ...
  @JsonCreator
  public ReportScheduleResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ReportScheduleResponseData data) {
        this.data = data;
  ...
  **/
  ...
  /**
   * <p>Related resources included with the report schedule, such as the author.</p>
   * @return included
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleResponse reportScheduleResponse = (ReportScheduleResponse) o;
    return Objects.equals(this.data, reportScheduleResponse.data) && Objects.equals(this.included, reportScheduleResponse.included) && Objects.equals(this.additionalProperties, reportScheduleResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportScheduleResponse {\n");
