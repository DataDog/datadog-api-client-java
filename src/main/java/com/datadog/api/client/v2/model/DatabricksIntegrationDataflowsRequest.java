 ...
 * created; on update, omitted fields keep their current values. Some dataflows have prerequisites,
 * noted on each; unless one is documented as rejecting the request, it is not verified, so a
