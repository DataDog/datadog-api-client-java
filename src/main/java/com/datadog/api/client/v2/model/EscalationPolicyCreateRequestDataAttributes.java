...
public class EscalationPolicyCreateRequestDataAttributes {
  ...
  public EscalationPolicyCreateRequestDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STEPS)List<EscalationPolicyCreateRequestDataAttributesStepsItems> steps) {
        this.name = name;
        this.steps = steps;
  }
  ...
  /**
   * <p>Specifies the name for the new escalation policy.</p>
   * @return name
  **/
  ...
  **/
  ...
  /**
   * <p>A list of escalation steps, each defining assignment, escalation timeout, and targets for the new policy.</p>
   * @return steps
  **/
  ...
  public boolean equals(Object o) {
    ...
    EscalationPolicyCreateRequestDataAttributes escalationPolicyCreateRequestDataAttributes = (EscalationPolicyCreateRequestDataAttributes) o;
    return Objects.equals(this.name, escalationPolicyCreateRequestDataAttributes.name) && Objects.equals(this.resolvePageOnPolicyEnd, escalationPolicyCreateRequestDataAttributes.resolvePageOnPolicyEnd) && Objects.equals(this.retries, escalationPolicyCreateRequestDataAttributes.retries) && Objects.equals(this.steps, escalationPolicyCreateRequestDataAttributes.steps) && Objects.equals(this.additionalProperties, escalationPolicyCreateRequestDataAttributes.additionalProperties);
  }
