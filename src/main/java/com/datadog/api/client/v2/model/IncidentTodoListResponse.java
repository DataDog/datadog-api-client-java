...
/**
   * <p>Response with a list of incident todos.</p>
 */
@JsonPropertyOrder({
...
public class IncidentTodoListResponse {
  ...
  @JsonCreator
  public IncidentTodoListResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<IncidentTodoResponseData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>An array of incident todos.</p>
   * @return data
  **/
  ...
  **/
   ...
   */
  @JsonAnySetter
  public IncidentTodoListResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, incidentTodoListResponse.data) && Objects.equals(this.included, incidentTodoListResponse.included) && Objects.equals(this.meta, incidentTodoListResponse.meta) && Objects.equals(this.additionalProperties, incidentTodoListResponse.additionalProperties);
  }
