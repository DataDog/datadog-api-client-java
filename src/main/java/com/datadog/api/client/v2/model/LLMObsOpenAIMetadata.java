...
public class LLMObsOpenAIMetadata {
  ...
  private JsonNullable<LLMObsOpenAIReasoningEffort> reasoningEffort = JsonNullable.<LLMObsOpenAIReasoningEffort>undefined();

  public static final String JSON_PROPERTY_REASONING_SUMMARY = "reasoning_summary";
  private JsonNullable<LLMObsOpenAIReasoningSummary> reasoningSummary = JsonNullable.<LLMObsOpenAIReasoningSummary>undefined();
  ...
  /**
   * <p>The reasoning effort level for OpenAI models that support it.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REASONING_EFFORT)public void setReasoningEffort_JsonNullable(JsonNullable<LLMObsOpenAIReasoningEffort> reasoningEffort) {
  ...
  /**
   * <p>The verbosity of the reasoning summary.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_REASONING_SUMMARY)public void setReasoningSummary_JsonNullable(JsonNullable<LLMObsOpenAIReasoningSummary> reasoningSummary) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reasoningEffort, llmObsOpenAiMetadata.reasoningEffort) && Objects.equals(this.reasoningSummary, llmObsOpenAiMetadata.reasoningSummary) && Objects.equals(this.additionalProperties, llmObsOpenAiMetadata.additionalProperties);
  }
