...
public class EmailType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("emails"));
  ...
  public static class EmailTypeSerializer extends StdSerializer<EmailType> {
    public EmailTypeSerializer(Class<EmailType> t) {
      super(t);
    }
