...
public class StatusPageDataAttributes {
  ...
  @JsonProperty(JSON_PROPERTY_COMPANY_LOGO)
  public void setCompanyLogo_JsonNullable(JsonNullable<String> companyLogo) {
  ...
  @JsonProperty(JSON_PROPERTY_EMAIL_HEADER_IMAGE)
  public void setEmailHeaderImage_JsonNullable(JsonNullable<String> emailHeaderImage) {
  ...
  @JsonProperty(JSON_PROPERTY_FAVICON)
  public void setFavicon_JsonNullable(JsonNullable<String> favicon) {
