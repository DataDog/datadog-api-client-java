...
public class SnapshotDataAttributes {
  ...
  /**
   * <p>Unique identifier of the RUM application.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp when the snapshot was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Display name of the user who created the snapshot.</p>
   * @return createdBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Email handle of the user who created the snapshot.</p>
  ...
  **/
  ...
  /**
   * <p>Numeric identifier of the user who created the snapshot.</p>
  ...
  **/
  ...
  /**
   * <p>Device type used when capturing the snapshot (e.g., desktop, mobile, tablet).</p>
   * @return deviceType
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier of the RUM event associated with the snapshot.</p>
   * @return eventId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Indicates whether the device type was explicitly selected by the user rather than auto-detected.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp when the snapshot was last modified.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Numeric identifier of the organization that owns the snapshot.</p>
   * @return orgId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier of the RUM session associated with the snapshot.</p>
   * @return sessionId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Human-readable name for the snapshot.</p>
   * @return snapshotName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Offset in milliseconds from the start of the session at which the snapshot was captured.</p>
   * @return start
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier of the RUM view associated with the snapshot.</p>
   * @return viewId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>URL path or name of the view where the snapshot was captured.</p>
   * @return viewName
  **/
      @jakarta.annotation.Nullable
