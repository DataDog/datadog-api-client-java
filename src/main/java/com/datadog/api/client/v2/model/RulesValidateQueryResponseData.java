...
public class RulesValidateQueryResponseData {
  ...
  private RulesValidateQueryResponseDataType type =
  ...
  public RulesValidateQueryResponseData(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          RulesValidateQueryResponseDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
  }

  public RulesValidateQueryResponseData attributes(
      RulesValidateQueryResponseDataAttributes attributes) {
  ...
  /**
   * The <code>RulesValidateQueryResponseData</code> <code>id</code>.
   *
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    RulesValidateQueryResponseData rulesValidateQueryResponseData =
        (RulesValidateQueryResponseData) o;
    return Objects.equals(this.attributes, rulesValidateQueryResponseData.attributes)
        && Objects.equals(this.id, rulesValidateQueryResponseData.id)
        && Objects.equals(this.type, rulesValidateQueryResponseData.type)
        && Objects.equals(
            this.additionalProperties, rulesValidateQueryResponseData.additionalProperties);
  }
