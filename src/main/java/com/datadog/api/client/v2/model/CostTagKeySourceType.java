...
public class CostTagKeySourceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("cost_tag_key_source"));

  public static final CostTagKeySourceType COST_TAG_KEY_SOURCE = new CostTagKeySourceType("cost_tag_key_source");
  ...
  public static class CostTagKeySourceTypeSerializer extends StdSerializer<CostTagKeySourceType> {
      ...
      @Override
      public void serialize(CostTagKeySourceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
