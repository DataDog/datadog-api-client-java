...
public class OAuthScopesRestrictionResponseData {
  ...
  private OAuthScopesRestrictionType type = OAuthScopesRestrictionType.SCOPES_RESTRICTION;
   ...
   * @return OAuthScopesRestrictionResponseData
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class OAuthScopesRestrictionResponseData {\n");
