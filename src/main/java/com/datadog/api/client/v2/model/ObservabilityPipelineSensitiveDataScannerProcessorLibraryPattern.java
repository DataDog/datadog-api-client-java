...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorLibraryPattern</code>
 * object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorLibraryPattern {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorLibraryPatternOptions
   * </code> object.
   *
   * @return options
   */
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorLibraryPatternType
   * </code> object.
   *
   * @return type
   */
