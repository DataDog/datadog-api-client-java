...
/**
   * <p>Narrows a retention query to a single cell, at the intersection of one cohort and one return period.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsRetentionCellScope {
  ...
  @JsonCreator
  public ProductAnalyticsRetentionCellScope(
            @JsonProperty(required=true, value=JSON_PROPERTY_COHORT_TARGET)ProductAnalyticsRetentionCohortTarget cohortTarget,
            @JsonProperty(required=true, value=JSON_PROPERTY_RETURN_PERIOD_TARGET)ProductAnalyticsRetentionIndexTarget returnPeriodTarget,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ProductAnalyticsRetentionCellScopeType type) {
  ...
  **/
  ...
  /**
   * <p>The discriminator identifying a scope narrowed to one grid cell.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsRetentionCellScope productAnalyticsRetentionCellScope = (ProductAnalyticsRetentionCellScope) o;
    return Objects.equals(this.cohortTarget, productAnalyticsRetentionCellScope.cohortTarget) && Objects.equals(this.returnPeriodTarget, productAnalyticsRetentionCellScope.returnPeriodTarget) && Objects.equals(this.type, productAnalyticsRetentionCellScope.type) && Objects.equals(this.additionalProperties, productAnalyticsRetentionCellScope.additionalProperties);
  }
