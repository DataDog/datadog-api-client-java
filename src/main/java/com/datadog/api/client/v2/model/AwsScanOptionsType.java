...
public class AwsScanOptionsType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("aws_scan_options"));

  public static final AwsScanOptionsType AWS_SCAN_OPTIONS = new AwsScanOptionsType("aws_scan_options");
  ...
  public static class AwsScanOptionsTypeSerializer extends StdSerializer<AwsScanOptionsType> {
      ...
      @Override
      public void serialize(AwsScanOptionsType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
