...
/**
   * <p>Progressive release details for a targeting rule allocation.</p>
 */
@JsonPropertyOrder({
...
public class AllocationExposureSchedule {
  ...
  public static final String JSON_PROPERTY_GUARDRAIL_TRIGGERED_ACTION = "guardrail_triggered_action";
  ...
  public AllocationExposureSchedule(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_GUARDRAIL_TRIGGERS)List<AllocationExposureGuardrailTrigger> guardrailTriggers,
            @JsonProperty(required=true, value=JSON_PROPERTY_ROLLOUT_OPTIONS)RolloutOptions rolloutOptions,
            @JsonProperty(required=true, value=JSON_PROPERTY_ROLLOUT_STEPS)List<AllocationExposureRolloutStep> rolloutSteps,
  ...
  /**
   * <p>The absolute UTC start time for this schedule.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ABSOLUTE_START_TIME)public void setAbsoluteStartTime_JsonNullable(JsonNullable<OffsetDateTime> absoluteStartTime) {
  ...
  /**
   * <p>The targeting rule allocation ID this progressive rollout belongs to.</p>
   * @return allocationId
  **/
  ...
  /**
   * <p>The control variant ID used for experiment comparisons.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CONTROL_VARIANT_ID)public void setControlVariantId_JsonNullable(JsonNullable<String> controlVariantId) {
  ...
  /**
   * <p>The timestamp when the schedule was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Last guardrail action triggered for this schedule.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_GUARDRAIL_TRIGGERED_ACTION)public void setGuardrailTriggeredAction_JsonNullable(JsonNullable<String> guardrailTriggeredAction) {
  ...
  /**
   * <p>Guardrail trigger records for this schedule.</p>
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the progressive rollout.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Applied progression options for a progressive rollout.</p>
  ...
  **/
  ...
  /**
   * <p>Ordered progression steps for exposure.</p>
   * @return rolloutSteps
  **/
  ...
  /**
   * <p>The timestamp when the schedule was last updated.</p>
   * @return updatedAt
  **/
