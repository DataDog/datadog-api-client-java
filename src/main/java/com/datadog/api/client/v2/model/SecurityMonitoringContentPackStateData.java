...
public class SecurityMonitoringContentPackStateData {
  ...
  @JsonCreator
  public SecurityMonitoringContentPackStateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SecurityMonitoringContentPackStateAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SecurityMonitoringContentPackStateType type) {
  ...
  public SecurityMonitoringContentPackStateData attributes(SecurityMonitoringContentPackStateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The content pack identifier.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringContentPackStateData securityMonitoringContentPackStateData = (SecurityMonitoringContentPackStateData) o;
    return Objects.equals(this.attributes, securityMonitoringContentPackStateData.attributes) && Objects.equals(this.id, securityMonitoringContentPackStateData.id) && Objects.equals(this.type, securityMonitoringContentPackStateData.type) && Objects.equals(this.additionalProperties, securityMonitoringContentPackStateData.additionalProperties);
  }
