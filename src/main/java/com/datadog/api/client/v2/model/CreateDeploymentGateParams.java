 ...
 */
@JsonPropertyOrder({
  CreateDeploymentGateParams.JSON_PROPERTY_DATA
})
...
public class CreateDeploymentGateParams {
  ...
  @JsonCreator
  public CreateDeploymentGateParams(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)CreateDeploymentGateParamsData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createDeploymentGateParams.data) && Objects.equals(this.additionalProperties, createDeploymentGateParams.additionalProperties);
  }
