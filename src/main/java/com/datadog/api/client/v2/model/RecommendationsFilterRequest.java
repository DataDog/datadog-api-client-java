...
/**
   * <p>Request body for filtering cost recommendations.</p>
 */
@JsonPropertyOrder({
...
public class RecommendationsFilterRequest {
  ...
  /**
   * <p>Filter expression applied to the recommendations.</p>
   * @return filter
  **/
  ...
  /**
   * <p>Ordered list of sort clauses applied to the result set.</p>
   * @return sort
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Active view name (for example, <code>active</code>, <code>dismissed</code>, <code>open</code>, <code>in-progress</code>, or <code>completed</code>).</p>
   * @return view
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.filter, recommendationsFilterRequest.filter) && Objects.equals(this.sort, recommendationsFilterRequest.sort) && Objects.equals(this.view, recommendationsFilterRequest.view) && Objects.equals(this.additionalProperties, recommendationsFilterRequest.additionalProperties);
  }
