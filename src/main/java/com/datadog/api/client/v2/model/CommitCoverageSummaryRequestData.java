...
/**
   * <p>Data object for commit summary request.</p>
 */
@JsonPropertyOrder({
...
public class CommitCoverageSummaryRequestData {
  ...
  @JsonCreator
  public CommitCoverageSummaryRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CommitCoverageSummaryRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)CommitCoverageSummaryRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public CommitCoverageSummaryRequestData attributes(CommitCoverageSummaryRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CommitCoverageSummaryRequestData commitCoverageSummaryRequestData = (CommitCoverageSummaryRequestData) o;
    return Objects.equals(this.attributes, commitCoverageSummaryRequestData.attributes) && Objects.equals(this.type, commitCoverageSummaryRequestData.type) && Objects.equals(this.additionalProperties, commitCoverageSummaryRequestData.additionalProperties);
  }
