...
public class EventType {
  ...
  public static class EventTypeSerializer extends StdSerializer<EventType> {
      public EventTypeSerializer(Class<EventType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(EventType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
  ...
  public boolean equals(Object o) {
    ...
    return this.value.equals(((EventType) o).value);
  }
