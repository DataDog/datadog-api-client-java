...
public class SecurityMonitoringRuleOptions {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(complianceRuleOptions,decreaseCriticalityBasedOnEnv,detectionMethod,evaluationWindow,hardcodedEvaluatorType,impossibleTravelOptions,keepAlive,maxSignalDuration,newValueOptions);
  }
