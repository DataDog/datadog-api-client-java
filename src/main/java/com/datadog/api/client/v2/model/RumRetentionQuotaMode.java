...
public class RumRetentionQuotaMode extends ModelEnum<String> {
  ...
  public static class RumRetentionQuotaModeSerializer extends StdSerializer<RumRetentionQuotaMode> {
      public RumRetentionQuotaModeSerializer(Class<RumRetentionQuotaMode> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(RumRetentionQuotaMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
