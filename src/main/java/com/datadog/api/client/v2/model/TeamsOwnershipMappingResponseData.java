...
/**
   * <p>The JSON:API data envelope for a teams ownership mapping.</p>
 */
@JsonPropertyOrder({
...
public class TeamsOwnershipMappingResponseData {
  ...
  @JsonCreator
  public TeamsOwnershipMappingResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TeamsOwnershipMappingResponseAttributes attributes,
  ...
  public TeamsOwnershipMappingResponseData attributes(TeamsOwnershipMappingResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingResponseData teamsOwnershipMappingResponseData = (TeamsOwnershipMappingResponseData) o;
    return Objects.equals(this.attributes, teamsOwnershipMappingResponseData.attributes) && Objects.equals(this.id, teamsOwnershipMappingResponseData.id) && Objects.equals(this.type, teamsOwnershipMappingResponseData.type) && Objects.equals(this.additionalProperties, teamsOwnershipMappingResponseData.additionalProperties);
  }
