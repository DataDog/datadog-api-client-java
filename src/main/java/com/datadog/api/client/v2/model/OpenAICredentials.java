...
public class OpenAICredentials extends AbstractOpenApiSchema {
    ...
    public static class OpenAICredentialsSerializer extends StdSerializer<OpenAICredentials> {
        ...
        @Override
        public void serialize(OpenAICredentials value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class OpenAICredentialsDeserializer extends StdDeserializer<OpenAICredentials> {
        ...
        @Override
        public OpenAICredentials deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (OpenAIAPIKey.class.equals(Integer.class) || OpenAIAPIKey.class.equals(Long.class) || OpenAIAPIKey.class.equals(Float.class) || OpenAIAPIKey.class.equals(Double.class) || OpenAIAPIKey.class.equals(Boolean.class) || OpenAIAPIKey.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((OpenAIAPIKey.class.equals(Integer.class) || OpenAIAPIKey.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((OpenAIAPIKey.class.equals(Float.class) || OpenAIAPIKey.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (OpenAIAPIKey.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (OpenAIAPIKey.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
    ...
    /**
     * Get the actual instance of `OpenAIAPIKey`. If the actual instance is not `OpenAIAPIKey`,
