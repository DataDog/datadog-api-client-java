...
public class AWSAccountType extends ModelEnum<String> {
  ...
  public static class AWSAccountTypeSerializer extends StdSerializer<AWSAccountType> {
      public AWSAccountTypeSerializer(Class<AWSAccountType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(AWSAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
