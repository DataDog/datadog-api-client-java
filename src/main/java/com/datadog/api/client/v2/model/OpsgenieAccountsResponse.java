...
/**
   * <p>Response with a list of Opsgenie accounts.</p>
 */
@JsonPropertyOrder({
  OpsgenieAccountsResponse.JSON_PROPERTY_DATA
})
...
public class OpsgenieAccountsResponse {
  ...
  private List<OpsgenieAccountResponseData> data = new ArrayList<>();

  public OpsgenieAccountsResponse() {}

  @JsonCreator
  public OpsgenieAccountsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<OpsgenieAccountResponseData> data) {
        this.data = data;
  ...
  /**
   * <p>An array of Opsgenie accounts.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<OpsgenieAccountResponseData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, opsgenieAccountsResponse.data) && Objects.equals(this.additionalProperties, opsgenieAccountsResponse.additionalProperties);
  }
