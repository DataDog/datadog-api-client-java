...
public class SecurityMonitoringCriticalAssetSeverity extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("info", "low", "medium", "high", "critical", "increase", "decrease", "no-op"));
  ...
  public static final SecurityMonitoringCriticalAssetSeverity NO_OP = new SecurityMonitoringCriticalAssetSeverity("no-op");
