 ...
 */
@JsonPropertyOrder({
  CostTagAttributes.JSON_PROPERTY_SOURCES,
  CostTagAttributes.JSON_PROPERTY_VALUE
})
...
public class CostTagAttributes {
  ...
  /**
   * <p>List of sources that define this tag.</p>
   * @return sources
  **/
  ...
  /**
   * <p>The tag value in <code>key:value</code> format.</p>
   * @return value
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sources, costTagAttributes.sources) && Objects.equals(this.value, costTagAttributes.value) && Objects.equals(this.additionalProperties, costTagAttributes.additionalProperties);
  }
