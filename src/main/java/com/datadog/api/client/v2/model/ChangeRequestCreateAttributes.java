...
/**
   * <p>Attributes for creating a change request.</p>
 */
@JsonPropertyOrder({
...
public class ChangeRequestCreateAttributes {
  ...
  public ChangeRequestCreateAttributes changeRequestLinkedIncidentUuid(String changeRequestLinkedIncidentUuid) {
    this.changeRequestLinkedIncidentUuid = changeRequestLinkedIncidentUuid;
    return this;
  }

  /**
   * <p>The UUID of an incident to link to the change request.</p>
  ...
  **/
  ...
  public ChangeRequestCreateAttributes changeRequestMaintenanceWindowQuery(String changeRequestMaintenanceWindowQuery) {
  ...
  **/
  ...
  public ChangeRequestCreateAttributes changeRequestType(ChangeRequestChangeType changeRequestType) {
  ...
  **/
  ...
  /**
   * <p>The project UUID to associate with the change request.</p>
   * @return projectId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A list of team handles to request decisions from.</p>
