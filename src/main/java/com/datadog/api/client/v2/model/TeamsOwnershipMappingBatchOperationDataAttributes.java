...
/**
 * The attributes of the mapping to add. <code>team_handle</code> and <code>view_name</code> are
 * required when <code>op</code> is <code>add</code>. At least one of <code>service</code> or <code>
 * application_id</code> must be provided.
 */
@JsonPropertyOrder({
