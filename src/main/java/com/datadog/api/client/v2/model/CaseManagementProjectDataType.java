...
public class CaseManagementProjectDataType extends ModelEnum<String> {
  ...
  public static final CaseManagementProjectDataType PROJECTS = new CaseManagementProjectDataType("projects");
  ...
  public static class CaseManagementProjectDataTypeSerializer extends StdSerializer<CaseManagementProjectDataType> {
      ...
      @Override
      public void serialize(CaseManagementProjectDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
