...
public class ReportScheduleListResponseRelationships {
  ...
  private ReportScheduleListResourceRelationship resource;
   ...
   * @return ReportScheduleListResponseRelationships
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class ReportScheduleListResponseRelationships {\n");
