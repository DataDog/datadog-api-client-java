...
public class CustomForecastResponseDataAttributes {
  ...
  public CustomForecastResponseDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_ENTRIES)List<CustomForecastEntry> entries,
  ...
  /**
   * <p>The UUID of the budget that this custom forecast belongs to.</p>
   * @return budgetUid
  **/
  ...
  /**
   * <p>Timestamp the custom forecast was created, in Unix milliseconds.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The id of the user that created the custom forecast.</p>
   * @return createdBy
  **/
  ...
  /**
   * <p>Monthly custom forecast entries.</p>
   * @return entries
  **/
  ...
  /**
   * <p>Timestamp the custom forecast was last updated, in Unix milliseconds.</p>
   * @return updatedAt
  **/
  ...
  /**
   * <p>The id of the user that last updated the custom forecast.</p>
   * @return updatedBy
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomForecastResponseDataAttributes customForecastResponseDataAttributes = (CustomForecastResponseDataAttributes) o;
    return Objects.equals(this.budgetUid, customForecastResponseDataAttributes.budgetUid) && Objects.equals(this.createdAt, customForecastResponseDataAttributes.createdAt) && Objects.equals(this.createdBy, customForecastResponseDataAttributes.createdBy) && Objects.equals(this.entries, customForecastResponseDataAttributes.entries) && Objects.equals(this.updatedAt, customForecastResponseDataAttributes.updatedAt) && Objects.equals(this.updatedBy, customForecastResponseDataAttributes.updatedBy) && Objects.equals(this.additionalProperties, customForecastResponseDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(budgetUid,createdAt,createdBy,entries,updatedAt,updatedBy, additionalProperties);
  }
