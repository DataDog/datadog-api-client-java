...
public class SpansMetricType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("spans_metrics"));
  ...
  public static class SpansMetricTypeSerializer extends StdSerializer<SpansMetricType> {
      ...
      @Override
      public void serialize(SpansMetricType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
