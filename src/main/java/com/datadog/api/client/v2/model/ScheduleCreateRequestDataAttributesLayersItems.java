...
/**
   * <p>Describes a schedule layer, including rotation intervals, members, restrictions, and timeline settings.</p>
 */
@JsonPropertyOrder({
...
public class ScheduleCreateRequestDataAttributesLayersItems {
  ...
  /**
   * <p>The date/time when this layer becomes active (in ISO 8601).</p>
  ...
  **/
  ...
  /**
   * <p>The date/time after which this layer no longer applies (in ISO 8601).</p>
   * @return endDate
  **/
  ...
  **/
  ...
  /**
   * <p>A list of members who participate in this layer's rotation.</p>
   * @return members
  **/
  ...
  **/
  ...
  /**
   * <p>Zero or more time-based restrictions (for example, only weekdays, during business hours).</p>
   * @return restrictions
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The date/time when the rotation for this layer starts (in ISO 8601).</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScheduleCreateRequestDataAttributesLayersItems scheduleCreateRequestDataAttributesLayersItems = (ScheduleCreateRequestDataAttributesLayersItems) o;
    return Objects.equals(this.effectiveDate, scheduleCreateRequestDataAttributesLayersItems.effectiveDate) && Objects.equals(this.endDate, scheduleCreateRequestDataAttributesLayersItems.endDate) && Objects.equals(this.interval, scheduleCreateRequestDataAttributesLayersItems.interval) && Objects.equals(this.members, scheduleCreateRequestDataAttributesLayersItems.members) && Objects.equals(this.name, scheduleCreateRequestDataAttributesLayersItems.name) && Objects.equals(this.restrictions, scheduleCreateRequestDataAttributesLayersItems.restrictions) && Objects.equals(this.rotationStart, scheduleCreateRequestDataAttributesLayersItems.rotationStart) && Objects.equals(this.timeZone, scheduleCreateRequestDataAttributesLayersItems.timeZone) && Objects.equals(this.additionalProperties, scheduleCreateRequestDataAttributesLayersItems.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(effectiveDate,endDate,interval,members,name,restrictions,rotationStart,timeZone, additionalProperties);
  }
