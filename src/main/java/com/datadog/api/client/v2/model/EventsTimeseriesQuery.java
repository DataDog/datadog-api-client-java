...
/**
   * <p>An individual timeseries query for logs, RUM, traces, CI pipelines, security signals, and other event-based data sources. Use this query type for any data source powered by the Events Platform. See the data_source field for the full list of supported sources.</p>
 */
@JsonPropertyOrder({
...
public class EventsTimeseriesQuery {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.compute, eventsTimeseriesQuery.compute) && Objects.equals(this.crossOrgUuids, eventsTimeseriesQuery.crossOrgUuids) && Objects.equals(this.dataSource, eventsTimeseriesQuery.dataSource) && Objects.equals(this.groupBy, eventsTimeseriesQuery.groupBy) && Objects.equals(this.indexes, eventsTimeseriesQuery.indexes) && Objects.equals(this.name, eventsTimeseriesQuery.name) && Objects.equals(this.search, eventsTimeseriesQuery.search) && Objects.equals(this.additionalProperties, eventsTimeseriesQuery.additionalProperties);
  }
