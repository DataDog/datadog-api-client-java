...
/**
   * <p>Supported export format for an Agent Observability dataset.</p>
 */
...
public class LLMObsDatasetExportFormat extends ModelEnum<String> {
  ...
  public static class LLMObsDatasetExportFormatSerializer extends StdSerializer<LLMObsDatasetExportFormat> {
      ...
      @Override
      public void serialize(LLMObsDatasetExportFormat value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
