...
public class ServiceNowIntegrationType extends ModelEnum<String> {
  ...
  public static final ServiceNowIntegrationType SERVICENOW = new ServiceNowIntegrationType("ServiceNow");
  ...
  public static class ServiceNowIntegrationTypeSerializer extends StdSerializer<ServiceNowIntegrationType> {
      ...
      @Override
      public void serialize(ServiceNowIntegrationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
