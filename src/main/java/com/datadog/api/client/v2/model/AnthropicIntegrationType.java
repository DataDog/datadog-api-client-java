...
public class AnthropicIntegrationType extends ModelEnum<String> {
  ...
  public static final AnthropicIntegrationType ANTHROPIC =
      new AnthropicIntegrationType("Anthropic");

  AnthropicIntegrationType(String value) {
    super(value, allowedValues);
  }

  public static class AnthropicIntegrationTypeSerializer
      extends StdSerializer<AnthropicIntegrationType> {
    ...
    public void serialize(
        AnthropicIntegrationType value, JsonGenerator jgen, SerializerProvider provider)
