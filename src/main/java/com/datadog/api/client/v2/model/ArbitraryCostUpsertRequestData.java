...
public class ArbitraryCostUpsertRequestData {
  ...
  private ArbitraryCostUpsertRequestDataType type =
  ...
  public ArbitraryCostUpsertRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ArbitraryCostUpsertRequestDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
  }

  public ArbitraryCostUpsertRequestData attributes(
      ArbitraryCostUpsertRequestDataAttributes attributes) {
  ...
  /**
   * The <code>ArbitraryCostUpsertRequestData</code> <code>id</code>.
   *
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ArbitraryCostUpsertRequestData arbitraryCostUpsertRequestData =
        (ArbitraryCostUpsertRequestData) o;
    return Objects.equals(this.attributes, arbitraryCostUpsertRequestData.attributes)
        && Objects.equals(this.id, arbitraryCostUpsertRequestData.id)
        && Objects.equals(this.type, arbitraryCostUpsertRequestData.type)
        && Objects.equals(
            this.additionalProperties, arbitraryCostUpsertRequestData.additionalProperties);
  }
