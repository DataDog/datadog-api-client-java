...
/**
   * <p>Attributes describing a directional relationship between two entities (cases, incidents, or pages).</p>
 */
@JsonPropertyOrder({
...
public class CaseLinkAttributes {
  ...
  public CaseLinkAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_CHILD_ENTITY_TYPE)String childEntityType,
            @JsonProperty(required=true, value=JSON_PROPERTY_PARENT_ENTITY_ID)String parentEntityId,
            @JsonProperty(required=true, value=JSON_PROPERTY_PARENT_ENTITY_TYPE)String parentEntityType,
  ...
  /**
   * <p>The UUID of the child (target) entity in the relationship.</p>
  ...
  **/
  ...
  /**
   * <p>The type of the child entity. Allowed values: <code>CASE</code>, <code>INCIDENT</code>, <code>PAGE</code>, <code>AGENT_CONVERSATION</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The UUID of the parent (source) entity in the relationship.</p>
  ...
  **/
  ...
  /**
   * <p>The type of the parent entity. Allowed values: <code>CASE</code>, <code>INCIDENT</code>, <code>PAGE</code>, <code>AGENT_CONVERSATION</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The type of directional relationship. Allowed values: <code>RELATES_TO</code> (bidirectional association), <code>CAUSES</code> (parent causes child), <code>BLOCKS</code> (parent blocks child), <code>DUPLICATES</code> (parent duplicates child), <code>PARENT_OF</code> (hierarchical), <code>SUCCESSOR_OF</code> (sequence), <code>ESCALATES_TO</code> (priority escalation).</p>
   * @return relationship
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.childEntityId, caseLinkAttributes.childEntityId) && Objects.equals(this.childEntityType, caseLinkAttributes.childEntityType) && Objects.equals(this.parentEntityId, caseLinkAttributes.parentEntityId) && Objects.equals(this.parentEntityType, caseLinkAttributes.parentEntityType) && Objects.equals(this.relationship, caseLinkAttributes.relationship) && Objects.equals(this.additionalProperties, caseLinkAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(childEntityId,childEntityType,parentEntityId,parentEntityType,relationship, additionalProperties);
  }
