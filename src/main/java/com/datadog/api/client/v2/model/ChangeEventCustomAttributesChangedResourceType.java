...
public class ChangeEventCustomAttributesChangedResourceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("feature_flag", "metric_configuration"));
  ...
  public static final ChangeEventCustomAttributesChangedResourceType METRIC_CONFIGURATION =
      new ChangeEventCustomAttributesChangedResourceType("metric_configuration");
