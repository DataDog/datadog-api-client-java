 ...
 */
@JsonPropertyOrder({
  MetricsTimeseriesQuery.JSON_PROPERTY_CROSS_ORG_UUIDS,
...
public class MetricsTimeseriesQuery {
  ...
  public MetricsTimeseriesQuery crossOrgUuids(List<String> crossOrgUuids) {
    this.crossOrgUuids = crossOrgUuids;
    return this;
  }
  public MetricsTimeseriesQuery addCrossOrgUuidsItem(String crossOrgUuidsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.crossOrgUuids, metricsTimeseriesQuery.crossOrgUuids) && Objects.equals(this.dataSource, metricsTimeseriesQuery.dataSource) && Objects.equals(this.name, metricsTimeseriesQuery.name) && Objects.equals(this.query, metricsTimeseriesQuery.query) && Objects.equals(this.additionalProperties, metricsTimeseriesQuery.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(crossOrgUuids,dataSource,name,query, additionalProperties);
  }
