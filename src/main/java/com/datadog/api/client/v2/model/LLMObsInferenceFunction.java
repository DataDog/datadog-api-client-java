...
/**
   * <p>A function definition for a tool available to the model.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsInferenceFunction {
  ...
  public LLMObsInferenceFunction(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_PARAMETERS)Map<String, Object> parameters) {
        this.name = name;
  ...
  /**
   * <p>A description of what the function does.</p>
   * @return description
  **/
  ...
  **/
  ...
  /**
   * <p>JSON schema describing the function parameters.</p>
   * @return parameters
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, llmObsInferenceFunction.description) && Objects.equals(this.name, llmObsInferenceFunction.name) && Objects.equals(this.parameters, llmObsInferenceFunction.parameters) && Objects.equals(this.additionalProperties, llmObsInferenceFunction.additionalProperties);
  }
