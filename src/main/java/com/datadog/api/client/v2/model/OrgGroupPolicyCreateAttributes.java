...
/**
   * <p>Attributes for creating an org group policy. If <code>policy_type</code> or <code>enforcement_tier</code> are not provided, they default to <code>org_config</code> and <code>DEFAULT</code> respectively.</p>
 */
@JsonPropertyOrder({
...
public class OrgGroupPolicyCreateAttributes {
  ...
  private OrgGroupPolicyEnforcementTier enforcementTier = OrgGroupPolicyEnforcementTier.OVERRIDE_ALLOWED;
  ...
  /**
   * <p>The policy content as key-value pairs.</p>
   * @return content
  **/
  ...
  public OrgGroupPolicyCreateAttributes enforcementTier(OrgGroupPolicyEnforcementTier enforcementTier) {
  ...
  /**
   * <p>The enforcement tier of the policy. <code>OVERRIDE_ALLOWED</code> means the policy is set but member orgs may mutate it. <code>GROUP_MANAGED</code> means the policy is strictly controlled and mutations are blocked for affected orgs. <code>DELEGATE</code> means each member org controls its own value.</p>
  ...
  **/
  ...
  /**
   * <p>The type of the policy. Only <code>org_config</code> is supported, indicating a policy backed by an organization configuration setting.</p>
   * @return policyType
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    OrgGroupPolicyCreateAttributes orgGroupPolicyCreateAttributes = (OrgGroupPolicyCreateAttributes) o;
    return Objects.equals(this.content, orgGroupPolicyCreateAttributes.content) && Objects.equals(this.enforcementTier, orgGroupPolicyCreateAttributes.enforcementTier) && Objects.equals(this.policyName, orgGroupPolicyCreateAttributes.policyName) && Objects.equals(this.policyType, orgGroupPolicyCreateAttributes.policyType) && Objects.equals(this.additionalProperties, orgGroupPolicyCreateAttributes.additionalProperties);
  }
