...
/**
   * <p>Schema for a Security-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class SecurityTriggerWrapper {
  ...
  @JsonCreator
  public SecurityTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_SECURITY_TRIGGER)SecurityTrigger securityTrigger) {
  ...
  /**
   * <p>Trigger a workflow from a Security Signal or Finding. For automatic triggering a handle must be configured and the workflow must be published.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.securityTrigger, securityTriggerWrapper.securityTrigger) && Objects.equals(this.startStepNames, securityTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, securityTriggerWrapper.additionalProperties);
  }
