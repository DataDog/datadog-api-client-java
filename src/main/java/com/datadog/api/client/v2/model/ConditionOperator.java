...
public class ConditionOperator extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("LT", "LTE", "GT", "GTE", "MATCHES", "NOT_MATCHES", "ONE_OF", "NOT_ONE_OF", "IS_NULL", "EQUALS"));
  ...
  public static class ConditionOperatorSerializer extends StdSerializer<ConditionOperator> {
      ...
      @Override
      public void serialize(ConditionOperator value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
