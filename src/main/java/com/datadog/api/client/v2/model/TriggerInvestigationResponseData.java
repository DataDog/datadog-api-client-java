...
/**
   * <p>Data for the trigger investigation response.</p>
 */
@JsonPropertyOrder({
...
public class TriggerInvestigationResponseData {
  ...
  @JsonCreator
  public TriggerInvestigationResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TriggerInvestigationResponseDataAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)TriggerInvestigationResponseType type) {
  ...
  public TriggerInvestigationResponseData attributes(TriggerInvestigationResponseDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for the trigger investigation response.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Unique identifier for the trigger response.</p>
   * @return id
  **/
  ...
  /**
   * <p>The resource type for trigger investigation responses.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    TriggerInvestigationResponseData triggerInvestigationResponseData = (TriggerInvestigationResponseData) o;
    return Objects.equals(this.attributes, triggerInvestigationResponseData.attributes) && Objects.equals(this.id, triggerInvestigationResponseData.id) && Objects.equals(this.type, triggerInvestigationResponseData.type) && Objects.equals(this.additionalProperties, triggerInvestigationResponseData.additionalProperties);
  }
