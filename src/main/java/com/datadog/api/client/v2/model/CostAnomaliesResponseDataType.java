...
public class CostAnomaliesResponseDataType extends ModelEnum<String> {
  ...
  public static final CostAnomaliesResponseDataType ANOMALIES = new CostAnomaliesResponseDataType("anomalies");
  ...
  public static class CostAnomaliesResponseDataTypeSerializer extends StdSerializer<CostAnomaliesResponseDataType> {
      ...
      @Override
      public void serialize(CostAnomaliesResponseDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
