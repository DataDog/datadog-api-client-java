 ...
 */
@JsonSerialize(using = ServiceDefinitionV2Dot1Version.ServiceDefinitionV2Dot1VersionSerializer.class)
public class ServiceDefinitionV2Dot1Version extends ModelEnum<String> {
  ...
  public static final ServiceDefinitionV2Dot1Version V2_1 = new ServiceDefinitionV2Dot1Version("v2.1");
  ...
  public static class ServiceDefinitionV2Dot1VersionSerializer extends StdSerializer<ServiceDefinitionV2Dot1Version> {
      ...
      @Override
      public void serialize(ServiceDefinitionV2Dot1Version value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
