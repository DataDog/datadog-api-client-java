...
public class OrgGroupPolicySortOption extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("id", "-id", "name", "-name"));
  ...
  public static class OrgGroupPolicySortOptionSerializer extends StdSerializer<OrgGroupPolicySortOption> {
      ...
      @Override
      public void serialize(OrgGroupPolicySortOption value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
