...
/** The definition of <code>TenancyConfigData</code> object. */
@JsonPropertyOrder({
...
public class TenancyConfigData {
  ...
  private TenancyConfigDataType type = TenancyConfigDataType.OCI_TENANCY;

  public TenancyConfigData() {}

  @JsonCreator
  public TenancyConfigData(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE) TenancyConfigDataType type) {
    this.type = type;
  ...
  public TenancyConfigData type(TenancyConfigDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  public TenancyConfigDataType getType() {
    return type;
  }

  public void setType(TenancyConfigDataType type) {
    if (!type.isValid()) {
      this.unparsed = true;
    }
    this.type = type;
