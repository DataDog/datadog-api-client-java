...
/**
   * <p>Organization handle for monitor notifications to a Google Chat space within a Google organization.</p>
 */
@JsonPropertyOrder({
  GoogleChatOrganizationHandleResponse.JSON_PROPERTY_DATA
})
...
public class GoogleChatOrganizationHandleResponse {
  ...
  @JsonCreator
  public GoogleChatOrganizationHandleResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)GoogleChatOrganizationHandleResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GoogleChatOrganizationHandleResponse googleChatOrganizationHandleResponse = (GoogleChatOrganizationHandleResponse) o;
    return Objects.equals(this.data, googleChatOrganizationHandleResponse.data) && Objects.equals(this.additionalProperties, googleChatOrganizationHandleResponse.additionalProperties);
  }
