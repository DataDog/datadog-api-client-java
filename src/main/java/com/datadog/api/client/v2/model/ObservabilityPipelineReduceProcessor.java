...
/**
   * <p>The <code>reduce</code> processor aggregates and merges logs based on matching keys and merge strategies.</p>
...
public class ObservabilityPipelineReduceProcessor {
  ...
  private List<ObservabilityPipelineReduceProcessorMergeStrategy> mergeStrategies = new ArrayList<>();

  public static final String JSON_PROPERTY_TYPE = "type";
  private ObservabilityPipelineReduceProcessorType type = ObservabilityPipelineReduceProcessorType.REDUCE;
  ...
  public ObservabilityPipelineReduceProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_MERGE_STRATEGIES)List<ObservabilityPipelineReduceProcessorMergeStrategy> mergeStrategies,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineReduceProcessorType type) {
  ...
  **/
  ...
  /**
   * <p>A list of fields used to group log events for merging.</p>
   * @return groupBy
  **/
  ...
  **/
  ...
  public ObservabilityPipelineReduceProcessor mergeStrategies(List<ObservabilityPipelineReduceProcessorMergeStrategy> mergeStrategies) {
    this.mergeStrategies = mergeStrategies;
  ...
  public ObservabilityPipelineReduceProcessor addMergeStrategiesItem(ObservabilityPipelineReduceProcessorMergeStrategy mergeStrategiesItem) {
  ...
  /**
   * <p>List of merge strategies defining how values from grouped events should be combined.</p>
  ...
  **/
  ...
  public void setMergeStrategies(List<ObservabilityPipelineReduceProcessorMergeStrategy> mergeStrategies) {
    this.mergeStrategies = mergeStrategies;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>reduce</code>.</p>
   * @return type
  **/
