...
public class LLMObsOpenAIReasoningEffort extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("none", "low", "medium", "high", "xhigh"));
  ...
  public static final LLMObsOpenAIReasoningEffort MEDIUM = new LLMObsOpenAIReasoningEffort("medium");
  ...
  public static class LLMObsOpenAIReasoningEffortSerializer extends StdSerializer<LLMObsOpenAIReasoningEffort> {
      ...
      @Override
      public void serialize(LLMObsOpenAIReasoningEffort value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
