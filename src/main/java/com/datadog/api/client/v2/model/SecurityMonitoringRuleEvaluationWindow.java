...
public class SecurityMonitoringRuleEvaluationWindow extends ModelEnum<Integer> {
  ...
  public static final SecurityMonitoringRuleEvaluationWindow THREE_HOURS = new SecurityMonitoringRuleEvaluationWindow(10800);
  public static final SecurityMonitoringRuleEvaluationWindow SIX_HOURS = new SecurityMonitoringRuleEvaluationWindow(21600);
  public static final SecurityMonitoringRuleEvaluationWindow TWELVE_HOURS = new SecurityMonitoringRuleEvaluationWindow(43200);
  public static final SecurityMonitoringRuleEvaluationWindow ONE_DAY = new SecurityMonitoringRuleEvaluationWindow(86400);
