...
/**
   * <p>Defines a rule for detecting sensitive data, including matching pattern, scope, and the action to take.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorRule {
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorRule(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_ON_MATCH)ObservabilityPipelineSensitiveDataScannerProcessorAction onMatch,
            @JsonProperty(required=true, value=JSON_PROPERTY_PATTERN)ObservabilityPipelineSensitiveDataScannerProcessorPattern pattern,
            @JsonProperty(required=true, value=JSON_PROPERTY_SCOPE)ObservabilityPipelineSensitiveDataScannerProcessorScope scope,
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorRule keywordOptions(ObservabilityPipelineSensitiveDataScannerProcessorKeywordOptions keywordOptions) {
  ...
  /**
   * <p>Configuration for keywords used to reinforce sensitive data pattern detection.</p>
  ...
  **/
  ...
  public void setKeywordOptions(ObservabilityPipelineSensitiveDataScannerProcessorKeywordOptions keywordOptions) {
    this.keywordOptions = keywordOptions;
  }
  ...
  /**
   * <p>A name identifying the rule.</p>
   * @return name
  **/
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorRule onMatch(ObservabilityPipelineSensitiveDataScannerProcessorAction onMatch) {
    this.onMatch = onMatch;
    this.unparsed |= onMatch.unparsed;
    return this;
  }
  ...
  /**
   * <p>Defines what action to take when sensitive data is matched.</p>
   * @return onMatch
  **/
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorRule pattern(ObservabilityPipelineSensitiveDataScannerProcessorPattern pattern) {
    this.pattern = pattern;
    this.unparsed |= pattern.unparsed;
    return this;
  }
  ...
  /**
   * <p>Pattern detection configuration for identifying sensitive data using either a custom regex or a library reference.</p>
   * @return pattern
  **/
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorRule scope(ObservabilityPipelineSensitiveDataScannerProcessorScope scope) {
    this.scope = scope;
    this.unparsed |= scope.unparsed;
    return this;
  }
  ...
  /**
   * <p>Determines which parts of the log the pattern-matching rule should be applied to.</p>
   * @return scope
  **/
  ...
  /**
   * <p>Tags assigned to this rule for filtering and classification.</p>
   * @return tags
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSensitiveDataScannerProcessorRule putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ObservabilityPipelineSensitiveDataScannerProcessorRule object is equal to o.
   */
  @Override
