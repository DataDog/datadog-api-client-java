...
/** The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorRule</code> object. */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorRule {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorAction</code> object.
   *
   * @return onMatch
   */
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorScope</code> object.
   *
   * @return scope
   */
