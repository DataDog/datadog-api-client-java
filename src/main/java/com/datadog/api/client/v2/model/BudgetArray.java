...
/**
   * <p>An array of budgets.</p>
 */
@JsonPropertyOrder({
  BudgetArray.JSON_PROPERTY_DATA
})
...
public class BudgetArray {
  ...
  @JsonCreator
  public BudgetArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<Budget> data) {
        this.data = data;
  }
  ...
  /**
   * <p>The <code>BudgetArray</code> <code>data</code>.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, budgetArray.data) && Objects.equals(this.additionalProperties, budgetArray.additionalProperties);
  }
