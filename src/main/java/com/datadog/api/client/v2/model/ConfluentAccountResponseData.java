...
/**
   * <p>An API key and API secret pair that represents a Confluent account.</p>
 */
@JsonPropertyOrder({
...
public class ConfluentAccountResponseData {
  ...
  @JsonCreator
  public ConfluentAccountResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ConfluentAccountResponseAttributes attributes,
  ...
  /**
   * <p>The attributes of a Confluent account.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>A randomly generated ID associated with a Confluent account.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, confluentAccountResponseData.attributes) && Objects.equals(this.id, confluentAccountResponseData.id) && Objects.equals(this.type, confluentAccountResponseData.type) && Objects.equals(this.additionalProperties, confluentAccountResponseData.additionalProperties);
  }
