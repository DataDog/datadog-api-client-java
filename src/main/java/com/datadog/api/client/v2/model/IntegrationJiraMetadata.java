...
/**
   * <p>Metadata for connecting a case management project to a Jira project.</p>
 */
@JsonPropertyOrder({
...
public class IntegrationJiraMetadata {
  ...
  /**
   * <p>The Jira account identifier.</p>
   * @return accountId
  **/
  ...
  /**
   * <p>The Jira issue type identifier to use when creating issues.</p>
   * @return issueTypeId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The Jira project identifier to associate with this case project.</p>
   * @return projectId
  **/
      @jakarta.annotation.Nullable
