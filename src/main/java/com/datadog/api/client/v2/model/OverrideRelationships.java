...
@JsonPropertyOrder({OverrideRelationships.JSON_PROPERTY_USER})
...
public class OverrideRelationships {
  ...
  public OverrideRelationships user(OnCallUserRelationship user) {
    this.user = user;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.user, overrideRelationships.user)
