...
/**
 * The definition of <code>UpdateRulesetRequestDataAttributesRulesItemsReferenceTable</code> object.
 */
@JsonPropertyOrder({
...
public class UpdateRulesetRequestDataAttributesRulesItemsReferenceTable {
  ...
  private List<UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable(
      @JsonProperty(required = true, value = JSON_PROPERTY_FIELD_PAIRS)
          List<UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>
              fieldPairs,
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable caseInsensitivity(
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable fieldPairs(
      List<UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems> fieldPairs) {
    this.fieldPairs = fieldPairs;
    for (UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems item :
        fieldPairs) {
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable addFieldPairsItem(
      UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems fieldPairsItem) {
  ...
  public List<UpdateRulesetRequestDataAttributesRulesItemsReferenceTableFieldPairsItems>
      getFieldPairs() {
    return fieldPairs;
  }
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable ifNotExists(
      Boolean ifNotExists) {
  ...
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable addSourceKeysItem(
   ...
   */
  @JsonAnySetter
  public UpdateRulesetRequestDataAttributesRulesItemsReferenceTable putAdditionalProperty(
  ...
  /**
   * Return true if this UpdateRulesetRequestDataAttributesRulesItemsReferenceTable object is equal
   * to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UpdateRulesetRequestDataAttributesRulesItemsReferenceTable
        updateRulesetRequestDataAttributesRulesItemsReferenceTable =
            (UpdateRulesetRequestDataAttributesRulesItemsReferenceTable) o;
    return Objects.equals(
            this.caseInsensitivity,
            updateRulesetRequestDataAttributesRulesItemsReferenceTable.caseInsensitivity)
        && Objects.equals(
            this.fieldPairs, updateRulesetRequestDataAttributesRulesItemsReferenceTable.fieldPairs)
        && Objects.equals(
            this.ifNotExists,
        ...
        && Objects.equals(
            ...
            updateRulesetRequestDataAttributesRulesItemsReferenceTable.additionalProperties);
  }
