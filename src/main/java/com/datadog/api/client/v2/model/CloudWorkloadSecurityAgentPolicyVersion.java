...
public class CloudWorkloadSecurityAgentPolicyVersion {
  ...
  /**
   * <p>The date and time the version was created</p>
   * @return date
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATE)public void setDate_JsonNullable(JsonNullable<String> date) {
    this.date = date;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloudWorkloadSecurityAgentPolicyVersion cloudWorkloadSecurityAgentPolicyVersion = (CloudWorkloadSecurityAgentPolicyVersion) o;
    return Objects.equals(this.date, cloudWorkloadSecurityAgentPolicyVersion.date) && Objects.equals(this.name, cloudWorkloadSecurityAgentPolicyVersion.name) && Objects.equals(this.additionalProperties, cloudWorkloadSecurityAgentPolicyVersion.additionalProperties);
  }
