...
public class LLMObsPatternsRunsResponseData {
  ...
  @JsonCreator
  public LLMObsPatternsRunsResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)LLMObsPatternsRunsResponseAttributes attributes,
  ...
  public LLMObsPatternsRunsResponseData attributes(LLMObsPatternsRunsResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Identifier of the configuration the runs belong to.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsPatternsRunsResponseData llmObsPatternsRunsResponseData = (LLMObsPatternsRunsResponseData) o;
    return Objects.equals(this.attributes, llmObsPatternsRunsResponseData.attributes) && Objects.equals(this.id, llmObsPatternsRunsResponseData.id) && Objects.equals(this.type, llmObsPatternsRunsResponseData.type) && Objects.equals(this.additionalProperties, llmObsPatternsRunsResponseData.additionalProperties);
  }
