...
/**
   * <p>A group-by rule for segmenting results by facet values.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsGroupBy {
  ...
  **/
  ...
  /**
   * <p>Exclude results with missing facet values.</p>
  ...
  **/
  ...
  /**
   * <p>The source for audience-filter-based group-by.</p>
   * @return source
  **/
      @jakarta.annotation.Nullable
