...
public class RUMOperationJourneyCompositeRule {
  ...
  @JsonCreator
  public RUMOperationJourneyCompositeRule(
            @JsonProperty(required=true, value=JSON_PROPERTY_KIND)RUMOperationJourneyCompositeRuleKind kind,
            @JsonProperty(required=true, value=JSON_PROPERTY_PREDICATES)List<RUMOperationJourneyPredicate> predicates) {
        this.kind = kind;
  ...
  /**
   * <p>The unique identifier of the composite rule. Generated by the server if omitted.</p>
  ...
  **/
  ...
  /**
   * <p>A hash of the composite rule's configuration, computed by the server.</p>
  ...
  **/
  ...
  /**
   * <p>The maximum time window, in milliseconds, in which all predicates must match.</p>
   * @return maxWindowMs
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The list of predicates that must be matched by RUM events.</p>
   * @return predicates
  **/
  ...
  public boolean equals(Object o) {
    ...
    RUMOperationJourneyCompositeRule rumOperationJourneyCompositeRule = (RUMOperationJourneyCompositeRule) o;
    return Objects.equals(this.compositeRuleId, rumOperationJourneyCompositeRule.compositeRuleId) && Objects.equals(this.configVersion, rumOperationJourneyCompositeRule.configVersion) && Objects.equals(this.kind, rumOperationJourneyCompositeRule.kind) && Objects.equals(this.maxWindowMs, rumOperationJourneyCompositeRule.maxWindowMs) && Objects.equals(this.predicates, rumOperationJourneyCompositeRule.predicates) && Objects.equals(this.additionalProperties, rumOperationJourneyCompositeRule.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(compositeRuleId,configVersion,kind,maxWindowMs,predicates, additionalProperties);
  }
