...
/**
   * <p>The <code>remove_fields</code> processor deletes specified fields from logs.</p>
...
public class ObservabilityPipelineRemoveFieldsProcessor {
  ...
  private ObservabilityPipelineRemoveFieldsProcessorType type = ObservabilityPipelineRemoveFieldsProcessorType.REMOVE_FIELDS;
  ...
  public ObservabilityPipelineRemoveFieldsProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineRemoveFieldsProcessorType type) {
  ...
  **/
  ...
  /**
   * <p>A list of field names to be removed from each log event.</p>
   * @return fields
  **/
  ...
  **/
  ...
  public ObservabilityPipelineRemoveFieldsProcessor type(ObservabilityPipelineRemoveFieldsProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>remove_fields</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineRemoveFieldsProcessor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineRemoveFieldsProcessor observabilityPipelineRemoveFieldsProcessor = (ObservabilityPipelineRemoveFieldsProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineRemoveFieldsProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineRemoveFieldsProcessor.enabled) && Objects.equals(this.fields, observabilityPipelineRemoveFieldsProcessor.fields) && Objects.equals(this.id, observabilityPipelineRemoveFieldsProcessor.id) && Objects.equals(this.include, observabilityPipelineRemoveFieldsProcessor.include) && Objects.equals(this.type, observabilityPipelineRemoveFieldsProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineRemoveFieldsProcessor.additionalProperties);
  }
