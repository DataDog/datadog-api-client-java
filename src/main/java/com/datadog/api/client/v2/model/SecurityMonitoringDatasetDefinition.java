...
/**
   * <p>The definition of the dataset. The shape depends on the value of <code>data_source</code>.
   * Use <code>reference_table</code> or <code>managed_resource</code> for a referential dataset, or one of the
   * event platform sources (for example <code>logs</code>, <code>audit</code>, <code>events</code>, <code>spans</code>, <code>rum</code>) for
   * an event platform dataset.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringDatasetDefinition {
  ...
  public SecurityMonitoringDatasetDefinition columns(List<SecurityMonitoringDatasetColumn> columns) {
  ...
  public SecurityMonitoringDatasetDefinition addColumnsItem(SecurityMonitoringDatasetColumn columnsItem) {
  ...
  /**
   * <p>For event platform datasets, the list of columns exposed by the dataset.</p>
   * @return columns
  **/
  ...
  /**
   * <p>The data source backing this dataset definition.</p>
   * @return dataSource
  **/
  ...
  /**
   * <p>For event platform datasets, the list of indexes to query.</p>
   * @return indexes
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The unique name of the dataset. Must start with a lowercase letter and contain only lowercase letters, digits, and underscores (max 255 characters).</p>
   * @return name
  **/
  ...
  /**
   * <p>For referential datasets, an optional filter expression applied to the table.</p>
   * @return queryFilter
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The search clause applied to an event platform dataset.</p>
   * @return search
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Storage tier the dataset reads from. Applies to event platform datasets.</p>
   * @return storage
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>For referential datasets, the name of the underlying table.</p>
   * @return tableName
  **/
      @jakarta.annotation.Nullable
  ...
  public SecurityMonitoringDatasetDefinition timeWindow(SecurityMonitoringDatasetTimeWindow timeWindow) {
  ...
  /**
   * <p>An optional time window that overrides the default query time range.</p>
   * @return timeWindow
  **/
      @jakarta.annotation.Nullable
