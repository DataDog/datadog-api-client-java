...
/**
   * <p>The rule type.</p>
 */
@JsonSerialize(using = SecurityMonitoringRuleTypeTest.SecurityMonitoringRuleTypeTestSerializer.class)
public class SecurityMonitoringRuleTypeTest extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("log_detection"));
  ...
  public static class SecurityMonitoringRuleTypeTestSerializer extends StdSerializer<SecurityMonitoringRuleTypeTest> {
      ...
      @Override
      public void serialize(SecurityMonitoringRuleTypeTest value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
