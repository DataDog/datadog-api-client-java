...
public class FleetDeploymentV2DetailAgent {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.error, fleetDeploymentV2DetailAgent.error)
        && Objects.equals(this.hostname, fleetDeploymentV2DetailAgent.hostname)
        && Objects.equals(this.runningStep, fleetDeploymentV2DetailAgent.runningStep)
        && Objects.equals(this.status, fleetDeploymentV2DetailAgent.status)
        && Objects.equals(this.statusDetails, fleetDeploymentV2DetailAgent.statusDetails)
        && Objects.equals(this.versions, fleetDeploymentV2DetailAgent.versions)
        && Objects.equals(
            this.additionalProperties, fleetDeploymentV2DetailAgent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        error, hostname, runningStep, status, statusDetails, versions, additionalProperties);
  }
