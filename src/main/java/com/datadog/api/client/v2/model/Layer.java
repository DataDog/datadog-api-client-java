...
/**
   * <p>Encapsulates a layer resource, holding attributes like rotation details, plus relationships to the members covering that layer.</p>
 */
@JsonPropertyOrder({
...
public class Layer {
  ...
  @JsonCreator
  public Layer(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)LayerType type) {
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>A unique identifier for this layer.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Layer layer = (Layer) o;
    return Objects.equals(this.attributes, layer.attributes) && Objects.equals(this.id, layer.id) && Objects.equals(this.relationships, layer.relationships) && Objects.equals(this.type, layer.type) && Objects.equals(this.additionalProperties, layer.additionalProperties);
  }
