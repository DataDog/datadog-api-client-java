...
/**
   * <p>Defines the main on-call responder object for a team, including relationships and metadata.</p>
 */
@JsonPropertyOrder({
...
public class TeamOnCallRespondersData {
  ...
  @JsonCreator
  public TeamOnCallRespondersData(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)TeamOnCallRespondersDataType type) {
        this.type = type;
  ...
  /**
   * <p>Unique identifier of the on-call responder configuration.</p>
   * @return id
  **/
  ...
  public TeamOnCallRespondersData relationships(TeamOnCallRespondersDataRelationships relationships) {
  ...
  /**
   * <p>Relationship objects linked to a team's on-call responder configuration, including escalations and responders.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, teamOnCallRespondersData.id) && Objects.equals(this.relationships, teamOnCallRespondersData.relationships) && Objects.equals(this.type, teamOnCallRespondersData.type) && Objects.equals(this.additionalProperties, teamOnCallRespondersData.additionalProperties);
  }
