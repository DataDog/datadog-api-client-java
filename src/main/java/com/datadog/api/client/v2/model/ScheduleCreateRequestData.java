...
public class ScheduleCreateRequestData {
  ...
  @JsonCreator
  public ScheduleCreateRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ScheduleCreateRequestDataAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ScheduleCreateRequestDataType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, scheduleCreateRequestData.attributes) && Objects.equals(this.relationships, scheduleCreateRequestData.relationships) && Objects.equals(this.type, scheduleCreateRequestData.type) && Objects.equals(this.additionalProperties, scheduleCreateRequestData.additionalProperties);
  }
