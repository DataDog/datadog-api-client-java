...
public class OAuthScopesRestrictionResponseAttributes {
  ...
  public static final String JSON_PROPERTY_REQUIRED_PERMISSION_SCOPES = "required_permission_scopes";
  ...
  @JsonCreator
  public OAuthScopesRestrictionResponseAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUIRED_PERMISSION_SCOPES)List<String> requiredPermissionScopes,
            @JsonProperty(required=true, value=JSON_PROPERTY_SCOPES_RESTRICTION)OAuthScopesRestriction scopesRestriction) {
  ...
  /**
   * <p>Permission scopes automatically required for this client (for example, mobile-app permission scopes).
   * Returns <code>null</code> when no scopes are required.</p>
  ...
  **/
  ...
  /**
   * <p>Allowlist of OIDC and permission scopes enforced for the OAuth2 client.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OAuthScopesRestrictionResponseAttributes oAuthScopesRestrictionResponseAttributes = (OAuthScopesRestrictionResponseAttributes) o;
    return Objects.equals(this.requiredPermissionScopes, oAuthScopesRestrictionResponseAttributes.requiredPermissionScopes) && Objects.equals(this.scopesRestriction, oAuthScopesRestrictionResponseAttributes.scopesRestriction) && Objects.equals(this.additionalProperties, oAuthScopesRestrictionResponseAttributes.additionalProperties);
  }
