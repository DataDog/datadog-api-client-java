...
public class LLMObsCustomEvalConfigAssessmentCriteria {
  ...
  /**
   * <p>Maximum numeric threshold for a passing result.</p>
   * @return maxThreshold
  **/
  ...
  @JsonProperty(JSON_PROPERTY_MAX_THRESHOLD)public void setMaxThreshold_JsonNullable(JsonNullable<Double> maxThreshold) {
  ...
  /**
   * <p>Minimum numeric threshold for a passing result.</p>
   * @return minThreshold
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_MIN_THRESHOLD)public void setMinThreshold_JsonNullable(JsonNullable<Double> minThreshold) {
  ...
  /**
   * <p>Specific output values considered as a passing result.</p>
   * @return passValues
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_PASS_VALUES)public void setPassValues_JsonNullable(JsonNullable<List<String>> passValues) {
  ...
  /**
   * <p>When true, a boolean output of true is treated as passing.</p>
   * @return passWhen
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_PASS_WHEN)public void setPassWhen_JsonNullable(JsonNullable<Boolean> passWhen) {
  ...
  public boolean equals(Object o) {
    ...
    LLMObsCustomEvalConfigAssessmentCriteria llmObsCustomEvalConfigAssessmentCriteria = (LLMObsCustomEvalConfigAssessmentCriteria) o;
    return Objects.equals(this.maxThreshold, llmObsCustomEvalConfigAssessmentCriteria.maxThreshold) && Objects.equals(this.minThreshold, llmObsCustomEvalConfigAssessmentCriteria.minThreshold) && Objects.equals(this.passValues, llmObsCustomEvalConfigAssessmentCriteria.passValues) && Objects.equals(this.passWhen, llmObsCustomEvalConfigAssessmentCriteria.passWhen) && Objects.equals(this.additionalProperties, llmObsCustomEvalConfigAssessmentCriteria.additionalProperties);
  }
