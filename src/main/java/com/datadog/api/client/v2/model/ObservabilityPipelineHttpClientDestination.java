...
public class ObservabilityPipelineHttpClientDestination {
  ...
  **/
  ...
  public ObservabilityPipelineHttpClientDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
