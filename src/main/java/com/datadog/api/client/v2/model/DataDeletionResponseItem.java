...
/**
   * <p>The created data deletion request information.</p>
 */
@JsonPropertyOrder({
...
public class DataDeletionResponseItem {
  ...
  @JsonCreator
  public DataDeletionResponseItem(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)DataDeletionResponseItemAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The ID of the created data deletion request.</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of the request created.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, dataDeletionResponseItem.attributes) && Objects.equals(this.id, dataDeletionResponseItem.id) && Objects.equals(this.type, dataDeletionResponseItem.type) && Objects.equals(this.additionalProperties, dataDeletionResponseItem.additionalProperties);
  }
