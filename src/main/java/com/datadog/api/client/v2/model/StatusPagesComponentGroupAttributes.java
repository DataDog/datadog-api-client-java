...
public class StatusPagesComponentGroupAttributes {
  ...
  @JsonCreator
  public StatusPagesComponentGroupAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)CreateComponentRequestDataAttributesType type) {
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>Timestamp of when the component was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp of when the component was last modified.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
