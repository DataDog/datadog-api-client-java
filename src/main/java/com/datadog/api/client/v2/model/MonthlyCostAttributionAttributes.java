...
/**
   * <p>Cost Attribution by Tag for a given organization.</p>
 */
@JsonPropertyOrder({
...
public class MonthlyCostAttributionAttributes {
  ...
  **/
  ...
  /**
   * <p>The source of the cost attribution tag configuration and the selected tags in the format <code>&lt;source_org_name&gt;:::&lt;selected tag 1&gt;///&lt;selected tag 2&gt;///&lt;selected tag 3&gt;</code>.</p>
  ...
  **/
  ...
  /**
   * <p>Tag keys and values.
   * A <code>null</code> value here means that the requested tag breakdown cannot be applied because it does not match the <a href="https://docs.datadoghq.com/account_management/billing/usage_attribution/#getting-started">tags
   * configured for usage attribution</a>.
   * In this scenario the API returns the total cost, not broken down by tags.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>Shows the most recent hour in the current months for all organizations for which all costs were calculated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Fields in Cost Attribution by tag(s). Example: <code>infra_host_on_demand_cost</code>, <code>infra_host_committed_cost</code>, <code>infra_host_total_cost</code>, <code>infra_host_percentage_in_org</code>, <code>infra_host_percentage_in_account</code>.</p>
   * @return values
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    MonthlyCostAttributionAttributes monthlyCostAttributionAttributes = (MonthlyCostAttributionAttributes) o;
    return Objects.equals(this.month, monthlyCostAttributionAttributes.month) && Objects.equals(this.orgName, monthlyCostAttributionAttributes.orgName) && Objects.equals(this.publicId, monthlyCostAttributionAttributes.publicId) && Objects.equals(this.tagConfigSource, monthlyCostAttributionAttributes.tagConfigSource) && Objects.equals(this.tags, monthlyCostAttributionAttributes.tags) && Objects.equals(this.updatedAt, monthlyCostAttributionAttributes.updatedAt) && Objects.equals(this.values, monthlyCostAttributionAttributes.values) && Objects.equals(this.additionalProperties, monthlyCostAttributionAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(month,orgName,publicId,tagConfigSource,tags,updatedAt,values, additionalProperties);
  }
