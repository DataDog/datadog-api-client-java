...
public class IncidentUserDefinedFieldResponseData {
  ...
  private IncidentUserDefinedFieldRelationships relationships;
   ...
   * @return IncidentUserDefinedFieldResponseData
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class IncidentUserDefinedFieldResponseData {\n");
