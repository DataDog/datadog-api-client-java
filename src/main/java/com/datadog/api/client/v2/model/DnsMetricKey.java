...
public class DnsMetricKey extends ModelEnum<String> {
  ...
  public static final DnsMetricKey DNS_SUCCESSFUL_RESPONSES =
      new DnsMetricKey("dns_successful_responses");
  ...
  public static final DnsMetricKey DNS_RESPONSES_NXDOMAIN =
      new DnsMetricKey("dns_responses.nxdomain");
  public static final DnsMetricKey DNS_RESPONSES_SERVFAIL =
      new DnsMetricKey("dns_responses.servfail");
  public static final DnsMetricKey DNS_RESPONSES_OTHER = new DnsMetricKey("dns_responses.other");
  public static final DnsMetricKey DNS_SUCCESS_LATENCY_PERCENTILE =
      new DnsMetricKey("dns_success_latency_percentile");
  public static final DnsMetricKey DNS_FAILURE_LATENCY_PERCENTILE =
      new DnsMetricKey("dns_failure_latency_percentile");
  ...
  public static class DnsMetricKeySerializer extends StdSerializer<DnsMetricKey> {
    ...
    @Override
    public void serialize(DnsMetricKey value, JsonGenerator jgen, SerializerProvider provider)
