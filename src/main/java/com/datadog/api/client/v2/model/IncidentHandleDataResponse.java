...
public class IncidentHandleDataResponse {
  ...
  private JsonNullable<IncidentHandleRelationships> relationships = JsonNullable.<IncidentHandleRelationships>undefined();
  ...
  @JsonCreator
  public IncidentHandleDataResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)IncidentHandleAttributesResponse attributes,
  ...
  **/
  ...
  /**
   * <p>The ID of the incident handle</p>
   * @return id
  **/
  ...
  /**
   * <p>Relationships associated with an incident handle response, including linked users and incident type.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_RELATIONSHIPS)public void setRelationships_JsonNullable(JsonNullable<IncidentHandleRelationships> relationships) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, incidentHandleDataResponse.attributes) && Objects.equals(this.id, incidentHandleDataResponse.id) && Objects.equals(this.relationships, incidentHandleDataResponse.relationships) && Objects.equals(this.type, incidentHandleDataResponse.type) && Objects.equals(this.additionalProperties, incidentHandleDataResponse.additionalProperties);
  }
