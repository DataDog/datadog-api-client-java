...
/**
   * <p>Schema for a Slack-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class SlackTriggerWrapper {
  ...
  @JsonCreator
  public SlackTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_SLACK_TRIGGER)SlackTrigger slackTrigger) {
  ...
  /**
   * <p>Trigger a workflow from Slack. The workflow must be published.</p>
   * @return slackTrigger
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.slackTrigger, slackTriggerWrapper.slackTrigger) && Objects.equals(this.startStepNames, slackTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, slackTriggerWrapper.additionalProperties);
  }
