...
/**
   * <p>Object containing the definition of a metric's ingested and indexed volume.</p>
 */
@JsonPropertyOrder({
...
public class MetricIngestedIndexedVolumeAttributes {
  ...
  /**
   * <p>Estimated average hourly number of indexed time series for the given metric over the last hour. For organizations on Metric Name Pricing, this represents the estimated sum of indexed data points over the last hour.</p>
  ...
  **/
  ...
  /**
   * <p>Estimated average hourly number of ingested time series for the given metric over the last hour. This value is <code>0</code> for metrics not configured with Metrics Without Limits. For organizations on Metric Name Pricing, this represents the estimated sum of ingested data points over the last hour.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.indexedVolume, metricIngestedIndexedVolumeAttributes.indexedVolume) && Objects.equals(this.ingestedVolume, metricIngestedIndexedVolumeAttributes.ingestedVolume) && Objects.equals(this.additionalProperties, metricIngestedIndexedVolumeAttributes.additionalProperties);
  }
