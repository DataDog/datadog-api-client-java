...
/**
   * <p>The definition of a configurable parameter on a control or mitigation.</p>
 */
@JsonPropertyOrder({
...
public class GovernanceControlParameterDefinition {
  ...
  public GovernanceControlParameterDefinition(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SUPPORTED_VALUES)List<GovernanceControlSupportedValue> supportedValues,
  ...
  /**
   * <p>The default value of the parameter. The JSON type depends on the parameter's <code>type</code>.</p>
   * @return defaultValue
  **/
  ...
  **/
  ...
  /**
   * <p>Whether the parameter is hidden from the UI.</p>
   * @return hidden
  **/
  ...
  /**
   * <p>The machine-readable name of the parameter.</p>
   * @return name
  **/
  ...
  /**
   * <p>Whether the parameter must be provided.</p>
   * @return required
  **/
  ...
  public GovernanceControlParameterDefinition supportedValues(List<GovernanceControlSupportedValue> supportedValues) {
    this.supportedValues = supportedValues;
    for (GovernanceControlSupportedValue item : supportedValues) {
      this.unparsed |= item.unparsed;
    }
  ...
  public GovernanceControlParameterDefinition addSupportedValuesItem(GovernanceControlSupportedValue supportedValuesItem) {
  ...
  /**
   * <p>The supported values for an enumerated parameter.</p>
  ...
  **/
  ...
  /**
   * <p>The type of the parameter, such as <code>integer</code>, <code>string</code>, <code>boolean</code>, <code>enum</code>, or <code>pattern_list</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    GovernanceControlParameterDefinition governanceControlParameterDefinition = (GovernanceControlParameterDefinition) o;
    return Objects.equals(this.defaultValue, governanceControlParameterDefinition.defaultValue) && Objects.equals(this.description, governanceControlParameterDefinition.description) && Objects.equals(this.displayName, governanceControlParameterDefinition.displayName) && Objects.equals(this.hidden, governanceControlParameterDefinition.hidden) && Objects.equals(this.name, governanceControlParameterDefinition.name) && Objects.equals(this.required, governanceControlParameterDefinition.required) && Objects.equals(this.supportedValues, governanceControlParameterDefinition.supportedValues) && Objects.equals(this.type, governanceControlParameterDefinition.type) && Objects.equals(this.additionalProperties, governanceControlParameterDefinition.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(defaultValue,description,displayName,hidden,name,required,supportedValues,type, additionalProperties);
  }
