...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionPartialRedact
 * </code> object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorActionPartialRedact {
   ...
   * ObservabilityPipelineSensitiveDataScannerProcessorActionPartialRedactAction</code> object.
   *
   * @return action
   */
  ...
  /**
   * The definition of <code>
   * ObservabilityPipelineSensitiveDataScannerProcessorActionPartialRedactOptions</code> object.
   *
   * @return options
   */
