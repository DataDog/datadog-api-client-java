 ...
 */
@JsonPropertyOrder({
  LogsMetricUpdateCompute.JSON_PROPERTY_INCLUDE_PERCENTILES
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class LogsMetricUpdateCompute {
  @JsonIgnore
  ...
  **/
   ...
   * @return LogsMetricUpdateCompute
   */
  @JsonAnySetter
  public LogsMetricUpdateCompute putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LogsMetricUpdateCompute logsMetricUpdateCompute = (LogsMetricUpdateCompute) o;
    return Objects.equals(this.includePercentiles, logsMetricUpdateCompute.includePercentiles) && Objects.equals(this.additionalProperties, logsMetricUpdateCompute.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LogsMetricUpdateCompute {\n");
