...
public class SpansType extends ModelEnum<String> {
  ...
  public static class SpansTypeSerializer extends StdSerializer<SpansType> {
      ...
      @Override
      public void serialize(SpansType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
