...
public class ScalarQuery extends AbstractOpenApiSchema {
    ...
    public static class ScalarQueryDeserializer extends StdDeserializer<ScalarQuery> {
        ...
        public ScalarQuery deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ProcessScalarQuery.class.equals(Integer.class) || ProcessScalarQuery.class.equals(Long.class) || ProcessScalarQuery.class.equals(Float.class) || ProcessScalarQuery.class.equals(Double.class) || ProcessScalarQuery.class.equals(Boolean.class) || ProcessScalarQuery.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ProcessScalarQuery.class.equals(Integer.class) || ProcessScalarQuery.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ProcessScalarQuery.class.equals(Float.class) || ProcessScalarQuery.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ProcessScalarQuery.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ProcessScalarQuery.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ContainerScalarQuery.class.equals(Integer.class) || ContainerScalarQuery.class.equals(Long.class) || ContainerScalarQuery.class.equals(Float.class) || ContainerScalarQuery.class.equals(Double.class) || ContainerScalarQuery.class.equals(Boolean.class) || ContainerScalarQuery.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ContainerScalarQuery.class.equals(Integer.class) || ContainerScalarQuery.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ContainerScalarQuery.class.equals(Float.class) || ContainerScalarQuery.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ContainerScalarQuery.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ContainerScalarQuery.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * MetricsScalarQuery, EventsScalarQuery, ApmResourceStatsQuery, ApmMetricsQuery, ApmDependencyStatsQuery, SloQuery, ProcessScalarQuery, ContainerScalarQuery
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be MetricsScalarQuery, EventsScalarQuery, ApmResourceStatsQuery, ApmMetricsQuery, ApmDependencyStatsQuery, SloQuery, ProcessScalarQuery, ContainerScalarQuery");
    }
     ...
     * MetricsScalarQuery, EventsScalarQuery, ApmResourceStatsQuery, ApmMetricsQuery, ApmDependencyStatsQuery, SloQuery, ProcessScalarQuery, ContainerScalarQuery
     *
     * @return The actual instance (MetricsScalarQuery, EventsScalarQuery, ApmResourceStatsQuery, ApmMetricsQuery, ApmDependencyStatsQuery, SloQuery, ProcessScalarQuery, ContainerScalarQuery)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ProcessScalarQuery`. If the actual instance is not `ProcessScalarQuery`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `ContainerScalarQuery`. If the actual instance is not `ContainerScalarQuery`,
     * the ClassCastException will be thrown.
     *
