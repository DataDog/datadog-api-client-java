...
public class FleetDeploymentOperation {
  ...
  /**
   * Patch data in JSON format to apply to the configuration file. When using <code>merge-patch
   * </code>, this object is merged with the existing configuration, allowing you to add, update, or
   ...
   * applicable when using the <code>delete</code> operation.
   *
   * @return patch
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileOp, fleetDeploymentOperation.fileOp)
        && Objects.equals(this.filePath, fleetDeploymentOperation.filePath)
        && Objects.equals(this.patch, fleetDeploymentOperation.patch)
        && Objects.equals(this.additionalProperties, fleetDeploymentOperation.additionalProperties);
  }
