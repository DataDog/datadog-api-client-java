...
public class SyntheticsTestVersionType extends ModelEnum<String> {
  ...
  public static class SyntheticsTestVersionTypeSerializer extends StdSerializer<SyntheticsTestVersionType> {
      ...
      @Override
      public void serialize(SyntheticsTestVersionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
