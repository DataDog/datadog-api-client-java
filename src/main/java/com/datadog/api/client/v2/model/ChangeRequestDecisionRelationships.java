...
public class ChangeRequestDecisionRelationships {
  ...
  public ChangeRequestDecisionRelationships(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUESTED_BY_USER)ChangeRequestUserRelationship requestedByUser,
            @JsonProperty(required=true, value=JSON_PROPERTY_REQUESTED_USER)ChangeRequestUserRelationship requestedUser) {
  ...
  **/
  ...
  public ChangeRequestDecisionRelationships requestedByUser(ChangeRequestUserRelationship requestedByUser) {
    this.requestedByUser = requestedByUser;
    this.unparsed |= requestedByUser.unparsed;
    return this;
  }
  ...
  **/
  ...
  public ChangeRequestDecisionRelationships requestedUser(ChangeRequestUserRelationship requestedUser) {
    this.requestedUser = requestedUser;
    this.unparsed |= requestedUser.unparsed;
    return this;
  }
