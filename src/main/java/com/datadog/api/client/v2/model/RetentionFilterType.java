...
public class RetentionFilterType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("spans-sampling-processor"));

  public static final RetentionFilterType SPANS_SAMPLING_PROCESSOR = new RetentionFilterType("spans-sampling-processor");
  ...
  public static class RetentionFilterTypeSerializer extends StdSerializer<RetentionFilterType> {
      ...
      @Override
      public void serialize(RetentionFilterType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
