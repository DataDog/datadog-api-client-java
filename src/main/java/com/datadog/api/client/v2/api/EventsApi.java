 ...
 */
  public EventCreateResponsePayload  createEvent(EventCreateRequestPayload body) throws ApiException {
 ...
 */
  public CompletableFuture<EventCreateResponsePayload>createEventAsync(EventCreateRequestPayload body) {
  ...
  /**
   * <p>This endpoint allows you to publish events.</p>
   * <p><strong>Note:</strong> To utilize this endpoint with our client libraries, please ensure you are using the latest version released on or after July 1, 2025. Earlier versions do not support this functionality.</p>
   * <p><strong>Important:</strong> Upgrade to the latest client library version to use the updated endpoint at <code>https://event-management-intake.{site}/api/v2/events</code>. Older client library versions of the Post an event (v2) API send requests to a deprecated endpoint (<code>https://api.{site}/api/v2/events</code>).</p>
   * <p>✅ <strong>Only events with the <code>change</code> or <code>alert</code> category</strong> are in General Availability. For change events, see <a href="https://docs.datadoghq.com/change_tracking">Change Tracking</a> for more details.</p>
   * <p>❌ For use cases involving other event categories, use the V1 endpoint or reach out to <a href="https://www.datadoghq.com/support/">support</a>.</p>
   *
   * @param body Event creation request payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<EventCreateResponsePayload> createEventWithHttpInfo(EventCreateRequestPayload body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.EventsApi.createEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventCreateResponsePayload>() {});
  }
  ...
  public CompletableFuture<ApiResponse<EventCreateResponsePayload>> createEventWithHttpInfoAsync(EventCreateRequestPayload body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.EventsApi.createEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventCreateResponsePayload>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<EventCreateResponsePayload>() {});
  }
 ...
 */
  ...
  /**
   * <p>Get the details of an event by <code>event_id</code>.</p>
   *
   * @param eventId The UID of the event. (required)
  ...
  public ApiResponse<V2EventResponse> getEventWithHttpInfo(String eventId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/events/{event_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.EventsApi.getEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<V2EventResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<V2EventResponse>> getEventWithHttpInfoAsync(String eventId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.EventsApi.getEvent", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<V2EventResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<V2EventResponse>() {});
  }
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, true, limit, args, 0);
  ...
  public ApiResponse<EventsListResponse> listEventsWithHttpInfo(ListEventsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.EventsApi.listEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<EventsListResponse>> listEventsWithHttpInfoAsync(ListEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.EventsApi.listEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, true, limit, args, 0);
  ...
  public ApiResponse<EventsListResponse> searchEventsWithHttpInfo(SearchEventsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.EventsApi.searchEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<EventsListResponse>> searchEventsWithHttpInfoAsync(SearchEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.EventsApi.searchEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<EventsListResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
