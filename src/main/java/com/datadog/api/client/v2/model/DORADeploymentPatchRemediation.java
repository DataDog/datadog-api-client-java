...
public class DORADeploymentPatchRemediation {
  ...
  /**
   * <p>The ID of the remediation deployment. Use this or <code>version</code> to identify the remediation deployment, but not both.</p>
   * @return id
  **/
  ...
  **/
  ...
  /**
   * <p>The version of the remediation deployment, matched against the same service and environment as the failed deployment. Use this or <code>id</code> to identify the remediation deployment, but not both.</p>
   * @return version
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, doraDeploymentPatchRemediation.id) && Objects.equals(this.type, doraDeploymentPatchRemediation.type) && Objects.equals(this.version, doraDeploymentPatchRemediation.version) && Objects.equals(this.additionalProperties, doraDeploymentPatchRemediation.additionalProperties);
  }
