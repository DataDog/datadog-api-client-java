...
public class CustomDestinationForwardDestinationHttp {
  ...
  private CustomDestinationForwardDestinationHttpType type = CustomDestinationForwardDestinationHttpType.HTTP;

  public CustomDestinationForwardDestinationHttp() {}

  @JsonCreator
  public CustomDestinationForwardDestinationHttp(
            @JsonProperty(required=true, value=JSON_PROPERTY_AUTH)CustomDestinationHttpDestinationAuth auth,
            @JsonProperty(required=true, value=JSON_PROPERTY_ENDPOINT)String endpoint,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)CustomDestinationForwardDestinationHttpType type) {
        this.auth = auth;
  ...
  **/
  ...
  public CustomDestinationForwardDestinationHttp type(CustomDestinationForwardDestinationHttpType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CustomDestinationForwardDestinationHttp customDestinationForwardDestinationHttp = (CustomDestinationForwardDestinationHttp) o;
    return Objects.equals(this.auth, customDestinationForwardDestinationHttp.auth) && Objects.equals(this.endpoint, customDestinationForwardDestinationHttp.endpoint) && Objects.equals(this.type, customDestinationForwardDestinationHttp.type) && Objects.equals(this.additionalProperties, customDestinationForwardDestinationHttp.additionalProperties);
  }
