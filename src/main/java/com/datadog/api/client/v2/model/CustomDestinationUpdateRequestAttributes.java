 ...
 */
@JsonPropertyOrder({
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_ENABLED,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_FORWARD_TAGS,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_FORWARD_TAGS_RESTRICTION_LIST,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_FORWARD_TAGS_RESTRICTION_LIST_TYPE,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_FORWARDER_DESTINATION,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_NAME,
  CustomDestinationUpdateRequestAttributes.JSON_PROPERTY_QUERY
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CustomDestinationUpdateRequestAttributes {
  @JsonIgnore
  ...
  **/
  ...
  /**
   * <p>List of <a href="https://docs.datadoghq.com/getting_started/tagging/#define-tags">keys of tags</a> to be restricted from being forwarded.
   * An empty list represents no restriction is in place and either all or no tags will be forwarded depending on <code>forward_tags_restriction_list_type</code> parameter.</p>
  ...
  **/
  ...
  /**
   * <p>The custom destination query and filter. Logs matching this query are forwarded to the destination.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
   ...
   * @return CustomDestinationUpdateRequestAttributes
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    CustomDestinationUpdateRequestAttributes customDestinationUpdateRequestAttributes = (CustomDestinationUpdateRequestAttributes) o;
    return Objects.equals(this.enabled, customDestinationUpdateRequestAttributes.enabled) && Objects.equals(this.forwardTags, customDestinationUpdateRequestAttributes.forwardTags) && Objects.equals(this.forwardTagsRestrictionList, customDestinationUpdateRequestAttributes.forwardTagsRestrictionList) && Objects.equals(this.forwardTagsRestrictionListType, customDestinationUpdateRequestAttributes.forwardTagsRestrictionListType) && Objects.equals(this.forwarderDestination, customDestinationUpdateRequestAttributes.forwarderDestination) && Objects.equals(this.name, customDestinationUpdateRequestAttributes.name) && Objects.equals(this.query, customDestinationUpdateRequestAttributes.query) && Objects.equals(this.additionalProperties, customDestinationUpdateRequestAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomDestinationUpdateRequestAttributes {\n");
