...
public class UpdateAppRequestDataAttributes {
  ...
  /**
   * The new UI components that make up the app. If this field is set, all existing components will
   * be replaced with the new components under this field.
   *
   * @return components
   */
   ...
   * this field is set, all existing queries will be replaced with the new queries under this field.
   *
  ...
  /**
   * The new name of the root component of the app. This should be a <code>grid</code> component
   ...
   * existing tags not included in the request will be removed.
   *
   * @return tags
   */
  @jakarta.annotation.Nullable
