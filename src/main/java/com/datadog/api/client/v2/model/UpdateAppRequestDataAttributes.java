...
public class UpdateAppRequestDataAttributes {
  ...
  /**
   * <p>The new UI components that make up the app. If this field is set, all existing components are replaced with the new components under this field.</p>
   * @return components
  **/
  ...
  /**
   * <p>The new human-readable description for the app.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The new array of queries, such as external actions and state variables, that the app uses. If this field is set, all existing queries are replaced with the new queries under this field.</p>
   * @return queries
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The new name of the root component of the app. This must be a <code>grid</code> component that contains all other components.</p>
  ...
  **/
  ...
  /**
   * <p>The new list of tags for the app, which can be used to filter apps. If this field is set, any existing tags not included in the request are removed.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
