...
public class OrgGroupMembershipBulkUpdateRelationships {
  ...
  @JsonCreator
  public OrgGroupMembershipBulkUpdateRelationships(
            @JsonProperty(required=true, value=JSON_PROPERTY_SOURCE_ORG_GROUP)OrgGroupRelationshipToOne sourceOrgGroup,
            @JsonProperty(required=true, value=JSON_PROPERTY_TARGET_ORG_GROUP)OrgGroupRelationshipToOne targetOrgGroup) {
  ...
  public OrgGroupMembershipBulkUpdateRelationships sourceOrgGroup(OrgGroupRelationshipToOne sourceOrgGroup) {
    this.sourceOrgGroup = sourceOrgGroup;
    this.unparsed |= sourceOrgGroup.unparsed;
    return this;
  }
  ...
  **/
  ...
  public OrgGroupMembershipBulkUpdateRelationships targetOrgGroup(OrgGroupRelationshipToOne targetOrgGroup) {
    this.targetOrgGroup = targetOrgGroup;
    this.unparsed |= targetOrgGroup.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrgGroupMembershipBulkUpdateRelationships orgGroupMembershipBulkUpdateRelationships = (OrgGroupMembershipBulkUpdateRelationships) o;
    return Objects.equals(this.sourceOrgGroup, orgGroupMembershipBulkUpdateRelationships.sourceOrgGroup) && Objects.equals(this.targetOrgGroup, orgGroupMembershipBulkUpdateRelationships.targetOrgGroup) && Objects.equals(this.additionalProperties, orgGroupMembershipBulkUpdateRelationships.additionalProperties);
  }
