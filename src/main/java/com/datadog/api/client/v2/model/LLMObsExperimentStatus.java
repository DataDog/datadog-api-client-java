...
public class LLMObsExperimentStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("running", "completed", "failed", "interrupted"));
  ...
  public static final LLMObsExperimentStatus INTERRUPTED = new LLMObsExperimentStatus("interrupted");
  ...
  public static class LLMObsExperimentStatusSerializer extends StdSerializer<LLMObsExperimentStatus> {
      ...
      @Override
      public void serialize(LLMObsExperimentStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
