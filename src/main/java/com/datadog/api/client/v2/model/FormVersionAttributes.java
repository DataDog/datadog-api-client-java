...
public class FormVersionAttributes {
  ...
  public FormVersionAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_DEFINITION_SIGNATURE)String definitionSignature,
  ...
  **/
  ...
  /**
   * <p>The signature of the version definition.</p>
  ...
  **/
  ...
  /**
   * <p>The ETag for optimistic concurrency control.</p>
   * @return etag
  **/
  ...
  **/
  ...
  /**
   * <p>The time at which the version was last modified.</p>
   * @return modifiedAt
  **/
  ...
  **/
  ...
  /**
   * <p>The ID of the user who created this version.</p>
   * @return userId
  **/
  ...
  /**
   * <p>The UUID of the user who created this version.</p>
   * @return userUuid
  **/
