...
/**
   * <p>The response returned when listing agentless hosts.</p>
 */
@JsonPropertyOrder({
...
public class CsmAgentlessHostsResponse {
  ...
  private List<CsmAgentlessHostData> data = new ArrayList<>();
  ...
  public CsmAgentlessHostsResponse data(List<CsmAgentlessHostData> data) {
    this.data = data;
    for (CsmAgentlessHostData item : data) {
      this.unparsed |= item.unparsed;
    }
  ...
  /**
   * <p>The list of agentless hosts for the current page.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<CsmAgentlessHostData> getData() {
        return data;
      }
  ...
  /**
   * <p>Pagination metadata for a CSM settings list response.</p>
   * @return meta
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, csmAgentlessHostsResponse.data) && Objects.equals(this.meta, csmAgentlessHostsResponse.meta) && Objects.equals(this.additionalProperties, csmAgentlessHostsResponse.additionalProperties);
  }
