...
/**
   * <p>One condition of the WAF Custom Rule.</p>
 */
@JsonPropertyOrder({
...
public class ApplicationSecurityWafCustomRuleCondition {
  ...
  @JsonCreator
  public ApplicationSecurityWafCustomRuleCondition(
            @JsonProperty(required=true, value=JSON_PROPERTY_OPERATOR)ApplicationSecurityWafCustomRuleConditionOperator operator,
            @JsonProperty(required=true, value=JSON_PROPERTY_PARAMETERS)ApplicationSecurityWafCustomRuleConditionParameters parameters) {
        this.operator = operator;
        this.unparsed |= !operator.isValid();
        this.parameters = parameters;
        this.unparsed |= parameters.unparsed;
  }
  public ApplicationSecurityWafCustomRuleCondition operator(ApplicationSecurityWafCustomRuleConditionOperator operator) {
    this.operator = operator;
    this.unparsed |= !operator.isValid();
    return this;
  }
  ...
  **/
  ...
  public ApplicationSecurityWafCustomRuleCondition parameters(ApplicationSecurityWafCustomRuleConditionParameters parameters) {
    this.parameters = parameters;
    this.unparsed |= parameters.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleCondition applicationSecurityWafCustomRuleCondition = (ApplicationSecurityWafCustomRuleCondition) o;
    return Objects.equals(this.operator, applicationSecurityWafCustomRuleCondition.operator) && Objects.equals(this.parameters, applicationSecurityWafCustomRuleCondition.parameters) && Objects.equals(this.additionalProperties, applicationSecurityWafCustomRuleCondition.additionalProperties);
  }
