...
public class LLMObsPatternsClusteredPointsResponseAttributes {
  ...
  public LLMObsPatternsClusteredPointsResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_POINTS)List<LLMObsPatternsClusteredPoint> points,
  ...
  /**
   * <p>Pagination token for the next page of points. Null if there are no more pages.</p>
  ...
  **/
  ...
  public LLMObsPatternsClusteredPointsResponseAttributes points(List<LLMObsPatternsClusteredPoint> points) {
    this.points = points;
    for (LLMObsPatternsClusteredPoint item : points) {
      this.unparsed |= item.unparsed;
    }
  ...
  public LLMObsPatternsClusteredPointsResponseAttributes addPointsItem(LLMObsPatternsClusteredPoint pointsItem) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public LLMObsPatternsClusteredPointsResponseAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LLMObsPatternsClusteredPointsResponseAttributes llmObsPatternsClusteredPointsResponseAttributes = (LLMObsPatternsClusteredPointsResponseAttributes) o;
    return Objects.equals(this.nextPageToken, llmObsPatternsClusteredPointsResponseAttributes.nextPageToken) && Objects.equals(this.points, llmObsPatternsClusteredPointsResponseAttributes.points) && Objects.equals(this.topicId, llmObsPatternsClusteredPointsResponseAttributes.topicId) && Objects.equals(this.additionalProperties, llmObsPatternsClusteredPointsResponseAttributes.additionalProperties);
  }
