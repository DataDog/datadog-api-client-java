...
public class TeamType {
  ...
  public static class TeamTypeSerializer extends StdSerializer<TeamType> {
    public TeamTypeSerializer(Class<TeamType> t) {
      super(t);
    }

    public TeamTypeSerializer() {
      this(null);
    }

    @Override
    public void serialize(TeamType value, JsonGenerator jgen, SerializerProvider provider)
  ...
  /** Return true if this TeamType object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((TeamType) o).value);
  }
