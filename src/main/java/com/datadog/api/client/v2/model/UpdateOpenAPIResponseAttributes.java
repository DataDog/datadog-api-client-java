...
/**
   * <p>Attributes for <code>UpdateOpenAPI</code>.</p>
 */
@JsonPropertyOrder({
  UpdateOpenAPIResponseAttributes.JSON_PROPERTY_FAILED_ENDPOINTS
})
...
public class UpdateOpenAPIResponseAttributes {
  ...
  private List<OpenAPIEndpoint> failedEndpoints = null;

  public UpdateOpenAPIResponseAttributes failedEndpoints(List<OpenAPIEndpoint> failedEndpoints) {
  ...
  public UpdateOpenAPIResponseAttributes addFailedEndpointsItem(OpenAPIEndpoint failedEndpointsItem) {
  ...
  /**
   * <p>List of endpoints which couldn't be parsed.</p>
  ...
  **/
      ...
      public List<OpenAPIEndpoint> getFailedEndpoints() {
        return failedEndpoints;
      }
  ...
  public boolean equals(Object o) {
    ...
    UpdateOpenAPIResponseAttributes updateOpenApiResponseAttributes = (UpdateOpenAPIResponseAttributes) o;
    return Objects.equals(this.failedEndpoints, updateOpenApiResponseAttributes.failedEndpoints) && Objects.equals(this.additionalProperties, updateOpenApiResponseAttributes.additionalProperties);
  }
