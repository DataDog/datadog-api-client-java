...
public class CIAppPipelineEventStepLevel extends ModelEnum<String> {
  ...
  public static class CIAppPipelineEventStepLevelSerializer extends StdSerializer<CIAppPipelineEventStepLevel> {
      ...
      @Override
      public void serialize(CIAppPipelineEventStepLevel value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
