...
public class MetricEstimateAttributes {
  ...
  /**
   * <p>Estimate type based on the queried configuration. <code>count_or_gauge</code> is returned by default, and <code>distribution</code> is returned for distribution metrics. The <code>filter[pct]</code> query parameter has no effect on this value.</p>
   * @return estimateType
  **/
