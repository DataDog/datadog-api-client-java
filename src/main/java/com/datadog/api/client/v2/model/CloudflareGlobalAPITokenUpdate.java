...
public class CloudflareGlobalAPITokenUpdate {
  ...
  /**
   * The <code>CloudflareGlobalAPITokenUpdate</code> <code>auth_email</code>.
   *
   * @return authEmail
   */
  ...
  /**
   * The <code>CloudflareGlobalAPITokenUpdate</code> <code>global_api_key</code>.
   *
   * @return globalApiKey
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    CloudflareGlobalAPITokenUpdate cloudflareGlobalApiTokenUpdate =
        (CloudflareGlobalAPITokenUpdate) o;
    return Objects.equals(this.authEmail, cloudflareGlobalApiTokenUpdate.authEmail)
        && Objects.equals(this.globalApiKey, cloudflareGlobalApiTokenUpdate.globalApiKey)
        && Objects.equals(this.type, cloudflareGlobalApiTokenUpdate.type)
        && Objects.equals(
            this.additionalProperties, cloudflareGlobalApiTokenUpdate.additionalProperties);
  }
