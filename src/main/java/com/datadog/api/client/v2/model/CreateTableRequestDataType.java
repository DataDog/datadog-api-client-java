...
public class CreateTableRequestDataType extends ModelEnum<String> {
  ...
  public static final CreateTableRequestDataType REFERENCE_TABLE = new CreateTableRequestDataType("reference_table");
  ...
  public static class CreateTableRequestDataTypeSerializer extends StdSerializer<CreateTableRequestDataType> {
      ...
      @Override
      public void serialize(CreateTableRequestDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
