...
public class PlaylistDataAttributes {
  ...
  /**
   * <p>Timestamp when the playlist was created.</p>
   * @return createdAt
  **/
  ...
  **/
  ...
  /**
   * <p>Optional human-readable description of the playlist's purpose or contents.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Human-readable name of the playlist.</p>
   * @return name
  **/
  ...
  /**
   * <p>Number of replay sessions in the playlist.</p>
   * @return sessionCount
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp when the playlist was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
