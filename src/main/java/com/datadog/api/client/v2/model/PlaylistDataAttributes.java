...
public class PlaylistDataAttributes {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, playlistDataAttributes.createdAt)
        && Objects.equals(this.createdBy, playlistDataAttributes.createdBy)
        && Objects.equals(this.description, playlistDataAttributes.description)
        && Objects.equals(this.name, playlistDataAttributes.name)
        && Objects.equals(this.sessionCount, playlistDataAttributes.sessionCount)
        && Objects.equals(this.updatedAt, playlistDataAttributes.updatedAt)
        && Objects.equals(this.additionalProperties, playlistDataAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        createdAt, createdBy, description, name, sessionCount, updatedAt, additionalProperties);
  }
