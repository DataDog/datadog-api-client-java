...
public class SyntheticsGlobalVariableParseTestOptionsType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("http_body", "http_header", "http_status_code", "local_variable"));
  ...
  public static final SyntheticsGlobalVariableParseTestOptionsType HTTP_STATUS_CODE = new SyntheticsGlobalVariableParseTestOptionsType("http_status_code");
