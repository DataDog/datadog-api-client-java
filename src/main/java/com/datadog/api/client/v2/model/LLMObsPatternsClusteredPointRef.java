...
/**
   * <p>A clustered point attached inline to a topic. The metric fields are populated
   * only when the request includes <code>include_metrics=true</code>.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsPatternsClusteredPointRef {
  ...
  /**
   * <p>Duration of the source span in nanoseconds. Included only when metrics are requested.</p>
   * @return duration
  **/
  ...
  /**
   * <p>Estimated total cost of the source span. Included only when metrics are requested.</p>
  ...
  **/
  ...
  /**
   * <p>Evaluation results for the source span keyed by evaluation name. Included
   * only when metrics are requested.</p>
   * @return evaluation
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of input tokens of the source span. Included only when metrics are requested.</p>
   * @return inputTokens
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of output tokens of the source span. Included only when metrics are requested.</p>
   * @return outputTokens
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Status of the source span. Included only when metrics are requested.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Total number of tokens of the source span. Included only when metrics are requested.</p>
   * @return totalTokens
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    LLMObsPatternsClusteredPointRef llmObsPatternsClusteredPointRef = (LLMObsPatternsClusteredPointRef) o;
    return Objects.equals(this.duration, llmObsPatternsClusteredPointRef.duration) && Objects.equals(this.estimatedTotalCost, llmObsPatternsClusteredPointRef.estimatedTotalCost) && Objects.equals(this.evaluation, llmObsPatternsClusteredPointRef.evaluation) && Objects.equals(this.inputTokens, llmObsPatternsClusteredPointRef.inputTokens) && Objects.equals(this.outputTokens, llmObsPatternsClusteredPointRef.outputTokens) && Objects.equals(this.spanId, llmObsPatternsClusteredPointRef.spanId) && Objects.equals(this.status, llmObsPatternsClusteredPointRef.status) && Objects.equals(this.totalTokens, llmObsPatternsClusteredPointRef.totalTokens) && Objects.equals(this.additionalProperties, llmObsPatternsClusteredPointRef.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(duration,estimatedTotalCost,evaluation,inputTokens,outputTokens,spanId,status,totalTokens, additionalProperties);
  }
