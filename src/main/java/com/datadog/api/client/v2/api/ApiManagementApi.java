...
@Deprecated
  public CompletableFuture<CreateOpenAPIResponse>createOpenAPIAsync() {
    return createOpenAPIWithHttpInfoAsync(new CreateOpenAPIOptionalParameters()).thenApply(response -> {
...
@Deprecated
  public CompletableFuture<CreateOpenAPIResponse>createOpenAPIAsync(CreateOpenAPIOptionalParameters parameters) {
    return createOpenAPIWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Create a new API from the <a href="https://spec.openapis.org/oas/latest.html">OpenAPI</a> specification given.
   * See the <a href="https://docs.datadoghq.com/api_catalog/add_metadata/">API Catalog documentation</a> for additional
   * information about the possible metadata.
   * It returns the created API ID.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<CreateOpenAPIResponse> createOpenAPIWithHttpInfo(CreateOpenAPIOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ApiManagementApi.createOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"multipart/form-data" }, localVarPostBody,localVarFormParams , false, new GenericType<CreateOpenAPIResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CreateOpenAPIResponse>> createOpenAPIWithHttpInfoAsync(CreateOpenAPIOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v2.ApiManagementApi.createOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CreateOpenAPIResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"multipart/form-data" }, localVarPostBody,localVarFormParams , false, new GenericType<CreateOpenAPIResponse>() {});
  }
...
@Deprecated
  public CompletableFuture<Void>deleteOpenAPIAsync(UUID id) {
    return deleteOpenAPIWithHttpInfoAsync(id).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete a specific API by ID.</p>
   *
   * @param id ID of the API to delete (required)
  ...
  public ApiResponse<Void> deleteOpenAPIWithHttpInfo(UUID id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/apicatalog/api/{id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ApiManagementApi.deleteOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteOpenAPIWithHttpInfoAsync(UUID id) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ApiManagementApi.deleteOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
...
@Deprecated
  public CompletableFuture<File>getOpenAPIAsync(UUID id) {
    return getOpenAPIWithHttpInfoAsync(id).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Retrieve information about a specific API in <a href="https://spec.openapis.org/oas/latest.html">OpenAPI</a> format file.</p>
   *
   * @param id ID of the API to retrieve (required)
  ...
  public ApiResponse<File> getOpenAPIWithHttpInfo(UUID id) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/apicatalog/api/{id}/openapi"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ApiManagementApi.getOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"multipart/form-data", "application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<File>> getOpenAPIWithHttpInfoAsync(UUID id) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ApiManagementApi.getOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"multipart/form-data", "application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<File>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
...
@Deprecated
  public CompletableFuture<ListAPIsResponse>listAPIsAsync() {
    return listAPIsWithHttpInfoAsync(new ListAPIsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
...
@Deprecated
  public CompletableFuture<ListAPIsResponse>listAPIsAsync(ListAPIsOptionalParameters parameters) {
    return listAPIsWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<ListAPIsResponse> listAPIsWithHttpInfo(ListAPIsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ApiManagementApi.listAPIs", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListAPIsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ListAPIsResponse>> listAPIsWithHttpInfoAsync(ListAPIsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ApiManagementApi.listAPIs", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ListAPIsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListAPIsResponse>() {});
  }
...
@Deprecated
  public CompletableFuture<UpdateOpenAPIResponse>updateOpenAPIAsync(UUID id) {
    return updateOpenAPIWithHttpInfoAsync(id, new UpdateOpenAPIOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
...
@Deprecated
  public CompletableFuture<UpdateOpenAPIResponse>updateOpenAPIAsync( UUID id, UpdateOpenAPIOptionalParameters parameters) {
    return updateOpenAPIWithHttpInfoAsync(id, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update information about a specific API. The given content will replace all API content of the given ID.
   * The ID is returned by the create API, or can be found in the URL in the API catalog UI.</p>
   *
   * @param id ID of the API to modify (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<UpdateOpenAPIResponse> updateOpenAPIWithHttpInfo(UUID id, UpdateOpenAPIOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ApiManagementApi.updateOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"multipart/form-data" }, localVarPostBody,localVarFormParams , false, new GenericType<UpdateOpenAPIResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<UpdateOpenAPIResponse>> updateOpenAPIWithHttpInfoAsync(UUID id, UpdateOpenAPIOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ApiManagementApi.updateOpenAPI", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<UpdateOpenAPIResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"multipart/form-data" }, localVarPostBody,localVarFormParams , false, new GenericType<UpdateOpenAPIResponse>() {});
  }
}