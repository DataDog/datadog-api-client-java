...
/**
   * <p>Aggregated performance statistics for a single network resource across sampled view instances.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedResource {
  ...
  public AggregatedResource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_CACHE_HIT_RATE_PCT)Double cacheHitRatePct,
            @JsonProperty(required=true, value=JSON_PROPERTY_CACHED_COUNT)Integer cachedCount,
            @JsonProperty(required=true, value=JSON_PROPERTY_DOWNLOADED_COUNT)Integer downloadedCount,
            @JsonProperty(required=true, value=JSON_PROPERTY_HTTP_METHOD)String httpMethod,
            @JsonProperty(required=true, value=JSON_PROPERTY_LOAD_FREQUENCY_PCT)Double loadFrequencyPct,
            @JsonProperty(required=true, value=JSON_PROPERTY_MAX_DURATION_MS)Double maxDurationMs,
            @JsonProperty(required=true, value=JSON_PROPERTY_MEDIAN_DURATION_MS)Double medianDurationMs,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RESOURCE_URL_PATH_GROUP)String resourceUrlPathGroup,
            @JsonProperty(required=true, value=JSON_PROPERTY_TIMING_BREAKDOWN)AggregatedResourceTimingBreakdown timingBreakdown,
            @JsonProperty(required=true, value=JSON_PROPERTY_TOTAL_REQUESTS)Integer totalRequests,
            @JsonProperty(required=true, value=JSON_PROPERTY_VIEWS_WITH_RESOURCE)Integer viewsWithResource) {
  ...
  /**
   * <p>Average total duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Average start time relative to view start in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Cache hit rate as a percentage.</p>
  ...
  **/
  ...
  /**
   * <p>Number of requests served from cache.</p>
   * maximum: 2147483647
   * @return cachedCount
  **/
  ...
  /**
   * <p>Number of requests downloaded from the network.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  /**
   * <p>75th percentile duration across all view names in the application, present when include_global_appearance is true.</p>
  ...
  **/
  ...
  /**
   * <p>Number of distinct view names in the application that load this resource, present when include_global_appearance is true.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  /**
   * <p>Percentage of distinct view names in the application that load this resource, present when include_global_appearance is true.</p>
  ...
  **/
  ...
  /**
   * <p>HTTP method for the resource request.</p>
   * @return httpMethod
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Percentage of sampled view instances that loaded this resource.</p>
  ...
  **/
  ...
  /**
   * <p>Maximum duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Median duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Minimum duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>75th percentile duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>95th percentile duration in milliseconds.</p>
  ...
  **/
  ...
  /**
   * <p>Resource type (JS, CSS, image, fetch, XHR, document, and so on).</p>
   * @return resourceType
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>URL path group used to aggregate similar resources.</p>
  ...
  **/
  ...
  /**
   * <p>Average timing breakdown per network phase for a resource.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of requests for this resource across all sampled views.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  /**
   * <p>Number of sampled view instances that loaded this resource.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.avgDurationMs, aggregatedResource.avgDurationMs) && Objects.equals(this.avgStartTimeMs, aggregatedResource.avgStartTimeMs) && Objects.equals(this.cacheHitRatePct, aggregatedResource.cacheHitRatePct) && Objects.equals(this.cachedCount, aggregatedResource.cachedCount) && Objects.equals(this.downloadedCount, aggregatedResource.downloadedCount) && Objects.equals(this.globalP75DurationMs, aggregatedResource.globalP75DurationMs) && Objects.equals(this.globalViewNameCount, aggregatedResource.globalViewNameCount) && Objects.equals(this.globalViewNamePct, aggregatedResource.globalViewNamePct) && Objects.equals(this.httpMethod, aggregatedResource.httpMethod) && Objects.equals(this.loadFrequencyPct, aggregatedResource.loadFrequencyPct) && Objects.equals(this.maxDurationMs, aggregatedResource.maxDurationMs) && Objects.equals(this.medianDurationMs, aggregatedResource.medianDurationMs) && Objects.equals(this.minDurationMs, aggregatedResource.minDurationMs) && Objects.equals(this.p75DurationMs, aggregatedResource.p75DurationMs) && Objects.equals(this.p95DurationMs, aggregatedResource.p95DurationMs) && Objects.equals(this.resourceType, aggregatedResource.resourceType) && Objects.equals(this.resourceUrlPathGroup, aggregatedResource.resourceUrlPathGroup) && Objects.equals(this.timingBreakdown, aggregatedResource.timingBreakdown) && Objects.equals(this.totalRequests, aggregatedResource.totalRequests) && Objects.equals(this.viewsWithResource, aggregatedResource.viewsWithResource) && Objects.equals(this.additionalProperties, aggregatedResource.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(avgDurationMs,avgStartTimeMs,cacheHitRatePct,cachedCount,downloadedCount,globalP75DurationMs,globalViewNameCount,globalViewNamePct,httpMethod,loadFrequencyPct,maxDurationMs,medianDurationMs,minDurationMs,p75DurationMs,p95DurationMs,resourceType,resourceUrlPathGroup,timingBreakdown,totalRequests,viewsWithResource, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    globalP75DurationMs: ").append(toIndentedString(globalP75DurationMs)).append("\n");
    sb.append("    globalViewNameCount: ").append(toIndentedString(globalViewNameCount)).append("\n");
