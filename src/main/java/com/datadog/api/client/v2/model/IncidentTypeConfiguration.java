...
public class IncidentTypeConfiguration {
  ...
  public static final String JSON_PROPERTY_PRIVATE_INCIDENTS_BY_DEFAULT = "private_incidents_by_default";
  ...
  /**
   * <p>Whether incidents of this type can be deleted.</p>
  ...
  **/
  ...
  /**
   * <p>Whether automation workflows can be triggered for incidents of this type.</p>
  ...
  **/
  ...
  /**
   * <p>An optional message shown to users when they declare an incident of this type.</p>
  ...
  **/
  ...
  /**
   * <p>Whether responders can edit incident timestamps for incidents of this type.</p>
  ...
  **/
  ...
  /**
   * <p>Whether responders can create private incidents of this type. This is an opt-in setting, distinct from <code>private_incidents_by_default</code>, which controls whether incidents are created private automatically.</p>
  ...
  **/
  ...
  /**
   * <p>Whether incidents of this type are created as private by default.</p>
  ...
  **/
  ...
  /**
   * <p>When set to <code>servicenow</code>, incidents will display the ServiceNow record ID instead of the public ID. If no ServiceNow integration exists, the public ID will be displayed.</p>
   * @return slugSource
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether incidents of this type are treated as test incidents.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowIncidentDeletion, incidentTypeConfiguration.allowIncidentDeletion) && Objects.equals(this.allowWorkflows, incidentTypeConfiguration.allowWorkflows) && Objects.equals(this.createMessage, incidentTypeConfiguration.createMessage) && Objects.equals(this.editableTimestamps, incidentTypeConfiguration.editableTimestamps) && Objects.equals(this.privateIncidents, incidentTypeConfiguration.privateIncidents) && Objects.equals(this.privateIncidentsByDefault, incidentTypeConfiguration.privateIncidentsByDefault) && Objects.equals(this.slugSource, incidentTypeConfiguration.slugSource) && Objects.equals(this.testIncidents, incidentTypeConfiguration.testIncidents) && Objects.equals(this.additionalProperties, incidentTypeConfiguration.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(allowIncidentDeletion,allowWorkflows,createMessage,editableTimestamps,privateIncidents,privateIncidentsByDefault,slugSource,testIncidents, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    allowIncidentDeletion: ").append(toIndentedString(allowIncidentDeletion)).append("\n");
    ...
    sb.append("    privateIncidentsByDefault: ").append(toIndentedString(privateIncidentsByDefault)).append("\n");
