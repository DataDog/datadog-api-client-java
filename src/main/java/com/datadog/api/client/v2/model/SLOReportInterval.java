...
public class SLOReportInterval extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("daily", "weekly", "monthly"));
  ...
  public static class SLOReportIntervalSerializer extends StdSerializer<SLOReportInterval> {
      ...
      @Override
      public void serialize(SLOReportInterval value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
