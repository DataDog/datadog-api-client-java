...
public class JVMSourcemapAttributes {
  ...
  **/
  ...
  /**
   * <p>The timestamp when the mapping file was created.</p>
   * @return createdAt
  **/
  ...
  **/
  ...
  /**
   * <p>The service name associated with the mapping file.</p>
   * @return service
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The size of the mapping file in bytes.</p>
   * @return size
  **/
  ...
  /**
   * <p>The build variant (e.g., <code>release</code>, <code>debug</code>).</p>
   * @return variant
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The version of the service associated with the mapping file.</p>
   * @return version
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buildId, jvmSourcemapAttributes.buildId) && Objects.equals(this.createdAt, jvmSourcemapAttributes.createdAt) && Objects.equals(this.mapkind, jvmSourcemapAttributes.mapkind) && Objects.equals(this.service, jvmSourcemapAttributes.service) && Objects.equals(this.size, jvmSourcemapAttributes.size) && Objects.equals(this.variant, jvmSourcemapAttributes.variant) && Objects.equals(this.version, jvmSourcemapAttributes.version) && Objects.equals(this.versionCode, jvmSourcemapAttributes.versionCode) && Objects.equals(this.additionalProperties, jvmSourcemapAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(buildId,createdAt,mapkind,service,size,variant,version,versionCode, additionalProperties);
  }
