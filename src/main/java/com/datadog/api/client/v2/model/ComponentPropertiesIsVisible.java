...
@JsonDeserialize(using = ComponentPropertiesIsVisible.ComponentPropertiesIsVisibleDeserializer.class)
@JsonSerialize(using = ComponentPropertiesIsVisible.ComponentPropertiesIsVisibleSerializer.class)
public class ComponentPropertiesIsVisible extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ComponentPropertiesIsVisible.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ComponentPropertiesIsVisibleSerializer extends StdSerializer<ComponentPropertiesIsVisible> {
        public ComponentPropertiesIsVisibleSerializer(Class<ComponentPropertiesIsVisible> t) {
            super(t);
        }

        public ComponentPropertiesIsVisibleSerializer() {
            this(null);
        }

        @Override
        public void serialize(ComponentPropertiesIsVisible value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ComponentPropertiesIsVisibleDeserializer extends StdDeserializer<ComponentPropertiesIsVisible> {
        public ComponentPropertiesIsVisibleDeserializer() {
            this(ComponentPropertiesIsVisible.class);
        }

        public ComponentPropertiesIsVisibleDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ComponentPropertiesIsVisible deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ComponentPropertiesIsVisible ret = new ComponentPropertiesIsVisible();
            if (match == 1) {
         ...
         */
        @Override
        public ComponentPropertiesIsVisible getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ComponentPropertiesIsVisible cannot be null");
        }
    }
    ...
    public ComponentPropertiesIsVisible() {
        super("oneOf", Boolean.FALSE);
    }
    public ComponentPropertiesIsVisible(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ComponentPropertiesIsVisible(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ComponentPropertiesIsVisible.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ComponentPropertiesIsVisible.schemas;
    }
