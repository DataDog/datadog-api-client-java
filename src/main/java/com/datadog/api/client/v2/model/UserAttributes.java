...
public class UserAttributes {
  ...
  /**
   * <p>The ISO 8601 timestamp of when the user account was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Whether the user account is deactivated. Disabled users cannot log in.</p>
   * @return disabled
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The email address of the user, used for login and notifications.</p>
   * @return email
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The unique handle (username) of the user, typically matching their email prefix.</p>
   * @return handle
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>URL of the user's profile icon, typically a Gravatar URL derived from the email address.</p>
   * @return icon
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The ISO 8601 timestamp of the user's most recent login, or null if the user has never logged in.</p>
  ...
  **/
  ...
  /**
   * <p>Whether multi-factor authentication (MFA) is enabled for the user's account.</p>
   * @return mfaEnabled
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The ISO 8601 timestamp of when the user account was last modified.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The full display name of the user as shown in the Datadog UI.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>Whether this is a service account rather than a human user.
   * Service accounts are used for programmatic API access.</p>
  ...
  **/
  ...
  /**
   * <p>The current status of the user account (for example, <code>Active</code>, <code>Pending</code>, or <code>Disabled</code>).</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The globally unique identifier (UUID) of the user.</p>
   * @return uuid
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the user's email address has been verified.</p>
   * @return verified
  **/
      @jakarta.annotation.Nullable
