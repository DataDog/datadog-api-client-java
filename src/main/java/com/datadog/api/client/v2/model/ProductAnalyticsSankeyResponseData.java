...
/**
 * The single JSON:API resource holding a computed Sankey diagram. Its attributes contain the nodes
 * of every column and the links that carry sessions between them.
 */
@JsonPropertyOrder({
