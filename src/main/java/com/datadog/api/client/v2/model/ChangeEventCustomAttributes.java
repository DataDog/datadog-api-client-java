...
public class ChangeEventCustomAttributes {
  ...
  /**
   * JSON Object representing the entity which made the change. Currently it only supports <code>
   * user</code> and <code>system</code> author type.
   *
   * @return author
   */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, changedResource, additionalProperties);
  }
