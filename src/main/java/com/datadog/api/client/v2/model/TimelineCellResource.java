...
/**
   * <p>A timeline cell resource representing a single entry in a case's activity timeline.</p>
 */
@JsonPropertyOrder({
...
public class TimelineCellResource {
  ...
  /**
   * <p>Attributes of a timeline cell, representing a single event in a case's chronological activity log (for example, a comment, status change, or assignment update).</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Timeline cell's identifier</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, timelineCellResource.attributes) && Objects.equals(this.id, timelineCellResource.id) && Objects.equals(this.type, timelineCellResource.type) && Objects.equals(this.additionalProperties, timelineCellResource.additionalProperties);
  }
