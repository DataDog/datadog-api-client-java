...
public class ProductAnalyticsRetentionSearch {
  ...
  public ProductAnalyticsRetentionSearch(
      @JsonProperty(required = true, value = JSON_PROPERTY_COHORT_CRITERIA)
          ProductAnalyticsRetentionCohortCriteria cohortCriteria,
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_RETURN_CONDITION)
          ProductAnalyticsRetentionReturnCondition returnCondition) {
  ...
  public ProductAnalyticsRetentionSearch cohortCriteria(
      ProductAnalyticsRetentionCohortCriteria cohortCriteria) {
    this.cohortCriteria = cohortCriteria;
    this.unparsed |= cohortCriteria.unparsed;
    return this;
  ...
  public ProductAnalyticsRetentionSearch retentionEntity(
      ProductAnalyticsRetentionEntity retentionEntity) {
    this.retentionEntity = retentionEntity;
    this.unparsed |= !retentionEntity.isValid();
    return this;
  ...
  public ProductAnalyticsRetentionSearch returnCondition(
      ProductAnalyticsRetentionReturnCondition returnCondition) {
    this.returnCondition = returnCondition;
    this.unparsed |= !returnCondition.isValid();
    return this;
  ...
  public ProductAnalyticsRetentionSearch returnCriteria(
      ProductAnalyticsRetentionReturnCriteria returnCriteria) {
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsRetentionSearch productAnalyticsRetentionSearch =
        (ProductAnalyticsRetentionSearch) o;
    return Objects.equals(this.cohortCriteria, productAnalyticsRetentionSearch.cohortCriteria)
        && Objects.equals(this.filters, productAnalyticsRetentionSearch.filters)
        && Objects.equals(this.retentionEntity, productAnalyticsRetentionSearch.retentionEntity)
        && Objects.equals(this.returnCondition, productAnalyticsRetentionSearch.returnCondition)
        && Objects.equals(this.returnCriteria, productAnalyticsRetentionSearch.returnCriteria)
        && Objects.equals(
            this.additionalProperties, productAnalyticsRetentionSearch.additionalProperties);
  }
