...
/**
   * <p>Response containing a list of OCI tenancy integration configurations.</p>
 */
@JsonPropertyOrder({
  TenancyConfigList.JSON_PROPERTY_DATA
})
...
public class TenancyConfigList {
  ...
  private List<TenancyConfigData> data = new ArrayList<>();
  ...
  /**
   * <p>List of OCI tenancy integration configuration objects.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<TenancyConfigData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, tenancyConfigList.data) && Objects.equals(this.additionalProperties, tenancyConfigList.additionalProperties);
  }
