...
/**
   * <p>Attributes for a monitor alert trigger.</p>
 */
@JsonPropertyOrder({
...
public class MonitorAlertTriggerAttributes {
  ...
  /**
   * <p>The event ID associated with the monitor alert.</p>
   * @return eventId
  **/
  ...
  /**
   * <p>The timestamp of the event in Unix milliseconds.</p>
   * @return eventTs
  **/
  ...
  /**
   * <p>The monitor ID that triggered the alert.</p>
   * @return monitorId
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, monitorAlertTriggerAttributes.eventId) && Objects.equals(this.eventTs, monitorAlertTriggerAttributes.eventTs) && Objects.equals(this.monitorId, monitorAlertTriggerAttributes.monitorId) && Objects.equals(this.additionalProperties, monitorAlertTriggerAttributes.additionalProperties);
  }
