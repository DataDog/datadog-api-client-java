...
public class GitlabCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class GitlabCredentialsUpdateSerializer extends StdSerializer<GitlabCredentialsUpdate> {
        ...
        @Override
        public void serialize(GitlabCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class GitlabCredentialsUpdateDeserializer extends StdDeserializer<GitlabCredentialsUpdate> {
        ...
        @Override
        public GitlabCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (GitlabAPIKeyUpdate.class.equals(Integer.class) || GitlabAPIKeyUpdate.class.equals(Long.class) || GitlabAPIKeyUpdate.class.equals(Float.class) || GitlabAPIKeyUpdate.class.equals(Double.class) || GitlabAPIKeyUpdate.class.equals(Boolean.class) || GitlabAPIKeyUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((GitlabAPIKeyUpdate.class.equals(Integer.class) || GitlabAPIKeyUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((GitlabAPIKeyUpdate.class.equals(Float.class) || GitlabAPIKeyUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (GitlabAPIKeyUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (GitlabAPIKeyUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public GitlabCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `GitlabAPIKeyUpdate`. If the actual instance is not `GitlabAPIKeyUpdate`,
