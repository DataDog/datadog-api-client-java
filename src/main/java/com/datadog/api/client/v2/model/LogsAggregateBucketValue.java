...
public class LogsAggregateBucketValue extends AbstractOpenApiSchema {
    ...
    public static class LogsAggregateBucketValueSerializer extends StdSerializer<LogsAggregateBucketValue> {
        ...
        @Override
        public void serialize(LogsAggregateBucketValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class LogsAggregateBucketValueDeserializer extends StdDeserializer<LogsAggregateBucketValue> {
        ...
        @Override
        public LogsAggregateBucketValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (LogsAggregateBucketValueTimeseries.class.equals(Integer.class) || LogsAggregateBucketValueTimeseries.class.equals(Long.class) || LogsAggregateBucketValueTimeseries.class.equals(Float.class) || LogsAggregateBucketValueTimeseries.class.equals(Double.class) || LogsAggregateBucketValueTimeseries.class.equals(Boolean.class) || LogsAggregateBucketValueTimeseries.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((LogsAggregateBucketValueTimeseries.class.equals(Integer.class) || LogsAggregateBucketValueTimeseries.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((LogsAggregateBucketValueTimeseries.class.equals(Float.class) || LogsAggregateBucketValueTimeseries.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (LogsAggregateBucketValueTimeseries.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (LogsAggregateBucketValueTimeseries.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'LogsAggregateBucketValueTimeseries'", e);
            }
         ...
         */
        @Override
        public LogsAggregateBucketValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        ...
        schemas.put("LogsAggregateBucketValueTimeseries", new GenericType<LogsAggregateBucketValueTimeseries>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(LogsAggregateBucketValueTimeseries.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        throw new RuntimeException("Invalid instance type. Must be String, Double, LogsAggregateBucketValueTimeseries");
    }
    ...
    /**
     * Get the actual instance of `LogsAggregateBucketValueTimeseries`. If the actual instance is not `LogsAggregateBucketValueTimeseries`,
     * the ClassCastException will be thrown.
     *
