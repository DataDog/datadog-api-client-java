...
public class MonitorConfigPolicyPolicy extends AbstractOpenApiSchema {
    ...
    public static class MonitorConfigPolicyPolicySerializer extends StdSerializer<MonitorConfigPolicyPolicy> {
        ...
        @Override
        public void serialize(MonitorConfigPolicyPolicy value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class MonitorConfigPolicyPolicyDeserializer extends StdDeserializer<MonitorConfigPolicyPolicy> {
        ...
        @Override
        public MonitorConfigPolicyPolicy deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (MonitorConfigPolicyTagPolicy.class.equals(Integer.class) || MonitorConfigPolicyTagPolicy.class.equals(Long.class) || MonitorConfigPolicyTagPolicy.class.equals(Float.class) || MonitorConfigPolicyTagPolicy.class.equals(Double.class) || MonitorConfigPolicyTagPolicy.class.equals(Boolean.class) || MonitorConfigPolicyTagPolicy.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((MonitorConfigPolicyTagPolicy.class.equals(Integer.class) || MonitorConfigPolicyTagPolicy.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((MonitorConfigPolicyTagPolicy.class.equals(Float.class) || MonitorConfigPolicyTagPolicy.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (MonitorConfigPolicyTagPolicy.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (MonitorConfigPolicyTagPolicy.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public MonitorConfigPolicyPolicy getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `MonitorConfigPolicyTagPolicy`. If the actual instance is not `MonitorConfigPolicyTagPolicy`,
