...
/** Snappy compression. */
@JsonPropertyOrder({ObservabilityPipelineAmazonS3GenericCompressionSnappy.JSON_PROPERTY_ALGORITHM})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ObservabilityPipelineAmazonS3GenericCompressionSnappy {
  @JsonIgnore public boolean unparsed = false;
  public static final String JSON_PROPERTY_ALGORITHM = "algorithm";
  private ObservabilityPipelineAmazonS3GenericCompressionSnappyType algorithm =
  ...
  public ObservabilityPipelineAmazonS3GenericCompressionSnappy(
      @JsonProperty(required = true, value = JSON_PROPERTY_ALGORITHM)
          ObservabilityPipelineAmazonS3GenericCompressionSnappyType algorithm) {
    this.algorithm = algorithm;
    this.unparsed |= !algorithm.isValid();
  }

  public ObservabilityPipelineAmazonS3GenericCompressionSnappy algorithm(
      ObservabilityPipelineAmazonS3GenericCompressionSnappyType algorithm) {
    this.algorithm = algorithm;
    this.unparsed |= !algorithm.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.algorithm, observabilityPipelineAmazonS3GenericCompressionSnappy.algorithm)
        && Objects.equals(
