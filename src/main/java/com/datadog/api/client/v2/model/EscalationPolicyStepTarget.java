...
/**
   * <p>Defines a single escalation target within a step for an escalation policy creation request. Contains <code>id</code>, <code>type</code>, and optional <code>config</code>.</p>
 */
@JsonPropertyOrder({
...
public class EscalationPolicyStepTarget {
  ...
  /**
   * <p>Configuration for an escalation target, such as schedule position.</p>
   * @return config
  **/
  ...
  /**
   * <p>Specifies the unique identifier for this target.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public EscalationPolicyStepTargetType getType() {
        return type;
      }
  public void setType(EscalationPolicyStepTargetType type) {
    if (!type.isValid()) {
        this.unparsed = true;
    }
    this.type = type;
   ...
   * @return EscalationPolicyStepTarget
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.config, escalationPolicyStepTarget.config) && Objects.equals(this.id, escalationPolicyStepTarget.id) && Objects.equals(this.type, escalationPolicyStepTarget.type) && Objects.equals(this.additionalProperties, escalationPolicyStepTarget.additionalProperties);
  }
