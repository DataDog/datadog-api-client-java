...
/**
   * <p>Identifies a team or organization hierarchy to include in synchronization.</p>
 */
@JsonPropertyOrder({
...
public class TeamSyncSelectionStateItem {
  ...
  @JsonCreator
  public TeamSyncSelectionStateItem(
            @JsonProperty(required=true, value=JSON_PROPERTY_EXTERNAL_ID)TeamSyncSelectionStateExternalId externalId) {
  ...
  /**
   * <p>The external identifier for a team or organization in the source platform.</p>
   * @return externalId
  **/
  ...
  /**
   * <p>The operation to perform on the selected hierarchy.
   * When set to <code>include</code>, synchronization covers the
   * referenced teams or organizations.</p>
   * @return operation
  **/
  ...
  /**
   * <p>The scope of the selection. When set to <code>subtree</code>,
   * synchronization includes the referenced team or
   * organization and everything nested under it.</p>
   * @return scope
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.externalId, teamSyncSelectionStateItem.externalId) && Objects.equals(this.operation, teamSyncSelectionStateItem.operation) && Objects.equals(this.scope, teamSyncSelectionStateItem.scope) && Objects.equals(this.additionalProperties, teamSyncSelectionStateItem.additionalProperties);
  }
