...
public class LLMObsAnnotationAssessment extends ModelEnum<String> {
  ...
  public static class LLMObsAnnotationAssessmentSerializer extends StdSerializer<LLMObsAnnotationAssessment> {
      ...
      @Override
      public void serialize(LLMObsAnnotationAssessment value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
