...
public class CreateStatusPageRequestDataAttributes {
  ...
  public static final String JSON_PROPERTY_SLACK_SUBSCRIPTIONS_ENABLED = "slack_subscriptions_enabled";
  ...
  public CreateStatusPageRequestDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)CreateStatusPageRequestDataAttributesType type,
            @JsonProperty(required=true, value=JSON_PROPERTY_VISUALIZATION_TYPE)CreateStatusPageRequestDataAttributesVisualizationType visualizationType) {
  ...
  /**
   * <p>The base64-encoded image data displayed on the status page.</p>
   * @return companyLogo
  **/
  ...
  public CreateStatusPageRequestDataAttributes components(List<CreateStatusPageRequestDataAttributesComponentsItems> components) {
  ...
  public CreateStatusPageRequestDataAttributes addComponentsItem(CreateStatusPageRequestDataAttributesComponentsItems componentsItem) {
  ...
  /**
   * <p>The components displayed on the status page.</p>
   * @return components
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The Slack app icon URL for the status page.</p>
   * @return slackAppIcon
  **/
      @jakarta.annotation.Nullable
  ...
  public CreateStatusPageRequestDataAttributes slackSubscriptionsEnabled(Boolean slackSubscriptionsEnabled) {
    this.slackSubscriptionsEnabled = slackSubscriptionsEnabled;
    return this;
  }

  /**
   * <p>Whether Slack subscriptions are enabled for the status page.</p>
  ...
  **/
  ...
  public CreateStatusPageRequestDataAttributes type(CreateStatusPageRequestDataAttributesType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
  ...
  public CreateStatusPageRequestDataAttributes visualizationType(CreateStatusPageRequestDataAttributesVisualizationType visualizationType) {
    this.visualizationType = visualizationType;
    this.unparsed |= !visualizationType.isValid();
    return this;
  }
