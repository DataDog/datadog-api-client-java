...
public class CreateStatusPageRequestDataAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(companyLogo,components,domainPrefix,emailHeaderImage,enabled,favicon,name,subscriptionsEnabled,type,visualizationType, additionalProperties);
  }
