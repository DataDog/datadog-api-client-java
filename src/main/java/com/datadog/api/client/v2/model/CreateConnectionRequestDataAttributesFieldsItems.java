...
/**
   * <p>Definition of a custom attribute field to import from a data source connection.</p>
 */
@JsonPropertyOrder({
...
public class CreateConnectionRequestDataAttributesFieldsItems {
  ...
  /**
   * <p>Human-readable explanation of what the field represents.</p>
   * @return description
  **/
  ...
  /**
   * <p>The human-readable label for the field shown in the UI.</p>
   * @return displayName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of group labels used to categorize the field.</p>
   * @return groups
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The unique identifier for the field within the connection.</p>
   * @return id
  **/
  ...
  /**
   * <p>The name of the column or attribute in the source data system that maps to this field.</p>
   * @return sourceName
  **/
  ...
  /**
   * <p>The data type of the field (for example, string or number).</p>
   * @return type
  **/
