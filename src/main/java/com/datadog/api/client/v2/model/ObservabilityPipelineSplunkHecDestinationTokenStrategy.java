...
public class ObservabilityPipelineSplunkHecDestinationTokenStrategy extends ModelEnum<String> {
  ...
  @JsonCreator
  public static ObservabilityPipelineSplunkHecDestinationTokenStrategy fromValue(String value) {
    return new ObservabilityPipelineSplunkHecDestinationTokenStrategy(value);
  }
}
