...
public class HamrOrgConnectionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("hamr_org_connections"));

  public static final HamrOrgConnectionType HAMR_ORG_CONNECTIONS = new HamrOrgConnectionType("hamr_org_connections");
  ...
  public static class HamrOrgConnectionTypeSerializer extends StdSerializer<HamrOrgConnectionType> {
      ...
      @Override
      public void serialize(HamrOrgConnectionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
