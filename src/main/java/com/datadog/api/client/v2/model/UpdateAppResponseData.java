...
/**
   * <p>The data object containing the updated app definition.</p>
 */
@JsonPropertyOrder({
...
public class UpdateAppResponseData {
  ...
  @JsonCreator
  public UpdateAppResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)UpdateAppResponseDataAttributes attributes,
  ...
  **/
  ...
  public UpdateAppResponseData type(AppDefinitionType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, updateAppResponseData.attributes) && Objects.equals(this.id, updateAppResponseData.id) && Objects.equals(this.type, updateAppResponseData.type) && Objects.equals(this.additionalProperties, updateAppResponseData.additionalProperties);
  }
