...
/**
   * <p>Specification for updating an existing field in a connection, including which field to modify and the new values.</p>
 */
@JsonPropertyOrder({
...
public class UpdateConnectionRequestDataAttributesFieldsToUpdateItems {
  ...
  /**
   * <p>The identifier of the existing field to update.</p>
   * @return fieldId
  **/
  ...
  /**
   * <p>The new description to set for the field.</p>
  ...
  **/
  ...
  /**
   * <p>The new human-readable display name to set for the field.</p>
  ...
  **/
  ...
  /**
   * <p>The new identifier to assign to the field, if renaming it.</p>
  ...
  **/
  ...
  /**
   * <p>The updated list of group labels to associate with the field.</p>
