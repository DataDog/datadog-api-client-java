...
/**
   * <p>A Cloud Cost Management tag key paired with the sources that produced it.</p>
 */
@JsonPropertyOrder({
...
public class CostTagKeySource {
  ...
  @JsonCreator
  public CostTagKeySource(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CostTagKeySourceAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The tag key identifier. Equal to the empty-tag sentinel <code>__empty_tag_key__</code> when the tag key is empty.</p>
   * @return id
  **/
  ...
  /**
   * <p>Type of the Cloud Cost Management tag source resource.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, costTagKeySource.attributes) && Objects.equals(this.id, costTagKeySource.id) && Objects.equals(this.type, costTagKeySource.type) && Objects.equals(this.additionalProperties, costTagKeySource.additionalProperties);
  }
