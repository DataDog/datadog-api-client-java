...
/** The source type. Always <code>aws_s3</code>. */
@JsonSerialize(
    using =
...
public class ObservabilityPipelineAmazonS3SourceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("aws_s3"));

  public static final ObservabilityPipelineAmazonS3SourceType AWS_S3 =
      new ObservabilityPipelineAmazonS3SourceType("aws_s3");
