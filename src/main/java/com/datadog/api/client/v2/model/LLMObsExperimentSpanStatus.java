...
public class LLMObsExperimentSpanStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ok", "error"));
  ...
  public static class LLMObsExperimentSpanStatusSerializer extends StdSerializer<LLMObsExperimentSpanStatus> {
      ...
      @Override
      public void serialize(LLMObsExperimentSpanStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
