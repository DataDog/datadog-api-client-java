 ...
 * config</code> is omitted, the first version stores an empty object. Configuration authoring must
 * be enabled for your organization to supply <code>config</code>. Otherwise, supplying it,
