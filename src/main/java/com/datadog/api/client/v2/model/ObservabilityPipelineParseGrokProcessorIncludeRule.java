...
/**
 * A Grok parsing rule selected using the <code>include</code> query. Each rule defines how to
 * extract structured fields from logs matching a Datadog search query.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineParseGrokProcessorIncludeRule {
  ...
  public ObservabilityPipelineParseGrokProcessorIncludeRule matchRules(
      List<ObservabilityPipelineParseGrokProcessorRuleMatchRule> matchRules) {
    this.matchRules = matchRules;
    for (ObservabilityPipelineParseGrokProcessorRuleMatchRule item : matchRules) {
      this.unparsed |= item.unparsed;
  ...
  public ObservabilityPipelineParseGrokProcessorIncludeRule addMatchRulesItem(
      ObservabilityPipelineParseGrokProcessorRuleMatchRule matchRulesItem) {
  ...
  /**
   * A list of Grok parsing rules that define how to extract fields from matching logs. Each rule
   * must contain a name and a valid Grok pattern.
   *
   * @return matchRules
   */
  ...
  public ObservabilityPipelineParseGrokProcessorIncludeRule addSupportRulesItem(
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineParseGrokProcessorIncludeRule putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.include, observabilityPipelineParseGrokProcessorIncludeRule.include)
        && Objects.equals(
            this.matchRules, observabilityPipelineParseGrokProcessorIncludeRule.matchRules)
        && Objects.equals(
            this.supportRules, observabilityPipelineParseGrokProcessorIncludeRule.supportRules)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineParseGrokProcessorIncludeRule.additionalProperties);
  }
