...
public class EscalationTarget extends AbstractOpenApiSchema {
    ...
    public static class EscalationTargetSerializer extends StdSerializer<EscalationTarget> {
        ...
        @Override
        public void serialize(EscalationTarget value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class EscalationTargetDeserializer extends StdDeserializer<EscalationTarget> {
        ...
        @Override
        public EscalationTarget deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (TeamTarget.class.equals(Integer.class) || TeamTarget.class.equals(Long.class) || TeamTarget.class.equals(Float.class) || TeamTarget.class.equals(Double.class) || TeamTarget.class.equals(Boolean.class) || TeamTarget.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((TeamTarget.class.equals(Integer.class) || TeamTarget.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((TeamTarget.class.equals(Float.class) || TeamTarget.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (TeamTarget.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (TeamTarget.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (UserTarget.class.equals(Integer.class) || UserTarget.class.equals(Long.class) || UserTarget.class.equals(Float.class) || UserTarget.class.equals(Double.class) || UserTarget.class.equals(Boolean.class) || UserTarget.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((UserTarget.class.equals(Integer.class) || UserTarget.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((UserTarget.class.equals(Float.class) || UserTarget.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (UserTarget.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (UserTarget.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ScheduleTarget.class.equals(Integer.class) || ScheduleTarget.class.equals(Long.class) || ScheduleTarget.class.equals(Float.class) || ScheduleTarget.class.equals(Double.class) || ScheduleTarget.class.equals(Boolean.class) || ScheduleTarget.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ScheduleTarget.class.equals(Integer.class) || ScheduleTarget.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ScheduleTarget.class.equals(Float.class) || ScheduleTarget.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ScheduleTarget.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ScheduleTarget.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ConfiguredScheduleTarget.class.equals(Integer.class) || ConfiguredScheduleTarget.class.equals(Long.class) || ConfiguredScheduleTarget.class.equals(Float.class) || ConfiguredScheduleTarget.class.equals(Double.class) || ConfiguredScheduleTarget.class.equals(Boolean.class) || ConfiguredScheduleTarget.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ConfiguredScheduleTarget.class.equals(Integer.class) || ConfiguredScheduleTarget.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ConfiguredScheduleTarget.class.equals(Float.class) || ConfiguredScheduleTarget.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ConfiguredScheduleTarget.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ConfiguredScheduleTarget.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * TeamTarget, UserTarget, ScheduleTarget, ConfiguredScheduleTarget
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be TeamTarget, UserTarget, ScheduleTarget, ConfiguredScheduleTarget");
    }
    ...
    /**
     * Get the actual instance of `TeamTarget`. If the actual instance is not `TeamTarget`,
    ...
    /**
     * Get the actual instance of `UserTarget`. If the actual instance is not `UserTarget`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `ConfiguredScheduleTarget`. If the actual instance is not `ConfiguredScheduleTarget`,
     * the ClassCastException will be thrown.
     *
