...
/**
   * <p>The new span-based metric properties.</p>
 */
@JsonPropertyOrder({
...
public class SpansMetricCreateData {
  ...
  @JsonCreator
  public SpansMetricCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SpansMetricCreateAttributes attributes,
  ...
  /**
   * <p>The object describing the Datadog span-based metric to create.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The name of the span-based metric.</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of resource. The value should always be spans_metrics.</p>
   * @return type
  **/
   ...
   * @return SpansMetricCreateData
   */
  @JsonAnySetter
  public SpansMetricCreateData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, spansMetricCreateData.attributes) && Objects.equals(this.id, spansMetricCreateData.id) && Objects.equals(this.type, spansMetricCreateData.type) && Objects.equals(this.additionalProperties, spansMetricCreateData.additionalProperties);
  }
