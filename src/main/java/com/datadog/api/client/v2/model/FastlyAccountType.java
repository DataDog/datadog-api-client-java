...
public class FastlyAccountType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("fastly-accounts"));
  ...
  public static class FastlyAccountTypeSerializer extends StdSerializer<FastlyAccountType> {
      ...
      @Override
      public void serialize(FastlyAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
