...
public class CIAppTestLevel extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("session", "module", "suite", "test"));
  ...
  public static class CIAppTestLevelSerializer extends StdSerializer<CIAppTestLevel> {
      ...
      @Override
      public void serialize(CIAppTestLevel value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
