...
public class GlobalOrgType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("global_user_orgs"));
  ...
  public static class GlobalOrgTypeSerializer extends StdSerializer<GlobalOrgType> {
      ...
      @Override
      public void serialize(GlobalOrgType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
