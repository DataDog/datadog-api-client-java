...
public class LLMObsUpdatePromptVersionDataAttributes {
  ...
  /**
   * <p>Optional new description for this version.</p>
   * @return description
  **/
  ...
  /**
   * <p>Optional feature-flag environment UUIDs the service attempts to enable and configure to use this version as their default.</p>
   * @return envIds
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Optional new labels for this version. Do not use this attribute for new integrations.</p>
   * @return labels
   * @deprecated
  **/
      @Deprecated
  ...
  public boolean equals(Object o) {
    ...
    LLMObsUpdatePromptVersionDataAttributes llmObsUpdatePromptVersionDataAttributes = (LLMObsUpdatePromptVersionDataAttributes) o;
    return Objects.equals(this.description, llmObsUpdatePromptVersionDataAttributes.description) && Objects.equals(this.envIds, llmObsUpdatePromptVersionDataAttributes.envIds) && Objects.equals(this.labels, llmObsUpdatePromptVersionDataAttributes.labels);
  }
