...
public class Remediation {
  ...
  public Remediation(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_AVOIDED_ADVISORIES)
          List<Advisory> avoidedAdvisories,
      @JsonProperty(required = true, value = JSON_PROPERTY_FIXED_ADVISORIES)
          List<Advisory> fixedAdvisories,
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_NEW_ADVISORIES)
          List<Advisory> newAdvisories,
      @JsonProperty(required = true, value = JSON_PROPERTY_REMAINING_ADVISORIES)
          List<Advisory> remainingAdvisories,
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoSolvable, remediation.autoSolvable)
        && Objects.equals(this.avoidedAdvisories, remediation.avoidedAdvisories)
        && Objects.equals(this.fixedAdvisories, remediation.fixedAdvisories)
        && Objects.equals(this.libraryName, remediation.libraryName)
        && Objects.equals(this.libraryVersion, remediation.libraryVersion)
        && Objects.equals(this.newAdvisories, remediation.newAdvisories)
        && Objects.equals(this.remainingAdvisories, remediation.remainingAdvisories)
        && Objects.equals(this.type, remediation.type)
        && Objects.equals(this.additionalProperties, remediation.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    remainingAdvisories: ")
        .append(toIndentedString(remainingAdvisories))
        .append("\n");
