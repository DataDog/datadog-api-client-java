...
public class ActionsDatastoresApi {
   ...
   *
   * @param datastoreId The ID of the datastore. (required)
   * @return DeleteAppsDatastoreResponse
   * @throws ApiException if fails to make API call
   */
  public DeleteAppsDatastoreResponse deleteDatastore(String datastoreId) throws ApiException {
    return deleteDatastoreWithHttpInfo(datastoreId).getData();
  }
   ...
   *
   * @param datastoreId The ID of the datastore. (required)
   * @return CompletableFuture&lt;DeleteAppsDatastoreResponse&gt;
   */
  public CompletableFuture<DeleteAppsDatastoreResponse> deleteDatastoreAsync(String datastoreId) {
   ...
   *
   * @param datastoreId The ID of the datastore. (required)
   * @return ApiResponse&lt;DeleteAppsDatastoreResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
   *     <table border="1">
   *    <caption>Response details</caption>
   ...
   *     </table>
   */
  public ApiResponse<DeleteAppsDatastoreResponse> deleteDatastoreWithHttpInfo(String datastoreId)
      throws ApiException {
    ...
    return apiClient.invokeAPI(
        ...
        new HashMap<String, Object>(),
        false,
        new GenericType<DeleteAppsDatastoreResponse>() {});
  }
   ...
   *
   * @param datastoreId The ID of the datastore. (required)
   * @return CompletableFuture&lt;ApiResponse&lt;DeleteAppsDatastoreResponse&gt;&gt;
   */
  public CompletableFuture<ApiResponse<DeleteAppsDatastoreResponse>>
      deleteDatastoreWithHttpInfoAsync(String datastoreId) {
    Object localVarPostBody = null;

    // verify the required parameter 'datastoreId' is set
    if (datastoreId == null) {
      CompletableFuture<ApiResponse<DeleteAppsDatastoreResponse>> result =
          new CompletableFuture<>();
      result.completeExceptionally(
          new ApiException(
              400, "Missing the required parameter 'datastoreId' when calling deleteDatastore"));
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteDatastoreItem(String datastoreId, DeleteAppsDatastoreItemRequest body)
      throws ApiException {
    deleteDatastoreItemWithHttpInfo(datastoreId, body);
  }
   ...
   */
  public CompletableFuture<Void> deleteDatastoreItemAsync(
   ...
   *     </table>
   */
  public ApiResponse<Void> deleteDatastoreItemWithHttpInfo(
   ...
   */
  public CompletableFuture<ApiResponse<Void>> deleteDatastoreItemWithHttpInfoAsync(
      String datastoreId, DeleteAppsDatastoreItemRequest body) {
    Object localVarPostBody = body;
  ...
  public ApiResponse<ItemApiPayloadArray> listDatastoreItemsWithHttpInfo(
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "itemKey", itemKey));
