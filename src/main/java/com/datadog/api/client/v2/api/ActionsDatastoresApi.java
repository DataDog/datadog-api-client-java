 ...
 */
  public DeleteAppsDatastoreItemResponseArray  bulkDeleteDatastoreItems(String datastoreId, BulkDeleteAppsDatastoreItemsRequest body) throws ApiException {
 ...
 */
  public CompletableFuture<DeleteAppsDatastoreItemResponseArray>bulkDeleteDatastoreItemsAsync(String datastoreId, BulkDeleteAppsDatastoreItemsRequest body) {
    return bulkDeleteDatastoreItemsWithHttpInfoAsync(datastoreId, body).thenApply(response -> {
   ...
   *     </table>
   */
  public ApiResponse<DeleteAppsDatastoreItemResponseArray> bulkDeleteDatastoreItemsWithHttpInfo(String datastoreId, BulkDeleteAppsDatastoreItemsRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'datastoreId' is set
    if (datastoreId == null) {
      throw new ApiException(400, "Missing the required parameter 'datastoreId' when calling bulkDeleteDatastoreItems");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling bulkDeleteDatastoreItems");
    }
    // create path and map variables
    String localVarPath = "/api/v2/actions-datastores/{datastore_id}/items/bulk"
      .replaceAll("\\{" + "datastore_id" + "\\}", apiClient.escapeString(datastoreId.toString()));

    
    Map<String, String> localVarHeaderParams = new HashMap<String, String>();


    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.bulkDeleteDatastoreItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DeleteAppsDatastoreItemResponseArray>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponseArray>> bulkDeleteDatastoreItemsWithHttpInfoAsync(String datastoreId, BulkDeleteAppsDatastoreItemsRequest body) {
    Object localVarPostBody = body;

    // verify the required parameter 'datastoreId' is set
    if (datastoreId == null) {
        CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponseArray>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'datastoreId' when calling bulkDeleteDatastoreItems"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponseArray>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling bulkDeleteDatastoreItems"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/actions-datastores/{datastore_id}/items/bulk"
    ...
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.bulkDeleteDatastoreItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponseArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DeleteAppsDatastoreItemResponseArray>() {});
  }
 ...
 */
  public CompletableFuture<PutAppsDatastoreItemResponseArray>bulkWriteDatastoreItemsAsync(String datastoreId, BulkPutAppsDatastoreItemsRequest body) {
    return bulkWriteDatastoreItemsWithHttpInfoAsync(datastoreId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Creates or replaces multiple items in a datastore by their keys in a single operation.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
   * @param body  (required)
  ...
  public ApiResponse<PutAppsDatastoreItemResponseArray> bulkWriteDatastoreItemsWithHttpInfo(String datastoreId, BulkPutAppsDatastoreItemsRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.bulkWriteDatastoreItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PutAppsDatastoreItemResponseArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PutAppsDatastoreItemResponseArray>> bulkWriteDatastoreItemsWithHttpInfoAsync(String datastoreId, BulkPutAppsDatastoreItemsRequest body) {
    ...
    // verify the required parameter 'datastoreId' is set
    if (datastoreId == null) {
        CompletableFuture<ApiResponse<PutAppsDatastoreItemResponseArray>> result = new CompletableFuture<>();
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.bulkWriteDatastoreItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PutAppsDatastoreItemResponseArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PutAppsDatastoreItemResponseArray>() {});
  }
 ...
 */
  public CompletableFuture<CreateAppsDatastoreResponse>createDatastoreAsync(CreateAppsDatastoreRequest body) {
    return createDatastoreWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<CreateAppsDatastoreResponse> createDatastoreWithHttpInfo(CreateAppsDatastoreRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.createDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CreateAppsDatastoreResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<CreateAppsDatastoreResponse>> createDatastoreWithHttpInfoAsync(CreateAppsDatastoreRequest body) {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
        CompletableFuture<ApiResponse<CreateAppsDatastoreResponse>> result = new CompletableFuture<>();
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.createDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CreateAppsDatastoreResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<CreateAppsDatastoreResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteDatastoreAsync(String datastoreId) {
    return deleteDatastoreWithHttpInfoAsync(datastoreId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes a datastore by its unique identifier.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
  ...
  public ApiResponse<Void> deleteDatastoreWithHttpInfo(String datastoreId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/actions-datastores/{datastore_id}"
      .replaceAll("\\{" + "datastore_id" + "\\}", apiClient.escapeString(datastoreId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.deleteDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteDatastoreWithHttpInfoAsync(String datastoreId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.deleteDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<DeleteAppsDatastoreItemResponse>deleteDatastoreItemAsync(String datastoreId, DeleteAppsDatastoreItemRequest body) {
    return deleteDatastoreItemWithHttpInfoAsync(datastoreId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes an item from a datastore by its key.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
   * @param body  (required)
  ...
  public ApiResponse<DeleteAppsDatastoreItemResponse> deleteDatastoreItemWithHttpInfo(String datastoreId, DeleteAppsDatastoreItemRequest body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/actions-datastores/{datastore_id}/items"
      .replaceAll("\\{" + "datastore_id" + "\\}", apiClient.escapeString(datastoreId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.deleteDatastoreItem", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DeleteAppsDatastoreItemResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponse>> deleteDatastoreItemWithHttpInfoAsync(String datastoreId, DeleteAppsDatastoreItemRequest body) {
    ...
    // verify the required parameter 'datastoreId' is set
    if (datastoreId == null) {
        CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponse>> result = new CompletableFuture<>();
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.deleteDatastoreItem", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DeleteAppsDatastoreItemResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DeleteAppsDatastoreItemResponse>() {});
  }
 ...
 */
  public CompletableFuture<Datastore>getDatastoreAsync(String datastoreId) {
    return getDatastoreWithHttpInfoAsync(datastoreId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Retrieves a specific datastore by its ID.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
  ...
  public ApiResponse<Datastore> getDatastoreWithHttpInfo(String datastoreId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.getDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<Datastore>() {});
  }
  ...
  public CompletableFuture<ApiResponse<Datastore>> getDatastoreWithHttpInfoAsync(String datastoreId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.getDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Datastore>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<Datastore>() {});
  }
  ...
  public static class ListDatastoreItemsOptionalParameters {
    ...
    /**
     * Set filter.
     * @param filter Optional query filter to search items using the <a href="https://docs.datadoghq.com/logs/explorer/search_syntax/">logs search syntax</a>. (optional)
    ...
    /**
     * Set itemKey.
     * @param itemKey Optional primary key value to retrieve a specific item. Cannot be used together with the filter parameter. (optional)
     * @return ListDatastoreItemsOptionalParameters
     */
    ...
    /**
     * Set pageLimit.
     * @param pageLimit Optional field to limit the number of items to return per page for pagination. Up to 100 items can be returned per page. (optional)
     * @return ListDatastoreItemsOptionalParameters
     */
    ...
    /**
     * Set pageOffset.
     * @param pageOffset Optional field to offset the number of items to skip from the beginning of the result set for pagination. (optional)
     * @return ListDatastoreItemsOptionalParameters
     */
    ...
    /**
     * Set sort.
     * @param sort Optional field to sort results by. Prefix with '-' for descending order (e.g., '-created_at'). (optional)
     * @return ListDatastoreItemsOptionalParameters
     */
 ...
 */
  public ItemApiPayloadArray listDatastoreItems (String datastoreId) throws ApiException {
    return listDatastoreItemsWithHttpInfo( datastoreId, new ListDatastoreItemsOptionalParameters()).getData();
  }
 ...
 */
  public CompletableFuture<ItemApiPayloadArray>listDatastoreItemsAsync(String datastoreId) {
    return listDatastoreItemsWithHttpInfoAsync(datastoreId, new ListDatastoreItemsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<ItemApiPayloadArray>listDatastoreItemsAsync( String datastoreId, ListDatastoreItemsOptionalParameters parameters) {
    return listDatastoreItemsWithHttpInfoAsync(datastoreId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Lists items from a datastore. You can filter the results by specifying either an item key or a filter query parameter, but not both at the same time. Supports server-side pagination for large datasets.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<ItemApiPayloadArray> listDatastoreItemsWithHttpInfo(String datastoreId, ListDatastoreItemsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.listDatastoreItems", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ItemApiPayloadArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ItemApiPayloadArray>> listDatastoreItemsWithHttpInfoAsync(String datastoreId, ListDatastoreItemsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.listDatastoreItems", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ItemApiPayloadArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ItemApiPayloadArray>() {});
  }
 ...
 */
  public CompletableFuture<DatastoreArray>listDatastoresAsync() {
    return listDatastoresWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Lists all datastores for the organization.</p>
   *
  ...
  public ApiResponse<DatastoreArray> listDatastoresWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.listDatastores", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatastoreArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DatastoreArray>> listDatastoresWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.listDatastores", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DatastoreArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatastoreArray>() {});
  }
 ...
 */
  public CompletableFuture<Datastore>updateDatastoreAsync(String datastoreId, UpdateAppsDatastoreRequest body) {
    return updateDatastoreWithHttpInfoAsync(datastoreId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates an existing datastore's attributes.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
   * @param body  (required)
   * @return ApiResponse&lt;Datastore&gt;
  ...
  public ApiResponse<Datastore> updateDatastoreWithHttpInfo(String datastoreId, UpdateAppsDatastoreRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.updateDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<Datastore>() {});
  }
  ...
  public CompletableFuture<ApiResponse<Datastore>> updateDatastoreWithHttpInfoAsync(String datastoreId, UpdateAppsDatastoreRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.updateDatastore", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Datastore>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<Datastore>() {});
  }
 ...
 */
  public CompletableFuture<ItemApiPayload>updateDatastoreItemAsync(String datastoreId, UpdateAppsDatastoreItemRequest body) {
    return updateDatastoreItemWithHttpInfoAsync(datastoreId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Partially updates an item in a datastore by its key.</p>
   *
   * @param datastoreId The unique identifier of the datastore to retrieve. (required)
   * @param body  (required)
  ...
  public ApiResponse<ItemApiPayload> updateDatastoreItemWithHttpInfo(String datastoreId, UpdateAppsDatastoreItemRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ActionsDatastoresApi.updateDatastoreItem", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ItemApiPayload>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ItemApiPayload>> updateDatastoreItemWithHttpInfoAsync(String datastoreId, UpdateAppsDatastoreItemRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ActionsDatastoresApi.updateDatastoreItem", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ItemApiPayload>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ItemApiPayload>() {});
  }
}