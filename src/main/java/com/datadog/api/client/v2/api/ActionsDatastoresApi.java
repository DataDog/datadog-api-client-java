...
public class ActionsDatastoresApi {
   ...
   *
   * <p>See {@link #writeDatastoreItemWithHttpInfo}.
   *
   * @param datastoreId The ID of the datastore. (required)
   * @param body (required)
   ...
   * @throws ApiException if fails to make API call
   */
  public PutAppsDatastoreItemResponse writeDatastoreItem(
      String datastoreId, PutAppsDatastoreItemRequest body) throws ApiException {
    return writeDatastoreItemWithHttpInfo(datastoreId, body).getData();
  }

  /**
   * Write datastore item.
   *
   * <p>See {@link #writeDatastoreItemWithHttpInfoAsync}.
   *
   * @param datastoreId The ID of the datastore. (required)
   * @param body (required)
   * @return CompletableFuture&lt;PutAppsDatastoreItemResponse&gt;
   */
  public CompletableFuture<PutAppsDatastoreItemResponse> writeDatastoreItemAsync(
      String datastoreId, PutAppsDatastoreItemRequest body) {
    return writeDatastoreItemWithHttpInfoAsync(datastoreId, body)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<PutAppsDatastoreItemResponse> writeDatastoreItemWithHttpInfo(
      String datastoreId, PutAppsDatastoreItemRequest body) throws ApiException {
    Object localVarPostBody = body;
    ...
    if (datastoreId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'datastoreId' when calling writeDatastoreItem");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling writeDatastoreItem");
    }
    // create path and map variables
    String localVarPath =
        "/api/v2/actions-datastores/{datastore_id}/items"
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ActionsDatastoresApi.writeDatastoreItem",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
  ...
  public CompletableFuture<ApiResponse<PutAppsDatastoreItemResponse>>
      writeDatastoreItemWithHttpInfoAsync(String datastoreId, PutAppsDatastoreItemRequest body) {
    Object localVarPostBody = body;
