...
public class CloudWorkloadSecurityAgentPolicyAttributes {
  ...
  public static final String JSON_PROPERTY_CONTENT_PACK_UPDATE_AVAILABLE = "contentPackUpdateAvailable";
  ...
  **/
  ...
  public CloudWorkloadSecurityAgentPolicyAttributes contentPackUpdateAvailable(Boolean contentPackUpdateAvailable) {
    this.contentPackUpdateAvailable = JsonNullable.<Boolean>of(contentPackUpdateAvailable);
    return this;
  }

  /**
   * <p>Whether an update is available for the content pack. Only set for activated content packs, <code>null</code> otherwise</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CONTENT_PACK_UPDATE_AVAILABLE)public void setContentPackUpdateAvailable_JsonNullable(JsonNullable<Boolean> contentPackUpdateAvailable) {
  ...
  **/
  ...
  public CloudWorkloadSecurityAgentPolicyAttributes sourceDefaultPolicyId(String sourceDefaultPolicyId) {
    this.sourceDefaultPolicyId = sourceDefaultPolicyId;
    return this;
  }

  /**
   * <p>The ID of the Datadog-managed default policy this policy is derived from</p>
