...
/**
   * <p>The metadata of a scanned asset.</p>
 */
@JsonPropertyOrder({
...
public class ScannedAssetMetadata {
  ...
  @JsonCreator
  public ScannedAssetMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ScannedAssetMetadataAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The ID of the scanned asset metadata.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, scannedAssetMetadata.attributes) && Objects.equals(this.id, scannedAssetMetadata.id) && Objects.equals(this.type, scannedAssetMetadata.type) && Objects.equals(this.additionalProperties, scannedAssetMetadata.additionalProperties);
  }
