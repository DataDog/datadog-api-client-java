...
public class AWSCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class AWSCredentialsUpdateSerializer extends StdSerializer<AWSCredentialsUpdate> {
        ...
        @Override
        public void serialize(AWSCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AWSCredentialsUpdateDeserializer extends StdDeserializer<AWSCredentialsUpdate> {
        ...
        @Override
        public AWSCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AWSAssumeRoleUpdate.class.equals(Integer.class) || AWSAssumeRoleUpdate.class.equals(Long.class) || AWSAssumeRoleUpdate.class.equals(Float.class) || AWSAssumeRoleUpdate.class.equals(Double.class) || AWSAssumeRoleUpdate.class.equals(Boolean.class) || AWSAssumeRoleUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSAssumeRoleUpdate.class.equals(Integer.class) || AWSAssumeRoleUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSAssumeRoleUpdate.class.equals(Float.class) || AWSAssumeRoleUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSAssumeRoleUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSAssumeRoleUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public AWSCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `AWSAssumeRoleUpdate`. If the actual instance is not `AWSAssumeRoleUpdate`,
