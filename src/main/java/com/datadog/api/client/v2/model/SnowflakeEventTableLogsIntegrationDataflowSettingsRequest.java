 ...
 * <code>record_type</code>. Only the fields provided are changed.
 */
@JsonPropertyOrder({
  SnowflakeEventTableLogsIntegrationDataflowSettingsRequest
      .JSON_PROPERTY_EVENT_TABLE_EVENTS_ENABLED,
  SnowflakeEventTableLogsIntegrationDataflowSettingsRequest.JSON_PROPERTY_EVENT_TABLE_LOGS_ENABLED,
  SnowflakeEventTableLogsIntegrationDataflowSettingsRequest
      .JSON_PROPERTY_EVENT_TABLE_LOGS_INTERVAL_MIN,
  SnowflakeEventTableLogsIntegrationDataflowSettingsRequest
      .JSON_PROPERTY_EVENT_TABLE_SPAN_EVENTS_ENABLED,
  SnowflakeEventTableLogsIntegrationDataflowSettingsRequest.JSON_PROPERTY_EVENT_TABLE_SPANS_ENABLED
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class SnowflakeEventTableLogsIntegrationDataflowSettingsRequest {
  ...
  public SnowflakeEventTableLogsIntegrationDataflowSettingsRequest eventTableEventsEnabled(
  ...
  /**
   * Whether records with a <code>record_type</code> of <code>event</code> are collected. Defaults
   * to <code>false</code>.
   *
  ...
  public SnowflakeEventTableLogsIntegrationDataflowSettingsRequest eventTableLogsEnabled(
  ...
  /**
   * Whether records with a <code>record_type</code> of <code>log</code> are collected. Defaults to
   * <code>false</code>.
   *
  ...
  public SnowflakeEventTableLogsIntegrationDataflowSettingsRequest eventTableLogsIntervalMin(
  ...
  /**
   * How often event table records are collected, in minutes. One of <code>5</code>, <code>15</code>
  ...
  public SnowflakeEventTableLogsIntegrationDataflowSettingsRequest eventTableSpanEventsEnabled(
  ...
  public SnowflakeEventTableLogsIntegrationDataflowSettingsRequest eventTableSpansEnabled(
  ...
  /**
   * Whether records with a <code>record_type</code> of <code>span</code> are collected. Defaults to
   * <code>false</code>.
   *
  ...
  /**
   * Return true if this SnowflakeEventTableLogsIntegrationDataflowSettingsRequest object is equal
   * to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SnowflakeEventTableLogsIntegrationDataflowSettingsRequest
        snowflakeEventTableLogsIntegrationDataflowSettingsRequest =
            (SnowflakeEventTableLogsIntegrationDataflowSettingsRequest) o;
    return Objects.equals(
            this.eventTableEventsEnabled,
            snowflakeEventTableLogsIntegrationDataflowSettingsRequest.eventTableEventsEnabled)
        && Objects.equals(
            this.eventTableLogsEnabled,
            snowflakeEventTableLogsIntegrationDataflowSettingsRequest.eventTableLogsEnabled)
        && Objects.equals(
            this.eventTableLogsIntervalMin,
            snowflakeEventTableLogsIntegrationDataflowSettingsRequest.eventTableLogsIntervalMin)
        && Objects.equals(
            this.eventTableSpanEventsEnabled,
            snowflakeEventTableLogsIntegrationDataflowSettingsRequest.eventTableSpanEventsEnabled)
        && Objects.equals(
            this.eventTableSpansEnabled,
            snowflakeEventTableLogsIntegrationDataflowSettingsRequest.eventTableSpansEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnowflakeEventTableLogsIntegrationDataflowSettingsRequest {\n");
