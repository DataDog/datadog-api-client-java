...
public class ProductAnalyticsJourneyFunnelResponseAttributes {
  ...
  @JsonCreator
  public ProductAnalyticsJourneyFunnelResponseAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_END_TO_END_CONVERSION_RATE)
          Double endToEndConversionRate,
      @JsonProperty(required = true, value = JSON_PROPERTY_END_TO_END_ELAPSED_TIME)
          ProductAnalyticsElapsedTime endToEndElapsedTime,
      @JsonProperty(required = true, value = JSON_PROPERTY_FUNNEL_STEPS)
  ...
  public ProductAnalyticsJourneyFunnelResponseAttributes endToEndConversionRate(
      Double endToEndConversionRate) {
    this.endToEndConversionRate = endToEndConversionRate;
    return this;
  }
  ...
  public ProductAnalyticsJourneyFunnelResponseAttributes endToEndElapsedTime(
      ProductAnalyticsElapsedTime endToEndElapsedTime) {
    this.endToEndElapsedTime = endToEndElapsedTime;
    this.unparsed |= endToEndElapsedTime.unparsed;
    return this;
  ...
  public ProductAnalyticsJourneyFunnelResponseAttributes funnelSteps(
      List<ProductAnalyticsJourneyFunnelStep> funnelSteps) {
    this.funnelSteps = funnelSteps;
    for (ProductAnalyticsJourneyFunnelStep item : funnelSteps) {
      this.unparsed |= item.unparsed;
  ...
  public ProductAnalyticsJourneyFunnelResponseAttributes addFunnelStepsItem(
      ProductAnalyticsJourneyFunnelStep funnelStepsItem) {
   ...
   */
  @JsonAnySetter
  public ProductAnalyticsJourneyFunnelResponseAttributes putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsJourneyFunnelResponseAttributes
        productAnalyticsJourneyFunnelResponseAttributes =
            (ProductAnalyticsJourneyFunnelResponseAttributes) o;
    return Objects.equals(
            this.endToEndConversionRate,
            productAnalyticsJourneyFunnelResponseAttributes.endToEndConversionRate)
        && Objects.equals(
            this.endToEndElapsedTime,
            productAnalyticsJourneyFunnelResponseAttributes.endToEndElapsedTime)
        && Objects.equals(
            this.funnelSteps, productAnalyticsJourneyFunnelResponseAttributes.funnelSteps)
        && Objects.equals(
            this.initialCount, productAnalyticsJourneyFunnelResponseAttributes.initialCount)
        && Objects.equals(
            this.additionalProperties,
            productAnalyticsJourneyFunnelResponseAttributes.additionalProperties);
  }
