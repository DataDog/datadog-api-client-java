...
public class OrgConnection {
  ...
  @JsonCreator
  public OrgConnection(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)OrgConnectionAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)UUID id,
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)OrgConnectionRelationships relationships,
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the org connection.</p>
   * @return id
  **/
  ...
  /**
   * <p>Related organizations and user.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, orgConnection.attributes) && Objects.equals(this.id, orgConnection.id) && Objects.equals(this.relationships, orgConnection.relationships) && Objects.equals(this.type, orgConnection.type) && Objects.equals(this.additionalProperties, orgConnection.additionalProperties);
  }
