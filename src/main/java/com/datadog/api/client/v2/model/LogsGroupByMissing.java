...
public class LogsGroupByMissing extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(LogsGroupByMissing.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class LogsGroupByMissingSerializer extends StdSerializer<LogsGroupByMissing> {
        public LogsGroupByMissingSerializer(Class<LogsGroupByMissing> t) {
            super(t);
        }

        public LogsGroupByMissingSerializer() {
            this(null);
        }

        @Override
        public void serialize(LogsGroupByMissing value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class LogsGroupByMissingDeserializer extends StdDeserializer<LogsGroupByMissing> {
        public LogsGroupByMissingDeserializer() {
            this(LogsGroupByMissing.class);
        }

        public LogsGroupByMissingDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public LogsGroupByMissing deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            LogsGroupByMissing ret = new LogsGroupByMissing();
            if (match == 1) {
         ...
         */
        @Override
        public LogsGroupByMissing getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "LogsGroupByMissing cannot be null");
        }
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return LogsGroupByMissing.schemas;
    }
