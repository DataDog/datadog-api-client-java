...
/**
   * <p>Cost data for a single budget entry.</p>
 */
@JsonPropertyOrder({
...
public class BudgetWithEntriesDataAttributesEntriesItemsCosts {
  ...
  /**
   * <p>The actual cost for this entry. Present only when <code>actual=true</code> is requested.</p>
   * @return actual
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ACTUAL)public void setActual_JsonNullable(JsonNullable<Double> actual) {
    this.actual = actual;
  }
  ...
  /**
   * <p>The budgeted amount for this entry.</p>
   * @return amount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_AMOUNT)public void setAmount_JsonNullable(JsonNullable<Double> amount) {
    this.amount = amount;
  }
  ...
  /**
   * <p>The custom forecast override for this entry. <code>null</code> when <code>forecast=true</code> is requested but no custom forecast has been set for this entry's month. A numeric value, including <code>0</code>, indicates an explicit custom forecast override. Omitted when <code>forecast=false</code> or the feature is not available for the organization.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FORECAST)public void setCustomForecast_JsonNullable(JsonNullable<Double> customForecast) {
  ...
  /**
   * <p>The final forecast for this entry, with any custom forecast override applied. Present only when <code>forecast=true</code> is requested.</p>
   * @return forecast
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_FORECAST)public void setForecast_JsonNullable(JsonNullable<Double> forecast) {
  ...
  /**
   * <p>The out-of-the-box ML forecast for this entry, before custom overrides. Present only when <code>forecast=true</code> is requested.</p>
   * @return ootbForecast
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_OOTB_FORECAST)public void setOotbForecast_JsonNullable(JsonNullable<Double> ootbForecast) {
   ...
   */
  @JsonAnySetter
  public BudgetWithEntriesDataAttributesEntriesItemsCosts putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BudgetWithEntriesDataAttributesEntriesItemsCosts budgetWithEntriesDataAttributesEntriesItemsCosts = (BudgetWithEntriesDataAttributesEntriesItemsCosts) o;
    return Objects.equals(this.actual, budgetWithEntriesDataAttributesEntriesItemsCosts.actual) && Objects.equals(this.amount, budgetWithEntriesDataAttributesEntriesItemsCosts.amount) && Objects.equals(this.customForecast, budgetWithEntriesDataAttributesEntriesItemsCosts.customForecast) && Objects.equals(this.forecast, budgetWithEntriesDataAttributesEntriesItemsCosts.forecast) && Objects.equals(this.ootbForecast, budgetWithEntriesDataAttributesEntriesItemsCosts.ootbForecast) && Objects.equals(this.additionalProperties, budgetWithEntriesDataAttributesEntriesItemsCosts.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(actual,amount,customForecast,forecast,ootbForecast, additionalProperties);
  }
