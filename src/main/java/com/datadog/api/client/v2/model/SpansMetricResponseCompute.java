...
public class SpansMetricResponseCompute {
  ...
  public SpansMetricResponseCompute aggregationType(SpansMetricComputeAggregationType aggregationType) {
  ...
  **/
   ...
   * Only present when the <code>aggregation_type</code> is <code>distribution</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The path to the value the span-based metric will aggregate on (only used if the aggregation type is a "distribution").</p>
   * @return path
  **/
      @jakarta.annotation.Nullable
   ...
   * @return SpansMetricResponseCompute
   */
  @JsonAnySetter
  public SpansMetricResponseCompute putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregationType, spansMetricResponseCompute.aggregationType) && Objects.equals(this.includePercentiles, spansMetricResponseCompute.includePercentiles) && Objects.equals(this.path, spansMetricResponseCompute.path) && Objects.equals(this.additionalProperties, spansMetricResponseCompute.additionalProperties);
  }
