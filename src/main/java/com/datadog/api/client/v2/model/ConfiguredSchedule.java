...
/**
   * <p>Full resource representation of a configured schedule target with position (previous, current, or next).</p>
 */
@JsonPropertyOrder({
...
public class ConfiguredSchedule {
  ...
  @JsonCreator
  public ConfiguredSchedule(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ConfiguredScheduleTargetAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)ConfiguredScheduleTargetRelationships relationships,
  ...
  **/
  ...
  /**
   * <p>Represents the relationships of a configured schedule target.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, configuredSchedule.attributes) && Objects.equals(this.id, configuredSchedule.id) && Objects.equals(this.relationships, configuredSchedule.relationships) && Objects.equals(this.type, configuredSchedule.type) && Objects.equals(this.additionalProperties, configuredSchedule.additionalProperties);
  }
