...
public class FindingCaseResponseDataRelationships {
  ...
  private SecurityUser modifiedBy;

  public static final String JSON_PROPERTY_PROJECT = "project";
  private CaseManagementProject project;

  public FindingCaseResponseDataRelationships createdBy(SecurityUser createdBy) {
  ...
  public SecurityUser getCreatedBy() {
    return createdBy;
  }

  public void setCreatedBy(SecurityUser createdBy) {
    this.createdBy = createdBy;
  }

  public FindingCaseResponseDataRelationships modifiedBy(SecurityUser modifiedBy) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public SecurityUser getModifiedBy() {
    return modifiedBy;
  }

  public void setModifiedBy(SecurityUser modifiedBy) {
    this.modifiedBy = modifiedBy;
  }
