...
public class STIXBundleRequest {
  ...
  /**
   * The STIX objects included in the bundle. Indicator objects are processed and ingested; other
   * STIX object types are accepted and counted in the <code>unsupported</code> response counter.
   *
   * @return objects
   */
