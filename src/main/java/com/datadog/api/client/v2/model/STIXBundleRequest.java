...
public class STIXBundleRequest {
  ...
  /**
   * The STIX objects included in the bundle. Indicator objects are processed and ingested; all
   * other STIX object types are ignored and are not included in the response counters.
   *
   * @return objects
   */
