...
public class STIXBundleRequest {
  ...
  private List<STIXIndicatorObject> objects = new ArrayList<>();
  ...
  public STIXBundleRequest(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_OBJECTS)
          List<STIXIndicatorObject> objects,
  ...
  public STIXBundleRequest objects(List<STIXIndicatorObject> objects) {
    this.objects = objects;
    for (STIXIndicatorObject item : objects) {
      this.unparsed |= item.unparsed;
    }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<STIXIndicatorObject> getObjects() {
    return objects;
  }

  public void setObjects(List<STIXIndicatorObject> objects) {
    this.objects = objects;
    if (objects != null) {
      for (STIXIndicatorObject item : objects) {
        this.unparsed |= item.unparsed;
