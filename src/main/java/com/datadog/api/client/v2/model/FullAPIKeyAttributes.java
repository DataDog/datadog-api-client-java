...
/**
   * <p>Attributes of a full API key.</p>
 */
@JsonPropertyOrder({
...
public class FullAPIKeyAttributes {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.category, fullApiKeyAttributes.category) && Objects.equals(this.createdAt, fullApiKeyAttributes.createdAt) && Objects.equals(this.dateLastUsed, fullApiKeyAttributes.dateLastUsed) && Objects.equals(this.key, fullApiKeyAttributes.key) && Objects.equals(this.last4, fullApiKeyAttributes.last4) && Objects.equals(this.modifiedAt, fullApiKeyAttributes.modifiedAt) && Objects.equals(this.name, fullApiKeyAttributes.name) && Objects.equals(this.remoteConfigReadEnabled, fullApiKeyAttributes.remoteConfigReadEnabled) && Objects.equals(this.additionalProperties, fullApiKeyAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(category,createdAt,dateLastUsed,key,last4,modifiedAt,name,remoteConfigReadEnabled, additionalProperties);
  }
