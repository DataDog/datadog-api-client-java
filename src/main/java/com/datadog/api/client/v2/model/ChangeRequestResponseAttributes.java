...
public class ChangeRequestResponseAttributes {
  ...
  public ChangeRequestResponseAttributes(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_CHANGE_REQUEST_LINKED_INCIDENT_UUID)
          String changeRequestLinkedIncidentUuid,
      @JsonProperty(required = true, value = JSON_PROPERTY_CHANGE_REQUEST_MAINTENANCE_WINDOW_QUERY)
          String changeRequestMaintenanceWindowQuery,
      @JsonProperty(required = true, value = JSON_PROPERTY_CHANGE_REQUEST_PLAN)
          String changeRequestPlan,
      @JsonProperty(required = true, value = JSON_PROPERTY_CHANGE_REQUEST_RISK)
          ChangeRequestRiskLevel changeRequestRisk,
      @JsonProperty(required = true, value = JSON_PROPERTY_CHANGE_REQUEST_TYPE)
  ...
  public ChangeRequestResponseAttributes putAttributesItem(
      String key, List<String> attributesItem) {
  ...
  public ChangeRequestResponseAttributes changeRequestLinkedIncidentUuid(
      String changeRequestLinkedIncidentUuid) {
    this.changeRequestLinkedIncidentUuid = changeRequestLinkedIncidentUuid;
    return this;
  }
  ...
  public ChangeRequestResponseAttributes changeRequestMaintenanceWindowQuery(
      String changeRequestMaintenanceWindowQuery) {
    this.changeRequestMaintenanceWindowQuery = changeRequestMaintenanceWindowQuery;
    return this;
  }
  ...
  public ChangeRequestResponseAttributes changeRequestRisk(
      ChangeRequestRiskLevel changeRequestRisk) {
    this.changeRequestRisk = changeRequestRisk;
    this.unparsed |= !changeRequestRisk.isValid();
    return this;
  ...
  public ChangeRequestResponseAttributes changeRequestType(
      ChangeRequestChangeType changeRequestType) {
    this.changeRequestType = changeRequestType;
    this.unparsed |= !changeRequestType.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    ChangeRequestResponseAttributes changeRequestResponseAttributes =
        (ChangeRequestResponseAttributes) o;
    return Objects.equals(this.archivedAt, changeRequestResponseAttributes.archivedAt)
        && Objects.equals(this.attributes, changeRequestResponseAttributes.attributes)
        && Objects.equals(
            this.changeRequestLinkedIncidentUuid,
            changeRequestResponseAttributes.changeRequestLinkedIncidentUuid)
        && Objects.equals(
            this.changeRequestMaintenanceWindowQuery,
            changeRequestResponseAttributes.changeRequestMaintenanceWindowQuery)
        && Objects.equals(this.changeRequestPlan, changeRequestResponseAttributes.changeRequestPlan)
        && Objects.equals(this.changeRequestRisk, changeRequestResponseAttributes.changeRequestRisk)
        && Objects.equals(this.changeRequestType, changeRequestResponseAttributes.changeRequestType)
        && Objects.equals(this.closedAt, changeRequestResponseAttributes.closedAt)
        && Objects.equals(this.createdAt, changeRequestResponseAttributes.createdAt)
        && Objects.equals(this.creationSource, changeRequestResponseAttributes.creationSource)
        && Objects.equals(this.description, changeRequestResponseAttributes.description)
        && Objects.equals(this.endDate, changeRequestResponseAttributes.endDate)
        && Objects.equals(this.key, changeRequestResponseAttributes.key)
        && Objects.equals(this.modifiedAt, changeRequestResponseAttributes.modifiedAt)
        && Objects.equals(this.planNotebookId, changeRequestResponseAttributes.planNotebookId)
        && Objects.equals(this.priority, changeRequestResponseAttributes.priority)
        && Objects.equals(this.projectId, changeRequestResponseAttributes.projectId)
        && Objects.equals(this.startDate, changeRequestResponseAttributes.startDate)
        && Objects.equals(this.status, changeRequestResponseAttributes.status)
        && Objects.equals(this.title, changeRequestResponseAttributes.title)
        && Objects.equals(this.type, changeRequestResponseAttributes.type)
        && Objects.equals(
            this.additionalProperties, changeRequestResponseAttributes.additionalProperties);
  }
