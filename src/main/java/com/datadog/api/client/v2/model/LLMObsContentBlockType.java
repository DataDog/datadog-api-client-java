...
public class LLMObsContentBlockType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("markdown", "header", "text", "json", "image", "widget", "llmobs_trace"));
  ...
  public static final LLMObsContentBlockType LLMOBS_TRACE = new LLMObsContentBlockType("llmobs_trace");
  ...
  public static class LLMObsContentBlockTypeSerializer extends StdSerializer<LLMObsContentBlockType> {
      ...
      @Override
      public void serialize(LLMObsContentBlockType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
