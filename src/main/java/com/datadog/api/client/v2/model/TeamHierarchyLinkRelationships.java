...
public class TeamHierarchyLinkRelationships {
  ...
  @JsonCreator
  public TeamHierarchyLinkRelationships(
            @JsonProperty(required=true, value=JSON_PROPERTY_PARENT_TEAM)TeamHierarchyLinkTeamRelationship parentTeam,
            @JsonProperty(required=true, value=JSON_PROPERTY_SUB_TEAM)TeamHierarchyLinkTeamRelationship subTeam) {
  ...
  /**
   * <p>Team hierarchy link team relationship</p>
   * @return parentTeam
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamHierarchyLinkRelationships teamHierarchyLinkRelationships = (TeamHierarchyLinkRelationships) o;
    return Objects.equals(this.parentTeam, teamHierarchyLinkRelationships.parentTeam) && Objects.equals(this.subTeam, teamHierarchyLinkRelationships.subTeam) && Objects.equals(this.additionalProperties, teamHierarchyLinkRelationships.additionalProperties);
  }
