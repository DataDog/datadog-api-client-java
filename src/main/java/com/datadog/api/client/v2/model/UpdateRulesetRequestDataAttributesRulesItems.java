...
/** The definition of <code>UpdateRulesetRequestDataAttributesRulesItems</code> object. */
@JsonPropertyOrder({
...
public class UpdateRulesetRequestDataAttributesRulesItems {
  ...
  private JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsMapping> mapping =
      JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsMapping>undefined();
  ...
  private JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsQuery> query =
      JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsQuery>undefined();

  public static final String JSON_PROPERTY_REFERENCE_TABLE = "reference_table";
  private JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsReferenceTable> referenceTable =
      JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsReferenceTable>undefined();
  ...
  public UpdateRulesetRequestDataAttributesRulesItems mapping(
      UpdateRulesetRequestDataAttributesRulesItemsMapping mapping) {
    this.mapping = JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsMapping>of(mapping);
    return this;
  }
  ...
  @JsonIgnore
  public UpdateRulesetRequestDataAttributesRulesItemsMapping getMapping() {
    return mapping.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_MAPPING)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsMapping>
  ...
  public void setMapping_JsonNullable(
      JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsMapping> mapping) {
    this.mapping = mapping;
  }

  public void setMapping(UpdateRulesetRequestDataAttributesRulesItemsMapping mapping) {
    this.mapping = JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsMapping>of(mapping);
  }
  ...
  public UpdateRulesetRequestDataAttributesRulesItems putMetadataItem(
  ...
  public UpdateRulesetRequestDataAttributesRulesItems query(
      UpdateRulesetRequestDataAttributesRulesItemsQuery query) {
  ...
  public void setQuery_JsonNullable(
      JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsQuery> query) {
    this.query = query;
  }
  ...
  public UpdateRulesetRequestDataAttributesRulesItems referenceTable(
      UpdateRulesetRequestDataAttributesRulesItemsReferenceTable referenceTable) {
    this.referenceTable =
        JsonNullable.<UpdateRulesetRequestDataAttributesRulesItemsReferenceTable>of(referenceTable);
    return this;
  }

  /**
   * The definition of <code>UpdateRulesetRequestDataAttributesRulesItemsReferenceTable</code>
   * object.
   *
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsReferenceTable>
  ...
  public void setReferenceTable_JsonNullable(
      JsonNullable<UpdateRulesetRequestDataAttributesRulesItemsReferenceTable> referenceTable) {
   ...
   */
  @JsonAnySetter
  public UpdateRulesetRequestDataAttributesRulesItems putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    UpdateRulesetRequestDataAttributesRulesItems updateRulesetRequestDataAttributesRulesItems =
        (UpdateRulesetRequestDataAttributesRulesItems) o;
    return Objects.equals(this.enabled, updateRulesetRequestDataAttributesRulesItems.enabled)
        && Objects.equals(this.mapping, updateRulesetRequestDataAttributesRulesItems.mapping)
        && Objects.equals(this.metadata, updateRulesetRequestDataAttributesRulesItems.metadata)
        && Objects.equals(this.name, updateRulesetRequestDataAttributesRulesItems.name)
        && Objects.equals(this.query, updateRulesetRequestDataAttributesRulesItems.query)
        && Objects.equals(
            this.referenceTable, updateRulesetRequestDataAttributesRulesItems.referenceTable)
        && Objects.equals(
            this.additionalProperties,
            updateRulesetRequestDataAttributesRulesItems.additionalProperties);
  }
