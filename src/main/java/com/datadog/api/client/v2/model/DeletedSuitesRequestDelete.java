...
/**
   * <p>Data object for a bulk delete Synthetic test suites request.</p>
 */
@JsonPropertyOrder({
...
public class DeletedSuitesRequestDelete {
  ...
  @JsonCreator
  public DeletedSuitesRequestDelete(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)DeletedSuitesRequestDeleteAttributes attributes) {
  ...
  **/
  ...
  /**
   * <p>An optional identifier for the delete request.</p>
   * @return id
  **/
  ...
  /**
   * <p>Type for the bulk delete Synthetic suites request, <code>delete_suites_request</code>.</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, deletedSuitesRequestDelete.attributes) && Objects.equals(this.id, deletedSuitesRequestDelete.id) && Objects.equals(this.type, deletedSuitesRequestDelete.type) && Objects.equals(this.additionalProperties, deletedSuitesRequestDelete.additionalProperties);
  }
