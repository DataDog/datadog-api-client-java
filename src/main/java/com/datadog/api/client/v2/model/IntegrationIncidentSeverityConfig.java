...
/**
   * <p>Severity configuration for mapping incident priorities to case priorities.</p>
 */
@JsonPropertyOrder({
  IntegrationIncidentSeverityConfig.JSON_PROPERTY_PRIORITY_MAPPING
})
...
public class IntegrationIncidentSeverityConfig {
  ...
  public IntegrationIncidentSeverityConfig putPriorityMappingItem(String key, String priorityMappingItem) {
  ...
  /**
   * <p>Mapping of incident severity values to case priority values.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IntegrationIncidentSeverityConfig integrationIncidentSeverityConfig = (IntegrationIncidentSeverityConfig) o;
    return Objects.equals(this.priorityMapping, integrationIncidentSeverityConfig.priorityMapping) && Objects.equals(this.additionalProperties, integrationIncidentSeverityConfig.additionalProperties);
  }
