...
/**
   * <p>The field and direction to sort apps by</p>
 */
@JsonSerialize(using = AppsSortField.AppsSortFieldSerializer.class)
public class AppsSortField extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("name", "created_at", "updated_at", "user_name", "-name", "-created_at", "-updated_at", "-user_name"));
  ...
  public static class AppsSortFieldSerializer extends StdSerializer<AppsSortField> {
      ...
      @Override
      public void serialize(AppsSortField value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
