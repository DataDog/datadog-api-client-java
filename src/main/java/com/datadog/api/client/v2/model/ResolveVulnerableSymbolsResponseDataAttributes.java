...
/** The definition of <code>ResolveVulnerableSymbolsResponseDataAttributes</code> object. */
...
public class ResolveVulnerableSymbolsResponseDataAttributes {
  ...
  private List<ResolveVulnerableSymbolsResponseDataAttributesResultsItems> results = null;

  public ResolveVulnerableSymbolsResponseDataAttributes results(
      List<ResolveVulnerableSymbolsResponseDataAttributesResultsItems> results) {
    this.results = results;
    for (ResolveVulnerableSymbolsResponseDataAttributesResultsItems item : results) {
  ...
  public ResolveVulnerableSymbolsResponseDataAttributes addResultsItem(
      ResolveVulnerableSymbolsResponseDataAttributesResultsItems resultsItem) {
  ...
  /**
   * The <code>attributes</code> <code>results</code>.
   *
   * @return results
   */
  ...
  public List<ResolveVulnerableSymbolsResponseDataAttributesResultsItems> getResults() {
    return results;
  }

  public void setResults(List<ResolveVulnerableSymbolsResponseDataAttributesResultsItems> results) {
    this.results = results;
  }
