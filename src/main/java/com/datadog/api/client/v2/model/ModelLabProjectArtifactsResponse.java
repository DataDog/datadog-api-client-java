...
/**
   * <p>Response containing the artifact listing for a Model Lab project.</p>
 */
@JsonPropertyOrder({
  ModelLabProjectArtifactsResponse.JSON_PROPERTY_DATA
})
...
public class ModelLabProjectArtifactsResponse {
  ...
  @JsonCreator
  public ModelLabProjectArtifactsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ModelLabProjectArtifactsData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelLabProjectArtifactsResponse modelLabProjectArtifactsResponse = (ModelLabProjectArtifactsResponse) o;
    return Objects.equals(this.data, modelLabProjectArtifactsResponse.data) && Objects.equals(this.additionalProperties, modelLabProjectArtifactsResponse.additionalProperties);
  }
