...
public class ServiceDefinitionSchema extends AbstractOpenApiSchema {
    ...
    public static class ServiceDefinitionSchemaSerializer extends StdSerializer<ServiceDefinitionSchema> {
        ...
        @Override
        public void serialize(ServiceDefinitionSchema value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ServiceDefinitionSchemaDeserializer extends StdDeserializer<ServiceDefinitionSchema> {
        ...
        @Override
        public ServiceDefinitionSchema deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (ServiceDefinitionV1.class.equals(Integer.class) || ServiceDefinitionV1.class.equals(Long.class) || ServiceDefinitionV1.class.equals(Float.class) || ServiceDefinitionV1.class.equals(Double.class) || ServiceDefinitionV1.class.equals(Boolean.class) || ServiceDefinitionV1.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        attemptParsing |= ((ServiceDefinitionV1.class.equals(Integer.class) || ServiceDefinitionV1.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ServiceDefinitionV1.class.equals(Float.class) || ServiceDefinitionV1.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ServiceDefinitionV1.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ServiceDefinitionV1.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public ServiceDefinitionSchema getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * ServiceDefinitionV1, ServiceDefinitionV2, ServiceDefinitionV2Dot1, ServiceDefinitionV2Dot2
     *
     ...
     * ServiceDefinitionV1, ServiceDefinitionV2, ServiceDefinitionV2Dot1, ServiceDefinitionV2Dot2
     *
     * @return The actual instance (ServiceDefinitionV1, ServiceDefinitionV2, ServiceDefinitionV2Dot1, ServiceDefinitionV2Dot2)
     */
    @Override
    ...
    /**
     * Get the actual instance of `ServiceDefinitionV1`. If the actual instance is not `ServiceDefinitionV1`,
