...
public class ModelLabFacetKeysData {
  ...
  @JsonCreator
  public ModelLabFacetKeysData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ModelLabFacetKeysAttributes attributes,
  ...
  /**
   * <p>Available facet key names for filtering resources.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The unique identifier of the facet keys resource.</p>
   * @return id
  **/
  ...
  /**
   * <p>The JSON:API type for a facet keys resource.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, modelLabFacetKeysData.attributes) && Objects.equals(this.id, modelLabFacetKeysData.id) && Objects.equals(this.type, modelLabFacetKeysData.type) && Objects.equals(this.additionalProperties, modelLabFacetKeysData.additionalProperties);
  }
