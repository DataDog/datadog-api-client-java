...
/**
   * <p>The <code>split_array</code> processor splits array fields into separate events based on configured rules.</p>
...
public class ObservabilityPipelineSplitArrayProcessor {
  ...
  private ObservabilityPipelineSplitArrayProcessorType type = ObservabilityPipelineSplitArrayProcessorType.SPLIT_ARRAY;

  public ObservabilityPipelineSplitArrayProcessor() {}

  @JsonCreator
  public ObservabilityPipelineSplitArrayProcessor(
            @JsonProperty(required=true, value=JSON_PROPERTY_ARRAYS)List<ObservabilityPipelineSplitArrayProcessorArrayConfig> arrays,
            @JsonProperty(required=true, value=JSON_PROPERTY_ENABLED)Boolean enabled,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_INCLUDE)String include,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineSplitArrayProcessorType type) {
        this.arrays = arrays;
  ...
  public ObservabilityPipelineSplitArrayProcessor arrays(List<ObservabilityPipelineSplitArrayProcessorArrayConfig> arrays) {
    this.arrays = arrays;
  ...
  public ObservabilityPipelineSplitArrayProcessor addArraysItem(ObservabilityPipelineSplitArrayProcessorArrayConfig arraysItem) {
  ...
  /**
   * <p>A list of array split configurations.</p>
   * @return arrays
  **/
  ...
  **/
  ...
  /**
   * <p>A Datadog search query used to determine which logs this processor targets. For split_array, this should typically be <code>*</code>.</p>
   * @return include
  **/
  ...
  public ObservabilityPipelineSplitArrayProcessor type(ObservabilityPipelineSplitArrayProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>split_array</code>.</p>
   * @return type
  **/
