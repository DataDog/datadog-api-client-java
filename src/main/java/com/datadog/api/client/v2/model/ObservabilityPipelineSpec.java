...
/**
   * <p>Input schema representing an observability pipeline configuration. Used in create and validate requests.</p>
 */
@JsonPropertyOrder({
  ObservabilityPipelineSpec.JSON_PROPERTY_DATA
})
...
public class ObservabilityPipelineSpec {
  ...
  @JsonCreator
  public ObservabilityPipelineSpec(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ObservabilityPipelineSpecData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, observabilityPipelineSpec.data) && Objects.equals(this.additionalProperties, observabilityPipelineSpec.additionalProperties);
  }
