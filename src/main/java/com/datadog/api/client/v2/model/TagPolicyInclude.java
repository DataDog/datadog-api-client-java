...
/**
   * <p>A related resource to include alongside a tag policy in the response. Currently the only supported value is <code>score</code>.</p>
 */
...
public class TagPolicyInclude extends ModelEnum<String> {
  ...
  public static class TagPolicyIncludeSerializer extends StdSerializer<TagPolicyInclude> {
      ...
      @Override
      public void serialize(TagPolicyInclude value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
