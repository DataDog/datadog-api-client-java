...
@JsonDeserialize(using = ActionQueryOnlyTriggerManually.ActionQueryOnlyTriggerManuallyDeserializer.class)
@JsonSerialize(using = ActionQueryOnlyTriggerManually.ActionQueryOnlyTriggerManuallySerializer.class)
public class ActionQueryOnlyTriggerManually extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryOnlyTriggerManually.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryOnlyTriggerManuallySerializer extends StdSerializer<ActionQueryOnlyTriggerManually> {
        public ActionQueryOnlyTriggerManuallySerializer(Class<ActionQueryOnlyTriggerManually> t) {
            super(t);
        }

        public ActionQueryOnlyTriggerManuallySerializer() {
            this(null);
        }

        @Override
        public void serialize(ActionQueryOnlyTriggerManually value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryOnlyTriggerManuallyDeserializer extends StdDeserializer<ActionQueryOnlyTriggerManually> {
        public ActionQueryOnlyTriggerManuallyDeserializer() {
            this(ActionQueryOnlyTriggerManually.class);
        }

        public ActionQueryOnlyTriggerManuallyDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ActionQueryOnlyTriggerManually deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ActionQueryOnlyTriggerManually ret = new ActionQueryOnlyTriggerManually();
            if (match == 1) {
         ...
         */
        @Override
        public ActionQueryOnlyTriggerManually getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryOnlyTriggerManually cannot be null");
        }
    }
    ...
    public ActionQueryOnlyTriggerManually() {
        super("oneOf", Boolean.FALSE);
    }
    public ActionQueryOnlyTriggerManually(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ActionQueryOnlyTriggerManually(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryOnlyTriggerManually.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ActionQueryOnlyTriggerManually.schemas;
    }
