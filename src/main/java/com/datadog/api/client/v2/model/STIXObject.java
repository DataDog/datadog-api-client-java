...
/**
 * A STIX 2.1 object. Indicator objects are processed and ingested; all other STIX object types are
 * ignored and are not included in the response counters.
 */
@JsonPropertyOrder({
...
public class STIXObject {
  ...
  /**
   * The STIX specification version declared on the object. Objects with an unsupported version are
