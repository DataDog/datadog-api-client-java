...
public class ContainerItem extends AbstractOpenApiSchema {
    ...
    public static class ContainerItemDeserializer extends StdDeserializer<ContainerItem> {
        ...
        public ContainerItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (Container.class.equals(Integer.class) || Container.class.equals(Long.class) || Container.class.equals(Float.class) || Container.class.equals(Double.class) || Container.class.equals(Boolean.class) || Container.class.equals(String.class)) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ContainerGroup.class.equals(Integer.class) || ContainerGroup.class.equals(Long.class) || ContainerGroup.class.equals(Float.class) || ContainerGroup.class.equals(Double.class) || ContainerGroup.class.equals(Boolean.class) || ContainerGroup.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
    ...
    /**
     * Get the actual instance of `Container`. If the actual instance is not `Container`,
