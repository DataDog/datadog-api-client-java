...
public class StegadographyWidgetsResponse {
  ...
  private List<StegadographyWidgetData> data = new ArrayList<>();
  ...
  public StegadographyWidgetsResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          List<StegadographyWidgetData> data) {
    this.data = data;
  }

  public StegadographyWidgetsResponse data(List<StegadographyWidgetData> data) {
    this.data = data;
  ...
  public List<StegadographyWidgetData> getData() {
    return data;
  }

  public void setData(List<StegadographyWidgetData> data) {
    this.data = data;
  }
