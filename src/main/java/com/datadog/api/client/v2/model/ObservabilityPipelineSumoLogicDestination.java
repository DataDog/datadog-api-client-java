...
/**
   * <p>The <code>sumo_logic</code> destination forwards logs to Sumo Logic.</p>
...
public class ObservabilityPipelineSumoLogicDestination {
  ...
  private List<ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem> headerCustomFields = null;
  ...
  private ObservabilityPipelineSumoLogicDestinationType type = ObservabilityPipelineSumoLogicDestinationType.SUMO_LOGIC;
  ...
  public ObservabilityPipelineSumoLogicDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineSumoLogicDestinationType type) {
        this.id = id;
        this.inputs = inputs;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public ObservabilityPipelineSumoLogicDestination buffer(ObservabilityPipelineBufferOptions buffer) {
    this.buffer = buffer;
  ...
  **/
  ...
  public ObservabilityPipelineSumoLogicDestination encoding(ObservabilityPipelineSumoLogicDestinationEncoding encoding) {
  ...
  /**
   * <p>The output encoding format.</p>
   * @return encoding
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the environment variable or secret that holds the Sumo Logic HTTP endpoint URL.</p>
  ...
  **/
  ...
  public ObservabilityPipelineSumoLogicDestination headerCustomFields(List<ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem> headerCustomFields) {
    this.headerCustomFields = headerCustomFields;
    for (ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem item : headerCustomFields) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }
  public ObservabilityPipelineSumoLogicDestination addHeaderCustomFieldsItem(ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem headerCustomFieldsItem) {
  ...
  /**
   * <p>A list of custom headers to include in the request to Sumo Logic.</p>
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public List<ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem> getHeaderCustomFields() {
        return headerCustomFields;
      }
  public void setHeaderCustomFields(List<ObservabilityPipelineSumoLogicDestinationHeaderCustomFieldsItem> headerCustomFields) {
    this.headerCustomFields = headerCustomFields;
  }
  ...
  /**
   * <p>Optional override for the host name header.</p>
  ...
  **/
  ...
  public ObservabilityPipelineSumoLogicDestination headerSourceCategory(String headerSourceCategory) {
    this.headerSourceCategory = headerSourceCategory;
    return this;
  }

  /**
   * <p>Optional override for the source category header.</p>
  ...
  **/
  ...
  /**
   * <p>Optional override for the source name header.</p>
  ...
  **/
  ...
  public ObservabilityPipelineSumoLogicDestination type(ObservabilityPipelineSumoLogicDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. The value should always be <code>sumo_logic</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineSumoLogicDestination observabilityPipelineSumoLogicDestination = (ObservabilityPipelineSumoLogicDestination) o;
    return Objects.equals(this.buffer, observabilityPipelineSumoLogicDestination.buffer) && Objects.equals(this.encoding, observabilityPipelineSumoLogicDestination.encoding) && Objects.equals(this.endpointUrlKey, observabilityPipelineSumoLogicDestination.endpointUrlKey) && Objects.equals(this.headerCustomFields, observabilityPipelineSumoLogicDestination.headerCustomFields) && Objects.equals(this.headerHostName, observabilityPipelineSumoLogicDestination.headerHostName) && Objects.equals(this.headerSourceCategory, observabilityPipelineSumoLogicDestination.headerSourceCategory) && Objects.equals(this.headerSourceName, observabilityPipelineSumoLogicDestination.headerSourceName) && Objects.equals(this.id, observabilityPipelineSumoLogicDestination.id) && Objects.equals(this.inputs, observabilityPipelineSumoLogicDestination.inputs) && Objects.equals(this.type, observabilityPipelineSumoLogicDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineSumoLogicDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(buffer,encoding,endpointUrlKey,headerCustomFields,headerHostName,headerSourceCategory,headerSourceName,id,inputs,type, additionalProperties);
  }
