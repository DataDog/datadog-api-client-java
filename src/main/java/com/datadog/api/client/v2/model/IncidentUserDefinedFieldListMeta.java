...
public class IncidentUserDefinedFieldListMeta {
  ...
  /**
   * <p>The offset of the current page.</p>
   * @return offset
  **/
  ...
  /**
   * <p>The total number of items in the current page.</p>
   * @return size
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    IncidentUserDefinedFieldListMeta incidentUserDefinedFieldListMeta = (IncidentUserDefinedFieldListMeta) o;
    return Objects.equals(this.offset, incidentUserDefinedFieldListMeta.offset) && Objects.equals(this.size, incidentUserDefinedFieldListMeta.size) && Objects.equals(this.additionalProperties, incidentUserDefinedFieldListMeta.additionalProperties);
  }
