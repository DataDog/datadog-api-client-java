...
/**
   * <p>Data envelope for an aggregated long tasks response.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedLongTasksResponseData {
  ...
  @JsonCreator
  public AggregatedLongTasksResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AggregatedLongTasksResponseAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AggregatedLongTasksRequestType type) {
  ...
  public AggregatedLongTasksResponseData attributes(AggregatedLongTasksResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The JSON:API type for aggregated long tasks requests.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedLongTasksResponseData aggregatedLongTasksResponseData = (AggregatedLongTasksResponseData) o;
    return Objects.equals(this.attributes, aggregatedLongTasksResponseData.attributes) && Objects.equals(this.id, aggregatedLongTasksResponseData.id) && Objects.equals(this.type, aggregatedLongTasksResponseData.type) && Objects.equals(this.additionalProperties, aggregatedLongTasksResponseData.additionalProperties);
  }
