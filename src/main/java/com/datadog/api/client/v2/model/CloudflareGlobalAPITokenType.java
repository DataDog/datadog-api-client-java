...
public class CloudflareGlobalAPITokenType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("CloudflareGlobalAPIToken"));

  public static final CloudflareGlobalAPITokenType CLOUDFLAREGLOBALAPITOKEN = new CloudflareGlobalAPITokenType("CloudflareGlobalAPIToken");
  ...
  public static class CloudflareGlobalAPITokenTypeSerializer extends StdSerializer<CloudflareGlobalAPITokenType> {
      ...
      @Override
      public void serialize(CloudflareGlobalAPITokenType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
