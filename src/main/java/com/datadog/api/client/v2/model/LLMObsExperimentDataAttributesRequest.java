...
public class LLMObsExperimentDataAttributesRequest {
  ...
  **/
  ...
  /**
   * <p>Version of the dataset to use. Defaults to the current version if not specified.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to ensure the experiment name is unique. Defaults to <code>true</code>.</p>
   * @return ensureUnique
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Identifier of the parent (baseline) experiment this experiment is run against.</p>
  ...
  **/
  ...
  /**
   * <p>Number of runs configured for this experiment.</p>
   * maximum: 2147483647
   * @return runCount
  **/
      @jakarta.annotation.Nullable
