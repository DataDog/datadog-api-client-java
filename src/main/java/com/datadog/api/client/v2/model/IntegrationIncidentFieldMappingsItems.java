...
/**
   * <p>Mapping between an incident user-defined field and a case field.</p>
 */
@JsonPropertyOrder({
...
public class IntegrationIncidentFieldMappingsItems {
  ...
  public static final String JSON_PROPERTY_INCIDENT_USER_DEFINED_FIELD_ID = "incident_user_defined_field_id";
  ...
  /**
   * <p>The case field to map the incident field value to.</p>
   * @return caseField
  **/
  ...
  public IntegrationIncidentFieldMappingsItems incidentUserDefinedFieldId(String incidentUserDefinedFieldId) {
    this.incidentUserDefinedFieldId = incidentUserDefinedFieldId;
    return this;
  }

  /**
   * <p>The identifier of the incident user-defined field to map from.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IntegrationIncidentFieldMappingsItems integrationIncidentFieldMappingsItems = (IntegrationIncidentFieldMappingsItems) o;
    return Objects.equals(this.caseField, integrationIncidentFieldMappingsItems.caseField) && Objects.equals(this.incidentUserDefinedFieldId, integrationIncidentFieldMappingsItems.incidentUserDefinedFieldId) && Objects.equals(this.additionalProperties, integrationIncidentFieldMappingsItems.additionalProperties);
  }
