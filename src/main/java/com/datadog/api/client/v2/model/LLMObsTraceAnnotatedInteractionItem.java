...
/**
   * <p>A trace, experiment trace, or session interaction with its associated annotations.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsTraceAnnotatedInteractionItem {
  ...
  public LLMObsTraceAnnotatedInteractionItem addAnnotationsItem(LLMObsAnnotationItem annotationsItem) {
