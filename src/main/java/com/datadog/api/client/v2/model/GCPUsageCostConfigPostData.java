...
/**
   * <p>Google Cloud Usage Cost config post data.</p>
 */
@JsonPropertyOrder({
...
public class GCPUsageCostConfigPostData {
  ...
  private GCPUsageCostConfigPostRequestType type = GCPUsageCostConfigPostRequestType.GCP_USAGE_COST_CONFIG_POST_REQUEST;

  public GCPUsageCostConfigPostData() {}

  @JsonCreator
  public GCPUsageCostConfigPostData(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)GCPUsageCostConfigPostRequestType type) {
        this.type = type;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, gcpUsageCostConfigPostData.attributes) && Objects.equals(this.type, gcpUsageCostConfigPostData.type) && Objects.equals(this.additionalProperties, gcpUsageCostConfigPostData.additionalProperties);
  }
