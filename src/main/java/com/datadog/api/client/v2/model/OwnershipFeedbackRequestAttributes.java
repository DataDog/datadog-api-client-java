...
/**
   * <p>The attributes of an ownership feedback request.</p>
 */
@JsonPropertyOrder({
...
public class OwnershipFeedbackRequestAttributes {
  ...
  public OwnershipFeedbackRequestAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_INFERENCE_CHECKSUM)String inferenceChecksum) {
        this.action = action;
  ...
  **/
  ...
  /**
   * <p>The handle of the actor submitting the feedback.</p>
   * @return actorHandle
  **/
  ...
  /**
   * <p>The type of actor submitting the feedback, for example <code>user</code> or <code>service</code>.</p>
   * @return actorType
  **/
  ...
  /**
   * <p>The corrected owner handle. Required when <code>action</code> is <code>correct</code>.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CORRECTED_OWNER_HANDLE)public void setCorrectedOwnerHandle_JsonNullable(JsonNullable<String> correctedOwnerHandle) {
  ...
  /**
   * <p>The corrected owner type. Required when <code>action</code> is <code>correct</code>.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CORRECTED_OWNER_TYPE)public void setCorrectedOwnerType_JsonNullable(JsonNullable<String> correctedOwnerType) {
  ...
  /**
   * <p>The checksum of the inference being acted upon. Must match the current inference checksum or the request returns a conflict.</p>
  ...
  **/
  ...
  /**
   * <p>An optional free-form reason explaining the feedback.</p>
   * @return reason
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_REASON)public void setReason_JsonNullable(JsonNullable<String> reason) {
    this.reason = reason;
  }
  ...
  public boolean equals(Object o) {
    ...
    OwnershipFeedbackRequestAttributes ownershipFeedbackRequestAttributes = (OwnershipFeedbackRequestAttributes) o;
    return Objects.equals(this.action, ownershipFeedbackRequestAttributes.action) && Objects.equals(this.actorHandle, ownershipFeedbackRequestAttributes.actorHandle) && Objects.equals(this.actorType, ownershipFeedbackRequestAttributes.actorType) && Objects.equals(this.correctedOwnerHandle, ownershipFeedbackRequestAttributes.correctedOwnerHandle) && Objects.equals(this.correctedOwnerType, ownershipFeedbackRequestAttributes.correctedOwnerType) && Objects.equals(this.inferenceChecksum, ownershipFeedbackRequestAttributes.inferenceChecksum) && Objects.equals(this.reason, ownershipFeedbackRequestAttributes.reason) && Objects.equals(this.additionalProperties, ownershipFeedbackRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(action,actorHandle,actorType,correctedOwnerHandle,correctedOwnerType,inferenceChecksum,reason, additionalProperties);
  }
