...
public class ObservabilityPipelineParseGrokProcessor {
  ...
  public ObservabilityPipelineParseGrokProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RULES)List<ObservabilityPipelineParseGrokProcessorRuleItem> rules,
  ...
  **/
  ...
  /**
   * <p>The log field to parse with the Grok rules.</p>
   * @return field
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public ObservabilityPipelineParseGrokProcessor rules(List<ObservabilityPipelineParseGrokProcessorRuleItem> rules) {
    this.rules = rules;
    for (ObservabilityPipelineParseGrokProcessorRuleItem item : rules) {
      this.unparsed |= item.unparsed;
    }
  ...
  public ObservabilityPipelineParseGrokProcessor addRulesItem(ObservabilityPipelineParseGrokProcessorRuleItem rulesItem) {
  ...
  /**
   * <p>The list of Grok parsing rules selected by either source field or include query.</p>
   * @return rules
  **/
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(disableLibraryRules,displayName,enabled,field,id,include,rules,type, additionalProperties);
  }
