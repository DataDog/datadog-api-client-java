...
/**
   * <p>The <code>parse_grok</code> processor extracts structured fields from unstructured log messages using Grok patterns.</p>
...
public class ObservabilityPipelineParseGrokProcessor {
  ...
  private ObservabilityPipelineParseGrokProcessorType type = ObservabilityPipelineParseGrokProcessorType.PARSE_GROK;
  ...
  public ObservabilityPipelineParseGrokProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RULES)List<ObservabilityPipelineParseGrokProcessorRule> rules,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineParseGrokProcessorType type) {
  ...
  /**
   * <p>If set to <code>true</code>, disables the default Grok rules provided by Datadog.</p>
  ...
  **/
  ...
  /**
   * <p>A unique identifier for this processor.</p>
   * @return id
  **/
  ...
  **/
  ...
  public ObservabilityPipelineParseGrokProcessor rules(List<ObservabilityPipelineParseGrokProcessorRule> rules) {
    this.rules = rules;
  ...
  public ObservabilityPipelineParseGrokProcessor addRulesItem(ObservabilityPipelineParseGrokProcessorRule rulesItem) {
  ...
  /**
   * <p>The list of Grok parsing rules. If multiple matching rules are provided, they are evaluated in order. The first successful match is applied.</p>
   * @return rules
  **/
  ...
  public ObservabilityPipelineParseGrokProcessor type(ObservabilityPipelineParseGrokProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value should always be <code>parse_grok</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineParseGrokProcessor observabilityPipelineParseGrokProcessor = (ObservabilityPipelineParseGrokProcessor) o;
    return Objects.equals(this.disableLibraryRules, observabilityPipelineParseGrokProcessor.disableLibraryRules) && Objects.equals(this.displayName, observabilityPipelineParseGrokProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineParseGrokProcessor.enabled) && Objects.equals(this.id, observabilityPipelineParseGrokProcessor.id) && Objects.equals(this.include, observabilityPipelineParseGrokProcessor.include) && Objects.equals(this.rules, observabilityPipelineParseGrokProcessor.rules) && Objects.equals(this.type, observabilityPipelineParseGrokProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineParseGrokProcessor.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(disableLibraryRules,displayName,enabled,id,include,rules,type, additionalProperties);
  }
