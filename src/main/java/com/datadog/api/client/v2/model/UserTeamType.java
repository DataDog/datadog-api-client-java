...
public class UserTeamType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_memberships"));
  ...
  public static class UserTeamTypeSerializer extends StdSerializer<UserTeamType> {
      ...
      @Override
      public void serialize(UserTeamType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
