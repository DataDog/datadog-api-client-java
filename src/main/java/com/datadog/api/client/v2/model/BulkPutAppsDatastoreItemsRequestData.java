...
/** The definition of <code>BulkPutAppsDatastoreItemsRequestData</code> object. */
@JsonPropertyOrder({
  BulkPutAppsDatastoreItemsRequestData.JSON_PROPERTY_ATTRIBUTES,
  BulkPutAppsDatastoreItemsRequestData.JSON_PROPERTY_ID,
...
public class BulkPutAppsDatastoreItemsRequestData {
  ...
  private BulkPutAppsDatastoreItemsRequestDataType type =
      BulkPutAppsDatastoreItemsRequestDataType.OMITEMPTY;
  ...
  public BulkPutAppsDatastoreItemsRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          BulkPutAppsDatastoreItemsRequestDataType type) {
    this.type = type;
  ...
  /**
   * The definition of <code>BulkPutAppsDatastoreItemsRequestDataAttributes</code> object.
   *
   * @return attributes
   */
  ...
  public BulkPutAppsDatastoreItemsRequestData id(String id) {
    this.id = id;
    return this;
  }

  /**
   * The <code>BulkPutAppsDatastoreItemsRequestData</code> <code>id</code>.
   *
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public BulkPutAppsDatastoreItemsRequestData type(BulkPutAppsDatastoreItemsRequestDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  public BulkPutAppsDatastoreItemsRequestDataType getType() {
    return type;
  }

  public void setType(BulkPutAppsDatastoreItemsRequestDataType type) {
    if (!type.isValid()) {
      this.unparsed = true;
    }
    this.type = type;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, bulkPutAppsDatastoreItemsRequestData.attributes)
        && Objects.equals(this.id, bulkPutAppsDatastoreItemsRequestData.id)
