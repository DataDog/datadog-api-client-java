 ...
 */
@JsonPropertyOrder({
  RumRateLimitAdaptiveConfig.JSON_PROPERTY_MAX_RETENTION_RATE
})
...
public class RumRateLimitAdaptiveConfig {
  ...
  @JsonCreator
  public RumRateLimitAdaptiveConfig(
            @JsonProperty(required=true, value=JSON_PROPERTY_MAX_RETENTION_RATE)Double maxRetentionRate) {
  ...
  /**
   * <p>The maximum fraction of sessions to retain, in the range <code>(0, 1]</code>.</p>
   * minimum: 0
   * maximum: 1
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.maxRetentionRate, rumRateLimitAdaptiveConfig.maxRetentionRate) && Objects.equals(this.additionalProperties, rumRateLimitAdaptiveConfig.additionalProperties);
  }
