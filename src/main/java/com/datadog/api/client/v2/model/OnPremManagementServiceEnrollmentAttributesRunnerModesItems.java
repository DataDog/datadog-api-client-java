...
public class OnPremManagementServiceEnrollmentAttributesRunnerModesItems extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("workflow_automation", "app_builder"));
  ...
  public static class OnPremManagementServiceEnrollmentAttributesRunnerModesItemsSerializer
      extends StdSerializer<OnPremManagementServiceEnrollmentAttributesRunnerModesItems> {
    public OnPremManagementServiceEnrollmentAttributesRunnerModesItemsSerializer(
        Class<OnPremManagementServiceEnrollmentAttributesRunnerModesItems> t) {
      super(t);
    }
