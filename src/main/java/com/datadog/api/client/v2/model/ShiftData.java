...
public class ShiftData {
  ...
  @JsonCreator
  public ShiftData(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) ShiftDataType type) {
    this.type = type;
  ...
  /**
   * The <code>ShiftData</code> <code>id</code>.
   *
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, shiftData.attributes)
        && Objects.equals(this.id, shiftData.id)
        && Objects.equals(this.relationships, shiftData.relationships)
        && Objects.equals(this.type, shiftData.type)
        && Objects.equals(this.additionalProperties, shiftData.additionalProperties);
  }
