...
public class RolloutOptionsRequest {
  ...
  /**
   * <p>Whether the schedule should begin automatically.</p>
   * @return autostart
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AUTOSTART)public void setAutostart_JsonNullable(JsonNullable<Boolean> autostart) {
  ...
  /**
   * <p>Interval in milliseconds for uniform interval strategies.</p>
  ...
  **/
  ...
  /**
   * <p>The progression strategy used by a progressive rollout.</p>
   * @return strategy
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autostart, rolloutOptionsRequest.autostart) && Objects.equals(this.selectionIntervalMs, rolloutOptionsRequest.selectionIntervalMs) && Objects.equals(this.strategy, rolloutOptionsRequest.strategy) && Objects.equals(this.additionalProperties, rolloutOptionsRequest.additionalProperties);
  }
