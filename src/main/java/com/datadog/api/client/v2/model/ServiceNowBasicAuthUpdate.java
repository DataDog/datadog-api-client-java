...
public class ServiceNowBasicAuthUpdate {
  ...
  /**
   * <p>The <code>ServiceNowBasicAuthUpdate</code> <code>instance</code>.</p>
   * @return instance
  **/
  ...
  /**
   * <p>The <code>ServiceNowBasicAuthUpdate</code> <code>password</code>.</p>
   * @return password
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The <code>ServiceNowBasicAuthUpdate</code> <code>username</code>.</p>
   * @return username
  **/
      @jakarta.annotation.Nullable
