...
/**
   * <p>The attributes of a governance control.</p>
 */
@JsonPropertyOrder({
...
public class GovernanceControlAttributes {
  ...
  public static final String JSON_PROPERTY_MITIGATED_DETECTIONS_COUNT = "mitigated_detections_count";
  ...
  public static final String JSON_PROPERTY_RESOURCE_TYPE_DISPLAY_NAME = "resource_type_display_name";
  private String resourceTypeDisplayName;

  public static final String JSON_PROPERTY_SUPPORTED_DETECTION_PARAMETERS = "supported_detection_parameters";
  private List<GovernanceControlParameterDefinition> supportedDetectionParameters = new ArrayList<>();

  public static final String JSON_PROPERTY_SUPPORTED_NOTIFICATION_PARAMETERS = "supported_notification_parameters";
  private List<GovernanceControlParameterDefinition> supportedNotificationParameters = new ArrayList<>();
  ...
  @JsonCreator
  public GovernanceControlAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ACTIVE_DETECTIONS_COUNT)Long activeDetectionsCount,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_DETECTION_FREQUENCY)String detectionFrequency,
            @JsonProperty(required=true, value=JSON_PROPERTY_DETECTION_PARAMETERS)Map<String, Object> detectionParameters,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_LAST_DETECTION_AT)OffsetDateTime lastDetectionAt,
            @JsonProperty(required=true, value=JSON_PROPERTY_MITIGATED_DETECTIONS_COUNT)Long mitigatedDetectionsCount,
            @JsonProperty(required=true, value=JSON_PROPERTY_MITIGATION_PARAMETERS)Map<String, Object> mitigationParameters,
            @JsonProperty(required=true, value=JSON_PROPERTY_MITIGATION_TYPE)String mitigationType,
            @JsonProperty(required=true, value=JSON_PROPERTY_MITIGATIONS)List<GovernanceControlMitigationDefinition> mitigations,
            @JsonProperty(required=true, value=JSON_PROPERTY_NAME)String name,
            @JsonProperty(required=true, value=JSON_PROPERTY_NEXT_STEPS)String nextSteps,
            @JsonProperty(required=true, value=JSON_PROPERTY_NOTIFICATION_FREQUENCY)String notificationFrequency,
            @JsonProperty(required=true, value=JSON_PROPERTY_NOTIFICATION_PARAMETERS)Map<String, Object> notificationParameters,
            @JsonProperty(required=true, value=JSON_PROPERTY_NOTIFICATION_TYPE)String notificationType,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RESOURCE_TYPE_DISPLAY_NAME)String resourceTypeDisplayName,
            @JsonProperty(required=true, value=JSON_PROPERTY_SUPPORTED_DETECTION_PARAMETERS)List<GovernanceControlParameterDefinition> supportedDetectionParameters,
            @JsonProperty(required=true, value=JSON_PROPERTY_SUPPORTED_NOTIFICATION_PARAMETERS)List<GovernanceControlParameterDefinition> supportedNotificationParameters,
  ...
  /**
   * <p>The number of active detections for the control.</p>
  ...
  **/
  ...
  /**
   * <p>The value driver the control is grouped under, such as <code>security</code> or <code>cost</code>.</p>
   * @return category
  **/
  ...
  /**
   * <p>The time the control configuration was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The UUID of the user who created the control configuration.</p>
   * @return createdBy
  **/
  ...
  /**
   * <p>A human-readable description of what the control detects.</p>
   * @return description
  **/
  ...
  /**
   * <p>How often detections are evaluated for the control.</p>
  ...
  **/
  ...
  public GovernanceControlAttributes putDetectionParametersItem(String key, Object detectionParametersItem) {
  ...
  **/
  ...
  /**
   * <p>The detection type that uniquely identifies the control.</p>
  ...
  **/
  ...
  /**
   * <p>The feature flags that gate the control.</p>
   * @return featureFlags
  **/
  ...
  /**
   * <p>The insight slugs associated with the control.</p>
   * @return insights
  **/
  ...
  /**
   * <p>The time of the most recent detection for the control. <code>null</code> when there are no detections.</p>
  ...
  **/
  ...
  /**
   * <p>The number of mitigated detections for the control.</p>
  ...
  **/
  ...
  public GovernanceControlAttributes mitigationParameters(Map<String, Object> mitigationParameters) {
    this.mitigationParameters = mitigationParameters;
    return this;
  }
  public GovernanceControlAttributes putMitigationParametersItem(String key, Object mitigationParametersItem) {
  ...
  **/
  ...
  /**
   * <p>The configured mitigation type for the control. Empty when not configured.</p>
  ...
  **/
  ...
  public GovernanceControlAttributes mitigations(List<GovernanceControlMitigationDefinition> mitigations) {
    this.mitigations = mitigations;
    for (GovernanceControlMitigationDefinition item : mitigations) {
      this.unparsed |= item.unparsed;
    }
  ...
  public GovernanceControlAttributes addMitigationsItem(GovernanceControlMitigationDefinition mitigationsItem) {
  ...
  /**
   * <p>The mitigations available for a control.</p>
   * @return mitigations
  **/
  ...
  /**
   * <p>Human-readable name of the control.</p>
   * @return name
  **/
  ...
  /**
   * <p>Guidance on the next steps to remediate detections for the control.</p>
   * @return nextSteps
  **/
  ...
  /**
   * <p>The configured notification frequency for the control. Empty when not configured.</p>
  ...
  **/
  ...
  public GovernanceControlAttributes notificationParameters(Map<String, Object> notificationParameters) {
    this.notificationParameters = notificationParameters;
    return this;
  }
  public GovernanceControlAttributes putNotificationParametersItem(String key, Object notificationParametersItem) {
  ...
  **/
  ...
  /**
   * <p>The configured notification type for the control. Empty when not configured.</p>
  ...
  **/
  ...
  /**
   * <p>The priority of the control, such as <code>High</code>.</p>
   * @return priority
  **/
  ...
  /**
   * <p>The product the control belongs to.</p>
   * @return product
  **/
  ...
  /**
   * <p>The release status of the control, such as <code>prod</code> or <code>beta</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The type of resource the control evaluates.</p>
   * @return resourceType
  **/
  ...
  /**
   * <p>The human-readable name of the resource type.</p>
  ...
  **/
  ...
  public GovernanceControlAttributes supportedDetectionParameters(List<GovernanceControlParameterDefinition> supportedDetectionParameters) {
    this.supportedDetectionParameters = supportedDetectionParameters;
    for (GovernanceControlParameterDefinition item : supportedDetectionParameters) {
      this.unparsed |= item.unparsed;
    }
  ...
  public GovernanceControlAttributes addSupportedDetectionParametersItem(GovernanceControlParameterDefinition supportedDetectionParametersItem) {
  ...
  /**
   * <p>An array of parameter definitions.</p>
  ...
  **/
  ...
  public void setSupportedDetectionParameters(List<GovernanceControlParameterDefinition> supportedDetectionParameters) {
    this.supportedDetectionParameters = supportedDetectionParameters;
  ...
  public GovernanceControlAttributes supportedNotificationParameters(List<GovernanceControlParameterDefinition> supportedNotificationParameters) {
    this.supportedNotificationParameters = supportedNotificationParameters;
    for (GovernanceControlParameterDefinition item : supportedNotificationParameters) {
      this.unparsed |= item.unparsed;
    }
  ...
  public GovernanceControlAttributes addSupportedNotificationParametersItem(GovernanceControlParameterDefinition supportedNotificationParametersItem) {
  ...
  **/
  ...
  public void setSupportedNotificationParameters(List<GovernanceControlParameterDefinition> supportedNotificationParameters) {
    this.supportedNotificationParameters = supportedNotificationParameters;
  ...
  /**
   * <p>A short description of the remediation task for the control.</p>
   * @return task
  **/
  ...
  /**
   * <p>The control type, such as <code>Proactive</code> or <code>Detection</code>.</p>
   * @return type
  **/
  ...
  /**
   * <p>The usage concern the control addresses, such as <code>Security</code> or <code>Cost Optimization</code>.</p>
   * @return usageConcern
  **/
