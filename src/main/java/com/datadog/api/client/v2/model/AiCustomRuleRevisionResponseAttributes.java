...
public class AiCustomRuleRevisionResponseAttributes {
  ...
  public AiCustomRuleRevisionResponseAttributes category(CustomRuleRevisionAttributesCategory category) {
    this.category = category;
    this.unparsed |= !category.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Checksum of the revision content.</p>
   * @return checksum
  **/
  ...
  **/
  ...
  /**
   * <p>The identifier of the user who created the revision.</p>
   * @return createdBy
  **/
  ...
  **/
  ...
  public AiCustomRuleRevisionResponseAttributes executionMode(AiCustomRuleRevisionExecutionMode executionMode) {
    this.executionMode = executionMode;
    this.unparsed |= !executionMode.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Whether this is a default Datadog rule.</p>
   * @return isDefault
  **/
  ...
  **/
  ...
  public AiCustomRuleRevisionResponseAttributes severity(CustomRuleRevisionAttributesSeverity severity) {
    this.severity = severity;
    this.unparsed |= !severity.isValid();
    return this;
  }
