...
/**
   * <p>The most recent actual start and end dates for a recurring downtime. For a canceled downtime,
   * this is the previously occurring downtime. For active downtimes, this is the ongoing downtime, and for scheduled
   * downtimes it is the upcoming downtime.</p>
 */
@JsonPropertyOrder({
...
public class DowntimeScheduleCurrentDowntimeResponse {
  ...
  /**
   * <p>The end of the current downtime.</p>
   * @return end
  **/
  ...
  /**
   * <p>The start of the current downtime.</p>
   * @return start
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    DowntimeScheduleCurrentDowntimeResponse downtimeScheduleCurrentDowntimeResponse = (DowntimeScheduleCurrentDowntimeResponse) o;
    return Objects.equals(this.end, downtimeScheduleCurrentDowntimeResponse.end) && Objects.equals(this.start, downtimeScheduleCurrentDowntimeResponse.start) && Objects.equals(this.additionalProperties, downtimeScheduleCurrentDowntimeResponse.additionalProperties);
  }
