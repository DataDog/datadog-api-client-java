...
/**
   * <p>A relationship to the compliance score resource for this rule.</p>
 */
@JsonPropertyOrder({
  TagRuleScoreRelationship.JSON_PROPERTY_DATA
})
...
public class TagRuleScoreRelationship {
  ...
  @JsonCreator
  public TagRuleScoreRelationship(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)TagRuleScoreRelationshipData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, tagRuleScoreRelationship.data) && Objects.equals(this.additionalProperties, tagRuleScoreRelationship.additionalProperties);
  }
