...
public class AutomationRuleScope {
  ...
  @JsonCreator
  public AutomationRuleScope(
            @JsonProperty(required=true, value=JSON_PROPERTY_FINDING_TYPES)List<SecurityFindingType> findingTypes) {
  ...
  /**
   * <p>The list of security finding types that the automation rule applies to.</p>
   * @return findingTypes
  **/
  ...
  /**
   * <p>A search query to further filter the findings matched by this rule. The <code>@workflow.*</code> namespace and <code>@status</code> fields are not permitted. For a reference of available fields, see the <a href="https://docs.datadoghq.com/security/guide/findings-schema/">Security Findings schema documentation</a>.</p>
   * @return query
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.findingTypes, automationRuleScope.findingTypes) && Objects.equals(this.query, automationRuleScope.query) && Objects.equals(this.additionalProperties, automationRuleScope.additionalProperties);
  }
