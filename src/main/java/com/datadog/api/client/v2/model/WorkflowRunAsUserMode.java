...
public class WorkflowRunAsUserMode extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("owner", "service_account", "initiator"));

  public static final WorkflowRunAsUserMode OWNER = new WorkflowRunAsUserMode("owner");
  public static final WorkflowRunAsUserMode SERVICE_ACCOUNT = new WorkflowRunAsUserMode("service_account");
  ...
  public static class WorkflowRunAsUserModeSerializer extends StdSerializer<WorkflowRunAsUserMode> {
      ...
      @Override
      public void serialize(WorkflowRunAsUserMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
