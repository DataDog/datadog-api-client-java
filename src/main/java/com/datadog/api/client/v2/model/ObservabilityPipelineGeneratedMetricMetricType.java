...
public class ObservabilityPipelineGeneratedMetricMetricType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("count", "gauge", "distribution"));
  ...
  public static class ObservabilityPipelineGeneratedMetricMetricTypeSerializer
      extends StdSerializer<ObservabilityPipelineGeneratedMetricMetricType> {
    public ObservabilityPipelineGeneratedMetricMetricTypeSerializer(
        Class<ObservabilityPipelineGeneratedMetricMetricType> t) {
      super(t);
    }
