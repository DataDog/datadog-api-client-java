...
@JsonDeserialize(using = IncidentAttachmentsResponseIncludedItem.IncidentAttachmentsResponseIncludedItemDeserializer.class)
@JsonSerialize(using = IncidentAttachmentsResponseIncludedItem.IncidentAttachmentsResponseIncludedItemSerializer.class)
public class IncidentAttachmentsResponseIncludedItem extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(IncidentAttachmentsResponseIncludedItem.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class IncidentAttachmentsResponseIncludedItemSerializer extends StdSerializer<IncidentAttachmentsResponseIncludedItem> {
        public IncidentAttachmentsResponseIncludedItemSerializer(Class<IncidentAttachmentsResponseIncludedItem> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(IncidentAttachmentsResponseIncludedItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class IncidentAttachmentsResponseIncludedItemDeserializer extends StdDeserializer<IncidentAttachmentsResponseIncludedItem> {
        ...
        @Override
        public IncidentAttachmentsResponseIncludedItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public IncidentAttachmentsResponseIncludedItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "IncidentAttachmentsResponseIncludedItem cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(IncidentAttachmentsResponseIncludedItem.class, Collections.unmodifiableMap(schemas));
    }
