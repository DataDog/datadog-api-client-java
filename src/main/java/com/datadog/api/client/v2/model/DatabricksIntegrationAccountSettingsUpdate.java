...
public class DatabricksIntegrationAccountSettingsUpdate {
   ...
   * HTTP Path under Warehouses &gt; Connection Details in the Databricks console. Required once the
   * cloud cost metrics or the Data Observability dataflow is enabled, or while <code>
   * serverless_jobs_enabled</code> is on; an update that leaves the account without one is rejected
   * with a <code>422</code> response.
   *
