...
public class AnalysisRequestDataAttributes {
  ...
  /**
   * <p>The base64-encoded source code to analyze.</p>
   * @return code
  **/
  ...
  /**
   * <p>The encoding of the source code file (must be <code>utf-8</code>).</p>
   * @return fileEncoding
  **/
  ...
  **/
  ...
  /**
   * <p>The programming language of the source code.</p>
   * @return language
  **/
  ...
  /**
   * <p>The list of static analysis rules to apply during analysis.</p>
   * @return rules
  **/
