...
@JsonPropertyOrder({
  OwnershipInferenceItem.JSON_PROPERTY_CHECKSUM,
  OwnershipInferenceItem.JSON_PROPERTY_CONFIDENCE,
  OwnershipInferenceItem.JSON_PROPERTY_CREATED_AT,
  OwnershipInferenceItem.JSON_PROPERTY_EVIDENCE_VERSIONS,
  OwnershipInferenceItem.JSON_PROPERTY_EXPLANATION,
  OwnershipInferenceItem.JSON_PROPERTY_ID,
  OwnershipInferenceItem.JSON_PROPERTY_OWNER_TYPE,
  OwnershipInferenceItem.JSON_PROPERTY_PRIMARY_CONTACT_REF,
  OwnershipInferenceItem.JSON_PROPERTY_SOURCES,
  OwnershipInferenceItem.JSON_PROPERTY_STATUS,
  OwnershipInferenceItem.JSON_PROPERTY_UPDATED_AT
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class OwnershipInferenceItem {
  ...
  /**
   * The identifier of the inference, formatted as <code>resource_id:owner_type</code>.
   *
   * @return id
   */
  ...
  public boolean equals(Object o) {
    ...
    OwnershipInferenceItem ownershipInferenceItem = (OwnershipInferenceItem) o;
    return Objects.equals(this.checksum, ownershipInferenceItem.checksum)
        && Objects.equals(this.confidence, ownershipInferenceItem.confidence)
        && Objects.equals(this.createdAt, ownershipInferenceItem.createdAt)
        && Objects.equals(this.evidenceVersions, ownershipInferenceItem.evidenceVersions)
        && Objects.equals(this.explanation, ownershipInferenceItem.explanation)
        && Objects.equals(this.id, ownershipInferenceItem.id)
        && Objects.equals(this.ownerType, ownershipInferenceItem.ownerType)
        && Objects.equals(this.primaryContactRef, ownershipInferenceItem.primaryContactRef)
        && Objects.equals(this.sources, ownershipInferenceItem.sources)
        && Objects.equals(this.status, ownershipInferenceItem.status)
        && Objects.equals(this.updatedAt, ownershipInferenceItem.updatedAt)
        && Objects.equals(this.additionalProperties, ownershipInferenceItem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OwnershipInferenceItem {\n");
