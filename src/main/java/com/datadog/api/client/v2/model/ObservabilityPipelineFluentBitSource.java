...
/**
   * <p>The <code>fluent_bit</code> source ingests logs from Fluent Bit.</p>
...
public class ObservabilityPipelineFluentBitSource {
  ...
  private ObservabilityPipelineFluentBitSourceType type = ObservabilityPipelineFluentBitSourceType.FLUENT_BIT;
  ...
  public ObservabilityPipelineFluentBitSource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineFluentBitSourceType type) {
        this.id = id;
        this.type = type;
  ...
  /**
   * <p>Name of the environment variable or secret that holds the listen address for the Fluent Bit receiver.</p>
   * @return addressKey
  **/
