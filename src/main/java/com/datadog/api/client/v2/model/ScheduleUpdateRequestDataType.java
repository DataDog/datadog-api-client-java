...
public class ScheduleUpdateRequestDataType extends ModelEnum<String> {
  ...
  public static final ScheduleUpdateRequestDataType SCHEDULES = new ScheduleUpdateRequestDataType("schedules");
  ...
  public static class ScheduleUpdateRequestDataTypeSerializer extends StdSerializer<ScheduleUpdateRequestDataType> {
      ...
      @Override
      public void serialize(ScheduleUpdateRequestDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
