...
public class SyntheticsTestVersionHistoryMeta {
  ...
  /**
   * <p>The version number to use as the <code>last_version_number</code> query parameter
   * to fetch the next page. <code>null</code> indicates there are no more pages.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NEXT_LAST_VERSION_NUMBER)public void setNextLastVersionNumber_JsonNullable(JsonNullable<Long> nextLastVersionNumber) {
  ...
  /**
   * <p>The number of days that version history is retained.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestVersionHistoryMeta syntheticsTestVersionHistoryMeta = (SyntheticsTestVersionHistoryMeta) o;
    return Objects.equals(this.nextLastVersionNumber, syntheticsTestVersionHistoryMeta.nextLastVersionNumber) && Objects.equals(this.retentionPeriodInDays, syntheticsTestVersionHistoryMeta.retentionPeriodInDays) && Objects.equals(this.additionalProperties, syntheticsTestVersionHistoryMeta.additionalProperties);
  }
