 ...
 */
@JsonPropertyOrder({
  DowntimeScheduleRecurrencesCreateRequest.JSON_PROPERTY_RECURRENCES,
  DowntimeScheduleRecurrencesCreateRequest.JSON_PROPERTY_TIMEZONE
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class DowntimeScheduleRecurrencesCreateRequest {
  @JsonIgnore
  public boolean unparsed = false;
  public static final String JSON_PROPERTY_RECURRENCES = "recurrences";
  private List<DowntimeScheduleRecurrenceCreateUpdateRequest> recurrences = new ArrayList<>();
  ...
  @JsonCreator
  public DowntimeScheduleRecurrencesCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_RECURRENCES)List<DowntimeScheduleRecurrenceCreateUpdateRequest> recurrences) {
  ...
  **/
   ...
   * @return DowntimeScheduleRecurrencesCreateRequest
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    DowntimeScheduleRecurrencesCreateRequest downtimeScheduleRecurrencesCreateRequest = (DowntimeScheduleRecurrencesCreateRequest) o;
    return Objects.equals(this.recurrences, downtimeScheduleRecurrencesCreateRequest.recurrences) && Objects.equals(this.timezone, downtimeScheduleRecurrencesCreateRequest.timezone) && Objects.equals(this.additionalProperties, downtimeScheduleRecurrencesCreateRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DowntimeScheduleRecurrencesCreateRequest {\n");
