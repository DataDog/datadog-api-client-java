...
/**
   * <p>Canvas coordinates and dimensions for an annotation on the workflow canvas.</p>
 */
@JsonPropertyOrder({
...
public class AnnotationDisplayBounds {
  ...
  /**
   * <p>The annotation's height on the canvas.</p>
   * @return height
  **/
  ...
  /**
   * <p>The annotation's width on the canvas.</p>
   * @return width
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The annotation's horizontal canvas coordinate.</p>
   * @return x
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The annotation's vertical canvas coordinate.</p>
   * @return y
  **/
      @jakarta.annotation.Nullable
   ...
   * @return AnnotationDisplayBounds
   */
  @JsonAnySetter
  public AnnotationDisplayBounds putAdditionalProperty(String key, Object value) {
