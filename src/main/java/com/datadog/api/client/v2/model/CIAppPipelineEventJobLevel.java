...
public class CIAppPipelineEventJobLevel extends ModelEnum<String> {
  ...
  public static class CIAppPipelineEventJobLevelSerializer extends StdSerializer<CIAppPipelineEventJobLevel> {
      ...
      @Override
      public void serialize(CIAppPipelineEventJobLevel value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
