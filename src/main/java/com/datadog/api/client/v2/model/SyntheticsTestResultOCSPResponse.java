...
public class SyntheticsTestResultOCSPResponse {
  ...
  /**
   * <p>Certificate details returned in an OCSP response.</p>
   * @return certificate
  **/
  ...
  /**
   * <p>OCSP response status (for example, <code>good</code>, <code>revoked</code>, <code>unknown</code>).</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
