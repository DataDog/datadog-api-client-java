...
public class SecurityMonitoringSignalsListResponseLinks {
  ...
  /**
   * <p>The link for the next set of results. <strong>Note</strong>: The request can also be made using the
   * POST endpoint.</p>
   * @return next
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringSignalsListResponseLinks putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.next, securityMonitoringSignalsListResponseLinks.next) && Objects.equals(this.additionalProperties, securityMonitoringSignalsListResponseLinks.additionalProperties);
  }
