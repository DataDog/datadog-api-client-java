...
public class DatastoreItemsDataType extends ModelEnum<String> {
  ...
  public static class DatastoreItemsDataTypeSerializer extends StdSerializer<DatastoreItemsDataType> {
      ...
      @Override
      public void serialize(DatastoreItemsDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
