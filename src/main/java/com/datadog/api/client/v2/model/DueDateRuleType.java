...
public class DueDateRuleType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("due_date_rules"));
  ...
  public static class DueDateRuleTypeSerializer extends StdSerializer<DueDateRuleType> {
      ...
      @Override
      public void serialize(DueDateRuleType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
