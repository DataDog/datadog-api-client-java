 ...
 */
@JsonPropertyOrder({
  CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail.JSON_PROPERTY_AZURE_CLIENT_ID,
  CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail.JSON_PROPERTY_AZURE_CONTAINER_NAME,
  CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail.JSON_PROPERTY_AZURE_STORAGE_ACCOUNT_NAME,
  CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail.JSON_PROPERTY_AZURE_TENANT_ID,
...
public class CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail {
  ...
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail azureClientId(String azureClientId) {
    this.azureClientId = azureClientId;
    return this;
  }
  ...
  **/
  ...
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail azureContainerName(String azureContainerName) {
    this.azureContainerName = azureContainerName;
    return this;
  }
  ...
  **/
  ...
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail azureStorageAccountName(String azureStorageAccountName) {
    this.azureStorageAccountName = azureStorageAccountName;
    return this;
  }
  ...
  **/
  ...
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail azureTenantId(String azureTenantId) {
    this.azureTenantId = azureTenantId;
    return this;
  }
  ...
  **/
  ...
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail filePath(String filePath) {
    this.filePath = filePath;
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class CreateTableRequestDataAttributesFileMetadataOneOfAccessDetailsAzureDetail {\n");
