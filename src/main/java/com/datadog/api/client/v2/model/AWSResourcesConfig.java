...
public class AWSResourcesConfig {
  ...
  public static final String JSON_PROPERTY_CLOUD_SECURITY_POSTURE_MANAGEMENT_COLLECTION = "cloud_security_posture_management_collection";
  ...
  /**
   * <p>Enable Cloud Security Management to scan AWS resources for vulnerabilities, misconfigurations,
   * identity risks, and compliance violations. Defaults to <code>false</code>.
   * Requires <code>extended_collection</code> to be set to <code>true</code>.</p>
  ...
  **/
  ...
  public void setCloudSecurityPostureManagementCollection(Boolean cloudSecurityPostureManagementCollection) {
    this.cloudSecurityPostureManagementCollection = cloudSecurityPostureManagementCollection;
  }
  ...
  /**
   * <p>Whether Datadog collects additional attributes and configuration information about the resources
   * in your AWS account. Defaults to <code>true</code>. Required for <code>cloud_security_posture_management_collection</code>.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cloudSecurityPostureManagementCollection, awsResourcesConfig.cloudSecurityPostureManagementCollection) && Objects.equals(this.extendedCollection, awsResourcesConfig.extendedCollection) && Objects.equals(this.additionalProperties, awsResourcesConfig.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(cloudSecurityPostureManagementCollection,extendedCollection, additionalProperties);
  }
