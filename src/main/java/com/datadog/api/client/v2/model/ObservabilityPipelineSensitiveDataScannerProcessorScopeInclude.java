...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude</code>
 * object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude {
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TARGET)
          ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget target) {
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude options(
      ObservabilityPipelineSensitiveDataScannerProcessorScopeOptions options) {
    this.options = options;
    this.unparsed |= options.unparsed;
    return this;
  ...
  public ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude target(
      ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget target) {
    this.target = target;
    this.unparsed |= !target.isValid();
    return this;
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorScopeIncludeTarget
   * </code> object.
   *
   * @return target
   */
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude putAdditionalProperty(
  ...
  /**
   * Return true if this ObservabilityPipelineSensitiveDataScannerProcessorScopeInclude object is
   * equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.options, observabilityPipelineSensitiveDataScannerProcessorScopeInclude.options)
        && Objects.equals(
            this.target, observabilityPipelineSensitiveDataScannerProcessorScopeInclude.target)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineSensitiveDataScannerProcessorScopeInclude.additionalProperties);
  }
