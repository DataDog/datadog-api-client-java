...
public class IssueDefinitionArray {
  ...
  private List<IssueDefinitionData> data = new ArrayList<>();

  public IssueDefinitionArray() {}

  @JsonCreator
  public IssueDefinitionArray(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<IssueDefinitionData> data) {
    this.data = data;
  }

  public IssueDefinitionArray data(List<IssueDefinitionData> data) {
    this.data = data;
  ...
  public List<IssueDefinitionData> getData() {
    return data;
  }

  public void setData(List<IssueDefinitionData> data) {
    this.data = data;
  }
