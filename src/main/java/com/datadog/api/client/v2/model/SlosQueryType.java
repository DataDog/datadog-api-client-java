...
public class SlosQueryType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("metric", "time_slice", "monitor"));
  ...
  public static class SlosQueryTypeSerializer extends StdSerializer<SlosQueryType> {
      ...
      @Override
      public void serialize(SlosQueryType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
