...
public class MuteReason extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("duplicate", "false_positive", "no_fix", "other", "pending_fix", "risk_accepted"));
  ...
  public static final MuteReason NO_FIX = new MuteReason("no_fix");
  ...
  public static class MuteReasonSerializer extends StdSerializer<MuteReason> {
      ...
      @Override
      public void serialize(MuteReason value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
