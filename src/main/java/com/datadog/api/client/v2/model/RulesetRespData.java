...
public class RulesetRespData {
  ...
  /**
   * The <code>RulesetRespData</code> <code>id</code>.
   *
   * @return id
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, rulesetRespData.attributes)
        && Objects.equals(this.id, rulesetRespData.id)
        && Objects.equals(this.type, rulesetRespData.type)
        && Objects.equals(this.additionalProperties, rulesetRespData.additionalProperties);
  }
