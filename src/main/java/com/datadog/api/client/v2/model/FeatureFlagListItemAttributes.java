...
/**
   * <p>Attributes of a feature flag in list responses.</p>
 */
@JsonPropertyOrder({
...
public class FeatureFlagListItemAttributes {
  ...
  **/
  ...
  public FeatureFlagListItemAttributes featureFlagEnvironments(List<FeatureFlagEnvironmentListItem> featureFlagEnvironments) {
  ...
  public FeatureFlagListItemAttributes addFeatureFlagEnvironmentsItem(FeatureFlagEnvironmentListItem featureFlagEnvironmentsItem) {
  ...
  **/
  ...
  public void setFeatureFlagEnvironments(List<FeatureFlagEnvironmentListItem> featureFlagEnvironments) {
    this.featureFlagEnvironments = featureFlagEnvironments;
    if (featureFlagEnvironments != null) {
      for (FeatureFlagEnvironmentListItem item : featureFlagEnvironments) {
        this.unparsed |= item.unparsed;
  ...
  **/
  ...
  /**
   * <p>Indicates the staleness status of the feature flag.</p>
