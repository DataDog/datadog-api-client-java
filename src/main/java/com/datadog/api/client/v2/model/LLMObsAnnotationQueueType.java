...
public class LLMObsAnnotationQueueType extends ModelEnum<String> {
  ...
  public static class LLMObsAnnotationQueueTypeSerializer extends StdSerializer<LLMObsAnnotationQueueType> {
      ...
      @Override
      public void serialize(LLMObsAnnotationQueueType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
