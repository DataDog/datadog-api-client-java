...
public class PlaylistDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("rum_replay_playlist"));

  public static final PlaylistDataType RUM_REPLAY_PLAYLIST = new PlaylistDataType("rum_replay_playlist");
  ...
  public static class PlaylistDataTypeSerializer extends StdSerializer<PlaylistDataType> {
      ...
      @Override
      public void serialize(PlaylistDataType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
