...
public class DegradationUpdateIncluded extends AbstractOpenApiSchema {
    ...
    public static class DegradationUpdateIncludedSerializer extends StdSerializer<DegradationUpdateIncluded> {
        ...
        @Override
        public void serialize(DegradationUpdateIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DegradationUpdateIncludedDeserializer extends StdDeserializer<DegradationUpdateIncluded> {
        ...
        @Override
        public DegradationUpdateIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (Degradation.class.equals(Integer.class) || Degradation.class.equals(Long.class) || Degradation.class.equals(Float.class) || Degradation.class.equals(Double.class) || Degradation.class.equals(Boolean.class) || Degradation.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((Degradation.class.equals(Integer.class) || Degradation.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((Degradation.class.equals(Float.class) || Degradation.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (Degradation.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (Degradation.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public DegradationUpdateIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
     ...
     * StatusPagesUser, Degradation, StatusPageAsIncluded
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be StatusPagesUser, Degradation, StatusPageAsIncluded");
    }
    ...
    /**
     * Get the actual instance of `Degradation`. If the actual instance is not `Degradation`,
     * the ClassCastException will be thrown.
     *
