 ...
 */
@JsonPropertyOrder({
  CaseUpdateResolvedReasonAttributes.JSON_PROPERTY_SECURITY_RESOLVED_REASON
})
...
public class CaseUpdateResolvedReasonAttributes {
  ...
  @JsonCreator
  public CaseUpdateResolvedReasonAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_SECURITY_RESOLVED_REASON)String securityResolvedReason) {
  ...
  /**
   * <p>The reason the security case was resolved (for example, <code>FALSE_POSITIVE</code>, <code>TRUE_POSITIVE</code>, <code>BENIGN_POSITIVE</code>).</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CaseUpdateResolvedReasonAttributes caseUpdateResolvedReasonAttributes = (CaseUpdateResolvedReasonAttributes) o;
    return Objects.equals(this.securityResolvedReason, caseUpdateResolvedReasonAttributes.securityResolvedReason) && Objects.equals(this.additionalProperties, caseUpdateResolvedReasonAttributes.additionalProperties);
  }
