...
/**
   * <p>Configuration for a single array split operation.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSplitArrayProcessorArrayConfig {
  ...
  /**
   * <p>The path to the array field to split.</p>
   * @return field
  **/
  ...
  /**
   * <p>A Datadog search query used to determine which logs this array split operation targets.</p>
   * @return include
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineSplitArrayProcessorArrayConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineSplitArrayProcessorArrayConfig observabilityPipelineSplitArrayProcessorArrayConfig = (ObservabilityPipelineSplitArrayProcessorArrayConfig) o;
    return Objects.equals(this.field, observabilityPipelineSplitArrayProcessorArrayConfig.field) && Objects.equals(this.include, observabilityPipelineSplitArrayProcessorArrayConfig.include) && Objects.equals(this.additionalProperties, observabilityPipelineSplitArrayProcessorArrayConfig.additionalProperties);
  }
