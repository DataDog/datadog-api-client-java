...
public class WorkflowListItemAttributes {
  ...
  /**
   * Whether the workflow is published. Unpublished workflows can only be run manually. Automatic
   * triggers such as Schedule do not fire until the workflow is published.
   *
   * @return published
   */
  @jakarta.annotation.Nullable
