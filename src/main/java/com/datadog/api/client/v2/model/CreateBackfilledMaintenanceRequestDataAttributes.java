...
public class CreateBackfilledMaintenanceRequestDataAttributes {
  ...
  private List<CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems> updates = new ArrayList<>();
  ...
  public CreateBackfilledMaintenanceRequestDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_UPDATES)List<CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems> updates) {
        this.title = title;
  ...
  /**
   * <p>The title of the backfilled maintenance.</p>
   * @return title
  **/
  ...
  /**
   * <p>The list of updates. Exactly two updates are required: the start (<code>in_progress</code>) and the end (<code>completed</code>).</p>
   * @return updates
  **/
  ...
  public void setUpdates(List<CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems> updates) {
    this.updates = updates;
    if (updates != null) {
      for (CreateBackfilledMaintenanceRequestDataAttributesUpdatesItems item : updates) {
        this.unparsed |= item.unparsed;
  ...
  public boolean equals(Object o) {
    ...
    CreateBackfilledMaintenanceRequestDataAttributes createBackfilledMaintenanceRequestDataAttributes = (CreateBackfilledMaintenanceRequestDataAttributes) o;
    return Objects.equals(this.title, createBackfilledMaintenanceRequestDataAttributes.title) && Objects.equals(this.updates, createBackfilledMaintenanceRequestDataAttributes.updates) && Objects.equals(this.additionalProperties, createBackfilledMaintenanceRequestDataAttributes.additionalProperties);
  }
