...
@JsonPropertyOrder({
  PipelineTls.JSON_PROPERTY_CA_FILE,
  PipelineTls.JSON_PROPERTY_CRT_FILE,
  PipelineTls.JSON_PROPERTY_KEY_FILE
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class PipelineTls {
  ...
  public PipelineTls caFile(String caFile) {
    this.caFile = caFile;
    return this;
  }
  ...
  public PipelineTls crtFile(String crtFile) {
    this.crtFile = crtFile;
    return this;
  }
  ...
  public PipelineTls keyFile(String keyFile) {
   ...
   */
  @JsonAnySetter
  public PipelineTls putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this PipelineTls object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    PipelineTls pipelineTls = (PipelineTls) o;
    return Objects.equals(this.caFile, pipelineTls.caFile)
        && Objects.equals(this.crtFile, pipelineTls.crtFile)
        && Objects.equals(this.keyFile, pipelineTls.keyFile)
        && Objects.equals(this.additionalProperties, pipelineTls.additionalProperties);
  }
