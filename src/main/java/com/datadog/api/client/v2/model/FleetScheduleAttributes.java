...
@JsonPropertyOrder({
  ...
  FleetScheduleAttributes.JSON_PROPERTY_NAME,
  FleetScheduleAttributes.JSON_PROPERTY_QUERY,
  FleetScheduleAttributes.JSON_PROPERTY_RULE,
  FleetScheduleAttributes.JSON_PROPERTY_STATUS,
  FleetScheduleAttributes.JSON_PROPERTY_UPDATED_AT_UNIX,
...
public class FleetScheduleAttributes {
  ...
  public static final String JSON_PROPERTY_UPDATED_AT_UNIX = "updated_at_unix";
  ...
  public FleetScheduleAttributes createdAtUnix(Long createdAtUnix) {
   ...
   * @return FleetScheduleAttributes
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class FleetScheduleAttributes {\n");
