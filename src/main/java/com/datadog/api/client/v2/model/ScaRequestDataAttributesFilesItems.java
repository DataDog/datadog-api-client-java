...
/**
   * <p>A file entry in the repository associated with a dependency manifest.</p>
 */
@JsonPropertyOrder({
...
public class ScaRequestDataAttributesFilesItems {
  ...
  /**
   * <p>The name or path of the file within the repository.</p>
   * @return name
  **/
  ...
  /**
   * <p>The Package URL (PURL) associated with the dependency declared in this file.</p>
   * @return purl
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ScaRequestDataAttributesFilesItems scaRequestDataAttributesFilesItems = (ScaRequestDataAttributesFilesItems) o;
    return Objects.equals(this.name, scaRequestDataAttributesFilesItems.name) && Objects.equals(this.purl, scaRequestDataAttributesFilesItems.purl) && Objects.equals(this.additionalProperties, scaRequestDataAttributesFilesItems.additionalProperties);
  }
