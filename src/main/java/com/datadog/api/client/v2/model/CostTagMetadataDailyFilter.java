...
/**
   * <p>Granularity for tag metadata results. <code>true</code> returns one row per day, <code>false</code> (or omitted) returns the monthly roll-up.</p>
 */
...
public class CostTagMetadataDailyFilter extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("true", "false"));
  ...
  public static class CostTagMetadataDailyFilterSerializer extends StdSerializer<CostTagMetadataDailyFilter> {
      ...
      @Override
      public void serialize(CostTagMetadataDailyFilter value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
