...
/**
   * <p>Attributes of a deployment detail response.</p>
 */
@JsonPropertyOrder({
...
public class FleetDeploymentV2DetailAttributes {
  ...
  /**
   * <p>Handle of the user who triggered the deployment.</p>
   * @return author
  **/
  ...
  /**
   * <p>Number of hosts on which the deployment was canceled.</p>
   * minimum: 0
  ...
  **/
  ...
  /**
   * <p>Ordered list of configuration file operations applied by this deployment.
   * Absent for package deployments, which have no configuration file operations.</p>
  ...
  **/
  ...
  /**
   * <p>Duration of the deployment in seconds, computed as <code>finished_at - started_at</code>.
   * Zero if the deployment has not finished.</p>
  ...
  **/
  ...
  /**
   * <p>Top-level error message for the deployment. Populated only when the deployment has failed.</p>
   * @return errorSummary
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Estimated completion time of the deployment as a Unix timestamp. Zero if not available.</p>
  ...
  **/
  ...
  /**
   * <p>Number of hosts on which the deployment failed.</p>
   * minimum: 0
   * @return failedHosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Current high-level status of the deployment (for example, "pending", "running",
   * "completed", "failed").</p>
  ...
  **/
  ...
  /**
   * <p>Per-host status list for this deployment.</p>
   * @return hosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether this deployment was triggered by a schedule (<code>schedule_id</code> is non-empty).</p>
   * @return isScheduled
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Number of hosts on which the deployment is currently running.</p>
   * minimum: 0
   * @return runningHosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Identifier of the schedule that triggered this deployment. Empty if triggered manually.</p>
   * @return scheduleId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of hosts that were skipped during the deployment.</p>
   * minimum: 0
   * @return skippedHosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Number of hosts on which the deployment succeeded.</p>
   * minimum: 0
  ...
  **/
  ...
  /**
   * <p>Distinct package versions targeted by this deployment, in first-seen order.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of hosts targeted by this deployment.</p>
   * @return totalHosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Type of update operation performed by this deployment
   * (for example, "update_config_operations", "update_package").</p>
   * @return updateType
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    FleetDeploymentV2DetailAttributes fleetDeploymentV2DetailAttributes = (FleetDeploymentV2DetailAttributes) o;
    return Objects.equals(this.author, fleetDeploymentV2DetailAttributes.author) && Objects.equals(this.canceledHosts, fleetDeploymentV2DetailAttributes.canceledHosts) && Objects.equals(this.configOperations, fleetDeploymentV2DetailAttributes.configOperations) && Objects.equals(this.durationSeconds, fleetDeploymentV2DetailAttributes.durationSeconds) && Objects.equals(this.errorSummary, fleetDeploymentV2DetailAttributes.errorSummary) && Objects.equals(this.estimatedFinishedAt, fleetDeploymentV2DetailAttributes.estimatedFinishedAt) && Objects.equals(this.failedHosts, fleetDeploymentV2DetailAttributes.failedHosts) && Objects.equals(this.highLevelStatus, fleetDeploymentV2DetailAttributes.highLevelStatus) && Objects.equals(this.hosts, fleetDeploymentV2DetailAttributes.hosts) && Objects.equals(this.isScheduled, fleetDeploymentV2DetailAttributes.isScheduled) && Objects.equals(this.query, fleetDeploymentV2DetailAttributes.query) && Objects.equals(this.runningHosts, fleetDeploymentV2DetailAttributes.runningHosts) && Objects.equals(this.scheduleId, fleetDeploymentV2DetailAttributes.scheduleId) && Objects.equals(this.skippedHosts, fleetDeploymentV2DetailAttributes.skippedHosts) && Objects.equals(this.succeededHosts, fleetDeploymentV2DetailAttributes.succeededHosts) && Objects.equals(this.targetVersions, fleetDeploymentV2DetailAttributes.targetVersions) && Objects.equals(this.totalHosts, fleetDeploymentV2DetailAttributes.totalHosts) && Objects.equals(this.updateType, fleetDeploymentV2DetailAttributes.updateType) && Objects.equals(this.additionalProperties, fleetDeploymentV2DetailAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(author,canceledHosts,configOperations,durationSeconds,errorSummary,estimatedFinishedAt,failedHosts,highLevelStatus,hosts,isScheduled,query,runningHosts,scheduleId,skippedHosts,succeededHosts,targetVersions,totalHosts,updateType, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    estimatedFinishedAt: ").append(toIndentedString(estimatedFinishedAt)).append("\n");
