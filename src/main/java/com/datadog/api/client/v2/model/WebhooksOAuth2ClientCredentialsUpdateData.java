...
/**
   * <p>OAuth2 client credentials data for an update request.</p>
 */
@JsonPropertyOrder({
...
public class WebhooksOAuth2ClientCredentialsUpdateData {
  ...
  @JsonCreator
  public WebhooksOAuth2ClientCredentialsUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)WebhooksOAuth2ClientCredentialsUpdateAttributes attributes,
  ...
  public WebhooksOAuth2ClientCredentialsUpdateData attributes(WebhooksOAuth2ClientCredentialsUpdateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>OAuth2 client credentials attributes for an update request.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOAuth2ClientCredentialsUpdateData webhooksOAuth2ClientCredentialsUpdateData = (WebhooksOAuth2ClientCredentialsUpdateData) o;
    return Objects.equals(this.attributes, webhooksOAuth2ClientCredentialsUpdateData.attributes) && Objects.equals(this.type, webhooksOAuth2ClientCredentialsUpdateData.type) && Objects.equals(this.additionalProperties, webhooksOAuth2ClientCredentialsUpdateData.additionalProperties);
  }
