...
/**
   * <p>Exclude only these namespaces from metrics collection.
   * Defaults to <code>["AWS/SQS", "AWS/ElasticMapReduce", "AWS/Usage"]</code>.
   * <code>AWS/SQS</code>, <code>AWS/ElasticMapReduce</code>, and <code>AWS/Usage</code> are excluded by default
   * to reduce your AWS CloudWatch costs from <code>GetMetricData</code> API calls.</p>
 */
@JsonPropertyOrder({
  AWSNamespaceFiltersExcludeOnly.JSON_PROPERTY_EXCLUDE_ONLY
})
...
public class AWSNamespaceFiltersExcludeOnly {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSNamespaceFiltersExcludeOnly awsNamespaceFiltersExcludeOnly = (AWSNamespaceFiltersExcludeOnly) o;
    return Objects.equals(this.excludeOnly, awsNamespaceFiltersExcludeOnly.excludeOnly) && Objects.equals(this.additionalProperties, awsNamespaceFiltersExcludeOnly.additionalProperties);
  }
