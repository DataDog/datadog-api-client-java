...
public class CloudNetworkMonitoringApi {
  ...
  public static class GetAggregatedConnectionsOptionalParameters {
    ...
    /**
     * Set query.
     * @param query Free-form search query using AND/OR/NOT operators, wildcards, and parentheses. When provided, takes precedence over the <code>tags</code> parameter. (optional)
     * @return GetAggregatedConnectionsOptionalParameters
     */
 ...
 */
  ...
  public ApiResponse<SingleAggregatedConnectionResponseArray> getAggregatedConnectionsWithHttpInfo(GetAggregatedConnectionsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CloudNetworkMonitoringApi.getAggregatedConnections", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<SingleAggregatedConnectionResponseArray>> getAggregatedConnectionsWithHttpInfoAsync(GetAggregatedConnectionsOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v2.CloudNetworkMonitoringApi.getAggregatedConnections", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
 ...
 */
  ...
  public ApiResponse<SingleAggregatedDnsResponseArray> getAggregatedDnsWithHttpInfo(GetAggregatedDnsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CloudNetworkMonitoringApi.getAggregatedDns", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<SingleAggregatedDnsResponseArray>> getAggregatedDnsWithHttpInfoAsync(GetAggregatedDnsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CloudNetworkMonitoringApi.getAggregatedDns", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
