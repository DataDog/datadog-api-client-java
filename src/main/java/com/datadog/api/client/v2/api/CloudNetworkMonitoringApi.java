...
public class CloudNetworkMonitoringApi {
  ...
  public static class GetAggregatedConnectionsOptionalParameters {
     ...
     *     timestamp. If neither from nor to are provided, the query window will be [now - 15m,
     *     now]. (optional)
     ...
     *     not provided, the end of the query window will be the current time. If neither from nor
     *     to are provided, the query window will be [now - 15m, now]. (optional)
     * @return GetAggregatedConnectionsOptionalParameters
     */
