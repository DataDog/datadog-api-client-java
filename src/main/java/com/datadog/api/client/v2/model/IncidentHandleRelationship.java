...
/**
   * <p>A single relationship object for an incident handle, wrapping the related resource data.</p>
 */
@JsonPropertyOrder({
  IncidentHandleRelationship.JSON_PROPERTY_DATA
})
...
public class IncidentHandleRelationship {
  ...
  @JsonCreator
  public IncidentHandleRelationship(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)IncidentHandleRelationshipData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, incidentHandleRelationship.data) && Objects.equals(this.additionalProperties, incidentHandleRelationship.additionalProperties);
  }
