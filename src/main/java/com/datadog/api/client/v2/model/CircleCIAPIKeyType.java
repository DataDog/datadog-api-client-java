...
public class CircleCIAPIKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("CircleCIAPIKey"));
  ...
  public static class CircleCIAPIKeyTypeSerializer extends StdSerializer<CircleCIAPIKeyType> {
      ...
      @Override
      public void serialize(CircleCIAPIKeyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
