...
/**
   * <p>Scorecard outcomes batch response.</p>
 */
@JsonPropertyOrder({
...
public class OutcomesBatchResponse {
  ...
  @JsonCreator
  public OutcomesBatchResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<OutcomesResponseDataItem> data,
  ...
  /**
   * <p>List of rule outcomes which were affected during the bulk operation.</p>
   * @return data
  **/
  ...
  /**
   * <p>Metadata pertaining to the bulk operation.</p>
   * @return meta
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, outcomesBatchResponse.data) && Objects.equals(this.meta, outcomesBatchResponse.meta) && Objects.equals(this.additionalProperties, outcomesBatchResponse.additionalProperties);
  }
