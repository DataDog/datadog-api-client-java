...
public class FormUpdateAttributes {
  ...
  public FormUpdateAttributes datastoreConfig(FormDatastoreConfigAttributes datastoreConfig) {
  ...
  public String toString() {
    ...
    sb.append("class FormUpdateAttributes {\n");
