...
/**
   * <p>Object describing a patch in the diff.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsTestVersionDiffPatches {
  ...
  /**
   * <p>List of individual diff operations.</p>
   * @return diffs
  **/
  ...
  /**
   * <p>Length of the original text segment.</p>
   * @return length1
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Length of the modified text segment.</p>
   * @return length2
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Start position in the original text.</p>
   * @return start1
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Start position in the modified text.</p>
   * @return start2
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestVersionDiffPatches syntheticsTestVersionDiffPatches = (SyntheticsTestVersionDiffPatches) o;
    return Objects.equals(this.diffs, syntheticsTestVersionDiffPatches.diffs) && Objects.equals(this.length1, syntheticsTestVersionDiffPatches.length1) && Objects.equals(this.length2, syntheticsTestVersionDiffPatches.length2) && Objects.equals(this.start1, syntheticsTestVersionDiffPatches.start1) && Objects.equals(this.start2, syntheticsTestVersionDiffPatches.start2) && Objects.equals(this.additionalProperties, syntheticsTestVersionDiffPatches.additionalProperties);
  }
