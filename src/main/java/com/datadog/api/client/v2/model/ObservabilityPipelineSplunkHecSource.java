...
public class ObservabilityPipelineSplunkHecSource {
  ...
  **/
  ...
  /**
   * <p>If <code>true</code>, the HEC token is stored in the event's metadata and made available to the Enrichment Table
   * processor and the <code>splunk_hec</code> destination for routing or enrichment based on the token. Defaults to <code>false</code>.</p>
  ...
  **/
   ...
   * @return ObservabilityPipelineSplunkHecSource
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressKey, observabilityPipelineSplunkHecSource.addressKey) && Objects.equals(this.id, observabilityPipelineSplunkHecSource.id) && Objects.equals(this.storeHecToken, observabilityPipelineSplunkHecSource.storeHecToken) && Objects.equals(this.tls, observabilityPipelineSplunkHecSource.tls) && Objects.equals(this.type, observabilityPipelineSplunkHecSource.type) && Objects.equals(this.additionalProperties, observabilityPipelineSplunkHecSource.additionalProperties);
  }
