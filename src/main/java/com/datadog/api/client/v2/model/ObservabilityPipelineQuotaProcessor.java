...
/**
   * <p>The <code>quota</code> processor measures logging traffic for logs that match a specified filter. When the configured daily quota is met, the processor can drop or alert.</p>
...
public class ObservabilityPipelineQuotaProcessor {
  ...
  public static final String JSON_PROPERTY_IGNORE_WHEN_MISSING_PARTITIONS = "ignore_when_missing_partitions";
  ...
  private ObservabilityPipelineQuotaProcessorType type = ObservabilityPipelineQuotaProcessorType.QUOTA;
  ...
  public ObservabilityPipelineQuotaProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineQuotaProcessorType type) {
  ...
  **/
  ...
  /**
   * <p>If set to <code>true</code>, logs that match the quota filter and are sent after the quota is exceeded are dropped. Logs that do not match the filter continue through the pipeline. <strong>Note</strong>: You can set either <code>drop_events</code> or <code>overflow_action</code>, but not both.</p>
   * @return dropEvents
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public ObservabilityPipelineQuotaProcessor ignoreWhenMissingPartitions(Boolean ignoreWhenMissingPartitions) {
    this.ignoreWhenMissingPartitions = ignoreWhenMissingPartitions;
    return this;
  }

  /**
   * <p>If <code>true</code>, the processor skips quota checks when partition fields are missing from the logs.</p>
  ...
  **/
  ...
  public ObservabilityPipelineQuotaProcessor overflowAction(ObservabilityPipelineQuotaProcessorOverflowAction overflowAction) {
  ...
  **/
  ...
  public ObservabilityPipelineQuotaProcessor overrides(List<ObservabilityPipelineQuotaProcessorOverride> overrides) {
  ...
  public ObservabilityPipelineQuotaProcessor addOverridesItem(ObservabilityPipelineQuotaProcessorOverride overridesItem) {
  ...
  /**
   * <p>A list of alternate quota rules that apply to specific sets of events, identified by matching field values. Each override can define a custom limit.</p>
   * @return overrides
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A list of fields used to segment log traffic for quota enforcement. Quotas are tracked independently by unique combinations of these field values.</p>
  ...
  **/
  ...
  public ObservabilityPipelineQuotaProcessor tooManyBucketsAction(ObservabilityPipelineQuotaProcessorOverflowAction tooManyBucketsAction) {
  ...
  **/
  ...
  public void setTooManyBucketsAction(ObservabilityPipelineQuotaProcessorOverflowAction tooManyBucketsAction) {
  ...
  /**
   * <p>The processor type. The value should always be <code>quota</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineQuotaProcessor observabilityPipelineQuotaProcessor = (ObservabilityPipelineQuotaProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineQuotaProcessor.displayName) && Objects.equals(this.dropEvents, observabilityPipelineQuotaProcessor.dropEvents) && Objects.equals(this.enabled, observabilityPipelineQuotaProcessor.enabled) && Objects.equals(this.id, observabilityPipelineQuotaProcessor.id) && Objects.equals(this.ignoreWhenMissingPartitions, observabilityPipelineQuotaProcessor.ignoreWhenMissingPartitions) && Objects.equals(this.include, observabilityPipelineQuotaProcessor.include) && Objects.equals(this.limit, observabilityPipelineQuotaProcessor.limit) && Objects.equals(this.name, observabilityPipelineQuotaProcessor.name) && Objects.equals(this.overflowAction, observabilityPipelineQuotaProcessor.overflowAction) && Objects.equals(this.overrides, observabilityPipelineQuotaProcessor.overrides) && Objects.equals(this.partitionFields, observabilityPipelineQuotaProcessor.partitionFields) && Objects.equals(this.tooManyBucketsAction, observabilityPipelineQuotaProcessor.tooManyBucketsAction) && Objects.equals(this.type, observabilityPipelineQuotaProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineQuotaProcessor.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(displayName,dropEvents,enabled,id,ignoreWhenMissingPartitions,include,limit,name,overflowAction,overrides,partitionFields,tooManyBucketsAction,type, additionalProperties);
  }
