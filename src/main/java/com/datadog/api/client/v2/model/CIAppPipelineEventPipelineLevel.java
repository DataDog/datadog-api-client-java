 ...
 */
@JsonSerialize(using = CIAppPipelineEventPipelineLevel.CIAppPipelineEventPipelineLevelSerializer.class)
public class CIAppPipelineEventPipelineLevel extends ModelEnum<String> {
  ...
  public static final CIAppPipelineEventPipelineLevel PIPELINE = new CIAppPipelineEventPipelineLevel("pipeline");
  ...
  public static class CIAppPipelineEventPipelineLevelSerializer extends StdSerializer<CIAppPipelineEventPipelineLevel> {
      ...
      @Override
      public void serialize(CIAppPipelineEventPipelineLevel value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
