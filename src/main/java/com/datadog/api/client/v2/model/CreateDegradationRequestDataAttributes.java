...
/**
   * <p>The supported attributes for creating a degradation.</p>
 */
@JsonPropertyOrder({
...
public class CreateDegradationRequestDataAttributes {
  ...
  private List<CreateDegradationRequestDataAttributesComponentsAffectedItems> componentsAffected = new ArrayList<>();
  ...
  @JsonCreator
  public CreateDegradationRequestDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_COMPONENTS_AFFECTED)List<CreateDegradationRequestDataAttributesComponentsAffectedItems> componentsAffected,
  ...
  public CreateDegradationRequestDataAttributes componentsAffected(List<CreateDegradationRequestDataAttributesComponentsAffectedItems> componentsAffected) {
    this.componentsAffected = componentsAffected;
  ...
  public CreateDegradationRequestDataAttributes addComponentsAffectedItem(CreateDegradationRequestDataAttributesComponentsAffectedItems componentsAffectedItem) {
  ...
  **/
  ...
  public CreateDegradationRequestDataAttributes status(CreateDegradationRequestDataAttributesStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateDegradationRequestDataAttributes createDegradationRequestDataAttributes = (CreateDegradationRequestDataAttributes) o;
    return Objects.equals(this.componentsAffected, createDegradationRequestDataAttributes.componentsAffected) && Objects.equals(this.description, createDegradationRequestDataAttributes.description) && Objects.equals(this.status, createDegradationRequestDataAttributes.status) && Objects.equals(this.title, createDegradationRequestDataAttributes.title) && Objects.equals(this.additionalProperties, createDegradationRequestDataAttributes.additionalProperties);
  }
