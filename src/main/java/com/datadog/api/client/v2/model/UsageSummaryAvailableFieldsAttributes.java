...
public class UsageSummaryAvailableFieldsAttributes {
  ...
  /**
   * <p>Sorted list of every key returned inside each <code>UsageSummaryDate</code>
   * entry of <code>usage[]</code> (typed fields and <code>additionalProperties</code> keys
   * combined).</p>
   * @return dateFields
  **/
  ...
  /**
   * <p>Sorted list of every key returned inside each <code>UsageSummaryDateOrg</code>
   * entry of <code>usage[].orgs[]</code> (typed fields and <code>additionalProperties</code>
   * keys combined).</p>
  ...
  **/
  ...
  /**
   * <p>Sorted list of every key returned as a direct property of
   * <code>UsageSummaryResponse</code> (typed fields and <code>additionalProperties</code>
   * keys combined).</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UsageSummaryAvailableFieldsAttributes usageSummaryAvailableFieldsAttributes = (UsageSummaryAvailableFieldsAttributes) o;
    return Objects.equals(this.dateFields, usageSummaryAvailableFieldsAttributes.dateFields) && Objects.equals(this.dateOrgFields, usageSummaryAvailableFieldsAttributes.dateOrgFields) && Objects.equals(this.responseFields, usageSummaryAvailableFieldsAttributes.responseFields) && Objects.equals(this.additionalProperties, usageSummaryAvailableFieldsAttributes.additionalProperties);
  }
