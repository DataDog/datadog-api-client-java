...
/**
   * <p>Response for a Sankey diagram query.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsSankeyResponse {
  ...
  public ProductAnalyticsSankeyResponse() {}

  @JsonCreator
  public ProductAnalyticsSankeyResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ProductAnalyticsSankeyResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsSankeyResponse productAnalyticsSankeyResponse = (ProductAnalyticsSankeyResponse) o;
    return Objects.equals(this.data, productAnalyticsSankeyResponse.data) && Objects.equals(this.additionalProperties, productAnalyticsSankeyResponse.additionalProperties);
  }
