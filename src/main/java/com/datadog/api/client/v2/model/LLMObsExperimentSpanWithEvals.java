...
/**
   * <p>An experiment span enriched with its associated evaluation metrics.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsExperimentSpanWithEvals {
  ...
  /**
   * <p>ID of the dataset record this span evaluated.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATASET_RECORD_ID)public void setDatasetRecordId_JsonNullable(JsonNullable<String> datasetRecordId) {
  ...
  **/
  ...
  public LLMObsExperimentSpanWithEvals evalMetrics(List<LLMObsExperimentEvalMetricEvent> evalMetrics) {
  ...
  public LLMObsExperimentSpanWithEvals addEvalMetricsItem(LLMObsExperimentEvalMetricEvent evalMetricsItem) {
  ...
  /**
   * <p>Evaluation metrics associated with this span.</p>
   * @return evalMetrics
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.datasetRecordId, llmObsExperimentSpanWithEvals.datasetRecordId) && Objects.equals(this.duration, llmObsExperimentSpanWithEvals.duration) && Objects.equals(this.evalMetrics, llmObsExperimentSpanWithEvals.evalMetrics) && Objects.equals(this.id, llmObsExperimentSpanWithEvals.id) && Objects.equals(this.meta, llmObsExperimentSpanWithEvals.meta) && Objects.equals(this.metrics, llmObsExperimentSpanWithEvals.metrics) && Objects.equals(this.name, llmObsExperimentSpanWithEvals.name) && Objects.equals(this.parentId, llmObsExperimentSpanWithEvals.parentId) && Objects.equals(this.spanId, llmObsExperimentSpanWithEvals.spanId) && Objects.equals(this.startNs, llmObsExperimentSpanWithEvals.startNs) && Objects.equals(this.status, llmObsExperimentSpanWithEvals.status) && Objects.equals(this.tags, llmObsExperimentSpanWithEvals.tags) && Objects.equals(this.traceId, llmObsExperimentSpanWithEvals.traceId) && Objects.equals(this.additionalProperties, llmObsExperimentSpanWithEvals.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(datasetRecordId,duration,evalMetrics,id,meta,metrics,name,parentId,spanId,startNs,status,tags,traceId, additionalProperties);
  }
