...
public class AzureCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class AzureCredentialsUpdateSerializer extends StdSerializer<AzureCredentialsUpdate> {
        ...
        @Override
        public void serialize(AzureCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AzureCredentialsUpdateDeserializer extends StdDeserializer<AzureCredentialsUpdate> {
        ...
        @Override
        public AzureCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AzureTenantUpdate.class.equals(Integer.class) || AzureTenantUpdate.class.equals(Long.class) || AzureTenantUpdate.class.equals(Float.class) || AzureTenantUpdate.class.equals(Double.class) || AzureTenantUpdate.class.equals(Boolean.class) || AzureTenantUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AzureTenantUpdate.class.equals(Integer.class) || AzureTenantUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AzureTenantUpdate.class.equals(Float.class) || AzureTenantUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AzureTenantUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AzureTenantUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public AzureCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `AzureTenantUpdate`. If the actual instance is not `AzureTenantUpdate`,
