...
/** The definition of <code>ItemApiPayloadMetaSchema</code> object. */
@JsonPropertyOrder({
...
public class ItemApiPayloadMetaSchema {
  ...
  /**
   * The <code>ItemApiPayloadMetaSchema</code> <code>fields</code>.
   *
   * @return fields
   */
  ...
  /**
   * The <code>ItemApiPayloadMetaSchema</code> <code>primary_key</code>.
   *
   * @return primaryKey
   */
  @jakarta.annotation.Nullable
