...
public class ReportSchedulePatchRequestAttributes {
  ...
  /**
   * <p>How a PDF-export report is delivered. <code>pdf</code> attaches a PDF file, <code>png</code> embeds
   * an inline PNG image, and <code>pdf_and_png</code> delivers both.</p>
  ...
  **/
  ...
  /**
   * <p>A description of the report, up to 4096 characters.</p>
   * @return description
  **/
  ...
  /**
   * <p>The recipients of the report. Each entry is an email address, a Slack channel
   * reference in the form <code>slack:{team_id}.{channel_id}.{channel_name}</code>, or a Microsoft
   * Teams channel reference in the form <code>teams:{tenant_id}|{team_id}|{channel_id}</code>.</p>
   * @return recipients
  **/
  ...
  **/
  ...
  /**
   * <p>The identifier of the dashboard tab to render, when the dashboard has tabs.</p>
   * @return tabId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The relative timeframe of data to include in the report.</p>
   * @return timeframe
  **/
  ...
  **/
  ...
  /**
   * <p>The title of the report, between 1 and 78 characters.</p>
   * @return title
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportSchedulePatchRequestAttributes reportSchedulePatchRequestAttributes = (ReportSchedulePatchRequestAttributes) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryFormat,description,recipients,rrule,tabId,templateVariables,timeframe,timezone,title, additionalProperties);
  }
