...
/**
   * <p>Attributes of a Synthetics downtime response object.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsDowntimeDataAttributesResponse {
  ...
  public SyntheticsDowntimeDataAttributesResponse(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TIME_SLOTS)List<SyntheticsDowntimeTimeSlotResponse> timeSlots,
  ...
  /**
   * <p>The timestamp when the downtime was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The UUID of the user who created the downtime.</p>
   * @return createdBy
  **/
  ...
  /**
   * <p>The display name of the user who created the downtime.</p>
  ...
  **/
  ...
  /**
   * <p>The description of the downtime.</p>
   * @return description
  **/
  ...
  /**
   * <p>Whether the downtime is enabled.</p>
   * @return isEnabled
  **/
  ...
  **/
  ...
  /**
   * <p>List of tags associated with a Synthetics downtime.</p>
   * @return tags
  **/
  ...
  /**
   * <p>List of Synthetics test public IDs associated with a downtime.</p>
   * @return testIds
  **/
  ...
  /**
   * <p>List of time slots in a Synthetics downtime response.</p>
   * @return timeSlots
  **/
  ...
  /**
   * <p>The timestamp when the downtime was last updated.</p>
   * @return updatedAt
  **/
  ...
  /**
   * <p>The UUID of the user who last updated the downtime.</p>
   * @return updatedBy
  **/
  ...
  /**
   * <p>The display name of the user who last updated the downtime.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsDowntimeDataAttributesResponse syntheticsDowntimeDataAttributesResponse = (SyntheticsDowntimeDataAttributesResponse) o;
    return Objects.equals(this.createdAt, syntheticsDowntimeDataAttributesResponse.createdAt) && Objects.equals(this.createdBy, syntheticsDowntimeDataAttributesResponse.createdBy) && Objects.equals(this.createdByName, syntheticsDowntimeDataAttributesResponse.createdByName) && Objects.equals(this.description, syntheticsDowntimeDataAttributesResponse.description) && Objects.equals(this.isEnabled, syntheticsDowntimeDataAttributesResponse.isEnabled) && Objects.equals(this.name, syntheticsDowntimeDataAttributesResponse.name) && Objects.equals(this.tags, syntheticsDowntimeDataAttributesResponse.tags) && Objects.equals(this.testIds, syntheticsDowntimeDataAttributesResponse.testIds) && Objects.equals(this.timeSlots, syntheticsDowntimeDataAttributesResponse.timeSlots) && Objects.equals(this.updatedAt, syntheticsDowntimeDataAttributesResponse.updatedAt) && Objects.equals(this.updatedBy, syntheticsDowntimeDataAttributesResponse.updatedBy) && Objects.equals(this.updatedByName, syntheticsDowntimeDataAttributesResponse.updatedByName) && Objects.equals(this.additionalProperties, syntheticsDowntimeDataAttributesResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdAt,createdBy,createdByName,description,isEnabled,name,tags,testIds,timeSlots,updatedAt,updatedBy,updatedByName, additionalProperties);
  }
