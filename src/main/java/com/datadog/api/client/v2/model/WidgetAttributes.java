...
/**
   * <p>Attributes of a widget resource.</p>
 */
@JsonPropertyOrder({
...
public class WidgetAttributes {
  ...
  /**
   * <p>ISO 8601 timestamp of when the widget was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The definition of a widget, including its type and configuration.</p>
   * @return definition
  **/
  ...
  /**
   * <p>Whether the current user has favorited this widget. Populated on get,
   * batch_get, update, and search responses; create responses always return
   * <code>false</code> because a widget can only be favorited after it exists.
  ...
  **/
  ...
  /**
   * <p>ISO 8601 timestamp of when the widget was last modified.</p>
   * @return modifiedAt
  **/
  ...
  /**
   * <p>User-defined tags for organizing widgets.</p>
   * @return tags
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, widgetAttributes.createdAt) && Objects.equals(this.definition, widgetAttributes.definition) && Objects.equals(this.isFavorited, widgetAttributes.isFavorited) && Objects.equals(this.modifiedAt, widgetAttributes.modifiedAt) && Objects.equals(this.tags, widgetAttributes.tags) && Objects.equals(this.additionalProperties, widgetAttributes.additionalProperties);
  }
