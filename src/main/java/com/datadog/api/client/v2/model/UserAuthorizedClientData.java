...
public class UserAuthorizedClientData {
  ...
  private UserAuthorizedClientRelationships relationships;

  public static final String JSON_PROPERTY_TYPE = "type";
  private UserAuthorizedClientType type;
   ...
   * @return UserAuthorizedClientData
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class UserAuthorizedClientData {\n");
