...
/**
   * <p>Configuration for bulk inserting multiple items into a datastore.</p>
 */
@JsonPropertyOrder({
...
public class BulkPutAppsDatastoreItemsRequestDataAttributes {
  ...
  @JsonCreator
  public BulkPutAppsDatastoreItemsRequestDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_VALUES)List<Map<String, Object>> values) {
        this.values = values;
  }
  ...
  /**
   * <p>How to handle conflicts when inserting items that already exist in the datastore.</p>
   * @return conflictMode
  **/
  ...
  /**
   * <p>An array of items to add to the datastore, where each item is a set of key-value pairs representing the item's data. Up to 100 items can be updated in a single request.</p>
   * @return values
  **/
  ...
  public boolean equals(Object o) {
    ...
    BulkPutAppsDatastoreItemsRequestDataAttributes bulkPutAppsDatastoreItemsRequestDataAttributes = (BulkPutAppsDatastoreItemsRequestDataAttributes) o;
    return Objects.equals(this.conflictMode, bulkPutAppsDatastoreItemsRequestDataAttributes.conflictMode) && Objects.equals(this.values, bulkPutAppsDatastoreItemsRequestDataAttributes.values) && Objects.equals(this.additionalProperties, bulkPutAppsDatastoreItemsRequestDataAttributes.additionalProperties);
  }
