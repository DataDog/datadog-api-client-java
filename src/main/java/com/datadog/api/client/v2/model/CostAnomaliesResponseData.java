...
public class CostAnomaliesResponseData {
  ...
  @JsonCreator
  public CostAnomaliesResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CostAnomaliesResponseDataAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>Static identifier of the cost anomalies collection resource.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, costAnomaliesResponseData.attributes) && Objects.equals(this.id, costAnomaliesResponseData.id) && Objects.equals(this.type, costAnomaliesResponseData.type) && Objects.equals(this.additionalProperties, costAnomaliesResponseData.additionalProperties);
  }
