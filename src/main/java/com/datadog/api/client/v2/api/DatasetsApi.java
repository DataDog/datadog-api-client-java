 ...
 */
  public CompletableFuture<DatasetResponseSingle>createDatasetAsync(DatasetCreateRequest body) {
    return createDatasetWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Create a dataset with the configurations in the request.</p>
   *
   * @param body Dataset payload (required)
  ...
  public ApiResponse<DatasetResponseSingle> createDatasetWithHttpInfo(DatasetCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DatasetsApi.createDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DatasetResponseSingle>> createDatasetWithHttpInfoAsync(DatasetCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.DatasetsApi.createDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DatasetResponseSingle>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteDatasetAsync(String datasetId) {
    return deleteDatasetWithHttpInfoAsync(datasetId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes the dataset associated with the ID.</p>
   *
   * @param datasetId The ID of a defined dataset. (required)
  ...
  public ApiResponse<Void> deleteDatasetWithHttpInfo(String datasetId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/datasets/{dataset_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DatasetsApi.deleteDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteDatasetWithHttpInfoAsync(String datasetId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.DatasetsApi.deleteDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<DatasetResponseMulti>getAllDatasetsAsync() {
    return getAllDatasetsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get all datasets that have been configured for an organization.</p>
   *
  ...
  public ApiResponse<DatasetResponseMulti> getAllDatasetsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DatasetsApi.getAllDatasets", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseMulti>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DatasetResponseMulti>> getAllDatasetsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.DatasetsApi.getAllDatasets", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DatasetResponseMulti>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseMulti>() {});
  }
 ...
 */
  public CompletableFuture<DatasetResponseSingle>getDatasetAsync(String datasetId) {
    return getDatasetWithHttpInfoAsync(datasetId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Retrieves the dataset associated with the ID.</p>
   *
   * @param datasetId The ID of a defined dataset. (required)
   * @return ApiResponse&lt;DatasetResponseSingle&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<DatasetResponseSingle> getDatasetWithHttpInfo(String datasetId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DatasetsApi.getDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DatasetResponseSingle>> getDatasetWithHttpInfoAsync(String datasetId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.DatasetsApi.getDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DatasetResponseSingle>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
 ...
 */
  public CompletableFuture<DatasetResponseSingle>updateDatasetAsync(String datasetId, DatasetUpdateRequest body) {
    return updateDatasetWithHttpInfoAsync(datasetId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<DatasetResponseSingle> updateDatasetWithHttpInfo(String datasetId, DatasetUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DatasetsApi.updateDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
  ...
  public CompletableFuture<ApiResponse<DatasetResponseSingle>> updateDatasetWithHttpInfoAsync(String datasetId, DatasetUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.DatasetsApi.updateDataset", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DatasetResponseSingle>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PUT", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<DatasetResponseSingle>() {});
  }
}