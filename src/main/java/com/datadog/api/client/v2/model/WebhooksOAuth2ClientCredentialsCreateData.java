...
/**
   * <p>OAuth2 client credentials data for a create request.</p>
 */
@JsonPropertyOrder({
...
public class WebhooksOAuth2ClientCredentialsCreateData {
  ...
  @JsonCreator
  public WebhooksOAuth2ClientCredentialsCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)WebhooksOAuth2ClientCredentialsCreateAttributes attributes,
  ...
  public WebhooksOAuth2ClientCredentialsCreateData attributes(WebhooksOAuth2ClientCredentialsCreateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebhooksOAuth2ClientCredentialsCreateData webhooksOAuth2ClientCredentialsCreateData = (WebhooksOAuth2ClientCredentialsCreateData) o;
    return Objects.equals(this.attributes, webhooksOAuth2ClientCredentialsCreateData.attributes) && Objects.equals(this.type, webhooksOAuth2ClientCredentialsCreateData.type) && Objects.equals(this.additionalProperties, webhooksOAuth2ClientCredentialsCreateData.additionalProperties);
  }
