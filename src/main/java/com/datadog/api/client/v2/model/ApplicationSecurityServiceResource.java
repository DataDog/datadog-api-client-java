...
/**
   * <p>A JSON:API resource describing a service and its Application Security details.</p>
 */
@JsonPropertyOrder({
...
public class ApplicationSecurityServiceResource {
  ...
  @JsonCreator
  public ApplicationSecurityServiceResource(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ApplicationSecurityServiceAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ApplicationSecurityServiceType type) {
  ...
  public ApplicationSecurityServiceResource attributes(ApplicationSecurityServiceAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the service, formatted as <code>&lt;service&gt;_&lt;environment&gt;</code>.</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of the resource. The value should always be <code>service_env</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityServiceResource applicationSecurityServiceResource = (ApplicationSecurityServiceResource) o;
    return Objects.equals(this.attributes, applicationSecurityServiceResource.attributes) && Objects.equals(this.id, applicationSecurityServiceResource.id) && Objects.equals(this.type, applicationSecurityServiceResource.type) && Objects.equals(this.additionalProperties, applicationSecurityServiceResource.additionalProperties);
  }
