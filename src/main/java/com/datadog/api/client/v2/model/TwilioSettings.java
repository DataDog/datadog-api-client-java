...
@JsonPropertyOrder({
  TwilioSettings.JSON_PROPERTY_ACCOUNT_SID,
  TwilioSettings.JSON_PROPERTY_CENSOR_LOGS
})
...
public class TwilioSettings {
  ...
  public TwilioSettings accountSid(String accountSid) {
    this.accountSid = accountSid;
    return this;
  }
  ...
  public TwilioSettings censorLogs(Boolean censorLogs) {
   ...
   */
  @JsonAnySetter
  public TwilioSettings putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this TwilioSettings object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    TwilioSettings twilioSettings = (TwilioSettings) o;
    return Objects.equals(this.accountSid, twilioSettings.accountSid)
        && Objects.equals(this.censorLogs, twilioSettings.censorLogs)
        && Objects.equals(this.additionalProperties, twilioSettings.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TwilioSettings {\n");
