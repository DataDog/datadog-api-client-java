...
@JsonDeserialize(using = ActionQueryCondition.ActionQueryConditionDeserializer.class)
@JsonSerialize(using = ActionQueryCondition.ActionQueryConditionSerializer.class)
public class ActionQueryCondition extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryCondition.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryConditionSerializer extends StdSerializer<ActionQueryCondition> {
        public ActionQueryConditionSerializer(Class<ActionQueryCondition> t) {
            super(t);
        }

        public ActionQueryConditionSerializer() {
            this(null);
        }

        @Override
        public void serialize(ActionQueryCondition value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryConditionDeserializer extends StdDeserializer<ActionQueryCondition> {
        public ActionQueryConditionDeserializer() {
            this(ActionQueryCondition.class);
        }

        public ActionQueryConditionDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ActionQueryCondition deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ActionQueryCondition ret = new ActionQueryCondition();
            if (match == 1) {
         ...
         */
        @Override
        public ActionQueryCondition getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryCondition cannot be null");
        }
    }
    ...
    public ActionQueryCondition() {
        super("oneOf", Boolean.FALSE);
    }
    public ActionQueryCondition(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ActionQueryCondition(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryCondition.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ActionQueryCondition.schemas;
    }
