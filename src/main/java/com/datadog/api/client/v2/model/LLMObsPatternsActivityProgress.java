...
/**
   * <p>Progress information for a single step of a patterns run.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsPatternsActivityProgress {
  ...
  **/
  ...
  /**
   * <p>Timestamp when the step started. Null if the step has not started.</p>
   * @return startedAt
  **/
  ...
  @JsonProperty(JSON_PROPERTY_STARTED_AT)public void setStartedAt_JsonNullable(JsonNullable<OffsetDateTime> startedAt) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsPatternsActivityProgress llmObsPatternsActivityProgress = (LLMObsPatternsActivityProgress) o;
    return Objects.equals(this.name, llmObsPatternsActivityProgress.name) && Objects.equals(this.startedAt, llmObsPatternsActivityProgress.startedAt) && Objects.equals(this.status, llmObsPatternsActivityProgress.status) && Objects.equals(this.additionalProperties, llmObsPatternsActivityProgress.additionalProperties);
  }
