...
public class SecurityMonitoringRuleMetadata {
  ...
  private JsonNullable<List<String>> sources = JsonNullable.<List<String>>undefined();

  public SecurityMonitoringRuleMetadata entities(List<Object> entities) {
  ...
  public SecurityMonitoringRuleMetadata addSourcesItem(String sourcesItem) {
    ...
    try {
      this.sources.get().add(sourcesItem);
    } catch (java.util.NoSuchElementException e) {
      // this can never happen, as we make sure above that the value is present
    }
    return this;
   ...
   * @return SecurityMonitoringRuleMetadata
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class SecurityMonitoringRuleMetadata {\n");
