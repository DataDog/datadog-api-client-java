...
public class IncidentIntegrationMetadataAttributes {
  ...
  @JsonCreator
  public IncidentIntegrationMetadataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_INTEGRATION_TYPE)Integer integrationType,
            @JsonProperty(required=true, value=JSON_PROPERTY_METADATA)IncidentIntegrationMetadataMetadata metadata) {
  ...
  /**
   * <p>Timestamp when the incident todo was created.</p>
   * @return created
  **/
  ...
  /**
   * <p>UUID of the incident this integration metadata is connected to.</p>
   * @return incidentId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A number indicating the type of integration this metadata is for. 1 indicates Slack;
   * 8 indicates Jira.</p>
   * maximum: 9
  ...
  **/
  ...
  /**
   * <p>Incident integration metadata's metadata attribute.</p>
   * @return metadata
  **/
  ...
  /**
   * <p>Timestamp when the incident todo was last modified.</p>
   * @return modified
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A number indicating the status of this integration metadata. 0 indicates unknown;
   * 1 indicates pending; 2 indicates complete; 3 indicates manually created;
   * 4 indicates manually updated; 5 indicates failed.</p>
   * maximum: 5
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    IncidentIntegrationMetadataAttributes incidentIntegrationMetadataAttributes = (IncidentIntegrationMetadataAttributes) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(created,incidentId,integrationType,metadata,modified,status, additionalProperties);
  }
