...
@JsonPropertyOrder({
  ...
  ObservabilityPipelineClientTls.JSON_PROPERTY_CRT_FILE,
  ObservabilityPipelineClientTls.JSON_PROPERTY_KEY_FILE,
...
public class ObservabilityPipelineClientTls {
   ...
   * @return ObservabilityPipelineClientTls
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class ObservabilityPipelineClientTls {\n");
