 ...
 *
 * See {@link #patchDORADeploymentByVersionWithHttpInfo}.
 *
 * @param body  (required)
 * @throws ApiException if fails to make API call
 */
  public  void  patchDORADeploymentByVersion(DORADeploymentPatchByVersionRequest body) throws ApiException {
 ...
 * Patch a deployment event by version.
 *
 * See {@link #patchDORADeploymentByVersionWithHttpInfoAsync}.
 *
 * @param body  (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>patchDORADeploymentByVersionAsync(DORADeploymentPatchByVersionRequest body) {
    return patchDORADeploymentByVersionWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update a deployment's change failure status, identifying the deployment by its service, environment, and version instead of its ID. Use this to mark a deployment as a change failure or back to stable. You can optionally include remediation details to enable failed deployment recovery time calculation. If multiple deployments match the given service, environment, and version, the most recently finished one is updated.</p>
   *
   * @param body  (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
   ...
   *     </table>
   */
  public ApiResponse<Void> patchDORADeploymentByVersionWithHttpInfo(DORADeploymentPatchByVersionRequest body) throws ApiException {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling patchDORADeploymentByVersion");
    }
    // create path and map variables
    String localVarPath = "/api/v2/dora/deployments";
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DoraMetricsApi.patchDORADeploymentByVersion", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, null);
  }
   ...
   * @return CompletableFuture&lt;ApiResponse&lt;Void&gt;&gt;
   */
  public CompletableFuture<ApiResponse<Void>> patchDORADeploymentByVersionWithHttpInfoAsync(DORADeploymentPatchByVersionRequest body) {
    // Check if unstable operation is enabled
    String operationId = "patchDORADeploymentByVersion";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling patchDORADeploymentByVersion"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/dora/deployments";
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.DoraMetricsApi.patchDORADeploymentByVersion", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
