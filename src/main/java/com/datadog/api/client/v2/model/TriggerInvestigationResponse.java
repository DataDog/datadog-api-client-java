...
/**
   * <p>Response after triggering an investigation.</p>
 */
@JsonPropertyOrder({
  TriggerInvestigationResponse.JSON_PROPERTY_DATA
})
...
public class TriggerInvestigationResponse {
  ...
  @JsonCreator
  public TriggerInvestigationResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)TriggerInvestigationResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, triggerInvestigationResponse.data) && Objects.equals(this.additionalProperties, triggerInvestigationResponse.additionalProperties);
  }
