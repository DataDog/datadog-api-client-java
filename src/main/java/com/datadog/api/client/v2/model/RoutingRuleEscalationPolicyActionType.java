...
@JsonSerialize(
    using =
        RoutingRuleEscalationPolicyActionType.RoutingRuleEscalationPolicyActionTypeSerializer.class)
public class RoutingRuleEscalationPolicyActionType extends ModelEnum<String> {
  ...
  public static final RoutingRuleEscalationPolicyActionType ESCALATION_POLICY =
  ...
  public static class RoutingRuleEscalationPolicyActionTypeSerializer
      extends StdSerializer<RoutingRuleEscalationPolicyActionType> {
    public RoutingRuleEscalationPolicyActionTypeSerializer(
        Class<RoutingRuleEscalationPolicyActionType> t) {
      super(t);
    }
    ...
    public void serialize(
        RoutingRuleEscalationPolicyActionType value,
        JsonGenerator jgen,
