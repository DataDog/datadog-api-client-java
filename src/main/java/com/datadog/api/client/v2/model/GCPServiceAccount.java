...
public class GCPServiceAccount {
  ...
  /**
   * The <code>GCPServiceAccount</code> <code>private_key</code>.
   *
   * @return privateKey
   */
  ...
  /**
   * The <code>GCPServiceAccount</code> <code>service_account_email</code>.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.privateKey, gcpServiceAccount.privateKey)
        && Objects.equals(this.serviceAccountEmail, gcpServiceAccount.serviceAccountEmail)
        && Objects.equals(this.type, gcpServiceAccount.type)
        && Objects.equals(this.additionalProperties, gcpServiceAccount.additionalProperties);
  }
