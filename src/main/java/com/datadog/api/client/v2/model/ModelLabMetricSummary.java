...
/**
   * <p>Summary statistics for a metric recorded during a Model Lab run.</p>
 */
@JsonPropertyOrder({
...
public class ModelLabMetricSummary {
  ...
  /**
   * <p>The total number of recorded values.</p>
   * @return count
  **/
  ...
  /**
   * <p>The first step at which the metric was recorded.</p>
   * @return firstStep
  **/
  ...
  @JsonProperty(JSON_PROPERTY_FIRST_STEP)public void setFirstStep_JsonNullable(JsonNullable<Long> firstStep) {
  ...
  **/
  ...
  /**
   * <p>The last step at which the metric was recorded.</p>
   * @return lastStep
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_LAST_STEP)public void setLastStep_JsonNullable(JsonNullable<Long> lastStep) {
  ...
  /**
   * <p>The most recently recorded value.</p>
   * @return latest
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_LATEST)public void setLatest_JsonNullable(JsonNullable<Double> latest) {
    this.latest = latest;
  }
  ...
  /**
   * <p>The maximum recorded value.</p>
   * @return max
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The mean of recorded values.</p>
   * @return mean
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_MEAN)public void setMean_JsonNullable(JsonNullable<Double> mean) {
    this.mean = mean;
  }
  ...
  /**
   * <p>The minimum recorded value.</p>
   * @return min
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The standard deviation of recorded values.</p>
   * @return stddev
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_STDDEV)public void setStddev_JsonNullable(JsonNullable<Double> stddev) {
    this.stddev = stddev;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, modelLabMetricSummary.count) && Objects.equals(this.firstStep, modelLabMetricSummary.firstStep) && Objects.equals(this.key, modelLabMetricSummary.key) && Objects.equals(this.lastStep, modelLabMetricSummary.lastStep) && Objects.equals(this.latest, modelLabMetricSummary.latest) && Objects.equals(this.max, modelLabMetricSummary.max) && Objects.equals(this.mean, modelLabMetricSummary.mean) && Objects.equals(this.min, modelLabMetricSummary.min) && Objects.equals(this.stddev, modelLabMetricSummary.stddev) && Objects.equals(this.additionalProperties, modelLabMetricSummary.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(count,firstStep,key,lastStep,latest,max,mean,min,stddev, additionalProperties);
  }
