...
/**
   * <p>Data for creating or updating a widget.</p>
 */
@JsonPropertyOrder({
...
public class CreateOrUpdateWidgetRequestData {
  ...
  @JsonCreator
  public CreateOrUpdateWidgetRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CreateOrUpdateWidgetRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)String type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
  }
  public CreateOrUpdateWidgetRequestData attributes(CreateOrUpdateWidgetRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for creating or updating a widget.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateOrUpdateWidgetRequestData createOrUpdateWidgetRequestData = (CreateOrUpdateWidgetRequestData) o;
    return Objects.equals(this.attributes, createOrUpdateWidgetRequestData.attributes) && Objects.equals(this.type, createOrUpdateWidgetRequestData.type) && Objects.equals(this.additionalProperties, createOrUpdateWidgetRequestData.additionalProperties);
  }
