...
public class SyntheticsSuiteTestAlertingCriticality extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("ignore", "critical"));
  ...
  public static class SyntheticsSuiteTestAlertingCriticalitySerializer
      extends StdSerializer<SyntheticsSuiteTestAlertingCriticality> {
    public SyntheticsSuiteTestAlertingCriticalitySerializer(
        Class<SyntheticsSuiteTestAlertingCriticality> t) {
      super(t);
    }
