...
/**
   * <p>ServiceNow ticket creation data</p>
 */
@JsonPropertyOrder({
...
public class ServiceNowTicketCreateData {
  ...
  @JsonCreator
  public ServiceNowTicketCreateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ServiceNowTicketCreateAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ServiceNowTicketResourceType type) {
  ...
  /**
   * <p>ServiceNow ticket creation attributes</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, serviceNowTicketCreateData.attributes) && Objects.equals(this.type, serviceNowTicketCreateData.type) && Objects.equals(this.additionalProperties, serviceNowTicketCreateData.additionalProperties);
  }
