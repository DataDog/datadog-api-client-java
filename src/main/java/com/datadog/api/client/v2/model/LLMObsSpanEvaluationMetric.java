...
/**
   * <p>An evaluation metric associated with an Agent Observability span.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsSpanEvaluationMetric {
  ...
  /**
   * <p>Assessment result (e.g., pass or fail).</p>
   * @return assessment
  **/
  ...
  /**
   * <p>Type of the evaluation metric (e.g., score, categorical, boolean).</p>
  ...
  **/
  ...
  /**
   * <p>Human-readable reasoning for the evaluation result.</p>
   * @return reasoning
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Status of the evaluation execution.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Tags associated with the evaluation metric.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Value of the evaluation result.</p>
   * @return value
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assessment, llmObsSpanEvaluationMetric.assessment) && Objects.equals(this.evalMetricType, llmObsSpanEvaluationMetric.evalMetricType) && Objects.equals(this.reasoning, llmObsSpanEvaluationMetric.reasoning) && Objects.equals(this.status, llmObsSpanEvaluationMetric.status) && Objects.equals(this.tags, llmObsSpanEvaluationMetric.tags) && Objects.equals(this.value, llmObsSpanEvaluationMetric.value) && Objects.equals(this.additionalProperties, llmObsSpanEvaluationMetric.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(assessment,evalMetricType,reasoning,status,tags,value, additionalProperties);
  }
