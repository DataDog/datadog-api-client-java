...
/**
   * <p>Data object for updating a tag policy.</p>
 */
@JsonPropertyOrder({
...
public class TagPolicyUpdateData {
  ...
  /**
   * <p>Mutable attributes of a tag policy. Each field is optional; omitting a field leaves its
   * current value unchanged. The <code>source</code> of a policy cannot be changed.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The unique identifier of the tag policy being updated.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, tagPolicyUpdateData.attributes) && Objects.equals(this.id, tagPolicyUpdateData.id) && Objects.equals(this.type, tagPolicyUpdateData.type) && Objects.equals(this.additionalProperties, tagPolicyUpdateData.additionalProperties);
  }
