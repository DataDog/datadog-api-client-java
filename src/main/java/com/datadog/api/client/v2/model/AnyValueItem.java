...
@JsonDeserialize(using = AnyValueItem.AnyValueItemDeserializer.class)
@JsonSerialize(using = AnyValueItem.AnyValueItemSerializer.class)
public class AnyValueItem extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AnyValueItem.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class AnyValueItemSerializer extends StdSerializer<AnyValueItem> {
        public AnyValueItemSerializer(Class<AnyValueItem> t) {
            super(t);
        }

        public AnyValueItemSerializer() {
            this(null);
        }

        @Override
        public void serialize(AnyValueItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AnyValueItemDeserializer extends StdDeserializer<AnyValueItem> {
        public AnyValueItemDeserializer() {
            this(AnyValueItem.class);
        }

        public AnyValueItemDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public AnyValueItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (Map.class.equals(Integer.class) || Map.class.equals(Long.class) || Map.class.equals(Float.class) || Map.class.equals(Double.class) || Map.class.equals(Boolean.class) || Map.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        ...
                        attemptParsing |= ((Map.class.equals(Float.class) || Map.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
            ...
            AnyValueItem ret = new AnyValueItem();
            if (match == 1) {
         ...
         */
        @Override
        public AnyValueItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "AnyValueItem cannot be null");
        }
    }
    ...
    public AnyValueItem(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public AnyValueItem(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public AnyValueItem(Map<String, Object> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public AnyValueItem(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(AnyValueItem.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return AnyValueItem.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * String, Double, Map&lt;String, Object&gt;, Boolean
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be String, Double, Map<String, Object>, Boolean");
    }
     ...
     * String, Double, Map&lt;String, Object&gt;, Boolean
     *
     * @return The actual instance (String, Double, Map&lt;String, Object&gt;, Boolean)
     */
    @Override
