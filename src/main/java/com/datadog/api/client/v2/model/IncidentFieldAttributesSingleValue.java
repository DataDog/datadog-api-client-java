...
/**
   * <p>A field with a single value selected.</p>
 */
@JsonPropertyOrder({
...
public class IncidentFieldAttributesSingleValue {
  ...
  **/
  ...
  /**
   * <p>The single value selected for this field.</p>
   * @return value
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_VALUE)public void setValue_JsonNullable(JsonNullable<String> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, incidentFieldAttributesSingleValue.type) && Objects.equals(this.value, incidentFieldAttributesSingleValue.value) && Objects.equals(this.additionalProperties, incidentFieldAttributesSingleValue.additionalProperties);
  }
