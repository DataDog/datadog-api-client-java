...
public class FleetAgentInfoDetailsV2 {
  ...
  **/
  ...
  public FleetAgentInfoDetailsV2 otelCollectorDeploymentTypes(List<String> otelCollectorDeploymentTypes) {
    this.otelCollectorDeploymentTypes = otelCollectorDeploymentTypes;
    return this;
  }
  public FleetAgentInfoDetailsV2 addOtelCollectorDeploymentTypesItem(String otelCollectorDeploymentTypesItem) {
  ...
  **/
  ...
  public FleetAgentInfoDetailsV2 otelCollectorDistributions(List<String> otelCollectorDistributions) {
    this.otelCollectorDistributions = otelCollectorDistributions;
    return this;
  }
  public FleetAgentInfoDetailsV2 addOtelCollectorDistributionsItem(String otelCollectorDistributionsItem) {
