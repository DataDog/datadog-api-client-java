...
/**
   * <p>A template variable that viewers can modify on the secure embed shared dashboard.</p>
 */
@JsonPropertyOrder({
...
public class SecureEmbedSelectableTemplateVariable {
  ...
  **/
  ...
  /**
   * <p>Name of the template variable. Usually matches the prefix unless you want a different display name.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Tag prefix for the variable (e.g., <code>environment</code>, <code>service</code>).</p>
   * @return prefix
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Restrict which tag values are visible to the viewer.</p>
   * @return visibleTags
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SecureEmbedSelectableTemplateVariable secureEmbedSelectableTemplateVariable = (SecureEmbedSelectableTemplateVariable) o;
    return Objects.equals(this.defaultValues, secureEmbedSelectableTemplateVariable.defaultValues) && Objects.equals(this.name, secureEmbedSelectableTemplateVariable.name) && Objects.equals(this.prefix, secureEmbedSelectableTemplateVariable.prefix) && Objects.equals(this.visibleTags, secureEmbedSelectableTemplateVariable.visibleTags) && Objects.equals(this.additionalProperties, secureEmbedSelectableTemplateVariable.additionalProperties);
  }
