...
/**
   * <p>Request body for a Sankey diagram query.</p>
 */
@JsonPropertyOrder({
  ProductAnalyticsSankeyRequest.JSON_PROPERTY_DATA
})
...
public class ProductAnalyticsSankeyRequest {
  ...
  @JsonCreator
  public ProductAnalyticsSankeyRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ProductAnalyticsSankeyRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, productAnalyticsSankeyRequest.data) && Objects.equals(this.additionalProperties, productAnalyticsSankeyRequest.additionalProperties);
  }
