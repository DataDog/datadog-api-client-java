...
/**
   * <p>The attributes of a CrowdStrike entity context sync configuration to create.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes {
  ...
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SECRETS)SecurityMonitoringIntegrationConfigCrowdStrikeSecrets secrets) {
        this.domain = domain;
  ...
  **/
  ...
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes integrationType(SecurityMonitoringIntegrationTypeCrowdStrike integrationType) {
    this.integrationType = integrationType;
    this.unparsed |= !integrationType.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes secrets(SecurityMonitoringIntegrationConfigCrowdStrikeSecrets secrets) {
    this.secrets = secrets;
    this.unparsed |= secrets.unparsed;
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes settings(Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes putSettingsItem(String key, Object settingsItem) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes = (SecurityMonitoringCrowdStrikeIntegrationConfigCreateAttributes) o;
    return Objects.equals(this.domain, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.domain) && Objects.equals(this.integrationType, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.integrationType) && Objects.equals(this.name, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.name) && Objects.equals(this.secrets, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.secrets) && Objects.equals(this.settings, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.settings) && Objects.equals(this.additionalProperties, securityMonitoringCrowdStrikeIntegrationConfigCreateAttributes.additionalProperties);
  }
