...
public class Event {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Event event = (Event) o;
    return Objects.equals(this.id, event.id) && Objects.equals(this.name, event.name) && Objects.equals(this.sourceId, event.sourceId) && Objects.equals(this.type, event.type) && Objects.equals(this.additionalProperties, event.additionalProperties);
  }
