...
public class RUMApplicationType extends ModelEnum<String> {
  ...
  public static final RUMApplicationType RUM_APPLICATION = new RUMApplicationType("rum_application");
  ...
  public static class RUMApplicationTypeSerializer extends StdSerializer<RUMApplicationType> {
      ...
      @Override
      public void serialize(RUMApplicationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
