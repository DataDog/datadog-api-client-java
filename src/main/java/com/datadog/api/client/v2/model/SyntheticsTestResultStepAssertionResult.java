...
public class SyntheticsTestResultStepAssertionResult {
  ...
  /**
   * <p>Actual value observed during the step assertion. Its type depends on the check type.</p>
   * @return actual
  **/
  ...
  /**
   * <p>Type of the step assertion check.</p>
   * @return checkType
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Expected value for the step assertion. Its type depends on the check type.</p>
   * @return expected
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the assertion involves secure variables.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestResultStepAssertionResult syntheticsTestResultStepAssertionResult = (SyntheticsTestResultStepAssertionResult) o;
    return Objects.equals(this.actual, syntheticsTestResultStepAssertionResult.actual) && Objects.equals(this.checkType, syntheticsTestResultStepAssertionResult.checkType) && Objects.equals(this.expected, syntheticsTestResultStepAssertionResult.expected) && Objects.equals(this.hasSecureVariables, syntheticsTestResultStepAssertionResult.hasSecureVariables) && Objects.equals(this.additionalProperties, syntheticsTestResultStepAssertionResult.additionalProperties);
  }
