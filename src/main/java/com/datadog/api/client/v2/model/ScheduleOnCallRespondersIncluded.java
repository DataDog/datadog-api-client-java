...
@JsonDeserialize(using = ScheduleOnCallRespondersIncluded.ScheduleOnCallRespondersIncludedDeserializer.class)
@JsonSerialize(using = ScheduleOnCallRespondersIncluded.ScheduleOnCallRespondersIncludedSerializer.class)
public class ScheduleOnCallRespondersIncluded extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ScheduleOnCallRespondersIncluded.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ScheduleOnCallRespondersIncludedSerializer extends StdSerializer<ScheduleOnCallRespondersIncluded> {
        ...
        @Override
        public void serialize(ScheduleOnCallRespondersIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ScheduleOnCallRespondersIncludedDeserializer extends StdDeserializer<ScheduleOnCallRespondersIncluded> {
        ...
        @Override
        public ScheduleOnCallRespondersIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (ScheduleOnCallResponderData.class.equals(Integer.class) || ScheduleOnCallResponderData.class.equals(Long.class) || ScheduleOnCallResponderData.class.equals(Float.class) || ScheduleOnCallResponderData.class.equals(Double.class) || ScheduleOnCallResponderData.class.equals(Boolean.class) || ScheduleOnCallResponderData.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ScheduleOnCallResponderData.class.equals(Integer.class) || ScheduleOnCallResponderData.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ScheduleOnCallResponderData.class.equals(Float.class) || ScheduleOnCallResponderData.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ScheduleOnCallResponderData.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ScheduleOnCallResponderData.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ShiftData.class.equals(Integer.class) || ShiftData.class.equals(Long.class) || ShiftData.class.equals(Float.class) || ShiftData.class.equals(Double.class) || ShiftData.class.equals(Boolean.class) || ShiftData.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ShiftData.class.equals(Integer.class) || ShiftData.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ShiftData.class.equals(Float.class) || ShiftData.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ShiftData.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ShiftData.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public ScheduleOnCallRespondersIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ScheduleOnCallRespondersIncluded cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(ScheduleOnCallRespondersIncluded.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * ScheduleOnCallResponderData, ShiftData, ScheduleData, User
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be ScheduleOnCallResponderData, ShiftData, ScheduleData, User");
    }
    ...
    /**
     * Get the actual instance of `ScheduleOnCallResponderData`. If the actual instance is not `ScheduleOnCallResponderData`,
    ...
    /**
     * Get the actual instance of `ShiftData`. If the actual instance is not `ShiftData`,
     * the ClassCastException will be thrown.
     *
