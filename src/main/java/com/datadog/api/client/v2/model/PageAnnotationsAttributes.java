...
public class PageAnnotationsAttributes {
  ...
  @JsonCreator
  public PageAnnotationsAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_ANNOTATIONS)Map<String, AnnotationInPage> annotations,
            @JsonProperty(required=true, value=JSON_PROPERTY_GLOBAL_ANNOTATIONS)List<UUID> globalAnnotations,
            @JsonProperty(required=true, value=JSON_PROPERTY_WIDGET_MAPPING)Map<String, List<UUID>> widgetMapping) {
  ...
  /**
   * <p>Map of annotation UUID to annotation object, keyed by annotation ID.</p>
   * @return annotations
  **/
  ...
  /**
   * <p>List of annotation IDs that apply to the entire page rather than a specific widget.</p>
  ...
  **/
  ...
  /**
   * <p>Map from widget ID to the list of annotation IDs displayed on that widget.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.annotations, pageAnnotationsAttributes.annotations) && Objects.equals(this.globalAnnotations, pageAnnotationsAttributes.globalAnnotations) && Objects.equals(this.widgetMapping, pageAnnotationsAttributes.widgetMapping) && Objects.equals(this.additionalProperties, pageAnnotationsAttributes.additionalProperties);
  }
