...
/**
   * <p>A cardinality override applied to a specific metric.</p>
 */
@JsonPropertyOrder({
  ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.JSON_PROPERTY_LIMIT_EXCEEDED_ACTION,
...
public class ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit {
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_OVERRIDE_TYPE)ObservabilityPipelineTagCardinalityLimitProcessorOverrideType overrideType) {
        this.metricName = metricName;
        this.overrideType = overrideType;
        this.unparsed |= !overrideType.isValid();
  }
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit limitExceededAction(ObservabilityPipelineTagCardinalityLimitProcessorAction limitExceededAction) {
  ...
  /**
   * <p>The action to take when the cardinality limit is exceeded.</p>
  ...
  **/
  ...
  public void setLimitExceededAction(ObservabilityPipelineTagCardinalityLimitProcessorAction limitExceededAction) {
    if (!limitExceededAction.isValid()) {
        this.unparsed = true;
    }
    this.limitExceededAction = limitExceededAction;
  }
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit metricName(String metricName) {
    this.metricName = metricName;
    return this;
  }

  /**
   * <p>The name of the metric this override applies to.</p>
   * @return metricName
  **/
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit overrideType(ObservabilityPipelineTagCardinalityLimitProcessorOverrideType overrideType) {
    this.overrideType = overrideType;
    this.unparsed |= !overrideType.isValid();
    return this;
  }
  ...
  /**
   * <p>How the override is applied. <code>limit_override</code> enforces a custom limit; <code>excluded</code> omits the metric or tag from cardinality tracking.</p>
   * @return overrideType
  **/
  ...
  public void setOverrideType(ObservabilityPipelineTagCardinalityLimitProcessorOverrideType overrideType) {
    if (!overrideType.isValid()) {
        this.unparsed = true;
    }
    this.overrideType = overrideType;
  }
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit perTagLimits(List<ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit> perTagLimits) {
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit addPerTagLimitsItem(ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit perTagLimitsItem) {
  ...
  /**
   * <p>A list of per-tag cardinality overrides that apply within this metric. Must be omitted when <code>override_type</code> is <code>excluded</code>.</p>
   * @return perTagLimits
  **/
      @jakarta.annotation.Nullable
  ...
  public void setPerTagLimits(List<ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit> perTagLimits) {
    this.perTagLimits = perTagLimits;
    if (perTagLimits != null) {
      for (ObservabilityPipelineTagCardinalityLimitProcessorPerTagLimit item : perTagLimits) {
        this.unparsed |= item.unparsed;
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit valueLimit(Long valueLimit) {
    this.valueLimit = valueLimit;
    return this;
  }

  /**
   * <p>The maximum number of distinct tag value combinations allowed for this metric. Required when <code>override_type</code> is <code>limit_override</code>. Must be omitted when <code>override_type</code> is <code>excluded</code>.</p>
   * minimum: 0
   * maximum: 1000000
   * @return valueLimit
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit = (ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit) o;
    return Objects.equals(this.limitExceededAction, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.limitExceededAction) && Objects.equals(this.metricName, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.metricName) && Objects.equals(this.overrideType, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.overrideType) && Objects.equals(this.perTagLimits, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.perTagLimits) && Objects.equals(this.valueLimit, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.valueLimit) && Objects.equals(this.additionalProperties, observabilityPipelineTagCardinalityLimitProcessorPerMetricLimit.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(limitExceededAction,metricName,overrideType,perTagLimits,valueLimit, additionalProperties);
  }
