...
public class MuteRuleAttributes {
  ...
  public MuteRuleAttributes createdBy(RuleUser createdBy) {
    this.createdBy = createdBy;
    this.unparsed |= createdBy.unparsed;
    return this;
  }
  ...
  public MuteRuleAttributes modifiedBy(RuleUser modifiedBy) {
    this.modifiedBy = modifiedBy;
    this.unparsed |= modifiedBy.unparsed;
    return this;
  }
  ...
  public MuteRuleAttributes rule(Rule rule) {
    this.rule = rule;
    this.unparsed |= rule.unparsed;
    return this;
  }
