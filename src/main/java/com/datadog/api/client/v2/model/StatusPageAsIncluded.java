...
public class StatusPageAsIncluded {
  ...
  private StatusPageAsIncludedRelationships relationships;
  ...
  public StatusPageAsIncluded id(String id) {
    this.id = id;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusPageAsIncluded {\n");
