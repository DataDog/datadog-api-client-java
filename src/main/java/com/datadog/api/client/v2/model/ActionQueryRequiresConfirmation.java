...
@JsonDeserialize(using = ActionQueryRequiresConfirmation.ActionQueryRequiresConfirmationDeserializer.class)
@JsonSerialize(using = ActionQueryRequiresConfirmation.ActionQueryRequiresConfirmationSerializer.class)
public class ActionQueryRequiresConfirmation extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryRequiresConfirmation.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryRequiresConfirmationSerializer extends StdSerializer<ActionQueryRequiresConfirmation> {
        ...
        @Override
        public void serialize(ActionQueryRequiresConfirmation value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryRequiresConfirmationDeserializer extends StdDeserializer<ActionQueryRequiresConfirmation> {
        ...
        @Override
        public ActionQueryRequiresConfirmation deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public ActionQueryRequiresConfirmation getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryRequiresConfirmation cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryRequiresConfirmation.class, Collections.unmodifiableMap(schemas));
    }
