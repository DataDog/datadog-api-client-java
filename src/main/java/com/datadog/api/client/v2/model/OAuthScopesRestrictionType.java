...
public class OAuthScopesRestrictionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("scopes_restriction"));

  public static final OAuthScopesRestrictionType SCOPES_RESTRICTION = new OAuthScopesRestrictionType("scopes_restriction");
  ...
  public static class OAuthScopesRestrictionTypeSerializer extends StdSerializer<OAuthScopesRestrictionType> {
      ...
      @Override
      public void serialize(OAuthScopesRestrictionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
