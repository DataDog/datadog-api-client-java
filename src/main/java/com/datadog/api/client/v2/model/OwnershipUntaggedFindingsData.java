...
public class OwnershipUntaggedFindingsData {
  ...
  private OwnershipUntaggedFindingsType type = OwnershipUntaggedFindingsType.OWNERSHIP_UNTAGGED_FINDINGS;

  public OwnershipUntaggedFindingsData() {}

  @JsonCreator
  public OwnershipUntaggedFindingsData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)OwnershipUntaggedFindingsAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)OwnershipUntaggedFindingsType type) {
  ...
  **/
  ...
  /**
   * <p>The identifier of the ownership untagged findings resource.</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of the ownership untagged findings resource. The value should always be <code>ownership_untagged_findings</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, ownershipUntaggedFindingsData.attributes) && Objects.equals(this.id, ownershipUntaggedFindingsData.id) && Objects.equals(this.type, ownershipUntaggedFindingsData.type) && Objects.equals(this.additionalProperties, ownershipUntaggedFindingsData.additionalProperties);
  }
