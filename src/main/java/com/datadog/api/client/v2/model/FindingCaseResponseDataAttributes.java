...
public class FindingCaseResponseDataAttributes {
  ...
  **/
  ...
  /**
   * <p>Custom attributes associated with the case as key-value pairs where values are string arrays.</p>
   * @return attributes
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public FindingCaseResponseDataAttributes servicenowTicket(FindingServiceNowTicket servicenowTicket) {
  ...
  /**
   * <p>ServiceNow ticket associated with the case.</p>
