...
@JsonPropertyOrder({
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_DEPENDENCIES,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_END,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_ERROR,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_GIT,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_ID,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_LEVEL,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_METRICS,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_NAME,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_NODE,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_PARAMETERS,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_PIPELINE_NAME,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_PIPELINE_UNIQUE_ID,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_QUEUE_TIME,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_STAGE_ID,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_STAGE_NAME,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_START,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_STATUS,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_TAGS,
  CIAppPipelineEventFinishedJob.JSON_PROPERTY_URL
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CIAppPipelineEventFinishedJob {
  ...
  public CIAppPipelineEventFinishedJob() {}
  ...
  public CIAppPipelineEventFinishedJob dependencies(List<String> dependencies) {
    this.dependencies = JsonNullable.<List<String>>of(dependencies);
    return this;
  }

  public CIAppPipelineEventFinishedJob addDependenciesItem(String dependenciesItem) {
  ...
  public CIAppPipelineEventFinishedJob end(OffsetDateTime end) {
    this.end = end;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob error(CIAppCIError error) {
  ...
  public CIAppPipelineEventFinishedJob git(CIAppGitInfo git) {
  ...
  public CIAppPipelineEventFinishedJob id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob level(CIAppPipelineEventJobLevel level) {
    this.level = level;
    this.unparsed |= !level.isValid();
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob metrics(List<String> metrics) {
    this.metrics = JsonNullable.<List<String>>of(metrics);
    return this;
  }

  public CIAppPipelineEventFinishedJob addMetricsItem(String metricsItem) {
  ...
  public CIAppPipelineEventFinishedJob name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob node(CIAppHostInfo node) {
  ...
  public CIAppPipelineEventFinishedJob parameters(Map<String, String> parameters) {
    this.parameters = JsonNullable.<Map<String, String>>of(parameters);
    return this;
  }

  public CIAppPipelineEventFinishedJob putParametersItem(String key, String parametersItem) {
  ...
  public CIAppPipelineEventFinishedJob pipelineName(String pipelineName) {
    this.pipelineName = pipelineName;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob pipelineUniqueId(String pipelineUniqueId) {
    this.pipelineUniqueId = pipelineUniqueId;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob queueTime(Long queueTime) {
  ...
  public CIAppPipelineEventFinishedJob stageId(String stageId) {
  ...
  public CIAppPipelineEventFinishedJob stageName(String stageName) {
  ...
  public CIAppPipelineEventFinishedJob start(OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob status(CIAppPipelineEventJobStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  public CIAppPipelineEventFinishedJob tags(List<String> tags) {
    this.tags = JsonNullable.<List<String>>of(tags);
    return this;
  }

  public CIAppPipelineEventFinishedJob addTagsItem(String tagsItem) {
  ...
  public CIAppPipelineEventFinishedJob url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return CIAppPipelineEventFinishedJob
   */
  @JsonAnySetter
  public CIAppPipelineEventFinishedJob putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this CIAppPipelineEventFinishedJob object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    CIAppPipelineEventFinishedJob ciAppPipelineEventFinishedJob = (CIAppPipelineEventFinishedJob) o;
    return Objects.equals(this.dependencies, ciAppPipelineEventFinishedJob.dependencies)
        && Objects.equals(this.end, ciAppPipelineEventFinishedJob.end)
        && Objects.equals(this.error, ciAppPipelineEventFinishedJob.error)
        && Objects.equals(this.git, ciAppPipelineEventFinishedJob.git)
        && Objects.equals(this.id, ciAppPipelineEventFinishedJob.id)
        && Objects.equals(this.level, ciAppPipelineEventFinishedJob.level)
        && Objects.equals(this.metrics, ciAppPipelineEventFinishedJob.metrics)
        && Objects.equals(this.name, ciAppPipelineEventFinishedJob.name)
        && Objects.equals(this.node, ciAppPipelineEventFinishedJob.node)
        && Objects.equals(this.parameters, ciAppPipelineEventFinishedJob.parameters)
        && Objects.equals(this.pipelineName, ciAppPipelineEventFinishedJob.pipelineName)
        && Objects.equals(this.pipelineUniqueId, ciAppPipelineEventFinishedJob.pipelineUniqueId)
        && Objects.equals(this.queueTime, ciAppPipelineEventFinishedJob.queueTime)
        && Objects.equals(this.stageId, ciAppPipelineEventFinishedJob.stageId)
        && Objects.equals(this.stageName, ciAppPipelineEventFinishedJob.stageName)
        && Objects.equals(this.start, ciAppPipelineEventFinishedJob.start)
        && Objects.equals(this.status, ciAppPipelineEventFinishedJob.status)
        && Objects.equals(this.tags, ciAppPipelineEventFinishedJob.tags)
        && Objects.equals(this.url, ciAppPipelineEventFinishedJob.url)
        && Objects.equals(
            this.additionalProperties, ciAppPipelineEventFinishedJob.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CIAppPipelineEventFinishedJob {\n");
