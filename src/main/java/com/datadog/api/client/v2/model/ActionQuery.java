...
/**
   * <p>An action query. This query type is used to trigger an action, such as sending a HTTP request.</p>
 */
@JsonPropertyOrder({
...
public class ActionQuery {
  ...
  public ActionQuery(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_PROPERTIES)ActionQueryProperties properties,
  ...
  /**
   * <p>Events to listen for downstream of the action query.</p>
   * @return events
  **/
  ...
  /**
   * <p>The ID of the action query.</p>
   * @return id
  **/
  ...
  /**
   * <p>A unique identifier for this action query. This name is also used to access the query's result throughout the app.</p>
   * @return name
  **/
