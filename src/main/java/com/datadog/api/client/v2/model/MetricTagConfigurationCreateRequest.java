...
/**
   * <p>Request object that includes the metric that you would like to configure tags for.</p>
 */
@JsonPropertyOrder({
...
public class MetricTagConfigurationCreateRequest {
  ...
  @JsonCreator
  public MetricTagConfigurationCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)MetricTagConfigurationCreateData data) {
        this.data = data;
  ...
  **/
   ...
   */
  @JsonAnySetter
  public MetricTagConfigurationCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, metricTagConfigurationCreateRequest.data) && Objects.equals(this.additionalProperties, metricTagConfigurationCreateRequest.additionalProperties);
  }
