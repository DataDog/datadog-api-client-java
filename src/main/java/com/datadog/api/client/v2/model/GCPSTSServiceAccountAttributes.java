...
public class GCPSTSServiceAccountAttributes {
  ...
  public static final String JSON_PROPERTY_IS_GLOBAL_LOCATION_ENABLED = "is_global_location_enabled";
  private Boolean isGlobalLocationEnabled = true;

  public static final String JSON_PROPERTY_IS_PER_PROJECT_QUOTA_ENABLED = "is_per_project_quota_enabled";
  ...
  /**
   * <p>Tags to be associated with GCP metrics and service checks from your account.</p>
   * @return accountTags
  **/
  ...
  **/
  ...
  /**
   * <p>Your service account email address.</p>
   * @return clientEmail
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>List of filters to limit the VM instances that are pulled into Datadog by using tags.
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog will activate the Cloud Security Monitoring product for this service account. Note: This requires resource_collection_enabled to be set to true.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog collects metrics where location is explicitly stated as "global" or where location information cannot be deduced from GCP labels.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog applies the <code>X-Goog-User-Project</code> header, attributing Google Cloud billing and quota usage to the project being monitored rather than the default service account project.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog scans for all resource change data in your Google Cloud environment.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog will attempt to collect Security Command Center Findings. Note: This requires additional permissions on the service account.</p>
  ...
  **/
  ...
  /**
   * <p>Configurations for GCP metric namespaces.</p>
  ...
  **/
  ...
  /**
   * <p>Configurations for GCP location filtering, such as region, multi-region, or zone. Only monitored resources that match the specified regions are imported into Datadog. By default, Datadog collects from all locations.</p>
  ...
  **/
  ...
  /**
   * <p>When enabled, Datadog scans for all resources in your GCP environment.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GCPSTSServiceAccountAttributes gcpstsServiceAccountAttributes = (GCPSTSServiceAccountAttributes) o;
    return Objects.equals(this.accountTags, gcpstsServiceAccountAttributes.accountTags) && Objects.equals(this.automute, gcpstsServiceAccountAttributes.automute) && Objects.equals(this.clientEmail, gcpstsServiceAccountAttributes.clientEmail) && Objects.equals(this.cloudRunRevisionFilters, gcpstsServiceAccountAttributes.cloudRunRevisionFilters) && Objects.equals(this.hostFilters, gcpstsServiceAccountAttributes.hostFilters) && Objects.equals(this.isCspmEnabled, gcpstsServiceAccountAttributes.isCspmEnabled) && Objects.equals(this.isGlobalLocationEnabled, gcpstsServiceAccountAttributes.isGlobalLocationEnabled) && Objects.equals(this.isPerProjectQuotaEnabled, gcpstsServiceAccountAttributes.isPerProjectQuotaEnabled) && Objects.equals(this.isResourceChangeCollectionEnabled, gcpstsServiceAccountAttributes.isResourceChangeCollectionEnabled) && Objects.equals(this.isSecurityCommandCenterEnabled, gcpstsServiceAccountAttributes.isSecurityCommandCenterEnabled) && Objects.equals(this.metricNamespaceConfigs, gcpstsServiceAccountAttributes.metricNamespaceConfigs) && Objects.equals(this.monitoredResourceConfigs, gcpstsServiceAccountAttributes.monitoredResourceConfigs) && Objects.equals(this.regionFilterConfigs, gcpstsServiceAccountAttributes.regionFilterConfigs) && Objects.equals(this.resourceCollectionEnabled, gcpstsServiceAccountAttributes.resourceCollectionEnabled) && Objects.equals(this.additionalProperties, gcpstsServiceAccountAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(accountTags,automute,clientEmail,cloudRunRevisionFilters,hostFilters,isCspmEnabled,isGlobalLocationEnabled,isPerProjectQuotaEnabled,isResourceChangeCollectionEnabled,isSecurityCommandCenterEnabled,metricNamespaceConfigs,monitoredResourceConfigs,regionFilterConfigs,resourceCollectionEnabled, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    cloudRunRevisionFilters: ").append(toIndentedString(cloudRunRevisionFilters)).append("\n");
    ...
    sb.append("    isResourceChangeCollectionEnabled: ").append(toIndentedString(isResourceChangeCollectionEnabled)).append("\n");
    sb.append("    isSecurityCommandCenterEnabled: ").append(toIndentedString(isSecurityCommandCenterEnabled)).append("\n");
    sb.append("    metricNamespaceConfigs: ").append(toIndentedString(metricNamespaceConfigs)).append("\n");
