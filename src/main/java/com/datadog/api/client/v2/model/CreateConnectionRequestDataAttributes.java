...
public class CreateConnectionRequestDataAttributes {
  ...
  /**
   * <p>List of custom attribute fields to import from the data source.</p>
   * @return fields
  **/
  ...
  /**
   * <p>The attribute in the data source used to join records with the entity.</p>
  ...
  **/
  ...
  /**
   * <p>The type of join key used to link the data source to the entity (for example, email or user_id).</p>
   * @return joinType
  **/
