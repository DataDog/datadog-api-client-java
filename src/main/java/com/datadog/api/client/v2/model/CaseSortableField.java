...
/**
   * <p>Case field that can be sorted on</p>
 */
...
public class CaseSortableField extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("created_at", "priority", "status"));
  ...
  public static class CaseSortableFieldSerializer extends StdSerializer<CaseSortableField> {
      ...
      @Override
      public void serialize(CaseSortableField value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
