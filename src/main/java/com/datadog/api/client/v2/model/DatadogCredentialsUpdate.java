...
public class DatadogCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class DatadogCredentialsUpdateSerializer extends StdSerializer<DatadogCredentialsUpdate> {
        ...
        @Override
        public void serialize(DatadogCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DatadogCredentialsUpdateDeserializer extends StdDeserializer<DatadogCredentialsUpdate> {
        ...
        @Override
        public DatadogCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (DatadogAPIKeyUpdate.class.equals(Integer.class) || DatadogAPIKeyUpdate.class.equals(Long.class) || DatadogAPIKeyUpdate.class.equals(Float.class) || DatadogAPIKeyUpdate.class.equals(Double.class) || DatadogAPIKeyUpdate.class.equals(Boolean.class) || DatadogAPIKeyUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((DatadogAPIKeyUpdate.class.equals(Integer.class) || DatadogAPIKeyUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((DatadogAPIKeyUpdate.class.equals(Float.class) || DatadogAPIKeyUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (DatadogAPIKeyUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (DatadogAPIKeyUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public DatadogCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `DatadogAPIKeyUpdate`. If the actual instance is not `DatadogAPIKeyUpdate`,
