...
public class AWSLogsServicesResponseData {
  ...
  public AWSLogsServicesResponseData(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AWSLogsServicesResponseDataType type) {
        this.id = id;
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>The <code>AWSLogsServicesResponseData</code> <code>id</code>.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, awsLogsServicesResponseData.attributes) && Objects.equals(this.id, awsLogsServicesResponseData.id) && Objects.equals(this.type, awsLogsServicesResponseData.type) && Objects.equals(this.additionalProperties, awsLogsServicesResponseData.additionalProperties);
  }
