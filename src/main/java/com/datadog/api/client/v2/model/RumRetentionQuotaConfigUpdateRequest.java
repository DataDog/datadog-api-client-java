...
/**
   * <p>The body of a request to create or update a RUM retention quota configuration.</p>
 */
@JsonPropertyOrder({
  RumRetentionQuotaConfigUpdateRequest.JSON_PROPERTY_DATA
})
...
public class RumRetentionQuotaConfigUpdateRequest {
  ...
  @JsonCreator
  public RumRetentionQuotaConfigUpdateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)RumRetentionQuotaConfigUpdateData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RumRetentionQuotaConfigUpdateRequest rumRetentionQuotaConfigUpdateRequest = (RumRetentionQuotaConfigUpdateRequest) o;
    return Objects.equals(this.data, rumRetentionQuotaConfigUpdateRequest.data) && Objects.equals(this.additionalProperties, rumRetentionQuotaConfigUpdateRequest.additionalProperties);
  }
