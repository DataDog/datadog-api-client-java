...
public class FreshserviceAPIKey {
  ...
  /**
   * The <code>FreshserviceAPIKey</code> <code>api_key</code>.
   *
   * @return apiKey
   */
  ...
  /**
   * The <code>FreshserviceAPIKey</code> <code>domain</code>.
   *
   * @return domain
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, freshserviceApiKey.apiKey)
        && Objects.equals(this.domain, freshserviceApiKey.domain)
        && Objects.equals(this.type, freshserviceApiKey.type)
        && Objects.equals(this.additionalProperties, freshserviceApiKey.additionalProperties);
  }
