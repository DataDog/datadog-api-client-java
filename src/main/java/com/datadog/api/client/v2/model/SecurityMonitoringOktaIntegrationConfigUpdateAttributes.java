...
/**
   * <p>Fields to update on an Okta entity context sync configuration.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringOktaIntegrationConfigUpdateAttributes {
  ...
  **/
  ...
  public SecurityMonitoringOktaIntegrationConfigUpdateAttributes integrationType(SecurityMonitoringIntegrationTypeOkta integrationType) {
    this.integrationType = integrationType;
    this.unparsed |= !integrationType.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringOktaIntegrationConfigUpdateAttributes secrets(SecurityMonitoringIntegrationConfigOktaSecrets secrets) {
  ...
  **/
  ...
  public SecurityMonitoringOktaIntegrationConfigUpdateAttributes settings(Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }
  public SecurityMonitoringOktaIntegrationConfigUpdateAttributes putSettingsItem(String key, Object settingsItem) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringOktaIntegrationConfigUpdateAttributes putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecurityMonitoringOktaIntegrationConfigUpdateAttributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SecurityMonitoringOktaIntegrationConfigUpdateAttributes securityMonitoringOktaIntegrationConfigUpdateAttributes = (SecurityMonitoringOktaIntegrationConfigUpdateAttributes) o;
    return Objects.equals(this.domain, securityMonitoringOktaIntegrationConfigUpdateAttributes.domain) && Objects.equals(this.enabled, securityMonitoringOktaIntegrationConfigUpdateAttributes.enabled) && Objects.equals(this.integrationType, securityMonitoringOktaIntegrationConfigUpdateAttributes.integrationType) && Objects.equals(this.name, securityMonitoringOktaIntegrationConfigUpdateAttributes.name) && Objects.equals(this.secrets, securityMonitoringOktaIntegrationConfigUpdateAttributes.secrets) && Objects.equals(this.settings, securityMonitoringOktaIntegrationConfigUpdateAttributes.settings) && Objects.equals(this.additionalProperties, securityMonitoringOktaIntegrationConfigUpdateAttributes.additionalProperties);
  }
