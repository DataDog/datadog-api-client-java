...
public class GovernanceInsightAuditQuery {
  ...
  @JsonCreator
  public GovernanceInsightAuditQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_COMPUTE)GovernanceInsightAuditCompute compute,
  ...
  **/
  ...
  /**
   * <p>The audit log indexes the query runs against.</p>
   * @return indexes
  **/
  ...
  /**
   * <p>The audit log search query string.</p>
   * @return query
  **/
