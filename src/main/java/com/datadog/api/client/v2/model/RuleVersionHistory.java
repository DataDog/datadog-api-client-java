...
@JsonPropertyOrder({
  RuleVersionHistory.JSON_PROPERTY_CHANGES,
  RuleVersionHistory.JSON_PROPERTY_RULE
})
...
public class RuleVersionHistory {
  ...
  private List<RuleVersionUpdate> changes = null;

  public static final String JSON_PROPERTY_RULE = "rule";
  private SecurityMonitoringRuleResponse rule;

  public RuleVersionHistory changes(List<RuleVersionUpdate> changes) {
    this.changes = changes;
    for (RuleVersionUpdate item : changes) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }

  public RuleVersionHistory addChangesItem(RuleVersionUpdate changesItem) {
  ...
  public List<RuleVersionUpdate> getChanges() {
    return changes;
  }

  public void setChanges(List<RuleVersionUpdate> changes) {
    this.changes = changes;
  }

  public RuleVersionHistory rule(SecurityMonitoringRuleResponse rule) {
    this.rule = rule;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.changes, ruleVersionHistory.changes)
        && Objects.equals(this.rule, ruleVersionHistory.rule)
        && Objects.equals(this.additionalProperties, ruleVersionHistory.additionalProperties);
  }
