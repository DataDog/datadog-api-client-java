...
@JsonPropertyOrder({RuleVersionHistory.JSON_PROPERTY_COUNT, RuleVersionHistory.JSON_PROPERTY_DATA})
...
public class RuleVersionHistory {
  ...
  /**
   * The <code>RuleVersionHistory</code> <code>data</code>.
   *
   * @return data
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, ruleVersionHistory.count)
        && Objects.equals(this.data, ruleVersionHistory.data)
