...
/**
   * <p>AWS Metrics Collection tag filters list. Defaults to <code>[]</code>.
   * The array of custom AWS resource tags (in the form <code>key:value</code>) defines a filter that Datadog uses
   * when collecting metrics from a specified service.
   * Wildcards, such as <code>?</code> (match a single character) and <code>*</code> (match multiple characters),
   * and exclusion using <code>!</code> before the tag are supported.
   * For EC2, only hosts that match one of the defined tags are imported into Datadog.
   * The rest are ignored. For example, <code>env:production,instance-type:c?.*,!region:us-east-1</code>.</p>
 */
@JsonPropertyOrder({
...
public class AWSNamespaceTagFilter {
  ...
  /**
   * <p>The AWS service for which the tag filters defined in <code>tags</code> will be applied.</p>
   * @return namespace
  **/
  ...
  /**
   * <p>The AWS resource tags to filter on for the service specified by <code>namespace</code>.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.namespace, awsNamespaceTagFilter.namespace) && Objects.equals(this.tags, awsNamespaceTagFilter.tags) && Objects.equals(this.additionalProperties, awsNamespaceTagFilter.additionalProperties);
  }
