...
public class AIGuardAction extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("ALLOW", "DENY", "ABORT"));
  ...
  public static class AIGuardActionSerializer extends StdSerializer<AIGuardAction> {
    public AIGuardActionSerializer(Class<AIGuardAction> t) {
      super(t);
    }
