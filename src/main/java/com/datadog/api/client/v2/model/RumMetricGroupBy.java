 ...
 */
@JsonPropertyOrder({
  RumMetricGroupBy.JSON_PROPERTY_PATH,
  RumMetricGroupBy.JSON_PROPERTY_TAG_NAME
})
...
public class RumMetricGroupBy {
  ...
  /**
   * <p>The path to the value the rum-based metric will be aggregated over.</p>
   * @return path
  **/
  ...
  /**
   * <p>Eventual name of the tag that gets created. By default, <code>path</code> is used as the tag name.</p>
   * @return tagName
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.path, rumMetricGroupBy.path) && Objects.equals(this.tagName, rumMetricGroupBy.tagName) && Objects.equals(this.additionalProperties, rumMetricGroupBy.additionalProperties);
  }
