...
public class RelationshipToIncidentPostmortem {
  ...
  public RelationshipToIncidentPostmortem() {}

  @JsonCreator
  public RelationshipToIncidentPostmortem(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)RelationshipToIncidentPostmortemData data) {
        this.data = data;
  ...
  /**
   * <p>The postmortem relationship data.</p>
   * @return data
  **/
   ...
   */
  @JsonAnySetter
  public RelationshipToIncidentPostmortem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, relationshipToIncidentPostmortem.data) && Objects.equals(this.additionalProperties, relationshipToIncidentPostmortem.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RelationshipToIncidentPostmortem {\n");
