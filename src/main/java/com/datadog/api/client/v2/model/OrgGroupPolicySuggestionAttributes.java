...
public class OrgGroupPolicySuggestionAttributes {
  ...
  public OrgGroupPolicySuggestionAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RECOMMENDED_VALUE)Object recommendedValue,
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)OrgGroupPolicySuggestionStatus status) {
  ...
  /**
   * <p>The ratio of member orgs whose configuration agrees on the recommended value.</p>
   * minimum: 0
   * maximum: 1
  ...
  **/
  ...
  /**
   * <p>The name of the suggested policy.</p>
   * @return policyName
  **/
  ...
  /**
   * <p>The recommended value for the policy, based on member org consensus.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrgGroupPolicySuggestionAttributes orgGroupPolicySuggestionAttributes = (OrgGroupPolicySuggestionAttributes) o;
    return Objects.equals(this.consensusRatio, orgGroupPolicySuggestionAttributes.consensusRatio) && Objects.equals(this.policyName, orgGroupPolicySuggestionAttributes.policyName) && Objects.equals(this.recommendedValue, orgGroupPolicySuggestionAttributes.recommendedValue) && Objects.equals(this.status, orgGroupPolicySuggestionAttributes.status) && Objects.equals(this.additionalProperties, orgGroupPolicySuggestionAttributes.additionalProperties);
  }
