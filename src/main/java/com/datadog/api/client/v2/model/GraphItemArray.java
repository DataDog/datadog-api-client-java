...
public class GraphItemArray {
  ...
  private List<GraphItemData> data = new ArrayList<>();

  public GraphItemArray() {}

  @JsonCreator
  public GraphItemArray(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<GraphItemData> data) {
    this.data = data;
  }

  public GraphItemArray data(List<GraphItemData> data) {
    this.data = data;
  ...
  public List<GraphItemData> getData() {
    return data;
  }

  public void setData(List<GraphItemData> data) {
    this.data = data;
  }
