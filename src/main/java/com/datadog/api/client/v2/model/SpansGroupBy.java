...
public class SpansGroupBy {
  ...
  private SpansGroupByTotal total;

  public SpansGroupBy() {}

  @JsonCreator
  public SpansGroupBy(@JsonProperty(required = true, value = JSON_PROPERTY_FACET) String facet) {
    this.facet = facet;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.facet, spansGroupBy.facet)
        && Objects.equals(this.histogram, spansGroupBy.histogram)
        && Objects.equals(this.limit, spansGroupBy.limit)
        && Objects.equals(this.missing, spansGroupBy.missing)
        && Objects.equals(this.sort, spansGroupBy.sort)
        && Objects.equals(this.total, spansGroupBy.total)
