 ...
 */
@JsonPropertyOrder({
  AnalysisPosition.JSON_PROPERTY_COL,
  AnalysisPosition.JSON_PROPERTY_LINE
})
...
public class AnalysisPosition {
  ...
  /**
   * <p>The column number in the source file (1-based).</p>
   * @return col
  **/
  ...
  /**
   * <p>The line number in the source file (1-based).</p>
   * @return line
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.col, analysisPosition.col) && Objects.equals(this.line, analysisPosition.line) && Objects.equals(this.additionalProperties, analysisPosition.additionalProperties);
  }
