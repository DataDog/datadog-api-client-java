...
public class ObservabilityPipelineTagCardinalityLimitProcessorType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("tag_cardinality_limit"));
  ...
  public static class ObservabilityPipelineTagCardinalityLimitProcessorTypeSerializer
      extends StdSerializer<ObservabilityPipelineTagCardinalityLimitProcessorType> {
    public ObservabilityPipelineTagCardinalityLimitProcessorTypeSerializer(
        Class<ObservabilityPipelineTagCardinalityLimitProcessorType> t) {
      super(t);
    }
