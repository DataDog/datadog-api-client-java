...
public class CaseBulkUpdateRequestAttributes {
  ...
  /**
   * <p>An array of case identifiers to apply the bulk action to.</p>
   * @return caseIds
  **/
  ...
  /**
   * <p>A key-value map of action-specific parameters. The required keys depend on the action type (for example, <code>priority</code> for the priority action, <code>assignee_id</code> for assign).</p>
   * @return payload
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CaseBulkUpdateRequestAttributes caseBulkUpdateRequestAttributes = (CaseBulkUpdateRequestAttributes) o;
    return Objects.equals(this.caseIds, caseBulkUpdateRequestAttributes.caseIds) && Objects.equals(this.payload, caseBulkUpdateRequestAttributes.payload) && Objects.equals(this.type, caseBulkUpdateRequestAttributes.type) && Objects.equals(this.additionalProperties, caseBulkUpdateRequestAttributes.additionalProperties);
  }
