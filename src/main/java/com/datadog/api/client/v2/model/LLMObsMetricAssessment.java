...
public class LLMObsMetricAssessment extends ModelEnum<String> {
  ...
  public static class LLMObsMetricAssessmentSerializer
      extends StdSerializer<LLMObsMetricAssessment> {
    ...
    public void serialize(
        LLMObsMetricAssessment value, JsonGenerator jgen, SerializerProvider provider)
