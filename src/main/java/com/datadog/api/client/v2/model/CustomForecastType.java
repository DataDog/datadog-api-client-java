...
public class CustomForecastType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("custom_forecast"));

  public static final CustomForecastType CUSTOM_FORECAST = new CustomForecastType("custom_forecast");
  ...
  public static class CustomForecastTypeSerializer extends StdSerializer<CustomForecastType> {
      ...
      @Override
      public void serialize(CustomForecastType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
