...
@JsonDeserialize(using = RUMGroupByTotal.RUMGroupByTotalDeserializer.class)
@JsonSerialize(using = RUMGroupByTotal.RUMGroupByTotalSerializer.class)
public class RUMGroupByTotal extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(RUMGroupByTotal.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class RUMGroupByTotalSerializer extends StdSerializer<RUMGroupByTotal> {
        public RUMGroupByTotalSerializer(Class<RUMGroupByTotal> t) {
            super(t);
        }

        public RUMGroupByTotalSerializer() {
            this(null);
        }

        @Override
        public void serialize(RUMGroupByTotal value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class RUMGroupByTotalDeserializer extends StdDeserializer<RUMGroupByTotal> {
        public RUMGroupByTotalDeserializer() {
            this(RUMGroupByTotal.class);
        }

        public RUMGroupByTotalDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public RUMGroupByTotal deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            RUMGroupByTotal ret = new RUMGroupByTotal();
            if (match == 1) {
         ...
         */
        @Override
        public RUMGroupByTotal getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "RUMGroupByTotal cannot be null");
        }
    }
    ...
    public RUMGroupByTotal() {
        super("oneOf", Boolean.FALSE);
    }
    public RUMGroupByTotal(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return RUMGroupByTotal.schemas;
    }
