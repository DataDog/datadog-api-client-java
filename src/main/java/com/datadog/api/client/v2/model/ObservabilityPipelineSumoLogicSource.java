...
/**
   * <p>The <code>sumo_logic</code> source receives logs from Sumo Logic collectors.</p>
...
public class ObservabilityPipelineSumoLogicSource {
  ...
  private ObservabilityPipelineSumoLogicSourceType type = ObservabilityPipelineSumoLogicSourceType.SUMO_LOGIC;
  ...
  public ObservabilityPipelineSumoLogicSource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineSumoLogicSourceType type) {
        this.id = id;
        this.type = type;
  ...
  /**
   * <p>Name of the environment variable or secret that holds the listen address for the Sumo Logic receiver.</p>
   * @return addressKey
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineSumoLogicSource observabilityPipelineSumoLogicSource = (ObservabilityPipelineSumoLogicSource) o;
    return Objects.equals(this.addressKey, observabilityPipelineSumoLogicSource.addressKey) && Objects.equals(this.id, observabilityPipelineSumoLogicSource.id) && Objects.equals(this.type, observabilityPipelineSumoLogicSource.type) && Objects.equals(this.additionalProperties, observabilityPipelineSumoLogicSource.additionalProperties);
  }
