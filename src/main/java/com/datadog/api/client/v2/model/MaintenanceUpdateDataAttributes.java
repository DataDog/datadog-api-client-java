...
public class MaintenanceUpdateDataAttributes {
  ...
  public MaintenanceUpdateDataAttributes componentsAffected(List<CreateMaintenanceRequestDataAttributesComponentsAffectedItems> componentsAffected) {
  ...
  public MaintenanceUpdateDataAttributes addComponentsAffectedItem(CreateMaintenanceRequestDataAttributesComponentsAffectedItems componentsAffectedItem) {
  ...
  /**
   * <p>Components affected at the time of the update.</p>
  ...
  **/
  ...
  /**
   * <p>The date and time the update was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The message body of the update.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the update was applied manually by a user (true) or automatically by the system (false).</p>
  ...
  **/
  ...
  /**
   * <p>The date and time the update was last modified.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The date and time the update started.</p>
   * @return startedAt
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MaintenanceUpdateDataAttributes maintenanceUpdateDataAttributes = (MaintenanceUpdateDataAttributes) o;
    return Objects.equals(this.componentsAffected, maintenanceUpdateDataAttributes.componentsAffected) && Objects.equals(this.createdAt, maintenanceUpdateDataAttributes.createdAt) && Objects.equals(this.description, maintenanceUpdateDataAttributes.description) && Objects.equals(this.manualTransition, maintenanceUpdateDataAttributes.manualTransition) && Objects.equals(this.modifiedAt, maintenanceUpdateDataAttributes.modifiedAt) && Objects.equals(this.startedAt, maintenanceUpdateDataAttributes.startedAt) && Objects.equals(this.status, maintenanceUpdateDataAttributes.status) && Objects.equals(this.additionalProperties, maintenanceUpdateDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(componentsAffected,createdAt,description,manualTransition,modifiedAt,startedAt,status, additionalProperties);
  }
