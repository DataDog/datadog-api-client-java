...
@JsonPropertyOrder({
  ...
  ApmDependencyStatsQuery.JSON_PROPERTY_NAME,
  ApmDependencyStatsQuery.JSON_PROPERTY_OPERATION_NAME,
  ApmDependencyStatsQuery.JSON_PROPERTY_PRIMARY_TAG_NAME,
  ApmDependencyStatsQuery.JSON_PROPERTY_PRIMARY_TAG_VALUE,
  ApmDependencyStatsQuery.JSON_PROPERTY_RESOURCE_NAME,
...
public class ApmDependencyStatsQuery {
  ...
  private ApmDependencyStatName stat;
   ...
   * @return ApmDependencyStatsQuery
   */
  @JsonAnySetter
