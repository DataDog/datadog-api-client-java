...
@JsonSerialize(
    using = SeverityModifierRuleShiftActionType.SeverityModifierRuleShiftActionTypeSerializer.class)
public class SeverityModifierRuleShiftActionType extends ModelEnum<String> {
  ...
  public static final SeverityModifierRuleShiftActionType SHIFT =
      new SeverityModifierRuleShiftActionType("shift");

  SeverityModifierRuleShiftActionType(String value) {
    super(value, allowedValues);
  }

  public static class SeverityModifierRuleShiftActionTypeSerializer
      extends StdSerializer<SeverityModifierRuleShiftActionType> {
    public SeverityModifierRuleShiftActionTypeSerializer(
        Class<SeverityModifierRuleShiftActionType> t) {
      super(t);
    }
    ...
    public void serialize(
        SeverityModifierRuleShiftActionType value, JsonGenerator jgen, SerializerProvider provider)
