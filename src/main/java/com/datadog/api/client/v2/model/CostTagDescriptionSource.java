...
public class CostTagDescriptionSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("human", "ai_generated", "datadog"));

  public static final CostTagDescriptionSource HUMAN = new CostTagDescriptionSource("human");
  public static final CostTagDescriptionSource AI_GENERATED = new CostTagDescriptionSource("ai_generated");
  ...
  public static class CostTagDescriptionSourceSerializer extends StdSerializer<CostTagDescriptionSource> {
      ...
      @Override
      public void serialize(CostTagDescriptionSource value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
