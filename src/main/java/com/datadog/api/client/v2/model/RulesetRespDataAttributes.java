...
/** The definition of <code>RulesetRespDataAttributes</code> object. */
@JsonPropertyOrder({
...
public class RulesetRespDataAttributes {
  ...
  @JsonCreator
  public RulesetRespDataAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_CREATED)
          RulesetRespDataAttributesCreated created,
      @JsonProperty(required = true, value = JSON_PROPERTY_ENABLED) Boolean enabled,
      @JsonProperty(required = true, value = JSON_PROPERTY_LAST_MODIFIED_USER_UUID)
          String lastModifiedUserUuid,
      @JsonProperty(required = true, value = JSON_PROPERTY_MODIFIED)
  ...
  /**
   * The <code>attributes</code> <code>position</code>. maximum: 2147483647
   *
   * @return position
   */
  ...
  /**
   * The <code>attributes</code> <code>version</code>.
   *
   * @return version
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.created, rulesetRespDataAttributes.created)
        && Objects.equals(this.enabled, rulesetRespDataAttributes.enabled)
        && Objects.equals(this.lastModifiedUserUuid, rulesetRespDataAttributes.lastModifiedUserUuid)
        ...
        && Objects.equals(
            this.additionalProperties, rulesetRespDataAttributes.additionalProperties);
  }
