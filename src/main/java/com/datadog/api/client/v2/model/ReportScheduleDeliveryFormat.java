...
public class ReportScheduleDeliveryFormat extends ModelEnum<String> {
  ...
  public static final ReportScheduleDeliveryFormat PDF_AND_PNG = new ReportScheduleDeliveryFormat("pdf_and_png");
  ...
  public static class ReportScheduleDeliveryFormatSerializer extends StdSerializer<ReportScheduleDeliveryFormat> {
      ...
      @Override
      public void serialize(ReportScheduleDeliveryFormat value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
