...
/**
   * <p>The <code>amazon_data_firehose</code> source ingests logs from AWS Data Firehose.</p>
...
public class ObservabilityPipelineAmazonDataFirehoseSource {
  ...
  private ObservabilityPipelineAmazonDataFirehoseSourceType type = ObservabilityPipelineAmazonDataFirehoseSourceType.AMAZON_DATA_FIREHOSE;
  ...
  public ObservabilityPipelineAmazonDataFirehoseSource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineAmazonDataFirehoseSourceType type) {
        this.id = id;
        this.type = type;
  ...
  /**
   * <p>Name of the environment variable or secret that holds the Firehose delivery stream address.</p>
   * @return addressKey
  **/
  ...
  **/
  ...
  public ObservabilityPipelineAmazonDataFirehoseSource type(ObservabilityPipelineAmazonDataFirehoseSourceType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The source type. The value should always be <code>amazon_data_firehose</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineAmazonDataFirehoseSource putAdditionalProperty(String key, Object value) {
