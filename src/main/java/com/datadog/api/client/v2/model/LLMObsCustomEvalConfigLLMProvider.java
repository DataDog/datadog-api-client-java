...
public class LLMObsCustomEvalConfigLLMProvider {
  ...
  /**
   * <p>AWS Bedrock-specific options for LLM provider configuration.</p>
   * @return bedrock
  **/
  ...
  /**
   * <p>Integration account identifier.</p>
  ...
  **/
  ...
  public LLMObsCustomEvalConfigLLMProvider integrationProvider(LLMObsCustomEvalConfigIntegrationProvider integrationProvider) {
  ...
  **/
  ...
  public void setIntegrationProvider(LLMObsCustomEvalConfigIntegrationProvider integrationProvider) {
  ...
  **/
  ...
  public LLMObsCustomEvalConfigLLMProvider vertexAi(LLMObsCustomEvalConfigVertexAIOptions vertexAi) {
  ...
  /**
   * <p>Google Vertex AI-specific options for LLM provider configuration.</p>
   * @return vertexAi
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    LLMObsCustomEvalConfigLLMProvider llmObsCustomEvalConfigLlmProvider = (LLMObsCustomEvalConfigLLMProvider) o;
    return Objects.equals(this.bedrock, llmObsCustomEvalConfigLlmProvider.bedrock) && Objects.equals(this.integrationAccountId, llmObsCustomEvalConfigLlmProvider.integrationAccountId) && Objects.equals(this.integrationProvider, llmObsCustomEvalConfigLlmProvider.integrationProvider) && Objects.equals(this.modelName, llmObsCustomEvalConfigLlmProvider.modelName) && Objects.equals(this.vertexAi, llmObsCustomEvalConfigLlmProvider.vertexAi) && Objects.equals(this.additionalProperties, llmObsCustomEvalConfigLlmProvider.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(bedrock,integrationAccountId,integrationProvider,modelName,vertexAi, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    integrationAccountId: ").append(toIndentedString(integrationAccountId)).append("\n");
