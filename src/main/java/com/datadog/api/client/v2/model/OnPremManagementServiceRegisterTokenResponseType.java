...
public class OnPremManagementServiceRegisterTokenResponseType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("tokenDefinitions"));
  ...
  public static class OnPremManagementServiceRegisterTokenResponseTypeSerializer
      extends StdSerializer<OnPremManagementServiceRegisterTokenResponseType> {
    public OnPremManagementServiceRegisterTokenResponseTypeSerializer(
        Class<OnPremManagementServiceRegisterTokenResponseType> t) {
      super(t);
    }
