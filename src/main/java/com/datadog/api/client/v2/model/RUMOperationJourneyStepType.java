...
public class RUMOperationJourneyStepType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("start", "update", "stop", "error", "abandoned"));

  public static final RUMOperationJourneyStepType START = new RUMOperationJourneyStepType("start");
  public static final RUMOperationJourneyStepType UPDATE = new RUMOperationJourneyStepType("update");
  ...
  public static final RUMOperationJourneyStepType ABANDONED = new RUMOperationJourneyStepType("abandoned");
  ...
  public static class RUMOperationJourneyStepTypeSerializer extends StdSerializer<RUMOperationJourneyStepType> {
      ...
      @Override
      public void serialize(RUMOperationJourneyStepType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
