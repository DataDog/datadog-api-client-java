...
/**
   * <p>Metadata about the policy that triggered this status change.</p>
 */
@JsonPropertyOrder({
...
public class FlakyTestHistoryPolicyMeta {
  ...
  /**
   * <p>Branches where the test was flaky at the time of the status change.</p>
   * @return branches
  **/
  ...
  **/
  ...
  /**
   * <p>The number of days the test has been active at the time of the status change.</p>
   * maximum: 2147483647
   * @return daysActive
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The number of days since the test last exhibited flakiness.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DAYS_WITHOUT_FLAKE)public void setDaysWithoutFlake_JsonNullable(JsonNullable<Integer> daysWithoutFlake) {
  ...
  /**
   * <p>The failure rate of the test at the time of the status change.</p>
   * minimum: 0
   * maximum: 1
   * @return failureRate
  **/
  ...
  /**
   * <p>The previous state of the test.</p>
   * @return state
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The total number of test runs at the time of the status change.</p>
   * maximum: 2147483647
   * @return totalRuns
  **/
      @jakarta.annotation.Nullable
  ...
  @JsonProperty(JSON_PROPERTY_TOTAL_RUNS)public void setTotalRuns_JsonNullable(JsonNullable<Integer> totalRuns) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.branches, flakyTestHistoryPolicyMeta.branches) && Objects.equals(this.config, flakyTestHistoryPolicyMeta.config) && Objects.equals(this.daysActive, flakyTestHistoryPolicyMeta.daysActive) && Objects.equals(this.daysWithoutFlake, flakyTestHistoryPolicyMeta.daysWithoutFlake) && Objects.equals(this.failureRate, flakyTestHistoryPolicyMeta.failureRate) && Objects.equals(this.state, flakyTestHistoryPolicyMeta.state) && Objects.equals(this.totalRuns, flakyTestHistoryPolicyMeta.totalRuns) && Objects.equals(this.additionalProperties, flakyTestHistoryPolicyMeta.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(branches,config,daysActive,daysWithoutFlake,failureRate,state,totalRuns, additionalProperties);
  }
