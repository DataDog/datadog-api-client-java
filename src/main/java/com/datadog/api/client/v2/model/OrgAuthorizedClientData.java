...
public class OrgAuthorizedClientData {
  ...
  @JsonCreator
  public OrgAuthorizedClientData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)OrgAuthorizedClientAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)OrgAuthorizedClientRelationships relationships,
  ...
  /**
   * <p>Attributes of an org authorized client.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The unique identifier of the org authorized client.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, orgAuthorizedClientData.attributes) && Objects.equals(this.id, orgAuthorizedClientData.id) && Objects.equals(this.relationships, orgAuthorizedClientData.relationships) && Objects.equals(this.type, orgAuthorizedClientData.type) && Objects.equals(this.additionalProperties, orgAuthorizedClientData.additionalProperties);
  }
