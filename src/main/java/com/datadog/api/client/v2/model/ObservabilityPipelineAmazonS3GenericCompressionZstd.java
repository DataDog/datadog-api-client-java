...
public class ObservabilityPipelineAmazonS3GenericCompressionZstd {
  ...
  private ObservabilityPipelineAmazonS3GenericCompressionZstdType algorithm =
  ...
  public ObservabilityPipelineAmazonS3GenericCompressionZstd(
      @JsonProperty(required = true, value = JSON_PROPERTY_ALGORITHM)
          ObservabilityPipelineAmazonS3GenericCompressionZstdType algorithm,
  ...
  public ObservabilityPipelineAmazonS3GenericCompressionZstd algorithm(
      ObservabilityPipelineAmazonS3GenericCompressionZstdType algorithm) {
    this.algorithm = algorithm;
    this.unparsed |= !algorithm.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.algorithm, observabilityPipelineAmazonS3GenericCompressionZstd.algorithm)
        && Objects.equals(this.level, observabilityPipelineAmazonS3GenericCompressionZstd.level)
        && Objects.equals(
