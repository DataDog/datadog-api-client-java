...
/**
   * <p>Attributes for creating an incident rule.</p>
 */
@JsonPropertyOrder({
...
public class IncidentRuleDataAttributesRequest {
  ...
  @JsonCreator
  public IncidentRuleDataAttributesRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_CONDITION)IncidentRuleQueryCondition condition,
            @JsonProperty(required=true, value=JSON_PROPERTY_CONDITION_TABLE_TYPE)Long conditionTableType,
            @JsonProperty(required=true, value=JSON_PROPERTY_ENABLED)Boolean enabled,
            @JsonProperty(required=true, value=JSON_PROPERTY_EXECUTION_TYPE)IncidentRuleExecutionType executionType,
  ...
  **/
  ...
  public IncidentRuleDataAttributesRequest conditionTableType(Long conditionTableType) {
    this.conditionTableType = conditionTableType;
    return this;
  }

  /**
   * <p>The condition table type. 1 = raw query.</p>
  ...
  **/
  ...
  /**
   * <p>The UUID of the incident type this rule applies to.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_INCIDENT_TYPE_UUID)public void setIncidentTypeUuid_JsonNullable(JsonNullable<UUID> incidentTypeUuid) {
  ...
  /**
   * <p>Whether any condition (OR logic) should match instead of all (AND logic).</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentRuleDataAttributesRequest incidentRuleDataAttributesRequest = (IncidentRuleDataAttributesRequest) o;
    return Objects.equals(this.condition, incidentRuleDataAttributesRequest.condition) && Objects.equals(this.conditionTableType, incidentRuleDataAttributesRequest.conditionTableType) && Objects.equals(this.conditions, incidentRuleDataAttributesRequest.conditions) && Objects.equals(this.enabled, incidentRuleDataAttributesRequest.enabled) && Objects.equals(this.executionType, incidentRuleDataAttributesRequest.executionType) && Objects.equals(this.incidentTypeUuid, incidentRuleDataAttributesRequest.incidentTypeUuid) && Objects.equals(this.matchAnyCondition, incidentRuleDataAttributesRequest.matchAnyCondition) && Objects.equals(this.taskId, incidentRuleDataAttributesRequest.taskId) && Objects.equals(this.taskPayload, incidentRuleDataAttributesRequest.taskPayload) && Objects.equals(this.trigger, incidentRuleDataAttributesRequest.trigger) && Objects.equals(this.additionalProperties, incidentRuleDataAttributesRequest.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(condition,conditionTableType,conditions,enabled,executionType,incidentTypeUuid,matchAnyCondition,taskId,taskPayload,trigger, additionalProperties);
  }
