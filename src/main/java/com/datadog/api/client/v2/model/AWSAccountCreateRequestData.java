...
/**
   * <p>AWS Account Create Request data.</p>
 */
@JsonPropertyOrder({
...
public class AWSAccountCreateRequestData {
  ...
  @JsonCreator
  public AWSAccountCreateRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AWSAccountCreateRequestAttributes attributes,
  ...
  /**
   * <p>The AWS Account Integration Config to be created.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, awsAccountCreateRequestData.attributes) && Objects.equals(this.type, awsAccountCreateRequestData.type) && Objects.equals(this.additionalProperties, awsAccountCreateRequestData.additionalProperties);
  }
