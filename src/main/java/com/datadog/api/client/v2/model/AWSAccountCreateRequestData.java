...
@JsonPropertyOrder({
  ...
  AWSAccountCreateRequestData.JSON_PROPERTY_ID,
...
public class AWSAccountCreateRequestData {
  ...
  public AWSAccountCreateRequestData id(String id) {
    this.id = id;
    return this;
  }
  ...
  public AWSAccountCreateRequestData type(String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, awsAccountCreateRequestData.attributes)
        && Objects.equals(this.id, awsAccountCreateRequestData.id)
