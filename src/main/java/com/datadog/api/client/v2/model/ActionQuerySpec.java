...
public class ActionQuerySpec extends AbstractOpenApiSchema {
    ...
    public static class ActionQuerySpecSerializer extends StdSerializer<ActionQuerySpec> {
        ...
        @Override
        public void serialize(ActionQuerySpec value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ActionQuerySpecDeserializer extends StdDeserializer<ActionQuerySpec> {
        ...
        @Override
        public ActionQuerySpec deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (ActionQuerySpecObject.class.equals(Integer.class) || ActionQuerySpecObject.class.equals(Long.class) || ActionQuerySpecObject.class.equals(Float.class) || ActionQuerySpecObject.class.equals(Double.class) || ActionQuerySpecObject.class.equals(Boolean.class) || ActionQuerySpecObject.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((ActionQuerySpecObject.class.equals(Integer.class) || ActionQuerySpecObject.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((ActionQuerySpecObject.class.equals(Float.class) || ActionQuerySpecObject.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (ActionQuerySpecObject.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (ActionQuerySpecObject.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
    ...
    /**
     * Get the actual instance of `ActionQuerySpecObject`. If the actual instance is not `ActionQuerySpecObject`,
     * the ClassCastException will be thrown.
     *
