...
public class ActionQueryProperties {
   ...
   * <code>true</code> in JavaScript and all other conditions are also met.
   *
   * @return condition
   */
  ...
  /**
   * The minimum time in milliseconds that must pass before the query can be triggered again. This
   * is useful for preventing accidental double-clicks from triggering the query multiple times.
   *
   * @return debounceInMs
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The mocked outputs of the action query. This is useful for testing the app without actually
   * running the action.
   *
  ...
  public ActionQueryProperties onlyTriggerManually(
      ActionQueryOnlyTriggerManually onlyTriggerManually) {
  ...
  /**
   * Determines when this query is executed. If set to <code>false</code>, the query will run when
   * the app loads and whenever any query arguments change. If set to <code>true</code>, the query
   * will only run when manually triggered from elsewhere in the app.
   *
  ...
  /**
   * The post-query transformation function, which is a JavaScript function that changes the query's
   * <code>.outputs</code> property after the query's execution.
   *
   * @return outputs
   */
  @jakarta.annotation.Nullable
  ...
  public ActionQueryProperties pollingIntervalInMs(
      ActionQueryPollingIntervalInMs pollingIntervalInMs) {
  ...
  /**
   * If specified, the app will poll the query at the specified interval in milliseconds. The
   * minimum polling interval is 15 seconds. The query will only poll when the app's browser tab is
   * active.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.condition, actionQueryProperties.condition)
        && Objects.equals(this.debounceInMs, actionQueryProperties.debounceInMs)
        && Objects.equals(this.mockedOutputs, actionQueryProperties.mockedOutputs)
        && Objects.equals(this.onlyTriggerManually, actionQueryProperties.onlyTriggerManually)
        && Objects.equals(this.outputs, actionQueryProperties.outputs)
        && Objects.equals(this.pollingIntervalInMs, actionQueryProperties.pollingIntervalInMs)
        && Objects.equals(this.requiresConfirmation, actionQueryProperties.requiresConfirmation)
        && Objects.equals(this.showToastOnError, actionQueryProperties.showToastOnError)
        && Objects.equals(this.spec, actionQueryProperties.spec)
        && Objects.equals(this.additionalProperties, actionQueryProperties.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    onlyTriggerManually: ")
        .append(toIndentedString(onlyTriggerManually))
        .append("\n");
    sb.append("    outputs: ").append(toIndentedString(outputs)).append("\n");
    sb.append("    pollingIntervalInMs: ")
        .append(toIndentedString(pollingIntervalInMs))
        .append("\n");
    sb.append("    requiresConfirmation: ")
        .append(toIndentedString(requiresConfirmation))
        .append("\n");
