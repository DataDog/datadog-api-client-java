...
public class ObservabilityPipelineGoogleCloudStorageDestination {
  ...
  **/
  ...
  public ObservabilityPipelineGoogleCloudStorageDestination compression(ObservabilityPipelineGoogleCloudStorageDestinationCompression compression) {
  ...
  **/
  ...
  public void setCompression(ObservabilityPipelineGoogleCloudStorageDestinationCompression compression) {
    this.compression = compression;
    if (compression != null) {
      this.unparsed |= compression.unparsed;
    }
