...
@JsonPropertyOrder({
  ...
  FlakyTestAttributes.JSON_PROPERTY_BROKEN_TEST,
...
public class FlakyTestAttributes {
  ...
  public static final String JSON_PROPERTY_BROKEN_TEST = "broken_test";
  private Boolean brokenTest;
  ...
  **/
  ...
  public FlakyTestAttributes brokenTest(Boolean brokenTest) {
    this.brokenTest = brokenTest;
    return this;
  }

  /**
   * <p>Whether every non-skipped run of the test failed over the last 7 days.</p>
   * @return brokenTest
  **/
      @jakarta.annotation.Nullable
      @JsonProperty(JSON_PROPERTY_BROKEN_TEST)
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public Boolean getBrokenTest() {
        return brokenTest;
      }
  public void setBrokenTest(Boolean brokenTest) {
    this.brokenTest = brokenTest;
  }
  ...
  **/
  ...
  /**
   * <p>A score from 0 to 1 indicating the impact of this flaky test, based on factors such as how often it fails and how many pipelines it affects.</p>
   * minimum: 0
   * maximum: 1
   * @return impactScore
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IMPACT_SCORE)public void setImpactScore_JsonNullable(JsonNullable<Double> impactScore) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    brokenTest: ").append(toIndentedString(brokenTest)).append("\n");
