...
public class FlakyTestAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attemptToFixId,codeowners,envs,firstFlakedBranch,firstFlakedSha,firstFlakedTs,flakyCategory,flakyState,history,impactLevel,impactScore,lastFlakedBranch,lastFlakedSha,lastFlakedTs,module,name,pipelineStats,services,suite,testRunMetadata,testStats, additionalProperties);
  }
