...
/**
   * <p>A facet group containing counts broken down by the distinct values of a case field (for example, status or priority).</p>
 */
@JsonPropertyOrder({
  CaseCountGroup.JSON_PROPERTY_GROUP,
  CaseCountGroup.JSON_PROPERTY_GROUP_VALUES
})
...
public class CaseCountGroup {
  ...
  public CaseCountGroup(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_GROUP_VALUES)List<CaseCountGroupValue> groupValues) {
        this.group = group;
  ...
  /**
   * <p>The name of the field being grouped on (for example, <code>status</code> or <code>priority</code>).</p>
   * @return group
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.group, caseCountGroup.group) && Objects.equals(this.groupValues, caseCountGroup.groupValues) && Objects.equals(this.additionalProperties, caseCountGroup.additionalProperties);
  }
