...
@JsonPropertyOrder({
  ...
  ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition.JSON_PROPERTY_FILE_NAME,
...
public class ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition {
  ...
  public ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition end(ScaRequestDataAttributesDependenciesItemsLocationsItemsPosition end) {
    this.end = end;
  ...
  /**
   * <p>A specific position (line and column) within a source file.</p>
   * @return end
  **/
  ...
  public ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition fileName(String fileName) {
    this.fileName = fileName;
    return this;
  }

  /**
   * <p>The name or path of the file containing this location.</p>
   * @return fileName
  **/
      @jakarta.annotation.Nullable
  ...
  public ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition role(String role) {
    this.role = role;
    return this;
  }

  /**
   * <p>The semantic role associated with this file location.</p>
   * @return role
  **/
      @jakarta.annotation.Nullable
  ...
  public ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition start(ScaRequestDataAttributesDependenciesItemsLocationsItemsPosition start) {
    this.start = start;
  ...
  **/
   ...
   */
  @JsonAnySetter
  public ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ScaRequestDataAttributesDependenciesItemsLocationsItemsNullableFilePosition {\n");
