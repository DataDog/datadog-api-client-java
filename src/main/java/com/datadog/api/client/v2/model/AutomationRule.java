...
public class AutomationRule {
  ...
  public AutomationRule(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          AutomationRuleAttributes attributes,
  ...
  /**
   * Related resources for the automation rule, including the users who created and last modified
   * it.
   *
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, automationRule.attributes)
        && Objects.equals(this.id, automationRule.id)
        && Objects.equals(this.relationships, automationRule.relationships)
        && Objects.equals(this.type, automationRule.type)
