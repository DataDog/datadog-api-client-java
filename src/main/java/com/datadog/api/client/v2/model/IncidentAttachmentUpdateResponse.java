...
/**
   * <p>The response object containing the created or updated incident attachments.</p>
 */
@JsonPropertyOrder({
...
public class IncidentAttachmentUpdateResponse {
  ...
  @JsonCreator
  public IncidentAttachmentUpdateResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<IncidentAttachmentData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>An array of incident attachments. Only the attachments that were created or updated by the request are
   * returned.</p>
   * @return data
  **/
  ...
  public IncidentAttachmentUpdateResponse included(List<IncidentAttachmentsResponseIncludedItem> included) {
  ...
  public IncidentAttachmentUpdateResponse addIncludedItem(IncidentAttachmentsResponseIncludedItem includedItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentAttachmentUpdateResponse incidentAttachmentUpdateResponse = (IncidentAttachmentUpdateResponse) o;
    return Objects.equals(this.data, incidentAttachmentUpdateResponse.data) && Objects.equals(this.included, incidentAttachmentUpdateResponse.included);
  }
