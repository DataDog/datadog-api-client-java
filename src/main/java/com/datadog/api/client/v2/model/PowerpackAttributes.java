...
public class PowerpackAttributes {
  ...
  public PowerpackAttributes addTemplateVariablesItem(
      PowerpackTemplateVariable templateVariablesItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, powerpackAttributes.description)
        && Objects.equals(this.groupWidget, powerpackAttributes.groupWidget)
        && Objects.equals(this.name, powerpackAttributes.name)
        && Objects.equals(this.tags, powerpackAttributes.tags)
        && Objects.equals(this.templateVariables, powerpackAttributes.templateVariables)
        && Objects.equals(this.additionalProperties, powerpackAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        description, groupWidget, name, tags, templateVariables, additionalProperties);
  }
