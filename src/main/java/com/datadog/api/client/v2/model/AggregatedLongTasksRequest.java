...
/**
   * <p>Request body for the aggregated long tasks endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedLongTasksRequest.JSON_PROPERTY_DATA
})
...
public class AggregatedLongTasksRequest {
  ...
  @JsonCreator
  public AggregatedLongTasksRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedLongTasksRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, aggregatedLongTasksRequest.data) && Objects.equals(this.additionalProperties, aggregatedLongTasksRequest.additionalProperties);
  }
