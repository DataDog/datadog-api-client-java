...
public class CampaignStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("in_progress", "not_started", "completed"));
  ...
  public static class CampaignStatusSerializer extends StdSerializer<CampaignStatus> {
      ...
      @Override
      public void serialize(CampaignStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
