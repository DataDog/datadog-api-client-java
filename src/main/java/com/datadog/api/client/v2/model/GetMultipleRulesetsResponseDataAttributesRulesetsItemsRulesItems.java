...
/**
   * <p>A static analysis rule within a ruleset, including its definition, metadata, and associated test cases.</p>
 */
@JsonPropertyOrder({
...
public class GetMultipleRulesetsResponseDataAttributesRulesetsItemsRulesItems {
  ...
  /**
   * <p>The list of configurable arguments accepted by this rule.</p>
   * @return arguments
  **/
  ...
  /**
   * <p>The category classifying the type of issue this rule detects (e.g., security, style, performance).</p>
   * @return category
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A checksum of the rule definition used to detect changes.</p>
   * @return checksum
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The rule implementation code used by the static analysis engine.</p>
   * @return code
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The date and time when the rule was created.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The identifier of the user or system that created the rule.</p>
   * @return createdBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The CVE identifier associated with the vulnerability this rule detects, if applicable.</p>
   * @return cve
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The CWE identifier associated with the weakness category this rule detects, if applicable.</p>
   * @return cwe
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>A detailed explanation of what the rule detects and why it matters.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A URL pointing to additional documentation for this rule.</p>
  ...
  **/
  ...
  /**
   * <p>The code entity type (e.g., function, class, variable) that this rule inspects.</p>
  ...
  **/
  ...
  /**
   * <p>Indicates whether the rule is publicly published and available to all users.</p>
   * @return isPublished
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Indicates whether the rule is in testing mode and not yet promoted to production.</p>
   * @return isTesting
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The programming language this rule applies to.</p>
   * @return language
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The date and time when the rule was last modified.</p>
  ...
  **/
  ...
  /**
   * <p>The identifier of the user or system that last updated the rule.</p>
  ...
  **/
  ...
  /**
   * <p>The unique name identifying this rule within its ruleset.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A regular expression pattern used by the rule for pattern-based detection.</p>
   * @return regex
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The severity level of findings produced by this rule (e.g., ERROR, WARNING, NOTICE).</p>
   * @return severity
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A brief summary of what the rule detects, suitable for display in listings.</p>
  ...
  **/
  ...
  /**
   * <p>Indicates whether an AI-generated fix suggestion should be offered for findings from this rule.</p>
  ...
  **/
  ...
  /**
   * <p>The list of test cases used to validate the rule's behavior.</p>
   * @return tests
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The Tree-sitter query expression used by the rule to match code patterns in the AST.</p>
  ...
  **/
  ...
  /**
   * <p>The rule type indicating the detection mechanism used (e.g., tree_sitter, regex).</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
