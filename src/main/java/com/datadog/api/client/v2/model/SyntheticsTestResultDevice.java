...
public class SyntheticsTestResultDevice {
  ...
  /**
   * <p>Browser information for the device used to run the test.</p>
   * @return browser
  **/
  ...
  **/
  ...
  /**
   * <p>Screen resolution of the device used to run the test.</p>
   * @return resolution
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.browser, syntheticsTestResultDevice.browser) && Objects.equals(this.id, syntheticsTestResultDevice.id) && Objects.equals(this.name, syntheticsTestResultDevice.name) && Objects.equals(this.platform, syntheticsTestResultDevice.platform) && Objects.equals(this.resolution, syntheticsTestResultDevice.resolution) && Objects.equals(this.type, syntheticsTestResultDevice.type) && Objects.equals(this.additionalProperties, syntheticsTestResultDevice.additionalProperties);
  }
