...
public class InvestigationType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("investigation"));
  ...
  public static class InvestigationTypeSerializer extends StdSerializer<InvestigationType> {
      ...
      @Override
      public void serialize(InvestigationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
