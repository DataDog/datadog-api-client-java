...
@JsonPropertyOrder({ExecutionPolicyKubernetesScope.JSON_PROPERTY_RULES})
...
public class ExecutionPolicyKubernetesScope {
  ...
  public ExecutionPolicyKubernetesScope(
      @JsonProperty(required = true, value = JSON_PROPERTY_RULES)
          List<ExecutionPolicyKubernetesScopeRule> rules) {
    this.rules = rules;
  ...
  public boolean equals(Object o) {
    ...
    ExecutionPolicyKubernetesScope executionPolicyKubernetesScope =
        (ExecutionPolicyKubernetesScope) o;
    return Objects.equals(this.rules, executionPolicyKubernetesScope.rules)
        && Objects.equals(
            this.additionalProperties, executionPolicyKubernetesScope.additionalProperties);
  }
