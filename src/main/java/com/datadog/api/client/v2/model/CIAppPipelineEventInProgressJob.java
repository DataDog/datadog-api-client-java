...
@JsonPropertyOrder({
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_DEPENDENCIES,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_ERROR,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_GIT,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_ID,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_LEVEL,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_METRICS,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_NAME,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_NODE,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_PARAMETERS,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_PIPELINE_NAME,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_PIPELINE_UNIQUE_ID,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_QUEUE_TIME,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_STAGE_ID,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_STAGE_NAME,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_START,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_STATUS,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_TAGS,
  CIAppPipelineEventInProgressJob.JSON_PROPERTY_URL
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CIAppPipelineEventInProgressJob {
  ...
  private CIAppPipelineEventJobInProgressStatus status;
  ...
  public CIAppPipelineEventInProgressJob() {}
  ...
  public CIAppPipelineEventInProgressJob(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_STATUS)
          CIAppPipelineEventJobInProgressStatus status,
  ...
  public CIAppPipelineEventInProgressJob dependencies(List<String> dependencies) {
    this.dependencies = JsonNullable.<List<String>>of(dependencies);
    return this;
  }

  public CIAppPipelineEventInProgressJob addDependenciesItem(String dependenciesItem) {
  ...
  public CIAppPipelineEventInProgressJob error(CIAppCIError error) {
  ...
  public CIAppPipelineEventInProgressJob git(CIAppGitInfo git) {
  ...
  public CIAppPipelineEventInProgressJob id(String id) {
    this.id = id;
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob level(CIAppPipelineEventJobLevel level) {
    this.level = level;
    this.unparsed |= !level.isValid();
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob metrics(List<String> metrics) {
    this.metrics = JsonNullable.<List<String>>of(metrics);
    return this;
  }

  public CIAppPipelineEventInProgressJob addMetricsItem(String metricsItem) {
  ...
  public CIAppPipelineEventInProgressJob name(String name) {
    this.name = name;
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob node(CIAppHostInfo node) {
  ...
  public CIAppPipelineEventInProgressJob parameters(Map<String, String> parameters) {
    this.parameters = JsonNullable.<Map<String, String>>of(parameters);
    return this;
  }

  public CIAppPipelineEventInProgressJob putParametersItem(String key, String parametersItem) {
  ...
  public CIAppPipelineEventInProgressJob pipelineName(String pipelineName) {
    this.pipelineName = pipelineName;
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob pipelineUniqueId(String pipelineUniqueId) {
    this.pipelineUniqueId = pipelineUniqueId;
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob queueTime(Long queueTime) {
  ...
  public CIAppPipelineEventInProgressJob stageId(String stageId) {
  ...
  public CIAppPipelineEventInProgressJob stageName(String stageName) {
  ...
  public CIAppPipelineEventInProgressJob start(OffsetDateTime start) {
    this.start = start;
    return this;
  }
  ...
  public CIAppPipelineEventInProgressJob status(CIAppPipelineEventJobInProgressStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public CIAppPipelineEventJobInProgressStatus getStatus() {
    return status;
  }

  public void setStatus(CIAppPipelineEventJobInProgressStatus status) {
    if (!status.isValid()) {
      this.unparsed = true;
    }
    this.status = status;
  ...
  public CIAppPipelineEventInProgressJob tags(List<String> tags) {
    this.tags = JsonNullable.<List<String>>of(tags);
    return this;
  }

  public CIAppPipelineEventInProgressJob addTagsItem(String tagsItem) {
  ...
  public CIAppPipelineEventInProgressJob url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return CIAppPipelineEventInProgressJob
   */
  @JsonAnySetter
  public CIAppPipelineEventInProgressJob putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this CIAppPipelineEventInProgressJob object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    CIAppPipelineEventInProgressJob ciAppPipelineEventInProgressJob =
        (CIAppPipelineEventInProgressJob) o;
    return Objects.equals(this.dependencies, ciAppPipelineEventInProgressJob.dependencies)
        && Objects.equals(this.error, ciAppPipelineEventInProgressJob.error)
        && Objects.equals(this.git, ciAppPipelineEventInProgressJob.git)
        && Objects.equals(this.id, ciAppPipelineEventInProgressJob.id)
        && Objects.equals(this.level, ciAppPipelineEventInProgressJob.level)
        && Objects.equals(this.metrics, ciAppPipelineEventInProgressJob.metrics)
        && Objects.equals(this.name, ciAppPipelineEventInProgressJob.name)
        && Objects.equals(this.node, ciAppPipelineEventInProgressJob.node)
        && Objects.equals(this.parameters, ciAppPipelineEventInProgressJob.parameters)
        && Objects.equals(this.pipelineName, ciAppPipelineEventInProgressJob.pipelineName)
        && Objects.equals(this.pipelineUniqueId, ciAppPipelineEventInProgressJob.pipelineUniqueId)
        && Objects.equals(this.queueTime, ciAppPipelineEventInProgressJob.queueTime)
        && Objects.equals(this.stageId, ciAppPipelineEventInProgressJob.stageId)
        && Objects.equals(this.stageName, ciAppPipelineEventInProgressJob.stageName)
        && Objects.equals(this.start, ciAppPipelineEventInProgressJob.start)
        && Objects.equals(this.status, ciAppPipelineEventInProgressJob.status)
        && Objects.equals(this.tags, ciAppPipelineEventInProgressJob.tags)
        && Objects.equals(this.url, ciAppPipelineEventInProgressJob.url)
        && Objects.equals(
            this.additionalProperties, ciAppPipelineEventInProgressJob.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CIAppPipelineEventInProgressJob {\n");
