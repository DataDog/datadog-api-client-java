...
/**
   * <p>Details of a running CI job.</p>
 */
@JsonPropertyOrder({
...
public class CIAppPipelineEventInProgressJob {
  ...
  public CIAppPipelineEventInProgressJob(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)CIAppPipelineEventJobInProgressStatus status,
  ...
  **/
  ...
  /**
   * <p>The UUID for the job. It must match the ID of the corresponding finished job.</p>
   * @return id
  **/
  ...
  **/
  ...
  /**
   * <p>Time when the job run instance started (it should not include any queue time).
   * The time format must be RFC3339.</p>
   * @return start
  **/
  ...
  /**
   * <p>The in-progress status of the job.</p>
   * @return status
  **/
