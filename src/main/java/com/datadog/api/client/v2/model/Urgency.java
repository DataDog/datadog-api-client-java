...
public class Urgency extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("low", "high", "dynamic"));
  ...
  public static class UrgencySerializer extends StdSerializer<Urgency> {
      ...
      @Override
      public void serialize(Urgency value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
