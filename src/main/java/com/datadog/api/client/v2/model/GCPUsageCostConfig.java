...
/**
   * <p>Google Cloud Usage Cost config.</p>
 */
@JsonPropertyOrder({
...
public class GCPUsageCostConfig {
  ...
  private GCPUsageCostConfigType type = GCPUsageCostConfigType.GCP_UC_CONFIG;

  public GCPUsageCostConfig() {}

  @JsonCreator
  public GCPUsageCostConfig(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)GCPUsageCostConfigAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The ID of the Google Cloud Usage Cost config.</p>
   * @return id
  **/
  ...
  /**
   * <p>Type of Google Cloud Usage Cost config.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, gcpUsageCostConfig.attributes) && Objects.equals(this.id, gcpUsageCostConfig.id) && Objects.equals(this.type, gcpUsageCostConfig.type) && Objects.equals(this.additionalProperties, gcpUsageCostConfig.additionalProperties);
  }
