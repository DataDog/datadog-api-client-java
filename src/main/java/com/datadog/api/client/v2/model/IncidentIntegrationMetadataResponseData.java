...
/**
   * <p>Incident integration metadata from a response.</p>
 */
@JsonPropertyOrder({
...
public class IncidentIntegrationMetadataResponseData {
  ...
  public IncidentIntegrationMetadataResponseData attributes(IncidentIntegrationMetadataAttributes attributes) {
  ...
  /**
   * <p>Incident integration metadata's attributes for a create request.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The incident integration metadata's ID.</p>
   * @return id
  **/
  ...
  public IncidentIntegrationMetadataResponseData relationships(IncidentIntegrationRelationships relationships) {
  ...
  /**
   * <p>The incident's integration relationships from a response.</p>
  ...
  **/
  ...
  /**
   * <p>Integration metadata resource type.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentIntegrationMetadataResponseData incidentIntegrationMetadataResponseData = (IncidentIntegrationMetadataResponseData) o;
    return Objects.equals(this.attributes, incidentIntegrationMetadataResponseData.attributes) && Objects.equals(this.id, incidentIntegrationMetadataResponseData.id) && Objects.equals(this.relationships, incidentIntegrationMetadataResponseData.relationships) && Objects.equals(this.type, incidentIntegrationMetadataResponseData.type) && Objects.equals(this.additionalProperties, incidentIntegrationMetadataResponseData.additionalProperties);
  }
