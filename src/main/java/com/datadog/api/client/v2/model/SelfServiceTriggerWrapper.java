...
/**
   * <p>Schema for a Self Service-based trigger.</p>
 */
@JsonPropertyOrder({
...
public class SelfServiceTriggerWrapper {
  ...
  @JsonCreator
  public SelfServiceTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_SELF_SERVICE_TRIGGER)Object selfServiceTrigger) {
  ...
  /**
   * <p>Trigger a workflow from Self Service.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.selfServiceTrigger, selfServiceTriggerWrapper.selfServiceTrigger) && Objects.equals(this.startStepNames, selfServiceTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, selfServiceTriggerWrapper.additionalProperties);
  }
