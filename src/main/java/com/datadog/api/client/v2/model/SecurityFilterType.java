...
public class SecurityFilterType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("security_filters"));

  public static final SecurityFilterType SECURITY_FILTERS = new SecurityFilterType("security_filters");
  ...
  public static class SecurityFilterTypeSerializer extends StdSerializer<SecurityFilterType> {
      ...
      @Override
      public void serialize(SecurityFilterType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
