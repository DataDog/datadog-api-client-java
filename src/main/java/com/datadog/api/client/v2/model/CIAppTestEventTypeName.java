...
public class CIAppTestEventTypeName extends ModelEnum<String> {
  ...
  public static class CIAppTestEventTypeNameSerializer extends StdSerializer<CIAppTestEventTypeName> {
      ...
      @Override
      public void serialize(CIAppTestEventTypeName value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
