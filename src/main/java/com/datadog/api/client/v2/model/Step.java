...
public class Step {
  ...
  /**
   * The <code>Step</code> <code>errorHandlers</code>.
   *
  ...
  public boolean equals(Object o) {
    ...
    Step step = (Step) o;
    return Objects.equals(this.actionId, step.actionId)
        && Objects.equals(this.completionGate, step.completionGate)
        && Objects.equals(this.connectionLabel, step.connectionLabel)
        && Objects.equals(this.display, step.display)
        && Objects.equals(this.errorHandlers, step.errorHandlers)
        && Objects.equals(this.name, step.name)
        && Objects.equals(this.outboundEdges, step.outboundEdges)
        && Objects.equals(this.parameters, step.parameters)
        && Objects.equals(this.readinessGate, step.readinessGate)
        && Objects.equals(this.additionalProperties, step.additionalProperties);
  }
