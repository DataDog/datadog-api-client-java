 ...
 * Delete user binding.
 *
 * See {@link #deleteMSTeamsUserBindingWithHttpInfo}.
 *
 ...
 * Delete user binding.
 *
 * See {@link #deleteMSTeamsUserBindingWithHttpInfoAsync}.
 *
 * @param tenantId Your tenant id. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteMSTeamsUserBindingAsync(String tenantId) {
    return deleteMSTeamsUserBindingWithHttpInfoAsync(tenantId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete the user binding for a given tenant from the Datadog Microsoft Teams integration.</p>
   *
   * @param tenantId Your tenant id. (required)
   ...
   *     </table>
   */
  public ApiResponse<Void> deleteMSTeamsUserBindingWithHttpInfo(String tenantId) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
      throw new ApiException(400, "Missing the required parameter 'tenantId' when calling deleteMSTeamsUserBinding");
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/ms-teams/configuration/user-binding/{tenant_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.MicrosoftTeamsIntegrationApi.deleteMSTeamsUserBinding", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
   ...
   */
  public CompletableFuture<ApiResponse<Void>> deleteMSTeamsUserBindingWithHttpInfoAsync(String tenantId) {
    Object localVarPostBody = null;

    // verify the required parameter 'tenantId' is set
    if (tenantId == null) {
        CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'tenantId' when calling deleteMSTeamsUserBinding"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/ms-teams/configuration/user-binding/{tenant_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.MicrosoftTeamsIntegrationApi.deleteMSTeamsUserBinding", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
