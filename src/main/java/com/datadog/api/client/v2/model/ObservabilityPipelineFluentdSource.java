...
/**
   * <p>The <code>fluentd</code> source ingests logs from a Fluentd-compatible service.</p>
...
public class ObservabilityPipelineFluentdSource {
  ...
  private ObservabilityPipelineFluentdSourceType type = ObservabilityPipelineFluentdSourceType.FLUENTD;
  ...
  public ObservabilityPipelineFluentdSource(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineFluentdSourceType type) {
        this.id = id;
        this.type = type;
  ...
  /**
   * <p>Name of the environment variable or secret that holds the listen address for the Fluent receiver.</p>
   * @return addressKey
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineFluentdSource observabilityPipelineFluentdSource = (ObservabilityPipelineFluentdSource) o;
    return Objects.equals(this.addressKey, observabilityPipelineFluentdSource.addressKey) && Objects.equals(this.id, observabilityPipelineFluentdSource.id) && Objects.equals(this.tls, observabilityPipelineFluentdSource.tls) && Objects.equals(this.type, observabilityPipelineFluentdSource.type) && Objects.equals(this.additionalProperties, observabilityPipelineFluentdSource.additionalProperties);
  }
