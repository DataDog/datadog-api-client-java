...
/**
   * <p>Data envelope for an aggregated waterfall response.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedWaterfallResponseData {
  ...
  @JsonCreator
  public AggregatedWaterfallResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)AggregatedWaterfallResponseAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AggregatedWaterfallRequestType type) {
  ...
  public AggregatedWaterfallResponseData attributes(AggregatedWaterfallResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The JSON:API type for aggregated waterfall requests.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedWaterfallResponseData aggregatedWaterfallResponseData = (AggregatedWaterfallResponseData) o;
    return Objects.equals(this.attributes, aggregatedWaterfallResponseData.attributes) && Objects.equals(this.id, aggregatedWaterfallResponseData.id) && Objects.equals(this.type, aggregatedWaterfallResponseData.type) && Objects.equals(this.additionalProperties, aggregatedWaterfallResponseData.additionalProperties);
  }
