...
public class AwsCurConfigResponseDataAttributesAccountFilters {
  ...
  /**
   * <p>The <code>account_filters</code> <code>excluded_accounts</code>.</p>
  ...
  **/
  ...
  public AwsCurConfigResponseDataAttributesAccountFilters includeNewAccounts(Boolean includeNewAccounts) {
    this.includeNewAccounts = JsonNullable.<Boolean>of(includeNewAccounts);
    return this;
  }

  /**
   * <p>The <code>account_filters</code> <code>include_new_accounts</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The <code>account_filters</code> <code>included_accounts</code>.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public AwsCurConfigResponseDataAttributesAccountFilters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AwsCurConfigResponseDataAttributesAccountFilters awsCurConfigResponseDataAttributesAccountFilters = (AwsCurConfigResponseDataAttributesAccountFilters) o;
    return Objects.equals(this.excludedAccounts, awsCurConfigResponseDataAttributesAccountFilters.excludedAccounts) && Objects.equals(this.includeNewAccounts, awsCurConfigResponseDataAttributesAccountFilters.includeNewAccounts) && Objects.equals(this.includedAccounts, awsCurConfigResponseDataAttributesAccountFilters.includedAccounts) && Objects.equals(this.additionalProperties, awsCurConfigResponseDataAttributesAccountFilters.additionalProperties);
  }
