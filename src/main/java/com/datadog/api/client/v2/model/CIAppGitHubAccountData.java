...
public class CIAppGitHubAccountData {
  ...
  public CIAppGitHubAccountData(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          CIAppGitHubAccountAttributes attributes,
  ...
  /**
   * The account's unique identifier, in the form <code>&lt;host&gt;/&lt;account name&gt;</code>
   * (for example <code>github.com/datadog</code>).
   *
   * @return id
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, ciAppGitHubAccountData.attributes)
        && Objects.equals(this.id, ciAppGitHubAccountData.id)
        && Objects.equals(this.type, ciAppGitHubAccountData.type)
        && Objects.equals(this.additionalProperties, ciAppGitHubAccountData.additionalProperties);
  }
