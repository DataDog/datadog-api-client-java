...
public class ServiceNowBasicAuth {
  ...
  /**
   * The <code>ServiceNowBasicAuth</code> <code>instance</code>.
   *
   * @return instance
   */
  ...
  /**
   * The <code>ServiceNowBasicAuth</code> <code>password</code>.
   *
   * @return password
   */
  ...
  /**
   * The <code>ServiceNowBasicAuth</code> <code>username</code>.
   *
   * @return username
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instance, serviceNowBasicAuth.instance)
        && Objects.equals(this.password, serviceNowBasicAuth.password)
        && Objects.equals(this.type, serviceNowBasicAuth.type)
        && Objects.equals(this.username, serviceNowBasicAuth.username)
        && Objects.equals(this.additionalProperties, serviceNowBasicAuth.additionalProperties);
  }
