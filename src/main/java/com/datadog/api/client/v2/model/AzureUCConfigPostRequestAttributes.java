...
public class AzureUCConfigPostRequestAttributes {
  ...
  public AzureUCConfigPostRequestAttributes(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_ACTUAL_BILL_CONFIG)
          BillConfig actualBillConfig,
      @JsonProperty(required = true, value = JSON_PROPERTY_AMORTIZED_BILL_CONFIG)
          BillConfig amortizedBillConfig,
  ...
  public boolean equals(Object o) {
    ...
    AzureUCConfigPostRequestAttributes azureUcConfigPostRequestAttributes =
        (AzureUCConfigPostRequestAttributes) o;
    return Objects.equals(this.accountId, azureUcConfigPostRequestAttributes.accountId)
        && Objects.equals(
            this.actualBillConfig, azureUcConfigPostRequestAttributes.actualBillConfig)
        && Objects.equals(
