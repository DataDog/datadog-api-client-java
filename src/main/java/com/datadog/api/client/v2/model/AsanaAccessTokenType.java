...
public class AsanaAccessTokenType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("AsanaAccessToken"));

  public static final AsanaAccessTokenType ASANAACCESSTOKEN =
      new AsanaAccessTokenType("AsanaAccessToken");
  ...
  public static class AsanaAccessTokenTypeSerializer extends StdSerializer<AsanaAccessTokenType> {
    ...
    public void serialize(
        AsanaAccessTokenType value, JsonGenerator jgen, SerializerProvider provider)
