...
public class CloudflareAccountCreateRequestAttributes {
  ...
  **/
  ...
  /**
   * <p>An allowlist of resources to restrict pulling metrics for including <code>'web', 'dns', 'lb' (load balancer), 'worker'</code>.</p>
   * @return resources
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, cloudflareAccountCreateRequestAttributes.apiKey) && Objects.equals(this.email, cloudflareAccountCreateRequestAttributes.email) && Objects.equals(this.name, cloudflareAccountCreateRequestAttributes.name) && Objects.equals(this.resources, cloudflareAccountCreateRequestAttributes.resources) && Objects.equals(this.zones, cloudflareAccountCreateRequestAttributes.zones) && Objects.equals(this.additionalProperties, cloudflareAccountCreateRequestAttributes.additionalProperties);
  }
