...
public class IntegrationAccountPrivateActionRunnerAuthRequest {
  ...
  public IntegrationAccountPrivateActionRunnerAuthRequest connectionId(UUID connectionId) {
    this.connectionId = connectionId;
    return this;
  }
  ...
  /**
   * Path of the credential inside the secret backend configured on the runner. Because an update
   * replaces the authentication object entirely, omitting it removes any stored path.
   *
   * @return secretPath
   */
  ...
  public IntegrationAccountPrivateActionRunnerAuthRequest userUuid(UUID userUuid) {
    this.userUuid = userUuid;
    return this;
  }
