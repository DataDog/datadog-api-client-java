...
public class DegradationIncluded extends AbstractOpenApiSchema {
    ...
    public static class DegradationIncludedSerializer extends StdSerializer<DegradationIncluded> {
        ...
        @Override
        public void serialize(DegradationIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class DegradationIncludedDeserializer extends StdDeserializer<DegradationIncluded> {
        ...
        @Override
        public DegradationIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public DegradationIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
