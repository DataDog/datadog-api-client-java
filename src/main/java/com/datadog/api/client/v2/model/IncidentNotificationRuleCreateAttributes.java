...
public class IncidentNotificationRuleCreateAttributes {
  ...
  public IncidentNotificationRuleCreateAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_CONDITIONS)
          List<IncidentNotificationRuleConditionsItems> conditions,
  ...
  public IncidentNotificationRuleCreateAttributes conditions(
      List<IncidentNotificationRuleConditionsItems> conditions) {
    this.conditions = conditions;
  ...
  public IncidentNotificationRuleCreateAttributes addConditionsItem(
      IncidentNotificationRuleConditionsItems conditionsItem) {
  ...
  public IncidentNotificationRuleCreateAttributes visibility(
      IncidentNotificationRuleCreateAttributesVisibility visibility) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentNotificationRuleCreateAttributes incidentNotificationRuleCreateAttributes =
        (IncidentNotificationRuleCreateAttributes) o;
    return Objects.equals(this.conditions, incidentNotificationRuleCreateAttributes.conditions)
        && Objects.equals(this.enabled, incidentNotificationRuleCreateAttributes.enabled)
        && Objects.equals(this.handles, incidentNotificationRuleCreateAttributes.handles)
        && Objects.equals(this.renotifyOn, incidentNotificationRuleCreateAttributes.renotifyOn)
        && Objects.equals(this.trigger, incidentNotificationRuleCreateAttributes.trigger)
        && Objects.equals(this.visibility, incidentNotificationRuleCreateAttributes.visibility)
        && Objects.equals(
            this.additionalProperties,
            incidentNotificationRuleCreateAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        conditions, enabled, handles, renotifyOn, trigger, visibility, additionalProperties);
  }
