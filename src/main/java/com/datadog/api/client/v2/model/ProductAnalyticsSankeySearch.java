...
public class ProductAnalyticsSankeySearch {
  ...
  public ProductAnalyticsSankeySearch audienceFilters(ProductAnalyticsAudienceFilters audienceFilters) {
  ...
  **/
  ...
  /**
   * <p>Datadog search query restricting the events considered.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
