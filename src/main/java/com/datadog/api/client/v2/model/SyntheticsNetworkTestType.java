...
public class SyntheticsNetworkTestType extends ModelEnum<String> {
  ...
  public static class SyntheticsNetworkTestTypeSerializer extends StdSerializer<SyntheticsNetworkTestType> {
      ...
      @Override
      public void serialize(SyntheticsNetworkTestType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
