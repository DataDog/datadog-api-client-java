...
public class OwnershipHistoryData {
  ...
  @JsonCreator
  public OwnershipHistoryData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)OwnershipHistoryAttributes attributes,
  ...
  /**
   * <p>The attributes of an ownership history response.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The resource identifier for which history is returned.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, ownershipHistoryData.attributes) && Objects.equals(this.id, ownershipHistoryData.id) && Objects.equals(this.type, ownershipHistoryData.type) && Objects.equals(this.additionalProperties, ownershipHistoryData.additionalProperties);
  }
