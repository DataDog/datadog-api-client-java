...
@JsonDeserialize(using = IncidentAttachmentAttributes.IncidentAttachmentAttributesDeserializer.class)
...
public class IncidentAttachmentAttributes extends AbstractOpenApiSchema {
    ...
    public static class IncidentAttachmentAttributesSerializer extends StdSerializer<IncidentAttachmentAttributes> {
        ...
        @Override
        public void serialize(IncidentAttachmentAttributes value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class IncidentAttachmentAttributesDeserializer extends StdDeserializer<IncidentAttachmentAttributes> {
        ...
        @Override
        public IncidentAttachmentAttributes deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public IncidentAttachmentAttributes getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "IncidentAttachmentAttributes cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(IncidentAttachmentAttributes.class, Collections.unmodifiableMap(schemas));
    }
