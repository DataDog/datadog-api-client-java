...
public class SensitiveDataScannerGroupCreate {
  ...
  @JsonCreator
  public SensitiveDataScannerGroupCreate(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SensitiveDataScannerGroupAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SensitiveDataScannerGroupType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataScannerGroupCreate sensitiveDataScannerGroupCreate = (SensitiveDataScannerGroupCreate) o;
    return Objects.equals(this.attributes, sensitiveDataScannerGroupCreate.attributes) && Objects.equals(this.relationships, sensitiveDataScannerGroupCreate.relationships) && Objects.equals(this.type, sensitiveDataScannerGroupCreate.type);
  }
