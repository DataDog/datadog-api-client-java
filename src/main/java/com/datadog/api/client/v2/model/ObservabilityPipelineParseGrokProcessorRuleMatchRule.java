...
/**
 * Defines a grok match rule, which extracts structured fields from log content using named grok
...
public class ObservabilityPipelineParseGrokProcessorRuleMatchRule {
  ...
  /**
   * Return true if this ObservabilityPipelineParseGrokProcessorRuleMatchRule object is equal to o.
   */
  @Override
  ...
  public String toString() {
    ...
    sb.append("class ObservabilityPipelineParseGrokProcessorRuleMatchRule {\n");
