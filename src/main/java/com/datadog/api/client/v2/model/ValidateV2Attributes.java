...
public class ValidateV2Attributes {
  ...
  public ValidateV2Attributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_API_KEY_SCOPES)List<String> apiKeyScopes,
  ...
  **/
  ...
  /**
   * <p>List of scope names associated with the API key.</p>
   * @return apiKeyScopes
  **/
  ...
  /**
   * <p>Whether the API key is valid.</p>
   * @return valid
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKeyId, validateV2Attributes.apiKeyId) && Objects.equals(this.apiKeyScopes, validateV2Attributes.apiKeyScopes) && Objects.equals(this.valid, validateV2Attributes.valid) && Objects.equals(this.additionalProperties, validateV2Attributes.additionalProperties);
  }
