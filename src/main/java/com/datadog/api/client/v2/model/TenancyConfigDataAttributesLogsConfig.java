...
public class TenancyConfigDataAttributesLogsConfig {
  ...
  public TenancyConfigDataAttributesLogsConfig compartmentTagFilters(List<String> compartmentTagFilters) {
    this.compartmentTagFilters = compartmentTagFilters;
    return this;
  }
  public TenancyConfigDataAttributesLogsConfig addCompartmentTagFiltersItem(String compartmentTagFiltersItem) {
  ...
  /**
   * <p>List of compartment tag filters scoping log collection to specific compartments.</p>
  ...
  **/
  ...
  /**
   * <p>Whether log collection is enabled for the tenancy.</p>
   * @return enabled
  **/
      @jakarta.annotation.Nullable
  ...
  public TenancyConfigDataAttributesLogsConfig enabledServices(List<String> enabledServices) {
  ...
  /**
   * <p>List of OCI service names for which log collection is enabled.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TenancyConfigDataAttributesLogsConfig tenancyConfigDataAttributesLogsConfig = (TenancyConfigDataAttributesLogsConfig) o;
    return Objects.equals(this.compartmentTagFilters, tenancyConfigDataAttributesLogsConfig.compartmentTagFilters) && Objects.equals(this.enabled, tenancyConfigDataAttributesLogsConfig.enabled) && Objects.equals(this.enabledServices, tenancyConfigDataAttributesLogsConfig.enabledServices) && Objects.equals(this.additionalProperties, tenancyConfigDataAttributesLogsConfig.additionalProperties);
  }
