...
public class LLMObsSpanFilter {
  ...
  **/
  ...
  /**
   * <p>Search query using Agent Observability query syntax. Supports attribute filters using the field:value syntax (e.g. session_id, trace_id, ml_app, meta.span.kind). When provided, structured field filters (<code>span_id</code>, <code>trace_id</code>, etc.) are ignored.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
