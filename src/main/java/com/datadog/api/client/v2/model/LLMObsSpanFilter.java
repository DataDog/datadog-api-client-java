...
/**
   * <p>Filter criteria for an LLM Observability span search.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsSpanFilter {
  ...
  /**
   * <p>Start of the time range. Accepts ISO 8601 or relative format (e.g., <code>now-15m</code>). Defaults to <code>now-15m</code>.</p>
   * @return from
  **/
  ...
  /**
   * <p>Filter by ML application name.</p>
   * @return mlApp
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Search query using LLM Observability query syntax. Supports attribute filters using the field:value syntax (e.g. session_id, trace_id, ml_app, meta.span.kind). When provided, structured field filters (<code>span_id</code>, <code>trace_id</code>, etc.) are ignored.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Filter by span kind (e.g., llm, agent, tool, task, workflow).</p>
   * @return spanKind
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Filter by tag key-value pairs.</p>
   * @return tags
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>End of the time range. Accepts ISO 8601 or relative format (e.g., <code>now</code>). Defaults to <code>now</code>.</p>
   * @return to
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.from, llmObsSpanFilter.from) && Objects.equals(this.mlApp, llmObsSpanFilter.mlApp) && Objects.equals(this.query, llmObsSpanFilter.query) && Objects.equals(this.spanId, llmObsSpanFilter.spanId) && Objects.equals(this.spanKind, llmObsSpanFilter.spanKind) && Objects.equals(this.spanName, llmObsSpanFilter.spanName) && Objects.equals(this.tags, llmObsSpanFilter.tags) && Objects.equals(this.to, llmObsSpanFilter.to) && Objects.equals(this.traceId, llmObsSpanFilter.traceId) && Objects.equals(this.additionalProperties, llmObsSpanFilter.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(from,mlApp,query,spanId,spanKind,spanName,tags,to,traceId, additionalProperties);
  }
