...
/**
   * <p>The attributes of a pruned trace returned by the Get pruned trace by ID endpoint.</p>
 */
@JsonPropertyOrder({
...
public class PrunedTraceAttributes {
  ...
  public PrunedTraceAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SUMMARIZED_TRACE)SummarizedTrace summarizedTrace) {
  ...
  /**
   * <p>Indicates whether the underlying trace was truncated because its size
   * exceeded the maximum that can be retrieved from storage.</p>
   * @return isTruncated
  **/
  ...
  /**
   * <p>The size, in bytes, of the original (non-pruned) trace before summarization.</p>
   * maximum: 2147483647
   * @return sizeBytes
  **/
  ...
  /**
   * <p>A summarized, hierarchical view of a trace.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.isTruncated, prunedTraceAttributes.isTruncated) && Objects.equals(this.sizeBytes, prunedTraceAttributes.sizeBytes) && Objects.equals(this.summarizedTrace, prunedTraceAttributes.summarizedTrace) && Objects.equals(this.additionalProperties, prunedTraceAttributes.additionalProperties);
  }
