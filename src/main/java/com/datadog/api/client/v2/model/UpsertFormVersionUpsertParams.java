...
public class UpsertFormVersionUpsertParams {
  ...
  @JsonCreator
  public UpsertFormVersionUpsertParams(
            @JsonProperty(required=true, value=JSON_PROPERTY_MATCH_POLICY)LatestVersionMatchPolicy matchPolicy) {
  ...
  /**
   * <p>The ETag of the latest version. Required when <code>match_policy</code> is <code>if_etag_match</code>.</p>
   * @return etag
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ETAG)public void setEtag_JsonNullable(JsonNullable<String> etag) {
    this.etag = etag;
  }
  ...
  /**
   * <p>If true, only a new version may be inserted; updating the current draft is not allowed.</p>
   * @return insertOnly
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The policy for matching the latest form version during an upsert operation.</p>
   * @return matchPolicy
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.etag, upsertFormVersionUpsertParams.etag) && Objects.equals(this.insertOnly, upsertFormVersionUpsertParams.insertOnly) && Objects.equals(this.matchPolicy, upsertFormVersionUpsertParams.matchPolicy) && Objects.equals(this.additionalProperties, upsertFormVersionUpsertParams.additionalProperties);
  }
