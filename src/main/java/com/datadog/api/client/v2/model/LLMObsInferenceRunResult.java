...
public class LLMObsInferenceRunResult {
  ...
  public LLMObsInferenceRunResult(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_INFERENCE_CODES)List<LLMObsInferenceCode> inferenceCodes,
  ...
  /**
   * <p>An optional assessment of the inference output quality.</p>
   * @return assessment
  **/
  ...
  /**
   * <p>The text content of the model response.</p>
   * @return content
  **/
  ...
  **/
  ...
  /**
   * <p>List of generated code snippets for the inference configuration.</p>
  ...
  **/
  ...
  /**
   * <p>Number of input tokens consumed.</p>
   * @return inputTokens
  **/
  ...
  /**
   * <p>The model's internal reasoning or thinking output, if available.</p>
  ...
  **/
  ...
  /**
   * <p>Request latency in milliseconds.</p>
   * @return latency
  **/
  ...
  /**
   * <p>Number of output tokens generated.</p>
   * @return outputTokens
  **/
  ...
  **/
  ...
  /**
   * <p>Total tokens used (input plus output).</p>
   * @return totalTokens
  **/
