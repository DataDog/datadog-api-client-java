...
/**
   * <p>A single message in a span input or output.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsSpanMessage {
  ...
  **/
  ...
  /**
   * <p>Role of the message sender (e.g., user, assistant, system).</p>
   * @return role
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Tool calls made in this message.</p>
   * @return toolCalls
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Tool results returned in this message.</p>
   * @return toolResults
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, llmObsSpanMessage.content) && Objects.equals(this.id, llmObsSpanMessage.id) && Objects.equals(this.role, llmObsSpanMessage.role) && Objects.equals(this.toolCalls, llmObsSpanMessage.toolCalls) && Objects.equals(this.toolResults, llmObsSpanMessage.toolResults) && Objects.equals(this.additionalProperties, llmObsSpanMessage.additionalProperties);
  }
