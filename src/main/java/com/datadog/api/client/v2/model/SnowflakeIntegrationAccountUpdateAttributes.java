 ...
 * entirely, so it must carry every field that creating an account requires.
 */
@JsonPropertyOrder({
...
public class SnowflakeIntegrationAccountUpdateAttributes {
  ...
  private SnowflakeIntegrationAccountAuthenticationUpdate authentication;
  ...
  public SnowflakeIntegrationAccountUpdateAttributes authentication(
      SnowflakeIntegrationAccountAuthenticationUpdate authentication) {
  ...
  /**
   * Authentication for updating the Snowflake integration account. Exactly one method is set. An
   * update replaces the authentication object entirely, so it requires the same fields as creating
   * an account.
   *
  ...
  public SnowflakeIntegrationAccountAuthenticationUpdate getAuthentication() {
    return authentication;
  }

  public void setAuthentication(SnowflakeIntegrationAccountAuthenticationUpdate authentication) {
    this.authentication = authentication;
