...
public class CustomConnectionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("custom_connections"));

  public static final CustomConnectionType CUSTOM_CONNECTIONS = new CustomConnectionType("custom_connections");
  ...
  public static class CustomConnectionTypeSerializer extends StdSerializer<CustomConnectionType> {
      ...
      @Override
      public void serialize(CustomConnectionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
