...
public class AWSRegions extends AbstractOpenApiSchema {
    ...
    public static class AWSRegionsSerializer extends StdSerializer<AWSRegions> {
        ...
        @Override
        public void serialize(AWSRegions value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AWSRegionsDeserializer extends StdDeserializer<AWSRegions> {
        ...
        @Override
        public AWSRegions deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AWSRegionsIncludeAll.class.equals(Integer.class) || AWSRegionsIncludeAll.class.equals(Long.class) || AWSRegionsIncludeAll.class.equals(Float.class) || AWSRegionsIncludeAll.class.equals(Double.class) || AWSRegionsIncludeAll.class.equals(Boolean.class) || AWSRegionsIncludeAll.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSRegionsIncludeAll.class.equals(Integer.class) || AWSRegionsIncludeAll.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSRegionsIncludeAll.class.equals(Float.class) || AWSRegionsIncludeAll.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSRegionsIncludeAll.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSRegionsIncludeAll.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AWSRegionsIncludeOnly.class.equals(Integer.class) || AWSRegionsIncludeOnly.class.equals(Long.class) || AWSRegionsIncludeOnly.class.equals(Float.class) || AWSRegionsIncludeOnly.class.equals(Double.class) || AWSRegionsIncludeOnly.class.equals(Boolean.class) || AWSRegionsIncludeOnly.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSRegionsIncludeOnly.class.equals(Integer.class) || AWSRegionsIncludeOnly.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSRegionsIncludeOnly.class.equals(Float.class) || AWSRegionsIncludeOnly.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSRegionsIncludeOnly.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSRegionsIncludeOnly.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * AWSRegionsIncludeAll, AWSRegionsIncludeOnly
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be AWSRegionsIncludeAll, AWSRegionsIncludeOnly");
    }
    ...
    /**
     * Get the actual instance of `AWSRegionsIncludeAll`. If the actual instance is not `AWSRegionsIncludeAll`,
    ...
    /**
     * Get the actual instance of `AWSRegionsIncludeOnly`. If the actual instance is not `AWSRegionsIncludeOnly`,
     * the ClassCastException will be thrown.
     *
