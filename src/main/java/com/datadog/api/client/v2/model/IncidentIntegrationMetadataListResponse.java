...
/**
   * <p>Response with a list of incident integration metadata.</p>
 */
@JsonPropertyOrder({
...
public class IncidentIntegrationMetadataListResponse {
  ...
  @JsonCreator
  public IncidentIntegrationMetadataListResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<IncidentIntegrationMetadataResponseData> data) {
        this.data = data;
  }
  public IncidentIntegrationMetadataListResponse data(List<IncidentIntegrationMetadataResponseData> data) {
    this.data = data;
  ...
  public IncidentIntegrationMetadataListResponse addDataItem(IncidentIntegrationMetadataResponseData dataItem) {
  ...
  /**
   * <p>An array of incident integration metadata.</p>
   * @return data
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentIntegrationMetadataListResponse incidentIntegrationMetadataListResponse = (IncidentIntegrationMetadataListResponse) o;
    return Objects.equals(this.data, incidentIntegrationMetadataListResponse.data) && Objects.equals(this.included, incidentIntegrationMetadataListResponse.included) && Objects.equals(this.meta, incidentIntegrationMetadataListResponse.meta) && Objects.equals(this.additionalProperties, incidentIntegrationMetadataListResponse.additionalProperties);
  }
