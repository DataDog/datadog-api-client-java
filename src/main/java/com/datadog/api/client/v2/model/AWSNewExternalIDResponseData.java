...
public class AWSNewExternalIDResponseData {
  ...
  public AWSNewExternalIDResponseData(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AWSNewExternalIDResponseDataType type) {
        this.id = id;
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>The <code>AWSNewExternalIDResponseData</code> <code>id</code>.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, awsNewExternalIdResponseData.attributes) && Objects.equals(this.id, awsNewExternalIdResponseData.id) && Objects.equals(this.type, awsNewExternalIdResponseData.type) && Objects.equals(this.additionalProperties, awsNewExternalIdResponseData.additionalProperties);
  }
