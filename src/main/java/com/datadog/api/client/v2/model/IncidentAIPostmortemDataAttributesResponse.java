...
@JsonPropertyOrder({
  ...
  IncidentAIPostmortemDataAttributesResponse.JSON_PROPERTY_KEY_INSIGHTS,
...
public class IncidentAIPostmortemDataAttributesResponse {
  ...
  public static final String JSON_PROPERTY_KEY_INSIGHTS = "key_insights";
  ...
  public IncidentAIPostmortemDataAttributesResponse keyInsights(String keyInsights) {
   ...
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_KEY_INSIGHTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionItems, incidentAiPostmortemDataAttributesResponse.actionItems)
        ...
        && Objects.equals(this.keyInsights, incidentAiPostmortemDataAttributesResponse.keyInsights)
