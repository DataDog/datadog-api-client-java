...
public class RumSdkConfigSerializedRegex {
  ...
  @JsonCreator
  public RumSdkConfigSerializedRegex(
            @JsonProperty(required=true, value=JSON_PROPERTY_RC_SERIALIZED_TYPE)RumSdkConfigSerializedRegexType rcSerializedType,
  ...
  public RumSdkConfigSerializedRegex rcSerializedType(RumSdkConfigSerializedRegexType rcSerializedType) {
    this.rcSerializedType = rcSerializedType;
    this.unparsed |= !rcSerializedType.isValid();
    return this;
  }
  ...
  /**
   * <p>The type identifier for a serialized regex. Always <code>regex</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The regex pattern used for extraction.</p>
   * @return value
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rcSerializedType, rumSdkConfigSerializedRegex.rcSerializedType) && Objects.equals(this.value, rumSdkConfigSerializedRegex.value) && Objects.equals(this.additionalProperties, rumSdkConfigSerializedRegex.additionalProperties);
  }
