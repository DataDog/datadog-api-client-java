...
/**
   * <p>Response containing the label schema of an annotation queue.</p>
 */
@JsonPropertyOrder({
  LLMObsAnnotationQueueLabelSchemaResponse.JSON_PROPERTY_DATA
})
...
public class LLMObsAnnotationQueueLabelSchemaResponse {
  ...
  @JsonCreator
  public LLMObsAnnotationQueueLabelSchemaResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)LLMObsAnnotationQueueLabelSchemaData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsAnnotationQueueLabelSchemaResponse llmObsAnnotationQueueLabelSchemaResponse = (LLMObsAnnotationQueueLabelSchemaResponse) o;
    return Objects.equals(this.data, llmObsAnnotationQueueLabelSchemaResponse.data) && Objects.equals(this.additionalProperties, llmObsAnnotationQueueLabelSchemaResponse.additionalProperties);
  }
