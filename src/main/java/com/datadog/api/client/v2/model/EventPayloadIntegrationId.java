...
public class EventPayloadIntegrationId extends ModelEnum<String> {
  ...
  public static final EventPayloadIntegrationId CUSTOM_EVENTS = new EventPayloadIntegrationId("custom-events");
  ...
  public static class EventPayloadIntegrationIdSerializer extends StdSerializer<EventPayloadIntegrationId> {
      ...
      @Override
      public void serialize(EventPayloadIntegrationId value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
