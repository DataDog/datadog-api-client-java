...
/**
   * <p>Data object for an Agent Observability experiment run.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsExperimentRunDataResponse {
  ...
  /**
   * <p>Aggregated metric data for this run.</p>
  ...
  **/
  ...
  /**
   * <p>Identifier of the experiment this run belongs to.</p>
   * @return experimentId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier of the experiment run.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Sequential number of this run within the experiment.</p>
   * maximum: 2147483647
   * @return runNumber
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    LLMObsExperimentRunDataResponse llmObsExperimentRunDataResponse = (LLMObsExperimentRunDataResponse) o;
    return Objects.equals(this.aggregateData, llmObsExperimentRunDataResponse.aggregateData) && Objects.equals(this.createdAt, llmObsExperimentRunDataResponse.createdAt) && Objects.equals(this.experimentId, llmObsExperimentRunDataResponse.experimentId) && Objects.equals(this.id, llmObsExperimentRunDataResponse.id) && Objects.equals(this.runNumber, llmObsExperimentRunDataResponse.runNumber) && Objects.equals(this.additionalProperties, llmObsExperimentRunDataResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(aggregateData,createdAt,experimentId,id,runNumber, additionalProperties);
  }
