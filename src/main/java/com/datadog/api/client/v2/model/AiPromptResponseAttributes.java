...
public class AiPromptResponseAttributes {
  ...
  public AiPromptResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_FILE_SEARCH_KEYWORDS)List<String> fileSearchKeywords,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RESULT_KEYWORDS_EXCLUDE)List<String> resultKeywordsExclude,
  ...
  **/
  ...
  /**
   * <p>Checksum of the prompt content.</p>
   * @return checksum
  **/
  ...
  /**
   * <p>Base64-encoded AI prompt content.</p>
   * @return content
  **/
  ...
  /**
   * <p>The CWE identifier associated with this prompt.</p>
   * @return cwe
  **/
  ...
  **/
  ...
  /**
   * <p>Directory patterns this prompt applies to.</p>
   * @return directories
  **/
  ...
  **/
  ...
  /**
   * <p>Keywords used to search for relevant files.</p>
  ...
  **/
  ...
  /**
   * <p>File glob patterns this prompt applies to.</p>
   * @return globs
  **/
  ...
  /**
   * <p>Whether this is a default Datadog prompt.</p>
   * @return isDefault
  **/
  ...
  /**
   * <p>Whether this prompt is for testing only.</p>
   * @return isTesting
  **/
  ...
  **/
  ...
  /**
   * <p>Keywords to exclude from results.</p>
  ...
  **/
  ...
  /**
   * <p>The version of the rule this prompt is associated with.</p>
   * @return ruleVersion
  **/
