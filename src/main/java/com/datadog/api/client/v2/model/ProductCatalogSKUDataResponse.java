...
/**
   * <p>A SKU and the pricing metadata that applies to it.</p>
 */
@JsonPropertyOrder({
...
public class ProductCatalogSKUDataResponse {
  ...
  @JsonCreator
  public ProductCatalogSKUDataResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ProductCatalogSKUDataAttributesResponse attributes,
  ...
  public ProductCatalogSKUDataResponse attributes(ProductCatalogSKUDataAttributesResponse attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The code that identifies the SKU.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, productCatalogSkuDataResponse.attributes) && Objects.equals(this.id, productCatalogSkuDataResponse.id) && Objects.equals(this.type, productCatalogSkuDataResponse.type) && Objects.equals(this.additionalProperties, productCatalogSkuDataResponse.additionalProperties);
  }
