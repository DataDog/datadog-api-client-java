...
public class LLMObsPatternsConfigSnapshot {
  ...
  /**
   * <p>Integration account ID used for a bring-your-own-model run.</p>
   * @return accountId
  **/
  ...
  /**
   * <p>Query that selected the spans for the run.</p>
   * @return evpQuery
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Depth of the topic hierarchy generated.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  /**
   * <p>Integration provider used for a bring-your-own-model run.</p>
  ...
  **/
  ...
  /**
   * <p>Model name used for a bring-your-own-model run.</p>
   * @return modelName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Maximum number of records processed for the run.</p>
   * maximum: 2147483647
   * @return numRecords
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Fraction of matching spans sampled for the run.</p>
