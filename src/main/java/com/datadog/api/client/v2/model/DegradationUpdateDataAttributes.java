...
/**
   * <p>Attributes of a degradation update resource.</p>
 */
@JsonPropertyOrder({
...
public class DegradationUpdateDataAttributes {
  ...
  public DegradationUpdateDataAttributes componentsAffected(List<DegradationUpdateDataAttributesComponentsAffectedItems> componentsAffected) {
  ...
  public DegradationUpdateDataAttributes addComponentsAffectedItem(DegradationUpdateDataAttributesComponentsAffectedItems componentsAffectedItem) {
  ...
  /**
   * <p>Components affected by this update.</p>
  ...
  **/
  ...
  public void setComponentsAffected(List<DegradationUpdateDataAttributesComponentsAffectedItems> componentsAffected) {
    this.componentsAffected = componentsAffected;
    if (componentsAffected != null) {
      for (DegradationUpdateDataAttributesComponentsAffectedItems item : componentsAffected) {
        this.unparsed |= item.unparsed;
  ...
  **/
  ...
  /**
   * <p>The date and time the update was soft-deleted.</p>
   * @return deletedAt
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public DegradationUpdateDataAttributes status(CreateDegradationRequestDataAttributesStatus status) {
    this.status = status;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DegradationUpdateDataAttributes degradationUpdateDataAttributes = (DegradationUpdateDataAttributes) o;
    return Objects.equals(this.componentsAffected, degradationUpdateDataAttributes.componentsAffected) && Objects.equals(this.createdAt, degradationUpdateDataAttributes.createdAt) && Objects.equals(this.deletedAt, degradationUpdateDataAttributes.deletedAt) && Objects.equals(this.description, degradationUpdateDataAttributes.description) && Objects.equals(this.modifiedAt, degradationUpdateDataAttributes.modifiedAt) && Objects.equals(this.startedAt, degradationUpdateDataAttributes.startedAt) && Objects.equals(this.status, degradationUpdateDataAttributes.status) && Objects.equals(this.additionalProperties, degradationUpdateDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(componentsAffected,createdAt,deletedAt,description,modifiedAt,startedAt,status, additionalProperties);
  }
