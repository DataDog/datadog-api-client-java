...
/**
   * <p>The response from the get data deletion requests endpoint.</p>
 */
@JsonPropertyOrder({
...
public class GetDataDeletionsResponseBody {
  ...
  private List<DataDeletionResponseItem> data = null;
  ...
  /**
   * <p>The list of data deletion requests that matches the query.</p>
   * @return data
  **/
      ...
      public List<DataDeletionResponseItem> getData() {
        return data;
      }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getDataDeletionsResponseBody.data) && Objects.equals(this.meta, getDataDeletionsResponseBody.meta) && Objects.equals(this.additionalProperties, getDataDeletionsResponseBody.additionalProperties);
  }
