...
/**
   * <p>Attributes required to create a custom attribute configuration.</p>
 */
@JsonPropertyOrder({
  ...
  CustomAttributeConfigAttributesCreate.JSON_PROPERTY_IS_MULTI,
  CustomAttributeConfigAttributesCreate.JSON_PROPERTY_KEY,
  CustomAttributeConfigAttributesCreate.JSON_PROPERTY_TYPE
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CustomAttributeConfigAttributesCreate {
  @JsonIgnore
  ...
  **/
   ...
   * @return CustomAttributeConfigAttributesCreate
   */
  @JsonAnySetter
