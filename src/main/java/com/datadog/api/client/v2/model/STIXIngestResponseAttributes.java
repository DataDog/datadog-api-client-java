...
@JsonPropertyOrder({
  STIXIngestResponseAttributes.JSON_PROPERTY_ADDED,
...
public class STIXIngestResponseAttributes {
  ...
  @JsonCreator
  public STIXIngestResponseAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_ADDED) Long added,
  ...
  public STIXIngestResponseAttributes added(Long added) {
    this.added = added;
    return this;
  }

  /**
   * The number of supported indicators added. minimum: 0
   *
   * @return added
   */
  ...
  /**
   * The number of unsupported objects or patterns. minimum: 0
   *
   * @return unsupported
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.added, stixIngestResponseAttributes.added)
  ...
  @Override
  public int hashCode() {
    return Objects.hash(added, invalid, unsupported, additionalProperties);
  }
