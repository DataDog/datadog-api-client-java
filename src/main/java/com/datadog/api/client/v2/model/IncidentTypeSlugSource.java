...
public class IncidentTypeSlugSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("default", "servicenow"));
  ...
  public static class IncidentTypeSlugSourceSerializer extends StdSerializer<IncidentTypeSlugSource> {
      ...
      @Override
      public void serialize(IncidentTypeSlugSource value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
