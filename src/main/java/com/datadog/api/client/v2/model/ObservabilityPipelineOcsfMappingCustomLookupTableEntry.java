...
/**
   * <p>A single entry in a lookup table for value transformation.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineOcsfMappingCustomLookupTableEntry {
  ...
  /**
   * <p>The substring to match in the source value.</p>
   * @return contains
  **/
  ...
  /**
   * <p>The exact value to match in the source.</p>
   * @return _equals
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The source field to match against.</p>
   * @return equalsSource
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A regex pattern to match in the source value.</p>
   * @return matches
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>A regex pattern that must not match the source value.</p>
   * @return notMatches
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The value to use when a match is found.</p>
   * @return value
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * Return true if this ObservabilityPipelineOcsfMappingCustomLookupTableEntry object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineOcsfMappingCustomLookupTableEntry observabilityPipelineOcsfMappingCustomLookupTableEntry = (ObservabilityPipelineOcsfMappingCustomLookupTableEntry) o;
    return Objects.equals(this.contains, observabilityPipelineOcsfMappingCustomLookupTableEntry.contains) && Objects.equals(this._equals, observabilityPipelineOcsfMappingCustomLookupTableEntry._equals) && Objects.equals(this.equalsSource, observabilityPipelineOcsfMappingCustomLookupTableEntry.equalsSource) && Objects.equals(this.matches, observabilityPipelineOcsfMappingCustomLookupTableEntry.matches) && Objects.equals(this.notMatches, observabilityPipelineOcsfMappingCustomLookupTableEntry.notMatches) && Objects.equals(this.value, observabilityPipelineOcsfMappingCustomLookupTableEntry.value) && Objects.equals(this.additionalProperties, observabilityPipelineOcsfMappingCustomLookupTableEntry.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(contains,_equals,equalsSource,matches,notMatches,value, additionalProperties);
  }
