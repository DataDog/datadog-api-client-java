...
public class ProjectNotificationSettings {
  ...
  public static final String JSON_PROPERTY_NOTIFY_ON_CASE_COMMENT_MENTION = "notify_on_case_comment_mention";
  private Boolean notifyOnCaseCommentMention;

  public static final String JSON_PROPERTY_NOTIFY_ON_CASE_PRIORITY_CHANGE = "notify_on_case_priority_change";
  private Boolean notifyOnCasePriorityChange;

  public static final String JSON_PROPERTY_NOTIFY_ON_CASE_STATUS_CHANGE = "notify_on_case_status_change";
  private Boolean notifyOnCaseStatusChange;

  public static final String JSON_PROPERTY_NOTIFY_ON_CASE_UNASSIGNMENT = "notify_on_case_unassignment";
  ...
  /**
   * <p>Notification destinations (1=email, 2=slack, 3=in-app).</p>
   * @return destinations
  **/
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a case is assigned.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a case is closed.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a comment is added to a case.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a user is mentioned in a case comment.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a case's priority changes.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a case's status changes.</p>
  ...
  **/
  ...
  /**
   * <p>Whether to send a notification when a case is unassigned.</p>
