...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorCustomPattern</code>
 * object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorCustomPattern {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorCustomPatternOptions
   * </code> object.
   *
   * @return options
   */
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorCustomPatternType
   * </code> object.
   *
   * @return type
   */
