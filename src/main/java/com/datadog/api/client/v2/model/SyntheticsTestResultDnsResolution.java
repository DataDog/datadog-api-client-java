...
public class SyntheticsTestResultDnsResolution {
  ...
  /**
   * <p>DNS resolution attempts made during the test.</p>
   * @return attempts
  **/
  ...
  /**
   * <p>Resolved IP address for the target host.</p>
   * @return resolvedIp
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Resolved port for the target service.</p>
   * @return resolvedPort
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>DNS server used for the resolution.</p>
   * @return server
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsTestResultDnsResolution syntheticsTestResultDnsResolution = (SyntheticsTestResultDnsResolution) o;
    return Objects.equals(this.attempts, syntheticsTestResultDnsResolution.attempts) && Objects.equals(this.resolvedIp, syntheticsTestResultDnsResolution.resolvedIp) && Objects.equals(this.resolvedPort, syntheticsTestResultDnsResolution.resolvedPort) && Objects.equals(this.server, syntheticsTestResultDnsResolution.server) && Objects.equals(this.additionalProperties, syntheticsTestResultDnsResolution.additionalProperties);
  }
