...
public class IntegrationOnCallEscalationQueriesItemsTarget {
  ...
  /**
   * <p>Whether to use dynamic team paging for escalation.</p>
  ...
  **/
  ...
  /**
   * <p>The identifier of the team to escalate to.</p>
   * @return teamId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The identifier of the user to escalate to.</p>
   * @return userId
  **/
      @jakarta.annotation.Nullable
