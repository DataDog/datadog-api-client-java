...
public class ObservabilityPipelineHttpServerSource {
  ...
  **/
  ...
  public ObservabilityPipelineHttpServerSource validTokens(List<ObservabilityPipelineHttpServerSourceValidToken> validTokens) {
  ...
  public ObservabilityPipelineHttpServerSource addValidTokensItem(ObservabilityPipelineHttpServerSourceValidToken validTokensItem) {
  ...
  /**
   * <p>A list of tokens that are accepted for authenticating incoming HTTP requests. When set,
   * the source rejects any request whose token does not match an enabled entry in this list.
   * Cannot be combined with the <code>plain</code> auth strategy.</p>
   * @return validTokens
  **/
      @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressKey,authStrategy,customKey,decoding,id,passwordKey,tls,type,usernameKey,validTokens, additionalProperties);
  }
