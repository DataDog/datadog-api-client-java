...
@JsonPropertyOrder({
  ...
  ObservabilityPipelineHttpServerSource.JSON_PROPERTY_INCLUDE,
  ObservabilityPipelineHttpServerSource.JSON_PROPERTY_INPUTS,
...
public class ObservabilityPipelineHttpServerSource {
  ...
  public ObservabilityPipelineHttpServerSource include(String include) {
    this.include = include;
    return this;
  }
  ...
  public ObservabilityPipelineHttpServerSource inputs(List<String> inputs) {
    this.inputs = inputs;
    return this;
  }

  public ObservabilityPipelineHttpServerSource addInputsItem(String inputsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authStrategy, observabilityPipelineHttpServerSource.authStrategy)
        ...
        && Objects.equals(this.include, observabilityPipelineHttpServerSource.include)
        && Objects.equals(this.inputs, observabilityPipelineHttpServerSource.inputs)
  ...
  public int hashCode() {
    return Objects.hash(
        authStrategy, decoding, id, include, inputs, tls, type, additionalProperties);
  }
