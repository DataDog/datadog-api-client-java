...
public class CloudInventorySyncConfigGCPRequestAttributes {
  ...
  @JsonCreator
  public CloudInventorySyncConfigGCPRequestAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_DESTINATION_BUCKET_NAME)String destinationBucketName,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SOURCE_BUCKET_NAME)String sourceBucketName) {
  ...
  /**
   * <p>GCS bucket name where Datadog reads inventory reports.</p>
  ...
  **/
  ...
  /**
   * <p>GCP project ID for the inventory destination bucket.</p>
   * @return projectId
  **/
  ...
  /**
   * <p>Service account email used to read the destination bucket.</p>
  ...
  **/
  ...
  /**
   * <p>GCS bucket name that inventory reports are generated for.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloudInventorySyncConfigGCPRequestAttributes cloudInventorySyncConfigGcpRequestAttributes = (CloudInventorySyncConfigGCPRequestAttributes) o;
    return Objects.equals(this.destinationBucketName, cloudInventorySyncConfigGcpRequestAttributes.destinationBucketName) && Objects.equals(this.projectId, cloudInventorySyncConfigGcpRequestAttributes.projectId) && Objects.equals(this.serviceAccountEmail, cloudInventorySyncConfigGcpRequestAttributes.serviceAccountEmail) && Objects.equals(this.sourceBucketName, cloudInventorySyncConfigGcpRequestAttributes.sourceBucketName) && Objects.equals(this.additionalProperties, cloudInventorySyncConfigGcpRequestAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(destinationBucketName,projectId,serviceAccountEmail,sourceBucketName, additionalProperties);
  }
