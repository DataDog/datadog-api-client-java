...
public class SecurityMonitoringSchedulingOptions {
  ...
  /**
   * <p>Schedule for the rule queries, written in RRULE syntax. See <a href="https://icalendar.org/iCalendar-RFC-5545/3-8-5-3-recurrence-rule.html">RFC</a> for syntax reference.</p>
   * @return rrule
  **/
  ...
  /**
   * <p>Start date for the schedule, in ISO 8601 format without timezone.</p>
   * @return start
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Time zone of the start date, in the <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones">tz database</a> format.</p>
   * @return timezone
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringSchedulingOptions securityMonitoringSchedulingOptions = (SecurityMonitoringSchedulingOptions) o;
    return Objects.equals(this.rrule, securityMonitoringSchedulingOptions.rrule) && Objects.equals(this.start, securityMonitoringSchedulingOptions.start) && Objects.equals(this.timezone, securityMonitoringSchedulingOptions.timezone) && Objects.equals(this.additionalProperties, securityMonitoringSchedulingOptions.additionalProperties);
  }
