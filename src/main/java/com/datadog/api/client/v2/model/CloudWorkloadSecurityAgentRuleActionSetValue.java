...
@JsonDeserialize(using = CloudWorkloadSecurityAgentRuleActionSetValue.CloudWorkloadSecurityAgentRuleActionSetValueDeserializer.class)
@JsonSerialize(using = CloudWorkloadSecurityAgentRuleActionSetValue.CloudWorkloadSecurityAgentRuleActionSetValueSerializer.class)
public class CloudWorkloadSecurityAgentRuleActionSetValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CloudWorkloadSecurityAgentRuleActionSetValue.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class CloudWorkloadSecurityAgentRuleActionSetValueSerializer extends StdSerializer<CloudWorkloadSecurityAgentRuleActionSetValue> {
        public CloudWorkloadSecurityAgentRuleActionSetValueSerializer(Class<CloudWorkloadSecurityAgentRuleActionSetValue> t) {
            super(t);
        }

        public CloudWorkloadSecurityAgentRuleActionSetValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(CloudWorkloadSecurityAgentRuleActionSetValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CloudWorkloadSecurityAgentRuleActionSetValueDeserializer extends StdDeserializer<CloudWorkloadSecurityAgentRuleActionSetValue> {
        public CloudWorkloadSecurityAgentRuleActionSetValueDeserializer() {
            this(CloudWorkloadSecurityAgentRuleActionSetValue.class);
        }

        public CloudWorkloadSecurityAgentRuleActionSetValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CloudWorkloadSecurityAgentRuleActionSetValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            CloudWorkloadSecurityAgentRuleActionSetValue ret = new CloudWorkloadSecurityAgentRuleActionSetValue();
            if (match == 1) {
         ...
         */
        @Override
        public CloudWorkloadSecurityAgentRuleActionSetValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CloudWorkloadSecurityAgentRuleActionSetValue cannot be null");
        }
    }
    ...
    public CloudWorkloadSecurityAgentRuleActionSetValue() {
        super("oneOf", Boolean.FALSE);
    }
    public CloudWorkloadSecurityAgentRuleActionSetValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public CloudWorkloadSecurityAgentRuleActionSetValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CloudWorkloadSecurityAgentRuleActionSetValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return CloudWorkloadSecurityAgentRuleActionSetValue.schemas;
    }
