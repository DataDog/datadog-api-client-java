...
public class LLMObsAnnotationQueueDataAttributesResponse {
  ...
  @JsonCreator
  public LLMObsAnnotationQueueDataAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_CAN_MANAGE_ACCESS)Boolean canManageAccess,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RESTRICT_TO_ASSIGNEES)Boolean restrictToAssignees,
            @JsonProperty(required=true, value=JSON_PROPERTY_RESTRICT_TO_REVIEWERS)Boolean restrictToReviewers) {
  ...
  **/
  ...
  /**
   * <p>Whether the current caller can manage access for the annotation queue.</p>
  ...
  **/
  ...
  /**
   * <p>Timestamp when the queue was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Identifier of the user who created the queue.</p>
   * @return createdBy
  **/
  ...
  **/
  ...
  /**
   * <p>Timestamp when the queue was last modified.</p>
   * @return modifiedAt
  **/
  ...
  /**
   * <p>Identifier of the user who last modified the queue.</p>
   * @return modifiedBy
  **/
  ...
  **/
  ...
  /**
   * <p>Identifier of the user who owns the queue.</p>
   * @return ownedBy
  **/
  ...
  **/
  ...
  /**
   * <p>Email addresses of reviewers for the annotation queue. Returned only
   * when the caller can manage queue access.</p>
