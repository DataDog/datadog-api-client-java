...
@JsonPropertyOrder({
  ...
  SecureEmbedUpdateRequestAttributes.JSON_PROPERTY_SELECTABLE_TEMPLATE_VARS,
  SecureEmbedUpdateRequestAttributes.JSON_PROPERTY_STATUS,
...
public class SecureEmbedUpdateRequestAttributes {
  ...
  public SecureEmbedUpdateRequestAttributes globalTime(SecureEmbedGlobalTime globalTime) {
   ...
   * @return SecureEmbedUpdateRequestAttributes
   */
  @JsonAnySetter
