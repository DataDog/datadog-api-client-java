...
/**
   * <p>Attributes of a user who has watched a RUM replay session, including contact information and watch statistics.</p>
 */
@JsonPropertyOrder({
...
public class WatcherDataAttributes {
  ...
  /**
   * <p>Email handle of the user who watched the session.</p>
   * @return handle
  **/
  ...
  /**
   * <p>URL or identifier of the watcher's avatar icon.</p>
   * @return icon
  **/
  ...
  /**
   * <p>Timestamp when the watcher last viewed the session.</p>
  ...
  **/
  ...
  /**
   * <p>Display name of the user who watched the session.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Total number of times the user has watched the session.</p>
   * maximum: 2147483647
   * @return watchCount
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.handle, watcherDataAttributes.handle) && Objects.equals(this.icon, watcherDataAttributes.icon) && Objects.equals(this.lastWatchedAt, watcherDataAttributes.lastWatchedAt) && Objects.equals(this.name, watcherDataAttributes.name) && Objects.equals(this.watchCount, watcherDataAttributes.watchCount) && Objects.equals(this.additionalProperties, watcherDataAttributes.additionalProperties);
  }
