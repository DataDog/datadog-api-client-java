...
public class SecurityMonitoringRuleQuery extends AbstractOpenApiSchema {
    ...
    public static class SecurityMonitoringRuleQuerySerializer extends StdSerializer<SecurityMonitoringRuleQuery> {
        ...
        @Override
        public void serialize(SecurityMonitoringRuleQuery value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class SecurityMonitoringRuleQueryDeserializer extends StdDeserializer<SecurityMonitoringRuleQuery> {
        ...
        @Override
        public SecurityMonitoringRuleQuery deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (SecurityMonitoringStandardRuleQuery.class.equals(Integer.class) || SecurityMonitoringStandardRuleQuery.class.equals(Long.class) || SecurityMonitoringStandardRuleQuery.class.equals(Float.class) || SecurityMonitoringStandardRuleQuery.class.equals(Double.class) || SecurityMonitoringStandardRuleQuery.class.equals(Boolean.class) || SecurityMonitoringStandardRuleQuery.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        attemptParsing |= ((SecurityMonitoringStandardRuleQuery.class.equals(Integer.class) || SecurityMonitoringStandardRuleQuery.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SecurityMonitoringStandardRuleQuery.class.equals(Float.class) || SecurityMonitoringStandardRuleQuery.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SecurityMonitoringStandardRuleQuery.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SecurityMonitoringStandardRuleQuery.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                log.log(Level.FINER, "Input data does not match schema 'SecurityMonitoringStandardRuleQuery'", e);
            }
            ...
            try {
                ...
                if (SecurityMonitoringSignalRuleQuery.class.equals(Integer.class) || SecurityMonitoringSignalRuleQuery.class.equals(Long.class) || SecurityMonitoringSignalRuleQuery.class.equals(Float.class) || SecurityMonitoringSignalRuleQuery.class.equals(Double.class) || SecurityMonitoringSignalRuleQuery.class.equals(Boolean.class) || SecurityMonitoringSignalRuleQuery.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((SecurityMonitoringSignalRuleQuery.class.equals(Integer.class) || SecurityMonitoringSignalRuleQuery.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((SecurityMonitoringSignalRuleQuery.class.equals(Float.class) || SecurityMonitoringSignalRuleQuery.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (SecurityMonitoringSignalRuleQuery.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (SecurityMonitoringSignalRuleQuery.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'SecurityMonitoringSignalRuleQuery'", e);
            }
         ...
         */
        @Override
        public SecurityMonitoringRuleQuery getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "SecurityMonitoringRuleQuery cannot be null");
        }
    }
    ...
    static {
        schemas.put("SecurityMonitoringStandardRuleQuery", new GenericType<SecurityMonitoringStandardRuleQuery>() {
        });
        schemas.put("SecurityMonitoringSignalRuleQuery", new GenericType<SecurityMonitoringSignalRuleQuery>() {
        });
     ...
     * SecurityMonitoringStandardRuleQuery, SecurityMonitoringSignalRuleQuery
     *
    ...
    public void setActualInstance(Object instance) {
        if (JSON.isInstanceOf(SecurityMonitoringStandardRuleQuery.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(SecurityMonitoringSignalRuleQuery.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * SecurityMonitoringStandardRuleQuery, SecurityMonitoringSignalRuleQuery
     *
     * @return The actual instance (SecurityMonitoringStandardRuleQuery, SecurityMonitoringSignalRuleQuery)
     */
    @Override
    ...
    /**
     * Get the actual instance of `SecurityMonitoringStandardRuleQuery`. If the actual instance is not `SecurityMonitoringStandardRuleQuery`,
    ...
    /**
     * Get the actual instance of `SecurityMonitoringSignalRuleQuery`. If the actual instance is not `SecurityMonitoringSignalRuleQuery`,
     * the ClassCastException will be thrown.
     *
