...
public class ApmResourceStatsDataSource extends ModelEnum<String> {
  ...
  public static final ApmResourceStatsDataSource APM_RESOURCE_STATS = new ApmResourceStatsDataSource("apm_resource_stats");
  ...
  public static class ApmResourceStatsDataSourceSerializer extends StdSerializer<ApmResourceStatsDataSource> {
      ...
      @Override
      public void serialize(ApmResourceStatsDataSource value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
