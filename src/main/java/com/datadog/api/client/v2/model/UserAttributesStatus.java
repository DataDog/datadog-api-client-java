...
public class UserAttributesStatus extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("active", "deactivated", "pending"));
  ...
  public static class UserAttributesStatusSerializer extends StdSerializer<UserAttributesStatus> {
      ...
      @Override
      public void serialize(UserAttributesStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
