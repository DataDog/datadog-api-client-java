...
public class RumRateLimitMode extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("custom", "adaptive"));
  ...
  public static class RumRateLimitModeSerializer extends StdSerializer<RumRateLimitMode> {
      ...
      @Override
      public void serialize(RumRateLimitMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
