...
public class AttachmentIncluded extends AbstractOpenApiSchema {
    ...
    public static class AttachmentIncludedSerializer extends StdSerializer<AttachmentIncluded> {
        ...
        @Override
        public void serialize(AttachmentIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AttachmentIncludedDeserializer extends StdDeserializer<AttachmentIncluded> {
        ...
        @Override
        public AttachmentIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public AttachmentIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
