...
public class RUMGroupByMissing extends AbstractOpenApiSchema {
    ...
    public static class RUMGroupByMissingSerializer extends StdSerializer<RUMGroupByMissing> {
        ...
        @Override
        public void serialize(RUMGroupByMissing value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class RUMGroupByMissingDeserializer extends StdDeserializer<RUMGroupByMissing> {
        ...
        @Override
        public RUMGroupByMissing deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
