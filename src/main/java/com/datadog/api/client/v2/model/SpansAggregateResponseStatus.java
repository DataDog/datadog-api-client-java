...
public class SpansAggregateResponseStatus extends ModelEnum<String> {
  ...
  public static final SpansAggregateResponseStatus TIMEOUT = new SpansAggregateResponseStatus("timeout");
  ...
  public static class SpansAggregateResponseStatusSerializer extends StdSerializer<SpansAggregateResponseStatus> {
      ...
      @Override
      public void serialize(SpansAggregateResponseStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
