...
/**
   * <p>The request body for creating or updating multiple rows into a reference table.</p>
 */
@JsonPropertyOrder({
  BatchUpsertRowsRequestArray.JSON_PROPERTY_DATA
})
...
public class BatchUpsertRowsRequestArray {
  ...
  @JsonCreator
  public BatchUpsertRowsRequestArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<BatchUpsertRowsRequestData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>List of row resources to create or update in the reference table.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, batchUpsertRowsRequestArray.data) && Objects.equals(this.additionalProperties, batchUpsertRowsRequestArray.additionalProperties);
  }
