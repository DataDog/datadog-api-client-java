...
public class SyntheticsTestParentSuiteAttributes {
  ...
  /**
   * <p>The name of the child test within the suite.</p>
   * @return childName
  **/
  ...
  /**
   * <p>The public ID of the child test within the suite.</p>
  ...
  **/
  ...
  /**
   * <p>The overall state of the parent suite.</p>
   * @return overallState
  **/
      @jakarta.annotation.Nullable
