...
public class DataTransformType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("dataTransform"));
  ...
  public static class DataTransformTypeSerializer extends StdSerializer<DataTransformType> {
      ...
      @Override
      public void serialize(DataTransformType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
