...
/** The definition of <code>SecretRuleDataAttributesMatchValidation</code> object. */
@JsonPropertyOrder({
...
public class SecretRuleDataAttributesMatchValidation {
  ...
  /**
   * The <code>match_validation</code> <code>endpoint</code>.
   *
   * @return endpoint
   */
  ...
  /**
   * The <code>match_validation</code> <code>hosts</code>.
   *
   * @return hosts
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>match_validation</code> <code>http_method</code>.
   *
   * @return httpMethod
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>match_validation</code> <code>invalid_http_status_code</code>.
   *
  ...
  /**
   * The <code>match_validation</code> <code>request_headers</code>.
   *
  ...
  /**
   * The <code>match_validation</code> <code>timeout_seconds</code>. minimum: 0 maximum:
  ...
  /**
   * The <code>match_validation</code> <code>type</code>.
   *
   * @return type
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>match_validation</code> <code>valid_http_status_code</code>.
   *
