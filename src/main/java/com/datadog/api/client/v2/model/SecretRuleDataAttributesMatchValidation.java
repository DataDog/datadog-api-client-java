...
public class SecretRuleDataAttributesMatchValidation {
  ...
  private List<SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems> invalidHttpStatusCode = null;
  ...
  private List<SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems> validHttpStatusCode = null;
  ...
  /**
   * <p>The URL endpoint to call when validating a detected secret.</p>
   * @return endpoint
  **/
  ...
  /**
   * <p>The list of hostnames to include when performing secret match validation.</p>
   * @return hosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The HTTP method (e.g., GET, POST) to use when making the validation request.</p>
   * @return httpMethod
  **/
      @jakarta.annotation.Nullable
  ...
  public SecretRuleDataAttributesMatchValidation invalidHttpStatusCode(List<SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems> invalidHttpStatusCode) {
    this.invalidHttpStatusCode = invalidHttpStatusCode;
    for (SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems item : invalidHttpStatusCode) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }
  public SecretRuleDataAttributesMatchValidation addInvalidHttpStatusCodeItem(SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems invalidHttpStatusCodeItem) {
  ...
  /**
   * <p>The HTTP status code ranges that indicate the detected secret is invalid or inactive.</p>
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public List<SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems> getInvalidHttpStatusCode() {
        return invalidHttpStatusCode;
      }
  public void setInvalidHttpStatusCode(List<SecretRuleDataAttributesMatchValidationInvalidHttpStatusCodeItems> invalidHttpStatusCode) {
    this.invalidHttpStatusCode = invalidHttpStatusCode;
  }
  public SecretRuleDataAttributesMatchValidation requestHeaders(Map<String, String> requestHeaders) {
    this.requestHeaders = requestHeaders;
    return this;
  }
  public SecretRuleDataAttributesMatchValidation putRequestHeadersItem(String key, String requestHeadersItem) {
  ...
  /**
   * <p>A map of HTTP header names to values to include in the validation request.</p>
  ...
  **/
  ...
  /**
   * <p>The maximum number of seconds to wait for a response during validation before timing out.</p>
   * minimum: 0
  ...
  **/
  ...
  /**
   * <p>The type of match validation to perform (e.g., http).</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
  ...
  public SecretRuleDataAttributesMatchValidation validHttpStatusCode(List<SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems> validHttpStatusCode) {
    this.validHttpStatusCode = validHttpStatusCode;
    for (SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems item : validHttpStatusCode) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }
  public SecretRuleDataAttributesMatchValidation addValidHttpStatusCodeItem(SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems validHttpStatusCodeItem) {
  ...
  /**
   * <p>The HTTP status code ranges that indicate the detected secret is valid and active.</p>
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public List<SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems> getValidHttpStatusCode() {
        return validHttpStatusCode;
      }
  public void setValidHttpStatusCode(List<SecretRuleDataAttributesMatchValidationValidHttpStatusCodeItems> validHttpStatusCode) {
    this.validHttpStatusCode = validHttpStatusCode;
  }
  ...
  public boolean equals(Object o) {
    ...
    SecretRuleDataAttributesMatchValidation secretRuleDataAttributesMatchValidation = (SecretRuleDataAttributesMatchValidation) o;
    return Objects.equals(this.endpoint, secretRuleDataAttributesMatchValidation.endpoint) && Objects.equals(this.hosts, secretRuleDataAttributesMatchValidation.hosts) && Objects.equals(this.httpMethod, secretRuleDataAttributesMatchValidation.httpMethod) && Objects.equals(this.invalidHttpStatusCode, secretRuleDataAttributesMatchValidation.invalidHttpStatusCode) && Objects.equals(this.requestHeaders, secretRuleDataAttributesMatchValidation.requestHeaders) && Objects.equals(this.timeoutSeconds, secretRuleDataAttributesMatchValidation.timeoutSeconds) && Objects.equals(this.type, secretRuleDataAttributesMatchValidation.type) && Objects.equals(this.validHttpStatusCode, secretRuleDataAttributesMatchValidation.validHttpStatusCode) && Objects.equals(this.additionalProperties, secretRuleDataAttributesMatchValidation.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(endpoint,hosts,httpMethod,invalidHttpStatusCode,requestHeaders,timeoutSeconds,type,validHttpStatusCode, additionalProperties);
  }
