...
public class OAuth2WellKnownSitesEnvType extends ModelEnum<String> {
  ...
  public static class OAuth2WellKnownSitesEnvTypeSerializer extends StdSerializer<OAuth2WellKnownSitesEnvType> {
      ...
      @Override
      public void serialize(OAuth2WellKnownSitesEnvType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
