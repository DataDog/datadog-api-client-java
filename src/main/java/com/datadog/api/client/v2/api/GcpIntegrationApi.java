 ...
 */
  public CompletableFuture<GCPSTSServiceAccountResponse>createGCPSTSAccountAsync(GCPSTSServiceAccountCreateRequest body) {
    return createGCPSTSAccountWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Create a new entry within Datadog for your STS enabled service account.</p>
   *
   * @param body  (required)
  ...
  public ApiResponse<GCPSTSServiceAccountResponse> createGCPSTSAccountWithHttpInfo(GCPSTSServiceAccountCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.createGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GCPSTSServiceAccountResponse>> createGCPSTSAccountWithHttpInfoAsync(GCPSTSServiceAccountCreateRequest body) {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
        CompletableFuture<ApiResponse<GCPSTSServiceAccountResponse>> result = new CompletableFuture<>();
    ...
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.createGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GCPSTSServiceAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteGCPSTSAccountAsync(String accountId) {
    return deleteGCPSTSAccountWithHttpInfoAsync(accountId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete an STS enabled GCP account from within Datadog.</p>
   *
   * @param accountId Your GCP STS enabled service account's unique ID. (required)
  ...
  public ApiResponse<Void> deleteGCPSTSAccountWithHttpInfo(String accountId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/integration/gcp/accounts/{account_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.deleteGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteGCPSTSAccountWithHttpInfoAsync(String accountId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.deleteGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<GCPSTSDelegateAccountResponse>getGCPSTSDelegateAsync() {
    return getGCPSTSDelegateWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>List your Datadog-GCP STS delegate account configured in your Datadog account.</p>
   *
  ...
  public ApiResponse<GCPSTSDelegateAccountResponse> getGCPSTSDelegateWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.getGCPSTSDelegate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSDelegateAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GCPSTSDelegateAccountResponse>> getGCPSTSDelegateWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.getGCPSTSDelegate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GCPSTSDelegateAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSDelegateAccountResponse>() {});
  }
 ...
 */
  public CompletableFuture<GCPSTSServiceAccountsResponse>listGCPSTSAccountsAsync() {
    return listGCPSTSAccountsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>List all GCP STS-enabled service accounts configured in your Datadog account.</p>
   *
  ...
  public ApiResponse<GCPSTSServiceAccountsResponse> listGCPSTSAccountsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.listGCPSTSAccounts", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GCPSTSServiceAccountsResponse>> listGCPSTSAccountsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.listGCPSTSAccounts", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GCPSTSServiceAccountsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountsResponse>() {});
  }
 ...
 */
  public CompletableFuture<GCPSTSDelegateAccountResponse>makeGCPSTSDelegateAsync() {
    return makeGCPSTSDelegateWithHttpInfoAsync(new MakeGCPSTSDelegateOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<GCPSTSDelegateAccountResponse>makeGCPSTSDelegateAsync(MakeGCPSTSDelegateOptionalParameters parameters) {
    return makeGCPSTSDelegateWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Create a Datadog GCP principal.</p>
   *
   * @param parameters Optional parameters for the request.
   * @return ApiResponse&lt;GCPSTSDelegateAccountResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<GCPSTSDelegateAccountResponse> makeGCPSTSDelegateWithHttpInfo(MakeGCPSTSDelegateOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.makeGCPSTSDelegate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSDelegateAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GCPSTSDelegateAccountResponse>> makeGCPSTSDelegateWithHttpInfoAsync(MakeGCPSTSDelegateOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.makeGCPSTSDelegate", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GCPSTSDelegateAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSDelegateAccountResponse>() {});
  }
 ...
 */
  public CompletableFuture<GCPSTSServiceAccountResponse>updateGCPSTSAccountAsync(String accountId, GCPSTSServiceAccountUpdateRequest body) {
    return updateGCPSTSAccountWithHttpInfoAsync(accountId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update an STS enabled service account.</p>
   *
   * @param accountId Your GCP STS enabled service account's unique ID. (required)
   * @param body  (required)
   * @return ApiResponse&lt;GCPSTSServiceAccountResponse&gt;
  ...
  public ApiResponse<GCPSTSServiceAccountResponse> updateGCPSTSAccountWithHttpInfo(String accountId, GCPSTSServiceAccountUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.GcpIntegrationApi.updateGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<GCPSTSServiceAccountResponse>> updateGCPSTSAccountWithHttpInfoAsync(String accountId, GCPSTSServiceAccountUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.GcpIntegrationApi.updateGCPSTSAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<GCPSTSServiceAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<GCPSTSServiceAccountResponse>() {});
  }
}