...
public class ObservabilityPipelineClickhouseDestinationAuth {
  ...
  @JsonCreator
  public ObservabilityPipelineClickhouseDestinationAuth(
            @JsonProperty(required=true, value=JSON_PROPERTY_STRATEGY)ObservabilityPipelineClickhouseDestinationAuthStrategy strategy) {
  ...
  /**
   * <p>Name of the environment variable or secret that contains the ClickHouse password.</p>
   * @return passwordKey
  **/
  ...
  public ObservabilityPipelineClickhouseDestinationAuth strategy(ObservabilityPipelineClickhouseDestinationAuthStrategy strategy) {
    this.strategy = strategy;
    this.unparsed |= !strategy.isValid();
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that contains the ClickHouse username.</p>
   * @return usernameKey
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineClickhouseDestinationAuth putAdditionalProperty(String key, Object value) {
