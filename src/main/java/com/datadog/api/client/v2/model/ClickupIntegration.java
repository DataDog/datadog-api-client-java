...
/**
   * <p>The definition of the <code>ClickupIntegration</code> object.</p>
 */
@JsonPropertyOrder({
...
public class ClickupIntegration {
  ...
  @JsonCreator
  public ClickupIntegration(
            @JsonProperty(required=true, value=JSON_PROPERTY_CREDENTIALS)ClickupCredentials credentials,
  ...
  /**
   * <p>The definition of the <code>ClickupCredentials</code> object.</p>
   * @return credentials
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentials, clickupIntegration.credentials) && Objects.equals(this.type, clickupIntegration.type) && Objects.equals(this.additionalProperties, clickupIntegration.additionalProperties);
  }
