...
public class StateVariableType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("stateVariable"));
  ...
  public static class StateVariableTypeSerializer extends StdSerializer<StateVariableType> {
      ...
      @Override
      public void serialize(StateVariableType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
