...
public class CustomAttributeValuesUnion extends AbstractOpenApiSchema {
    ...
    public static class CustomAttributeValuesUnionSerializer extends StdSerializer<CustomAttributeValuesUnion> {
        ...
        @Override
        public void serialize(CustomAttributeValuesUnion value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CustomAttributeValuesUnionDeserializer extends StdDeserializer<CustomAttributeValuesUnion> {
        ...
        @Override
        public CustomAttributeValuesUnion deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public CustomAttributeValuesUnion getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        ...
        JSON.registerDescendants(CustomAttributeValuesUnion.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * String, List&lt;String&gt;, Double, List&lt;Double&gt;
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be String, List<String>, Double, List<Double>");
    }
