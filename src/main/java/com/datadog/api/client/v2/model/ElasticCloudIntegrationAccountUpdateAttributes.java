...
/**
 * Updatable attributes of an Elastic Cloud integration account. Every field is optional; only the
 * fields provided are changed.
 */
@JsonPropertyOrder({
  ElasticCloudIntegrationAccountUpdateAttributes.JSON_PROPERTY_INTERFACE,
...
public class ElasticCloudIntegrationAccountUpdateAttributes {
  ...
  public ElasticCloudIntegrationAccountUpdateAttributes _interface(
      ElasticCloudInterfaceUpdate _interface) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this._interface, elasticCloudIntegrationAccountUpdateAttributes._interface)
