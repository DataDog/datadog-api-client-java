...
public class ElasticCloudIntegrationAccountUpdateAttributes {
  ...
  public ElasticCloudIntegrationAccountUpdateAttributes authentication(ElasticCloudIntegrationAccountAuthenticationUpdate authentication) {
  ...
  /**
   * <p>Authentication for updating the Elastic Cloud integration account. Exactly one method is set.</p>
  ...
  **/
  ...
  public ElasticCloudIntegrationAccountUpdateAttributes dataflows(ElasticCloudIntegrationDataflowsRequest dataflows) {
  ...
  **/
  ...
  public ElasticCloudIntegrationAccountUpdateAttributes settings(ElasticCloudIntegrationAccountSettingsUpdate settings) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public ElasticCloudIntegrationAccountUpdateAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ElasticCloudIntegrationAccountUpdateAttributes elasticCloudIntegrationAccountUpdateAttributes = (ElasticCloudIntegrationAccountUpdateAttributes) o;
