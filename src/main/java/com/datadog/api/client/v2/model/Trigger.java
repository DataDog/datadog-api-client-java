...
public class Trigger extends AbstractOpenApiSchema {
    ...
    public static class TriggerDeserializer extends StdDeserializer<Trigger> {
        ...
        public Trigger deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AgentTriggerWrapper.class.equals(Integer.class) || AgentTriggerWrapper.class.equals(Long.class) || AgentTriggerWrapper.class.equals(Float.class) || AgentTriggerWrapper.class.equals(Double.class) || AgentTriggerWrapper.class.equals(Boolean.class) || AgentTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AgentTriggerWrapper.class.equals(Integer.class) || AgentTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AgentTriggerWrapper.class.equals(Float.class) || AgentTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AgentTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AgentTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentCreatedTriggerWrapper.class.equals(Integer.class) || IncidentCreatedTriggerWrapper.class.equals(Long.class) || IncidentCreatedTriggerWrapper.class.equals(Float.class) || IncidentCreatedTriggerWrapper.class.equals(Double.class) || IncidentCreatedTriggerWrapper.class.equals(Boolean.class) || IncidentCreatedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentCreatedTriggerWrapper.class.equals(Integer.class) || IncidentCreatedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentCreatedTriggerWrapper.class.equals(Float.class) || IncidentCreatedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentCreatedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentCreatedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentImpactCreatedTriggerWrapper.class.equals(Integer.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Long.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Float.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Double.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Boolean.class) || IncidentImpactCreatedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentImpactCreatedTriggerWrapper.class.equals(Integer.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentImpactCreatedTriggerWrapper.class.equals(Float.class) || IncidentImpactCreatedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentImpactCreatedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentImpactCreatedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentImpactCreatedTriggerWrapper'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentImpactUpdatedTriggerWrapper.class.equals(Integer.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Long.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Float.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Double.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Boolean.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentImpactUpdatedTriggerWrapper.class.equals(Integer.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentImpactUpdatedTriggerWrapper.class.equals(Float.class) || IncidentImpactUpdatedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentImpactUpdatedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentImpactUpdatedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentImpactUpdatedTriggerWrapper'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentPostmortemUpdatedTriggerWrapper.class.equals(Integer.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Long.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Float.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Double.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Boolean.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentPostmortemUpdatedTriggerWrapper.class.equals(Integer.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentPostmortemUpdatedTriggerWrapper.class.equals(Float.class) || IncidentPostmortemUpdatedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentPostmortemUpdatedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentPostmortemUpdatedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(IncidentPostmortemUpdatedTriggerWrapper.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'IncidentPostmortemUpdatedTriggerWrapper'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentPostmortemUpdatedTriggerWrapper'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentResponderCreatedTriggerWrapper.class.equals(Integer.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Long.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Float.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Double.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Boolean.class) || IncidentResponderCreatedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentResponderCreatedTriggerWrapper.class.equals(Integer.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentResponderCreatedTriggerWrapper.class.equals(Float.class) || IncidentResponderCreatedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentResponderCreatedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentResponderCreatedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                    tmp = tree.traverse(jp.getCodec()).readValueAs(IncidentResponderCreatedTriggerWrapper.class);
                    // TODO: there is no validation against JSON schema constraints
                    // (min, max, enum, pattern...), this does not perform a strict JSON
                    // validation, which means the 'match' count may be higher than it should be.
                    ...
                    log.log(Level.FINER, "Input data matches schema 'IncidentResponderCreatedTriggerWrapper'");
                }
            } catch (Exception e) {
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentResponderCreatedTriggerWrapper'", e);
            }
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentSavedTriggerWrapper.class.equals(Integer.class) || IncidentSavedTriggerWrapper.class.equals(Long.class) || IncidentSavedTriggerWrapper.class.equals(Float.class) || IncidentSavedTriggerWrapper.class.equals(Double.class) || IncidentSavedTriggerWrapper.class.equals(Boolean.class) || IncidentSavedTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentSavedTriggerWrapper.class.equals(Integer.class) || IncidentSavedTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentSavedTriggerWrapper.class.equals(Float.class) || IncidentSavedTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentSavedTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentSavedTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentScheduleTriggerWrapper.class.equals(Integer.class) || IncidentScheduleTriggerWrapper.class.equals(Long.class) || IncidentScheduleTriggerWrapper.class.equals(Float.class) || IncidentScheduleTriggerWrapper.class.equals(Double.class) || IncidentScheduleTriggerWrapper.class.equals(Boolean.class) || IncidentScheduleTriggerWrapper.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentScheduleTriggerWrapper.class.equals(Integer.class) || IncidentScheduleTriggerWrapper.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentScheduleTriggerWrapper.class.equals(Float.class) || IncidentScheduleTriggerWrapper.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentScheduleTriggerWrapper.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentScheduleTriggerWrapper.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'IncidentScheduleTriggerWrapper'", e);
            }
    ...
    static {
        ...
        schemas.put("IncidentCreatedTriggerWrapper", new GenericType<IncidentCreatedTriggerWrapper>() {
        });
        schemas.put("IncidentImpactCreatedTriggerWrapper", new GenericType<IncidentImpactCreatedTriggerWrapper>() {
        });
        schemas.put("IncidentImpactUpdatedTriggerWrapper", new GenericType<IncidentImpactUpdatedTriggerWrapper>() {
        });
        schemas.put("IncidentPostmortemUpdatedTriggerWrapper", new GenericType<IncidentPostmortemUpdatedTriggerWrapper>() {
        });
        schemas.put("IncidentResponderCreatedTriggerWrapper", new GenericType<IncidentResponderCreatedTriggerWrapper>() {
        });
        schemas.put("IncidentSavedTriggerWrapper", new GenericType<IncidentSavedTriggerWrapper>() {
        });
        schemas.put("IncidentScheduleTriggerWrapper", new GenericType<IncidentScheduleTriggerWrapper>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(IncidentImpactCreatedTriggerWrapper.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(IncidentImpactUpdatedTriggerWrapper.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(IncidentPostmortemUpdatedTriggerWrapper.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(IncidentResponderCreatedTriggerWrapper.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (JSON.isInstanceOf(IncidentScheduleTriggerWrapper.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * AgentTriggerWrapper, APITriggerWrapper, AppTriggerWrapper, CaseTriggerWrapper, ChangeEventTriggerWrapper, DatabaseMonitoringTriggerWrapper, DatastoreTriggerWrapper, DashboardTriggerWrapper, FormTriggerWrapper, GithubWebhookTriggerWrapper, IncidentCreatedTriggerWrapper, IncidentImpactCreatedTriggerWrapper, IncidentImpactUpdatedTriggerWrapper, IncidentPostmortemUpdatedTriggerWrapper, IncidentResponderCreatedTriggerWrapper, IncidentSavedTriggerWrapper, IncidentScheduleTriggerWrapper, IncidentTriggerWrapper, MonitorTriggerWrapper, NotebookTriggerWrapper, OnCallTriggerWrapper, ScheduleTriggerWrapper, SecurityTriggerWrapper, SelfServiceTriggerWrapper, SlackTriggerWrapper, SoftwareCatalogTriggerWrapper, WorkflowTriggerWrapper
     *
     * @return The actual instance (AgentTriggerWrapper, APITriggerWrapper, AppTriggerWrapper, CaseTriggerWrapper, ChangeEventTriggerWrapper, DatabaseMonitoringTriggerWrapper, DatastoreTriggerWrapper, DashboardTriggerWrapper, FormTriggerWrapper, GithubWebhookTriggerWrapper, IncidentCreatedTriggerWrapper, IncidentImpactCreatedTriggerWrapper, IncidentImpactUpdatedTriggerWrapper, IncidentPostmortemUpdatedTriggerWrapper, IncidentResponderCreatedTriggerWrapper, IncidentSavedTriggerWrapper, IncidentScheduleTriggerWrapper, IncidentTriggerWrapper, MonitorTriggerWrapper, NotebookTriggerWrapper, OnCallTriggerWrapper, ScheduleTriggerWrapper, SecurityTriggerWrapper, SelfServiceTriggerWrapper, SlackTriggerWrapper, SoftwareCatalogTriggerWrapper, WorkflowTriggerWrapper)
     */
    @Override
    ...
    /**
     * Get the actual instance of `AgentTriggerWrapper`. If the actual instance is not `AgentTriggerWrapper`,
    ...
    /**
     * Get the actual instance of `IncidentCreatedTriggerWrapper`. If the actual instance is not `IncidentCreatedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentCreatedTriggerWrapper getIncidentCreatedTriggerWrapper() throws ClassCastException {
        return (IncidentCreatedTriggerWrapper)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IncidentImpactCreatedTriggerWrapper`. If the actual instance is not `IncidentImpactCreatedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentImpactCreatedTriggerWrapper getIncidentImpactCreatedTriggerWrapper() throws ClassCastException {
        return (IncidentImpactCreatedTriggerWrapper)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IncidentImpactUpdatedTriggerWrapper`. If the actual instance is not `IncidentImpactUpdatedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentImpactUpdatedTriggerWrapper getIncidentImpactUpdatedTriggerWrapper() throws ClassCastException {
        return (IncidentImpactUpdatedTriggerWrapper)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IncidentPostmortemUpdatedTriggerWrapper`. If the actual instance is not `IncidentPostmortemUpdatedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentPostmortemUpdatedTriggerWrapper getIncidentPostmortemUpdatedTriggerWrapper() throws ClassCastException {
        return (IncidentPostmortemUpdatedTriggerWrapper)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IncidentResponderCreatedTriggerWrapper`. If the actual instance is not `IncidentResponderCreatedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentResponderCreatedTriggerWrapper getIncidentResponderCreatedTriggerWrapper() throws ClassCastException {
        return (IncidentResponderCreatedTriggerWrapper)super.getActualInstance();
    }

    /**
     * Get the actual instance of `IncidentSavedTriggerWrapper`. If the actual instance is not `IncidentSavedTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `IncidentScheduleTriggerWrapper`. If the actual instance is not `IncidentScheduleTriggerWrapper`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public IncidentScheduleTriggerWrapper getIncidentScheduleTriggerWrapper() throws ClassCastException {
