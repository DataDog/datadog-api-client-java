...
public class SecurityMonitoringStandardDataSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs", "audit", "app_sec_spans", "spans", "security_runtime", "network", "events", "security_signals"));
  ...
  public static final SecurityMonitoringStandardDataSource SECURITY_SIGNALS = new SecurityMonitoringStandardDataSource("security_signals");
