...
public class SecurityMonitoringContentPackStateType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("content_pack_state"));
  ...
  public static class SecurityMonitoringContentPackStateTypeSerializer
      extends StdSerializer<SecurityMonitoringContentPackStateType> {
    public SecurityMonitoringContentPackStateTypeSerializer(
        Class<SecurityMonitoringContentPackStateType> t) {
      super(t);
    }
