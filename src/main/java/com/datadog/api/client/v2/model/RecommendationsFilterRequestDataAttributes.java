...
public class RecommendationsFilterRequestDataAttributes {
  ...
  public RecommendationsFilterRequestDataAttributes sort(
      List<RecommendationsFilterRequestSortItems> sort) {
    this.sort = sort;
    if (sort != null) {
  ...
  public RecommendationsFilterRequestDataAttributes addSortItem(
      RecommendationsFilterRequestSortItems sortItem) {
    if (this.sort == null) {
  ...
  public RecommendationsFilterRequestDataAttributes view(String view) {
    this.view = view;
    return this;
  }
   ...
   * @return RecommendationsFilterRequestDataAttributes
   */
  @JsonAnySetter
  public RecommendationsFilterRequestDataAttributes putAdditionalProperty(
  ...
  /** Return true if this RecommendationsFilterRequestDataAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.scope, recommendationsFilterRequestDataAttributes.scope)
        ...
        && Objects.equals(
            ...
            recommendationsFilterRequestDataAttributes.additionalProperties);
  }
