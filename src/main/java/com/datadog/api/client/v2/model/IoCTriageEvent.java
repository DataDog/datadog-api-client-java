...
/**
   * <p>A single entry in an indicator's triage history timeline.</p>
 */
@JsonPropertyOrder({
...
public class IoCTriageEvent {
  ...
  public IoCTriageEvent triageState(IoCTriageState triageState) {
  ...
  **/
  ...
  /**
   * <p>Timestamp when this triage action occurred.</p>
   * @return triagedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>UUID of the user who performed this triage action.</p>
   * @return triagedBy
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.triageState, ioCTriageEvent.triageState) && Objects.equals(this.triagedAt, ioCTriageEvent.triagedAt) && Objects.equals(this.triagedBy, ioCTriageEvent.triagedBy) && Objects.equals(this.additionalProperties, ioCTriageEvent.additionalProperties);
  }
