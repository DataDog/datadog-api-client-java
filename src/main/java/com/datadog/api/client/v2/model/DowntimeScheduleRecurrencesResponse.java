...
public class DowntimeScheduleRecurrencesResponse {
  ...
  @JsonCreator
  public DowntimeScheduleRecurrencesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_RECURRENCES)List<DowntimeScheduleRecurrenceResponse> recurrences) {
  ...
  **/
  ...
  /**
   * <p>The timezone in which to schedule the downtime. This affects recurring start and end dates.
   * Must match <code>display_timezone</code>.</p>
   * @return timezone
  **/
      @jakarta.annotation.Nullable
