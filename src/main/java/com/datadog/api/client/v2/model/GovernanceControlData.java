...
public class GovernanceControlData {
  ...
  @JsonCreator
  public GovernanceControlData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)GovernanceControlAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)GovernanceControlResourceType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, governanceControlData.attributes) && Objects.equals(this.id, governanceControlData.id) && Objects.equals(this.type, governanceControlData.type) && Objects.equals(this.additionalProperties, governanceControlData.additionalProperties);
  }
