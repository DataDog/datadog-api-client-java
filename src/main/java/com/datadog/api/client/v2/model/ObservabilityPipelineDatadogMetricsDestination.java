...
/**
   * <p>The <code>datadog_metrics</code> destination forwards metrics to Datadog.</p>
...
public class ObservabilityPipelineDatadogMetricsDestination {
  ...
  private ObservabilityPipelineDatadogMetricsDestinationType type = ObservabilityPipelineDatadogMetricsDestinationType.DATADOG_METRICS;
  ...
  public ObservabilityPipelineDatadogMetricsDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineDatadogMetricsDestinationType type) {
        this.id = id;
        this.inputs = inputs;
        this.type = type;
  ...
  **/
  ...
  public ObservabilityPipelineDatadogMetricsDestination type(ObservabilityPipelineDatadogMetricsDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. The value should always be <code>datadog_metrics</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineDatadogMetricsDestination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineDatadogMetricsDestination observabilityPipelineDatadogMetricsDestination = (ObservabilityPipelineDatadogMetricsDestination) o;
    return Objects.equals(this.id, observabilityPipelineDatadogMetricsDestination.id) && Objects.equals(this.inputs, observabilityPipelineDatadogMetricsDestination.inputs) && Objects.equals(this.type, observabilityPipelineDatadogMetricsDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineDatadogMetricsDestination.additionalProperties);
  }
