...
public class ProductAnalyticsAnalyticsListQuery {
  ...
  public ProductAnalyticsAnalyticsListQuery audienceFilters(
  ...
  /**
   * Maximum number of event rows to return. minimum: 1 maximum: 1000
   *
   * @return limit
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsAnalyticsListQuery productAnalyticsAnalyticsListQuery =
        (ProductAnalyticsAnalyticsListQuery) o;
    return Objects.equals(this.audienceFilters, productAnalyticsAnalyticsListQuery.audienceFilters)
        && Objects.equals(this.columns, productAnalyticsAnalyticsListQuery.columns)
        && Objects.equals(this.limit, productAnalyticsAnalyticsListQuery.limit)
        && Objects.equals(this.query, productAnalyticsAnalyticsListQuery.query)
        && Objects.equals(this.sort, productAnalyticsAnalyticsListQuery.sort)
        && Objects.equals(
            this.additionalProperties, productAnalyticsAnalyticsListQuery.additionalProperties);
  }
