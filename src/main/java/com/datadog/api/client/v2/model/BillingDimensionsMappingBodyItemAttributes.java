...
public class BillingDimensionsMappingBodyItemAttributes {
  ...
  public BillingDimensionsMappingBodyItemAttributes endpoints(List<BillingDimensionsMappingBodyItemAttributesEndpointsItems> endpoints) {
  ...
  public BillingDimensionsMappingBodyItemAttributes addEndpointsItem(BillingDimensionsMappingBodyItemAttributesEndpointsItems endpointsItem) {
  ...
  /**
   * <p>List of supported endpoints with their keys mapped to the billing_dimension.</p>
   * @return endpoints
  **/
  ...
  public void setEndpoints(List<BillingDimensionsMappingBodyItemAttributesEndpointsItems> endpoints) {
    this.endpoints = endpoints;
  }
  ...
  /**
   * <p>Label used for the billing dimension in the Plan &amp; Usage charts.</p>
   * @return inAppLabel
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Month in ISO-8601 format, UTC, and precise to the second: <code>[YYYY-MM-DDThh:mm:ss]</code>.</p>
   * @return timestamp
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public BillingDimensionsMappingBodyItemAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BillingDimensionsMappingBodyItemAttributes billingDimensionsMappingBodyItemAttributes = (BillingDimensionsMappingBodyItemAttributes) o;
