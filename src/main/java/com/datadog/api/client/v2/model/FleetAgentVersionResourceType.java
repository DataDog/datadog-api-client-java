...
public class FleetAgentVersionResourceType extends ModelEnum<String> {
  ...
  public static final FleetAgentVersionResourceType AGENT_VERSION = new FleetAgentVersionResourceType("agent_version");
  ...
  public static class FleetAgentVersionResourceTypeSerializer extends StdSerializer<FleetAgentVersionResourceType> {
      ...
      @Override
      public void serialize(FleetAgentVersionResourceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
