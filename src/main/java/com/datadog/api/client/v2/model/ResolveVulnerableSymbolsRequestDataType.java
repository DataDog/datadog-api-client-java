...
public class ResolveVulnerableSymbolsRequestDataType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("resolve-vulnerable-symbols-request"));
  ...
  public static class ResolveVulnerableSymbolsRequestDataTypeSerializer
      extends StdSerializer<ResolveVulnerableSymbolsRequestDataType> {
    public ResolveVulnerableSymbolsRequestDataTypeSerializer(
        Class<ResolveVulnerableSymbolsRequestDataType> t) {
      super(t);
    }
