...
/**
   * <p>Data needed to create a data deletion request.</p>
 */
@JsonPropertyOrder({
...
public class CreateDataDeletionRequestBodyData {
  ...
  @JsonCreator
  public CreateDataDeletionRequestBodyData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CreateDataDeletionRequestBodyAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)CreateDataDeletionRequestBodyDataType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public CreateDataDeletionRequestBodyData attributes(CreateDataDeletionRequestBodyAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateDataDeletionRequestBodyData createDataDeletionRequestBodyData = (CreateDataDeletionRequestBodyData) o;
    return Objects.equals(this.attributes, createDataDeletionRequestBodyData.attributes) && Objects.equals(this.type, createDataDeletionRequestBodyData.type) && Objects.equals(this.additionalProperties, createDataDeletionRequestBodyData.additionalProperties);
  }
