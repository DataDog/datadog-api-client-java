...
public class SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes {
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes integrationType(
      SecurityMonitoringIntegrationTypeGoogleWorkspace integrationType) {
    this.integrationType = integrationType;
    this.unparsed |= !integrationType.isValid();
    return this;
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes secrets(
      SecurityMonitoringIntegrationConfigGoogleWorkspaceSecrets secrets) {
    this.secrets = secrets;
    this.unparsed |= secrets.unparsed;
    return this;
  ...
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes settings(
      Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }

  public SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes putSettingsItem(
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes putAdditionalProperty(
  ...
  /**
   * Return true if this SecurityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes object
   * is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(
            this.domain, securityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes.domain)
        && Objects.equals(
            this.integrationType,
            securityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes.integrationType)
        && Objects.equals(
            this.name, securityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes.name)
        && Objects.equals(
            this.secrets,
            securityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes.secrets)
        && Objects.equals(
            this.settings,
            securityMonitoringGoogleWorkspaceIntegrationConfigCreateAttributes.settings)
        && Objects.equals(
