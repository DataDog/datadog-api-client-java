...
/**
   * <p>Response containing a list of network health insights for the organization.</p>
 */
@JsonPropertyOrder({
  NetworkHealthInsightsResponse.JSON_PROPERTY_DATA
})
...
public class NetworkHealthInsightsResponse {
  ...
  private List<NetworkHealthInsight> data = new ArrayList<>();
  ...
  /**
   * <p>Array of network health insights returned for the query window.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<NetworkHealthInsight> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, networkHealthInsightsResponse.data) && Objects.equals(this.additionalProperties, networkHealthInsightsResponse.additionalProperties);
  }
