...
public class RetryStrategyKind extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("RETRY_STRATEGY_LINEAR"));

  public static final RetryStrategyKind RETRY_STRATEGY_LINEAR = new RetryStrategyKind("RETRY_STRATEGY_LINEAR");
  ...
  public static class RetryStrategyKindSerializer extends StdSerializer<RetryStrategyKind> {
      ...
      @Override
      public void serialize(RetryStrategyKind value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
