...
/** The <code>opentelemetry</code> source receives OpenTelemetry data through gRPC or HTTP. */
@JsonPropertyOrder({
...
public class ObservabilityPipelineOpentelemetrySource {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, observabilityPipelineOpentelemetrySource.id)
