...
public class ObservabilityPipelineOpentelemetrySource {
  ...
  public ObservabilityPipelineOpentelemetrySource(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ObservabilityPipelineOpentelemetrySourceType type) {
    this.id = id;
    this.type = type;
  ...
  /**
   * Environment variable name containing the gRPC server address for receiving OTLP data. Must be a
   * valid environment variable name (alphanumeric characters and underscores only).
   *
  ...
  /**
   * Environment variable name containing the HTTP server address for receiving OTLP data. Must be a
   * valid environment variable name (alphanumeric characters and underscores only).
   *
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineOpentelemetrySource observabilityPipelineOpentelemetrySource =
        (ObservabilityPipelineOpentelemetrySource) o;
    return Objects.equals(
            this.grpcAddressKey, observabilityPipelineOpentelemetrySource.grpcAddressKey)
        && Objects.equals(
            this.httpAddressKey, observabilityPipelineOpentelemetrySource.httpAddressKey)
        && Objects.equals(this.id, observabilityPipelineOpentelemetrySource.id)
        && Objects.equals(this.tls, observabilityPipelineOpentelemetrySource.tls)
        && Objects.equals(this.type, observabilityPipelineOpentelemetrySource.type)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineOpentelemetrySource.additionalProperties);
  }
