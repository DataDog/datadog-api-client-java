...
/**
 * Databricks OAuth machine-to-machine authentication using a service principal. Only the fields
 * provided are changed; omit <code>client_secret</code> to keep the stored one.
 */
@JsonPropertyOrder({
...
public class DatabricksIntegrationAccountOAuthAuthUpdate {
  ...
  private JsonNullable<String> azureTenantId = JsonNullable.<String>undefined();
  ...
  public DatabricksIntegrationAccountOAuthAuthUpdate azureTenantId(String azureTenantId) {
    this.azureTenantId = JsonNullable.<String>of(azureTenantId);
    return this;
  }

  /**
   * Microsoft Entra ID tenant of the service principal, for Azure Databricks workspaces. Omit it to
   * keep the stored tenant, send <code>null</code> or an empty string to remove it, or send a value
   * to replace it.
   *
  ...
  public String getAzureTenantId() {
    return azureTenantId.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_AZURE_TENANT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<String> getAzureTenantId_JsonNullable() {
    return azureTenantId;
  }

  @JsonProperty(JSON_PROPERTY_AZURE_TENANT_ID)
  public void setAzureTenantId_JsonNullable(JsonNullable<String> azureTenantId) {
