...
/** */
@JsonPropertyOrder({
  WidgetSchemaJSONAPIDocument.JSON_PROPERTY_DATA,
  WidgetSchemaJSONAPIDocument.JSON_PROPERTY_ERRORS,
  WidgetSchemaJSONAPIDocument.JSON_PROPERTY_INCLUDED,
  WidgetSchemaJSONAPIDocument.JSON_PROPERTY_LINKS,
  WidgetSchemaJSONAPIDocument.JSON_PROPERTY_META
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class WidgetSchemaJSONAPIDocument {
  @JsonIgnore public boolean unparsed = false;
  public static final String JSON_PROPERTY_DATA = "data";
  private WidgetSchemaResource data;
  ...
  public WidgetSchemaJSONAPIDocument() {}

  @JsonCreator
  public WidgetSchemaJSONAPIDocument(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) WidgetSchemaResource data) {
    this.data = data;
    this.unparsed |= data.unparsed;
  }

  public WidgetSchemaJSONAPIDocument data(WidgetSchemaResource data) {
    this.data = data;
    this.unparsed |= data.unparsed;
    return this;
  }
  ...
  public WidgetSchemaResource getData() {
    return data;
  }

  public void setData(WidgetSchemaResource data) {
    this.data = data;
  }

  public WidgetSchemaJSONAPIDocument errors(List<WidgetErrorInput> errors) {
    this.errors = JsonNullable.<List<WidgetErrorInput>>of(errors);
    return this;
  }

  public WidgetSchemaJSONAPIDocument addErrorsItem(WidgetErrorInput errorsItem) {
  ...
  public WidgetSchemaJSONAPIDocument included(List<WidgetResourceObjectOutput> included) {
    this.included = JsonNullable.<List<WidgetResourceObjectOutput>>of(included);
    return this;
  }

  public WidgetSchemaJSONAPIDocument addIncludedItem(WidgetResourceObjectOutput includedItem) {
  ...
  public WidgetSchemaJSONAPIDocument links(WidgetLinks links) {
    this.links = links;
  ...
  public WidgetSchemaJSONAPIDocument meta(Map<String, Object> meta) {
    this.meta = JsonNullable.<Map<String, Object>>of(meta);
    return this;
  }

  public WidgetSchemaJSONAPIDocument putMetaItem(String key, Object metaItem) {
   ...
   */
  @JsonAnySetter
  public WidgetSchemaJSONAPIDocument putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this WidgetSchemaJSONAPIDocument object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    WidgetSchemaJSONAPIDocument widgetSchemaJsonapiDocument = (WidgetSchemaJSONAPIDocument) o;
    return Objects.equals(this.data, widgetSchemaJsonapiDocument.data)
        && Objects.equals(this.errors, widgetSchemaJsonapiDocument.errors)
        && Objects.equals(this.included, widgetSchemaJsonapiDocument.included)
        && Objects.equals(this.links, widgetSchemaJsonapiDocument.links)
        && Objects.equals(this.meta, widgetSchemaJsonapiDocument.meta)
        && Objects.equals(
            this.additionalProperties, widgetSchemaJsonapiDocument.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class WidgetSchemaJSONAPIDocument {\n");
