...
/**
   * <p>Represents a user who is subscribed to notifications for a case. Watchers receive updates when the case's status, priority, assignee, or comments change.</p>
 */
@JsonPropertyOrder({
...
public class CaseWatcher {
  ...
  public CaseWatcher(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)CaseWatcherRelationships relationships,
  ...
  /**
   * <p>The primary identifier of the case watcher.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, caseWatcher.id) && Objects.equals(this.relationships, caseWatcher.relationships) && Objects.equals(this.type, caseWatcher.type) && Objects.equals(this.additionalProperties, caseWatcher.additionalProperties);
  }
