...
/**
   * <p>All the available span-based metric objects.</p>
 */
@JsonPropertyOrder({
  SpansMetricsResponse.JSON_PROPERTY_DATA
})
...
public class SpansMetricsResponse {
  ...
  /**
   * <p>A list of span-based metric objects.</p>
   * @return data
  **/
   ...
   */
  @JsonAnySetter
  public SpansMetricsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, spansMetricsResponse.data) && Objects.equals(this.additionalProperties, spansMetricsResponse.additionalProperties);
  }
