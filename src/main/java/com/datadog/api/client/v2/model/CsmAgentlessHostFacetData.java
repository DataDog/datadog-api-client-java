...
/**
   * <p>A single agentless host facet resource.</p>
 */
@JsonPropertyOrder({
...
public class CsmAgentlessHostFacetData {
  ...
  @JsonCreator
  public CsmAgentlessHostFacetData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CsmAgentlessHostFacetAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The identifier of the facet, corresponding to the field path.</p>
   * @return id
  **/
  ...
  /**
   * <p>The JSON:API type for agentless host facet resources. The value should always be <code>agentless_host_facet</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, csmAgentlessHostFacetData.attributes) && Objects.equals(this.id, csmAgentlessHostFacetData.id) && Objects.equals(this.type, csmAgentlessHostFacetData.type) && Objects.equals(this.additionalProperties, csmAgentlessHostFacetData.additionalProperties);
  }
