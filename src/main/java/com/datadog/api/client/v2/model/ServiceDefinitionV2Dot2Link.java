...
public class ServiceDefinitionV2Dot2Link {
  ...
  /**
   * Link type. Datadog recognizes the following types: <code>runbook</code>, <code>doc</code>,
   * <code>repo</code>, <code>dashboard</code>, and <code>other</code>.
   *
   * @return type
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, serviceDefinitionV2Dot2Link.name)
        && Objects.equals(this.provider, serviceDefinitionV2Dot2Link.provider)
        && Objects.equals(this.type, serviceDefinitionV2Dot2Link.type)
        && Objects.equals(this.url, serviceDefinitionV2Dot2Link.url)
        && Objects.equals(
            this.additionalProperties, serviceDefinitionV2Dot2Link.additionalProperties);
  }
