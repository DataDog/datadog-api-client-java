...
public class SampleLogGenerationDuration extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("1h", "1d", "3d", "7d"));
  ...
  public static final SampleLogGenerationDuration THREE_DAYS = new SampleLogGenerationDuration("3d");
  public static final SampleLogGenerationDuration SEVEN_DAYS = new SampleLogGenerationDuration("7d");
  ...
  public static class SampleLogGenerationDurationSerializer extends StdSerializer<SampleLogGenerationDuration> {
      ...
      @Override
      public void serialize(SampleLogGenerationDuration value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
