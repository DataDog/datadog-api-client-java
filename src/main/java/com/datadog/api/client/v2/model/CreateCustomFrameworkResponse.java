...
@JsonPropertyOrder({CreateCustomFrameworkResponse.JSON_PROPERTY_DATA})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CreateCustomFrameworkResponse {
  @JsonIgnore public boolean unparsed = false;
  public static final String JSON_PROPERTY_DATA = "data";
  private PartialCustomFrameworkData data;

  public CreateCustomFrameworkResponse() {}

  @JsonCreator
  public CreateCustomFrameworkResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) PartialCustomFrameworkData data) {
    this.data = data;
    this.unparsed |= data.unparsed;
  }

  public CreateCustomFrameworkResponse data(PartialCustomFrameworkData data) {
    this.data = data;
    this.unparsed |= data.unparsed;
    return this;
  }
  ...
  public PartialCustomFrameworkData getData() {
    return data;
  }

  public void setData(PartialCustomFrameworkData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createCustomFrameworkResponse.data)
        && Objects.equals(
            this.additionalProperties, createCustomFrameworkResponse.additionalProperties);
  }
