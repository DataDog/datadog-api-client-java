...
public class FleetAutomationApi {
   ...
   * Create a schedule.
   *
   * <p>See {@link #createFleetScheduleWithHttpInfo}.
   *
   * @param body Request payload containing the schedule details. (required)
   * @return FleetScheduleResponse
   * @throws ApiException if fails to make API call
   */
  public FleetScheduleResponse createFleetSchedule(FleetScheduleCreateRequest body)
      throws ApiException {
   ...
   * Create a schedule.
   *
   * <p>See {@link #createFleetScheduleWithHttpInfoAsync}.
   *
   * @param body Request payload containing the schedule details. (required)
   * @return CompletableFuture&lt;FleetScheduleResponse&gt;
   */
  public CompletableFuture<FleetScheduleResponse> createFleetScheduleAsync(
      FleetScheduleCreateRequest body) {
    return createFleetScheduleWithHttpInfoAsync(body)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *
   * <p>Schedules define when and how often to automatically deploy package upgrades to a fleet of
   * hosts. Each schedule includes: - A filter query to select target hosts - A recurrence rule
   * defining maintenance windows - A version strategy (e.g., always latest, or N versions behind
   * latest)
   *
   ...
   *     </table>
   */
  public ApiResponse<FleetScheduleResponse> createFleetScheduleWithHttpInfo(
      FleetScheduleCreateRequest body) throws ApiException {
    // Check if unstable operation is enabled
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling createFleetSchedule");
    }
    // create path and map variables
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.FleetAutomationApi.createFleetSchedule",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   */
  public CompletableFuture<ApiResponse<FleetScheduleResponse>> createFleetScheduleWithHttpInfoAsync(
      FleetScheduleCreateRequest body) {
    // Check if unstable operation is enabled
    String operationId = "createFleetSchedule";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
   ...
   * Delete a schedule.
   *
   * <p>See {@link #deleteFleetScheduleWithHttpInfo}.
   *
   ...
   * Delete a schedule.
   *
   * <p>See {@link #deleteFleetScheduleWithHttpInfoAsync}.
   *
   * @param id The unique identifier of the schedule to delete. (required)
   * @return CompletableFuture
   */
  public CompletableFuture<Void> deleteFleetScheduleAsync(String id) {
    return deleteFleetScheduleWithHttpInfoAsync(id)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *
   * <p>When you delete a schedule: - The schedule is permanently removed and will no longer create
   * deployments - Any deployments already created by this schedule are not affected - This action
   * cannot be undone
   *
   * <p>If you want to temporarily stop a schedule from creating deployments, consider updating its
   * status to "inactive" instead of deleting it.
   *
   * @param id The unique identifier of the schedule to delete. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<Void> deleteFleetScheduleWithHttpInfo(String id) throws ApiException {
    ...
    if (id == null) {
      throw new ApiException(
          400, "Missing the required parameter 'id' when calling deleteFleetSchedule");
    }
    // create path and map variables
    String localVarPath =
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.FleetAutomationApi.deleteFleetSchedule",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   *
   * <p>See {@link #triggerFleetScheduleWithHttpInfo}.
   *
   ...
   * Trigger a schedule deployment.
   *
   * <p>See {@link #triggerFleetScheduleWithHttpInfoAsync}.
   *
   * @param id The unique identifier of the schedule to trigger. (required)
   * @return CompletableFuture&lt;FleetDeploymentResponse&gt;
   */
  public CompletableFuture<FleetDeploymentResponse> triggerFleetScheduleAsync(String id) {
    return triggerFleetScheduleWithHttpInfoAsync(id)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   * configuration, without waiting for the next scheduled maintenance window. This is useful for: -
   * Testing a schedule before it runs automatically - Performing an emergency update outside the
   * regular maintenance window - Creating an ad-hoc deployment with the same settings as a schedule
   *
   * <p>The deployment is created immediately with: - The same filter query as the schedule - The
   * package version determined by the schedule's version strategy - All matching hosts as targets
   *
   * <p>The manually triggered deployment is independent of the schedule and does not affect the
   * schedule's normal recurrence pattern.
   *
   * @param id The unique identifier of the schedule to trigger. (required)
   * @return ApiResponse&lt;FleetDeploymentResponse&gt;
   * @throws ApiException if fails to make API call
   ...
   *     </table>
   */
  public ApiResponse<FleetDeploymentResponse> triggerFleetScheduleWithHttpInfo(String id)
      throws ApiException {
    // Check if unstable operation is enabled
    ...
    if (id == null) {
      throw new ApiException(
          400, "Missing the required parameter 'id' when calling triggerFleetSchedule");
    }
    // create path and map variables
    String localVarPath =
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.FleetAutomationApi.triggerFleetSchedule",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   */
  public CompletableFuture<ApiResponse<FleetDeploymentResponse>>
      triggerFleetScheduleWithHttpInfoAsync(String id) {
    // Check if unstable operation is enabled
    String operationId = "triggerFleetSchedule";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
   ...
   * Update a schedule.
   *
   * <p>See {@link #updateFleetScheduleWithHttpInfo}.
   *
   ...
   * @throws ApiException if fails to make API call
   */
  public FleetScheduleResponse updateFleetSchedule(String id, FleetSchedulePatchRequest body)
      throws ApiException {
   ...
   * Update a schedule.
   *
   * <p>See {@link #updateFleetScheduleWithHttpInfoAsync}.
   *
   * @param id The unique identifier of the schedule to update. (required)
   * @param body Request payload containing the fields to update. (required)
   * @return CompletableFuture&lt;FleetScheduleResponse&gt;
   */
  public CompletableFuture<FleetScheduleResponse> updateFleetScheduleAsync(
      String id, FleetSchedulePatchRequest body) {
    return updateFleetScheduleWithHttpInfoAsync(id, body)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *
   * <p>This endpoint allows you to modify specific attributes of a schedule without affecting other
   * fields. Common use cases include: - Changing the schedule status between active and inactive -
   * Updating the maintenance window times - Modifying the filter query to target different hosts -
   * Adjusting the version strategy
   *
   * <p>Only include the fields you want to update in the request body. All fields are optional in a
   * PATCH request.
   *
   * @param id The unique identifier of the schedule to update. (required)
   * @param body Request payload containing the fields to update. (required)
   ...
   *     </table>
   */
  public ApiResponse<FleetScheduleResponse> updateFleetScheduleWithHttpInfo(
      String id, FleetSchedulePatchRequest body) throws ApiException {
    // Check if unstable operation is enabled
    ...
    if (id == null) {
      throw new ApiException(
          400, "Missing the required parameter 'id' when calling updateFleetSchedule");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling updateFleetSchedule");
    }
    // create path and map variables
    String localVarPath =
        "/api/unstable/fleet/schedules/{id}"
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.FleetAutomationApi.updateFleetSchedule",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   * @return CompletableFuture&lt;ApiResponse&lt;FleetScheduleResponse&gt;&gt;
   */
  public CompletableFuture<ApiResponse<FleetScheduleResponse>> updateFleetScheduleWithHttpInfoAsync(
      String id, FleetSchedulePatchRequest body) {
    // Check if unstable operation is enabled
    String operationId = "updateFleetSchedule";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
