...
/**
   * <p>The <code>azure_storage</code> destination forwards logs to an Azure Blob Storage container.</p>
...
public class AzureStorageDestination {
  ...
  /**
   * <p>Optional prefix for blobs written to the container.</p>
   * @return blobPrefix
  **/
  ...
  **/
  ...
  public AzureStorageDestination compression(ObservabilityPipelineAzureStorageDestinationCompression compression) {
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the Azure Storage connection string.</p>
  ...
  **/
  ...
  /**
   * <p>The name of the Azure Blob Storage container to store logs in.</p>
  ...
  **/
  ...
  /**
   * <p>The destination type. The value should always be <code>azure_storage</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blobPrefix, azureStorageDestination.blobPrefix) && Objects.equals(this.buffer, azureStorageDestination.buffer) && Objects.equals(this.compression, azureStorageDestination.compression) && Objects.equals(this.connectionStringKey, azureStorageDestination.connectionStringKey) && Objects.equals(this.containerName, azureStorageDestination.containerName) && Objects.equals(this.id, azureStorageDestination.id) && Objects.equals(this.inputs, azureStorageDestination.inputs) && Objects.equals(this.type, azureStorageDestination.type) && Objects.equals(this.additionalProperties, azureStorageDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(blobPrefix,buffer,compression,connectionStringKey,containerName,id,inputs,type, additionalProperties);
  }
