 ...
 */
@JsonPropertyOrder({
  LLMObsCursorMeta.JSON_PROPERTY_AFTER
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class LLMObsCursorMeta {
  @JsonIgnore
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_AFTER)public void setAfter_JsonNullable(JsonNullable<String> after) {
    this.after = after;
  }
  ...
  public boolean equals(Object o) {
    ...
    LLMObsCursorMeta llmObsCursorMeta = (LLMObsCursorMeta) o;
    return Objects.equals(this.after, llmObsCursorMeta.after) && Objects.equals(this.additionalProperties, llmObsCursorMeta.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LLMObsCursorMeta {\n");
