...
/**
   * <p>Metadata about the search results.</p>
 */
@JsonPropertyOrder({
...
public class WidgetSearchMeta {
  ...
  /**
   * <p>Total number of widgets created by anyone.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of widgets created by the current user.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of widgets favorited by the current user.</p>
  ...
  **/
  ...
  /**
   * <p>Total number of widgets matching the current filter criteria.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdByAnyoneTotal, widgetSearchMeta.createdByAnyoneTotal) && Objects.equals(this.createdByYouTotal, widgetSearchMeta.createdByYouTotal) && Objects.equals(this.favoritedByYouTotal, widgetSearchMeta.favoritedByYouTotal) && Objects.equals(this.filteredTotal, widgetSearchMeta.filteredTotal) && Objects.equals(this.additionalProperties, widgetSearchMeta.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdByAnyoneTotal,createdByYouTotal,favoritedByYouTotal,filteredTotal, additionalProperties);
  }
