...
/**
   * <p>Attributes of an aggregated waterfall response.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedWaterfallResponseAttributes {
  ...
  public AggregatedWaterfallResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RESOURCES)List<AggregatedResource> resources,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TOTAL_CACHE_HIT_RATE_PCT)Double totalCacheHitRatePct,
  ...
  **/
  ...
  /**
   * <p>Network resources in chronological waterfall order.</p>
   * @return resources
  **/
  ...
  **/
  ...
  /**
   * <p>Overall cache hit rate across all sampled views.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedWaterfallResponseAttributes aggregatedWaterfallResponseAttributes = (AggregatedWaterfallResponseAttributes) o;
    return Objects.equals(this.applicationId, aggregatedWaterfallResponseAttributes.applicationId) && Objects.equals(this.criteria, aggregatedWaterfallResponseAttributes.criteria) && Objects.equals(this.from, aggregatedWaterfallResponseAttributes.from) && Objects.equals(this.resources, aggregatedWaterfallResponseAttributes.resources) && Objects.equals(this.sampledViewIds, aggregatedWaterfallResponseAttributes.sampledViewIds) && Objects.equals(this.to, aggregatedWaterfallResponseAttributes.to) && Objects.equals(this.totalCacheHitRatePct, aggregatedWaterfallResponseAttributes.totalCacheHitRatePct) && Objects.equals(this.viewCount, aggregatedWaterfallResponseAttributes.viewCount) && Objects.equals(this.viewName, aggregatedWaterfallResponseAttributes.viewName) && Objects.equals(this.additionalProperties, aggregatedWaterfallResponseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(applicationId,criteria,from,resources,sampledViewIds,to,totalCacheHitRatePct,viewCount,viewName, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    totalCacheHitRatePct: ").append(toIndentedString(totalCacheHitRatePct)).append("\n");
