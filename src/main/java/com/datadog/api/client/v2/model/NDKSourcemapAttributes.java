...
/**
   * <p>Attributes of an Android NDK symbol file.</p>
 */
@JsonPropertyOrder({
  NDKSourcemapAttributes.JSON_PROPERTY_ARCH,
  NDKSourcemapAttributes.JSON_PROPERTY_BUILD_ID,
  NDKSourcemapAttributes.JSON_PROPERTY_CREATED_AT,
  NDKSourcemapAttributes.JSON_PROPERTY_FILE_NAME,
  NDKSourcemapAttributes.JSON_PROPERTY_MAPKIND,
  NDKSourcemapAttributes.JSON_PROPERTY_SIZE
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class NDKSourcemapAttributes {
  @JsonIgnore
  ...
  **/
  ...
  /**
   * <p>The build identifier (UUID format).</p>
   * @return buildId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The size of the symbol file in bytes.</p>
   * @return size
  **/
  ...
  public boolean equals(Object o) {
    ...
    NDKSourcemapAttributes ndkSourcemapAttributes = (NDKSourcemapAttributes) o;
    return Objects.equals(this.arch, ndkSourcemapAttributes.arch) && Objects.equals(this.buildId, ndkSourcemapAttributes.buildId) && Objects.equals(this.createdAt, ndkSourcemapAttributes.createdAt) && Objects.equals(this.fileName, ndkSourcemapAttributes.fileName) && Objects.equals(this.mapkind, ndkSourcemapAttributes.mapkind) && Objects.equals(this.size, ndkSourcemapAttributes.size) && Objects.equals(this.additionalProperties, ndkSourcemapAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(arch,buildId,createdAt,fileName,mapkind,size, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NDKSourcemapAttributes {\n");
