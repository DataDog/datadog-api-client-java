...
public class RumMetricUniquenessWhen extends ModelEnum<String> {
  ...
  public static final RumMetricUniquenessWhen MATCH = new RumMetricUniquenessWhen("match");
  public static final RumMetricUniquenessWhen END = new RumMetricUniquenessWhen("end");
