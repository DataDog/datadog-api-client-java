...
public class RumMetricUniquenessWhen extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("match", "end"));
  ...
  public static class RumMetricUniquenessWhenSerializer extends StdSerializer<RumMetricUniquenessWhen> {
      ...
      @Override
      public void serialize(RumMetricUniquenessWhen value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
