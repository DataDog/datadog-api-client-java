 ...
 */
@JsonPropertyOrder({
  OrgConnectionCreateRelationships.JSON_PROPERTY_SINK_ORG
})
...
public class OrgConnectionCreateRelationships {
  ...
  @JsonCreator
  public OrgConnectionCreateRelationships(
            @JsonProperty(required=true, value=JSON_PROPERTY_SINK_ORG)OrgConnectionOrgRelationship sinkOrg) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrgConnectionCreateRelationships orgConnectionCreateRelationships = (OrgConnectionCreateRelationships) o;
    return Objects.equals(this.sinkOrg, orgConnectionCreateRelationships.sinkOrg) && Objects.equals(this.additionalProperties, orgConnectionCreateRelationships.additionalProperties);
  }
