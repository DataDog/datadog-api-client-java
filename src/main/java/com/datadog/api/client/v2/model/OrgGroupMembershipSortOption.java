...
/**
   * <p>Field to sort memberships by.</p>
 */
...
public class OrgGroupMembershipSortOption extends ModelEnum<String> {
  ...
  public static final OrgGroupMembershipSortOption MINUS_NAME = new OrgGroupMembershipSortOption("-name");
  public static final OrgGroupMembershipSortOption UUID = new OrgGroupMembershipSortOption("uuid");
  public static final OrgGroupMembershipSortOption MINUS_UUID = new OrgGroupMembershipSortOption("-uuid");
  ...
  public static class OrgGroupMembershipSortOptionSerializer extends StdSerializer<OrgGroupMembershipSortOption> {
      ...
      @Override
      public void serialize(OrgGroupMembershipSortOption value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
