 ...
 */
  ...
  public ApiResponse<IPAllowlistResponse> getIPAllowlistWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IpAllowlistApi.getIPAllowlist", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<IPAllowlistResponse>> getIPAllowlistWithHttpInfoAsync() {
    ...
    try {
      builder = apiClient.createBuilder("v2.IpAllowlistApi.getIPAllowlist", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public ApiResponse<IPAllowlistResponse> updateIPAllowlistWithHttpInfo(IPAllowlistUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IpAllowlistApi.updateIPAllowlist", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<IPAllowlistResponse>> updateIPAllowlistWithHttpInfoAsync(IPAllowlistUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.IpAllowlistApi.updateIPAllowlist", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IPAllowlistResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
