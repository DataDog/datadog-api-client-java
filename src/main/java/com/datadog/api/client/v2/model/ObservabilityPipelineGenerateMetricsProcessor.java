...
/**
   * <p>The <code>generate_datadog_metrics</code> processor creates custom metrics from logs and sends them to Datadog.
   * Metrics can be counters, gauges, or distributions and optionally grouped by log fields.</p>
...
public class ObservabilityPipelineGenerateMetricsProcessor {
  ...
  private ObservabilityPipelineGenerateMetricsProcessorType type = ObservabilityPipelineGenerateMetricsProcessorType.GENERATE_DATADOG_METRICS;
  ...
  public ObservabilityPipelineGenerateMetricsProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineGenerateMetricsProcessorType type) {
  ...
  **/
  ...
  public ObservabilityPipelineGenerateMetricsProcessor metrics(List<ObservabilityPipelineGeneratedMetric> metrics) {
  ...
  public ObservabilityPipelineGenerateMetricsProcessor addMetricsItem(ObservabilityPipelineGeneratedMetric metricsItem) {
  ...
  /**
   * <p>Configuration for generating individual metrics.</p>
   * @return metrics
  **/
      @jakarta.annotation.Nullable
  ...
  public ObservabilityPipelineGenerateMetricsProcessor type(ObservabilityPipelineGenerateMetricsProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineGenerateMetricsProcessor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineGenerateMetricsProcessor observabilityPipelineGenerateMetricsProcessor = (ObservabilityPipelineGenerateMetricsProcessor) o;
    return Objects.equals(this.displayName, observabilityPipelineGenerateMetricsProcessor.displayName) && Objects.equals(this.enabled, observabilityPipelineGenerateMetricsProcessor.enabled) && Objects.equals(this.id, observabilityPipelineGenerateMetricsProcessor.id) && Objects.equals(this.include, observabilityPipelineGenerateMetricsProcessor.include) && Objects.equals(this.metrics, observabilityPipelineGenerateMetricsProcessor.metrics) && Objects.equals(this.type, observabilityPipelineGenerateMetricsProcessor.type) && Objects.equals(this.additionalProperties, observabilityPipelineGenerateMetricsProcessor.additionalProperties);
  }
