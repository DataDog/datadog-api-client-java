...
public class OCIConfigAttributes {
  ...
  public OCIConfigAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS_UPDATED_AT)String statusUpdatedAt,
  ...
  /**
   * <p>The OCID of the OCI tenancy.</p>
   * @return accountId
  **/
  ...
  /**
   * <p>The timestamp when the OCI config was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The error messages for the OCI config.</p>
  ...
  **/
  ...
  /**
   * <p>The status of the OCI config.</p>
   * @return status
  **/
  ...
  /**
   * <p>The timestamp when the OCI config status was last updated.</p>
  ...
  **/
  ...
  /**
   * <p>The timestamp when the OCI config was last updated.</p>
   * @return updatedAt
  **/
