...
/**
   * <p>Response with notification templates.</p>
 */
@JsonPropertyOrder({
...
public class IncidentNotificationTemplateArray {
  ...
  @JsonCreator
  public IncidentNotificationTemplateArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<IncidentNotificationTemplateResponseData> data) {
        this.data = data;
  }
  public IncidentNotificationTemplateArray data(List<IncidentNotificationTemplateResponseData> data) {
    this.data = data;
  ...
  public IncidentNotificationTemplateArray addDataItem(IncidentNotificationTemplateResponseData dataItem) {
  ...
  /**
   * <p>The <code>NotificationTemplateArray</code> <code>data</code>.</p>
   * @return data
  **/
  ...
  public IncidentNotificationTemplateArray included(List<IncidentNotificationTemplateIncludedItems> included) {
  ...
  public IncidentNotificationTemplateArray addIncludedItem(IncidentNotificationTemplateIncludedItems includedItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentNotificationTemplateArray incidentNotificationTemplateArray = (IncidentNotificationTemplateArray) o;
    return Objects.equals(this.data, incidentNotificationTemplateArray.data) && Objects.equals(this.included, incidentNotificationTemplateArray.included) && Objects.equals(this.meta, incidentNotificationTemplateArray.meta) && Objects.equals(this.additionalProperties, incidentNotificationTemplateArray.additionalProperties);
  }
