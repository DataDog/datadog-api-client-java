...
public class PaginationMetaPageType extends ModelEnum<String> {
  ...
  public static final PaginationMetaPageType OFFSET_LIMIT = new PaginationMetaPageType("offset_limit");
  ...
  public static class PaginationMetaPageTypeSerializer extends StdSerializer<PaginationMetaPageType> {
      ...
      @Override
      public void serialize(PaginationMetaPageType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
