...
@JsonDeserialize(using = CIAppGroupByMissing.CIAppGroupByMissingDeserializer.class)
@JsonSerialize(using = CIAppGroupByMissing.CIAppGroupByMissingSerializer.class)
public class CIAppGroupByMissing extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CIAppGroupByMissing.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class CIAppGroupByMissingSerializer extends StdSerializer<CIAppGroupByMissing> {
        public CIAppGroupByMissingSerializer(Class<CIAppGroupByMissing> t) {
            super(t);
        }

        public CIAppGroupByMissingSerializer() {
            this(null);
        }

        @Override
        public void serialize(CIAppGroupByMissing value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CIAppGroupByMissingDeserializer extends StdDeserializer<CIAppGroupByMissing> {
        public CIAppGroupByMissingDeserializer() {
            this(CIAppGroupByMissing.class);
        }

        public CIAppGroupByMissingDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CIAppGroupByMissing deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            CIAppGroupByMissing ret = new CIAppGroupByMissing();
            if (match == 1) {
         ...
         */
        @Override
        public CIAppGroupByMissing getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CIAppGroupByMissing cannot be null");
        }
    }
    ...
    public CIAppGroupByMissing() {
        super("oneOf", Boolean.FALSE);
    }
    public CIAppGroupByMissing(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public CIAppGroupByMissing(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CIAppGroupByMissing.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return CIAppGroupByMissing.schemas;
    }
