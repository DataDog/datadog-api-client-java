...
public class FlagSuggestionEventDataType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("flag-suggestion-events"));
  ...
  public static class FlagSuggestionEventDataTypeSerializer
      extends StdSerializer<FlagSuggestionEventDataType> {
    public FlagSuggestionEventDataTypeSerializer(Class<FlagSuggestionEventDataType> t) {
      super(t);
    }
