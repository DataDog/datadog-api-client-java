...
public class SharedDashboardRelationships {
  ...
  public static final String JSON_PROPERTY_SHARER = "sharer";
  private SharedDashboardRelationshipSharer sharer;
   ...
   * @return SharedDashboardRelationships
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class SharedDashboardRelationships {\n");
