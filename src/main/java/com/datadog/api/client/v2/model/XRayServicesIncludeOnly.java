...
/**
   * <p>Include only these services. Defaults to <code>[]</code>.</p>
 */
@JsonPropertyOrder({
  XRayServicesIncludeOnly.JSON_PROPERTY_INCLUDE_ONLY
})
...
public class XRayServicesIncludeOnly {
  ...
  /**
   * <p>Include only these services.</p>
   * @return includeOnly
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeOnly, xRayServicesIncludeOnly.includeOnly) && Objects.equals(this.additionalProperties, xRayServicesIncludeOnly.additionalProperties);
  }
