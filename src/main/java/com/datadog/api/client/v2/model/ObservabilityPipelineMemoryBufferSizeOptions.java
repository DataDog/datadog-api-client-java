...
/**
   * <p>Options for configuring a memory buffer by queue length.</p>
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineMemoryBufferSizeOptions {
  ...
  private ObservabilityPipelineBufferOptionsMemoryType type = ObservabilityPipelineBufferOptionsMemoryType.MEMORY;

  public static final String JSON_PROPERTY_WHEN_FULL = "when_full";
  private ObservabilityPipelineBufferOptionsWhenFull whenFull = ObservabilityPipelineBufferOptionsWhenFull.BLOCK;
  ...
  /**
   * <p>Maximum events for the memory buffer.</p>
   * @return maxEvents
  **/
  ...
  public ObservabilityPipelineMemoryBufferSizeOptions type(ObservabilityPipelineBufferOptionsMemoryType type) {
    this.type = type;
  ...
  **/
  ...
  public ObservabilityPipelineMemoryBufferSizeOptions whenFull(ObservabilityPipelineBufferOptionsWhenFull whenFull) {
  ...
  /**
   * <p>Behavior when the buffer is full (block and stop accepting new events, or drop new events)</p>
   * @return whenFull
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineMemoryBufferSizeOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineMemoryBufferSizeOptions observabilityPipelineMemoryBufferSizeOptions = (ObservabilityPipelineMemoryBufferSizeOptions) o;
    return Objects.equals(this.maxEvents, observabilityPipelineMemoryBufferSizeOptions.maxEvents) && Objects.equals(this.type, observabilityPipelineMemoryBufferSizeOptions.type) && Objects.equals(this.whenFull, observabilityPipelineMemoryBufferSizeOptions.whenFull) && Objects.equals(this.additionalProperties, observabilityPipelineMemoryBufferSizeOptions.additionalProperties);
  }
