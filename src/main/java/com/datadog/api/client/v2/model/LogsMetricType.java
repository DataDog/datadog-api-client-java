...
public class LogsMetricType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs_metrics"));
  ...
  public static class LogsMetricTypeSerializer extends StdSerializer<LogsMetricType> {
      ...
      @Override
      public void serialize(LogsMetricType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
