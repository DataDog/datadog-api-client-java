...
/** The definition of <code>AppBuilderError</code> object. */
...
public class AppBuilderError {
  ...
  private List<AppBuilderErrorErrorsItems> errors = null;

  public AppBuilderError errors(List<AppBuilderErrorErrorsItems> errors) {
    this.errors = errors;
  ...
  /**
   * The <code>AppBuilderError</code> <code>errors</code>.
   *
   * @return errors
   */
  ...
  public List<AppBuilderErrorErrorsItems> getErrors() {
    return errors;
  }

  public void setErrors(List<AppBuilderErrorErrorsItems> errors) {
    this.errors = errors;
  }
