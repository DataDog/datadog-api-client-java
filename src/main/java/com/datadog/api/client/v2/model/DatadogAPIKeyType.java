...
public class DatadogAPIKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("DatadogAPIKey"));
  ...
  public static class DatadogAPIKeyTypeSerializer extends StdSerializer<DatadogAPIKeyType> {
      ...
      @Override
      public void serialize(DatadogAPIKeyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
