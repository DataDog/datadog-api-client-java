...
public class TriggerInvestigationRequestData {
  ...
  @JsonCreator
  public TriggerInvestigationRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)TriggerInvestigationRequestDataAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)TriggerInvestigationRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public TriggerInvestigationRequestData attributes(TriggerInvestigationRequestDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for the trigger investigation request.</p>
   * @return attributes
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TriggerInvestigationRequestData triggerInvestigationRequestData = (TriggerInvestigationRequestData) o;
    return Objects.equals(this.attributes, triggerInvestigationRequestData.attributes) && Objects.equals(this.type, triggerInvestigationRequestData.type) && Objects.equals(this.additionalProperties, triggerInvestigationRequestData.additionalProperties);
  }
