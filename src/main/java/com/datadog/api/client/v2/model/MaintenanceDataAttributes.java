...
@JsonPropertyOrder({
  ...
  MaintenanceDataAttributes.JSON_PROPERTY_START_DATE,
  MaintenanceDataAttributes.JSON_PROPERTY_STATUS,
...
public class MaintenanceDataAttributes {
  ...
  private List<MaintenanceDataAttributesComponentsAffectedItems> componentsAffected = null;
  ...
  **/
  ...
  /**
   * <p>Whether the maintenance was backfilled.</p>
   * @return isBackfilled
  **/
      @jakarta.annotation.Nullable
  ...
  **/
   ...
   * @return MaintenanceDataAttributes
   */
  @JsonAnySetter
