...
public class MaintenanceDataAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(completedDate,completedDescription,componentsAffected,inProgressDescription,isBackfilled,modifiedAt,publishedDate,scheduledDescription,startDate,status,title,updates, additionalProperties);
  }
