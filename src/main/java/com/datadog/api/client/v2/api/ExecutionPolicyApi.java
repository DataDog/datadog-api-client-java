...
public class ExecutionPolicyApi {
   ...
   *
   * <p>See {@link #createExecutionPolicyWithHttpInfo}.
   *
   * @param body The execution policy to create. (required)
   * @return ExecutionPolicyResponse
   * @throws ApiException if fails to make API call
   */
  public ExecutionPolicyResponse createExecutionPolicy(ExecutionPolicyCreateRequest body)
      throws ApiException {
   ...
   * Create an execution policy.
   *
   * <p>See {@link #createExecutionPolicyWithHttpInfoAsync}.
   *
   * @param body The execution policy to create. (required)
   * @return CompletableFuture&lt;ExecutionPolicyResponse&gt;
   */
  public CompletableFuture<ExecutionPolicyResponse> createExecutionPolicyAsync(
      ExecutionPolicyCreateRequest body) {
    return createExecutionPolicyWithHttpInfoAsync(body)
        .thenApply(
            response -> {
   ...
   *     </table>
   */
  public ApiResponse<ExecutionPolicyResponse> createExecutionPolicyWithHttpInfo(
      ExecutionPolicyCreateRequest body) throws ApiException {
    ...
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling createExecutionPolicy");
    }
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ExecutionPolicyApi.createExecutionPolicy",
            localVarPath,
            new ArrayList<Pair>(),
    ...
    return apiClient.invokeAPI(
        ...
        false,
        new GenericType<ExecutionPolicyResponse>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<ExecutionPolicyResponse>>
      createExecutionPolicyWithHttpInfoAsync(ExecutionPolicyCreateRequest body) {
    // Check if unstable operation is enabled
    String operationId = "createExecutionPolicy";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
   ...
   *
   * <p>See {@link #deleteExecutionPolicyWithHttpInfo}.
   *
   ...
   * Delete an execution policy.
   *
   * <p>See {@link #deleteExecutionPolicyWithHttpInfoAsync}.
   *
   * @param policyId The ID of the execution policy. (required)
   * @return CompletableFuture
   */
  public CompletableFuture<Void> deleteExecutionPolicyAsync(String policyId) {
    return deleteExecutionPolicyWithHttpInfoAsync(policyId)
        .thenApply(
            response -> {
              return response.getData();
            });
  ...
  public ApiResponse<Void> deleteExecutionPolicyWithHttpInfo(String policyId) throws ApiException {
    ...
    if (policyId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'policyId' when calling deleteExecutionPolicy");
    }
    // create path and map variables
    String localVarPath =
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ExecutionPolicyApi.deleteExecutionPolicy",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   */
  public CompletableFuture<ApiResponse<Void>> deleteExecutionPolicyWithHttpInfoAsync(
      String policyId) {
    // Check if unstable operation is enabled
    String operationId = "deleteExecutionPolicy";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
   ...
   *
   * <p>See {@link #getExecutionPolicyWithHttpInfo}.
   *
   * @param policyId The ID of the execution policy. (required)
   * @return ExecutionPolicyResponse
   * @throws ApiException if fails to make API call
   ...
   * Get an execution policy.
   *
   * <p>See {@link #getExecutionPolicyWithHttpInfoAsync}.
   *
   * @param policyId The ID of the execution policy. (required)
   * @return CompletableFuture&lt;ExecutionPolicyResponse&gt;
   */
  public CompletableFuture<ExecutionPolicyResponse> getExecutionPolicyAsync(String policyId) {
    return getExecutionPolicyWithHttpInfoAsync(policyId)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<ExecutionPolicyResponse> getExecutionPolicyWithHttpInfo(String policyId)
      throws ApiException {
    // Check if unstable operation is enabled
    ...
    if (policyId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'policyId' when calling getExecutionPolicy");
    }
    // create path and map variables
    String localVarPath =
        "/api/v2/actions/execution-policies/{policy_id}"
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ExecutionPolicyApi.getExecutionPolicy",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   */
  public CompletableFuture<ApiResponse<ExecutionPolicyResponse>>
      getExecutionPolicyWithHttpInfoAsync(String policyId) {
    // Check if unstable operation is enabled
    String operationId = "getExecutionPolicy";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
  ...
  public static class ListExecutionPoliciesOptionalParameters {
     ...
     * Set pageSize.
     *
     * @param pageSize The number of execution policies to return per page. (optional, default to
     *     100)
     ...
     * @return ListExecutionPoliciesOptionalParameters
     */
    public ListExecutionPoliciesOptionalParameters filterIntegration(
        List<ExecutionPolicyIntegration> filterIntegration) {
     ...
     * @return ListExecutionPoliciesOptionalParameters
     */
    public ListExecutionPoliciesOptionalParameters filterEffects(
        List<ExecutionPolicyEffect> filterEffects) {
     ...
     * Set sort.
     *
     * @param sort The sort order for the results. Prefix a field with <code>-</code> to sort in
     *     descending order. Valid fields are <code>name</code>, <code>effect</code>, <code>
     *     integration</code>, <code>created_at</code>, and <code>updated_at</code>. (optional)
     * @return ListExecutionPoliciesOptionalParameters
     */
   ...
   *
   * <p>See {@link #listExecutionPoliciesWithHttpInfo}.
   *
   * @return ExecutionPolicyListResponse
   * @throws ApiException if fails to make API call
   */
  public ExecutionPolicyListResponse listExecutionPolicies() throws ApiException {
    return listExecutionPoliciesWithHttpInfo(new ListExecutionPoliciesOptionalParameters())
        .getData();
  }
   ...
   * List execution policies.
   *
   * <p>See {@link #listExecutionPoliciesWithHttpInfoAsync}.
   *
  ...
  public CompletableFuture<ExecutionPolicyListResponse> listExecutionPoliciesAsync() {
    return listExecutionPoliciesWithHttpInfoAsync(new ListExecutionPoliciesOptionalParameters())
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   * @throws ApiException if fails to make API call
   */
  public ExecutionPolicyListResponse listExecutionPolicies(
      ListExecutionPoliciesOptionalParameters parameters) throws ApiException {
   ...
   */
  public CompletableFuture<ExecutionPolicyListResponse> listExecutionPoliciesAsync(
      ListExecutionPoliciesOptionalParameters parameters) {
    return listExecutionPoliciesWithHttpInfoAsync(parameters)
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<ExecutionPolicyListResponse> listExecutionPoliciesWithHttpInfo(
      ListExecutionPoliciesOptionalParameters parameters) throws ApiException {
    // Check if unstable operation is enabled
    ...
    localVarQueryParams.addAll(
        apiClient.parameterToPairs("multi", "filter[effects]", filterEffects));
    localVarQueryParams.addAll(
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ExecutionPolicyApi.listExecutionPolicies",
            localVarPath,
            localVarQueryParams,
            localVarHeaderParams,
            new HashMap<String, String>(),
    ...
    return apiClient.invokeAPI(
        ...
        new HashMap<String, Object>(),
        false,
        new GenericType<ExecutionPolicyListResponse>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<ExecutionPolicyListResponse>>
      listExecutionPoliciesWithHttpInfoAsync(ListExecutionPoliciesOptionalParameters parameters) {
    // Check if unstable operation is enabled
    String operationId = "listExecutionPolicies";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
    } else {
      CompletableFuture<ApiResponse<ExecutionPolicyListResponse>> result =
   ...
   *
   * <p>See {@link #updateExecutionPolicyWithHttpInfo}.
   *
   * @param policyId The ID of the execution policy. (required)
   ...
   * @throws ApiException if fails to make API call
   */
  public ExecutionPolicyResponse updateExecutionPolicy(
      String policyId, ExecutionPolicyUpdateRequest body) throws ApiException {
   ...
   * Update an execution policy.
   *
   * <p>See {@link #updateExecutionPolicyWithHttpInfoAsync}.
   *
   * @param policyId The ID of the execution policy. (required)
   * @param body The new execution policy. (required)
   * @return CompletableFuture&lt;ExecutionPolicyResponse&gt;
   */
  public CompletableFuture<ExecutionPolicyResponse> updateExecutionPolicyAsync(
      String policyId, ExecutionPolicyUpdateRequest body) {
    return updateExecutionPolicyWithHttpInfoAsync(policyId, body)
        .thenApply(
            response -> {
              return response.getData();
            });
  ...
  /**
   * Update an existing execution policy. Returns the execution policy object when the request is
   * successful.
   *
   * @param policyId The ID of the execution policy. (required)
   * @param body The new execution policy. (required)
   ...
   *     </table>
   */
  public ApiResponse<ExecutionPolicyResponse> updateExecutionPolicyWithHttpInfo(
      String policyId, ExecutionPolicyUpdateRequest body) throws ApiException {
    // Check if unstable operation is enabled
    ...
    if (policyId == null) {
      throw new ApiException(
          400, "Missing the required parameter 'policyId' when calling updateExecutionPolicy");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(
          400, "Missing the required parameter 'body' when calling updateExecutionPolicy");
    }
    // create path and map variables
    String localVarPath =
        "/api/v2/actions/execution-policies/{policy_id}"
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.ExecutionPolicyApi.updateExecutionPolicy",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
   ...
   */
  public CompletableFuture<ApiResponse<ExecutionPolicyResponse>>
      updateExecutionPolicyWithHttpInfoAsync(String policyId, ExecutionPolicyUpdateRequest body) {
    // Check if unstable operation is enabled
    String operationId = "updateExecutionPolicy";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
