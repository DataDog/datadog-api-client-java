...
/**
   * <p>Google Chat configuration data in a response.</p>
 */
@JsonPropertyOrder({
...
public class IncidentGoogleChatConfigurationDataResponse {
  ...
  @JsonCreator
  public IncidentGoogleChatConfigurationDataResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)IncidentGoogleChatConfigurationDataAttributesResponse attributes,
  ...
  public IncidentGoogleChatConfigurationDataResponse attributes(IncidentGoogleChatConfigurationDataAttributesResponse attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public IncidentGoogleChatConfigurationDataResponse relationships(IncidentGoogleChatConfigurationRelationships relationships) {
  ...
  **/
  ...
  public IncidentGoogleChatConfigurationDataResponse type(IncidentGoogleChatConfigurationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public IncidentGoogleChatConfigurationDataResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentGoogleChatConfigurationDataResponse incidentGoogleChatConfigurationDataResponse = (IncidentGoogleChatConfigurationDataResponse) o;
    return Objects.equals(this.attributes, incidentGoogleChatConfigurationDataResponse.attributes) && Objects.equals(this.id, incidentGoogleChatConfigurationDataResponse.id) && Objects.equals(this.relationships, incidentGoogleChatConfigurationDataResponse.relationships) && Objects.equals(this.type, incidentGoogleChatConfigurationDataResponse.type) && Objects.equals(this.additionalProperties, incidentGoogleChatConfigurationDataResponse.additionalProperties);
  }
