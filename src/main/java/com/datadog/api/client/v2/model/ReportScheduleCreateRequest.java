...
/**
   * <p>Request body for creating a report schedule.</p>
 */
@JsonPropertyOrder({
  ReportScheduleCreateRequest.JSON_PROPERTY_DATA
})
...
public class ReportScheduleCreateRequest {
  ...
  @JsonCreator
  public ReportScheduleCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ReportScheduleCreateRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, reportScheduleCreateRequest.data) && Objects.equals(this.additionalProperties, reportScheduleCreateRequest.additionalProperties);
  }
