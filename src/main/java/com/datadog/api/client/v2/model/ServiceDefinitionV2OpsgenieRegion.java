...
public class ServiceDefinitionV2OpsgenieRegion extends ModelEnum<String> {
  ...
  public static final ServiceDefinitionV2OpsgenieRegion US = new ServiceDefinitionV2OpsgenieRegion("US");
  public static final ServiceDefinitionV2OpsgenieRegion EU = new ServiceDefinitionV2OpsgenieRegion("EU");
  ...
  public static class ServiceDefinitionV2OpsgenieRegionSerializer extends StdSerializer<ServiceDefinitionV2OpsgenieRegion> {
      ...
      @Override
      public void serialize(ServiceDefinitionV2OpsgenieRegion value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
