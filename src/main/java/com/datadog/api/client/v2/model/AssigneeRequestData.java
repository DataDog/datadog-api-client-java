...
public class AssigneeRequestData {
  ...
  @JsonCreator
  public AssigneeRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)AssigneeRequestDataRelationships relationships,
