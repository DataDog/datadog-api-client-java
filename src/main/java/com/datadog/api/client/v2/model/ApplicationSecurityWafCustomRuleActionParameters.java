...
public class ApplicationSecurityWafCustomRuleActionParameters {
  ...
  /**
   * <p>The location to redirect to when the WAF custom rule triggers.</p>
   * @return location
  **/
  ...
  /**
   * <p>The status code to return when the WAF custom rule triggers.</p>
   * @return statusCode
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public ApplicationSecurityWafCustomRuleActionParameters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleActionParameters applicationSecurityWafCustomRuleActionParameters = (ApplicationSecurityWafCustomRuleActionParameters) o;
