...
public class AnnotationColor extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("gray", "blue", "purple", "green", "yellow", "red"));
  ...
  public static class AnnotationColorSerializer extends StdSerializer<AnnotationColor> {
      ...
      @Override
      public void serialize(AnnotationColor value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
