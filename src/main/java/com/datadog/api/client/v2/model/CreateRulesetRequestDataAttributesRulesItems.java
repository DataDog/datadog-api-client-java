...
/**
   * <p>The definition of <code>CreateRulesetRequestDataAttributesRulesItems</code> object.</p>
 */
@JsonPropertyOrder({
...
public class CreateRulesetRequestDataAttributesRulesItems {
  ...
  private JsonNullable<CreateRulesetRequestDataAttributesRulesItemsQuery> query = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsQuery>undefined();

  public static final String JSON_PROPERTY_REFERENCE_TABLE = "reference_table";
  private JsonNullable<CreateRulesetRequestDataAttributesRulesItemsReferenceTable> referenceTable = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsReferenceTable>undefined();
  ...
  **/
  ...
  public CreateRulesetRequestDataAttributesRulesItems mapping(DataAttributesRulesItemsMapping mapping) {
  ...
  **/
  ...
  public CreateRulesetRequestDataAttributesRulesItems putMetadataItem(String key, String metadataItem) {
  ...
  **/
  ...
  public CreateRulesetRequestDataAttributesRulesItems query(CreateRulesetRequestDataAttributesRulesItemsQuery query) {
    this.query = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsQuery>of(query);
    return this;
  }

  /**
   * <p>The definition of <code>CreateRulesetRequestDataAttributesRulesItemsQuery</code> object.</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_QUERY)public void setQuery_JsonNullable(JsonNullable<CreateRulesetRequestDataAttributesRulesItemsQuery> query) {
    this.query = query;
  }
  public void setQuery(CreateRulesetRequestDataAttributesRulesItemsQuery query) {
    this.query = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsQuery>of(query);
  }
  public CreateRulesetRequestDataAttributesRulesItems referenceTable(CreateRulesetRequestDataAttributesRulesItemsReferenceTable referenceTable) {
    this.referenceTable = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsReferenceTable>of(referenceTable);
    return this;
  }
  ...
  **/
  ...
  @JsonInclude(
    value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<CreateRulesetRequestDataAttributesRulesItemsReferenceTable> getReferenceTable_JsonNullable() {
    return referenceTable;
  }
  @JsonProperty(JSON_PROPERTY_REFERENCE_TABLE)public void setReferenceTable_JsonNullable(JsonNullable<CreateRulesetRequestDataAttributesRulesItemsReferenceTable> referenceTable) {
    this.referenceTable = referenceTable;
  }
  public void setReferenceTable(CreateRulesetRequestDataAttributesRulesItemsReferenceTable referenceTable) {
    this.referenceTable = JsonNullable.<CreateRulesetRequestDataAttributesRulesItemsReferenceTable>of(referenceTable);
  }
   ...
   */
  @JsonAnySetter
  public CreateRulesetRequestDataAttributesRulesItems putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateRulesetRequestDataAttributesRulesItems createRulesetRequestDataAttributesRulesItems = (CreateRulesetRequestDataAttributesRulesItems) o;
    return Objects.equals(this.enabled, createRulesetRequestDataAttributesRulesItems.enabled) && Objects.equals(this.mapping, createRulesetRequestDataAttributesRulesItems.mapping) && Objects.equals(this.metadata, createRulesetRequestDataAttributesRulesItems.metadata) && Objects.equals(this.name, createRulesetRequestDataAttributesRulesItems.name) && Objects.equals(this.query, createRulesetRequestDataAttributesRulesItems.query) && Objects.equals(this.referenceTable, createRulesetRequestDataAttributesRulesItems.referenceTable) && Objects.equals(this.additionalProperties, createRulesetRequestDataAttributesRulesItems.additionalProperties);
  }
