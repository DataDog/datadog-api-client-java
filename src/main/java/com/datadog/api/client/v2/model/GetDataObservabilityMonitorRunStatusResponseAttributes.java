...
public class GetDataObservabilityMonitorRunStatusResponseAttributes {
  ...
  @JsonCreator
  public GetDataObservabilityMonitorRunStatusResponseAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)DataObservabilityMonitorRunStatus status) {
        this.status = status;
  ...
  /**
   * <p>Error message describing why the monitor run failed. Only present when status is error.</p>
   * @return errorMessage
  **/
  ...
  public GetDataObservabilityMonitorRunStatusResponseAttributes status(DataObservabilityMonitorRunStatus status) {
    this.status = status;
    this.unparsed |= !status.isValid();
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public GetDataObservabilityMonitorRunStatusResponseAttributes putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this GetDataObservabilityMonitorRunStatusResponseAttributes object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    GetDataObservabilityMonitorRunStatusResponseAttributes getDataObservabilityMonitorRunStatusResponseAttributes = (GetDataObservabilityMonitorRunStatusResponseAttributes) o;
    return Objects.equals(this.errorMessage, getDataObservabilityMonitorRunStatusResponseAttributes.errorMessage) && Objects.equals(this.status, getDataObservabilityMonitorRunStatusResponseAttributes.status) && Objects.equals(this.additionalProperties, getDataObservabilityMonitorRunStatusResponseAttributes.additionalProperties);
  }
