...
/**
   * <p>Azure Virtual Machine Reserved Instance commitment details.</p>
 */
@JsonPropertyOrder({
...
public class CommitmentsAzureVMRICommitment {
  ...
  public CommitmentsAzureVMRICommitment(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_METER_SUB_CATEGORY)String meterSubCategory,
            @JsonProperty(required=true, value=JSON_PROPERTY_REGION)String region,
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)CommitmentsAzureVMRIStatus status) {
  ...
  /**
   * <p>The display name of the Azure reservation.</p>
   * @return benefitName
  **/
  ...
  **/
  ...
  /**
   * <p>The Azure VM instance type.</p>
   * @return instanceType
  **/
  ...
  /**
   * <p>The Azure meter sub-category for the reservation.</p>
  ...
  **/
  ...
  /**
   * <p>The Azure region of the Reserved Instance.</p>
   * @return region
  **/
