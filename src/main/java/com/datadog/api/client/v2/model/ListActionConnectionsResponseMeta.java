...
@JsonPropertyOrder({
  ListActionConnectionsResponseMeta.JSON_PROPERTY_INTEGRATION_COUNTS,
  ListActionConnectionsResponseMeta.JSON_PROPERTY_TOTAL,
  ListActionConnectionsResponseMeta.JSON_PROPERTY_TOTAL_FILTERED
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ListActionConnectionsResponseMeta {
  ...
  public ListActionConnectionsResponseMeta() {}
  ...
  public ListActionConnectionsResponseMeta integrationCounts(
      List<IntegrationCounts> integrationCounts) {
    this.integrationCounts = JsonNullable.<List<IntegrationCounts>>of(integrationCounts);
    return this;
  }

  public ListActionConnectionsResponseMeta addIntegrationCountsItem(
  ...
  public ListActionConnectionsResponseMeta total(Long total) {
    this.total = total;
    return this;
  }
  ...
  public ListActionConnectionsResponseMeta totalFiltered(Long totalFiltered) {
    this.totalFiltered = totalFiltered;
    return this;
  }
   ...
   * @return ListActionConnectionsResponseMeta
   */
  @JsonAnySetter
  public ListActionConnectionsResponseMeta putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this ListActionConnectionsResponseMeta object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ListActionConnectionsResponseMeta listActionConnectionsResponseMeta =
        (ListActionConnectionsResponseMeta) o;
    return Objects.equals(
            this.integrationCounts, listActionConnectionsResponseMeta.integrationCounts)
        && Objects.equals(this.total, listActionConnectionsResponseMeta.total)
        && Objects.equals(this.totalFiltered, listActionConnectionsResponseMeta.totalFiltered)
        && Objects.equals(
            this.additionalProperties, listActionConnectionsResponseMeta.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListActionConnectionsResponseMeta {\n");
