...
public class McpScanRequestDataAttributes {
  ...
  public McpScanRequestDataAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_LIBRARIES)List<McpScanRequestDataAttributesLibrariesItems> libraries,
  ...
  /**
   * <p>The commit hash of the source code being scanned.</p>
   * @return commitHash
  **/
  ...
  public McpScanRequestDataAttributes libraries(List<McpScanRequestDataAttributesLibrariesItems> libraries) {
    this.libraries = libraries;
    for (McpScanRequestDataAttributesLibrariesItems item : libraries) {
      this.unparsed |= item.unparsed;
    }
  ...
  public McpScanRequestDataAttributes addLibrariesItem(McpScanRequestDataAttributesLibrariesItems librariesItem) {
  ...
  /**
   * <p>The list of libraries to scan for vulnerabilities.</p>
   * @return libraries
  **/
  ...
  /**
   * <p>The name of the resource (typically the repository or project name) being scanned.</p>
   * @return resourceName
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commitHash, mcpScanRequestDataAttributes.commitHash) && Objects.equals(this.libraries, mcpScanRequestDataAttributes.libraries) && Objects.equals(this.resourceName, mcpScanRequestDataAttributes.resourceName) && Objects.equals(this.additionalProperties, mcpScanRequestDataAttributes.additionalProperties);
  }
