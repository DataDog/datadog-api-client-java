...
public class TeamRoutingRulesRequestData {
  ...
  public TeamRoutingRulesRequestData(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          TeamRoutingRulesRequestDataType type) {
    this.type = type;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, teamRoutingRulesRequestData.attributes)
        && Objects.equals(this.id, teamRoutingRulesRequestData.id)
        && Objects.equals(this.type, teamRoutingRulesRequestData.type)
        && Objects.equals(
            this.additionalProperties, teamRoutingRulesRequestData.additionalProperties);
  }
