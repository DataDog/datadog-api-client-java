 ...
 *
 * See {@link #createIncidentServiceWithHttpInfo}.
 *
 ...
 * Create a new incident service.
 *
 * See {@link #createIncidentServiceWithHttpInfoAsync}.
 *
 * @param body Incident Service Payload. (required)
 ...
 */
  public CompletableFuture<IncidentServiceResponse>createIncidentServiceAsync(IncidentServiceCreateRequest body) {
    return createIncidentServiceWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Creates a new incident service.</p>
   *
   * @param body Incident Service Payload. (required)
  ...
  public ApiResponse<IncidentServiceResponse> createIncidentServiceWithHttpInfo(IncidentServiceCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IncidentServicesApi.createIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IncidentServiceResponse>> createIncidentServiceWithHttpInfoAsync(IncidentServiceCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.IncidentServicesApi.createIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IncidentServiceResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }

  /**
 * Delete an existing incident service.
 *
 * See {@link #deleteIncidentServiceWithHttpInfo}.
 *
 ...
 * Delete an existing incident service.
 *
 * See {@link #deleteIncidentServiceWithHttpInfoAsync}.
 *
 * @param serviceId The ID of the incident service. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteIncidentServiceAsync(String serviceId) {
    return deleteIncidentServiceWithHttpInfoAsync(serviceId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Deletes an existing incident service.</p>
   *
   * @param serviceId The ID of the incident service. (required)
  ...
  public ApiResponse<Void> deleteIncidentServiceWithHttpInfo(String serviceId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IncidentServicesApi.deleteIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteIncidentServiceWithHttpInfoAsync(String serviceId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.IncidentServicesApi.deleteIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #getIncidentServiceWithHttpInfo}.
 *
 * @param serviceId The ID of the incident service. (required)
 * @return IncidentServiceResponse
 * @throws ApiException if fails to make API call
 ...
 * Get details of an incident service.
 *
 * See {@link #getIncidentServiceWithHttpInfoAsync}.
 *
 * @param serviceId The ID of the incident service. (required)
 * @return CompletableFuture&lt;IncidentServiceResponse&gt;
 */
  public CompletableFuture<IncidentServiceResponse>getIncidentServiceAsync(String serviceId) {
    return getIncidentServiceWithHttpInfoAsync(serviceId, new GetIncidentServiceOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<IncidentServiceResponse>getIncidentServiceAsync( String serviceId, GetIncidentServiceOptionalParameters parameters) {
    return getIncidentServiceWithHttpInfoAsync(serviceId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get details of an incident service. If the <code>include[users]</code> query parameter is provided,
   * the included attribute will contain the users related to these incident services.</p>
   *
   * @param serviceId The ID of the incident service. (required)
   * @param parameters Optional parameters for the request.
   * @return ApiResponse&lt;IncidentServiceResponse&gt;
  ...
  public ApiResponse<IncidentServiceResponse> getIncidentServiceWithHttpInfo(String serviceId, GetIncidentServiceOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IncidentServicesApi.getIncidentService", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IncidentServiceResponse>> getIncidentServiceWithHttpInfoAsync(String serviceId, GetIncidentServiceOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.IncidentServicesApi.getIncidentService", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IncidentServiceResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }
 ...
 *
 * See {@link #listIncidentServicesWithHttpInfo}.
 *
 ...
 * Get a list of all incident services.
 *
 * See {@link #listIncidentServicesWithHttpInfoAsync}.
 *
 ...
 */
  public CompletableFuture<IncidentServicesResponse>listIncidentServicesAsync() {
    return listIncidentServicesWithHttpInfoAsync(new ListIncidentServicesOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<IncidentServicesResponse>listIncidentServicesAsync(ListIncidentServicesOptionalParameters parameters) {
    return listIncidentServicesWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get all incident services uploaded for the requesting user's organization. If the <code>include[users]</code> query parameter is provided, the included attribute will contain the users related to these incident services.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<IncidentServicesResponse> listIncidentServicesWithHttpInfo(ListIncidentServicesOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IncidentServicesApi.listIncidentServices", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServicesResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IncidentServicesResponse>> listIncidentServicesWithHttpInfoAsync(ListIncidentServicesOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.IncidentServicesApi.listIncidentServices", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IncidentServicesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServicesResponse>() {});
  }

  /**
 * Update an existing incident service.
 *
 * See {@link #updateIncidentServiceWithHttpInfo}.
 *
 * @param serviceId The ID of the incident service. (required)
 * @param body Incident Service Payload. (required)
 * @return IncidentServiceResponse
 ...
 * Update an existing incident service.
 *
 * See {@link #updateIncidentServiceWithHttpInfoAsync}.
 *
 * @param serviceId The ID of the incident service. (required)
 * @param body Incident Service Payload. (required)
 * @return CompletableFuture&lt;IncidentServiceResponse&gt;
 */
  public CompletableFuture<IncidentServiceResponse>updateIncidentServiceAsync(String serviceId, IncidentServiceUpdateRequest body) {
    return updateIncidentServiceWithHttpInfoAsync(serviceId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Updates an existing incident service. Only provide the attributes which should be updated as this request is a partial update.</p>
   *
   * @param serviceId The ID of the incident service. (required)
   * @param body Incident Service Payload. (required)
   * @return ApiResponse&lt;IncidentServiceResponse&gt;
  ...
  public ApiResponse<IncidentServiceResponse> updateIncidentServiceWithHttpInfo(String serviceId, IncidentServiceUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.IncidentServicesApi.updateIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<IncidentServiceResponse>> updateIncidentServiceWithHttpInfoAsync(String serviceId, IncidentServiceUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.IncidentServicesApi.updateIncidentService", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<IncidentServiceResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<IncidentServiceResponse>() {});
  }
}