...
public class CreateSnapshotAdditionalConfig {
  ...
  public CreateSnapshotAdditionalConfig templateVariables(List<CreateSnapshotTemplateVariable> templateVariables) {
  ...
  public CreateSnapshotAdditionalConfig addTemplateVariablesItem(CreateSnapshotTemplateVariable templateVariablesItem) {
  ...
  /**
   * <p>List of template variable definitions for snapshot rendering.</p>
  ...
  **/
  ...
  public CreateSnapshotAdditionalConfig timeseriesLegendType(CreateSnapshotTimeseriesLegendType timeseriesLegendType) {
  ...
  /**
   * <p>The legend display type for timeseries widgets. A value of <code>none</code> hides the legend entirely; omitting the field lets the frontend choose automatically.</p>
  ...
  **/
  ...
  /**
   * <p>Timezone offset in minutes from UTC. Positive values are west of UTC (for example, <code>300</code> for UTC-5). Use <code>0</code> for UTC.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateSnapshotAdditionalConfig createSnapshotAdditionalConfig = (CreateSnapshotAdditionalConfig) o;
    return Objects.equals(this.templateVariables, createSnapshotAdditionalConfig.templateVariables) && Objects.equals(this.timeseriesLegendType, createSnapshotAdditionalConfig.timeseriesLegendType) && Objects.equals(this.timezoneOffsetMinutes, createSnapshotAdditionalConfig.timezoneOffsetMinutes) && Objects.equals(this.additionalProperties, createSnapshotAdditionalConfig.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(templateVariables,timeseriesLegendType,timezoneOffsetMinutes, additionalProperties);
  }
