...
public class CaseAutomationRuleState extends ModelEnum<String> {
  ...
  public static class CaseAutomationRuleStateSerializer extends StdSerializer<CaseAutomationRuleState> {
      ...
      @Override
      public void serialize(CaseAutomationRuleState value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
