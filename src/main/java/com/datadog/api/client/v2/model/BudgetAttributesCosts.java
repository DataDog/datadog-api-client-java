...
public class BudgetAttributesCosts {
  ...
  /**
   * <p>The total actual cost. Present only when <code>actual=true</code> is requested.</p>
   * @return actual
  **/
  ...
  /**
   * <p>The total budgeted amount over the requested period.</p>
   * @return amount
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The total forecast cost, with any custom forecast overrides applied. Present only when <code>forecast=true</code> is requested.</p>
   * @return forecast
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>The out-of-the-box ML forecast before custom overrides. Present only when <code>forecast=true</code> is requested.</p>
   * @return ootbForecast
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
