...
public class HistoricalJobResponseAttributes {
  ...
  **/
  ...
  /**
   * <p>Job execution progress as a value between 0 and 1. Available for ongoing jobs.</p>
   * @return progressRate
  **/
      @jakarta.annotation.Nullable
