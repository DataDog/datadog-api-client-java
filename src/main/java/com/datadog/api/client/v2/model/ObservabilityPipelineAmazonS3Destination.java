...
public class ObservabilityPipelineAmazonS3Destination {
  ...
  private ObservabilityPipelineAmazonS3DestinationType type =
  ...
  public ObservabilityPipelineAmazonS3Destination(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ObservabilityPipelineAmazonS3DestinationType type) {
    this.bucket = bucket;
    this.id = id;
    this.inputs = inputs;
    this.region = region;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auth, observabilityPipelineAmazonS3Destination.auth)
        ...
        && Objects.equals(
            ...
            observabilityPipelineAmazonS3Destination.additionalProperties);
  }
