...
@JsonPropertyOrder({
  ...
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_EXPIRATION_DATE,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_INSTANCE_TYPE,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_IS_MULTI_AZ,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_NUMBER_OF_NFUS,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_NUMBER_OF_RESERVATIONS,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_PURCHASE_OPTION,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_REGION,
  CommitmentsAwsRDSRICommitment.JSON_PROPERTY_START_DATE,
...
public class CommitmentsAwsRDSRICommitment {
  ...
  public static final String JSON_PROPERTY_DATABASE_ENGINE = "database_engine";
  ...
  public static final String JSON_PROPERTY_IS_MULTI_AZ = "is_multi_az";
   ...
   * @return CommitmentsAwsRDSRICommitment
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class CommitmentsAwsRDSRICommitment {\n");
