...
public class GeminiAPIKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("GeminiAPIKey"));
  ...
  public static class GeminiAPIKeyTypeSerializer extends StdSerializer<GeminiAPIKeyType> {
      ...
      @Override
      public void serialize(GeminiAPIKeyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
