...
public class CIAppGitHubAccountType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ci_github_account"));

  public static final CIAppGitHubAccountType CI_GITHUB_ACCOUNT = new CIAppGitHubAccountType("ci_github_account");
  ...
  public static class CIAppGitHubAccountTypeSerializer extends StdSerializer<CIAppGitHubAccountType> {
      ...
      @Override
      public void serialize(CIAppGitHubAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
