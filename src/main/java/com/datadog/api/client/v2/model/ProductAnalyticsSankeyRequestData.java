...
/**
   * <p>The single JSON:API resource carrying a Sankey query. Its attributes hold the time window to
   * query, the search that selects the sessions, and the definition of the diagram to build.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsSankeyRequestData {
  ...
  @JsonCreator
  public ProductAnalyticsSankeyRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ProductAnalyticsSankeyRequestAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ProductAnalyticsSankeyRequestType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public ProductAnalyticsSankeyRequestData attributes(ProductAnalyticsSankeyRequestAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The resource type identifier for a Sankey request.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsSankeyRequestData productAnalyticsSankeyRequestData = (ProductAnalyticsSankeyRequestData) o;
    return Objects.equals(this.attributes, productAnalyticsSankeyRequestData.attributes) && Objects.equals(this.type, productAnalyticsSankeyRequestData.type) && Objects.equals(this.additionalProperties, productAnalyticsSankeyRequestData.additionalProperties);
  }
