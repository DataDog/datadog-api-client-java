...
@JsonDeserialize(using = CIAppGroupByTotal.CIAppGroupByTotalDeserializer.class)
@JsonSerialize(using = CIAppGroupByTotal.CIAppGroupByTotalSerializer.class)
public class CIAppGroupByTotal extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CIAppGroupByTotal.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class CIAppGroupByTotalSerializer extends StdSerializer<CIAppGroupByTotal> {
        public CIAppGroupByTotalSerializer(Class<CIAppGroupByTotal> t) {
            super(t);
        }

        public CIAppGroupByTotalSerializer() {
            this(null);
        }

        @Override
        public void serialize(CIAppGroupByTotal value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CIAppGroupByTotalDeserializer extends StdDeserializer<CIAppGroupByTotal> {
        public CIAppGroupByTotalDeserializer() {
            this(CIAppGroupByTotal.class);
        }

        public CIAppGroupByTotalDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public CIAppGroupByTotal deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            CIAppGroupByTotal ret = new CIAppGroupByTotal();
            if (match == 1) {
         ...
         */
        @Override
        public CIAppGroupByTotal getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "CIAppGroupByTotal cannot be null");
        }
    }
    ...
    public CIAppGroupByTotal() {
        super("oneOf", Boolean.FALSE);
    }
    public CIAppGroupByTotal(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public CIAppGroupByTotal(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public CIAppGroupByTotal(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(CIAppGroupByTotal.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return CIAppGroupByTotal.schemas;
    }
