...
@JsonPropertyOrder({
  OCIMetricsConfig.JSON_PROPERTY_COMPARTMENT_TAG_FILTERS,
  OCIMetricsConfig.JSON_PROPERTY_ENABLED,
  OCIMetricsConfig.JSON_PROPERTY_EXCLUDED_SERVICES
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class OCIMetricsConfig {
  ...
  public OCIMetricsConfig compartmentTagFilters(List<String> compartmentTagFilters) {
    this.compartmentTagFilters = compartmentTagFilters;
    return this;
  }

  public OCIMetricsConfig addCompartmentTagFiltersItem(String compartmentTagFiltersItem) {
  ...
  /**
   * The compartment tag filters to apply to metric collection. Each value represents a Datadog tag
  ...
  public OCIMetricsConfig enabled(Boolean enabled) {
  ...
  public OCIMetricsConfig excludedServices(List<String> excludedServices) {
    this.excludedServices = excludedServices;
    return this;
  }

  public OCIMetricsConfig addExcludedServicesItem(String excludedServicesItem) {
   ...
   */
  @JsonAnySetter
  public OCIMetricsConfig putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this OCIMetricsConfig object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    OCIMetricsConfig ociMetricsConfig = (OCIMetricsConfig) o;
    return Objects.equals(this.compartmentTagFilters, ociMetricsConfig.compartmentTagFilters)
        && Objects.equals(this.enabled, ociMetricsConfig.enabled)
        && Objects.equals(this.excludedServices, ociMetricsConfig.excludedServices)
        && Objects.equals(this.additionalProperties, ociMetricsConfig.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OCIMetricsConfig {\n");
