...
/**
   * <p>Metadata accompanying the spans response.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsSpansResponseMeta {
  ...
  /**
   * <p>Time elapsed for the query in milliseconds.</p>
   * @return elapsed
  **/
  ...
  **/
  ...
  /**
   * <p>Status of the query execution.</p>
   * @return status
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.elapsed, llmObsSpansResponseMeta.elapsed) && Objects.equals(this.page, llmObsSpansResponseMeta.page) && Objects.equals(this.requestId, llmObsSpansResponseMeta.requestId) && Objects.equals(this.status, llmObsSpansResponseMeta.status) && Objects.equals(this.additionalProperties, llmObsSpansResponseMeta.additionalProperties);
  }
