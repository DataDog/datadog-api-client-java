...
/**
   * <p>Aggregated uncompressed resource detection grouped by URL path.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedUncompressedResource {
  ...
  /**
   * <p>Average uncompressed body size in bytes.</p>
   * @return avgBodySize
  **/
  ...
  /**
   * <p>Average resource loading duration in nanoseconds.</p>
   * @return avgDuration
  **/
  ...
  **/
  ...
  /**
   * <p>Impact score combining view frequency and resource size.</p>
   * @return impactScore
  **/
  ...
  **/
  ...
  /**
   * <p>CDN or hosting provider type for the resource.</p>
   * @return providerType
  **/
  ...
  /**
   * <p>Whether the resource is render-blocking.</p>
  ...
  **/
  ...
  /**
   * <p>Type of the resource (JS, CSS, image, fetch, and so on).</p>
   * @return resourceType
  **/
  ...
  /**
   * <p>Normalized URL path pattern for the uncompressed resource.</p>
   * @return urlPathGroup
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedUncompressedResource aggregatedUncompressedResource = (AggregatedUncompressedResource) o;
    return Objects.equals(this.avgBodySize, aggregatedUncompressedResource.avgBodySize) && Objects.equals(this.avgDuration, aggregatedUncompressedResource.avgDuration) && Objects.equals(this.fingerprint, aggregatedUncompressedResource.fingerprint) && Objects.equals(this.impactScore, aggregatedUncompressedResource.impactScore) && Objects.equals(this.instanceCount, aggregatedUncompressedResource.instanceCount) && Objects.equals(this.providerType, aggregatedUncompressedResource.providerType) && Objects.equals(this.renderBlocking, aggregatedUncompressedResource.renderBlocking) && Objects.equals(this.resourceType, aggregatedUncompressedResource.resourceType) && Objects.equals(this.urlPathGroup, aggregatedUncompressedResource.urlPathGroup) && Objects.equals(this.viewOccurrences, aggregatedUncompressedResource.viewOccurrences) && Objects.equals(this.additionalProperties, aggregatedUncompressedResource.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(avgBodySize,avgDuration,fingerprint,impactScore,instanceCount,providerType,renderBlocking,resourceType,urlPathGroup,viewOccurrences, additionalProperties);
  }
