...
public class ActionQuerySpecInputs extends AbstractOpenApiSchema {
    ...
    public static class ActionQuerySpecInputsSerializer extends StdSerializer<ActionQuerySpecInputs> {
        ...
        @Override
        public void serialize(ActionQuerySpecInputs value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQuerySpecInputsDeserializer extends StdDeserializer<ActionQuerySpecInputs> {
        ...
        @Override
        public ActionQuerySpecInputs deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public ActionQuerySpecInputs getNullValue(DeserializationContext ctxt) throws JsonMappingException {
