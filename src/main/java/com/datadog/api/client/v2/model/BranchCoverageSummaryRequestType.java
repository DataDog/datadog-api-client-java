...
/**
 * JSON:API type for branch coverage summary request. The value must always be <code>
 * ci_app_coverage_branch_summary_request</code>.
 */
@JsonSerialize(
...
public class BranchCoverageSummaryRequestType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("ci_app_coverage_branch_summary_request"));
  ...
  public static class BranchCoverageSummaryRequestTypeSerializer
      extends StdSerializer<BranchCoverageSummaryRequestType> {
