...
public class SBOMComponentLicenseType extends ModelEnum<String> {
  ...
  public static final SBOMComponentLicenseType NETWORK_STRONG_COPYLEFT =
      new SBOMComponentLicenseType("network_strong_copyleft");
  public static final SBOMComponentLicenseType NON_STANDARD_COPYLEFT =
      new SBOMComponentLicenseType("non_standard_copyleft");
  public static final SBOMComponentLicenseType OTHER_NON_FREE =
      new SBOMComponentLicenseType("other_non_free");
  public static final SBOMComponentLicenseType OTHER_NON_STANDARD =
      new SBOMComponentLicenseType("other_non_standard");
  ...
  public static final SBOMComponentLicenseType PUBLIC_DOMAIN =
      new SBOMComponentLicenseType("public_domain");
  public static final SBOMComponentLicenseType STRONG_COPYLEFT =
      new SBOMComponentLicenseType("strong_copyleft");
  public static final SBOMComponentLicenseType WEAK_COPYLEFT =
      new SBOMComponentLicenseType("weak_copyleft");

  SBOMComponentLicenseType(String value) {
    super(value, allowedValues);
  }

  public static class SBOMComponentLicenseTypeSerializer
      extends StdSerializer<SBOMComponentLicenseType> {
    ...
    public void serialize(
        SBOMComponentLicenseType value, JsonGenerator jgen, SerializerProvider provider)
