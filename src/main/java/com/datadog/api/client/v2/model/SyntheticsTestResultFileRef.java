...
/**
   * <p>Reference to a file attached to a Synthetic test request.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsTestResultFileRef {
  ...
  /**
   * <p>Storage bucket key where the file is stored.</p>
   * @return bucketKey
  **/
  ...
  /**
   * <p>Encoding of the file contents.</p>
   * @return encoding
  **/
      @jakarta.annotation.Nullable
