...
public class TimelineCellContent extends AbstractOpenApiSchema {
    ...
    public static class TimelineCellContentSerializer extends StdSerializer<TimelineCellContent> {
        ...
        @Override
        public void serialize(TimelineCellContent value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class TimelineCellContentDeserializer extends StdDeserializer<TimelineCellContent> {
        ...
        @Override
        public TimelineCellContent deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (TimelineCellContentComment.class.equals(Integer.class) || TimelineCellContentComment.class.equals(Long.class) || TimelineCellContentComment.class.equals(Float.class) || TimelineCellContentComment.class.equals(Double.class) || TimelineCellContentComment.class.equals(Boolean.class) || TimelineCellContentComment.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((TimelineCellContentComment.class.equals(Integer.class) || TimelineCellContentComment.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((TimelineCellContentComment.class.equals(Float.class) || TimelineCellContentComment.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (TimelineCellContentComment.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (TimelineCellContentComment.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public TimelineCellContent getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `TimelineCellContentComment`. If the actual instance is not `TimelineCellContentComment`,
