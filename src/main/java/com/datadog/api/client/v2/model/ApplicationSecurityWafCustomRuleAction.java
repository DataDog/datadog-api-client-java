...
public class ApplicationSecurityWafCustomRuleAction {
  ...
  private ApplicationSecurityWafCustomRuleActionAction action = ApplicationSecurityWafCustomRuleActionAction.BLOCK_REQUEST;

  public static final String JSON_PROPERTY_PARAMETERS = "parameters";
  private ApplicationSecurityWafCustomRuleActionParameters parameters;

  public ApplicationSecurityWafCustomRuleAction action(ApplicationSecurityWafCustomRuleActionAction action) {
    this.action = action;
  ...
  **/
  ...
  public ApplicationSecurityWafCustomRuleAction parameters(ApplicationSecurityWafCustomRuleActionParameters parameters) {
  ...
  /**
   * <p>The definition of <code>ApplicationSecurityWafCustomRuleActionParameters</code> object.</p>
   * @return parameters
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleAction applicationSecurityWafCustomRuleAction = (ApplicationSecurityWafCustomRuleAction) o;
    return Objects.equals(this.action, applicationSecurityWafCustomRuleAction.action) && Objects.equals(this.parameters, applicationSecurityWafCustomRuleAction.parameters) && Objects.equals(this.additionalProperties, applicationSecurityWafCustomRuleAction.additionalProperties);
  }
