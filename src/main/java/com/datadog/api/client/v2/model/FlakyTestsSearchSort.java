...
public class FlakyTestsSearchSort extends ModelEnum<String> {
  ...
  public static final FlakyTestsSearchSort FIRST_FLAKED_ASCENDING =
      new FlakyTestsSearchSort("first_flaked");
  public static final FlakyTestsSearchSort FIRST_FLAKED_DESCENDING =
      new FlakyTestsSearchSort("-first_flaked");
  public static final FlakyTestsSearchSort LAST_FLAKED_ASCENDING =
      new FlakyTestsSearchSort("last_flaked");
  public static final FlakyTestsSearchSort LAST_FLAKED_DESCENDING =
      new FlakyTestsSearchSort("-last_flaked");
  public static final FlakyTestsSearchSort FAILURE_RATE_ASCENDING =
      new FlakyTestsSearchSort("failure_rate");
  public static final FlakyTestsSearchSort FAILURE_RATE_DESCENDING =
      new FlakyTestsSearchSort("-failure_rate");
  public static final FlakyTestsSearchSort PIPELINES_FAILED_ASCENDING =
      new FlakyTestsSearchSort("pipelines_failed");
  public static final FlakyTestsSearchSort PIPELINES_FAILED_DESCENDING =
      new FlakyTestsSearchSort("-pipelines_failed");
  public static final FlakyTestsSearchSort PIPELINES_DURATION_LOST_ASCENDING =
  ...
  public static class FlakyTestsSearchSortSerializer extends StdSerializer<FlakyTestsSearchSort> {
    ...
    public void serialize(
        FlakyTestsSearchSort value, JsonGenerator jgen, SerializerProvider provider)
