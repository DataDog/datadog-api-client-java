...
public class LLMObsDataDeletionRequestAttributes {
  ...
  /**
   * <p>Optional delay in seconds before the deletion is executed.</p>
   * @return delay
  **/
  ...
  **/
  ...
  /**
   * <p>Query filters selecting the data to delete. Must include a <code>query</code> key with an <code>@trace_id</code> filter.</p>
   * @return query
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsDataDeletionRequestAttributes llmObsDataDeletionRequestAttributes = (LLMObsDataDeletionRequestAttributes) o;
    return Objects.equals(this.delay, llmObsDataDeletionRequestAttributes.delay) && Objects.equals(this.from, llmObsDataDeletionRequestAttributes.from) && Objects.equals(this.query, llmObsDataDeletionRequestAttributes.query) && Objects.equals(this.to, llmObsDataDeletionRequestAttributes.to) && Objects.equals(this.additionalProperties, llmObsDataDeletionRequestAttributes.additionalProperties);
  }
