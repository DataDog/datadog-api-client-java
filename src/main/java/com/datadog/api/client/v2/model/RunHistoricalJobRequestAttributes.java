...
/**
   * <p>Run a historical job request.</p>
 */
@JsonPropertyOrder({
...
public class RunHistoricalJobRequestAttributes {
  ...
  /**
   * <p>Definition of a historical job based on a security monitoring rule.</p>
   * @return fromRule
  **/
  ...
  **/
  ...
  /**
   * <p>Whether the job outputs signals when results are converted.</p>
   * @return signalOutput
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    RunHistoricalJobRequestAttributes runHistoricalJobRequestAttributes = (RunHistoricalJobRequestAttributes) o;
    return Objects.equals(this.fromRule, runHistoricalJobRequestAttributes.fromRule) && Objects.equals(this.jobDefinition, runHistoricalJobRequestAttributes.jobDefinition) && Objects.equals(this.signalOutput, runHistoricalJobRequestAttributes.signalOutput) && Objects.equals(this.additionalProperties, runHistoricalJobRequestAttributes.additionalProperties);
  }
