...
public class AWSAssumeRoleType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("AWSAssumeRole"));
  ...
  public static class AWSAssumeRoleTypeSerializer extends StdSerializer<AWSAssumeRoleType> {
      public AWSAssumeRoleTypeSerializer(Class<AWSAssumeRoleType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(AWSAssumeRoleType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
