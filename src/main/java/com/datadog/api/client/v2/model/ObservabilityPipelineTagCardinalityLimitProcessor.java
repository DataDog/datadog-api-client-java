...
/**
   * <p>The <code>tag_cardinality_limit</code> processor caps the number of distinct tag value combinations on metrics, dropping tags or events once the limit is exceeded.</p>
...
public class ObservabilityPipelineTagCardinalityLimitProcessor {
  ...
  private List<ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit> perMetricLimits = null;
  ...
  private ObservabilityPipelineTagCardinalityLimitProcessorType type = ObservabilityPipelineTagCardinalityLimitProcessorType.TAG_CARDINALITY_LIMIT;
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_LIMIT_EXCEEDED_ACTION)ObservabilityPipelineTagCardinalityLimitProcessorAction limitExceededAction,
            @JsonProperty(required=true, value=JSON_PROPERTY_TRACKING_MODE)ObservabilityPipelineTagCardinalityLimitProcessorTrackingMode trackingMode,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineTagCardinalityLimitProcessorType type,
  ...
  **/
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessor limitExceededAction(ObservabilityPipelineTagCardinalityLimitProcessorAction limitExceededAction) {
    this.limitExceededAction = limitExceededAction;
    this.unparsed |= !limitExceededAction.isValid();
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessor perMetricLimits(List<ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit> perMetricLimits) {
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessor addPerMetricLimitsItem(ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit perMetricLimitsItem) {
  ...
  /**
   * <p>A list of per-metric cardinality overrides that take precedence over the default <code>value_limit</code>.</p>
  ...
  **/
      ...
      @JsonInclude(
        value = JsonInclude.Include.USE_DEFAULTS)
      public List<ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit> getPerMetricLimits() {
        return perMetricLimits;
      }
  public void setPerMetricLimits(List<ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit> perMetricLimits) {
    this.perMetricLimits = perMetricLimits;
    if (perMetricLimits != null) {
      for (ObservabilityPipelineTagCardinalityLimitProcessorPerMetricLimit item : perMetricLimits) {
        this.unparsed |= item.unparsed;
  ...
  public ObservabilityPipelineTagCardinalityLimitProcessor trackingMode(ObservabilityPipelineTagCardinalityLimitProcessorTrackingMode trackingMode) {
    this.trackingMode = trackingMode;
    this.unparsed |= trackingMode.unparsed;
    return this;
  }
  ...
  /**
   * <p>Controls whether the processor uses exact or probabilistic tag tracking.</p>
   * @return trackingMode
  **/
  ...
  public void setTrackingMode(ObservabilityPipelineTagCardinalityLimitProcessorTrackingMode trackingMode) {
    this.trackingMode = trackingMode;
    if (trackingMode != null) {
      this.unparsed |= trackingMode.unparsed;
    }
  }
  public ObservabilityPipelineTagCardinalityLimitProcessor type(ObservabilityPipelineTagCardinalityLimitProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. The value must be <code>tag_cardinality_limit</code>.</p>
   * @return type
  **/
  ...
  /**
   * <p>The default maximum number of distinct tag value combinations allowed per metric.</p>
   * minimum: 0
   * maximum: 1000000
   * @return valueLimit
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineTagCardinalityLimitProcessor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineTagCardinalityLimitProcessor observabilityPipelineTagCardinalityLimitProcessor = (ObservabilityPipelineTagCardinalityLimitProcessor) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(displayName,enabled,id,include,limitExceededAction,perMetricLimits,trackingMode,type,valueLimit, additionalProperties);
  }
