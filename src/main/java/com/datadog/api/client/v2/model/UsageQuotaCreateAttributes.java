...
/**
   * <p>Attributes for creating or updating a usage quota by scope.</p>
 */
@JsonPropertyOrder({
...
public class UsageQuotaCreateAttributes {
  ...
  /**
   * <p>Whether to actively block usage above the limit instead of only tracking or alerting on it.</p>
   * @return enforced
  **/
  ...
  /**
   * <p>A namespace-specific key and value identifying what the quota applies to within an organization. The object must contain exactly one entry. Use <code>"*"</code> as the value for the default quota applied to entities without a specific quota, or omit the scope for an organization-wide quota. A specific value must identify an existing user handle in the caller's organization when <code>include_descendants</code> is false. When <code>include_descendants</code> is true, the handle must exist in the caller's organization or in at least one targeted descendant organization; the quota is then applied only to the organizations where that handle exists, and the request fails only if the handle exists in none of them.</p>
   * @return scope
  **/
  ...
  /**
   * <p>The quota limit to set in the usage units defined by the quota namespace. For an organization-wide quota (scope omitted), the limit must be greater than the usage already recorded in the current period.</p>
   * minimum: 0
   * @return usageLimit
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enforced, usageQuotaCreateAttributes.enforced) && Objects.equals(this.scope, usageQuotaCreateAttributes.scope) && Objects.equals(this.usageLimit, usageQuotaCreateAttributes.usageLimit) && Objects.equals(this.additionalProperties, usageQuotaCreateAttributes.additionalProperties);
  }
