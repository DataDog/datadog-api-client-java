 ...
 */
   ...
   * - Use <strong>value</strong> for single-value conditions: "is", "is not", "contains", "does not contain", "=", "!=", "like", "not like", "is all values", "is untagged"
   * - Use <strong>values</strong> for multi-value conditions: "in", "not in"
   * - Cannot use both value and values simultaneously.</p>
   * <p><strong>Supported operators</strong>: is, is not, is all values, is untagged, contains, does not contain, in, not in, =, !=, like, not like</p>
   *
   * @param body  (required)
 ...
 */
  public CompletableFuture<BudgetWithEntries>getBudgetAsync(String budgetId) {
    return getBudgetWithHttpInfoAsync(budgetId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<BudgetWithEntries> getBudgetWithHttpInfo(String budgetId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CloudCostManagementApi.getBudget", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<BudgetWithEntries>> getBudgetWithHttpInfoAsync(String budgetId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CloudCostManagementApi.getBudget", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<BudgetWithEntries>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
