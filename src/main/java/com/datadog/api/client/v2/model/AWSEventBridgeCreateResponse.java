...
@JsonPropertyOrder({AWSEventBridgeCreateResponse.JSON_PROPERTY_DATA})
...
public class AWSEventBridgeCreateResponse {
  ...
  public AWSEventBridgeCreateResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          AWSEventBridgeCreateResponseData data) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, awsEventBridgeCreateResponse.data)
        && Objects.equals(
