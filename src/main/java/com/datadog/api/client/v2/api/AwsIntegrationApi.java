...
public class AwsIntegrationApi {
   ...
   *
   * <p>See {@link #generateNewExternalIDWithHttpInfo}.
   *
   * @return AWSNewExternalIDResponse
   * @throws ApiException if fails to make API call
   */
  public AWSNewExternalIDResponse generateNewExternalID() throws ApiException {
    return generateNewExternalIDWithHttpInfo().getData();
  }

  /**
   * AWS Integration - Generate new external ID.
   *
   * <p>See {@link #generateNewExternalIDWithHttpInfoAsync}.
   *
   * @return CompletableFuture&lt;AWSNewExternalIDResponse&gt;
   */
  public CompletableFuture<AWSNewExternalIDResponse> generateNewExternalIDAsync() {
    return generateNewExternalIDWithHttpInfoAsync()
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<AWSNewExternalIDResponse> generateNewExternalIDWithHttpInfo()
      throws ApiException {
    // Check if unstable operation is enabled
    String operationId = "generateNewExternalID";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
    } else {
      throw new ApiException(0, String.format("Unstable operation '%s' is disabled", operationId));
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.AwsIntegrationApi.generateNewExternalID",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
  ...
  public CompletableFuture<ApiResponse<AWSNewExternalIDResponse>>
      generateNewExternalIDWithHttpInfoAsync() {
    // Check if unstable operation is enabled
    String operationId = "generateNewExternalID";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
   ...
   *
   * <p>See {@link #listAWSLogServicesWithHttpInfo}.
   *
   * @return AWSLogsServicesResponse
   * @throws ApiException if fails to make API call
   */
  public AWSLogsServicesResponse listAWSLogServices() throws ApiException {
    return listAWSLogServicesWithHttpInfo().getData();
  }

  /**
   * AWS Integration - List log services.
   *
   * <p>See {@link #listAWSLogServicesWithHttpInfoAsync}.
   *
   * @return CompletableFuture&lt;AWSLogsServicesResponse&gt;
   */
  public CompletableFuture<AWSLogsServicesResponse> listAWSLogServicesAsync() {
    return listAWSLogServicesWithHttpInfoAsync()
        .thenApply(
            response -> {
              return response.getData();
            });
   ...
   *     </table>
   */
  public ApiResponse<AWSLogsServicesResponse> listAWSLogServicesWithHttpInfo() throws ApiException {
    // Check if unstable operation is enabled
    String operationId = "listAWSLogServices";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
    } else {
      throw new ApiException(0, String.format("Unstable operation '%s' is disabled", operationId));
    ...
    Invocation.Builder builder =
        apiClient.createBuilder(
            "v2.AwsIntegrationApi.listAWSLogServices",
            localVarPath,
            new ArrayList<Pair>(),
            localVarHeaderParams,
            new HashMap<String, String>(),
  ...
  public CompletableFuture<ApiResponse<AWSLogsServicesResponse>>
      listAWSLogServicesWithHttpInfoAsync() {
    // Check if unstable operation is enabled
    String operationId = "listAWSLogServices";
    if (apiClient.isUnstableOperationEnabled("v2." + operationId)) {
      apiClient.getLogger().warning(String.format("Using unstable operation '%s'", operationId));
  ...
  public ApiResponse<AWSNamespacesResponse> listAWSNamespacesWithHttpInfo() throws ApiException {
    ...
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/api/v2/integration/aws/namespaces";
   ...
   * @throws ApiException if fails to make API call
   */
  public AWSAccountResponse updateAWSAccount(String awsAccountConfigId, AWSAccountPatchRequest body)
      throws ApiException {
