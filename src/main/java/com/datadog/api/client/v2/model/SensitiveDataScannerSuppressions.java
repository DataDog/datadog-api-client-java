...
public class SensitiveDataScannerSuppressions {
  ...
  /**
   * <p>List of strings to use for suppression of matches ending with these strings.</p>
   * @return endsWith
  **/
  ...
  /**
   * <p>List of strings to use for suppression of matches exactly matching these strings.</p>
   * @return exactMatch
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of strings to use for suppression of matches starting with these strings.</p>
   * @return startsWith
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SensitiveDataScannerSuppressions sensitiveDataScannerSuppressions = (SensitiveDataScannerSuppressions) o;
    return Objects.equals(this.endsWith, sensitiveDataScannerSuppressions.endsWith) && Objects.equals(this.exactMatch, sensitiveDataScannerSuppressions.exactMatch) && Objects.equals(this.startsWith, sensitiveDataScannerSuppressions.startsWith) && Objects.equals(this.additionalProperties, sensitiveDataScannerSuppressions.additionalProperties);
  }
