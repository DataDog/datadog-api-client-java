...
public class ProductAnalyticsJourneyScalarQuery {
  ...
  @JsonCreator
  public ProductAnalyticsJourneyScalarQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_COMPUTE)ProductAnalyticsJourneyScalarCompute compute,
  ...
  /**
   * <p>Defines the metric computed over the journey for a scalar query.</p>
   * @return compute
  **/
  ...
  public ProductAnalyticsJourneyScalarQuery groupBy(List<ProductAnalyticsGraphQueryGroupBy> groupBy) {
  ...
  public ProductAnalyticsJourneyScalarQuery addGroupByItem(ProductAnalyticsGraphQueryGroupBy groupByItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsJourneyScalarQuery productAnalyticsJourneyScalarQuery = (ProductAnalyticsJourneyScalarQuery) o;
    return Objects.equals(this.compute, productAnalyticsJourneyScalarQuery.compute) && Objects.equals(this.groupBy, productAnalyticsJourneyScalarQuery.groupBy) && Objects.equals(this.queryId, productAnalyticsJourneyScalarQuery.queryId) && Objects.equals(this.search, productAnalyticsJourneyScalarQuery.search) && Objects.equals(this.additionalProperties, productAnalyticsJourneyScalarQuery.additionalProperties);
  }
