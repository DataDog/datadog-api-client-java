...
/**
   * <p>Schema for an incident declared trigger.</p>
 */
@JsonPropertyOrder({
...
public class IncidentCreatedTriggerWrapper {
  ...
  @JsonCreator
  public IncidentCreatedTriggerWrapper(
            @JsonProperty(required=true, value=JSON_PROPERTY_INCIDENT_CREATED_TRIGGER)IncidentCreatedTrigger incidentCreatedTrigger) {
        this.incidentCreatedTrigger = incidentCreatedTrigger;
        this.unparsed |= incidentCreatedTrigger.unparsed;
  }
  public IncidentCreatedTriggerWrapper incidentCreatedTrigger(IncidentCreatedTrigger incidentCreatedTrigger) {
    this.incidentCreatedTrigger = incidentCreatedTrigger;
    this.unparsed |= incidentCreatedTrigger.unparsed;
    return this;
  }
  ...
  /**
   * <p>Trigger a workflow when an incident is declared.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.incidentCreatedTrigger, incidentCreatedTriggerWrapper.incidentCreatedTrigger) && Objects.equals(this.startStepNames, incidentCreatedTriggerWrapper.startStepNames) && Objects.equals(this.additionalProperties, incidentCreatedTriggerWrapper.additionalProperties);
  }
