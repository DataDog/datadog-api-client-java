...
/**
   * <p>Response for getting the rule version history.</p>
 */
@JsonPropertyOrder({
...
public class GetRuleVersionHistoryResponse {
  ...
  private GetRuleVersionHistoryData data;

  public GetRuleVersionHistoryResponse data(GetRuleVersionHistoryData data) {
    this.data = data;
  ...
  **/
      ...
      public GetRuleVersionHistoryData getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, getRuleVersionHistoryResponse.data) && Objects.equals(this.additionalProperties, getRuleVersionHistoryResponse.additionalProperties);
  }
