...
@JsonPropertyOrder({AWSEventBridgeDeleteRequest.JSON_PROPERTY_DATA})
...
public class AWSEventBridgeDeleteRequest {
  ...
  public AWSEventBridgeDeleteRequest(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          AWSEventBridgeDeleteRequestData data) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, awsEventBridgeDeleteRequest.data)
        && Objects.equals(
