...
/**
   * <p>A monitor notification rule.</p>
 */
@JsonPropertyOrder({
...
public class MonitorNotificationRuleResponse {
  ...
  **/
  ...
  public MonitorNotificationRuleResponse included(List<MonitorNotificationRuleResponseIncludedItem> included) {
  ...
  public MonitorNotificationRuleResponse addIncludedItem(MonitorNotificationRuleResponseIncludedItem includedItem) {
  ...
  /**
   * <p>Array of objects related to the monitor notification rule that the user requested.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    MonitorNotificationRuleResponse monitorNotificationRuleResponse = (MonitorNotificationRuleResponse) o;
    return Objects.equals(this.data, monitorNotificationRuleResponse.data) && Objects.equals(this.included, monitorNotificationRuleResponse.included) && Objects.equals(this.additionalProperties, monitorNotificationRuleResponse.additionalProperties);
  }
