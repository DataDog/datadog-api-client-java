...
public class ProductAnalyticsJourneyFunnelCompute {
  ...
  public ProductAnalyticsJourneyFunnelCompute aggregation(String aggregation) {
  ...
  **/
   ...
   * @return ProductAnalyticsJourneyFunnelCompute
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class ProductAnalyticsJourneyFunnelCompute {\n");
