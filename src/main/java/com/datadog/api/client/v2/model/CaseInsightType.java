...
/**
   * <p>The type of Datadog resource linked to the case as contextual evidence. Each type corresponds to a different Datadog product signal (for example, a security finding, a monitor alert, or an incident).</p>
 */
@JsonSerialize(using = CaseInsightType.CaseInsightTypeSerializer.class)
public class CaseInsightType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("SECURITY_SIGNAL", "MONITOR", "EVENT_CORRELATION", "ERROR_TRACKING", "CLOUD_COST_RECOMMENDATION", "INCIDENT", "SENSITIVE_DATA_SCANNER_ISSUE", "EVENT", "WATCHDOG_STORY", "WIDGET", "SECURITY_FINDING", "INSIGHT_SCORECARD_CAMPAIGN", "RESOURCE_POLICY", "APM_RECOMMENDATION", "SCM_URL", "PROFILING_DOWNSIZING_EXPERIMENT"));
  ...
  public static final CaseInsightType CLOUD_COST_RECOMMENDATION = new CaseInsightType("CLOUD_COST_RECOMMENDATION");
  public static final CaseInsightType INCIDENT = new CaseInsightType("INCIDENT");
  public static final CaseInsightType SENSITIVE_DATA_SCANNER_ISSUE = new CaseInsightType("SENSITIVE_DATA_SCANNER_ISSUE");
  ...
  public static final CaseInsightType INSIGHT_SCORECARD_CAMPAIGN = new CaseInsightType("INSIGHT_SCORECARD_CAMPAIGN");
  public static final CaseInsightType RESOURCE_POLICY = new CaseInsightType("RESOURCE_POLICY");
  public static final CaseInsightType APM_RECOMMENDATION = new CaseInsightType("APM_RECOMMENDATION");
  public static final CaseInsightType SCM_URL = new CaseInsightType("SCM_URL");
  public static final CaseInsightType PROFILING_DOWNSIZING_EXPERIMENT = new CaseInsightType("PROFILING_DOWNSIZING_EXPERIMENT");
  ...
  public static class CaseInsightTypeSerializer extends StdSerializer<CaseInsightType> {
      ...
      @Override
      public void serialize(CaseInsightType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
