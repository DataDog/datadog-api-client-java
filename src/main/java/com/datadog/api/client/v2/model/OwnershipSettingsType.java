...
public class OwnershipSettingsType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ownership_settings"));

  public static final OwnershipSettingsType OWNERSHIP_SETTINGS = new OwnershipSettingsType("ownership_settings");
  ...
  public static class OwnershipSettingsTypeSerializer extends StdSerializer<OwnershipSettingsType> {
      ...
      @Override
      public void serialize(OwnershipSettingsType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
