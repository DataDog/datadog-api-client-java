...
public class LLMObsAnnotationsDataAttributesResponse {
  ...
  @JsonCreator
  public LLMObsAnnotationsDataAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ANNOTATIONS)List<LLMObsAnnotationItemResponse> annotations) {
  ...
  /**
   * <p>Successfully created or updated annotations.</p>
   * @return annotations
  **/
  ...
  /**
   * <p>Partial errors for annotations that could not be processed.</p>
   * @return errors
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsAnnotationsDataAttributesResponse llmObsAnnotationsDataAttributesResponse = (LLMObsAnnotationsDataAttributesResponse) o;
    return Objects.equals(this.annotations, llmObsAnnotationsDataAttributesResponse.annotations) && Objects.equals(this.errors, llmObsAnnotationsDataAttributesResponse.errors) && Objects.equals(this.additionalProperties, llmObsAnnotationsDataAttributesResponse.additionalProperties);
  }
