...
public class ProductAnalyticsInterval {
  ...
  /**
   * <p>The duration of each time bucket in milliseconds.</p>
   * @return milliseconds
  **/
  ...
  /**
   * <p>The start of this interval as an epoch timestamp in milliseconds.</p>
   * @return startTime
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Epoch timestamps (in milliseconds) for each bucket in this interval.</p>
   * @return times
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The interval type (e.g., fixed or auto-computed bucket size).</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
