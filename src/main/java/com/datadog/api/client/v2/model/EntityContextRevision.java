...
/**
   * <p>A single historical revision of an entity, including the time range during which the revision was observed.</p>
 */
@JsonPropertyOrder({
...
public class EntityContextRevision {
  ...
  public EntityContextRevision(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_LAST_SEEN_AT)OffsetDateTime lastSeenAt) {
  ...
  /**
   * <p>The set of attributes recorded for the entity at this revision. The keys depend on the kind of entity.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The first time the entity was observed at this revision.</p>
   * @return firstSeenAt
  **/
  ...
  /**
   * <p>The last time the entity was observed at this revision.</p>
   * @return lastSeenAt
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, entityContextRevision.attributes) && Objects.equals(this.firstSeenAt, entityContextRevision.firstSeenAt) && Objects.equals(this.lastSeenAt, entityContextRevision.lastSeenAt) && Objects.equals(this.additionalProperties, entityContextRevision.additionalProperties);
  }
