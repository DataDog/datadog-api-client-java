...
/**
   * <p>Response object for a list of maintenance templates.</p>
 */
@JsonPropertyOrder({
...
public class MaintenanceTemplateArray {
  ...
  @JsonCreator
  public MaintenanceTemplateArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<MaintenanceTemplateData> data) {
        this.data = data;
  ...
  /**
   * <p>A list of maintenance template data objects.</p>
   * @return data
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, maintenanceTemplateArray.data) && Objects.equals(this.included, maintenanceTemplateArray.included) && Objects.equals(this.additionalProperties, maintenanceTemplateArray.additionalProperties);
  }
