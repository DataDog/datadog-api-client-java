...
public class SeverityModifierSeverity extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("info_none", "low", "medium", "high", "critical"));

  public static final SeverityModifierSeverity INFO_NONE =
      new SeverityModifierSeverity("info_none");
  ...
  public static class SeverityModifierSeveritySerializer
      extends StdSerializer<SeverityModifierSeverity> {
    ...
    public void serialize(
        SeverityModifierSeverity value, JsonGenerator jgen, SerializerProvider provider)
