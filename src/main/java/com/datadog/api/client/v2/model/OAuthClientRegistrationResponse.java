...
/**
   * <p>Response payload for a successful OAuth2 dynamic client registration as defined by RFC 7591.</p>
 */
@JsonPropertyOrder({
...
public class OAuthClientRegistrationResponse {
  ...
  public OAuthClientRegistrationResponse(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_GRANT_TYPES)List<OAuthClientRegistrationGrantType> grantTypes,
            @JsonProperty(required=true, value=JSON_PROPERTY_REDIRECT_URIS)List<String> redirectUris,
            @JsonProperty(required=true, value=JSON_PROPERTY_RESPONSE_TYPES)List<OAuthClientRegistrationResponseType> responseTypes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TOKEN_ENDPOINT_AUTH_METHOD)String tokenEndpointAuthMethod) {
  ...
  /**
   * <p>Unique identifier assigned to the registered client.</p>
   * @return clientId
  **/
  ...
  /**
   * <p>Human-readable name of the client.</p>
   * @return clientName
  **/
  ...
  /**
   * <p>OAuth 2.0 grant types registered for the client.</p>
   * @return grantTypes
  **/
  ...
  /**
   * <p>Redirection URIs registered for the client.</p>
   * @return redirectUris
  **/
  ...
  /**
   * <p>OAuth 2.0 response types registered for the client.</p>
  ...
  **/
  ...
  /**
   * <p>Authentication method registered for the token endpoint. Always <code>none</code>.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OAuthClientRegistrationResponse oAuthClientRegistrationResponse = (OAuthClientRegistrationResponse) o;
    return Objects.equals(this.clientId, oAuthClientRegistrationResponse.clientId) && Objects.equals(this.clientName, oAuthClientRegistrationResponse.clientName) && Objects.equals(this.grantTypes, oAuthClientRegistrationResponse.grantTypes) && Objects.equals(this.redirectUris, oAuthClientRegistrationResponse.redirectUris) && Objects.equals(this.responseTypes, oAuthClientRegistrationResponse.responseTypes) && Objects.equals(this.tokenEndpointAuthMethod, oAuthClientRegistrationResponse.tokenEndpointAuthMethod) && Objects.equals(this.additionalProperties, oAuthClientRegistrationResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(clientId,clientName,grantTypes,redirectUris,responseTypes,tokenEndpointAuthMethod, additionalProperties);
  }
