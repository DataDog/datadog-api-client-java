...
public class ModelLabRunArtifactsData {
  ...
  @JsonCreator
  public ModelLabRunArtifactsData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ModelLabRunArtifactsAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the artifacts resource.</p>
   * @return id
  **/
  ...
  /**
   * <p>The JSON:API type for a run artifacts resource.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, modelLabRunArtifactsData.attributes) && Objects.equals(this.id, modelLabRunArtifactsData.id) && Objects.equals(this.type, modelLabRunArtifactsData.type) && Objects.equals(this.additionalProperties, modelLabRunArtifactsData.additionalProperties);
  }
