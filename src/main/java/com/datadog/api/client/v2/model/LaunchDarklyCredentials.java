...
public class LaunchDarklyCredentials extends AbstractOpenApiSchema {
    ...
    public static class LaunchDarklyCredentialsSerializer extends StdSerializer<LaunchDarklyCredentials> {
        ...
        @Override
        public void serialize(LaunchDarklyCredentials value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class LaunchDarklyCredentialsDeserializer extends StdDeserializer<LaunchDarklyCredentials> {
        ...
        @Override
        public LaunchDarklyCredentials deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (LaunchDarklyAPIKey.class.equals(Integer.class) || LaunchDarklyAPIKey.class.equals(Long.class) || LaunchDarklyAPIKey.class.equals(Float.class) || LaunchDarklyAPIKey.class.equals(Double.class) || LaunchDarklyAPIKey.class.equals(Boolean.class) || LaunchDarklyAPIKey.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((LaunchDarklyAPIKey.class.equals(Integer.class) || LaunchDarklyAPIKey.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((LaunchDarklyAPIKey.class.equals(Float.class) || LaunchDarklyAPIKey.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (LaunchDarklyAPIKey.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (LaunchDarklyAPIKey.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public LaunchDarklyCredentials getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `LaunchDarklyAPIKey`. If the actual instance is not `LaunchDarklyAPIKey`,
