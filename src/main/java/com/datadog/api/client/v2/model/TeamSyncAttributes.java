...
public class TeamSyncAttributes {
  ...
  **/
  ...
  /**
   * <p>Specifies which teams or organizations to sync. When
   * provided, synchronization is limited to the specified
   * items and their subtrees.</p>
