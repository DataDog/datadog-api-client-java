...
public class SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse {
  ...
  public SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse
  ...
  /**
   * The period each metric aggregates over. When <code>true</code>, metrics aggregate the past 24
   * hours on a rolling basis; when <code>false</code>, they aggregate the current day so far.
   *
   ...
   * @return SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse
   */
  @JsonAnySetter
  public SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse putAdditionalProperty(
  ...
  /**
   * Return true if this SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse object
   * is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse
        snowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse =
            (SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(organizationUsageMetricsAggregateLast24h, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnowflakeOrganizationUsageMetricsIntegrationDataflowSettingsResponse {\n");
