...
/**
   * <p>AWS Accounts response body.</p>
 */
@JsonPropertyOrder({
  AWSAccountsResponse.JSON_PROPERTY_DATA
})
...
public class AWSAccountsResponse {
  ...
  private List<AWSAccountResponseData> data = new ArrayList<>();

  public AWSAccountsResponse() {}

  @JsonCreator
  public AWSAccountsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<AWSAccountResponseData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>List of AWS Account Integration Configs.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<AWSAccountResponseData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, awsAccountsResponse.data) && Objects.equals(this.additionalProperties, awsAccountsResponse.additionalProperties);
  }
