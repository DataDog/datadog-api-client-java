...
public class AWSAccountsResponse {
  ...
  private List<AWSAccount> data = null;

  public AWSAccountsResponse data(List<AWSAccount> data) {
    this.data = data;
    for (AWSAccount item : data) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }

  public AWSAccountsResponse addDataItem(AWSAccount dataItem) {
    if (this.data == null) {
  ...
  public List<AWSAccount> getData() {
    return data;
  }

  public void setData(List<AWSAccount> data) {
    this.data = data;
  }
