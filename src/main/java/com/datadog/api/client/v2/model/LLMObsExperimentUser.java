...
public class LLMObsExperimentUser {
  ...
  **/
  ...
  /**
   * <p>Username or handle associated with the user's Datadog account.</p>
   * @return handle
  **/
      @jakarta.annotation.Nullable
