 ...
 */
@JsonPropertyOrder({
  ListInvestigationsResponseMeta.JSON_PROPERTY_PAGE
})
...
public class ListInvestigationsResponseMeta {
  ...
  @JsonCreator
  public ListInvestigationsResponseMeta(
            @JsonProperty(required=true, value=JSON_PROPERTY_PAGE)ListInvestigationsResponseMetaPage page) {
        this.page = page;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ListInvestigationsResponseMeta listInvestigationsResponseMeta = (ListInvestigationsResponseMeta) o;
    return Objects.equals(this.page, listInvestigationsResponseMeta.page) && Objects.equals(this.additionalProperties, listInvestigationsResponseMeta.additionalProperties);
  }
