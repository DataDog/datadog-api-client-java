...
@JsonPropertyOrder({
  OnCallNotificationRuleRequestAttributes.JSON_PROPERTY_CATEGORY,
  OnCallNotificationRuleRequestAttributes.JSON_PROPERTY_CHANNEL_SETTINGS,
  OnCallNotificationRuleRequestAttributes.JSON_PROPERTY_DELAY_MINUTES
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class OnCallNotificationRuleRequestAttributes {
  ...
  public OnCallNotificationRuleRequestAttributes category(OnCallNotificationRuleCategory category) {
  ...
  public OnCallNotificationRuleRequestAttributes channelSettings(
      OnCallNotificationRuleChannelSettings channelSettings) {
  ...
  public OnCallNotificationRuleRequestAttributes delayMinutes(Long delayMinutes) {
    this.delayMinutes = delayMinutes;
    return this;
  }

  /**
   * The number of minutes that will elapse before this rule is evaluated. 0 indicates immediate
   * evaluation
   *
   * @return delayMinutes
   */
   ...
   * @return OnCallNotificationRuleRequestAttributes
   */
  @JsonAnySetter
  public OnCallNotificationRuleRequestAttributes putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this OnCallNotificationRuleRequestAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    OnCallNotificationRuleRequestAttributes onCallNotificationRuleRequestAttributes =
        (OnCallNotificationRuleRequestAttributes) o;
    return Objects.equals(this.category, onCallNotificationRuleRequestAttributes.category)
        && Objects.equals(
            this.channelSettings, onCallNotificationRuleRequestAttributes.channelSettings)
        && Objects.equals(this.delayMinutes, onCallNotificationRuleRequestAttributes.delayMinutes)
        && Objects.equals(
            this.additionalProperties,
            onCallNotificationRuleRequestAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OnCallNotificationRuleRequestAttributes {\n");
