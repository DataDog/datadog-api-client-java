...
public class ProductAnalyticsCalendarInterval {
  ...
  public ProductAnalyticsCalendarInterval(
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ProductAnalyticsCalendarIntervalType type) {
    this.type = type;
  ...
  /**
   * Where each bucket starts within the calendar unit. Use an hour for <code>day</code> (for
   * example <code>1am</code> or <code>14</code>), a day name for <code>week</code> (for example
   * <code>monday</code>), or an ordinal for <code>month</code> (for example <code>1st</code>).
   *
   * @return alignment
   */
  ...
  /**
   * Number of calendar units per bucket. minimum: 1
   *
   * @return quantity
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsCalendarInterval productAnalyticsCalendarInterval =
        (ProductAnalyticsCalendarInterval) o;
    return Objects.equals(this.alignment, productAnalyticsCalendarInterval.alignment)
        && Objects.equals(this.quantity, productAnalyticsCalendarInterval.quantity)
        && Objects.equals(this.timezone, productAnalyticsCalendarInterval.timezone)
        && Objects.equals(this.type, productAnalyticsCalendarInterval.type)
        && Objects.equals(
            this.additionalProperties, productAnalyticsCalendarInterval.additionalProperties);
  }
