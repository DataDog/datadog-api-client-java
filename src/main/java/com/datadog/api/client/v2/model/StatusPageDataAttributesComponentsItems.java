...
/**
   * <p>A component displayed on a status page.</p>
 */
@JsonPropertyOrder({
...
public class StatusPageDataAttributesComponentsItems {
  ...
  **/
  ...
  public void setComponents(List<StatusPageDataAttributesComponentsItemsComponentsItems> components) {
    this.components = components;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StatusPageDataAttributesComponentsItems statusPageDataAttributesComponentsItems = (StatusPageDataAttributesComponentsItems) o;
    return Objects.equals(this.components, statusPageDataAttributesComponentsItems.components) && Objects.equals(this.id, statusPageDataAttributesComponentsItems.id) && Objects.equals(this.name, statusPageDataAttributesComponentsItems.name) && Objects.equals(this.position, statusPageDataAttributesComponentsItems.position) && Objects.equals(this.status, statusPageDataAttributesComponentsItems.status) && Objects.equals(this.type, statusPageDataAttributesComponentsItems.type) && Objects.equals(this.additionalProperties, statusPageDataAttributesComponentsItems.additionalProperties);
  }
