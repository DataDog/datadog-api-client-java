...
public class DowntimeResourceType extends ModelEnum<String> {
  ...
  public static class DowntimeResourceTypeSerializer extends StdSerializer<DowntimeResourceType> {
      ...
      @Override
      public void serialize(DowntimeResourceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
