...
/**
   * <p>A single agentless host resource.</p>
 */
@JsonPropertyOrder({
...
public class CsmAgentlessHostData {
  ...
  @JsonCreator
  public CsmAgentlessHostData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CsmAgentlessHostAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>The resource identifier of the agentless host.</p>
   * @return id
  **/
  ...
  /**
   * <p>The JSON:API type for agentless host resources. The value should always be <code>agentless_host</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, csmAgentlessHostData.attributes) && Objects.equals(this.id, csmAgentlessHostData.id) && Objects.equals(this.type, csmAgentlessHostData.type) && Objects.equals(this.additionalProperties, csmAgentlessHostData.additionalProperties);
  }
