...
@JsonPropertyOrder({
  TicketCreationRuleAction.JSON_PROPERTY_ASSIGNEE_ID,
  TicketCreationRuleAction.JSON_PROPERTY_FIELDS,
  TicketCreationRuleAction.JSON_PROPERTY_MAX_TICKETS_PER_DAY,
  TicketCreationRuleAction.JSON_PROPERTY_PROJECT_ID,
  TicketCreationRuleAction.JSON_PROPERTY_TARGET
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class TicketCreationRuleAction {
   ...
   * @return TicketCreationRuleAction
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    TicketCreationRuleAction ticketCreationRuleAction = (TicketCreationRuleAction) o;
    return Objects.equals(this.assigneeId, ticketCreationRuleAction.assigneeId)
        && Objects.equals(this.fields, ticketCreationRuleAction.fields)
        && Objects.equals(this.maxTicketsPerDay, ticketCreationRuleAction.maxTicketsPerDay)
        && Objects.equals(this.projectId, ticketCreationRuleAction.projectId)
        && Objects.equals(this.target, ticketCreationRuleAction.target)
        && Objects.equals(this.additionalProperties, ticketCreationRuleAction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        assigneeId, fields, maxTicketsPerDay, projectId, target, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TicketCreationRuleAction {\n");
