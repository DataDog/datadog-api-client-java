...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionRedact</code>
 * object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorActionRedact {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionRedactAction
   * </code> object.
   *
   * @return action
   */
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionRedactOptions
   * </code> object.
   *
   * @return options
   */
