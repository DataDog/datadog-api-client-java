...
public class ObservabilityPipelineSplunkHecDestination {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(autoExtractTimestamp,buffer,encoding,endpointUrlKey,id,index,indexedFields,inputs,sourcetype,tokenKey,tokenStrategy,type, additionalProperties);
  }
