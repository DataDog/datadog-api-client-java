...
public class ObservabilityPipelineSplunkHecDestination {
   ...
   * If <code>false</code>, Splunk assigns the time the event was received.
   * Only applies when <code>endpoint_target</code> is <code>event</code>; cannot be <code>true</code> when <code>endpoint_target</code> is <code>raw</code>.</p>
  ...
  **/
  ...
  public ObservabilityPipelineSplunkHecDestination endpointTarget(ObservabilityPipelineSplunkHecDestinationEndpointTarget endpointTarget) {
  ...
  **/
  ...
  public void setEndpointTarget(ObservabilityPipelineSplunkHecDestinationEndpointTarget endpointTarget) {
  ...
  **/
  ...
  /**
   * <p>List of log field names to send as indexed fields to Splunk HEC. Available only when <code>encoding</code> is <code>json</code>.</p>
  ...
  **/
  ...
  public ObservabilityPipelineSplunkHecDestination tokenStrategy(ObservabilityPipelineSplunkHecDestinationTokenStrategy tokenStrategy) {
  ...
  **/
  ...
  public void setTokenStrategy(ObservabilityPipelineSplunkHecDestinationTokenStrategy tokenStrategy) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.autoExtractTimestamp, observabilityPipelineSplunkHecDestination.autoExtractTimestamp) && Objects.equals(this.buffer, observabilityPipelineSplunkHecDestination.buffer) && Objects.equals(this.encoding, observabilityPipelineSplunkHecDestination.encoding) && Objects.equals(this.endpointTarget, observabilityPipelineSplunkHecDestination.endpointTarget) && Objects.equals(this.endpointUrlKey, observabilityPipelineSplunkHecDestination.endpointUrlKey) && Objects.equals(this.id, observabilityPipelineSplunkHecDestination.id) && Objects.equals(this.index, observabilityPipelineSplunkHecDestination.index) && Objects.equals(this.indexedFields, observabilityPipelineSplunkHecDestination.indexedFields) && Objects.equals(this.inputs, observabilityPipelineSplunkHecDestination.inputs) && Objects.equals(this.sourcetype, observabilityPipelineSplunkHecDestination.sourcetype) && Objects.equals(this.tokenKey, observabilityPipelineSplunkHecDestination.tokenKey) && Objects.equals(this.tokenStrategy, observabilityPipelineSplunkHecDestination.tokenStrategy) && Objects.equals(this.type, observabilityPipelineSplunkHecDestination.type) && Objects.equals(this.additionalProperties, observabilityPipelineSplunkHecDestination.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(autoExtractTimestamp,buffer,encoding,endpointTarget,endpointUrlKey,id,index,indexedFields,inputs,sourcetype,tokenKey,tokenStrategy,type, additionalProperties);
  }
