...
/**
   * <p>An error encountered while validating or applying an operation.</p>
 */
@JsonPropertyOrder({
...
public class TeamsOwnershipMappingBatchError {
  ...
  /**
   * <p>A human-readable explanation specific to this error.</p>
   * @return detail
  **/
  ...
  /**
   * <p>The HTTP status code applicable to this error.</p>
   * @return status
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingBatchError teamsOwnershipMappingBatchError = (TeamsOwnershipMappingBatchError) o;
    return Objects.equals(this.detail, teamsOwnershipMappingBatchError.detail) && Objects.equals(this.status, teamsOwnershipMappingBatchError.status) && Objects.equals(this.title, teamsOwnershipMappingBatchError.title) && Objects.equals(this.additionalProperties, teamsOwnershipMappingBatchError.additionalProperties);
  }
