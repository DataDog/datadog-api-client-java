...
public class SensitiveDataScannerStandardPatternAttributes {
  ...
  /**
   * <p>Description of the standard pattern.</p>
   * @return description
  **/
  ...
  **/
  ...
  /**
   * <p>(Deprecated) Regex to match, optionally documented for older standard rules. Refer to the <code>description</code> field to understand what the rule does.</p>
   * @return pattern
   * @deprecated
  **/
      @Deprecated
  ...
  /**
   * <p>Integer from 1 (high) to 5 (low) indicating standard pattern issue severity.</p>
   * minimum: 1
   * maximum: 5
   * @return priority
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, sensitiveDataScannerStandardPatternAttributes.description) && Objects.equals(this.includedKeywords, sensitiveDataScannerStandardPatternAttributes.includedKeywords) && Objects.equals(this.name, sensitiveDataScannerStandardPatternAttributes.name) && Objects.equals(this.pattern, sensitiveDataScannerStandardPatternAttributes.pattern) && Objects.equals(this.priority, sensitiveDataScannerStandardPatternAttributes.priority) && Objects.equals(this.tags, sensitiveDataScannerStandardPatternAttributes.tags) && Objects.equals(this.additionalProperties, sensitiveDataScannerStandardPatternAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(description,includedKeywords,name,pattern,priority,tags, additionalProperties);
  }
