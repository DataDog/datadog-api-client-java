...
/**
   * <p>Available connection types between organizations.</p>
 */
...
public class OrgConnectionTypeEnum extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("logs", "metrics", "audit"));
  ...
  public static class OrgConnectionTypeEnumSerializer extends StdSerializer<OrgConnectionTypeEnum> {
      ...
      @Override
      public void serialize(OrgConnectionTypeEnum value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
