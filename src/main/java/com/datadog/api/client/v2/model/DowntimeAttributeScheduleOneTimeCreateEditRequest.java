...
@JsonPropertyOrder({
  DowntimeAttributeScheduleOneTimeCreateEditRequest.JSON_PROPERTY_END,
  DowntimeAttributeScheduleOneTimeCreateEditRequest.JSON_PROPERTY_START
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class DowntimeAttributeScheduleOneTimeCreateEditRequest {
  ...
  public DowntimeAttributeScheduleOneTimeCreateEditRequest end(OffsetDateTime end) {
  ...
  public DowntimeAttributeScheduleOneTimeCreateEditRequest start(OffsetDateTime start) {
  ...
  /** Return true if this DowntimeAttributeScheduleOneTimeCreateEditRequest object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, downtimeAttributeScheduleOneTimeCreateEditRequest.end)
        && Objects.equals(this.start, downtimeAttributeScheduleOneTimeCreateEditRequest.start);
  }
  ...
  public String toString() {
    ...
    sb.append("class DowntimeAttributeScheduleOneTimeCreateEditRequest {\n");
