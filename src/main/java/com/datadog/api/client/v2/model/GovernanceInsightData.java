...
/**
   * <p>A governance insight resource.</p>
 */
@JsonPropertyOrder({
...
public class GovernanceInsightData {
  ...
  @JsonCreator
  public GovernanceInsightData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)GovernanceInsightAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)GovernanceInsightResourceType type) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, governanceInsightData.attributes) && Objects.equals(this.id, governanceInsightData.id) && Objects.equals(this.type, governanceInsightData.type) && Objects.equals(this.additionalProperties, governanceInsightData.additionalProperties);
  }
