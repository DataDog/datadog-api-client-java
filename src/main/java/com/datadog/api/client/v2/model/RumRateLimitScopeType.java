...
/**
   * <p>The type of scope the rate limit configuration applies to.</p>
 */
...
public class RumRateLimitScopeType extends ModelEnum<String> {
  ...
  public static class RumRateLimitScopeTypeSerializer extends StdSerializer<RumRateLimitScopeType> {
      ...
      @Override
      public void serialize(RumRateLimitScopeType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
