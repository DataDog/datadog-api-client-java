...
public class SyntheticsTestResultVariables {
  ...
  private List<SyntheticsTestResultVariable> extracted = null;
  ...
  public SyntheticsTestResultVariables addConfigItem(SyntheticsTestResultVariable configItem) {
    ...
    this.unparsed |= configItem.unparsed;
    return this;
  }
  ...
  public SyntheticsTestResultVariables addExtractedItem(
    ...
    this.extracted.add(extractedItem);
    this.unparsed |= extractedItem.unparsed;
    return this;
  }
   ...
   * @return SyntheticsTestResultVariables
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class SyntheticsTestResultVariables {\n");
