...
/**
   * <p>Incident integration metadata data for a patch request.</p>
 */
@JsonPropertyOrder({
...
public class IncidentIntegrationMetadataPatchData {
  ...
  @JsonCreator
  public IncidentIntegrationMetadataPatchData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)IncidentIntegrationMetadataAttributes attributes,
  ...
  public IncidentIntegrationMetadataPatchData attributes(IncidentIntegrationMetadataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
   ...
   * @return IncidentIntegrationMetadataPatchData
   */
  @JsonAnySetter
  public IncidentIntegrationMetadataPatchData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IncidentIntegrationMetadataPatchData incidentIntegrationMetadataPatchData = (IncidentIntegrationMetadataPatchData) o;
    return Objects.equals(this.attributes, incidentIntegrationMetadataPatchData.attributes) && Objects.equals(this.type, incidentIntegrationMetadataPatchData.type) && Objects.equals(this.additionalProperties, incidentIntegrationMetadataPatchData.additionalProperties);
  }
