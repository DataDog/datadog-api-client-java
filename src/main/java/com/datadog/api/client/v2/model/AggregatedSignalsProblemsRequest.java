...
/**
   * <p>Request body for the aggregated signals and problems endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedSignalsProblemsRequest.JSON_PROPERTY_DATA
})
...
public class AggregatedSignalsProblemsRequest {
  ...
  @JsonCreator
  public AggregatedSignalsProblemsRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedSignalsProblemsRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedSignalsProblemsRequest aggregatedSignalsProblemsRequest = (AggregatedSignalsProblemsRequest) o;
    return Objects.equals(this.data, aggregatedSignalsProblemsRequest.data) && Objects.equals(this.additionalProperties, aggregatedSignalsProblemsRequest.additionalProperties);
  }
