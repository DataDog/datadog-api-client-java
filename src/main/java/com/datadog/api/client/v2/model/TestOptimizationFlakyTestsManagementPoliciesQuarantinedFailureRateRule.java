...
public class TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule {
  ...
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule branches(List<String> branches) {
    this.branches = branches;
    return this;
  }
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule addBranchesItem(String branchesItem) {
  ...
  **/
  ...
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule enabled(Boolean enabled) {
  ...
  **/
  ...
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule minRuns(Long minRuns) {
  ...
  **/
  ...
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule threshold(Double threshold) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this TestOptimizationFlakyTestsManagementPoliciesQuarantinedFailureRateRule object is equal to o.
   */
  @Override
