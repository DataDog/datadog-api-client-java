...
public class IncidentUserDefinedFieldAttributesResponse {
  ...
  @JsonCreator
  public IncidentUserDefinedFieldAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_CATEGORY)IncidentUserDefinedFieldCategory category,
            @JsonProperty(required=true, value=JSON_PROPERTY_COLLECTED)IncidentUserDefinedFieldCollected collected,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_METADATA)IncidentUserDefinedFieldMetadata metadata,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_VALID_VALUES)List<IncidentUserDefinedFieldValidValue> validValues) {
  ...
  public IncidentUserDefinedFieldAttributesResponse category(IncidentUserDefinedFieldCategory category) {
    this.category = category;
        if (category != null) {
    this.unparsed |= !category.isValid();
    }
  ...
  **/
  ...
  public IncidentUserDefinedFieldAttributesResponse collected(IncidentUserDefinedFieldCollected collected) {
    this.collected = collected;
        if (collected != null) {
    this.unparsed |= !collected.isValid();
    }
  ...
  **/
  ...
  /**
   * <p>Timestamp when the field was created.</p>
   * @return created
  **/
  ...
  **/
  ...
  /**
   * <p>Timestamp when the field was soft-deleted, or null if not deleted.</p>
   * @return deleted
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The human-readable name shown in the UI.</p>
   * @return displayName
  **/
  ...
  public IncidentUserDefinedFieldAttributesResponse metadata(IncidentUserDefinedFieldMetadata metadata) {
    this.metadata = metadata;
        if (metadata != null) {
    this.unparsed |= metadata.unparsed;
    }
  ...
  /**
   * <p>Metadata for autocomplete-type user-defined fields, describing how to populate autocomplete options.</p>
   * @return metadata
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp when the field was last modified.</p>
   * @return modified
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>When true, this field is reserved for system use and cannot be deleted.</p>
   * @return reserved
  **/
  ...
  **/
  ...
  public IncidentUserDefinedFieldAttributesResponse validValues(List<IncidentUserDefinedFieldValidValue> validValues) {
    this.validValues = validValues;
    for (IncidentUserDefinedFieldValidValue item : validValues) {
      this.unparsed |= item.unparsed;
    }
  ...
  public IncidentUserDefinedFieldAttributesResponse addValidValuesItem(IncidentUserDefinedFieldValidValue validValuesItem) {
  ...
  /**
   * <p>The list of allowed values for dropdown, multiselect, and autocomplete fields.</p>
   * @return validValues
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public IncidentUserDefinedFieldAttributesResponse putAdditionalProperty(String key, Object value) {
