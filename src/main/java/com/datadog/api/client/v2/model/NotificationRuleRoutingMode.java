...
public class NotificationRuleRoutingMode extends ModelEnum<String> {
  ...
  public static final NotificationRuleRoutingMode MANUAL = new NotificationRuleRoutingMode("manual");
  ...
  public static class NotificationRuleRoutingModeSerializer extends StdSerializer<NotificationRuleRoutingMode> {
      ...
      @Override
      public void serialize(NotificationRuleRoutingMode value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
