...
public class FormPublicationType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("form_publications"));

  public static final FormPublicationType FORM_PUBLICATIONS = new FormPublicationType("form_publications");
  ...
  public static class FormPublicationTypeSerializer extends StdSerializer<FormPublicationType> {
      ...
      @Override
      public void serialize(FormPublicationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
