 ...
 */
@JsonPropertyOrder({
  RumMetricResponseUniqueness.JSON_PROPERTY_WHEN
})
...
public class RumMetricResponseUniqueness {
  ...
  /**
   * <p>When to count updatable events. <code>match</code> when the event is first seen, or <code>end</code> when the event is complete.</p>
   * @return when
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.when, rumMetricResponseUniqueness.when) && Objects.equals(this.additionalProperties, rumMetricResponseUniqueness.additionalProperties);
  }
