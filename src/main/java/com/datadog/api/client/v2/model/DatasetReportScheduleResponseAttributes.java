...
@JsonPropertyOrder({
  ...
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_DESCRIPTION,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_FILE_ROW_LIMIT,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_INLINE_ROW_LIMIT,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_NEXT_RECURRENCE,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_NOTEBOOK_ID,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_RECIPIENTS,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_RESOURCE_ID,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_RESOURCE_TYPE,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_RRULE,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_STATUS,
  DatasetReportScheduleResponseAttributes.JSON_PROPERTY_TIMEFRAME,
...
public class DatasetReportScheduleResponseAttributes {
  ...
  public static final String JSON_PROPERTY_FILE_ROW_LIMIT = "file_row_limit";
  private Long fileRowLimit;

  public static final String JSON_PROPERTY_INLINE_ROW_LIMIT = "inline_row_limit";
  private Long inlineRowLimit;

  public static final String JSON_PROPERTY_NEXT_RECURRENCE = "next_recurrence";
  private Long nextRecurrence;

  public static final String JSON_PROPERTY_NOTEBOOK_ID = "notebook_id";
  ...
  private DatasetReportScheduleResourceType resourceType;
   ...
   * @return DatasetReportScheduleResponseAttributes
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class DatasetReportScheduleResponseAttributes {\n");
