...
/** The definition of <code>SecretRuleDataAttributes</code> object. */
@JsonPropertyOrder({
...
public class SecretRuleDataAttributes {
  ...
  /**
   * The <code>attributes</code> <code>default_included_keywords</code>.
   *
  ...
  /**
   * The <code>attributes</code> <code>license</code>.
   *
   * @return license
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>pattern</code>.
   *
   * @return pattern
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>priority</code>.
   *
   * @return priority
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>sds_id</code>.
   *
   * @return sdsId
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>attributes</code> <code>validators</code>.
   *
   * @return validators
   */
  @jakarta.annotation.Nullable
