...
public class DeploymentGatesMonitorRule {
  ...
  private DeploymentGatesMonitorRuleOptions options;

  public static final String JSON_PROPERTY_TYPE = "type";
  private DeploymentGatesMonitorRuleType type;
   ...
   * @return DeploymentGatesMonitorRule
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class DeploymentGatesMonitorRule {\n");
