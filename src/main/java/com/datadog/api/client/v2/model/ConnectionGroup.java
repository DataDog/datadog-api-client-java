...
/** The definition of <code>ConnectionGroup</code> object. */
@JsonPropertyOrder({
...
public class ConnectionGroup {
  ...
  @JsonCreator
  public ConnectionGroup(
      @JsonProperty(required = true, value = JSON_PROPERTY_CONNECTION_GROUP_ID)
  ...
  /**
   * The <code>ConnectionGroup</code> <code>connectionGroupId</code>.
   *
  ...
  /**
   * The <code>ConnectionGroup</code> <code>label</code>.
   *
   * @return label
   */
  ...
  /**
   * The <code>ConnectionGroup</code> <code>tags</code>.
   *
   * @return tags
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionGroupId, connectionGroup.connectionGroupId)
        && Objects.equals(this.label, connectionGroup.label)
        && Objects.equals(this.tags, connectionGroup.tags)
        && Objects.equals(this.additionalProperties, connectionGroup.additionalProperties);
  }
