...
/**
   * <p>A query for container-level metrics such as CPU and memory usage.</p>
 */
@JsonPropertyOrder({
  ...
  ContainerTimeseriesQuery.JSON_PROPERTY_METRIC,
  ContainerTimeseriesQuery.JSON_PROPERTY_NAME,
  ContainerTimeseriesQuery.JSON_PROPERTY_SORT,
  ContainerTimeseriesQuery.JSON_PROPERTY_TAG_FILTERS,
  ContainerTimeseriesQuery.JSON_PROPERTY_TEXT_FILTER
})
...
public class ContainerTimeseriesQuery {
  ...
  public ContainerTimeseriesQuery() {}

  @JsonCreator
  public ContainerTimeseriesQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)ContainerDataSource dataSource,
  ...
  **/
  ...
  /**
   * <p>A data source for container-level infrastructure metrics.</p>
   * @return dataSource
  **/
  ...
  public ContainerTimeseriesQuery isNormalizedCpu(Boolean isNormalizedCpu) {
    this.isNormalizedCpu = isNormalizedCpu;
    return this;
  }

  /**
   * <p>Whether CPU metrics should be normalized by core count.</p>
  ...
  **/
  ...
  public ContainerTimeseriesQuery limit(Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public ContainerTimeseriesQuery metric(String metric) {
    this.metric = metric;
    return this;
  }

  /**
   * <p>The container metric to query.</p>
   * @return metric
  **/
  ...
  public ContainerTimeseriesQuery name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ContainerTimeseriesQuery sort(QuerySortOrder sort) {
    this.sort = sort;
  ...
  **/
  ...
  public ContainerTimeseriesQuery tagFilters(List<String> tagFilters) {
    this.tagFilters = tagFilters;
    return this;
  }
  public ContainerTimeseriesQuery addTagFiltersItem(String tagFiltersItem) {
  ...
  /**
   * <p>Tag filters to narrow down containers.</p>
   * @return tagFilters
  **/
      @jakarta.annotation.Nullable
  ...
  public ContainerTimeseriesQuery textFilter(String textFilter) {
    this.textFilter = textFilter;
    return this;
  }

  /**
   * <p>A full-text search filter to match container names.</p>
   * @return textFilter
  **/
      @jakarta.annotation.Nullable
   ...
   * @return ContainerTimeseriesQuery
   */
  @JsonAnySetter
  public ContainerTimeseriesQuery putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ContainerTimeseriesQuery object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.crossOrgUuids, containerTimeseriesQuery.crossOrgUuids) && Objects.equals(this.dataSource, containerTimeseriesQuery.dataSource) && Objects.equals(this.isNormalizedCpu, containerTimeseriesQuery.isNormalizedCpu) && Objects.equals(this.limit, containerTimeseriesQuery.limit) && Objects.equals(this.metric, containerTimeseriesQuery.metric) && Objects.equals(this.name, containerTimeseriesQuery.name) && Objects.equals(this.sort, containerTimeseriesQuery.sort) && Objects.equals(this.tagFilters, containerTimeseriesQuery.tagFilters) && Objects.equals(this.textFilter, containerTimeseriesQuery.textFilter) && Objects.equals(this.additionalProperties, containerTimeseriesQuery.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(crossOrgUuids,dataSource,isNormalizedCpu,limit,metric,name,sort,tagFilters,textFilter, additionalProperties);
  }
