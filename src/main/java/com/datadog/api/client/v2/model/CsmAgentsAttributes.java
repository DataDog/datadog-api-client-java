...
/**
   * <p>A CSM Agent returned by the API.</p>
 */
@JsonPropertyOrder({
...
public class CsmAgentsAttributes {
  ...
  /**
   * <p>Version of the Datadog Agent.</p>
   * @return agentVersion
  **/
  ...
  **/
  ...
  /**
   * <p>List of cluster names associated with the Agent.</p>
   * @return clusterName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier for the Datadog Agent.</p>
   * @return datadogAgent
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>ARN of the ECS Fargate task.</p>
  ...
  **/
  ...
  /**
   * <p>List of environments associated with the Agent.</p>
   * @return envs
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_ENVS)public void setEnvs_JsonNullable(JsonNullable<List<String>> envs) {
    this.envs = envs;
  }
  ...
  **/
  ...
  /**
   * <p>Version of the installer used for installing the Datadog Agent.</p>
  ...
  **/
  ...
  /**
   * <p>Tool used for installing the Datadog Agent.</p>
  ...
  **/
  ...
  /**
   * <p>Indicates if CSM VM Containers is enabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_CSM_VM_CONTAINERS_ENABLED)public void setIsCsmVmContainersEnabled_JsonNullable(JsonNullable<Boolean> isCsmVmContainersEnabled) {
  ...
  /**
   * <p>Indicates if CSM VM Hosts is enabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_CSM_VM_HOSTS_ENABLED)public void setIsCsmVmHostsEnabled_JsonNullable(JsonNullable<Boolean> isCsmVmHostsEnabled) {
  ...
  /**
   * <p>Indicates if CSPM is enabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_CSPM_ENABLED)public void setIsCspmEnabled_JsonNullable(JsonNullable<Boolean> isCspmEnabled) {
  ...
  /**
   * <p>Indicates if CWS is enabled.</p>
   * @return isCwsEnabled
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_IS_CWS_ENABLED)public void setIsCwsEnabled_JsonNullable(JsonNullable<Boolean> isCwsEnabled) {
  ...
  public CsmAgentsAttributes isCwsRemoteConfigurationEnabled(Boolean isCwsRemoteConfigurationEnabled) {
    this.isCwsRemoteConfigurationEnabled = JsonNullable.<Boolean>of(isCwsRemoteConfigurationEnabled);
    return this;
  }

  /**
   * <p>Indicates if CWS Remote Configuration is enabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_CWS_REMOTE_CONFIGURATION_ENABLED)public void setIsCwsRemoteConfigurationEnabled_JsonNullable(JsonNullable<Boolean> isCwsRemoteConfigurationEnabled) {
  ...
  /**
   * <p>Indicates if Remote Configuration is enabled.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_IS_REMOTE_CONFIGURATION_ENABLED)public void setIsRemoteConfigurationEnabled_JsonNullable(JsonNullable<Boolean> isRemoteConfigurationEnabled) {
  ...
  /**
   * <p>Operating system of the host.</p>
   * @return os
  **/
      @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentVersion,awsFargate,clusterName,datadogAgent,ecsFargateTaskArn,envs,hostId,hostname,installMethodInstallerVersion,installMethodTool,isCsmVmContainersEnabled,isCsmVmHostsEnabled,isCspmEnabled,isCwsEnabled,isCwsRemoteConfigurationEnabled,isRemoteConfigurationEnabled,os, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    isCsmVmContainersEnabled: ").append(toIndentedString(isCsmVmContainersEnabled)).append("\n");
    sb.append("    isCsmVmHostsEnabled: ").append(toIndentedString(isCsmVmHostsEnabled)).append("\n");
    ...
    sb.append("    isCwsRemoteConfigurationEnabled: ").append(toIndentedString(isCwsRemoteConfigurationEnabled)).append("\n");
    sb.append("    isRemoteConfigurationEnabled: ").append(toIndentedString(isRemoteConfigurationEnabled)).append("\n");
