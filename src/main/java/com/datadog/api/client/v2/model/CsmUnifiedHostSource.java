...
public class CsmUnifiedHostSource extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("agent", "agentless", "both"));
  ...
  public static class CsmUnifiedHostSourceSerializer extends StdSerializer<CsmUnifiedHostSource> {
      ...
      @Override
      public void serialize(CsmUnifiedHostSource value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
