...
public class ScalarColumn extends AbstractOpenApiSchema {
    ...
    public static class ScalarColumnDeserializer extends StdDeserializer<ScalarColumn> {
        ...
        public ScalarColumn deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (GroupScalarColumn.class.equals(Integer.class) || GroupScalarColumn.class.equals(Long.class) || GroupScalarColumn.class.equals(Float.class) || GroupScalarColumn.class.equals(Double.class) || GroupScalarColumn.class.equals(Boolean.class) || GroupScalarColumn.class.equals(String.class)) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (DataScalarColumn.class.equals(Integer.class) || DataScalarColumn.class.equals(Long.class) || DataScalarColumn.class.equals(Float.class) || DataScalarColumn.class.equals(Double.class) || DataScalarColumn.class.equals(Boolean.class) || DataScalarColumn.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
     ...
     * GroupScalarColumn, DataScalarColumn
     *
    ...
    /**
     * Get the actual instance of `GroupScalarColumn`. If the actual instance is not `GroupScalarColumn`,
    ...
    /**
     * Get the actual instance of `DataScalarColumn`. If the actual instance is not `DataScalarColumn`,
     * the ClassCastException will be thrown.
     *
