...
public class IssueIncluded extends AbstractOpenApiSchema {
    ...
    public static class IssueIncludedSerializer extends StdSerializer<IssueIncluded> {
        ...
        @Override
        public void serialize(IssueIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class IssueIncludedDeserializer extends StdDeserializer<IssueIncluded> {
        ...
        @Override
        public IssueIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
