 ...
 */
@JsonPropertyOrder({
  EntityContextPage.JSON_PROPERTY_NEXT_TOKEN
})
...
public class EntityContextPage {
  ...
  /**
   * <p>An opaque token to pass as <code>page_token</code> in a subsequent request to retrieve the next page of results. Empty when there are no more results.</p>
   * @return nextToken
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.nextToken, entityContextPage.nextToken) && Objects.equals(this.additionalProperties, entityContextPage.additionalProperties);
  }
