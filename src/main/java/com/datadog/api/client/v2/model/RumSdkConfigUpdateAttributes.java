 ...
 */
@JsonPropertyOrder({
  RumSdkConfigUpdateAttributes.JSON_PROPERTY_RUM
})
...
public class RumSdkConfigUpdateAttributes {
  ...
  @JsonCreator
  public RumSdkConfigUpdateAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_RUM)RumSdkConfigRumUpdateAttributes rum) {
        this.rum = rum;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rum, rumSdkConfigUpdateAttributes.rum) && Objects.equals(this.additionalProperties, rumSdkConfigUpdateAttributes.additionalProperties);
  }
