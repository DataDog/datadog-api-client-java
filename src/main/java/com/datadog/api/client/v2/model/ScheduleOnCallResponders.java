...
/**
   * <p>Root object representing a schedule's on-call responders, grouped by position (previous, current, next), for a given point in time.</p>
 */
@JsonPropertyOrder({
...
public class ScheduleOnCallResponders {
  ...
  **/
  ...
  /**
   * <p>Related resources referenced in the responder groups' relationships, such as shifts, schedules, and users.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, scheduleOnCallResponders.data) && Objects.equals(this.included, scheduleOnCallResponders.included) && Objects.equals(this.additionalProperties, scheduleOnCallResponders.additionalProperties);
  }
