...
public class DomainAllowlistType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("domain_allowlist"));

  public static final DomainAllowlistType DOMAIN_ALLOWLIST = new DomainAllowlistType("domain_allowlist");
  ...
  public static class DomainAllowlistTypeSerializer extends StdSerializer<DomainAllowlistType> {
      ...
      @Override
      public void serialize(DomainAllowlistType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
