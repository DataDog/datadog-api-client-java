...
public class OnPremManagementServiceEnrollmentType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("enrollment"));
  ...
  public static class OnPremManagementServiceEnrollmentTypeSerializer
      extends StdSerializer<OnPremManagementServiceEnrollmentType> {
    public OnPremManagementServiceEnrollmentTypeSerializer(
        Class<OnPremManagementServiceEnrollmentType> t) {
      super(t);
    }
