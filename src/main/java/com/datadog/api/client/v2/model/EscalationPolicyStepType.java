...
public class EscalationPolicyStepType extends ModelEnum<String> {
  ...
  public static class EscalationPolicyStepTypeSerializer extends StdSerializer<EscalationPolicyStepType> {
      ...
      @Override
      public void serialize(EscalationPolicyStepType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
