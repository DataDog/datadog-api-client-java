...
public class ArbitraryRuleStatusResponseData {
  ...
  private ArbitraryRuleStatusResponseDataType type = ArbitraryRuleStatusResponseDataType.ARBITRARY_RULE_STATUS;

  public ArbitraryRuleStatusResponseData() {}

  @JsonCreator
  public ArbitraryRuleStatusResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ArbitraryRuleStatusResponseDataAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ArbitraryRuleStatusResponseDataType type) {
  ...
  public ArbitraryRuleStatusResponseData attributes(ArbitraryRuleStatusResponseDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The unique identifier of the custom allocation rule.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ArbitraryRuleStatusResponseData arbitraryRuleStatusResponseData = (ArbitraryRuleStatusResponseData) o;
    return Objects.equals(this.attributes, arbitraryRuleStatusResponseData.attributes) && Objects.equals(this.id, arbitraryRuleStatusResponseData.id) && Objects.equals(this.type, arbitraryRuleStatusResponseData.type) && Objects.equals(this.additionalProperties, arbitraryRuleStatusResponseData.additionalProperties);
  }
