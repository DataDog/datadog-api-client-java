...
/**
   * <p>The preview result for a single rule type.</p>
 */
@JsonPropertyOrder({
...
public class NotificationRulePreviewResult {
  ...
  @JsonCreator
  public NotificationRulePreviewResult(
            @JsonProperty(required=true, value=JSON_PROPERTY_NOTIFICATION_STATUS)NotificationRulePreviewNotificationStatus notificationStatus,
  ...
  public NotificationRulePreviewResult notificationStatus(NotificationRulePreviewNotificationStatus notificationStatus) {
    this.notificationStatus = notificationStatus;
    this.unparsed |= !notificationStatus.isValid();
    return this;
  }
  ...
  **/
   ...
   * api_security, host_vulnerability, iac_misconfiguration, sast_vulnerability, secret_vulnerability and workload_activity.</p>
   * @return ruleType
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.notificationStatus, notificationRulePreviewResult.notificationStatus) && Objects.equals(this.ruleType, notificationRulePreviewResult.ruleType) && Objects.equals(this.additionalProperties, notificationRulePreviewResult.additionalProperties);
  }
