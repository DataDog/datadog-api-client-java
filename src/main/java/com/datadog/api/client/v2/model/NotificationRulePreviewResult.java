...
public class NotificationRulePreviewResult {
   ...
   * host_vulnerability, iac_misconfiguration, sast_vulnerability, secret_vulnerability,
   * workload_activity, sensitive_data and serverless_function_code_vulnerability.
   *
   * @return ruleType
   */
