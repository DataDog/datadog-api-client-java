...
public class GovernanceInsightQueryConfig {
  ...
  /**
   * <p>The chart type the frontend should use to render the insight.</p>
   * @return chartType
  **/
  ...
  **/
  ...
  /**
   * <p>Whether an increase in the value is good, bad, or neutral. One of <code>neutral</code>,
   * <code>increase_better</code>, or <code>decrease_better</code>.</p>
