...
/**
 * The definition of <code>ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems
 * </code> object.
 */
@JsonPropertyOrder({
...
public class ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems {
  ...
  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems condition(
      String condition) {
    this.condition = condition;
    return this;
  }
  ...
  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems value(
      String value) {
    this.value = value;
    return this;
  }
  ...
  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems values(
      List<String> values) {
    this.values = JsonNullable.<List<String>>of(values);
    return this;
  }

  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems addValuesItem(
      String valuesItem) {
  ...
  /**
   * Return true if this ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems
  ...
  public boolean equals(Object o) {
    ...
    ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems
        arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems =
            (ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems) o;
    return Objects.equals(
            this.condition,
            arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems.condition)
        && Objects.equals(
            this.tag, arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems.tag)
        && Objects.equals(
            this.value,
            arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems.value)
        && Objects.equals(
            this.values,
            arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByFiltersItems.values)
        && Objects.equals(
