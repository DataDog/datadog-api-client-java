 ...
 */
@JsonPropertyOrder({
  CommitmentsTimeseriesMetric.JSON_PROPERTY_SERIES,
  CommitmentsTimeseriesMetric.JSON_PROPERTY_TIMES,
  CommitmentsTimeseriesMetric.JSON_PROPERTY_UNIT
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class CommitmentsTimeseriesMetric {
  @JsonIgnore
  ...
  public CommitmentsTimeseriesMetric() {}
  ...
  /**
   * <p>Timeseries data as a map of series names to their corresponding value arrays.</p>
   * @return series
  **/
  ...
  /**
   * <p>Unix timestamps in seconds for the timeseries data points.</p>
   * @return times
  **/
  ...
  **/
   ...
   * @return CommitmentsTimeseriesMetric
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    CommitmentsTimeseriesMetric commitmentsTimeseriesMetric = (CommitmentsTimeseriesMetric) o;
    return Objects.equals(this.series, commitmentsTimeseriesMetric.series) && Objects.equals(this.times, commitmentsTimeseriesMetric.times) && Objects.equals(this.unit, commitmentsTimeseriesMetric.unit) && Objects.equals(this.additionalProperties, commitmentsTimeseriesMetric.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CommitmentsTimeseriesMetric {\n");
