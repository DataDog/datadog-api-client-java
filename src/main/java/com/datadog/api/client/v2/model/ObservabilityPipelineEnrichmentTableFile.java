...
public class ObservabilityPipelineEnrichmentTableFile {
  ...
  @JsonCreator
  public ObservabilityPipelineEnrichmentTableFile(
            @JsonProperty(required=true, value=JSON_PROPERTY_ENCODING)ObservabilityPipelineEnrichmentTableFileEncoding encoding,
            @JsonProperty(required=true, value=JSON_PROPERTY_KEY)List<ObservabilityPipelineEnrichmentTableFileKeyItems> key,
            @JsonProperty(required=true, value=JSON_PROPERTY_PATH)String path,
            @JsonProperty(required=true, value=JSON_PROPERTY_SCHEMA)List<ObservabilityPipelineEnrichmentTableFileSchemaItems> schema) {
  ...
  public ObservabilityPipelineEnrichmentTableFile encoding(ObservabilityPipelineEnrichmentTableFileEncoding encoding) {
    this.encoding = encoding;
    this.unparsed |= encoding.unparsed;
    return this;
  }
  ...
  **/
  ...
  public ObservabilityPipelineEnrichmentTableFile key(List<ObservabilityPipelineEnrichmentTableFileKeyItems> key) {
    this.key = key;
  ...
  public ObservabilityPipelineEnrichmentTableFile addKeyItem(ObservabilityPipelineEnrichmentTableFileKeyItems keyItem) {
  ...
  /**
   * <p>Key fields used to look up enrichment values.</p>
   * @return key
  **/
  ...
  **/
  ...
  public ObservabilityPipelineEnrichmentTableFile schema(List<ObservabilityPipelineEnrichmentTableFileSchemaItems> schema) {
    this.schema = schema;
  ...
  public ObservabilityPipelineEnrichmentTableFile addSchemaItem(ObservabilityPipelineEnrichmentTableFileSchemaItems schemaItem) {
  ...
  /**
   * <p>Schema defining column names and their types.</p>
   * @return schema
  **/
