...
public class IncidentTimestampType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("detected", "resolved", "declared"));
  ...
  public static class IncidentTimestampTypeSerializer extends StdSerializer<IncidentTimestampType> {
      ...
      @Override
      public void serialize(IncidentTimestampType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
