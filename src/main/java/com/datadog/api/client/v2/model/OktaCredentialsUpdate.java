...
public class OktaCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class OktaCredentialsUpdateSerializer extends StdSerializer<OktaCredentialsUpdate> {
        ...
        @Override
        public void serialize(OktaCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class OktaCredentialsUpdateDeserializer extends StdDeserializer<OktaCredentialsUpdate> {
        ...
        @Override
        public OktaCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (OktaAPITokenUpdate.class.equals(Integer.class) || OktaAPITokenUpdate.class.equals(Long.class) || OktaAPITokenUpdate.class.equals(Float.class) || OktaAPITokenUpdate.class.equals(Double.class) || OktaAPITokenUpdate.class.equals(Boolean.class) || OktaAPITokenUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((OktaAPITokenUpdate.class.equals(Integer.class) || OktaAPITokenUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((OktaAPITokenUpdate.class.equals(Float.class) || OktaAPITokenUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (OktaAPITokenUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (OktaAPITokenUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public OktaCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `OktaAPITokenUpdate`. If the actual instance is not `OktaAPITokenUpdate`,
