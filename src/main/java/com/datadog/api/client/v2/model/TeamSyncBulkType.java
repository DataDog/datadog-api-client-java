...
public class TeamSyncBulkType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_sync_bulk"));
  ...
  public static class TeamSyncBulkTypeSerializer extends StdSerializer<TeamSyncBulkType> {
      ...
      @Override
      public void serialize(TeamSyncBulkType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
