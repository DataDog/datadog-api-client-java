...
public class SecurityEntityRiskScoreAttributes {
  ...
  public SecurityEntityRiskScoreAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_RISK_SCORE_EVOLUTION)Double riskScoreEvolution,
  ...
  **/
  ...
  /**
   * <p>Type of the entity (e.g., aws_iam_user, aws_ec2_instance)</p>
   * @return entityType
  **/
