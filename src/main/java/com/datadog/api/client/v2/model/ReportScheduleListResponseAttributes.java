...
@JsonPropertyOrder({
  ...
  ReportScheduleListResponseAttributes.JSON_PROPERTY_QUERY_PARAMS,
...
public class ReportScheduleListResponseAttributes {
  ...
  private Map<String, ReportScheduleQueryParameterValue> queryParams =
      new HashMap<String, ReportScheduleQueryParameterValue>();
  ...
  public ReportScheduleListResponseAttributes(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_QUERY_PARAMS)
          Map<String, ReportScheduleQueryParameterValue> queryParams,
  ...
  public ReportScheduleListResponseAttributes queryParams(
      Map<String, ReportScheduleQueryParameterValue> queryParams) {
    this.queryParams = queryParams;
    return this;
  }

  public ReportScheduleListResponseAttributes putQueryParamsItem(
      String key, ReportScheduleQueryParameterValue queryParamsItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public Map<String, ReportScheduleQueryParameterValue> getQueryParams() {
    return queryParams;
  }

  public void setQueryParams(Map<String, ReportScheduleQueryParameterValue> queryParams) {
    this.queryParams = queryParams;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deliveryFormat, reportScheduleListResponseAttributes.deliveryFormat)
        ...
        && Objects.equals(this.queryParams, reportScheduleListResponseAttributes.queryParams)
