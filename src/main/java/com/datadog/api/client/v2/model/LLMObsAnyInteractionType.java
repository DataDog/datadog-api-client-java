...
public class LLMObsAnyInteractionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("trace", "experiment_trace", "session", "display_block"));

  public static final LLMObsAnyInteractionType TRACE = new LLMObsAnyInteractionType("trace");
  public static final LLMObsAnyInteractionType EXPERIMENT_TRACE = new LLMObsAnyInteractionType("experiment_trace");
  public static final LLMObsAnyInteractionType SESSION = new LLMObsAnyInteractionType("session");
  public static final LLMObsAnyInteractionType DISPLAY_BLOCK = new LLMObsAnyInteractionType("display_block");
  ...
  public static class LLMObsAnyInteractionTypeSerializer extends StdSerializer<LLMObsAnyInteractionType> {
      ...
      @Override
      public void serialize(LLMObsAnyInteractionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
