...
/**
   * <p>Data object in the global incident settings response.</p>
 */
@JsonPropertyOrder({
...
public class GlobalIncidentSettingsDataResponse {
  ...
  @JsonCreator
  public GlobalIncidentSettingsDataResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)GlobalIncidentSettingsAttributesResponse attributes,
  ...
  public GlobalIncidentSettingsDataResponse attributes(GlobalIncidentSettingsAttributesResponse attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>The unique identifier for the global incident settings</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GlobalIncidentSettingsDataResponse globalIncidentSettingsDataResponse = (GlobalIncidentSettingsDataResponse) o;
    return Objects.equals(this.attributes, globalIncidentSettingsDataResponse.attributes) && Objects.equals(this.id, globalIncidentSettingsDataResponse.id) && Objects.equals(this.type, globalIncidentSettingsDataResponse.type) && Objects.equals(this.additionalProperties, globalIncidentSettingsDataResponse.additionalProperties);
  }
