...
public class FleetDeploymentConfigureV2DryRun {
  ...
  public FleetDeploymentConfigureV2DryRun(
      @JsonProperty(required = true, value = JSON_PROPERTY_ATTRIBUTES)
          FleetDeploymentConfigureV2DryRunAttributes attributes,
  ...
  public FleetDeploymentConfigureV2DryRun attributes(
      FleetDeploymentConfigureV2DryRunAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  ...
  /**
   * Always <code>"dry-run"</code> for a dry-run response. Does not identify a real deployment and
   * cannot be used to fetch a deployment by ID.
   *
   * @return id
   */
  ...
  public boolean equals(Object o) {
    ...
    FleetDeploymentConfigureV2DryRun fleetDeploymentConfigureV2DryRun =
        (FleetDeploymentConfigureV2DryRun) o;
    return Objects.equals(this.attributes, fleetDeploymentConfigureV2DryRun.attributes)
        && Objects.equals(this.id, fleetDeploymentConfigureV2DryRun.id)
        && Objects.equals(this.type, fleetDeploymentConfigureV2DryRun.type)
        && Objects.equals(
            this.additionalProperties, fleetDeploymentConfigureV2DryRun.additionalProperties);
  }
