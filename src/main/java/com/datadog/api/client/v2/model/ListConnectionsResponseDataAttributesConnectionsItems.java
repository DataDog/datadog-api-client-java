...
/**
   * <p>Details of a single data source connection, including its fields, join configuration, and audit metadata.</p>
 */
@JsonPropertyOrder({
...
public class ListConnectionsResponseDataAttributesConnectionsItems {
  ...
  /**
   * <p>Timestamp indicating when the connection was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Identifier of the user who created the connection.</p>
   * @return createdBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of custom attribute fields imported from the data source.</p>
   * @return fields
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Additional key-value metadata associated with the connection.</p>
   * @return metadata
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The type of data source connection (for example, ref_table).</p>
   * @return type
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp indicating when the connection was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Identifier of the user who last updated the connection.</p>
   * @return updatedBy
  **/
      @jakarta.annotation.Nullable
