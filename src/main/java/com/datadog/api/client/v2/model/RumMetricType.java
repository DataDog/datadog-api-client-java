...
public class RumMetricType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("rum_metrics"));
  ...
  public static class RumMetricTypeSerializer extends StdSerializer<RumMetricType> {
      ...
      @Override
      public void serialize(RumMetricType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
