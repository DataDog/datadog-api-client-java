...
public class ProductAnalyticsRetentionGroupBy {
  ...
  public ProductAnalyticsRetentionGroupBy(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TARGET)
          ProductAnalyticsRetentionGroupByTarget target) {
    this.facet = facet;
    this.target = target;
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsRetentionGroupBy productAnalyticsRetentionGroupBy =
        (ProductAnalyticsRetentionGroupBy) o;
    return Objects.equals(this.facet, productAnalyticsRetentionGroupBy.facet)
        && Objects.equals(this.limit, productAnalyticsRetentionGroupBy.limit)
        && Objects.equals(
            this.shouldExcludeMissing, productAnalyticsRetentionGroupBy.shouldExcludeMissing)
        && Objects.equals(this.sort, productAnalyticsRetentionGroupBy.sort)
        && Objects.equals(this.source, productAnalyticsRetentionGroupBy.source)
        && Objects.equals(this.target, productAnalyticsRetentionGroupBy.target)
        && Objects.equals(
            this.additionalProperties, productAnalyticsRetentionGroupBy.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        facet, limit, shouldExcludeMissing, sort, source, target, additionalProperties);
  }
