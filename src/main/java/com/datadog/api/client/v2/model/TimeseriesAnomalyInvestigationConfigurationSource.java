...
public class TimeseriesAnomalyInvestigationConfigurationSource extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("request_formula", "watchdog_explains_default"));
  ...
  public static class TimeseriesAnomalyInvestigationConfigurationSourceSerializer
      extends StdSerializer<TimeseriesAnomalyInvestigationConfigurationSource> {
    public TimeseriesAnomalyInvestigationConfigurationSourceSerializer(
        Class<TimeseriesAnomalyInvestigationConfigurationSource> t) {
      super(t);
    }
