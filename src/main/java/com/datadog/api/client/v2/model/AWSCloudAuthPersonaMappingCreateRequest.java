...
/**
   * <p>Request used to create an AWS cloud authentication persona mapping</p>
 */
@JsonPropertyOrder({
  AWSCloudAuthPersonaMappingCreateRequest.JSON_PROPERTY_DATA
})
...
public class AWSCloudAuthPersonaMappingCreateRequest {
  ...
  @JsonCreator
  public AWSCloudAuthPersonaMappingCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AWSCloudAuthPersonaMappingCreateData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSCloudAuthPersonaMappingCreateRequest awsCloudAuthPersonaMappingCreateRequest = (AWSCloudAuthPersonaMappingCreateRequest) o;
    return Objects.equals(this.data, awsCloudAuthPersonaMappingCreateRequest.data) && Objects.equals(this.additionalProperties, awsCloudAuthPersonaMappingCreateRequest.additionalProperties);
  }
