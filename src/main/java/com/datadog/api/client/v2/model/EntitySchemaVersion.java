...
/**
   * <p>Entity schema version for conversion.</p>
 */
...
public class EntitySchemaVersion extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("v2", "v2.1", "v2.2", "v3"));
  ...
  public static class EntitySchemaVersionSerializer extends StdSerializer<EntitySchemaVersion> {
      ...
      @Override
      public void serialize(EntitySchemaVersion value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
