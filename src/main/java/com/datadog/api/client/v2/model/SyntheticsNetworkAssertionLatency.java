...
/**
   * <p>Network latency assertion for a Network Path test.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsNetworkAssertionLatency {
  ...
  private SyntheticsNetworkAssertionLatencyType type = SyntheticsNetworkAssertionLatencyType.LATENCY;
  ...
  public SyntheticsNetworkAssertionLatency(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SyntheticsNetworkAssertionLatencyType type) {
  ...
  **/
  ...
  /**
   * <p>Target value in milliseconds.</p>
   * @return target
  **/
