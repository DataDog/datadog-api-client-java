...
public class RelationshipToUsers {
  ...
  @JsonCreator
  public RelationshipToUsers(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<RelationshipToUserData> data) {
        this.data = data;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public RelationshipToUsers putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, relationshipToUsers.data) && Objects.equals(this.additionalProperties, relationshipToUsers.additionalProperties);
  }
