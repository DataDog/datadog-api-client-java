...
/**
   * <p>The result of a single operation.
   * Add operations are processed first, then remove operations, so results may not appear
   * in the same order as the request. Empty for <code>remove</code> operations.</p>
 */
@JsonPropertyOrder({
  TeamsOwnershipMappingBatchResult.JSON_PROPERTY_DATA
})
...
public class TeamsOwnershipMappingBatchResult {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingBatchResult teamsOwnershipMappingBatchResult = (TeamsOwnershipMappingBatchResult) o;
    return Objects.equals(this.data, teamsOwnershipMappingBatchResult.data) && Objects.equals(this.additionalProperties, teamsOwnershipMappingBatchResult.additionalProperties);
  }
