...
/**
   * <p>Attributes for the AWS scan options.</p>
 */
@JsonPropertyOrder({
...
public class AwsScanOptionsAttributes {
  ...
  **/
  ...
  /**
   * <p>Indicates if scanning of Lambda functions is enabled.</p>
   * @return lambda
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Indicates if scanning for sensitive data is enabled.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.complianceHost, awsScanOptionsAttributes.complianceHost) && Objects.equals(this.lambda, awsScanOptionsAttributes.lambda) && Objects.equals(this.sensitiveData, awsScanOptionsAttributes.sensitiveData) && Objects.equals(this.vulnContainersOs, awsScanOptionsAttributes.vulnContainersOs) && Objects.equals(this.vulnHostOs, awsScanOptionsAttributes.vulnHostOs) && Objects.equals(this.additionalProperties, awsScanOptionsAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(complianceHost,lambda,sensitiveData,vulnContainersOs,vulnHostOs, additionalProperties);
  }
