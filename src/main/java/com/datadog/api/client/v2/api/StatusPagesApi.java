 ...
 */
  ...
  /**
   * <p>Publishes a status page. For pages of type <code>public</code>, makes the status page available on the public internet and requires the <code>status_pages_public_page_publish</code> permission. For pages of type <code>internal</code>, makes the status page available under the <code>status-pages/$domain_prefix/view</code> route within the Datadog organization and requires the <code>status_pages_internal_page_publish</code> permission. The <code>status_pages_settings_write</code> permission is temporarily honored as we migrate publishing functionality from the update status page endpoint to the publish status page endpoint.</p>
   *
   * @param pageId The ID of the status page. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
 ...
 */
  ...
  /**
   * <p>Unpublishes a status page. For pages of type <code>public</code>, removes the status page from the public internet and requires the <code>status_pages_public_page_publish</code> permission. For pages of type <code>internal</code>, removes the <code>status-pages/$domain_prefix/view</code> route from the Datadog organization and requires the <code>status_pages_internal_page_publish</code> permission. The <code>status_pages_settings_write</code> permission is temporarily honored as we migrate unpublishing functionality from the update status page endpoint to the unpublish status page endpoint.</p>
   *
   * @param pageId The ID of the status page. (required)
   * @return ApiResponse&lt;Void&gt;
   * @throws ApiException if fails to make API call
 ...
 */
  ...
  /**
   * <p>Updates an existing status page's attributes. <strong>Note</strong>: Publishing and unpublishing via the <code>enabled</code> property will be deprecated on this endpoint. Use the dedicated <a href="#publish-status-page">publish</a> and <a href="#unpublish-status-page">unpublish</a> status page endpoints instead.</p>
   *
   * @param pageId The ID of the status page. (required)
   * @param body  (required)
   * @param parameters Optional parameters for the request.
