...
public class AnalysisEditType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ADD", "UPDATE", "REMOVE"));
  ...
  public static class AnalysisEditTypeSerializer extends StdSerializer<AnalysisEditType> {
      ...
      @Override
      public void serialize(AnalysisEditType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
