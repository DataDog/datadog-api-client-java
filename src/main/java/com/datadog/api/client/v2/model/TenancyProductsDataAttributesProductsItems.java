...
/**
   * <p>An individual Datadog product with its enablement status for a tenancy.</p>
 */
@JsonPropertyOrder({
...
public class TenancyProductsDataAttributesProductsItems {
  ...
  /**
   * <p>Indicates whether the product is enabled for the tenancy.</p>
   * @return enabled
  **/
  ...
  /**
   * <p>The unique key identifying the Datadog product (for example, CLOUD_SECURITY_POSTURE_MANAGEMENT).</p>
   * @return productKey
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public TenancyProductsDataAttributesProductsItems putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TenancyProductsDataAttributesProductsItems tenancyProductsDataAttributesProductsItems = (TenancyProductsDataAttributesProductsItems) o;
    return Objects.equals(this.enabled, tenancyProductsDataAttributesProductsItems.enabled) && Objects.equals(this.productKey, tenancyProductsDataAttributesProductsItems.productKey) && Objects.equals(this.additionalProperties, tenancyProductsDataAttributesProductsItems.additionalProperties);
  }
