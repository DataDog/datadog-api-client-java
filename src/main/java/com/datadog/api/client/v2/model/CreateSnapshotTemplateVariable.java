...
/**
   * <p>A template variable definition for snapshot rendering.</p>
 */
@JsonPropertyOrder({
...
public class CreateSnapshotTemplateVariable {
  ...
  **/
  ...
  /**
   * <p>The tag prefix associated with the template variable. For example, a prefix of <code>host</code> with a value of <code>web-server-1</code> scopes the snapshot to <code>host:web-server-1</code>.</p>
   * @return prefix
  **/
  ...
  /**
   * <p>The list of scoped values for this template variable.</p>
   * @return values
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateSnapshotTemplateVariable createSnapshotTemplateVariable = (CreateSnapshotTemplateVariable) o;
    return Objects.equals(this.name, createSnapshotTemplateVariable.name) && Objects.equals(this.prefix, createSnapshotTemplateVariable.prefix) && Objects.equals(this.values, createSnapshotTemplateVariable.values) && Objects.equals(this.additionalProperties, createSnapshotTemplateVariable.additionalProperties);
  }
