...
/**
   * <p>Paging attributes. Only present if pagination query parameters were provided.</p>
 */
@JsonPropertyOrder({
...
public class MetricMetaPage {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CURSOR)public void setCursor_JsonNullable(JsonNullable<String> cursor) {
    this.cursor = cursor;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_NEXT_CURSOR)public void setNextCursor_JsonNullable(JsonNullable<String> nextCursor) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cursor, metricMetaPage.cursor) && Objects.equals(this.limit, metricMetaPage.limit) && Objects.equals(this.nextCursor, metricMetaPage.nextCursor) && Objects.equals(this.type, metricMetaPage.type) && Objects.equals(this.additionalProperties, metricMetaPage.additionalProperties);
  }
