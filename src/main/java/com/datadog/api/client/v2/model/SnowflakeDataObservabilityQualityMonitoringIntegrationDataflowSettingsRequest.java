...
public class SnowflakeDataObservabilityQualityMonitoringIntegrationDataflowSettingsRequest {
   ...
   * day of the month and the day of the week cannot both be constrained. Common values are hourly (
   * <code>0 * * * *</code>) and daily (<code>0 0 * * *</code>). Defaults to hourly (<code>0 * * * *
   * </code>).
   *
