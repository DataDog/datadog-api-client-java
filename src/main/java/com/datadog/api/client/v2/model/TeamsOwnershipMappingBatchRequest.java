...
/**
   * <p>The request body for bulk-creating and bulk-removing teams ownership mappings.</p>
 */
@JsonPropertyOrder({
  TeamsOwnershipMappingBatchRequest.JSON_PROPERTY_ATOMIC_OPERATIONS
})
...
public class TeamsOwnershipMappingBatchRequest {
  ...
  private List<TeamsOwnershipMappingBatchOperation> atomicOperations = new ArrayList<>();

  public TeamsOwnershipMappingBatchRequest() {}

  @JsonCreator
  public TeamsOwnershipMappingBatchRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATOMIC_OPERATIONS)List<TeamsOwnershipMappingBatchOperation> atomicOperations) {
  ...
  /**
   * <p>The list of add and remove operations to apply atomically.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TeamsOwnershipMappingBatchRequest teamsOwnershipMappingBatchRequest = (TeamsOwnershipMappingBatchRequest) o;
    return Objects.equals(this.atomicOperations, teamsOwnershipMappingBatchRequest.atomicOperations) && Objects.equals(this.additionalProperties, teamsOwnershipMappingBatchRequest.additionalProperties);
  }
