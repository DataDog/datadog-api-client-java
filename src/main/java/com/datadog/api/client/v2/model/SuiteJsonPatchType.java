...
public class SuiteJsonPatchType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("suites_json_patch"));

  public static final SuiteJsonPatchType SUITES_JSON_PATCH = new SuiteJsonPatchType("suites_json_patch");
  ...
  public static class SuiteJsonPatchTypeSerializer extends StdSerializer<SuiteJsonPatchType> {
      ...
      @Override
      public void serialize(SuiteJsonPatchType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
