...
public class IssueState extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("OPEN", "ACKNOWLEDGED", "RESOLVED", "IGNORED", "EXCLUDED"));
  ...
  public static class IssueStateSerializer extends StdSerializer<IssueState> {
      ...
      @Override
      public void serialize(IssueState value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
