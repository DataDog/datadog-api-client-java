...
public class CustomDestinationListResponse {
  ...
  private List<CustomDestination> data = new ArrayList<>();
  ...
  @JsonCreator
  public CustomDestinationListResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<CustomDestination> data) {
    this.data = data;
  }

  public CustomDestinationListResponse data(List<CustomDestination> data) {
    this.data = data;
    for (CustomDestination item : data) {
      this.unparsed |= item.unparsed;
    }
    return this;
  }

  public CustomDestinationListResponse addDataItem(CustomDestination dataItem) {
  ...
  public List<CustomDestination> getData() {
    return data;
  }

  public void setData(List<CustomDestination> data) {
    this.data = data;
  }
