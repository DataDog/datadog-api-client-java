...
/**
   * <p>Per-finding outcome of an assign or unassign operation.</p>
 */
@JsonPropertyOrder({
...
public class AssignmentResult {
  ...
  /**
   * <p>Human-readable explanation of the outcome.</p>
   * @return detail
  **/
  ...
  **/
  ...
  /**
   * <p>HTTP-like status code describing the outcome for this finding.</p>
   * maximum: 599
   * @return status
  **/
  ...
  /**
   * <p>Short label describing the outcome for this finding.</p>
   * @return title
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.detail, assignmentResult.detail) && Objects.equals(this.findingId, assignmentResult.findingId) && Objects.equals(this.status, assignmentResult.status) && Objects.equals(this.title, assignmentResult.title) && Objects.equals(this.additionalProperties, assignmentResult.additionalProperties);
  }
