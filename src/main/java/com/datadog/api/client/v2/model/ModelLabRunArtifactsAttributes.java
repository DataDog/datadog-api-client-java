...
/**
   * <p>Artifact listing for a Model Lab run.</p>
 */
@JsonPropertyOrder({
...
public class ModelLabRunArtifactsAttributes {
  ...
  @JsonCreator
  public ModelLabRunArtifactsAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_FILES)List<ModelLabArtifactObjectInfo> files,
  ...
  /**
   * <p>The list of artifact files and directories.</p>
   * @return files
  **/
  ...
  /**
   * <p>The path of the run's artifacts relative to the project's artifact root.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ModelLabRunArtifactsAttributes modelLabRunArtifactsAttributes = (ModelLabRunArtifactsAttributes) o;
    return Objects.equals(this.files, modelLabRunArtifactsAttributes.files) && Objects.equals(this.pathInProject, modelLabRunArtifactsAttributes.pathInProject) && Objects.equals(this.additionalProperties, modelLabRunArtifactsAttributes.additionalProperties);
  }
