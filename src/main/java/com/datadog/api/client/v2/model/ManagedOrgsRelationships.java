...
/**
   * <p>Relationships of the managed organizations resource.</p>
 */
@JsonPropertyOrder({
...
public class ManagedOrgsRelationships {
  ...
  @JsonCreator
  public ManagedOrgsRelationships(
            @JsonProperty(required=true, value=JSON_PROPERTY_CURRENT_ORG)ManagedOrgsRelationshipToOrg currentOrg,
            @JsonProperty(required=true, value=JSON_PROPERTY_MANAGED_ORGS)ManagedOrgsRelationshipToOrgs managedOrgs) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentOrg, managedOrgsRelationships.currentOrg) && Objects.equals(this.managedOrgs, managedOrgsRelationships.managedOrgs) && Objects.equals(this.additionalProperties, managedOrgsRelationships.additionalProperties);
  }
