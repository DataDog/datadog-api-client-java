...
/**
   * <p>Create a new WAF custom rule.</p>
 */
@JsonPropertyOrder({
...
public class ApplicationSecurityWafCustomRuleCreateAttributes {
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes action(ApplicationSecurityWafCustomRuleAction action) {
    this.action = action;
  ...
  **/
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes conditions(List<ApplicationSecurityWafCustomRuleCondition> conditions) {
    this.conditions = conditions;
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes addConditionsItem(ApplicationSecurityWafCustomRuleCondition conditionsItem) {
  ...
  **/
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes scope(List<ApplicationSecurityWafCustomRuleScope> scope) {
    this.scope = scope;
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes addScopeItem(ApplicationSecurityWafCustomRuleScope scopeItem) {
    if (this.scope == null) {
  ...
  **/
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes tags(ApplicationSecurityWafCustomRuleTags tags) {
    this.tags = tags;
    this.unparsed |= tags.unparsed;
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public ApplicationSecurityWafCustomRuleCreateAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleCreateAttributes applicationSecurityWafCustomRuleCreateAttributes = (ApplicationSecurityWafCustomRuleCreateAttributes) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action,blocking,conditions,enabled,name,pathGlob,scope,tags, additionalProperties);
  }
