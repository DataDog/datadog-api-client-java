...
@JsonPropertyOrder({
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_ACTION,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_BLOCKING,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_CONDITIONS,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_ENABLED,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_NAME,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_PATH_GLOB,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_SCOPE,
  ApplicationSecurityWafCustomRuleCreateAttributes.JSON_PROPERTY_TAGS
})
...
public class ApplicationSecurityWafCustomRuleCreateAttributes {
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes action(
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes conditions(
      List<ApplicationSecurityWafCustomRuleCondition> conditions) {
    this.conditions = conditions;
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes addConditionsItem(
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes pathGlob(String pathGlob) {
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes scope(
  ...
  public ApplicationSecurityWafCustomRuleCreateAttributes addScopeItem(
   ...
   * @return ApplicationSecurityWafCustomRuleCreateAttributes
   */
  @JsonAnySetter
  public ApplicationSecurityWafCustomRuleCreateAttributes putAdditionalProperty(
  ...
  /** Return true if this ApplicationSecurityWafCustomRuleCreateAttributes object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleCreateAttributes
        applicationSecurityWafCustomRuleCreateAttributes =
            (ApplicationSecurityWafCustomRuleCreateAttributes) o;
    return Objects.equals(this.action, applicationSecurityWafCustomRuleCreateAttributes.action)
        && Objects.equals(this.blocking, applicationSecurityWafCustomRuleCreateAttributes.blocking)
        && Objects.equals(
            this.conditions, applicationSecurityWafCustomRuleCreateAttributes.conditions)
        && Objects.equals(this.enabled, applicationSecurityWafCustomRuleCreateAttributes.enabled)
        && Objects.equals(this.name, applicationSecurityWafCustomRuleCreateAttributes.name)
        && Objects.equals(this.pathGlob, applicationSecurityWafCustomRuleCreateAttributes.pathGlob)
        && Objects.equals(this.scope, applicationSecurityWafCustomRuleCreateAttributes.scope)
        && Objects.equals(this.tags, applicationSecurityWafCustomRuleCreateAttributes.tags)
        && Objects.equals(
            this.additionalProperties,
            applicationSecurityWafCustomRuleCreateAttributes.additionalProperties);
  }
