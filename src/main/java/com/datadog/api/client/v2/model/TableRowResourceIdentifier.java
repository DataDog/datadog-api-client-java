...
/**
   * <p>Row resource containing a single row identifier.</p>
 */
@JsonPropertyOrder({
...
public class TableRowResourceIdentifier {
  ...
  /**
   * <p>The primary key value that uniquely identifies the row to delete.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, tableRowResourceIdentifier.id) && Objects.equals(this.type, tableRowResourceIdentifier.type) && Objects.equals(this.additionalProperties, tableRowResourceIdentifier.additionalProperties);
  }
