...
/**
   * <p>Segments journey results by the values of a facet.</p>
 */
@JsonPropertyOrder({
...
public class ProductAnalyticsGraphQueryGroupBy {
  ...
  /**
   * <p>Attribute path to group by.</p>
   * @return facet
  **/
  ...
  **/
  ...
  /**
   * <p>Whether to exclude entities that have no value for this facet.</p>
  ...
  **/
  ...
  /**
   * <p>Restricts the results to these facet values.</p>
   * @return valueFilters
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsGraphQueryGroupBy productAnalyticsGraphQueryGroupBy = (ProductAnalyticsGraphQueryGroupBy) o;
    return Objects.equals(this.facet, productAnalyticsGraphQueryGroupBy.facet) && Objects.equals(this.limit, productAnalyticsGraphQueryGroupBy.limit) && Objects.equals(this.shouldExcludeMissing, productAnalyticsGraphQueryGroupBy.shouldExcludeMissing) && Objects.equals(this.sort, productAnalyticsGraphQueryGroupBy.sort) && Objects.equals(this.source, productAnalyticsGraphQueryGroupBy.source) && Objects.equals(this.target, productAnalyticsGraphQueryGroupBy.target) && Objects.equals(this.valueFilters, productAnalyticsGraphQueryGroupBy.valueFilters) && Objects.equals(this.additionalProperties, productAnalyticsGraphQueryGroupBy.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(facet,limit,shouldExcludeMissing,sort,source,target,valueFilters, additionalProperties);
  }
