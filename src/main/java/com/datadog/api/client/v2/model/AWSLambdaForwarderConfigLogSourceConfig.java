 ...
 */
@JsonPropertyOrder({
  AWSLambdaForwarderConfigLogSourceConfig.JSON_PROPERTY_TAG_FILTERS
})
...
public class AWSLambdaForwarderConfigLogSourceConfig {
  ...
  public AWSLambdaForwarderConfigLogSourceConfig tagFilters(List<AWSLogSourceTagFilter> tagFilters) {
  ...
  public AWSLambdaForwarderConfigLogSourceConfig addTagFiltersItem(AWSLogSourceTagFilter tagFiltersItem) {
  ...
  /**
   * <p>List of AWS log source tag filters. Defaults to <code>[]</code>.</p>
   * @return tagFilters
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSLambdaForwarderConfigLogSourceConfig awsLambdaForwarderConfigLogSourceConfig = (AWSLambdaForwarderConfigLogSourceConfig) o;
    return Objects.equals(this.tagFilters, awsLambdaForwarderConfigLogSourceConfig.tagFilters) && Objects.equals(this.additionalProperties, awsLambdaForwarderConfigLogSourceConfig.additionalProperties);
  }
