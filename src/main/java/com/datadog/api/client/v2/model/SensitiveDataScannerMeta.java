...
public class SensitiveDataScannerMeta {
  ...
  **/
  ...
  /**
   * <p>(Deprecated) Whether or not scanned events are highlighted in Logs or RUM for the org.</p>
  ...
  **/
  ...
  /**
   * <p>(Deprecated) Whether or not scanned events have multi-pass enabled.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(countLimit,groupCountLimit,hasHighlightEnabled,hasMultiPassEnabled,isPciCompliant,version, additionalProperties);
  }
