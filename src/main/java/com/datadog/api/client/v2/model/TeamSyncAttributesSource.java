...
public class TeamSyncAttributesSource extends ModelEnum<String> {
  ...
  public static class TeamSyncAttributesSourceSerializer extends StdSerializer<TeamSyncAttributesSource> {
      ...
      @Override
      public void serialize(TeamSyncAttributesSource value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
