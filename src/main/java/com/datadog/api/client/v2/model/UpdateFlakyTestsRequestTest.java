...
/**
   * <p>Details of what tests to update and their new attributes.</p>
 */
@JsonPropertyOrder({
...
public class UpdateFlakyTestsRequestTest {
  ...
  public UpdateFlakyTestsRequestTest(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_NEW_STATE)UpdateFlakyTestsRequestTestNewState newState) {
        this.id = id;
  ...
  /**
   * <p>The ID of the flaky test. This is the same ID returned by the Search flaky tests endpoint and is the
   * value of the <code>@test.fingerprint_fqn</code> facet on test events. You can find it by searching on
   * <code>@test.fingerprint_fqn</code> in the Test Optimization Explorer, or by filtering the Search flaky tests
   * endpoint with the <code>fingerprint_fqn</code> key.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, updateFlakyTestsRequestTest.id) && Objects.equals(this.newState, updateFlakyTestsRequestTest.newState) && Objects.equals(this.additionalProperties, updateFlakyTestsRequestTest.additionalProperties);
  }
