...
public class UpdateFlakyTestsRequestTest {
  ...
  /**
   * <p>The ID of the flaky test. This is the same ID returned by the Search flaky tests endpoint and corresponds to the test_fingerprint_fqn field in test run events.</p>
   * @return id
  **/
