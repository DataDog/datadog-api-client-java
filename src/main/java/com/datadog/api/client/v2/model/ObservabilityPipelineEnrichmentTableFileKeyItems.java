...
public class ObservabilityPipelineEnrichmentTableFileKeyItems {
  ...
  public ObservabilityPipelineEnrichmentTableFileKeyItems(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_FIELD)ObservabilityPipelineEnrichmentTableFileKeyItemField field) {
        this.column = column;
  ...
  **/
  ...
  public ObservabilityPipelineEnrichmentTableFileKeyItems field(ObservabilityPipelineEnrichmentTableFileKeyItemField field) {
    this.field = field;
    this.unparsed |= field.unparsed;
    return this;
  }
  ...
  /**
   * <p>Specifies the source of the key value used for enrichment table lookups.
   * Can be a plain field path string or an object specifying <code>event</code>, <code>vrl</code>, or <code>secret</code>.</p>
   * @return field
  **/
