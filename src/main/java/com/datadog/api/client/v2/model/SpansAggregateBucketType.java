...
public class SpansAggregateBucketType extends ModelEnum<String> {
  ...
  public static class SpansAggregateBucketTypeSerializer extends StdSerializer<SpansAggregateBucketType> {
      ...
      @Override
      public void serialize(SpansAggregateBucketType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
