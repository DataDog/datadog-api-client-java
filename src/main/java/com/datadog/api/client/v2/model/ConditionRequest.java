...
/**
   * <p>Condition request payload for targeting rules. A condition is either an inline
   * predicate with <code>operator</code>, <code>attribute</code>, and <code>value</code>, or a reference to a
   * saved filter with <code>saved_filter_id</code>. The two shapes are mutually exclusive.</p>
 */
@JsonPropertyOrder({
...
public class ConditionRequest {
  ...
  /**
   * <p>The user or request attribute to evaluate. Required for inline conditions; omit when <code>saved_filter_id</code> is set.</p>
   * @return attribute
  **/
  ...
  **/
  ...
  /**
   * <p>The ID of a saved filter to reference as this condition. Mutually exclusive
   * with <code>operator</code>, <code>attribute</code>, and <code>value</code>. When set, the saved filter's
   * targeting rules are evaluated in place of an inline predicate.</p>
  ...
  **/
  ...
  /**
   * <p>Values used by the selected operator. Required for inline conditions; omit when <code>saved_filter_id</code> is set.</p>
   * @return value
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attribute, conditionRequest.attribute) && Objects.equals(this.operator, conditionRequest.operator) && Objects.equals(this.savedFilterId, conditionRequest.savedFilterId) && Objects.equals(this.value, conditionRequest.value) && Objects.equals(this.additionalProperties, conditionRequest.additionalProperties);
  }
