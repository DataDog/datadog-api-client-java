...
/**
   * <p>The response of a severity modifier rule reorder request.</p>
 */
@JsonPropertyOrder({
  SeverityModifierRuleReorderResponse.JSON_PROPERTY_DATA
})
...
public class SeverityModifierRuleReorderResponse {
  ...
  @JsonCreator
  public SeverityModifierRuleReorderResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<SeverityModifierRuleReorderItem> data) {
        this.data = data;
  ...
  /**
   * <p>The ordered list of severity modifier rules; every rule must be included.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    SeverityModifierRuleReorderResponse severityModifierRuleReorderResponse = (SeverityModifierRuleReorderResponse) o;
    return Objects.equals(this.data, severityModifierRuleReorderResponse.data) && Objects.equals(this.additionalProperties, severityModifierRuleReorderResponse.additionalProperties);
  }
