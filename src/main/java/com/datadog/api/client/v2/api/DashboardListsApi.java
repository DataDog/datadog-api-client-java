 ...
 */
  ...
  public CompletableFuture<ApiResponse<DashboardListAddItemsResponse>> createDashboardListItemsWithHttpInfoAsync(Long dashboardListId, DashboardListAddItemsRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("DashboardListsApi.createDashboardListItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public CompletableFuture<ApiResponse<DashboardListDeleteItemsResponse>> deleteDashboardListItemsWithHttpInfoAsync(Long dashboardListId, DashboardListDeleteItemsRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DashboardListsApi.deleteDashboardListItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DashboardListDeleteItemsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public ApiResponse<DashboardListItems> getDashboardListItemsWithHttpInfo(Long dashboardListId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.DashboardListsApi.getDashboardListItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<DashboardListItems>> getDashboardListItemsWithHttpInfoAsync(Long dashboardListId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DashboardListsApi.getDashboardListItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DashboardListItems>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public CompletableFuture<ApiResponse<DashboardListUpdateItemsResponse>> updateDashboardListItemsWithHttpInfoAsync(Long dashboardListId, DashboardListUpdateItemsRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("DashboardListsApi.updateDashboardListItems", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<DashboardListUpdateItemsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
