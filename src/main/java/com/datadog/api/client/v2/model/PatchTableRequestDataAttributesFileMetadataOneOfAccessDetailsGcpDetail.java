...
@JsonPropertyOrder({
  ...
  PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
      .JSON_PROPERTY_GCP_BUCKET_NAME,
  PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
      .JSON_PROPERTY_GCP_PROJECT_ID,
  PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
...
public class PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail {
  ...
  public PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail filePath(
      String filePath) {
  ...
  public PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail gcpBucketName(
  ...
  public PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail gcpProjectId(
      String gcpProjectId) {
  ...
  public PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
      gcpServiceAccountEmail(String gcpServiceAccountEmail) {
  ...
  /**
   * Return true if this PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
  ...
  public boolean equals(Object o) {
    ...
    PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail
        patchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail =
            (PatchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail) o;
    return Objects.equals(
            this.filePath,
            patchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail.filePath)
        && Objects.equals(
            this.gcpBucketName,
            patchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail.gcpBucketName)
        && Objects.equals(
            this.gcpProjectId,
            patchTableRequestDataAttributesFileMetadataOneOfAccessDetailsGcpDetail.gcpProjectId)
        && Objects.equals(
  ...
  public int hashCode() {
    return Objects.hash(
        filePath, gcpBucketName, gcpProjectId, gcpServiceAccountEmail, additionalProperties);
  }
