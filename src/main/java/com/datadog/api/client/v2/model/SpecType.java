...
public class SpecType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("spec"));
  ...
  public static class SpecTypeSerializer extends StdSerializer<SpecType> {
    public SpecTypeSerializer(Class<SpecType> t) {
      super(t);
    }
