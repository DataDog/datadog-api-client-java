...
/**
   * <p>The pricing and allotment metadata of a SKU.</p>
 */
@JsonPropertyOrder({
...
public class ProductCatalogSKUDataAttributesResponse {
  ...
  public static final String JSON_PROPERTY_NUMBER_OF_UNITS_INCLUDED_IN_PRICE = "number_of_units_included_in_price";
  ...
  @JsonCreator
  public ProductCatalogSKUDataAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_ALLOTMENTS)List<ProductCatalogSKUAllotment> allotments,
            @JsonProperty(required=true, value=JSON_PROPERTY_BILLING_DIMENSION)String billingDimension,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_DEFAULT_ON_DEMAND_OPTION)ProductCatalogSKUOnDemandOption defaultOnDemandOption,
            @JsonProperty(required=true, value=JSON_PROPERTY_NUMBER_OF_UNITS_INCLUDED_IN_PRICE)Long numberOfUnitsIncludedInPrice,
            @JsonProperty(required=true, value=JSON_PROPERTY_ON_DEMAND_LIST_PRICE)String onDemandListPrice,
            @JsonProperty(required=true, value=JSON_PROPERTY_ON_DEMAND_TIERED)ProductCatalogSKUTieredPricing onDemandTiered,
            @JsonProperty(required=true, value=JSON_PROPERTY_PRICING_TYPE)ProductCatalogSKUPricingType pricingType,
  ...
  public ProductCatalogSKUDataAttributesResponse allotments(List<ProductCatalogSKUAllotment> allotments) {
    this.allotments = allotments;
    for (ProductCatalogSKUAllotment item : allotments) {
      this.unparsed |= item.unparsed;
    }
  ...
  public ProductCatalogSKUDataAttributesResponse addAllotmentsItem(ProductCatalogSKUAllotment allotmentsItem) {
  ...
  /**
   * <p>The allotments the SKU provides to other SKUs. Every entry carries the code of this
   * SKU as its <code>parent_sku_code</code>. Empty when the SKU provides no allotments.</p>
   * @return allotments
  **/
  ...
  /**
   * <p>The identifier of the billing dimension the SKU is billed on, as used by the usage
   * metering endpoints. Several SKUs can share one billing dimension, so this value does
   * not identify a SKU.</p>
  ...
  **/
  ...
  /**
   * <p>The billable usage unit the SKU is priced per. <code>null</code> for SKUs that are not priced
   * per unit of usage, such as those whose <code>pricing_type</code> is <code>percent</code>.</p>
   * @return billingUnits
  **/
  ...
  /**
   * <p>The ISO-4217 code of the currency the prices are expressed in.</p>
   * @return currency
  **/
  ...
  public ProductCatalogSKUDataAttributesResponse defaultOnDemandOption(ProductCatalogSKUOnDemandOption defaultOnDemandOption) {
    this.defaultOnDemandOption = defaultOnDemandOption;
    this.unparsed |= !defaultOnDemandOption.isValid();
    return this;
  }
  ...
  /**
   * <p>The billing frequency applied to on-demand usage of the SKU by default.</p>
  ...
  **/
  ...
  public ProductCatalogSKUDataAttributesResponse numberOfUnitsIncludedInPrice(Long numberOfUnitsIncludedInPrice) {
    this.numberOfUnitsIncludedInPrice = numberOfUnitsIncludedInPrice;
    return this;
  }

  /**
   * <p>The number of billable usage units that one unit of price covers. Divide measured
   * usage by this value before multiplying by the price. For example, a SKU priced at <code>18.00</code> with
   * <code>number_of_units_included_in_price</code> of <code>1</code> costs <code>18.00</code> per host, while a SKU priced
   * at <code>12.00</code> with <code>number_of_units_included_in_price</code> of <code>10000</code> costs <code>12.00</code> per
   * 10,000 requests. It is a scaling factor on the price, not a free allotment; included
   * quantities are in <code>allotments</code>. The same factor applies to the price of a tier in
   * <code>on_demand_tiered</code> whose <code>pricing_unit_type</code> is <code>unit</code>. It does not apply to a tier
   * whose <code>pricing_unit_type</code> is <code>block</code>: that tier's <code>price</code> is charged for the whole
   * block bounded by <code>min_usage_quantity</code> and <code>max_usage_quantity</code>, however much of the
   * block is used. <code>0</code> for SKUs that are not priced per unit of usage, such as those
   * whose <code>pricing_type</code> is <code>percent</code>.</p>
  ...
  **/
  ...
  /**
   * <p>The public list price of on-demand usage of the SKU, as a decimal string. The number
   * of decimal places is not normalized, so values such as <code>0</code>, <code>0.9</code>, and <code>30000.00</code>
   * all occur. <code>null</code> when the SKU is priced with tiers, in which case the prices are in
   * <code>on_demand_tiered</code>.</p>
  ...
  **/
  ...
  public ProductCatalogSKUDataAttributesResponse onDemandTiered(ProductCatalogSKUTieredPricing onDemandTiered) {
    this.onDemandTiered = onDemandTiered;
        if (onDemandTiered != null) {
    this.unparsed |= onDemandTiered.unparsed;
    }
  ...
  /**
   * <p>The tiered pricing applied to on-demand usage of the SKU. <code>null</code> when the SKU is priced
   * with a single list price instead.</p>
  ...
  **/
  ...
  public ProductCatalogSKUDataAttributesResponse pricingType(ProductCatalogSKUPricingType pricingType) {
    this.pricingType = pricingType;
    this.unparsed |= !pricingType.isValid();
    return this;
  }
  ...
  /**
   * <p>How the SKU is priced. <code>usage</code> prices each billable usage unit, and <code>percent</code> prices a
   * percentage; percent-priced SKUs have no <code>billing_units</code>.</p>
   * @return pricingType
  **/
  ...
  /**
   * <p>The human-readable name of the SKU.</p>
   * @return skuName
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductCatalogSKUDataAttributesResponse productCatalogSkuDataAttributesResponse = (ProductCatalogSKUDataAttributesResponse) o;
    return Objects.equals(this.allotments, productCatalogSkuDataAttributesResponse.allotments) && Objects.equals(this.billingDimension, productCatalogSkuDataAttributesResponse.billingDimension) && Objects.equals(this.billingUnits, productCatalogSkuDataAttributesResponse.billingUnits) && Objects.equals(this.currency, productCatalogSkuDataAttributesResponse.currency) && Objects.equals(this.defaultOnDemandOption, productCatalogSkuDataAttributesResponse.defaultOnDemandOption) && Objects.equals(this.numberOfUnitsIncludedInPrice, productCatalogSkuDataAttributesResponse.numberOfUnitsIncludedInPrice) && Objects.equals(this.onDemandListPrice, productCatalogSkuDataAttributesResponse.onDemandListPrice) && Objects.equals(this.onDemandTiered, productCatalogSkuDataAttributesResponse.onDemandTiered) && Objects.equals(this.pricingType, productCatalogSkuDataAttributesResponse.pricingType) && Objects.equals(this.skuName, productCatalogSkuDataAttributesResponse.skuName) && Objects.equals(this.additionalProperties, productCatalogSkuDataAttributesResponse.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(allotments,billingDimension,billingUnits,currency,defaultOnDemandOption,numberOfUnitsIncludedInPrice,onDemandListPrice,onDemandTiered,pricingType,skuName, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    defaultOnDemandOption: ").append(toIndentedString(defaultOnDemandOption)).append("\n");
    sb.append("    numberOfUnitsIncludedInPrice: ").append(toIndentedString(numberOfUnitsIncludedInPrice)).append("\n");
