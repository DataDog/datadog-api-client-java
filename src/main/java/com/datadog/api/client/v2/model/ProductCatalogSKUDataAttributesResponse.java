...
public class ProductCatalogSKUDataAttributesResponse {
  ...
  **/
  ...
  /**
   * <p>The number of billable usage units included in the price. <code>0</code> for SKUs that are not
   * priced per unit of usage, such as those whose <code>pricing_type</code> is <code>percent</code>.</p>
