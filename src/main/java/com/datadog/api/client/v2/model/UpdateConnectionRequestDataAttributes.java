...
public class UpdateConnectionRequestDataAttributes {
  ...
  /**
   * <p>New fields to add to the connection from the data source.</p>
   * @return fieldsToAdd
  **/
  ...
  /**
   * <p>Identifiers of existing fields to remove from the connection.</p>
  ...
  **/
  ...
  /**
   * <p>Existing fields with updated metadata to apply to the connection.</p>
