...
/**
   * <p>Response object for a batch rows query against a reference table.</p>
 */
@JsonPropertyOrder({
...
public class BatchRowsQueryResponse {
  ...
  /**
   * <p>Data object for a batch rows query response.</p>
   * @return data
  **/
  ...
  /**
   * <p>Full row resources matching the query, included alongside the relationship references in <code>data</code>.</p>
   * @return included
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, batchRowsQueryResponse.data) && Objects.equals(this.included, batchRowsQueryResponse.included) && Objects.equals(this.additionalProperties, batchRowsQueryResponse.additionalProperties);
  }
