...
@JsonDeserialize(using = IncidentResponseIncludedItem.IncidentResponseIncludedItemDeserializer.class)
...
public class IncidentResponseIncludedItem extends AbstractOpenApiSchema {
    ...
    public static class IncidentResponseIncludedItemSerializer extends StdSerializer<IncidentResponseIncludedItem> {
        ...
        @Override
        public void serialize(IncidentResponseIncludedItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class IncidentResponseIncludedItemDeserializer extends StdDeserializer<IncidentResponseIncludedItem> {
        ...
        @Override
        public IncidentResponseIncludedItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AttachmentData.class.equals(Integer.class) || AttachmentData.class.equals(Long.class) || AttachmentData.class.equals(Float.class) || AttachmentData.class.equals(Double.class) || AttachmentData.class.equals(Boolean.class) || AttachmentData.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AttachmentData.class.equals(Integer.class) || AttachmentData.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AttachmentData.class.equals(Float.class) || AttachmentData.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AttachmentData.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AttachmentData.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public IncidentResponseIncludedItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "IncidentResponseIncludedItem cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(IncidentResponseIncludedItem.class, Collections.unmodifiableMap(schemas));
    }
     ...
     * IncidentUserData, AttachmentData
     *
