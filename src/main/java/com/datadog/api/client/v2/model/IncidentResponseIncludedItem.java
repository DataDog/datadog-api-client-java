...
public class IncidentResponseIncludedItem extends AbstractOpenApiSchema {
    ...
    public static class IncidentResponseIncludedItemDeserializer extends StdDeserializer<IncidentResponseIncludedItem> {
        ...
        public IncidentResponseIncludedItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (IncidentAttachmentData.class.equals(Integer.class) || IncidentAttachmentData.class.equals(Long.class) || IncidentAttachmentData.class.equals(Float.class) || IncidentAttachmentData.class.equals(Double.class) || IncidentAttachmentData.class.equals(Boolean.class) || IncidentAttachmentData.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((IncidentAttachmentData.class.equals(Integer.class) || IncidentAttachmentData.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((IncidentAttachmentData.class.equals(Float.class) || IncidentAttachmentData.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (IncidentAttachmentData.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (IncidentAttachmentData.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
    ...
    /**
     * Get the actual instance of `IncidentAttachmentData`. If the actual instance is not `IncidentAttachmentData`,
     * the ClassCastException will be thrown.
     *
