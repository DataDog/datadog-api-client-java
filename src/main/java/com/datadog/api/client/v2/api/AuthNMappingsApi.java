 ...
 */
  ...
  public ApiResponse<AuthNMappingResponse> createAuthNMappingWithHttpInfo(AuthNMappingCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AuthNMappingsApi.createAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AuthNMappingResponse>> createAuthNMappingWithHttpInfoAsync(AuthNMappingCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.AuthNMappingsApi.createAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  public ApiResponse<Void> deleteAuthNMappingWithHttpInfo(String authnMappingId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AuthNMappingsApi.deleteAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteAuthNMappingWithHttpInfoAsync(String authnMappingId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AuthNMappingsApi.deleteAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public ApiResponse<AuthNMappingResponse> getAuthNMappingWithHttpInfo(String authnMappingId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AuthNMappingsApi.getAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AuthNMappingResponse>> getAuthNMappingWithHttpInfoAsync(String authnMappingId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AuthNMappingsApi.getAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AuthNMappingResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  ...
  public ApiResponse<AuthNMappingsResponse> listAuthNMappingsWithHttpInfo(ListAuthNMappingsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AuthNMappingsApi.listAuthNMappings", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AuthNMappingsResponse>> listAuthNMappingsWithHttpInfoAsync(ListAuthNMappingsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AuthNMappingsApi.listAuthNMappings", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  public ApiResponse<AuthNMappingResponse> updateAuthNMappingWithHttpInfo(String authnMappingId, AuthNMappingUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.AuthNMappingsApi.updateAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<AuthNMappingResponse>> updateAuthNMappingWithHttpInfoAsync(String authnMappingId, AuthNMappingUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.AuthNMappingsApi.updateAuthNMapping", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "AuthZ", "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AuthNMappingResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
