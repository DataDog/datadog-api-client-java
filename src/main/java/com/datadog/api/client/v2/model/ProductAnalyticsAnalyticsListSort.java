...
public class ProductAnalyticsAnalyticsListSort {
  ...
  private ProductAnalyticsAnalyticsListSortOrder order;

  public ProductAnalyticsAnalyticsListSort facet(String facet) {
    this.facet = facet;
    return this;
  }
  ...
  **/
   ...
   * @return ProductAnalyticsAnalyticsListSort
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class ProductAnalyticsAnalyticsListSort {\n");
