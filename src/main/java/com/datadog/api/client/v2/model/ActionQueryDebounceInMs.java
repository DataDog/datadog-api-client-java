...
@JsonDeserialize(using = ActionQueryDebounceInMs.ActionQueryDebounceInMsDeserializer.class)
@JsonSerialize(using = ActionQueryDebounceInMs.ActionQueryDebounceInMsSerializer.class)
public class ActionQueryDebounceInMs extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryDebounceInMs.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryDebounceInMsSerializer extends StdSerializer<ActionQueryDebounceInMs> {
        public ActionQueryDebounceInMsSerializer(Class<ActionQueryDebounceInMs> t) {
            super(t);
        }

        public ActionQueryDebounceInMsSerializer() {
            this(null);
        }

        @Override
        public void serialize(ActionQueryDebounceInMs value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryDebounceInMsDeserializer extends StdDeserializer<ActionQueryDebounceInMs> {
        public ActionQueryDebounceInMsDeserializer() {
            this(ActionQueryDebounceInMs.class);
        }

        public ActionQueryDebounceInMsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ActionQueryDebounceInMs deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ActionQueryDebounceInMs ret = new ActionQueryDebounceInMs();
            if (match == 1) {
         ...
         */
        @Override
        public ActionQueryDebounceInMs getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryDebounceInMs cannot be null");
        }
    }
    ...
    public ActionQueryDebounceInMs() {
        super("oneOf", Boolean.FALSE);
    }
    public ActionQueryDebounceInMs(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ActionQueryDebounceInMs(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryDebounceInMs.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ActionQueryDebounceInMs.schemas;
    }
