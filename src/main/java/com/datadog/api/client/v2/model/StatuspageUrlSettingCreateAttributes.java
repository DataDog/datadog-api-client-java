...
public class StatuspageUrlSettingCreateAttributes {
  ...
  /**
   * The Statuspage URL to monitor. Must be a <code>status.io</code> or <code>statuspage.com</code>
   * URL.
   *
   * @return url
   */
  ...
  public boolean equals(Object o) {
    ...
    StatuspageUrlSettingCreateAttributes statuspageUrlSettingCreateAttributes =
        (StatuspageUrlSettingCreateAttributes) o;
    return Objects.equals(this.customTags, statuspageUrlSettingCreateAttributes.customTags)
        && Objects.equals(this.url, statuspageUrlSettingCreateAttributes.url)
        && Objects.equals(
            this.additionalProperties, statuspageUrlSettingCreateAttributes.additionalProperties);
  }
