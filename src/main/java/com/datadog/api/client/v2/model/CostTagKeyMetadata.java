...
/**
   * <p>A Cloud Cost Management tag key metadata entry, aggregating coverage and example values for a single tag key, metric, and period.</p>
 */
@JsonPropertyOrder({
...
public class CostTagKeyMetadata {
  ...
  @JsonCreator
  public CostTagKeyMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)CostTagKeyMetadataAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>A composite identifier of the form <code>tag_key:metric</code> for monthly roll-ups, or <code>tag_key:metric:YYYY-MM-DD</code> when <code>filter[daily]=true</code>.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, costTagKeyMetadata.attributes) && Objects.equals(this.id, costTagKeyMetadata.id) && Objects.equals(this.type, costTagKeyMetadata.type) && Objects.equals(this.additionalProperties, costTagKeyMetadata.additionalProperties);
  }
