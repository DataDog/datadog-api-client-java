 ...
 */
@JsonPropertyOrder({
  ScheduleTarget.JSON_PROPERTY_ID,
  ScheduleTarget.JSON_PROPERTY_TYPE
})
...
public class ScheduleTarget {
  ...
  /**
   * <p>Specifies the unique identifier of the schedule resource.</p>
   * @return id
  **/
  ...
  /**
   * <p>Indicates that the resource is of type <code>schedules</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, scheduleTarget.id) && Objects.equals(this.type, scheduleTarget.type) && Objects.equals(this.additionalProperties, scheduleTarget.additionalProperties);
  }
