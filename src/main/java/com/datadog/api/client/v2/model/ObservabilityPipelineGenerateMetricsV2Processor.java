...
/**
   * <p>The <code>generate_metrics</code> processor creates custom metrics from logs.
   * Metrics can be counters, gauges, or distributions and optionally grouped by log fields.
   * The generated metrics must be routed to a metrics destination using the input <code>&lt;processor-id&gt;.metrics</code>.</p>
...
public class ObservabilityPipelineGenerateMetricsV2Processor {
  ...
  private ObservabilityPipelineGenerateMetricsV2ProcessorType type = ObservabilityPipelineGenerateMetricsV2ProcessorType.GENERATE_METRICS;
  ...
  public ObservabilityPipelineGenerateMetricsV2Processor(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineGenerateMetricsV2ProcessorType type) {
  ...
  **/
  ...
  public ObservabilityPipelineGenerateMetricsV2Processor metrics(List<ObservabilityPipelineGeneratedMetric> metrics) {
  ...
  public ObservabilityPipelineGenerateMetricsV2Processor addMetricsItem(ObservabilityPipelineGeneratedMetric metricsItem) {
  ...
  **/
  ...
  public ObservabilityPipelineGenerateMetricsV2Processor type(ObservabilityPipelineGenerateMetricsV2ProcessorType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The processor type. Always <code>generate_metrics</code>.</p>
   * @return type
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineGenerateMetricsV2Processor putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineGenerateMetricsV2Processor observabilityPipelineGenerateMetricsV2Processor = (ObservabilityPipelineGenerateMetricsV2Processor) o;
