...
/**
   * <p>Attributes for creating an incident user-defined field.</p>
 */
@JsonPropertyOrder({
...
public class IncidentUserDefinedFieldAttributesCreateRequest {
  ...
  private JsonNullable<IncidentUserDefinedFieldCategory> category = JsonNullable.<IncidentUserDefinedFieldCategory>undefined();

  public static final String JSON_PROPERTY_COLLECTED = "collected";
  private JsonNullable<IncidentUserDefinedFieldCollected> collected = JsonNullable.<IncidentUserDefinedFieldCollected>undefined();
  ...
  public IncidentUserDefinedFieldAttributesCreateRequest(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)IncidentUserDefinedFieldFieldType type) {
        this.name = name;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public IncidentUserDefinedFieldAttributesCreateRequest category(IncidentUserDefinedFieldCategory category) {
    this.category = JsonNullable.<IncidentUserDefinedFieldCategory>of(category);
    return this;
  }

  /**
   * <p>The section in which the field appears: "what_happened" or "why_it_happened". When null, the field appears in the Attributes section.</p>
   * @return category
  **/
  ...
  @JsonProperty(JSON_PROPERTY_CATEGORY)public void setCategory_JsonNullable(JsonNullable<IncidentUserDefinedFieldCategory> category) {
  ...
  public IncidentUserDefinedFieldAttributesCreateRequest collected(IncidentUserDefinedFieldCollected collected) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_COLLECTED)public void setCollected_JsonNullable(JsonNullable<IncidentUserDefinedFieldCollected> collected) {
  ...
  /**
   * <p>The default value for the field. Must be one of the valid values when valid_values is set.</p>
   * @return defaultValue
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_DEFAULT_VALUE)public void setDefaultValue_JsonNullable(JsonNullable<String> defaultValue) {
  ...
  /**
   * <p>The human-readable name shown in the UI. Defaults to a formatted version of the name if not provided.</p>
   * @return displayName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The unique identifier of the field. Must start with a letter or digit and contain only letters, digits, underscores, or periods.</p>
   * @return name
  **/
  ...
  /**
   * <p>A decimal string representing the field's display order in the UI.</p>
   * @return ordinal
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_ORDINAL)public void setOrdinal_JsonNullable(JsonNullable<String> ordinal) {
  ...
  /**
   * <p>When true, users must fill out this field on incidents.</p>
   * @return required
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>For metric tag-type fields only, the metric tag key that powers the autocomplete options.</p>
   * @return tagKey
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  public IncidentUserDefinedFieldAttributesCreateRequest type(IncidentUserDefinedFieldFieldType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The data type of the field. 1=dropdown, 2=multiselect, 3=textbox, 4=textarray, 5=metrictag, 6=autocomplete, 7=number, 8=datetime.</p>
   * @return type
  **/
  ...
  public IncidentUserDefinedFieldAttributesCreateRequest validValues(List<IncidentUserDefinedFieldValidValue> validValues) {
  ...
  public IncidentUserDefinedFieldAttributesCreateRequest addValidValuesItem(IncidentUserDefinedFieldValidValue validValuesItem) {
  ...
  /**
   * <p>The list of allowed values for dropdown and multiselect fields. Limited to 1000 values.</p>
   * @return validValues
  **/
      @jakarta.annotation.Nullable
   ...
   */
  @JsonAnySetter
  public IncidentUserDefinedFieldAttributesCreateRequest putAdditionalProperty(String key, Object value) {
