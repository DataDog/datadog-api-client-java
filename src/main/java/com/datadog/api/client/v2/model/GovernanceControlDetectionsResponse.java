...
/**
   * <p>A list of governance control detections.</p>
 */
@JsonPropertyOrder({
  GovernanceControlDetectionsResponse.JSON_PROPERTY_DATA
})
...
public class GovernanceControlDetectionsResponse {
  ...
  @JsonCreator
  public GovernanceControlDetectionsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<GovernanceControlDetectionData> data) {
        this.data = data;
  ...
  /**
   * <p>An array of governance control detection resources.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    GovernanceControlDetectionsResponse governanceControlDetectionsResponse = (GovernanceControlDetectionsResponse) o;
    return Objects.equals(this.data, governanceControlDetectionsResponse.data) && Objects.equals(this.additionalProperties, governanceControlDetectionsResponse.additionalProperties);
  }
