...
/**
   * <p>The configuration of the report schedule to create.</p>
 */
@JsonPropertyOrder({
...
public class ReportScheduleCreateRequestAttributes {
  ...
  **/
  ...
  /**
   * <p>The identifier of the dashboard or integration dashboard to render in the report.</p>
   * @return resourceId
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleCreateRequestAttributes reportScheduleCreateRequestAttributes = (ReportScheduleCreateRequestAttributes) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deliveryFormat,description,recipients,resourceId,resourceType,rrule,tabId,templateVariables,timeframe,timezone,title, additionalProperties);
  }
