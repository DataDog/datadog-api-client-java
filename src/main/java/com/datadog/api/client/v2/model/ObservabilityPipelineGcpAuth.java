 ...
 */
@JsonPropertyOrder({
  ObservabilityPipelineGcpAuth.JSON_PROPERTY_CREDENTIALS_FILE
})
...
public class ObservabilityPipelineGcpAuth {
  ...
  @JsonCreator
  public ObservabilityPipelineGcpAuth(
            @JsonProperty(required=true, value=JSON_PROPERTY_CREDENTIALS_FILE)String credentialsFile) {
  ...
  /**
   * <p>Path to the Google Cloud service account key file.</p>
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.credentialsFile, observabilityPipelineGcpAuth.credentialsFile) && Objects.equals(this.additionalProperties, observabilityPipelineGcpAuth.additionalProperties);
  }
