...
/**
   * <p>Request for computing analytics results (scalar or timeseries).</p>
 */
@JsonPropertyOrder({
  ProductAnalyticsAnalyticsRequest.JSON_PROPERTY_DATA
})
...
public class ProductAnalyticsAnalyticsRequest {
  ...
  @JsonCreator
  public ProductAnalyticsAnalyticsRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ProductAnalyticsAnalyticsRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsAnalyticsRequest productAnalyticsAnalyticsRequest = (ProductAnalyticsAnalyticsRequest) o;
    return Objects.equals(this.data, productAnalyticsAnalyticsRequest.data) && Objects.equals(this.additionalProperties, productAnalyticsAnalyticsRequest.additionalProperties);
  }
