...
public class FindingType {
  ...
  public static class FindingTypeSerializer extends StdSerializer<FindingType> {
    public FindingTypeSerializer(Class<FindingType> t) {
      super(t);
    }

    public FindingTypeSerializer() {
      this(null);
    }

    @Override
    public void serialize(FindingType value, JsonGenerator jgen, SerializerProvider provider)
  ...
  /** Return true if this FindingType object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return this.value.equals(((FindingType) o).value);
  }
