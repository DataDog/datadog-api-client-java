...
/**
   * <p>Request object for getting code coverage summary for a branch.</p>
 */
@JsonPropertyOrder({
  BranchCoverageSummaryRequest.JSON_PROPERTY_DATA
})
...
public class BranchCoverageSummaryRequest {
  ...
  @JsonCreator
  public BranchCoverageSummaryRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)BranchCoverageSummaryRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, branchCoverageSummaryRequest.data) && Objects.equals(this.additionalProperties, branchCoverageSummaryRequest.additionalProperties);
  }
