...
@JsonPropertyOrder({ListAPIsResponseData.JSON_PROPERTY_ID, ListAPIsResponseData.JSON_PROPERTY_NAME})
...
public class ListAPIsResponseData {
  ...
  public ListAPIsResponseData name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listApIsResponseData.id)
        && Objects.equals(this.name, listApIsResponseData.name)
