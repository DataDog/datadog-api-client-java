...
public class AWSEventBridgeDeleteStatus extends ModelEnum<String> {
  ...
  public static class AWSEventBridgeDeleteStatusSerializer extends StdSerializer<AWSEventBridgeDeleteStatus> {
      ...
      @Override
      public void serialize(AWSEventBridgeDeleteStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
