...
public class ProductAnalyticsUnit {
  ...
  /**
   * <p>The unit family (e.g., time, bytes).</p>
   * @return family
  **/
  ...
  /**
   * <p>Numeric identifier for the unit.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The full name of the unit (e.g., nanosecond).</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Plural form of the unit name (e.g., nanoseconds).</p>
   * @return plural
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Conversion factor relative to the base unit of the family.</p>
   * @return scaleFactor
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Abbreviated unit name (e.g., ns).</p>
   * @return shortName
  **/
      @jakarta.annotation.Nullable
