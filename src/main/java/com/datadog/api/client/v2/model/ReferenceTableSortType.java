...
/**
   * <p>Sort field and direction for reference tables. Use field name for ascending, prefix with "-" for descending.</p>
 */
...
public class ReferenceTableSortType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("updated_at", "table_name", "status", "-updated_at", "-table_name", "-status"));
  ...
  public static final ReferenceTableSortType MINUS_UPDATED_AT = new ReferenceTableSortType("-updated_at");
  public static final ReferenceTableSortType MINUS_TABLE_NAME = new ReferenceTableSortType("-table_name");
  ...
  public static class ReferenceTableSortTypeSerializer extends StdSerializer<ReferenceTableSortType> {
      ...
      @Override
      public void serialize(ReferenceTableSortType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
