 ...
 */
@JsonSerialize(using = LogsArchiveDestinationAzureType.LogsArchiveDestinationAzureTypeSerializer.class)
public class LogsArchiveDestinationAzureType extends ModelEnum<String> {
  ...
  public static final LogsArchiveDestinationAzureType AZURE = new LogsArchiveDestinationAzureType("azure");
  ...
  public static class LogsArchiveDestinationAzureTypeSerializer extends StdSerializer<LogsArchiveDestinationAzureType> {
      ...
      @Override
      public void serialize(LogsArchiveDestinationAzureType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
