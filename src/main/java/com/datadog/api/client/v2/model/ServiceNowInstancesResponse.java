...
/**
   * <p>Response containing ServiceNow instances</p>
 */
@JsonPropertyOrder({
  ServiceNowInstancesResponse.JSON_PROPERTY_DATA
})
...
public class ServiceNowInstancesResponse {
  ...
  private List<ServiceNowInstanceData> data = new ArrayList<>();

  public ServiceNowInstancesResponse() {}

  @JsonCreator
  public ServiceNowInstancesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<ServiceNowInstanceData> data) {
        this.data = data;
  }
  ...
  /**
   * <p>Array of ServiceNow instance data objects</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<ServiceNowInstanceData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, serviceNowInstancesResponse.data) && Objects.equals(this.additionalProperties, serviceNowInstancesResponse.additionalProperties);
  }
