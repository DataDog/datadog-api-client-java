...
/**
   * <p>A valid value for an incident user-defined field.</p>
 */
@JsonPropertyOrder({
...
public class IncidentUserDefinedFieldValidValue {
  ...
  /**
   * <p>A detailed description of the valid value.</p>
   * @return description
  **/
  ...
  /**
   * <p>The human-readable display name for this value.</p>
   * @return displayName
  **/
  ...
  /**
   * <p>A short description of the valid value.</p>
  ...
  **/
  ...
  /**
   * <p>The identifier that is stored when this option is selected.</p>
   * @return value
  **/
