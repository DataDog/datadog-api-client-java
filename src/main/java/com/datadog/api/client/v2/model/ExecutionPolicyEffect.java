...
public class ExecutionPolicyEffect extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("allow", "deny"));
  ...
  public static class ExecutionPolicyEffectSerializer extends StdSerializer<ExecutionPolicyEffect> {
      ...
      @Override
      public void serialize(ExecutionPolicyEffect value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
