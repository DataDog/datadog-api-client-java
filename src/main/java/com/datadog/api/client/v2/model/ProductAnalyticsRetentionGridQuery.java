 ...
 */
@JsonPropertyOrder({
  ProductAnalyticsRetentionGridQuery.JSON_PROPERTY_COMPUTATION_SCOPE,
  ProductAnalyticsRetentionGridQuery.JSON_PROPERTY_COMPUTE,
  ProductAnalyticsRetentionGridQuery.JSON_PROPERTY_GROUP_BY,
  ProductAnalyticsRetentionGridQuery.JSON_PROPERTY_SEARCH
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ProductAnalyticsRetentionGridQuery {
  @JsonIgnore
  ...
  public ProductAnalyticsRetentionGridQuery() {}
  ...
  public ProductAnalyticsRetentionGridQuery computationScope(ProductAnalyticsRetentionScope computationScope) {
  ...
  **/
  ...
  public ProductAnalyticsRetentionGridQuery compute(ProductAnalyticsRetentionCompute compute) {
    this.compute = compute;
    this.unparsed |= compute.unparsed;
    return this;
  }
  ...
  **/
  ...
  public ProductAnalyticsRetentionGridQuery groupBy(List<ProductAnalyticsRetentionGroupBy> groupBy) {
  ...
  public ProductAnalyticsRetentionGridQuery addGroupByItem(ProductAnalyticsRetentionGroupBy groupByItem) {
  ...
  **/
  ...
  public ProductAnalyticsRetentionGridQuery search(ProductAnalyticsRetentionSearch search) {
    this.search = search;
    this.unparsed |= search.unparsed;
    return this;
  }
  ...
  **/
   ...
   * @return ProductAnalyticsRetentionGridQuery
   */
  @JsonAnySetter
  public ProductAnalyticsRetentionGridQuery putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ProductAnalyticsRetentionGridQuery object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ProductAnalyticsRetentionGridQuery productAnalyticsRetentionGridQuery = (ProductAnalyticsRetentionGridQuery) o;
    return Objects.equals(this.computationScope, productAnalyticsRetentionGridQuery.computationScope) && Objects.equals(this.compute, productAnalyticsRetentionGridQuery.compute) && Objects.equals(this.groupBy, productAnalyticsRetentionGridQuery.groupBy) && Objects.equals(this.search, productAnalyticsRetentionGridQuery.search) && Objects.equals(this.additionalProperties, productAnalyticsRetentionGridQuery.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAnalyticsRetentionGridQuery {\n");
