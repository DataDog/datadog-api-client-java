...
public class AllocationType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("FEATURE_GATE", "CANARY"));
  ...
  public static class AllocationTypeSerializer extends StdSerializer<AllocationType> {
      ...
      @Override
      public void serialize(AllocationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
