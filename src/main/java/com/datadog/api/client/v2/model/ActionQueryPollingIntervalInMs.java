...
@JsonDeserialize(using = ActionQueryPollingIntervalInMs.ActionQueryPollingIntervalInMsDeserializer.class)
@JsonSerialize(using = ActionQueryPollingIntervalInMs.ActionQueryPollingIntervalInMsSerializer.class)
public class ActionQueryPollingIntervalInMs extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ActionQueryPollingIntervalInMs.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class ActionQueryPollingIntervalInMsSerializer extends StdSerializer<ActionQueryPollingIntervalInMs> {
        public ActionQueryPollingIntervalInMsSerializer(Class<ActionQueryPollingIntervalInMs> t) {
            super(t);
        }

        public ActionQueryPollingIntervalInMsSerializer() {
            this(null);
        }

        @Override
        public void serialize(ActionQueryPollingIntervalInMs value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ActionQueryPollingIntervalInMsDeserializer extends StdDeserializer<ActionQueryPollingIntervalInMs> {
        public ActionQueryPollingIntervalInMsDeserializer() {
            this(ActionQueryPollingIntervalInMs.class);
        }

        public ActionQueryPollingIntervalInMsDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public ActionQueryPollingIntervalInMs deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            ActionQueryPollingIntervalInMs ret = new ActionQueryPollingIntervalInMs();
            if (match == 1) {
         ...
         */
        @Override
        public ActionQueryPollingIntervalInMs getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ActionQueryPollingIntervalInMs cannot be null");
        }
    }
    ...
    public ActionQueryPollingIntervalInMs() {
        super("oneOf", Boolean.FALSE);
    }
    public ActionQueryPollingIntervalInMs(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public ActionQueryPollingIntervalInMs(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(ActionQueryPollingIntervalInMs.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return ActionQueryPollingIntervalInMs.schemas;
    }
