...
public class ListVulnerabilitiesResponse {
  ...
  public ListVulnerabilitiesResponse(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_LINKS) Links links,
      @JsonProperty(required = true, value = JSON_PROPERTY_META) Metadata meta) {
    this.data = data;
    this.links = links;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, listVulnerabilitiesResponse.data)
        && Objects.equals(this.links, listVulnerabilitiesResponse.links)
        && Objects.equals(this.meta, listVulnerabilitiesResponse.meta)
        && Objects.equals(
            this.additionalProperties, listVulnerabilitiesResponse.additionalProperties);
  }
