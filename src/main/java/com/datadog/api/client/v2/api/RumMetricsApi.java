 ...
 */
  public CompletableFuture<RumMetricResponse>createRumMetricAsync(RumMetricCreateRequest body) {
    return createRumMetricWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Create a metric based on your organization's RUM data.
   * Returns the rum-based metric object from the request body when the request is successful.</p>
   *
   * @param body The definition of the new rum-based metric. (required)
  ...
  public ApiResponse<RumMetricResponse> createRumMetricWithHttpInfo(RumMetricCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumMetricsApi.createRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RumMetricResponse>> createRumMetricWithHttpInfoAsync(RumMetricCreateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.RumMetricsApi.createRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RumMetricResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteRumMetricAsync(String metricId) {
    return deleteRumMetricWithHttpInfoAsync(metricId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete a specific rum-based metric from your organization.</p>
   *
   * @param metricId The name of the rum-based metric. (required)
  ...
  public ApiResponse<Void> deleteRumMetricWithHttpInfo(String metricId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/rum/config/metrics/{metric_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumMetricsApi.deleteRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteRumMetricWithHttpInfoAsync(String metricId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RumMetricsApi.deleteRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<RumMetricResponse>getRumMetricAsync(String metricId) {
    return getRumMetricWithHttpInfoAsync(metricId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get a specific rum-based metric from your organization.</p>
   *
   * @param metricId The name of the rum-based metric. (required)
   * @return ApiResponse&lt;RumMetricResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<RumMetricResponse> getRumMetricWithHttpInfo(String metricId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumMetricsApi.getRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RumMetricResponse>> getRumMetricWithHttpInfoAsync(String metricId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RumMetricsApi.getRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RumMetricResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
 ...
 */
  public CompletableFuture<RumMetricsResponse>listRumMetricsAsync() {
    return listRumMetricsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get the list of configured rum-based metrics with their definitions.</p>
   *
  ...
  public ApiResponse<RumMetricsResponse> listRumMetricsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumMetricsApi.listRumMetrics", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RumMetricsResponse>> listRumMetricsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RumMetricsApi.listRumMetrics", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RumMetricsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricsResponse>() {});
  }
 ...
 */
  public CompletableFuture<RumMetricResponse>updateRumMetricAsync(String metricId, RumMetricUpdateRequest body) {
    return updateRumMetricWithHttpInfoAsync(metricId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update a specific rum-based metric from your organization.
   * Returns the rum-based metric object from the request body when the request is successful.</p>
   *
   * @param metricId The name of the rum-based metric. (required)
   * @param body New definition of the rum-based metric. (required)
  ...
  public ApiResponse<RumMetricResponse> updateRumMetricWithHttpInfo(String metricId, RumMetricUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RumMetricsApi.updateRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RumMetricResponse>> updateRumMetricWithHttpInfoAsync(String metricId, RumMetricUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RumMetricsApi.updateRumMetric", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RumMetricResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RumMetricResponse>() {});
  }
}