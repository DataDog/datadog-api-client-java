...
public class AWSAuthConfig extends AbstractOpenApiSchema {
    ...
    public static class AWSAuthConfigSerializer extends StdSerializer<AWSAuthConfig> {
        ...
        @Override
        public void serialize(AWSAuthConfig value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AWSAuthConfigDeserializer extends StdDeserializer<AWSAuthConfig> {
        ...
        @Override
        public AWSAuthConfig deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AWSAuthConfigKeys.class.equals(Integer.class) || AWSAuthConfigKeys.class.equals(Long.class) || AWSAuthConfigKeys.class.equals(Float.class) || AWSAuthConfigKeys.class.equals(Double.class) || AWSAuthConfigKeys.class.equals(Boolean.class) || AWSAuthConfigKeys.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSAuthConfigKeys.class.equals(Integer.class) || AWSAuthConfigKeys.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSAuthConfigKeys.class.equals(Float.class) || AWSAuthConfigKeys.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSAuthConfigKeys.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSAuthConfigKeys.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (AWSAuthConfigRole.class.equals(Integer.class) || AWSAuthConfigRole.class.equals(Long.class) || AWSAuthConfigRole.class.equals(Float.class) || AWSAuthConfigRole.class.equals(Double.class) || AWSAuthConfigRole.class.equals(Boolean.class) || AWSAuthConfigRole.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSAuthConfigRole.class.equals(Integer.class) || AWSAuthConfigRole.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSAuthConfigRole.class.equals(Float.class) || AWSAuthConfigRole.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSAuthConfigRole.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSAuthConfigRole.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
     ...
     * AWSAuthConfigKeys, AWSAuthConfigRole
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be AWSAuthConfigKeys, AWSAuthConfigRole");
    }
    ...
    /**
     * Get the actual instance of `AWSAuthConfigKeys`. If the actual instance is not `AWSAuthConfigKeys`,
    ...
    /**
     * Get the actual instance of `AWSAuthConfigRole`. If the actual instance is not `AWSAuthConfigRole`,
     * the ClassCastException will be thrown.
     *
