...
/**
   * <p>Attributes of a deployment in the response.</p>
 */
@JsonPropertyOrder({
...
public class FleetDeploymentAttributes {
  ...
  **/
  ...
  /**
   * <p>Estimated completion time of the deployment as a Unix timestamp (seconds since epoch).</p>
  ...
  **/
  ...
  /**
   * <p>Paginated list of hosts in this deployment with their individual statuses. Only included
   * when fetching a single deployment by ID. Use the <code>limit</code> and <code>page</code> query parameters to
   * navigate through pages. Pagination metadata is included in the response <code>meta.hosts</code> field.</p>
   * @return hosts
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>List of packages to deploy to target hosts. Present only for package upgrade deployments.</p>
   * @return packages
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configOperations,estimatedEndTimeUnix,filterQuery,highLevelStatus,hosts,packages,totalHosts, additionalProperties);
  }
