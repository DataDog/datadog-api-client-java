...
/**
 * Step definition for sequence detection containing the step name, condition, and evaluation
 * window.
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringRuleSequenceDetectionStep {
  ...
  /**
   * Condition referencing rule queries (e.g., <code>a &gt; 0</code>).
   *
   * @return condition
   */
  ...
  public SecurityMonitoringRuleSequenceDetectionStep evaluationWindow(
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringRuleSequenceDetectionStep putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringRuleSequenceDetectionStep securityMonitoringRuleSequenceDetectionStep =
        (SecurityMonitoringRuleSequenceDetectionStep) o;
    return Objects.equals(this.condition, securityMonitoringRuleSequenceDetectionStep.condition)
        && Objects.equals(
            this.evaluationWindow, securityMonitoringRuleSequenceDetectionStep.evaluationWindow)
        && Objects.equals(this.name, securityMonitoringRuleSequenceDetectionStep.name)
        && Objects.equals(
            this.additionalProperties,
            securityMonitoringRuleSequenceDetectionStep.additionalProperties);
  }
