...
public class GovernanceInsightPercentageQuery {
  ...
  @JsonCreator
  public GovernanceInsightPercentageQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_DENOMINATOR_QUERY)GovernanceInsightMetricQuery denominatorQuery,
            @JsonProperty(required=true, value=JSON_PROPERTY_NUMERATOR_QUERY)GovernanceInsightMetricQuery numeratorQuery) {
  ...
  public GovernanceInsightPercentageQuery denominatorQuery(GovernanceInsightMetricQuery denominatorQuery) {
    this.denominatorQuery = denominatorQuery;
    this.unparsed |= denominatorQuery.unparsed;
    return this;
  }
  ...
  **/
  ...
  public GovernanceInsightPercentageQuery numeratorQuery(GovernanceInsightMetricQuery numeratorQuery) {
    this.numeratorQuery = numeratorQuery;
    this.unparsed |= numeratorQuery.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GovernanceInsightPercentageQuery governanceInsightPercentageQuery = (GovernanceInsightPercentageQuery) o;
    return Objects.equals(this.denominatorQuery, governanceInsightPercentageQuery.denominatorQuery) && Objects.equals(this.numeratorQuery, governanceInsightPercentageQuery.numeratorQuery) && Objects.equals(this.additionalProperties, governanceInsightPercentageQuery.additionalProperties);
  }
