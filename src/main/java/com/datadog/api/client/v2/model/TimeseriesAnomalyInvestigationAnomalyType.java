...
public class TimeseriesAnomalyInvestigationAnomalyType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("spike", "dip"));
  ...
  public static class TimeseriesAnomalyInvestigationAnomalyTypeSerializer
      extends StdSerializer<TimeseriesAnomalyInvestigationAnomalyType> {
    public TimeseriesAnomalyInvestigationAnomalyTypeSerializer(
        Class<TimeseriesAnomalyInvestigationAnomalyType> t) {
      super(t);
    }
