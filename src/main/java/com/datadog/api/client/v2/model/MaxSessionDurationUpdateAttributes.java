 ...
 */
@JsonPropertyOrder({
  MaxSessionDurationUpdateAttributes.JSON_PROPERTY_MAX_SESSION_DURATION
})
...
public class MaxSessionDurationUpdateAttributes {
  ...
  @JsonCreator
  public MaxSessionDurationUpdateAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_MAX_SESSION_DURATION)Long maxSessionDuration) {
  ...
  /**
   * <p>The maximum session duration, in seconds.</p>
   * minimum: 1
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MaxSessionDurationUpdateAttributes maxSessionDurationUpdateAttributes = (MaxSessionDurationUpdateAttributes) o;
    return Objects.equals(this.maxSessionDuration, maxSessionDurationUpdateAttributes.maxSessionDuration) && Objects.equals(this.additionalProperties, maxSessionDurationUpdateAttributes.additionalProperties);
  }
