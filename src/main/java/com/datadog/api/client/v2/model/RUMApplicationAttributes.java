...
public class RUMApplicationAttributes {
  ...
  **/
  ...
  /**
   * <p>ID of the RUM SDK remote configuration for the application, if one exists.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKeyId,applicationId,clientToken,createdAt,createdByHandle,hash,isActive,name,orgId,productScales,remoteConfigId,type,updatedAt,updatedByHandle, additionalProperties);
  }
