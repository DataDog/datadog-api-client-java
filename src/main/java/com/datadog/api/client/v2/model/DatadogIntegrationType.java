...
public class DatadogIntegrationType extends ModelEnum<String> {
  ...
  public static class DatadogIntegrationTypeSerializer extends StdSerializer<DatadogIntegrationType> {
      ...
      @Override
      public void serialize(DatadogIntegrationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
