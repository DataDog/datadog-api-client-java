...
/**
   * <p>Schema definition for a single label in an annotation queue.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsLabelSchema {
  ...
  **/
  ...
  /**
   * <p>Whether this label includes an assessment field.</p>
  ...
  **/
  ...
  /**
   * <p>Whether this label includes a reasoning field.</p>
   * @return hasReasoning
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Unique identifier of the label schema. Assigned by the server if not provided.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the boolean label represents an assessment. Requires <code>has_assessment</code> to be true.</p>
   * @return isAssessment
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether score values must be integers. Applicable to score-type labels.</p>
   * @return isInteger
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether this label is required for an annotation.</p>
   * @return isRequired
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Maximum value for score-type labels.</p>
   * @return max
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Minimum value for score-type labels.</p>
   * @return min
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the label. Must match the pattern <code>^[a-zA-Z0-9_-]+$</code> and be unique within the queue.</p>
   * @return name
  **/
  ...
  **/
  ...
  /**
   * <p>Allowed values for categorical-type labels. Must contain at least one non-empty, unique value.</p>
   * @return values
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, llmObsLabelSchema.description) && Objects.equals(this.hasAssessment, llmObsLabelSchema.hasAssessment) && Objects.equals(this.hasReasoning, llmObsLabelSchema.hasReasoning) && Objects.equals(this.id, llmObsLabelSchema.id) && Objects.equals(this.isAssessment, llmObsLabelSchema.isAssessment) && Objects.equals(this.isInteger, llmObsLabelSchema.isInteger) && Objects.equals(this.isRequired, llmObsLabelSchema.isRequired) && Objects.equals(this.max, llmObsLabelSchema.max) && Objects.equals(this.min, llmObsLabelSchema.min) && Objects.equals(this.name, llmObsLabelSchema.name) && Objects.equals(this.type, llmObsLabelSchema.type) && Objects.equals(this.values, llmObsLabelSchema.values) && Objects.equals(this.additionalProperties, llmObsLabelSchema.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(description,hasAssessment,hasReasoning,id,isAssessment,isInteger,isRequired,max,min,name,type,values, additionalProperties);
  }
