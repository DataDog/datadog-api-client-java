...
public class TagPolicyScoreType extends ModelEnum<String> {
  ...
  public static class TagPolicyScoreTypeSerializer extends StdSerializer<TagPolicyScoreType> {
    public TagPolicyScoreTypeSerializer(Class<TagPolicyScoreType> t) {
      super(t);
    }
