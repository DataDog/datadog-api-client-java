...
public class LLMObsCustomEvalConfigUpdateData {
  ...
  @JsonCreator
  public LLMObsCustomEvalConfigUpdateData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)LLMObsCustomEvalConfigUpdateAttributes attributes,
  ...
  public LLMObsCustomEvalConfigUpdateData attributes(LLMObsCustomEvalConfigUpdateAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes for creating or updating a custom LLM Observability evaluator configuration.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>Name of the evaluator. If provided, must match the eval_name path parameter.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    LLMObsCustomEvalConfigUpdateData llmObsCustomEvalConfigUpdateData = (LLMObsCustomEvalConfigUpdateData) o;
    return Objects.equals(this.attributes, llmObsCustomEvalConfigUpdateData.attributes) && Objects.equals(this.id, llmObsCustomEvalConfigUpdateData.id) && Objects.equals(this.type, llmObsCustomEvalConfigUpdateData.type) && Objects.equals(this.additionalProperties, llmObsCustomEvalConfigUpdateData.additionalProperties);
  }
