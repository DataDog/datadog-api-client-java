...
public class ObservabilityPipelineEnrichmentTableGeoIp {
  ...
  /**
   * <p>Path to the IP field in the log.</p>
   * @return keyField
  **/
  ...
  /**
   * <p>Locale used to resolve geographical names.</p>
   * @return locale
  **/
  ...
  /**
   * <p>Path to the GeoIP database file.</p>
   * @return path
  **/
