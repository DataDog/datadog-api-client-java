...
public class TagIndexingRuleExemptionAttributes {
  ...
  /**
   * <p>Timestamp when the exemption was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Handle of the user who created the exemption.</p>
  ...
  **/
  ...
  /**
   * <p>Discriminates between an explicit exemption (<code>exemption</code>) and a pre-existing legacy tag configuration acting as an implicit exclusion (<code>legacy_tag_configuration</code>).</p>
   * @return kind
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TagIndexingRuleExemptionAttributes tagIndexingRuleExemptionAttributes = (TagIndexingRuleExemptionAttributes) o;
    return Objects.equals(this.createdAt, tagIndexingRuleExemptionAttributes.createdAt) && Objects.equals(this.createdByHandle, tagIndexingRuleExemptionAttributes.createdByHandle) && Objects.equals(this.kind, tagIndexingRuleExemptionAttributes.kind) && Objects.equals(this.reason, tagIndexingRuleExemptionAttributes.reason) && Objects.equals(this.additionalProperties, tagIndexingRuleExemptionAttributes.additionalProperties);
  }
