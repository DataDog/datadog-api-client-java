...
public class FindingServiceNowTicket {
  ...
  **/
  ...
  /**
   * <p>Status of the ServiceNow ticket operation. Can be "COMPLETED" if successful, or "FAILED" if the operation failed.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.result, findingServiceNowTicket.result) && Objects.equals(this.status, findingServiceNowTicket.status) && Objects.equals(this.additionalProperties, findingServiceNowTicket.additionalProperties);
  }
