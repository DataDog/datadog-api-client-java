...
public class FlakyTestsSearchFilter {
  ...
  **/
  ...
  /**
   * <p>Search query following log syntax used to filter flaky tests, same as on Flaky Tests Management UI. The supported search keys are:
   * - <code>flaky_test_state</code>
   * - <code>flaky_test_category</code>
   * - <code>@test.name</code>
   * - <code>@test.suite</code>
   * - <code>@test.module</code>
   * - <code>@test.service</code>
   * - <code>@git.repository.id_v2</code>
   * - <code>@git.branch</code>
   * - <code>@test.codeowners</code>
   * - <code>env</code>
   * - <code>fingerprint_fqn</code></p>
   * <p>Use <code>fingerprint_fqn</code> to filter by a test's stable Fingerprint FQN (the same value as the test's <code>id</code>).</p>
   * @return query
  **/
      @jakarta.annotation.Nullable
   ...
   * @return FlakyTestsSearchFilter
   */
  @JsonAnySetter
  public FlakyTestsSearchFilter putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this FlakyTestsSearchFilter object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeHistory, flakyTestsSearchFilter.includeHistory) && Objects.equals(this.query, flakyTestsSearchFilter.query) && Objects.equals(this.additionalProperties, flakyTestsSearchFilter.additionalProperties);
  }
