...
public class ContainerImageMetaPageType extends ModelEnum<String> {
  ...
  public static final ContainerImageMetaPageType CURSOR_LIMIT = new ContainerImageMetaPageType("cursor_limit");
  ...
  public static class ContainerImageMetaPageTypeSerializer extends StdSerializer<ContainerImageMetaPageType> {
      ...
      @Override
      public void serialize(ContainerImageMetaPageType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
