...
public class ObservabilityPipelineAmazonOpenSearchDestination {
  ...
  private ObservabilityPipelineAmazonOpenSearchDestinationType type =
  ...
  public ObservabilityPipelineAmazonOpenSearchDestination(
      @JsonProperty(required = true, value = JSON_PROPERTY_AUTH)
          ObservabilityPipelineAmazonOpenSearchDestinationAuth auth,
      @JsonProperty(required = true, value = JSON_PROPERTY_ID) String id,
      @JsonProperty(required = true, value = JSON_PROPERTY_INPUTS) List<String> inputs,
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ObservabilityPipelineAmazonOpenSearchDestinationType type) {
    this.auth = auth;
  ...
  public ObservabilityPipelineAmazonOpenSearchDestination auth(
      ObservabilityPipelineAmazonOpenSearchDestinationAuth auth) {
    this.auth = auth;
    this.unparsed |= auth.unparsed;
    return this;
  ...
  public ObservabilityPipelineAmazonOpenSearchDestination type(
      ObservabilityPipelineAmazonOpenSearchDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineAmazonOpenSearchDestination putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.auth, observabilityPipelineAmazonOpenSearchDestination.auth)
        ...
        && Objects.equals(this.inputs, observabilityPipelineAmazonOpenSearchDestination.inputs)
        && Objects.equals(this.type, observabilityPipelineAmazonOpenSearchDestination.type)
        && Objects.equals(
            this.additionalProperties,
            observabilityPipelineAmazonOpenSearchDestination.additionalProperties);
  }
