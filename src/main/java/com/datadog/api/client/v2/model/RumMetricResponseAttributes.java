...
/**
   * <p>The object describing a Datadog rum-based metric.</p>
 */
@JsonPropertyOrder({
...
public class RumMetricResponseAttributes {
  ...
  **/
  ...
  /**
   * <p>The rum-based metric filter. RUM events matching this filter will be aggregated in this metric.</p>
   * @return filter
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The rule to count updatable events. Is only set if <code>event_type</code> is <code>session</code> or <code>view</code>.</p>
   * @return uniqueness
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.compute, rumMetricResponseAttributes.compute) && Objects.equals(this.eventType, rumMetricResponseAttributes.eventType) && Objects.equals(this.filter, rumMetricResponseAttributes.filter) && Objects.equals(this.groupBy, rumMetricResponseAttributes.groupBy) && Objects.equals(this.uniqueness, rumMetricResponseAttributes.uniqueness) && Objects.equals(this.additionalProperties, rumMetricResponseAttributes.additionalProperties);
  }
