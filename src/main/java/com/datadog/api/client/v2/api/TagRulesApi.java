...
public class TagRulesApi {
   ...
   */
  public CompletableFuture<Void> deleteTagRuleAsync(String policyId) {
   ...
   * @return CompletableFuture&lt;TagRuleResponse&gt;
   */
  public CompletableFuture<TagRuleResponse> getTagRuleAsync(String policyId) {
   ...
   */
  public CompletableFuture<TagRuleScoreResponse> getTagRuleScoreAsync(String policyId) {
