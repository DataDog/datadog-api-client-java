...
public class FastlyCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class FastlyCredentialsUpdateSerializer extends StdSerializer<FastlyCredentialsUpdate> {
        ...
        @Override
        public void serialize(FastlyCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class FastlyCredentialsUpdateDeserializer extends StdDeserializer<FastlyCredentialsUpdate> {
        ...
        @Override
        public FastlyCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (FastlyAPIKeyUpdate.class.equals(Integer.class) || FastlyAPIKeyUpdate.class.equals(Long.class) || FastlyAPIKeyUpdate.class.equals(Float.class) || FastlyAPIKeyUpdate.class.equals(Double.class) || FastlyAPIKeyUpdate.class.equals(Boolean.class) || FastlyAPIKeyUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((FastlyAPIKeyUpdate.class.equals(Integer.class) || FastlyAPIKeyUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((FastlyAPIKeyUpdate.class.equals(Float.class) || FastlyAPIKeyUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (FastlyAPIKeyUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (FastlyAPIKeyUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public FastlyCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `FastlyAPIKeyUpdate`. If the actual instance is not `FastlyAPIKeyUpdate`,
