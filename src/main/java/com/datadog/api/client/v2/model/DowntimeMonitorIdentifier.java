...
public class DowntimeMonitorIdentifier extends AbstractOpenApiSchema {
    ...
    public static class DowntimeMonitorIdentifierSerializer extends StdSerializer<DowntimeMonitorIdentifier> {
        ...
        @Override
        public void serialize(DowntimeMonitorIdentifier value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class DowntimeMonitorIdentifierDeserializer extends StdDeserializer<DowntimeMonitorIdentifier> {
        ...
        @Override
        public DowntimeMonitorIdentifier deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (DowntimeMonitorIdentifierId.class.equals(Integer.class) || DowntimeMonitorIdentifierId.class.equals(Long.class) || DowntimeMonitorIdentifierId.class.equals(Float.class) || DowntimeMonitorIdentifierId.class.equals(Double.class) || DowntimeMonitorIdentifierId.class.equals(Boolean.class) || DowntimeMonitorIdentifierId.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((DowntimeMonitorIdentifierId.class.equals(Integer.class) || DowntimeMonitorIdentifierId.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((DowntimeMonitorIdentifierId.class.equals(Float.class) || DowntimeMonitorIdentifierId.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (DowntimeMonitorIdentifierId.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (DowntimeMonitorIdentifierId.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (DowntimeMonitorIdentifierTags.class.equals(Integer.class) || DowntimeMonitorIdentifierTags.class.equals(Long.class) || DowntimeMonitorIdentifierTags.class.equals(Float.class) || DowntimeMonitorIdentifierTags.class.equals(Double.class) || DowntimeMonitorIdentifierTags.class.equals(Boolean.class) || DowntimeMonitorIdentifierTags.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((DowntimeMonitorIdentifierTags.class.equals(Integer.class) || DowntimeMonitorIdentifierTags.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((DowntimeMonitorIdentifierTags.class.equals(Float.class) || DowntimeMonitorIdentifierTags.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (DowntimeMonitorIdentifierTags.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (DowntimeMonitorIdentifierTags.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public DowntimeMonitorIdentifier getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        ...
        schemas.put("DowntimeMonitorIdentifierTags", new GenericType<DowntimeMonitorIdentifierTags>() {
        });
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be DowntimeMonitorIdentifierId, DowntimeMonitorIdentifierTags");
    }
    ...
    /**
     * Get the actual instance of `DowntimeMonitorIdentifierId`. If the actual instance is not `DowntimeMonitorIdentifierId`,
    ...
    /**
     * Get the actual instance of `DowntimeMonitorIdentifierTags`. If the actual instance is not `DowntimeMonitorIdentifierTags`,
     * the ClassCastException will be thrown.
     *
     ...
     */
    public DowntimeMonitorIdentifierTags getDowntimeMonitorIdentifierTags() throws ClassCastException {
