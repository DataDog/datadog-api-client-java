...
public class FleetDeploymentPackageUpgradeV2Attributes {
  ...
  public FleetDeploymentPackageUpgradeV2Attributes targetPackages(
      List<FleetDeploymentPackage> targetPackages) {
    this.targetPackages = targetPackages;
    for (FleetDeploymentPackage item : targetPackages) {
      this.unparsed |= item.unparsed;
  ...
  public FleetDeploymentPackageUpgradeV2Attributes addTargetPackagesItem(
  ...
  public boolean equals(Object o) {
    ...
    FleetDeploymentPackageUpgradeV2Attributes fleetDeploymentPackageUpgradeV2Attributes =
        (FleetDeploymentPackageUpgradeV2Attributes) o;
    return Objects.equals(this.filterQuery, fleetDeploymentPackageUpgradeV2Attributes.filterQuery)
        && Objects.equals(
            this.targetPackages, fleetDeploymentPackageUpgradeV2Attributes.targetPackages)
        && Objects.equals(
            this.additionalProperties,
            fleetDeploymentPackageUpgradeV2Attributes.additionalProperties);
  }
