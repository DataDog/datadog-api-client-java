 ...
 */
@JsonPropertyOrder({
  UpdateFormDataAttributes.JSON_PROPERTY_FORM_UPDATE
})
...
public class UpdateFormDataAttributes {
  ...
  @JsonCreator
  public UpdateFormDataAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_FORM_UPDATE)FormUpdateAttributes formUpdate) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.formUpdate, updateFormDataAttributes.formUpdate) && Objects.equals(this.additionalProperties, updateFormDataAttributes.additionalProperties);
  }
