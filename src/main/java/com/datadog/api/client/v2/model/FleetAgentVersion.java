...
/**
   * <p>Represents an available Datadog Agent version.</p>
 */
@JsonPropertyOrder({
...
public class FleetAgentVersion {
  ...
  public FleetAgentVersion(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)FleetAgentVersionResourceType type) {
        this.id = id;
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>Unique identifier for the Agent version (same as version).</p>
   * @return id
  **/
  ...
  /**
   * <p>The type of Agent version resource.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, fleetAgentVersion.attributes) && Objects.equals(this.id, fleetAgentVersion.id) && Objects.equals(this.type, fleetAgentVersion.type) && Objects.equals(this.additionalProperties, fleetAgentVersion.additionalProperties);
  }
