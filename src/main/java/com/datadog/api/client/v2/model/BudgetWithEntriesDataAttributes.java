...
public class BudgetWithEntriesDataAttributes {
  ...
  **/
  ...
  /**
   * <p>The month when the budget ends, in YYYYMM format.</p>
   * @return endMonth
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The cost query used to track spending against the budget.</p>
   * @return metricsQuery
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The ID of the organization the budget belongs to.</p>
   * @return orgId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The month when the budget starts, in YYYYMM format.</p>
   * @return startMonth
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The total budget amount across all entries.</p>
   * @return totalAmount
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The ID of the user that last updated the budget.</p>
   * @return updatedBy
  **/
      @jakarta.annotation.Nullable
