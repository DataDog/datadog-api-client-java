...
public class FastlyServiceType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("fastly-services"));
  ...
  public static class FastlyServiceTypeSerializer extends StdSerializer<FastlyServiceType> {
      ...
      @Override
      public void serialize(FastlyServiceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
