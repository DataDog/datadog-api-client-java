...
public class SecurityMonitoringCriticalAssetAttributes {
  ...
  **/
  ...
  /**
   * <p>Whether the critical asset is editable.</p>
   * @return editable
  **/
      @jakarta.annotation.Nullable
