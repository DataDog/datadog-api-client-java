...
@JsonPropertyOrder({
  ...
  RUMApplicationCreateAttributes.JSON_PROPERTY_RUM_PRODUCT_ANALYTICS_RETENTION_STATE,
...
public class RUMApplicationCreateAttributes {
  ...
  public static final String JSON_PROPERTY_RUM_PRODUCT_ANALYTICS_RETENTION_STATE =
      "rum_product_analytics_retention_state";
  private RUMProductAnalyticsRetentionState rumProductAnalyticsRetentionState;
  ...
  public RUMApplicationCreateAttributes rumProductAnalyticsRetentionState(
      RUMProductAnalyticsRetentionState rumProductAnalyticsRetentionState) {
    this.rumProductAnalyticsRetentionState = rumProductAnalyticsRetentionState;
    this.unparsed |= !rumProductAnalyticsRetentionState.isValid();
    return this;
  }
   ...
   *
   * @return rumProductAnalyticsRetentionState
   */
  @jakarta.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_RUM_PRODUCT_ANALYTICS_RETENTION_STATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public RUMProductAnalyticsRetentionState getRumProductAnalyticsRetentionState() {
    return rumProductAnalyticsRetentionState;
  }

  public void setRumProductAnalyticsRetentionState(
      RUMProductAnalyticsRetentionState rumProductAnalyticsRetentionState) {
    if (!rumProductAnalyticsRetentionState.isValid()) {
      this.unparsed = true;
    }
    this.rumProductAnalyticsRetentionState = rumProductAnalyticsRetentionState;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, rumApplicationCreateAttributes.name)
        ...
        && Objects.equals(
            this.rumProductAnalyticsRetentionState,
            rumApplicationCreateAttributes.rumProductAnalyticsRetentionState)
  ...
  public String toString() {
    ...
    sb.append("    rumEventProcessingState: ")
        ...
        .append("\n");
    sb.append("    rumProductAnalyticsRetentionState: ")
        .append(toIndentedString(rumProductAnalyticsRetentionState))
        .append("\n");
