...
public class ServiceAccountType extends ModelEnum<String> {
  ...
  public static final ServiceAccountType SERVICE_ACCOUNT = new ServiceAccountType("service_account");
  ...
  public static class ServiceAccountTypeSerializer extends StdSerializer<ServiceAccountType> {
      ...
      @Override
      public void serialize(ServiceAccountType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
