...
/**
   * <p>The request data object containing attributes for unassigning seats from users.</p>
 */
@JsonPropertyOrder({
...
public class UnassignSeatsUserRequestData {
  ...
  @JsonCreator
  public UnassignSeatsUserRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)UnassignSeatsUserRequestDataAttributes attributes,
  ...
  public UnassignSeatsUserRequestData attributes(UnassignSeatsUserRequestDataAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  /**
   * <p>Attributes specifying the product and users from whom seats will be unassigned.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The ID of the unassign seats user request.</p>
   * @return id
  **/
  ...
  /**
   * <p>Seat assignments resource type.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, unassignSeatsUserRequestData.attributes) && Objects.equals(this.id, unassignSeatsUserRequestData.id) && Objects.equals(this.type, unassignSeatsUserRequestData.type) && Objects.equals(this.additionalProperties, unassignSeatsUserRequestData.additionalProperties);
  }
