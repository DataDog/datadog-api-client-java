...
/**
   * <p>The definition of <code>ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems</code> object.</p>
 */
@JsonPropertyOrder({
...
public class ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems {
  ...
  private List<ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItemsAllocatedTagsItems> allocatedTags = new ArrayList<>();
  ...
  @JsonCreator
  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems(
            @JsonProperty(required=true, value=JSON_PROPERTY_ALLOCATED_TAGS)List<ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItemsAllocatedTagsItems> allocatedTags,
  ...
  public ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems allocatedTags(List<ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItemsAllocatedTagsItems> allocatedTags) {
    this.allocatedTags = allocatedTags;
    for (ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItemsAllocatedTagsItems item : allocatedTags) {
  ...
  **/
  ...
  public void setAllocatedTags(List<ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItemsAllocatedTagsItems> allocatedTags) {
    this.allocatedTags = allocatedTags;
  }
  ...
  **/
  ...
  /**
   * Return true if this ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems = (ArbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems) o;
    return Objects.equals(this.allocatedTags, arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems.allocatedTags) && Objects.equals(this.percentage, arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems.percentage) && Objects.equals(this.additionalProperties, arbitraryCostUpsertRequestDataAttributesStrategyAllocatedByItems.additionalProperties);
  }
