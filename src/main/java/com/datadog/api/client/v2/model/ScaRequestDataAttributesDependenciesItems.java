...
/** The definition of <code>ScaRequestDataAttributesDependenciesItems</code> object. */
@JsonPropertyOrder({
...
public class ScaRequestDataAttributesDependenciesItems {
  ...
  /**
   * The <code>items</code> <code>exclusions</code>.
   *
   * @return exclusions
   */
  ...
  /**
   * The <code>items</code> <code>group</code>.
   *
   * @return group
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>items</code> <code>is_dev</code>.
   *
   * @return isDev
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>items</code> <code>is_direct</code>.
   *
   * @return isDirect
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>items</code> <code>locations</code>.
   *
   * @return locations
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>items</code> <code>package_manager</code>.
   *
  ...
  /**
   * The <code>items</code> <code>reachable_symbol_properties</code>.
   *
  ...
  /**
   * The <code>items</code> <code>version</code>.
   *
   * @return version
   */
  @jakarta.annotation.Nullable
