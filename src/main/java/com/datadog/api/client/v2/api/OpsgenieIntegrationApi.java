 ...
 */
  public OpsgenieAccountResponse  createOpsgenieAccount(OpsgenieAccountCreateRequest body) throws ApiException {
 ...
 */
  public CompletableFuture<OpsgenieAccountResponse>createOpsgenieAccountAsync(OpsgenieAccountCreateRequest body) {
    return createOpsgenieAccountWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Create a new Opsgenie account in the Datadog Opsgenie integration.</p>
   *
   * @param body Opsgenie account payload. (required)
   ...
   *     </table>
   */
  public ApiResponse<OpsgenieAccountResponse> createOpsgenieAccountWithHttpInfo(OpsgenieAccountCreateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling createOpsgenieAccount");
    }
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.createOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<OpsgenieAccountResponse>> createOpsgenieAccountWithHttpInfoAsync(OpsgenieAccountCreateRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling createOpsgenieAccount"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/opsgenie/accounts";
    ...
    try {
      builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.createOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OpsgenieAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountResponse>() {});
  }
 ...
 */
  public CompletableFuture<Void>deleteOpsgenieAccountAsync(String accountId) {
    return deleteOpsgenieAccountWithHttpInfoAsync(accountId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Delete a single Opsgenie account from the Datadog Opsgenie integration.</p>
   *
   * @param accountId The UUID of the Opsgenie account. (required)
  ...
  public ApiResponse<Void> deleteOpsgenieAccountWithHttpInfo(String accountId) throws ApiException {
    ...
    if (accountId == null) {
      throw new ApiException(400, "Missing the required parameter 'accountId' when calling deleteOpsgenieAccount");
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/opsgenie/accounts/{account_id}"
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.deleteOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteOpsgenieAccountWithHttpInfoAsync(String accountId) {
    ...
    if (accountId == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'accountId' when calling deleteOpsgenieAccount"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/opsgenie/accounts/{account_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.deleteOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 */
  public CompletableFuture<OpsgenieAccountsResponse>listOpsgenieAccountsAsync() {
    return listOpsgenieAccountsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get a list of all Opsgenie accounts from the Datadog Opsgenie integration.</p>
   *
  ...
  public ApiResponse<OpsgenieAccountsResponse> listOpsgenieAccountsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.listOpsgenieAccounts", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<OpsgenieAccountsResponse>> listOpsgenieAccountsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.listOpsgenieAccounts", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OpsgenieAccountsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountsResponse>() {});
  }
 ...
 * @return CompletableFuture&lt;OpsgenieAccountResponse&gt;
 */
  public CompletableFuture<OpsgenieAccountResponse>updateOpsgenieAccountAsync(String accountId, OpsgenieAccountUpdateRequest body) {
    return updateOpsgenieAccountWithHttpInfoAsync(accountId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Update a single Opsgenie account in the Datadog Opsgenie integration.</p>
   *
   * @param accountId The UUID of the Opsgenie account. (required)
   * @param body Opsgenie account payload. (required)
   * @return ApiResponse&lt;OpsgenieAccountResponse&gt;
   ...
   *     </table>
   */
  public ApiResponse<OpsgenieAccountResponse> updateOpsgenieAccountWithHttpInfo(String accountId, OpsgenieAccountUpdateRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'accountId' is set
    if (accountId == null) {
      throw new ApiException(400, "Missing the required parameter 'accountId' when calling updateOpsgenieAccount");
    }

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling updateOpsgenieAccount");
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/opsgenie/accounts/{account_id}"
      .replaceAll("\\{" + "account_id" + "\\}", apiClient.escapeString(accountId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.updateOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<OpsgenieAccountResponse>> updateOpsgenieAccountWithHttpInfoAsync(String accountId, OpsgenieAccountUpdateRequest body) {
    ...
    if (accountId == null) {
        CompletableFuture<ApiResponse<OpsgenieAccountResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'accountId' when calling updateOpsgenieAccount"));
        return result;
    }
    ...
    if (body == null) {
        CompletableFuture<ApiResponse<OpsgenieAccountResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling updateOpsgenieAccount"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/integration/opsgenie/accounts/{account_id}"
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.OpsgenieIntegrationApi.updateOpsgenieAccount", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<OpsgenieAccountResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<OpsgenieAccountResponse>() {});
  }
