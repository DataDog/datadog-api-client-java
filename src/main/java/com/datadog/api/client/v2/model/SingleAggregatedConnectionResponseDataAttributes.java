...
public class SingleAggregatedConnectionResponseDataAttributes {
  ...
  /**
   * <p>The total number of bytes sent by the client over the given period.</p>
  ...
  **/
  ...
  /**
   * <p>The total number of bytes sent by the server over the given period.</p>
  ...
  **/
  ...
  /**
   * <p>The total number of packets sent by the client over the given period.</p>
  ...
  **/
  ...
  /**
   * <p>The total number of packets sent by the server over the given period.</p>
  ...
  **/
  ...
  /**
   * <p>Measured as TCP smoothed round trip time in microseconds (the time between a TCP frame being sent and acknowledged).</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP connections in a closed state. Measured in connections per second from the client.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP segments acknowledged with the ECN Congestion Experienced (CE) mark, indicating that an upstream router marked packets as experiencing congestion.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP connections in an established state. Measured in connections per second from the client.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP zero-window probes sent. These probes are sent when the receiver advertises a zero receive window, indicating it cannot accept more data.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP packets received out of order. This indicates network-level packet reordering, which can degrade TCP performance by triggering spurious retransmissions and reducing throughput.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP fast recovery events. Fast recovery retransmits lost segments detected through duplicate ACKs or selective acknowledgment (SACK) without waiting for a retransmission timeout.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP connections that were refused by the server. Typically this indicates an attempt to connect to an IP/port that is not receiving connections, or a firewall/security misconfiguration.</p>
   * @return tcpRefusals
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The number of times reordering of sent packets was detected. Reordering detection adjusts the duplicate ACK threshold, preventing spurious retransmissions caused by out-of-order delivery.</p>
   * @return tcpReordSeen
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The number of TCP connections that were reset by the server.</p>
   * @return tcpResets
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>TCP Retransmits represent detected failures that are retransmitted to ensure delivery. Measured in count of retransmits from the client.</p>
  ...
  **/
  ...
  /**
   * <p>The number of TCP retransmission timeouts (RTOs). An RTO occurs when an ACK is not received within the estimated round-trip time, forcing the sender to retransmit and halve its congestion window.</p>
   * @return tcpRtoCount
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The number of TCP connections that timed out from the perspective of the operating system. This can indicate general connectivity and latency issues.</p>
   * @return tcpTimeouts
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    SingleAggregatedConnectionResponseDataAttributes singleAggregatedConnectionResponseDataAttributes = (SingleAggregatedConnectionResponseDataAttributes) o;
    return Objects.equals(this.bytesSentByClient, singleAggregatedConnectionResponseDataAttributes.bytesSentByClient) && Objects.equals(this.bytesSentByServer, singleAggregatedConnectionResponseDataAttributes.bytesSentByServer) && Objects.equals(this.groupBys, singleAggregatedConnectionResponseDataAttributes.groupBys) && Objects.equals(this.packetsSentByClient, singleAggregatedConnectionResponseDataAttributes.packetsSentByClient) && Objects.equals(this.packetsSentByServer, singleAggregatedConnectionResponseDataAttributes.packetsSentByServer) && Objects.equals(this.rttMicroSeconds, singleAggregatedConnectionResponseDataAttributes.rttMicroSeconds) && Objects.equals(this.tcpClosedConnections, singleAggregatedConnectionResponseDataAttributes.tcpClosedConnections) && Objects.equals(this.tcpDeliveredCe, singleAggregatedConnectionResponseDataAttributes.tcpDeliveredCe) && Objects.equals(this.tcpEstablishedConnections, singleAggregatedConnectionResponseDataAttributes.tcpEstablishedConnections) && Objects.equals(this.tcpProbe0Count, singleAggregatedConnectionResponseDataAttributes.tcpProbe0Count) && Objects.equals(this.tcpRcvOooPack, singleAggregatedConnectionResponseDataAttributes.tcpRcvOooPack) && Objects.equals(this.tcpRecoveryCount, singleAggregatedConnectionResponseDataAttributes.tcpRecoveryCount) && Objects.equals(this.tcpRefusals, singleAggregatedConnectionResponseDataAttributes.tcpRefusals) && Objects.equals(this.tcpReordSeen, singleAggregatedConnectionResponseDataAttributes.tcpReordSeen) && Objects.equals(this.tcpResets, singleAggregatedConnectionResponseDataAttributes.tcpResets) && Objects.equals(this.tcpRetransmits, singleAggregatedConnectionResponseDataAttributes.tcpRetransmits) && Objects.equals(this.tcpRtoCount, singleAggregatedConnectionResponseDataAttributes.tcpRtoCount) && Objects.equals(this.tcpTimeouts, singleAggregatedConnectionResponseDataAttributes.tcpTimeouts) && Objects.equals(this.additionalProperties, singleAggregatedConnectionResponseDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(bytesSentByClient,bytesSentByServer,groupBys,packetsSentByClient,packetsSentByServer,rttMicroSeconds,tcpClosedConnections,tcpDeliveredCe,tcpEstablishedConnections,tcpProbe0Count,tcpRcvOooPack,tcpRecoveryCount,tcpRefusals,tcpReordSeen,tcpResets,tcpRetransmits,tcpRtoCount,tcpTimeouts, additionalProperties);
  }
