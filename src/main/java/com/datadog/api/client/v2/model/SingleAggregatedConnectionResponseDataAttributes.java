...
public class SingleAggregatedConnectionResponseDataAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bytesSentByClient,bytesSentByServer,groupBys,packetsSentByClient,packetsSentByServer,rttMicroSeconds,tcpClosedConnections,tcpEstablishedConnections,tcpRefusals,tcpResets,tcpRetransmits,tcpTimeouts, additionalProperties);
  }
