...
/**
   * <p>A time slot returned in a Synthetics downtime response.</p>
 */
@JsonPropertyOrder({
...
public class SyntheticsDowntimeTimeSlotResponse {
  ...
  /**
   * <p>The duration of the time slot in seconds.</p>
   * @return duration
  **/
  ...
  /**
   * <p>The unique identifier of the time slot.</p>
   * @return id
  **/
  ...
  /**
   * <p>The label for the time slot.</p>
   * @return name
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsDowntimeTimeSlotResponse syntheticsDowntimeTimeSlotResponse = (SyntheticsDowntimeTimeSlotResponse) o;
    return Objects.equals(this.duration, syntheticsDowntimeTimeSlotResponse.duration) && Objects.equals(this.id, syntheticsDowntimeTimeSlotResponse.id) && Objects.equals(this.name, syntheticsDowntimeTimeSlotResponse.name) && Objects.equals(this.recurrence, syntheticsDowntimeTimeSlotResponse.recurrence) && Objects.equals(this.start, syntheticsDowntimeTimeSlotResponse.start) && Objects.equals(this.timezone, syntheticsDowntimeTimeSlotResponse.timezone) && Objects.equals(this.additionalProperties, syntheticsDowntimeTimeSlotResponse.additionalProperties);
  }
