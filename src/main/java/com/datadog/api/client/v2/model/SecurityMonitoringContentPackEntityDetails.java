...
/**
   * <p>Details for an entity or identity content pack.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringContentPackEntityDetails {
  ...
  public SecurityMonitoringContentPackEntityDetails(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SecurityMonitoringContentPackEntityDetailsType type) {
        this.cpActivation = cpActivation;
        this.unparsed |= !cpActivation.isValid();
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public SecurityMonitoringContentPackEntityDetails cpActivation(SecurityMonitoringContentPackActivation cpActivation) {
    this.cpActivation = cpActivation;
    this.unparsed |= !cpActivation.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringContentPackEntityDetails type(SecurityMonitoringContentPackEntityDetailsType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringContentPackEntityDetails putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringContentPackEntityDetails securityMonitoringContentPackEntityDetails = (SecurityMonitoringContentPackEntityDetails) o;
    return Objects.equals(this.cpActivation, securityMonitoringContentPackEntityDetails.cpActivation) && Objects.equals(this.type, securityMonitoringContentPackEntityDetails.type) && Objects.equals(this.additionalProperties, securityMonitoringContentPackEntityDetails.additionalProperties);
  }
