...
public class ElasticCloudIntegrationAccountCreateAttributes {
  ...
  public ElasticCloudIntegrationAccountCreateAttributes(
      @JsonProperty(required = true, value = JSON_PROPERTY_AUTHENTICATION)
          ElasticCloudIntegrationAccountAuthenticationRequest authentication,
      @JsonProperty(required = true, value = JSON_PROPERTY_NAME) String name,
      @JsonProperty(required = true, value = JSON_PROPERTY_SETTINGS)
          ElasticCloudIntegrationAccountSettingsRequest settings) {
  ...
  public ElasticCloudIntegrationAccountCreateAttributes authentication(
      ElasticCloudIntegrationAccountAuthenticationRequest authentication) {
    this.authentication = authentication;
    this.unparsed |= authentication.unparsed;
    return this;
  ...
  public ElasticCloudIntegrationAccountCreateAttributes dataflows(
  ...
  public ElasticCloudIntegrationAccountCreateAttributes settings(
      ElasticCloudIntegrationAccountSettingsRequest settings) {
    this.settings = settings;
    this.unparsed |= settings.unparsed;
    return this;
   ...
   */
  @JsonAnySetter
  public ElasticCloudIntegrationAccountCreateAttributes putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    ElasticCloudIntegrationAccountCreateAttributes elasticCloudIntegrationAccountCreateAttributes =
        (ElasticCloudIntegrationAccountCreateAttributes) o;
    return Objects.equals(
            this.authentication, elasticCloudIntegrationAccountCreateAttributes.authentication)
        && Objects.equals(this.dataflows, elasticCloudIntegrationAccountCreateAttributes.dataflows)
        && Objects.equals(this.name, elasticCloudIntegrationAccountCreateAttributes.name)
        && Objects.equals(this.settings, elasticCloudIntegrationAccountCreateAttributes.settings)
        && Objects.equals(
            this.additionalProperties,
            elasticCloudIntegrationAccountCreateAttributes.additionalProperties);
  }
