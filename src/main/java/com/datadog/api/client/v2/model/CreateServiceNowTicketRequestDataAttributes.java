...
public class CreateServiceNowTicketRequestDataAttributes {
  ...
  /**
   * <p>Unique identifier of the Datadog user assigned to the case backing the ServiceNow ticket.</p>
   * @return assigneeId
  **/
  ...
  /**
   * <p>Description of the ServiceNow ticket. If not provided, the description will be automatically generated.</p>
   * @return description
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Title of the ServiceNow ticket. If not provided, the title will be automatically generated.</p>
   * @return title
  **/
      @jakarta.annotation.Nullable
