...
public class PersonalAccessTokenResponse {
  ...
  public PersonalAccessTokenResponse data(FullPersonalAccessToken data) {
    this.data = data;
  ...
  /**
   * Personal access token object with the secret key value. This is only returned when creating a
   * new token.
   *
   * @return data
   */
   ...
   */
  @JsonAnySetter
  public PersonalAccessTokenResponse putAdditionalProperty(String key, Object value) {
  ...
  /** Return true if this PersonalAccessTokenResponse object is equal to o. */
  @Override
