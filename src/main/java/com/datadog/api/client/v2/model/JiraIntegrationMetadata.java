...
/**
   * <p>Incident integration metadata for the Jira integration.</p>
 */
@JsonPropertyOrder({
  JiraIntegrationMetadata.JSON_PROPERTY_ISSUES
})
...
public class JiraIntegrationMetadata {
  ...
  @JsonCreator
  public JiraIntegrationMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_ISSUES)List<JiraIntegrationMetadataIssuesItem> issues) {
        this.issues = issues;
  }
  ...
  /**
   * <p>Array of Jira issues in this integration metadata.</p>
   * @return issues
  **/
   ...
   * @return JiraIntegrationMetadata
   */
  @JsonAnySetter
  public JiraIntegrationMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issues, jiraIntegrationMetadata.issues) && Objects.equals(this.additionalProperties, jiraIntegrationMetadata.additionalProperties);
  }
