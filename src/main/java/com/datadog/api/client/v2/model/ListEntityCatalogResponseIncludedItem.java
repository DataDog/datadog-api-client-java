...
@JsonDeserialize(using = ListEntityCatalogResponseIncludedItem.ListEntityCatalogResponseIncludedItemDeserializer.class)
@JsonSerialize(using = ListEntityCatalogResponseIncludedItem.ListEntityCatalogResponseIncludedItemSerializer.class)
public class ListEntityCatalogResponseIncludedItem extends AbstractOpenApiSchema {
    ...
    public static class ListEntityCatalogResponseIncludedItemSerializer extends StdSerializer<ListEntityCatalogResponseIncludedItem> {
        public ListEntityCatalogResponseIncludedItemSerializer(Class<ListEntityCatalogResponseIncludedItem> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(ListEntityCatalogResponseIncludedItem value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class ListEntityCatalogResponseIncludedItemDeserializer extends StdDeserializer<ListEntityCatalogResponseIncludedItem> {
        ...
        @Override
        public ListEntityCatalogResponseIncludedItem deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (EntityResponseIncludedSchema.class.equals(Integer.class) || EntityResponseIncludedSchema.class.equals(Long.class) || EntityResponseIncludedSchema.class.equals(Float.class) || EntityResponseIncludedSchema.class.equals(Double.class) || EntityResponseIncludedSchema.class.equals(Boolean.class) || EntityResponseIncludedSchema.class.equals(String.class)) {
                    ...
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityResponseIncludedSchema.class.equals(Integer.class) || EntityResponseIncludedSchema.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityResponseIncludedSchema.class.equals(Float.class) || EntityResponseIncludedSchema.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityResponseIncludedSchema.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityResponseIncludedSchema.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                ...
                if (EntityResponseIncludedRawSchema.class.equals(Integer.class) || EntityResponseIncludedRawSchema.class.equals(Long.class) || EntityResponseIncludedRawSchema.class.equals(Float.class) || EntityResponseIncludedRawSchema.class.equals(Double.class) || EntityResponseIncludedRawSchema.class.equals(Boolean.class) || EntityResponseIncludedRawSchema.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityResponseIncludedRawSchema.class.equals(Integer.class) || EntityResponseIncludedRawSchema.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityResponseIncludedRawSchema.class.equals(Float.class) || EntityResponseIncludedRawSchema.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityResponseIncludedRawSchema.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityResponseIncludedRawSchema.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'EntityResponseIncludedRawSchema'", e);
            }
            ...
            try {
                ...
                if (EntityResponseIncludedRelatedEntity.class.equals(Integer.class) || EntityResponseIncludedRelatedEntity.class.equals(Long.class) || EntityResponseIncludedRelatedEntity.class.equals(Float.class) || EntityResponseIncludedRelatedEntity.class.equals(Double.class) || EntityResponseIncludedRelatedEntity.class.equals(Boolean.class) || EntityResponseIncludedRelatedEntity.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityResponseIncludedRelatedEntity.class.equals(Integer.class) || EntityResponseIncludedRelatedEntity.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityResponseIncludedRelatedEntity.class.equals(Float.class) || EntityResponseIncludedRelatedEntity.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityResponseIncludedRelatedEntity.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityResponseIncludedRelatedEntity.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'EntityResponseIncludedRelatedEntity'", e);
            }
            ...
            try {
                ...
                if (EntityResponseIncludedOncall.class.equals(Integer.class) || EntityResponseIncludedOncall.class.equals(Long.class) || EntityResponseIncludedOncall.class.equals(Float.class) || EntityResponseIncludedOncall.class.equals(Double.class) || EntityResponseIncludedOncall.class.equals(Boolean.class) || EntityResponseIncludedOncall.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityResponseIncludedOncall.class.equals(Integer.class) || EntityResponseIncludedOncall.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityResponseIncludedOncall.class.equals(Float.class) || EntityResponseIncludedOncall.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityResponseIncludedOncall.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityResponseIncludedOncall.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
            ...
            try {
                ...
                if (EntityResponseIncludedIncident.class.equals(Integer.class) || EntityResponseIncludedIncident.class.equals(Long.class) || EntityResponseIncludedIncident.class.equals(Float.class) || EntityResponseIncludedIncident.class.equals(Double.class) || EntityResponseIncludedIncident.class.equals(Boolean.class) || EntityResponseIncludedIncident.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((EntityResponseIncludedIncident.class.equals(Integer.class) || EntityResponseIncludedIncident.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((EntityResponseIncludedIncident.class.equals(Float.class) || EntityResponseIncludedIncident.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (EntityResponseIncludedIncident.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (EntityResponseIncludedIncident.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
                ...
                // deserialization failed, continue
                log.log(Level.FINER, "Input data does not match schema 'EntityResponseIncludedIncident'", e);
            }
         ...
         */
        @Override
        public ListEntityCatalogResponseIncludedItem getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "ListEntityCatalogResponseIncludedItem cannot be null");
        }
    }
    ...
    static {
        ...
        schemas.put("EntityResponseIncludedRawSchema", new GenericType<EntityResponseIncludedRawSchema>() {
        });
        schemas.put("EntityResponseIncludedRelatedEntity", new GenericType<EntityResponseIncludedRelatedEntity>() {
        });
        schemas.put("EntityResponseIncludedOncall", new GenericType<EntityResponseIncludedOncall>() {
        });
        schemas.put("EntityResponseIncludedIncident", new GenericType<EntityResponseIncludedIncident>() {
        });
     ...
     * EntityResponseIncludedSchema, EntityResponseIncludedRawSchema, EntityResponseIncludedRelatedEntity, EntityResponseIncludedOncall, EntityResponseIncludedIncident
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        if (JSON.isInstanceOf(EntityResponseIncludedRawSchema.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        if (JSON.isInstanceOf(EntityResponseIncludedRelatedEntity.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
        ...
        if (JSON.isInstanceOf(EntityResponseIncludedIncident.class, instance, new HashSet<Class<?>>())) {
            super.setActualInstance(instance);
            return;
        }
     ...
     * EntityResponseIncludedSchema, EntityResponseIncludedRawSchema, EntityResponseIncludedRelatedEntity, EntityResponseIncludedOncall, EntityResponseIncludedIncident
     *
     * @return The actual instance (EntityResponseIncludedSchema, EntityResponseIncludedRawSchema, EntityResponseIncludedRelatedEntity, EntityResponseIncludedOncall, EntityResponseIncludedIncident)
     */
    @Override
    ...
    /**
     * Get the actual instance of `EntityResponseIncludedSchema`. If the actual instance is not `EntityResponseIncludedSchema`,
    ...
    /**
     * Get the actual instance of `EntityResponseIncludedRawSchema`. If the actual instance is not `EntityResponseIncludedRawSchema`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `EntityResponseIncludedRelatedEntity`. If the actual instance is not `EntityResponseIncludedRelatedEntity`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `EntityResponseIncludedOncall`. If the actual instance is not `EntityResponseIncludedOncall`,
     * the ClassCastException will be thrown.
     *
    ...
    /**
     * Get the actual instance of `EntityResponseIncludedIncident`. If the actual instance is not `EntityResponseIncludedIncident`,
     * the ClassCastException will be thrown.
     *
