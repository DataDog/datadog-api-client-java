 ...
 */
  public CompletableFuture<BatchRowsQueryResponse>batchRowsQueryAsync(BatchRowsQueryRequest body) {
    return batchRowsQueryWithHttpInfoAsync(body).thenApply(response -> {
  ...
  /**
   * <p>Batch query reference table rows by their primary key values.  Returns only found rows in the included array.</p>
   *
   * @param body  (required)
   ...
   *     </table>
   */
  public ApiResponse<BatchRowsQueryResponse> batchRowsQueryWithHttpInfo(BatchRowsQueryRequest body) throws ApiException {
    Object localVarPostBody = body;

    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling batchRowsQuery");
    }
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ReferenceTablesApi.batchRowsQuery", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<BatchRowsQueryResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<BatchRowsQueryResponse>> batchRowsQueryWithHttpInfoAsync(BatchRowsQueryRequest body) {
    ...
    if (body == null) {
        ...
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'body' when calling batchRowsQuery"));
        return result;
    }
    // create path and map variables
    String localVarPath = "/api/v2/reference-tables/queries/batch-rows";
    ...
    try {
      builder = apiClient.createBuilder("v2.ReferenceTablesApi.batchRowsQuery", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<BatchRowsQueryResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<BatchRowsQueryResponse>() {});
  }
 ...
 */
  ...
  public static class ListReferenceTableRowsOptionalParameters {
    ...
    /**
     * Set pageLimit.
     * @param pageLimit Number of rows to return per page. Defaults to 100, maximum is 1000. (optional, default to 100)
     ...
     * @param pageContinuationToken Opaque cursor from the previous response's next link. Pass this to retrieve the next page on the same consistent snapshot. (optional)
     * @return ListReferenceTableRowsOptionalParameters
     */
    public ListReferenceTableRowsOptionalParameters pageContinuationToken(String pageContinuationToken) {
 ...
 * List rows.
 *
 * See {@link #listReferenceTableRowsWithHttpInfo}.
 *
 ...
 */
  public ListRowsResponse listReferenceTableRows (String id) throws ApiException {
    return listReferenceTableRowsWithHttpInfo( id, new ListReferenceTableRowsOptionalParameters()).getData();
  }

  /**
 * List rows.
 *
 * See {@link #listReferenceTableRowsWithHttpInfoAsync}.
 *
 * @param id Unique identifier of the reference table to list rows from. (required)
 * @return CompletableFuture&lt;ListRowsResponse&gt;
 */
  public CompletableFuture<ListRowsResponse>listReferenceTableRowsAsync(String id) {
    return listReferenceTableRowsWithHttpInfoAsync(id, new ListReferenceTableRowsOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 * @throws ApiException if fails to make API call
 */
  public ListRowsResponse listReferenceTableRows(String id, ListReferenceTableRowsOptionalParameters parameters) throws ApiException {
 ...
 * @return CompletableFuture&lt;ListRowsResponse&gt;
 */
  public CompletableFuture<ListRowsResponse>listReferenceTableRowsAsync( String id, ListReferenceTableRowsOptionalParameters parameters) {
    return listReferenceTableRowsWithHttpInfoAsync(id, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>List all rows in a reference table using cursor-based pagination. Pass the <code>page[continuation_token]</code> from the previous response to fetch the next page on the same consistent snapshot. Returns 400 for tables with more than 10,000,000 rows.</p>
   *
   * @param id Unique identifier of the reference table to list rows from. (required)
   * @param parameters Optional parameters for the request.
   ...
   *     </table>
   */
  public ApiResponse<ListRowsResponse> listReferenceTableRowsWithHttpInfo(String id, ListReferenceTableRowsOptionalParameters parameters) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling listReferenceTableRows");
    }
    Long pageLimit = parameters.pageLimit;
    String pageContinuationToken = parameters.pageContinuationToken;
    // create path and map variables
    String localVarPath = "/api/v2/reference-tables/tables/{id}/rows/list"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("", "page[continuation_token]", pageContinuationToken));

    Invocation.Builder builder = apiClient.createBuilder("v2.ReferenceTablesApi.listReferenceTableRows", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListRowsResponse>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<ListRowsResponse>> listReferenceTableRowsWithHttpInfoAsync(String id, ListReferenceTableRowsOptionalParameters parameters) {
    Object localVarPostBody = null;

    // verify the required parameter 'id' is set
    if (id == null) {
        CompletableFuture<ApiResponse<ListRowsResponse>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'id' when calling listReferenceTableRows"));
        return result;
    }
    Long pageLimit = parameters.pageLimit;
    String pageContinuationToken = parameters.pageContinuationToken;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.ReferenceTablesApi.listReferenceTableRows", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ListRowsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ListRowsResponse>() {});
  }
