...
/**
   * <p>Payload schema when adding a Fastly account.</p>
 */
@JsonPropertyOrder({
  FastlyAccountCreateRequest.JSON_PROPERTY_DATA
})
...
public class FastlyAccountCreateRequest {
  ...
  @JsonCreator
  public FastlyAccountCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)FastlyAccountCreateRequestData data) {
        this.data = data;
  ...
  **/
   ...
   * @return FastlyAccountCreateRequest
   */
  @JsonAnySetter
  public FastlyAccountCreateRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, fastlyAccountCreateRequest.data) && Objects.equals(this.additionalProperties, fastlyAccountCreateRequest.additionalProperties);
  }
