...
public class FastlyAPIKeyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("FastlyAPIKey"));
  ...
  public static class FastlyAPIKeyTypeSerializer extends StdSerializer<FastlyAPIKeyType> {
      ...
      @Override
      public void serialize(FastlyAPIKeyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
