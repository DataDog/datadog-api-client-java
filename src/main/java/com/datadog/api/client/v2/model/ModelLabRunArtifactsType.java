...
public class ModelLabRunArtifactsType extends ModelEnum<String> {
  ...
  public static final ModelLabRunArtifactsType ARTIFACTS = new ModelLabRunArtifactsType("artifacts");
  ...
  public static class ModelLabRunArtifactsTypeSerializer extends StdSerializer<ModelLabRunArtifactsType> {
      ...
      @Override
      public void serialize(ModelLabRunArtifactsType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
