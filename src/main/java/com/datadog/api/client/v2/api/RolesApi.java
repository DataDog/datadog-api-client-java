...
public class RolesApi {
   ...
   *
   * <p><strong>Note</strong>: When a role is created, the following permissions are automatically
   * added, unless specifically excluded: Dashboards Read, Notebooks Read, Monitors Read, APM Read,
   * Vulnerability Management Read, RUM Apps Read, Incidents Read, SLOs Read, CI Visibility Read,
   * and CD Visibility Read.
   *
   * @param body (required)
