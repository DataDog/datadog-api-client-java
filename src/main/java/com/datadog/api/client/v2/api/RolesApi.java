 ...
 *
 * See {@link #addPermissionToRoleWithHttpInfo}.
 *
 ...
 * Grant permission to a role.
 *
 * See {@link #addPermissionToRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 */
  public CompletableFuture<PermissionsResponse>addPermissionToRoleAsync(String roleId, RelationshipToPermission body) {
    return addPermissionToRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
  ...
  /**
   * <p>Adds a permission to a role.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @param body  (required)
  ...
  public ApiResponse<PermissionsResponse> addPermissionToRoleWithHttpInfo(String roleId, RelationshipToPermission body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.addPermissionToRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PermissionsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PermissionsResponse>> addPermissionToRoleWithHttpInfoAsync(String roleId, RelationshipToPermission body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.RolesApi.addPermissionToRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PermissionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PermissionsResponse>() {});
  }

  /**
 * Add a user to a role.
 *
 * See {@link #addUserToRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 * Add a user to a role.
 *
 * See {@link #addUserToRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 */
  public CompletableFuture<UsersResponse>addUserToRoleAsync(String roleId, RelationshipToUser body) {
    return addUserToRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<UsersResponse> addUserToRoleWithHttpInfo(String roleId, RelationshipToUser body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.addUserToRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<UsersResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<UsersResponse>> addUserToRoleWithHttpInfoAsync(String roleId, RelationshipToUser body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.addUserToRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<UsersResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<UsersResponse>() {});
  }

  /**
 * Create a new role by cloning an existing role.
 *
 * See {@link #cloneRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 * @return RoleResponse
 ...
 * Create a new role by cloning an existing role.
 *
 * See {@link #cloneRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 */
  public CompletableFuture<RoleResponse>cloneRoleAsync(String roleId, RoleCloneRequest body) {
    return cloneRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<RoleResponse> cloneRoleWithHttpInfo(String roleId, RoleCloneRequest body) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/api/v2/roles/{role_id}/clone"
      .replaceAll("\\{" + "role_id" + "\\}", apiClient.escapeString(roleId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.cloneRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RoleResponse>> cloneRoleWithHttpInfoAsync(String roleId, RoleCloneRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.cloneRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RoleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleResponse>() {});
  }

  /**
 * Create role.
 *
 * See {@link #createRoleWithHttpInfo}.
 *
 * @param body  (required)
 ...
 * Create role.
 *
 * See {@link #createRoleWithHttpInfoAsync}.
 *
 * @param body  (required)
 ...
 */
  public CompletableFuture<RoleCreateResponse>createRoleAsync(RoleCreateRequest body) {
    return createRoleWithHttpInfoAsync(body).thenApply(response -> {
        return response.getData();
    });
  }
   ...
   * <p>The following read permissions are automatically added to every new role, even if they are not included in the request:</p>
   * <ul>
   * <li>Dashboards Read</li>
   * <li>Notebooks Read</li>
   * <li>Monitors Read</li>
   * <li>APM Read</li>
   * <li>Vulnerability Management Read</li>
   * <li>RUM Apps Read</li>
   * <li>Incidents Read</li>
   * <li>SLOs Read</li>
   * <li>CI Visibility Read</li>
   * <li>CD Visibility Read</li>
   * </ul>
   *
   * @param body  (required)
  ...
  public ApiResponse<RoleCreateResponse> createRoleWithHttpInfo(RoleCreateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.createRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleCreateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RoleCreateResponse>> createRoleWithHttpInfoAsync(RoleCreateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.createRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RoleCreateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("POST", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleCreateResponse>() {});
  }

  /**
 * Delete role.
 *
 * See {@link #deleteRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @throws ApiException if fails to make API call
 */
 ...
 * Delete role.
 *
 * See {@link #deleteRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return CompletableFuture
 */
  public CompletableFuture<Void>deleteRoleAsync(String roleId) {
    return deleteRoleWithHttpInfoAsync(roleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<Void> deleteRoleWithHttpInfo(String roleId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.deleteRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<Void>> deleteRoleWithHttpInfoAsync(String roleId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.deleteRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"*/*" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<Void>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Get a role.
 *
 * See {@link #getRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return CompletableFuture&lt;RoleResponse&gt;
 */
  public CompletableFuture<RoleResponse>getRoleAsync(String roleId) {
    return getRoleWithHttpInfoAsync(roleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Get a role in the organization specified by the role’s <code>role_id</code>.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @return ApiResponse&lt;RoleResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<RoleResponse> getRoleWithHttpInfo(String roleId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.getRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RoleResponse>> getRoleWithHttpInfoAsync(String roleId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.getRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RoleResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleResponse>() {});
  }

  /**
 * List permissions.
 *
 * See {@link #listPermissionsWithHttpInfo}.
 *
 * @return PermissionsResponse
 * @throws ApiException if fails to make API call
 */
 ...
 * List permissions.
 *
 * See {@link #listPermissionsWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;PermissionsResponse&gt;
 */
  public CompletableFuture<PermissionsResponse>listPermissionsAsync() {
    return listPermissionsWithHttpInfoAsync().thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns a list of all permissions, including name, description, and ID.</p>
   *
   * @return ApiResponse&lt;PermissionsResponse&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
  ...
  public ApiResponse<PermissionsResponse> listPermissionsWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.listPermissions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<PermissionsResponse>> listPermissionsWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.listPermissions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PermissionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 *
 * See {@link #listRolePermissionsWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return PermissionsResponse
 * @throws ApiException if fails to make API call
 ...
 * List permissions for a role.
 *
 * See {@link #listRolePermissionsWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return CompletableFuture&lt;PermissionsResponse&gt;
 */
  public CompletableFuture<PermissionsResponse>listRolePermissionsAsync(String roleId) {
    return listRolePermissionsWithHttpInfoAsync(roleId).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns a list of all permissions for a single role.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @return ApiResponse&lt;PermissionsResponse&gt;
   * @throws ApiException if fails to make API call
  ...
  public ApiResponse<PermissionsResponse> listRolePermissionsWithHttpInfo(String roleId) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.listRolePermissions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PermissionsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PermissionsResponse>> listRolePermissionsWithHttpInfoAsync(String roleId) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.listRolePermissions", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PermissionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
  ...
  public static class ListRolesOptionalParameters {
    ...
    /**
     * Set sort.
     * @param sort Sort roles depending on the given field. Sort order is <strong>ascending</strong> by default. Sort order is <strong>descending</strong> if the field is prefixed by a negative sign, for example: <code>sort=-name</code>. (optional, default to "name")
     * @return ListRolesOptionalParameters
     */
 ...
 * List roles.
 *
 * See {@link #listRolesWithHttpInfo}.
 *
 ...
 * List roles.
 *
 * See {@link #listRolesWithHttpInfoAsync}.
 *
 * @return CompletableFuture&lt;RolesResponse&gt;
 */
  public CompletableFuture<RolesResponse>listRolesAsync() {
    return listRolesWithHttpInfoAsync(new ListRolesOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<RolesResponse>listRolesAsync(ListRolesOptionalParameters parameters) {
    return listRolesWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Returns all roles, including their names and their unique identifiers.</p>
   *
   * @param parameters Optional parameters for the request.
  ...
  public ApiResponse<RolesResponse> listRolesWithHttpInfo(ListRolesOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.listRoles", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RolesResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RolesResponse>> listRolesWithHttpInfoAsync(ListRolesOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.listRoles", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RolesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RolesResponse>() {});
  }

  /**
 * List role templates.
 *
 * See {@link #listRoleTemplatesWithHttpInfo}.
 *
 ...
 */
  ...
  public ApiResponse<RoleTemplateArray> listRoleTemplatesWithHttpInfo() throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.listRoleTemplates", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleTemplateArray>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RoleTemplateArray>> listRoleTemplatesWithHttpInfoAsync() {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.listRoleTemplates", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RoleTemplateArray>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleTemplateArray>() {});
  }
  ...
  public static class ListRoleUsersOptionalParameters {
    ...
    /**
     * Set sort.
     * @param sort User attribute to order results by. Sort order is <strong>ascending</strong> by default. Sort order is <strong>descending</strong> if the field is prefixed by a negative sign, for example <code>sort=-name</code>. Options: <code>name</code>, <code>email</code>, <code>status</code>. (optional, default to "name")
     * @return ListRoleUsersOptionalParameters
     */
 ...
 *
 * See {@link #listRoleUsersWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return UsersResponse
 * @throws ApiException if fails to make API call
 ...
 * Get all users of a role.
 *
 * See {@link #listRoleUsersWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @return CompletableFuture&lt;UsersResponse&gt;
 */
  public CompletableFuture<UsersResponse>listRoleUsersAsync(String roleId) {
    return listRoleUsersWithHttpInfoAsync(roleId, new ListRoleUsersOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  public CompletableFuture<UsersResponse>listRoleUsersAsync( String roleId, ListRoleUsersOptionalParameters parameters) {
    return listRoleUsersWithHttpInfoAsync(roleId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  public ApiResponse<UsersResponse> listRoleUsersWithHttpInfo(String roleId, ListRoleUsersOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.listRoleUsers", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
  ...
  public CompletableFuture<ApiResponse<UsersResponse>> listRoleUsersWithHttpInfoAsync(String roleId, ListRoleUsersOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.listRoleUsers", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<UsersResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
 ...
 * Revoke permission.
 *
 * See {@link #removePermissionFromRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 * @return PermissionsResponse
 ...
 * Revoke permission.
 *
 * See {@link #removePermissionFromRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 * @return CompletableFuture&lt;PermissionsResponse&gt;
 */
  public CompletableFuture<PermissionsResponse>removePermissionFromRoleAsync(String roleId, RelationshipToPermission body) {
    return removePermissionFromRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes a permission from a role.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @param body  (required)
   * @return ApiResponse&lt;PermissionsResponse&gt;
  ...
  public ApiResponse<PermissionsResponse> removePermissionFromRoleWithHttpInfo(String roleId, RelationshipToPermission body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.removePermissionFromRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PermissionsResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<PermissionsResponse>> removePermissionFromRoleWithHttpInfoAsync(String roleId, RelationshipToPermission body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.removePermissionFromRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<PermissionsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<PermissionsResponse>() {});
  }

  /**
 * Remove a user from a role.
 *
 * See {@link #removeUserFromRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 * @return UsersResponse
 ...
 * Remove a user from a role.
 *
 * See {@link #removeUserFromRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 * @return CompletableFuture&lt;UsersResponse&gt;
 */
  public CompletableFuture<UsersResponse>removeUserFromRoleAsync(String roleId, RelationshipToUser body) {
    return removeUserFromRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Removes a user from a role.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @param body  (required)
   * @return ApiResponse&lt;UsersResponse&gt;
  ...
  public ApiResponse<UsersResponse> removeUserFromRoleWithHttpInfo(String roleId, RelationshipToUser body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.removeUserFromRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<UsersResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<UsersResponse>> removeUserFromRoleWithHttpInfoAsync(String roleId, RelationshipToUser body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.removeUserFromRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<UsersResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("DELETE", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<UsersResponse>() {});
  }

  /**
 * Update a role.
 *
 * See {@link #updateRoleWithHttpInfo}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 * Update a role.
 *
 * See {@link #updateRoleWithHttpInfoAsync}.
 *
 * @param roleId The unique identifier of the role. (required)
 * @param body  (required)
 ...
 */
  public CompletableFuture<RoleUpdateResponse>updateRoleAsync(String roleId, RoleUpdateRequest body) {
    return updateRoleWithHttpInfoAsync(roleId, body).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Edit a role. Can only be used with application keys belonging to administrators.</p>
   *
   * @param roleId The unique identifier of the role. (required)
   * @param body  (required)
  ...
  public ApiResponse<RoleUpdateResponse> updateRoleWithHttpInfo(String roleId, RoleUpdateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.RolesApi.updateRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleUpdateResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<RoleUpdateResponse>> updateRoleWithHttpInfoAsync(String roleId, RoleUpdateRequest body) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.RolesApi.updateRole", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<RoleUpdateResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("PATCH", builder, localVarHeaderParams,  new String[] {"application/json" }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<RoleUpdateResponse>() {});
  }
}