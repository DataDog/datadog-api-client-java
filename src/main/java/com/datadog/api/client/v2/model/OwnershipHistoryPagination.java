...
/**
   * <p>Cursor-based pagination metadata for the history response.</p>
 */
@JsonPropertyOrder({
...
public class OwnershipHistoryPagination {
  ...
  /**
   * <p>Whether more history entries are available beyond this page.</p>
   * @return hasMore
  **/
  ...
  /**
   * <p>An opaque, base64-encoded cursor token. Pass it as the <code>cursor</code> query parameter to retrieve the next page. Absent or <code>null</code> when there are no further pages.</p>
   * @return nextCursor
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasMore, ownershipHistoryPagination.hasMore) && Objects.equals(this.nextCursor, ownershipHistoryPagination.nextCursor) && Objects.equals(this.additionalProperties, ownershipHistoryPagination.additionalProperties);
  }
