...
/**
   * <p>Exclude metric names matching one of these patterns for a single namespace.</p>
 */
@JsonPropertyOrder({
  AWSMetricNameFiltersExcludeOnly.JSON_PROPERTY_EXCLUDE_ONLY,
  AWSMetricNameFiltersExcludeOnly.JSON_PROPERTY_NAMESPACE
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class AWSMetricNameFiltersExcludeOnly {
  @JsonIgnore
  ...
  public AWSMetricNameFiltersExcludeOnly() {}
  ...
  /**
   * <p>Exclude metric names matching one of these patterns.</p>
   * @return excludeOnly
  **/
  ...
  **/
   ...
   * @return AWSMetricNameFiltersExcludeOnly
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    AWSMetricNameFiltersExcludeOnly awsMetricNameFiltersExcludeOnly = (AWSMetricNameFiltersExcludeOnly) o;
    return Objects.equals(this.excludeOnly, awsMetricNameFiltersExcludeOnly.excludeOnly) && Objects.equals(this.namespace, awsMetricNameFiltersExcludeOnly.namespace) && Objects.equals(this.additionalProperties, awsMetricNameFiltersExcludeOnly.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(excludeOnly,namespace, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AWSMetricNameFiltersExcludeOnly {\n");
