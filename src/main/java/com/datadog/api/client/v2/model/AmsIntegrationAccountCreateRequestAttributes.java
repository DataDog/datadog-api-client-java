...
public class AmsIntegrationAccountCreateRequestAttributes {
  ...
  public AmsIntegrationAccountCreateRequestAttributes secrets(Map<String, Object> secrets) {
    this.secrets = secrets;
    return this;
  }
  ...
  public AmsIntegrationAccountCreateRequestAttributes settings(Map<String, Object> settings) {
    this.settings = settings;
    return this;
  }
