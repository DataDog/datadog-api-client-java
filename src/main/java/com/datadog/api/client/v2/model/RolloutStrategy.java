...
public class RolloutStrategy extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("UNIFORM_INTERVALS", "NO_ROLLOUT"));
  ...
  public static class RolloutStrategySerializer extends StdSerializer<RolloutStrategy> {
      ...
      @Override
      public void serialize(RolloutStrategy value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
