...
public class ObservabilityPipelineClickhouseDestinationBatchEncoding {
  ...
  @JsonCreator
  public ObservabilityPipelineClickhouseDestinationBatchEncoding(
            @JsonProperty(required=true, value=JSON_PROPERTY_CODEC)ObservabilityPipelineClickhouseDestinationBatchEncodingCodec codec) {
        this.codec = codec;
        this.unparsed |= !codec.isValid();
  }
  public ObservabilityPipelineClickhouseDestinationBatchEncoding allowNullableFields(Boolean allowNullableFields) {
    this.allowNullableFields = allowNullableFields;
    return this;
  }

  /**
   * <p>When <code>true</code>, null values are allowed for non-nullable fields in the ClickHouse schema.
   * When <code>false</code> (default), missing values for non-nullable columns cause encoding errors.</p>
  ...
  **/
  ...
  public ObservabilityPipelineClickhouseDestinationBatchEncoding codec(ObservabilityPipelineClickhouseDestinationBatchEncodingCodec codec) {
    this.codec = codec;
    this.unparsed |= !codec.isValid();
    return this;
  }
  ...
  /**
   * <p>The codec used for batch encoding. Only <code>arrow_stream</code> is supported.</p>
   * @return codec
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineClickhouseDestinationBatchEncoding putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ObservabilityPipelineClickhouseDestinationBatchEncoding object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineClickhouseDestinationBatchEncoding observabilityPipelineClickhouseDestinationBatchEncoding = (ObservabilityPipelineClickhouseDestinationBatchEncoding) o;
    return Objects.equals(this.allowNullableFields, observabilityPipelineClickhouseDestinationBatchEncoding.allowNullableFields) && Objects.equals(this.codec, observabilityPipelineClickhouseDestinationBatchEncoding.codec) && Objects.equals(this.additionalProperties, observabilityPipelineClickhouseDestinationBatchEncoding.additionalProperties);
  }
