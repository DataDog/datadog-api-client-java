...
public class DatadogCredentials extends AbstractOpenApiSchema {
    ...
    public static class DatadogCredentialsSerializer extends StdSerializer<DatadogCredentials> {
        ...
        @Override
        public void serialize(DatadogCredentials value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class DatadogCredentialsDeserializer extends StdDeserializer<DatadogCredentials> {
        ...
        @Override
        public DatadogCredentials deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (DatadogAPIKey.class.equals(Integer.class) || DatadogAPIKey.class.equals(Long.class) || DatadogAPIKey.class.equals(Float.class) || DatadogAPIKey.class.equals(Double.class) || DatadogAPIKey.class.equals(Boolean.class) || DatadogAPIKey.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((DatadogAPIKey.class.equals(Integer.class) || DatadogAPIKey.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((DatadogAPIKey.class.equals(Float.class) || DatadogAPIKey.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (DatadogAPIKey.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (DatadogAPIKey.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public DatadogCredentials getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `DatadogAPIKey`. If the actual instance is not `DatadogAPIKey`,
