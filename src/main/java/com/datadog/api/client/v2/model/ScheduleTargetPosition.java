...
public class ScheduleTargetPosition extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("previous", "current", "next"));
  ...
  public static class ScheduleTargetPositionSerializer extends StdSerializer<ScheduleTargetPosition> {
      ...
      @Override
      public void serialize(ScheduleTargetPosition value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
