...
/**
   * <p>Relates a team to this schedule, identified by <code>id</code> and <code>type</code> (must be <code>teams</code>).</p>
 */
@JsonPropertyOrder({
...
public class DataRelationshipsTeamsDataItems {
  ...
  public DataRelationshipsTeamsDataItems(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)DataRelationshipsTeamsDataItemsType type) {
        this.id = id;
        this.type = type;
  ...
  /**
   * <p>The unique identifier of the team in this relationship.</p>
   * @return id
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DataRelationshipsTeamsDataItems dataRelationshipsTeamsDataItems = (DataRelationshipsTeamsDataItems) o;
    return Objects.equals(this.id, dataRelationshipsTeamsDataItems.id) && Objects.equals(this.type, dataRelationshipsTeamsDataItems.type) && Objects.equals(this.additionalProperties, dataRelationshipsTeamsDataItems.additionalProperties);
  }
