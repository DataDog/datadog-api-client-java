...
public class WebIntegrationAccountSchemaResponse {
  ...
  public WebIntegrationAccountSchemaResponse properties(Map<String, Object> properties) {
    this.properties = properties;
    return this;
  }

  public WebIntegrationAccountSchemaResponse putPropertiesItem(String key, Object propertiesItem) {
  ...
  /**
   * The schema properties definition containing <code>settings</code> and <code>secrets</code>
   * objects. Each property includes type information, validation rules, and descriptions.
   *
   * @return properties
   */
  @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(Schema, properties, required, type, additionalProperties);
  }
