...
public class CustomDestinationType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("custom_destination"));

  public static final CustomDestinationType CUSTOM_DESTINATION = new CustomDestinationType("custom_destination");
  ...
  public static class CustomDestinationTypeSerializer extends StdSerializer<CustomDestinationType> {
      ...
      @Override
      public void serialize(CustomDestinationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
