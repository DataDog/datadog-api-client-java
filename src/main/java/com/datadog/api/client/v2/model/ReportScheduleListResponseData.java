...
/**
   * <p>The JSON:API data object representing a report schedule in a list response.</p>
 */
@JsonPropertyOrder({
...
public class ReportScheduleListResponseData {
  ...
  @JsonCreator
  public ReportScheduleListResponseData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)ReportScheduleListResponseAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_ID)String id,
            @JsonProperty(required=true, value=JSON_PROPERTY_RELATIONSHIPS)ReportScheduleListResponseRelationships relationships,
  ...
  public ReportScheduleListResponseData attributes(ReportScheduleListResponseAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public ReportScheduleListResponseData relationships(ReportScheduleListResponseRelationships relationships) {
    this.relationships = relationships;
    this.unparsed |= relationships.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleListResponseData reportScheduleListResponseData = (ReportScheduleListResponseData) o;
    return Objects.equals(this.attributes, reportScheduleListResponseData.attributes) && Objects.equals(this.id, reportScheduleListResponseData.id) && Objects.equals(this.relationships, reportScheduleListResponseData.relationships) && Objects.equals(this.type, reportScheduleListResponseData.type) && Objects.equals(this.additionalProperties, reportScheduleListResponseData.additionalProperties);
  }
