...
public class ReportScheduleListResponseLinks {
  ...
  **/
  ...
  /**
   * <p>Link to the last page, or <code>null</code> if it is unavailable.</p>
   * @return last
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>Link to the next page, or <code>null</code> if it is unavailable.</p>
   * @return next
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>Link to the previous page, or <code>null</code> if it is unavailable.</p>
   * @return prev
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SELF)public void setSelf_JsonNullable(JsonNullable<String> self) {
    this.self = self;
  }
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleListResponseLinks reportScheduleListResponseLinks = (ReportScheduleListResponseLinks) o;
    return Objects.equals(this.first, reportScheduleListResponseLinks.first) && Objects.equals(this.last, reportScheduleListResponseLinks.last) && Objects.equals(this.next, reportScheduleListResponseLinks.next) && Objects.equals(this.prev, reportScheduleListResponseLinks.prev) && Objects.equals(this.self, reportScheduleListResponseLinks.self) && Objects.equals(this.additionalProperties, reportScheduleListResponseLinks.additionalProperties);
  }
