...
public class ElasticCloudPrimaryShardGracefulTimeoutIntegrationDataflowRequest {
  ...
  public ElasticCloudPrimaryShardGracefulTimeoutIntegrationDataflowRequest enabled(
      Boolean enabled) {
  ...
  /**
   * Return true if this ElasticCloudPrimaryShardGracefulTimeoutIntegrationDataflowRequest object is
   * equal to o.
   */
  @Override
