...
public class ClickupIntegrationType extends ModelEnum<String> {
  ...
  public static class ClickupIntegrationTypeSerializer extends StdSerializer<ClickupIntegrationType> {
      ...
      @Override
      public void serialize(ClickupIntegrationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
