...
/**
   * <p>Response containing a list of org group policy suggestions.</p>
 */
@JsonPropertyOrder({
  OrgGroupPolicySuggestionListResponse.JSON_PROPERTY_DATA
})
...
public class OrgGroupPolicySuggestionListResponse {
  ...
  @JsonCreator
  public OrgGroupPolicySuggestionListResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<OrgGroupPolicySuggestionData> data) {
        this.data = data;
  ...
  /**
   * <p>An array of org group policy suggestions.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrgGroupPolicySuggestionListResponse orgGroupPolicySuggestionListResponse = (OrgGroupPolicySuggestionListResponse) o;
    return Objects.equals(this.data, orgGroupPolicySuggestionListResponse.data) && Objects.equals(this.additionalProperties, orgGroupPolicySuggestionListResponse.additionalProperties);
  }
