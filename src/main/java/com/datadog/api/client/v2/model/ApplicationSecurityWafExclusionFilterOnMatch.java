 ...
 */
@JsonSerialize(using = ApplicationSecurityWafExclusionFilterOnMatch.ApplicationSecurityWafExclusionFilterOnMatchSerializer.class)
public class ApplicationSecurityWafExclusionFilterOnMatch extends ModelEnum<String> {
  ...
  public static class ApplicationSecurityWafExclusionFilterOnMatchSerializer extends StdSerializer<ApplicationSecurityWafExclusionFilterOnMatch> {
      public ApplicationSecurityWafExclusionFilterOnMatchSerializer(Class<ApplicationSecurityWafExclusionFilterOnMatch> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(ApplicationSecurityWafExclusionFilterOnMatch value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
