...
public class CircleCICredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class CircleCICredentialsUpdateSerializer extends StdSerializer<CircleCICredentialsUpdate> {
        ...
        @Override
        public void serialize(CircleCICredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class CircleCICredentialsUpdateDeserializer extends StdDeserializer<CircleCICredentialsUpdate> {
        ...
        @Override
        public CircleCICredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (CircleCIAPIKeyUpdate.class.equals(Integer.class) || CircleCIAPIKeyUpdate.class.equals(Long.class) || CircleCIAPIKeyUpdate.class.equals(Float.class) || CircleCIAPIKeyUpdate.class.equals(Double.class) || CircleCIAPIKeyUpdate.class.equals(Boolean.class) || CircleCIAPIKeyUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((CircleCIAPIKeyUpdate.class.equals(Integer.class) || CircleCIAPIKeyUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((CircleCIAPIKeyUpdate.class.equals(Float.class) || CircleCIAPIKeyUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (CircleCIAPIKeyUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (CircleCIAPIKeyUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public CircleCICredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `CircleCIAPIKeyUpdate`. If the actual instance is not `CircleCIAPIKeyUpdate`,
