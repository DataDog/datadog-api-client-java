...
public class LLMObsMetricScoreType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("score", "categorical", "boolean", "json"));
  ...
  public static class LLMObsMetricScoreTypeSerializer extends StdSerializer<LLMObsMetricScoreType> {
      ...
      @Override
      public void serialize(LLMObsMetricScoreType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
