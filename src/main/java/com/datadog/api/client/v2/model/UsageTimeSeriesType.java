...
public class UsageTimeSeriesType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("usage_timeseries"));

  public static final UsageTimeSeriesType USAGE_TIMESERIES = new UsageTimeSeriesType("usage_timeseries");
  ...
  public static class UsageTimeSeriesTypeSerializer extends StdSerializer<UsageTimeSeriesType> {
      ...
      @Override
      public void serialize(UsageTimeSeriesType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
