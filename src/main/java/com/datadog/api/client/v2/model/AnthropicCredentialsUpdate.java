...
public class AnthropicCredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class AnthropicCredentialsUpdateSerializer extends StdSerializer<AnthropicCredentialsUpdate> {
        ...
        @Override
        public void serialize(AnthropicCredentialsUpdate value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class AnthropicCredentialsUpdateDeserializer extends StdDeserializer<AnthropicCredentialsUpdate> {
        ...
        @Override
        public AnthropicCredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AnthropicAPIKeyUpdate.class.equals(Integer.class) || AnthropicAPIKeyUpdate.class.equals(Long.class) || AnthropicAPIKeyUpdate.class.equals(Float.class) || AnthropicAPIKeyUpdate.class.equals(Double.class) || AnthropicAPIKeyUpdate.class.equals(Boolean.class) || AnthropicAPIKeyUpdate.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AnthropicAPIKeyUpdate.class.equals(Integer.class) || AnthropicAPIKeyUpdate.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AnthropicAPIKeyUpdate.class.equals(Float.class) || AnthropicAPIKeyUpdate.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AnthropicAPIKeyUpdate.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AnthropicAPIKeyUpdate.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public AnthropicCredentialsUpdate getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    static {
        ...
        JSON.registerDescendants(AnthropicCredentialsUpdate.class, Collections.unmodifiableMap(schemas));
    }
    ...
    /**
     * Get the actual instance of `AnthropicAPIKeyUpdate`. If the actual instance is not `AnthropicAPIKeyUpdate`,
