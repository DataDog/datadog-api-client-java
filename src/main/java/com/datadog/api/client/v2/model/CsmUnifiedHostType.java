...
public class CsmUnifiedHostType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("unified_host"));
  ...
  public static class CsmUnifiedHostTypeSerializer extends StdSerializer<CsmUnifiedHostType> {
      ...
      @Override
      public void serialize(CsmUnifiedHostType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
