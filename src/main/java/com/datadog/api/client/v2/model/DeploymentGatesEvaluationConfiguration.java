...
/**
   * <p>Inline rule definitions for a deployment gate evaluation. When provided, rules are evaluated
   * directly from this configuration instead of using the preconfigured gate rules.
   * At least one rule is required.</p>
 */
@JsonPropertyOrder({
...
public class DeploymentGatesEvaluationConfiguration {
  ...
  @JsonCreator
  public DeploymentGatesEvaluationConfiguration(
            @JsonProperty(required=true, value=JSON_PROPERTY_RULES)List<DeploymentGatesEvaluationRule> rules) {
        this.rules = rules;
  ...
  /**
   * <p>Gate-level dry run. When enabled, the rules are evaluated normally but the gate always returns <code>pass</code>. The real result is visible in the Datadog UI.</p>
   * @return dryRun
  **/
  ...
  public DeploymentGatesEvaluationConfiguration addRulesItem(DeploymentGatesEvaluationRule rulesItem) {
  ...
  /**
   * <p>The list of rules to evaluate. At least one rule is required.</p>
   * @return rules
  **/
  ...
  public boolean equals(Object o) {
    ...
    DeploymentGatesEvaluationConfiguration deploymentGatesEvaluationConfiguration = (DeploymentGatesEvaluationConfiguration) o;
    return Objects.equals(this.dryRun, deploymentGatesEvaluationConfiguration.dryRun) && Objects.equals(this.rules, deploymentGatesEvaluationConfiguration.rules) && Objects.equals(this.additionalProperties, deploymentGatesEvaluationConfiguration.additionalProperties);
  }
