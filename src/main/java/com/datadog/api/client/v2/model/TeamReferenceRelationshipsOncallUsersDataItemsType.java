...
public class TeamReferenceRelationshipsOncallUsersDataItemsType extends ModelEnum<String> {
  ...
  public static class TeamReferenceRelationshipsOncallUsersDataItemsTypeSerializer
      extends StdSerializer<TeamReferenceRelationshipsOncallUsersDataItemsType> {
    public TeamReferenceRelationshipsOncallUsersDataItemsTypeSerializer(
        Class<TeamReferenceRelationshipsOncallUsersDataItemsType> t) {
      super(t);
    }
