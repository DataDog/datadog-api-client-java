...
/**
   * <p>Configuration for a GCP metric namespace.</p>
 */
@JsonPropertyOrder({
...
public class GCPMetricNamespaceConfig {
  ...
  /**
   * <p>When disabled, Datadog does not collect metrics that are related to this GCP metric namespace.</p>
   * @return disabled
  **/
  ...
  /**
   * <p>When enabled, Datadog applies these additional filters to limit metric collection. A metric is collected only if it does not match all exclusion filters and matches at least one allow filter.</p>
   * @return filters
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The id of the GCP metric namespace.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.disabled, gcpMetricNamespaceConfig.disabled) && Objects.equals(this.filters, gcpMetricNamespaceConfig.filters) && Objects.equals(this.id, gcpMetricNamespaceConfig.id) && Objects.equals(this.additionalProperties, gcpMetricNamespaceConfig.additionalProperties);
  }
