...
/**
   * <p>Analytics aggregation parameters.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsExperimentationAnalyticsAggregate {
  ...
  @JsonCreator
  public LLMObsExperimentationAnalyticsAggregate(
            @JsonProperty(required=true, value=JSON_PROPERTY_COMPUTE)List<LLMObsExperimentationAnalyticsCompute> compute,
            @JsonProperty(required=true, value=JSON_PROPERTY_INDEXES)List<String> indexes,
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH)LLMObsExperimentationAnalyticsSearch search) {
  ...
  /**
   * <p>List of metric computations to perform.</p>
   * @return compute
  **/
  ...
  /**
   * <p>Filter to a specific dataset version.</p>
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DATASET_VERSION)public void setDatasetVersion_JsonNullable(JsonNullable<Long> datasetVersion) {
  ...
  /**
   * <p>Fields to group results by.</p>
   * @return groupBy
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Data indexes to query. At least one is required.</p>
   * @return indexes
  **/
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LIMIT)public void setLimit_JsonNullable(JsonNullable<Integer> limit) {
    this.limit = limit;
  }
  ...
  /**
   * <p>Search query for filtering analytics data.</p>
   * @return search
  **/
  ...
  /**
   * <p>Unix-millisecond time range for filtering analytics data.</p>
   * @return time
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    LLMObsExperimentationAnalyticsAggregate llmObsExperimentationAnalyticsAggregate = (LLMObsExperimentationAnalyticsAggregate) o;
    return Objects.equals(this.compute, llmObsExperimentationAnalyticsAggregate.compute) && Objects.equals(this.datasetVersion, llmObsExperimentationAnalyticsAggregate.datasetVersion) && Objects.equals(this.groupBy, llmObsExperimentationAnalyticsAggregate.groupBy) && Objects.equals(this.indexes, llmObsExperimentationAnalyticsAggregate.indexes) && Objects.equals(this.limit, llmObsExperimentationAnalyticsAggregate.limit) && Objects.equals(this.search, llmObsExperimentationAnalyticsAggregate.search) && Objects.equals(this.time, llmObsExperimentationAnalyticsAggregate.time) && Objects.equals(this.additionalProperties, llmObsExperimentationAnalyticsAggregate.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(compute,datasetVersion,groupBy,indexes,limit,search,time, additionalProperties);
  }
