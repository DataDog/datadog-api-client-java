...
/**
   * <p>A single annotation to create or update. The annotation is matched by
   * <code>interaction_id</code> and the requesting user's identity.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsUpsertAnnotationItem {
  ...
  public LLMObsUpsertAnnotationItem(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_LABEL_VALUES)List<LLMObsAnnotationLabelValue> labelValues) {
  ...
  /**
   * <p>ID of the interaction to annotate.</p>
  ...
  **/
   ...
   * and provides the corresponding value validated against the schema type constraints.</p>
   * @return labelValues
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interactionId, llmObsUpsertAnnotationItem.interactionId) && Objects.equals(this.labelValues, llmObsUpsertAnnotationItem.labelValues) && Objects.equals(this.additionalProperties, llmObsUpsertAnnotationItem.additionalProperties);
  }
