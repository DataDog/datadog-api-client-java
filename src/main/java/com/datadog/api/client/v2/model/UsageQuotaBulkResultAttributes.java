...
public class UsageQuotaBulkResultAttributes {
  ...
  /**
   * <p>Whether usage above the limit is actively blocked instead of only tracked or alerted on. Omitted if this item failed to write.</p>
   * @return enforced
  **/
  ...
  /**
   * <p>An error message describing why this item failed to write. Omitted if this item was written successfully.</p>
   * @return error
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The public ID of the organization that owns the quota. Omitted if this item failed to write.</p>
   * @return orgPublicId
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The quota limit in the usage units defined by the quota namespace. May be fractional for quotas configured before public writes required whole units. Omitted if this item failed to write.</p>
   * @return usageLimit
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    UsageQuotaBulkResultAttributes usageQuotaBulkResultAttributes = (UsageQuotaBulkResultAttributes) o;
    return Objects.equals(this.enforced, usageQuotaBulkResultAttributes.enforced) && Objects.equals(this.error, usageQuotaBulkResultAttributes.error) && Objects.equals(this.orgPublicId, usageQuotaBulkResultAttributes.orgPublicId) && Objects.equals(this.scope, usageQuotaBulkResultAttributes.scope) && Objects.equals(this.usageLimit, usageQuotaBulkResultAttributes.usageLimit) && Objects.equals(this.additionalProperties, usageQuotaBulkResultAttributes.additionalProperties);
  }
