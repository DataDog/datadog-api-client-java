...
/**
   * <p>Attributes of a shared dashboard response.</p>
 */
@JsonPropertyOrder({
...
public class SharedDashboardResponseAttributes {
  ...
  private List<SharedDashboardSelectableTemplateVariable> selectableTemplateVars = new ArrayList<>();
  ...
  public SharedDashboardResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_EMBEDDABLE_DOMAINS)List<String> embeddableDomains,
            @JsonProperty(required=true, value=JSON_PROPERTY_EXPIRATION)OffsetDateTime expiration,
            @JsonProperty(required=true, value=JSON_PROPERTY_GLOBAL_TIME)Map<String, Object> globalTime,
            @JsonProperty(required=true, value=JSON_PROPERTY_GLOBAL_TIME_SELECTABLE)Boolean globalTimeSelectable,
            @JsonProperty(required=true, value=JSON_PROPERTY_INVITEES)List<SharedDashboardInvitee> invitees,
            @JsonProperty(required=true, value=JSON_PROPERTY_LAST_ACCESSED)OffsetDateTime lastAccessed,
            @JsonProperty(required=true, value=JSON_PROPERTY_SELECTABLE_TEMPLATE_VARS)List<SharedDashboardSelectableTemplateVariable> selectableTemplateVars,
            @JsonProperty(required=true, value=JSON_PROPERTY_SHARE_TYPE)SharedDashboardShareType shareType,
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_VIEWING_PREFERENCES)SharedDashboardViewingPreferences viewingPreferences) {
  ...
  /**
   * <p>Time when the shared dashboard was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Domains where embed-type shared dashboards can be embedded.</p>
  ...
  **/
  ...
  /**
   * <p>Time when the shared dashboard expires.</p>
   * @return expiration
  **/
  ...
  /**
   * <p>Default time range configuration for the shared dashboard.</p>
   * @return globalTime
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether viewers can select a different global time setting.</p>
  ...
  **/
  ...
  /**
   * <p>Invitees for invite-only shared dashboards.</p>
   * @return invitees
  **/
  ...
  /**
   * <p>Time when the shared dashboard was last accessed.</p>
   * @return lastAccessed
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Template variables that viewers can modify.</p>
  ...
  **/
  ...
  /**
   * <p>Whether the user who shared the dashboard is disabled.</p>
  ...
  **/
  ...
  /**
   * <p>Status of the shared dashboard.</p>
   * @return status
  **/
  ...
  /**
   * <p>Display title for the shared dashboard.</p>
   * @return title
  **/
  ...
  /**
   * <p>Token assigned to the shared dashboard.</p>
   * @return token
  **/
  ...
  /**
   * <p>URL for the shared dashboard.</p>
   * @return url
  **/
