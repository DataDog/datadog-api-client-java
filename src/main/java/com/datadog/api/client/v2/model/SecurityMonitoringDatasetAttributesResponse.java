...
/**
   * <p>The attributes of a Cloud SIEM dataset.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringDatasetAttributesResponse {
  ...
  public SecurityMonitoringDatasetAttributesResponse(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_DEFINITION)SecurityMonitoringDatasetDefinition definition,
  ...
  /**
   * <p>The creation timestamp of the dataset, in ISO 8601 format.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The Datadog handle of the user who created the dataset.</p>
  ...
  **/
  ...
  /**
   * <p>The display name of the user who created the dataset.</p>
  ...
  **/
  ...
  public SecurityMonitoringDatasetAttributesResponse definition(SecurityMonitoringDatasetDefinition definition) {
    this.definition = definition;
    this.unparsed |= definition.unparsed;
    return this;
  }
  ...
  **/
  ...
  /**
   * <p>Whether the dataset is an out-of-the-box dataset provided by Datadog.</p>
   * @return isDefault
  **/
  ...
  /**
   * <p>Whether the dataset is marked as deprecated.</p>
   * @return isDeprecated
  **/
  ...
  /**
   * <p>The timestamp of the last modification of the dataset, in ISO 8601 format.</p>
   * @return modifiedAt
  **/
  ...
  **/
  ...
  /**
   * <p>The Datadog handle of the user who last updated the dataset.</p>
  ...
  **/
  ...
  /**
   * <p>The display name of the user who last updated the dataset.</p>
  ...
  **/
  ...
  /**
   * <p>The current version of the dataset.</p>
   * @return version
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringDatasetAttributesResponse putAdditionalProperty(String key, Object value) {
