 ...
 */
  ...
  public ApiResponse<CIAppTestsAnalyticsAggregateResponse> aggregateCIAppTestEventsWithHttpInfo(CIAppTestsAggregateRequest body) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.aggregateCIAppTestEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<CIAppTestsAnalyticsAggregateResponse>> aggregateCIAppTestEventsWithHttpInfoAsync(CIAppTestsAggregateRequest body) {
    ...
    try {
      builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.aggregateCIAppTestEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listCIAppTestEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  /**
   * <p>List endpoint returns CI Visibility test events that match a log search query.
  ...
  public ApiResponse<CIAppTestEventsResponse> listCIAppTestEventsWithHttpInfo(ListCIAppTestEventsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.listCIAppTestEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<CIAppTestEventsResponse>> listCIAppTestEventsWithHttpInfoAsync(ListCIAppTestEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.listCIAppTestEvents", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchCIAppTestEvents", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  public ApiResponse<CIAppTestEventsResponse> searchCIAppTestEventsWithHttpInfo(SearchCIAppTestEventsOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.searchCIAppTestEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
  ...
  public CompletableFuture<ApiResponse<CIAppTestEventsResponse>> searchCIAppTestEventsWithHttpInfoAsync(SearchCIAppTestEventsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.CiVisibilityTestsApi.searchCIAppTestEvents", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<CIAppTestEventsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
