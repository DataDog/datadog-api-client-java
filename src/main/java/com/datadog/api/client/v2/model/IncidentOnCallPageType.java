...
public class IncidentOnCallPageType extends ModelEnum<String> {
  ...
  public static class IncidentOnCallPageTypeSerializer extends StdSerializer<IncidentOnCallPageType> {
      ...
      @Override
      public void serialize(IncidentOnCallPageType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
