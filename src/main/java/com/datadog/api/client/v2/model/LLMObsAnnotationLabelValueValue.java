...
@JsonDeserialize(
    using = LLMObsAnnotationLabelValueValue.LLMObsAnnotationLabelValueValueDeserializer.class)
@JsonSerialize(
    using = LLMObsAnnotationLabelValueValue.LLMObsAnnotationLabelValueValueSerializer.class)
public class LLMObsAnnotationLabelValueValue extends AbstractOpenApiSchema {
  private static final Logger log =
      Logger.getLogger(LLMObsAnnotationLabelValueValue.class.getName());

  @JsonIgnore public boolean unparsed = false;

  public static class LLMObsAnnotationLabelValueValueSerializer
      extends StdSerializer<LLMObsAnnotationLabelValueValue> {
    ...
    public void serialize(
        LLMObsAnnotationLabelValueValue value, JsonGenerator jgen, SerializerProvider provider)
        throws IOException, JsonProcessingException {
      jgen.writeObject(value.getActualInstance());
    }
  }

  public static class LLMObsAnnotationLabelValueValueDeserializer
      extends StdDeserializer<LLMObsAnnotationLabelValueValue> {
    ...
    @Override
    public LLMObsAnnotationLabelValueValue deserialize(JsonParser jp, DeserializationContext ctxt)
        throws IOException, JsonProcessingException {
    ...
    @Override
    public LLMObsAnnotationLabelValueValue getNullValue(DeserializationContext ctxt)
        throws JsonMappingException {
      throw new JsonMappingException(
          ctxt.getParser(), "LLMObsAnnotationLabelValueValue cannot be null");
    }
  }
  ...
  static {
    ...
    JSON.registerDescendants(
        LLMObsAnnotationLabelValueValue.class, Collections.unmodifiableMap(schemas));
  }
   ...
   * against the oneOf child schemas: Double, String, List&lt;String&gt;, Boolean
   *
  ...
  public void setActualInstance(Object instance) {
    ...
    throw new RuntimeException(
        "Invalid instance type. Must be Double, String, List<String>, Boolean");
  }

  /**
   * Get the actual instance, which can be the following: Double, String, List&lt;String&gt;,
   * Boolean
   *
