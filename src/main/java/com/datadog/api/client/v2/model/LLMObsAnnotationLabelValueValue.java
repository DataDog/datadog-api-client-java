...
@JsonDeserialize(using = LLMObsAnnotationLabelValueValue.LLMObsAnnotationLabelValueValueDeserializer.class)
@JsonSerialize(using = LLMObsAnnotationLabelValueValue.LLMObsAnnotationLabelValueValueSerializer.class)
public class LLMObsAnnotationLabelValueValue extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(LLMObsAnnotationLabelValueValue.class.getName());

    @JsonIgnore
    public boolean unparsed = false;

    public static class LLMObsAnnotationLabelValueValueSerializer extends StdSerializer<LLMObsAnnotationLabelValueValue> {
        public LLMObsAnnotationLabelValueValueSerializer(Class<LLMObsAnnotationLabelValueValue> t) {
            super(t);
        }

        public LLMObsAnnotationLabelValueValueSerializer() {
            this(null);
        }

        @Override
        public void serialize(LLMObsAnnotationLabelValueValue value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class LLMObsAnnotationLabelValueValueDeserializer extends StdDeserializer<LLMObsAnnotationLabelValueValue> {
        public LLMObsAnnotationLabelValueValueDeserializer() {
            this(LLMObsAnnotationLabelValueValue.class);
        }

        public LLMObsAnnotationLabelValueValueDeserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public LLMObsAnnotationLabelValueValue deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            LLMObsAnnotationLabelValueValue ret = new LLMObsAnnotationLabelValueValue();
            if (match == 1) {
         ...
         */
        @Override
        public LLMObsAnnotationLabelValueValue getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "LLMObsAnnotationLabelValueValue cannot be null");
        }
    }
    ...
    public LLMObsAnnotationLabelValueValue() {
        super("oneOf", Boolean.FALSE);
    }
    public LLMObsAnnotationLabelValueValue(Double o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public LLMObsAnnotationLabelValueValue(String o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public LLMObsAnnotationLabelValueValue(List<String> o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    public LLMObsAnnotationLabelValueValue(Boolean o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(LLMObsAnnotationLabelValueValue.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return LLMObsAnnotationLabelValueValue.schemas;
    }

    /**
     * Set the instance that matches the oneOf child schema, check
     * the instance parameter is valid against the oneOf child schemas:
     * Double, String, List&lt;String&gt;, Boolean
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be Double, String, List<String>, Boolean");
    }
     ...
     * Double, String, List&lt;String&gt;, Boolean
     *
     * @return The actual instance (Double, String, List&lt;String&gt;, Boolean)
     */
    @Override
