...
public class ScaRequestDataAttributesCommit {
  ...
  **/
  ...
  /**
   * <p>The email address of the commit author.</p>
   * @return authorEmail
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The full name of the commit author.</p>
   * @return authorName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The branch name on which the commit was made.</p>
   * @return branch
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The email address of the person who committed the change.</p>
  ...
  **/
  ...
  /**
   * <p>The full name of the person who committed the change.</p>
  ...
  **/
  ...
  /**
   * <p>The SHA hash uniquely identifying the commit.</p>
   * @return sha
  **/
      @jakarta.annotation.Nullable
