...
public class ScaRequestDataAttributesCommit {
  ...
  /**
   * The <code>commit</code> <code>author_date</code>.
   *
   * @return authorDate
   */
  ...
  /**
   * The <code>commit</code> <code>author_email</code>.
   *
   * @return authorEmail
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>commit</code> <code>author_name</code>.
   *
   * @return authorName
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>commit</code> <code>branch</code>.
   *
   * @return branch
   */
  @jakarta.annotation.Nullable
  ...
  /**
   * The <code>commit</code> <code>committer_email</code>.
   *
  ...
  /**
   * The <code>commit</code> <code>committer_name</code>.
   *
  ...
  /**
   * The <code>commit</code> <code>sha</code>.
   *
   * @return sha
   */
  @jakarta.annotation.Nullable
