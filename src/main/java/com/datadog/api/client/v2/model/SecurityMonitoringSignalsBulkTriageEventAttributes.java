...
/**
   * <p>Triage attributes of a security signal returned in a bulk update response.</p>
 */
@JsonPropertyOrder({
...
public class SecurityMonitoringSignalsBulkTriageEventAttributes {
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes archiveCommentTimestamp(Long archiveCommentTimestamp) {
    this.archiveCommentTimestamp = archiveCommentTimestamp;
    return this;
  }

  /**
   * <p>Timestamp of the last edit to the archive comment.</p>
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes archiveCommentUser(SecurityMonitoringTriageUser archiveCommentUser) {
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes archiveReason(SecurityMonitoringSignalArchiveReason archiveReason) {
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes assignee(SecurityMonitoringTriageUser assignee) {
    this.assignee = assignee;
    this.unparsed |= assignee.unparsed;
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes addIncidentIdsItem(Long incidentIdsItem) {
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes state(SecurityMonitoringSignalState state) {
    this.state = state;
    this.unparsed |= !state.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes stateUpdateTimestamp(Long stateUpdateTimestamp) {
    this.stateUpdateTimestamp = stateUpdateTimestamp;
    return this;
  }

  /**
   * <p>Timestamp of the last state update.</p>
  ...
  **/
  ...
  public SecurityMonitoringSignalsBulkTriageEventAttributes stateUpdateUser(SecurityMonitoringTriageUser stateUpdateUser) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringSignalsBulkTriageEventAttributes putAdditionalProperty(String key, Object value) {
