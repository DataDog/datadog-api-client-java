...
@JsonPropertyOrder({AWSEventBridgeListResponse.JSON_PROPERTY_DATA})
...
public class AWSEventBridgeListResponse {
  ...
  public AWSEventBridgeListResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          AWSEventBridgeListResponseData data) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, awsEventBridgeListResponse.data)
        && Objects.equals(
