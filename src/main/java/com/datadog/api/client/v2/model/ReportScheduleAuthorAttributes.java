...
/**
   * <p>Attributes of the report author.</p>
 */
@JsonPropertyOrder({
...
public class ReportScheduleAuthorAttributes {
  ...
  /**
   * <p>The email address of the report author, or <code>null</code> if unavailable.</p>
   * @return email
  **/
  ...
  /**
   * <p>The display name of the report author, or <code>null</code> if unavailable.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    ReportScheduleAuthorAttributes reportScheduleAuthorAttributes = (ReportScheduleAuthorAttributes) o;
    return Objects.equals(this.email, reportScheduleAuthorAttributes.email) && Objects.equals(this.name, reportScheduleAuthorAttributes.name) && Objects.equals(this.additionalProperties, reportScheduleAuthorAttributes.additionalProperties);
  }
