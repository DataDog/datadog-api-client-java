...
/**
   * <p>Request body for the aggregated waterfall endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedWaterfallRequest.JSON_PROPERTY_DATA
})
...
public class AggregatedWaterfallRequest {
  ...
  @JsonCreator
  public AggregatedWaterfallRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedWaterfallRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, aggregatedWaterfallRequest.data) && Objects.equals(this.additionalProperties, aggregatedWaterfallRequest.additionalProperties);
  }
