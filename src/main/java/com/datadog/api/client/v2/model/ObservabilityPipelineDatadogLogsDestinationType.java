 ...
 */
@JsonSerialize(using = ObservabilityPipelineDatadogLogsDestinationType.ObservabilityPipelineDatadogLogsDestinationTypeSerializer.class)
public class ObservabilityPipelineDatadogLogsDestinationType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("datadog_logs"));
  ...
  public static class ObservabilityPipelineDatadogLogsDestinationTypeSerializer extends StdSerializer<ObservabilityPipelineDatadogLogsDestinationType> {
      public ObservabilityPipelineDatadogLogsDestinationTypeSerializer(Class<ObservabilityPipelineDatadogLogsDestinationType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(ObservabilityPipelineDatadogLogsDestinationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
