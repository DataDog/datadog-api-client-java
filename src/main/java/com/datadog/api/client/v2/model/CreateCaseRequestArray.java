...
/**
   * <p>List of requests to create cases for security findings.</p>
 */
@JsonPropertyOrder({
  CreateCaseRequestArray.JSON_PROPERTY_DATA
})
...
public class CreateCaseRequestArray {
  ...
  private List<CreateCaseRequestData> data = new ArrayList<>();
  ...
  /**
   * <p>Array of case creation request data objects.</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<CreateCaseRequestData> getData() {
        return data;
      }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, createCaseRequestArray.data) && Objects.equals(this.additionalProperties, createCaseRequestArray.additionalProperties);
  }
