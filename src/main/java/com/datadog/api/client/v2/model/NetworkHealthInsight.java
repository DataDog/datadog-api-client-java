...
/**
   * <p>A single network health insight describing a service-to-service connectivity issue.</p>
 */
@JsonPropertyOrder({
...
public class NetworkHealthInsight {
  ...
  @JsonCreator
  public NetworkHealthInsight(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)NetworkHealthInsightAttributes attributes,
  ...
  **/
  ...
  /**
   * <p>Unique identifier for this network health insight.</p>
   * @return id
  **/
  ...
  /**
   * <p>The resource type for network health insights. Always <code>network-health-insights</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, networkHealthInsight.attributes) && Objects.equals(this.id, networkHealthInsight.id) && Objects.equals(this.type, networkHealthInsight.type) && Objects.equals(this.additionalProperties, networkHealthInsight.additionalProperties);
  }
