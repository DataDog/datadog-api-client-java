 ...
 */
@JsonPropertyOrder({
  DORADeploymentRequestData.JSON_PROPERTY_ATTRIBUTES
})
...
public class DORADeploymentRequestData {
  ...
  @JsonCreator
  public DORADeploymentRequestData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)DORADeploymentRequestAttributes attributes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, doraDeploymentRequestData.attributes) && Objects.equals(this.additionalProperties, doraDeploymentRequestData.additionalProperties);
  }
