...
public class SecurityMonitoringNotificationRuleType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("notification_profiles"));

  public static final SecurityMonitoringNotificationRuleType NOTIFICATION_PROFILES =
      new SecurityMonitoringNotificationRuleType("notification_profiles");
