...
/**
   * <p>The type of facet for filtering Model Lab runs.</p>
 */
...
public class ModelLabFacetType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("parameter", "attribute", "tag", "metric"));
  ...
  public static class ModelLabFacetTypeSerializer extends StdSerializer<ModelLabFacetType> {
      ...
      @Override
      public void serialize(ModelLabFacetType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
