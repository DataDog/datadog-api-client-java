...
/**
   * <p>A mapping of a severity level to the number of days until a finding is due.</p>
 */
@JsonPropertyOrder({
...
public class DueDatePerSeverityItem {
  ...
  /**
   * <p>The number of days from the reference point until the finding is due.</p>
   * minimum: 1
   * maximum: 365
   * @return dueInDays
  **/
  ...
  /**
   * <p>A severity level used to configure due date thresholds.</p>
   * @return severity
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dueInDays, dueDatePerSeverityItem.dueInDays) && Objects.equals(this.severity, dueDatePerSeverityItem.severity) && Objects.equals(this.additionalProperties, dueDatePerSeverityItem.additionalProperties);
  }
