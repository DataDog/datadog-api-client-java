 ...
 */
@JsonPropertyOrder({
  WebhooksAuthMethodRelationships.JSON_PROPERTY_OAUTH2_CLIENT_CREDENTIALS
})
...
public class WebhooksAuthMethodRelationships {
  ...
  public WebhooksAuthMethodRelationships oauth2ClientCredentials(WebhooksOAuth2ClientCredentialsRelationship oauth2ClientCredentials) {
  ...
  /**
   * <p>Relationship pointing to the OAuth2 client credentials resource for this auth method.</p>
  ...
  **/
  ...
  public void setOauth2ClientCredentials(WebhooksOAuth2ClientCredentialsRelationship oauth2ClientCredentials) {
    this.oauth2ClientCredentials = oauth2ClientCredentials;
  ...
  public boolean equals(Object o) {
    ...
    WebhooksAuthMethodRelationships webhooksAuthMethodRelationships = (WebhooksAuthMethodRelationships) o;
    return Objects.equals(this.oauth2ClientCredentials, webhooksAuthMethodRelationships.oauth2ClientCredentials) && Objects.equals(this.additionalProperties, webhooksAuthMethodRelationships.additionalProperties);
  }
