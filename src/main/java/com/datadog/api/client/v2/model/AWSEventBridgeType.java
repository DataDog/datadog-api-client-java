...
public class AWSEventBridgeType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("event_bridge"));
  ...
  public static class AWSEventBridgeTypeSerializer extends StdSerializer<AWSEventBridgeType> {
      ...
      @Override
      public void serialize(AWSEventBridgeType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
