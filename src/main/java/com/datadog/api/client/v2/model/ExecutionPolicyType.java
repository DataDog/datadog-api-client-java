...
public class ExecutionPolicyType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("execution_policy"));

  public static final ExecutionPolicyType EXECUTION_POLICY = new ExecutionPolicyType("execution_policy");
  ...
  public static class ExecutionPolicyTypeSerializer extends StdSerializer<ExecutionPolicyType> {
      ...
      @Override
      public void serialize(ExecutionPolicyType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
