...
public class SloReportCreateRequestAttributes {
  ...
  /**
   * <p>The <code>from</code> timestamp for the report in epoch seconds.</p>
   * @return fromTs
  **/
  ...
  /**
   * <p>The frequency at which report data is to be generated.</p>
   * @return interval
  **/
  ...
  /**
   * <p>The query string used to filter SLO results. Some examples of queries include <code>service:&lt;service-name&gt;</code> and <code>slo-name</code>.</p>
   * @return query
  **/
  ...
  /**
   * <p>The timezone used to determine the start and end of each interval. For example, weekly intervals start at 12am on Sunday in the specified timezone.</p>
   * @return timezone
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The <code>to</code> timestamp for the report in epoch seconds.</p>
   * @return toTs
  **/
