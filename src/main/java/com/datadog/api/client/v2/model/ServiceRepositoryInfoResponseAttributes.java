...
public class ServiceRepositoryInfoResponseAttributes {
  ...
  @JsonCreator
  public ServiceRepositoryInfoResponseAttributes(
            @JsonProperty(required=true, value=JSON_PROPERTY_STATUS)ServiceRepositoryInfoStatus status) {
        this.status = status;
  ...
  /**
   * <p>The SHA of the commit associated with the service version.</p>
   * @return commitSha
  **/
  ...
  /**
   * <p>The URL of the source code repository.</p>
