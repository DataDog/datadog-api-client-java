...
public class AWSEventBridgeCreateRequestAttributes {
  ...
  public AWSEventBridgeCreateRequestAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_EVENT_GENERATOR_NAME)String eventGeneratorName,
  ...
  **/
  ...
  /**
   * <p>Set to true if Datadog should create the event bus in addition to the event
  ...
  **/
  ...
  /**
   * <p>The event source's
   * <a href="https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints">AWS region</a>.</p>
   * @return region
  **/
  ...
  public boolean equals(Object o) {
    ...
    AWSEventBridgeCreateRequestAttributes awsEventBridgeCreateRequestAttributes = (AWSEventBridgeCreateRequestAttributes) o;
    return Objects.equals(this.accountId, awsEventBridgeCreateRequestAttributes.accountId) && Objects.equals(this.createEventBus, awsEventBridgeCreateRequestAttributes.createEventBus) && Objects.equals(this.eventGeneratorName, awsEventBridgeCreateRequestAttributes.eventGeneratorName) && Objects.equals(this.region, awsEventBridgeCreateRequestAttributes.region) && Objects.equals(this.additionalProperties, awsEventBridgeCreateRequestAttributes.additionalProperties);
  }
