...
/**
   * <p>Request object to create a branch for a change request.</p>
 */
@JsonPropertyOrder({
  ChangeRequestBranchCreateRequest.JSON_PROPERTY_DATA
})
...
public class ChangeRequestBranchCreateRequest {
  ...
  @JsonCreator
  public ChangeRequestBranchCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)ChangeRequestBranchCreateData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ChangeRequestBranchCreateRequest changeRequestBranchCreateRequest = (ChangeRequestBranchCreateRequest) o;
    return Objects.equals(this.data, changeRequestBranchCreateRequest.data) && Objects.equals(this.additionalProperties, changeRequestBranchCreateRequest.additionalProperties);
  }
