...
@JsonPropertyOrder({
  ...
  ProductAnalyticsJourneyAudienceFilters.JSON_PROPERTY_FORMULA,
...
public class ProductAnalyticsJourneyAudienceFilters {
  ...
  private List<ProductAnalyticsJourneyAudienceSegmentQuery> segments = null;
   ...
   * @return ProductAnalyticsJourneyAudienceFilters
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class ProductAnalyticsJourneyAudienceFilters {\n");
