...
/**
   * <p>Attributes of a DDSQL tabular query response. <code>query_id</code> is set when
   * <code>state</code> is <code>running</code>; <code>columns</code> is set when <code>state</code> is <code>completed</code>.</p>
 */
@JsonPropertyOrder({
...
public class DdsqlTabularQueryResponseAttributes {
  ...
  /**
   * <p>Column-major result set. Each element carries one column's name, type, and values,
   * with one value per row of the result. Set when <code>state</code> is <code>completed</code>.</p>
   * @return columns
  **/
  ...
  /**
   * <p>Opaque token to pass to the fetch endpoint to poll for results.
   * Set when <code>state</code> is <code>running</code> and absent when <code>state</code> is <code>completed</code>.</p>
   * @return queryId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Lifecycle state of a DDSQL tabular query response.
   * <code>running</code> means the query is still executing and the client should poll
   * the fetch endpoint with the returned <code>query_id</code>. <code>completed</code> means the
   * result set is inlined in <code>columns</code> and no further polling is required.</p>
   * @return state
  **/
  ...
  /**
   * <p>Non-fatal messages emitted by the query engine while serving this response.</p>
   * @return warnings
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    DdsqlTabularQueryResponseAttributes ddsqlTabularQueryResponseAttributes = (DdsqlTabularQueryResponseAttributes) o;
    return Objects.equals(this.columns, ddsqlTabularQueryResponseAttributes.columns) && Objects.equals(this.queryId, ddsqlTabularQueryResponseAttributes.queryId) && Objects.equals(this.state, ddsqlTabularQueryResponseAttributes.state) && Objects.equals(this.warnings, ddsqlTabularQueryResponseAttributes.warnings) && Objects.equals(this.additionalProperties, ddsqlTabularQueryResponseAttributes.additionalProperties);
  }
