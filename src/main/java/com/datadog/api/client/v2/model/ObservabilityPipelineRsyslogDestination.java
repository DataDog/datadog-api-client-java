...
/**
   * <p>The <code>rsyslog</code> destination forwards logs to an external <code>rsyslog</code> server over TCP or UDP using the syslog protocol.</p>
...
public class ObservabilityPipelineRsyslogDestination {
  ...
  private ObservabilityPipelineRsyslogDestinationType type = ObservabilityPipelineRsyslogDestinationType.RSYSLOG;
  ...
  public ObservabilityPipelineRsyslogDestination(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)ObservabilityPipelineRsyslogDestinationType type) {
        this.id = id;
        this.inputs = inputs;
        this.type = type;
  ...
  **/
  ...
  /**
   * <p>Name of the environment variable or secret that holds the syslog server endpoint URL.</p>
  ...
  **/
  ...
  public ObservabilityPipelineRsyslogDestination type(ObservabilityPipelineRsyslogDestinationType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  }
  ...
  /**
   * <p>The destination type. The value should always be <code>rsyslog</code>.</p>
   * @return type
  **/
