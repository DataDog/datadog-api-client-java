...
public class IssueAttributes {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorMessage,errorType,filePath,firstSeen,firstSeenVersion,functionName,isCrash,languages,lastSeen,lastSeenVersion,platform,service,state, additionalProperties);
  }
