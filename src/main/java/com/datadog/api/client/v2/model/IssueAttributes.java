...
/**
   * <p>Object containing the information of an issue.</p>
 */
@JsonPropertyOrder({
...
public class IssueAttributes {
  ...
  /**
   * <p>Error message associated with the issue.</p>
   * @return errorMessage
  **/
  ...
  /**
   * <p>Type of the error that matches the issue.</p>
   * @return errorType
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Path of the file where the issue occurred.</p>
   * @return filePath
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp of the first seen error in milliseconds since the Unix epoch.</p>
   * @return firstSeen
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The application version (for example, git commit hash) where the issue was first observed.</p>
  ...
  **/
  ...
  /**
   * <p>Name of the function where the issue occurred.</p>
   * @return functionName
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Array of programming languages associated with the issue.</p>
   * @return languages
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp of the last seen error in milliseconds since the Unix epoch.</p>
   * @return lastSeen
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The application version (for example, git commit hash) where the issue was last observed.</p>
  ...
  **/
  ...
  /**
   * <p>Platform associated with the issue.</p>
   * @return platform
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Regression information for an issue that was previously resolved and then reopened.</p>
   * @return regression
  **/
      @jakarta.annotation.Nullable
