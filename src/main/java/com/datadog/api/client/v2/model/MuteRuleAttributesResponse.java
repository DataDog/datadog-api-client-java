...
@JsonPropertyOrder({
  ...
  MuteRuleAttributesResponse.JSON_PROPERTY_CREATED_BY,
  MuteRuleAttributesResponse.JSON_PROPERTY_ENABLED,
  MuteRuleAttributesResponse.JSON_PROPERTY_MODIFIED_AT,
  MuteRuleAttributesResponse.JSON_PROPERTY_MODIFIED_BY,
...
public class MuteRuleAttributesResponse {
   ...
   * @return MuteRuleAttributesResponse
   */
  @JsonAnySetter
  ...
  public String toString() {
    ...
    sb.append("class MuteRuleAttributesResponse {\n");
