...
public class ScheduleOnCallRespondersDataRelationshipsScheduleData {
  ...
  private ScheduleOnCallRespondersDataRelationshipsScheduleDataType type =
  ...
  public ScheduleOnCallRespondersDataRelationshipsScheduleData(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          ScheduleOnCallRespondersDataRelationshipsScheduleDataType type) {
    this.id = id;
    this.type = type;
  ...
  public ScheduleOnCallRespondersDataRelationshipsScheduleData type(
      ScheduleOnCallRespondersDataRelationshipsScheduleDataType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
   ...
   */
  @JsonAnySetter
  public ScheduleOnCallRespondersDataRelationshipsScheduleData putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    ScheduleOnCallRespondersDataRelationshipsScheduleData
        scheduleOnCallRespondersDataRelationshipsScheduleData =
            (ScheduleOnCallRespondersDataRelationshipsScheduleData) o;
    return Objects.equals(this.id, scheduleOnCallRespondersDataRelationshipsScheduleData.id)
        && Objects.equals(this.type, scheduleOnCallRespondersDataRelationshipsScheduleData.type)
        && Objects.equals(
            this.additionalProperties,
            scheduleOnCallRespondersDataRelationshipsScheduleData.additionalProperties);
  }
