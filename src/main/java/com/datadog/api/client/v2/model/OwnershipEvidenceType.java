...
public class OwnershipEvidenceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("ownership_evidence"));

  public static final OwnershipEvidenceType OWNERSHIP_EVIDENCE = new OwnershipEvidenceType("ownership_evidence");
  ...
  public static class OwnershipEvidenceTypeSerializer extends StdSerializer<OwnershipEvidenceType> {
      ...
      @Override
      public void serialize(OwnershipEvidenceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
