...
public class DatastoreDataAttributes {
  ...
  private DatastoreDataAttributesPrimaryKeyGenerationStrategy primaryKeyGenerationStrategy;
  ...
  /**
   * The <code>attributes</code> <code>creator_user_id</code>.
   *
  ...
  /**
   * The <code>attributes</code> <code>creator_user_uuid</code>.
   *
  ...
  public DatastoreDataAttributes primaryKeyGenerationStrategy(
      DatastoreDataAttributesPrimaryKeyGenerationStrategy primaryKeyGenerationStrategy) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public DatastoreDataAttributesPrimaryKeyGenerationStrategy getPrimaryKeyGenerationStrategy() {
    return primaryKeyGenerationStrategy;
  }
