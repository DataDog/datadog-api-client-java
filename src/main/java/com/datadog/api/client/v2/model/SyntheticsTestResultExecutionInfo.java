...
public class SyntheticsTestResultExecutionInfo {
  ...
  /**
   * <p>Total duration of a Synthetic test execution.</p>
   * @return duration
  **/
  ...
  /**
   * <p>Error message if the execution encountered an issue.</p>
   * @return errorMessage
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Timing breakdown of the test execution in milliseconds.</p>
   * @return timings
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Whether the location was unhealthy during execution.</p>
   * @return unhealthy
  **/
      @jakarta.annotation.Nullable
