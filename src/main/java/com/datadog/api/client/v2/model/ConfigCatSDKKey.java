...
public class ConfigCatSDKKey {
  ...
  /**
   * <p>The <code>ConfigCatSDKKey</code> <code>api_password</code>.</p>
   * @return apiPassword
  **/
  ...
  /**
   * <p>The <code>ConfigCatSDKKey</code> <code>api_username</code>.</p>
   * @return apiUsername
  **/
  ...
  /**
   * <p>The <code>ConfigCatSDKKey</code> <code>sdk_key</code>.</p>
   * @return sdkKey
  **/
