...
/**
   * <p>Request to partially update an Agent Observability experiment.</p>
 */
@JsonPropertyOrder({
  LLMObsExperimentUpdateRequest.JSON_PROPERTY_DATA
})
...
public class LLMObsExperimentUpdateRequest {
  ...
  @JsonCreator
  public LLMObsExperimentUpdateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)LLMObsExperimentUpdateDataRequest data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, llmObsExperimentUpdateRequest.data) && Objects.equals(this.additionalProperties, llmObsExperimentUpdateRequest.additionalProperties);
  }
