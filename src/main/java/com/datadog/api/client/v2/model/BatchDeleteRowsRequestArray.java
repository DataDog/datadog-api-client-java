...
/**
   * <p>The request body for deleting multiple rows from a reference table.</p>
 */
@JsonPropertyOrder({
  BatchDeleteRowsRequestArray.JSON_PROPERTY_DATA
})
...
public class BatchDeleteRowsRequestArray {
  ...
  @JsonCreator
  public BatchDeleteRowsRequestArray(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)List<TableRowResourceIdentifier> data) {
        this.data = data;
  }
  ...
  /**
   * <p>List of row resources to delete from the reference table.</p>
   * @return data
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, batchDeleteRowsRequestArray.data) && Objects.equals(this.additionalProperties, batchDeleteRowsRequestArray.additionalProperties);
  }
