...
public class TagPoliciesResponse {
  ...
  private List<TagPolicyDataResponse> data = new ArrayList<>();

  public TagPoliciesResponse() {}

  @JsonCreator
  public TagPoliciesResponse(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA) List<TagPolicyDataResponse> data) {
    this.data = data;
  }

  public TagPoliciesResponse data(List<TagPolicyDataResponse> data) {
    this.data = data;
  ...
  public List<TagPolicyDataResponse> getData() {
    return data;
  }

  public void setData(List<TagPolicyDataResponse> data) {
    this.data = data;
  }
