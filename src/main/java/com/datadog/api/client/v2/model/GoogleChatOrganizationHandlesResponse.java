...
/**
 * Response with a list of organization handles. Organization handle is a handle for monitor
 * notifications to a Google Chat space within a Google organization.
 */
