...
public class CustomCostsFileMetadataWithContent {
  ...
  **/
  ...
  /**
   * <p>Detail of the line items from the Custom Costs file.</p>
   * @return content
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Name of the Custom Costs file.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Providers contained in the Custom Costs file.</p>
  ...
  **/
  ...
  /**
   * <p>Status of the Custom Costs file.</p>
   * @return status
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Timestamp in millisecond of the upload time of the Custom Costs file.</p>
   * @return uploadedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Metadata of the user that has uploaded the Custom Costs file.</p>
   * @return uploadedBy
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    CustomCostsFileMetadataWithContent customCostsFileMetadataWithContent = (CustomCostsFileMetadataWithContent) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billedCost,billingCurrency,chargePeriod,content,name,providerNames,status,uploadedAt,uploadedBy, additionalProperties);
  }
