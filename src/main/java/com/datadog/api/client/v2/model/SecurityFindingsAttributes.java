...
public class SecurityFindingsAttributes {
  ...
  /**
   * The Unix timestamp at which the detection changed for the resource. Same value
   * as @detection_changed_at.
   *
   * @return timestamp
   */
  @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, securityFindingsAttributes.attributes)
        && Objects.equals(this.tags, securityFindingsAttributes.tags)
        && Objects.equals(this.timestamp, securityFindingsAttributes.timestamp)
        && Objects.equals(
            this.additionalProperties, securityFindingsAttributes.additionalProperties);
  }
