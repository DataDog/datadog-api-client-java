 ...
 */
@JsonPropertyOrder({
  SharedDashboardRelationshipDashboard.JSON_PROPERTY_DATA
})
...
public class SharedDashboardRelationshipDashboard {
  ...
  @JsonCreator
  public SharedDashboardRelationshipDashboard(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)SharedDashboardRelationshipDashboardData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SharedDashboardRelationshipDashboard sharedDashboardRelationshipDashboard = (SharedDashboardRelationshipDashboard) o;
    return Objects.equals(this.data, sharedDashboardRelationshipDashboard.data) && Objects.equals(this.additionalProperties, sharedDashboardRelationshipDashboard.additionalProperties);
  }
