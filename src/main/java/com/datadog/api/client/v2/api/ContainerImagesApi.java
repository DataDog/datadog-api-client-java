 ...
 *
 * See {@link #listContainerImagesWithHttpInfo}.
 *
 ...
 * Get all Container Images.
 *
 * See {@link #listContainerImagesWithHttpInfoAsync}.
 *
 ...
 */
  public CompletableFuture<ContainerImagesResponse>listContainerImagesAsync() {
    return listContainerImagesWithHttpInfoAsync(new ListContainerImagesOptionalParameters()).thenApply(response -> {
 ...
 */
  public CompletableFuture<ContainerImagesResponse>listContainerImagesAsync(ListContainerImagesOptionalParameters parameters) {
    return listContainerImagesWithHttpInfoAsync(parameters).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listContainerImages", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, true, true, limit, args, 0);
  ...
  /**
   * <p>Get all Container Images for your organization.
  ...
  public ApiResponse<ContainerImagesResponse> listContainerImagesWithHttpInfo(ListContainerImagesOptionalParameters parameters) throws ApiException {
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.ContainerImagesApi.listContainerImages", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ContainerImagesResponse>() {});
  }
  ...
  public CompletableFuture<ApiResponse<ContainerImagesResponse>> listContainerImagesWithHttpInfoAsync(ListContainerImagesOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("v2.ContainerImagesApi.listContainerImages", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ContainerImagesResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ContainerImagesResponse>() {});
  }
}