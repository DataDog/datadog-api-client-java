...
/**
   * <p>The RUM SDK configuration data object.</p>
 */
@JsonPropertyOrder({
...
public class RumSdkConfigData {
  ...
  @JsonCreator
  public RumSdkConfigData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)RumSdkConfigAttributes attributes,
  ...
  /**
   * <p>Attributes of the RUM SDK configuration.</p>
   * @return attributes
  **/
  ...
  /**
   * <p>The unique identifier of the RUM SDK configuration.</p>
   * @return id
  **/
  ...
  /**
   * <p>Metadata associated with a RUM SDK configuration.</p>
   * @return meta
  **/
  ...
  /**
   * <p>The type of the resource. The value should always be <code>rum_sdk_config</code>.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, rumSdkConfigData.attributes) && Objects.equals(this.id, rumSdkConfigData.id) && Objects.equals(this.meta, rumSdkConfigData.meta) && Objects.equals(this.type, rumSdkConfigData.type) && Objects.equals(this.additionalProperties, rumSdkConfigData.additionalProperties);
  }
