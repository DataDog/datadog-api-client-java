...
/**
   * <p>The CrowdStrike credentials to validate against the external entity source.</p>
 */
@JsonPropertyOrder({
  SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes.JSON_PROPERTY_DOMAIN,
  SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes.JSON_PROPERTY_INTEGRATION_TYPE,
...
public class SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes {
  ...
  public SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes integrationType(SecurityMonitoringIntegrationTypeCrowdStrike integrationType) {
    this.integrationType = integrationType;
    this.unparsed |= !integrationType.isValid();
    return this;
  }
  ...
  **/
  ...
  public SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes secrets(SecurityMonitoringIntegrationConfigCrowdStrikeSecrets secrets) {
    this.secrets = secrets;
    this.unparsed |= secrets.unparsed;
    return this;
  }
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SecurityMonitoringCrowdStrikeIntegrationCredentialsValidateAttributes object is equal to o.
   */
  @Override
