...
/**
   * <p>Result of the ServiceNow ticket creation or attachment.</p>
 */
@JsonPropertyOrder({
...
public class FindingServiceNowTicketResult {
  ...
  /**
   * <p>ServiceNow instance name extracted from the ticket URL.</p>
   * @return instanceName
  **/
  ...
  /**
   * <p>Unique identifier of the ServiceNow incident record.</p>
   * @return sysId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Direct link to the ServiceNow incident record.</p>
  ...
  **/
  ...
  /**
   * <p>Unique identifier of the target ServiceNow record.</p>
  ...
  **/
  ...
  /**
   * <p>ServiceNow table containing the incident record.</p>
   * @return tableName
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>URL of the ServiceNow incident record.</p>
   * @return url
  **/
      @jakarta.annotation.Nullable
