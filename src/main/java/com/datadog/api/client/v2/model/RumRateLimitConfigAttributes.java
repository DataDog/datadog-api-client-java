...
public class RumRateLimitConfigAttributes {
  ...
  **/
  ...
  /**
   * <p>The ID of the organization the rate limit configuration belongs to.</p>
   * @return orgId
  **/
  ...
  /**
   * <p>The date the rate limit configuration was last updated.</p>
   * @return updatedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The handle of the user who last updated the rate limit configuration.</p>
   * @return updatedBy
  **/
      @jakarta.annotation.Nullable
