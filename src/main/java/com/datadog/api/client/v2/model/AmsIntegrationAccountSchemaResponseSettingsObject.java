...
public class AmsIntegrationAccountSchemaResponseSettingsObject {
  ...
  private Map<String, AmsIntegrationAccountSchemaResponseSettingsField> properties = null;
  ...
  public AmsIntegrationAccountSchemaResponseSettingsObject properties(
      Map<String, AmsIntegrationAccountSchemaResponseSettingsField> properties) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Map<String, AmsIntegrationAccountSchemaResponseSettingsField> getProperties() {
    return properties;
  }
  ...
  public AmsIntegrationAccountSchemaResponseSettingsObject required(List<String> required) {
