...
/**
 * Response for listing experiment events (v2/v3). Returns spans and summary metrics in a single
 * resource.
 */
@JsonPropertyOrder({
...
public class LLMObsExperimentEventsV2Response {
  ...
  public LLMObsExperimentEventsV2Response(
      @JsonProperty(required = true, value = JSON_PROPERTY_DATA)
          LLMObsExperimentEventsV2DataResponse data) {
    this.data = data;
  ...
  public boolean equals(Object o) {
    ...
    LLMObsExperimentEventsV2Response llmObsExperimentEventsV2Response =
        (LLMObsExperimentEventsV2Response) o;
    return Objects.equals(this.data, llmObsExperimentEventsV2Response.data)
        && Objects.equals(this.meta, llmObsExperimentEventsV2Response.meta)
        && Objects.equals(
            this.additionalProperties, llmObsExperimentEventsV2Response.additionalProperties);
  }
