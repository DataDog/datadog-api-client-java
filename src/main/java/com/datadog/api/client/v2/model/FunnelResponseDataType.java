...
public class FunnelResponseDataType extends ModelEnum<String> {
  ...
  public static class FunnelResponseDataTypeSerializer
      extends StdSerializer<FunnelResponseDataType> {
    public FunnelResponseDataTypeSerializer(Class<FunnelResponseDataType> t) {
      super(t);
    }
