...
public class StatusPagesUserAttributes {
  ...
  /**
   * <p>The email of the Datadog user.</p>
   * @return email
  **/
  ...
  /**
   * <p>The handle of the Datadog user.</p>
   * @return handle
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The icon of the Datadog user.</p>
   * @return icon
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name of the Datadog user.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The UUID of the Datadog user.</p>
   * @return uuid
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, statusPagesUserAttributes.email) && Objects.equals(this.handle, statusPagesUserAttributes.handle) && Objects.equals(this.icon, statusPagesUserAttributes.icon) && Objects.equals(this.name, statusPagesUserAttributes.name) && Objects.equals(this.uuid, statusPagesUserAttributes.uuid) && Objects.equals(this.additionalProperties, statusPagesUserAttributes.additionalProperties);
  }
