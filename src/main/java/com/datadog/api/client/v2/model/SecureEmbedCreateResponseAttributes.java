...
public class SecureEmbedCreateResponseAttributes {
  ...
  **/
  ...
  /**
   * <p>The secret credential used for HMAC signing. Returned only on creation. Store securely — it cannot be retrieved again.</p>
   * @return credential
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public SecureEmbedCreateResponseAttributes selectableTemplateVars(List<SecureEmbedSelectableTemplateVariable> selectableTemplateVars) {
  ...
  public SecureEmbedCreateResponseAttributes addSelectableTemplateVarsItem(SecureEmbedSelectableTemplateVariable selectableTemplateVarsItem) {
  ...
  **/
  ...
  public SecureEmbedCreateResponseAttributes viewingPreferences(SecureEmbedViewingPreferences viewingPreferences) {
