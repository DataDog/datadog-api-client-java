...
/**
   * <p>Response containing the list of deleted Synthetic tests.</p>
 */
@JsonPropertyOrder({
  DeletedTestsResponse.JSON_PROPERTY_DATA
})
...
public class DeletedTestsResponse {
  ...
  private List<DeletedTestResponseData> data = null;
  ...
  /**
   * <p>List of deleted Synthetic test data objects.</p>
   * @return data
  **/
      ...
      public List<DeletedTestResponseData> getData() {
        return data;
      }
  public void setData(List<DeletedTestResponseData> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, deletedTestsResponse.data) && Objects.equals(this.additionalProperties, deletedTestsResponse.additionalProperties);
  }
