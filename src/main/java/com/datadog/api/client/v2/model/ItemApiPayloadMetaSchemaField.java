...
/**
   * <p>Information about a specific column in the datastore schema.</p>
 */
@JsonPropertyOrder({
...
public class ItemApiPayloadMetaSchemaField {
  ...
  /**
   * <p>The name of this column in the datastore.</p>
   * @return name
  **/
  ...
  /**
   * <p>The data type of this column. For example, 'string', 'number', or 'boolean'.</p>
   * @return type
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, itemApiPayloadMetaSchemaField.name) && Objects.equals(this.type, itemApiPayloadMetaSchemaField.type) && Objects.equals(this.additionalProperties, itemApiPayloadMetaSchemaField.additionalProperties);
  }
