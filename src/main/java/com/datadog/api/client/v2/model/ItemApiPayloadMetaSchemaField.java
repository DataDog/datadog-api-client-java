...
/** The definition of <code>ItemApiPayloadMetaSchemaField</code> object. */
@JsonPropertyOrder({
...
public class ItemApiPayloadMetaSchemaField {
  ...
  /**
   * The <code>ItemApiPayloadMetaSchemaField</code> <code>name</code>.
   *
   * @return name
   */
  ...
  /**
   * The <code>ItemApiPayloadMetaSchemaField</code> <code>type</code>.
   *
   * @return type
   */
