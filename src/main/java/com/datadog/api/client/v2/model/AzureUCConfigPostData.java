...
public class AzureUCConfigPostData {
  ...
  private AzureUCConfigPostRequestType type = AzureUCConfigPostRequestType.AZURE_UC_CONFIG_POST_REQUEST;

  public AzureUCConfigPostData() {}

  @JsonCreator
  public AzureUCConfigPostData(
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)AzureUCConfigPostRequestType type) {
        this.type = type;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, azureUcConfigPostData.attributes) && Objects.equals(this.type, azureUcConfigPostData.type) && Objects.equals(this.additionalProperties, azureUcConfigPostData.additionalProperties);
  }
