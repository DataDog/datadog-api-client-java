 ...
 */
@JsonPropertyOrder({
  ProductAnalyticsGraphQueryCompute.JSON_PROPERTY_AGGREGATION,
  ProductAnalyticsGraphQueryCompute.JSON_PROPERTY_INTERVAL,
  ProductAnalyticsGraphQueryCompute.JSON_PROPERTY_METRIC,
  ProductAnalyticsGraphQueryCompute.JSON_PROPERTY_TARGET
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ProductAnalyticsGraphQueryCompute {
  @JsonIgnore
  ...
  **/
  ...
  /**
   * <p>Time bucket interval in milliseconds, used by timeseries queries.</p>
   * @return interval
  **/
  ...
  /**
   * <p>Metric to aggregate on. Use a facet path such as <code>@view.time_spent</code>, or one of the
   * journey metrics <code>__dd.conversion</code>, <code>__dd.conversion_rate</code>, <code>__dd.time_to_convert</code>,
   * or <code>__dd.dropoff_rate</code>. Defaults to <code>__dd.conversion</code>.</p>
   * @return metric
  **/
      @jakarta.annotation.Nullable
  ...
  **/
   ...
   * @return ProductAnalyticsGraphQueryCompute
   */
  @JsonAnySetter
  ...
  public boolean equals(Object o) {
    ...
    ProductAnalyticsGraphQueryCompute productAnalyticsGraphQueryCompute = (ProductAnalyticsGraphQueryCompute) o;
    return Objects.equals(this.aggregation, productAnalyticsGraphQueryCompute.aggregation) && Objects.equals(this.interval, productAnalyticsGraphQueryCompute.interval) && Objects.equals(this.metric, productAnalyticsGraphQueryCompute.metric) && Objects.equals(this.target, productAnalyticsGraphQueryCompute.target) && Objects.equals(this.additionalProperties, productAnalyticsGraphQueryCompute.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(aggregation,interval,metric,target, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ProductAnalyticsGraphQueryCompute {\n");
