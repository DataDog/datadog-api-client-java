 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "listAuditLogs", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  public CompletableFuture<ApiResponse<AuditLogsEventsResponse>> listAuditLogsWithHttpInfoAsync(ListAuditLogsOptionalParameters parameters) {
    ...
    try {
      builder = apiClient.createBuilder("AuditApi.listAuditLogs", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
 ...
 */
  ...
  PaginationIterable iterator = new PaginationIterable(this, "searchAuditLogs", resultsPath, valueGetterPath, valueSetterPath, valueSetterParamOptional, limit, args);
  ...
  public CompletableFuture<ApiResponse<AuditLogsEventsResponse>> searchAuditLogsWithHttpInfoAsync(SearchAuditLogsOptionalParameters parameters) {
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("AuditApi.searchAuditLogs", localVarPath, new ArrayList<Pair>(), localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<AuditLogsEventsResponse>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
