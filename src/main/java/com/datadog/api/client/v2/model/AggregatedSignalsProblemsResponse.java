...
/**
   * <p>Response body for the aggregated signals and problems endpoint.</p>
 */
@JsonPropertyOrder({
  AggregatedSignalsProblemsResponse.JSON_PROPERTY_DATA
})
...
public class AggregatedSignalsProblemsResponse {
  ...
  @JsonCreator
  public AggregatedSignalsProblemsResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)AggregatedSignalsProblemsResponseData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AggregatedSignalsProblemsResponse aggregatedSignalsProblemsResponse = (AggregatedSignalsProblemsResponse) o;
    return Objects.equals(this.data, aggregatedSignalsProblemsResponse.data) && Objects.equals(this.additionalProperties, aggregatedSignalsProblemsResponse.additionalProperties);
  }
