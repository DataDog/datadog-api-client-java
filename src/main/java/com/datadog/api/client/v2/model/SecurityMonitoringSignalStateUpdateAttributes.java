...
public class SecurityMonitoringSignalStateUpdateAttributes {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringSignalStateUpdateAttributes putAdditionalProperty(String key, Object value) {
