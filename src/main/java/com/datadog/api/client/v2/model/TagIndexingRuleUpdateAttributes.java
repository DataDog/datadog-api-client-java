...
@JsonPropertyOrder({
  ...
  TagIndexingRuleUpdateAttributes.JSON_PROPERTY_IGNORED_METRIC_NAME_MATCHES,
  TagIndexingRuleUpdateAttributes.JSON_PROPERTY_METRIC_NAME_MATCHES,
  TagIndexingRuleUpdateAttributes.JSON_PROPERTY_NAME,
  TagIndexingRuleUpdateAttributes.JSON_PROPERTY_OPTIONS,
...
public class TagIndexingRuleUpdateAttributes {
   ...
   * @return TagIndexingRuleUpdateAttributes
   */
  @JsonAnySetter
