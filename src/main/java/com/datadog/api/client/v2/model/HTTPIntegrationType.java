...
public class HTTPIntegrationType extends ModelEnum<String> {
  ...
  HTTPIntegrationType(String value) {
    super(value, allowedValues);
  }

  public static class HTTPIntegrationTypeSerializer extends StdSerializer<HTTPIntegrationType> {
      public HTTPIntegrationTypeSerializer(Class<HTTPIntegrationType> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(HTTPIntegrationType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
          jgen.writeObject(value.value);
      }
  }

  @JsonCreator
  public static HTTPIntegrationType fromValue(String value) {
    return new HTTPIntegrationType(value);
  }
}
