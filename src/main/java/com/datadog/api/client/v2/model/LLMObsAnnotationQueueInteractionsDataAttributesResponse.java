...
public class LLMObsAnnotationQueueInteractionsDataAttributesResponse {
  ...
  @JsonCreator
  public LLMObsAnnotationQueueInteractionsDataAttributesResponse(
            @JsonProperty(required=true, value=JSON_PROPERTY_INTERACTIONS)List<LLMObsAnnotationQueueInteractionResponseItem> interactions) {
  ...
  /**
   * <p>List of interactions that were processed.</p>
   * @return interactions
  **/
  ...
  /**
   * Return true if this LLMObsAnnotationQueueInteractionsDataAttributesResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    LLMObsAnnotationQueueInteractionsDataAttributesResponse llmObsAnnotationQueueInteractionsDataAttributesResponse = (LLMObsAnnotationQueueInteractionsDataAttributesResponse) o;
    return Objects.equals(this.interactions, llmObsAnnotationQueueInteractionsDataAttributesResponse.interactions) && Objects.equals(this.additionalProperties, llmObsAnnotationQueueInteractionsDataAttributesResponse.additionalProperties);
  }
