...
public class WorkflowRunAsOwnerType extends ModelEnum<String> {
  ...
  public static class WorkflowRunAsOwnerTypeSerializer extends StdSerializer<WorkflowRunAsOwnerType> {
      ...
      @Override
      public void serialize(WorkflowRunAsOwnerType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
