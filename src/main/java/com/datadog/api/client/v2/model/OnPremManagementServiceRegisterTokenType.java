...
@JsonSerialize(
    using =
        OnPremManagementServiceRegisterTokenType.OnPremManagementServiceRegisterTokenTypeSerializer
            .class)
public class OnPremManagementServiceRegisterTokenType extends ModelEnum<String> {

  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("registerTokenRequest"));
  ...
  public static class OnPremManagementServiceRegisterTokenTypeSerializer
      extends StdSerializer<OnPremManagementServiceRegisterTokenType> {
    public OnPremManagementServiceRegisterTokenTypeSerializer(
        Class<OnPremManagementServiceRegisterTokenType> t) {
      super(t);
    }
