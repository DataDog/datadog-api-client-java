...
/**
   * <p>Attributes of an aggregated signals and problems response.</p>
 */
@JsonPropertyOrder({
...
public class AggregatedSignalsProblemsResponseAttributes {
  ...
  public AggregatedSignalsProblemsResponseAttributes(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_PROBLEM_DETECTIONS)SignalsProblemsDetections problemDetections,
            @JsonProperty(required=true, value=JSON_PROPERTY_SAMPLE_METADATA)SignalsProblemsSampleMetadata sampleMetadata,
  ...
  **/
  ...
  public AggregatedSignalsProblemsResponseAttributes criteria(AggregatedWaterfallPerformanceCriteria criteria) {
  ...
  **/
  ...
  public AggregatedSignalsProblemsResponseAttributes problemDetections(SignalsProblemsDetections problemDetections) {
    this.problemDetections = problemDetections;
    this.unparsed |= problemDetections.unparsed;
    return this;
  }
  ...
  **/
  ...
  public AggregatedSignalsProblemsResponseAttributes sampleMetadata(SignalsProblemsSampleMetadata sampleMetadata) {
    this.sampleMetadata = sampleMetadata;
    this.unparsed |= sampleMetadata.unparsed;
    return this;
  }
  ...
  /**
   * <p>Metadata about the sampling quality for a signals and problems query.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public AggregatedSignalsProblemsResponseAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AggregatedSignalsProblemsResponseAttributes aggregatedSignalsProblemsResponseAttributes = (AggregatedSignalsProblemsResponseAttributes) o;
    return Objects.equals(this.applicationId, aggregatedSignalsProblemsResponseAttributes.applicationId) && Objects.equals(this.criteria, aggregatedSignalsProblemsResponseAttributes.criteria) && Objects.equals(this.from, aggregatedSignalsProblemsResponseAttributes.from) && Objects.equals(this.problemDetections, aggregatedSignalsProblemsResponseAttributes.problemDetections) && Objects.equals(this.sampleMetadata, aggregatedSignalsProblemsResponseAttributes.sampleMetadata) && Objects.equals(this.to, aggregatedSignalsProblemsResponseAttributes.to) && Objects.equals(this.viewName, aggregatedSignalsProblemsResponseAttributes.viewName) && Objects.equals(this.additionalProperties, aggregatedSignalsProblemsResponseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(applicationId,criteria,from,problemDetections,sampleMetadata,to,viewName, additionalProperties);
  }
