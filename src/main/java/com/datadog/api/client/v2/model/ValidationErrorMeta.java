...
public class ValidationErrorMeta {
  ...
  /**
   * <p>The field name that caused the error.</p>
   * @return field
  **/
  ...
  /**
   * <p>The ID of the component in which the error occurred.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.field, validationErrorMeta.field) && Objects.equals(this.id, validationErrorMeta.id) && Objects.equals(this.message, validationErrorMeta.message) && Objects.equals(this.additionalProperties, validationErrorMeta.additionalProperties);
  }
