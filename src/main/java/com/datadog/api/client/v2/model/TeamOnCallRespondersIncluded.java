...
@JsonDeserialize(using = TeamOnCallRespondersIncluded.TeamOnCallRespondersIncludedDeserializer.class)
...
public class TeamOnCallRespondersIncluded extends AbstractOpenApiSchema {
    ...
    public static class TeamOnCallRespondersIncludedSerializer extends StdSerializer<TeamOnCallRespondersIncluded> {
        ...
        @Override
        public void serialize(TeamOnCallRespondersIncluded value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class TeamOnCallRespondersIncludedDeserializer extends StdDeserializer<TeamOnCallRespondersIncluded> {
        ...
        @Override
        public TeamOnCallRespondersIncluded deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                boolean attemptParsing = true;
                // ensure that we respect type coercion as set on the client ObjectMapper
                if (Escalation.class.equals(Integer.class) || Escalation.class.equals(Long.class) || Escalation.class.equals(Float.class) || Escalation.class.equals(Double.class) || Escalation.class.equals(Boolean.class) || Escalation.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((Escalation.class.equals(Integer.class) || Escalation.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((Escalation.class.equals(Float.class) || Escalation.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (Escalation.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (Escalation.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public TeamOnCallRespondersIncluded getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "TeamOnCallRespondersIncluded cannot be null");
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(TeamOnCallRespondersIncluded.class, Collections.unmodifiableMap(schemas));
    }
    ...
    /**
     * Get the actual instance of `Escalation`. If the actual instance is not `Escalation`,
     * the ClassCastException will be thrown.
     *
