...
public class SecurityMonitoringRuleUser {
  ...
  /**
   * <p>The user handle. Empty for a default rule with no user.</p>
   * @return handle
  **/
  ...
  /**
   * <p>The user name. Empty for a default rule with no user.</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.handle, securityMonitoringRuleUser.handle) && Objects.equals(this.name, securityMonitoringRuleUser.name) && Objects.equals(this.additionalProperties, securityMonitoringRuleUser.additionalProperties);
  }
