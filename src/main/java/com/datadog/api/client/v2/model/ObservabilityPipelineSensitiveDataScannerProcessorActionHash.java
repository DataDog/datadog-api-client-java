...
/**
 * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionHash</code>
 * object.
 */
@JsonPropertyOrder({
...
public class ObservabilityPipelineSensitiveDataScannerProcessorActionHash {
  ...
  /**
   * The definition of <code>ObservabilityPipelineSensitiveDataScannerProcessorActionHashAction
   * </code> object.
   *
   * @return action
   */
