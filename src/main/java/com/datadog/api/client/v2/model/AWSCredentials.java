...
public class AWSCredentials extends AbstractOpenApiSchema {
    ...
    public static class AWSCredentialsSerializer extends StdSerializer<AWSCredentials> {
        ...
        @Override
        public void serialize(AWSCredentials value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class AWSCredentialsDeserializer extends StdDeserializer<AWSCredentials> {
        ...
        @Override
        public AWSCredentials deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (AWSAssumeRole.class.equals(Integer.class) || AWSAssumeRole.class.equals(Long.class) || AWSAssumeRole.class.equals(Float.class) || AWSAssumeRole.class.equals(Double.class) || AWSAssumeRole.class.equals(Boolean.class) || AWSAssumeRole.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((AWSAssumeRole.class.equals(Integer.class) || AWSAssumeRole.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((AWSAssumeRole.class.equals(Float.class) || AWSAssumeRole.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (AWSAssumeRole.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (AWSAssumeRole.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
