...
public class TimelineCellAuthor extends AbstractOpenApiSchema {
    ...
    public static class TimelineCellAuthorSerializer extends StdSerializer<TimelineCellAuthor> {
        ...
        @Override
        public void serialize(TimelineCellAuthor value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class TimelineCellAuthorDeserializer extends StdDeserializer<TimelineCellAuthor> {
        ...
        @Override
        public TimelineCellAuthor deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (TimelineCellAuthorUser.class.equals(Integer.class) || TimelineCellAuthorUser.class.equals(Long.class) || TimelineCellAuthorUser.class.equals(Float.class) || TimelineCellAuthorUser.class.equals(Double.class) || TimelineCellAuthorUser.class.equals(Boolean.class) || TimelineCellAuthorUser.class.equals(String.class)) {
                    attemptParsing = typeCoercion;
                    if (!attemptParsing) {
                        attemptParsing |= ((TimelineCellAuthorUser.class.equals(Integer.class) || TimelineCellAuthorUser.class.equals(Long.class)) && token == JsonToken.VALUE_NUMBER_INT);
                        attemptParsing |= ((TimelineCellAuthorUser.class.equals(Float.class) || TimelineCellAuthorUser.class.equals(Double.class)) && (token == JsonToken.VALUE_NUMBER_FLOAT || token == JsonToken.VALUE_NUMBER_INT));
                        attemptParsing |= (TimelineCellAuthorUser.class.equals(Boolean.class) && (token == JsonToken.VALUE_FALSE || token == JsonToken.VALUE_TRUE));
                        attemptParsing |= (TimelineCellAuthorUser.class.equals(String.class) && token == JsonToken.VALUE_STRING);
                    }
                }
                if (attemptParsing) {
         ...
         */
        @Override
        public TimelineCellAuthor getNullValue(DeserializationContext ctxt) throws JsonMappingException {
    ...
    /**
     * Get the actual instance of `TimelineCellAuthorUser`. If the actual instance is not `TimelineCellAuthorUser`,
