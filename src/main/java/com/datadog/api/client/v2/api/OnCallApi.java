 ...
 */
  ...
  public static class GetScheduleOnCallRespondersOptionalParameters {
    ...
    /**
     * Set include.
     * @param include Comma-separated list of included relationships to be returned. Allowed values: <code>schedule</code>, <code>responders</code>, <code>responders.shifts</code>, <code>responders.shifts.user</code>. (optional)
    ...
    /**
     * Set filterPosition.
     * @param filterPosition Comma-separated list of positions to retrieve. Allowed values: <code>previous</code>, <code>current</code>, <code>next</code>. Defaults to <code>current</code> if omitted. (optional)
     * @return GetScheduleOnCallRespondersOptionalParameters
     */
    ...
    /**
     * Set filterAtTs.
     * @param filterAtTs Retrieves the on-call responders at the given timestamp in RFC3339 format (for example, <code>2025-05-07T02:53:01Z</code> or <code>2025-05-07T02:53:01+00:00</code>). When using timezone offsets with <code>+</code> or <code>-</code>, ensure proper URL encoding (<code>+</code> should be encoded as <code>%2B</code>). Defaults to the current time if omitted. (optional)
     * @return GetScheduleOnCallRespondersOptionalParameters
     */
 ...
 *
 * See {@link #getScheduleOnCallRespondersWithHttpInfo}.
 *
 * @param scheduleId The ID of the schedule. (required)
 * @return ScheduleOnCallResponders
 * @throws ApiException if fails to make API call
 */
  public ScheduleOnCallResponders getScheduleOnCallResponders (String scheduleId) throws ApiException {
    return getScheduleOnCallRespondersWithHttpInfo( scheduleId, new GetScheduleOnCallRespondersOptionalParameters()).getData();
  }

  /**
 * Get on-call responders for a schedule.
 *
 * See {@link #getScheduleOnCallRespondersWithHttpInfoAsync}.
 *
 * @param scheduleId The ID of the schedule. (required)
 * @return CompletableFuture&lt;ScheduleOnCallResponders&gt;
 */
  public CompletableFuture<ScheduleOnCallResponders>getScheduleOnCallRespondersAsync(String scheduleId) {
    return getScheduleOnCallRespondersWithHttpInfoAsync(scheduleId, new GetScheduleOnCallRespondersOptionalParameters()).thenApply(response -> {
        return response.getData();
    });
  }
 ...
 * @throws ApiException if fails to make API call
 */
  public ScheduleOnCallResponders getScheduleOnCallResponders(String scheduleId, GetScheduleOnCallRespondersOptionalParameters parameters) throws ApiException {
 ...
 * @return CompletableFuture&lt;ScheduleOnCallResponders&gt;
 */
  public CompletableFuture<ScheduleOnCallResponders>getScheduleOnCallRespondersAsync( String scheduleId, GetScheduleOnCallRespondersOptionalParameters parameters) {
    return getScheduleOnCallRespondersWithHttpInfoAsync(scheduleId, parameters).thenApply(response -> {
        return response.getData();
    });
  }
  ...
  /**
   * <p>Retrieves the on-call responders for the specified schedule, grouped by position (previous, current, next), at a given time. Supports schedules with multiple concurrent on-call responders at a position, by returning a list of shifts per position.</p>
   *
   * @param scheduleId The ID of the schedule. (required)
   * @param parameters Optional parameters for the request.
   ...
   *     </table>
   */
  public ApiResponse<ScheduleOnCallResponders> getScheduleOnCallRespondersWithHttpInfo(String scheduleId, GetScheduleOnCallRespondersOptionalParameters parameters) throws ApiException {
    Object localVarPostBody = null;

    // verify the required parameter 'scheduleId' is set
    if (scheduleId == null) {
      throw new ApiException(400, "Missing the required parameter 'scheduleId' when calling getScheduleOnCallResponders");
    }
    String include = parameters.include;
    String filterPosition = parameters.filterPosition;
    String filterAtTs = parameters.filterAtTs;
    // create path and map variables
    String localVarPath = "/api/v2/on-call/schedules/{schedule_id}/responders"
      .replaceAll("\\{" + "schedule_id" + "\\}", apiClient.escapeString(scheduleId.toString()));
    ...
    Invocation.Builder builder = apiClient.createBuilder("v2.OnCallApi.getScheduleOnCallResponders", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    return apiClient.invokeAPI("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ScheduleOnCallResponders>() {});
  }
   ...
   */
  public CompletableFuture<ApiResponse<ScheduleOnCallResponders>> getScheduleOnCallRespondersWithHttpInfoAsync(String scheduleId, GetScheduleOnCallRespondersOptionalParameters parameters) {
    Object localVarPostBody = null;

    // verify the required parameter 'scheduleId' is set
    if (scheduleId == null) {
        CompletableFuture<ApiResponse<ScheduleOnCallResponders>> result = new CompletableFuture<>();
        result.completeExceptionally(new ApiException(400, "Missing the required parameter 'scheduleId' when calling getScheduleOnCallResponders"));
        return result;
    }
    String include = parameters.include;
    String filterPosition = parameters.filterPosition;
    ...
    Invocation.Builder builder;
    try {
      builder = apiClient.createBuilder("v2.OnCallApi.getScheduleOnCallResponders", localVarPath, localVarQueryParams, localVarHeaderParams, new HashMap<String, String>(), new String[] {"application/json" }, new String[] { "apiKeyAuth", "appKeyAuth", "AuthZ" });
    } catch (ApiException ex) {
      CompletableFuture<ApiResponse<ScheduleOnCallResponders>> result = new CompletableFuture<>();
      result.completeExceptionally(ex);
      return result;
    }
    return apiClient.invokeAPIAsync("GET", builder, localVarHeaderParams,  new String[] { }, localVarPostBody,new HashMap<String, Object>() , false, new GenericType<ScheduleOnCallResponders>() {});
  }
...
@Deprecated
  ...
  /**
   * <p>Retrieves the user who is on-call for the specified schedule at a given time. This endpoint does not support schedules with multiple concurrent on-call responders at a position. Deprecated. Use <code>Get on-call responders for a schedule</code> instead.</p>
   *
   * @param scheduleId The ID of the schedule. (required)
   * @param parameters Optional parameters for the request.
