...
public class OnCallApi {
  ...
  /**
   * Create a new notification channel for an on-call user. The authenticated user must be the
   * target user or have <code>on_call_admin</code>
   *
   * @param userId The user ID (required)
   * @param body (required)
  ...
  /**
   * Delete a notification channel for an on-call user. The authenticated user must be the target
   * user or have <code>on_call_admin</code>
   *
   * @param userId The user ID (required)
   * @param channelId The channel ID (required)
   * @return ApiResponse&lt;Void&gt;
  ...
  /**
   * Get a notification channel for an on-call user. The authenticated user must be the target user
   * or have <code>on_call_admin</code>
   *
   * @param userId The user ID (required)
   * @param channelId The channel ID (required)
   * @return ApiResponse&lt;NotificationChannel&gt;
  ...
  /**
   * List the notification channels for an on-call user. The authenticated user must be the target
   * user or have <code>on_call_admin</code>
   *
   * @param userId The user ID (required)
