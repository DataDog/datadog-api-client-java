...
public class OpenAICredentialsUpdate extends AbstractOpenApiSchema {
    ...
    public static class OpenAICredentialsUpdateSerializer extends StdSerializer<OpenAICredentialsUpdate> {
    ...
    public static class OpenAICredentialsUpdateDeserializer extends StdDeserializer<OpenAICredentialsUpdate> {
        ...
        public OpenAICredentialsUpdate deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                if (OpenAIAPIKeyUpdate.class.equals(Integer.class) || OpenAIAPIKeyUpdate.class.equals(Long.class) || OpenAIAPIKeyUpdate.class.equals(Float.class) || OpenAIAPIKeyUpdate.class.equals(Double.class) || OpenAIAPIKeyUpdate.class.equals(Boolean.class) || OpenAIAPIKeyUpdate.class.equals(String.class)) {
    ...
    /**
     * Get the actual instance of `OpenAIAPIKeyUpdate`. If the actual instance is not `OpenAIAPIKeyUpdate`,
