...
public class DdsqlTabularQueryResponseMeta {
  ...
  /**
   * <p>Server-side time spent serving this request, in milliseconds.</p>
   * @return elapsed
  **/
  ...
  /**
   * <p>Echo of the <code>DD-Request-ID</code> header assigned by Datadog's edge to this request,
   * for support correlation.</p>
   * @return requestId
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.elapsed, ddsqlTabularQueryResponseMeta.elapsed) && Objects.equals(this.requestId, ddsqlTabularQueryResponseMeta.requestId) && Objects.equals(this.additionalProperties, ddsqlTabularQueryResponseMeta.additionalProperties);
  }
