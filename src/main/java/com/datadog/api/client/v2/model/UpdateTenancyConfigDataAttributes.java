...
/**
   * <p>Attributes for updating an existing OCI tenancy integration configuration, including optional credentials, region settings, and collection options.</p>
 */
@JsonPropertyOrder({
...
public class UpdateTenancyConfigDataAttributes {
  ...
  public UpdateTenancyConfigDataAttributes authCredentials(UpdateTenancyConfigDataAttributesAuthCredentials authCredentials) {
  ...
  /**
   * <p>OCI API signing key credentials used to update the Datadog integration's authentication with the OCI tenancy.</p>
  ...
  **/
  ...
  public UpdateTenancyConfigDataAttributes logsConfig(UpdateTenancyConfigDataAttributesLogsConfig logsConfig) {
  ...
  /**
   * <p>Log collection configuration for updating an OCI tenancy, controlling which compartments and services have log collection enabled.</p>
   * @return logsConfig
  **/
      @jakarta.annotation.Nullable
  ...
  public UpdateTenancyConfigDataAttributes metricsConfig(UpdateTenancyConfigDataAttributesMetricsConfig metricsConfig) {
  ...
  /**
   * <p>Metrics collection configuration for updating an OCI tenancy, controlling which compartments and services are included or excluded.</p>
  ...
  **/
  ...
  public UpdateTenancyConfigDataAttributes regionsConfig(UpdateTenancyConfigDataAttributesRegionsConfig regionsConfig) {
  ...
  /**
   * <p>Region configuration for updating an OCI tenancy, specifying which regions are available, enabled, or disabled for data collection.</p>
  ...
  **/
  ...
  public UpdateTenancyConfigDataAttributes resourceCollectionEnabled(Boolean resourceCollectionEnabled) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateTenancyConfigDataAttributes updateTenancyConfigDataAttributes = (UpdateTenancyConfigDataAttributes) o;
    return Objects.equals(this.authCredentials, updateTenancyConfigDataAttributes.authCredentials) && Objects.equals(this.costCollectionEnabled, updateTenancyConfigDataAttributes.costCollectionEnabled) && Objects.equals(this.homeRegion, updateTenancyConfigDataAttributes.homeRegion) && Objects.equals(this.logsConfig, updateTenancyConfigDataAttributes.logsConfig) && Objects.equals(this.metricsConfig, updateTenancyConfigDataAttributes.metricsConfig) && Objects.equals(this.regionsConfig, updateTenancyConfigDataAttributes.regionsConfig) && Objects.equals(this.resourceCollectionEnabled, updateTenancyConfigDataAttributes.resourceCollectionEnabled) && Objects.equals(this.userOcid, updateTenancyConfigDataAttributes.userOcid) && Objects.equals(this.additionalProperties, updateTenancyConfigDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(authCredentials,costCollectionEnabled,homeRegion,logsConfig,metricsConfig,regionsConfig,resourceCollectionEnabled,userOcid, additionalProperties);
  }
