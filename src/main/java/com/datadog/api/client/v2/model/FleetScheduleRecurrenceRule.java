...
public class FleetScheduleRecurrenceRule {
  ...
  public FleetScheduleRecurrenceRule(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_MAINTENANCE_WINDOW_DURATION)Long maintenanceWindowDuration,
            @JsonProperty(required=true, value=JSON_PROPERTY_START_MAINTENANCE_WINDOW)String startMaintenanceWindow,
  ...
  /**
   * <p>List of days of the week when the schedule should trigger. Valid values are:
  ...
  **/
   ...
   * Deployments will be triggered at this time on the specified days.</p>
  ...
  **/
  ...
  /**
   * <p>Timezone for the schedule in IANA Time Zone Database format (e.g., "America/New_York", "UTC").</p>
   * @return timezone
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.daysOfWeek, fleetScheduleRecurrenceRule.daysOfWeek) && Objects.equals(this.maintenanceWindowDuration, fleetScheduleRecurrenceRule.maintenanceWindowDuration) && Objects.equals(this.startMaintenanceWindow, fleetScheduleRecurrenceRule.startMaintenanceWindow) && Objects.equals(this.timezone, fleetScheduleRecurrenceRule.timezone) && Objects.equals(this.additionalProperties, fleetScheduleRecurrenceRule.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(daysOfWeek,maintenanceWindowDuration,startMaintenanceWindow,timezone, additionalProperties);
  }
