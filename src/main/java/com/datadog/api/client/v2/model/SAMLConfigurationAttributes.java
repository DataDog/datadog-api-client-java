...
/**
   * <p>Attributes of a SAML configuration.</p>
 */
@JsonPropertyOrder({
...
public class SAMLConfigurationAttributes {
  ...
  public static final String JSON_PROPERTY_ASSERTION_CONSUMER_SERVICE = "assertion_consumer_service";
  ...
  /**
   * <p>The assertion consumer service (ACS) URLs that the identity provider posts SAML responses to.</p>
  ...
  **/
  ...
  /**
   * <p>Creation time of the SAML configuration.</p>
   * @return createdAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The service provider entity ID Datadog presents to the identity provider.</p>
   * @return entityId
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Expiration time of the uploaded identity provider metadata.</p>
   * @return expiresAt
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_EXPIRES_AT)public void setExpiresAt_JsonNullable(JsonNullable<OffsetDateTime> expiresAt) {
  ...
  /**
   * <p>Whether identity-provider-initiated login is enabled for the organization.</p>
   * @return idpInitiated
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Email domains for which users are automatically provisioned on first SAML login
   * (just-in-time provisioning).</p>
   * @return jitDomains
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Time of the last SAML configuration modification.</p>
   * @return modifiedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The single sign-on URL users can visit to start a SAML login.
   * Returns <code>null</code> when the organization is identity-provider-initiated and has no subdomain.</p>
   * @return ssoUrl
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  @JsonProperty(JSON_PROPERTY_SSO_URL)public void setSsoUrl_JsonNullable(JsonNullable<String> ssoUrl) {
    this.ssoUrl = ssoUrl;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.assertionConsumerService, samlConfigurationAttributes.assertionConsumerService) && Objects.equals(this.createdAt, samlConfigurationAttributes.createdAt) && Objects.equals(this.entityId, samlConfigurationAttributes.entityId) && Objects.equals(this.expiresAt, samlConfigurationAttributes.expiresAt) && Objects.equals(this.idpInitiated, samlConfigurationAttributes.idpInitiated) && Objects.equals(this.jitDomains, samlConfigurationAttributes.jitDomains) && Objects.equals(this.modifiedAt, samlConfigurationAttributes.modifiedAt) && Objects.equals(this.ssoUrl, samlConfigurationAttributes.ssoUrl) && Objects.equals(this.additionalProperties, samlConfigurationAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(assertionConsumerService,createdAt,entityId,expiresAt,idpInitiated,jitDomains,modifiedAt,ssoUrl, additionalProperties);
  }
