...
/**
   * <p>A query for host-level process metrics such as CPU and memory usage.</p>
 */
@JsonPropertyOrder({
  ...
  ProcessScalarQuery.JSON_PROPERTY_METRIC,
  ProcessScalarQuery.JSON_PROPERTY_NAME,
  ProcessScalarQuery.JSON_PROPERTY_SORT,
  ProcessScalarQuery.JSON_PROPERTY_TAG_FILTERS,
  ProcessScalarQuery.JSON_PROPERTY_TEXT_FILTER
})
@jakarta.annotation.Generated(value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class ProcessScalarQuery {
  @JsonIgnore
  ...
  public ProcessScalarQuery() {}

  @JsonCreator
  public ProcessScalarQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA_SOURCE)ProcessDataSource dataSource,
  ...
  public ProcessScalarQuery aggregator(MetricsAggregator aggregator) {
  ...
  **/
  ...
  /**
   * <p>A data source for process-level infrastructure metrics.</p>
   * @return dataSource
  **/
  ...
  public ProcessScalarQuery isNormalizedCpu(Boolean isNormalizedCpu) {
  ...
  **/
  ...
  public ProcessScalarQuery limit(Long limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public ProcessScalarQuery metric(String metric) {
    this.metric = metric;
    return this;
  }

  /**
   * <p>The process metric to query.</p>
   * @return metric
  **/
  ...
  public ProcessScalarQuery name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProcessScalarQuery sort(QuerySortOrder sort) {
    this.sort = sort;
  ...
  **/
  ...
  public ProcessScalarQuery tagFilters(List<String> tagFilters) {
    this.tagFilters = tagFilters;
    return this;
  }
  public ProcessScalarQuery addTagFiltersItem(String tagFiltersItem) {
  ...
  /**
   * <p>Tag filters to narrow down processes.</p>
   * @return tagFilters
  **/
      @jakarta.annotation.Nullable
  ...
  public ProcessScalarQuery textFilter(String textFilter) {
    this.textFilter = textFilter;
    return this;
  }

  /**
   * <p>A full-text search filter to match process names or commands.</p>
   * @return textFilter
  **/
      @jakarta.annotation.Nullable
   ...
   * @return ProcessScalarQuery
   */
  @JsonAnySetter
  public ProcessScalarQuery putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this ProcessScalarQuery object is equal to o.
   */
  @Override
