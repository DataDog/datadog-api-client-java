...
public class ProcessScalarQuery {
  ...
  public ProcessScalarQuery aggregator(String aggregator) {
    this.aggregator = aggregator;
    return this;
  }

  /**
   * The temporal reduction function to apply.
   *
   * @return aggregator
   */
  ...
  public ProcessScalarQuery sort(String sort) {
    this.sort = sort;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aggregator, processScalarQuery.aggregator)
        ...
        && Objects.equals(this.metric, processScalarQuery.metric)
        && Objects.equals(this.name, processScalarQuery.name)
        && Objects.equals(this.sort, processScalarQuery.sort)
        && Objects.equals(this.tagFilters, processScalarQuery.tagFilters)
        && Objects.equals(this.textFilter, processScalarQuery.textFilter)
        && Objects.equals(this.additionalProperties, processScalarQuery.additionalProperties);
  }
