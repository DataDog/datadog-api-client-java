...
public class CIAppPipelineEventJobStatus extends ModelEnum<String> {
  ...
  public static final CIAppPipelineEventJobStatus SKIPPED = new CIAppPipelineEventJobStatus("skipped");
  ...
  public static class CIAppPipelineEventJobStatusSerializer extends StdSerializer<CIAppPipelineEventJobStatus> {
      ...
      @Override
      public void serialize(CIAppPipelineEventJobStatus value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
