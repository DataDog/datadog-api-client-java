...
/**
   * <p>Response containing Jira issue templates</p>
 */
@JsonPropertyOrder({
...
public class JiraIssueTemplatesResponse {
  ...
  private List<JiraIssueTemplateData> data = new ArrayList<>();

  public static final String JSON_PROPERTY_INCLUDED = "included";
  private List<JiraAccountData> included = null;
  ...
  /**
   * <p>Array of Jira issue template data objects</p>
   * @return data
  **/
      @JsonProperty(JSON_PROPERTY_DATA)
      @JsonInclude(
        value = JsonInclude.Include.ALWAYS)
      public List<JiraIssueTemplateData> getData() {
        return data;
      }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, jiraIssueTemplatesResponse.data) && Objects.equals(this.included, jiraIssueTemplatesResponse.included) && Objects.equals(this.additionalProperties, jiraIssueTemplatesResponse.additionalProperties);
  }
