...
@JsonPropertyOrder({
  UpdateOnCallNotificationRuleRequestAttributes.JSON_PROPERTY_CATEGORY,
  UpdateOnCallNotificationRuleRequestAttributes.JSON_PROPERTY_CHANNEL_SETTINGS,
  UpdateOnCallNotificationRuleRequestAttributes.JSON_PROPERTY_DELAY_MINUTES
})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class UpdateOnCallNotificationRuleRequestAttributes {
  ...
  public UpdateOnCallNotificationRuleRequestAttributes category(
      OnCallNotificationRuleCategory category) {
  ...
  public UpdateOnCallNotificationRuleRequestAttributes channelSettings(
   ...
   * @return UpdateOnCallNotificationRuleRequestAttributes
   */
  @JsonAnySetter
  public UpdateOnCallNotificationRuleRequestAttributes putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    UpdateOnCallNotificationRuleRequestAttributes updateOnCallNotificationRuleRequestAttributes =
        (UpdateOnCallNotificationRuleRequestAttributes) o;
    return Objects.equals(this.category, updateOnCallNotificationRuleRequestAttributes.category)
        && Objects.equals(
            this.channelSettings, updateOnCallNotificationRuleRequestAttributes.channelSettings)
        && Objects.equals(
            this.delayMinutes, updateOnCallNotificationRuleRequestAttributes.delayMinutes)
        && Objects.equals(
            this.additionalProperties,
            updateOnCallNotificationRuleRequestAttributes.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateOnCallNotificationRuleRequestAttributes {\n");
