...
public class IncidentRuleType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("incident_rules"));

  public static final IncidentRuleType INCIDENT_RULES = new IncidentRuleType("incident_rules");
  ...
  public static class IncidentRuleTypeSerializer extends StdSerializer<IncidentRuleType> {
      ...
      @Override
      public void serialize(IncidentRuleType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
