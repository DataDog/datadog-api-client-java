...
public class ApplicationSecurityWafCustomRuleConditionInput {
  ...
  @JsonCreator
  public ApplicationSecurityWafCustomRuleConditionInput(
      @JsonProperty(required = true, value = JSON_PROPERTY_ADDRESS)
          ApplicationSecurityWafCustomRuleConditionInputAddress address) {
    this.address = address;
    this.unparsed |= !address.isValid();
  }

  public ApplicationSecurityWafCustomRuleConditionInput address(
      ApplicationSecurityWafCustomRuleConditionInputAddress address) {
    this.address = address;
    this.unparsed |= !address.isValid();
    return this;
   ...
   */
  @JsonAnySetter
  public ApplicationSecurityWafCustomRuleConditionInput putAdditionalProperty(
  ...
  public boolean equals(Object o) {
    ...
    ApplicationSecurityWafCustomRuleConditionInput applicationSecurityWafCustomRuleConditionInput =
        (ApplicationSecurityWafCustomRuleConditionInput) o;
    return Objects.equals(this.address, applicationSecurityWafCustomRuleConditionInput.address)
        && Objects.equals(this.keyPath, applicationSecurityWafCustomRuleConditionInput.keyPath)
        && Objects.equals(
            this.additionalProperties,
            applicationSecurityWafCustomRuleConditionInput.additionalProperties);
  }
