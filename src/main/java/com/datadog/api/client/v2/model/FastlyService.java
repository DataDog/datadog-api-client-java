...
@JsonPropertyOrder({FastlyService.JSON_PROPERTY_ID, FastlyService.JSON_PROPERTY_TAGS})
...
public class FastlyService {
  ...
  @JsonCreator
  public FastlyService(@JsonProperty(required = true, value = JSON_PROPERTY_ID) String id) {
    this.id = id;
  }
   ...
   */
  @JsonAnySetter
  public FastlyService putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, fastlyService.id)
        && Objects.equals(this.tags, fastlyService.tags)
        && Objects.equals(this.additionalProperties, fastlyService.additionalProperties);
  }
