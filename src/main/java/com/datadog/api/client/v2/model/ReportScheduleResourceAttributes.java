...
/**
   * <p>Attributes of an included report target resource.</p>
 */
@JsonPropertyOrder({
...
public class ReportScheduleResourceAttributes {
  ...
  private JsonNullable<List<ReportScheduleIndexTemplateVariable>> templateVariables = JsonNullable.<List<ReportScheduleIndexTemplateVariable>>undefined();
  ...
  **/
  ...
  public ReportScheduleResourceAttributes templateVariables(List<ReportScheduleIndexTemplateVariable> templateVariables) {
    this.templateVariables = JsonNullable.<List<ReportScheduleIndexTemplateVariable>>of(templateVariables);
    return this;
  }
  public ReportScheduleResourceAttributes addTemplateVariablesItem(ReportScheduleIndexTemplateVariable templateVariablesItem) {
    if (this.templateVariables == null || !this.templateVariables.isPresent()) {
      this.templateVariables = JsonNullable.<List<ReportScheduleIndexTemplateVariable>>of(new ArrayList<>());
    }
    try {
  ...
  /**
   * <p>Template variable metadata from the dashboard resource, when available.</p>
  ...
  **/
  ...
  public JsonNullable<List<ReportScheduleIndexTemplateVariable>> getTemplateVariables_JsonNullable() {
    return templateVariables;
  }
  @JsonProperty(JSON_PROPERTY_TEMPLATE_VARIABLES)public void setTemplateVariables_JsonNullable(JsonNullable<List<ReportScheduleIndexTemplateVariable>> templateVariables) {
  ...
  /**
   * <p>The title of the dashboard or integration dashboard resource, when available.</p>
   * @return title
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
