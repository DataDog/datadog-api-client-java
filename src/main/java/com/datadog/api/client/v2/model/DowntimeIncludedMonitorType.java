...
public class DowntimeIncludedMonitorType extends ModelEnum<String> {

  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("monitors"));

  public static final DowntimeIncludedMonitorType MONITORS = new DowntimeIncludedMonitorType("monitors");
  ...
  public static class DowntimeIncludedMonitorTypeSerializer extends StdSerializer<DowntimeIncludedMonitorType> {
      ...
      @Override
      public void serialize(DowntimeIncludedMonitorType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
