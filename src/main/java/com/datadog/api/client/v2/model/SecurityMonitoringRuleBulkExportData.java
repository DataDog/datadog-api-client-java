...
public class SecurityMonitoringRuleBulkExportData {
  ...
  @JsonCreator
  public SecurityMonitoringRuleBulkExportData(
            @JsonProperty(required=true, value=JSON_PROPERTY_ATTRIBUTES)SecurityMonitoringRuleBulkExportAttributes attributes,
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)SecurityMonitoringRuleBulkExportDataType type) {
        this.attributes = attributes;
        this.unparsed |= attributes.unparsed;
        this.type = type;
        this.unparsed |= !type.isValid();
  }
  public SecurityMonitoringRuleBulkExportData attributes(SecurityMonitoringRuleBulkExportAttributes attributes) {
    this.attributes = attributes;
    this.unparsed |= attributes.unparsed;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringRuleBulkExportData securityMonitoringRuleBulkExportData = (SecurityMonitoringRuleBulkExportData) o;
    return Objects.equals(this.attributes, securityMonitoringRuleBulkExportData.attributes) && Objects.equals(this.id, securityMonitoringRuleBulkExportData.id) && Objects.equals(this.type, securityMonitoringRuleBulkExportData.type) && Objects.equals(this.additionalProperties, securityMonitoringRuleBulkExportData.additionalProperties);
  }
