...
/**
   * <p>Request object for getting code coverage summary for a commit.</p>
 */
@JsonPropertyOrder({
  CommitCoverageSummaryRequest.JSON_PROPERTY_DATA
})
...
public class CommitCoverageSummaryRequest {
  ...
  @JsonCreator
  public CommitCoverageSummaryRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)CommitCoverageSummaryRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, commitCoverageSummaryRequest.data) && Objects.equals(this.additionalProperties, commitCoverageSummaryRequest.additionalProperties);
  }
