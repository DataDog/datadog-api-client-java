...
public class IncidentTeamIncludedItems extends AbstractOpenApiSchema {
    ...
    public static class IncidentTeamIncludedItemsSerializer extends StdSerializer<IncidentTeamIncludedItems> {
        public IncidentTeamIncludedItemsSerializer(Class<IncidentTeamIncludedItems> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(IncidentTeamIncludedItems value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class IncidentTeamIncludedItemsDeserializer extends StdDeserializer<IncidentTeamIncludedItems> {
        ...
        @Override
        public IncidentTeamIncludedItems deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
         ...
         */
        @Override
        public IncidentTeamIncludedItems getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "IncidentTeamIncludedItems cannot be null");
        }
    }
    ...
    public IncidentTeamIncludedItems(User o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(IncidentTeamIncludedItems.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, GenericType> getSchemas() {
        return IncidentTeamIncludedItems.schemas;
    }
