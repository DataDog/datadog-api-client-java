...
/**
   * <p>A column in a scalar response. When type is "group", values contains arrays of strings. When type is "number", values contains numeric values.</p>
 */
@JsonPropertyOrder({
...
public class CommitmentsScalarColumn {
  ...
  **/
  ...
  /**
   * <p>The column type. "group" for dimension columns, "number" for metric columns.</p>
   * @return type
  **/
  ...
  /**
   * <p>Values for a scalar column. Arrays of strings for group columns, numbers for value columns.</p>
   * @return values
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.meta, commitmentsScalarColumn.meta) && Objects.equals(this.name, commitmentsScalarColumn.name) && Objects.equals(this.type, commitmentsScalarColumn.type) && Objects.equals(this.values, commitmentsScalarColumn.values) && Objects.equals(this.additionalProperties, commitmentsScalarColumn.additionalProperties);
  }
