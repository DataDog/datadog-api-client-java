...
/**
   * <p>Invitee that can access an invite-only shared dashboard.</p>
 */
@JsonPropertyOrder({
...
public class SharedDashboardInvitee {
  ...
  @JsonCreator
  public SharedDashboardInvitee(
            @JsonProperty(required=true, value=JSON_PROPERTY_ACCESS_EXPIRATION)OffsetDateTime accessExpiration,
  ...
  /**
   * <p>Time when the invitee's access expires.</p>
  ...
  **/
  ...
  /**
   * <p>Time when the invitee was added.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Email address of the invitee.</p>
   * @return email
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpiration, sharedDashboardInvitee.accessExpiration) && Objects.equals(this.createdAt, sharedDashboardInvitee.createdAt) && Objects.equals(this.email, sharedDashboardInvitee.email) && Objects.equals(this.additionalProperties, sharedDashboardInvitee.additionalProperties);
  }
