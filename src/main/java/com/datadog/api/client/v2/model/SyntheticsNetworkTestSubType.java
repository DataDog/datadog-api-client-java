...
public class SyntheticsNetworkTestSubType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("tcp", "udp", "icmp"));
  ...
  public static class SyntheticsNetworkTestSubTypeSerializer extends StdSerializer<SyntheticsNetworkTestSubType> {
      ...
      @Override
      public void serialize(SyntheticsNetworkTestSubType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
