...
public class ObservabilityPipelineAwsAuth {
  ...
  private JsonNullable<String> assumeRole = JsonNullable.<String>undefined();
  ...
  public ObservabilityPipelineAwsAuth assumeRole(String assumeRole) {
    this.assumeRole = JsonNullable.<String>of(assumeRole);
    return this;
  }
  ...
  public String getAssumeRole() {
    return assumeRole.orElse(null);
  }

  @JsonProperty(JSON_PROPERTY_ASSUME_ROLE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public JsonNullable<String> getAssumeRole_JsonNullable() {
    return assumeRole;
  }

  @JsonProperty(JSON_PROPERTY_ASSUME_ROLE)
  public void setAssumeRole_JsonNullable(JsonNullable<String> assumeRole) {
