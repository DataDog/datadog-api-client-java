...
/**
   * <p>The set action applied on the scope matching the rule</p>
 */
@JsonPropertyOrder({
...
public class CloudWorkloadSecurityAgentRuleActionSet {
  ...
  /**
   * <p>Whether the value should be appended to the field.</p>
   * @return append
  **/
  ...
  /**
   * <p>The default value of the set action</p>
   * @return defaultValue
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The expression of the set action.</p>
   * @return expression
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The field of the set action</p>
   * @return field
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>Whether the value should be inherited.</p>
   * @return inherited
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The name of the set action</p>
   * @return name
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The scope of the set action.</p>
   * @return scope
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The size of the set action.</p>
   * @return size
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>The time to live of the set action.</p>
   * @return ttl
  **/
      @jakarta.annotation.Nullable
  ...
  public CloudWorkloadSecurityAgentRuleActionSet value(CloudWorkloadSecurityAgentRuleActionSetValue value) {
    this.value = value;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CloudWorkloadSecurityAgentRuleActionSet cloudWorkloadSecurityAgentRuleActionSet = (CloudWorkloadSecurityAgentRuleActionSet) o;
    return Objects.equals(this.append, cloudWorkloadSecurityAgentRuleActionSet.append) && Objects.equals(this.defaultValue, cloudWorkloadSecurityAgentRuleActionSet.defaultValue) && Objects.equals(this.expression, cloudWorkloadSecurityAgentRuleActionSet.expression) && Objects.equals(this.field, cloudWorkloadSecurityAgentRuleActionSet.field) && Objects.equals(this.inherited, cloudWorkloadSecurityAgentRuleActionSet.inherited) && Objects.equals(this.name, cloudWorkloadSecurityAgentRuleActionSet.name) && Objects.equals(this.scope, cloudWorkloadSecurityAgentRuleActionSet.scope) && Objects.equals(this.size, cloudWorkloadSecurityAgentRuleActionSet.size) && Objects.equals(this.ttl, cloudWorkloadSecurityAgentRuleActionSet.ttl) && Objects.equals(this.value, cloudWorkloadSecurityAgentRuleActionSet.value) && Objects.equals(this.additionalProperties, cloudWorkloadSecurityAgentRuleActionSet.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(append,defaultValue,expression,field,inherited,name,scope,size,ttl,value, additionalProperties);
  }
