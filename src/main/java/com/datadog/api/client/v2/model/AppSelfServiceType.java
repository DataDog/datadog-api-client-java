...
public class AppSelfServiceType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("selfService"));
  ...
  public static class AppSelfServiceTypeSerializer extends StdSerializer<AppSelfServiceType> {
      ...
      @Override
      public void serialize(AppSelfServiceType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
