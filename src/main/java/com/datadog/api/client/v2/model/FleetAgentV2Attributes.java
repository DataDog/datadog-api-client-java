...
public class FleetAgentV2Attributes {
  ...
  **/
  ...
  /**
   * <p>The primary OpenTelemetry collector version, if applicable.</p>
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentVersion,apiKeyName,apiKeyUuid,cloudProvider,clusterName,datadogDataCenter,ecsFargateClusterName,ecsFargateTaskArn,enabledProducts,env,firstSeenAt,fleetPolicies,hostname,instrumentationErrorCounts,instrumentationStatus,integrations,ipAddresses,isSingleStepInstrumentationEnabled,lastRestartAt,os,otelCollectorDeploymentTypes,otelCollectorDistributions,otelCollectorVersion,otelCollectorVersions,otelResourceAttributes,podName,remoteAgentManagement,remoteConfigStatus,services,tags,team, additionalProperties);
  }
