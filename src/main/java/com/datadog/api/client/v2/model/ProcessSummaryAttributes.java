...
public class ProcessSummaryAttributes {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cmdline, processSummaryAttributes.cmdline)
        ...
        && Objects.equals(this.additionalProperties, processSummaryAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        cmdline, host, pid, ppid, start, tags, timestamp, user, additionalProperties);
  }
