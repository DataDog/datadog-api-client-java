...
public class CaseViewAttributes {
  ...
  /**
   * <p>Timestamp when the view was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>Timestamp when the view was last modified.</p>
   * @return modifiedAt
  **/
  ...
  /**
   * <p>A human-readable name for the view, displayed in the Case Management UI.</p>
   * @return name
  **/
  ...
  **/
  ...
  /**
   * <p>The search query that determines which cases appear in this view. Uses the same syntax as the Case Management search bar (for example, <code>status:open priority:P1</code>).</p>
   * @return query
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.createdAt, caseViewAttributes.createdAt) && Objects.equals(this.modifiedAt, caseViewAttributes.modifiedAt) && Objects.equals(this.name, caseViewAttributes.name) && Objects.equals(this.npRuleId, caseViewAttributes.npRuleId) && Objects.equals(this.query, caseViewAttributes.query) && Objects.equals(this.additionalProperties, caseViewAttributes.additionalProperties);
  }
