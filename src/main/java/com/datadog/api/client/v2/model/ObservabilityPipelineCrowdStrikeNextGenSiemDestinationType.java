...
public class ObservabilityPipelineCrowdStrikeNextGenSiemDestinationType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues =
      new HashSet<String>(Arrays.asList("crowdstrike_next_gen_siem"));
  ...
  public static class ObservabilityPipelineCrowdStrikeNextGenSiemDestinationTypeSerializer
      extends StdSerializer<ObservabilityPipelineCrowdStrikeNextGenSiemDestinationType> {
    public ObservabilityPipelineCrowdStrikeNextGenSiemDestinationTypeSerializer(
        Class<ObservabilityPipelineCrowdStrikeNextGenSiemDestinationType> t) {
      super(t);
    }
