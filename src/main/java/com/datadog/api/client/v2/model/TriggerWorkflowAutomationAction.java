...
/**
   * <p>Triggers a Workflow Automation.</p>
 */
@JsonPropertyOrder({
...
public class TriggerWorkflowAutomationAction {
  ...
  private TriggerWorkflowAutomationActionType type = TriggerWorkflowAutomationActionType.TRIGGER_WORKFLOW_AUTOMATION;
  ...
  public TriggerWorkflowAutomationAction(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_TYPE)TriggerWorkflowAutomationActionType type) {
        this.handle = handle;
        this.type = type;
  ...
  /**
   * <p>The handle of the Workflow Automation to trigger.</p>
   * @return handle
  **/
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TriggerWorkflowAutomationAction triggerWorkflowAutomationAction = (TriggerWorkflowAutomationAction) o;
    return Objects.equals(this.handle, triggerWorkflowAutomationAction.handle) && Objects.equals(this.type, triggerWorkflowAutomationAction.type) && Objects.equals(this.additionalProperties, triggerWorkflowAutomationAction.additionalProperties);
  }
