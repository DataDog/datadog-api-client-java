...
/**
   * <p>A paginated list of seat user resources with associated pagination metadata.</p>
 */
@JsonPropertyOrder({
  SeatUserDataArray.JSON_PROPERTY_DATA,
  SeatUserDataArray.JSON_PROPERTY_META
})
...
public class SeatUserDataArray {
  ...
  private List<SeatUserData> data = null;
  ...
  **/
  ...
  /**
   * <p>Pagination metadata for the seat users list response.</p>
   * @return meta
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, seatUserDataArray.data) && Objects.equals(this.meta, seatUserDataArray.meta) && Objects.equals(this.additionalProperties, seatUserDataArray.additionalProperties);
  }
