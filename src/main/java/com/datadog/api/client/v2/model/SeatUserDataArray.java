...
public class SeatUserDataArray {
  ...
  private JsonNullable<List<SeatUserData>> data = JsonNullable.<List<SeatUserData>>undefined();

  public static final String JSON_PROPERTY_META = "meta";
  private SeatUserMeta meta;

  public SeatUserDataArray data(List<SeatUserData> data) {
    this.data = JsonNullable.<List<SeatUserData>>of(data);
    return this;
  }

  public SeatUserDataArray addDataItem(SeatUserData dataItem) {
    if (this.data == null || !this.data.isPresent()) {
      this.data = JsonNullable.<List<SeatUserData>>of(new ArrayList<>());
    }
    try {
  ...
  public JsonNullable<List<SeatUserData>> getData_JsonNullable() {
    return data;
  }

  @JsonProperty(JSON_PROPERTY_DATA)
  public void setData_JsonNullable(JsonNullable<List<SeatUserData>> data) {
    this.data = data;
  }
