...
/**
   * <p>The data object for a degradation update.</p>
 */
@JsonPropertyOrder({
...
public class DegradationUpdateData {
  ...
  **/
  ...
  /**
   * <p>The ID of the degradation update.</p>
   * @return id
  **/
      @jakarta.annotation.Nullable
