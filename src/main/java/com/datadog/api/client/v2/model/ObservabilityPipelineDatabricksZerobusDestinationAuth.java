...
public class ObservabilityPipelineDatabricksZerobusDestinationAuth {
  ...
  /**
   * <p>Your service principal application ID (UUID).</p>
   * @return clientId
  **/
  ...
  public ObservabilityPipelineDatabricksZerobusDestinationAuth clientSecretKey(String clientSecretKey) {
    this.clientSecretKey = clientSecretKey;
    return this;
  }

  /**
   * <p>Name of the environment variable or secret that holds the OAuth client secret used to authenticate with the Databricks ingestion endpoint.</p>
  ...
  **/
   ...
   */
  @JsonAnySetter
  public ObservabilityPipelineDatabricksZerobusDestinationAuth putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ObservabilityPipelineDatabricksZerobusDestinationAuth observabilityPipelineDatabricksZerobusDestinationAuth = (ObservabilityPipelineDatabricksZerobusDestinationAuth) o;
    return Objects.equals(this.clientId, observabilityPipelineDatabricksZerobusDestinationAuth.clientId) && Objects.equals(this.clientSecretKey, observabilityPipelineDatabricksZerobusDestinationAuth.clientSecretKey) && Objects.equals(this.additionalProperties, observabilityPipelineDatabricksZerobusDestinationAuth.additionalProperties);
  }
