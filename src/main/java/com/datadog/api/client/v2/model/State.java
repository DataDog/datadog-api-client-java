...
public class State extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("pass", "fail", "skip"));
  ...
  public static class StateSerializer extends StdSerializer<State> {
      ...
      @Override
      public void serialize(State value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
