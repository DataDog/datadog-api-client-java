...
public class IncidentUserDefinedFieldMetadata {
  ...
  public IncidentUserDefinedFieldMetadata(
            ...
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH_LIMIT_PARAM)String searchLimitParam,
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH_PARAMS)Map<String, Object> searchParams,
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH_QUERY_PARAM)String searchQueryParam,
            @JsonProperty(required=true, value=JSON_PROPERTY_SEARCH_RESULT_PATH)String searchResultPath,
  ...
  /**
   * <p>The category of the autocomplete source.</p>
   * @return category
  **/
  ...
  /**
   * <p>The query parameter used to limit the number of autocomplete results.</p>
  ...
  **/
  ...
  /**
   * <p>Additional query parameters to include in the search URL.</p>
   * @return searchParams
  **/
  ...
  /**
   * <p>The query parameter used to pass typed input to the search URL.</p>
  ...
  **/
  ...
  /**
   * <p>The JSON path to the results in the response body.</p>
  ...
  **/
  ...
  /**
   * <p>The URL used to populate autocomplete options.</p>
   * @return searchUrl
  **/
  ...
  public boolean equals(Object o) {
    ...
    IncidentUserDefinedFieldMetadata incidentUserDefinedFieldMetadata = (IncidentUserDefinedFieldMetadata) o;
    return Objects.equals(this.category, incidentUserDefinedFieldMetadata.category) && Objects.equals(this.searchLimitParam, incidentUserDefinedFieldMetadata.searchLimitParam) && Objects.equals(this.searchParams, incidentUserDefinedFieldMetadata.searchParams) && Objects.equals(this.searchQueryParam, incidentUserDefinedFieldMetadata.searchQueryParam) && Objects.equals(this.searchResultPath, incidentUserDefinedFieldMetadata.searchResultPath) && Objects.equals(this.searchUrl, incidentUserDefinedFieldMetadata.searchUrl) && Objects.equals(this.additionalProperties, incidentUserDefinedFieldMetadata.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(category,searchLimitParam,searchParams,searchQueryParam,searchResultPath,searchUrl, additionalProperties);
  }
