...
/**
   * <p>Payload schema when adding a web integration account.</p>
 */
@JsonPropertyOrder({
  WebIntegrationAccountCreateRequest.JSON_PROPERTY_DATA
})
...
public class WebIntegrationAccountCreateRequest {
  ...
  @JsonCreator
  public WebIntegrationAccountCreateRequest(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)WebIntegrationAccountCreateRequestData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    WebIntegrationAccountCreateRequest webIntegrationAccountCreateRequest = (WebIntegrationAccountCreateRequest) o;
    return Objects.equals(this.data, webIntegrationAccountCreateRequest.data) && Objects.equals(this.additionalProperties, webIntegrationAccountCreateRequest.additionalProperties);
  }
