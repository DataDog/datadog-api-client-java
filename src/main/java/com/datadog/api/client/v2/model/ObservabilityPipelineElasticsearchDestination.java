...
/**
   * <p>The <code>elasticsearch</code> destination writes logs or metrics to an Elasticsearch cluster.</p>
...
public class ObservabilityPipelineElasticsearchDestination {
  ...
  **/
  ...
  /**
   * <p>The name of the index to write events to in Elasticsearch.</p>
   * @return bulkIndex
  **/
      @jakarta.annotation.Nullable
  ...
  public ObservabilityPipelineElasticsearchDestination compression(ObservabilityPipelineElasticsearchDestinationCompression compression) {
  ...
  **/
  ...
  /**
   * <p>The name of the field used as the document ID in Elasticsearch.</p>
   * @return idKey
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>The name of an Elasticsearch ingest pipeline to apply to events before indexing.</p>
   * @return pipeline
  **/
      @jakarta.annotation.Nullable
  ...
  public ObservabilityPipelineElasticsearchDestination requestRetryPartial(Boolean requestRetryPartial) {
    this.requestRetryPartial = requestRetryPartial;
    return this;
  }

  /**
   * <p>When <code>true</code>, retries failed partial bulk requests when some events in a batch fail while others succeed.</p>
