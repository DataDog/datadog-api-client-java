...
/**
   * <p>Payload with API-returned permissions.</p>
 */
@JsonPropertyOrder({
  PermissionsResponse.JSON_PROPERTY_DATA
})
...
public class PermissionsResponse {
  ...
  public PermissionsResponse addDataItem(Permission dataItem) {
    if (this.data == null) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public PermissionsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, permissionsResponse.data) && Objects.equals(this.additionalProperties, permissionsResponse.additionalProperties);
  }
