...
/**
   * <p>The definition of <code>RulesetRespDataAttributesRulesItemsReferenceTable</code> object.</p>
 */
@JsonPropertyOrder({
...
public class RulesetRespDataAttributesRulesItemsReferenceTable {
  ...
  private List<RulesetRespDataAttributesRulesItemsReferenceTableFieldPairsItems> fieldPairs = new ArrayList<>();
  ...
  @JsonCreator
  public RulesetRespDataAttributesRulesItemsReferenceTable(
            @JsonProperty(required=true, value=JSON_PROPERTY_FIELD_PAIRS)List<RulesetRespDataAttributesRulesItemsReferenceTableFieldPairsItems> fieldPairs,
  ...
  public RulesetRespDataAttributesRulesItemsReferenceTable caseInsensitivity(Boolean caseInsensitivity) {
  ...
  **/
  ...
  public RulesetRespDataAttributesRulesItemsReferenceTable fieldPairs(List<RulesetRespDataAttributesRulesItemsReferenceTableFieldPairsItems> fieldPairs) {
    this.fieldPairs = fieldPairs;
  ...
  public RulesetRespDataAttributesRulesItemsReferenceTable addFieldPairsItem(RulesetRespDataAttributesRulesItemsReferenceTableFieldPairsItems fieldPairsItem) {
  ...
  **/
  ...
  public void setFieldPairs(List<RulesetRespDataAttributesRulesItemsReferenceTableFieldPairsItems> fieldPairs) {
    this.fieldPairs = fieldPairs;
  }
  ...
  **/
  ...
  public RulesetRespDataAttributesRulesItemsReferenceTable ifTagExists(DataAttributesRulesItemsIfTagExists ifTagExists) {
  ...
  **/
  ...
  public RulesetRespDataAttributesRulesItemsReferenceTable addSourceKeysItem(String sourceKeysItem) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public RulesetRespDataAttributesRulesItemsReferenceTable putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RulesetRespDataAttributesRulesItemsReferenceTable rulesetRespDataAttributesRulesItemsReferenceTable = (RulesetRespDataAttributesRulesItemsReferenceTable) o;
    return Objects.equals(this.caseInsensitivity, rulesetRespDataAttributesRulesItemsReferenceTable.caseInsensitivity) && Objects.equals(this.fieldPairs, rulesetRespDataAttributesRulesItemsReferenceTable.fieldPairs) && Objects.equals(this.ifNotExists, rulesetRespDataAttributesRulesItemsReferenceTable.ifNotExists) && Objects.equals(this.ifTagExists, rulesetRespDataAttributesRulesItemsReferenceTable.ifTagExists) && Objects.equals(this.sourceKeys, rulesetRespDataAttributesRulesItemsReferenceTable.sourceKeys) && Objects.equals(this.tableName, rulesetRespDataAttributesRulesItemsReferenceTable.tableName) && Objects.equals(this.additionalProperties, rulesetRespDataAttributesRulesItemsReferenceTable.additionalProperties);
  }
