 ...
 */
@JsonPropertyOrder({
  SecurityMonitoringRuleConvertBulkAttributes.JSON_PROPERTY_RULE_IDS
})
...
public class SecurityMonitoringRuleConvertBulkAttributes {
  ...
  /**
   * <p>List of rule IDs to convert. Each rule will be included in the resulting ZIP file
   * as a separate Terraform file.</p>
   * @return ruleIds
  **/
   ...
   */
  @JsonAnySetter
  public SecurityMonitoringRuleConvertBulkAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityMonitoringRuleConvertBulkAttributes securityMonitoringRuleConvertBulkAttributes = (SecurityMonitoringRuleConvertBulkAttributes) o;
    return Objects.equals(this.ruleIds, securityMonitoringRuleConvertBulkAttributes.ruleIds) && Objects.equals(this.additionalProperties, securityMonitoringRuleConvertBulkAttributes.additionalProperties);
  }
