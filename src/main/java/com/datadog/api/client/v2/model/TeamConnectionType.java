...
public class TeamConnectionType extends ModelEnum<String> {
  ...
  private static final Set<String> allowedValues = new HashSet<String>(Arrays.asList("team_connection"));

  public static final TeamConnectionType TEAM_CONNECTION = new TeamConnectionType("team_connection");
  ...
  public static class TeamConnectionTypeSerializer extends StdSerializer<TeamConnectionType> {
      ...
      @Override
      public void serialize(TeamConnectionType value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
