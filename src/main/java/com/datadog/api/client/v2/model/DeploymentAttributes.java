 ...
 */
@JsonPropertyOrder({
  DeploymentAttributes.JSON_PROPERTY_APP_VERSION_ID
})
...
public class DeploymentAttributes {
  ...
  /**
   * <p>The version ID of the app that was published. For an unpublished app, this is always the nil UUID (<code>00000000-0000-0000-0000-000000000000</code>).</p>
   * @return appVersionId
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appVersionId, deploymentAttributes.appVersionId) && Objects.equals(this.additionalProperties, deploymentAttributes.additionalProperties);
  }
