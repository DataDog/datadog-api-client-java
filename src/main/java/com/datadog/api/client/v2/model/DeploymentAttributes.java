...
public class DeploymentAttributes {
  ...
  /**
   * The version ID of the app that was published. For an unpublished app, this will always be the
   * nil UUID, i.e. <code>00000000-0000-0000-0000-000000000000</code>.
   *
   * @return appVersionId
   */
