...
public class IoCTriageWriteResponseAttributes {
  ...
  /**
   * <p>Timestamp when the triage record was created.</p>
   * @return createdAt
  **/
  ...
  /**
   * <p>The indicator value that was triaged.</p>
   * @return indicator
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  /**
   * <p>Timestamp when the triage state was set.</p>
   * @return triagedAt
  **/
      @jakarta.annotation.Nullable
  ...
  /**
   * <p>UUID of the user who set the triage state.</p>
   * @return triagedBy
  **/
      @jakarta.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    IoCTriageWriteResponseAttributes ioCTriageWriteResponseAttributes = (IoCTriageWriteResponseAttributes) o;
    return Objects.equals(this.createdAt, ioCTriageWriteResponseAttributes.createdAt) && Objects.equals(this.indicator, ioCTriageWriteResponseAttributes.indicator) && Objects.equals(this.triageState, ioCTriageWriteResponseAttributes.triageState) && Objects.equals(this.triagedAt, ioCTriageWriteResponseAttributes.triagedAt) && Objects.equals(this.triagedBy, ioCTriageWriteResponseAttributes.triagedBy) && Objects.equals(this.additionalProperties, ioCTriageWriteResponseAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(createdAt,indicator,triageState,triagedAt,triagedBy, additionalProperties);
  }
