...
/**
   * <p>Attributes of an OCI tenancy integration configuration, including authentication details, region settings, and collection options.</p>
 */
@JsonPropertyOrder({
...
public class TenancyConfigDataAttributes {
  ...
  /**
   * <p>The identifier of the billing plan associated with the OCI tenancy.</p>
   * maximum: 2147483647
  ...
  **/
  ...
  /**
   * <p>Log collection configuration for an OCI tenancy, indicating which compartments and services have log collection enabled.</p>
   * @return logsConfig
  **/
      @jakarta.annotation.Nullable
  ...
  public TenancyConfigDataAttributes metricsConfig(TenancyConfigDataAttributesMetricsConfig metricsConfig) {
  ...
  /**
   * <p>Metrics collection configuration for an OCI tenancy, indicating which compartments and services are included or excluded.</p>
  ...
  **/
  ...
  /**
   * <p>The name of the parent OCI tenancy, if applicable.</p>
  ...
  **/
  ...
  public TenancyConfigDataAttributes regionsConfig(TenancyConfigDataAttributesRegionsConfig regionsConfig) {
  ...
  /**
   * <p>Region configuration for an OCI tenancy, indicating which regions are available, enabled, or disabled for data collection.</p>
  ...
  **/
  ...
  /**
   * <p>The human-readable name of the OCI tenancy.</p>
   * @return tenancyName
  **/
      @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingPlanId, tenancyConfigDataAttributes.billingPlanId) && Objects.equals(this.configVersion, tenancyConfigDataAttributes.configVersion) && Objects.equals(this.costCollectionEnabled, tenancyConfigDataAttributes.costCollectionEnabled) && Objects.equals(this.ddCompartmentId, tenancyConfigDataAttributes.ddCompartmentId) && Objects.equals(this.ddStackId, tenancyConfigDataAttributes.ddStackId) && Objects.equals(this.homeRegion, tenancyConfigDataAttributes.homeRegion) && Objects.equals(this.logsConfig, tenancyConfigDataAttributes.logsConfig) && Objects.equals(this.metricsConfig, tenancyConfigDataAttributes.metricsConfig) && Objects.equals(this.parentTenancyName, tenancyConfigDataAttributes.parentTenancyName) && Objects.equals(this.regionsConfig, tenancyConfigDataAttributes.regionsConfig) && Objects.equals(this.resourceCollectionEnabled, tenancyConfigDataAttributes.resourceCollectionEnabled) && Objects.equals(this.tenancyName, tenancyConfigDataAttributes.tenancyName) && Objects.equals(this.userOcid, tenancyConfigDataAttributes.userOcid) && Objects.equals(this.additionalProperties, tenancyConfigDataAttributes.additionalProperties);
  }


  @Override
  public int hashCode() {
    return Objects.hash(billingPlanId,configVersion,costCollectionEnabled,ddCompartmentId,ddStackId,homeRegion,logsConfig,metricsConfig,parentTenancyName,regionsConfig,resourceCollectionEnabled,tenancyName,userOcid, additionalProperties);
  }
