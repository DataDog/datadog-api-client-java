...
public class EntityResponseDataRelationships {
  ...
  public EntityResponseDataRelationships incidents(
      EntityResponseDataRelationshipsIncidents incidents) {
  ...
  public EntityResponseDataRelationships rawSchema(
      EntityResponseDataRelationshipsRawSchema rawSchema) {
  ...
  public EntityResponseDataRelationships relatedEntities(
      EntityResponseDataRelationshipsRelatedEntities relatedEntities) {
  ...
  public boolean equals(Object o) {
    ...
    EntityResponseDataRelationships entityResponseDataRelationships =
        (EntityResponseDataRelationships) o;
    return Objects.equals(this.incidents, entityResponseDataRelationships.incidents)
        && Objects.equals(this.oncalls, entityResponseDataRelationships.oncalls)
        && Objects.equals(this.rawSchema, entityResponseDataRelationships.rawSchema)
        && Objects.equals(this.relatedEntities, entityResponseDataRelationships.relatedEntities)
        && Objects.equals(this.schema, entityResponseDataRelationships.schema)
        && Objects.equals(
            this.additionalProperties, entityResponseDataRelationships.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(
        incidents, oncalls, rawSchema, relatedEntities, schema, additionalProperties);
  }
