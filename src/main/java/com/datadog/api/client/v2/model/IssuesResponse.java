...
@JsonPropertyOrder({IssuesResponse.JSON_PROPERTY_DATA, IssuesResponse.JSON_PROPERTY_INCLUDED})
@jakarta.annotation.Generated(
    value = "https://github.com/DataDog/datadog-api-client-java/blob/master/.generator")
public class IssuesResponse {
  @JsonIgnore public boolean unparsed = false;
  public static final String JSON_PROPERTY_DATA = "data";
  private List<Issue> data = null;
  ...
  public IssuesResponse included(List<IssueIncluded> included) {
  ...
  public IssuesResponse addIncludedItem(IssueIncluded includedItem) {
  ...
  /** Return true if this IssuesResponse object is equal to o. */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, issuesResponse.data)
        && Objects.equals(this.included, issuesResponse.included)
