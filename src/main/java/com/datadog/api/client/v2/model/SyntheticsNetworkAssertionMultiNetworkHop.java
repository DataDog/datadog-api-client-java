...
public class SyntheticsNetworkAssertionMultiNetworkHop {
  ...
  private SyntheticsNetworkAssertionMultiNetworkHopType type =
      SyntheticsNetworkAssertionMultiNetworkHopType.MULTI_NETWORK_HOP;
  ...
  public SyntheticsNetworkAssertionMultiNetworkHop(
      ...
      @JsonProperty(required = true, value = JSON_PROPERTY_TYPE)
          SyntheticsNetworkAssertionMultiNetworkHopType type) {
  ...
  public SyntheticsNetworkAssertionMultiNetworkHop operator(
      SyntheticsNetworkAssertionOperator operator) {
    this.operator = operator;
    this.unparsed |= !operator.isValid();
    return this;
  ...
  public SyntheticsNetworkAssertionMultiNetworkHop property(
      SyntheticsNetworkAssertionProperty property) {
    this.property = property;
    this.unparsed |= !property.isValid();
    return this;
  ...
  public SyntheticsNetworkAssertionMultiNetworkHop type(
      SyntheticsNetworkAssertionMultiNetworkHopType type) {
    this.type = type;
    this.unparsed |= !type.isValid();
    return this;
  ...
  public boolean equals(Object o) {
    ...
    SyntheticsNetworkAssertionMultiNetworkHop syntheticsNetworkAssertionMultiNetworkHop =
        (SyntheticsNetworkAssertionMultiNetworkHop) o;
    return Objects.equals(this.operator, syntheticsNetworkAssertionMultiNetworkHop.operator)
        && Objects.equals(this.property, syntheticsNetworkAssertionMultiNetworkHop.property)
        && Objects.equals(this.target, syntheticsNetworkAssertionMultiNetworkHop.target)
        && Objects.equals(this.type, syntheticsNetworkAssertionMultiNetworkHop.type)
        && Objects.equals(
            this.additionalProperties,
            syntheticsNetworkAssertionMultiNetworkHop.additionalProperties);
  }
