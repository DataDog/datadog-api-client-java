...
public class CreateRulesetRequestDataAttributesRulesItemsQuery {
  ...
  @JsonCreator
  public CreateRulesetRequestDataAttributesRulesItemsQuery(
            @JsonProperty(required=true, value=JSON_PROPERTY_ADDITION)CreateRulesetRequestDataAttributesRulesItemsQueryAddition addition,
  ...
  public CreateRulesetRequestDataAttributesRulesItemsQuery addition(CreateRulesetRequestDataAttributesRulesItemsQueryAddition addition) {
    this.addition = addition;
        if (addition != null) {
    this.unparsed |= addition.unparsed;
    }
  ...
  /**
   * <p>The definition of <code>CreateRulesetRequestDataAttributesRulesItemsQueryAddition</code> object.</p>
   * @return addition
  **/
  ...
  public CreateRulesetRequestDataAttributesRulesItemsQuery caseInsensitivity(Boolean caseInsensitivity) {
  ...
  **/
  ...
  public CreateRulesetRequestDataAttributesRulesItemsQuery ifTagExists(DataAttributesRulesItemsIfTagExists ifTagExists) {
  ...
  **/
   ...
   */
  @JsonAnySetter
  public CreateRulesetRequestDataAttributesRulesItemsQuery putAdditionalProperty(String key, Object value) {
