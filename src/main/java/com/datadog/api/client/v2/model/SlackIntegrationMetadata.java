...
/**
   * <p>Incident integration metadata for the Slack integration.</p>
 */
@JsonPropertyOrder({
  SlackIntegrationMetadata.JSON_PROPERTY_CHANNELS
})
...
public class SlackIntegrationMetadata {
  ...
  @JsonCreator
  public SlackIntegrationMetadata(
            @JsonProperty(required=true, value=JSON_PROPERTY_CHANNELS)List<SlackIntegrationMetadataChannelItem> channels) {
  ...
  public SlackIntegrationMetadata addChannelsItem(SlackIntegrationMetadataChannelItem channelsItem) {
  ...
  /**
   * <p>Array of Slack channels in this integration metadata.</p>
   * @return channels
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channels, slackIntegrationMetadata.channels) && Objects.equals(this.additionalProperties, slackIntegrationMetadata.additionalProperties);
  }
