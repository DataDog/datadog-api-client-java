...
/**
   * <p>Relationship between team membership and team</p>
 */
@JsonPropertyOrder({
  RelationshipToUserTeamTeam.JSON_PROPERTY_DATA
})
...
public class RelationshipToUserTeamTeam {
  ...
  @JsonCreator
  public RelationshipToUserTeamTeam(
            @JsonProperty(required=true, value=JSON_PROPERTY_DATA)RelationshipToUserTeamTeamData data) {
        this.data = data;
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, relationshipToUserTeamTeam.data) && Objects.equals(this.additionalProperties, relationshipToUserTeamTeam.additionalProperties);
  }
