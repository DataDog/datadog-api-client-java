...
public class CIAppPipelineEventStep {
  ...
  @JsonProperty(JSON_PROPERTY_JOB_NAME)
  public void setJobName_JsonNullable(JsonNullable<String> jobName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.end, ciAppPipelineEventStep.end)
        && Objects.equals(this.error, ciAppPipelineEventStep.error)
        && Objects.equals(this.git, ciAppPipelineEventStep.git)
        && Objects.equals(this.id, ciAppPipelineEventStep.id)
        && Objects.equals(this.jobId, ciAppPipelineEventStep.jobId)
        && Objects.equals(this.jobName, ciAppPipelineEventStep.jobName)
        && Objects.equals(this.level, ciAppPipelineEventStep.level)
        && Objects.equals(this.metrics, ciAppPipelineEventStep.metrics)
        && Objects.equals(this.name, ciAppPipelineEventStep.name)
        && Objects.equals(this.node, ciAppPipelineEventStep.node)
        && Objects.equals(this.parameters, ciAppPipelineEventStep.parameters)
        && Objects.equals(this.pipelineName, ciAppPipelineEventStep.pipelineName)
        && Objects.equals(this.pipelineUniqueId, ciAppPipelineEventStep.pipelineUniqueId)
        && Objects.equals(this.stageId, ciAppPipelineEventStep.stageId)
        && Objects.equals(this.stageName, ciAppPipelineEventStep.stageName)
