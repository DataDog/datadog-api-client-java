...
/**
   * <p>Parameters for an LLM inference request.</p>
 */
@JsonPropertyOrder({
...
public class LLMObsIntegrationInferenceRequest {
  ...
  public LLMObsIntegrationInferenceRequest anthropicMetadata(LLMObsAnthropicMetadata anthropicMetadata) {
  ...
  **/
  ...
  public LLMObsIntegrationInferenceRequest azureOpenaiMetadata(LLMObsAzureOpenAIMetadata azureOpenaiMetadata) {
  ...
  **/
  ...
  /**
   * <p>Penalty for token frequency to reduce repetition.</p>
  ...
  **/
  ...
  /**
   * <p>JSON schema for structured output, if supported by the model.</p>
   * @return jsonSchema
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  /**
   * <p>Maximum number of completion tokens to generate (alternative to max_tokens for some providers).</p>
  ...
  **/
  ...
  /**
   * <p>The model identifier to use for inference.</p>
   * @return modelId
  **/
  ...
  **/
  ...
  /**
   * <p>Penalty for token presence to encourage topic diversity.</p>
  ...
  **/
  ...
  /**
   * <p>Sampling temperature between 0 and 2. Higher values produce more random output.</p>
   * @return temperature
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  **/
  ...
  /**
   * <p>Nucleus sampling probability mass.</p>
   * @return topP
  **/
      @jakarta.annotation.Nullable
      @JsonIgnore
  ...
  public LLMObsIntegrationInferenceRequest vertexAiMetadata(LLMObsVertexAIMetadata vertexAiMetadata) {
