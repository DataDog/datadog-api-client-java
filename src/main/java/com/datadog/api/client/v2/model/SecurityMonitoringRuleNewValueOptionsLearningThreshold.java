 ...
 */
@JsonSerialize(using = SecurityMonitoringRuleNewValueOptionsLearningThreshold.SecurityMonitoringRuleNewValueOptionsLearningThresholdSerializer.class)
public class SecurityMonitoringRuleNewValueOptionsLearningThreshold {
  ...
  public static class SecurityMonitoringRuleNewValueOptionsLearningThresholdSerializer extends StdSerializer<SecurityMonitoringRuleNewValueOptionsLearningThreshold> {
      public SecurityMonitoringRuleNewValueOptionsLearningThresholdSerializer(Class<SecurityMonitoringRuleNewValueOptionsLearningThreshold> t) {
          super(t);
      }
      ...
      @Override
      public void serialize(SecurityMonitoringRuleNewValueOptionsLearningThreshold value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
  ...
  /**
   * Return true if this SecurityMonitoringRuleNewValueOptionsLearningThreshold object is equal to o.
   */
  @Override
