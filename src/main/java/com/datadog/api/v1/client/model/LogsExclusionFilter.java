...
public class LogsExclusionFilter {
  ...
  **/
   ...
   * @return sampleRate
  **/
  @ApiModelProperty(example = "1.0", required = true, value = "Sample rate to apply to logs going through this exclusion filter, a value of 1.0 excludes all logs matching the query.")
