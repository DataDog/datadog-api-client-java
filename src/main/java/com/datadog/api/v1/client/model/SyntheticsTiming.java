 ...
 */
@ApiModel(
    description = "Object containing all metrics and their values collected for a Synthetic API test. Learn more about those metrics in [Synthetics documentation](https://docs.datadoghq.com/synthetics/#metrics)."
)
@JsonPropertyOrder(
    {
...
public class SyntheticsTiming {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.dns, syntheticsTiming.dns) &&
