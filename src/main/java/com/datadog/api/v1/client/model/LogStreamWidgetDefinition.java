...
public class LogStreamWidgetDefinition {
    ...
    @JsonCreator
    public LogStreamWidgetDefinition(@JsonProperty(required = true, value = JSON_PROPERTY_TYPE) LogStreamWidgetDefinitionType type) {
        this.type = type;
    ...
    @ApiModelProperty(
        ...
        value = "An array of index names to query in the stream. Use [] to query all indexes at once."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.columns, logStreamWidgetDefinition.columns) &&
