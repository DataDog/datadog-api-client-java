...
public class LogsListRequest {
    ...
    @JsonCreator
    public LogsListRequest(@JsonProperty(required = true, value = JSON_PROPERTY_TIME) LogsListRequestTime time) {
        this.time = time;
    ...
    @ApiModelProperty(
        ...
        value = "The log index on which the request is performed. For multi-index organizations, the default is all live indexes. Historical indexes of rehydrated logs must be specified."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Hash identifier of the first log to return in the list, available in a log `id` attribute. This parameter is used for the pagination feature.  **Note**: This parameter is ignored if the corresponding log is out of the scope of the specified time window."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.index, logsListRequest.index) &&
