...
@JsonPropertyOrder({ HostMuteSettings.JSON_PROPERTY_END, HostMuteSettings.JSON_PROPERTY_MESSAGE, HostMuteSettings.JSON_PROPERTY_OVERRIDE })
...
public class HostMuteSettings {
    ...
    @ApiModelProperty(
        example = "1579098130",
        value = "POSIX timestamp in seconds when the host is unmuted. If omitted, the host remains muted until explicitly unmuted."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.end, hostMuteSettings.end) &&
