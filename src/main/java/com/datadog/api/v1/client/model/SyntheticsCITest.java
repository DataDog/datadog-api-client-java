...
public class SyntheticsCITest {
    ...
    @JsonCreator
    public SyntheticsCITest(@JsonProperty(required = true, value = JSON_PROPERTY_PUBLIC_ID) String publicId) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.allowInsecureCertificates, syntheticsCITest.allowInsecureCertificates) &&
