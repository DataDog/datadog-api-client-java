...
public class SLOHistorySLIData {
    ...
    @ApiModelProperty(
        example = "{\"30d\":1,\"7d\":2}",
        value = "A mapping of threshold `timeframe` to number of accurate decimals, regardless of the from && to timestamp."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.errorBudgetRemaining, slOHistorySLIData.errorBudgetRemaining) &&
