 ...
 */
@ApiModel(
    description = "Object that contains the new private location, the public key for result encryption, and the configuration skeleton."
)
@JsonPropertyOrder(
    {
...
public class SyntheticsPrivateLocationCreationResponse {
    ...
    @ApiModelProperty(
        value = "Configuration skeleton for the private location. See installation instructions of the private location on how to use this configuration."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.config, syntheticsPrivateLocationCreationResponse.config) &&
