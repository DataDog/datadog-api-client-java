...
public class UsageSummaryResponse {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Azure app services using APM over all hours in the current months all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct APM hosts over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of the number of functions that executed 1 or more times each hour in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Azure app services over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of the high-water marks of all distinct containers over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average number of Cloud Security Posture Management containers over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of the the high-water marks of Cloud Security Posture Management containers over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Security Posture Management hosts over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average number of distinct custom metrics over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of all distinct Cloud Workload Security containers over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Workload Security hosts over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Database Monitoring hosts over all hours in the current month for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of all distinct Database Monitoring Normalized Queries over all hours in the current month for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of the high-water marks of all Fargate tasks over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows sum of the the high-water marks of incident management monthly active users in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct infrastructure hosts over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the the most recent hour in the current months for all organizations for which all usages were calculated."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all live logs indexed over all hours in the current months for all organizations (data available as of December 1, 2020)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all live logs bytes ingested over all hours in the current months for all organizations (data available as of December 1, 2020)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all mobile RUM Sessions on Android over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct Networks hosts over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all rehydrated logs indexed over all hours in the current months for all organizations (data available as of December 1, 2020)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all rehydrated logs bytes ingested over all hours in the current months for all organizations (data available as of December 1, 2020)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of RUM Sessions (browser and mobile) over all hours in the current months for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current month for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current month for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all tracing without limits bytes ingested over all hours in the current months for all organizations."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.agentHostTop99pSum, usageSummaryResponse.agentHostTop99pSum) &&
    ...
    public String toString() {
        ...
        sb
            .append("    incidentManagementMonthlyActiveUsersHwmSum: ")
        ...
        sb
            .append("    syntheticsBrowserCheckCallsCountAggSum: ")
