...
public class OrganizationCreateBody {
    ...
    @JsonCreator
    public OrganizationCreateBody(@JsonProperty(required = true, value = JSON_PROPERTY_NAME) String name) {
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.billing, organizationCreateBody.billing) &&
