...
public class SyntheticsBrowserTest {
    ...
    @JsonCreator
    public SyntheticsBrowserTest(@JsonProperty(required = true, value = JSON_PROPERTY_MESSAGE) String message) {
    ...
    @ApiModelProperty(
        example = "",
        required = true,
        value = "Notification message associated with the test. Message can either be text or an empty string."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.config, syntheticsBrowserTest.config) &&
