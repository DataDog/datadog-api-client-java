...
public class ServiceSummaryWidgetDefinition implements WidgetDefinition {
  ...
  private String type = "trace_service";
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(example = "trace_service", required = true, value = "Type of the widget.")
