 ...
 */
@ApiModel(description = "APM resource stats query using formulas and functions.")
@JsonPropertyOrder(
    {
...
public class FormulaAndFunctionApmResourceStatsQueryDefinition {
    ...
    @ApiModelProperty(value = "Array of fields to group results by.")
     ...
     * @return name
     **/
    @ApiModelProperty(example = "query_errors", required = true, value = "Name of this query to use in formulas.")
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "cassandra.query", value = "Name of operation on service.")
    ...
    @ApiModelProperty(
        example = "datacenter",
        value = "Name of the second primary tag used within APM. Required when `primary_tag_value` is specified. See https://docs.datadoghq.com/tracing/guide/setting_primary_tags_to_scope/#add-a-second-primary-tag-in-datadog"
    )
    ...
    @ApiModelProperty(
        example = "us-east-az",
        value = "Value of the second primary tag by which to filter APM data. `primary_tag_name` must also be specified."
    )
     ...
     **/
    @javax.annotation.Nullable
    @ApiModelProperty(example = "Admin::ProductsController#create", value = "APM resource name.")
     ...
     * @return service
     **/
    @ApiModelProperty(example = "web-store", required = true, value = "APM service name.")
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.dataSource, formulaAndFunctionApmResourceStatsQueryDefinition.dataSource) &&
            ...
            Objects.equals(this.operationName, formulaAndFunctionApmResourceStatsQueryDefinition.operationName) &&
            Objects.equals(this.primaryTagName, formulaAndFunctionApmResourceStatsQueryDefinition.primaryTagName) &&
            Objects.equals(this.primaryTagValue, formulaAndFunctionApmResourceStatsQueryDefinition.primaryTagValue) &&
            Objects.equals(this.resourceName, formulaAndFunctionApmResourceStatsQueryDefinition.resourceName) &&
