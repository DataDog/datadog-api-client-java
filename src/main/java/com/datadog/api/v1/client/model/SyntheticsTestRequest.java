...
public class SyntheticsTestRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowInsecure, basicAuth, body, certificate, dnsServer, dnsServerPort, followRedirects, headers, host, message, method, noSavingResponseBody, numberOfPackets, port, query, servername, shouldTrackHops, timeout, url);
  }
