...
public class ServiceLevelObjectivesApi {
  ...
  public ApiResponse<SLOCorrectionListResponse> getSLOCorrectionsWithHttpInfo(String sloId) throws ApiException {
    ...
    return apiClient.invokeAPI("ServiceLevelObjectivesApi.getSLOCorrections", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  ...
  public static class GetSLOHistoryOptionalParameters {
    ...
    /**
     * Set applyCorrection
     * @param applyCorrection Defaults to &#x60;true&#x60;. If any SLO corrections are applied and this parameter is set to &#x60;false&#x60;, then the corrections will not be applied and the SLI values will not be affected. (optional)
     * @return GetSLOHistoryOptionalParameters
     */
