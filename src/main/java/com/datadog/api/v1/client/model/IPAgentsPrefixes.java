 ...
 */
@ApiModel(description = "Available prefix information for the Agent endpoints.")
@JsonPropertyOrder({
  IPAgentsPrefixes.JSON_PROPERTY_PREFIXES_IPV4,
  IPAgentsPrefixes.JSON_PROPERTY_PREFIXES_IPV6
})

public class IPAgentsPrefixes {
  ...
  public IPAgentsPrefixes prefixesIpv4(List<String> prefixesIpv4) {
    
    this.prefixesIpv4 = prefixesIpv4;
    return this;
  }

  public IPAgentsPrefixes addPrefixesIpv4Item(String prefixesIpv4Item) {
  ...
  **/
  ...
  public IPAgentsPrefixes prefixesIpv6(List<String> prefixesIpv6) {
    
    this.prefixesIpv6 = prefixesIpv6;
    return this;
  }

  public IPAgentsPrefixes addPrefixesIpv6Item(String prefixesIpv6Item) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IPAgentsPrefixes ipAgentsPrefixes = (IPAgentsPrefixes) o;
    return Objects.equals(this.prefixesIpv4, ipAgentsPrefixes.prefixesIpv4) &&
        Objects.equals(this.prefixesIpv6, ipAgentsPrefixes.prefixesIpv6);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPAgentsPrefixes {\n");
