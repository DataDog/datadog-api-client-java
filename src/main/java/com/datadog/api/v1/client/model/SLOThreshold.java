...
public class SLOThreshold {
    ...
    @ApiModelProperty(
        example = "99.9",
        required = true,
        value = "The target value for the service level indicator within the corresponding timeframe."
    )
    ...
    @ApiModelProperty(
        example = "99.9",
        value = "A string representation of the target that indicates its precision. It uses trailing zeros to show significant decimal places (e.g. `98.00`).  Always included in service level objective responses. Ignored in create/update requests."
    )
    ...
    @ApiModelProperty(
        example = "90.0",
        value = "A string representation of the warning target (see the description of the `target_display` field for details).  Included in service level objective responses if a warning target exists. Ignored in create/update requests."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.target, slOThreshold.target) &&
