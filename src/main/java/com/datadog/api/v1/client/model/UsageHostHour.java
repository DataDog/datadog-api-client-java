...
public class UsageHostHour {
    ...
    @ApiModelProperty(
        value = "Contains the total number of infrastructure hosts reporting during a given hour that were running the Datadog Agent."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via Alibaba integration (and were NOT running the Datadog Agent)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the total number of hosts using APM during the hour, these are counted as billable (except during trial periods)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via the AWS integration (and were NOT running the Datadog Agent)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via Azure integration (and were NOT running the Datadog Agent)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via the Google Cloud integration (and were NOT running the Datadog Agent)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of billable infrastructure hosts reporting during a given hour. This is the sum of `agent_host_count`, `aws_host_count`, and `gcp_host_count`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via the Azure App Services integration (and were NOT running the Datadog Agent)."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number of hosts that reported via vSphere integration (and were NOT running the Datadog Agent)."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.agentHostCount, usageHostHour.agentHostCount) &&
