 ...
 */
@ApiModel(description = "The description of a notebook create request.")
...
public class NotebookCreateRequest {
    ...
    @JsonCreator
    public NotebookCreateRequest(@JsonProperty(required = true, value = JSON_PROPERTY_DATA) NotebookCreateData data) {
        this.data = data;
