...
@JsonPropertyOrder({ NotebooksResponsePage.JSON_PROPERTY_TOTAL_COUNT, NotebooksResponsePage.JSON_PROPERTY_TOTAL_FILTERED_COUNT })
...
public class NotebooksResponsePage {
    ...
    @ApiModelProperty(
        value = "The total number of notebooks that would be returned if the request was not filtered by `start` and `count` parameters."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.totalCount, notebooksResponsePage.totalCount) &&
