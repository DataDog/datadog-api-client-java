...
public class LogsIndex {
    ...
    @ApiModelProperty(
        example = "300000000",
        value = "The number of log events you can send in this index per day before you are rate-limited."
    )
    ...
    @ApiModelProperty(
        example = "false",
        value = "A boolean stating if the index is rate limited, meaning more logs than the daily limit have been sent. Rate limit is reset every-day at 2pm UTC."
    )
    ...
    @ApiModelProperty(
        example = "15",
        value = "The number of days before logs are deleted from this index. Available values depend on retention plans specified in your organization's contract/subscriptions."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.dailyLimit, logsIndex.dailyLimit) &&
