...
public class GeomapWidgetDefinition {
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "Array of one request object to display in the widget. The request must contain a `group-by` tag whose value is a country ISO code.  See the [Request JSON schema documentation](https://docs.datadoghq.com/dashboards/graphing_json/request_json) for information about building the `REQUEST_SCHEMA`."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.customLinks, geomapWidgetDefinition.customLinks) &&
