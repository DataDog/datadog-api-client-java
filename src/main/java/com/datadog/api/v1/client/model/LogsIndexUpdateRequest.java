...
public class LogsIndexUpdateRequest {
    ...
    @JsonCreator
    public LogsIndexUpdateRequest(@JsonProperty(required = true, value = JSON_PROPERTY_FILTER) LogsFilter filter) {
        this.filter = filter;
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "If true, sets the `daily_limit` value to null and the index is not limited on a daily basis (any specified `daily_limit` value in the request is ignored). If false or omitted, the index's current `daily_limit` is maintained."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "An array of exclusion objects. The logs are tested against the query of each filter, following the order of the array. Only the first matching active exclusion matters, others (if any) are ignored."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The number of days before logs are deleted from this index. Available values depend on retention plans specified in your organization's contract/subscriptions.  **Note:** Changing the retention for an index adjusts the length of retention for all logs already in this index. It may also affect billing."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.dailyLimit, logsIndexUpdateRequest.dailyLimit) &&
