...
public class UsageAttributionPagination {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The cursor to use to get the next results, if any. To make the next request, use the same parameters with the addition of this next_record_id."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.limit, usageAttributionPagination.limit) &&
