...
public class DistributionWidgetXAxis {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Specifies maximum value to show on the x-axis. It takes a number, percentile (p90 === 90th percentile), or auto for default behavior."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Specifies minimum value to show on the x-axis. It takes a number, percentile (p90 === 90th percentile), or auto for default behavior."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.includeZero, distributionWidgetXAxis.includeZero) &&
