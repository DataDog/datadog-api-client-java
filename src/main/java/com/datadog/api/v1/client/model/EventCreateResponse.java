...
public class EventCreateResponse {
    ...
    @ApiModelProperty(
        example = "Oh boy!",
        value = "The body of the event. Limited to 4000 characters. The text supports markdown. Use `msg_text` with the Datadog Ruby library."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.alertType, eventCreateResponse.alertType) &&
