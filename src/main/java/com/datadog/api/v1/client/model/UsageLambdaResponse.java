...
import com.datadog.api.v1.client.model.UsageLambdaHour;
 ...
 */
@ApiModel(description = "Reponse containing the number of lambda functions and sum of the invocations of all lambda functions for each hour for a given organization.")
@JsonPropertyOrder({
...
public class UsageLambdaResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "Get hourly usage for Lambda.")
