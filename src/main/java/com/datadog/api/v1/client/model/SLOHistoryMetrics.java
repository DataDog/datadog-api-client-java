...
public class SLOHistoryMetrics {
    ...
    @ApiModelProperty(
        example = "0",
        required = true,
        value = "The aggregated query interval for the series data. It's implicit based on the query time window."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.denominator, slOHistoryMetrics.denominator) &&
