 ...
 */
@ApiModel(
    description = "A service level objective object includes a service level indicator, thresholds for one or more timeframes, and metadata (`name`, `description`, `tags`, etc.)."
)
@JsonPropertyOrder(
    {
...
public class SLOResponseData {
    ...
    @ApiModelProperty(
        example = "[123,456,789]",
        value = "A list of SLO monitors IDs that reference this SLO. This field is returned only when `with_configured_alert_ids` parameter is true in query."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A user-defined description of the service level objective.  Always included in service level objective responses (but may be `null`). Optional in create/update requests."
    )
    @JsonIgnore
    ...
    @ApiModelProperty(
        ...
        value = "A list of (up to 20) monitor groups that narrow the scope of a monitor service level objective.  Included in service level objective responses if it is not empty. Optional in create/update requests for monitor service level objectives, but may only be used when then length of the `monitor_ids` field is one."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A unique identifier for the service level objective object.  Always included in service level objective responses."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A list of monitor ids that defines the scope of a monitor service level objective. **Required if type is `monitor`**."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The union of monitor tags for all monitors referenced by the `monitor_ids` field. Always included in service level objective responses for monitor service level objectives (but may be empty). Ignored in create/update requests. Does not affect which monitors are included in the service level objective (that is determined entirely by the `monitor_ids` field)."
    )
    ...
    @ApiModelProperty(
        ...
        value = "A list of tags associated with this service level objective. Always included in service level objective responses (but may be empty). Optional in create/update requests."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        example = "[{\"target\":95,\"timeframe\":\"7d\"},{\"target\":95,\"timeframe\":\"30d\",\"warning\":97}]",
        value = "The thresholds (timeframes and associated targets) for this service level objective object."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.configuredAlertIds, slOResponseData.configuredAlertIds) &&
