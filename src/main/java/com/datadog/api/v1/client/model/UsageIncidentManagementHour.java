...
@JsonPropertyOrder({ UsageIncidentManagementHour.JSON_PROPERTY_HOUR, UsageIncidentManagementHour.JSON_PROPERTY_MONTHLY_ACTIVE_USERS })
...
public class UsageIncidentManagementHour {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Contains the total number monthly active users from the start of the given hour's month until the given hour."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.hour, usageIncidentManagementHour.hour) &&
