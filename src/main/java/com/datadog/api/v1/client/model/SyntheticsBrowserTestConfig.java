...
public class SyntheticsBrowserTestConfig {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Cookies to be used for the request, using the [Set-Cookie](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie) syntax."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.assertions, syntheticsBrowserTestConfig.assertions) &&
