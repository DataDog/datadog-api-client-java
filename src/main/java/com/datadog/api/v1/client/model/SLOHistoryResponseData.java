...
import com.datadog.api.v1.client.model.SLOHistoryMonitor;
...
public class SLOHistoryResponseData {
    ...
    @ApiModelProperty(
        example = "[]",
        value = "For `metric` based SLOs where the query includes a group-by clause, this represents the list of grouping parameters.  This is not included in responses for `monitor` based SLOs."
    )
    ...
    @ApiModelProperty(
        example = "[]",
        value = "For grouped SLOs, this represents SLI data for specific groups.  This is not included in the responses for `metric` based SLOs."
    )
    ...
    @ApiModelProperty(
        example = "[]",
        value = "For multi-monitor SLOs, this represents SLI data for specific monitors.  This is not included in the responses for `metric` based SLOs."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.fromTs, slOHistoryResponseData.fromTs) &&
