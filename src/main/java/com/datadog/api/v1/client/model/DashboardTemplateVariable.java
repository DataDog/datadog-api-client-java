...
public class DashboardTemplateVariable {
    ...
    @JsonCreator
    public DashboardTemplateVariable(@JsonProperty(required = true, value = JSON_PROPERTY_NAME) String name) {
        this.name = name;
    }
    ...
    @ApiModelProperty(
        example = "host",
        value = "The tag prefix associated with the variable. Only tags with this prefix appear in the variable drop-down."
    )
    @JsonIgnore
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.availableValues, dashboardTemplateVariable.availableValues) &&
