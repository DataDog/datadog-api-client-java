...
public class LogsCategoryProcessor {
    ...
    @ApiModelProperty(
        example = "[]",
        required = true,
        value = "Array of filters to match or not a log and their corresponding `name`to assign a custom value to the log."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.categories, logsCategoryProcessor.categories) &&
