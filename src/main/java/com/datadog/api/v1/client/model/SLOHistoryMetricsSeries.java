 ...
 */
@ApiModel(
    description = "A representation of `metric` based SLO time series for the provided queries. This is the same response type from `batch_query` endpoint."
)
@JsonPropertyOrder(
    {
...
public class SLOHistoryMetricsSeries {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.count, slOHistoryMetricsSeries.count) &&
