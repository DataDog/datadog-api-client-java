...
public class WidgetLayout {
    ...
    @ApiModelProperty(
        value = "Whether the widget should be the first one on the second column in high density or not. **Note**: Only for the **new dashboard layout** and only one widget in the dashboard should have this property set to `true`."
    )
    ...
    @ApiModelProperty(
        example = "0",
        required = true,
        value = "The position of the widget on the x (horizontal) axis. Should be a non-negative integer."
    )
    ...
    @ApiModelProperty(
        example = "0",
        required = true,
        value = "The position of the widget on the y (vertical) axis. Should be a non-negative integer."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.height, widgetLayout.height) &&
