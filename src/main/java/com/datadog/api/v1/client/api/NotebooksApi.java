...
public class NotebooksApi {
  ...
  public ApiResponse<NotebookResponse> createNotebookWithHttpInfo(NotebookCreateRequest body) throws ApiException {
    ...
    return apiClient.invokeAPI("NotebooksApi.createNotebook", localVarPath, "POST", localVarQueryParams, localVarPostBody,
  ...
  public ApiResponse<Void> deleteNotebookWithHttpInfo(Long notebookId) throws ApiException {
    ...
    return apiClient.invokeAPI("NotebooksApi.deleteNotebook", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
  ...
  public ApiResponse<NotebookResponse> getNotebookWithHttpInfo(Long notebookId) throws ApiException {
    ...
    return apiClient.invokeAPI("NotebooksApi.getNotebook", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  ...
  public static class ListNotebooksOptionalParameters {
    ...
    /**
     * Set authorHandle
     * @param authorHandle Return notebooks created by the given &#x60;author_handle&#x60;. (optional)
     ...
     * @param excludeAuthorHandle Return notebooks not created by the given &#x60;author_handle&#x60;. (optional)
     * @return ListNotebooksOptionalParameters
     */
    ...
    /**
     * Set sortField
     * @param sortField Sort by field &#x60;modified&#x60;, &#x60;name&#x60;, or &#x60;created&#x60;. (optional, default to modified)
     * @return ListNotebooksOptionalParameters
     */
    ...
    /**
     * Set sortDir
     * @param sortDir Sort by direction &#x60;asc&#x60; or &#x60;desc&#x60;. (optional, default to desc)
     * @return ListNotebooksOptionalParameters
     */
    ...
    /**
     * Set query
     * @param query Return only notebooks with &#x60;query&#x60; string in notebook name or author handle. (optional)
     * @return ListNotebooksOptionalParameters
     */
    ...
    /**
     * Set includeCells
     * @param includeCells Value of &#x60;false&#x60; excludes the &#x60;cells&#x60; and global &#x60;time&#x60; for each notebook. (optional, default to true)
     * @return ListNotebooksOptionalParameters
     */
  ...
  public ApiResponse<NotebooksResponse> listNotebooksWithHttpInfo(ListNotebooksOptionalParameters parameters) throws ApiException {
    ...
    return apiClient.invokeAPI("NotebooksApi.listNotebooks", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
  ...
  public ApiResponse<NotebookResponse> updateNotebookWithHttpInfo(Long notebookId, NotebookUpdateRequest body) throws ApiException {
    ...
    return apiClient.invokeAPI("NotebooksApi.updateNotebook", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, localVarReturnType, false);
  }
}
