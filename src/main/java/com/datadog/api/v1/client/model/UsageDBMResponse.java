...
import com.datadog.api.v1.client.model.UsageDBMHour;
 ...
 */
@ApiModel(description = "Response containing the Database Monitoring usage for each hour for a given organization.")
@JsonPropertyOrder({
...
public class UsageDBMResponse {
  ...
  **/
  ...
  @ApiModelProperty(value = "Get hourly usage for Database Monitoring")
