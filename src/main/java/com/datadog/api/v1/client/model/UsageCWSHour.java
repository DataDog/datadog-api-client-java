...
@JsonPropertyOrder(
    { UsageCWSHour.JSON_PROPERTY_CWS_CONTAINER_COUNT, UsageCWSHour.JSON_PROPERTY_CWS_HOST_COUNT, UsageCWSHour.JSON_PROPERTY_HOUR }
)
...
public class UsageCWSHour {
    ...
    @ApiModelProperty(
        value = "The total number of Cloud Workload Security container hours from the start of the given hour’s month until the given hour."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The total number of Cloud Workload Security host hours from the start of the given hour’s month until the given hour."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.cwsContainerCount, usageCWSHour.cwsContainerCount) &&
