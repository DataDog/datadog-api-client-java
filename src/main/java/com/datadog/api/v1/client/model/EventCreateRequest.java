...
public class EventCreateRequest {
  ...
  **/
   ...
   * @return text
  **/
  @ApiModelProperty(example = "Oh boy!", required = true, value = "The body of the event. Limited to 4000 characters. The text supports markdown. To use markdown in the event text, start the text block with `%%% \\n` and end the text block with `\\n %%%`. Use `msg_text` with the Datadog Ruby library.")
   ...
   * @return title
  **/
  @ApiModelProperty(example = "Did you hear the news today?", required = true, value = "The event title.")
