...
public class EventCreateRequest {
    ...
    @ApiModelProperty(
        value = "An arbitrary string to use for aggregation. Limited to 100 characters. If you specify a key, all events using that key are grouped together in the Event Stream."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "POSIX timestamp of the event. Must be sent as an integer (i.e. no quotes). Limited to events no older than 7 days."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The type of event being posted. Option examples include nagios, hudson, jenkins, my_apps, chef, puppet, git, bitbucket, etc. A complete list of source attribute values [available here](https://docs.datadoghq.com/integrations/faq/list-of-api-source-attribute-value)."
    )
    ...
    @ApiModelProperty(
        example = "Oh boy!",
        required = true,
        value = "The body of the event. Limited to 4000 characters. The text supports markdown. To use markdown in the event text, start the text block with `%%% \\n` and end the text block with `\\n %%%`. Use `msg_text` with the Datadog Ruby library."
    )
    ...
    @ApiModelProperty(
        ...
        required = true,
        value = "The event title. Limited to 100 characters. Use `msg_title` with the Datadog Ruby library."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aggregationKey, eventCreateRequest.aggregationKey) &&
