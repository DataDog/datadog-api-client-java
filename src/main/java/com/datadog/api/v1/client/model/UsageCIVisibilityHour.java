...
@JsonPropertyOrder({
  ...
  UsageCIVisibilityHour.JSON_PROPERTY_CI_VISIBILITY_COMBO_COMMITTERS,
...
public class UsageCIVisibilityHour {
  ...
  public static final String JSON_PROPERTY_CI_VISIBILITY_COMBO_COMMITTERS =
      "ci_visibility_combo_committers";
  private Integer ciVisibilityComboCommitters;
  ...
  public UsageCIVisibilityHour ciVisibilityComboCommitters(Integer ciVisibilityComboCommitters) {
    this.ciVisibilityComboCommitters = ciVisibilityComboCommitters;
    return this;
  }
   ...
   *
   * @return ciVisibilityComboCommitters
   */
  @javax.annotation.Nullable
  @ApiModelProperty(
      value = "The number of combined test and pipeline committers in the queried hour.")
  @JsonProperty(JSON_PROPERTY_CI_VISIBILITY_COMBO_COMMITTERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public Integer getCiVisibilityComboCommitters() {
    return ciVisibilityComboCommitters;
  }

  public void setCiVisibilityComboCommitters(Integer ciVisibilityComboCommitters) {
    this.ciVisibilityComboCommitters = ciVisibilityComboCommitters;
  }
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of pipeline committers in the queried hour.")
   ...
   */
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The number of test committers in the queried hour.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ciPipelineIndexedSpans, usageCIVisibilityHour.ciPipelineIndexedSpans)
        ...
        && Objects.equals(
            this.ciVisibilityComboCommitters, usageCIVisibilityHour.ciVisibilityComboCommitters)
        && Objects.equals(
  ...
  public String toString() {
    ...
    sb.append("    ciVisibilityComboCommitters: ")
        .append(toIndentedString(ciVisibilityComboCommitters))
        .append("\n");
