...
public class LogsIndexesOrder {
   ...
   * @return indexNames
  **/
  @ApiModelProperty(required = true, value = "Array of strings identifying by their name(s) the index(es) of your organisation. Logs are tested against the query filter of each index one by one, following the order of the array. Logs are eventually stored in the first matching index.")
