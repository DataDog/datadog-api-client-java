...
public class SLOHistoryMetricsSeriesMetadata {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        example = "[{\"family\":\"bytes\",\"id\":2,\"name\":\"byte\",\"plural\":\"bytes\",\"scale_factor\":1.0,\"short_name\":\"B\"},null]",
        value = "An array of metric units that contains up to two unit objects. For example, bytes represents one unit object and bytes per second represents two unit objects. If a metric query only has one unit object, the second array element is null."
    )
    @JsonIgnore
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aggr, slOHistoryMetricsSeriesMetadata.aggr) &&
