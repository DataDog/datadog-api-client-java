...
public class SyntheticsTestOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines whether or not to ignore server certificate errors.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acceptSelfSigned, allowInsecure, deviceIds, disableCors, followRedirects, minFailureDuration, minLocationFailed, monitorOptions, noScreenshot, retry, tickEvery);
  }
