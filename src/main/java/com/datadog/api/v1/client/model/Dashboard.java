 ...
 */
@ApiModel(
    description = "A dashboard is Datadog’s tool for visually tracking, analyzing, and displaying key performance metrics, which enable you to monitor the health of your infrastructure."
)
@JsonPropertyOrder(
    {
...
public class Dashboard {
    ...
    @ApiModelProperty(
        example = "false",
        value = "Whether this dashboard is read-only. If True, only the author and admins can make changes to it."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A list of role identifiers. Only the author and users associated with at least one of these roles can edit this dashboard. Overrides the `is_read_only` property if both are present. **This feature is currently in beta.**"
    )
     ...
     **/
    @ApiModelProperty(
        example = "[{\"definition\":{\"requests\":{\"fill\":{\"q\":\"system.cpu.user\"}},\"type\":\"hostmap\"}}]",
        required = true,
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.authorHandle, dashboard.authorHandle) &&
