 ...
 */
@ApiModel(
    description = "Parser options to use for retrieving a Synthetics global variable from a Synthetics Test. Used in conjunction with `parse_test_public_id`."
)
@JsonPropertyOrder(
    {
...
public class SyntheticsGlobalVariableParseTestOptions {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.field, syntheticsGlobalVariableParseTestOptions.field) &&
