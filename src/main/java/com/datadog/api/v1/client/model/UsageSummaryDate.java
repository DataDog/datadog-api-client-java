...
public class UsageSummaryDate {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of audit logs lines indexed over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser lite sessions over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser replay sessions over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser RUM units over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the high-water mark of all distinct containers over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the average number of Cloud Security Posture Management containers over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the high-water mark of Cloud Security Posture Management containers over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all Cloud Security Posture Management hosts over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the average of all distinct Cloud Workload Security containers over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all Cloud Workload Security hosts over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all Database Monitoring hosts over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the average of all normalized Database Monitoring queries over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all Heroku dynos over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the high-water mark of incident management monthly active users over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all IoT devices over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all IoT devices over all hours in the current date all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile lite sessions over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile RUM Sessions on Android over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile RUM Sessions on iOS over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile RUM units over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of RUM Sessions (browser and mobile) over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser and mobile RUM units over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current month for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current month for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all Indexed Spans indexed over all hours in the current date for all organizations.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all vSphere hosts over all hours in the current date for all organizations.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentHostTop99p, usageSummaryDate.agentHostTop99p) &&
        ...
        Objects.equals(this.browserRumLiteSessionCountSum, usageSummaryDate.browserRumLiteSessionCountSum) &&
        Objects.equals(this.browserRumReplaySessionCountSum, usageSummaryDate.browserRumReplaySessionCountSum) &&
        ...
        Objects.equals(this.incidentManagementMonthlyActiveUsersHwm, usageSummaryDate.incidentManagementMonthlyActiveUsersHwm) &&
        ...
        Objects.equals(this.mobileRumLiteSessionCountSum, usageSummaryDate.mobileRumLiteSessionCountSum) &&
        Objects.equals(this.mobileRumSessionCountAndroidSum, usageSummaryDate.mobileRumSessionCountAndroidSum) &&
        Objects.equals(this.mobileRumSessionCountIosSum, usageSummaryDate.mobileRumSessionCountIosSum) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentHostTop99p, apmAzureAppServiceHostTop99p, apmHostTop99p, auditLogsLinesIndexedSum, avgProfiledFargateTasks, awsHostTop99p, awsLambdaFuncCount, awsLambdaInvocationsSum, azureAppServiceTop99p, billableIngestedBytesSum, browserRumLiteSessionCountSum, browserRumReplaySessionCountSum, browserRumUnitsSum, containerAvg, containerHwm, cspmContainerAvg, cspmContainerHwm, cspmHostTop99p, customTsAvg, cwsContainerCountAvg, cwsHostTop99p, date, dbmHostTop99p, dbmQueriesCountAvg, fargateTasksCountAvg, fargateTasksCountHwm, gcpHostTop99p, herokuHostTop99p, incidentManagementMonthlyActiveUsersHwm, indexedEventsCountSum, infraHostTop99p, ingestedEventsBytesSum, iotDeviceSum, iotDeviceTop99p, mobileRumLiteSessionCountSum, mobileRumSessionCountAndroidSum, mobileRumSessionCountIosSum, mobileRumSessionCountSum, mobileRumUnitsSum, netflowIndexedEventsCountSum, npmHostTop99p, opentelemetryHostTop99p, orgs, profilingHostTop99p, rumSessionCountSum, rumTotalSessionCountSum, rumUnitsSum, sdsLogsScannedBytesSum, sdsTotalScannedBytesSum, syntheticsBrowserCheckCallsCountSum, syntheticsCheckCallsCountSum, traceSearchIndexedEventsCountSum, twolIngestedEventsBytesSum, vsphereHostTop99p);
  }
