...
public class UsageSummaryDate {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Azure app services using APM over all hours in the current date all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct APM hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of the number of functions that executed 1 or more times each hour in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Azure app services over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the high-water mark of all distinct containers over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average number of Cloud Security Posture Management containers over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the high-water mark of Cloud Security Posture Management containers over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Security Posture Management hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average number of distinct custom metrics over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of all distinct Cloud Workload Security containers over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Workload Security hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Database Monitoring hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of all normalized Database Monitoring queries over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the high-water mark of incident management monthly active users over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct infrastructure hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all mobile RUM Sessions on Android over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct Networks hosts over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of RUM Sessions (browser and mobile) over all hours in the current date for all organizations."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all tracing without limits bytes ingested over all hours in the current date for all organizations."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.agentHostTop99p, usageSummaryDate.agentHostTop99p) &&
    ...
    public String toString() {
        ...
        sb
            .append("    incidentManagementMonthlyActiveUsersHwm: ")
