 ...
 */
@ApiModel(
    description = "Information about widget.  **Note**: The `layout` property is required for widgets in dashboards with `free` `layout_type`.       For the **new dashboard layout**, the `layout` property depends on the `reflow_type` of the dashboard.       - If `reflow_type` is `fixed`, `layout` is required.       - If `reflow_type` is `auto`, `layout` should not be set."
)
@JsonPropertyOrder({ Widget.JSON_PROPERTY_DEFINITION, Widget.JSON_PROPERTY_ID, Widget.JSON_PROPERTY_LAYOUT })
...
public class Widget {
    ...
    @JsonCreator
    public Widget(@JsonProperty(required = true, value = JSON_PROPERTY_DEFINITION) WidgetDefinition definition) {
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.definition, widget.definition) &&
