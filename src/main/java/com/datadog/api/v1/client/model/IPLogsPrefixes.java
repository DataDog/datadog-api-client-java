 ...
 */
@ApiModel(description = "Available prefix information for the Logs endpoints.")
@JsonPropertyOrder({
  IPLogsPrefixes.JSON_PROPERTY_PREFIXES_IPV4,
  IPLogsPrefixes.JSON_PROPERTY_PREFIXES_IPV6
})

public class IPLogsPrefixes {
  ...
  public IPLogsPrefixes prefixesIpv4(List<String> prefixesIpv4) {
    
    this.prefixesIpv4 = prefixesIpv4;
    return this;
  }

  public IPLogsPrefixes addPrefixesIpv4Item(String prefixesIpv4Item) {
  ...
  **/
  ...
  public IPLogsPrefixes prefixesIpv6(List<String> prefixesIpv6) {
    
    this.prefixesIpv6 = prefixesIpv6;
    return this;
  }

  public IPLogsPrefixes addPrefixesIpv6Item(String prefixesIpv6Item) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IPLogsPrefixes ipLogsPrefixes = (IPLogsPrefixes) o;
    return Objects.equals(this.prefixesIpv4, ipLogsPrefixes.prefixesIpv4) &&
        Objects.equals(this.prefixesIpv6, ipLogsPrefixes.prefixesIpv6);
  }
  ...
  public String toString() {
    ...
    sb.append("class IPLogsPrefixes {\n");
