...
public class MonitorOptions {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "We recommend using the [is_renotify](https://docs.datadoghq.com/monitors/notify/?tab=is_alert#renotify), block in the original message instead. A message to include with a re-notification. Supports the `@username` notification we allow elsewhere. Not applicable if `renotify_interval` is `None`."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Time (in seconds) to delay evaluation, as a non-negative integer. For example, if the value is set to `300` (5min), the timeframe is set to `last_5m` and the time is 7:00, the monitor evaluates data from 6:50 to 6:55. This is useful for AWS CloudWatch and other backfilled metrics to ensure the monitor always has data during evaluation."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Whether the log alert monitor triggers a single alert or multiple alerts when any group breaches a threshold."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A Boolean indicating whether notifications from this monitor automatically inserts its triggering tags into the title.  **Examples** - If `True`, `[Triggered on {host:h1}] Monitor Title` - If `False`, `[Triggered] Monitor Title`"
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The minimum number of locations in failure at the same time during at least one moment in the `min_failure_duration` period (`min_location_failed` and `min_failure_duration` are part of the advanced alerting rules - integer, >= 1)."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Time (in seconds) to skip evaluations for new groups.  For example, this option can be used to skip evaluations for new hosts while they initialize.  Must be a non negative integer."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Time (in seconds) to allow a host to boot and applications to fully start before starting the evaluation of monitor results. Should be a non negative integer.  Use new_group_delay instead."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The number of minutes before a monitor notifies after data stops reporting. Datadog recommends at least 2x the monitor timeframe for metric alerts or 2 minutes for service checks. If omitted, 2x the evaluation timeframe is used for metric alerts, and 24 hours is used for service checks."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The number of minutes after the last notification before a monitor re-notifies on the current status. It only re-notifies if it’s not resolved."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The number of times re-notification messages should be sent on the current status at the provided re-notification interval."
    )
    @JsonIgnore
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "A Boolean indicating whether this monitor needs a full window of data before it’s evaluated. We highly recommend you set this to `false` for sparse metrics, otherwise some evaluations are skipped. Default is false."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The number of hours of the monitor not reporting data before it automatically resolves from a triggered state."
    )
    @JsonIgnore
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.aggregation, monitorOptions.aggregation) &&
