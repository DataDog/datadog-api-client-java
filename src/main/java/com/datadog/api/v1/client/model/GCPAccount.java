...
public class GCPAccount {
    ...
    @ApiModelProperty(
        ...
        value = "Should be `https://www.googleapis.com/robot/v1/metadata/x509/<CLIENT_EMAIL>` where `<CLIENT_EMAIL>` is the email found in your JSON service account key."
    )
    ...
    @ApiModelProperty(
        ...
        value = "Limit the GCE instances that are pulled into Datadog by using tags. Only hosts that match one of the defined tags are imported into Datadog."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.authProviderX509CertUrl, gcPAccount.authProviderX509CertUrl) &&
