...
@JsonPropertyOrder(
    { LogsListRequestTime.JSON_PROPERTY_FROM, LogsListRequestTime.JSON_PROPERTY_TIMEZONE, LogsListRequestTime.JSON_PROPERTY_TO }
)
...
public class LogsListRequestTime {
     ...
     * @return from
     **/
    @ApiModelProperty(example = "2020-02-02T02:02:02Z", required = true, value = "Minimum timestamp for requested logs.")
    ...
    @ApiModelProperty(
        value = "Timezone can be specified both as an offset (e.g. \"UTC+03:00\") or a regional zone (e.g. \"Europe/Paris\")."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.from, logsListRequestTime.from) &&
