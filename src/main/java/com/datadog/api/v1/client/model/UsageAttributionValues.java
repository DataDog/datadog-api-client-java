...
public class UsageAttributionValues {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The percentage of Cloud Security Posture Management container usage by tag(s)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The percentage of Cloud Security Posture Management host usage by tag(s)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The percentage of Database Monitoring normalized queries usage by tag(s).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Database Monitoring normalized queries usage by tag(s).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The percentage of estimated live indexed logs usage by tag(s). Note this field is in private beta.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The estimated live indexed logs usage by tag(s). Note this field is in private beta.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiPercentage, usageAttributionValues.apiPercentage) &&
        ...
        Objects.equals(this.cspmContainerPercentage, usageAttributionValues.cspmContainerPercentage) &&
        ...
        Objects.equals(this.cwsContainerPercentage, usageAttributionValues.cwsContainerPercentage) &&
        ...
        Objects.equals(this.estimatedIndexedLogsPercentage, usageAttributionValues.estimatedIndexedLogsPercentage) &&
        Objects.equals(this.estimatedIndexedLogsUsage, usageAttributionValues.estimatedIndexedLogsUsage) &&
        ...
        Objects.equals(this.profiledContainerPercentage, usageAttributionValues.profiledContainerPercentage) &&
        Objects.equals(this.profiledContainerUsage, usageAttributionValues.profiledContainerUsage) &&
        Objects.equals(this.profiledHostsPercentage, usageAttributionValues.profiledHostsPercentage) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiPercentage, apiUsage, apmHostPercentage, apmHostUsage, browserPercentage, browserUsage, containerPercentage, containerUsage, cspmContainerPercentage, cspmContainerUsage, cspmHostPercentage, cspmHostUsage, customTimeseriesPercentage, customTimeseriesUsage, cwsContainerPercentage, cwsContainerUsage, cwsHostPercentage, cwsHostUsage, dbmHostsPercentage, dbmHostsUsage, dbmQueriesPercentage, dbmQueriesUsage, estimatedIndexedLogsPercentage, estimatedIndexedLogsUsage, infraHostPercentage, infraHostUsage, lambdaFunctionsPercentage, lambdaFunctionsUsage, lambdaInvocationsPercentage, lambdaInvocationsUsage, lambdaPercentage, lambdaUsage, npmHostPercentage, npmHostUsage, profiledContainerPercentage, profiledContainerUsage, profiledHostsPercentage, profiledHostsUsage, snmpPercentage, snmpUsage);
  }
