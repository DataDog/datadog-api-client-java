...
public class SyntheticsAPIStep {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Determines whether or not to consider the entire test as failed if this step fails. Can be used only if `allowFailure` is `true`."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.allowFailure, syntheticsAPIStep.allowFailure) &&
