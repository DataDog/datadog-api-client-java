...
public class UsageAttributionBody {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "The source of the usage attribution tag configuration and the selected tags in the format `<source_org_name>:<selected tag 1>-<selected tag 2>-<selected tag 3>`."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.month, usageAttributionBody.month) &&
