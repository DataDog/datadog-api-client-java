...
public class UsageSummaryDateOrg {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser lite sessions over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser replay sessions over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser RUM units over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the 99th percentile of all Database Monitoring hosts over all hours in the current month for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the average of all distinct Database Monitoring normalized queries over all hours in the current month for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile lite sessions over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all mobile RUM units over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all browser and mobile RUM units over all hours in the current date for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all bytes scanned of logs usage by the Sensitive Data Scanner over all hours in the current month for the given org.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Shows the sum of all bytes scanned across all usage types by the Sensitive Data Scanner over all hours in the current month for the given org.")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentHostTop99p, usageSummaryDateOrg.agentHostTop99p) &&
        Objects.equals(this.apmAzureAppServiceHostTop99p, usageSummaryDateOrg.apmAzureAppServiceHostTop99p) &&
        Objects.equals(this.apmHostTop99p, usageSummaryDateOrg.apmHostTop99p) &&
        Objects.equals(this.auditLogsLinesIndexedSum, usageSummaryDateOrg.auditLogsLinesIndexedSum) &&
        ...
        Objects.equals(this.browserRumLiteSessionCountSum, usageSummaryDateOrg.browserRumLiteSessionCountSum) &&
        Objects.equals(this.browserRumReplaySessionCountSum, usageSummaryDateOrg.browserRumReplaySessionCountSum) &&
        ...
        Objects.equals(this.mobileRumLiteSessionCountSum, usageSummaryDateOrg.mobileRumLiteSessionCountSum) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(agentHostTop99p, apmAzureAppServiceHostTop99p, apmHostTop99p, auditLogsLinesIndexedSum, avgProfiledFargateTasks, awsHostTop99p, awsLambdaFuncCount, awsLambdaInvocationsSum, azureAppServiceTop99p, billableIngestedBytesSum, browserRumLiteSessionCountSum, browserRumReplaySessionCountSum, browserRumUnitsSum, containerAvg, containerHwm, cspmContainerAvg, cspmContainerHwm, cspmHostTop99p, customTsAvg, cwsContainerCountAvg, cwsHostTop99p, dbmHostTop99pSum, dbmQueriesAvgSum, fargateTasksCountAvg, fargateTasksCountHwm, gcpHostTop99p, herokuHostTop99p, id, incidentManagementMonthlyActiveUsersHwm, indexedEventsCountSum, infraHostTop99p, ingestedEventsBytesSum, iotDeviceAggSum, iotDeviceTop99pSum, mobileRumLiteSessionCountSum, mobileRumSessionCountAndroidSum, mobileRumSessionCountIosSum, mobileRumSessionCountSum, mobileRumUnitsSum, name, netflowIndexedEventsCountSum, npmHostTop99p, opentelemetryHostTop99p, profilingHostTop99p, publicId, rumSessionCountSum, rumTotalSessionCountSum, rumUnitsSum, sdsLogsScannedBytesSum, sdsTotalScannedBytesSum, syntheticsBrowserCheckCallsCountSum, syntheticsCheckCallsCountSum, traceSearchIndexedEventsCountSum, twolIngestedEventsBytesSum, vsphereHostTop99p);
  }
