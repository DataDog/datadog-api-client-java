...
public class UsageSummaryDateOrg {
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Azure app services using APM over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average number of Cloud Security Posture Management containers over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the high-water mark of Cloud Security Posture Management containers over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Security Posture Management hosts over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the average of all distinct Cloud Workload Security containers over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all Cloud Workload Security hosts over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the high-water mark of incident management monthly active users over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct infrastructure hosts over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all distinct Networks hosts over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the 99th percentile of all hosts reported by the Datadog exporter for the OpenTelemetry Collector over all hours in the current date for the given org."
    )
    ...
    @javax.annotation.Nullable
    @ApiModelProperty(
        value = "Shows the sum of all tracing without limits bytes ingested over all hours in the current date for the given org."
    )
