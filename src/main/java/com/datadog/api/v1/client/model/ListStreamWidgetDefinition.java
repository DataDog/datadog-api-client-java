 ...
 */
@ApiModel(
    description = "The list stream visualization displays a table of recent events in your application that match a search criteria using user-defined columns. "
)
@JsonPropertyOrder(
    {
...
public class ListStreamWidgetDefinition {
     ...
     **/
    @ApiModelProperty(
        example = "[{\"response_format\":\"event_list\"},{\"columns\":[{\"field\":\"timestamp\",\"width\":\"auto\"}]},{\"query\":{\"data_source\":\"issue_stream\",\"query_string\":\"@data_source:APM\"}}]",
        required = true,
