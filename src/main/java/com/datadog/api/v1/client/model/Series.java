...
public class Series {
  ...
  **/
  ...
  @ApiModelProperty(value = "The name of the host that produced the metric.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "If the type of the metric is rate or count, define the corresponding interval.")
  @JsonIgnore
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of tags associated with the metric.")
