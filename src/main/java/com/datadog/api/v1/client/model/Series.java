 ...
 */
@ApiModel(
    description = "A metric to submit to Datadog. See [Datadog metrics](https://docs.datadoghq.com/developers/metrics/#custom-metrics-properties)."
)
@JsonPropertyOrder(
    {
...
public class Series {
    ...
    @ApiModelProperty(
        required = true,
        value = "Points relating to a metric. All points must be tuples with timestamp and a scalar value (cannot be a string). Timestamps should be in POSIX time in seconds, and cannot be more than ten minutes in the future or more than one hour in the past."
    )
    ...
    public boolean equals(Object o) {
        ...
        return (
            Objects.equals(this.host, series.host) &&
