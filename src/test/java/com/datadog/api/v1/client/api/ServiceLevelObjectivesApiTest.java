...
public class ServiceLevelObjectivesApiTest extends V1ApiTest {
    ...
    private final ServiceLevelObjectiveRequest monitorSLO = new ServiceLevelObjectiveRequest()
        ...
        .thresholds(Arrays.asList(new SLOThreshold().timeframe(SLOTimeframe.THIRTY_DAYS).target(95.0).warning(98.0)));
    private final ServiceLevelObjectiveRequest eventSLO = new ServiceLevelObjectiveRequest()
        ...
        .thresholds(Arrays.asList(new SLOThreshold().timeframe(SLOTimeframe.SEVEN_DAYS).target(95.0).warning(98.0)))
        .query(
    ...
    public void canDelete409SLOErrorTest() throws IOException {
        ...
        stubFor(get(urlPathEqualTo(apiUri + "/can_delete")).willReturn(okJson(fixtureData).withStatus(409)));
