...
public class OrganizationsApiTest extends V1ApiTest {
        ...
        Organization org = new Organization()
            ...
            .settings(
                new OrganizationSettings()
                    ...
                    .samlIdpInitiatedLogin(new OrganizationSettingsSamlIdpInitiatedLogin().enabled(true))
    ...
    public void uploadIdPForOrgTest() throws ApiException, IOException, URISyntaxException {
        ...
        IdpResponse response = unitApi.uploadIdPForOrg(publicId, idpFile); // .uploadIdPForOrg(publicId);
    ...
    public void orgsUploadIdp415ErrorTest() throws URISyntaxException, IOException {
        ...
        stubFor(post(urlPathEqualTo(apiUri + "/id/idp_metadata")).willReturn(okJson(fixtureData).withStatus(415)));
