...
public class PagerDutyIntegrationApiTest extends V1ApiTest {
    ...
    public void lifecyclePagerDutyIntegrationTest() throws ApiException, TestUtils.RetryException {
        ...
        ApiResponse<PagerDutyServiceName> serviceNameResponse = api.createPagerDutyIntegrationServiceWithHttpInfo(serviceBody);
        ...
        ApiResponse<Void> serviceDeleteResponse = api.deletePagerDutyIntegrationServiceWithHttpInfo(serviceName);
    ...
    public void createPagerDutyIntegrationServicesTest() throws IOException {
        PagerDutyService body = new PagerDutyService().serviceKey("lalaa").serviceName(getUniqueEntityName());
