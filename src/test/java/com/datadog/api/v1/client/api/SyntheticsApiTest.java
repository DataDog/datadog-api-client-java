...
public class SyntheticsApiTest extends V1ApiTest {
        ...
        return new SyntheticsAPITest()
            .config(
                new SyntheticsAPITestConfig()
                    ...
                    .request(new SyntheticsTestRequest().host("agent-intake.logs.datadoghq.com").port(443L))
            )
            .locations(Arrays.asList("aws:us-east-2"))
        ...
        return new SyntheticsBrowserTest()
            .config(
                new SyntheticsBrowserTestConfig()
                    ...
                    .request(new SyntheticsTestRequest().method(HTTPMethod.GET).url("https://datadoghq.com"))
            )
            .locations(Arrays.asList("aws:us-east-2"))
    ...
    public void testSyntheticsAPILifecycle() throws ApiException, IOException {
        ...
        File recentResultsFixture = new File(getClass().getResource("synthetics_fixtures/api_test_recent_results.json").getFile());
        File singleResultFixture = new File(getClass().getResource("synthetics_fixtures/api_test_single_result.json").getFile());
        ...
        // Stop API test
        pauseStatus =
            api.updateTestPauseStatus(publicId, new SyntheticsUpdateTestPauseStatusPayload().newStatus(SyntheticsTestPauseStatus.PAUSED));
        assertEquals(true, pauseStatus);

        // Start API test
        pauseStatus =
            api.updateTestPauseStatus(publicId, new SyntheticsUpdateTestPauseStatusPayload().newStatus(SyntheticsTestPauseStatus.LIVE));
        assertEquals(true, pauseStatus);
        ...
        try {
            generalApiClient.getJSON().getContext(null).readValue(recentResultsFixture, SyntheticsGetAPITestLatestResultsResponse.class);
        } catch (Exception e) {
            assertNull(e);
        }
        ...
        try {
            generalApiClient.getJSON().getContext(null).readValue(singleResultFixture, SyntheticsAPITestResultFull.class);
        } catch (Exception e) {
            assertNull(e);
        }
        ...
        SyntheticsAPITestResultFull result = unitApi.getAPITestResult("test-synthetics-id", "test-result-id");
    ...
    public void testSyntheticsSubtypeTcpAPILifecycle() throws ApiException, IOException {
        ...
        SyntheticsGetAPITestLatestResultsResponse latestResults;
        SyntheticsAPITestResultFull singleResult;
        File recentResultsFixture = new File(
            getClass().getResource("synthetics_fixtures/api_test_subtype_tcp_recent_results.json").getFile()
        );
        File singleResultFixture = new File(
            getClass().getResource("synthetics_fixtures/api_test_subtype_tcp_single_result.json").getFile()
        );
    ...
    public void testSyntheticsBrowserLifecycle() throws ApiException, IOException {
        ...
        File recentResultsFixture = new File(getClass().getResource("synthetics_fixtures/browser_test_recent_results.json").getFile());
        File singleResultFixture = new File(getClass().getResource("synthetics_fixtures/browser_test_single_result.json").getFile());
        ...
        // Again, using a mock response to just test deserialization
        stubFor(
            get(urlPathEqualTo("/api/v1/synthetics/tests/browser/test-synthetics-id/results/test-result-id"))
                .willReturn(okJson(TestUtils.getFixture("v1/client/api/synthetics_fixtures/browser_test_single_result.json")))
        );
        SyntheticsBrowserTestResultFull result = unitApi.getBrowserTestResult("test-synthetics-id", "test-result-id");
    ...
    public void deleteSynthetics404ErrorsTest() throws IOException {
        ...
        stubFor(post(urlPathEqualTo(apiUri + "/tests/delete")).willReturn(okJson(fixtureData).withStatus(404)));
    ...
    public void createTestSynthetics402ErrorTest() throws IOException {
        ...
        stubFor(post(urlPathEqualTo(apiUri + "/tests/api")).willReturn(okJson(fixtureData).withStatus(402)));
    ...
    @Test
    public void TestDeserializationUnknownNestedOneOfInList() throws JsonProcessingException, NoSuchFieldException, IllegalAccessException {
        String body =
    ...
    @Test
    public void TestDeserializationUnknownNestedEnumInList() throws JsonProcessingException, NoSuchFieldException, IllegalAccessException {
        String body =
    ...
    @Test
    public void TestDeserializationUnknownTopLevelEnum() throws JsonProcessingException, NoSuchFieldException, IllegalAccessException {
        String body =
    ...
    @Test
    public void TestDeserializationUnknownNestedEnum() throws JsonProcessingException, NoSuchFieldException, IllegalAccessException {
        String body =
            "{\"status\":\"live\",\"public_id\":\"g6d-gcm-pdq\",\"tags\":[],\"locations\":[\"aws:eu-central-1\",\"aws:ap-northeast-1\"],\"message\":\"\",\"name\":\"Check" +
