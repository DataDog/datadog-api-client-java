...
public class HostsApiTest extends V1ApiTest {
    ...
    public void hostsTest() throws ApiException, TestUtils.RetryException {
        ...
        // test methods
        HostMuteSettings muteSettings = new HostMuteSettings().message("muting for java tests").end(nowMillis + 60);
        ...
        muteSettings = new HostMuteSettings().message("muting for test - updating").end(nowMillis + 120);
