...
public class AwsIntegrationApiTest extends V1ApiTest  {
    ...
    public void removeAccounts() throws ApiException {
        for (AWSAccount account: accountsToDelete) {
            api.deleteAWSAccount().awSAccount(account).execute();
        }
    }
    ...
    public void createAWSAccountTest() throws ApiException {
        ...
        AWSAccountCreateResponse createResponse = api.createAWSAccount().awSAccount(awsAccount).execute();
        ...
        AWSAccountCreateResponse createResponse2 = api.createAWSAccount().awSAccount(awsAccountFull).execute();
    ...
    public void createAWSAccountMissingIDTest() throws ApiException {
        ...
        AWSAccount awsAccount = new AWSAccount();
        awsAccount.setRoleName("java_testRoleName");
        api.createAWSAccount().awSAccount(awsAccount).execute();
    }
    ...
    public void getAllAWSAccountsTest() throws ApiException {
        ...
        for (int i=0; i<5; i++) {
            ...
            api.createAWSAccount().awSAccount(awsAccounts.get(i)).execute();
    ...
    public void updateAWSAccountTest() throws ApiException {
        ...
        api.updateAWSAccount().awSAccount(awsAccount).accountId(awsAccount.getAccountId()).roleName(awsAccount.getRoleName()).execute();
