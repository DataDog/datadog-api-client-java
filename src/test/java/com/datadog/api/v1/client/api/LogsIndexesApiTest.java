...
public class LogsIndexesApiTest extends V1ApiTest {
    ...
    public void updateLogsIndexTest() throws ApiException, IOException {
        ...
        LogsIndexUpdateRequest body = new LogsIndexUpdateRequest().filter(orig.getFilter()).exclusionFilters(exclusionFilters);
    ...
    public void logsIndexesOrderUpdate429ErrorTest() throws IOException {
        ...
        stubFor(put(urlPathEqualTo(apiUri + "/shrugs")).willReturn(okJson(fixtureData).withStatus(429)));
