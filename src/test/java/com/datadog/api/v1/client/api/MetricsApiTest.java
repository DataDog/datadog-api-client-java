...
public class MetricsApiTest extends V1ApiTest {
    ...
    public void metricsTests() throws ApiException, TestUtils.RetryException {
                        ...
                        new TreeMap<String, Object>() {
                            {
                                ...
                                put(
                                    "points",
                                    Arrays.asList(Arrays.asList((double) nowSeconds - 60, 10.5), Arrays.asList((double) nowSeconds, 11.0))
                                );
        ...
        ApiResponse<String> response = sendRequest("POST", "/api/v1/series", payload, new GenericType<String>(String.class));
        ...
        // Test query
        MetricsQueryResponse queryResult = api.queryMetrics(nowSeconds - 100, nowSeconds + 100, testQuery);
        ...
        MetricMetadata newMetadata = new MetricMetadata()
    ...
    public void metricListActiveTestMock() throws ApiException, IOException {
        ...
        MetricsListResponse r = unitApi.listActiveMetrics(1L, new MetricsApi.ListActiveMetricsOptionalParameters().host("host"));
    ...
    public void metricsMetadataUpdate400ErrorTest() throws IOException {
        String fixtureData = TestUtils.getFixture(fixturePrefix + "/error_400.json");
        stubFor(put(urlPathEqualTo(apiUri + "/ametric")).willReturn(okJson(fixtureData).withStatus(400)));
