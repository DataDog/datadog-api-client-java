...
public class LogsPipelinesLifecycleTest extends V1ApiTest {
  ...
  public void pipelineLifecycleTest() throws ApiException {
            ...
            new LogsGrokParser()
                ...
                .grok(
                    new LogsGrokParserRules()
                        ...
                        .supportRules("support baz"))
                .name("grok parser"));
    LogsProcessor logDateRemapper =
        new LogsProcessor(
            new LogsDateRemapper().addSourcesItem("source").name("log date remapper"));
    LogsProcessor logStatusRemapper =
        new LogsProcessor(
            new LogsStatusRemapper().addSourcesItem("source").name("log status remapper"));
    LogsProcessor serviceRemapper =
        new LogsProcessor(
            new LogsServiceRemapper().addSourcesItem("source").name("service remapper"));
    LogsProcessor logMessageRemapper =
        new LogsProcessor(
            new LogsMessageRemapper().addSourcesItem("source").name("log message remapper"));
    LogsProcessor remapperToAttribute =
        new LogsProcessor(
    ...
    LogsProcessor urlParser =
        new LogsProcessor(
            new LogsURLParser().addSourcesItem("source").target("target").name("URL parser"));
    LogsProcessor userAgentParser =
        new LogsProcessor(
            new LogsUserAgentParser()
                .addSourcesItem("source")
                .target("target")
                .isEncoded(true)
                .name("user agent parser"));
    LogsProcessor categoryProcessor =
        new LogsProcessor(
    ...
    LogsProcessor arithmeticProcessor =
        new LogsProcessor(
    ...
    LogsProcessor stringBuilderProcessor =
        new LogsProcessor(
    ...
    LogsProcessor traceRemapper =
        new LogsProcessor(new LogsTraceRemapper().addSourcesItem("source").name("trace remapper"));
    LogsProcessor pipelineProcessor =
        new LogsProcessor(
    ...
    LogsPipelineProcessor nestedPipelineProcessor =
        (LogsPipelineProcessor) createdPipeline.getProcessors().get(15).getActualInstance();
