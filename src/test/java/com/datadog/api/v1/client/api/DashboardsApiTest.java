...
public class DashboardsApiTest extends V1ApiTest {
    ...
    public void dashboardLifecycleTest() throws ApiException {
        ...
        // Add widgets to this list and the created dashboard to have them dynamically tested against
        // the "get" call
        ...
        ChangeWidgetDefinition changeWidgetDefinition = new ChangeWidgetDefinition()
            ...
            .titleSize("16")
            .time(new WidgetTime().liveSpan(WidgetLiveSpan.PAST_FIFTEEN_MINUTES))
            .addCustomLinksItem(new WidgetCustomLink().label("Test Custom Link label").link("https://app.datadoghq.com/dashboard/lists"))
            .addRequestsItem(
        ...
        DistributionWidgetDefinition distributionWidgetDefinition = new DistributionWidgetDefinition()
            .addRequestsItem(new DistributionWidgetRequest().q("avg:system.load.1{*}").style(new WidgetStyle().palette("dog_classic")))
            .showLegend(true)
        ...
        Widget eventStreamWidget = new Widget()
        ...
        Widget eventTimelineWidget = new Widget()
        ...
        FreeTextWidgetDefinition freeTextWidgetDefinition = new FreeTextWidgetDefinition()
            ...
            .fontSize("16")
            .textAlign(WidgetTextAlign.CENTER);
        Widget freeTextWidget = new Widget()
            .definition(new WidgetDefinition(freeTextWidgetDefinition))
            .layout(new WidgetLayout().height(10L).width(10L).x(0L).y(0L));
        freeWidgetList.add(freeTextWidget);

        // Group Widget
        NoteWidgetDefinition groupNoteWidgetDefinition = new NoteWidgetDefinition().content("Test Note Inside Group");
        ...
        HeatMapWidgetDefinition heatMapWidgetDefinition = new HeatMapWidgetDefinition()
            .addRequestsItem(new HeatMapWidgetRequest().style(new WidgetStyle().palette("dog_classic")).q("avg:system.load.1{*}"))
        ...
        HostMapWidgetDefinition hostMapWidgetDefinition = new HostMapWidgetDefinition()
            ...
            .addScopeItem("foo")
            .style(new HostMapWidgetDefinitionStyle().palette("dog_classic").paletteFlip(true).fillMin("0").fillMax("100"))
        ...
        IFrameWidgetDefinition iFrameWidgetDefinition = new IFrameWidgetDefinition().url("https://datadoghq.com");
        Widget iFrameWidget = new Widget()
            .definition(new WidgetDefinition(iFrameWidgetDefinition))
            .layout(new WidgetLayout().height(10L).width(10L).x(0L).y(0L));
        ...
        Widget imageWidget = new Widget()
            .definition(new WidgetDefinition(imageWidgetDefinition))
            .layout(new WidgetLayout().height(10L).width(10L).x(0L).y(0L));
        ...
        LogStreamWidgetDefinition logStreamWidgetDefinition = new LogStreamWidgetDefinition()
            ...
            .sort(new WidgetFieldSort().column("Route").order(WidgetSort.ASCENDING));
        Widget logStreamWidget = new Widget()
            .definition(new WidgetDefinition(logStreamWidgetDefinition))
            .layout(new WidgetLayout().height(10L).width(10L).x(0L).y(0L));
        ...
        MonitorSummaryWidgetDefinition monitorSummaryWidgetDefinition = new MonitorSummaryWidgetDefinition()
            ...
            .start(0L)
            .count(5L);
        Widget monitorSummaryWidget = new Widget()
            .definition(new WidgetDefinition(monitorSummaryWidgetDefinition))
            .layout(new WidgetLayout().height(10L).width(10L).x(0L).y(0L));
        ...
        NoteWidgetDefinition noteDefinition = new NoteWidgetDefinition()
            ...
            .showTick(true)
            .tickPos("4")
            .tickEdge(WidgetTickEdge.BOTTOM);
        ...
        ScatterPlotWidgetDefinition scatterPlotWidgetDefinition = new ScatterPlotWidgetDefinition()
            .requests(
                new ScatterPlotWidgetDefinitionRequests()
                    .x(new ScatterPlotRequest().q("avg:system.load.1{*}").aggregator(ScatterplotWidgetAggregator.AVERAGE))
                    .y(new ScatterPlotRequest().q("avg:system.load.1{*}").aggregator(ScatterplotWidgetAggregator.AVERAGE))
            )
        ...
        Widget serviceSummaryWidget = new Widget()
        ...
        TimeseriesWidgetDefinition timeseriesWidgetDefinition = new TimeseriesWidgetDefinition()
            .addRequestsItem(
                new TimeseriesWidgetRequest()
                    .q("avg:system.load.1{*}")
                    .style(new WidgetRequestStyle().palette("dog_classic").lineType(WidgetLineType.DASHED).lineWidth(WidgetLineWidth.THICK))
                    .addMetadataItem(new TimeseriesWidgetExpressionAlias().expression("avg:system.load.1{*}").aliasName("Aliased metric"))
                        ...
                        new LogQueryDefinition()
                            ...
                            .addGroupByItem(
                                new LogQueryDefinitionGroupBy()
                                    .facet("host")
                                    .limit(5L)
                                    .sort(new LogQueryDefinitionGroupBySort().aggregation("count").order(WidgetSort.ASCENDING))
                            )
                    )
                    .style(new WidgetRequestStyle().palette("dog_classic").lineType(WidgetLineType.DASHED).lineWidth(WidgetLineWidth.THICK))
                    .addMetadataItem(new TimeseriesWidgetExpressionAlias().expression("avg:system.load.1{*}").aliasName("Aliased metric"))
        ...
        DashboardTemplateVariablePreset dashboardTemplateVariablePreset = new DashboardTemplateVariablePreset()
            .name("Test Preset")
            .addTemplateVariablesItem(new DashboardTemplateVariablePresetValue().name("test preset").value("*"));
        ...
        //        //TODO: The user handle in the notify_list needs to be an active user. Create a test
        // user and add it to notify_list
        ...
        dashboard
            ...
            .notifyList(null)
            .addWidgetsItem(noteWidget.definition(new WidgetDefinition(noteDefinition.content("Updated content").fontSize("30"))));
