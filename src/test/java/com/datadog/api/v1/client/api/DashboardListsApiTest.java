...
public class DashboardListsApiTest extends V1ApiTest {
    ...
    public void dashboardListCreateModifyDeleteTest() throws ApiException {
        ...
        DashboardList dashboardList = api.createDashboardList().dashboardList(testDashboardList).execute();
        ...
        dashboardList = api.updateDashboardList(dashboardList.getId()).dashboardList(editedDashboardList).execute();
