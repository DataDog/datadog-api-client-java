...
public class TagsApiTest extends V1ApiTest {
    ...
    public void tagsTest() throws ApiException, TestUtils.RetryException {
        ...
        HostTags addTagsResp = api.createHostTags(hostname, hostTags, new TagsApi.CreateHostTagsOptionalParameters().source("datadog"));
        ...
        HostTags getTagsResp = api.getHostTags(hostname, new TagsApi.GetHostTagsOptionalParameters().source("datadog"));
        ...
        TestUtils.retry(
            ...
            () -> {
                MetricsListResponse metrics;
                try {
                    TagToHosts hostTagsResp = api.listHostTags(new TagsApi.ListHostTagsOptionalParameters().source("datadog"));
        ...
        HostTags updateTagsResp = api.updateHostTags(
            hostname,
            updatedHostTags,
