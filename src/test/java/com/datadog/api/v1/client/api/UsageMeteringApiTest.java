...
public class UsageMeteringApiTest extends V1ApiTest {
    ...
    public void initDateTime() {
        ...
        startHr =
            OffsetDateTime.of(nowDateTime.getYear(), nowDateTime.getMonth().getValue(), 1, 12, 0, 0, 0, ZoneOffset.UTC).minusMonths(1);
        endHr = startHr.plusHours(1);
        startMonth =
            OffsetDateTime.of(nowDateTime.getYear(), nowDateTime.getMonth().getValue(), 1, 0, 0, 0, 0, ZoneOffset.UTC).minusMonths(2);
        endMonth = startHr.plusMonths(1);
        futureStartHr =
            OffsetDateTime
                .of(now.getYear(), now.getMonth().getValue(), now.getDayOfMonth(), now.getHour(), now.getMinute(), 0, 0, ZoneOffset.UTC)
                .plusHours(5);
    ...
    public void getUsageAnalyzedLogsTest() throws ApiException {
        UsageAnalyzedLogsResponse response = api.getUsageAnalyzedLogs(
            startHr,
            new UsageMeteringApi.GetUsageAnalyzedLogsOptionalParameters().endHr(endHr)
        );
    ...
    public void getUsageFargateTest() throws ApiException {
        UsageFargateResponse response = api.getUsageFargate(startHr, new UsageMeteringApi.GetUsageFargateOptionalParameters().endHr(endHr));
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageRumSessionsTest() throws ApiException {
        UsageRumSessionsResponse response = api.getUsageRumSessions(
            startHr,
            new UsageMeteringApi.GetUsageRumSessionsOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageMobileRumSessionsTest() throws ApiException {
        UsageRumSessionsResponse response = api.getUsageRumSessions(
            startHr,
            new UsageMeteringApi.GetUsageRumSessionsOptionalParameters().endHr(endHr).type("mobile")
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageHostsTest() throws ApiException {
        UsageHostsResponse response = api.getUsageHosts(startHr, new UsageMeteringApi.GetUsageHostsOptionalParameters().endHr(endHr));
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageLogsTest() throws ApiException {
        UsageLogsResponse response = api.getUsageLogs(startHr, new UsageMeteringApi.GetUsageLogsOptionalParameters().endHr(endHr));
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageLogsByIndexTest() throws ApiException {
        UsageLogsByIndexResponse response = api.getUsageLogsByIndex(
            startHr,
            new UsageMeteringApi.GetUsageLogsByIndexOptionalParameters().endHr(endHr).indexName(null)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageNetworkFlowsTest() throws ApiException {
        UsageNetworkFlowsResponse response = api.getUsageNetworkFlows(
            startHr,
            new UsageMeteringApi.GetUsageNetworkFlowsOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageNetworkHostsTest() throws ApiException {
        UsageNetworkHostsResponse response = api.getUsageNetworkHosts(
            startHr,
            new UsageMeteringApi.GetUsageNetworkHostsOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageSNMPTest() throws ApiException {
        UsageSNMPResponse response = api.getUsageSNMP(startHr, new UsageMeteringApi.GetUsageSNMPOptionalParameters().endHr(endHr));
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageIncidentManagementTest() throws ApiException {
        UsageIncidentManagementResponse response = api.getIncidentManagement(
            startHr,
            new UsageMeteringApi.GetIncidentManagementOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageBillableSummaryTest() throws ApiException, IOException {
        ...
        OffsetDateTime startDateExpected = OffsetDateTime.of(LocalDateTime.of(2020, 06, 01, 00, 00), ZoneOffset.ofHoursMinutes(0, 0));
        OffsetDateTime endDateExpected = OffsetDateTime.of(LocalDateTime.of(2020, 06, 28, 23, 00), ZoneOffset.ofHoursMinutes(0, 0));
    ...
    public void getSpecifiedDailyCustomReportsTest() throws ApiException {
        ...
        try {
            ...
            if (TestUtils.getRecordingMode().equals(RecordingMode.MODE_REPLAYING) == false || e.getCode() == 404 || e.getCode() == 403) {
    ...
    public void getUsageSummaryTest() throws ApiException, IOException {
        ...
        stubFor(
            get(urlPathEqualTo("/api/v1/usage/summary"))
                .withQueryParam("start_month", equalTo(generalApiClient.formatOffsetDateTime(startMonth)))
        ...
        UsageSummaryResponse usage = unitApi.getUsageSummary(
            startMonth,
            new UsageMeteringApi.GetUsageSummaryOptionalParameters().endMonth(endMonth).includeOrgDetails(includeOrgDetails)
        );

        assertNotNull(usage.getUsage());
        OffsetDateTime startDateExpected = OffsetDateTime.of(LocalDateTime.of(2019, 02, 02, 23, 00), ZoneOffset.ofHoursMinutes(0, 0));
        OffsetDateTime endDateExpected = OffsetDateTime.of(LocalDateTime.of(2020, 02, 02, 23, 00), ZoneOffset.ofHoursMinutes(0, 0));
        ...
        OffsetDateTime dateExpected = OffsetDateTime.of(LocalDateTime.of(2020, 02, 02, 23, 00), ZoneOffset.ofHoursMinutes(0, 0));
    ...
    public void getUsageSyntheticsAPITest() throws ApiException {
        UsageSyntheticsAPIResponse response = api.getUsageSyntheticsAPI(
            startHr,
            new UsageMeteringApi.GetUsageSyntheticsAPIOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageIndexedSpansTest() throws ApiException {
        UsageIndexedSpansResponse response = api.getUsageIndexedSpans(
            startHr,
            new UsageMeteringApi.GetUsageIndexedSpansOptionalParameters().endHr(endHr)
        );
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageLambdaTest() throws ApiException {
        UsageLambdaResponse response = api.getUsageLambda(startHr, new UsageMeteringApi.GetUsageLambdaOptionalParameters().endHr(endHr));
        assertNotNull(response.getUsage());
    }
    ...
    public void getUsageTopAvgMetricsErrorsTest() throws IOException {
        ...
        try {
            fakeAuthApi.getUsageTopAvgMetrics(new UsageMeteringApi.GetUsageTopAvgMetricsOptionalParameters().month(pastStartMonth));
            fail("Expected ApiException not thrown");
        } catch (ApiException e) {
            assertEquals(403, e.getCode());
            APIErrorResponse error = objectMapper.readValue(e.getResponseBody(), APIErrorResponse.class);
    ...
    public void getUsageRumSessionErrorsTest() throws IOException {
        ...
        try {
            api.getUsageRumSessions(startHr, new UsageMeteringApi.GetUsageRumSessionsOptionalParameters().endHr(endHr).type("invalid"));
            fail("Expected ApiException not thrown");
        } catch (ApiException e) {
            assertEquals(400, e.getCode());
            APIErrorResponse error = objectMapper.readValue(e.getResponseBody(), APIErrorResponse.class);
    ...
    public void getUsageBillableSummary400ErrorTest() throws IOException {
        ...
        stubFor(get(urlPathEqualTo(apiUri + "/billable-summary")).willReturn(okJson(fixtureData).withStatus(400)));
    ...
    public void getUsageSummary400ErrorTest() throws IOException {
        String fixtureData = TestUtils.getFixture(fixturePrefix + "/error_400.json");
        stubFor(get(urlPathEqualTo(apiUri + "/summary")).willReturn(okJson(fixtureData).withStatus(400)));
