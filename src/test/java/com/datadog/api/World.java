...
public class World {
    ...
    public void setUnstableOperationEnabled(String operationId)
        throws java.lang.reflect.InvocationTargetException, java.lang.IllegalAccessException, java.lang.NoSuchMethodException {
    ...
    public void addRequestParameter(String parameterName, String value)
        throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, java.lang.NoSuchMethodException, java.lang.reflect.InvocationTargetException, com.fasterxml.jackson.core.JsonProcessingException {
        ...
        if (fieldType == null) {
            throw new RuntimeException(propertyName + " " + requestParametersClass + " " + requestBuilder.getParameterTypes().length);
        }
    ...
    public void given(String apiVersion, Given step) throws Exception {
        ...
        Class<?> givenAPIClass = Class.forName("com.datadog.api." + apiVersion + ".client.api." + step.getAPIName() + "Api");
        // import com.datadog.api.{{ apiVersion }}.client.ApiClient
    ...
    public Callable<?> getRequestUndo(String apiVersion, Undo undoSettings, Object data) throws Exception {
        ...
        Class<?> undoAPIClass = Class.forName("com.datadog.api." + apiVersion + ".client.api." + undoSettings.getAPIName() + "Api");
        Class<?> apiClientClass = Class.forName("com.datadog.api." + apiVersion + ".client.ApiClient");
        Object clientAPI = apiClientClass.getConstructor().newInstance();
        configureClient(apiClientClass, clientAPI);
        authenticateClient(apiClientClass, clientAPI);
        ...
        if ((boolean) apiClientClass.getMethod("isUnstableOperation", String.class).invoke(clientAPI, undoOperationName)) {
            apiClientClass.getMethod("setUnstableOperationEnabled", String.class, boolean.class).invoke(clientAPI, undoOperationName, true);
        }
    ...
    public void sendRequest() throws Exception {
        ...
        Undo undoSettings = UndoAction
            .UndoAction()
            .getUndo(apiVersion, requestBuilder.getName().substring(0, requestBuilder.getName().length() - 12));
     ...
     */
    public static Object lookup(Object data, String path) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException {
        Object result = data;
     ...
     */
    public static String templated(String source, Object context) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException {
        return replace(
            source,
            Pattern.compile("\\{\\{ *([^{}]+|'[^']+'|\"[^\"]+\") *}}"),
            m -> {
    ...
    public static String toClassName(String identifier) {
        return replace(identifier, Pattern.compile("([A-Z])([A-Z]+)([A-Z][a-z])"), m -> m.group(1) + m.group(2).toLowerCase() + m.group(3));
    }
