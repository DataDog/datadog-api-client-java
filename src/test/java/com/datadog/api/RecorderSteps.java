...
public class RecorderSteps {
    ...
    public void cleanAndSendExpectations() throws IOException {
        // Cleanup the recorded requests from sensitive information (API keys in headers
        // and query params),
        // create the associated expectations and save them to disk in the
        // `cassettes/**/*.json` files
