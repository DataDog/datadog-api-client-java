...
public class DashboardsApiTest extends V1ApiTest {
  ...
  public void dashboardLifecycleTest() throws ApiException {
    ...
    // Alert Graph Widget
    AlertGraphWidgetDefinition alertGraphDefinition =
        new AlertGraphWidgetDefinition()
            ...
            .time(
                new WidgetTime(
                    new WidgetLegacyLiveSpan().liveSpan(WidgetLiveSpan.PAST_FIFTEEN_MINUTES)));
    ...
    // Alert Value Widget
    AlertValueWidgetDefinition alertValueDefinition =
    ...
    EventTimelineWidgetDefinition eventTimelineWidgetDefinition =
        new EventTimelineWidgetDefinition()
            ...
            .time(
                new WidgetTime(new WidgetLegacyLiveSpan().liveSpan(WidgetLiveSpan.PAST_ONE_MONTH)));
    ...
    IFrameWidgetDefinition iFrameWidgetDefinition =
        new IFrameWidgetDefinition().url("https://datadoghq.com");
    Widget iFrameWidget =
        new Widget()
    ...
    // Note Widget
    NoteWidgetDefinition noteDefinition =
        ...
        new QueryValueWidgetDefinition()
                ...
                new QueryValueWidgetRequest()
                    ...
                    .addConditionalFormatsItem(
                        new WidgetConditionalFormat()
                            ...
                            .customFgColor("black")
                            .imageUrl(
                                "https://docs.datadoghq.com/images/dashboards/widgets/image/image.mp4")))
            .autoscale(true)
            .customUnit("ns")
            .precision(2L)
            .textAlign(WidgetTextAlign.CENTER)
            ...
            .addCustomLinksItem(
                new WidgetCustomLink()
                    .label("Test Custom Link label")
                    .link("https://app.datadoghq.com/dashboard/lists"));
    Widget queryValueWidget =
        new Widget().definition(new WidgetDefinition(queryValueWidgetDefinition));
    ...
    Widget scatterPlotWidget =
        new Widget().definition(new WidgetDefinition(scatterPlotWidgetDefinition));
        ...
        new ServiceMapWidgetDefinition()
            ...
            .addCustomLinksItem(
                new WidgetCustomLink()
                    .label("Test Custom Link label")
                    .link("https://app.datadoghq.com/dashboard/lists"));
    Widget serviceMapWidget =
        new Widget().definition(new WidgetDefinition(serviceMapWidgetDefinition));
    ...
    ServiceSummaryWidgetDefinition serviceSummaryWidgetDefinition =
        new ServiceSummaryWidgetDefinition()
            ...
            .titleAlign(WidgetTextAlign.CENTER)
            .time(
                new WidgetTime(new WidgetLegacyLiveSpan().liveSpan(WidgetLiveSpan.PAST_ONE_HOUR)));
        ...
        new TimeseriesWidgetDefinition()
            .addRequestsItem(
                new TimeseriesWidgetRequest()
                    ...
                    .addMetadataItem(
                        new TimeseriesWidgetExpressionAlias()
                            .expression("avg:system.load.1{*}")
                            .aliasName("Aliased metric"))
    ...
    TimeseriesWidgetDefinition timeseriesWidgetDefinitionProcessQuery =
        new TimeseriesWidgetDefinition()
            .addRequestsItem(
                new TimeseriesWidgetRequest()
                    .processQuery(
            ...
            .addCustomLinksItem(
                new WidgetCustomLink()
                    .label("Test Custom Link label")
                    .link("https://app.datadoghq.com/dashboard/lists"));
    Widget timeseriesWidgetProcessQuery =
        new Widget().definition(new WidgetDefinition(timeseriesWidgetDefinitionProcessQuery));
    orderedWidgetList.add(timeseriesWidgetProcessQuery);

    // Timeseries Widget with Event query
    TimeseriesWidgetDefinition timeseriesWidgetDefinitionEventQuery =
        new TimeseriesWidgetDefinition()
            .addRequestsItem(
                new TimeseriesWidgetRequest()
                    .eventQuery(
            ...
            .addCustomLinksItem(
                new WidgetCustomLink()
                    .label("Test Custom Link label")
                    .link("https://app.datadoghq.com/dashboard/lists"));
    Widget timeseriesWidgetEventQuery =
        new Widget().definition(new WidgetDefinition(timeseriesWidgetDefinitionEventQuery));
    ...
    TimeseriesWidgetDefinition timeseriesWidgetDefinitionLogQuery =
        new TimeseriesWidgetDefinition()
            .addRequestsItem(
                new TimeseriesWidgetRequest()
                    .logQuery(
            ...
            .addCustomLinksItem(
                new WidgetCustomLink()
                    .label("Test Custom Link label")
                    .link("https://app.datadoghq.com/dashboard/lists"));
    Widget timeseriesWidgetLogQuery =
        new Widget().definition(new WidgetDefinition(timeseriesWidgetDefinitionLogQuery));
    ...
    // Template Variables
    DashboardTemplateVariable templateVariable =
        new DashboardTemplateVariable().name("test template var").prefix("test-java")._default("*");
    ...
    for (Widget noteWidgetResponse : updateResponse.getWidgets()) {
      if (noteWidgetResponse.getDefinition().getActualInstance() instanceof NoteWidgetDefinition) {
        NoteWidgetDefinition def =
            (NoteWidgetDefinition) noteWidgetResponse.getDefinition().getActualInstance();
        foundWidget = true;
