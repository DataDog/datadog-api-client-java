...
set +e
mvn --show-version --batch-mode -Dsurefire.rerunFailingTestsCount=${RERUN_COUNT} test -Dtest=ScenariosTest -Dcucumber.features=./src/test/resources/com/datadog/api/client/v2/api/service_scorecards.feature:31
RESULT=$?
