...
### Fixed
* Fleet Automation v2 remove deprecated or redundant agent detail fields [#4151](https://github.com/DataDog/datadog-api-client-java/pull/4151)
* Uppercase automation rule trigger and action type enum values [#4145](https://github.com/DataDog/datadog-api-client-java/pull/4145)
* Fix broken JSON API shape for security monitoring rules bulk delete [#4120](https://github.com/DataDog/datadog-api-client-java/pull/4120)
* Document CNM API authorization requirements [#4117](https://github.com/DataDog/datadog-api-client-java/pull/4117)
* Fix incident user-defined role policy not required on create [#4103](https://github.com/DataDog/datadog-api-client-java/pull/4103)
* Do not return UnparsedObject when matching nested oneOf schema [#4096](https://github.com/DataDog/datadog-api-client-java/pull/4096)
* Document 409 and 412 error codes for UpsertRows/DeleteRows [#4082](https://github.com/DataDog/datadog-api-client-java/pull/4082)
* Mark list-of-oneOf with an invalid item as unparsed [#4078](https://github.com/DataDog/datadog-api-client-java/pull/4078)
* Add `template_variables` to Notebooks v1 API spec [#4052](https://github.com/DataDog/datadog-api-client-java/pull/4052)

### Added
* data quality monitor sensitivity definition [#4147](https://github.com/DataDog/datadog-api-client-java/pull/4147)
* Add SSE-KMS encryption fields to ObservabilityPipelineAmazonS3Destination for datadog_archives [#4136](https://github.com/DataDog/datadog-api-client-java/pull/4136)
* Adds documentation for historical metrics endpoints [#4134](https://github.com/DataDog/datadog-api-client-java/pull/4134)
* Remove unit conversion notes from usage metering descriptions [#4129](https://github.com/DataDog/datadog-api-client-java/pull/4129)
* Add impact_score and impact_level to Flaky Test Management API spec [#4125](https://github.com/DataDog/datadog-api-client-java/pull/4125)
* Add list custom LLM Obs evaluator configs endpoint [#4123](https://github.com/DataDog/datadog-api-client-java/pull/4123)
* Promote RUM Operations endpoints from private to public [#4115](https://github.com/DataDog/datadog-api-client-java/pull/4115)
* Add TLS support and server_name SNI option to Observability Pipelines client components [#4114](https://github.com/DataDog/datadog-api-client-java/pull/4114)
* Add workflow schedule overlap behavior [#4113](https://github.com/DataDog/datadog-api-client-java/pull/4113)
* Add notice templates to the Status Pages API spec [#4112](https://github.com/DataDog/datadog-api-client-java/pull/4112)
* Add `key-value` type in Logs Array processor [#4111](https://github.com/DataDog/datadog-api-client-java/pull/4111)
* Expand incidents postmortem-templates spec to full CRUD contract [#4105](https://github.com/DataDog/datadog-api-client-java/pull/4105)
* Remove unstable tags from Case Management APIs [#4104](https://github.com/DataDog/datadog-api-client-java/pull/4104)
* Add CSM Ownership settings endpoints [#4101](https://github.com/DataDog/datadog-api-client-java/pull/4101)
* Add DD_ENV filter to Feature Flags environments API [#4100](https://github.com/DataDog/datadog-api-client-java/pull/4100)
* Add feature-flag type to restriction policies [#4092](https://github.com/DataDog/datadog-api-client-java/pull/4092)
* Add Exclude-mode tag usage fields to tag indexing rules [#4091](https://github.com/DataDog/datadog-api-client-java/pull/4091)
* Add public API spec for LLM Observability prompt registry CRUD endpoints [#4090](https://github.com/DataDog/datadog-api-client-java/pull/4090)
* Add public DDSQL tabular query endpoints [#4089](https://github.com/DataDog/datadog-api-client-java/pull/4089)
* Add function and cloud_function fields to Azure and GCP scan options [#4087](https://github.com/DataDog/datadog-api-client-java/pull/4087)
* Add WAF custom rule file addresses [#4084](https://github.com/DataDog/datadog-api-client-java/pull/4084)
* Make incident user-defined-roles API public but keep it unstable [#4081](https://github.com/DataDog/datadog-api-client-java/pull/4081)
* Add OpenAPI spec for GET /api/v2/org_group_policy_suggestions [#4080](https://github.com/DataDog/datadog-api-client-java/pull/4080)
* Add cloud-agnostic account filters endpoints to Cloud Cost Management [#4079](https://github.com/DataDog/datadog-api-client-java/pull/4079)
* Add GET endpoint for custom forecast [#4074](https://github.com/DataDog/datadog-api-client-java/pull/4074)
* Add OpenAPI specs for ListDatasetReportSchedules and PrintReport [#4072](https://github.com/DataDog/datadog-api-client-java/pull/4072)
* Add editable field to critical assets attributes [#4071](https://github.com/DataDog/datadog-api-client-java/pull/4071)
* Add GET /api/v2/on-call/schedules/schedule_id/responders spec [#4069](https://github.com/DataDog/datadog-api-client-java/pull/4069)
* Add OpenAPI spec for hostmap widgwet DDSQL request shape, deprecate legacy metric shape [#4061](https://github.com/DataDog/datadog-api-client-java/pull/4061)
* Document secmon-public-api Entra ID integration endpoints [#4059](https://github.com/DataDog/datadog-api-client-java/pull/4059)
* Add AWS integration metric name filters and preview endpoints [#4056](https://github.com/DataDog/datadog-api-client-java/pull/4056)
* Add public unstable spec for Security Findings Linear endpoints [#4051](https://github.com/DataDog/datadog-api-client-java/pull/4051)
* Add workload activity rule type to notification rules [#4050](https://github.com/DataDog/datadog-api-client-java/pull/4050)
* Add configuration attribute to incident type schema [#4049](https://github.com/DataDog/datadog-api-client-java/pull/4049)
* Add OpenAPI spec for POST /api/v2/snapshot [#4048](https://github.com/DataDog/datadog-api-client-java/pull/4048)
* Add SSE-KMS encryption fields to ObservabilityPipelineAmazonS3GenericDestination [#4047](https://github.com/DataDog/datadog-api-client-java/pull/4047)
* Add included rows to batchrowsquery and pagination meta to listrows for reference tables responses [#4044](https://github.com/DataDog/datadog-api-client-java/pull/4044)
* security-monitoring - add description field to critical assets API spec [#4043](https://github.com/DataDog/datadog-api-client-java/pull/4043)
* Mark ServiceNow triage endpoints as stable [#4041](https://github.com/DataDog/datadog-api-client-java/pull/4041)
* Add OpenAPI spec `version` attribute for Logs Transactions V2 Preview [#4039](https://github.com/DataDog/datadog-api-client-java/pull/4039)
* Page related updates to synthetics  [#4038](https://github.com/DataDog/datadog-api-client-java/pull/4038)
* Add Obs Pipeline Grok processor updates to OpenAPI Spec [#4036](https://github.com/DataDog/datadog-api-client-java/pull/4036)
* Add public v2 OpenAPI operations for governance console [#4029](https://github.com/DataDog/datadog-api-client-java/pull/4029)
* Add UK1 [#4024](https://github.com/DataDog/datadog-api-client-java/pull/4024)
* Add OpenAPI spec for identity providers and Authorized client apis [#3986](https://github.com/DataDog/datadog-api-client-java/pull/3986)
* Add DashboardDefaultTimeframe schema and default_timeframe to Dashboard [#3944](https://github.com/DataDog/datadog-api-client-java/pull/3944)
* Add OpenAPI spec for api v2 rum config [#3942](https://github.com/DataDog/datadog-api-client-java/pull/3942)
* Add OpenAPI specifications for incidents-rapid-api endpoints [#3918](https://github.com/DataDog/datadog-api-client-java/pull/3918)

### Changed
* Fleet Automation promote ready v2 endpoints to public [#4140](https://github.com/DataDog/datadog-api-client-java/pull/4140)
* Migrate tag-policies routes to snake_case [#4124](https://github.com/DataDog/datadog-api-client-java/pull/4124)
* Deprecate report-related endpoints from SLO documentation [#4121](https://github.com/DataDog/datadog-api-client-java/pull/4121)
* Update documentation according to new content pack states endpoint response shape [#4102](https://github.com/DataDog/datadog-api-client-java/pull/4102)
* Mark Linear security findings endpoints as stable [#4094](https://github.com/DataDog/datadog-api-client-java/pull/4094)
* Mark custom forecast endpoints as generally available [#4093](https://github.com/DataDog/datadog-api-client-java/pull/4093)
* Change TopologyMapWidgetDefinition to oneOf with TopologyMapServiceMapDefinitionServiceMap [#4062](https://github.com/DataDog/datadog-api-client-java/pull/4062)
* Update ListAssetsSBOMs spec - require asset_type on first page, add ServerlessFunction asset type [#4054](https://github.com/DataDog/datadog-api-client-java/pull/4054)
* Fix DORA deployment and incident read responses to use date-time timestamps [#4053](https://github.com/DataDog/datadog-api-client-java/pull/4053)
* Allow using access key to specify AWS s3 integration in create / update logs archives [#3993](https://github.com/DataDog/datadog-api-client-java/pull/3993)
* Add saved filters endpoints to the Feature Flags API [#3973](https://github.com/DataDog/datadog-api-client-java/pull/3973)

### Removed
* Remove prerequisite, table_id, and attached_to fields from incident user-defined field API [#4058](https://github.com/DataDog/datadog-api-client-java/pull/4058)
...
### Added
* Add captureNetworkPayloads for Synthetics Browser tests [#4002](https://github.com/DataDog/datadog-api-client-java/pull/4002)
* Set x-keep-typed-in-additional-properties on UsageSummary schemas [#4001](https://github.com/DataDog/datadog-api-client-java/pull/4001)
* add OpenAPI spec for Tag Policies API [#3996](https://github.com/DataDog/datadog-api-client-java/pull/3996)
* Mark ServiceNow triage endpoints as stable [#3994](https://github.com/DataDog/datadog-api-client-java/pull/3994)
* Add restore rule version endpoint in detection rules [#3987](https://github.com/DataDog/datadog-api-client-java/pull/3987)
* Document LLM Observability Patterns API [#3985](https://github.com/DataDog/datadog-api-client-java/pull/3985)
* Add OpenAPI spec for max session duration endpoint [#3982](https://github.com/DataDog/datadog-api-client-java/pull/3982)
* Additional Forms v2 API endpoints [#3981](https://github.com/DataDog/datadog-api-client-java/pull/3981)
* Add observability pipelines Generate metrics processor [#3978](https://github.com/DataDog/datadog-api-client-java/pull/3978)
* Add GET /api/v2/integration/slack/user-bindings to Slack integration spec [#3976](https://github.com/DataDog/datadog-api-client-java/pull/3976)
* Add OpenAPI spec for CSM settings endpoints [#3975](https://github.com/DataDog/datadog-api-client-java/pull/3975)
* Add OpenAPI spec for CSM ownership-api endpoints [#3974](https://github.com/DataDog/datadog-api-client-java/pull/3974)
* Add configuration field to deployment gates evaluation API [#3970](https://github.com/DataDog/datadog-api-client-java/pull/3970)
* Add triage endpoint and fields to IoC Explorer API docs [#3969](https://github.com/DataDog/datadog-api-client-java/pull/3969)
* Add GetSingleEntityContext endpoint to security monitoring spec [#3967](https://github.com/DataDog/datadog-api-client-java/pull/3967)
* Add int64 format and extract inline schemas [#3966](https://github.com/DataDog/datadog-api-client-java/pull/3966)
* Add metric filter query parameter to Cloud Cost Management tag metadata tag sources endpoint [#3965](https://github.com/DataDog/datadog-api-client-java/pull/3965)
* Document SendSecurityMonitoringNotificationPreview endpoint [#3962](https://github.com/DataDog/datadog-api-client-java/pull/3962)
* Add filter[owned_by] parameter to GET /api/v2/application_keys [#3961](https://github.com/DataDog/datadog-api-client-java/pull/3961)
* Add OpenAPI spec for App Builder Forms v2 API  [#3959](https://github.com/DataDog/datadog-api-client-java/pull/3959)
* Add JWT authentication type for Synthetics HTTP API tests [#3958](https://github.com/DataDog/datadog-api-client-java/pull/3958)
* Add shared dashboard list OpenAPI spec [#3955](https://github.com/DataDog/datadog-api-client-java/pull/3955)
* Expose usage summary keys for June SKUs [#3954](https://github.com/DataDog/datadog-api-client-java/pull/3954)
* Add OpenAPI spec for SAML configuration endpoints [#3953](https://github.com/DataDog/datadog-api-client-java/pull/3953)
* Add slo_query to SLO Correction API for global correction support [#3952](https://github.com/DataDog/datadog-api-client-java/pull/3952)
* Add OpenAPI spec for /api/v2/network-health-insights [#3950](https://github.com/DataDog/datadog-api-client-java/pull/3950)
* Add OpenAPI spec for OAuth2 well-known sites endpoint [#3949](https://github.com/DataDog/datadog-api-client-java/pull/3949)
* [error-tracking] Add Linear issue to API endpoints response schemas [#3948](https://github.com/DataDog/datadog-api-client-java/pull/3948)
* Add OpenAPI spec for ASM services v2 endpoint [#3947](https://github.com/DataDog/datadog-api-client-java/pull/3947)
* Add OpenAPI spec for stegadography get-widgets endpoint [#3943](https://github.com/DataDog/datadog-api-client-java/pull/3943)
* Add available_fields endpoint to usage summary [#3941](https://github.com/DataDog/datadog-api-client-java/pull/3941)
* add issue_stream to public spec  [#3938](https://github.com/DataDog/datadog-api-client-java/pull/3938)
* Add public OpenAPI spec for report schedule create and update [#3937](https://github.com/DataDog/datadog-api-client-java/pull/3937)
* Add ListWorkflows endpoint to Workflow Automation [#3936](https://github.com/DataDog/datadog-api-client-java/pull/3936)
* Add edited_before and viewed_before filters to ListDashboardsUsage [#3932](https://github.com/DataDog/datadog-api-client-java/pull/3932)
* Add tag indexing rule APIs to v2 metrics spec [#3931](https://github.com/DataDog/datadog-api-client-java/pull/3931)
* Add OpenAPI spec for global orgs endpoint [#3929](https://github.com/DataDog/datadog-api-client-java/pull/3929)
* doc ml obs Expose LLM Observability annotation endpoints [#3928](https://github.com/DataDog/datadog-api-client-java/pull/3928)
* Add OpenAPI spec for sourcemap-admin public endpoints [#3926](https://github.com/DataDog/datadog-api-client-java/pull/3926)
* RUM - Add OpenAPI spec for hardcoded retention filters [#3925](https://github.com/DataDog/datadog-api-client-java/pull/3925)
* Add missing query parameter to CNM aggregated connections and DNS endpoints [#3924](https://github.com/DataDog/datadog-api-client-java/pull/3924)
* Add RUM rate limit configuration v2 endpoints [#3923](https://github.com/DataDog/datadog-api-client-java/pull/3923)
* Update ListVolumesByMetricName description for Metric Name Pricing [#3922](https://github.com/DataDog/datadog-api-client-java/pull/3922)
* Add status-page resource to restriction policy API docs [#3920](https://github.com/DataDog/datadog-api-client-java/pull/3920)
* Add public OpenAPI ops for Salesforce-incidents orgs and templates [#3919](https://github.com/DataDog/datadog-api-client-java/pull/3919)
* Add partitioning_attributes and lookup_attributes to Log Archives spec [#3917](https://github.com/DataDog/datadog-api-client-java/pull/3917)
* Add OpenAPI spec for security monitoring bulk convert rules endpoint [#3916](https://github.com/DataDog/datadog-api-client-java/pull/3916)
* Add public OpenAPI ops for Webhooks OAuth2 client credentials [#3915](https://github.com/DataDog/datadog-api-client-java/pull/3915)
* Add public OpenAPI ops for Statuspage account and URL settings [#3914](https://github.com/DataDog/datadog-api-client-java/pull/3914)
* Add new Host Map widget infrastructure request type [#3913](https://github.com/DataDog/datadog-api-client-java/pull/3913)
* Add public OpenAPI ops for Opsgenie accounts CRUD [#3912](https://github.com/DataDog/datadog-api-client-java/pull/3912)
*  Allow llm-observability data source in formula event queries [#3910](https://github.com/DataDog/datadog-api-client-java/pull/3910)
* Add OpenAPI spec for APM spans-public-api trace endpoints [#3908](https://github.com/DataDog/datadog-api-client-java/pull/3908)
* Add DeleteSyncConfig OpenAPI endpoint for Storage Management [#3906](https://github.com/DataDog/datadog-api-client-java/pull/3906)
* Add OpenAPI spec for OAuth2 client endpoints [#3905](https://github.com/DataDog/datadog-api-client-java/pull/3905)
* Add OpenAPI specs for SCA licenses and dependency scan endpoints [#3904](https://github.com/DataDog/datadog-api-client-java/pull/3904)
* Allow apm metrics data source for distribution histogram request [#3901](https://github.com/DataDog/datadog-api-client-java/pull/3901)
* Add is_backfilled to our Status Pages degradations and maintenances API responses.  [#3897](https://github.com/DataDog/datadog-api-client-java/pull/3897)
* Add OpenAPI for LLM Observability dataset export batch_update clone restore and records upload SSE [#3895](https://github.com/DataDog/datadog-api-client-java/pull/3895)
* Add OpenAPI specs for secmon-public-api datasets endpoints [#3893](https://github.com/DataDog/datadog-api-client-java/pull/3893)
* Add OpenAPI specs for static-analysis-api missing endpoints [#3891](https://github.com/DataDog/datadog-api-client-java/pull/3891)
* RUM - add API endpoints for permanent retention filters [#3890](https://github.com/DataDog/datadog-api-client-java/pull/3890)
* Add siem_12mo_retention and siem_6mo_retention to usage API [#3887](https://github.com/DataDog/datadog-api-client-java/pull/3887)
* Add serverless_apps_dsm_fargate_tasks fields to usage metering API [#3886](https://github.com/DataDog/datadog-api-client-java/pull/3886)
* Add Cloud Cost Management tag_metadata months endpoint [#3885](https://github.com/DataDog/datadog-api-client-java/pull/3885)
* Add observability pipelines splunk HEC metrics destination [#3884](https://github.com/DataDog/datadog-api-client-java/pull/3884)
* Add comparison to QueryValueWidgetRequest for surfacing the change indicator feature  [#3883](https://github.com/DataDog/datadog-api-client-java/pull/3883)
* Support for In-App WAF policies operations [#3882](https://github.com/DataDog/datadog-api-client-java/pull/3882)
* Adjust TS generated clients to query extra pages unless an empty set was returned [#3880](https://github.com/DataDog/datadog-api-client-java/pull/3880)
* Add OpenAPI for LLM Observability dataset draft state and versions [#3879](https://github.com/DataDog/datadog-api-client-java/pull/3879)
* Document LLM Observability org config endpoints [#3877](https://github.com/DataDog/datadog-api-client-java/pull/3877)
* Add OpenAPI spec for IDP entity integration configs [#3876](https://github.com/DataDog/datadog-api-client-java/pull/3876)
* Add OpenAPI specs for app-builder blueprints, tags, and private query endpoints [#3875](https://github.com/DataDog/datadog-api-client-java/pull/3875)
* Add buffer support to remaining Observability Pipelines destinations [#3874](https://github.com/DataDog/datadog-api-client-java/pull/3874)
* Add critical_query / critical_recovery_query to MonitorThresholds [#3873](https://github.com/DataDog/datadog-api-client-java/pull/3873)
* Sync 'status_pages.yaml' files with backend [#3872](https://github.com/DataDog/datadog-api-client-java/pull/3872)
* Add OpenAPI spec for v2 customer org disable endpoint [#3871](https://github.com/DataDog/datadog-api-client-java/pull/3871)
* Add Annotations API v2 spec [#3870](https://github.com/DataDog/datadog-api-client-java/pull/3870)
* Document LLM Observability LLM provider integration endpoints [#3868](https://github.com/DataDog/datadog-api-client-java/pull/3868)
* Add ValidateAWSCCMConfig operation to AWS integration v2 spec [#3867](https://github.com/DataDog/datadog-api-client-java/pull/3867)
* Add baselineUserLocationsDuration to Impossible Travel rule options [#3866](https://github.com/DataDog/datadog-api-client-java/pull/3866)
* Add OpenAPI spec for RUM insight aggregation endpoints [#3864](https://github.com/DataDog/datadog-api-client-java/pull/3864)
* Add OpenAPI definitions for path-param tag_description endpoints [#3863](https://github.com/DataDog/datadog-api-client-java/pull/3863)
* Monitors Augmented Query Add Group By Source [#3862](https://github.com/DataDog/datadog-api-client-java/pull/3862)
* Add mcp step subtype to synthetics multi-step api tests [#3861](https://github.com/DataDog/datadog-api-client-java/pull/3861)
* Document Cloud SIEM Growth and Content owned endpoints [#3859](https://github.com/DataDog/datadog-api-client-java/pull/3859)
* Add API fields for jobs_monitoring_orchestrators [#3857](https://github.com/DataDog/datadog-api-client-java/pull/3857)
* Add OpenAPI specs for 36 undocumented case-rapid-api v2 endpoints [#3856](https://github.com/DataDog/datadog-api-client-java/pull/3856)
* Document LLM Observability Experiments search endpoints [#3855](https://github.com/DataDog/datadog-api-client-java/pull/3855)
* Add new metrics processors in Observability Pipelines [#3853](https://github.com/DataDog/datadog-api-client-java/pull/3853)
* Add OpenAPI spec for Model Lab API v2 endpoints [#3852](https://github.com/DataDog/datadog-api-client-java/pull/3852)
* Update observability pipelines databricks_zerobus destination endpoint fields to be secret [#3851](https://github.com/DataDog/datadog-api-client-java/pull/3851)
* Add csm_host_pro hosts agentless scanners to usage metering API [#3850](https://github.com/DataDog/datadog-api-client-java/pull/3850)
* Add Dashboards Usage v2 endpoints [#3849](https://github.com/DataDog/datadog-api-client-java/pull/3849)
* observability pipelines add tls.verify_certificate field to multiple push sources [#3848](https://github.com/DataDog/datadog-api-client-java/pull/3848)
* Update Synthetics downtime spec: gate write ops on default-settings and add monthly weekday positions [#3847](https://github.com/DataDog/datadog-api-client-java/pull/3847)
* Add TCP congestion signals to CNM aggregated connections spec [#3846](https://github.com/DataDog/datadog-api-client-java/pull/3846)
* Add ListReferenceTableRows endpoint to Reference Tables [#3845](https://github.com/DataDog/datadog-api-client-java/pull/3845)
* Cloud Cost Recommendations Search API [#3839](https://github.com/DataDog/datadog-api-client-java/pull/3839)
* Add Cloud Cost Management tag_metadata endpoints [#3838](https://github.com/DataDog/datadog-api-client-java/pull/3838)
* feat - Add data-jobs alert monitor type support [#3834](https://github.com/DataDog/datadog-api-client-java/pull/3834)
* Add display_block interaction type to LLM Obs annotation queues [#3832](https://github.com/DataDog/datadog-api-client-java/pull/3832)
* Add exclude-attribute processor to logs pipelines [#3821](https://github.com/DataDog/datadog-api-client-java/pull/3821)
* Add missing scorecards OpenAPI specs [#3820](https://github.com/DataDog/datadog-api-client-java/pull/3820)
* Adding valid tokens to Splunk and HTTP server source [#3816](https://github.com/DataDog/datadog-api-client-java/pull/3816)
* Add escalation policy routing action with support hours and acknowledgment timeout to On-Call routing rules [#3798](https://github.com/DataDog/datadog-api-client-java/pull/3798)
* Add created_at/modified_at to LLM Obs annotation queue interaction responses [#3746](https://github.com/DataDog/datadog-api-client-java/pull/3746)

### Removed
* Remove deprecated incident services APIs (/api/v2/services) [#3990](https://github.com/DataDog/datadog-api-client-java/pull/3990)
* Make fleet-automation clusters and instrumented_pods specs private [#3979](https://github.com/DataDog/datadog-api-client-java/pull/3979)

### Changed
* Add DELETE user-binding endpoint to Microsoft Teams Integration spec [#3984](https://github.com/DataDog/datadog-api-client-java/pull/3984)
* Add Google Chat organizations, delegated-user, and target-audience OpenAPI operations [#3960](https://github.com/DataDog/datadog-api-client-java/pull/3960)
* Update param spec for GET experiments in LLM Observability [#3934](https://github.com/DataDog/datadog-api-client-java/pull/3934)
* Add risk-scores entityID spec [#3927](https://github.com/DataDog/datadog-api-client-java/pull/3927)
* Update PAT and SAT api spec [#3909](https://github.com/DataDog/datadog-api-client-java/pull/3909)
* Rename Tiers for Org Group Policies and Remove Include Memberships Support [#3878](https://github.com/DataDog/datadog-api-client-java/pull/3878)
* Document LLM Observability span search and data deletion endpoints [#3865](https://github.com/DataDog/datadog-api-client-java/pull/3865)

### Deprecated
* Deprecate bulk tag config API endpoints [#3977](https://github.com/DataDog/datadog-api-client-java/pull/3977)
* Move MuteFindings operation to private spec [#3968](https://github.com/DataDog/datadog-api-client-java/pull/3968)

### Fixed
* Fix RUM casing in descriptions and summaries [#3939](https://github.com/DataDog/datadog-api-client-java/pull/3939)
* Reconcile SIEM historical detections OpenAPI with current schema [#3896](https://github.com/DataDog/datadog-api-client-java/pull/3896)
* security-monitoring - Change histsignals/search method from GET to POST [#3892](https://github.com/DataDog/datadog-api-client-java/pull/3892)
