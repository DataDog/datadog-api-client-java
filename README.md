...
This repository contains the autogenerated Java client for the [Datadog API](https://docs.datadoghq.com/api/). The client code, feature files, and test data are generated from Datadog's public OpenAPI specifications by internal tooling.
